...
public class AttachmentSetExpiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.support.model.AttachmentSetExpiredException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return attachmentSetExpiredException;
    }

    private static AttachmentSetExpiredExceptionUnmarshaller instance;

    public static AttachmentSetExpiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AttachmentSetExpiredExceptionUnmarshaller();
        return instance;
    }
}
