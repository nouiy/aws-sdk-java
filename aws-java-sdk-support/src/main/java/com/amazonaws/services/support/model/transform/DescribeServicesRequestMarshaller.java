...
public class DescribeServicesRequestMarshaller {
    ...
    private static final MarshallingInfo<List> SERVICECODELIST_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("serviceCodeList").build();
    ...
    public void marshall(DescribeServicesRequest describeServicesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeServicesRequest.getServiceCodeList(), SERVICECODELIST_BINDING);
            protocolMarshaller.marshall(describeServicesRequest.getLanguage(), LANGUAGE_BINDING);
        } catch (Exception e) {
