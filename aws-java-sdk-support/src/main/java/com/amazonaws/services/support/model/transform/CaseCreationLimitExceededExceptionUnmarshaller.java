...
public class CaseCreationLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CaseCreationLimitExceededExceptionUnmarshaller instance;

    public static CaseCreationLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CaseCreationLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
