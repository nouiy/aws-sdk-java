...
public class AttachmentSetIdNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.support.model.AttachmentSetIdNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return attachmentSetIdNotFoundException;
    }

    private static AttachmentSetIdNotFoundExceptionUnmarshaller instance;

    public static AttachmentSetIdNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AttachmentSetIdNotFoundExceptionUnmarshaller();
        return instance;
    }
}
