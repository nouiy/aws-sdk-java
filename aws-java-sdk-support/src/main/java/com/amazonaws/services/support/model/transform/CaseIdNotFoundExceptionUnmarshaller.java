...
public class CaseIdNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CaseIdNotFoundExceptionUnmarshaller instance;

    public static CaseIdNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CaseIdNotFoundExceptionUnmarshaller();
        return instance;
    }
}
