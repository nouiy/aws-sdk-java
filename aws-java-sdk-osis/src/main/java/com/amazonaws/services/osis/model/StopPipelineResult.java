...
public class StopPipelineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopPipelineResult withPipeline(Pipeline pipeline) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopPipelineResult == false)
            return false;
        StopPipelineResult other = (StopPipelineResult) obj;
    ...
    @Override
    public StopPipelineResult clone() {
        try {
            return (StopPipelineResult) super.clone();
