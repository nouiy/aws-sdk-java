...
/**
 * ChangeProgressStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChangeProgressStatusJsonUnmarshaller implements Unmarshaller<ChangeProgressStatus, JsonUnmarshallerContext> {

    public ChangeProgressStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ChangeProgressStatus changeProgressStatus = new ChangeProgressStatus();
    ...
    private static ChangeProgressStatusJsonUnmarshaller instance;

    public static ChangeProgressStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ChangeProgressStatusJsonUnmarshaller();
        return instance;
    }
}
