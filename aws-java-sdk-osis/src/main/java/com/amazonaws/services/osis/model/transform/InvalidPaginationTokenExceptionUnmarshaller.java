...
public class InvalidPaginationTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidPaginationTokenExceptionUnmarshaller() {
        super(com.amazonaws.services.osis.model.InvalidPaginationTokenException.class, "InvalidPaginationTokenException");
    }

    @Override
    public com.amazonaws.services.osis.model.InvalidPaginationTokenException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.osis.model.InvalidPaginationTokenException invalidPaginationTokenException = new com.amazonaws.services.osis.model.InvalidPaginationTokenException(
                null);
