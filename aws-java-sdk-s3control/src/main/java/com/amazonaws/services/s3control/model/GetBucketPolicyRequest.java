...
public class GetBucketPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBucketPolicyRequest withAccountId(String accountId) {
    ...
    @Override
    public GetBucketPolicyRequest clone() {
        return (GetBucketPolicyRequest) super.clone();
    }
