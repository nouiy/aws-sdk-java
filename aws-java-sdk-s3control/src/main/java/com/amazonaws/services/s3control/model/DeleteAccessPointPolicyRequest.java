...
public class DeleteAccessPointPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAccessPointPolicyRequest withAccountId(String accountId) {
    ...
    public DeleteAccessPointPolicyRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAccessPointPolicyRequest == false)
            return false;
        DeleteAccessPointPolicyRequest other = (DeleteAccessPointPolicyRequest) obj;
    ...
    @Override
    public DeleteAccessPointPolicyRequest clone() {
        return (DeleteAccessPointPolicyRequest) super.clone();
    }
