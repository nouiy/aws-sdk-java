...
/**
 * CreateBucketConfiguration StAX Unmarshaller
 */
...
public class CreateBucketConfigurationStaxUnmarshaller implements Unmarshaller<CreateBucketConfiguration, StaxUnmarshallerContext> {
    ...
    public CreateBucketConfiguration unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LocationConstraint", targetDepth)) {
                    createBucketConfiguration.setLocationConstraint(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
