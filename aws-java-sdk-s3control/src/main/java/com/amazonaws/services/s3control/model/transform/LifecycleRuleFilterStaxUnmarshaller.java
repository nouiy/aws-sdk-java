...
/**
 * LifecycleRuleFilter StAX Unmarshaller
 */
...
public class LifecycleRuleFilterStaxUnmarshaller implements Unmarshaller<LifecycleRuleFilter, StaxUnmarshallerContext> {
    ...
    public LifecycleRuleFilter unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Prefix", targetDepth)) {
                    lifecycleRuleFilter.setPrefix(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Tag", targetDepth)) {
                    lifecycleRuleFilter.setTag(S3TagStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
