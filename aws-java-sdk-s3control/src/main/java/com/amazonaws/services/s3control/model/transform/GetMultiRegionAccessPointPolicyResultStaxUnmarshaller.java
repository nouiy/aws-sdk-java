...
/**
 * GetMultiRegionAccessPointPolicyResult StAX Unmarshaller
 */
...
public class GetMultiRegionAccessPointPolicyResultStaxUnmarshaller implements Unmarshaller<GetMultiRegionAccessPointPolicyResult, StaxUnmarshallerContext> {
    ...
    public GetMultiRegionAccessPointPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Policy", targetDepth)) {
                    getMultiRegionAccessPointPolicyResult.setPolicy(MultiRegionAccessPointPolicyDocumentStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
