...
/**
 * GetPublicAccessBlockResult StAX Unmarshaller
 */
...
public class GetPublicAccessBlockResultStaxUnmarshaller implements Unmarshaller<GetPublicAccessBlockResult, StaxUnmarshallerContext> {
    ...
    public GetPublicAccessBlockResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("PublicAccessBlockConfiguration", targetDepth)) {
                    getPublicAccessBlockResult.setPublicAccessBlockConfiguration(PublicAccessBlockConfigurationStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
