...
public class DeleteBucketPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteBucketPolicyRequest withAccountId(String accountId) {
    ...
    @Override
    public DeleteBucketPolicyRequest clone() {
        return (DeleteBucketPolicyRequest) super.clone();
    }
