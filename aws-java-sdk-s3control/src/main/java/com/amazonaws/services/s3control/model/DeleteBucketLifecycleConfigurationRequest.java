...
public class DeleteBucketLifecycleConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The account ID of the lifecycle configuration to delete.
     */
    ...
    public DeleteBucketLifecycleConfigurationRequest withAccountId(String accountId) {
    ...
    public DeleteBucketLifecycleConfigurationRequest withBucket(String bucket) {
        setBucket(bucket);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBucketLifecycleConfigurationRequest == false)
            return false;
        DeleteBucketLifecycleConfigurationRequest other = (DeleteBucketLifecycleConfigurationRequest) obj;
    ...
    @Override
    public DeleteBucketLifecycleConfigurationRequest clone() {
        return (DeleteBucketLifecycleConfigurationRequest) super.clone();
    }
