...
/**
 * RegionReport StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegionReportStaxUnmarshaller implements Unmarshaller<RegionReport, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Bucket", targetDepth)) {
                    regionReport.setBucket(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
