...
/**
 * ActivityMetrics StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActivityMetricsStaxUnmarshaller implements Unmarshaller<ActivityMetrics, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("IsEnabled", targetDepth)) {
                    activityMetrics.setIsEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
