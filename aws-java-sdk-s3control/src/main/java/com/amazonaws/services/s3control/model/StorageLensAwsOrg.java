...
public class StorageLensAwsOrg implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StorageLensAwsOrg == false)
            return false;
        StorageLensAwsOrg other = (StorageLensAwsOrg) obj;
    ...
    public StorageLensAwsOrg clone() {
        try {
            return (StorageLensAwsOrg) super.clone();
