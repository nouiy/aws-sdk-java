        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    listJobsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Jobs", targetDepth)) {
                    listJobsResult.withJobs(new ArrayList<JobListDescriptor>());
                    continue;
                }

                if (context.testExpression("Jobs/member", targetDepth)) {
                    listJobsResult.withJobs(JobListDescriptorStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
