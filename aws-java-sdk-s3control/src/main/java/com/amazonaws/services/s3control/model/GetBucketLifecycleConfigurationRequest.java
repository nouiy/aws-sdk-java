...
public class GetBucketLifecycleConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBucketLifecycleConfigurationRequest withAccountId(String accountId) {
    ...
    @Override
    public GetBucketLifecycleConfigurationRequest clone() {
