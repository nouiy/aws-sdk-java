...
/**
 * ListAccessPointsResult StAX Unmarshaller
 */
...
public class ListAccessPointsResultStaxUnmarshaller implements Unmarshaller<ListAccessPointsResult, StaxUnmarshallerContext> {
    ...
    public ListAccessPointsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AccessPointList", targetDepth)) {
                    listAccessPointsResult.withAccessPointList(new ArrayList<AccessPoint>());
                    continue;
                }

                if (context.testExpression("AccessPointList/AccessPoint", targetDepth)) {
                    listAccessPointsResult.withAccessPointList(AccessPointStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("NextToken", targetDepth)) {
                    listAccessPointsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
