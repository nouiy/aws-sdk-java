...
/**
 * StorageLensDataExportEncryption StAX Unmarshaller
 */
...
public class StorageLensDataExportEncryptionStaxUnmarshaller implements Unmarshaller<StorageLensDataExportEncryption, StaxUnmarshallerContext> {
    ...
    public StorageLensDataExportEncryption unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SSE-S3", targetDepth)) {
                    storageLensDataExportEncryption.setSSES3(SSES3StaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("SSE-KMS", targetDepth)) {
                    storageLensDataExportEncryption.setSSEKMS(SSEKMSStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
