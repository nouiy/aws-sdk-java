...
/**
 * CreateAccessPointForObjectLambdaResult StAX Unmarshaller
 */
...
public class CreateAccessPointForObjectLambdaResultStaxUnmarshaller implements Unmarshaller<CreateAccessPointForObjectLambdaResult, StaxUnmarshallerContext> {
    ...
    public CreateAccessPointForObjectLambdaResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ObjectLambdaAccessPointArn", targetDepth)) {
                    createAccessPointForObjectLambdaResult.setObjectLambdaAccessPointArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
