...
public class GetBucketRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBucketRequest withAccountId(String accountId) {
    ...
    public GetBucketRequest withBucket(String bucket) {
        setBucket(bucket);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBucketRequest == false)
            return false;
    ...
    public GetBucketRequest clone() {
        return (GetBucketRequest) super.clone();
    }
