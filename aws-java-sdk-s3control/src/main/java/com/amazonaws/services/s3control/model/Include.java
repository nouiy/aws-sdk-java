 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/Include" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Include implements Serializable, Cloneable {
    ...
    public Include withBuckets(String... buckets) {
    ...
    public Include withBuckets(java.util.Collection<String> buckets) {
        setBuckets(buckets);
        return this;
    }
    ...
    public Include withRegions(String... regions) {
    ...
    public Include withRegions(java.util.Collection<String> regions) {
        setRegions(regions);
        return this;
    }
