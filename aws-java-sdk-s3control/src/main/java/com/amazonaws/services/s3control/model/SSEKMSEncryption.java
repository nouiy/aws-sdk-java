 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/SSEKMSEncryption" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SSEKMSEncryption implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SSEKMSEncryption == false)
            return false;
        SSEKMSEncryption other = (SSEKMSEncryption) obj;
    ...
    public SSEKMSEncryption clone() {
        try {
            return (SSEKMSEncryption) super.clone();
