...
public class S3DeleteObjectTaggingOperation implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof S3DeleteObjectTaggingOperation == false)
            return false;
        S3DeleteObjectTaggingOperation other = (S3DeleteObjectTaggingOperation) obj;
        return true;
    }
    ...
    public S3DeleteObjectTaggingOperation clone() {
        try {
            return (S3DeleteObjectTaggingOperation) super.clone();
