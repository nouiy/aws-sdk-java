        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EncryptionType", targetDepth)) {
                    context.nextToken();
                    encryption.setEncryptionType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("KMSKeyId", targetDepth)) {
                    context.nextToken();
                    encryption.setKMSKeyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("KMSContext", targetDepth)) {
                    context.nextToken();
                    encryption.setKMSContext(context.getUnmarshaller(String.class).unmarshall(context));
                }
