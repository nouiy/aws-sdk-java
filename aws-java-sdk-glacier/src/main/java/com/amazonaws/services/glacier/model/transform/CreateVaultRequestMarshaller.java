...
public class CreateVaultRequestMarshaller {
    ...
    private static final CreateVaultRequestMarshaller instance = new CreateVaultRequestMarshaller();

    public static CreateVaultRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateVaultRequest createVaultRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createVaultRequest.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(createVaultRequest.getVaultName(), VAULTNAME_BINDING);
        } catch (Exception e) {
