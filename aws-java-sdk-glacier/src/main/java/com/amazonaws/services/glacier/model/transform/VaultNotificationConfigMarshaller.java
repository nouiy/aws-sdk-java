...
public class VaultNotificationConfigMarshaller {
    ...
    public void marshall(VaultNotificationConfig vaultNotificationConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(vaultNotificationConfig.getSNSTopic(), SNSTOPIC_BINDING);
            protocolMarshaller.marshall(vaultNotificationConfig.getEvents(), EVENTS_BINDING);
        } catch (Exception e) {
