...
/**
 * SelectParameters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SelectParametersJsonUnmarshaller implements Unmarshaller<SelectParameters, JsonUnmarshallerContext> {
    ...
    private static SelectParametersJsonUnmarshaller instance;

    public static SelectParametersJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SelectParametersJsonUnmarshaller();
        return instance;
    }
}
