...
public class DeleteVaultRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for DeleteVaultRequest object. Callers should use the setter or fluent setter (with...)
    ...
    /**
     * Constructs a new DeleteVaultRequest object. Callers should use the setter or fluent setter (with...) methods to
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVaultRequest == false)
            return false;
