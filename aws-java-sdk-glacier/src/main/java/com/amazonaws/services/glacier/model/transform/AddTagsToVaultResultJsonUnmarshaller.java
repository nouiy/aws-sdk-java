...
public class AddTagsToVaultResultJsonUnmarshaller implements Unmarshaller<AddTagsToVaultResult, JsonUnmarshallerContext> {
    ...
    public AddTagsToVaultResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AddTagsToVaultResult addTagsToVaultResult = new AddTagsToVaultResult();
