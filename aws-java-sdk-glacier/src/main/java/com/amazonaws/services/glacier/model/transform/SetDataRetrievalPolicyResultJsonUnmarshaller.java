...
public class SetDataRetrievalPolicyResultJsonUnmarshaller implements Unmarshaller<SetDataRetrievalPolicyResult, JsonUnmarshallerContext> {
    ...
    public SetDataRetrievalPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SetDataRetrievalPolicyResult setDataRetrievalPolicyResult = new SetDataRetrievalPolicyResult();
