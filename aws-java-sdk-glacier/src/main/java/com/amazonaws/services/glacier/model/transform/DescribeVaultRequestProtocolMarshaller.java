...
public class DescribeVaultRequestProtocolMarshaller implements Marshaller<Request<DescribeVaultRequest>, DescribeVaultRequest> {
    ...
    public DescribeVaultRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribeVaultRequest> marshall(DescribeVaultRequest describeVaultRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DescribeVaultRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    describeVaultRequest);

            protocolMarshaller.startMarshalling();
            DescribeVaultRequestMarshaller.getInstance().marshall(describeVaultRequest, protocolMarshaller);
