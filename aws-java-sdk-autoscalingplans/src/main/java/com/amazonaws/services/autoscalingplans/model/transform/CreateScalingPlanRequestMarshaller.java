...
@SdkInternalApi
public class CreateScalingPlanRequestMarshaller {
    ...
    private static final CreateScalingPlanRequestMarshaller instance = new CreateScalingPlanRequestMarshaller();

    public static CreateScalingPlanRequestMarshaller getInstance() {
        return instance;
    }
