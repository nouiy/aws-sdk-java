...
public class DescribeWorldGenerationJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * 
     * @param status
     *        The status of the world generation job:</p>
     *        <dl>
     *        <dt>Pending</dt>
     *        <dd>
     *        <p>
     ...
     * </dl>
     * 
     * @return The status of the world generation job:</p>
     *         <dl>
     *         <dt>Pending</dt>
     *         <dd>
     *         <p>
     ...
     * </p>
     * 
     * @return The time, in milliseconds since the epoch, when the world generation job was created.
     */
    ...
    public DescribeWorldGenerationJobResult withCreatedAt(java.util.Date createdAt) {
     ...
     * 
     * @param failureCode
     *        The failure code of the world generation job if it failed:</p>
     *        <dl>
     *        <dt>InternalServiceError</dt>
     *        <dd>
     *        <p>
     ...
     * </dl>
     * 
     * @return The failure code of the world generation job if it failed:</p>
     *         <dl>
     *         <dt>InternalServiceError</dt>
     *         <dd>
     *         <p>
     ...
     * </p>
     * 
     * @return The reason why the world generation job failed.
     */
     ...
     * </p>
     * 
     * @param finishedWorldsSummary
     *        Summary information about finished worlds.
     */

    public void setFinishedWorldsSummary(FinishedWorldsSummary finishedWorldsSummary) {
     ...
     * </p>
     * 
     * @return Summary information about finished worlds.
     */

    public FinishedWorldsSummary getFinishedWorldsSummary() {
    ...
    public DescribeWorldGenerationJobResult withFinishedWorldsSummary(FinishedWorldsSummary finishedWorldsSummary) {
        setFinishedWorldsSummary(finishedWorldsSummary);
        return this;
    }
     ...
     * </p>
     * 
     * @return A map that contains tag keys and tag values that are attached to the world generation job.
     */
    ...
    public DescribeWorldGenerationJobResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeWorldGenerationJobResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DescribeWorldGenerationJobResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeWorldGenerationJobResult == false)
            return false;
        DescribeWorldGenerationJobResult other = (DescribeWorldGenerationJobResult) obj;
        ...
        if (other.getWorldCount() != null && other.getWorldCount().equals(this.getWorldCount()) == false)
            return false;
        if (other.getFinishedWorldsSummary() == null ^ this.getFinishedWorldsSummary() == null)
            return false;
        if (other.getFinishedWorldsSummary() != null && other.getFinishedWorldsSummary().equals(this.getFinishedWorldsSummary()) == false)
            return false;
    ...
    public DescribeWorldGenerationJobResult clone() {
        try {
            return (DescribeWorldGenerationJobResult) super.clone();
