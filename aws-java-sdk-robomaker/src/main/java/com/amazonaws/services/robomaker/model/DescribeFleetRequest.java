...
public class DescribeFleetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeFleetRequest withFleet(String fleet) {
        setFleet(fleet);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFleetRequest == false)
            return false;
        DescribeFleetRequest other = (DescribeFleetRequest) obj;
    ...
    @Override
    public DescribeFleetRequest clone() {
        return (DescribeFleetRequest) super.clone();
    }
