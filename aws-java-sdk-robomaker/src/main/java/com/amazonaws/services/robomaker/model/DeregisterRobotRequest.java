...
public class DeregisterRobotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeregisterRobotRequest withFleet(String fleet) {
        setFleet(fleet);
        return this;
    }
    ...
    public DeregisterRobotRequest withRobot(String robot) {
        setRobot(robot);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterRobotRequest == false)
            return false;
        DeregisterRobotRequest other = (DeregisterRobotRequest) obj;
    ...
    @Override
    public DeregisterRobotRequest clone() {
        return (DeregisterRobotRequest) super.clone();
    }
