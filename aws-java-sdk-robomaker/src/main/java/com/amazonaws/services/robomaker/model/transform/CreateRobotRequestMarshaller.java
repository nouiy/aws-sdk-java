...
@SdkInternalApi
public class CreateRobotRequestMarshaller {
    ...
    public static CreateRobotRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateRobotRequest createRobotRequest, ProtocolMarshaller protocolMarshaller) {
