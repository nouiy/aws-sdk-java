...
public class CreateWorldTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateWorldTemplateResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateWorldTemplateResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateWorldTemplateResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateWorldTemplateResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateWorldTemplateResult == false)
            return false;
        CreateWorldTemplateResult other = (CreateWorldTemplateResult) obj;
    ...
    public CreateWorldTemplateResult clone() {
        try {
            return (CreateWorldTemplateResult) super.clone();
