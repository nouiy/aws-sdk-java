...
/**
 * RobotDeployment JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RobotDeploymentJsonUnmarshaller implements Unmarshaller<RobotDeployment, JsonUnmarshallerContext> {

    public RobotDeployment unmarshall(JsonUnmarshallerContext context) throws Exception {
        RobotDeployment robotDeployment = new RobotDeployment();
    ...
    private static RobotDeploymentJsonUnmarshaller instance;

    public static RobotDeploymentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RobotDeploymentJsonUnmarshaller();
        return instance;
    }
}
