...
public class ListSimulationJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSimulationJobsRequest withMaxResults(Integer maxResults) {
    ...
    public ListSimulationJobsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSimulationJobsRequest == false)
            return false;
        ListSimulationJobsRequest other = (ListSimulationJobsRequest) obj;
    ...
    public ListSimulationJobsRequest clone() {
        return (ListSimulationJobsRequest) super.clone();
    }
