...
/**
 * CancelDeploymentJobResult JSON Unmarshaller
 */
...
public class CancelDeploymentJobResultJsonUnmarshaller implements Unmarshaller<CancelDeploymentJobResult, JsonUnmarshallerContext> {
    ...
    public CancelDeploymentJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelDeploymentJobResult cancelDeploymentJobResult = new CancelDeploymentJobResult();

        return cancelDeploymentJobResult;
    }
