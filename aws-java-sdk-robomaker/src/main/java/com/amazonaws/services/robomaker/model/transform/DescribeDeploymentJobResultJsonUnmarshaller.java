...
/**
 * DescribeDeploymentJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeDeploymentJobResultJsonUnmarshaller implements Unmarshaller<DescribeDeploymentJobResult, JsonUnmarshallerContext> {

    public DescribeDeploymentJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeDeploymentJobResult describeDeploymentJobResult = new DescribeDeploymentJobResult();
    ...
    private static DescribeDeploymentJobResultJsonUnmarshaller instance;

    public static DescribeDeploymentJobResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeDeploymentJobResultJsonUnmarshaller();
        return instance;
    }
}
