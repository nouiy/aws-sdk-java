...
public class CreateSimulationApplicationVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateSimulationApplicationVersionResult withSources(Source... sources) {
    ...
    public CreateSimulationApplicationVersionResult withSources(java.util.Collection<Source> sources) {
        setSources(sources);
        return this;
    }
    ...
    public CreateSimulationApplicationVersionResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSimulationApplicationVersionResult == false)
            return false;
        CreateSimulationApplicationVersionResult other = (CreateSimulationApplicationVersionResult) obj;
