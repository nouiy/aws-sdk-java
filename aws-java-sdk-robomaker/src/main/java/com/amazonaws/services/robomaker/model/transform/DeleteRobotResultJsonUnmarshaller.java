...
/**
 * DeleteRobotResult JSON Unmarshaller
 */
...
public class DeleteRobotResultJsonUnmarshaller implements Unmarshaller<DeleteRobotResult, JsonUnmarshallerContext> {
    ...
    public DeleteRobotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRobotResult deleteRobotResult = new DeleteRobotResult();
