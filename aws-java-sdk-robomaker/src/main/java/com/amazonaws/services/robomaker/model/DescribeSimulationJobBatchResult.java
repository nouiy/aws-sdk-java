...
public class DescribeSimulationJobBatchResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeSimulationJobBatchResult withLastUpdatedAt(java.util.Date lastUpdatedAt) {
    ...
    public DescribeSimulationJobBatchResult withCreatedAt(java.util.Date createdAt) {
    ...
    public DescribeSimulationJobBatchResult withFailedRequests(FailedCreateSimulationJobRequest... failedRequests) {
    ...
    public DescribeSimulationJobBatchResult withFailedRequests(java.util.Collection<FailedCreateSimulationJobRequest> failedRequests) {
    ...
    public DescribeSimulationJobBatchResult withPendingRequests(SimulationJobRequest... pendingRequests) {
    ...
    public DescribeSimulationJobBatchResult withPendingRequests(java.util.Collection<SimulationJobRequest> pendingRequests) {
    ...
    public DescribeSimulationJobBatchResult withCreatedRequests(SimulationJobSummary... createdRequests) {
    ...
    public DescribeSimulationJobBatchResult withCreatedRequests(java.util.Collection<SimulationJobSummary> createdRequests) {
    ...
    public DescribeSimulationJobBatchResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeSimulationJobBatchResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DescribeSimulationJobBatchResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSimulationJobBatchResult == false)
            return false;
        DescribeSimulationJobBatchResult other = (DescribeSimulationJobBatchResult) obj;
