        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("jobPort", targetDepth)) {
                    context.nextToken();
                    portMapping.setJobPort(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("applicationPort", targetDepth)) {
                    context.nextToken();
                    portMapping.setApplicationPort(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("enableOnPublicIp", targetDepth)) {
                    context.nextToken();
                    portMapping.setEnableOnPublicIp(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
