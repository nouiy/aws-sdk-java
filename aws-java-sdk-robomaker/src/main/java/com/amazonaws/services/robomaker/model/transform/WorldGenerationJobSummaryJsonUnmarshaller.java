...
/**
 * WorldGenerationJobSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorldGenerationJobSummaryJsonUnmarshaller implements Unmarshaller<WorldGenerationJobSummary, JsonUnmarshallerContext> {

    public WorldGenerationJobSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        WorldGenerationJobSummary worldGenerationJobSummary = new WorldGenerationJobSummary();
    ...
    private static WorldGenerationJobSummaryJsonUnmarshaller instance;

    public static WorldGenerationJobSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorldGenerationJobSummaryJsonUnmarshaller();
        return instance;
    }
}
