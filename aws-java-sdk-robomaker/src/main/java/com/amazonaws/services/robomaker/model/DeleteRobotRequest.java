...
public class DeleteRobotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteRobotRequest withRobot(String robot) {
        setRobot(robot);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRobotRequest == false)
            return false;
        DeleteRobotRequest other = (DeleteRobotRequest) obj;
    ...
    @Override
    public DeleteRobotRequest clone() {
        return (DeleteRobotRequest) super.clone();
    }
