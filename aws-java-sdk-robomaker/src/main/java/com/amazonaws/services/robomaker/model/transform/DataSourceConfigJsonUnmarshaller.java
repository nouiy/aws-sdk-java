...
/**
 * DataSourceConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataSourceConfigJsonUnmarshaller implements Unmarshaller<DataSourceConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("s3Keys", targetDepth)) {
                    context.nextToken();
                    dataSourceConfig.setS3Keys(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
