        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Encrypted", targetDepth)) {
                    context.nextToken();
                    encryptionConfiguration.setEncrypted(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("CmkArn", targetDepth)) {
                    context.nextToken();
                    encryptionConfiguration.setCmkArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
