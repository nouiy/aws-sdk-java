...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.dlm.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.dlm.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.dlm.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.dlm.model.ResourceNotFoundException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ResourceIds", targetDepth)) {
                    context.nextToken();
                    resourceNotFoundException.setResourceIds(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
