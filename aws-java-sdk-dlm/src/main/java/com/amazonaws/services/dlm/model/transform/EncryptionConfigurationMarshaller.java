...
public class EncryptionConfigurationMarshaller {
    ...
    public void marshall(EncryptionConfiguration encryptionConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(encryptionConfiguration.getEncrypted(), ENCRYPTED_BINDING);
            protocolMarshaller.marshall(encryptionConfiguration.getCmkArn(), CMKARN_BINDING);
        } catch (Exception e) {
