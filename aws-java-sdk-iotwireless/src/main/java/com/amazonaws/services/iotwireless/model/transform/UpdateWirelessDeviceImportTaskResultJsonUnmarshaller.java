...
/**
 * UpdateWirelessDeviceImportTaskResult JSON Unmarshaller
 */
...
public class UpdateWirelessDeviceImportTaskResultJsonUnmarshaller implements Unmarshaller<UpdateWirelessDeviceImportTaskResult, JsonUnmarshallerContext> {
    ...
    public UpdateWirelessDeviceImportTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateWirelessDeviceImportTaskResult updateWirelessDeviceImportTaskResult = new UpdateWirelessDeviceImportTaskResult();

        return updateWirelessDeviceImportTaskResult;
    }
