 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/ConnectionStatusEventConfiguration"
...
public class ConnectionStatusEventConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setWirelessGatewayIdEventTopic(String wirelessGatewayIdEventTopic) {
    ...
    public ConnectionStatusEventConfiguration withWirelessGatewayIdEventTopic(String wirelessGatewayIdEventTopic) {
        setWirelessGatewayIdEventTopic(wirelessGatewayIdEventTopic);
        return this;
    }
    ...
    public ConnectionStatusEventConfiguration withWirelessGatewayIdEventTopic(EventNotificationTopicStatus wirelessGatewayIdEventTopic) {
        this.wirelessGatewayIdEventTopic = wirelessGatewayIdEventTopic.toString();
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionStatusEventConfiguration == false)
            return false;
        ...
        if (other.getLoRaWAN() != null && other.getLoRaWAN().equals(this.getLoRaWAN()) == false)
            return false;
        if (other.getWirelessGatewayIdEventTopic() == null ^ this.getWirelessGatewayIdEventTopic() == null)
            return false;
        if (other.getWirelessGatewayIdEventTopic() != null && other.getWirelessGatewayIdEventTopic().equals(this.getWirelessGatewayIdEventTopic()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getWirelessGatewayIdEventTopic() == null) ? 0 : getWirelessGatewayIdEventTopic().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotwireless.model.transform.ConnectionStatusEventConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
