...
/**
 * DeleteDeviceProfileResult JSON Unmarshaller
 */
...
public class DeleteDeviceProfileResultJsonUnmarshaller implements Unmarshaller<DeleteDeviceProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteDeviceProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDeviceProfileResult deleteDeviceProfileResult = new DeleteDeviceProfileResult();
