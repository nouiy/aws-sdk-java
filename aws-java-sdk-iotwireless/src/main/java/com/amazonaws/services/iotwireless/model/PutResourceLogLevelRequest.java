...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotwireless-2020-11-22/PutResourceLogLevel" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutResourceLogLevelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutResourceLogLevelRequest withLogLevel(String logLevel) {
    ...
    public PutResourceLogLevelRequest withLogLevel(LogLevel logLevel) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutResourceLogLevelRequest == false)
            return false;
    ...
    @Override
    public PutResourceLogLevelRequest clone() {
        return (PutResourceLogLevelRequest) super.clone();
    }
