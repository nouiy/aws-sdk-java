...
public class WirelessMetadataMarshaller {
    ...
    public void marshall(WirelessMetadata wirelessMetadata, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(wirelessMetadata.getLoRaWAN(), LORAWAN_BINDING);
            protocolMarshaller.marshall(wirelessMetadata.getSidewalk(), SIDEWALK_BINDING);
        } catch (Exception e) {
