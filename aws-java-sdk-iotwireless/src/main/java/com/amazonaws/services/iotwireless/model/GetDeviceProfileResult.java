...
public class GetDeviceProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDeviceProfileResult == false)
            return false;
        GetDeviceProfileResult other = (GetDeviceProfileResult) obj;
    ...
    public GetDeviceProfileResult clone() {
        try {
            return (GetDeviceProfileResult) super.clone();
