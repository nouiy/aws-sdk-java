...
public class DisassociateWirelessDeviceFromMulticastGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DisassociateWirelessDeviceFromMulticastGroupRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public DisassociateWirelessDeviceFromMulticastGroupRequest withWirelessDeviceId(String wirelessDeviceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateWirelessDeviceFromMulticastGroupRequest == false)
            return false;
        DisassociateWirelessDeviceFromMulticastGroupRequest other = (DisassociateWirelessDeviceFromMulticastGroupRequest) obj;
    ...
    @Override
    public DisassociateWirelessDeviceFromMulticastGroupRequest clone() {
        return (DisassociateWirelessDeviceFromMulticastGroupRequest) super.clone();
    }
