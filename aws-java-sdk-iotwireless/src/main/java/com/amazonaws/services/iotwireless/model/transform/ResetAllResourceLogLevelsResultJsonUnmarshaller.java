...
/**
 * ResetAllResourceLogLevelsResult JSON Unmarshaller
 */
...
public class ResetAllResourceLogLevelsResultJsonUnmarshaller implements Unmarshaller<ResetAllResourceLogLevelsResult, JsonUnmarshallerContext> {
    ...
    public ResetAllResourceLogLevelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResetAllResourceLogLevelsResult resetAllResourceLogLevelsResult = new ResetAllResourceLogLevelsResult();
