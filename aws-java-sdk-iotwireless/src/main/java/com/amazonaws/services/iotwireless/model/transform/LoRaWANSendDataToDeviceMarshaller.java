...
/**
 * LoRaWANSendDataToDeviceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LoRaWANSendDataToDeviceMarshaller {
    ...
    public static LoRaWANSendDataToDeviceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LoRaWANSendDataToDevice loRaWANSendDataToDevice, ProtocolMarshaller protocolMarshaller) {

        if (loRaWANSendDataToDevice == null) {
