...
/**
 * CancelMulticastGroupSessionResult JSON Unmarshaller
 */
...
public class CancelMulticastGroupSessionResultJsonUnmarshaller implements Unmarshaller<CancelMulticastGroupSessionResult, JsonUnmarshallerContext> {
    ...
    public CancelMulticastGroupSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelMulticastGroupSessionResult cancelMulticastGroupSessionResult = new CancelMulticastGroupSessionResult();
