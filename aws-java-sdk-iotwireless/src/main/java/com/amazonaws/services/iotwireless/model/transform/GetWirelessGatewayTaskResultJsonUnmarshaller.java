...
/**
 * GetWirelessGatewayTaskResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetWirelessGatewayTaskResultJsonUnmarshaller implements Unmarshaller<GetWirelessGatewayTaskResult, JsonUnmarshallerContext> {

    public GetWirelessGatewayTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetWirelessGatewayTaskResult getWirelessGatewayTaskResult = new GetWirelessGatewayTaskResult();
    ...
    private static GetWirelessGatewayTaskResultJsonUnmarshaller instance;

    public static GetWirelessGatewayTaskResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetWirelessGatewayTaskResultJsonUnmarshaller();
        return instance;
    }
}
