...
/**
 * DeregisterWirelessDeviceResult JSON Unmarshaller
 */
...
public class DeregisterWirelessDeviceResultJsonUnmarshaller implements Unmarshaller<DeregisterWirelessDeviceResult, JsonUnmarshallerContext> {
    ...
    public DeregisterWirelessDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterWirelessDeviceResult deregisterWirelessDeviceResult = new DeregisterWirelessDeviceResult();

        return deregisterWirelessDeviceResult;
    }
