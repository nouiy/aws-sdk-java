...
/**
 * GetWirelessGatewayResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetWirelessGatewayResultJsonUnmarshaller implements Unmarshaller<GetWirelessGatewayResult, JsonUnmarshallerContext> {

    public GetWirelessGatewayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetWirelessGatewayResult getWirelessGatewayResult = new GetWirelessGatewayResult();
    ...
    private static GetWirelessGatewayResultJsonUnmarshaller instance;

    public static GetWirelessGatewayResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetWirelessGatewayResultJsonUnmarshaller();
        return instance;
    }
}
