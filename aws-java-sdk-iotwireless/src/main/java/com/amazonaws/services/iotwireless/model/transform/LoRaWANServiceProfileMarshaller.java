...
/**
 * LoRaWANServiceProfileMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LoRaWANServiceProfileMarshaller {
    ...
    public static LoRaWANServiceProfileMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LoRaWANServiceProfile loRaWANServiceProfile, ProtocolMarshaller protocolMarshaller) {

        if (loRaWANServiceProfile == null) {
