...
/**
 * DeviceRegistrationStateEventConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeviceRegistrationStateEventConfigurationMarshaller {
    ...
    public static DeviceRegistrationStateEventConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeviceRegistrationStateEventConfiguration deviceRegistrationStateEventConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (deviceRegistrationStateEventConfiguration == null) {
