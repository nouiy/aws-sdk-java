...
public class GetLogLevelsByResourceTypesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetLogLevelsByResourceTypesResult withWirelessGatewayLogOptions(java.util.Collection<WirelessGatewayLogOption> wirelessGatewayLogOptions) {
    ...
    public GetLogLevelsByResourceTypesResult withWirelessDeviceLogOptions(java.util.Collection<WirelessDeviceLogOption> wirelessDeviceLogOptions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLogLevelsByResourceTypesResult == false)
            return false;
        GetLogLevelsByResourceTypesResult other = (GetLogLevelsByResourceTypesResult) obj;
