...
public class CreateDeviceProfileRequestMarshaller {
    ...
    public static CreateDeviceProfileRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateDeviceProfileRequest createDeviceProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDeviceProfileRequest.getName(), NAME_BINDING);
