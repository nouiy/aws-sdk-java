...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.personalizeruntime.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.personalizeruntime.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.personalizeruntime.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.personalizeruntime.model.ResourceNotFoundException(
                null);
