...
public class InvalidInputExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidInputExceptionUnmarshaller() {
        super(com.amazonaws.services.personalizeruntime.model.InvalidInputException.class, "InvalidInputException");
    }

    @Override
    public com.amazonaws.services.personalizeruntime.model.InvalidInputException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.personalizeruntime.model.InvalidInputException invalidInputException = new com.amazonaws.services.personalizeruntime.model.InvalidInputException(
                null);
