...
/**
 * RowLevelPermissionDataSetMarshaller
 */
...
public class RowLevelPermissionDataSetMarshaller {
    ...
    public static RowLevelPermissionDataSetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RowLevelPermissionDataSet rowLevelPermissionDataSet, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(rowLevelPermissionDataSet.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
