...
public class SearchDashboardsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The list of dashboards owned by the user specified in <code>Filters</code> in your request.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The list of dashboards owned by the user specified in <code>Filters</code> in your request.
     */
    ...
    public SearchDashboardsResult withDashboardSummaryList(java.util.Collection<DashboardSummary> dashboardSummaryList) {
    ...
    public SearchDashboardsResult clone() {
        try {
            return (SearchDashboardsResult) super.clone();
