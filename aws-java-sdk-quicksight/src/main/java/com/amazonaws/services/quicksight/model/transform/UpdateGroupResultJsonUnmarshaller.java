...
public class UpdateGroupResultJsonUnmarshaller implements Unmarshaller<UpdateGroupResult, JsonUnmarshallerContext> {
    ...
    public UpdateGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        updateGroupResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Group", targetDepth)) {
                    context.nextToken();
                    updateGroupResult.setGroup(GroupJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    updateGroupResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
