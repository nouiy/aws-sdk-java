...
/**
 * RegisteredUserDashboardEmbeddingConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RegisteredUserDashboardEmbeddingConfigurationMarshaller {
    ...
    public static RegisteredUserDashboardEmbeddingConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RegisteredUserDashboardEmbeddingConfiguration registeredUserDashboardEmbeddingConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (registeredUserDashboardEmbeddingConfiguration == null) {
