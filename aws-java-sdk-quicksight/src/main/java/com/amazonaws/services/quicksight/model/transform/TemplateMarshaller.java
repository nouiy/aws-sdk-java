...
public class TemplateMarshaller {
    ...
    public void marshall(Template template, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(template.getTemplateId(), TEMPLATEID_BINDING);
            protocolMarshaller.marshall(template.getLastUpdatedTime(), LASTUPDATEDTIME_BINDING);
            protocolMarshaller.marshall(template.getCreatedTime(), CREATEDTIME_BINDING);
        } catch (Exception e) {
