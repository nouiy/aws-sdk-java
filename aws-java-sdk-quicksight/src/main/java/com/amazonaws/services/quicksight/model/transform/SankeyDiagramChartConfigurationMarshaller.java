...
/**
 * SankeyDiagramChartConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SankeyDiagramChartConfigurationMarshaller {
    ...
    public static SankeyDiagramChartConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SankeyDiagramChartConfiguration sankeyDiagramChartConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (sankeyDiagramChartConfiguration == null) {
