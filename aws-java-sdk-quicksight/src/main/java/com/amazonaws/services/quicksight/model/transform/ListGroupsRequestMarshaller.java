...
public class ListGroupsRequestMarshaller {
    ...
    public void marshall(ListGroupsRequest listGroupsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listGroupsRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            ...
            protocolMarshaller.marshall(listGroupsRequest.getNamespace(), NAMESPACE_BINDING);
        } catch (Exception e) {
