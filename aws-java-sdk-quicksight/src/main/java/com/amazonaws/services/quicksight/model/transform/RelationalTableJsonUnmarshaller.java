...
/**
 * RelationalTable JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RelationalTableJsonUnmarshaller implements Unmarshaller<RelationalTable, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    relationalTable.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("InputColumns", targetDepth)) {
                    context.nextToken();
                    relationalTable.setInputColumns(new ListUnmarshaller<InputColumn>(InputColumnJsonUnmarshaller.getInstance())
