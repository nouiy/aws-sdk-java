...
/**
 * DescribeTemplateAliasResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeTemplateAliasResultJsonUnmarshaller implements Unmarshaller<DescribeTemplateAliasResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TemplateAlias", targetDepth)) {
                    context.nextToken();
                    describeTemplateAliasResult.setTemplateAlias(TemplateAliasJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeTemplateAliasResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
