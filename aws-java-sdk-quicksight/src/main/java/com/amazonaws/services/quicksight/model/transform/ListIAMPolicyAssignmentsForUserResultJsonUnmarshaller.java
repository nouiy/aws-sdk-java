...
/**
 * ListIAMPolicyAssignmentsForUserResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListIAMPolicyAssignmentsForUserResultJsonUnmarshaller implements Unmarshaller<ListIAMPolicyAssignmentsForUserResult, JsonUnmarshallerContext> {

    public ListIAMPolicyAssignmentsForUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    listIAMPolicyAssignmentsForUserResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listIAMPolicyAssignmentsForUserResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
