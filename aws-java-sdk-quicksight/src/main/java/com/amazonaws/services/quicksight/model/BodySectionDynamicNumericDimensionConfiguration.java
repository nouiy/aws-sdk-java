...
/**
 * <p>
 * Describes the <b>Numeric</b> dataset column and constraints for the dynamic values used to repeat the contents of a
 * section.
 * </p>
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/BodySectionDynamicNumericDimensionConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BodySectionDynamicNumericDimensionConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public BodySectionDynamicNumericDimensionConfiguration withSortByMetrics(ColumnSort... sortByMetrics) {
    ...
    public BodySectionDynamicNumericDimensionConfiguration withSortByMetrics(java.util.Collection<ColumnSort> sortByMetrics) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BodySectionDynamicNumericDimensionConfiguration == false)
            return false;
    ...
    public BodySectionDynamicNumericDimensionConfiguration clone() {
        try {
            return (BodySectionDynamicNumericDimensionConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.BodySectionDynamicNumericDimensionConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
