...
/**
 * SearchDashboardsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchDashboardsResultJsonUnmarshaller implements Unmarshaller<SearchDashboardsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    searchDashboardsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    searchDashboardsResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
