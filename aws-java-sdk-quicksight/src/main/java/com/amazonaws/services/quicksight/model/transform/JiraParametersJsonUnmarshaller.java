...
/**
 * JiraParameters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JiraParametersJsonUnmarshaller implements Unmarshaller<JiraParameters, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SiteBaseUrl", targetDepth)) {
                    context.nextToken();
                    jiraParameters.setSiteBaseUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
