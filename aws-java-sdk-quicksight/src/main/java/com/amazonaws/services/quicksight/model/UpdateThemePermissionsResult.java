...
public class UpdateThemePermissionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The resulting list of resource permissions for the theme.
     */
    ...
    public UpdateThemePermissionsResult withPermissions(ResourcePermission... permissions) {
    ...
    public UpdateThemePermissionsResult withPermissions(java.util.Collection<ResourcePermission> permissions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateThemePermissionsResult == false)
            return false;
        UpdateThemePermissionsResult other = (UpdateThemePermissionsResult) obj;
    ...
    public UpdateThemePermissionsResult clone() {
        try {
            return (UpdateThemePermissionsResult) super.clone();
