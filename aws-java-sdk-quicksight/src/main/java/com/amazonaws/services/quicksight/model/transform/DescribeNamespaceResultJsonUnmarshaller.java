...
public class DescribeNamespaceResultJsonUnmarshaller implements Unmarshaller<DescribeNamespaceResult, JsonUnmarshallerContext> {
    ...
    public DescribeNamespaceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        describeNamespaceResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Namespace", targetDepth)) {
                    context.nextToken();
                    describeNamespaceResult.setNamespace(NamespaceInfoV2JsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeNamespaceResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
