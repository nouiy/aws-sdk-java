...
public class DescribeDashboardResultJsonUnmarshaller implements Unmarshaller<DescribeDashboardResult, JsonUnmarshallerContext> {
    ...
    public DescribeDashboardResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        describeDashboardResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Dashboard", targetDepth)) {
                    context.nextToken();
                    describeDashboardResult.setDashboard(DashboardJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeDashboardResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
