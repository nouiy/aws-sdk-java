...
public class ThemeSummaryMarshaller {
    ...
    public void marshall(ThemeSummary themeSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(themeSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(themeSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(themeSummary.getThemeId(), THEMEID_BINDING);
            protocolMarshaller.marshall(themeSummary.getLatestVersionNumber(), LATESTVERSIONNUMBER_BINDING);
            protocolMarshaller.marshall(themeSummary.getCreatedTime(), CREATEDTIME_BINDING);
            protocolMarshaller.marshall(themeSummary.getLastUpdatedTime(), LASTUPDATEDTIME_BINDING);
        } catch (Exception e) {
