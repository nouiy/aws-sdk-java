...
/**
 * NumericEqualityFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NumericEqualityFilterMarshaller {
    ...
    public static NumericEqualityFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NumericEqualityFilter numericEqualityFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(numericEqualityFilter.getFilterId(), FILTERID_BINDING);
            protocolMarshaller.marshall(numericEqualityFilter.getColumn(), COLUMN_BINDING);
            protocolMarshaller.marshall(numericEqualityFilter.getValue(), VALUE_BINDING);
            protocolMarshaller.marshall(numericEqualityFilter.getSelectAllOptions(), SELECTALLOPTIONS_BINDING);
            protocolMarshaller.marshall(numericEqualityFilter.getMatchOperator(), MATCHOPERATOR_BINDING);
