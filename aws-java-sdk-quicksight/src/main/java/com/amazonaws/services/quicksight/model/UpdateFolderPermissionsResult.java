...
public class UpdateFolderPermissionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateFolderPermissionsResult withPermissions(ResourcePermission... permissions) {
    ...
    public UpdateFolderPermissionsResult withPermissions(java.util.Collection<ResourcePermission> permissions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateFolderPermissionsResult == false)
            return false;
        UpdateFolderPermissionsResult other = (UpdateFolderPermissionsResult) obj;
    ...
    public UpdateFolderPermissionsResult clone() {
        try {
            return (UpdateFolderPermissionsResult) super.clone();
