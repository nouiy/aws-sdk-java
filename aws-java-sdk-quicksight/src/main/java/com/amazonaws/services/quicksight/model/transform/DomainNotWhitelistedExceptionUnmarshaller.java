...
public class DomainNotWhitelistedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    domainNotWhitelistedException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static DomainNotWhitelistedExceptionUnmarshaller instance;

    public static DomainNotWhitelistedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainNotWhitelistedExceptionUnmarshaller();
        return instance;
    }
}
