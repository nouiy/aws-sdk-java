...
public class DescribeDataSetRequestMarshaller {
    ...
    public void marshall(DescribeDataSetRequest describeDataSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeDataSetRequest.getAwsAccountId(), AWSACCOUNTID_BINDING);
            protocolMarshaller.marshall(describeDataSetRequest.getDataSetId(), DATASETID_BINDING);
        } catch (Exception e) {
