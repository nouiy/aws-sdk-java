...
public class UpdateThemeAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateThemeAliasResult == false)
            return false;
        UpdateThemeAliasResult other = (UpdateThemeAliasResult) obj;
    ...
    public UpdateThemeAliasResult clone() {
        try {
            return (UpdateThemeAliasResult) super.clone();
