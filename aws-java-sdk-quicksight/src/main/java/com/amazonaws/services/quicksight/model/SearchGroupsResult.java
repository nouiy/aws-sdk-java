...
public class SearchGroupsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of groups in a specified namespace that match the filters you set in your
     *         <code>SearchGroups</code> request.
     */
    ...
    public SearchGroupsResult withGroupList(java.util.Collection<Group> groupList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchGroupsResult == false)
            return false;
        SearchGroupsResult other = (SearchGroupsResult) obj;
    ...
    public SearchGroupsResult clone() {
        try {
            return (SearchGroupsResult) super.clone();
