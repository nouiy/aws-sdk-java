        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    columnSchema.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("DataType", targetDepth)) {
                    context.nextToken();
                    columnSchema.setDataType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("GeographicRole", targetDepth)) {
                    context.nextToken();
                    columnSchema.setGeographicRole(context.getUnmarshaller(String.class).unmarshall(context));
                }
