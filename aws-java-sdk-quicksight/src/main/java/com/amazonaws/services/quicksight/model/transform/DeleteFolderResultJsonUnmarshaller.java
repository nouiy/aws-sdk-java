...
public class DeleteFolderResultJsonUnmarshaller implements Unmarshaller<DeleteFolderResult, JsonUnmarshallerContext> {
    ...
    public DeleteFolderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        deleteFolderResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Arn", targetDepth)) {
                    context.nextToken();
                    deleteFolderResult.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FolderId", targetDepth)) {
                    context.nextToken();
                    deleteFolderResult.setFolderId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    deleteFolderResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
