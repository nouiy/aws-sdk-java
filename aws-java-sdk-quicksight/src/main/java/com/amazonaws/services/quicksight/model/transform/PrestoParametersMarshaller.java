...
public class PrestoParametersMarshaller {
    ...
    public void marshall(PrestoParameters prestoParameters, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(prestoParameters.getHost(), HOST_BINDING);
            protocolMarshaller.marshall(prestoParameters.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(prestoParameters.getCatalog(), CATALOG_BINDING);
        } catch (Exception e) {
