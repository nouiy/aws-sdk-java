...
public class DescribeAccountSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * referred to as a QuickSight "account" even though it's technically not an account by itself. Instead, it's a
     * subscription to the Amazon QuickSight service for your Amazon Web Services account. The edition that you
     ...
     *        the Amazon QuickSight subscription. In the QuickSight console, the Amazon QuickSight subscription is
     *        sometimes referred to as a QuickSight "account" even though it's technically not an account by itself.
     *        Instead, it's a subscription to the Amazon QuickSight service for your Amazon Web Services account. The
     *        edition that you subscribe to applies to Amazon QuickSight in every Amazon Web Services Region where you
     *        use it.
     */
     ...
     *         email for the Amazon QuickSight subscription. In the QuickSight console, the Amazon QuickSight
     *         subscription is sometimes referred to as a QuickSight "account" even though it's technically not an
     *         account by itself. Instead, it's a subscription to the Amazon QuickSight service for your Amazon Web
