...
public class IdentityTypeNotSupportedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    identityTypeNotSupportedException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static IdentityTypeNotSupportedExceptionUnmarshaller instance;

    public static IdentityTypeNotSupportedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IdentityTypeNotSupportedExceptionUnmarshaller();
        return instance;
    }
}
