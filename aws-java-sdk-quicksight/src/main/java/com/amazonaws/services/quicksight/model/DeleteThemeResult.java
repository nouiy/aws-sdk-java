...
public class DeleteThemeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteThemeResult == false)
            return false;
        DeleteThemeResult other = (DeleteThemeResult) obj;
    ...
    public DeleteThemeResult clone() {
        try {
            return (DeleteThemeResult) super.clone();
