...
public class UnsupportedUserEditionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    unsupportedUserEditionException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static UnsupportedUserEditionExceptionUnmarshaller instance;

    public static UnsupportedUserEditionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedUserEditionExceptionUnmarshaller();
        return instance;
    }
}
