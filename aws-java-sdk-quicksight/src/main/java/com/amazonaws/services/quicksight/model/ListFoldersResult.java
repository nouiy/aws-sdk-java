...
public class ListFoldersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListFoldersResult withFolderSummaryList(FolderSummary... folderSummaryList) {
    ...
    public ListFoldersResult withFolderSummaryList(java.util.Collection<FolderSummary> folderSummaryList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFoldersResult == false)
            return false;
    ...
    public ListFoldersResult clone() {
        try {
            return (ListFoldersResult) super.clone();
