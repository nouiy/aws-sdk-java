...
/**
 * DescribeIngestionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeIngestionResultJsonUnmarshaller implements Unmarshaller<DescribeIngestionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Ingestion", targetDepth)) {
                    context.nextToken();
                    describeIngestionResult.setIngestion(IngestionJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeIngestionResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
