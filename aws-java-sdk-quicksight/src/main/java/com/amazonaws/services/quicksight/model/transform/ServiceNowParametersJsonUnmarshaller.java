...
/**
 * ServiceNowParameters JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServiceNowParametersJsonUnmarshaller implements Unmarshaller<ServiceNowParameters, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SiteBaseUrl", targetDepth)) {
                    context.nextToken();
                    serviceNowParameters.setSiteBaseUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
