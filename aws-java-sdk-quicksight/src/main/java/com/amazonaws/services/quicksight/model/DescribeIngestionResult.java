...
public class DescribeIngestionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getIngestion() != null)
            sb.append("Ingestion: ").append(getIngestion()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeIngestionResult == false)
            return false;
        DescribeIngestionResult other = (DescribeIngestionResult) obj;
    ...
    public DescribeIngestionResult clone() {
        try {
            return (DescribeIngestionResult) super.clone();
