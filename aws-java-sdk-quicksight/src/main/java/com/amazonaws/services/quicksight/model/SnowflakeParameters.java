 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/SnowflakeParameters" target="_top">AWS API
 *      Documentation</a>
 */
...
public class SnowflakeParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public SnowflakeParameters clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.SnowflakeParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
