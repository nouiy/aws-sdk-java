 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ThemeVersionSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ThemeVersionSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ThemeVersionSummary withCreatedTime(java.util.Date createdTime) {
    ...
    public ThemeVersionSummary withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public ThemeVersionSummary withStatus(ResourceStatus status) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ThemeVersionSummary == false)
            return false;
    ...
    @Override
    public ThemeVersionSummary clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ThemeVersionSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
