...
/**
 * PivotTableConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PivotTableConfigurationJsonUnmarshaller implements Unmarshaller<PivotTableConfiguration, JsonUnmarshallerContext> {

    public PivotTableConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        PivotTableConfiguration pivotTableConfiguration = new PivotTableConfiguration();
    ...
    private static PivotTableConfigurationJsonUnmarshaller instance;

    public static PivotTableConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PivotTableConfigurationJsonUnmarshaller();
        return instance;
    }
}
