...
public class DescribeTemplatePermissionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeTemplatePermissionsResult withPermissions(java.util.Collection<ResourcePermission> permissions) {
    ...
    public DescribeTemplatePermissionsResult clone() {
        try {
            return (DescribeTemplatePermissionsResult) super.clone();
