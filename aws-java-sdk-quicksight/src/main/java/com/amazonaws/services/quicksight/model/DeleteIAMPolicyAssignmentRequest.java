...
public class DeleteIAMPolicyAssignmentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID where you want to delete the IAM policy assignment.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteIAMPolicyAssignmentRequest == false)
            return false;
        DeleteIAMPolicyAssignmentRequest other = (DeleteIAMPolicyAssignmentRequest) obj;
    ...
    public DeleteIAMPolicyAssignmentRequest clone() {
        return (DeleteIAMPolicyAssignmentRequest) super.clone();
    }
