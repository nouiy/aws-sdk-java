...
/**
 * DescribeAnalysisResult JSON Unmarshaller
 */
...
public class DescribeAnalysisResultJsonUnmarshaller implements Unmarshaller<DescribeAnalysisResult, JsonUnmarshallerContext> {
    ...
    public DescribeAnalysisResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeAnalysisResult describeAnalysisResult = new DescribeAnalysisResult();

        describeAnalysisResult.setStatus(context.getHttpResponse().getStatusCode());
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Analysis", targetDepth)) {
                    context.nextToken();
                    describeAnalysisResult.setAnalysis(AnalysisJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    describeAnalysisResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
