...
public class ListCallAnalyticsJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * job first. If you do not include <code>Status</code>, all Call Analytics jobs are returned.
     * </p>
     */
    ...
    /**
     * <p>
     * If your <code>ListCallAnalyticsJobs</code> request returns more results than can be displayed,
     ...
     * 
     * @param status
     *        Returns only Call Analytics jobs with the specified status. Jobs are ordered by creation date, with the
     *        newest job first. If you do not include <code>Status</code>, all Call Analytics jobs are returned.
     ...
     * </p>
     * 
     * @return Returns only Call Analytics jobs with the specified status. Jobs are ordered by creation date, with the
     *         newest job first. If you do not include <code>Status</code>, all Call Analytics jobs are returned.
     * @see CallAnalyticsJobStatus
     */
     ...
     * </p>
     * 
     * @return Returns only the Call Analytics jobs that contain the specified string. The search is not case sensitive.
     */
     ...
     * </p>
     * 
     * @return If your <code>ListCallAnalyticsJobs</code> request returns more results than can be displayed,
     *         <code>NextToken</code> is displayed in the response with an associated string. To get the next page of
     *         results, copy this string and repeat your request, including <code>NextToken</code> with the value of the
     *         copied string. Repeat as needed to view all your results.
     */
