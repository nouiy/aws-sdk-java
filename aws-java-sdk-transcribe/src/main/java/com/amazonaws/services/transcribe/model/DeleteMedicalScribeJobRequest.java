...
public class DeleteMedicalScribeJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the Medical Scribe job you want to delete. Job names are case sensitive.
     */
    ...
    @Override
    public DeleteMedicalScribeJobRequest clone() {
        return (DeleteMedicalScribeJobRequest) super.clone();
    }
