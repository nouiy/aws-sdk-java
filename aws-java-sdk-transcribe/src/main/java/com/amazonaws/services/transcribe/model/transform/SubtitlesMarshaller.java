...
@SdkInternalApi
public class SubtitlesMarshaller {
    ...
    public static SubtitlesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Subtitles subtitles, ProtocolMarshaller protocolMarshaller) {
