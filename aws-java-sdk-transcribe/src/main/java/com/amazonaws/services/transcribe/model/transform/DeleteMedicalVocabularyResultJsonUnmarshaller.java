...
/**
 * DeleteMedicalVocabularyResult JSON Unmarshaller
 */
...
public class DeleteMedicalVocabularyResultJsonUnmarshaller implements Unmarshaller<DeleteMedicalVocabularyResult, JsonUnmarshallerContext> {
    ...
    public DeleteMedicalVocabularyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMedicalVocabularyResult deleteMedicalVocabularyResult = new DeleteMedicalVocabularyResult();
