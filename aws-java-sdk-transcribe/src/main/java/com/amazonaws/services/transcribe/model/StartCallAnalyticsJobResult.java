...
public class StartCallAnalyticsJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartCallAnalyticsJobResult clone() {
        try {
            return (StartCallAnalyticsJobResult) super.clone();
