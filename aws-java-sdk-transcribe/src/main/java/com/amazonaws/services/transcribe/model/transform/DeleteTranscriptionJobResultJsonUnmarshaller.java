...
/**
 * DeleteTranscriptionJobResult JSON Unmarshaller
 */
...
public class DeleteTranscriptionJobResultJsonUnmarshaller implements Unmarshaller<DeleteTranscriptionJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteTranscriptionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTranscriptionJobResult deleteTranscriptionJobResult = new DeleteTranscriptionJobResult();
