...
public class DeleteTranscriptionJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteTranscriptionJobRequest clone() {
        return (DeleteTranscriptionJobRequest) super.clone();
    }
