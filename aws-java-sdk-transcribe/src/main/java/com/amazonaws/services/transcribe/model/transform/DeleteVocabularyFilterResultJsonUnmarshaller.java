...
/**
 * DeleteVocabularyFilterResult JSON Unmarshaller
 */
...
public class DeleteVocabularyFilterResultJsonUnmarshaller implements Unmarshaller<DeleteVocabularyFilterResult, JsonUnmarshallerContext> {
    ...
    public DeleteVocabularyFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVocabularyFilterResult deleteVocabularyFilterResult = new DeleteVocabularyFilterResult();
