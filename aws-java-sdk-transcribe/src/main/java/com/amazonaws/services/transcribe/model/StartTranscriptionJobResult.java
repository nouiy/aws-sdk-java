...
public class StartTranscriptionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public StartTranscriptionJobResult clone() {
        try {
            return (StartTranscriptionJobResult) super.clone();
