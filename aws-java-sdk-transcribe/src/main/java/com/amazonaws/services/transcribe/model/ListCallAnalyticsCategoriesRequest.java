...
public class ListCallAnalyticsCategoriesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The maximum number of categories to return in the response. If there are fewer results in the list, the response
     ...
     * 
     * @param maxResults
     *        The maximum number of categories to return in the response. If there are fewer results in the list, the
     ...
     * </p>
     * 
     * @return The maximum number of categories to return in the response. If there are fewer results in the list, the
     *         response contains only the actual results.
     */
    ...
    public ListCallAnalyticsCategoriesRequest clone() {
        return (ListCallAnalyticsCategoriesRequest) super.clone();
    }
