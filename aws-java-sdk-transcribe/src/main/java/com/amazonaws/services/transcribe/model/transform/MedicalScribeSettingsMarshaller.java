...
/**
 * MedicalScribeSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MedicalScribeSettingsMarshaller {
    ...
    private static final MedicalScribeSettingsMarshaller instance = new MedicalScribeSettingsMarshaller();

    public static MedicalScribeSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MedicalScribeSettings medicalScribeSettings, ProtocolMarshaller protocolMarshaller) {

        if (medicalScribeSettings == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(medicalScribeSettings.getShowSpeakerLabels(), SHOWSPEAKERLABELS_BINDING);
            protocolMarshaller.marshall(medicalScribeSettings.getMaxSpeakerLabels(), MAXSPEAKERLABELS_BINDING);
            protocolMarshaller.marshall(medicalScribeSettings.getChannelIdentification(), CHANNELIDENTIFICATION_BINDING);
            protocolMarshaller.marshall(medicalScribeSettings.getVocabularyName(), VOCABULARYNAME_BINDING);
            protocolMarshaller.marshall(medicalScribeSettings.getVocabularyFilterName(), VOCABULARYFILTERNAME_BINDING);
            protocolMarshaller.marshall(medicalScribeSettings.getVocabularyFilterMethod(), VOCABULARYFILTERMETHOD_BINDING);
        } catch (Exception e) {
