...
/**
 * LanguageIdSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LanguageIdSettingsMarshaller {
    ...
    private static final LanguageIdSettingsMarshaller instance = new LanguageIdSettingsMarshaller();

    public static LanguageIdSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LanguageIdSettings languageIdSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(languageIdSettings.getVocabularyName(), VOCABULARYNAME_BINDING);
            protocolMarshaller.marshall(languageIdSettings.getVocabularyFilterName(), VOCABULARYFILTERNAME_BINDING);
            protocolMarshaller.marshall(languageIdSettings.getLanguageModelName(), LANGUAGEMODELNAME_BINDING);
        } catch (Exception e) {
