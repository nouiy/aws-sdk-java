...
/**
 * DeleteDataIntegrationResult JSON Unmarshaller
 */
...
public class DeleteDataIntegrationResultJsonUnmarshaller implements Unmarshaller<DeleteDataIntegrationResult, JsonUnmarshallerContext> {
    ...
    public DeleteDataIntegrationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDataIntegrationResult deleteDataIntegrationResult = new DeleteDataIntegrationResult();
