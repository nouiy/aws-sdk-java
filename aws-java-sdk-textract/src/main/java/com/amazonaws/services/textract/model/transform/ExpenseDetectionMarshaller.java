...
/**
 * ExpenseDetectionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ExpenseDetectionMarshaller {
    ...
    private static final ExpenseDetectionMarshaller instance = new ExpenseDetectionMarshaller();

    public static ExpenseDetectionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExpenseDetection expenseDetection, ProtocolMarshaller protocolMarshaller) {

        if (expenseDetection == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(expenseDetection.getText(), TEXT_BINDING);
            protocolMarshaller.marshall(expenseDetection.getGeometry(), GEOMETRY_BINDING);
            protocolMarshaller.marshall(expenseDetection.getConfidence(), CONFIDENCE_BINDING);
        } catch (Exception e) {
