...
/**
 * <p>
 * Sets up the human review workflow the document will be sent to if one of the conditions is met. You can also set
 * certain attributes of the image before review.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/HumanLoopConfig" target="_top">AWS API
 *      Documentation</a>
 */
...
public class HumanLoopConfig implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The name of the human workflow used for this image. This should be kept unique within a region.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.textract.model.transform.HumanLoopConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
