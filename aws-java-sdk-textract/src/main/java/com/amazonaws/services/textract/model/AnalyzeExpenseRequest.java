...
public class AnalyzeExpenseRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public AnalyzeExpenseRequest clone() {
        return (AnalyzeExpenseRequest) super.clone();
    }
