...
public class ExpenseFieldMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> LABELDETECTION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("LabelDetection").build();
    ...
    public void marshall(ExpenseField expenseField, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(expenseField.getType(), TYPE_BINDING);
