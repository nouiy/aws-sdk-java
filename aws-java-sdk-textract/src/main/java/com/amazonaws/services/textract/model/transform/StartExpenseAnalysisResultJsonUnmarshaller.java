...
/**
 * StartExpenseAnalysisResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartExpenseAnalysisResultJsonUnmarshaller implements Unmarshaller<StartExpenseAnalysisResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startExpenseAnalysisResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
