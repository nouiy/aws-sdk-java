...
public class DocumentTooLargeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DocumentTooLargeExceptionUnmarshaller instance;

    public static DocumentTooLargeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DocumentTooLargeExceptionUnmarshaller();
        return instance;
    }
}
