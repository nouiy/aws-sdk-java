...
public class InvalidJobIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidJobIdExceptionUnmarshaller instance;

    public static InvalidJobIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidJobIdExceptionUnmarshaller();
        return instance;
    }
}
