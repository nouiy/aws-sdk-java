...
public class UnsupportedDocumentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedDocumentExceptionUnmarshaller instance;

    public static UnsupportedDocumentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedDocumentExceptionUnmarshaller();
        return instance;
    }
}
