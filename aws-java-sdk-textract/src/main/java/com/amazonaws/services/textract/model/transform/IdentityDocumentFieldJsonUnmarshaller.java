...
/**
 * IdentityDocumentField JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IdentityDocumentFieldJsonUnmarshaller implements Unmarshaller<IdentityDocumentField, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    identityDocumentField.setType(AnalyzeIDDetectionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ValueDetection", targetDepth)) {
                    context.nextToken();
                    identityDocumentField.setValueDetection(AnalyzeIDDetectionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
