...
/**
 * <p>
 * The X and Y coordinates of a point on a document page. The X and Y values that are returned are ratios of the overall
 * document page size. For example, if the input document is 700 x 200 and the operation returns X=0.5 and Y=0.25, then
 ...
 * <code>Polygon</code> represents a fine-grained polygon around detected text. For more information, see Geometry in
 * the Amazon Textract Developer Guide.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/Point" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Point implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.textract.model.transform.PointMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
