...
/**
 * CloudFormationActionMarshaller
 */
...
public class CloudFormationActionMarshaller {
    ...
    public void marshall(CloudFormationAction cloudFormationAction, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(cloudFormationAction.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(cloudFormationAction.getActionType(), ACTIONTYPE_BINDING);
        } catch (Exception e) {
