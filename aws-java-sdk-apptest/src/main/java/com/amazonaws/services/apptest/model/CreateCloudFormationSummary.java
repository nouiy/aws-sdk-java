 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/CreateCloudFormationSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateCloudFormationSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateCloudFormationStepInput getStepInput() {
    ...
    public void setStepOutput(CreateCloudFormationStepOutput stepOutput) {
    ...
    public CreateCloudFormationStepOutput getStepOutput() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCloudFormationSummary == false)
            return false;
    ...
    @Override
    public CreateCloudFormationSummary clone() {
        try {
            return (CreateCloudFormationSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apptest.model.transform.CreateCloudFormationSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
