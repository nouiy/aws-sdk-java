        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ccsid", targetDepth)) {
                    context.nextToken();
                    dataSet.setCcsid(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("format", targetDepth)) {
                    context.nextToken();
                    dataSet.setFormat(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("length", targetDepth)) {
                    context.nextToken();
                    dataSet.setLength(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
