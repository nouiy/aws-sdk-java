...
/**
 * DeleteTestRunResult JSON Unmarshaller
 */
...
public class DeleteTestRunResultJsonUnmarshaller implements Unmarshaller<DeleteTestRunResult, JsonUnmarshallerContext> {
    ...
    public DeleteTestRunResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTestRunResult deleteTestRunResult = new DeleteTestRunResult();

        return deleteTestRunResult;
    }
