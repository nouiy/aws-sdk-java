...
public class GetTestCaseRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetTestCaseRequest withTestCaseId(String testCaseId) {
    ...
    public GetTestCaseRequest withTestCaseVersion(Integer testCaseVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTestCaseRequest == false)
            return false;
    ...
    public GetTestCaseRequest clone() {
        return (GetTestCaseRequest) super.clone();
    }
