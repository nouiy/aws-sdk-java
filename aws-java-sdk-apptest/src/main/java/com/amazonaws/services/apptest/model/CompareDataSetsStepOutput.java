 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/CompareDataSetsStepOutput" target="_top">AWS
 *      API Documentation</a>
 */
...
public class CompareDataSetsStepOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public CompareDataSetsStepOutput withComparisonOutputLocation(String comparisonOutputLocation) {
    ...
    public CompareDataSetsStepOutput withComparisonStatus(String comparisonStatus) {
    ...
    public CompareDataSetsStepOutput withComparisonStatus(ComparisonStatusEnum comparisonStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CompareDataSetsStepOutput == false)
            return false;
    ...
    @Override
    public CompareDataSetsStepOutput clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apptest.model.transform.CompareDataSetsStepOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
