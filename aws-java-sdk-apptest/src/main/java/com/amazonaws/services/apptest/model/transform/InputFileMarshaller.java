...
public class InputFileMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> FILEMETADATA_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("fileMetadata").build();
    ...
    public void marshall(InputFile inputFile, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputFile.getSourceLocation(), SOURCELOCATION_BINDING);
            protocolMarshaller.marshall(inputFile.getTargetLocation(), TARGETLOCATION_BINDING);
            protocolMarshaller.marshall(inputFile.getFileMetadata(), FILEMETADATA_BINDING);
        } catch (Exception e) {
