...
/**
 * DeleteTestConfigurationResult JSON Unmarshaller
 */
...
public class DeleteTestConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteTestConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteTestConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTestConfigurationResult deleteTestConfigurationResult = new DeleteTestConfigurationResult();

        return deleteTestConfigurationResult;
    }
