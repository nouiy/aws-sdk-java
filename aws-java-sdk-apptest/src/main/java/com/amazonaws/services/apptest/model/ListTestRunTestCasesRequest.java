...
public class ListTestRunTestCasesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The test run ID of the test cases.
     */
     ...
     * </p>
     * 
     * @return The maximum number of test run test cases to return in one page of results.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTestRunTestCasesRequest == false)
            return false;
        ListTestRunTestCasesRequest other = (ListTestRunTestCasesRequest) obj;
    ...
    public ListTestRunTestCasesRequest clone() {
        return (ListTestRunTestCasesRequest) super.clone();
    }
