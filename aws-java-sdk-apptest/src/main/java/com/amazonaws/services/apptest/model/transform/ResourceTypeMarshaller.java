...
public class ResourceTypeMarshaller {
    ...
    public void marshall(ResourceType resourceType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceType.getCloudFormation(), CLOUDFORMATION_BINDING);
            protocolMarshaller.marshall(resourceType.getM2ManagedApplication(), M2MANAGEDAPPLICATION_BINDING);
            protocolMarshaller.marshall(resourceType.getM2NonManagedApplication(), M2NONMANAGEDAPPLICATION_BINDING);
        } catch (Exception e) {
