...
public class UpdateTestCaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateTestCaseResult withTestCaseId(String testCaseId) {
    ...
    public UpdateTestCaseResult withTestCaseVersion(Integer testCaseVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTestCaseResult == false)
            return false;
        UpdateTestCaseResult other = (UpdateTestCaseResult) obj;
    ...
    @Override
    public UpdateTestCaseResult clone() {
        try {
