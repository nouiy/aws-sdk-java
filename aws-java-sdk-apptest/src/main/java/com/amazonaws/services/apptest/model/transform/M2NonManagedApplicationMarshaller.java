...
/**
 * M2NonManagedApplicationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class M2NonManagedApplicationMarshaller {
    ...
    private static final M2NonManagedApplicationMarshaller instance = new M2NonManagedApplicationMarshaller();

    public static M2NonManagedApplicationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(M2NonManagedApplication m2NonManagedApplication, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(m2NonManagedApplication.getVpcEndpointServiceName(), VPCENDPOINTSERVICENAME_BINDING);
            protocolMarshaller.marshall(m2NonManagedApplication.getListenerPort(), LISTENERPORT_BINDING);
            protocolMarshaller.marshall(m2NonManagedApplication.getRuntime(), RUNTIME_BINDING);
            protocolMarshaller.marshall(m2NonManagedApplication.getWebAppName(), WEBAPPNAME_BINDING);
        } catch (Exception e) {
