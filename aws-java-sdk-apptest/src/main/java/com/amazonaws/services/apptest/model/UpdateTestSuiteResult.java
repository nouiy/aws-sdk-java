...
public class UpdateTestSuiteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateTestSuiteResult withTestSuiteId(String testSuiteId) {
     ...
     * </p>
     * 
     * @return The test suite version of the test suite.
     */
    ...
    public UpdateTestSuiteResult withTestSuiteVersion(Integer testSuiteVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTestSuiteResult == false)
            return false;
        UpdateTestSuiteResult other = (UpdateTestSuiteResult) obj;
    ...
    @Override
    public UpdateTestSuiteResult clone() {
        try {
            return (UpdateTestSuiteResult) super.clone();
