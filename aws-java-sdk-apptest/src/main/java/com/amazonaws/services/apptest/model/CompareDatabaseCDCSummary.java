 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/apptest-2022-12-06/CompareDatabaseCDCSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CompareDatabaseCDCSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public CompareDatabaseCDCStepInput getStepInput() {
    ...
    public void setStepOutput(CompareDatabaseCDCStepOutput stepOutput) {
    ...
    public CompareDatabaseCDCStepOutput getStepOutput() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CompareDatabaseCDCSummary == false)
            return false;
    ...
    public CompareDatabaseCDCSummary clone() {
        try {
            return (CompareDatabaseCDCSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apptest.model.transform.CompareDatabaseCDCSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
