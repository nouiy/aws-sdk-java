...
/**
 * ListPlaybackRestrictionPoliciesRequestMarshaller
 */
...
public class ListPlaybackRestrictionPoliciesRequestMarshaller {
    ...
    public static ListPlaybackRestrictionPoliciesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPlaybackRestrictionPoliciesRequest listPlaybackRestrictionPoliciesRequest, ProtocolMarshaller protocolMarshaller) {

        if (listPlaybackRestrictionPoliciesRequest == null) {
