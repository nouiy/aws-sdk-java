...
public class ImportPlaybackKeyPairRequestMarshaller {
    ...
    private static final ImportPlaybackKeyPairRequestMarshaller instance = new ImportPlaybackKeyPairRequestMarshaller();

    public static ImportPlaybackKeyPairRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportPlaybackKeyPairRequest importPlaybackKeyPairRequest, ProtocolMarshaller protocolMarshaller) {
