...
/**
 * StreamKey JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StreamKeyJsonUnmarshaller implements Unmarshaller<StreamKey, JsonUnmarshallerContext> {

    public StreamKey unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static StreamKeyJsonUnmarshaller instance;

    public static StreamKeyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StreamKeyJsonUnmarshaller();
        return instance;
    }
}
