 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-2020-07-14/PlaybackRestrictionPolicySummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PlaybackRestrictionPolicySummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public PlaybackRestrictionPolicySummary withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public PlaybackRestrictionPolicySummary withAllowedCountries(String... allowedCountries) {
    ...
    public PlaybackRestrictionPolicySummary withAllowedCountries(java.util.Collection<String> allowedCountries) {
    ...
    public PlaybackRestrictionPolicySummary withAllowedOrigins(String... allowedOrigins) {
    ...
    public PlaybackRestrictionPolicySummary withAllowedOrigins(java.util.Collection<String> allowedOrigins) {
    ...
    public PlaybackRestrictionPolicySummary withEnableStrictOriginEnforcement(Boolean enableStrictOriginEnforcement) {
    ...
    public PlaybackRestrictionPolicySummary withName(String name) {
        setName(name);
        return this;
    }
    ...
    public PlaybackRestrictionPolicySummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see PlaybackRestrictionPolicySummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PlaybackRestrictionPolicySummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public PlaybackRestrictionPolicySummary clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PlaybackRestrictionPolicySummary == false)
            return false;
    ...
    @Override
    public PlaybackRestrictionPolicySummary clone() {
        try {
            return (PlaybackRestrictionPolicySummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ivs.model.transform.PlaybackRestrictionPolicySummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
