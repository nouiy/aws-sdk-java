...
public class BatchGetStreamKeyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchGetStreamKeyRequest withArns(String... arns) {
        if (this.arns == null) {
    ...
    public BatchGetStreamKeyRequest withArns(java.util.Collection<String> arns) {
        setArns(arns);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetStreamKeyRequest == false)
            return false;
        BatchGetStreamKeyRequest other = (BatchGetStreamKeyRequest) obj;
    ...
    @Override
    public BatchGetStreamKeyRequest clone() {
        return (BatchGetStreamKeyRequest) super.clone();
    }
