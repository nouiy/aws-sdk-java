...
/**
 * DeleteStreamKeyResult JSON Unmarshaller
 */
...
public class DeleteStreamKeyResultJsonUnmarshaller implements Unmarshaller<DeleteStreamKeyResult, JsonUnmarshallerContext> {
    ...
    public DeleteStreamKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteStreamKeyResult deleteStreamKeyResult = new DeleteStreamKeyResult();
