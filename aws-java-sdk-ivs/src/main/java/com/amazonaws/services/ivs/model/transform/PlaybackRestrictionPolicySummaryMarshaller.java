...
/**
 * PlaybackRestrictionPolicySummaryMarshaller
 */
...
public class PlaybackRestrictionPolicySummaryMarshaller {
    ...
    private static final PlaybackRestrictionPolicySummaryMarshaller instance = new PlaybackRestrictionPolicySummaryMarshaller();

    public static PlaybackRestrictionPolicySummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PlaybackRestrictionPolicySummary playbackRestrictionPolicySummary, ProtocolMarshaller protocolMarshaller) {

        if (playbackRestrictionPolicySummary == null) {
