...
/**
 * StreamSessionSummaryMarshaller
 */
...
public class StreamSessionSummaryMarshaller {
    ...
    public static StreamSessionSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StreamSessionSummary streamSessionSummary, ProtocolMarshaller protocolMarshaller) {

        if (streamSessionSummary == null) {
