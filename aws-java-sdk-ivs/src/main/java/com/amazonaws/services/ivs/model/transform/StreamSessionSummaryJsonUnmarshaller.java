...
/**
 * StreamSessionSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StreamSessionSummaryJsonUnmarshaller implements Unmarshaller<StreamSessionSummary, JsonUnmarshallerContext> {

    public StreamSessionSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        StreamSessionSummary streamSessionSummary = new StreamSessionSummary();
    ...
    private static StreamSessionSummaryJsonUnmarshaller instance;

    public static StreamSessionSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StreamSessionSummaryJsonUnmarshaller();
        return instance;
    }
}
