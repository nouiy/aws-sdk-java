...
public class CreateStreamKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateStreamKeyResult == false)
            return false;
        CreateStreamKeyResult other = (CreateStreamKeyResult) obj;
    ...
    public CreateStreamKeyResult clone() {
        try {
            return (CreateStreamKeyResult) super.clone();
