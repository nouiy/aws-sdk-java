...
@SdkInternalApi
public class ListStreamSessionsRequestMarshaller {
    ...
    public static ListStreamSessionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListStreamSessionsRequest listStreamSessionsRequest, ProtocolMarshaller protocolMarshaller) {
