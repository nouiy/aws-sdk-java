...
public class ImportPlaybackKeyPairRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ImportPlaybackKeyPairRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ImportPlaybackKeyPairRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ImportPlaybackKeyPairRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public ImportPlaybackKeyPairRequest clone() {
        return (ImportPlaybackKeyPairRequest) super.clone();
    }
