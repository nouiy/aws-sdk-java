...
/**
 * PutMetadataResult JSON Unmarshaller
 */
...
public class PutMetadataResultJsonUnmarshaller implements Unmarshaller<PutMetadataResult, JsonUnmarshallerContext> {
    ...
    public PutMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutMetadataResult putMetadataResult = new PutMetadataResult();
