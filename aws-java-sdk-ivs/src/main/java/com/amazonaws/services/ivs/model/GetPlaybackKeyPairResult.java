...
public class GetPlaybackKeyPairResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetPlaybackKeyPairResult withKeyPair(PlaybackKeyPair keyPair) {
        setKeyPair(keyPair);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPlaybackKeyPairResult == false)
            return false;
        GetPlaybackKeyPairResult other = (GetPlaybackKeyPairResult) obj;
    ...
    @Override
    public GetPlaybackKeyPairResult clone() {
        try {
            return (GetPlaybackKeyPairResult) super.clone();
