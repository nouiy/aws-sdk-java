        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("channel", targetDepth)) {
                    context.nextToken();
                    createChannelResult.setChannel(ChannelJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("streamKey", targetDepth)) {
                    context.nextToken();
                    createChannelResult.setStreamKey(StreamKeyJsonUnmarshaller.getInstance().unmarshall(context));
                }
