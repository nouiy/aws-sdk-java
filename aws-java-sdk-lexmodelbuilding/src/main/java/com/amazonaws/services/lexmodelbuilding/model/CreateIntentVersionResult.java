...
public class CreateIntentVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateIntentVersionResult withSlots(Slot... slots) {
        if (this.slots == null) {
    ...
    public CreateIntentVersionResult withSlots(java.util.Collection<Slot> slots) {
        setSlots(slots);
        return this;
    }
    ...
    public CreateIntentVersionResult withSampleUtterances(String... sampleUtterances) {
    ...
    public CreateIntentVersionResult withSampleUtterances(java.util.Collection<String> sampleUtterances) {
    ...
    public CreateIntentVersionResult withRejectionStatement(Statement rejectionStatement) {
    ...
    public CreateIntentVersionResult withConclusionStatement(Statement conclusionStatement) {
    ...
    public CreateIntentVersionResult withLastUpdatedDate(java.util.Date lastUpdatedDate) {
    ...
    public CreateIntentVersionResult withCreatedDate(java.util.Date createdDate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIntentVersionResult == false)
            return false;
        CreateIntentVersionResult other = (CreateIntentVersionResult) obj;
    ...
    public CreateIntentVersionResult clone() {
        try {
            return (CreateIntentVersionResult) super.clone();
