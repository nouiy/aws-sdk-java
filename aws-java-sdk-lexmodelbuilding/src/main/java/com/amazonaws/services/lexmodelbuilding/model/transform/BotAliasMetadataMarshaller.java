...
public class BotAliasMetadataMarshaller {
    ...
    public void marshall(BotAliasMetadata botAliasMetadata, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(botAliasMetadata.getName(), NAME_BINDING);
            protocolMarshaller.marshall(botAliasMetadata.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(botAliasMetadata.getBotVersion(), BOTVERSION_BINDING);
            protocolMarshaller.marshall(botAliasMetadata.getBotName(), BOTNAME_BINDING);
