...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.lexmodelbuilding.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.lexmodelbuilding.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lexmodelbuilding.model.LimitExceededException limitExceededException = new com.amazonaws.services.lexmodelbuilding.model.LimitExceededException(
                null);
