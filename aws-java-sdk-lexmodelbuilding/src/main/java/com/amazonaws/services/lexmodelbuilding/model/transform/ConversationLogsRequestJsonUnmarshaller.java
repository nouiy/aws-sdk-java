...
/**
 * ConversationLogsRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConversationLogsRequestJsonUnmarshaller implements Unmarshaller<ConversationLogsRequest, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("logSettings", targetDepth)) {
                    context.nextToken();
                    conversationLogsRequest.setLogSettings(new ListUnmarshaller<LogSettingsRequest>(LogSettingsRequestJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("iamRoleArn", targetDepth)) {
                    context.nextToken();
                    conversationLogsRequest.setIamRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
