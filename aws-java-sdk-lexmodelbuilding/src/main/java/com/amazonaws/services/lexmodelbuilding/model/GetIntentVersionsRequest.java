...
public class GetIntentVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetIntentVersionsRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetIntentVersionsRequest withNextToken(String nextToken) {
    ...
    public GetIntentVersionsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIntentVersionsRequest == false)
            return false;
        GetIntentVersionsRequest other = (GetIntentVersionsRequest) obj;
    ...
    @Override
    public GetIntentVersionsRequest clone() {
        return (GetIntentVersionsRequest) super.clone();
    }
