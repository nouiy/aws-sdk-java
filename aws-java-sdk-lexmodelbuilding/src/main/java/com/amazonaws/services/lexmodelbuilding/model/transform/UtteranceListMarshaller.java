...
public class UtteranceListMarshaller {
    ...
    private static final MarshallingInfo<List> UTTERANCES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("utterances").build();
    ...
    public void marshall(UtteranceList utteranceList, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(utteranceList.getBotVersion(), BOTVERSION_BINDING);
            protocolMarshaller.marshall(utteranceList.getUtterances(), UTTERANCES_BINDING);
        } catch (Exception e) {
