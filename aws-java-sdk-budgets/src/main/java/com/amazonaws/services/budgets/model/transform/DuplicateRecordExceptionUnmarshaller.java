...
public class DuplicateRecordExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicateRecordExceptionUnmarshaller instance;

    public static DuplicateRecordExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateRecordExceptionUnmarshaller();
        return instance;
    }
}
