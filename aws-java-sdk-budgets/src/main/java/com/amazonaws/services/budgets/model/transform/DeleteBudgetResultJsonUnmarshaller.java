...
/**
 * DeleteBudgetResult JSON Unmarshaller
 */
...
public class DeleteBudgetResultJsonUnmarshaller implements Unmarshaller<DeleteBudgetResult, JsonUnmarshallerContext> {
    ...
    public DeleteBudgetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBudgetResult deleteBudgetResult = new DeleteBudgetResult();
