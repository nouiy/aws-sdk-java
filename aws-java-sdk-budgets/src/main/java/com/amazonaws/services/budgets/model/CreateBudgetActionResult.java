...
public class CreateBudgetActionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBudgetActionResult == false)
            return false;
        CreateBudgetActionResult other = (CreateBudgetActionResult) obj;
    ...
    public CreateBudgetActionResult clone() {
        try {
            return (CreateBudgetActionResult) super.clone();
