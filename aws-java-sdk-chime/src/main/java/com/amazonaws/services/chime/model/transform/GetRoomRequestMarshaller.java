...
public class GetRoomRequestMarshaller {
    ...
    private static final GetRoomRequestMarshaller instance = new GetRoomRequestMarshaller();

    public static GetRoomRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetRoomRequest getRoomRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRoomRequest.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(getRoomRequest.getRoomId(), ROOMID_BINDING);
        } catch (Exception e) {
