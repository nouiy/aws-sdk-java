...
public class DisassociatePhoneNumbersFromVoiceConnectorGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public DisassociatePhoneNumbersFromVoiceConnectorGroupResult withPhoneNumberErrors(PhoneNumberError... phoneNumberErrors) {
    ...
    public DisassociatePhoneNumbersFromVoiceConnectorGroupResult withPhoneNumberErrors(java.util.Collection<PhoneNumberError> phoneNumberErrors) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociatePhoneNumbersFromVoiceConnectorGroupResult == false)
            return false;
        DisassociatePhoneNumbersFromVoiceConnectorGroupResult other = (DisassociatePhoneNumbersFromVoiceConnectorGroupResult) obj;
    ...
    public DisassociatePhoneNumbersFromVoiceConnectorGroupResult clone() {
        try {
            return (DisassociatePhoneNumbersFromVoiceConnectorGroupResult) super.clone();
