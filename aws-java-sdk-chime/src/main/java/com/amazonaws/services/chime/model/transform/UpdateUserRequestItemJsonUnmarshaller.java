...
/**
 * UpdateUserRequestItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateUserRequestItemJsonUnmarshaller implements Unmarshaller<UpdateUserRequestItem, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserId", targetDepth)) {
                    context.nextToken();
                    updateUserRequestItem.setUserId(context.getUnmarshaller(String.class).unmarshall(context));
                }
