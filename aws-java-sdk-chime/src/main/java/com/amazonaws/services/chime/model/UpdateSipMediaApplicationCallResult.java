...
public class UpdateSipMediaApplicationCallResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public UpdateSipMediaApplicationCallResult withSipMediaApplicationCall(SipMediaApplicationCall sipMediaApplicationCall) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSipMediaApplicationCallResult == false)
            return false;
        UpdateSipMediaApplicationCallResult other = (UpdateSipMediaApplicationCallResult) obj;
        if (other.getSipMediaApplicationCall() == null ^ this.getSipMediaApplicationCall() == null)
            return false;
        if (other.getSipMediaApplicationCall() != null && other.getSipMediaApplicationCall().equals(this.getSipMediaApplicationCall()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSipMediaApplicationCall() == null) ? 0 : getSipMediaApplicationCall().hashCode());
        return hashCode;
    }

    @Override
    public UpdateSipMediaApplicationCallResult clone() {
        try {
            return (UpdateSipMediaApplicationCallResult) super.clone();
