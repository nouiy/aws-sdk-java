...
/**
 * RoomRetentionSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RoomRetentionSettingsJsonUnmarshaller implements Unmarshaller<RoomRetentionSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RetentionDays", targetDepth)) {
                    context.nextToken();
                    roomRetentionSettings.setRetentionDays(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
