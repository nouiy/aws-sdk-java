...
public class AccountSettingsMarshaller {
    ...
    private static final MarshallingInfo<Boolean> DISABLEREMOTECONTROL_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DisableRemoteControl").build();
    private static final MarshallingInfo<Boolean> ENABLEDIALOUT_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EnableDialOut").build();
