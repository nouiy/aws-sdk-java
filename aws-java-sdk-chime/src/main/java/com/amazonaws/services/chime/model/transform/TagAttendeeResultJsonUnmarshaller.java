...
/**
 * TagAttendeeResult JSON Unmarshaller
 */
...
public class TagAttendeeResultJsonUnmarshaller implements Unmarshaller<TagAttendeeResult, JsonUnmarshallerContext> {
    ...
    public TagAttendeeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        TagAttendeeResult tagAttendeeResult = new TagAttendeeResult();
