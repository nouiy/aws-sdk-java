 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/VoiceConnectorSettings" target="_top">AWS API
 *      Documentation</a>
 */
...
public class VoiceConnectorSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VoiceConnectorSettings == false)
            return false;
    ...
    public VoiceConnectorSettings clone() {
        try {
            return (VoiceConnectorSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.chime.model.transform.VoiceConnectorSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
