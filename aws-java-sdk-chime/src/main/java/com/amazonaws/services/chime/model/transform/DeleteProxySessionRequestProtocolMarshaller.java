...
@SdkInternalApi
public class DeleteProxySessionRequestProtocolMarshaller implements Marshaller<Request<DeleteProxySessionRequest>, DeleteProxySessionRequest> {
    ...
    public Request<DeleteProxySessionRequest> marshall(DeleteProxySessionRequest deleteProxySessionRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DeleteProxySessionRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
