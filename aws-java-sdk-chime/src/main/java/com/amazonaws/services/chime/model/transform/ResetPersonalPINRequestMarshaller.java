...
/**
 * ResetPersonalPINRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ResetPersonalPINRequestMarshaller {
    ...
    private static final ResetPersonalPINRequestMarshaller instance = new ResetPersonalPINRequestMarshaller();

    public static ResetPersonalPINRequestMarshaller getInstance() {
        return instance;
    }
