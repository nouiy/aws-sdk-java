...
public class PutAppInstanceStreamingConfigurationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public PutAppInstanceStreamingConfigurationsResult withAppInstanceStreamingConfigurations(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutAppInstanceStreamingConfigurationsResult == false)
            return false;
        PutAppInstanceStreamingConfigurationsResult other = (PutAppInstanceStreamingConfigurationsResult) obj;
    ...
    @Override
    public PutAppInstanceStreamingConfigurationsResult clone() {
        try {
