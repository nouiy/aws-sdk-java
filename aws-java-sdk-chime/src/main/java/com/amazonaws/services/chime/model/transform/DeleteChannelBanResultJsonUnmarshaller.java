...
/**
 * DeleteChannelBanResult JSON Unmarshaller
 */
...
public class DeleteChannelBanResultJsonUnmarshaller implements Unmarshaller<DeleteChannelBanResult, JsonUnmarshallerContext> {
    ...
    public DeleteChannelBanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteChannelBanResult deleteChannelBanResult = new DeleteChannelBanResult();
