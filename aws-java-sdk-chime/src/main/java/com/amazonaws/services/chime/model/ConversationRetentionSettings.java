 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/ConversationRetentionSettings"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConversationRetentionSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public ConversationRetentionSettings clone() {
        try {
            return (ConversationRetentionSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.chime.model.transform.ConversationRetentionSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
