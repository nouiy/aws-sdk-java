...
public class CreateRoomMembershipResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public CreateRoomMembershipResult clone() {
        try {
            return (CreateRoomMembershipResult) super.clone();
