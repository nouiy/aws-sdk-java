...
/**
 * GetVoiceConnectorOriginationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetVoiceConnectorOriginationRequestMarshaller {
    ...
    private static final GetVoiceConnectorOriginationRequestMarshaller instance = new GetVoiceConnectorOriginationRequestMarshaller();

    public static GetVoiceConnectorOriginationRequestMarshaller getInstance() {
        return instance;
    }
