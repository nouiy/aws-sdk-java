...
/**
 * ListAppInstanceUsersResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAppInstanceUsersResultJsonUnmarshaller implements Unmarshaller<ListAppInstanceUsersResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceArn", targetDepth)) {
                    context.nextToken();
                    listAppInstanceUsersResult.setAppInstanceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("AppInstanceUsers", targetDepth)) {
                    context.nextToken();
                    listAppInstanceUsersResult.setAppInstanceUsers(new ListUnmarshaller<AppInstanceUserSummary>(AppInstanceUserSummaryJsonUnmarshaller
                            .getInstance())
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listAppInstanceUsersResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
