...
public class PutVoiceConnectorLoggingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The updated logging configuration details.
     */
    ...
    public PutVoiceConnectorLoggingConfigurationResult withLoggingConfiguration(LoggingConfiguration loggingConfiguration) {
    ...
    @Override
    public PutVoiceConnectorLoggingConfigurationResult clone() {
        try {
            return (PutVoiceConnectorLoggingConfigurationResult) super.clone();
