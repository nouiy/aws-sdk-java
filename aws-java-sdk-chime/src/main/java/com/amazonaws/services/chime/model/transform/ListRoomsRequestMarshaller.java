...
public class ListRoomsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> MEMBERID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("member-id").build();
    ...
    public static ListRoomsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListRoomsRequest listRoomsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRoomsRequest.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(listRoomsRequest.getMemberId(), MEMBERID_BINDING);
