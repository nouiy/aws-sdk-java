...
/**
 * GetUserSettingsResult JSON Unmarshaller
 */
...
public class GetUserSettingsResultJsonUnmarshaller implements Unmarshaller<GetUserSettingsResult, JsonUnmarshallerContext> {
    ...
    public GetUserSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserSettings", targetDepth)) {
                    context.nextToken();
                    getUserSettingsResult.setUserSettings(UserSettingsJsonUnmarshaller.getInstance().unmarshall(context));
                }
