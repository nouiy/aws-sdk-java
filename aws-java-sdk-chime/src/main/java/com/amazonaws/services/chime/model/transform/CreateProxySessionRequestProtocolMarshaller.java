...
@SdkInternalApi
public class CreateProxySessionRequestProtocolMarshaller implements Marshaller<Request<CreateProxySessionRequest>, CreateProxySessionRequest> {
    ...
    public Request<CreateProxySessionRequest> marshall(CreateProxySessionRequest createProxySessionRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<CreateProxySessionRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
