...
/**
 * ChannelMembershipForAppInstanceUserSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChannelMembershipForAppInstanceUserSummaryJsonUnmarshaller implements
        Unmarshaller<ChannelMembershipForAppInstanceUserSummary, JsonUnmarshallerContext> {

    public ChannelMembershipForAppInstanceUserSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelSummary", targetDepth)) {
                    context.nextToken();
                    channelMembershipForAppInstanceUserSummary.setChannelSummary(ChannelSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("AppInstanceUserMembershipSummary", targetDepth)) {
                    context.nextToken();
                    channelMembershipForAppInstanceUserSummary.setAppInstanceUserMembershipSummary(AppInstanceUserMembershipSummaryJsonUnmarshaller
