...
public class AssociatePhoneNumbersWithVoiceConnectorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public AssociatePhoneNumbersWithVoiceConnectorResult withPhoneNumberErrors(PhoneNumberError... phoneNumberErrors) {
    ...
    public AssociatePhoneNumbersWithVoiceConnectorResult withPhoneNumberErrors(java.util.Collection<PhoneNumberError> phoneNumberErrors) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociatePhoneNumbersWithVoiceConnectorResult == false)
            return false;
        AssociatePhoneNumbersWithVoiceConnectorResult other = (AssociatePhoneNumbersWithVoiceConnectorResult) obj;
    ...
    @Override
    public AssociatePhoneNumbersWithVoiceConnectorResult clone() {
        try {
            return (AssociatePhoneNumbersWithVoiceConnectorResult) super.clone();
