...
/**
 * ArtifactsConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ArtifactsConfigurationJsonUnmarshaller implements Unmarshaller<ArtifactsConfiguration, JsonUnmarshallerContext> {

    public ArtifactsConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ArtifactsConfigurationJsonUnmarshaller instance;

    public static ArtifactsConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ArtifactsConfigurationJsonUnmarshaller();
        return instance;
    }
}
