...
/**
 * ListPhoneNumberOrdersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListPhoneNumberOrdersRequestMarshaller {
    ...
    private static final ListPhoneNumberOrdersRequestMarshaller instance = new ListPhoneNumberOrdersRequestMarshaller();

    public static ListPhoneNumberOrdersRequestMarshaller getInstance() {
        return instance;
    }
