        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MemberId", targetDepth)) {
                    context.nextToken();
                    member.setMemberId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MemberType", targetDepth)) {
                    context.nextToken();
                    member.setMemberType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("FullName", targetDepth)) {
                    context.nextToken();
                    member.setFullName(context.getUnmarshaller(String.class).unmarshall(context));
                }
