...
public class DescribeAppInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getAppInstance() != null)
            sb.append("AppInstance: ").append(getAppInstance());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAppInstance() == null ^ this.getAppInstance() == null)
            return false;
        if (other.getAppInstance() != null && other.getAppInstance().equals(this.getAppInstance()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getAppInstance() == null) ? 0 : getAppInstance().hashCode());
        return hashCode;
    }
    ...
    public DescribeAppInstanceResult clone() {
        try {
            return (DescribeAppInstanceResult) super.clone();
