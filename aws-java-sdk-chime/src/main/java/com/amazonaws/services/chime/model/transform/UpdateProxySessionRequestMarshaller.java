...
/**
 * UpdateProxySessionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateProxySessionRequestMarshaller {
    ...
    private static final UpdateProxySessionRequestMarshaller instance = new UpdateProxySessionRequestMarshaller();

    public static UpdateProxySessionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateProxySessionRequest updateProxySessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateProxySessionRequest.getVoiceConnectorId(), VOICECONNECTORID_BINDING);
            ...
            protocolMarshaller.marshall(updateProxySessionRequest.getExpiryMinutes(), EXPIRYMINUTES_BINDING);
        } catch (Exception e) {
