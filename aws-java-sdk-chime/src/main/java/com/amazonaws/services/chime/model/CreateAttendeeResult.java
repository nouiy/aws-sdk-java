...
public class CreateAttendeeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAttendeeResult == false)
            return false;
        CreateAttendeeResult other = (CreateAttendeeResult) obj;
    ...
    public CreateAttendeeResult clone() {
        try {
            return (CreateAttendeeResult) super.clone();
