...
/**
 * UpdatePhoneNumberSettingsResult JSON Unmarshaller
 */
...
public class UpdatePhoneNumberSettingsResultJsonUnmarshaller implements Unmarshaller<UpdatePhoneNumberSettingsResult, JsonUnmarshallerContext> {
    ...
    public UpdatePhoneNumberSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePhoneNumberSettingsResult updatePhoneNumberSettingsResult = new UpdatePhoneNumberSettingsResult();
