...
public class UpdateAccountSettingsRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ACCOUNTSETTINGS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AccountSettings").build();
    ...
    public void marshall(UpdateAccountSettingsRequest updateAccountSettingsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateAccountSettingsRequest.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(updateAccountSettingsRequest.getAccountSettings(), ACCOUNTSETTINGS_BINDING);
        } catch (Exception e) {
