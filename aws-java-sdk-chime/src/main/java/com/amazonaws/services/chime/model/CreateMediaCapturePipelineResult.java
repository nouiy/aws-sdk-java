...
public class CreateMediaCapturePipelineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateMediaCapturePipelineResult withMediaCapturePipeline(MediaCapturePipeline mediaCapturePipeline) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMediaCapturePipelineResult == false)
            return false;
        CreateMediaCapturePipelineResult other = (CreateMediaCapturePipelineResult) obj;
    ...
    @Override
    public CreateMediaCapturePipelineResult clone() {
        try {
            return (CreateMediaCapturePipelineResult) super.clone();
