...
public class BatchUpdateUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * If the <a>BatchUpdateUser</a> action fails for one or more of the user IDs in the request, a list of the user IDs
     ...
     * </p>
     * 
     * @return If the <a>BatchUpdateUser</a> action fails for one or more of the user IDs in the request, a list of the
     ...
     * 
     * @param userErrors
     *        If the <a>BatchUpdateUser</a> action fails for one or more of the user IDs in the request, a list of the
     *        user IDs is returned, along with error codes and error messages.
     */
    ...
    @Override
    public BatchUpdateUserResult clone() {
        try {
            return (BatchUpdateUserResult) super.clone();
