...
public class BatchUnsuspendUserResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * If the <a>BatchUnsuspendUser</a> action fails for one or more of the user IDs in the request, a list of the user
     ...
     * </p>
     * 
     * @return If the <a>BatchUnsuspendUser</a> action fails for one or more of the user IDs in the request, a list of
     ...
     * 
     * @param userErrors
     *        If the <a>BatchUnsuspendUser</a> action fails for one or more of the user IDs in the request, a list of
     *        the user IDs is returned, along with error codes and error messages.
     */
    ...
    public BatchUnsuspendUserResult withUserErrors(UserError... userErrors) {
    ...
    public BatchUnsuspendUserResult withUserErrors(java.util.Collection<UserError> userErrors) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchUnsuspendUserResult == false)
            return false;
        BatchUnsuspendUserResult other = (BatchUnsuspendUserResult) obj;
