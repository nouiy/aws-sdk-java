...
public class PutVoiceConnectorStreamingConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutVoiceConnectorStreamingConfigurationRequest withVoiceConnectorId(String voiceConnectorId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutVoiceConnectorStreamingConfigurationRequest == false)
            return false;
    ...
    @Override
    public PutVoiceConnectorStreamingConfigurationRequest clone() {
