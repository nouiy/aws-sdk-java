...
public class GetVoiceConnectorGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVoiceConnectorGroupResult == false)
            return false;
        GetVoiceConnectorGroupResult other = (GetVoiceConnectorGroupResult) obj;
    ...
    @Override
    public GetVoiceConnectorGroupResult clone() {
        try {
            return (GetVoiceConnectorGroupResult) super.clone();
