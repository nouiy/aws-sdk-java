...
/**
 * BatchUpdateUserResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchUpdateUserResultJsonUnmarshaller implements Unmarshaller<BatchUpdateUserResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserErrors", targetDepth)) {
                    context.nextToken();
                    batchUpdateUserResult.setUserErrors(new ListUnmarshaller<UserError>(UserErrorJsonUnmarshaller.getInstance())
