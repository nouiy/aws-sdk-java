...
/**
 * VoiceConnectorMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VoiceConnectorMarshaller {
    ...
    private static final MarshallingInfo<String> OUTBOUNDHOSTNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("OutboundHostName").build();
    ...
    public static VoiceConnectorMarshaller getInstance() {
        return instance;
    }
