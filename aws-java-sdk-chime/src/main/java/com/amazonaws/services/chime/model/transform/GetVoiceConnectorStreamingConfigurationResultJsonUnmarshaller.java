...
/**
 * GetVoiceConnectorStreamingConfigurationResult JSON Unmarshaller
 */
...
public class GetVoiceConnectorStreamingConfigurationResultJsonUnmarshaller implements
    ...
    public GetVoiceConnectorStreamingConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamingConfiguration", targetDepth)) {
                    context.nextToken();
                    getVoiceConnectorStreamingConfigurationResult.setStreamingConfiguration(StreamingConfigurationJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
