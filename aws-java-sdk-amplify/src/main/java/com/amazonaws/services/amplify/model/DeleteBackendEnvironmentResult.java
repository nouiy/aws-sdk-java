...
public class DeleteBackendEnvironmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBackendEnvironmentResult == false)
            return false;
        DeleteBackendEnvironmentResult other = (DeleteBackendEnvironmentResult) obj;
    ...
    @Override
    public DeleteBackendEnvironmentResult clone() {
        try {
            return (DeleteBackendEnvironmentResult) super.clone();
