...
public class StartDeploymentRequestMarshaller {
    ...
    public void marshall(StartDeploymentRequest startDeploymentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startDeploymentRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(startDeploymentRequest.getBranchName(), BRANCHNAME_BINDING);
            protocolMarshaller.marshall(startDeploymentRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(startDeploymentRequest.getSourceUrl(), SOURCEURL_BINDING);
        } catch (Exception e) {
