...
public class CreateBranchResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBranchResult == false)
            return false;
        CreateBranchResult other = (CreateBranchResult) obj;
    ...
    public CreateBranchResult clone() {
        try {
            return (CreateBranchResult) super.clone();
