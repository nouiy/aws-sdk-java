...
public class CreateBranchResultJsonUnmarshaller implements Unmarshaller<CreateBranchResult, JsonUnmarshallerContext> {
    ...
    public CreateBranchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateBranchResult createBranchResult = new CreateBranchResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("branch", targetDepth)) {
                    context.nextToken();
                    createBranchResult.setBranch(BranchJsonUnmarshaller.getInstance().unmarshall(context));
                }
