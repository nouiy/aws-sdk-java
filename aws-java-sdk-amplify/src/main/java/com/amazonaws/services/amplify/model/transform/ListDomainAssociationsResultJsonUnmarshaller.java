...
/**
 * ListDomainAssociationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDomainAssociationsResultJsonUnmarshaller implements Unmarshaller<ListDomainAssociationsResult, JsonUnmarshallerContext> {

    public ListDomainAssociationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listDomainAssociationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
