...
public class ListBranchesResultJsonUnmarshaller implements Unmarshaller<ListBranchesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("branches", targetDepth)) {
                    context.nextToken();
                    listBranchesResult.setBranches(new ListUnmarshaller<Branch>(BranchJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listBranchesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
