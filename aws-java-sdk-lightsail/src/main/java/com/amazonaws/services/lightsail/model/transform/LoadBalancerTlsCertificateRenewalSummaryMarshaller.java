...
/**
 * LoadBalancerTlsCertificateRenewalSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LoadBalancerTlsCertificateRenewalSummaryMarshaller {
    ...
    private static final LoadBalancerTlsCertificateRenewalSummaryMarshaller instance = new LoadBalancerTlsCertificateRenewalSummaryMarshaller();

    public static LoadBalancerTlsCertificateRenewalSummaryMarshaller getInstance() {
        return instance;
    }
