...
/**
 * GetExportSnapshotRecordsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetExportSnapshotRecordsResultJsonUnmarshaller implements Unmarshaller<GetExportSnapshotRecordsResult, JsonUnmarshallerContext> {

    public GetExportSnapshotRecordsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextPageToken", targetDepth)) {
                    context.nextToken();
                    getExportSnapshotRecordsResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
