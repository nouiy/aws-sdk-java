...
/**
 * InstanceSnapshotInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceSnapshotInfoJsonUnmarshaller implements Unmarshaller<InstanceSnapshotInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fromBundleId", targetDepth)) {
                    context.nextToken();
                    instanceSnapshotInfo.setFromBundleId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("fromBlueprintId", targetDepth)) {
                    context.nextToken();
                    instanceSnapshotInfo.setFromBlueprintId(context.getUnmarshaller(String.class).unmarshall(context));
                }
