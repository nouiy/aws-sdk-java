...
public class DeleteRelationalDatabaseSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteRelationalDatabaseSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRelationalDatabaseSnapshotResult == false)
            return false;
        DeleteRelationalDatabaseSnapshotResult other = (DeleteRelationalDatabaseSnapshotResult) obj;
    ...
    @Override
    public DeleteRelationalDatabaseSnapshotResult clone() {
        try {
            return (DeleteRelationalDatabaseSnapshotResult) super.clone();
