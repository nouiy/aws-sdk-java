...
public class CreateRelationalDatabaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateRelationalDatabaseResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRelationalDatabaseResult == false)
            return false;
        CreateRelationalDatabaseResult other = (CreateRelationalDatabaseResult) obj;
    ...
    @Override
    public CreateRelationalDatabaseResult clone() {
        try {
            return (CreateRelationalDatabaseResult) super.clone();
