...
public class DiskInfoMarshaller {
    ...
    public void marshall(DiskInfo diskInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(diskInfo.getName(), NAME_BINDING);
            protocolMarshaller.marshall(diskInfo.getPath(), PATH_BINDING);
            protocolMarshaller.marshall(diskInfo.getSizeInGb(), SIZEINGB_BINDING);
            protocolMarshaller.marshall(diskInfo.getIsSystemDisk(), ISSYSTEMDISK_BINDING);
        } catch (Exception e) {
