...
/**
 * RelationalDatabaseHardware JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RelationalDatabaseHardwareJsonUnmarshaller implements Unmarshaller<RelationalDatabaseHardware, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cpuCount", targetDepth)) {
                    context.nextToken();
                    relationalDatabaseHardware.setCpuCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("diskSizeInGb", targetDepth)) {
                    context.nextToken();
                    relationalDatabaseHardware.setDiskSizeInGb(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("ramSizeInGb", targetDepth)) {
                    context.nextToken();
                    relationalDatabaseHardware.setRamSizeInGb(context.getUnmarshaller(Float.class).unmarshall(context));
                }
