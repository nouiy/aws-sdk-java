...
/**
 * GetInstanceSnapshotsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetInstanceSnapshotsResultJsonUnmarshaller implements Unmarshaller<GetInstanceSnapshotsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextPageToken", targetDepth)) {
                    context.nextToken();
                    getInstanceSnapshotsResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
