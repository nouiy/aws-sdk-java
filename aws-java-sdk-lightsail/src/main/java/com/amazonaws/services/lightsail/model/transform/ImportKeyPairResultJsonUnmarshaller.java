...
/**
 * ImportKeyPairResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportKeyPairResultJsonUnmarshaller implements Unmarshaller<ImportKeyPairResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("operation", targetDepth)) {
                    context.nextToken();
                    importKeyPairResult.setOperation(OperationJsonUnmarshaller.getInstance().unmarshall(context));
                }
