...
public class UpdateDistributionBundleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDistributionBundleResult == false)
            return false;
        UpdateDistributionBundleResult other = (UpdateDistributionBundleResult) obj;
    ...
    public UpdateDistributionBundleResult clone() {
        try {
            return (UpdateDistributionBundleResult) super.clone();
