...
/**
 * GetAutoSnapshotsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetAutoSnapshotsResultJsonUnmarshaller implements Unmarshaller<GetAutoSnapshotsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("resourceName", targetDepth)) {
                    context.nextToken();
                    getAutoSnapshotsResult.setResourceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("resourceType", targetDepth)) {
                    context.nextToken();
                    getAutoSnapshotsResult.setResourceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
