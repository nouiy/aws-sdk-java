...
public class DeleteBucketAccessKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteBucketAccessKeyResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBucketAccessKeyResult == false)
            return false;
        DeleteBucketAccessKeyResult other = (DeleteBucketAccessKeyResult) obj;
    ...
    @Override
    public DeleteBucketAccessKeyResult clone() {
        try {
            return (DeleteBucketAccessKeyResult) super.clone();
