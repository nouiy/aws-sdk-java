...
/**
 * CreateDistributionRequestMarshaller
 */
...
public class CreateDistributionRequestMarshaller {
    ...
    public static CreateDistributionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateDistributionRequest createDistributionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDistributionRequest.getDistributionName(), DISTRIBUTIONNAME_BINDING);
            protocolMarshaller.marshall(createDistributionRequest.getOrigin(), ORIGIN_BINDING);
            protocolMarshaller.marshall(createDistributionRequest.getDefaultCacheBehavior(), DEFAULTCACHEBEHAVIOR_BINDING);
