...
public class TestAlarmResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public TestAlarmResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TestAlarmResult == false)
            return false;
        TestAlarmResult other = (TestAlarmResult) obj;
    ...
    @Override
    public TestAlarmResult clone() {
        try {
            return (TestAlarmResult) super.clone();
