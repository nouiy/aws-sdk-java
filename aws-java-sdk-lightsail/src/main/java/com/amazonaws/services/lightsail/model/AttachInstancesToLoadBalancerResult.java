...
public class AttachInstancesToLoadBalancerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public AttachInstancesToLoadBalancerResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttachInstancesToLoadBalancerResult == false)
            return false;
        AttachInstancesToLoadBalancerResult other = (AttachInstancesToLoadBalancerResult) obj;
    ...
    @Override
    public AttachInstancesToLoadBalancerResult clone() {
        try {
            return (AttachInstancesToLoadBalancerResult) super.clone();
