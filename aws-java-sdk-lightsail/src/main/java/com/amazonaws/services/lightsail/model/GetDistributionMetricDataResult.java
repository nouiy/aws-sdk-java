...
public class GetDistributionMetricDataResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetDistributionMetricDataResult withMetricName(String metricName) {
    ...
    public GetDistributionMetricDataResult withMetricName(DistributionMetricName metricName) {
    ...
    public GetDistributionMetricDataResult withMetricData(java.util.Collection<MetricDatapoint> metricData) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDistributionMetricDataResult == false)
            return false;
        GetDistributionMetricDataResult other = (GetDistributionMetricDataResult) obj;
    ...
    @Override
    public GetDistributionMetricDataResult clone() {
        try {
            return (GetDistributionMetricDataResult) super.clone();
