...
public class CreateDomainEntryRequestMarshaller {
    ...
    private static final CreateDomainEntryRequestMarshaller instance = new CreateDomainEntryRequestMarshaller();

    public static CreateDomainEntryRequestMarshaller getInstance() {
        return instance;
    }
