...
public class ReleaseStaticIpResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ReleaseStaticIpResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReleaseStaticIpResult == false)
            return false;
        ReleaseStaticIpResult other = (ReleaseStaticIpResult) obj;
    ...
    @Override
    public ReleaseStaticIpResult clone() {
        try {
            return (ReleaseStaticIpResult) super.clone();
