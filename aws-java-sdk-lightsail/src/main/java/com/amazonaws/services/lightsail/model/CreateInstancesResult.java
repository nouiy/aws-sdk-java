...
public class CreateInstancesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateInstancesResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateInstancesResult == false)
            return false;
        CreateInstancesResult other = (CreateInstancesResult) obj;
    ...
    @Override
    public CreateInstancesResult clone() {
        try {
            return (CreateInstancesResult) super.clone();
