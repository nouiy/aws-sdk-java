...
/**
 * ContainerServiceDeployment JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContainerServiceDeploymentJsonUnmarshaller implements Unmarshaller<ContainerServiceDeployment, JsonUnmarshallerContext> {

    public ContainerServiceDeployment unmarshall(JsonUnmarshallerContext context) throws Exception {
        ContainerServiceDeployment containerServiceDeployment = new ContainerServiceDeployment();
    ...
    private static ContainerServiceDeploymentJsonUnmarshaller instance;

    public static ContainerServiceDeploymentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ContainerServiceDeploymentJsonUnmarshaller();
        return instance;
    }
}
