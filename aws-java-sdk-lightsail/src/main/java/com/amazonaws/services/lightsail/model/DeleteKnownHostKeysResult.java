...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteKnownHostKeys" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteKnownHostKeysResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteKnownHostKeysResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteKnownHostKeysResult == false)
            return false;
        DeleteKnownHostKeysResult other = (DeleteKnownHostKeysResult) obj;
    ...
    @Override
    public DeleteKnownHostKeysResult clone() {
        try {
            return (DeleteKnownHostKeysResult) super.clone();
