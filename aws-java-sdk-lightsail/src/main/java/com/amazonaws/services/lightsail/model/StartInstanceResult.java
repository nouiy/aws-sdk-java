...
public class StartInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartInstanceResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartInstanceResult == false)
            return false;
        StartInstanceResult other = (StartInstanceResult) obj;
    ...
    @Override
    public StartInstanceResult clone() {
        try {
            return (StartInstanceResult) super.clone();
