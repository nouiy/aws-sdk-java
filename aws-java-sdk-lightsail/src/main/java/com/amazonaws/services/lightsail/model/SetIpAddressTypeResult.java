...
public class SetIpAddressTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SetIpAddressTypeResult withOperations(Operation... operations) {
    ...
    public SetIpAddressTypeResult withOperations(java.util.Collection<Operation> operations) {
