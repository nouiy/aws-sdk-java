...
public class CreateContainerServiceDeploymentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateContainerServiceDeploymentResult == false)
            return false;
        CreateContainerServiceDeploymentResult other = (CreateContainerServiceDeploymentResult) obj;
    ...
    @Override
    public CreateContainerServiceDeploymentResult clone() {
        try {
            return (CreateContainerServiceDeploymentResult) super.clone();
