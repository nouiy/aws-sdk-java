...
/**
 * BucketBundle JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BucketBundleJsonUnmarshaller implements Unmarshaller<BucketBundle, JsonUnmarshallerContext> {

    public BucketBundle unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static BucketBundleJsonUnmarshaller instance;

    public static BucketBundleJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BucketBundleJsonUnmarshaller();
        return instance;
    }
}
