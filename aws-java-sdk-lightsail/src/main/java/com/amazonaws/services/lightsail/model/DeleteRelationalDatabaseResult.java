...
public class DeleteRelationalDatabaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteRelationalDatabaseResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRelationalDatabaseResult == false)
            return false;
        DeleteRelationalDatabaseResult other = (DeleteRelationalDatabaseResult) obj;
    ...
    @Override
    public DeleteRelationalDatabaseResult clone() {
        try {
            return (DeleteRelationalDatabaseResult) super.clone();
