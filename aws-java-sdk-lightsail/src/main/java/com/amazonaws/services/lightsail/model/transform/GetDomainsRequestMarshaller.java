...
public class GetDomainsRequestMarshaller {
    ...
    private static final GetDomainsRequestMarshaller instance = new GetDomainsRequestMarshaller();

    public static GetDomainsRequestMarshaller getInstance() {
        return instance;
    }
