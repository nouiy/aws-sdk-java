...
public class StopRelationalDatabaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopRelationalDatabaseResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopRelationalDatabaseResult == false)
            return false;
        StopRelationalDatabaseResult other = (StopRelationalDatabaseResult) obj;
    ...
    public StopRelationalDatabaseResult clone() {
        try {
            return (StopRelationalDatabaseResult) super.clone();
