...
public class DeleteLoadBalancerTlsCertificateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteLoadBalancerTlsCertificateResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteLoadBalancerTlsCertificateResult == false)
            return false;
        DeleteLoadBalancerTlsCertificateResult other = (DeleteLoadBalancerTlsCertificateResult) obj;
    ...
    @Override
    public DeleteLoadBalancerTlsCertificateResult clone() {
        try {
            return (DeleteLoadBalancerTlsCertificateResult) super.clone();
