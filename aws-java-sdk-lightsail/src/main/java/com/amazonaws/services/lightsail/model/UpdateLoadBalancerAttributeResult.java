...
public class UpdateLoadBalancerAttributeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateLoadBalancerAttributeResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLoadBalancerAttributeResult == false)
            return false;
        UpdateLoadBalancerAttributeResult other = (UpdateLoadBalancerAttributeResult) obj;
    ...
    @Override
    public UpdateLoadBalancerAttributeResult clone() {
        try {
            return (UpdateLoadBalancerAttributeResult) super.clone();
