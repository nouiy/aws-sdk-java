...
public class DeleteContactMethodResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteContactMethodResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteContactMethodResult == false)
            return false;
        DeleteContactMethodResult other = (DeleteContactMethodResult) obj;
    ...
    @Override
    public DeleteContactMethodResult clone() {
        try {
            return (DeleteContactMethodResult) super.clone();
