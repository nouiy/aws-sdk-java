...
/**
 * GetCloudFormationStackRecordsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCloudFormationStackRecordsResultJsonUnmarshaller implements Unmarshaller<GetCloudFormationStackRecordsResult, JsonUnmarshallerContext> {

    public GetCloudFormationStackRecordsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextPageToken", targetDepth)) {
                    context.nextToken();
                    getCloudFormationStackRecordsResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
