...
public class DetachDiskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DetachDiskResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachDiskResult == false)
            return false;
        DetachDiskResult other = (DetachDiskResult) obj;
    ...
    @Override
    public DetachDiskResult clone() {
        try {
            return (DetachDiskResult) super.clone();
