...
/**
 * GetRelationalDatabaseLogStreamsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetRelationalDatabaseLogStreamsRequestMarshaller {
    ...
    private static final GetRelationalDatabaseLogStreamsRequestMarshaller instance = new GetRelationalDatabaseLogStreamsRequestMarshaller();

    public static GetRelationalDatabaseLogStreamsRequestMarshaller getInstance() {
        return instance;
    }
