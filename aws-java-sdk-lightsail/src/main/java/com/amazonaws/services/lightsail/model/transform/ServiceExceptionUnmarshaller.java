        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    serviceException.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("docs", targetDepth)) {
                    context.nextToken();
                    serviceException.setDocs(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("tip", targetDepth)) {
                    context.nextToken();
                    serviceException.setTip(context.getUnmarshaller(String.class).unmarshall(context));
                }
