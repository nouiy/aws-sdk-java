...
public class StartRelationalDatabaseRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of your database to start.
     */
    ...
    @Override
    public StartRelationalDatabaseRequest clone() {
        return (StartRelationalDatabaseRequest) super.clone();
    }
