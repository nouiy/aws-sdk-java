...
public class StopInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopInstanceResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopInstanceResult == false)
            return false;
        StopInstanceResult other = (StopInstanceResult) obj;
    ...
    @Override
    public StopInstanceResult clone() {
        try {
            return (StopInstanceResult) super.clone();
