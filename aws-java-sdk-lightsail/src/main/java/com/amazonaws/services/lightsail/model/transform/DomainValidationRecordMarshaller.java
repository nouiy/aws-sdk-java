...
/**
 * DomainValidationRecordMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DomainValidationRecordMarshaller {
    ...
    public static DomainValidationRecordMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DomainValidationRecord domainValidationRecord, ProtocolMarshaller protocolMarshaller) {

        if (domainValidationRecord == null) {
