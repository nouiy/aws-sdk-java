...
/**
 * GetLoadBalancerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetLoadBalancerRequestMarshaller {
    ...
    private static final GetLoadBalancerRequestMarshaller instance = new GetLoadBalancerRequestMarshaller();

    public static GetLoadBalancerRequestMarshaller getInstance() {
        return instance;
    }
