...
public class CreateContactMethodResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateContactMethodResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateContactMethodResult == false)
            return false;
        CreateContactMethodResult other = (CreateContactMethodResult) obj;
    ...
    @Override
    public CreateContactMethodResult clone() {
        try {
            return (CreateContactMethodResult) super.clone();
