...
public class CreateCloudFormationStackResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCloudFormationStackResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCloudFormationStackResult == false)
            return false;
        CreateCloudFormationStackResult other = (CreateCloudFormationStackResult) obj;
    ...
    @Override
    public CreateCloudFormationStackResult clone() {
        try {
            return (CreateCloudFormationStackResult) super.clone();
