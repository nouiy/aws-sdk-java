...
public enum LoadBalancerTlsCertificateRevocationReason {
     ...
     * @param value
     *        real value
     * @return LoadBalancerTlsCertificateRevocationReason corresponding to the value
     *
    ...
    public static LoadBalancerTlsCertificateRevocationReason fromValue(String value) {
        ...
        for (LoadBalancerTlsCertificateRevocationReason enumEntry : LoadBalancerTlsCertificateRevocationReason.values()) {
