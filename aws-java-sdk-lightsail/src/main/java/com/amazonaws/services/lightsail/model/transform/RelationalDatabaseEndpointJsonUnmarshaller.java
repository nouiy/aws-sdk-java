...
/**
 * RelationalDatabaseEndpoint JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RelationalDatabaseEndpointJsonUnmarshaller implements Unmarshaller<RelationalDatabaseEndpoint, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("port", targetDepth)) {
                    context.nextToken();
                    relationalDatabaseEndpoint.setPort(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("address", targetDepth)) {
                    context.nextToken();
                    relationalDatabaseEndpoint.setAddress(context.getUnmarshaller(String.class).unmarshall(context));
                }
