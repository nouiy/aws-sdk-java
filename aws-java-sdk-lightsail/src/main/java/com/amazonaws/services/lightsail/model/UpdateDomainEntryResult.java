...
public class UpdateDomainEntryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDomainEntryResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDomainEntryResult == false)
            return false;
        UpdateDomainEntryResult other = (UpdateDomainEntryResult) obj;
    ...
    @Override
    public UpdateDomainEntryResult clone() {
        try {
            return (UpdateDomainEntryResult) super.clone();
