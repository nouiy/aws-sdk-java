...
public class GetOperationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * To get a page token, perform an initial <code>GetOperations</code> request. If your results are paginated, the
     ...
     *        <p>
     *        To get a page token, perform an initial <code>GetOperations</code> request. If your results are paginated,
     ...
     *         <p>
     *         To get a page token, perform an initial <code>GetOperations</code> request. If your results are
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOperationsRequest == false)
            return false;
        GetOperationsRequest other = (GetOperationsRequest) obj;
