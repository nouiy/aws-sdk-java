...
public class DeleteDiskSnapshotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteDiskSnapshotRequest clone() {
        return (DeleteDiskSnapshotRequest) super.clone();
    }
