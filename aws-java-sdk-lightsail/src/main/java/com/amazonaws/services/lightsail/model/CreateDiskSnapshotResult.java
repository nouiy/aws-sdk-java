...
public class CreateDiskSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDiskSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDiskSnapshotResult == false)
            return false;
        CreateDiskSnapshotResult other = (CreateDiskSnapshotResult) obj;
    ...
    @Override
    public CreateDiskSnapshotResult clone() {
        try {
            return (CreateDiskSnapshotResult) super.clone();
