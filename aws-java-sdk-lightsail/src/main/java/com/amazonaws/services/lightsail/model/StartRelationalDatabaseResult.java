...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/StartRelationalDatabase" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartRelationalDatabaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartRelationalDatabaseResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartRelationalDatabaseResult == false)
            return false;
        StartRelationalDatabaseResult other = (StartRelationalDatabaseResult) obj;
    ...
    @Override
    public StartRelationalDatabaseResult clone() {
        try {
            return (StartRelationalDatabaseResult) super.clone();
