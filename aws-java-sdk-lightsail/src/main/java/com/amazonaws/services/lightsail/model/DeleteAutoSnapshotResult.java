...
public class DeleteAutoSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteAutoSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAutoSnapshotResult == false)
            return false;
        DeleteAutoSnapshotResult other = (DeleteAutoSnapshotResult) obj;
    ...
    @Override
    public DeleteAutoSnapshotResult clone() {
        try {
            return (DeleteAutoSnapshotResult) super.clone();
