...
public class GetLoadBalancersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * To get a page token, perform an initial <code>GetLoadBalancers</code> request. If your results are paginated, the
     ...
     *        <p>
     *        To get a page token, perform an initial <code>GetLoadBalancers</code> request. If your results are
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLoadBalancersRequest == false)
            return false;
        GetLoadBalancersRequest other = (GetLoadBalancersRequest) obj;
    ...
    @Override
    public GetLoadBalancersRequest clone() {
        return (GetLoadBalancersRequest) super.clone();
    }
