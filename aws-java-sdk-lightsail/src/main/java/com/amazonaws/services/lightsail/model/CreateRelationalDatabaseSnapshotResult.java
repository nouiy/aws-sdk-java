...
public class CreateRelationalDatabaseSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateRelationalDatabaseSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRelationalDatabaseSnapshotResult == false)
            return false;
        CreateRelationalDatabaseSnapshotResult other = (CreateRelationalDatabaseSnapshotResult) obj;
    ...
    @Override
    public CreateRelationalDatabaseSnapshotResult clone() {
        try {
            return (CreateRelationalDatabaseSnapshotResult) super.clone();
