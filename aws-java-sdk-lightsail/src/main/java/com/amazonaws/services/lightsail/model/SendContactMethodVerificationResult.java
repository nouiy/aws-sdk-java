...
public class SendContactMethodVerificationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public SendContactMethodVerificationResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SendContactMethodVerificationResult == false)
            return false;
        SendContactMethodVerificationResult other = (SendContactMethodVerificationResult) obj;
    ...
    @Override
    public SendContactMethodVerificationResult clone() {
        try {
            return (SendContactMethodVerificationResult) super.clone();
