...
public class CreateRelationalDatabaseFromSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateRelationalDatabaseFromSnapshotResult withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRelationalDatabaseFromSnapshotResult == false)
            return false;
        CreateRelationalDatabaseFromSnapshotResult other = (CreateRelationalDatabaseFromSnapshotResult) obj;
    ...
    @Override
    public CreateRelationalDatabaseFromSnapshotResult clone() {
        try {
            return (CreateRelationalDatabaseFromSnapshotResult) super.clone();
