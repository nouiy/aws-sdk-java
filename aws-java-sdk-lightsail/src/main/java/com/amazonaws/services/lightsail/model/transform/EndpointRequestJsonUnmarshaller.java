        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("containerName", targetDepth)) {
                    context.nextToken();
                    endpointRequest.setContainerName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("containerPort", targetDepth)) {
                    context.nextToken();
                    endpointRequest.setContainerPort(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("healthCheck", targetDepth)) {
                    context.nextToken();
                    endpointRequest.setHealthCheck(ContainerServiceHealthCheckConfigJsonUnmarshaller.getInstance().unmarshall(context));
                }
