...
/**
 * GetRelationalDatabaseBlueprintsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetRelationalDatabaseBlueprintsRequestMarshaller {
    ...
    private static final GetRelationalDatabaseBlueprintsRequestMarshaller instance = new GetRelationalDatabaseBlueprintsRequestMarshaller();

    public static GetRelationalDatabaseBlueprintsRequestMarshaller getInstance() {
        return instance;
    }
