...
public class DeleteRelationalDatabaseSnapshotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the database snapshot that you are deleting.
     */
    ...
    @Override
    public DeleteRelationalDatabaseSnapshotRequest clone() {
        return (DeleteRelationalDatabaseSnapshotRequest) super.clone();
    }
