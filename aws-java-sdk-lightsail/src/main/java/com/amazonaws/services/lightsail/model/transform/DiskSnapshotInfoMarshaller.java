...
/**
 * DiskSnapshotInfoMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DiskSnapshotInfoMarshaller {
    ...
    private static final DiskSnapshotInfoMarshaller instance = new DiskSnapshotInfoMarshaller();

    public static DiskSnapshotInfoMarshaller getInstance() {
        return instance;
    }
