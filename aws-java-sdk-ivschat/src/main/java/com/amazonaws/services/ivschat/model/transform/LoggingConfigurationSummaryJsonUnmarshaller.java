...
/**
 * LoggingConfigurationSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LoggingConfigurationSummaryJsonUnmarshaller implements Unmarshaller<LoggingConfigurationSummary, JsonUnmarshallerContext> {

    public LoggingConfigurationSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        LoggingConfigurationSummary loggingConfigurationSummary = new LoggingConfigurationSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("state", targetDepth)) {
                    context.nextToken();
                    loggingConfigurationSummary.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static LoggingConfigurationSummaryJsonUnmarshaller instance;

    public static LoggingConfigurationSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LoggingConfigurationSummaryJsonUnmarshaller();
        return instance;
    }
}
