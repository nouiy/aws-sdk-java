...
/**
 * DisconnectUserResult JSON Unmarshaller
 */
...
public class DisconnectUserResultJsonUnmarshaller implements Unmarshaller<DisconnectUserResult, JsonUnmarshallerContext> {
    ...
    public DisconnectUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisconnectUserResult disconnectUserResult = new DisconnectUserResult();

        return disconnectUserResult;
    }
