...
public class GetRoomResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetRoomResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetRoomResult withCreateTime(java.util.Date createTime) {
    ...
    public GetRoomResult withUpdateTime(java.util.Date updateTime) {
    ...
    public GetRoomResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     * </p>
     * 
     * @return Array of logging configurations attached to the room.
     */
    ...
    public GetRoomResult withLoggingConfigurationIdentifiers(String... loggingConfigurationIdentifiers) {
    ...
    public GetRoomResult withLoggingConfigurationIdentifiers(java.util.Collection<String> loggingConfigurationIdentifiers) {
