...
public class ConditionalCheckFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConditionalCheckFailedExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.ConditionalCheckFailedException.class, "ConditionalCheckFailedException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.ConditionalCheckFailedException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.codestarconnections.model.ConditionalCheckFailedException conditionalCheckFailedException = new com.amazonaws.services.codestarconnections.model.ConditionalCheckFailedException(
                null);
