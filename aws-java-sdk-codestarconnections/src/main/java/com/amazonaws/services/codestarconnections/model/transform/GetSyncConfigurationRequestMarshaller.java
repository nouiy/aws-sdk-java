...
public class GetSyncConfigurationRequestMarshaller {
    ...
    private static final GetSyncConfigurationRequestMarshaller instance = new GetSyncConfigurationRequestMarshaller();

    public static GetSyncConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetSyncConfigurationRequest getSyncConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSyncConfigurationRequest.getSyncType(), SYNCTYPE_BINDING);
            protocolMarshaller.marshall(getSyncConfigurationRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
