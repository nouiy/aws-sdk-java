...
public class GetSyncConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The sync type for the sync configuration for which you want to retrieve information.
     * @see SyncConfigurationType
     */
    ...
    public GetSyncConfigurationRequest withSyncType(String syncType) {
    ...
    public GetSyncConfigurationRequest withSyncType(SyncConfigurationType syncType) {
     ...
     * </p>
     * 
     * @return The name of the Amazon Web Services resource for the sync configuration for which you want to retrieve
     *         information.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSyncConfigurationRequest == false)
            return false;
        GetSyncConfigurationRequest other = (GetSyncConfigurationRequest) obj;
    ...
    @Override
    public GetSyncConfigurationRequest clone() {
        return (GetSyncConfigurationRequest) super.clone();
    }
