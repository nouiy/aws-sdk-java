...
public class ResourceUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceUnavailableExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.ResourceUnavailableException.class, "ResourceUnavailableException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.ResourceUnavailableException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.codestarconnections.model.ResourceUnavailableException resourceUnavailableException = new com.amazonaws.services.codestarconnections.model.ResourceUnavailableException(
                null);
