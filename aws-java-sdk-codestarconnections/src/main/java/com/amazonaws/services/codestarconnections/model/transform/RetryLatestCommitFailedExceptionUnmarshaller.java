...
public class RetryLatestCommitFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private RetryLatestCommitFailedExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.RetryLatestCommitFailedException.class, "RetryLatestCommitFailedException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.RetryLatestCommitFailedException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.codestarconnections.model.RetryLatestCommitFailedException retryLatestCommitFailedException = new com.amazonaws.services.codestarconnections.model.RetryLatestCommitFailedException(
                null);
