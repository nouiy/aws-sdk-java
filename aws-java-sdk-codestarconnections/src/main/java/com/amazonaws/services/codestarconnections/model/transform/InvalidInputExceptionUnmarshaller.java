...
public class InvalidInputExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidInputExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.InvalidInputException.class, "InvalidInputException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.InvalidInputException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarconnections.model.InvalidInputException invalidInputException = new com.amazonaws.services.codestarconnections.model.InvalidInputException(
                null);
