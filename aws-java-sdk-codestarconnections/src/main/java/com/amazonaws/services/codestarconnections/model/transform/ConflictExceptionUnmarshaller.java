...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarconnections.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.codestarconnections.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarconnections.model.ConflictException conflictException = new com.amazonaws.services.codestarconnections.model.ConflictException(
                null);
