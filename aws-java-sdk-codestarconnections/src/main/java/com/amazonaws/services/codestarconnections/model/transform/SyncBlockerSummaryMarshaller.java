...
/**
 * SyncBlockerSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SyncBlockerSummaryMarshaller {
    ...
    private static final SyncBlockerSummaryMarshaller instance = new SyncBlockerSummaryMarshaller();

    public static SyncBlockerSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SyncBlockerSummary syncBlockerSummary, ProtocolMarshaller protocolMarshaller) {

        if (syncBlockerSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(syncBlockerSummary.getResourceName(), RESOURCENAME_BINDING);
            protocolMarshaller.marshall(syncBlockerSummary.getParentResourceName(), PARENTRESOURCENAME_BINDING);
            protocolMarshaller.marshall(syncBlockerSummary.getLatestBlockers(), LATESTBLOCKERS_BINDING);
        } catch (Exception e) {
