...
public class UpdateStageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateStageResult withRouteSettings(java.util.Map<String, RouteSettings> routeSettings) {
     ...
     *
     * @see UpdateStageResult#withRouteSettings
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateStageResult addRouteSettingsEntry(String key, RouteSettings value) {
    ...
    public UpdateStageResult withStageVariables(java.util.Map<String, String> stageVariables) {
     ...
     *
     * @see UpdateStageResult#withStageVariables
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateStageResult addStageVariablesEntry(String key, String value) {
