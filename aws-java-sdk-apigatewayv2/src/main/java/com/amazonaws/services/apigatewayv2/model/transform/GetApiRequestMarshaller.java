...
/**
 * GetApiRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetApiRequestMarshaller {
    ...
    private static final GetApiRequestMarshaller instance = new GetApiRequestMarshaller();

    public static GetApiRequestMarshaller getInstance() {
        return instance;
    }
