...
/**
 * DeleteApiMappingResult JSON Unmarshaller
 */
...
public class DeleteApiMappingResultJsonUnmarshaller implements Unmarshaller<DeleteApiMappingResult, JsonUnmarshallerContext> {
    ...
    public DeleteApiMappingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteApiMappingResult deleteApiMappingResult = new DeleteApiMappingResult();
