...
@SdkInternalApi
public class GetRouteResponseRequestMarshaller {
    ...
    private static final GetRouteResponseRequestMarshaller instance = new GetRouteResponseRequestMarshaller();

    public static GetRouteResponseRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetRouteResponseRequest getRouteResponseRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRouteResponseRequest.getApiId(), APIID_BINDING);
            protocolMarshaller.marshall(getRouteResponseRequest.getRouteId(), ROUTEID_BINDING);
            protocolMarshaller.marshall(getRouteResponseRequest.getRouteResponseId(), ROUTERESPONSEID_BINDING);
        } catch (Exception e) {
