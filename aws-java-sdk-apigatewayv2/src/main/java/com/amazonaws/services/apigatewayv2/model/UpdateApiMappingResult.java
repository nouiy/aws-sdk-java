...
public class UpdateApiMappingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApiMappingResult == false)
            return false;
        UpdateApiMappingResult other = (UpdateApiMappingResult) obj;
    ...
    @Override
    public UpdateApiMappingResult clone() {
        try {
            return (UpdateApiMappingResult) super.clone();
