...
/**
 * GetApiMappingsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetApiMappingsResultJsonUnmarshaller implements Unmarshaller<GetApiMappingsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("items", targetDepth)) {
                    context.nextToken();
                    getApiMappingsResult.setItems(new ListUnmarshaller<ApiMapping>(ApiMappingJsonUnmarshaller.getInstance())
