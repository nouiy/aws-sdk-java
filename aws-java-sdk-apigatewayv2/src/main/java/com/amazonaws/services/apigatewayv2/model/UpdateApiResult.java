...
public class UpdateApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateApiResult withCreatedDate(java.util.Date createdDate) {
    ...
    public UpdateApiResult withImportInfo(java.util.Collection<String> importInfo) {
    ...
    public UpdateApiResult withWarnings(java.util.Collection<String> warnings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApiResult == false)
            return false;
        UpdateApiResult other = (UpdateApiResult) obj;
    ...
    public UpdateApiResult clone() {
        try {
            return (UpdateApiResult) super.clone();
