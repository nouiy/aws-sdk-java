...
public class UpdateDomainNameResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDomainNameResult withApiMappingSelectionExpression(String apiMappingSelectionExpression) {
    ...
    public UpdateDomainNameResult withDomainNameConfigurations(DomainNameConfiguration... domainNameConfigurations) {
    ...
    public UpdateDomainNameResult withDomainNameConfigurations(java.util.Collection<DomainNameConfiguration> domainNameConfigurations) {
