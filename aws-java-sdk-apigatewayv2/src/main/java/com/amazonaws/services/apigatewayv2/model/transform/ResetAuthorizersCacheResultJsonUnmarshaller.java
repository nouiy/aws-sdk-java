...
/**
 * ResetAuthorizersCacheResult JSON Unmarshaller
 */
...
public class ResetAuthorizersCacheResultJsonUnmarshaller implements Unmarshaller<ResetAuthorizersCacheResult, JsonUnmarshallerContext> {
    ...
    public ResetAuthorizersCacheResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResetAuthorizersCacheResult resetAuthorizersCacheResult = new ResetAuthorizersCacheResult();

        return resetAuthorizersCacheResult;
    }
