...
public class AuthorizerMarshaller {
    ...
    public void marshall(Authorizer authorizer, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(authorizer.getAuthorizerPayloadFormatVersion(), AUTHORIZERPAYLOADFORMATVERSION_BINDING);
            ...
            protocolMarshaller.marshall(authorizer.getEnableSimpleResponses(), ENABLESIMPLERESPONSES_BINDING);
