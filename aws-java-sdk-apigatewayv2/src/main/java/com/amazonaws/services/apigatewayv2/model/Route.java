...
public class Route implements Serializable, Cloneable, StructuredPojo {
    ...
    public Route withAuthorizationScopes(java.util.Collection<String> authorizationScopes) {
    ...
    public Route clearRequestModelsEntries() {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apigatewayv2.model.transform.RouteMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
