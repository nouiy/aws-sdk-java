...
public class GetRouteResponseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetRouteResponseResult withResponseModels(java.util.Map<String, String> responseModels) {
    ...
    public GetRouteResponseResult withResponseParameters(java.util.Map<String, ParameterConstraints> responseParameters) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRouteResponseResult == false)
            return false;
        GetRouteResponseResult other = (GetRouteResponseResult) obj;
    ...
    public GetRouteResponseResult clone() {
        try {
            return (GetRouteResponseResult) super.clone();
