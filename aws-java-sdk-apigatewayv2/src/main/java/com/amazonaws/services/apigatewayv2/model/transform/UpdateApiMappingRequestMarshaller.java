...
@SdkInternalApi
public class UpdateApiMappingRequestMarshaller {
    ...
    private static final UpdateApiMappingRequestMarshaller instance = new UpdateApiMappingRequestMarshaller();

    public static UpdateApiMappingRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateApiMappingRequest updateApiMappingRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateApiMappingRequest.getApiId(), APIID_BINDING);
            protocolMarshaller.marshall(updateApiMappingRequest.getApiMappingId(), APIMAPPINGID_BINDING);
            protocolMarshaller.marshall(updateApiMappingRequest.getApiMappingKey(), APIMAPPINGKEY_BINDING);
            protocolMarshaller.marshall(updateApiMappingRequest.getDomainName(), DOMAINNAME_BINDING);
            protocolMarshaller.marshall(updateApiMappingRequest.getStage(), STAGE_BINDING);
        } catch (Exception e) {
