...
public class CreateApiResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateApiResult withImportInfo(java.util.Collection<String> importInfo) {
    ...
    public CreateApiResult withWarnings(java.util.Collection<String> warnings) {
