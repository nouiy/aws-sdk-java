...
/**
 * DeleteRouteRequestParameterResult JSON Unmarshaller
 */
...
public class DeleteRouteRequestParameterResultJsonUnmarshaller implements Unmarshaller<DeleteRouteRequestParameterResult, JsonUnmarshallerContext> {
    ...
    public DeleteRouteRequestParameterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRouteRequestParameterResult deleteRouteRequestParameterResult = new DeleteRouteRequestParameterResult();

        return deleteRouteRequestParameterResult;
    }
