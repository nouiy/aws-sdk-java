...
/**
 * JWTConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JWTConfigurationJsonUnmarshaller implements Unmarshaller<JWTConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("issuer", targetDepth)) {
                    context.nextToken();
                    jWTConfiguration.setIssuer(context.getUnmarshaller(String.class).unmarshall(context));
                }
