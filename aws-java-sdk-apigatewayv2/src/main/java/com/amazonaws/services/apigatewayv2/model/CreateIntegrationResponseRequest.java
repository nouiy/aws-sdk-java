...
public class CreateIntegrationResponseRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateIntegrationResponseRequest withContentHandlingStrategy(String contentHandlingStrategy) {
    ...
    public CreateIntegrationResponseRequest withContentHandlingStrategy(ContentHandlingStrategy contentHandlingStrategy) {
    ...
    public CreateIntegrationResponseRequest withIntegrationResponseKey(String integrationResponseKey) {
    ...
    public CreateIntegrationResponseRequest withResponseParameters(java.util.Map<String, String> responseParameters) {
    ...
    public CreateIntegrationResponseRequest clearResponseParametersEntries() {
    ...
    public CreateIntegrationResponseRequest withResponseTemplates(java.util.Map<String, String> responseTemplates) {
    ...
    public CreateIntegrationResponseRequest clearResponseTemplatesEntries() {
    ...
    public CreateIntegrationResponseRequest withTemplateSelectionExpression(String templateSelectionExpression) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIntegrationResponseRequest == false)
            return false;
        CreateIntegrationResponseRequest other = (CreateIntegrationResponseRequest) obj;
    ...
    @Override
    public CreateIntegrationResponseRequest clone() {
        return (CreateIntegrationResponseRequest) super.clone();
    }
