...
public class GetAuthorizersRequestMarshaller {
    ...
    public void marshall(GetAuthorizersRequest getAuthorizersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAuthorizersRequest.getApiId(), APIID_BINDING);
            protocolMarshaller.marshall(getAuthorizersRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(getAuthorizersRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
