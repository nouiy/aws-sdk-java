...
public class GetDomainNameRequestMarshaller {
    ...
    private static final GetDomainNameRequestMarshaller instance = new GetDomainNameRequestMarshaller();

    public static GetDomainNameRequestMarshaller getInstance() {
        return instance;
    }
