...
public class GetVpcLinkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetVpcLinkResult withCreatedDate(java.util.Date createdDate) {
    ...
    public GetVpcLinkResult withSecurityGroupIds(String... securityGroupIds) {
    ...
    public GetVpcLinkResult withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    public GetVpcLinkResult withSubnetIds(String... subnetIds) {
    ...
    public GetVpcLinkResult withSubnetIds(java.util.Collection<String> subnetIds) {
