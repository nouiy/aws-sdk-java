...
public class CreateVpcLinkRequestMarshaller {
    ...
    public void marshall(CreateVpcLinkRequest createVpcLinkRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createVpcLinkRequest.getSecurityGroupIds(), SECURITYGROUPIDS_BINDING);
            protocolMarshaller.marshall(createVpcLinkRequest.getSubnetIds(), SUBNETIDS_BINDING);
