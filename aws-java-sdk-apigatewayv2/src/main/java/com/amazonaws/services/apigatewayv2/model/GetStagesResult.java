...
public class GetStagesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<Stage> items;
    /**
     * <p>
    ...
    public java.util.List<Stage> getItems() {
        return items;
    }
    ...
    public GetStagesResult withItems(Stage... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<Stage>(items.length));
        }
        for (Stage ele : items) {
            this.items.add(ele);
        }
    ...
    public GetStagesResult withItems(java.util.Collection<Stage> items) {
        setItems(items);
        return this;
    }
    ...
    public GetStagesResult withNextToken(String nextToken) {
