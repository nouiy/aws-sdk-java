...
public class XksKeyAlreadyInUseException extends com.amazonaws.services.kms.model.AWSKMSException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new XksKeyAlreadyInUseException with the specified error message.
     *
     * @param message
