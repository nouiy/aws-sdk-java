...
/**
 * MultiRegionConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MultiRegionConfigurationJsonUnmarshaller implements Unmarshaller<MultiRegionConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ReplicaKeys", targetDepth)) {
                    context.nextToken();
                    multiRegionConfiguration.setReplicaKeys(new ListUnmarshaller<MultiRegionKey>(MultiRegionKeyJsonUnmarshaller.getInstance())
