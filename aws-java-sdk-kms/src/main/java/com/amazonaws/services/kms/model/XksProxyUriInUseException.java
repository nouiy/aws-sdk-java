...
public class XksProxyUriInUseException extends com.amazonaws.services.kms.model.AWSKMSException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new XksProxyUriInUseException with the specified error message.
     *
     * @param message
