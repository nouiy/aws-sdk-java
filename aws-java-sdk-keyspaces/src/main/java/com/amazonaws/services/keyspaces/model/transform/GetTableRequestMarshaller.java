...
public class GetTableRequestMarshaller {
    ...
    public static GetTableRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetTableRequest getTableRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getTableRequest.getKeyspaceName(), KEYSPACENAME_BINDING);
            protocolMarshaller.marshall(getTableRequest.getTableName(), TABLENAME_BINDING);
        } catch (Exception e) {
