...
public class CreateKeyspaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateKeyspaceResult == false)
            return false;
        CreateKeyspaceResult other = (CreateKeyspaceResult) obj;
    ...
    public CreateKeyspaceResult clone() {
        try {
            return (CreateKeyspaceResult) super.clone();
