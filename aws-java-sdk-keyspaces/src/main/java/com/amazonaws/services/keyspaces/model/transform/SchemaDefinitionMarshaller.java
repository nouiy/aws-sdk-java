...
public class SchemaDefinitionMarshaller {
    ...
    private static final MarshallingInfo<List> ALLCOLUMNS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("allColumns").build();
    ...
    private static final MarshallingInfo<List> CLUSTERINGKEYS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("clusteringKeys").build();
    private static final MarshallingInfo<List> STATICCOLUMNS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("staticColumns").build();
