...
/**
 * GetRawMessageContentResult JSON Unmarshaller
 */
...
public class GetRawMessageContentResultJsonUnmarshaller implements Unmarshaller<GetRawMessageContentResult, JsonUnmarshallerContext> {
    ...
    public GetRawMessageContentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetRawMessageContentResult getRawMessageContentResult = new GetRawMessageContentResult();

        getRawMessageContentResult.setMessageContent(context.getHttpResponse().getContent());
