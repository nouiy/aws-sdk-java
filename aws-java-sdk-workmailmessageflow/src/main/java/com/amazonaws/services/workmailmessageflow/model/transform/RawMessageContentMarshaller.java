...
public class RawMessageContentMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> S3REFERENCE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("s3Reference").build();
    ...
    public void marshall(RawMessageContent rawMessageContent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rawMessageContent.getS3Reference(), S3REFERENCE_BINDING);
        } catch (Exception e) {
