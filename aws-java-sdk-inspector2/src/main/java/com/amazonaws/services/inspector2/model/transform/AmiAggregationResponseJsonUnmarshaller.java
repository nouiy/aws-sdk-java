...
/**
 * AmiAggregationResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AmiAggregationResponseJsonUnmarshaller implements Unmarshaller<AmiAggregationResponse, JsonUnmarshallerContext> {

    public AmiAggregationResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        AmiAggregationResponse amiAggregationResponse = new AmiAggregationResponse();
    ...
    private static AmiAggregationResponseJsonUnmarshaller instance;

    public static AmiAggregationResponseJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AmiAggregationResponseJsonUnmarshaller();
        return instance;
    }
}
