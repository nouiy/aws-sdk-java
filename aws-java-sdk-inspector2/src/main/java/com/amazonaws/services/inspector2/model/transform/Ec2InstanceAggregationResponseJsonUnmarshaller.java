...
/**
 * Ec2InstanceAggregationResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Ec2InstanceAggregationResponseJsonUnmarshaller implements Unmarshaller<Ec2InstanceAggregationResponse, JsonUnmarshallerContext> {

    public Ec2InstanceAggregationResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        Ec2InstanceAggregationResponse ec2InstanceAggregationResponse = new Ec2InstanceAggregationResponse();
    ...
    private static Ec2InstanceAggregationResponseJsonUnmarshaller instance;

    public static Ec2InstanceAggregationResponseJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new Ec2InstanceAggregationResponseJsonUnmarshaller();
        return instance;
    }
}
