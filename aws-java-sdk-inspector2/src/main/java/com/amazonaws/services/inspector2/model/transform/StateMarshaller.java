...
public class StateMarshaller {
    ...
    public void marshall(State state, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(state.getErrorCode(), ERRORCODE_BINDING);
            protocolMarshaller.marshall(state.getErrorMessage(), ERRORMESSAGE_BINDING);
            protocolMarshaller.marshall(state.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
