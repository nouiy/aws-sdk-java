        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("componentId", targetDepth)) {
                    context.nextToken();
                    step.setComponentId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("componentType", targetDepth)) {
                    context.nextToken();
                    step.setComponentType(context.getUnmarshaller(String.class).unmarshall(context));
                }
