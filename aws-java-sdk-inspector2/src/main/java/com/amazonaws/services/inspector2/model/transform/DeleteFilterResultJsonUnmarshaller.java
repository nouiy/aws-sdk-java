...
/**
 * DeleteFilterResult JSON Unmarshaller
 */
...
public class DeleteFilterResultJsonUnmarshaller implements Unmarshaller<DeleteFilterResult, JsonUnmarshallerContext> {
    ...
    public DeleteFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFilterResult deleteFilterResult = new DeleteFilterResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    deleteFilterResult.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
