        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("lowerInclusive", targetDepth)) {
                    context.nextToken();
                    numberFilter.setLowerInclusive(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("upperInclusive", targetDepth)) {
                    context.nextToken();
                    numberFilter.setUpperInclusive(context.getUnmarshaller(Double.class).unmarshall(context));
                }
