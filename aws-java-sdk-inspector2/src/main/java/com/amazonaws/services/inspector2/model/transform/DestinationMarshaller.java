...
public class DestinationMarshaller {
    ...
    public void marshall(Destination destination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(destination.getBucketName(), BUCKETNAME_BINDING);
            protocolMarshaller.marshall(destination.getKeyPrefix(), KEYPREFIX_BINDING);
            protocolMarshaller.marshall(destination.getKmsKeyArn(), KMSKEYARN_BINDING);
        } catch (Exception e) {
