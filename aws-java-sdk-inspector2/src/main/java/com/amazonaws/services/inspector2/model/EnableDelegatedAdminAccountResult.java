...
public class EnableDelegatedAdminAccountResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableDelegatedAdminAccountResult == false)
            return false;
        EnableDelegatedAdminAccountResult other = (EnableDelegatedAdminAccountResult) obj;
    ...
    public EnableDelegatedAdminAccountResult clone() {
        try {
            return (EnableDelegatedAdminAccountResult) super.clone();
