...
public class LambdaVpcConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public LambdaVpcConfig withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    public LambdaVpcConfig withSubnetIds(java.util.Collection<String> subnetIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LambdaVpcConfig == false)
            return false;
        LambdaVpcConfig other = (LambdaVpcConfig) obj;
    ...
    public LambdaVpcConfig clone() {
        try {
            return (LambdaVpcConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.inspector2.model.transform.LambdaVpcConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
