...
public class CancelFindingsReportResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the canceled report.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelFindingsReportResult == false)
            return false;
        CancelFindingsReportResult other = (CancelFindingsReportResult) obj;
    ...
    public CancelFindingsReportResult clone() {
        try {
            return (CancelFindingsReportResult) super.clone();
