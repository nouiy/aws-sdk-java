        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("delegatedAdminAccountId", targetDepth)) {
                    context.nextToken();
                    member.setDelegatedAdminAccountId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("updatedAt", targetDepth)) {
                    context.nextToken();
                    member.setUpdatedAt(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
