        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("operation", targetDepth)) {
                    context.nextToken();
                    permission.setOperation(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("service", targetDepth)) {
                    context.nextToken();
                    permission.setService(context.getUnmarshaller(String.class).unmarshall(context));
                }
