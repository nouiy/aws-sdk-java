...
/**
 * PackageFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PackageFilterJsonUnmarshaller implements Unmarshaller<PackageFilter, JsonUnmarshallerContext> {

    public PackageFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PackageFilterJsonUnmarshaller instance;

    public static PackageFilterJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PackageFilterJsonUnmarshaller();
        return instance;
    }
}
