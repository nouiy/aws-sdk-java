        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SessionConfiguration", targetDepth)) {
                    context.nextToken();
                    profileConfiguration.setSessionConfiguration(new MapUnmarshaller<String, ConfigurationObject>(context.getUnmarshaller(String.class),
                            ConfigurationObjectJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("JobConfiguration", targetDepth)) {
                    context.nextToken();
                    profileConfiguration.setJobConfiguration(new MapUnmarshaller<String, ConfigurationObject>(context.getUnmarshaller(String.class),
                            ConfigurationObjectJsonUnmarshaller.getInstance()).unmarshall(context));
                }
