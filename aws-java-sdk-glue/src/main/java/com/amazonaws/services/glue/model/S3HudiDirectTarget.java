 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/S3HudiDirectTarget" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3HudiDirectTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public S3HudiDirectTarget withInputs(java.util.Collection<String> inputs) {
        setInputs(inputs);
        return this;
    }
    ...
    public S3HudiDirectTarget withPartitionKeys(java.util.List<String>... partitionKeys) {
    ...
    public S3HudiDirectTarget withPartitionKeys(java.util.Collection<java.util.List<String>> partitionKeys) {
     ...
     *
     * @see S3HudiDirectTarget#withAdditionalOptions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public S3HudiDirectTarget addAdditionalOptionsEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof S3HudiDirectTarget == false)
            return false;
    ...
    public S3HudiDirectTarget clone() {
        try {
            return (S3HudiDirectTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.S3HudiDirectTargetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
