 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/S3CatalogDeltaSource" target="_top">AWS API
 *      Documentation</a>
 */
...
public class S3CatalogDeltaSource implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see S3CatalogDeltaSource#withAdditionalDeltaOptions
     * @returns a reference to this object so that method calls can be chained together.
     */

    public S3CatalogDeltaSource addAdditionalDeltaOptionsEntry(String key, String value) {
    ...
    public S3CatalogDeltaSource withOutputSchemas(java.util.Collection<GlueSchema> outputSchemas) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof S3CatalogDeltaSource == false)
            return false;
        S3CatalogDeltaSource other = (S3CatalogDeltaSource) obj;
    ...
    @Override
    public S3CatalogDeltaSource clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.S3CatalogDeltaSourceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
