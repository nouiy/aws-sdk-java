...
/**
 * DeleteColumnStatisticsForTableResult JSON Unmarshaller
 */
...
public class DeleteColumnStatisticsForTableResultJsonUnmarshaller implements Unmarshaller<DeleteColumnStatisticsForTableResult, JsonUnmarshallerContext> {
    ...
    public DeleteColumnStatisticsForTableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteColumnStatisticsForTableResult deleteColumnStatisticsForTableResult = new DeleteColumnStatisticsForTableResult();
