...
/**
 * DeleteClassifierResult JSON Unmarshaller
 */
...
public class DeleteClassifierResultJsonUnmarshaller implements Unmarshaller<DeleteClassifierResult, JsonUnmarshallerContext> {
    ...
    public DeleteClassifierResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteClassifierResult deleteClassifierResult = new DeleteClassifierResult();
