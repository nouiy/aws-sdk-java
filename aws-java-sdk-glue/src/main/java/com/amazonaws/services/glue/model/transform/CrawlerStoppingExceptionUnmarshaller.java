...
public class CrawlerStoppingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CrawlerStoppingExceptionUnmarshaller instance;

    public static CrawlerStoppingExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CrawlerStoppingExceptionUnmarshaller();
        return instance;
    }
}
