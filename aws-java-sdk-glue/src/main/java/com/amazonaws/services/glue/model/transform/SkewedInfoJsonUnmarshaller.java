...
/**
 * SkewedInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SkewedInfoJsonUnmarshaller implements Unmarshaller<SkewedInfo, JsonUnmarshallerContext> {
    ...
    private static SkewedInfoJsonUnmarshaller instance;

    public static SkewedInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SkewedInfoJsonUnmarshaller();
        return instance;
    }
}
