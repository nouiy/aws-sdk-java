...
/**
 * CreateMLTransformResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateMLTransformResultJsonUnmarshaller implements Unmarshaller<CreateMLTransformResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TransformId", targetDepth)) {
                    context.nextToken();
                    createMLTransformResult.setTransformId(context.getUnmarshaller(String.class).unmarshall(context));
                }
