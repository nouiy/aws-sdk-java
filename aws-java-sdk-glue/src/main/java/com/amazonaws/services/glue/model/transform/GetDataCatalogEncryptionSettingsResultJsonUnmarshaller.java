...
/**
 * GetDataCatalogEncryptionSettingsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDataCatalogEncryptionSettingsResultJsonUnmarshaller implements Unmarshaller<GetDataCatalogEncryptionSettingsResult, JsonUnmarshallerContext> {

    public GetDataCatalogEncryptionSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataCatalogEncryptionSettings", targetDepth)) {
                    context.nextToken();
                    getDataCatalogEncryptionSettingsResult.setDataCatalogEncryptionSettings(DataCatalogEncryptionSettingsJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
