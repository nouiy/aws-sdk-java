...
public class DeleteConnectionRequestMarshaller {
    ...
    public void marshall(DeleteConnectionRequest deleteConnectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteConnectionRequest.getCatalogId(), CATALOGID_BINDING);
            protocolMarshaller.marshall(deleteConnectionRequest.getConnectionName(), CONNECTIONNAME_BINDING);
        } catch (Exception e) {
