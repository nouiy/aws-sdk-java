...
/**
 * CreateCrawlerResult JSON Unmarshaller
 */
...
public class CreateCrawlerResultJsonUnmarshaller implements Unmarshaller<CreateCrawlerResult, JsonUnmarshallerContext> {
    ...
    public CreateCrawlerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateCrawlerResult createCrawlerResult = new CreateCrawlerResult();
