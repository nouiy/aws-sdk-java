...
public class StopSessionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the session to be stopped.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopSessionRequest == false)
            return false;
        StopSessionRequest other = (StopSessionRequest) obj;
    ...
    public StopSessionRequest clone() {
        return (StopSessionRequest) super.clone();
    }
