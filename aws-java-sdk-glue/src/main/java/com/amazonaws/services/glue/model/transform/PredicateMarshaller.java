...
public class PredicateMarshaller {
    ...
    private static final MarshallingInfo<String> LOGICAL_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Logical").build();
