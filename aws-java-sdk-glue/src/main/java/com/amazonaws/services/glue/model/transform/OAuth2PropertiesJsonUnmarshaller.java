        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("OAuth2ClientApplication", targetDepth)) {
                    context.nextToken();
                    oAuth2Properties.setOAuth2ClientApplication(OAuth2ClientApplicationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("TokenUrlParametersMap", targetDepth)) {
                    context.nextToken();
                    oAuth2Properties.setTokenUrlParametersMap(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
