...
/**
 * CatalogHudiSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CatalogHudiSourceMarshaller {
    ...
    private static final CatalogHudiSourceMarshaller instance = new CatalogHudiSourceMarshaller();

    public static CatalogHudiSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CatalogHudiSource catalogHudiSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(catalogHudiSource.getName(), NAME_BINDING);
            protocolMarshaller.marshall(catalogHudiSource.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(catalogHudiSource.getTable(), TABLE_BINDING);
            protocolMarshaller.marshall(catalogHudiSource.getAdditionalHudiOptions(), ADDITIONALHUDIOPTIONS_BINDING);
            protocolMarshaller.marshall(catalogHudiSource.getOutputSchemas(), OUTPUTSCHEMAS_BINDING);
        } catch (Exception e) {
