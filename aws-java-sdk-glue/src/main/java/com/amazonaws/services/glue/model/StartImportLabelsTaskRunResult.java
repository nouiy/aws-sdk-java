...
public class StartImportLabelsTaskRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartImportLabelsTaskRunResult == false)
            return false;
        StartImportLabelsTaskRunResult other = (StartImportLabelsTaskRunResult) obj;
    ...
    @Override
    public StartImportLabelsTaskRunResult clone() {
        try {
            return (StartImportLabelsTaskRunResult) super.clone();
