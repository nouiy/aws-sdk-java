...
/**
 * DeletePartitionResult JSON Unmarshaller
 */
...
public class DeletePartitionResultJsonUnmarshaller implements Unmarshaller<DeletePartitionResult, JsonUnmarshallerContext> {
    ...
    public DeletePartitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePartitionResult deletePartitionResult = new DeletePartitionResult();
