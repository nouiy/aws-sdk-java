...
public class ProfileConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Map> SESSIONCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.MAP)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SessionConfiguration").build();
    private static final MarshallingInfo<Map> JOBCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.MAP)
    ...
    public void marshall(ProfileConfiguration profileConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(profileConfiguration.getSessionConfiguration(), SESSIONCONFIGURATION_BINDING);
            protocolMarshaller.marshall(profileConfiguration.getJobConfiguration(), JOBCONFIGURATION_BINDING);
        } catch (Exception e) {
