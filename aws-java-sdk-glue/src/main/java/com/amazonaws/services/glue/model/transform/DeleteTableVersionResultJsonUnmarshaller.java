...
/**
 * DeleteTableVersionResult JSON Unmarshaller
 */
...
public class DeleteTableVersionResultJsonUnmarshaller implements Unmarshaller<DeleteTableVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteTableVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTableVersionResult deleteTableVersionResult = new DeleteTableVersionResult();
