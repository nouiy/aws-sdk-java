 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/CreateJsonClassifierRequest" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateJsonClassifierRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateJsonClassifierRequest clone() {
        try {
            return (CreateJsonClassifierRequest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.CreateJsonClassifierRequestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
