...
/**
 * DeleteTableOptimizerResult JSON Unmarshaller
 */
...
public class DeleteTableOptimizerResultJsonUnmarshaller implements Unmarshaller<DeleteTableOptimizerResult, JsonUnmarshallerContext> {
    ...
    public DeleteTableOptimizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTableOptimizerResult deleteTableOptimizerResult = new DeleteTableOptimizerResult();

        return deleteTableOptimizerResult;
    }
