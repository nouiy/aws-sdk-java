 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/TriggerNodeDetails" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TriggerNodeDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public TriggerNodeDetails clone() {
        try {
            return (TriggerNodeDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.TriggerNodeDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
