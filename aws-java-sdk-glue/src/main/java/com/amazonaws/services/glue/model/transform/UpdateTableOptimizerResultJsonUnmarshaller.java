...
/**
 * UpdateTableOptimizerResult JSON Unmarshaller
 */
...
public class UpdateTableOptimizerResultJsonUnmarshaller implements Unmarshaller<UpdateTableOptimizerResult, JsonUnmarshallerContext> {
    ...
    public UpdateTableOptimizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateTableOptimizerResult updateTableOptimizerResult = new UpdateTableOptimizerResult();

        return updateTableOptimizerResult;
    }
