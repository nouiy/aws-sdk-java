...
public class ResourceUriMarshaller {
    ...
    public void marshall(ResourceUri resourceUri, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceUri.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(resourceUri.getUri(), URI_BINDING);
        } catch (Exception e) {
