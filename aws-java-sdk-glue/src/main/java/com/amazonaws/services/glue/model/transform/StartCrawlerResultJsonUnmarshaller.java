...
/**
 * StartCrawlerResult JSON Unmarshaller
 */
...
public class StartCrawlerResultJsonUnmarshaller implements Unmarshaller<StartCrawlerResult, JsonUnmarshallerContext> {
    ...
    public StartCrawlerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartCrawlerResult startCrawlerResult = new StartCrawlerResult();
