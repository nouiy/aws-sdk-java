...
public class ConfigurationObjectMarshaller {
    ...
    public void marshall(ConfigurationObject configurationObject, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(configurationObject.getDefaultValue(), DEFAULTVALUE_BINDING);
            protocolMarshaller.marshall(configurationObject.getAllowedValues(), ALLOWEDVALUES_BINDING);
            protocolMarshaller.marshall(configurationObject.getMinValue(), MINVALUE_BINDING);
            protocolMarshaller.marshall(configurationObject.getMaxValue(), MAXVALUE_BINDING);
        } catch (Exception e) {
