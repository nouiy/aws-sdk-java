...
public class MLTransformNotReadyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MLTransformNotReadyExceptionUnmarshaller instance;

    public static MLTransformNotReadyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MLTransformNotReadyExceptionUnmarshaller();
        return instance;
    }
}
