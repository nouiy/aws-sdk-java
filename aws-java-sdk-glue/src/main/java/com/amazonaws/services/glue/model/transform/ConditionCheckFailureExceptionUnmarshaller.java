...
public class ConditionCheckFailureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ConditionCheckFailureExceptionUnmarshaller instance;

    public static ConditionCheckFailureExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConditionCheckFailureExceptionUnmarshaller();
        return instance;
    }
}
