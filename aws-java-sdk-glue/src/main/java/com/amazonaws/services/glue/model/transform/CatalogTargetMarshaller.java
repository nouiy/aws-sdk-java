...
@SdkInternalApi
public class CatalogTargetMarshaller {
    ...
    public static CatalogTargetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CatalogTarget catalogTarget, ProtocolMarshaller protocolMarshaller) {
