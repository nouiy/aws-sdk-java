...
public class SchedulerTransitioningExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SchedulerTransitioningExceptionUnmarshaller instance;

    public static SchedulerTransitioningExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SchedulerTransitioningExceptionUnmarshaller();
        return instance;
    }
}
