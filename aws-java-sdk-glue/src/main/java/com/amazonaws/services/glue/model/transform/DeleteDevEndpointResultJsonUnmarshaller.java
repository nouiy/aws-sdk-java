...
/**
 * DeleteDevEndpointResult JSON Unmarshaller
 */
...
public class DeleteDevEndpointResultJsonUnmarshaller implements Unmarshaller<DeleteDevEndpointResult, JsonUnmarshallerContext> {
    ...
    public DeleteDevEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDevEndpointResult deleteDevEndpointResult = new DeleteDevEndpointResult();
