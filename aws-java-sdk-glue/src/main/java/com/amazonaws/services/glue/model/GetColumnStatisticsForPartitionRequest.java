...
public class GetColumnStatisticsForPartitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetColumnStatisticsForPartitionRequest withPartitionValues(java.util.Collection<String> partitionValues) {
    ...
    public GetColumnStatisticsForPartitionRequest withColumnNames(java.util.Collection<String> columnNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetColumnStatisticsForPartitionRequest == false)
            return false;
        GetColumnStatisticsForPartitionRequest other = (GetColumnStatisticsForPartitionRequest) obj;
    ...
    public GetColumnStatisticsForPartitionRequest clone() {
        return (GetColumnStatisticsForPartitionRequest) super.clone();
    }
