...
public class GetDatabaseRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The ID of the Data Catalog in which the database resides. If none is provided, the Amazon Web Services account ID
     * is used by default.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The ID of the Data Catalog in which the database resides. If none is provided, the Amazon Web Services
     *         account ID is used by default.
     */
     ...
     * </p>
     * 
     * @return The name of the database to retrieve. For Hive compatibility, this should be all lowercase.
     */
