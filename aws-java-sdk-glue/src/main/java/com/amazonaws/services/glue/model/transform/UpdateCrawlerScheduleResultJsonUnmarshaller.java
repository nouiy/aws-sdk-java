...
/**
 * UpdateCrawlerScheduleResult JSON Unmarshaller
 */
...
public class UpdateCrawlerScheduleResultJsonUnmarshaller implements Unmarshaller<UpdateCrawlerScheduleResult, JsonUnmarshallerContext> {
    ...
    public UpdateCrawlerScheduleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCrawlerScheduleResult updateCrawlerScheduleResult = new UpdateCrawlerScheduleResult();
