...
/**
 * StopWorkflowRunResult JSON Unmarshaller
 */
...
public class StopWorkflowRunResultJsonUnmarshaller implements Unmarshaller<StopWorkflowRunResult, JsonUnmarshallerContext> {
    ...
    public StopWorkflowRunResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopWorkflowRunResult stopWorkflowRunResult = new StopWorkflowRunResult();

        return stopWorkflowRunResult;
    }
