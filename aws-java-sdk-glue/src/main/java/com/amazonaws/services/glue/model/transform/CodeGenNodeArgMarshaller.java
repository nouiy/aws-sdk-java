...
public class CodeGenNodeArgMarshaller {
    ...
    private static final MarshallingInfo<Boolean> PARAM_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Param").build();
