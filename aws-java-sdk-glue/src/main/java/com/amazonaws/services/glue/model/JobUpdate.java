...
public class JobUpdate implements Serializable, Cloneable, StructuredPojo {
    ...
    public JobUpdate withJobMode(String jobMode) {
        setJobMode(jobMode);
        return this;
    }
    ...
    public JobUpdate withJobMode(JobMode jobMode) {
    ...
    public JobUpdate withMaintenanceWindow(String maintenanceWindow) {
