...
public class GetTriggerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The requested trigger definition.
     */
    ...
    @Override
    public GetTriggerResult clone() {
        try {
            return (GetTriggerResult) super.clone();
