...
public class ListStatementsRequestMarshaller {
    ...
    public void marshall(ListStatementsRequest listStatementsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listStatementsRequest.getSessionId(), SESSIONID_BINDING);
            protocolMarshaller.marshall(listStatementsRequest.getRequestOrigin(), REQUESTORIGIN_BINDING);
