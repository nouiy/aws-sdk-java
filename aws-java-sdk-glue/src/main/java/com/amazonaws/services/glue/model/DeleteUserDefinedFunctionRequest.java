...
public class DeleteUserDefinedFunctionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The ID of the Data Catalog where the function to be deleted is located. If none is supplied, the Amazon Web
     ...
     * 
     * @param catalogId
     *        The ID of the Data Catalog where the function to be deleted is located. If none is supplied, the Amazon
     ...
     * </p>
     * 
     * @return The ID of the Data Catalog where the function to be deleted is located. If none is supplied, the Amazon
     *         Web Services account ID is used by default.
     */
