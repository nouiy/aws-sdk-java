...
@SdkInternalApi
public class GetSchemaVersionRequestMarshaller {
    ...
    private static final GetSchemaVersionRequestMarshaller instance = new GetSchemaVersionRequestMarshaller();

    public static GetSchemaVersionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetSchemaVersionRequest getSchemaVersionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSchemaVersionRequest.getSchemaId(), SCHEMAID_BINDING);
            protocolMarshaller.marshall(getSchemaVersionRequest.getSchemaVersionId(), SCHEMAVERSIONID_BINDING);
            protocolMarshaller.marshall(getSchemaVersionRequest.getSchemaVersionNumber(), SCHEMAVERSIONNUMBER_BINDING);
        } catch (Exception e) {
