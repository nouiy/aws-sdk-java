...
@SdkInternalApi
public class GetTriggerRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Name").build();

    private static final GetTriggerRequestMarshaller instance = new GetTriggerRequestMarshaller();

    public static GetTriggerRequestMarshaller getInstance() {
        return instance;
    }
