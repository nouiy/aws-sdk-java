...
public class ListBlueprintsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Filters the list by an Amazon Web Services resource tag.
     */
     ...
     *
     * @see ListBlueprintsRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ListBlueprintsRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListBlueprintsRequest == false)
            return false;
    ...
    public ListBlueprintsRequest clone() {
        return (ListBlueprintsRequest) super.clone();
    }
