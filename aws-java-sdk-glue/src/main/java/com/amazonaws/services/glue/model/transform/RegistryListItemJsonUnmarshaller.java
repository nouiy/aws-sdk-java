...
/**
 * RegistryListItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegistryListItemJsonUnmarshaller implements Unmarshaller<RegistryListItem, JsonUnmarshallerContext> {

    public RegistryListItem unmarshall(JsonUnmarshallerContext context) throws Exception {
        RegistryListItem registryListItem = new RegistryListItem();
    ...
    private static RegistryListItemJsonUnmarshaller instance;

    public static RegistryListItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RegistryListItemJsonUnmarshaller();
        return instance;
    }
}
