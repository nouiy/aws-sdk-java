...
/**
 * DecimalColumnStatisticsData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DecimalColumnStatisticsDataJsonUnmarshaller implements Unmarshaller<DecimalColumnStatisticsData, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MinimumValue", targetDepth)) {
                    context.nextToken();
                    decimalColumnStatisticsData.setMinimumValue(DecimalNumberJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("MaximumValue", targetDepth)) {
                    context.nextToken();
                    decimalColumnStatisticsData.setMaximumValue(DecimalNumberJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("NumberOfNulls", targetDepth)) {
                    context.nextToken();
                    decimalColumnStatisticsData.setNumberOfNulls(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("NumberOfDistinctValues", targetDepth)) {
                    context.nextToken();
                    decimalColumnStatisticsData.setNumberOfDistinctValues(context.getUnmarshaller(Long.class).unmarshall(context));
                }
