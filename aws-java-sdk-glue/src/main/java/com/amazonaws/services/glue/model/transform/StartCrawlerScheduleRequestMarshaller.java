...
/**
 * StartCrawlerScheduleRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartCrawlerScheduleRequestMarshaller {
    ...
    private static final StartCrawlerScheduleRequestMarshaller instance = new StartCrawlerScheduleRequestMarshaller();

    public static StartCrawlerScheduleRequestMarshaller getInstance() {
        return instance;
    }
