...
/**
 * TransformFilterCriteriaMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TransformFilterCriteriaMarshaller {
    ...
    private static final TransformFilterCriteriaMarshaller instance = new TransformFilterCriteriaMarshaller();

    public static TransformFilterCriteriaMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TransformFilterCriteria transformFilterCriteria, ProtocolMarshaller protocolMarshaller) {

        if (transformFilterCriteria == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(transformFilterCriteria.getLastModifiedAfter(), LASTMODIFIEDAFTER_BINDING);
            protocolMarshaller.marshall(transformFilterCriteria.getSchema(), SCHEMA_BINDING);
        } catch (Exception e) {
