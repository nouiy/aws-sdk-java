...
public class DeleteSessionRequestMarshaller {
    ...
    public void marshall(DeleteSessionRequest deleteSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteSessionRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(deleteSessionRequest.getRequestOrigin(), REQUESTORIGIN_BINDING);
        } catch (Exception e) {
