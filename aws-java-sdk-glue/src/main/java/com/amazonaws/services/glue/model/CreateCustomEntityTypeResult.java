...
public class CreateCustomEntityTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCustomEntityTypeResult == false)
            return false;
        CreateCustomEntityTypeResult other = (CreateCustomEntityTypeResult) obj;
    ...
    public CreateCustomEntityTypeResult clone() {
        try {
            return (CreateCustomEntityTypeResult) super.clone();
