...
/**
 * S3Encryption JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3EncryptionJsonUnmarshaller implements Unmarshaller<S3Encryption, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("S3EncryptionMode", targetDepth)) {
                    context.nextToken();
                    s3Encryption.setS3EncryptionMode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("KmsKeyArn", targetDepth)) {
                    context.nextToken();
                    s3Encryption.setKmsKeyArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
