...
/**
 * GetColumnStatisticsForTableResult JSON Unmarshaller
 */
...
public class GetColumnStatisticsForTableResultJsonUnmarshaller implements Unmarshaller<GetColumnStatisticsForTableResult, JsonUnmarshallerContext> {
    ...
    public GetColumnStatisticsForTableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
