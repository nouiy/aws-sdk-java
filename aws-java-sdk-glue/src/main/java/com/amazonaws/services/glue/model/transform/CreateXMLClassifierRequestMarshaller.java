...
/**
 * CreateXMLClassifierRequestMarshaller
 */
...
public class CreateXMLClassifierRequestMarshaller {
    ...
    public void marshall(CreateXMLClassifierRequest createXMLClassifierRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        if (createXMLClassifierRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createXMLClassifierRequest.getClassification(), CLASSIFICATION_BINDING);
            protocolMarshaller.marshall(createXMLClassifierRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createXMLClassifierRequest.getRowTag(), ROWTAG_BINDING);
        } catch (Exception e) {
