...
public class CreateScriptRequestMarshaller {
    ...
    private static final MarshallingInfo<List> DAGNODES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("DagNodes").build();
    private static final MarshallingInfo<List> DAGEDGES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("DagEdges").build();
