...
/**
 * GetUserDefinedFunctionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetUserDefinedFunctionsResultJsonUnmarshaller implements Unmarshaller<GetUserDefinedFunctionsResult, JsonUnmarshallerContext> {

    public GetUserDefinedFunctionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    getUserDefinedFunctionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
