...
/**
 * GetCrawlersResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCrawlersResultJsonUnmarshaller implements Unmarshaller<GetCrawlersResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    getCrawlersResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
