...
/**
 * PutDataCatalogEncryptionSettingsRequestMarshaller
 */
...
public class PutDataCatalogEncryptionSettingsRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> DATACATALOGENCRYPTIONSETTINGS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DataCatalogEncryptionSettings").build();
