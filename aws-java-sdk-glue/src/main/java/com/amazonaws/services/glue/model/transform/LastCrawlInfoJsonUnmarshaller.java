...
/**
 * LastCrawlInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LastCrawlInfoJsonUnmarshaller implements Unmarshaller<LastCrawlInfo, JsonUnmarshallerContext> {

    public LastCrawlInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        LastCrawlInfo lastCrawlInfo = new LastCrawlInfo();
    ...
    private static LastCrawlInfoJsonUnmarshaller instance;

    public static LastCrawlInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LastCrawlInfoJsonUnmarshaller();
        return instance;
    }
}
