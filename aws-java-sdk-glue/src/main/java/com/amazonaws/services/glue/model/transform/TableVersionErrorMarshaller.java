...
public class TableVersionErrorMarshaller {
    ...
    public void marshall(TableVersionError tableVersionError, ProtocolMarshaller protocolMarshaller) {
        ...
        if (tableVersionError == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(tableVersionError.getTableName(), TABLENAME_BINDING);
            protocolMarshaller.marshall(tableVersionError.getVersionId(), VERSIONID_BINDING);
            protocolMarshaller.marshall(tableVersionError.getErrorDetail(), ERRORDETAIL_BINDING);
        } catch (Exception e) {
