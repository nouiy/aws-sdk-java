...
@SdkInternalApi
public class StartCrawlerRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Name").build();

    private static final StartCrawlerRequestMarshaller instance = new StartCrawlerRequestMarshaller();

    public static StartCrawlerRequestMarshaller getInstance() {
        return instance;
    }
