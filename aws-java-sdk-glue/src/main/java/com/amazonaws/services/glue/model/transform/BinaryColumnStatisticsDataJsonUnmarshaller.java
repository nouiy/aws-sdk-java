...
/**
 * BinaryColumnStatisticsData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BinaryColumnStatisticsDataJsonUnmarshaller implements Unmarshaller<BinaryColumnStatisticsData, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MaximumLength", targetDepth)) {
                    context.nextToken();
                    binaryColumnStatisticsData.setMaximumLength(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("AverageLength", targetDepth)) {
                    context.nextToken();
                    binaryColumnStatisticsData.setAverageLength(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("NumberOfNulls", targetDepth)) {
                    context.nextToken();
                    binaryColumnStatisticsData.setNumberOfNulls(context.getUnmarshaller(Long.class).unmarshall(context));
                }
