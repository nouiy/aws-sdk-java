 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GluePolicy" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GluePolicy implements Serializable, Cloneable, StructuredPojo {
    ...
    public GluePolicy withCreateTime(java.util.Date createTime) {
    ...
    public GluePolicy withUpdateTime(java.util.Date updateTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GluePolicy == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.glue.model.transform.GluePolicyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
