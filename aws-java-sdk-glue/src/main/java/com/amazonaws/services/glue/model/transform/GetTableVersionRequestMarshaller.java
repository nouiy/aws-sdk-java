...
@SdkInternalApi
public class GetTableVersionRequestMarshaller {
    ...
    private static final GetTableVersionRequestMarshaller instance = new GetTableVersionRequestMarshaller();

    public static GetTableVersionRequestMarshaller getInstance() {
        return instance;
    }
