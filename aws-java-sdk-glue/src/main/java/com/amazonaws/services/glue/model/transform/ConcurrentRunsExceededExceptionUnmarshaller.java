...
public class ConcurrentRunsExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ConcurrentRunsExceededExceptionUnmarshaller instance;

    public static ConcurrentRunsExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConcurrentRunsExceededExceptionUnmarshaller();
        return instance;
    }
}
