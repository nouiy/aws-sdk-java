        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("failuresNotRedrivable", targetDepth)) {
                    context.nextToken();
                    mapRunItemCounts.setFailuresNotRedrivable(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("pendingRedrive", targetDepth)) {
                    context.nextToken();
                    mapRunItemCounts.setPendingRedrive(context.getUnmarshaller(Long.class).unmarshall(context));
                }
