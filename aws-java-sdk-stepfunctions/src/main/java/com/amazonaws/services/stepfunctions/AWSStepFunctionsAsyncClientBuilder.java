...
/**
 * Fluent builder for {@link com.amazonaws.services.stepfunctions.AWSStepFunctionsAsync}. Use of the builder is
...
public final class AWSStepFunctionsAsyncClientBuilder extends AwsAsyncClientBuilder<AWSStepFunctionsAsyncClientBuilder, AWSStepFunctionsAsync> {
     ...
     */
    public static AWSStepFunctionsAsyncClientBuilder standard() {
        return new AWSStepFunctionsAsyncClientBuilder();
    }
     ...
     */
    public static AWSStepFunctionsAsync defaultClient() {
        return standard().build();
    }

    private AWSStepFunctionsAsyncClientBuilder() {
     ...
     * @return Fully configured implementation of AWSStepFunctionsAsync.
     */
    @Override
    protected AWSStepFunctionsAsync build(AwsAsyncClientParams params) {
        return new AWSStepFunctionsAsyncClient(params);
    }
