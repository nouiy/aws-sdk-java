 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/states-2016-11-23/MapRunRedrivenEventDetails" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MapRunRedrivenEventDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MapRunRedrivenEventDetails == false)
            return false;
    ...
    public MapRunRedrivenEventDetails clone() {
        try {
            return (MapRunRedrivenEventDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.stepfunctions.model.transform.MapRunRedrivenEventDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
