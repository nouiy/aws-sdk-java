...
public class ActivityLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.ActivityLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return activityLimitExceededException;
    }

    private static ActivityLimitExceededExceptionUnmarshaller instance;

    public static ActivityLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActivityLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
