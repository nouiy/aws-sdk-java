...
public class TaskSubmitFailedEventDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TaskSubmitFailedEventDetails == false)
            return false;
        TaskSubmitFailedEventDetails other = (TaskSubmitFailedEventDetails) obj;
    ...
    @Override
    public TaskSubmitFailedEventDetails clone() {
        try {
            return (TaskSubmitFailedEventDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.stepfunctions.model.transform.TaskSubmitFailedEventDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
