...
public class StateMachineLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.StateMachineLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return stateMachineLimitExceededException;
    }

    private static StateMachineLimitExceededExceptionUnmarshaller instance;

    public static StateMachineLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StateMachineLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
