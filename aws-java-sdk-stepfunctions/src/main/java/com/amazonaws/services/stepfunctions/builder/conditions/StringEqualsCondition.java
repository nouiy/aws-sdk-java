...
public final class StringEqualsCondition implements BinaryCondition<String> {
    ...
    /**
     * @return Builder instance to construct a {@link StringEqualsCondition}.
     */
    ...
    /**
     * Builder for a {@link StringEqualsCondition}.
     */
    public static final class Builder extends BinaryStringConditionBuilder {
        ...
        /**
         * @return An immutable {@link StringEqualsCondition} object.
         */
        @Override
