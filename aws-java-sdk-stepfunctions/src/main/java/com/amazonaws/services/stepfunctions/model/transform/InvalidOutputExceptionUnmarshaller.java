...
public class InvalidOutputExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidOutputExceptionUnmarshaller instance;

    public static InvalidOutputExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidOutputExceptionUnmarshaller();
        return instance;
    }
}
