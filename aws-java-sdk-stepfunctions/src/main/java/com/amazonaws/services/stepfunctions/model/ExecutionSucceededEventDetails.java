...
public class ExecutionSucceededEventDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The JSON data output by the execution. Length constraints apply to the payload size, and are expressed as bytes
     * in UTF-8 encoding.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The JSON data output by the execution. Length constraints apply to the payload size, and are expressed as
     *         bytes in UTF-8 encoding.
     */
