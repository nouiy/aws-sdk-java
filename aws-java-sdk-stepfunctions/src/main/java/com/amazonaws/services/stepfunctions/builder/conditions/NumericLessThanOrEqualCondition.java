...
public final class NumericLessThanOrEqualCondition implements BinaryCondition<String> {
    ...
    /**
     * @return Builder instance to construct a {@link NumericLessThanOrEqualCondition}.
     */
    ...
    /**
     * Builder for a {@link NumericLessThanOrEqualCondition}.
     */
    public static final class Builder extends BinaryConditionBuilder {
        ...
        @Override
        String type() {
            return PropertyNames.NUMERIC_LESS_THAN_EQUALS;
        }

        /**
         * @return An immutable {@link NumericLessThanOrEqualCondition} object.
         */
