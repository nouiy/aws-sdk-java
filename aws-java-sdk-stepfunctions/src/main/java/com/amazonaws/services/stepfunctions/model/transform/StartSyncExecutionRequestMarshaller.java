...
/**
 * StartSyncExecutionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StartSyncExecutionRequestMarshaller {
    ...
    public static StartSyncExecutionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartSyncExecutionRequest startSyncExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startSyncExecutionRequest.getStateMachineArn(), STATEMACHINEARN_BINDING);
