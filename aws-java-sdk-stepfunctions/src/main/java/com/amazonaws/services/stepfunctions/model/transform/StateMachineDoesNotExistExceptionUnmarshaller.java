...
public class StateMachineDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.StateMachineDoesNotExistException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return stateMachineDoesNotExistException;
    }

    private static StateMachineDoesNotExistExceptionUnmarshaller instance;

    public static StateMachineDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StateMachineDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
