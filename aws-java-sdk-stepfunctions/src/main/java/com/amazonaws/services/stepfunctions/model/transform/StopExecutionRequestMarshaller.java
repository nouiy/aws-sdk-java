...
/**
 * StopExecutionRequestMarshaller
 */
...
public class StopExecutionRequestMarshaller {
    ...
    private static final StopExecutionRequestMarshaller instance = new StopExecutionRequestMarshaller();

    public static StopExecutionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StopExecutionRequest stopExecutionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(stopExecutionRequest.getExecutionArn(), EXECUTIONARN_BINDING);
            protocolMarshaller.marshall(stopExecutionRequest.getError(), ERROR_BINDING);
            protocolMarshaller.marshall(stopExecutionRequest.getCause(), CAUSE_BINDING);
        } catch (Exception e) {
