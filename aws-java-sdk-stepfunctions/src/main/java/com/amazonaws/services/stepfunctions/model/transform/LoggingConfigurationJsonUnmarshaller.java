        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("level", targetDepth)) {
                    context.nextToken();
                    loggingConfiguration.setLevel(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("includeExecutionData", targetDepth)) {
                    context.nextToken();
                    loggingConfiguration.setIncludeExecutionData(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
