...
public class ActivityDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.ActivityDoesNotExistException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return activityDoesNotExistException;
    }

    private static ActivityDoesNotExistExceptionUnmarshaller instance;

    public static ActivityDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActivityDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
