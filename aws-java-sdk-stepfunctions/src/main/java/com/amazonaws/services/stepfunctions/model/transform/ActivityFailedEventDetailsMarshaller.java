...
@SdkInternalApi
public class ActivityFailedEventDetailsMarshaller {
    ...
    private static final ActivityFailedEventDetailsMarshaller instance = new ActivityFailedEventDetailsMarshaller();

    public static ActivityFailedEventDetailsMarshaller getInstance() {
        return instance;
    }
