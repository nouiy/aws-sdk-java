...
public class ExecutionLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.ExecutionLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return executionLimitExceededException;
    }

    private static ExecutionLimitExceededExceptionUnmarshaller instance;

    public static ExecutionLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExecutionLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
