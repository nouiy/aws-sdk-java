...
public class TaskDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.stepfunctions.model.TaskDoesNotExistException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return taskDoesNotExistException;
    }

    private static TaskDoesNotExistExceptionUnmarshaller instance;

    public static TaskDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TaskDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
