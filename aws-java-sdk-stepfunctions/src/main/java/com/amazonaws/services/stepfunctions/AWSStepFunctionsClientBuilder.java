...
/**
 * Fluent builder for {@link com.amazonaws.services.stepfunctions.AWSStepFunctions}. Use of the builder is preferred
...
public final class AWSStepFunctionsClientBuilder extends AwsSyncClientBuilder<AWSStepFunctionsClientBuilder, AWSStepFunctions> {
     ...
     */
    public static AWSStepFunctionsClientBuilder standard() {
        return new AWSStepFunctionsClientBuilder();
    }
     ...
     */
    public static AWSStepFunctions defaultClient() {
        return standard().build();
    }

    private AWSStepFunctionsClientBuilder() {
     ...
     * @return Fully configured implementation of AWSStepFunctions.
     */
    @Override
    protected AWSStepFunctions build(AwsSyncClientParams params) {
        return new AWSStepFunctionsClient(params);
    }
