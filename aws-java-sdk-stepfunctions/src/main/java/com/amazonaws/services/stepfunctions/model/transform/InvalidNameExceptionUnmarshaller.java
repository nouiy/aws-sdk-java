...
public class InvalidNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidNameExceptionUnmarshaller instance;

    public static InvalidNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidNameExceptionUnmarshaller();
        return instance;
    }
}
