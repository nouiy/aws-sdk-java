...
/**
 * ExecuteScheduledQueryResult JSON Unmarshaller
 */
...
public class ExecuteScheduledQueryResultJsonUnmarshaller implements Unmarshaller<ExecuteScheduledQueryResult, JsonUnmarshallerContext> {
    ...
    public ExecuteScheduledQueryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExecuteScheduledQueryResult executeScheduledQueryResult = new ExecuteScheduledQueryResult();
