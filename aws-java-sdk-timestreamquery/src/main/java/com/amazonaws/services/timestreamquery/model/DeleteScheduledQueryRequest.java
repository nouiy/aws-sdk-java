...
public class DeleteScheduledQueryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteScheduledQueryRequest withScheduledQueryArn(String scheduledQueryArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteScheduledQueryRequest == false)
            return false;
        DeleteScheduledQueryRequest other = (DeleteScheduledQueryRequest) obj;
    ...
    @Override
    public DeleteScheduledQueryRequest clone() {
        return (DeleteScheduledQueryRequest) super.clone();
    }
