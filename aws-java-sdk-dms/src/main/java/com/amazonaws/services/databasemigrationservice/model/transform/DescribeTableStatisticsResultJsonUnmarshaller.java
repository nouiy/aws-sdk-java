...
public class DescribeTableStatisticsResultJsonUnmarshaller implements Unmarshaller<DescribeTableStatisticsResult, JsonUnmarshallerContext> {

    public DescribeTableStatisticsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
