...
public class ReloadTablesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReloadTablesResult == false)
            return false;
        ReloadTablesResult other = (ReloadTablesResult) obj;
    ...
    public ReloadTablesResult clone() {
        try {
            return (ReloadTablesResult) super.clone();
