...
/**
 * ElasticsearchSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ElasticsearchSettingsMarshaller {
    ...
    private static final MarshallingInfo<String> ENDPOINTURI_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EndpointUri").build();
    private static final MarshallingInfo<Integer> FULLLOADERRORPERCENTAGE_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
    ...
    public static ElasticsearchSettingsMarshaller getInstance() {
        return instance;
    }
