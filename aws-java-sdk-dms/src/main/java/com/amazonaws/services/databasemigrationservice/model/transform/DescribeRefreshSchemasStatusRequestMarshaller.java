...
public class DescribeRefreshSchemasStatusRequestMarshaller {
    ...
    private static final DescribeRefreshSchemasStatusRequestMarshaller instance = new DescribeRefreshSchemasStatusRequestMarshaller();

    public static DescribeRefreshSchemasStatusRequestMarshaller getInstance() {
        return instance;
    }
