...
public class DescribeReplicationSubnetGroupsResultJsonUnmarshaller implements Unmarshaller<DescribeReplicationSubnetGroupsResult, JsonUnmarshallerContext> {

    public DescribeReplicationSubnetGroupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    describeReplicationSubnetGroupsResult.setMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
