...
public class SNSNoAuthorizationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.databasemigrationservice.model.SNSNoAuthorizationException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return sNSNoAuthorizationException;
    }

    private static SNSNoAuthorizationExceptionUnmarshaller instance;

    public static SNSNoAuthorizationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SNSNoAuthorizationExceptionUnmarshaller();
        return instance;
    }
}
