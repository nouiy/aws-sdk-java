...
class EndpointDeleted {
    ...
    static class IsResourceNotFoundFaultMatcher extends WaiterAcceptor<DescribeEndpointsResult> {
        /**
    ...
    static class IsActiveMatcher extends WaiterAcceptor<DescribeEndpointsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("Endpoints")), new JmesPathField("Status"));
         ...
         */
        @Override
        public boolean matches(DescribeEndpointsResult result) {
    ...
    static class IsCreatingMatcher extends WaiterAcceptor<DescribeEndpointsResult> {
        private static final JsonNode expectedResult;
