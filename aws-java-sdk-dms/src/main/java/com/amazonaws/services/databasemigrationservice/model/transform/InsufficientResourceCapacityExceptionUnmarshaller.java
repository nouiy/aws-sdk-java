...
public class InsufficientResourceCapacityExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.databasemigrationservice.model.InsufficientResourceCapacityException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return insufficientResourceCapacityException;
    }

    private static InsufficientResourceCapacityExceptionUnmarshaller instance;

    public static InsufficientResourceCapacityExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InsufficientResourceCapacityExceptionUnmarshaller();
        return instance;
    }
}
