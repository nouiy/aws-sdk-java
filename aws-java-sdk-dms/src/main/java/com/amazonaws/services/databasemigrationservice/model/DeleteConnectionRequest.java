...
public class DeleteConnectionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteConnectionRequest withEndpointArn(String endpointArn) {
    ...
    public DeleteConnectionRequest withReplicationInstanceArn(String replicationInstanceArn) {
