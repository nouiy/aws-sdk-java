...
public class DescribeEventSubscriptionsRequestMarshaller {
    ...
    private static final DescribeEventSubscriptionsRequestMarshaller instance = new DescribeEventSubscriptionsRequestMarshaller();

    public static DescribeEventSubscriptionsRequestMarshaller getInstance() {
        return instance;
    }
