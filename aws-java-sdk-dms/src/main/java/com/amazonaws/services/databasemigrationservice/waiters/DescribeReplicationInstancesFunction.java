...
public class DescribeReplicationInstancesFunction implements SdkFunction<DescribeReplicationInstancesRequest, DescribeReplicationInstancesResult> {
    ...
    /**
     * Constructs a new DescribeReplicationInstancesFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public DescribeReplicationInstancesFunction(AWSDatabaseMigrationService client) {
        this.client = client;
    }
