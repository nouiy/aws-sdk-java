...
class ReplicationInstanceAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeReplicationInstancesResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("ReplicationInstances")), new JmesPathField(
         ...
         */
        @Override
        public boolean matches(DescribeReplicationInstancesResult result) {
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeReplicationInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatiblecredentialsMatcher extends WaiterAcceptor<DescribeReplicationInstancesResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"incompatible-credentials\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsIncompatiblenetworkMatcher extends WaiterAcceptor<DescribeReplicationInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsInaccessibleencryptioncredentialsMatcher extends WaiterAcceptor<DescribeReplicationInstancesResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"inaccessible-encryption-credentials\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
