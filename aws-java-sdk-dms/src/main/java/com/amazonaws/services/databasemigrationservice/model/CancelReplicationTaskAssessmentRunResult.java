...
public class CancelReplicationTaskAssessmentRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CancelReplicationTaskAssessmentRunResult withReplicationTaskAssessmentRun(ReplicationTaskAssessmentRun replicationTaskAssessmentRun) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelReplicationTaskAssessmentRunResult == false)
            return false;
        CancelReplicationTaskAssessmentRunResult other = (CancelReplicationTaskAssessmentRunResult) obj;
    ...
    @Override
    public CancelReplicationTaskAssessmentRunResult clone() {
        try {
            return (CancelReplicationTaskAssessmentRunResult) super.clone();
