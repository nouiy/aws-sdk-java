...
/**
 * ApplyPendingMaintenanceActionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApplyPendingMaintenanceActionResultJsonUnmarshaller implements Unmarshaller<ApplyPendingMaintenanceActionResult, JsonUnmarshallerContext> {

    public ApplyPendingMaintenanceActionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourcePendingMaintenanceActions", targetDepth)) {
                    context.nextToken();
                    applyPendingMaintenanceActionResult.setResourcePendingMaintenanceActions(ResourcePendingMaintenanceActionsJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
