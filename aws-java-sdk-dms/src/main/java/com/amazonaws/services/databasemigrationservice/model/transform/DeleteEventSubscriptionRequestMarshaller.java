...
/**
 * DeleteEventSubscriptionRequestMarshaller
 */
...
public class DeleteEventSubscriptionRequestMarshaller {
    ...
    private static final DeleteEventSubscriptionRequestMarshaller instance = new DeleteEventSubscriptionRequestMarshaller();

    public static DeleteEventSubscriptionRequestMarshaller getInstance() {
        return instance;
    }
