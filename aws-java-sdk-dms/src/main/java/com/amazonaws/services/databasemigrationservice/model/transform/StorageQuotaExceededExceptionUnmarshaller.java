...
public class StorageQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static StorageQuotaExceededExceptionUnmarshaller instance;

    public static StorageQuotaExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StorageQuotaExceededExceptionUnmarshaller();
        return instance;
    }
}
