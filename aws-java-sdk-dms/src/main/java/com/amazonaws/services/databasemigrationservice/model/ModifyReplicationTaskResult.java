...
public class ModifyReplicationTaskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyReplicationTaskResult withReplicationTask(ReplicationTask replicationTask) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyReplicationTaskResult == false)
            return false;
        ModifyReplicationTaskResult other = (ModifyReplicationTaskResult) obj;
    ...
    @Override
    public ModifyReplicationTaskResult clone() {
        try {
            return (ModifyReplicationTaskResult) super.clone();
