...
/**
 * ModifyReplicationTaskResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModifyReplicationTaskResultJsonUnmarshaller implements Unmarshaller<ModifyReplicationTaskResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ReplicationTask", targetDepth)) {
                    context.nextToken();
                    modifyReplicationTaskResult.setReplicationTask(ReplicationTaskJsonUnmarshaller.getInstance().unmarshall(context));
                }
