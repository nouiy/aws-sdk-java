...
public class SubnetAlreadyInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.databasemigrationservice.model.SubnetAlreadyInUseException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return subnetAlreadyInUseException;
    }

    private static SubnetAlreadyInUseExceptionUnmarshaller instance;

    public static SubnetAlreadyInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SubnetAlreadyInUseExceptionUnmarshaller();
        return instance;
    }
}
