...
public class MoveReplicationTaskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The replication task that was moved.
     */
    ...
    public MoveReplicationTaskResult withReplicationTask(ReplicationTask replicationTask) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MoveReplicationTaskResult == false)
            return false;
        MoveReplicationTaskResult other = (MoveReplicationTaskResult) obj;
    ...
    @Override
    public MoveReplicationTaskResult clone() {
        try {
            return (MoveReplicationTaskResult) super.clone();
