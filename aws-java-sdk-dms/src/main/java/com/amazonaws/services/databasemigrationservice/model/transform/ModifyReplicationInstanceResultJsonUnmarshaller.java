...
public class ModifyReplicationInstanceResultJsonUnmarshaller implements Unmarshaller<ModifyReplicationInstanceResult, JsonUnmarshallerContext> {

    public ModifyReplicationInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ReplicationInstance", targetDepth)) {
                    context.nextToken();
                    modifyReplicationInstanceResult.setReplicationInstance(ReplicationInstanceJsonUnmarshaller.getInstance().unmarshall(context));
                }
