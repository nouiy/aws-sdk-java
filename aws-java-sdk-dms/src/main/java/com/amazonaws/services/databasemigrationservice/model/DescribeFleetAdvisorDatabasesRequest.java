...
public class DescribeFleetAdvisorDatabasesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeFleetAdvisorDatabasesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFleetAdvisorDatabasesRequest == false)
            return false;
        DescribeFleetAdvisorDatabasesRequest other = (DescribeFleetAdvisorDatabasesRequest) obj;
    ...
    public DescribeFleetAdvisorDatabasesRequest clone() {
        return (DescribeFleetAdvisorDatabasesRequest) super.clone();
    }
