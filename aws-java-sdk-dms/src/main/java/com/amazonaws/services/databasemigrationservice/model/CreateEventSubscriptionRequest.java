...
public class CreateEventSubscriptionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * by a replication instance, you set this parameter to <code>replication-instance</code>. If this value isn't
     ...
     * </p>
     * 
     * @return The name of the DMS event notification subscription. This name must be less than 255 characters.
     */
     ...
     * </p>
     * 
     * @return The type of DMS resource that generates the events. For example, if you want to be notified of events
     *         generated by a replication instance, you set this parameter to <code>replication-instance</code>. If this
     *         value isn't specified, all events are returned. </p>
     *         <p>
     *         Valid values: <code>replication-instance</code> | <code>replication-task</code>
     ...
     * </p>
     * 
     * @return A list of identifiers for which DMS provides notification events.</p>
     *         <p>
     *         If you don't specify a value, notifications are provided for all sources.
     *         </p>
     *         <p>
     ...
     * 
     * @param sourceIds
     *        A list of identifiers for which DMS provides notification events.</p>
     *        <p>
     *        If you don't specify a value, notifications are provided for all sources.
     *        </p>
     *        <p>
