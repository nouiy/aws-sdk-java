...
public class CancelReplicationTaskAssessmentRunRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Amazon Resource Name (ARN) of the premigration assessment run to be canceled.
     */
    ...
    public CancelReplicationTaskAssessmentRunRequest withReplicationTaskAssessmentRunArn(String replicationTaskAssessmentRunArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelReplicationTaskAssessmentRunRequest == false)
            return false;
        CancelReplicationTaskAssessmentRunRequest other = (CancelReplicationTaskAssessmentRunRequest) obj;
    ...
    @Override
    public CancelReplicationTaskAssessmentRunRequest clone() {
        return (CancelReplicationTaskAssessmentRunRequest) super.clone();
    }
