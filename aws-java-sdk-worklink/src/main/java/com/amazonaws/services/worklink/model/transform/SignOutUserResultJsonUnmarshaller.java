...
/**
 * SignOutUserResult JSON Unmarshaller
 */
...
public class SignOutUserResultJsonUnmarshaller implements Unmarshaller<SignOutUserResult, JsonUnmarshallerContext> {
    ...
    public SignOutUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SignOutUserResult signOutUserResult = new SignOutUserResult();
