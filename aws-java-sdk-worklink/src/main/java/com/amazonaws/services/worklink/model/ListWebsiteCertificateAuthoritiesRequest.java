...
public class ListWebsiteCertificateAuthoritiesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListWebsiteCertificateAuthoritiesRequest clone() {
        return (ListWebsiteCertificateAuthoritiesRequest) super.clone();
    }
