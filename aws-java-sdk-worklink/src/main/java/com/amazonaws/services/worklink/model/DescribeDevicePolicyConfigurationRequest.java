...
public class DescribeDevicePolicyConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeDevicePolicyConfigurationRequest clone() {
        return (DescribeDevicePolicyConfigurationRequest) super.clone();
    }
