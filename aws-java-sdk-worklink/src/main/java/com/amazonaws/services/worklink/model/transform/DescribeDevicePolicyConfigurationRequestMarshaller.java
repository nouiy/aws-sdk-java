...
/**
 * DescribeDevicePolicyConfigurationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeDevicePolicyConfigurationRequestMarshaller {
    ...
    private static final DescribeDevicePolicyConfigurationRequestMarshaller instance = new DescribeDevicePolicyConfigurationRequestMarshaller();

    public static DescribeDevicePolicyConfigurationRequestMarshaller getInstance() {
        return instance;
    }
