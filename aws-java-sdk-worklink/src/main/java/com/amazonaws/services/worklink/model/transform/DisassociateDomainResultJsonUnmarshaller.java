...
/**
 * DisassociateDomainResult JSON Unmarshaller
 */
...
public class DisassociateDomainResultJsonUnmarshaller implements Unmarshaller<DisassociateDomainResult, JsonUnmarshallerContext> {
    ...
    public DisassociateDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateDomainResult disassociateDomainResult = new DisassociateDomainResult();
