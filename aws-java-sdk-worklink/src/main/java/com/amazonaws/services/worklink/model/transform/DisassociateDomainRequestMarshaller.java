...
/**
 * DisassociateDomainRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DisassociateDomainRequestMarshaller {
    ...
    private static final DisassociateDomainRequestMarshaller instance = new DisassociateDomainRequestMarshaller();

    public static DisassociateDomainRequestMarshaller getInstance() {
        return instance;
    }
