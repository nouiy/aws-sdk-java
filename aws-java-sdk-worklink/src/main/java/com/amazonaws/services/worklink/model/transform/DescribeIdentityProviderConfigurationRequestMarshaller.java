...
/**
 * DescribeIdentityProviderConfigurationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeIdentityProviderConfigurationRequestMarshaller {
    ...
    private static final DescribeIdentityProviderConfigurationRequestMarshaller instance = new DescribeIdentityProviderConfigurationRequestMarshaller();

    public static DescribeIdentityProviderConfigurationRequestMarshaller getInstance() {
        return instance;
    }
