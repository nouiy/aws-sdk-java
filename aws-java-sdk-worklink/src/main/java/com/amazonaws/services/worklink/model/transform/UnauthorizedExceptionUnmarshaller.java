...
public class UnauthorizedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnauthorizedExceptionUnmarshaller() {
        super(com.amazonaws.services.worklink.model.UnauthorizedException.class, "UnauthorizedException");
    }

    @Override
    public com.amazonaws.services.worklink.model.UnauthorizedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.worklink.model.UnauthorizedException unauthorizedException = new com.amazonaws.services.worklink.model.UnauthorizedException(
                null);
