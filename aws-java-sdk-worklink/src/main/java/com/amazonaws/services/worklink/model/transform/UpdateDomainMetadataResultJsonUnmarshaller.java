...
/**
 * UpdateDomainMetadataResult JSON Unmarshaller
 */
...
public class UpdateDomainMetadataResultJsonUnmarshaller implements Unmarshaller<UpdateDomainMetadataResult, JsonUnmarshallerContext> {
    ...
    public UpdateDomainMetadataResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDomainMetadataResult updateDomainMetadataResult = new UpdateDomainMetadataResult();
