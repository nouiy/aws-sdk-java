...
/**
 * BlockPublicAccessConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BlockPublicAccessConfigurationJsonUnmarshaller implements Unmarshaller<BlockPublicAccessConfiguration, JsonUnmarshallerContext> {

    public BlockPublicAccessConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BlockPublicSecurityGroupRules", targetDepth)) {
                    context.nextToken();
                    blockPublicAccessConfiguration.setBlockPublicSecurityGroupRules(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
