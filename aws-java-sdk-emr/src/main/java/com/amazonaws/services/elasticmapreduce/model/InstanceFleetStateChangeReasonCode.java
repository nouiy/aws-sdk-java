...
public enum InstanceFleetStateChangeReasonCode {
     ...
     * @param value
     *        real value
     * @return InstanceFleetStateChangeReasonCode corresponding to the value
     *
    ...
    public static InstanceFleetStateChangeReasonCode fromValue(String value) {
        ...
        for (InstanceFleetStateChangeReasonCode enumEntry : InstanceFleetStateChangeReasonCode.values()) {
