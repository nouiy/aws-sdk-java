...
/**
 * BlockPublicAccessConfigurationMarshaller
 */
...
public class BlockPublicAccessConfigurationMarshaller {
    ...
    public void marshall(BlockPublicAccessConfiguration blockPublicAccessConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(blockPublicAccessConfiguration.getPermittedPublicSecurityGroupRuleRanges(),
                    PERMITTEDPUBLICSECURITYGROUPRULERANGES_BINDING);
        } catch (Exception e) {
