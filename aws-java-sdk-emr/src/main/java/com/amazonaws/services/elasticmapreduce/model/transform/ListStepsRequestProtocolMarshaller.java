...
@SdkInternalApi
public class ListStepsRequestProtocolMarshaller implements Marshaller<Request<ListStepsRequest>, ListStepsRequest> {
    ...
    public ListStepsRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ListStepsRequest> marshall(ListStepsRequest listStepsRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<ListStepsRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    listStepsRequest);
