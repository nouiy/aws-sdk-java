...
/**
 * UpdateStudioSessionMappingResult JSON Unmarshaller
 */
...
public class UpdateStudioSessionMappingResultJsonUnmarshaller implements Unmarshaller<UpdateStudioSessionMappingResult, JsonUnmarshallerContext> {
    ...
    public UpdateStudioSessionMappingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateStudioSessionMappingResult updateStudioSessionMappingResult = new UpdateStudioSessionMappingResult();

        return updateStudioSessionMappingResult;
    }
