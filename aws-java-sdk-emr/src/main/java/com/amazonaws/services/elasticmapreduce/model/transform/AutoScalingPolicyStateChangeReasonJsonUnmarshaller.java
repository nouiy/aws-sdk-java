...
/**
 * AutoScalingPolicyStateChangeReason JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AutoScalingPolicyStateChangeReasonJsonUnmarshaller implements Unmarshaller<AutoScalingPolicyStateChangeReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    autoScalingPolicyStateChangeReason.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    autoScalingPolicyStateChangeReason.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
