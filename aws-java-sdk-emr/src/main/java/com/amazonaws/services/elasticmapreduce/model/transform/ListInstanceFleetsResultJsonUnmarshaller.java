...
/**
 * ListInstanceFleetsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListInstanceFleetsResultJsonUnmarshaller implements Unmarshaller<ListInstanceFleetsResult, JsonUnmarshallerContext> {

    public ListInstanceFleetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    context.nextToken();
                    listInstanceFleetsResult.setMarker(context.getUnmarshaller(String.class).unmarshall(context));
                }
