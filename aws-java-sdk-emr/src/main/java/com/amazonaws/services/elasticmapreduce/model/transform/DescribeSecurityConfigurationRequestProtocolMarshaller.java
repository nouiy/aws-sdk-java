...
@SdkInternalApi
public class DescribeSecurityConfigurationRequestProtocolMarshaller implements
    ...
    public DescribeSecurityConfigurationRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribeSecurityConfigurationRequest> marshall(DescribeSecurityConfigurationRequest describeSecurityConfigurationRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DescribeSecurityConfigurationRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(
                    SDK_OPERATION_BINDING, describeSecurityConfigurationRequest);
