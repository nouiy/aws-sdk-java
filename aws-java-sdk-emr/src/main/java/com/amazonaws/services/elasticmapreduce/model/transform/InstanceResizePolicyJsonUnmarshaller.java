...
public class InstanceResizePolicyJsonUnmarshaller implements Unmarshaller<InstanceResizePolicy, JsonUnmarshallerContext> {

    public InstanceResizePolicy unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("InstanceTerminationTimeout", targetDepth)) {
                    context.nextToken();
                    instanceResizePolicy.setInstanceTerminationTimeout(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
