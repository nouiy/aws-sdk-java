...
public class ShrinkPolicyJsonUnmarshaller implements Unmarshaller<ShrinkPolicy, JsonUnmarshallerContext> {

    public ShrinkPolicy unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DecommissionTimeout", targetDepth)) {
                    context.nextToken();
                    shrinkPolicy.setDecommissionTimeout(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
