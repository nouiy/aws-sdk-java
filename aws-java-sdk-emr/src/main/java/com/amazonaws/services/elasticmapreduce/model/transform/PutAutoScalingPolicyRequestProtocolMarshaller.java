...
@SdkInternalApi
public class PutAutoScalingPolicyRequestProtocolMarshaller implements Marshaller<Request<PutAutoScalingPolicyRequest>, PutAutoScalingPolicyRequest> {
    ...
    public PutAutoScalingPolicyRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<PutAutoScalingPolicyRequest> marshall(PutAutoScalingPolicyRequest putAutoScalingPolicyRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<PutAutoScalingPolicyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
