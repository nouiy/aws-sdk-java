...
public class UpdateStudioSessionMappingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateStudioSessionMappingRequest withIdentityName(String identityName) {
     ...
     * </p>
     * 
     * @return Specifies whether the identity to update is a user or a group.
     * @see IdentityType
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the session policy to associate with the specified user or group.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateStudioSessionMappingRequest == false)
            return false;
        UpdateStudioSessionMappingRequest other = (UpdateStudioSessionMappingRequest) obj;
    ...
    public UpdateStudioSessionMappingRequest clone() {
        return (UpdateStudioSessionMappingRequest) super.clone();
    }
