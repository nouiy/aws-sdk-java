...
/**
 * StopNotebookExecutionResult JSON Unmarshaller
 */
...
public class StopNotebookExecutionResultJsonUnmarshaller implements Unmarshaller<StopNotebookExecutionResult, JsonUnmarshallerContext> {
    ...
    public StopNotebookExecutionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopNotebookExecutionResult stopNotebookExecutionResult = new StopNotebookExecutionResult();
