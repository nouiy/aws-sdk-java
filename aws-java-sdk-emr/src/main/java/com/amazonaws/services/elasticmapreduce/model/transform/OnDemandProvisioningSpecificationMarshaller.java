...
/**
 * OnDemandProvisioningSpecificationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OnDemandProvisioningSpecificationMarshaller {
    ...
    public static OnDemandProvisioningSpecificationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OnDemandProvisioningSpecification onDemandProvisioningSpecification, ProtocolMarshaller protocolMarshaller) {

        if (onDemandProvisioningSpecification == null) {
