...
/**
 * StudioSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StudioSummaryMarshaller {
    ...
    private static final StudioSummaryMarshaller instance = new StudioSummaryMarshaller();

    public static StudioSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StudioSummary studioSummary, ProtocolMarshaller protocolMarshaller) {

        if (studioSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(studioSummary.getStudioId(), STUDIOID_BINDING);
            protocolMarshaller.marshall(studioSummary.getName(), NAME_BINDING);
