...
/**
 * PutAutoTerminationPolicyResult JSON Unmarshaller
 */
...
public class PutAutoTerminationPolicyResultJsonUnmarshaller implements Unmarshaller<PutAutoTerminationPolicyResult, JsonUnmarshallerContext> {
    ...
    public PutAutoTerminationPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAutoTerminationPolicyResult putAutoTerminationPolicyResult = new PutAutoTerminationPolicyResult();

        return putAutoTerminationPolicyResult;
    }
