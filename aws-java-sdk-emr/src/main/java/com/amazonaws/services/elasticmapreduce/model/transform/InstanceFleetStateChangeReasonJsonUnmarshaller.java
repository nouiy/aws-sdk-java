...
/**
 * InstanceFleetStateChangeReason JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceFleetStateChangeReasonJsonUnmarshaller implements Unmarshaller<InstanceFleetStateChangeReason, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Code", targetDepth)) {
                    context.nextToken();
                    instanceFleetStateChangeReason.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    instanceFleetStateChangeReason.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
