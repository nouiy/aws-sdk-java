...
public enum InstalledComponentLifecycleState {
     ...
     * @param value
     *        real value
     * @return InstalledComponentLifecycleState corresponding to the value
     *
    ...
    public static InstalledComponentLifecycleState fromValue(String value) {
        ...
        for (InstalledComponentLifecycleState enumEntry : InstalledComponentLifecycleState.values()) {
