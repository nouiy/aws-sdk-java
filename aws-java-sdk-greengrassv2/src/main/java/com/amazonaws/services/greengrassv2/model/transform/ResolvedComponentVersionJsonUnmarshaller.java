...
/**
 * ResolvedComponentVersion JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResolvedComponentVersionJsonUnmarshaller implements Unmarshaller<ResolvedComponentVersion, JsonUnmarshallerContext> {

    public ResolvedComponentVersion unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResolvedComponentVersion resolvedComponentVersion = new ResolvedComponentVersion();
    ...
    private static ResolvedComponentVersionJsonUnmarshaller instance;

    public static ResolvedComponentVersionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResolvedComponentVersionJsonUnmarshaller();
        return instance;
    }
}
