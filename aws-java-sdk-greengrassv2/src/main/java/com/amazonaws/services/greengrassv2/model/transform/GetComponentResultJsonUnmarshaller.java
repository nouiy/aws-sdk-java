        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("recipeOutputFormat", targetDepth)) {
                    context.nextToken();
                    getComponentResult.setRecipeOutputFormat(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("recipe", targetDepth)) {
                    context.nextToken();
                    getComponentResult.setRecipe(context.getUnmarshaller(java.nio.ByteBuffer.class).unmarshall(context));
                }
