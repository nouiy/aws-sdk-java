...
/**
 * CreateComponentVersionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateComponentVersionRequestMarshaller {

    private static final MarshallingInfo<java.nio.ByteBuffer> INLINERECIPE_BINDING = MarshallingInfo.builder(MarshallingType.BYTE_BUFFER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("inlineRecipe").build();
    ...
    public static CreateComponentVersionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateComponentVersionRequest createComponentVersionRequest, ProtocolMarshaller protocolMarshaller) {
