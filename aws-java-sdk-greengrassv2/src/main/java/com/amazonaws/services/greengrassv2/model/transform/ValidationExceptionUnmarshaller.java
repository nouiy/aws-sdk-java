...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.greengrassv2.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.greengrassv2.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.greengrassv2.model.ValidationException validationException = new com.amazonaws.services.greengrassv2.model.ValidationException(
                null);
