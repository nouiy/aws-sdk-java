        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("componentName", targetDepth)) {
                    context.nextToken();
                    component.setComponentName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("latestVersion", targetDepth)) {
                    context.nextToken();
                    component.setLatestVersion(ComponentLatestVersionJsonUnmarshaller.getInstance().unmarshall(context));
                }
