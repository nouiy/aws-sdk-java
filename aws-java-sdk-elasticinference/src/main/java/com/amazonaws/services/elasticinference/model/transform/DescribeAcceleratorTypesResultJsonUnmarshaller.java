...
/**
 * DescribeAcceleratorTypesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeAcceleratorTypesResultJsonUnmarshaller implements Unmarshaller<DescribeAcceleratorTypesResult, JsonUnmarshallerContext> {

    public DescribeAcceleratorTypesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("acceleratorTypes", targetDepth)) {
                    context.nextToken();
                    describeAcceleratorTypesResult.setAcceleratorTypes(new ListUnmarshaller<AcceleratorType>(AcceleratorTypeJsonUnmarshaller.getInstance())
