...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.elasticinference.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.elasticinference.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.elasticinference.model.InternalServerException internalServerException = new com.amazonaws.services.elasticinference.model.InternalServerException(
                null);
