...
public class DescribeAcceleratorTypesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAcceleratorTypesResult withAcceleratorTypes(AcceleratorType... acceleratorTypes) {
        if (this.acceleratorTypes == null) {
            setAcceleratorTypes(new java.util.ArrayList<AcceleratorType>(acceleratorTypes.length));
        }
        for (AcceleratorType ele : acceleratorTypes) {
    ...
    public DescribeAcceleratorTypesResult withAcceleratorTypes(java.util.Collection<AcceleratorType> acceleratorTypes) {
    ...
    @Override
    public DescribeAcceleratorTypesResult clone() {
        try {
