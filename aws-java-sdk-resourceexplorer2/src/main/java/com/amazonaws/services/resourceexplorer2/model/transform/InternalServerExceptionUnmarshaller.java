...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.resourceexplorer2.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.resourceexplorer2.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.resourceexplorer2.model.InternalServerException internalServerException = new com.amazonaws.services.resourceexplorer2.model.InternalServerException(
                null);
