...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.resourceexplorer2.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.resourceexplorer2.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.resourceexplorer2.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.resourceexplorer2.model.AccessDeniedException(
                null);
