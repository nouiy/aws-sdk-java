...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the view or index that you want to remove tags from.
     */
     ...
     * </p>
     * 
     * @return A list of the keys for the tags that you want to remove from the specified view or index.
     */
