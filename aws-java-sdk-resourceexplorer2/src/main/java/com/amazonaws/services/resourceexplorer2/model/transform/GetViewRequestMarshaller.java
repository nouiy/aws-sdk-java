...
public class GetViewRequestMarshaller {
    ...
    private static final GetViewRequestMarshaller instance = new GetViewRequestMarshaller();

    public static GetViewRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetViewRequest getViewRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getViewRequest.getViewArn(), VIEWARN_BINDING);
        } catch (Exception e) {
