...
public class ViewMarshaller {
    ...
    public void marshall(View view, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(view.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(view.getIncludedProperties(), INCLUDEDPROPERTIES_BINDING);
            protocolMarshaller.marshall(view.getLastUpdatedAt(), LASTUPDATEDAT_BINDING);
            protocolMarshaller.marshall(view.getOwner(), OWNER_BINDING);
            protocolMarshaller.marshall(view.getScope(), SCOPE_BINDING);
            protocolMarshaller.marshall(view.getViewArn(), VIEWARN_BINDING);
        } catch (Exception e) {
