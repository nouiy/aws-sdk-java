...
/**
 * UpdateViewRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateViewRequestMarshaller {
    ...
    private static final UpdateViewRequestMarshaller instance = new UpdateViewRequestMarshaller();

    public static UpdateViewRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateViewRequest updateViewRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateViewRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(updateViewRequest.getIncludedProperties(), INCLUDEDPROPERTIES_BINDING);
            protocolMarshaller.marshall(updateViewRequest.getViewArn(), VIEWARN_BINDING);
        } catch (Exception e) {
