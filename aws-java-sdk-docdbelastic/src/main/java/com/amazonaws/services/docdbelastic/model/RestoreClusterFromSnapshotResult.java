...
public class RestoreClusterFromSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreClusterFromSnapshotResult == false)
            return false;
        RestoreClusterFromSnapshotResult other = (RestoreClusterFromSnapshotResult) obj;
    ...
    public RestoreClusterFromSnapshotResult clone() {
        try {
            return (RestoreClusterFromSnapshotResult) super.clone();
