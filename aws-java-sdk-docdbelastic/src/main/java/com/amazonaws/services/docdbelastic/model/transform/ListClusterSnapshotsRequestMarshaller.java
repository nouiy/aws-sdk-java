...
public class ListClusterSnapshotsRequestMarshaller {
    ...
    public static ListClusterSnapshotsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListClusterSnapshotsRequest listClusterSnapshotsRequest, ProtocolMarshaller protocolMarshaller) {
