...
public class InvalidClientExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidClientExceptionUnmarshaller() {
        super(com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidClientException.class, "InvalidClientException");
    }

    @Override
    public com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidClientException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidClientException invalidClientException = new com.amazonaws.services.kinesisvideosignalingchannels.model.InvalidClientException(
                null);
