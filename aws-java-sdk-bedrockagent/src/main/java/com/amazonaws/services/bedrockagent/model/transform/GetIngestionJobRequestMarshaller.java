...
public class GetIngestionJobRequestMarshaller {
    ...
    public static GetIngestionJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetIngestionJobRequest getIngestionJobRequest, ProtocolMarshaller protocolMarshaller) {
