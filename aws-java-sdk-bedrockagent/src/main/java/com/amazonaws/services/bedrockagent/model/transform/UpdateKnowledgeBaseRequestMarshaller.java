...
public class UpdateKnowledgeBaseRequestMarshaller {
    ...
    private static final UpdateKnowledgeBaseRequestMarshaller instance = new UpdateKnowledgeBaseRequestMarshaller();

    public static UpdateKnowledgeBaseRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateKnowledgeBaseRequest updateKnowledgeBaseRequest, ProtocolMarshaller protocolMarshaller) {
