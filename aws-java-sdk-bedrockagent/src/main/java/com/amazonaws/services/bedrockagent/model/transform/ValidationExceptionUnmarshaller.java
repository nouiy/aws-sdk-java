...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockagent.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.bedrockagent.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockagent.model.ValidationException validationException = new com.amazonaws.services.bedrockagent.model.ValidationException(
                null);
