...
public class GetAgentAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetAgentAliasResult withAgentAlias(AgentAlias agentAlias) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAgentAliasResult == false)
            return false;
        GetAgentAliasResult other = (GetAgentAliasResult) obj;
    ...
    @Override
    public GetAgentAliasResult clone() {
        try {
            return (GetAgentAliasResult) super.clone();
