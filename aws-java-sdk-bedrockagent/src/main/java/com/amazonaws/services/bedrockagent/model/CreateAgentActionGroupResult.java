...
public class CreateAgentActionGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAgentActionGroupResult == false)
            return false;
        CreateAgentActionGroupResult other = (CreateAgentActionGroupResult) obj;
    ...
    public CreateAgentActionGroupResult clone() {
        try {
            return (CreateAgentActionGroupResult) super.clone();
