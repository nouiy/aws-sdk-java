...
public class GetAgentKnowledgeBaseRequestMarshaller {
    ...
    private static final GetAgentKnowledgeBaseRequestMarshaller instance = new GetAgentKnowledgeBaseRequestMarshaller();

    public static GetAgentKnowledgeBaseRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetAgentKnowledgeBaseRequest getAgentKnowledgeBaseRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAgentKnowledgeBaseRequest.getAgentId(), AGENTID_BINDING);
            protocolMarshaller.marshall(getAgentKnowledgeBaseRequest.getAgentVersion(), AGENTVERSION_BINDING);
            protocolMarshaller.marshall(getAgentKnowledgeBaseRequest.getKnowledgeBaseId(), KNOWLEDGEBASEID_BINDING);
        } catch (Exception e) {
