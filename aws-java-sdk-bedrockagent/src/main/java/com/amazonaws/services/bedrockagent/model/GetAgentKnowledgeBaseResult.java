...
public class GetAgentKnowledgeBaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAgentKnowledgeBaseResult == false)
            return false;
        GetAgentKnowledgeBaseResult other = (GetAgentKnowledgeBaseResult) obj;
    ...
    @Override
    public GetAgentKnowledgeBaseResult clone() {
        try {
            return (GetAgentKnowledgeBaseResult) super.clone();
