...
/**
 * DeleteAgentResult JSON Unmarshaller
 */
...
public class DeleteAgentResultJsonUnmarshaller implements Unmarshaller<DeleteAgentResult, JsonUnmarshallerContext> {
    ...
    public DeleteAgentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("agentId", targetDepth)) {
                    context.nextToken();
                    deleteAgentResult.setAgentId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("agentStatus", targetDepth)) {
                    context.nextToken();
                    deleteAgentResult.setAgentStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
