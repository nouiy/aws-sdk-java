...
/**
 * UpdateAgentResult JSON Unmarshaller
 */
...
public class UpdateAgentResultJsonUnmarshaller implements Unmarshaller<UpdateAgentResult, JsonUnmarshallerContext> {
    ...
    public UpdateAgentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("agent", targetDepth)) {
                    context.nextToken();
                    updateAgentResult.setAgent(AgentJsonUnmarshaller.getInstance().unmarshall(context));
                }
