...
/**
 * AgentSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AgentSummaryMarshaller {
    ...
    public static AgentSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AgentSummary agentSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(agentSummary.getAgentId(), AGENTID_BINDING);
