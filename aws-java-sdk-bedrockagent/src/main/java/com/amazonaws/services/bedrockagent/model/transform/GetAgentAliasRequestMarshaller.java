...
public class GetAgentAliasRequestMarshaller {
    ...
    public static GetAgentAliasRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetAgentAliasRequest getAgentAliasRequest, ProtocolMarshaller protocolMarshaller) {
