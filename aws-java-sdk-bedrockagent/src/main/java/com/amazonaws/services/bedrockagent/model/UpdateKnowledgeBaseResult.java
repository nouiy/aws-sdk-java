...
public class UpdateKnowledgeBaseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateKnowledgeBaseResult == false)
            return false;
        UpdateKnowledgeBaseResult other = (UpdateKnowledgeBaseResult) obj;
    ...
    public UpdateKnowledgeBaseResult clone() {
        try {
            return (UpdateKnowledgeBaseResult) super.clone();
