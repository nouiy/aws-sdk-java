...
/**
 * DeleteAssessmentResult JSON Unmarshaller
 */
...
public class DeleteAssessmentResultJsonUnmarshaller implements Unmarshaller<DeleteAssessmentResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssessmentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssessmentResult deleteAssessmentResult = new DeleteAssessmentResult();
