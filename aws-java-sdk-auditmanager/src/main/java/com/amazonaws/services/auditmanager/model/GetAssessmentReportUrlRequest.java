...
public class GetAssessmentReportUrlRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getAssessmentReportId() != null)
            sb.append("AssessmentReportId: ").append(getAssessmentReportId()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAssessmentReportUrlRequest == false)
            return false;
        GetAssessmentReportUrlRequest other = (GetAssessmentReportUrlRequest) obj;
    ...
    @Override
    public GetAssessmentReportUrlRequest clone() {
        return (GetAssessmentReportUrlRequest) super.clone();
    }
