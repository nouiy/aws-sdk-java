...
public class BatchAssociateAssessmentReportEvidenceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public BatchAssociateAssessmentReportEvidenceResult withEvidenceIds(String... evidenceIds) {
    ...
    public BatchAssociateAssessmentReportEvidenceResult withEvidenceIds(java.util.Collection<String> evidenceIds) {
    ...
    public BatchAssociateAssessmentReportEvidenceResult withErrors(java.util.Collection<AssessmentReportEvidenceError> errors) {
        setErrors(errors);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchAssociateAssessmentReportEvidenceResult == false)
            return false;
        BatchAssociateAssessmentReportEvidenceResult other = (BatchAssociateAssessmentReportEvidenceResult) obj;
    ...
    public BatchAssociateAssessmentReportEvidenceResult clone() {
        try {
            return (BatchAssociateAssessmentReportEvidenceResult) super.clone();
