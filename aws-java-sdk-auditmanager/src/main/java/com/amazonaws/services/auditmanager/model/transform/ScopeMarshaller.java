...
public class ScopeMarshaller {
    ...
    private static final MarshallingInfo<List> AWSACCOUNTS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("awsAccounts").build();
    ...
    public void marshall(Scope scope, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(scope.getAwsAccounts(), AWSACCOUNTS_BINDING);
            protocolMarshaller.marshall(scope.getAwsServices(), AWSSERVICES_BINDING);
        } catch (Exception e) {
