...
/**
 * Control JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ControlJsonUnmarshaller implements Unmarshaller<Control, JsonUnmarshallerContext> {

    public Control unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("state", targetDepth)) {
                    context.nextToken();
                    control.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ControlJsonUnmarshaller instance;

    public static ControlJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ControlJsonUnmarshaller();
        return instance;
    }
}
