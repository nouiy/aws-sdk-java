...
public class ListControlInsightsByControlDomainRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListControlInsightsByControlDomainRequest withControlDomainId(String controlDomainId) {
        setControlDomainId(controlDomainId);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getControlDomainId() != null)
            sb.append("ControlDomainId: ").append(getControlDomainId()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListControlInsightsByControlDomainRequest == false)
            return false;
        ListControlInsightsByControlDomainRequest other = (ListControlInsightsByControlDomainRequest) obj;
        if (other.getControlDomainId() == null ^ this.getControlDomainId() == null)
            return false;
        if (other.getControlDomainId() != null && other.getControlDomainId().equals(this.getControlDomainId()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getControlDomainId() == null) ? 0 : getControlDomainId().hashCode());
    ...
    @Override
    public ListControlInsightsByControlDomainRequest clone() {
        return (ListControlInsightsByControlDomainRequest) super.clone();
    }
