...
public class AWSAccountMarshaller {
    ...
    public void marshall(AWSAccount aWSAccount, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(aWSAccount.getId(), ID_BINDING);
            protocolMarshaller.marshall(aWSAccount.getEmailAddress(), EMAILADDRESS_BINDING);
            protocolMarshaller.marshall(aWSAccount.getName(), NAME_BINDING);
        } catch (Exception e) {
