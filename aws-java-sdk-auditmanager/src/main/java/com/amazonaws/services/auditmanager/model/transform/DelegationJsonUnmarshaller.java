...
/**
 * Delegation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DelegationJsonUnmarshaller implements Unmarshaller<Delegation, JsonUnmarshallerContext> {

    public Delegation unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DelegationJsonUnmarshaller instance;

    public static DelegationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DelegationJsonUnmarshaller();
        return instance;
    }
}
