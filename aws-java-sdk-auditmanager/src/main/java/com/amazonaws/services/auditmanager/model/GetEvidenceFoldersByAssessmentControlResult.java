...
public class GetEvidenceFoldersByAssessmentControlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetEvidenceFoldersByAssessmentControlResult withEvidenceFolders(AssessmentEvidenceFolder... evidenceFolders) {
    ...
    public GetEvidenceFoldersByAssessmentControlResult withEvidenceFolders(java.util.Collection<AssessmentEvidenceFolder> evidenceFolders) {
    ...
    public GetEvidenceFoldersByAssessmentControlResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEvidenceFoldersByAssessmentControlResult == false)
            return false;
        GetEvidenceFoldersByAssessmentControlResult other = (GetEvidenceFoldersByAssessmentControlResult) obj;
    ...
    @Override
    public GetEvidenceFoldersByAssessmentControlResult clone() {
        try {
            return (GetEvidenceFoldersByAssessmentControlResult) super.clone();
