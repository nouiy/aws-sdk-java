...
public class UpdateControlResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateControlResult withControl(Control control) {
        setControl(control);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateControlResult == false)
            return false;
        UpdateControlResult other = (UpdateControlResult) obj;
    ...
    public UpdateControlResult clone() {
        try {
            return (UpdateControlResult) super.clone();
