        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("at", targetDepth)) {
                    context.nextToken();
                    schedule.setAt(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("cron", targetDepth)) {
                    context.nextToken();
                    schedule.setCron(context.getUnmarshaller(String.class).unmarshall(context));
                }
