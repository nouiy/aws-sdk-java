...
public class RestoreTableFromRecoveryPointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public RestoreTableFromRecoveryPointResult withTableRestoreStatus(TableRestoreStatus tableRestoreStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreTableFromRecoveryPointResult == false)
            return false;
        RestoreTableFromRecoveryPointResult other = (RestoreTableFromRecoveryPointResult) obj;
    ...
    @Override
    public RestoreTableFromRecoveryPointResult clone() {
        try {
            return (RestoreTableFromRecoveryPointResult) super.clone();
