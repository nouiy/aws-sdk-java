...
public class ListTagsLogGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListTagsLogGroupResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ListTagsLogGroupResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ListTagsLogGroupResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTagsLogGroupResult == false)
            return false;
        ListTagsLogGroupResult other = (ListTagsLogGroupResult) obj;
    ...
    public ListTagsLogGroupResult clone() {
        try {
            return (ListTagsLogGroupResult) super.clone();
