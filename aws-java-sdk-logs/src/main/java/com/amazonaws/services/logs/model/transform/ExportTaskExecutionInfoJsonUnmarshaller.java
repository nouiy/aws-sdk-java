...
public class ExportTaskExecutionInfoJsonUnmarshaller implements Unmarshaller<ExportTaskExecutionInfo, JsonUnmarshallerContext> {

    public ExportTaskExecutionInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
