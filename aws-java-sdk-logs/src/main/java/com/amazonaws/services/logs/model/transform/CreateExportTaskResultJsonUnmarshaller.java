...
public class CreateExportTaskResultJsonUnmarshaller implements Unmarshaller<CreateExportTaskResult, JsonUnmarshallerContext> {
    ...
    public CreateExportTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskId", targetDepth)) {
                    context.nextToken();
                    createExportTaskResult.setTaskId(context.getUnmarshaller(String.class).unmarshall(context));
                }
