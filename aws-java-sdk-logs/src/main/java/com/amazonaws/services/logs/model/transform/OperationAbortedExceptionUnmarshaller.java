...
public class OperationAbortedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OperationAbortedExceptionUnmarshaller instance;

    public static OperationAbortedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OperationAbortedExceptionUnmarshaller();
        return instance;
    }
}
