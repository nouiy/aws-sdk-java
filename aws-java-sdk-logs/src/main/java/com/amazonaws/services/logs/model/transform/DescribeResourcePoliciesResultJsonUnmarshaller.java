...
/**
 * DescribeResourcePoliciesResult JSON Unmarshaller
 */
...
public class DescribeResourcePoliciesResultJsonUnmarshaller implements Unmarshaller<DescribeResourcePoliciesResult, JsonUnmarshallerContext> {
    ...
    public DescribeResourcePoliciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeResourcePoliciesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
