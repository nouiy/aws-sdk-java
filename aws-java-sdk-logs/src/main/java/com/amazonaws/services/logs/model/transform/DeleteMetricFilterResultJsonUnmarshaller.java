...
public class DeleteMetricFilterResultJsonUnmarshaller implements Unmarshaller<DeleteMetricFilterResult, JsonUnmarshallerContext> {
    ...
    public DeleteMetricFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMetricFilterResult deleteMetricFilterResult = new DeleteMetricFilterResult();
