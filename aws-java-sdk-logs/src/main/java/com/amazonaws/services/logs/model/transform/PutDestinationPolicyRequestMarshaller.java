...
public class PutDestinationPolicyRequestMarshaller {
    ...
    public static PutDestinationPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutDestinationPolicyRequest putDestinationPolicyRequest, ProtocolMarshaller protocolMarshaller) {
