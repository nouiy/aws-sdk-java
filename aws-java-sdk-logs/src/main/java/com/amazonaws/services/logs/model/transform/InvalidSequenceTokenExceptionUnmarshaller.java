...
public class InvalidSequenceTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("expectedSequenceToken", targetDepth)) {
                    context.nextToken();
                    invalidSequenceTokenException.setExpectedSequenceToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidSequenceTokenExceptionUnmarshaller instance;

    public static InvalidSequenceTokenExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSequenceTokenExceptionUnmarshaller();
        return instance;
    }
}
