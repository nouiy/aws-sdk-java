...
public class UnrecognizedClientExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnrecognizedClientExceptionUnmarshaller instance;

    public static UnrecognizedClientExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnrecognizedClientExceptionUnmarshaller();
        return instance;
    }
}
