...
/**
 * ResultField JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResultFieldJsonUnmarshaller implements Unmarshaller<ResultField, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("field", targetDepth)) {
                    context.nextToken();
                    resultField.setField(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    resultField.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
