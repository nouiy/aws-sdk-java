...
public class CodeStorageExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    codeStorageExceededException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static CodeStorageExceededExceptionUnmarshaller instance;

    public static CodeStorageExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeStorageExceededExceptionUnmarshaller();
        return instance;
    }
}
