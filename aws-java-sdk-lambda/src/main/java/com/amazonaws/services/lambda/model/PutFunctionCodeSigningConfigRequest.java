...
public class PutFunctionCodeSigningConfigRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutFunctionCodeSigningConfigRequest withCodeSigningConfigArn(String codeSigningConfigArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutFunctionCodeSigningConfigRequest == false)
            return false;
        PutFunctionCodeSigningConfigRequest other = (PutFunctionCodeSigningConfigRequest) obj;
    ...
    @Override
    public PutFunctionCodeSigningConfigRequest clone() {
        return (PutFunctionCodeSigningConfigRequest) super.clone();
    }
