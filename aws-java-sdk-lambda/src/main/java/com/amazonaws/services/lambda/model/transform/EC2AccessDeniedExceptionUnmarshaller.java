...
public class EC2AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    eC2AccessDeniedException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static EC2AccessDeniedExceptionUnmarshaller instance;

    public static EC2AccessDeniedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EC2AccessDeniedExceptionUnmarshaller();
        return instance;
    }
}
