...
public class DestinationConfigMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ONSUCCESS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("OnSuccess").build();
    ...
    public void marshall(DestinationConfig destinationConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(destinationConfig.getOnSuccess(), ONSUCCESS_BINDING);
            protocolMarshaller.marshall(destinationConfig.getOnFailure(), ONFAILURE_BINDING);
        } catch (Exception e) {
