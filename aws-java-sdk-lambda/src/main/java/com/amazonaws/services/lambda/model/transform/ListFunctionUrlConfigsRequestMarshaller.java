...
public class ListFunctionUrlConfigsRequestMarshaller {
    ...
    private static final ListFunctionUrlConfigsRequestMarshaller instance = new ListFunctionUrlConfigsRequestMarshaller();

    public static ListFunctionUrlConfigsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListFunctionUrlConfigsRequest listFunctionUrlConfigsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listFunctionUrlConfigsRequest.getFunctionName(), FUNCTIONNAME_BINDING);
            protocolMarshaller.marshall(listFunctionUrlConfigsRequest.getMarker(), MARKER_BINDING);
            protocolMarshaller.marshall(listFunctionUrlConfigsRequest.getMaxItems(), MAXITEMS_BINDING);
        } catch (Exception e) {
