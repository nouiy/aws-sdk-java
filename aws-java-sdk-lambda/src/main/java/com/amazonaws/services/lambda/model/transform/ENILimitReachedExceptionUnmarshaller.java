...
public class ENILimitReachedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    eNILimitReachedException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ENILimitReachedExceptionUnmarshaller instance;

    public static ENILimitReachedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ENILimitReachedExceptionUnmarshaller();
        return instance;
    }
}
