...
public class SubnetIPAddressLimitReachedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    subnetIPAddressLimitReachedException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SubnetIPAddressLimitReachedExceptionUnmarshaller instance;

    public static SubnetIPAddressLimitReachedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SubnetIPAddressLimitReachedExceptionUnmarshaller();
        return instance;
    }
}
