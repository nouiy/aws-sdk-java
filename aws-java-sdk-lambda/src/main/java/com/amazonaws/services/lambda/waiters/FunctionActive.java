...
class FunctionActive {
    ...
    static class IsActiveMatcher extends WaiterAcceptor<GetFunctionConfigurationResult> {
    ...
    static class IsPendingMatcher extends WaiterAcceptor<GetFunctionConfigurationResult> {
        private static final JsonNode expectedResult;
