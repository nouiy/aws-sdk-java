...
public class GetFunctionEventInvokeConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetFunctionEventInvokeConfigResult withLastModified(java.util.Date lastModified) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetFunctionEventInvokeConfigResult == false)
            return false;
        GetFunctionEventInvokeConfigResult other = (GetFunctionEventInvokeConfigResult) obj;
    ...
    @Override
    public GetFunctionEventInvokeConfigResult clone() {
        try {
            return (GetFunctionEventInvokeConfigResult) super.clone();
