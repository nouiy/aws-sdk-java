...
public class EC2UnexpectedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    eC2UnexpectedException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("EC2ErrorCode", targetDepth)) {
                    context.nextToken();
                    eC2UnexpectedException.setEC2ErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static EC2UnexpectedExceptionUnmarshaller instance;

    public static EC2UnexpectedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EC2UnexpectedExceptionUnmarshaller();
        return instance;
    }
}
