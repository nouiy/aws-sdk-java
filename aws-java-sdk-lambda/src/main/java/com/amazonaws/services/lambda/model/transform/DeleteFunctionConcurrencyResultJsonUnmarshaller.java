...
/**
 * DeleteFunctionConcurrencyResult JSON Unmarshaller
 */
...
public class DeleteFunctionConcurrencyResultJsonUnmarshaller implements Unmarshaller<DeleteFunctionConcurrencyResult, JsonUnmarshallerContext> {
    ...
    public DeleteFunctionConcurrencyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFunctionConcurrencyResult deleteFunctionConcurrencyResult = new DeleteFunctionConcurrencyResult();

        return deleteFunctionConcurrencyResult;
    }
