...
public class UpdateFunctionEventInvokeConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateFunctionEventInvokeConfigResult withLastModified(java.util.Date lastModified) {
    ...
    public UpdateFunctionEventInvokeConfigResult withFunctionArn(String functionArn) {
    ...
    public UpdateFunctionEventInvokeConfigResult withMaximumRetryAttempts(Integer maximumRetryAttempts) {
    ...
    public UpdateFunctionEventInvokeConfigResult withMaximumEventAgeInSeconds(Integer maximumEventAgeInSeconds) {
    ...
    public UpdateFunctionEventInvokeConfigResult withDestinationConfig(DestinationConfig destinationConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateFunctionEventInvokeConfigResult == false)
            return false;
        UpdateFunctionEventInvokeConfigResult other = (UpdateFunctionEventInvokeConfigResult) obj;
    ...
    @Override
    public UpdateFunctionEventInvokeConfigResult clone() {
        try {
            return (UpdateFunctionEventInvokeConfigResult) super.clone();
