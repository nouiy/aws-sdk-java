...
public class PutFunctionConcurrencyRequestMarshaller {
    ...
    private static final MarshallingInfo<Integer> RESERVEDCONCURRENTEXECUTIONS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ReservedConcurrentExecutions").build();

    private static final PutFunctionConcurrencyRequestMarshaller instance = new PutFunctionConcurrencyRequestMarshaller();

    public static PutFunctionConcurrencyRequestMarshaller getInstance() {
        return instance;
    }
