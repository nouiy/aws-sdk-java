...
public class InvalidRuntimeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    invalidRuntimeException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidRuntimeExceptionUnmarshaller instance;

    public static InvalidRuntimeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRuntimeExceptionUnmarshaller();
        return instance;
    }
}
