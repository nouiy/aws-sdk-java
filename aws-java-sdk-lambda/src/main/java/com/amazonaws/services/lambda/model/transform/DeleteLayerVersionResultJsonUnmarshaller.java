...
/**
 * DeleteLayerVersionResult JSON Unmarshaller
 */
...
public class DeleteLayerVersionResultJsonUnmarshaller implements Unmarshaller<DeleteLayerVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteLayerVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLayerVersionResult deleteLayerVersionResult = new DeleteLayerVersionResult();

        return deleteLayerVersionResult;
    }
