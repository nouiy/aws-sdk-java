...
public class TooManyRequestsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyRequestsExceptionUnmarshaller() {
        super(com.amazonaws.services.lambda.model.TooManyRequestsException.class, "TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.lambda.model.TooManyRequestsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.lambda.model.TooManyRequestsException tooManyRequestsException = new com.amazonaws.services.lambda.model.TooManyRequestsException(
                null);
