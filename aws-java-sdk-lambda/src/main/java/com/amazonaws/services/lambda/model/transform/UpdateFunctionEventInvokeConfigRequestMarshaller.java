...
@SdkInternalApi
public class UpdateFunctionEventInvokeConfigRequestMarshaller {
    ...
    private static final UpdateFunctionEventInvokeConfigRequestMarshaller instance = new UpdateFunctionEventInvokeConfigRequestMarshaller();

    public static UpdateFunctionEventInvokeConfigRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateFunctionEventInvokeConfigRequest updateFunctionEventInvokeConfigRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateFunctionEventInvokeConfigRequest.getFunctionName(), FUNCTIONNAME_BINDING);
            protocolMarshaller.marshall(updateFunctionEventInvokeConfigRequest.getQualifier(), QUALIFIER_BINDING);
            protocolMarshaller.marshall(updateFunctionEventInvokeConfigRequest.getMaximumRetryAttempts(), MAXIMUMRETRYATTEMPTS_BINDING);
            protocolMarshaller.marshall(updateFunctionEventInvokeConfigRequest.getMaximumEventAgeInSeconds(), MAXIMUMEVENTAGEINSECONDS_BINDING);
            protocolMarshaller.marshall(updateFunctionEventInvokeConfigRequest.getDestinationConfig(), DESTINATIONCONFIG_BINDING);
        } catch (Exception e) {
