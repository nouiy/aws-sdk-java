...
/**
 * RemoveLayerVersionPermissionResult JSON Unmarshaller
 */
...
public class RemoveLayerVersionPermissionResultJsonUnmarshaller implements Unmarshaller<RemoveLayerVersionPermissionResult, JsonUnmarshallerContext> {
    ...
    public RemoveLayerVersionPermissionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveLayerVersionPermissionResult removeLayerVersionPermissionResult = new RemoveLayerVersionPermissionResult();

        return removeLayerVersionPermissionResult;
    }
