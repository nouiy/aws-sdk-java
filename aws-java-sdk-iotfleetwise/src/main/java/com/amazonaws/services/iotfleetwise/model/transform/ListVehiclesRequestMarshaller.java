...
/**
 * ListVehiclesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListVehiclesRequestMarshaller {
    ...
    private static final ListVehiclesRequestMarshaller instance = new ListVehiclesRequestMarshaller();

    public static ListVehiclesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListVehiclesRequest listVehiclesRequest, ProtocolMarshaller protocolMarshaller) {

        if (listVehiclesRequest == null) {
