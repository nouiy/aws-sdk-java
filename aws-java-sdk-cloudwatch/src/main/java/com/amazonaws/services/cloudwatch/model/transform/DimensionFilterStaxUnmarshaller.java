        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Name", targetDepth)) {
                    dimensionFilter.setName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Value", targetDepth)) {
                    dimensionFilter.setValue(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
