...
/**
 * DeleteDashboardsResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteDashboardsResultStaxUnmarshaller implements Unmarshaller<DeleteDashboardsResult, StaxUnmarshallerContext> {

    public DeleteDashboardsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
