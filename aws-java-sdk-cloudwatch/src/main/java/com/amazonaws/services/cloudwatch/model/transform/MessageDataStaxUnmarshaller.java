...
public class MessageDataStaxUnmarshaller implements Unmarshaller<MessageData, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Code", targetDepth)) {
                    messageData.setCode(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Value", targetDepth)) {
                    messageData.setValue(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
