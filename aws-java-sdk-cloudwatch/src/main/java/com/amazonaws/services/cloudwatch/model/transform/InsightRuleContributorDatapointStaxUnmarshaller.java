...
/**
 * InsightRuleContributorDatapoint StAX Unmarshaller
 */
...
public class InsightRuleContributorDatapointStaxUnmarshaller implements Unmarshaller<InsightRuleContributorDatapoint, StaxUnmarshallerContext> {
    ...
    public InsightRuleContributorDatapoint unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Timestamp", targetDepth)) {
                    insightRuleContributorDatapoint.setTimestamp(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }

                if (context.testExpression("ApproximateValue", targetDepth)) {
                    insightRuleContributorDatapoint.setApproximateValue(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
