...
/**
 * ListDashboardsResult StAX Unmarshaller
 */
...
public class ListDashboardsResultStaxUnmarshaller implements Unmarshaller<ListDashboardsResult, StaxUnmarshallerContext> {
    ...
    public ListDashboardsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DashboardEntries", targetDepth)) {
                    listDashboardsResult.withDashboardEntries(new ArrayList<DashboardEntry>());
                    continue;
                }

                if (context.testExpression("DashboardEntries/member", targetDepth)) {
                    listDashboardsResult.withDashboardEntries(DashboardEntryStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("NextToken", targetDepth)) {
                    listDashboardsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
