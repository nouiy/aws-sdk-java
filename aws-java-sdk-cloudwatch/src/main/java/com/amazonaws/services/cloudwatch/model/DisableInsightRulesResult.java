...
public class DisableInsightRulesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisableInsightRulesResult withFailures(PartialFailure... failures) {
    ...
    public DisableInsightRulesResult withFailures(java.util.Collection<PartialFailure> failures) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableInsightRulesResult == false)
            return false;
        DisableInsightRulesResult other = (DisableInsightRulesResult) obj;
    ...
    @Override
    public DisableInsightRulesResult clone() {
        try {
            return (DisableInsightRulesResult) super.clone();
