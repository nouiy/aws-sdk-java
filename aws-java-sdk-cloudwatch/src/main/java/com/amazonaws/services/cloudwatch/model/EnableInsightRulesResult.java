...
public class EnableInsightRulesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public EnableInsightRulesResult withFailures(PartialFailure... failures) {
    ...
    public EnableInsightRulesResult withFailures(java.util.Collection<PartialFailure> failures) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableInsightRulesResult == false)
            return false;
        EnableInsightRulesResult other = (EnableInsightRulesResult) obj;
    ...
    public EnableInsightRulesResult clone() {
        try {
            return (EnableInsightRulesResult) super.clone();
