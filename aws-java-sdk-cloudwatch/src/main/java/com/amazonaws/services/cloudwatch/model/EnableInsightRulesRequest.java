...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/EnableInsightRules" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnableInsightRulesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * An array of the rule names to enable. If you need to find out the names of your rules, use <a
     ...
     * </p>
     * 
     * @return An array of the rule names to enable. If you need to find out the names of your rules, use <a
     *         href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_DescribeInsightRules.html"
     *         >DescribeInsightRules</a>.
     */
    ...
    public EnableInsightRulesRequest withRuleNames(String... ruleNames) {
    ...
    public EnableInsightRulesRequest withRuleNames(java.util.Collection<String> ruleNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableInsightRulesRequest == false)
            return false;
        EnableInsightRulesRequest other = (EnableInsightRulesRequest) obj;
    ...
    @Override
    public EnableInsightRulesRequest clone() {
        return (EnableInsightRulesRequest) super.clone();
    }
