...
public class DeleteAppRequestMarshaller {
    ...
    public void marshall(DeleteAppRequest deleteAppRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteAppRequest.getAppArn(), APPARN_BINDING);
            protocolMarshaller.marshall(deleteAppRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(deleteAppRequest.getForceDelete(), FORCEDELETE_BINDING);
        } catch (Exception e) {
