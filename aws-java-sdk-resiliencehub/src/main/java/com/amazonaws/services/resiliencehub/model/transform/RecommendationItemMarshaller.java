...
/**
 * RecommendationItemMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecommendationItemMarshaller {
    ...
    private static final RecommendationItemMarshaller instance = new RecommendationItemMarshaller();

    public static RecommendationItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecommendationItem recommendationItem, ProtocolMarshaller protocolMarshaller) {
