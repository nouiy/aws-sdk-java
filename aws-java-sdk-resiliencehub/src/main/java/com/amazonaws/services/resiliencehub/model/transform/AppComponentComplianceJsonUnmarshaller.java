...
/**
 * AppComponentCompliance JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AppComponentComplianceJsonUnmarshaller implements Unmarshaller<AppComponentCompliance, JsonUnmarshallerContext> {

    public AppComponentCompliance unmarshall(JsonUnmarshallerContext context) throws Exception {
        AppComponentCompliance appComponentCompliance = new AppComponentCompliance();
    ...
    private static AppComponentComplianceJsonUnmarshaller instance;

    public static AppComponentComplianceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AppComponentComplianceJsonUnmarshaller();
        return instance;
    }
}
