...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.resiliencehub.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.resiliencehub.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.resiliencehub.model.ConflictException conflictException = new com.amazonaws.services.resiliencehub.model.ConflictException(null);
