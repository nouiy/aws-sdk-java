...
public class DescribeResiliencyPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeResiliencyPolicyResult == false)
            return false;
        DescribeResiliencyPolicyResult other = (DescribeResiliencyPolicyResult) obj;
    ...
    @Override
    public DescribeResiliencyPolicyResult clone() {
        try {
            return (DescribeResiliencyPolicyResult) super.clone();
