...
public enum ConfigRecommendationOptimizationType {
     ...
     * @param value
     *        real value
     * @return ConfigRecommendationOptimizationType corresponding to the value
     *
    ...
    public static ConfigRecommendationOptimizationType fromValue(String value) {
        ...
        for (ConfigRecommendationOptimizationType enumEntry : ConfigRecommendationOptimizationType.values()) {
