 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/LifeCycleLastTestFinalized" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LifeCycleLastTestFinalized implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Lifecycle Test failed API call date and time.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LifeCycleLastTestFinalized == false)
            return false;
        LifeCycleLastTestFinalized other = (LifeCycleLastTestFinalized) obj;
    ...
    public LifeCycleLastTestFinalized clone() {
        try {
            return (LifeCycleLastTestFinalized) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.LifeCycleLastTestFinalizedMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
