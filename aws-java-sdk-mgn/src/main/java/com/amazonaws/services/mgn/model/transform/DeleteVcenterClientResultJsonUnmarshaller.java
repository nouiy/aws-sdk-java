...
/**
 * DeleteVcenterClientResult JSON Unmarshaller
 */
...
public class DeleteVcenterClientResultJsonUnmarshaller implements Unmarshaller<DeleteVcenterClientResult, JsonUnmarshallerContext> {
    ...
    public DeleteVcenterClientResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVcenterClientResult deleteVcenterClientResult = new DeleteVcenterClientResult();
