 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mgn-2020-02-26/LifeCycleLastCutoverInitiated" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LifeCycleLastCutoverInitiated implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Lifecycle last Cutover initiated by Job ID.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LifeCycleLastCutoverInitiated == false)
            return false;
        LifeCycleLastCutoverInitiated other = (LifeCycleLastCutoverInitiated) obj;
    ...
    @Override
    public LifeCycleLastCutoverInitiated clone() {
        try {
            return (LifeCycleLastCutoverInitiated) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mgn.model.transform.LifeCycleLastCutoverInitiatedMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
