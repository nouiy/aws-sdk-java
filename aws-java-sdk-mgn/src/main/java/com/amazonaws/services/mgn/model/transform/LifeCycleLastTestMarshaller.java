...
/**
 * LifeCycleLastTestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LifeCycleLastTestMarshaller {
    ...
    private static final LifeCycleLastTestMarshaller instance = new LifeCycleLastTestMarshaller();

    public static LifeCycleLastTestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LifeCycleLastTest lifeCycleLastTest, ProtocolMarshaller protocolMarshaller) {

        if (lifeCycleLastTest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(lifeCycleLastTest.getFinalized(), FINALIZED_BINDING);
            protocolMarshaller.marshall(lifeCycleLastTest.getInitiated(), INITIATED_BINDING);
            protocolMarshaller.marshall(lifeCycleLastTest.getReverted(), REVERTED_BINDING);
        } catch (Exception e) {
