...
/**
 * ImportNotebookRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ImportNotebookRequestMarshaller {
    ...
    private static final ImportNotebookRequestMarshaller instance = new ImportNotebookRequestMarshaller();

    public static ImportNotebookRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ImportNotebookRequest importNotebookRequest, ProtocolMarshaller protocolMarshaller) {

        if (importNotebookRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(importNotebookRequest.getWorkGroup(), WORKGROUP_BINDING);
