...
public class ImportNotebookResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportNotebookResult == false)
            return false;
        ImportNotebookResult other = (ImportNotebookResult) obj;
    ...
    public ImportNotebookResult clone() {
        try {
            return (ImportNotebookResult) super.clone();
