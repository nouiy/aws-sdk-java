 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/athena-2017-05-18/QueryRuntimeStatisticsTimeline"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class QueryRuntimeStatisticsTimeline implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getTotalExecutionTimeInMillis() != null)
            sb.append("TotalExecutionTimeInMillis: ").append(getTotalExecutionTimeInMillis());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QueryRuntimeStatisticsTimeline == false)
            return false;
    ...
    public QueryRuntimeStatisticsTimeline clone() {
        try {
            return (QueryRuntimeStatisticsTimeline) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.athena.model.transform.QueryRuntimeStatisticsTimelineMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
