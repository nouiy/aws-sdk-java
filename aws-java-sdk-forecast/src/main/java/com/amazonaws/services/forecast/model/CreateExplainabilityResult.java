...
public class CreateExplainabilityResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateExplainabilityResult withExplainabilityArn(String explainabilityArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateExplainabilityResult == false)
            return false;
        CreateExplainabilityResult other = (CreateExplainabilityResult) obj;
    ...
    @Override
    public CreateExplainabilityResult clone() {
        try {
            return (CreateExplainabilityResult) super.clone();
