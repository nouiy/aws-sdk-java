 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/forecast-2018-06-26/ExplainabilityExportSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExplainabilityExportSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ExplainabilityExportSummary withCreationTime(java.util.Date creationTime) {
    ...
    public ExplainabilityExportSummary withLastModificationTime(java.util.Date lastModificationTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExplainabilityExportSummary == false)
            return false;
    ...
    public ExplainabilityExportSummary clone() {
        try {
            return (ExplainabilityExportSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.forecast.model.transform.ExplainabilityExportSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
