...
/**
 * PredictorSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredictorSummaryJsonUnmarshaller implements Unmarshaller<PredictorSummary, JsonUnmarshallerContext> {

    public PredictorSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        PredictorSummary predictorSummary = new PredictorSummary();
    ...
    private static PredictorSummaryJsonUnmarshaller instance;

    public static PredictorSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PredictorSummaryJsonUnmarshaller();
        return instance;
    }
}
