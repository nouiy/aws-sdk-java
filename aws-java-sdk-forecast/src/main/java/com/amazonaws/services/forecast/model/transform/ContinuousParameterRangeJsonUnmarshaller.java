        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("MaxValue", targetDepth)) {
                    context.nextToken();
                    continuousParameterRange.setMaxValue(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("MinValue", targetDepth)) {
                    context.nextToken();
                    continuousParameterRange.setMinValue(context.getUnmarshaller(Double.class).unmarshall(context));
                }
