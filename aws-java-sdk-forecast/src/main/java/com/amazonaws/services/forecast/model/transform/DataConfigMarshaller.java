...
public class DataConfigMarshaller {
    ...
    private static final MarshallingInfo<List> ATTRIBUTECONFIGS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AttributeConfigs").build();
    private static final MarshallingInfo<List> ADDITIONALDATASETS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AdditionalDatasets").build();
    ...
    public void marshall(DataConfig dataConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataConfig.getDatasetGroupArn(), DATASETGROUPARN_BINDING);
