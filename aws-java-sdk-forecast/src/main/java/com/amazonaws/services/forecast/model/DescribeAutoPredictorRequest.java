...
public class DescribeAutoPredictorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAutoPredictorRequest == false)
            return false;
        DescribeAutoPredictorRequest other = (DescribeAutoPredictorRequest) obj;
    ...
    @Override
    public DescribeAutoPredictorRequest clone() {
        return (DescribeAutoPredictorRequest) super.clone();
    }
