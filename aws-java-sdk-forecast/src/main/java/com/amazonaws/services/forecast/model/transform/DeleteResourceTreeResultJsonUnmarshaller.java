...
/**
 * DeleteResourceTreeResult JSON Unmarshaller
 */
...
public class DeleteResourceTreeResultJsonUnmarshaller implements Unmarshaller<DeleteResourceTreeResult, JsonUnmarshallerContext> {
    ...
    public DeleteResourceTreeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteResourceTreeResult deleteResourceTreeResult = new DeleteResourceTreeResult();

        return deleteResourceTreeResult;
    }
