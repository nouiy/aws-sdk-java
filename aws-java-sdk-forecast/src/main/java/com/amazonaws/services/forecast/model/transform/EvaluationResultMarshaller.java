...
public class EvaluationResultMarshaller {
    ...
    public void marshall(EvaluationResult evaluationResult, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(evaluationResult.getAlgorithmArn(), ALGORITHMARN_BINDING);
            protocolMarshaller.marshall(evaluationResult.getTestWindows(), TESTWINDOWS_BINDING);
        } catch (Exception e) {
