 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/forecast-2018-06-26/AdditionalDataset" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AdditionalDataset implements Serializable, Cloneable, StructuredPojo {
     ...
     * </ul>
     */
    private java.util.Map<String, java.util.List<String>> configuration;
    ...
    public java.util.Map<String, java.util.List<String>> getConfiguration() {
    ...
    public void setConfiguration(java.util.Map<String, java.util.List<String>> configuration) {
    ...
    public AdditionalDataset withConfiguration(java.util.Map<String, java.util.List<String>> configuration) {
     ...
     *
     * @see AdditionalDataset#withConfiguration
     * @returns a reference to this object so that method calls can be chained together.
     */

    public AdditionalDataset addConfigurationEntry(String key, java.util.List<String> value) {
        if (null == this.configuration) {
            this.configuration = new java.util.HashMap<String, java.util.List<String>>();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdditionalDataset == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.forecast.model.transform.AdditionalDatasetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
