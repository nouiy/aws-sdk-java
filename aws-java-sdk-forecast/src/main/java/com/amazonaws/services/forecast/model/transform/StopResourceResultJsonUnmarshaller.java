...
/**
 * StopResourceResult JSON Unmarshaller
 */
...
public class StopResourceResultJsonUnmarshaller implements Unmarshaller<StopResourceResult, JsonUnmarshallerContext> {
    ...
    public StopResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopResourceResult stopResourceResult = new StopResourceResult();

        return stopResourceResult;
    }
