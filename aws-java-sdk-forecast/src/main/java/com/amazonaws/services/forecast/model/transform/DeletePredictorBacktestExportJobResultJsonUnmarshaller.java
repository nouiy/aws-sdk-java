...
/**
 * DeletePredictorBacktestExportJobResult JSON Unmarshaller
 */
...
public class DeletePredictorBacktestExportJobResultJsonUnmarshaller implements Unmarshaller<DeletePredictorBacktestExportJobResult, JsonUnmarshallerContext> {
    ...
    public DeletePredictorBacktestExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePredictorBacktestExportJobResult deletePredictorBacktestExportJobResult = new DeletePredictorBacktestExportJobResult();

        return deletePredictorBacktestExportJobResult;
    }
