 ...
 * operation. To get a complete set of properties, call the <a>DescribePredictorBacktestExportJob</a> operation, and
 * provide the listed <code>PredictorBacktestExportJobArn</code>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/forecast-2018-06-26/PredictorBacktestExportJobSummary"
...
public class PredictorBacktestExportJobSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public PredictorBacktestExportJobSummary withCreationTime(java.util.Date creationTime) {
    ...
    public PredictorBacktestExportJobSummary withLastModificationTime(java.util.Date lastModificationTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PredictorBacktestExportJobSummary == false)
            return false;
        PredictorBacktestExportJobSummary other = (PredictorBacktestExportJobSummary) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.forecast.model.transform.PredictorBacktestExportJobSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
