...
public class DatasetImportJobSummaryMarshaller {
    ...
    public void marshall(DatasetImportJobSummary datasetImportJobSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(datasetImportJobSummary.getDatasetImportJobName(), DATASETIMPORTJOBNAME_BINDING);
            protocolMarshaller.marshall(datasetImportJobSummary.getDataSource(), DATASOURCE_BINDING);
