...
/**
 * AutoTuneOptionsInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AutoTuneOptionsInputMarshaller {
    ...
    public static AutoTuneOptionsInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AutoTuneOptionsInput autoTuneOptionsInput, ProtocolMarshaller protocolMarshaller) {

        if (autoTuneOptionsInput == null) {
