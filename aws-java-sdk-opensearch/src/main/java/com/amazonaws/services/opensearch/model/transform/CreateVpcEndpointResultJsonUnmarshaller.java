...
/**
 * CreateVpcEndpointResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateVpcEndpointResultJsonUnmarshaller implements Unmarshaller<CreateVpcEndpointResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VpcEndpoint", targetDepth)) {
                    context.nextToken();
                    createVpcEndpointResult.setVpcEndpoint(VpcEndpointJsonUnmarshaller.getInstance().unmarshall(context));
                }
