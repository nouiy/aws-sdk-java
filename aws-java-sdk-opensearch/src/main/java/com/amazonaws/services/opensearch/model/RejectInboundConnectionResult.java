...
public class RejectInboundConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Contains details about the rejected inbound connection.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectInboundConnectionResult == false)
            return false;
        RejectInboundConnectionResult other = (RejectInboundConnectionResult) obj;
    ...
    public RejectInboundConnectionResult clone() {
        try {
            return (RejectInboundConnectionResult) super.clone();
