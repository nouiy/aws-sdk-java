...
public class SAMLIdpMarshaller {
    ...
    private static final MarshallingInfo<String> METADATACONTENT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MetadataContent").build();
    ...
    public void marshall(SAMLIdp sAMLIdp, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sAMLIdp.getMetadataContent(), METADATACONTENT_BINDING);
            protocolMarshaller.marshall(sAMLIdp.getEntityId(), ENTITYID_BINDING);
        } catch (Exception e) {
