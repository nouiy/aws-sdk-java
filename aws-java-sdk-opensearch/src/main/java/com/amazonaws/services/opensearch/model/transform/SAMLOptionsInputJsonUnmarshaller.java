...
/**
 * SAMLOptionsInput JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SAMLOptionsInputJsonUnmarshaller implements Unmarshaller<SAMLOptionsInput, JsonUnmarshallerContext> {

    public SAMLOptionsInput unmarshall(JsonUnmarshallerContext context) throws Exception {
        SAMLOptionsInput sAMLOptionsInput = new SAMLOptionsInput();
    ...
    private static SAMLOptionsInputJsonUnmarshaller instance;

    public static SAMLOptionsInputJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SAMLOptionsInputJsonUnmarshaller();
        return instance;
    }
}
