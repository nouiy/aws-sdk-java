...
public class JWTOptionsOutputMarshaller {
    ...
    public void marshall(JWTOptionsOutput jWTOptionsOutput, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jWTOptionsOutput.getEnabled(), ENABLED_BINDING);
            protocolMarshaller.marshall(jWTOptionsOutput.getSubjectKey(), SUBJECTKEY_BINDING);
            protocolMarshaller.marshall(jWTOptionsOutput.getRolesKey(), ROLESKEY_BINDING);
            protocolMarshaller.marshall(jWTOptionsOutput.getPublicKey(), PUBLICKEY_BINDING);
        } catch (Exception e) {
