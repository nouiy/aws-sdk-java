...
public class DeleteOutboundConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteOutboundConnectionResult == false)
            return false;
        DeleteOutboundConnectionResult other = (DeleteOutboundConnectionResult) obj;
    ...
    public DeleteOutboundConnectionResult clone() {
        try {
            return (DeleteOutboundConnectionResult) super.clone();
