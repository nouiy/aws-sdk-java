...
public class AssociatePackageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about a package that is associated with a domain.
     */
    ...
    @Override
    public AssociatePackageResult clone() {
        try {
            return (AssociatePackageResult) super.clone();
