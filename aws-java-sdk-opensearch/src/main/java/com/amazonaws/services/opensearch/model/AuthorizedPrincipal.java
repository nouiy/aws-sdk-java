...
/**
 * <p>
 * Information about an Amazon Web Services account or service that has access to an Amazon OpenSearch Service domain
...
public class AuthorizedPrincipal implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearch.model.transform.AuthorizedPrincipalMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
