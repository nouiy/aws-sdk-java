...
/**
 * DescribeVpcEndpointsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeVpcEndpointsResultJsonUnmarshaller implements Unmarshaller<DescribeVpcEndpointsResult, JsonUnmarshallerContext> {

    public DescribeVpcEndpointsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DescribeVpcEndpointsResultJsonUnmarshaller instance;

    public static DescribeVpcEndpointsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeVpcEndpointsResultJsonUnmarshaller();
        return instance;
    }
}
