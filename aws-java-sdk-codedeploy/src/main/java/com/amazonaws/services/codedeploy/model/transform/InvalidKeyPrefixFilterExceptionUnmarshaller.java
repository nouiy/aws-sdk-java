...
public class InvalidKeyPrefixFilterExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidKeyPrefixFilterExceptionUnmarshaller instance;

    public static InvalidKeyPrefixFilterExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidKeyPrefixFilterExceptionUnmarshaller();
        return instance;
    }
}
