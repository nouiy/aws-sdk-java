...
public class InvalidAlarmConfigExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAlarmConfigExceptionUnmarshaller instance;

    public static InvalidAlarmConfigExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAlarmConfigExceptionUnmarshaller();
        return instance;
    }
}
