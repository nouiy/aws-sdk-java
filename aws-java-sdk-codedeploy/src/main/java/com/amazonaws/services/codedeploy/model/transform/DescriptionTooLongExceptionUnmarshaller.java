...
public class DescriptionTooLongExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DescriptionTooLongExceptionUnmarshaller instance;

    public static DescriptionTooLongExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescriptionTooLongExceptionUnmarshaller();
        return instance;
    }
}
