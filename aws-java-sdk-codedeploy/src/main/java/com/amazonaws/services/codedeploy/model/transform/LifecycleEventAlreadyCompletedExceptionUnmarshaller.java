...
public class LifecycleEventAlreadyCompletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LifecycleEventAlreadyCompletedExceptionUnmarshaller instance;

    public static LifecycleEventAlreadyCompletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LifecycleEventAlreadyCompletedExceptionUnmarshaller();
        return instance;
    }
}
