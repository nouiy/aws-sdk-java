...
public class ListGitHubAccountTokenNamesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListGitHubAccountTokenNamesRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListGitHubAccountTokenNamesRequest == false)
            return false;
        ListGitHubAccountTokenNamesRequest other = (ListGitHubAccountTokenNamesRequest) obj;
    ...
    @Override
    public ListGitHubAccountTokenNamesRequest clone() {
        return (ListGitHubAccountTokenNamesRequest) super.clone();
    }
