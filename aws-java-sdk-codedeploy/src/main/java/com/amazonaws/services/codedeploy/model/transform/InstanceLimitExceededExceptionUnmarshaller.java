...
public class InstanceLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InstanceLimitExceededExceptionUnmarshaller instance;

    public static InstanceLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
