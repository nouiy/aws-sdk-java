...
public class DeploymentNotStartedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentNotStartedExceptionUnmarshaller instance;

    public static DeploymentNotStartedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentNotStartedExceptionUnmarshaller();
        return instance;
    }
}
