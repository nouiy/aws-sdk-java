...
public class InvalidAutoScalingGroupExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAutoScalingGroupExceptionUnmarshaller instance;

    public static InvalidAutoScalingGroupExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAutoScalingGroupExceptionUnmarshaller();
        return instance;
    }
}
