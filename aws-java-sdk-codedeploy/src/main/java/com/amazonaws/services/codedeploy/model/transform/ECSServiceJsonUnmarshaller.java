        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("serviceName", targetDepth)) {
                    context.nextToken();
                    eCSService.setServiceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("clusterName", targetDepth)) {
                    context.nextToken();
                    eCSService.setClusterName(context.getUnmarshaller(String.class).unmarshall(context));
                }
