...
public class InvalidRevisionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRevisionExceptionUnmarshaller instance;

    public static InvalidRevisionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRevisionExceptionUnmarshaller();
        return instance;
    }
}
