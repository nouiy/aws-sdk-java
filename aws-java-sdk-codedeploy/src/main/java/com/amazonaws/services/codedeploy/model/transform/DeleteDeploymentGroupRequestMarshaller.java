...
@SdkInternalApi
public class DeleteDeploymentGroupRequestMarshaller {
    ...
    private static final DeleteDeploymentGroupRequestMarshaller instance = new DeleteDeploymentGroupRequestMarshaller();

    public static DeleteDeploymentGroupRequestMarshaller getInstance() {
        return instance;
    }
