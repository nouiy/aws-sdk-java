...
public class InvalidFileExistsBehaviorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidFileExistsBehaviorExceptionUnmarshaller instance;

    public static InvalidFileExistsBehaviorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFileExistsBehaviorExceptionUnmarshaller();
        return instance;
    }
}
