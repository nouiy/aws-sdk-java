...
public class DeploymentGroupLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentGroupLimitExceededExceptionUnmarshaller instance;

    public static DeploymentGroupLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentGroupLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
