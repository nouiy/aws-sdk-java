...
public class InstanceNameAlreadyRegisteredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InstanceNameAlreadyRegisteredExceptionUnmarshaller instance;

    public static InstanceNameAlreadyRegisteredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstanceNameAlreadyRegisteredExceptionUnmarshaller();
        return instance;
    }
}
