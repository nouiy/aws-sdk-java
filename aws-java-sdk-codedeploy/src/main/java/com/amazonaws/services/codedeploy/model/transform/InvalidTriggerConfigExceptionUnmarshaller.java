...
public class InvalidTriggerConfigExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTriggerConfigExceptionUnmarshaller instance;

    public static InvalidTriggerConfigExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTriggerConfigExceptionUnmarshaller();
        return instance;
    }
}
