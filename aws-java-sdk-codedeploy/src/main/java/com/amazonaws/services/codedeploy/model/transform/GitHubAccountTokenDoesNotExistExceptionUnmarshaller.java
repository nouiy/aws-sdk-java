...
public class GitHubAccountTokenDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static GitHubAccountTokenDoesNotExistExceptionUnmarshaller instance;

    public static GitHubAccountTokenDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new GitHubAccountTokenDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
