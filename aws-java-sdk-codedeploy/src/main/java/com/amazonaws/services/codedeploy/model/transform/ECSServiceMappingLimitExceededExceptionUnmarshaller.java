...
public class ECSServiceMappingLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ECSServiceMappingLimitExceededExceptionUnmarshaller instance;

    public static ECSServiceMappingLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ECSServiceMappingLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
