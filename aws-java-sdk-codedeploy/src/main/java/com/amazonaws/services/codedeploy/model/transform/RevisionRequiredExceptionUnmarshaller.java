...
public class RevisionRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RevisionRequiredExceptionUnmarshaller instance;

    public static RevisionRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RevisionRequiredExceptionUnmarshaller();
        return instance;
    }
}
