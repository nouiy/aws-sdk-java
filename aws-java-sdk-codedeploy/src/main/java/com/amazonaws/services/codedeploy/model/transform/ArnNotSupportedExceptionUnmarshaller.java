...
public class ArnNotSupportedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ArnNotSupportedExceptionUnmarshaller instance;

    public static ArnNotSupportedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ArnNotSupportedExceptionUnmarshaller();
        return instance;
    }
}
