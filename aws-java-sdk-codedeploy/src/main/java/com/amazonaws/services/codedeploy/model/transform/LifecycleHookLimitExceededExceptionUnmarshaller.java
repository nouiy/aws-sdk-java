...
public class LifecycleHookLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LifecycleHookLimitExceededExceptionUnmarshaller instance;

    public static LifecycleHookLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LifecycleHookLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
