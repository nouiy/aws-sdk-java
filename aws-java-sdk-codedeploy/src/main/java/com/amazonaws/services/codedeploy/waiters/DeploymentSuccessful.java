...
class DeploymentSuccessful {
    ...
    static class IsSucceededMatcher extends WaiterAcceptor<GetDeploymentResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("deploymentInfo"), new JmesPathField("status"));
         ...
         */
        @Override
        public boolean matches(GetDeploymentResult result) {
    ...
    static class IsFailedMatcher extends WaiterAcceptor<GetDeploymentResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsStoppedMatcher extends WaiterAcceptor<GetDeploymentResult> {
        private static final JsonNode expectedResult;
