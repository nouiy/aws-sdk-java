...
public class DeploymentIsNotInReadyStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentIsNotInReadyStateExceptionUnmarshaller instance;

    public static DeploymentIsNotInReadyStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentIsNotInReadyStateExceptionUnmarshaller();
        return instance;
    }
}
