...
public class InvalidBlueGreenDeploymentConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidBlueGreenDeploymentConfigurationExceptionUnmarshaller instance;

    public static InvalidBlueGreenDeploymentConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidBlueGreenDeploymentConfigurationExceptionUnmarshaller();
        return instance;
    }
}
