...
public class RemoveTagsFromOnPremisesInstancesRequestMarshaller {
    ...
    private static final RemoveTagsFromOnPremisesInstancesRequestMarshaller instance = new RemoveTagsFromOnPremisesInstancesRequestMarshaller();

    public static RemoveTagsFromOnPremisesInstancesRequestMarshaller getInstance() {
        return instance;
    }
