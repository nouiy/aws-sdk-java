...
public class RevisionDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RevisionDoesNotExistExceptionUnmarshaller instance;

    public static RevisionDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RevisionDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
