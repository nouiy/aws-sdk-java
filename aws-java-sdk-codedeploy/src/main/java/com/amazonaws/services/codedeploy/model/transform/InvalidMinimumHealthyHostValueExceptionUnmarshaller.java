...
public class InvalidMinimumHealthyHostValueExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidMinimumHealthyHostValueExceptionUnmarshaller instance;

    public static InvalidMinimumHealthyHostValueExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidMinimumHealthyHostValueExceptionUnmarshaller();
        return instance;
    }
}
