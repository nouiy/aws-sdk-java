...
public class ResourceValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceValidationExceptionUnmarshaller instance;

    public static ResourceValidationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceValidationExceptionUnmarshaller();
        return instance;
    }
}
