...
public class InvalidIgnoreApplicationStopFailuresValueExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidIgnoreApplicationStopFailuresValueExceptionUnmarshaller instance;

    public static InvalidIgnoreApplicationStopFailuresValueExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidIgnoreApplicationStopFailuresValueExceptionUnmarshaller();
        return instance;
    }
}
