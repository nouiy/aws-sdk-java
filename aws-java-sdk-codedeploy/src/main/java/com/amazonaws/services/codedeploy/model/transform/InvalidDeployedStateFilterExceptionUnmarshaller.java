...
public class InvalidDeployedStateFilterExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeployedStateFilterExceptionUnmarshaller instance;

    public static InvalidDeployedStateFilterExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeployedStateFilterExceptionUnmarshaller();
        return instance;
    }
}
