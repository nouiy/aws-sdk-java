...
public class DeploymentTargetListSizeExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentTargetListSizeExceededExceptionUnmarshaller instance;

    public static DeploymentTargetListSizeExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentTargetListSizeExceededExceptionUnmarshaller();
        return instance;
    }
}
