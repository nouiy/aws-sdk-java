...
@SdkInternalApi
public class DeleteDeploymentConfigRequestMarshaller {
    ...
    private static final DeleteDeploymentConfigRequestMarshaller instance = new DeleteDeploymentConfigRequestMarshaller();

    public static DeleteDeploymentConfigRequestMarshaller getInstance() {
        return instance;
    }
