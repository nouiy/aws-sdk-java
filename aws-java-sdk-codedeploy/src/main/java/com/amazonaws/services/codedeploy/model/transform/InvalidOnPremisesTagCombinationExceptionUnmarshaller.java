...
public class InvalidOnPremisesTagCombinationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidOnPremisesTagCombinationExceptionUnmarshaller instance;

    public static InvalidOnPremisesTagCombinationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidOnPremisesTagCombinationExceptionUnmarshaller();
        return instance;
    }
}
