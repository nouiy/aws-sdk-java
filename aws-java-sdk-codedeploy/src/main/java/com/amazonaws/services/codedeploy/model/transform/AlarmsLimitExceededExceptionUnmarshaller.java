...
public class AlarmsLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AlarmsLimitExceededExceptionUnmarshaller instance;

    public static AlarmsLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AlarmsLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
