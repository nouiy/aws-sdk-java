...
public class InvalidComputePlatformExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidComputePlatformExceptionUnmarshaller instance;

    public static InvalidComputePlatformExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidComputePlatformExceptionUnmarshaller();
        return instance;
    }
}
