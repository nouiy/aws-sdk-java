...
public class S3LocationMarshaller {
    ...
    public void marshall(S3Location s3Location, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(s3Location.getBundleType(), BUNDLETYPE_BINDING);
            protocolMarshaller.marshall(s3Location.getVersion(), VERSION_BINDING);
            protocolMarshaller.marshall(s3Location.getETag(), ETAG_BINDING);
        } catch (Exception e) {
