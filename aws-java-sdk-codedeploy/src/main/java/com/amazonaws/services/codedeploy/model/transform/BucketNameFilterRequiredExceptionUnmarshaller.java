...
public class BucketNameFilterRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BucketNameFilterRequiredExceptionUnmarshaller instance;

    public static BucketNameFilterRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BucketNameFilterRequiredExceptionUnmarshaller();
        return instance;
    }
}
