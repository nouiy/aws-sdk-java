...
public class InvalidSortOrderExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSortOrderExceptionUnmarshaller instance;

    public static InvalidSortOrderExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSortOrderExceptionUnmarshaller();
        return instance;
    }
}
