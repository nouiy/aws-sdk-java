...
public class DeploymentGroupNameRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentGroupNameRequiredExceptionUnmarshaller instance;

    public static DeploymentGroupNameRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentGroupNameRequiredExceptionUnmarshaller();
        return instance;
    }
}
