...
public class InvalidApplicationNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidApplicationNameExceptionUnmarshaller instance;

    public static InvalidApplicationNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidApplicationNameExceptionUnmarshaller();
        return instance;
    }
}
