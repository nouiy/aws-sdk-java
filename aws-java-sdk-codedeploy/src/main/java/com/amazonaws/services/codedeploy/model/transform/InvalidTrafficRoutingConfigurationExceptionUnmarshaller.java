...
public class InvalidTrafficRoutingConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTrafficRoutingConfigurationExceptionUnmarshaller instance;

    public static InvalidTrafficRoutingConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTrafficRoutingConfigurationExceptionUnmarshaller();
        return instance;
    }
}
