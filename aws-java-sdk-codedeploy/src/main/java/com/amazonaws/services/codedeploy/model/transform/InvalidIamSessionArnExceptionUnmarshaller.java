...
public class InvalidIamSessionArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidIamSessionArnExceptionUnmarshaller instance;

    public static InvalidIamSessionArnExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidIamSessionArnExceptionUnmarshaller();
        return instance;
    }
}
