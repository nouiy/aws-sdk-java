...
public class InvalidDeploymentStyleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeploymentStyleExceptionUnmarshaller instance;

    public static InvalidDeploymentStyleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeploymentStyleExceptionUnmarshaller();
        return instance;
    }
}
