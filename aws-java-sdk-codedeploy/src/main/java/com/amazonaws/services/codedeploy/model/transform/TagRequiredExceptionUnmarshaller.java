...
public class TagRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TagRequiredExceptionUnmarshaller instance;

    public static TagRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TagRequiredExceptionUnmarshaller();
        return instance;
    }
}
