...
public class DeploymentConfigAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentConfigAlreadyExistsExceptionUnmarshaller instance;

    public static DeploymentConfigAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentConfigAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
