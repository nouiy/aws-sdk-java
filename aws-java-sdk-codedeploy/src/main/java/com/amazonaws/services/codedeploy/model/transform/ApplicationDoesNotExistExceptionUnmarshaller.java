...
public class ApplicationDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ApplicationDoesNotExistExceptionUnmarshaller instance;

    public static ApplicationDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApplicationDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
