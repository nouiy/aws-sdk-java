...
public class DeploymentConfigNameRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentConfigNameRequiredExceptionUnmarshaller instance;

    public static DeploymentConfigNameRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentConfigNameRequiredExceptionUnmarshaller();
        return instance;
    }
}
