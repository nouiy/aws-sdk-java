...
public class DeploymentAlreadyCompletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeploymentAlreadyCompletedExceptionUnmarshaller instance;

    public static DeploymentAlreadyCompletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeploymentAlreadyCompletedExceptionUnmarshaller();
        return instance;
    }
}
