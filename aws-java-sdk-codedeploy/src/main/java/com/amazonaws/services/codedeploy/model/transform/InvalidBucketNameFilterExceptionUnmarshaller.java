...
public class InvalidBucketNameFilterExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidBucketNameFilterExceptionUnmarshaller instance;

    public static InvalidBucketNameFilterExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidBucketNameFilterExceptionUnmarshaller();
        return instance;
    }
}
