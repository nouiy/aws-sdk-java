...
public class AlarmConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Boolean> IGNOREPOLLALARMFAILURE_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ignorePollAlarmFailure").build();
