...
public class InvalidRegistrationStatusExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRegistrationStatusExceptionUnmarshaller instance;

    public static InvalidRegistrationStatusExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRegistrationStatusExceptionUnmarshaller();
        return instance;
    }
}
