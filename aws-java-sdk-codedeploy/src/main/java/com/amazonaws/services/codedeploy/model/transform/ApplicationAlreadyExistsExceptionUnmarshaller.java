...
public class ApplicationAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ApplicationAlreadyExistsExceptionUnmarshaller instance;

    public static ApplicationAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApplicationAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
