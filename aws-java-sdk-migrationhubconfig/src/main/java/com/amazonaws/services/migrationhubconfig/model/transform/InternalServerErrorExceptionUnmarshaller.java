...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhubconfig.model.InternalServerErrorException.class, "InternalServerError");
    }

    @Override
    public com.amazonaws.services.migrationhubconfig.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhubconfig.model.InternalServerErrorException internalServerErrorException = new com.amazonaws.services.migrationhubconfig.model.InternalServerErrorException(
                null);
