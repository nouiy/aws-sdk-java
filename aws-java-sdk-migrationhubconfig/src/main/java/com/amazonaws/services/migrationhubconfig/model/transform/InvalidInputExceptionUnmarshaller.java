...
public class InvalidInputExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidInputExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhubconfig.model.InvalidInputException.class, "InvalidInputException");
    }

    @Override
    public com.amazonaws.services.migrationhubconfig.model.InvalidInputException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhubconfig.model.InvalidInputException invalidInputException = new com.amazonaws.services.migrationhubconfig.model.InvalidInputException(
                null);
