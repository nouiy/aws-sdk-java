...
public class InvalidStructureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidStructureExceptionUnmarshaller instance;

    public static InvalidStructureExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidStructureExceptionUnmarshaller();
        return instance;
    }
}
