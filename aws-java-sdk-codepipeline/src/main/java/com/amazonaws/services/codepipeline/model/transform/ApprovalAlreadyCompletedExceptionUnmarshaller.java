...
public class ApprovalAlreadyCompletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ApprovalAlreadyCompletedExceptionUnmarshaller instance;

    public static ApprovalAlreadyCompletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApprovalAlreadyCompletedExceptionUnmarshaller();
        return instance;
    }
}
