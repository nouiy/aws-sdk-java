...
public class GetPipelineStateResultJsonUnmarshaller implements Unmarshaller<GetPipelineStateResult, JsonUnmarshallerContext> {

    public GetPipelineStateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetPipelineStateResult getPipelineStateResult = new GetPipelineStateResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pipelineName", targetDepth)) {
                    context.nextToken();
                    getPipelineStateResult.setPipelineName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("pipelineVersion", targetDepth)) {
                    context.nextToken();
                    getPipelineStateResult.setPipelineVersion(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
    ...
    public static GetPipelineStateResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetPipelineStateResultJsonUnmarshaller();
        return instance;
    }
}
