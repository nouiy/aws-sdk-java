...
@SdkInternalApi
public class GetPipelineStateRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("name").build();

    private static final GetPipelineStateRequestMarshaller instance = new GetPipelineStateRequestMarshaller();

    public static GetPipelineStateRequestMarshaller getInstance() {
        return instance;
    }
