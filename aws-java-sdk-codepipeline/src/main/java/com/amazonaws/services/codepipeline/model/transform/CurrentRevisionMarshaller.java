...
public class CurrentRevisionMarshaller {
    ...
    private static final MarshallingInfo<String> CHANGEIDENTIFIER_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("changeIdentifier").build();
    ...
    public void marshall(CurrentRevision currentRevision, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(currentRevision.getRevision(), REVISION_BINDING);
            protocolMarshaller.marshall(currentRevision.getChangeIdentifier(), CHANGEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(currentRevision.getCreated(), CREATED_BINDING);
            protocolMarshaller.marshall(currentRevision.getRevisionSummary(), REVISIONSUMMARY_BINDING);
        } catch (Exception e) {
