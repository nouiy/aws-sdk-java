...
public class NotLatestPipelineExecutionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NotLatestPipelineExecutionExceptionUnmarshaller instance;

    public static NotLatestPipelineExecutionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotLatestPipelineExecutionExceptionUnmarshaller();
        return instance;
    }
}
