...
public class ActionNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ActionNotFoundExceptionUnmarshaller instance;

    public static ActionNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActionNotFoundExceptionUnmarshaller();
        return instance;
    }
}
