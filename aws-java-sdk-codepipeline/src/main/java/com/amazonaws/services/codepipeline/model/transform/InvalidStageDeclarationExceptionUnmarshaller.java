...
public class InvalidStageDeclarationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidStageDeclarationExceptionUnmarshaller instance;

    public static InvalidStageDeclarationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidStageDeclarationExceptionUnmarshaller();
        return instance;
    }
}
