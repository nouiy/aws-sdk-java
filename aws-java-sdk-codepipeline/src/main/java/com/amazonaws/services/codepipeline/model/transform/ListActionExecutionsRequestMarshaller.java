...
@SdkInternalApi
public class ListActionExecutionsRequestMarshaller {
    ...
    private static final ListActionExecutionsRequestMarshaller instance = new ListActionExecutionsRequestMarshaller();

    public static ListActionExecutionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListActionExecutionsRequest listActionExecutionsRequest, ProtocolMarshaller protocolMarshaller) {
