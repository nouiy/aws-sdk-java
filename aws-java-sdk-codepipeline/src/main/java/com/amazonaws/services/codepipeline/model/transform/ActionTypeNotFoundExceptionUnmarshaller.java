...
public class ActionTypeNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ActionTypeNotFoundExceptionUnmarshaller instance;

    public static ActionTypeNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActionTypeNotFoundExceptionUnmarshaller();
        return instance;
    }
}
