...
public class WebhookFilterRuleMarshaller {
    ...
    private static final MarshallingInfo<String> MATCHEQUALS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("matchEquals").build();
    ...
    public void marshall(WebhookFilterRule webhookFilterRule, ProtocolMarshaller protocolMarshaller) {
        ...
        if (webhookFilterRule == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(webhookFilterRule.getJsonPath(), JSONPATH_BINDING);
            protocolMarshaller.marshall(webhookFilterRule.getMatchEquals(), MATCHEQUALS_BINDING);
        } catch (Exception e) {
