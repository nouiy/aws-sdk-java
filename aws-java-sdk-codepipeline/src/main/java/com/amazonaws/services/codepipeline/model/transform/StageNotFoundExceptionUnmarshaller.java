...
public class StageNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static StageNotFoundExceptionUnmarshaller instance;

    public static StageNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StageNotFoundExceptionUnmarshaller();
        return instance;
    }
}
