...
public class InvalidTagsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTagsExceptionUnmarshaller instance;

    public static InvalidTagsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTagsExceptionUnmarshaller();
        return instance;
    }
}
