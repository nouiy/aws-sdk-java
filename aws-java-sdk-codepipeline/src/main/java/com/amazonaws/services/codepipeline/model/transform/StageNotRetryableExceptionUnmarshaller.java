...
public class StageNotRetryableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static StageNotRetryableExceptionUnmarshaller instance;

    public static StageNotRetryableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StageNotRetryableExceptionUnmarshaller();
        return instance;
    }
}
