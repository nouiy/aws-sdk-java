...
/**
 * ActionTypeUrls JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ActionTypeUrlsJsonUnmarshaller implements Unmarshaller<ActionTypeUrls, JsonUnmarshallerContext> {

    public ActionTypeUrls unmarshall(JsonUnmarshallerContext context) throws Exception {
        ActionTypeUrls actionTypeUrls = new ActionTypeUrls();
    ...
    private static ActionTypeUrlsJsonUnmarshaller instance;

    public static ActionTypeUrlsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActionTypeUrlsJsonUnmarshaller();
        return instance;
    }
}
