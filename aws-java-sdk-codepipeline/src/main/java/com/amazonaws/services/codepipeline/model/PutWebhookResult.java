...
public class PutWebhookResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListWebhookItem getWebhook() {
        return this.webhook;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutWebhookResult == false)
            return false;
        PutWebhookResult other = (PutWebhookResult) obj;
    ...
    public PutWebhookResult clone() {
        try {
            return (PutWebhookResult) super.clone();
