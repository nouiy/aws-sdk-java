...
public class InvalidActionDeclarationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidActionDeclarationExceptionUnmarshaller instance;

    public static InvalidActionDeclarationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidActionDeclarationExceptionUnmarshaller();
        return instance;
    }
}
