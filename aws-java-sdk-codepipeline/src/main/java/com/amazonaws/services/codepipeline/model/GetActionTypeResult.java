...
public class GetActionTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetActionTypeResult == false)
            return false;
        GetActionTypeResult other = (GetActionTypeResult) obj;
    ...
    public GetActionTypeResult clone() {
        try {
            return (GetActionTypeResult) super.clone();
