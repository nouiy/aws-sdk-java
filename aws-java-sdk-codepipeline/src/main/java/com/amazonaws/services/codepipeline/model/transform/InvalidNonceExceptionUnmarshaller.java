...
public class InvalidNonceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidNonceExceptionUnmarshaller instance;

    public static InvalidNonceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidNonceExceptionUnmarshaller();
        return instance;
    }
}
