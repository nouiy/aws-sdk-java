 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codepipeline-2015-07-09/LambdaExecutorConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaExecutorConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The ARN of the Lambda function used by the action engine.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LambdaExecutorConfiguration == false)
            return false;
        LambdaExecutorConfiguration other = (LambdaExecutorConfiguration) obj;
    ...
    public LambdaExecutorConfiguration clone() {
        try {
            return (LambdaExecutorConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.codepipeline.model.transform.LambdaExecutorConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
