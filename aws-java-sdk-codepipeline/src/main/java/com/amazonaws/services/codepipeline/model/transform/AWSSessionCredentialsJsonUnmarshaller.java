...
public class AWSSessionCredentialsJsonUnmarshaller implements Unmarshaller<AWSSessionCredentials, JsonUnmarshallerContext> {
    ...
    public static AWSSessionCredentialsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AWSSessionCredentialsJsonUnmarshaller();
        return instance;
    }
}
