...
/**
 * DeregisterWebhookWithThirdPartyResult JSON Unmarshaller
 */
...
public class DeregisterWebhookWithThirdPartyResultJsonUnmarshaller implements Unmarshaller<DeregisterWebhookWithThirdPartyResult, JsonUnmarshallerContext> {
    ...
    public DeregisterWebhookWithThirdPartyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterWebhookWithThirdPartyResult deregisterWebhookWithThirdPartyResult = new DeregisterWebhookWithThirdPartyResult();

        return deregisterWebhookWithThirdPartyResult;
    }
