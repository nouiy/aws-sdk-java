 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/customer-profiles-2020-08-15/IntegrationConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IntegrationConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public AppflowIntegration getAppflowIntegration() {
    ...
    public IntegrationConfig withAppflowIntegration(AppflowIntegration appflowIntegration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IntegrationConfig == false)
            return false;
    ...
    public IntegrationConfig clone() {
        try {
            return (IntegrationConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.customerprofiles.model.transform.IntegrationConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
