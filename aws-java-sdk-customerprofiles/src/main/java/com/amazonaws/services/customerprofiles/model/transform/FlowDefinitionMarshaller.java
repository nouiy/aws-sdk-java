...
public class FlowDefinitionMarshaller {
    ...
    public void marshall(FlowDefinition flowDefinition, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(flowDefinition.getKmsArn(), KMSARN_BINDING);
            protocolMarshaller.marshall(flowDefinition.getSourceFlowConfig(), SOURCEFLOWCONFIG_BINDING);
            protocolMarshaller.marshall(flowDefinition.getTasks(), TASKS_BINDING);
            protocolMarshaller.marshall(flowDefinition.getTriggerConfig(), TRIGGERCONFIG_BINDING);
        } catch (Exception e) {
