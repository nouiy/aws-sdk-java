...
@SdkInternalApi
public class MatchItemMarshaller {

    private static final MarshallingInfo<String> MATCHID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public static MatchItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MatchItem matchItem, ProtocolMarshaller protocolMarshaller) {
