...
/**
 * ListIntegrationItemMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListIntegrationItemMarshaller {
    ...
    public static ListIntegrationItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListIntegrationItem listIntegrationItem, ProtocolMarshaller protocolMarshaller) {

        if (listIntegrationItem == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(listIntegrationItem.getDomainName(), DOMAINNAME_BINDING);
            protocolMarshaller.marshall(listIntegrationItem.getUri(), URI_BINDING);
            protocolMarshaller.marshall(listIntegrationItem.getObjectTypeName(), OBJECTTYPENAME_BINDING);
            protocolMarshaller.marshall(listIntegrationItem.getCreatedAt(), CREATEDAT_BINDING);
