 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/customer-profiles-2020-08-15/WorkflowStepItem" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkflowStepItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public AppflowIntegrationWorkflowStep getAppflowIntegration() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkflowStepItem == false)
            return false;
    ...
    public WorkflowStepItem clone() {
        try {
            return (WorkflowStepItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.customerprofiles.model.transform.WorkflowStepItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
