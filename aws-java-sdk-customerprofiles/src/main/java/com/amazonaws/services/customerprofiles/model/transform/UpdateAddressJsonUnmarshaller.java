...
/**
 * UpdateAddress JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateAddressJsonUnmarshaller implements Unmarshaller<UpdateAddress, JsonUnmarshallerContext> {

    public UpdateAddress unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static UpdateAddressJsonUnmarshaller instance;

    public static UpdateAddressJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateAddressJsonUnmarshaller();
        return instance;
    }
}
