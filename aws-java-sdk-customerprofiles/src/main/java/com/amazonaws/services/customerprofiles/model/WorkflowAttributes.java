 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/customer-profiles-2020-08-15/WorkflowAttributes"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkflowAttributes implements Serializable, Cloneable, StructuredPojo {
    ...
    public AppflowIntegrationWorkflowAttributes getAppflowIntegration() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WorkflowAttributes == false)
            return false;
    ...
    @Override
    public WorkflowAttributes clone() {
        try {
            return (WorkflowAttributes) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.customerprofiles.model.transform.WorkflowAttributesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
