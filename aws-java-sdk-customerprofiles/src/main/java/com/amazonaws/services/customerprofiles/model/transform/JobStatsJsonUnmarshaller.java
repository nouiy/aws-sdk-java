...
/**
 * JobStats JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JobStatsJsonUnmarshaller implements Unmarshaller<JobStats, JsonUnmarshallerContext> {

    public JobStats unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static JobStatsJsonUnmarshaller instance;

    public static JobStatsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new JobStatsJsonUnmarshaller();
        return instance;
    }
}
