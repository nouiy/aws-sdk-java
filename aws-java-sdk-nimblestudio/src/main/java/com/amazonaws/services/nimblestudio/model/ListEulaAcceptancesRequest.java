...
public class ListEulaAcceptancesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEulaAcceptancesRequest withEulaIds(java.util.Collection<String> eulaIds) {
        setEulaIds(eulaIds);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEulaAcceptancesRequest == false)
            return false;
        ListEulaAcceptancesRequest other = (ListEulaAcceptancesRequest) obj;
    ...
    public ListEulaAcceptancesRequest clone() {
        return (ListEulaAcceptancesRequest) super.clone();
    }
