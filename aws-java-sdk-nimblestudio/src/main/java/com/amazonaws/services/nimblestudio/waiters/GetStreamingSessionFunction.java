...
public class GetStreamingSessionFunction implements SdkFunction<GetStreamingSessionRequest, GetStreamingSessionResult> {
    ...
    /**
     * Constructs a new GetStreamingSessionFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetStreamingSessionFunction(AmazonNimbleStudio client) {
        this.client = client;
    }
    ...
    public GetStreamingSessionResult apply(GetStreamingSessionRequest getStreamingSessionRequest) {
        return client.getStreamingSession(getStreamingSessionRequest);
    }
}
