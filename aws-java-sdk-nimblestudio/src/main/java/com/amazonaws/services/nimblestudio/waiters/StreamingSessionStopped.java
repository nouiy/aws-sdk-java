...
class StreamingSessionStopped {
    ...
    static class IsSTOPPEDMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
    ...
    static class IsSTOP_FAILEDMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
        private static final JsonNode expectedResult;
