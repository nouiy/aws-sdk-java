...
public class InternalServerErrorException extends com.amazonaws.services.nimblestudio.model.AmazonNimbleStudioException {
    ...
    public InternalServerErrorException withContext(java.util.Map<String, String> context) {
        setContext(context);
        return this;
    }
     ...
     *
     * @see InternalServerErrorException#withContext
     * @returns a reference to this object so that method calls can be chained together.
     */

    public InternalServerErrorException addContextEntry(String key, String value) {
    ...
    public InternalServerErrorException clearContextEntries() {
        this.context = null;
        return this;
    }
