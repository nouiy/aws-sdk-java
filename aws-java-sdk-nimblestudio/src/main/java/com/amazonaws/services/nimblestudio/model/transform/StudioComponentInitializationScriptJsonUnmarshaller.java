...
/**
 * StudioComponentInitializationScript JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StudioComponentInitializationScriptJsonUnmarshaller implements Unmarshaller<StudioComponentInitializationScript, JsonUnmarshallerContext> {

    public StudioComponentInitializationScript unmarshall(JsonUnmarshallerContext context) throws Exception {
        StudioComponentInitializationScript studioComponentInitializationScript = new StudioComponentInitializationScript();
    ...
    private static StudioComponentInitializationScriptJsonUnmarshaller instance;

    public static StudioComponentInitializationScriptJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StudioComponentInitializationScriptJsonUnmarshaller();
        return instance;
    }
}
