...
public class DeleteStreamingImageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteStreamingImageRequest withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteStreamingImageRequest == false)
            return false;
        DeleteStreamingImageRequest other = (DeleteStreamingImageRequest) obj;
    ...
    @Override
    public DeleteStreamingImageRequest clone() {
        return (DeleteStreamingImageRequest) super.clone();
    }
