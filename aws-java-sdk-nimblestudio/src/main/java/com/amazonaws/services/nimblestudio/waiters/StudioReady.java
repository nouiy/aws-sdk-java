...
class StudioReady {
    ...
    static class IsREADYMatcher extends WaiterAcceptor<GetStudioResult> {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetStudioResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetStudioResult> {
        private static final JsonNode expectedResult;
