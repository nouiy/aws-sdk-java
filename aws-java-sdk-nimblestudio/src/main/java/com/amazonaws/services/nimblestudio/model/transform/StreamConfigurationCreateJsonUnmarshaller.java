...
/**
 * StreamConfigurationCreate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StreamConfigurationCreateJsonUnmarshaller implements Unmarshaller<StreamConfigurationCreate, JsonUnmarshallerContext> {

    public StreamConfigurationCreate unmarshall(JsonUnmarshallerContext context) throws Exception {
        StreamConfigurationCreate streamConfigurationCreate = new StreamConfigurationCreate();
    ...
    private static StreamConfigurationCreateJsonUnmarshaller instance;

    public static StreamConfigurationCreateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StreamConfigurationCreateJsonUnmarshaller();
        return instance;
    }
}
