...
class LaunchProfileDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetLaunchProfileResult> {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetLaunchProfileResult> {
        private static final JsonNode expectedResult;
