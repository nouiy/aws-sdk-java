...
public class CreateStreamingImageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateStreamingImageResult withStreamingImage(StreamingImage streamingImage) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateStreamingImageResult == false)
            return false;
        CreateStreamingImageResult other = (CreateStreamingImageResult) obj;
    ...
    @Override
    public CreateStreamingImageResult clone() {
        try {
            return (CreateStreamingImageResult) super.clone();
