...
class StudioComponentReady {
    ...
    static class IsREADYMatcher extends WaiterAcceptor<GetStudioComponentResult> {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetStudioComponentResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetStudioComponentResult> {
        private static final JsonNode expectedResult;
