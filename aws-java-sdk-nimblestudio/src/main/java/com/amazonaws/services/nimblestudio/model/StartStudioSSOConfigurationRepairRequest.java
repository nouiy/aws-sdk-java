...
public class StartStudioSSOConfigurationRepairRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartStudioSSOConfigurationRepairRequest withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartStudioSSOConfigurationRepairRequest == false)
            return false;
        StartStudioSSOConfigurationRepairRequest other = (StartStudioSSOConfigurationRepairRequest) obj;
    ...
    @Override
    public StartStudioSSOConfigurationRepairRequest clone() {
        return (StartStudioSSOConfigurationRepairRequest) super.clone();
    }
