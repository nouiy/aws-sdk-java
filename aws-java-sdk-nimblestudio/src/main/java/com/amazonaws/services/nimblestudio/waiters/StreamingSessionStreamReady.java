...
class StreamingSessionStreamReady {
    ...
    static class IsREADYMatcher extends WaiterAcceptor<GetStreamingSessionStreamResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("stream"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(GetStreamingSessionStreamResult result) {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetStreamingSessionStreamResult> {
        private static final JsonNode expectedResult;
