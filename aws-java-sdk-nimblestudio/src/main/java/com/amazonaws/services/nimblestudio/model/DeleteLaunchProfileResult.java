...
public class DeleteLaunchProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteLaunchProfileResult withLaunchProfile(LaunchProfile launchProfile) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteLaunchProfileResult == false)
            return false;
        DeleteLaunchProfileResult other = (DeleteLaunchProfileResult) obj;
    ...
    @Override
    public DeleteLaunchProfileResult clone() {
        try {
            return (DeleteLaunchProfileResult) super.clone();
