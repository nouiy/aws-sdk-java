...
class StreamingSessionDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetStreamingSessionResult> {
        private static final JsonNode expectedResult;
