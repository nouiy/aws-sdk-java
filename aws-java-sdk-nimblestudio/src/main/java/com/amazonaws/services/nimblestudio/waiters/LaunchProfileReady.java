...
class LaunchProfileReady {
    ...
    static class IsREADYMatcher extends WaiterAcceptor<GetLaunchProfileResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("launchProfile"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(GetLaunchProfileResult result) {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<GetLaunchProfileResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATE_FAILEDMatcher extends WaiterAcceptor<GetLaunchProfileResult> {
        private static final JsonNode expectedResult;
