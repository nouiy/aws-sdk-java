...
public class DeleteStudioMemberRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteStudioMemberRequest withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteStudioMemberRequest == false)
            return false;
        DeleteStudioMemberRequest other = (DeleteStudioMemberRequest) obj;
    ...
    @Override
    public DeleteStudioMemberRequest clone() {
        return (DeleteStudioMemberRequest) super.clone();
    }
