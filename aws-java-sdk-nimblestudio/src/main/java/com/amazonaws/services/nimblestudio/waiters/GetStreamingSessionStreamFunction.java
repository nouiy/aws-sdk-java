...
public class GetStreamingSessionStreamFunction implements SdkFunction<GetStreamingSessionStreamRequest, GetStreamingSessionStreamResult> {
    ...
    /**
     * Constructs a new GetStreamingSessionStreamFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetStreamingSessionStreamFunction(AmazonNimbleStudio client) {
        this.client = client;
    }
    ...
    public GetStreamingSessionStreamResult apply(GetStreamingSessionStreamRequest getStreamingSessionStreamRequest) {
        return client.getStreamingSessionStream(getStreamingSessionStreamRequest);
    }
}
