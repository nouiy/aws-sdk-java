 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/billingconductor-2021-07-30/ListCustomLineItemFlatChargeDetails"
...
public class ListCustomLineItemFlatChargeDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCustomLineItemFlatChargeDetails == false)
            return false;
        ListCustomLineItemFlatChargeDetails other = (ListCustomLineItemFlatChargeDetails) obj;
    ...
    @Override
    public ListCustomLineItemFlatChargeDetails clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.billingconductor.model.transform.ListCustomLineItemFlatChargeDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
