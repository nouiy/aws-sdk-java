...
/**
 * ListCustomLineItemsFilterMarshaller
 */
...
public class ListCustomLineItemsFilterMarshaller {
    ...
    private static final MarshallingInfo<List> BILLINGGROUPS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("BillingGroups").build();
