 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/billingconductor-2021-07-30/ListCustomLineItemPercentageChargeDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCustomLineItemPercentageChargeDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getPercentageValue() != null)
            sb.append("PercentageValue: ").append(getPercentageValue());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCustomLineItemPercentageChargeDetails == false)
            return false;
        ListCustomLineItemPercentageChargeDetails other = (ListCustomLineItemPercentageChargeDetails) obj;
    ...
    public ListCustomLineItemPercentageChargeDetails clone() {
        try {
            return (ListCustomLineItemPercentageChargeDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.billingconductor.model.transform.ListCustomLineItemPercentageChargeDetailsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
