...
/**
 * DeleteTargetResult JSON Unmarshaller
 */
...
public class DeleteTargetResultJsonUnmarshaller implements Unmarshaller<DeleteTargetResult, JsonUnmarshallerContext> {
    ...
    public DeleteTargetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTargetResult deleteTargetResult = new DeleteTargetResult();
