...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarnotifications.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.codestarnotifications.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarnotifications.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.codestarnotifications.model.ResourceNotFoundException(
                null);
