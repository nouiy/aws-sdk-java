...
public class ConcurrentModificationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConcurrentModificationExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarnotifications.model.ConcurrentModificationException.class, "ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.codestarnotifications.model.ConcurrentModificationException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.codestarnotifications.model.ConcurrentModificationException concurrentModificationException = new com.amazonaws.services.codestarnotifications.model.ConcurrentModificationException(
                null);
