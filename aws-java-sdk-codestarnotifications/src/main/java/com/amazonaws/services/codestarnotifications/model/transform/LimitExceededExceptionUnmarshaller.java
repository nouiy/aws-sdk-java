...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarnotifications.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.codestarnotifications.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarnotifications.model.LimitExceededException limitExceededException = new com.amazonaws.services.codestarnotifications.model.LimitExceededException(
                null);
