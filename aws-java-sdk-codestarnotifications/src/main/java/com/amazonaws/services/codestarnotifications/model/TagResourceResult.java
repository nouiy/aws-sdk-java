...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codestar-notifications-2019-10-15/TagResource" target="_top">AWS
 *      API Documentation</a>
 */
...
public class TagResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The list of tags associated with the resource.
     */
     ...
     *
     * @see TagResourceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public TagResourceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
