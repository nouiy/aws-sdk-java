...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.codestarnotifications.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.codestarnotifications.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codestarnotifications.model.ValidationException validationException = new com.amazonaws.services.codestarnotifications.model.ValidationException(
                null);
