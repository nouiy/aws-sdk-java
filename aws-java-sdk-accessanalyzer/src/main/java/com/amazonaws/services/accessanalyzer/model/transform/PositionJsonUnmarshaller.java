        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("offset", targetDepth)) {
                    context.nextToken();
                    position.setOffset(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
