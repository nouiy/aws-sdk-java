...
/**
 * GenerateFindingRecommendationResult JSON Unmarshaller
 */
...
public class GenerateFindingRecommendationResultJsonUnmarshaller implements Unmarshaller<GenerateFindingRecommendationResult, JsonUnmarshallerContext> {
    ...
    public GenerateFindingRecommendationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GenerateFindingRecommendationResult generateFindingRecommendationResult = new GenerateFindingRecommendationResult();

        return generateFindingRecommendationResult;
    }
