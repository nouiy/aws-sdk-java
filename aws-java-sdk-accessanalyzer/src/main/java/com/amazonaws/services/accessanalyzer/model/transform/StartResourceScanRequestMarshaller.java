...
@SdkInternalApi
public class StartResourceScanRequestMarshaller {
    ...
    public static StartResourceScanRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartResourceScanRequest startResourceScanRequest, ProtocolMarshaller protocolMarshaller) {
