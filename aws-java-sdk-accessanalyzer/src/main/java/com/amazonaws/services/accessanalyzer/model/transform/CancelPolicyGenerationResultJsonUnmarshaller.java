...
/**
 * CancelPolicyGenerationResult JSON Unmarshaller
 */
...
public class CancelPolicyGenerationResultJsonUnmarshaller implements Unmarshaller<CancelPolicyGenerationResult, JsonUnmarshallerContext> {
    ...
    public CancelPolicyGenerationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelPolicyGenerationResult cancelPolicyGenerationResult = new CancelPolicyGenerationResult();

        return cancelPolicyGenerationResult;
    }
