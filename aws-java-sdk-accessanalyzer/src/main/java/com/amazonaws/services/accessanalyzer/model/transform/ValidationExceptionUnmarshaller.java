...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.accessanalyzer.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.accessanalyzer.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.accessanalyzer.model.ValidationException validationException = new com.amazonaws.services.accessanalyzer.model.ValidationException(
                null);
