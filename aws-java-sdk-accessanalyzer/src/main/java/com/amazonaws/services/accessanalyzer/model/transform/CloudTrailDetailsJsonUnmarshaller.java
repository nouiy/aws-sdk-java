...
/**
 * CloudTrailDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CloudTrailDetailsJsonUnmarshaller implements Unmarshaller<CloudTrailDetails, JsonUnmarshallerContext> {

    public CloudTrailDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        CloudTrailDetails cloudTrailDetails = new CloudTrailDetails();
    ...
    private static CloudTrailDetailsJsonUnmarshaller instance;

    public static CloudTrailDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CloudTrailDetailsJsonUnmarshaller();
        return instance;
    }
}
