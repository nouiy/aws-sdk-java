...
/**
 * KmsGrantConfigurationMarshaller
 */
...
public class KmsGrantConfigurationMarshaller {
    ...
    public static KmsGrantConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KmsGrantConfiguration kmsGrantConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (kmsGrantConfiguration == null) {
