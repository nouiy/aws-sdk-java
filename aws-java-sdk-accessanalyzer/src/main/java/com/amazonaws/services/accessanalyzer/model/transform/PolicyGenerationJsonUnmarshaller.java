...
/**
 * PolicyGeneration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PolicyGenerationJsonUnmarshaller implements Unmarshaller<PolicyGeneration, JsonUnmarshallerContext> {

    public PolicyGeneration unmarshall(JsonUnmarshallerContext context) throws Exception {
        PolicyGeneration policyGeneration = new PolicyGeneration();
    ...
    private static PolicyGenerationJsonUnmarshaller instance;

    public static PolicyGenerationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyGenerationJsonUnmarshaller();
        return instance;
    }
}
