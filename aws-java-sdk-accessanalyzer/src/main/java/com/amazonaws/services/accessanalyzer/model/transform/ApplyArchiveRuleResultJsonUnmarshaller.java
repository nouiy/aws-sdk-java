...
/**
 * ApplyArchiveRuleResult JSON Unmarshaller
 */
...
public class ApplyArchiveRuleResultJsonUnmarshaller implements Unmarshaller<ApplyArchiveRuleResult, JsonUnmarshallerContext> {
    ...
    public ApplyArchiveRuleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ApplyArchiveRuleResult applyArchiveRuleResult = new ApplyArchiveRuleResult();
