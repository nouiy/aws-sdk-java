...
public class FindingSourceMarshaller {
    ...
    public static FindingSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FindingSource findingSource, ProtocolMarshaller protocolMarshaller) {
