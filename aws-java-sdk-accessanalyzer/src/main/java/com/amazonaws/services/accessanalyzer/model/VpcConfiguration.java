...
/**
 * <p>
 * The proposed virtual private cloud (VPC) configuration for the Amazon S3 access point. VPC configuration does not
 * apply to multi-region access points. For more information, see <a
 * href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_control_VpcConfiguration.html">VpcConfiguration</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/VpcConfiguration" target="_top">AWS
 *      API Documentation</a>
 */
...
public class VpcConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.accessanalyzer.model.transform.VpcConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
