...
/**
 * StartResourceScanResult JSON Unmarshaller
 */
...
public class StartResourceScanResultJsonUnmarshaller implements Unmarshaller<StartResourceScanResult, JsonUnmarshallerContext> {
    ...
    public StartResourceScanResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartResourceScanResult startResourceScanResult = new StartResourceScanResult();
