...
/**
 * TrailProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrailPropertiesJsonUnmarshaller implements Unmarshaller<TrailProperties, JsonUnmarshallerContext> {

    public TrailProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        TrailProperties trailProperties = new TrailProperties();
    ...
    private static TrailPropertiesJsonUnmarshaller instance;

    public static TrailPropertiesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrailPropertiesJsonUnmarshaller();
        return instance;
    }
}
