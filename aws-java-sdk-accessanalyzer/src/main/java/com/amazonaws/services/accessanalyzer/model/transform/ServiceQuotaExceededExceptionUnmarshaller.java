...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.accessanalyzer.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.accessanalyzer.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.accessanalyzer.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.accessanalyzer.model.ServiceQuotaExceededException(
                null);
