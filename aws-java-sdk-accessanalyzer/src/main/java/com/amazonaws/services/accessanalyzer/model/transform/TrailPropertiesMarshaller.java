...
public class TrailPropertiesMarshaller {
    ...
    public static TrailPropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TrailProperties trailProperties, ProtocolMarshaller protocolMarshaller) {
