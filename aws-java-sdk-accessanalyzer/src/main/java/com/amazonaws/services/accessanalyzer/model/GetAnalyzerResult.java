...
public class GetAnalyzerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getAnalyzer() != null)
            sb.append("Analyzer: ").append(getAnalyzer());
        sb.append("}");
        return sb.toString();
    }
    ...
    public GetAnalyzerResult clone() {
        try {
            return (GetAnalyzerResult) super.clone();
