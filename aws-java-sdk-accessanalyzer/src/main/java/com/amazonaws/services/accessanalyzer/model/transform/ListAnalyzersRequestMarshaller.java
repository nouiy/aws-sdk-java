...
/**
 * ListAnalyzersRequestMarshaller
 */
...
public class ListAnalyzersRequestMarshaller {
    ...
    private static final ListAnalyzersRequestMarshaller instance = new ListAnalyzersRequestMarshaller();

    public static ListAnalyzersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAnalyzersRequest listAnalyzersRequest, ProtocolMarshaller protocolMarshaller) {
