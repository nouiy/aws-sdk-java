...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.accessanalyzer.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.accessanalyzer.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.accessanalyzer.model.InternalServerException internalServerException = new com.amazonaws.services.accessanalyzer.model.InternalServerException(
                null);
