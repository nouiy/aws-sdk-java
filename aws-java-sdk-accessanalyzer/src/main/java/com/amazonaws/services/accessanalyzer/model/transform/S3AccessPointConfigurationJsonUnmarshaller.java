...
/**
 * S3AccessPointConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3AccessPointConfigurationJsonUnmarshaller implements Unmarshaller<S3AccessPointConfiguration, JsonUnmarshallerContext> {

    public S3AccessPointConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        S3AccessPointConfiguration s3AccessPointConfiguration = new S3AccessPointConfiguration();
    ...
    private static S3AccessPointConfigurationJsonUnmarshaller instance;

    public static S3AccessPointConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new S3AccessPointConfigurationJsonUnmarshaller();
        return instance;
    }
}
