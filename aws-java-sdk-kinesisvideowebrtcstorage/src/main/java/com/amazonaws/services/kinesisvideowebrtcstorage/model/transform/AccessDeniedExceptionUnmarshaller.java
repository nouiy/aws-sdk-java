...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.kinesisvideowebrtcstorage.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.kinesisvideowebrtcstorage.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.kinesisvideowebrtcstorage.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.kinesisvideowebrtcstorage.model.AccessDeniedException(
                null);
