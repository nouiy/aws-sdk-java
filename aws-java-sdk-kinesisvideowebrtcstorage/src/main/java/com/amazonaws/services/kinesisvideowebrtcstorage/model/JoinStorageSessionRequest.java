...
public class JoinStorageSessionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public JoinStorageSessionRequest clone() {
        return (JoinStorageSessionRequest) super.clone();
    }
