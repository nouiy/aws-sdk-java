...
public interface AmazonKinesisVideoWebRTCStorageAsync extends AmazonKinesisVideoWebRTCStorage {
     ...
     * @return A Java Future containing the result of the JoinStorageSessionAsViewer operation returned by the service.
     * @sample AmazonKinesisVideoWebRTCStorageAsync.JoinStorageSessionAsViewer
     * @see <a
     *      href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-webrtc-storage-2018-05-10/JoinStorageSessionAsViewer"
     *      target="_top">AWS API Documentation</a>
     */
    java.util.concurrent.Future<JoinStorageSessionAsViewerResult> joinStorageSessionAsViewerAsync(
     ...
     *        unsuccessful completion of the operation.
     * @return A Java Future containing the result of the JoinStorageSessionAsViewer operation returned by the service.
     * @sample AmazonKinesisVideoWebRTCStorageAsyncHandler.JoinStorageSessionAsViewer
     * @see <a
     *      href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-webrtc-storage-2018-05-10/JoinStorageSessionAsViewer"
     *      target="_top">AWS API Documentation</a>
     */
