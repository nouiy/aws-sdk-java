...
/**
 * JoinStorageSessionResult JSON Unmarshaller
 */
...
public class JoinStorageSessionResultJsonUnmarshaller implements Unmarshaller<JoinStorageSessionResult, JsonUnmarshallerContext> {
    ...
    public JoinStorageSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        JoinStorageSessionResult joinStorageSessionResult = new JoinStorageSessionResult();

        return joinStorageSessionResult;
    }
