...
/**
 * Client for accessing Amazon Kinesis Video WebRTC Storage asynchronously. Each asynchronous method will return a Java
...
public class AmazonKinesisVideoWebRTCStorageAsyncClient extends AmazonKinesisVideoWebRTCStorageClient implements AmazonKinesisVideoWebRTCStorageAsync {
    ...
    /**
     * Constructs a new asynchronous client to invoke service methods on Amazon Kinesis Video WebRTC Storage using the
    ...
    @Override
    public java.util.concurrent.Future<JoinStorageSessionResult> joinStorageSessionAsync(JoinStorageSessionRequest request) {

        return joinStorageSessionAsync(request, null);
    }

    @Override
    public java.util.concurrent.Future<JoinStorageSessionResult> joinStorageSessionAsync(final JoinStorageSessionRequest request,
            final com.amazonaws.handlers.AsyncHandler<JoinStorageSessionRequest, JoinStorageSessionResult> asyncHandler) {
        final JoinStorageSessionRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<JoinStorageSessionResult>() {
            @Override
            public JoinStorageSessionResult call() throws Exception {
                JoinStorageSessionResult result = null;

                try {
                    result = executeJoinStorageSession(finalRequest);
                } catch (Exception ex) {
