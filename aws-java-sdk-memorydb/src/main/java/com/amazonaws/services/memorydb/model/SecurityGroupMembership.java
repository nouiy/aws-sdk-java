 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/SecurityGroupMembership" target="_top">AWS
 *      API Documentation</a>
 */
...
public class SecurityGroupMembership implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The status of the security group membership. The status changes whenever a security group is modified, or when
     ...
     * </p>
     * 
     * @return The identifier of the security group.
     */
     ...
     * 
     * @param status
     *        The status of the security group membership. The status changes whenever a security group is modified, or
     *        when the security groups assigned to a cluster are modified.
     */
     ...
     * </p>
     * 
     * @return The status of the security group membership. The status changes whenever a security group is modified, or
     *         when the security groups assigned to a cluster are modified.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.memorydb.model.transform.SecurityGroupMembershipMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
