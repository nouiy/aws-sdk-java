        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    subnetGroup.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Subnets", targetDepth)) {
                    context.nextToken();
                    subnetGroup.setSubnets(new ListUnmarshaller<Subnet>(SubnetJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("ARN", targetDepth)) {
                    context.nextToken();
                    subnetGroup.setARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
