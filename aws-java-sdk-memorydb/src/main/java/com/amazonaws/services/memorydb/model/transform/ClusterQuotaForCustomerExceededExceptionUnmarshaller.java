...
public class ClusterQuotaForCustomerExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ClusterQuotaForCustomerExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.memorydb.model.ClusterQuotaForCustomerExceededException.class, "ClusterQuotaForCustomerExceededFault");
    }

    @Override
    public com.amazonaws.services.memorydb.model.ClusterQuotaForCustomerExceededException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.memorydb.model.ClusterQuotaForCustomerExceededException clusterQuotaForCustomerExceededException = new com.amazonaws.services.memorydb.model.ClusterQuotaForCustomerExceededException(
                null);
