...
public class DescribeClustersRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> SHOWSHARDDETAILS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ShowShardDetails").build();
    ...
    public void marshall(DescribeClustersRequest describeClustersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeClustersRequest.getClusterName(), CLUSTERNAME_BINDING);
            ...
            protocolMarshaller.marshall(describeClustersRequest.getShowShardDetails(), SHOWSHARDDETAILS_BINDING);
        } catch (Exception e) {
