...
public class CreateUserRequestMarshaller {
    ...
    public void marshall(CreateUserRequest createUserRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createUserRequest.getAuthenticationMode(), AUTHENTICATIONMODE_BINDING);
            protocolMarshaller.marshall(createUserRequest.getAccessString(), ACCESSSTRING_BINDING);
