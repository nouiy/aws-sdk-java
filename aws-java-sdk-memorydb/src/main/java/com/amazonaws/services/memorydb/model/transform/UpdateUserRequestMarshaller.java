...
public class UpdateUserRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> AUTHENTICATIONMODE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AuthenticationMode").build();
    ...
    public void marshall(UpdateUserRequest updateUserRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateUserRequest.getAuthenticationMode(), AUTHENTICATIONMODE_BINDING);
            protocolMarshaller.marshall(updateUserRequest.getAccessString(), ACCESSSTRING_BINDING);
        } catch (Exception e) {
