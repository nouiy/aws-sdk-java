 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/memorydb-2021-01-01/Event" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Event implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The name for the source of the event. For example, if the event occurred at the cluster level, the identifier
     * would be the name of the cluster.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The name for the source of the event. For example, if the event occurred at the cluster level, the
     *         identifier would be the name of the cluster.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.memorydb.model.transform.EventMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
