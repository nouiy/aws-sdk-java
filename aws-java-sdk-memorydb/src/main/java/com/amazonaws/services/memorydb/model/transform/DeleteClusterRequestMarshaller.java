...
public class DeleteClusterRequestMarshaller {
    ...
    private static final MarshallingInfo<String> FINALSNAPSHOTNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("FinalSnapshotName").build();
    ...
    public void marshall(DeleteClusterRequest deleteClusterRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(deleteClusterRequest.getFinalSnapshotName(), FINALSNAPSHOTNAME_BINDING);
        } catch (Exception e) {
