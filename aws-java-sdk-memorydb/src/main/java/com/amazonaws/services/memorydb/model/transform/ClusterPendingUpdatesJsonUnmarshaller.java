...
/**
 * ClusterPendingUpdates JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClusterPendingUpdatesJsonUnmarshaller implements Unmarshaller<ClusterPendingUpdates, JsonUnmarshallerContext> {

    public ClusterPendingUpdates unmarshall(JsonUnmarshallerContext context) throws Exception {
        ClusterPendingUpdates clusterPendingUpdates = new ClusterPendingUpdates();
    ...
    private static ClusterPendingUpdatesJsonUnmarshaller instance;

    public static ClusterPendingUpdatesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClusterPendingUpdatesJsonUnmarshaller();
        return instance;
    }
}
