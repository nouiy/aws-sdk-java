...
public class SubnetMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> AVAILABILITYZONE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(Subnet subnet, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(subnet.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(subnet.getAvailabilityZone(), AVAILABILITYZONE_BINDING);
        } catch (Exception e) {
