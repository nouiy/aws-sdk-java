...
public class DescribeUsersRequestMarshaller {
    ...
    public void marshall(DescribeUsersRequest describeUsersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeUsersRequest.getUserName(), USERNAME_BINDING);
            protocolMarshaller.marshall(describeUsersRequest.getFilters(), FILTERS_BINDING);
