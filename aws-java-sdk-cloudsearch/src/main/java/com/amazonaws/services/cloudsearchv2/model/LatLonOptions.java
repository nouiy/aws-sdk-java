 ...
 * if <code>IndexFieldType</code> specifies the field is of type <code>latlon</code>. All options are enabled by
 * default.
 * </p>
 */
...
public class LatLonOptions implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LatLonOptions == false)
            return false;
        LatLonOptions other = (LatLonOptions) obj;
