...
/**
 * <p>
 * Options for a field that contains an array of dates. Present if <code>IndexFieldType</code> specifies the field is of
 * type <code>date-array</code>. All options are enabled by default.
 * </p>
 */
...
public class DateArrayOptions implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DateArrayOptions == false)
            return false;
