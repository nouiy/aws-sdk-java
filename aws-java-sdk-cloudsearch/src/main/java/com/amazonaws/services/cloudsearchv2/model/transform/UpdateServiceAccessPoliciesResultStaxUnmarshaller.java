...
public class UpdateServiceAccessPoliciesResultStaxUnmarshaller implements Unmarshaller<UpdateServiceAccessPoliciesResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AccessPolicies", targetDepth)) {
                    updateServiceAccessPoliciesResult.setAccessPolicies(AccessPoliciesStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static UpdateServiceAccessPoliciesResultStaxUnmarshaller instance;

    public static UpdateServiceAccessPoliciesResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateServiceAccessPoliciesResultStaxUnmarshaller();
        return instance;
    }
}
