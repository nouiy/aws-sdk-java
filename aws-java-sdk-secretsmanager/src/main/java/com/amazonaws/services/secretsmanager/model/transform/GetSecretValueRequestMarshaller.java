...
/**
 * GetSecretValueRequestMarshaller
 */
...
public class GetSecretValueRequestMarshaller {
    ...
    private static final GetSecretValueRequestMarshaller instance = new GetSecretValueRequestMarshaller();

    public static GetSecretValueRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetSecretValueRequest getSecretValueRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSecretValueRequest.getSecretId(), SECRETID_BINDING);
            protocolMarshaller.marshall(getSecretValueRequest.getVersionId(), VERSIONID_BINDING);
            protocolMarshaller.marshall(getSecretValueRequest.getVersionStage(), VERSIONSTAGE_BINDING);
        } catch (Exception e) {
