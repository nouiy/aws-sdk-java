...
/**
 * ValidateResourcePolicyResult JSON Unmarshaller
 */
...
public class ValidateResourcePolicyResultJsonUnmarshaller implements Unmarshaller<ValidateResourcePolicyResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PolicyValidationPassed", targetDepth)) {
                    context.nextToken();
                    validateResourcePolicyResult.setPolicyValidationPassed(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("ValidationErrors", targetDepth)) {
                    context.nextToken();
                    validateResourcePolicyResult.setValidationErrors(new ListUnmarshaller<ValidationErrorsEntry>(ValidationErrorsEntryJsonUnmarshaller
                            .getInstance())
    ...
    public static ValidateResourcePolicyResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ValidateResourcePolicyResultJsonUnmarshaller();
        return instance;
    }
}
