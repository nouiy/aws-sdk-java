...
public class CreateSecretRequestMarshaller {
    ...
    public void marshall(CreateSecretRequest createSecretRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createSecretRequest.getAddReplicaRegions(), ADDREPLICAREGIONS_BINDING);
            protocolMarshaller.marshall(createSecretRequest.getForceOverwriteReplicaSecret(), FORCEOVERWRITEREPLICASECRET_BINDING);
        } catch (Exception e) {
