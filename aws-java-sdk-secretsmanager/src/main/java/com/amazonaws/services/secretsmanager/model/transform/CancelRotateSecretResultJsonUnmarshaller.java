...
/**
 * CancelRotateSecretResult JSON Unmarshaller
 */
...
public class CancelRotateSecretResultJsonUnmarshaller implements Unmarshaller<CancelRotateSecretResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ARN", targetDepth)) {
                    context.nextToken();
                    cancelRotateSecretResult.setARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    cancelRotateSecretResult.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("VersionId", targetDepth)) {
                    context.nextToken();
                    cancelRotateSecretResult.setVersionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static CancelRotateSecretResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CancelRotateSecretResultJsonUnmarshaller();
        return instance;
    }
}
