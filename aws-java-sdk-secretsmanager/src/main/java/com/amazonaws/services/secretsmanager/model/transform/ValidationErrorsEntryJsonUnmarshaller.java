...
/**
 * ValidationErrorsEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ValidationErrorsEntryJsonUnmarshaller implements Unmarshaller<ValidationErrorsEntry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CheckName", targetDepth)) {
                    context.nextToken();
                    validationErrorsEntry.setCheckName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ErrorMessage", targetDepth)) {
                    context.nextToken();
                    validationErrorsEntry.setErrorMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ValidationErrorsEntryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ValidationErrorsEntryJsonUnmarshaller();
        return instance;
    }
}
