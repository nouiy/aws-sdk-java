...
public class DecryptionFailureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DecryptionFailureExceptionUnmarshaller instance;

    public static DecryptionFailureExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DecryptionFailureExceptionUnmarshaller();
        return instance;
    }
}
