...
/**
 * RestoreSecretRequestMarshaller
 */
...
public class RestoreSecretRequestMarshaller {
    ...
    private static final RestoreSecretRequestMarshaller instance = new RestoreSecretRequestMarshaller();

    public static RestoreSecretRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(RestoreSecretRequest restoreSecretRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(restoreSecretRequest.getSecretId(), SECRETID_BINDING);
        } catch (Exception e) {
