...
class BatchPredictionAvailable {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<DescribeBatchPredictionsResult> {
         ...
         */
        @Override
        public boolean matches(DescribeBatchPredictionsResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeBatchPredictionsResult> {
        private static final JsonNode expectedResult;
