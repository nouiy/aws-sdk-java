...
public class CreateRealtimeEndpointRequestMarshaller {
    ...
    private static final CreateRealtimeEndpointRequestMarshaller instance = new CreateRealtimeEndpointRequestMarshaller();

    public static CreateRealtimeEndpointRequestMarshaller getInstance() {
        return instance;
    }
