...
public class DescribeEvaluationsFunction implements SdkFunction<DescribeEvaluationsRequest, DescribeEvaluationsResult> {
     ...
     *        Service client
     */
    public DescribeEvaluationsFunction(AmazonMachineLearning client) {
        this.client = client;
    }
     ...
     */
    @Override
    public DescribeEvaluationsResult apply(DescribeEvaluationsRequest describeEvaluationsRequest) {
