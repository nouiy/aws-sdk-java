...
public class DescribeTagsRequestMarshaller {
    ...
    public void marshall(DescribeTagsRequest describeTagsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeTagsRequest.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(describeTagsRequest.getResourceType(), RESOURCETYPE_BINDING);
        } catch (Exception e) {
