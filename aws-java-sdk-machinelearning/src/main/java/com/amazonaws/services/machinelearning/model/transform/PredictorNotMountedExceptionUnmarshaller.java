...
public class PredictorNotMountedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PredictorNotMountedExceptionUnmarshaller instance;

    public static PredictorNotMountedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PredictorNotMountedExceptionUnmarshaller();
        return instance;
    }
}
