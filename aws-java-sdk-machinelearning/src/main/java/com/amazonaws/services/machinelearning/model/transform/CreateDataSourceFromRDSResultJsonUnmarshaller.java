...
public class CreateDataSourceFromRDSResultJsonUnmarshaller implements Unmarshaller<CreateDataSourceFromRDSResult, JsonUnmarshallerContext> {

    public CreateDataSourceFromRDSResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataSourceId", targetDepth)) {
                    context.nextToken();
                    createDataSourceFromRDSResult.setDataSourceId(context.getUnmarshaller(String.class).unmarshall(context));
                }
