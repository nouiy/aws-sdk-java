...
class MLModelAvailable {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<DescribeMLModelsResult> {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeMLModelsResult> {
        private static final JsonNode expectedResult;
