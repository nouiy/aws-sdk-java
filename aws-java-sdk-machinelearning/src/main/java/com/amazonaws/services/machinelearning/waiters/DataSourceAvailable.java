...
class DataSourceAvailable {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<DescribeDataSourcesResult> {
         ...
         */
        @Override
        public boolean matches(DescribeDataSourcesResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeDataSourcesResult> {
        private static final JsonNode expectedResult;
