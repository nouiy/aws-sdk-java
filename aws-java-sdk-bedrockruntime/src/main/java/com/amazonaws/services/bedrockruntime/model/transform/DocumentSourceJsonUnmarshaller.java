...
/**
 * DocumentSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocumentSourceJsonUnmarshaller implements Unmarshaller<DocumentSource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("bytes", targetDepth)) {
                    context.nextToken();
                    documentSource.setBytes(context.getUnmarshaller(java.nio.ByteBuffer.class).unmarshall(context));
                }
