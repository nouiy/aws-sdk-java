...
/**
 * GuardrailConverseTextBlockMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GuardrailConverseTextBlockMarshaller {
    ...
    public static GuardrailConverseTextBlockMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GuardrailConverseTextBlock guardrailConverseTextBlock, ProtocolMarshaller protocolMarshaller) {

        if (guardrailConverseTextBlock == null) {
