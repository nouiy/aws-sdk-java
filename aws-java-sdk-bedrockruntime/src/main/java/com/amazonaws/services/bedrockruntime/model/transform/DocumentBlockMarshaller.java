...
public class DocumentBlockMarshaller {
    ...
    public void marshall(DocumentBlock documentBlock, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(documentBlock.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(documentBlock.getName(), NAME_BINDING);
            protocolMarshaller.marshall(documentBlock.getSource(), SOURCE_BINDING);
        } catch (Exception e) {
