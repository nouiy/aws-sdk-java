...
public class DocumentSource implements Serializable, Cloneable, StructuredPojo {
    ...
    public DocumentSource withBytes(java.nio.ByteBuffer bytes) {
        setBytes(bytes);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DocumentSource == false)
            return false;
    ...
    public DocumentSource clone() {
        try {
            return (DocumentSource) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.bedrockruntime.model.transform.DocumentSourceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
