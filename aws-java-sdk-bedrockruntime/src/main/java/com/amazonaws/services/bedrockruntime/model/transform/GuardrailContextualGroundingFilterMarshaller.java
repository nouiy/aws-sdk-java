...
public class GuardrailContextualGroundingFilterMarshaller {
    ...
    public void marshall(GuardrailContextualGroundingFilter guardrailContextualGroundingFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(guardrailContextualGroundingFilter.getScore(), SCORE_BINDING);
            protocolMarshaller.marshall(guardrailContextualGroundingFilter.getAction(), ACTION_BINDING);
        } catch (Exception e) {
