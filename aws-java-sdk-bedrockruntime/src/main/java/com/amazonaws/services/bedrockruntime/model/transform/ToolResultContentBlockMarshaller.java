...
/**
 * ToolResultContentBlockMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ToolResultContentBlockMarshaller {
    ...
    public static ToolResultContentBlockMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ToolResultContentBlock toolResultContentBlock, ProtocolMarshaller protocolMarshaller) {

        if (toolResultContentBlock == null) {
