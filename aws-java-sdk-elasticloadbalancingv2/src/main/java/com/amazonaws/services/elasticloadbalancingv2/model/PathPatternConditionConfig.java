...
public class PathPatternConditionConfig implements Serializable, Cloneable {
    ...
    public PathPatternConditionConfig withValues(java.util.Collection<String> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PathPatternConditionConfig == false)
            return false;
        PathPatternConditionConfig other = (PathPatternConditionConfig) obj;
    ...
    public PathPatternConditionConfig clone() {
        try {
            return (PathPatternConditionConfig) super.clone();
