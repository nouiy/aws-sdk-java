...
public class CreateTargetGroupResultStaxUnmarshaller implements Unmarshaller<CreateTargetGroupResult, StaxUnmarshallerContext> {

    public CreateTargetGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    private static CreateTargetGroupResultStaxUnmarshaller instance;

    public static CreateTargetGroupResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateTargetGroupResultStaxUnmarshaller();
        return instance;
    }
}
