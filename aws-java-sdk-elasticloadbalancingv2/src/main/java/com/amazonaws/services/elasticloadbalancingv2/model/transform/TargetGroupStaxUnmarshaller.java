        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TargetGroupArn", targetDepth)) {
                    targetGroup.setTargetGroupArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("TargetGroupName", targetDepth)) {
                    targetGroup.setTargetGroupName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Protocol", targetDepth)) {
                    targetGroup.setProtocol(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Port", targetDepth)) {
                    targetGroup.setPort(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("VpcId", targetDepth)) {
                    targetGroup.setVpcId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("HealthCheckProtocol", targetDepth)) {
                    targetGroup.setHealthCheckProtocol(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("HealthCheckPort", targetDepth)) {
                    targetGroup.setHealthCheckPort(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("HealthCheckTimeoutSeconds", targetDepth)) {
                    targetGroup.setHealthCheckTimeoutSeconds(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("HealthyThresholdCount", targetDepth)) {
                    targetGroup.setHealthyThresholdCount(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("UnhealthyThresholdCount", targetDepth)) {
                    targetGroup.setUnhealthyThresholdCount(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("HealthCheckPath", targetDepth)) {
                    targetGroup.setHealthCheckPath(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Matcher", targetDepth)) {
                    targetGroup.setMatcher(MatcherStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
