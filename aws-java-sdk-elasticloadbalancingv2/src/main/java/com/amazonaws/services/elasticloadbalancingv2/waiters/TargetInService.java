...
class TargetInService {
    ...
    static class IsHealthyMatcher extends WaiterAcceptor<DescribeTargetHealthResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"healthy\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }

        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("TargetHealthDescriptions")),
                new JmesPathSubExpression(new JmesPathField("TargetHealth"), new JmesPathField("State")));
    ...
    static class IsInvalidInstanceMatcher extends WaiterAcceptor<DescribeTargetHealthResult> {
        /**
