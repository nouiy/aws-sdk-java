...
public class AWSMarketplaceCommerceAnalyticsException extends com.amazonaws.AmazonServiceException {
    ...
    /**
     * Constructs a new AWSMarketplaceCommerceAnalyticsException with the specified error message.
     *
     * @param message
     *        Describes the error encountered.
     */
    public AWSMarketplaceCommerceAnalyticsException(String message) {
        super(message);
    }
