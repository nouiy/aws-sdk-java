...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.iotfleethub.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.iotfleethub.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotfleethub.model.LimitExceededException limitExceededException = new com.amazonaws.services.iotfleethub.model.LimitExceededException(
                null);
