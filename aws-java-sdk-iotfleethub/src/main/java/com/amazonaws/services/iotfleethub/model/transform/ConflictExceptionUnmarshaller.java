...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.iotfleethub.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.iotfleethub.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotfleethub.model.ConflictException conflictException = new com.amazonaws.services.iotfleethub.model.ConflictException(null);
