...
public class DeleteTextMessageSpendLimitOverrideResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTextMessageSpendLimitOverrideResult == false)
            return false;
        DeleteTextMessageSpendLimitOverrideResult other = (DeleteTextMessageSpendLimitOverrideResult) obj;
    ...
    public DeleteTextMessageSpendLimitOverrideResult clone() {
        try {
            return (DeleteTextMessageSpendLimitOverrideResult) super.clone();
