...
public class UpdatePhoneNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdatePhoneNumberResult withNumberCapabilities(java.util.Collection<String> numberCapabilities) {
    ...
    public UpdatePhoneNumberResult withCreatedTimestamp(java.util.Date createdTimestamp) {
