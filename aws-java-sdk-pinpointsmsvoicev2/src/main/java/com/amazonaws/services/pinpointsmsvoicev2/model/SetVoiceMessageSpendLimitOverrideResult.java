...
public class SetVoiceMessageSpendLimitOverrideResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The current monthly limit to enforce on sending voice messages.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetVoiceMessageSpendLimitOverrideResult == false)
            return false;
        SetVoiceMessageSpendLimitOverrideResult other = (SetVoiceMessageSpendLimitOverrideResult) obj;
    ...
    public SetVoiceMessageSpendLimitOverrideResult clone() {
        try {
            return (SetVoiceMessageSpendLimitOverrideResult) super.clone();
