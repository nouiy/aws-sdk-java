...
public class DeleteDefaultSenderIdRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The name of the configuration set or the configuration set Amazon Resource Name (ARN) to delete the default
     * sender ID from. The ConfigurationSetName and ConfigurationSetArn can be found using the
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDefaultSenderIdRequest == false)
            return false;
        DeleteDefaultSenderIdRequest other = (DeleteDefaultSenderIdRequest) obj;
    ...
    @Override
    public DeleteDefaultSenderIdRequest clone() {
        return (DeleteDefaultSenderIdRequest) super.clone();
    }
