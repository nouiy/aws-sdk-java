...
public class DeleteOptedOutNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The phone number that was removed from the OptOutList.
     */
     ...
     *        The time that the number was removed at, in <a href="https://www.epochconverter.com/">UNIX epoch time</a>
     *        format.
     */
     ...
     * </p>
     * 
     * @return The time that the number was removed at, in <a href="https://www.epochconverter.com/">UNIX epoch time</a>
     *         format.
     */
    ...
    public DeleteOptedOutNumberResult withOptedOutTimestamp(java.util.Date optedOutTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteOptedOutNumberResult == false)
            return false;
        DeleteOptedOutNumberResult other = (DeleteOptedOutNumberResult) obj;
    ...
    public DeleteOptedOutNumberResult clone() {
        try {
            return (DeleteOptedOutNumberResult) super.clone();
