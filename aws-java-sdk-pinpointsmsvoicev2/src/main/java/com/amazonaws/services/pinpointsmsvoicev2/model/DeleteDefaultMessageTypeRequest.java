...
public class DeleteDefaultMessageTypeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The name of the configuration set or the configuration set Amazon Resource Name (ARN) to delete the default
     * message type from. The ConfigurationSetName and ConfigurationSetArn can be found using the
     ...
     * </p>
     * 
     * @return The name of the configuration set or the configuration set Amazon Resource Name (ARN) to delete the
     *         default message type from. The ConfigurationSetName and ConfigurationSetArn can be found using the
     *         <a>DescribeConfigurationSets</a> action.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDefaultMessageTypeRequest == false)
            return false;
        DeleteDefaultMessageTypeRequest other = (DeleteDefaultMessageTypeRequest) obj;
    ...
    @Override
    public DeleteDefaultMessageTypeRequest clone() {
        return (DeleteDefaultMessageTypeRequest) super.clone();
    }
