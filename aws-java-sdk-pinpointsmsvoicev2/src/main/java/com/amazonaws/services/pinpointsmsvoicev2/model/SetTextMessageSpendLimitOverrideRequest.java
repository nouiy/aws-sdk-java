...
public class SetTextMessageSpendLimitOverrideRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The new monthly limit to enforce on text messages.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetTextMessageSpendLimitOverrideRequest == false)
            return false;
        SetTextMessageSpendLimitOverrideRequest other = (SetTextMessageSpendLimitOverrideRequest) obj;
    ...
    @Override
    public SetTextMessageSpendLimitOverrideRequest clone() {
        return (SetTextMessageSpendLimitOverrideRequest) super.clone();
    }
