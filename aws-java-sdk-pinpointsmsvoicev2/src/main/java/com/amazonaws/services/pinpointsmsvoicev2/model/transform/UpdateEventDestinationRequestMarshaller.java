...
public class UpdateEventDestinationRequestMarshaller {
    ...
    private static final UpdateEventDestinationRequestMarshaller instance = new UpdateEventDestinationRequestMarshaller();

    public static UpdateEventDestinationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateEventDestinationRequest updateEventDestinationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateEventDestinationRequest.getConfigurationSetName(), CONFIGURATIONSETNAME_BINDING);
            protocolMarshaller.marshall(updateEventDestinationRequest.getEventDestinationName(), EVENTDESTINATIONNAME_BINDING);
            protocolMarshaller.marshall(updateEventDestinationRequest.getEnabled(), ENABLED_BINDING);
            protocolMarshaller.marshall(updateEventDestinationRequest.getMatchingEventTypes(), MATCHINGEVENTTYPES_BINDING);
            protocolMarshaller.marshall(updateEventDestinationRequest.getCloudWatchLogsDestination(), CLOUDWATCHLOGSDESTINATION_BINDING);
            protocolMarshaller.marshall(updateEventDestinationRequest.getKinesisFirehoseDestination(), KINESISFIREHOSEDESTINATION_BINDING);
            protocolMarshaller.marshall(updateEventDestinationRequest.getSnsDestination(), SNSDESTINATION_BINDING);
        } catch (Exception e) {
