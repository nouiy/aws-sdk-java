...
/**
 * DescribeKeywordsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeKeywordsResultJsonUnmarshaller implements Unmarshaller<DescribeKeywordsResult, JsonUnmarshallerContext> {

    public DescribeKeywordsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeKeywordsResult describeKeywordsResult = new DescribeKeywordsResult();
    ...
    private static DescribeKeywordsResultJsonUnmarshaller instance;

    public static DescribeKeywordsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeKeywordsResultJsonUnmarshaller();
        return instance;
    }
}
