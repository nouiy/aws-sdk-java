...
public class DescribeConfigurationSetsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ConfigurationSetInformation> configurationSets;
    /**
     * <p>
    ...
    public java.util.List<ConfigurationSetInformation> getConfigurationSets() {
    ...
    public void setConfigurationSets(java.util.Collection<ConfigurationSetInformation> configurationSets) {
        if (configurationSets == null) {
            this.configurationSets = null;
            return;
        }

        this.configurationSets = new java.util.ArrayList<ConfigurationSetInformation>(configurationSets);
    }
    ...
    public DescribeConfigurationSetsResult withConfigurationSets(ConfigurationSetInformation... configurationSets) {
        if (this.configurationSets == null) {
            setConfigurationSets(new java.util.ArrayList<ConfigurationSetInformation>(configurationSets.length));
        }
        for (ConfigurationSetInformation ele : configurationSets) {
    ...
    public DescribeConfigurationSetsResult withConfigurationSets(java.util.Collection<ConfigurationSetInformation> configurationSets) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeConfigurationSetsResult == false)
            return false;
        DescribeConfigurationSetsResult other = (DescribeConfigurationSetsResult) obj;
    ...
    public DescribeConfigurationSetsResult clone() {
        try {
            return (DescribeConfigurationSetsResult) super.clone();
