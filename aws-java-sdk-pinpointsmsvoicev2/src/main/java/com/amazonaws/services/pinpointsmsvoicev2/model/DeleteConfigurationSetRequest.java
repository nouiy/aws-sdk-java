...
public class DeleteConfigurationSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The name of the configuration set or the configuration set ARN that you want to delete. The ConfigurationSetName
     * and ConfigurationSetArn can be found using the <a>DescribeConfigurationSets</a> action.
     * </p>
     */
     ...
     *        ConfigurationSetName and ConfigurationSetArn can be found using the <a>DescribeConfigurationSets</a>
     *        action.
     */
     ...
     * </p>
     * 
     * @return The name of the configuration set or the configuration set ARN that you want to delete. The
     *         ConfigurationSetName and ConfigurationSetArn can be found using the <a>DescribeConfigurationSets</a>
     *         action.
     */
