...
public class SetTextMessageSpendLimitOverrideResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetTextMessageSpendLimitOverrideResult == false)
            return false;
        SetTextMessageSpendLimitOverrideResult other = (SetTextMessageSpendLimitOverrideResult) obj;
    ...
    @Override
    public SetTextMessageSpendLimitOverrideResult clone() {
        try {
            return (SetTextMessageSpendLimitOverrideResult) super.clone();
