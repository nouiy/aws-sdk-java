...
public class CreatePoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreatePoolResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public CreatePoolResult withCreatedTimestamp(java.util.Date createdTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePoolResult == false)
            return false;
        CreatePoolResult other = (CreatePoolResult) obj;
