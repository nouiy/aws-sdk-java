...
/**
 * AssociateMemberToGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateMemberToGroupRequestMarshaller {
    ...
    private static final AssociateMemberToGroupRequestMarshaller instance = new AssociateMemberToGroupRequestMarshaller();

    public static AssociateMemberToGroupRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(AssociateMemberToGroupRequest associateMemberToGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(associateMemberToGroupRequest.getOrganizationId(), ORGANIZATIONID_BINDING);
            protocolMarshaller.marshall(associateMemberToGroupRequest.getGroupId(), GROUPID_BINDING);
            protocolMarshaller.marshall(associateMemberToGroupRequest.getMemberId(), MEMBERID_BINDING);
        } catch (Exception e) {
