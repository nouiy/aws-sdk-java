...
/**
 * AssociateDelegateToResourceResult JSON Unmarshaller
 */
...
public class AssociateDelegateToResourceResultJsonUnmarshaller implements Unmarshaller<AssociateDelegateToResourceResult, JsonUnmarshallerContext> {
    ...
    public AssociateDelegateToResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateDelegateToResourceResult associateDelegateToResourceResult = new AssociateDelegateToResourceResult();
