...
public class DnsRecordMarshaller {
    ...
    public void marshall(DnsRecord dnsRecord, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dnsRecord.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(dnsRecord.getHostname(), HOSTNAME_BINDING);
            protocolMarshaller.marshall(dnsRecord.getValue(), VALUE_BINDING);
        } catch (Exception e) {
