...
/**
 * CancelMailboxExportJobResult JSON Unmarshaller
 */
...
public class CancelMailboxExportJobResultJsonUnmarshaller implements Unmarshaller<CancelMailboxExportJobResult, JsonUnmarshallerContext> {
    ...
    public CancelMailboxExportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelMailboxExportJobResult cancelMailboxExportJobResult = new CancelMailboxExportJobResult();
