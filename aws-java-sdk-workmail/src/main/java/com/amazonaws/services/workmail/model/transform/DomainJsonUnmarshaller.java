        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainName", targetDepth)) {
                    context.nextToken();
                    domain.setDomainName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("HostedZoneId", targetDepth)) {
                    context.nextToken();
                    domain.setHostedZoneId(context.getUnmarshaller(String.class).unmarshall(context));
                }
