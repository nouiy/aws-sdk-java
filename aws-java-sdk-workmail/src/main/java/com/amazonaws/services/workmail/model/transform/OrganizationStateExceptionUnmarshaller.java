...
public class OrganizationStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationStateExceptionUnmarshaller instance;

    public static OrganizationStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationStateExceptionUnmarshaller();
        return instance;
    }
}
