...
/**
 * DeleteMailboxPermissionsResult JSON Unmarshaller
 */
...
public class DeleteMailboxPermissionsResultJsonUnmarshaller implements Unmarshaller<DeleteMailboxPermissionsResult, JsonUnmarshallerContext> {
    ...
    public DeleteMailboxPermissionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMailboxPermissionsResult deleteMailboxPermissionsResult = new DeleteMailboxPermissionsResult();

        return deleteMailboxPermissionsResult;
    }
