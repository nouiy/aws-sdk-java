...
/**
 * PutMobileDeviceAccessOverrideResult JSON Unmarshaller
 */
...
public class PutMobileDeviceAccessOverrideResultJsonUnmarshaller implements Unmarshaller<PutMobileDeviceAccessOverrideResult, JsonUnmarshallerContext> {
    ...
    public PutMobileDeviceAccessOverrideResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutMobileDeviceAccessOverrideResult putMobileDeviceAccessOverrideResult = new PutMobileDeviceAccessOverrideResult();

        return putMobileDeviceAccessOverrideResult;
    }
