...
/**
 * PutInboundDmarcSettingsResult JSON Unmarshaller
 */
...
public class PutInboundDmarcSettingsResultJsonUnmarshaller implements Unmarshaller<PutInboundDmarcSettingsResult, JsonUnmarshallerContext> {
    ...
    public PutInboundDmarcSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutInboundDmarcSettingsResult putInboundDmarcSettingsResult = new PutInboundDmarcSettingsResult();

        return putInboundDmarcSettingsResult;
    }
