...
public class ReservedNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ReservedNameExceptionUnmarshaller instance;

    public static ReservedNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReservedNameExceptionUnmarshaller();
        return instance;
    }
}
