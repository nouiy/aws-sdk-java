...
public class EntityStateException extends com.amazonaws.services.workmail.model.AmazonWorkMailException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new EntityStateException with the specified error message.
     *
     * @param message
