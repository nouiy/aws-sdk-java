...
public class MailDomainNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MailDomainNotFoundExceptionUnmarshaller instance;

    public static MailDomainNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MailDomainNotFoundExceptionUnmarshaller();
        return instance;
    }
}
