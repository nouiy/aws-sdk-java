...
/**
 * GetAccessControlEffectRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetAccessControlEffectRequestMarshaller {
    ...
    public static GetAccessControlEffectRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetAccessControlEffectRequest getAccessControlEffectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getAccessControlEffectRequest.getOrganizationId(), ORGANIZATIONID_BINDING);
