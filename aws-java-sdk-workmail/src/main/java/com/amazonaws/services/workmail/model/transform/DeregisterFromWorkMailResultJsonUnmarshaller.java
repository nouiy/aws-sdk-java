...
/**
 * DeregisterFromWorkMailResult JSON Unmarshaller
 */
...
public class DeregisterFromWorkMailResultJsonUnmarshaller implements Unmarshaller<DeregisterFromWorkMailResult, JsonUnmarshallerContext> {
    ...
    public DeregisterFromWorkMailResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterFromWorkMailResult deregisterFromWorkMailResult = new DeregisterFromWorkMailResult();
