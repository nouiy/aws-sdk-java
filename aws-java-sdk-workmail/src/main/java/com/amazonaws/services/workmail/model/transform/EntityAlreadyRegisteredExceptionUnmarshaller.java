...
public class EntityAlreadyRegisteredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EntityAlreadyRegisteredExceptionUnmarshaller instance;

    public static EntityAlreadyRegisteredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EntityAlreadyRegisteredExceptionUnmarshaller();
        return instance;
    }
}
