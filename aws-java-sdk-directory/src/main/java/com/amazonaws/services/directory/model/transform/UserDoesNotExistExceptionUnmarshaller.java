...
public class UserDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    userDoesNotExistException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static UserDoesNotExistExceptionUnmarshaller instance;

    public static UserDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
