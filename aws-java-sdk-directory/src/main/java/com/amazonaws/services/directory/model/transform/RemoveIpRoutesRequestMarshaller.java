...
/**
 * RemoveIpRoutesRequestMarshaller
 */
...
public class RemoveIpRoutesRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CIDRIPS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("CidrIps").build();

    private static final RemoveIpRoutesRequestMarshaller instance = new RemoveIpRoutesRequestMarshaller();

    public static RemoveIpRoutesRequestMarshaller getInstance() {
        return instance;
    }
