...
public class AuthenticationFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    authenticationFailedException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static AuthenticationFailedExceptionUnmarshaller instance;

    public static AuthenticationFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AuthenticationFailedExceptionUnmarshaller();
        return instance;
    }
}
