...
public class ShareLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    shareLimitExceededException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ShareLimitExceededExceptionUnmarshaller instance;

    public static ShareLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ShareLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
