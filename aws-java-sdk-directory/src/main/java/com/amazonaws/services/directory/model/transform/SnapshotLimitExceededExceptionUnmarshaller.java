...
public class SnapshotLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    snapshotLimitExceededException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SnapshotLimitExceededExceptionUnmarshaller instance;

    public static SnapshotLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SnapshotLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
