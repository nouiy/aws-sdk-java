...
/**
 * RemoveRegionResult JSON Unmarshaller
 */
...
public class RemoveRegionResultJsonUnmarshaller implements Unmarshaller<RemoveRegionResult, JsonUnmarshallerContext> {
    ...
    public RemoveRegionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveRegionResult removeRegionResult = new RemoveRegionResult();
