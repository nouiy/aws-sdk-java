...
/**
 * AddRegionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddRegionResultJsonUnmarshaller implements Unmarshaller<AddRegionResult, JsonUnmarshallerContext> {

    public AddRegionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AddRegionResult addRegionResult = new AddRegionResult();
