...
public class InvalidNextTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidNextTokenExceptionUnmarshaller() {
        super(com.amazonaws.services.directory.model.InvalidNextTokenException.class, "InvalidNextTokenException");
    }

    @Override
    public com.amazonaws.services.directory.model.InvalidNextTokenException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
