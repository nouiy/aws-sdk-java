...
public class DirectoryLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RequestId", targetDepth)) {
                    context.nextToken();
                    directoryLimitExceededException.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static DirectoryLimitExceededExceptionUnmarshaller instance;

    public static DirectoryLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DirectoryLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
