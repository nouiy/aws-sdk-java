...
public class DeregisterEventTopicResultJsonUnmarshaller implements Unmarshaller<DeregisterEventTopicResult, JsonUnmarshallerContext> {
    ...
    public DeregisterEventTopicResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterEventTopicResult deregisterEventTopicResult = new DeregisterEventTopicResult();
