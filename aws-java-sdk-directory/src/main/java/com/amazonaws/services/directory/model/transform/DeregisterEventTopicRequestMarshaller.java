...
/**
 * DeregisterEventTopicRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeregisterEventTopicRequestMarshaller {
    ...
    private static final DeregisterEventTopicRequestMarshaller instance = new DeregisterEventTopicRequestMarshaller();

    public static DeregisterEventTopicRequestMarshaller getInstance() {
        return instance;
    }
