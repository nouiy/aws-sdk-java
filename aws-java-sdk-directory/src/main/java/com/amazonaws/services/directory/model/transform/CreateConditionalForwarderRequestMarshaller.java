...
public class CreateConditionalForwarderRequestMarshaller {
    ...
    private static final CreateConditionalForwarderRequestMarshaller instance = new CreateConditionalForwarderRequestMarshaller();

    public static CreateConditionalForwarderRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateConditionalForwarderRequest createConditionalForwarderRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createConditionalForwarderRequest.getDirectoryId(), DIRECTORYID_BINDING);
            protocolMarshaller.marshall(createConditionalForwarderRequest.getRemoteDomainName(), REMOTEDOMAINNAME_BINDING);
            protocolMarshaller.marshall(createConditionalForwarderRequest.getDnsIpAddrs(), DNSIPADDRS_BINDING);
        } catch (Exception e) {
