...
public class EnableRadiusResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableRadiusResult == false)
            return false;
        EnableRadiusResult other = (EnableRadiusResult) obj;
        return true;
    }
    ...
    @Override
    public EnableRadiusResult clone() {
        try {
            return (EnableRadiusResult) super.clone();
