...
public class AWSDirectoryServiceModuleInjector implements InjectorSource {
    ...
    public Injector getInjector() {
        return Guice.createInjector(Stage.PRODUCTION, CucumberModules.SCENARIO, new AWSDirectoryServiceModule());
    }

    static class AWSDirectoryServiceModule extends AbstractModule {

        @Override
        protected void configure() {
            bind(AmazonWebServiceClient.class).to(AWSDirectoryServiceClient.class);
        }
    }
}
