...
public class PreconditionFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private PreconditionFailedExceptionUnmarshaller() {
        super(com.amazonaws.services.qconnect.model.PreconditionFailedException.class, "PreconditionFailedException");
    }

    @Override
    public com.amazonaws.services.qconnect.model.PreconditionFailedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.qconnect.model.PreconditionFailedException preconditionFailedException = new com.amazonaws.services.qconnect.model.PreconditionFailedException(
                null);
