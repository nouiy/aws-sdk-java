...
public class GetQuickResponseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetQuickResponseResult withQuickResponse(QuickResponseData quickResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetQuickResponseResult == false)
            return false;
        GetQuickResponseResult other = (GetQuickResponseResult) obj;
    ...
    @Override
    public GetQuickResponseResult clone() {
        try {
            return (GetQuickResponseResult) super.clone();
