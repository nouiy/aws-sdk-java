...
public class AssistantCapabilityConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssistantCapabilityConfiguration == false)
            return false;
        AssistantCapabilityConfiguration other = (AssistantCapabilityConfiguration) obj;
    ...
    public AssistantCapabilityConfiguration clone() {
        try {
            return (AssistantCapabilityConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.qconnect.model.transform.AssistantCapabilityConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
