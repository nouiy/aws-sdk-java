 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/qconnect-2020-10-19/ContentAssociationSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContentAssociationSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ContentAssociationSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ContentAssociationSummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ContentAssociationSummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ContentAssociationSummary == false)
            return false;
    ...
    public ContentAssociationSummary clone() {
        try {
            return (ContentAssociationSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.qconnect.model.transform.ContentAssociationSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
