...
/**
 * DeleteImportJobResult JSON Unmarshaller
 */
...
public class DeleteImportJobResultJsonUnmarshaller implements Unmarshaller<DeleteImportJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteImportJobResult deleteImportJobResult = new DeleteImportJobResult();
