...
public class PutFeedbackRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CONTENTFEEDBACK_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("contentFeedback").build();
    ...
    public void marshall(PutFeedbackRequest putFeedbackRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putFeedbackRequest.getAssistantId(), ASSISTANTID_BINDING);
            protocolMarshaller.marshall(putFeedbackRequest.getContentFeedback(), CONTENTFEEDBACK_BINDING);
            protocolMarshaller.marshall(putFeedbackRequest.getTargetId(), TARGETID_BINDING);
            protocolMarshaller.marshall(putFeedbackRequest.getTargetType(), TARGETTYPE_BINDING);
        } catch (Exception e) {
