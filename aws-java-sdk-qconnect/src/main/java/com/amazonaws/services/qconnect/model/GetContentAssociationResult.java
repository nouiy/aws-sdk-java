...
public class GetContentAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetContentAssociationResult == false)
            return false;
        GetContentAssociationResult other = (GetContentAssociationResult) obj;
    ...
    public GetContentAssociationResult clone() {
        try {
            return (GetContentAssociationResult) super.clone();
