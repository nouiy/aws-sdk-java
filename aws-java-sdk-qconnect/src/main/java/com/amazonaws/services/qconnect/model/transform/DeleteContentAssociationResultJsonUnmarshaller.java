...
/**
 * DeleteContentAssociationResult JSON Unmarshaller
 */
...
public class DeleteContentAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteContentAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteContentAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContentAssociationResult deleteContentAssociationResult = new DeleteContentAssociationResult();

        return deleteContentAssociationResult;
    }
