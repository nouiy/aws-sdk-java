...
/**
 * UpdateUserSettingsResult JSON Unmarshaller
 */
...
public class UpdateUserSettingsResultJsonUnmarshaller implements Unmarshaller<UpdateUserSettingsResult, JsonUnmarshallerContext> {
    ...
    public UpdateUserSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateUserSettingsResult updateUserSettingsResult = new UpdateUserSettingsResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("userSettings", targetDepth)) {
                    context.nextToken();
                    updateUserSettingsResult.setUserSettings(UserSettingsJsonUnmarshaller.getInstance().unmarshall(context));
                }
