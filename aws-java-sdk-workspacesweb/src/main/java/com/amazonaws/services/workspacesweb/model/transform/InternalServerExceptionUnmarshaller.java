...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesweb.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.workspacesweb.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesweb.model.InternalServerException internalServerException = new com.amazonaws.services.workspacesweb.model.InternalServerException(
                null);
