...
public class AssociateNetworkSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateNetworkSettingsResult == false)
            return false;
        AssociateNetworkSettingsResult other = (AssociateNetworkSettingsResult) obj;
    ...
    public AssociateNetworkSettingsResult clone() {
        try {
            return (AssociateNetworkSettingsResult) super.clone();
