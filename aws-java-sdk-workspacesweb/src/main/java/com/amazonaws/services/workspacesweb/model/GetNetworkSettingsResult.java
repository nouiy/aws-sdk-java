...
public class GetNetworkSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetNetworkSettingsResult withNetworkSettings(NetworkSettings networkSettings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetNetworkSettingsResult == false)
            return false;
        GetNetworkSettingsResult other = (GetNetworkSettingsResult) obj;
    ...
    @Override
    public GetNetworkSettingsResult clone() {
        try {
            return (GetNetworkSettingsResult) super.clone();
