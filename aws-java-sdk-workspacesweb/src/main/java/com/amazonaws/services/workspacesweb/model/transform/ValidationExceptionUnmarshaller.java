...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.workspacesweb.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.workspacesweb.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.workspacesweb.model.ValidationException validationException = new com.amazonaws.services.workspacesweb.model.ValidationException(
                null);
