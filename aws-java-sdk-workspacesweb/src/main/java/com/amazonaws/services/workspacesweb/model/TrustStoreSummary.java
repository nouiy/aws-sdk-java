 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-web-2020-07-08/TrustStoreSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrustStoreSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TrustStoreSummary == false)
            return false;
        TrustStoreSummary other = (TrustStoreSummary) obj;
    ...
    @Override
    public TrustStoreSummary clone() {
        try {
            return (TrustStoreSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.workspacesweb.model.transform.TrustStoreSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
