...
public class AssociateUserSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateUserSettingsResult == false)
            return false;
        AssociateUserSettingsResult other = (AssociateUserSettingsResult) obj;
    ...
    public AssociateUserSettingsResult clone() {
        try {
            return (AssociateUserSettingsResult) super.clone();
