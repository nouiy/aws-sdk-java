...
public class UpdateIdentityPoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateIdentityPoolResult withAllowClassicFlow(Boolean allowClassicFlow) {
     ...
     *
     * @see UpdateIdentityPoolResult#withSupportedLoginProviders
    ...
    public UpdateIdentityPoolResult withIdentityPoolTags(java.util.Map<String, String> identityPoolTags) {
     ...
     *
     * @see UpdateIdentityPoolResult#withIdentityPoolTags
     * @returns a reference to this object so that method calls can be chained together.
     */
