...
public class GetPrincipalTagAttributeMapRequestMarshaller {
    ...
    private static final GetPrincipalTagAttributeMapRequestMarshaller instance = new GetPrincipalTagAttributeMapRequestMarshaller();

    public static GetPrincipalTagAttributeMapRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetPrincipalTagAttributeMapRequest getPrincipalTagAttributeMapRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getPrincipalTagAttributeMapRequest.getIdentityPoolId(), IDENTITYPOOLID_BINDING);
            protocolMarshaller.marshall(getPrincipalTagAttributeMapRequest.getIdentityProviderName(), IDENTITYPROVIDERNAME_BINDING);
        } catch (Exception e) {
