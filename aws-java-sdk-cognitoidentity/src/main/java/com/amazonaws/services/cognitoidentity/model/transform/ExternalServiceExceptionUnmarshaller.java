...
public class ExternalServiceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ExternalServiceExceptionUnmarshaller instance;

    public static ExternalServiceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExternalServiceExceptionUnmarshaller();
        return instance;
    }
}
