        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    roleMapping.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("AmbiguousRoleResolution", targetDepth)) {
                    context.nextToken();
                    roleMapping.setAmbiguousRoleResolution(context.getUnmarshaller(String.class).unmarshall(context));
                }
