...
/**
 * Abstract implementation of {@code AWSMigrationHubRefactorSpacesAsync}. Convenient method forms pass through to the
 * corresponding overload that takes a request object and an {@code AsyncHandler}, which throws an
 * {@code UnsupportedOperationException}.
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AbstractAWSMigrationHubRefactorSpacesAsync extends AbstractAWSMigrationHubRefactorSpaces implements AWSMigrationHubRefactorSpacesAsync {

    protected AbstractAWSMigrationHubRefactorSpacesAsync() {
    }
