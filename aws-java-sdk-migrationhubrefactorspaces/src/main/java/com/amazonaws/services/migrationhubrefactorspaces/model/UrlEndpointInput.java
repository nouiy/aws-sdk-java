 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/migration-hub-refactor-spaces-2021-10-26/UrlEndpointInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UrlEndpointInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public UrlEndpointInput withHealthUrl(String healthUrl) {
    ...
    public UrlEndpointInput withUrl(String url) {
        setUrl(url);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UrlEndpointInput == false)
            return false;
        UrlEndpointInput other = (UrlEndpointInput) obj;
    ...
    public UrlEndpointInput clone() {
        try {
            return (UrlEndpointInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.migrationhubrefactorspaces.model.transform.UrlEndpointInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
