...
public class GetServiceRequestMarshaller {
    ...
    public void marshall(GetServiceRequest getServiceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getServiceRequest.getApplicationIdentifier(), APPLICATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getServiceRequest.getEnvironmentIdentifier(), ENVIRONMENTIDENTIFIER_BINDING);
