...
public class DeleteEnvironmentRequestProtocolMarshaller implements Marshaller<Request<DeleteEnvironmentRequest>, DeleteEnvironmentRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON)
            .requestUri("/environments/{EnvironmentIdentifier}").httpMethodName(HttpMethodName.DELETE).hasExplicitPayloadMember(false).hasPayloadMembers(false)
            .serviceName("AWSMigrationHubRefactorSpaces").build();
