...
public class CreateServiceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The tags assigned to the created service. A tag is a label that you assign to an Amazon Web Services resource.
     ...
     * </p>
     * 
     * @return The ID of the application that the created service belongs to.
     */
    ...
    public CreateServiceResult withCreatedTime(java.util.Date createdTime) {
     ...
     * </p>
     * 
     * @return The description of the created service.
     */
    ...
    public CreateServiceResult withLastUpdatedTime(java.util.Date lastUpdatedTime) {
     ...
     * </p>
     * 
     * @return The tags assigned to the created service. A tag is a label that you assign to an Amazon Web Services
    ...
    public CreateServiceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateServiceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateServiceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
