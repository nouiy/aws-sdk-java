...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhubrefactorspaces.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.migrationhubrefactorspaces.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhubrefactorspaces.model.ConflictException conflictException = new com.amazonaws.services.migrationhubrefactorspaces.model.ConflictException(
                null);
