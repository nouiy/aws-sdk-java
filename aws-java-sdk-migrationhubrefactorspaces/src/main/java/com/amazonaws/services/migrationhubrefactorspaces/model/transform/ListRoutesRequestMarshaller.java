...
public class ListRoutesRequestMarshaller {
    ...
    public void marshall(ListRoutesRequest listRoutesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRoutesRequest.getApplicationIdentifier(), APPLICATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listRoutesRequest.getEnvironmentIdentifier(), ENVIRONMENTIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listRoutesRequest.getMaxResults(), MAXRESULTS_BINDING);
