 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/migration-hub-refactor-spaces-2021-10-26/EnvironmentSummary"
...
public class EnvironmentSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public EnvironmentSummary withCreatedTime(java.util.Date createdTime) {
    ...
    public EnvironmentSummary withLastUpdatedTime(java.util.Date lastUpdatedTime) {
    ...
    public EnvironmentSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see EnvironmentSummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public EnvironmentSummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.migrationhubrefactorspaces.model.transform.EnvironmentSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
