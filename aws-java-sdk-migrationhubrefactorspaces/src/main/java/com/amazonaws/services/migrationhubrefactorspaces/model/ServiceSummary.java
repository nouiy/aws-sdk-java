 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/migration-hub-refactor-spaces-2021-10-26/ServiceSummary"
...
public class ServiceSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ServiceSummary withCreatedTime(java.util.Date createdTime) {
    ...
    public void setLambdaEndpoint(LambdaEndpointSummary lambdaEndpoint) {
    ...
    public LambdaEndpointSummary getLambdaEndpoint() {
    ...
    public ServiceSummary withLastUpdatedTime(java.util.Date lastUpdatedTime) {
    ...
    public ServiceSummary withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ServiceSummary#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ServiceSummary addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UrlEndpointSummary getUrlEndpoint() {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.migrationhubrefactorspaces.model.transform.ServiceSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
