...
public class StopQueryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The ID of the query that you want to stop. A <code>QueryId</code> is an internally-generated identifier for a
     * specific query.
     * </p>
     */
     ...
     * 
     * @param queryId
     *        The ID of the query that you want to stop. A <code>QueryId</code> is an internally-generated identifier
     ...
     * </p>
     * 
     * @return The ID of the query that you want to stop. A <code>QueryId</code> is an internally-generated identifier
     *         for a specific query.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopQueryRequest == false)
            return false;
        StopQueryRequest other = (StopQueryRequest) obj;
    ...
    @Override
    public StopQueryRequest clone() {
        return (StopQueryRequest) super.clone();
    }
