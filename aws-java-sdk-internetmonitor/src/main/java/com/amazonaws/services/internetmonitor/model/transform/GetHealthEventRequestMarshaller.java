...
@SdkInternalApi
public class GetHealthEventRequestMarshaller {
    ...
    public static GetHealthEventRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetHealthEventRequest getHealthEventRequest, ProtocolMarshaller protocolMarshaller) {
