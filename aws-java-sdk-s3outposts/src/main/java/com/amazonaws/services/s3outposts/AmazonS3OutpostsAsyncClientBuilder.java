...
/**
 * Fluent builder for {@link com.amazonaws.services.s3outposts.AmazonS3OutpostsAsync}. Use of the builder is preferred
...
public final class AmazonS3OutpostsAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonS3OutpostsAsyncClientBuilder, AmazonS3OutpostsAsync> {
     ...
     * @return Fully configured implementation of AmazonS3OutpostsAsync.
     */
    @Override
    protected AmazonS3OutpostsAsync build(AwsAsyncClientParams params) {
        return new AmazonS3OutpostsAsyncClient(params);
    }
