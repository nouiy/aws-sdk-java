...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.s3outposts.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.s3outposts.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.s3outposts.model.ValidationException validationException = new com.amazonaws.services.s3outposts.model.ValidationException(null);
