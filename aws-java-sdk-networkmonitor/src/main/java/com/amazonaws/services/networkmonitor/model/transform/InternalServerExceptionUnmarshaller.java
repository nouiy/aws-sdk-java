...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.networkmonitor.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.networkmonitor.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.networkmonitor.model.InternalServerException internalServerException = new com.amazonaws.services.networkmonitor.model.InternalServerException(
                null);
