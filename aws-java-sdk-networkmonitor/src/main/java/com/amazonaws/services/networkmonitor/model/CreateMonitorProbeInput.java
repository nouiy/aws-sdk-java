 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/networkmonitor-2023-08-01/CreateMonitorProbeInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateMonitorProbeInput implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.Map<String, String> probeTags;
    ...
    public java.util.Map<String, String> getProbeTags() {
        return probeTags;
    }
    ...
    public void setProbeTags(java.util.Map<String, String> probeTags) {
    ...
    public CreateMonitorProbeInput withProbeTags(java.util.Map<String, String> probeTags) {
        setProbeTags(probeTags);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getProbeTags() != null)
            sb.append("ProbeTags: ").append(getProbeTags());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMonitorProbeInput == false)
            return false;
        ...
        if (other.getProbeTags() == null ^ this.getProbeTags() == null)
            return false;
        if (other.getProbeTags() != null && other.getProbeTags().equals(this.getProbeTags()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getProbeTags() == null) ? 0 : getProbeTags().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.networkmonitor.model.transform.CreateMonitorProbeInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
