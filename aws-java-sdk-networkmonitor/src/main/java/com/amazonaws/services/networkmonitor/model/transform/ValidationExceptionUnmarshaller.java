...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.networkmonitor.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.networkmonitor.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.networkmonitor.model.ValidationException validationException = new com.amazonaws.services.networkmonitor.model.ValidationException(
                null);
