...
public class GetProbeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetProbeResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetProbeResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public GetProbeResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetProbeResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetProbeResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetProbeResult == false)
            return false;
        GetProbeResult other = (GetProbeResult) obj;
