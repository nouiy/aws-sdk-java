...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.networkmonitor.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.networkmonitor.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.networkmonitor.model.ThrottlingException throttlingException = new com.amazonaws.services.networkmonitor.model.ThrottlingException(
                null);
