...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.appregistry.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.appregistry.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.appregistry.model.ValidationException validationException = new com.amazonaws.services.appregistry.model.ValidationException(
                null);
