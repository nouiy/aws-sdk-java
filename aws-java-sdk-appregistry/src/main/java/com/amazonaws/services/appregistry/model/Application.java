...
public class Application implements Serializable, Cloneable, StructuredPojo {
    ...
    public Application withCreationTime(java.util.Date creationTime) {
    ...
    public Application withLastUpdateTime(java.util.Date lastUpdateTime) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appregistry.model.transform.ApplicationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
