...
public class ListAssociatedAttributeGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAssociatedAttributeGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAssociatedAttributeGroupsRequest == false)
            return false;
        ListAssociatedAttributeGroupsRequest other = (ListAssociatedAttributeGroupsRequest) obj;
    ...
    @Override
    public ListAssociatedAttributeGroupsRequest clone() {
        return (ListAssociatedAttributeGroupsRequest) super.clone();
    }
