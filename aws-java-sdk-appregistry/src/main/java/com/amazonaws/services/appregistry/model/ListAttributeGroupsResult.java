...
public class ListAttributeGroupsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setAttributeGroups(java.util.Collection<AttributeGroupSummary> attributeGroups) {
        ...
        this.attributeGroups = new java.util.ArrayList<AttributeGroupSummary>(attributeGroups);
    }
    ...
    public ListAttributeGroupsResult withAttributeGroups(AttributeGroupSummary... attributeGroups) {
        if (this.attributeGroups == null) {
            setAttributeGroups(new java.util.ArrayList<AttributeGroupSummary>(attributeGroups.length));
        }
        for (AttributeGroupSummary ele : attributeGroups) {
    ...
    public ListAttributeGroupsResult withAttributeGroups(java.util.Collection<AttributeGroupSummary> attributeGroups) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAttributeGroupsResult == false)
            return false;
        ListAttributeGroupsResult other = (ListAttributeGroupsResult) obj;
    ...
    @Override
    public ListAttributeGroupsResult clone() {
        try {
            return (ListAttributeGroupsResult) super.clone();
