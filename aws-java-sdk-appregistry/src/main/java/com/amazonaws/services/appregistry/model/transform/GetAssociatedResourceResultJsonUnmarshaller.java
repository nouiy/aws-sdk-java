...
/**
 * GetAssociatedResourceResult JSON Unmarshaller
 */
...
public class GetAssociatedResourceResultJsonUnmarshaller implements Unmarshaller<GetAssociatedResourceResult, JsonUnmarshallerContext> {
    ...
    public GetAssociatedResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("resource", targetDepth)) {
                    context.nextToken();
                    getAssociatedResourceResult.setResource(ResourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
