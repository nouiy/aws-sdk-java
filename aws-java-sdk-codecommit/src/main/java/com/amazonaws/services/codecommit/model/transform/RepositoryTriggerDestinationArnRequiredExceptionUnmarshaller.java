...
public class RepositoryTriggerDestinationArnRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryTriggerDestinationArnRequiredExceptionUnmarshaller instance;

    public static RepositoryTriggerDestinationArnRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryTriggerDestinationArnRequiredExceptionUnmarshaller();
        return instance;
    }
}
