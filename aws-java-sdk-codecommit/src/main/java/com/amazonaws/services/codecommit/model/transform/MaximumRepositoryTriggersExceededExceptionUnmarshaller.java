...
public class MaximumRepositoryTriggersExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumRepositoryTriggersExceededExceptionUnmarshaller instance;

    public static MaximumRepositoryTriggersExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumRepositoryTriggersExceededExceptionUnmarshaller();
        return instance;
    }
}
