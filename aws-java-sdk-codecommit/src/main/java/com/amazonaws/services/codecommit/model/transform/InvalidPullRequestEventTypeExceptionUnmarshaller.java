...
public class InvalidPullRequestEventTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidPullRequestEventTypeExceptionUnmarshaller instance;

    public static InvalidPullRequestEventTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidPullRequestEventTypeExceptionUnmarshaller();
        return instance;
    }
}
