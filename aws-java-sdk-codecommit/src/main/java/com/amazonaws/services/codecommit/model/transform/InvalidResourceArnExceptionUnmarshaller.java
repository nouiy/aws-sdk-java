...
public class InvalidResourceArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidResourceArnExceptionUnmarshaller instance;

    public static InvalidResourceArnExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidResourceArnExceptionUnmarshaller();
        return instance;
    }
}
