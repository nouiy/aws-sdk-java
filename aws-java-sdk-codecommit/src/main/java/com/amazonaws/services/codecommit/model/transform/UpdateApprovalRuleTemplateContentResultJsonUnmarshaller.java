...
/**
 * UpdateApprovalRuleTemplateContentResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateApprovalRuleTemplateContentResultJsonUnmarshaller implements Unmarshaller<UpdateApprovalRuleTemplateContentResult, JsonUnmarshallerContext> {

    public UpdateApprovalRuleTemplateContentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("approvalRuleTemplate", targetDepth)) {
                    context.nextToken();
                    updateApprovalRuleTemplateContentResult.setApprovalRuleTemplate(ApprovalRuleTemplateJsonUnmarshaller.getInstance().unmarshall(context));
                }
