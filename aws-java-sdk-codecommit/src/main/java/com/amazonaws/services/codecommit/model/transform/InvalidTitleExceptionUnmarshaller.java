...
public class InvalidTitleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTitleExceptionUnmarshaller instance;

    public static InvalidTitleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTitleExceptionUnmarshaller();
        return instance;
    }
}
