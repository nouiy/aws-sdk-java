...
public class PullRequestAlreadyClosedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PullRequestAlreadyClosedExceptionUnmarshaller instance;

    public static PullRequestAlreadyClosedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PullRequestAlreadyClosedExceptionUnmarshaller();
        return instance;
    }
}
