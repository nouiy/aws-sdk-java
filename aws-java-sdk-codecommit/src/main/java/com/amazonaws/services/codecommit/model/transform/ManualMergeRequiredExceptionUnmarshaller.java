...
public class ManualMergeRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ManualMergeRequiredExceptionUnmarshaller instance;

    public static ManualMergeRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ManualMergeRequiredExceptionUnmarshaller();
        return instance;
    }
}
