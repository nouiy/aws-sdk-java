...
public class AuthorDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AuthorDoesNotExistExceptionUnmarshaller instance;

    public static AuthorDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AuthorDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
