...
public class BranchNameIsTagNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BranchNameIsTagNameExceptionUnmarshaller instance;

    public static BranchNameIsTagNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BranchNameIsTagNameExceptionUnmarshaller();
        return instance;
    }
}
