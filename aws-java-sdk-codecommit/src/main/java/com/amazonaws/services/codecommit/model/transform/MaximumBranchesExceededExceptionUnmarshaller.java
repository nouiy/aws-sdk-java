...
public class MaximumBranchesExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumBranchesExceededExceptionUnmarshaller instance;

    public static MaximumBranchesExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumBranchesExceededExceptionUnmarshaller();
        return instance;
    }
}
