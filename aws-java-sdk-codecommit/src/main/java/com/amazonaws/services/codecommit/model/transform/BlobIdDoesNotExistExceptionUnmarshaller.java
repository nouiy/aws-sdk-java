...
public class BlobIdDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BlobIdDoesNotExistExceptionUnmarshaller instance;

    public static BlobIdDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BlobIdDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
