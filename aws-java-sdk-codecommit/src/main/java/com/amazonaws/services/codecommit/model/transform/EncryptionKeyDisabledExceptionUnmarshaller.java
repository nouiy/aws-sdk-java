...
public class EncryptionKeyDisabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EncryptionKeyDisabledExceptionUnmarshaller instance;

    public static EncryptionKeyDisabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EncryptionKeyDisabledExceptionUnmarshaller();
        return instance;
    }
}
