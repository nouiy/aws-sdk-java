...
public class RepositoryDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryDoesNotExistExceptionUnmarshaller instance;

    public static RepositoryDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
