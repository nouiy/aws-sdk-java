...
/**
 * MergePullRequestByThreeWayRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MergePullRequestByThreeWayRequestMarshaller {
    ...
    private static final MergePullRequestByThreeWayRequestMarshaller instance = new MergePullRequestByThreeWayRequestMarshaller();

    public static MergePullRequestByThreeWayRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MergePullRequestByThreeWayRequest mergePullRequestByThreeWayRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getPullRequestId(), PULLREQUESTID_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getRepositoryName(), REPOSITORYNAME_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getSourceCommitId(), SOURCECOMMITID_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getConflictDetailLevel(), CONFLICTDETAILLEVEL_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getConflictResolutionStrategy(), CONFLICTRESOLUTIONSTRATEGY_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getCommitMessage(), COMMITMESSAGE_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getAuthorName(), AUTHORNAME_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getEmail(), EMAIL_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getKeepEmptyFolders(), KEEPEMPTYFOLDERS_BINDING);
            protocolMarshaller.marshall(mergePullRequestByThreeWayRequest.getConflictResolution(), CONFLICTRESOLUTION_BINDING);
        } catch (Exception e) {
