...
public class SamePathRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SamePathRequestExceptionUnmarshaller instance;

    public static SamePathRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SamePathRequestExceptionUnmarshaller();
        return instance;
    }
}
