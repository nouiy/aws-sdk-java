...
public class CommitMessageLengthExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommitMessageLengthExceededExceptionUnmarshaller instance;

    public static CommitMessageLengthExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommitMessageLengthExceededExceptionUnmarshaller();
        return instance;
    }
}
