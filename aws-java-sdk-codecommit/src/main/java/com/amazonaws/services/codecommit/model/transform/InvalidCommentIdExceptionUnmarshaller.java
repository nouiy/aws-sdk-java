...
public class InvalidCommentIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidCommentIdExceptionUnmarshaller instance;

    public static InvalidCommentIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCommentIdExceptionUnmarshaller();
        return instance;
    }
}
