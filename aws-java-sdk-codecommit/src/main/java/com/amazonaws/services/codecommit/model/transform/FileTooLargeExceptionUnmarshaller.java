...
public class FileTooLargeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FileTooLargeExceptionUnmarshaller instance;

    public static FileTooLargeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileTooLargeExceptionUnmarshaller();
        return instance;
    }
}
