...
public class InvalidFilePositionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidFilePositionExceptionUnmarshaller instance;

    public static InvalidFilePositionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFilePositionExceptionUnmarshaller();
        return instance;
    }
}
