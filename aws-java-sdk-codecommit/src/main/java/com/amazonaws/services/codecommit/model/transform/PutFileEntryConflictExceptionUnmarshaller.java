...
public class PutFileEntryConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PutFileEntryConflictExceptionUnmarshaller instance;

    public static PutFileEntryConflictExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PutFileEntryConflictExceptionUnmarshaller();
        return instance;
    }
}
