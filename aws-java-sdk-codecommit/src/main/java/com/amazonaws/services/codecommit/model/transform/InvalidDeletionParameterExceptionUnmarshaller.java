...
public class InvalidDeletionParameterExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidDeletionParameterExceptionUnmarshaller instance;

    public static InvalidDeletionParameterExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidDeletionParameterExceptionUnmarshaller();
        return instance;
    }
}
