...
public class TipsDivergenceExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TipsDivergenceExceededExceptionUnmarshaller instance;

    public static TipsDivergenceExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TipsDivergenceExceededExceptionUnmarshaller();
        return instance;
    }
}
