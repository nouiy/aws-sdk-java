...
public class EncryptionIntegrityChecksFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EncryptionIntegrityChecksFailedExceptionUnmarshaller instance;

    public static EncryptionIntegrityChecksFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EncryptionIntegrityChecksFailedExceptionUnmarshaller();
        return instance;
    }
}
