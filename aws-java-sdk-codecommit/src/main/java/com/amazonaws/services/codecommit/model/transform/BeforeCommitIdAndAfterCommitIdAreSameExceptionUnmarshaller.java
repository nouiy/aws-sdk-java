...
public class BeforeCommitIdAndAfterCommitIdAreSameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BeforeCommitIdAndAfterCommitIdAreSameExceptionUnmarshaller instance;

    public static BeforeCommitIdAndAfterCommitIdAreSameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BeforeCommitIdAndAfterCommitIdAreSameExceptionUnmarshaller();
        return instance;
    }
}
