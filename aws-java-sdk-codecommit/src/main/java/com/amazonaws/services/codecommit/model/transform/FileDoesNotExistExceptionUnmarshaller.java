...
public class FileDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FileDoesNotExistExceptionUnmarshaller instance;

    public static FileDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
