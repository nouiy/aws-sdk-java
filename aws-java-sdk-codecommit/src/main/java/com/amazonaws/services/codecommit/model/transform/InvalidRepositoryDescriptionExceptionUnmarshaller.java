...
public class InvalidRepositoryDescriptionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRepositoryDescriptionExceptionUnmarshaller instance;

    public static InvalidRepositoryDescriptionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRepositoryDescriptionExceptionUnmarshaller();
        return instance;
    }
}
