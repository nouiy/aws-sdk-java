...
public class InvalidConflictDetailLevelExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidConflictDetailLevelExceptionUnmarshaller instance;

    public static InvalidConflictDetailLevelExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidConflictDetailLevelExceptionUnmarshaller();
        return instance;
    }
}
