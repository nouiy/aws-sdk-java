...
public class InvalidMaxMergeHunksExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidMaxMergeHunksExceptionUnmarshaller instance;

    public static InvalidMaxMergeHunksExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidMaxMergeHunksExceptionUnmarshaller();
        return instance;
    }
}
