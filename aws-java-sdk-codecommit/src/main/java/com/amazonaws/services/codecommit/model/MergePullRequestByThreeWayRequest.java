...
public class MergePullRequestByThreeWayRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public MergePullRequestByThreeWayRequest withConflictDetailLevel(ConflictDetailLevelTypeEnum conflictDetailLevel) {
    ...
    public MergePullRequestByThreeWayRequest withConflictResolutionStrategy(String conflictResolutionStrategy) {
    ...
    public MergePullRequestByThreeWayRequest withConflictResolutionStrategy(ConflictResolutionStrategyTypeEnum conflictResolutionStrategy) {
    ...
    @Override
    public MergePullRequestByThreeWayRequest clone() {
        return (MergePullRequestByThreeWayRequest) super.clone();
    }
