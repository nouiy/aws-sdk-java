...
public class InvalidSystemTagUsageExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSystemTagUsageExceptionUnmarshaller instance;

    public static InvalidSystemTagUsageExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSystemTagUsageExceptionUnmarshaller();
        return instance;
    }
}
