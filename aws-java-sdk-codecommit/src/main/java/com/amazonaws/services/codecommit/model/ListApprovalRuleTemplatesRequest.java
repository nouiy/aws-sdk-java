...
public class ListApprovalRuleTemplatesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListApprovalRuleTemplatesRequest clone() {
        return (ListApprovalRuleTemplatesRequest) super.clone();
    }
