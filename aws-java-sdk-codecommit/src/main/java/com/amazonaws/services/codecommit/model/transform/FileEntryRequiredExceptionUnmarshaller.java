...
public class FileEntryRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FileEntryRequiredExceptionUnmarshaller instance;

    public static FileEntryRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileEntryRequiredExceptionUnmarshaller();
        return instance;
    }
}
