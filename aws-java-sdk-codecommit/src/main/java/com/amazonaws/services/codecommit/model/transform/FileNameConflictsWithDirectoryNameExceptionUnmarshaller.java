...
public class FileNameConflictsWithDirectoryNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FileNameConflictsWithDirectoryNameExceptionUnmarshaller instance;

    public static FileNameConflictsWithDirectoryNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileNameConflictsWithDirectoryNameExceptionUnmarshaller();
        return instance;
    }
}
