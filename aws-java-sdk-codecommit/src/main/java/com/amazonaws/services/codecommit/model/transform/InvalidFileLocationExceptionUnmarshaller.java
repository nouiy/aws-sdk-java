...
public class InvalidFileLocationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidFileLocationExceptionUnmarshaller instance;

    public static InvalidFileLocationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFileLocationExceptionUnmarshaller();
        return instance;
    }
}
