...
public class CreatePullRequestResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePullRequestResult == false)
            return false;
        CreatePullRequestResult other = (CreatePullRequestResult) obj;
    ...
    public CreatePullRequestResult clone() {
        try {
            return (CreatePullRequestResult) super.clone();
