...
public class GetApprovalRuleTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The content and structure of the approval rule template.
     */
    ...
    public GetApprovalRuleTemplateResult withApprovalRuleTemplate(ApprovalRuleTemplate approvalRuleTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetApprovalRuleTemplateResult == false)
            return false;
        GetApprovalRuleTemplateResult other = (GetApprovalRuleTemplateResult) obj;
    ...
    @Override
    public GetApprovalRuleTemplateResult clone() {
        try {
            return (GetApprovalRuleTemplateResult) super.clone();
