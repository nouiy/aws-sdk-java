...
public class BranchDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BranchDoesNotExistExceptionUnmarshaller instance;

    public static BranchDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BranchDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
