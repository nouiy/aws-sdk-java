...
public class InvalidSourceCommitSpecifierExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSourceCommitSpecifierExceptionUnmarshaller instance;

    public static InvalidSourceCommitSpecifierExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSourceCommitSpecifierExceptionUnmarshaller();
        return instance;
    }
}
