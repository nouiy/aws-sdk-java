...
public class BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest withRepositoryNames(java.util.Collection<String> repositoryNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest == false)
            return false;
    ...
    public BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest clone() {
        return (BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest) super.clone();
    }
