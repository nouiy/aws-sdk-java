...
public class DeletePullRequestApprovalRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public String toString() {
        ...
        if (getApprovalRuleId() != null)
            sb.append("ApprovalRuleId: ").append(getApprovalRuleId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public DeletePullRequestApprovalRuleResult clone() {
        try {
            return (DeletePullRequestApprovalRuleResult) super.clone();
