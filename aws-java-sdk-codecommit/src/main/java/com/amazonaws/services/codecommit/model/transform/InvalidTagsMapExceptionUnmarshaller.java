...
public class InvalidTagsMapExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTagsMapExceptionUnmarshaller instance;

    public static InvalidTagsMapExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTagsMapExceptionUnmarshaller();
        return instance;
    }
}
