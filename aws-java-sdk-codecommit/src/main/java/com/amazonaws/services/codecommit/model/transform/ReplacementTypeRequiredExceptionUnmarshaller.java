...
public class ReplacementTypeRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ReplacementTypeRequiredExceptionUnmarshaller instance;

    public static ReplacementTypeRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReplacementTypeRequiredExceptionUnmarshaller();
        return instance;
    }
}
