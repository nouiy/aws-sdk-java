...
/**
 * DeleteFileEntryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteFileEntryMarshaller {
    ...
    private static final DeleteFileEntryMarshaller instance = new DeleteFileEntryMarshaller();

    public static DeleteFileEntryMarshaller getInstance() {
        return instance;
    }
