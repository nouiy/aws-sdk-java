...
public class RestrictedSourceFileExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RestrictedSourceFileExceptionUnmarshaller instance;

    public static RestrictedSourceFileExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RestrictedSourceFileExceptionUnmarshaller();
        return instance;
    }
}
