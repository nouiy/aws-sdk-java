...
public class RepositoryNameRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryNameRequiredExceptionUnmarshaller instance;

    public static RepositoryNameRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryNameRequiredExceptionUnmarshaller();
        return instance;
    }
}
