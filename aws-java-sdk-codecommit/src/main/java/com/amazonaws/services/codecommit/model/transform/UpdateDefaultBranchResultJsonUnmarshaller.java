...
public class UpdateDefaultBranchResultJsonUnmarshaller implements Unmarshaller<UpdateDefaultBranchResult, JsonUnmarshallerContext> {
    ...
    public UpdateDefaultBranchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDefaultBranchResult updateDefaultBranchResult = new UpdateDefaultBranchResult();
