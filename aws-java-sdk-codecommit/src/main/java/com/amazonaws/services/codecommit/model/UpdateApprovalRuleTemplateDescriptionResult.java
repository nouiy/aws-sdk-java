...
public class UpdateApprovalRuleTemplateDescriptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateApprovalRuleTemplateDescriptionResult withApprovalRuleTemplate(ApprovalRuleTemplate approvalRuleTemplate) {
    ...
    @Override
    public UpdateApprovalRuleTemplateDescriptionResult clone() {
        try {
            return (UpdateApprovalRuleTemplateDescriptionResult) super.clone();
