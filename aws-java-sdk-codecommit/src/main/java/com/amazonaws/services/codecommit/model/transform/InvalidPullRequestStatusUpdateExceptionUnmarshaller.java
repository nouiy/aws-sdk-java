...
public class InvalidPullRequestStatusUpdateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidPullRequestStatusUpdateExceptionUnmarshaller instance;

    public static InvalidPullRequestStatusUpdateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidPullRequestStatusUpdateExceptionUnmarshaller();
        return instance;
    }
}
