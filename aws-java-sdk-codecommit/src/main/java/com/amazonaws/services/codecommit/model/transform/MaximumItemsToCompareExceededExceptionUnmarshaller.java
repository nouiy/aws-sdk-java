...
public class MaximumItemsToCompareExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaximumItemsToCompareExceededExceptionUnmarshaller instance;

    public static MaximumItemsToCompareExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaximumItemsToCompareExceededExceptionUnmarshaller();
        return instance;
    }
}
