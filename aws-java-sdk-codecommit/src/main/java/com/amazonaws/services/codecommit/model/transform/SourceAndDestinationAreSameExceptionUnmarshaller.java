...
public class SourceAndDestinationAreSameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SourceAndDestinationAreSameExceptionUnmarshaller instance;

    public static SourceAndDestinationAreSameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SourceAndDestinationAreSameExceptionUnmarshaller();
        return instance;
    }
}
