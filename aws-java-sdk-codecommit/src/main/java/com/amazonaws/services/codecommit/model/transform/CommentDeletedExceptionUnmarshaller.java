...
public class CommentDeletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommentDeletedExceptionUnmarshaller instance;

    public static CommentDeletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommentDeletedExceptionUnmarshaller();
        return instance;
    }
}
