...
/**
 * MergeBranchesBySquashRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MergeBranchesBySquashRequestMarshaller {
    ...
    private static final MergeBranchesBySquashRequestMarshaller instance = new MergeBranchesBySquashRequestMarshaller();

    public static MergeBranchesBySquashRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MergeBranchesBySquashRequest mergeBranchesBySquashRequest, ProtocolMarshaller protocolMarshaller) {

        if (mergeBranchesBySquashRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getRepositoryName(), REPOSITORYNAME_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getSourceCommitSpecifier(), SOURCECOMMITSPECIFIER_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getDestinationCommitSpecifier(), DESTINATIONCOMMITSPECIFIER_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getTargetBranch(), TARGETBRANCH_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getConflictDetailLevel(), CONFLICTDETAILLEVEL_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getConflictResolutionStrategy(), CONFLICTRESOLUTIONSTRATEGY_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getAuthorName(), AUTHORNAME_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getEmail(), EMAIL_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getCommitMessage(), COMMITMESSAGE_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getKeepEmptyFolders(), KEEPEMPTYFOLDERS_BINDING);
            protocolMarshaller.marshall(mergeBranchesBySquashRequest.getConflictResolution(), CONFLICTRESOLUTION_BINDING);
        } catch (Exception e) {
