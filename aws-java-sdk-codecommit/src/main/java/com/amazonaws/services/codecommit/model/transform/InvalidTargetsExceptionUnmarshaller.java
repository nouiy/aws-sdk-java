...
public class InvalidTargetsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTargetsExceptionUnmarshaller instance;

    public static InvalidTargetsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTargetsExceptionUnmarshaller();
        return instance;
    }
}
