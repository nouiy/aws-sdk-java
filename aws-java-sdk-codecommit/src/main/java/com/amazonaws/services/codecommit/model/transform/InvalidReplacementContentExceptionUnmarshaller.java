...
public class InvalidReplacementContentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidReplacementContentExceptionUnmarshaller instance;

    public static InvalidReplacementContentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidReplacementContentExceptionUnmarshaller();
        return instance;
    }
}
