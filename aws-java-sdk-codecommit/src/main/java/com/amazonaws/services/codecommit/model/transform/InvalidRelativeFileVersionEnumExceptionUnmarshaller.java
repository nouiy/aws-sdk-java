...
public class InvalidRelativeFileVersionEnumExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRelativeFileVersionEnumExceptionUnmarshaller instance;

    public static InvalidRelativeFileVersionEnumExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRelativeFileVersionEnumExceptionUnmarshaller();
        return instance;
    }
}
