...
public class InvalidCommitIdExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidCommitIdExceptionUnmarshaller instance;

    public static InvalidCommitIdExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCommitIdExceptionUnmarshaller();
        return instance;
    }
}
