...
public class CommentContentRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommentContentRequiredExceptionUnmarshaller instance;

    public static CommentContentRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommentContentRequiredExceptionUnmarshaller();
        return instance;
    }
}
