...
public class CommitIdsLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommitIdsLimitExceededExceptionUnmarshaller instance;

    public static CommitIdsLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommitIdsLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
