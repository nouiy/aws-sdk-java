...
public class BranchNameExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BranchNameExistsExceptionUnmarshaller instance;

    public static BranchNameExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BranchNameExistsExceptionUnmarshaller();
        return instance;
    }
}
