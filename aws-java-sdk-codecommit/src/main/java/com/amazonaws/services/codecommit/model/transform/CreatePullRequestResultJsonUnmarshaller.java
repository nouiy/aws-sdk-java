...
/**
 * CreatePullRequestResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreatePullRequestResultJsonUnmarshaller implements Unmarshaller<CreatePullRequestResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pullRequest", targetDepth)) {
                    context.nextToken();
                    createPullRequestResult.setPullRequest(PullRequestJsonUnmarshaller.getInstance().unmarshall(context));
                }
