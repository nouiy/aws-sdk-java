...
/**
 * BatchAssociateApprovalRuleTemplateWithRepositoriesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchAssociateApprovalRuleTemplateWithRepositoriesResultJsonUnmarshaller implements
        Unmarshaller<BatchAssociateApprovalRuleTemplateWithRepositoriesResult, JsonUnmarshallerContext> {

    public BatchAssociateApprovalRuleTemplateWithRepositoriesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("associatedRepositoryNames", targetDepth)) {
                    context.nextToken();
                    batchAssociateApprovalRuleTemplateWithRepositoriesResult.setAssociatedRepositoryNames(new ListUnmarshaller<String>(context
                ...
                if (context.testExpression("errors", targetDepth)) {
                    ...
                    batchAssociateApprovalRuleTemplateWithRepositoriesResult
                            .setErrors(new ListUnmarshaller<BatchAssociateApprovalRuleTemplateWithRepositoriesError>(
                                    BatchAssociateApprovalRuleTemplateWithRepositoriesErrorJsonUnmarshaller.getInstance())
