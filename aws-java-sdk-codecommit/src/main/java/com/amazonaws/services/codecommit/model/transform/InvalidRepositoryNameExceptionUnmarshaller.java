...
public class InvalidRepositoryNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRepositoryNameExceptionUnmarshaller instance;

    public static InvalidRepositoryNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRepositoryNameExceptionUnmarshaller();
        return instance;
    }
}
