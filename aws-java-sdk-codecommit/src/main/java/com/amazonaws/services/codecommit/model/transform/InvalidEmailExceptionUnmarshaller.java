...
public class InvalidEmailExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidEmailExceptionUnmarshaller instance;

    public static InvalidEmailExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidEmailExceptionUnmarshaller();
        return instance;
    }
}
