...
public final class AWSCodeCommitClientBuilder extends AwsSyncClientBuilder<AWSCodeCommitClientBuilder, AWSCodeCommit> {
     ...
     */
    public static AWSCodeCommitClientBuilder standard() {
        return new AWSCodeCommitClientBuilder();
    }
     ...
     */
    public static AWSCodeCommit defaultClient() {
        return standard().build();
    }

    private AWSCodeCommitClientBuilder() {
     ...
     * @return Fully configured implementation of AWSCodeCommit.
     */
    @Override
    protected AWSCodeCommit build(AwsSyncClientParams params) {
