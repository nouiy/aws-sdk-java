...
public class CommitDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CommitDoesNotExistExceptionUnmarshaller instance;

    public static CommitDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CommitDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
