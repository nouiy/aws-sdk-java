...
public class RepositoryTriggerBranchNameListRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RepositoryTriggerBranchNameListRequiredExceptionUnmarshaller instance;

    public static RepositoryTriggerBranchNameListRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryTriggerBranchNameListRequiredExceptionUnmarshaller();
        return instance;
    }
}
