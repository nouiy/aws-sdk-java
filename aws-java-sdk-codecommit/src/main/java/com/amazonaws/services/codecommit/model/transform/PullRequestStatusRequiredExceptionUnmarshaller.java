...
public class PullRequestStatusRequiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PullRequestStatusRequiredExceptionUnmarshaller instance;

    public static PullRequestStatusRequiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PullRequestStatusRequiredExceptionUnmarshaller();
        return instance;
    }
}
