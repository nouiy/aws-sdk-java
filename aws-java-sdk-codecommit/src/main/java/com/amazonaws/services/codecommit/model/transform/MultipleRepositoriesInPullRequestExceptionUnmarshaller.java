...
public class MultipleRepositoriesInPullRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MultipleRepositoriesInPullRequestExceptionUnmarshaller instance;

    public static MultipleRepositoriesInPullRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MultipleRepositoriesInPullRequestExceptionUnmarshaller();
        return instance;
    }
}
