...
/**
 * ListAssociatedApprovalRuleTemplatesForRepositoryResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAssociatedApprovalRuleTemplatesForRepositoryResultJsonUnmarshaller implements
        Unmarshaller<ListAssociatedApprovalRuleTemplatesForRepositoryResult, JsonUnmarshallerContext> {

    public ListAssociatedApprovalRuleTemplatesForRepositoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listAssociatedApprovalRuleTemplatesForRepositoryResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
