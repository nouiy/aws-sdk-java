...
public class MultipleConflictResolutionEntriesExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MultipleConflictResolutionEntriesExceptionUnmarshaller instance;

    public static MultipleConflictResolutionEntriesExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MultipleConflictResolutionEntriesExceptionUnmarshaller();
        return instance;
    }
}
