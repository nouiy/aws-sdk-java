...
public class InvalidRepositoryTriggerEventsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidRepositoryTriggerEventsExceptionUnmarshaller instance;

    public static InvalidRepositoryTriggerEventsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidRepositoryTriggerEventsExceptionUnmarshaller();
        return instance;
    }
}
