...
public class InvalidTargetBranchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTargetBranchExceptionUnmarshaller instance;

    public static InvalidTargetBranchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTargetBranchExceptionUnmarshaller();
        return instance;
    }
}
