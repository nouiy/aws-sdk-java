...
public class ActorDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ActorDoesNotExistExceptionUnmarshaller instance;

    public static ActorDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActorDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
