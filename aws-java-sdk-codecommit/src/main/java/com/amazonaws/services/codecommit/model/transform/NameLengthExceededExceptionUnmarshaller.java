...
public class NameLengthExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NameLengthExceededExceptionUnmarshaller instance;

    public static NameLengthExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NameLengthExceededExceptionUnmarshaller();
        return instance;
    }
}
