...
public class MergePullRequestBySquashResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public MergePullRequestBySquashResult clone() {
        try {
            return (MergePullRequestBySquashResult) super.clone();
