...
/**
 * PullRequestCreatedEventMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PullRequestCreatedEventMetadataJsonUnmarshaller implements Unmarshaller<PullRequestCreatedEventMetadata, JsonUnmarshallerContext> {

    public PullRequestCreatedEventMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        PullRequestCreatedEventMetadata pullRequestCreatedEventMetadata = new PullRequestCreatedEventMetadata();
    ...
    private static PullRequestCreatedEventMetadataJsonUnmarshaller instance;

    public static PullRequestCreatedEventMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PullRequestCreatedEventMetadataJsonUnmarshaller();
        return instance;
    }
}
