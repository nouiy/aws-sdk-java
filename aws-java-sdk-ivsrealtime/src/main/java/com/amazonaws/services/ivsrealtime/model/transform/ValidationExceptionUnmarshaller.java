...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.ivsrealtime.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.ivsrealtime.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ivsrealtime.model.ValidationException validationException = new com.amazonaws.services.ivsrealtime.model.ValidationException(
                null);
