...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.ivsrealtime.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.ivsrealtime.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ivsrealtime.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.ivsrealtime.model.AccessDeniedException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("exceptionMessage", targetDepth)) {
                    context.nextToken();
                    accessDeniedException.setExceptionMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
