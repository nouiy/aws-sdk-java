...
/**
 * CompositionSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CompositionSummaryJsonUnmarshaller implements Unmarshaller<CompositionSummary, JsonUnmarshallerContext> {

    public CompositionSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        CompositionSummary compositionSummary = new CompositionSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("state", targetDepth)) {
                    context.nextToken();
                    compositionSummary.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static CompositionSummaryJsonUnmarshaller instance;

    public static CompositionSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CompositionSummaryJsonUnmarshaller();
        return instance;
    }
}
