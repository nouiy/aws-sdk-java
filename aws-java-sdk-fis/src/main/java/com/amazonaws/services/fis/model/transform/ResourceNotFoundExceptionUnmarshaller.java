...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.fis.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.fis.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.fis.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.fis.model.ResourceNotFoundException(
                null);
