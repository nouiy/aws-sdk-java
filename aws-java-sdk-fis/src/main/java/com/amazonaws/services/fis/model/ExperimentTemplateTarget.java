...
public class ExperimentTemplateTarget implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see ExperimentTemplateTarget#withParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ExperimentTemplateTarget addParametersEntry(String key, String value) {
    ...
    public ExperimentTemplateTarget clearParametersEntries() {
