...
public class UpdateExperimentTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateExperimentTemplateResult withExperimentTemplate(ExperimentTemplate experimentTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateExperimentTemplateResult == false)
            return false;
        UpdateExperimentTemplateResult other = (UpdateExperimentTemplateResult) obj;
    ...
    @Override
    public UpdateExperimentTemplateResult clone() {
        try {
            return (UpdateExperimentTemplateResult) super.clone();
