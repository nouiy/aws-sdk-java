...
public class TargetResourceTypeMarshaller {
    ...
    public void marshall(TargetResourceType targetResourceType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(targetResourceType.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(targetResourceType.getDescription(), DESCRIPTION_BINDING);
