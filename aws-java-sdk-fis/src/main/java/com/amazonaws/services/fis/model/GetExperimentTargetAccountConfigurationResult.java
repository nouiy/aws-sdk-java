...
public class GetExperimentTargetAccountConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public void setTargetAccountConfiguration(ExperimentTargetAccountConfiguration targetAccountConfiguration) {
    ...
    public GetExperimentTargetAccountConfigurationResult withTargetAccountConfiguration(ExperimentTargetAccountConfiguration targetAccountConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetExperimentTargetAccountConfigurationResult == false)
            return false;
        GetExperimentTargetAccountConfigurationResult other = (GetExperimentTargetAccountConfigurationResult) obj;
    ...
    @Override
    public GetExperimentTargetAccountConfigurationResult clone() {
        try {
