...
/**
 * CorsRule JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CorsRuleJsonUnmarshaller implements Unmarshaller<CorsRule, JsonUnmarshallerContext> {

    public CorsRule unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("MaxAgeSeconds", targetDepth)) {
                    context.nextToken();
                    corsRule.setMaxAgeSeconds(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
    ...
    private static CorsRuleJsonUnmarshaller instance;

    public static CorsRuleJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CorsRuleJsonUnmarshaller();
        return instance;
    }
}
