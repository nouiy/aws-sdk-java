...
public class DeleteContainerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteContainerRequest withContainerName(String containerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteContainerRequest == false)
            return false;
        DeleteContainerRequest other = (DeleteContainerRequest) obj;
    ...
    public DeleteContainerRequest clone() {
        return (DeleteContainerRequest) super.clone();
    }
