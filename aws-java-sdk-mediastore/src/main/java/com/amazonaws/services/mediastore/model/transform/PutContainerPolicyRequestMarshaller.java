...
/**
 * PutContainerPolicyRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutContainerPolicyRequestMarshaller {
    ...
    private static final PutContainerPolicyRequestMarshaller instance = new PutContainerPolicyRequestMarshaller();

    public static PutContainerPolicyRequestMarshaller getInstance() {
        return instance;
    }
