...
/**
 * DeleteMetricPolicyResult JSON Unmarshaller
 */
...
public class DeleteMetricPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteMetricPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteMetricPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMetricPolicyResult deleteMetricPolicyResult = new DeleteMetricPolicyResult();
