...
/**
 * StopAccessLoggingRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StopAccessLoggingRequestMarshaller {
    ...
    private static final StopAccessLoggingRequestMarshaller instance = new StopAccessLoggingRequestMarshaller();

    public static StopAccessLoggingRequestMarshaller getInstance() {
        return instance;
    }
