...
/**
 * StopAccessLoggingResult JSON Unmarshaller
 */
...
public class StopAccessLoggingResultJsonUnmarshaller implements Unmarshaller<StopAccessLoggingResult, JsonUnmarshallerContext> {
    ...
    public StopAccessLoggingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopAccessLoggingResult stopAccessLoggingResult = new StopAccessLoggingResult();
