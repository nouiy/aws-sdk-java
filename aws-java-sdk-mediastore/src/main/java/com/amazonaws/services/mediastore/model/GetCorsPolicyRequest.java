...
public class GetCorsPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCorsPolicyRequest withContainerName(String containerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCorsPolicyRequest == false)
            return false;
        GetCorsPolicyRequest other = (GetCorsPolicyRequest) obj;
    ...
    @Override
    public GetCorsPolicyRequest clone() {
        return (GetCorsPolicyRequest) super.clone();
    }
