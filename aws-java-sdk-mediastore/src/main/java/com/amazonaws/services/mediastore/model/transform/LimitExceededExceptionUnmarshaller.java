...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.mediastore.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.mediastore.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mediastore.model.LimitExceededException limitExceededException = new com.amazonaws.services.mediastore.model.LimitExceededException(
                null);
