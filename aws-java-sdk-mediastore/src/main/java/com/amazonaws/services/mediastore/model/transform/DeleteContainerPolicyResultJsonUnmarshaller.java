...
/**
 * DeleteContainerPolicyResult JSON Unmarshaller
 */
...
public class DeleteContainerPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteContainerPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteContainerPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContainerPolicyResult deleteContainerPolicyResult = new DeleteContainerPolicyResult();
