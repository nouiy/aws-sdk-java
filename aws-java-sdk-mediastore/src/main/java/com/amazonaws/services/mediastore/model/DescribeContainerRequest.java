...
public class DescribeContainerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeContainerRequest withContainerName(String containerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeContainerRequest == false)
            return false;
        DescribeContainerRequest other = (DescribeContainerRequest) obj;
    ...
    @Override
    public DescribeContainerRequest clone() {
        return (DescribeContainerRequest) super.clone();
    }
