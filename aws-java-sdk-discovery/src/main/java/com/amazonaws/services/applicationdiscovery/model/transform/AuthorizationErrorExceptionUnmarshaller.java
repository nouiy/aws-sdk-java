...
public class AuthorizationErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AuthorizationErrorExceptionUnmarshaller instance;

    public static AuthorizationErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AuthorizationErrorExceptionUnmarshaller();
        return instance;
    }
}
