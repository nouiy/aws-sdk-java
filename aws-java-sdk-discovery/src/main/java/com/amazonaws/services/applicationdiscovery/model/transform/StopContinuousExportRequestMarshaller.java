...
/**
 * StopContinuousExportRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class StopContinuousExportRequestMarshaller {
    ...
    private static final StopContinuousExportRequestMarshaller instance = new StopContinuousExportRequestMarshaller();

    public static StopContinuousExportRequestMarshaller getInstance() {
        return instance;
    }
