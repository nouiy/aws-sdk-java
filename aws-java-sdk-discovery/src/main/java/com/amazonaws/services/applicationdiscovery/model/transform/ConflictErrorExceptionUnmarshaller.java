...
public class ConflictErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ConflictErrorExceptionUnmarshaller instance;

    public static ConflictErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConflictErrorExceptionUnmarshaller();
        return instance;
    }
}
