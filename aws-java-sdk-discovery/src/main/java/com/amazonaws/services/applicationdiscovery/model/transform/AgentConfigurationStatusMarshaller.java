...
public class AgentConfigurationStatusMarshaller {
    ...
    private static final MarshallingInfo<Boolean> OPERATIONSUCCEEDED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("operationSucceeded").build();
    ...
    public void marshall(AgentConfigurationStatus agentConfigurationStatus, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(agentConfigurationStatus.getAgentId(), AGENTID_BINDING);
            protocolMarshaller.marshall(agentConfigurationStatus.getOperationSucceeded(), OPERATIONSUCCEEDED_BINDING);
            protocolMarshaller.marshall(agentConfigurationStatus.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
