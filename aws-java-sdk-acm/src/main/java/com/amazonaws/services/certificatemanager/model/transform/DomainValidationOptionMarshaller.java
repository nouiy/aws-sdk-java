...
/**
 * DomainValidationOptionMarshaller
 */
...
public class DomainValidationOptionMarshaller {
    ...
    public void marshall(DomainValidationOption domainValidationOption, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(domainValidationOption.getDomainName(), DOMAINNAME_BINDING);
            protocolMarshaller.marshall(domainValidationOption.getValidationDomain(), VALIDATIONDOMAIN_BINDING);
        } catch (Exception e) {
