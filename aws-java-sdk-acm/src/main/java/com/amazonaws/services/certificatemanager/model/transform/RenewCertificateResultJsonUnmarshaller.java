...
/**
 * RenewCertificateResult JSON Unmarshaller
 */
...
public class RenewCertificateResultJsonUnmarshaller implements Unmarshaller<RenewCertificateResult, JsonUnmarshallerContext> {
    ...
    public RenewCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RenewCertificateResult renewCertificateResult = new RenewCertificateResult();
