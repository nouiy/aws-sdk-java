...
/**
 * ListTagsForCertificateRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListTagsForCertificateRequestMarshaller {

    private static final MarshallingInfo<String> CERTIFICATEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CertificateArn").build();

    private static final ListTagsForCertificateRequestMarshaller instance = new ListTagsForCertificateRequestMarshaller();

    public static ListTagsForCertificateRequestMarshaller getInstance() {
        return instance;
    }
