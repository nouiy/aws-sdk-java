...
public class DomainValidationOptionJsonUnmarshaller implements Unmarshaller<DomainValidationOption, JsonUnmarshallerContext> {
    ...
    private static DomainValidationOptionJsonUnmarshaller instance;

    public static DomainValidationOptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainValidationOptionJsonUnmarshaller();
        return instance;
    }
}
