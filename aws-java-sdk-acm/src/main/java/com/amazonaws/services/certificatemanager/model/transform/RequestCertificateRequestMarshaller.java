...
public class RequestCertificateRequestMarshaller {
    ...
    public void marshall(RequestCertificateRequest requestCertificateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(requestCertificateRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(requestCertificateRequest.getKeyAlgorithm(), KEYALGORITHM_BINDING);
        } catch (Exception e) {
