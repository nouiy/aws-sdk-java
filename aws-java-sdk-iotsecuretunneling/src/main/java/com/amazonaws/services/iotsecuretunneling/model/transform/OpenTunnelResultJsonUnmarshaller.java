...
/**
 * OpenTunnelResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenTunnelResultJsonUnmarshaller implements Unmarshaller<OpenTunnelResult, JsonUnmarshallerContext> {

    public OpenTunnelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        OpenTunnelResult openTunnelResult = new OpenTunnelResult();
    ...
    private static OpenTunnelResultJsonUnmarshaller instance;

    public static OpenTunnelResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpenTunnelResultJsonUnmarshaller();
        return instance;
    }
}
