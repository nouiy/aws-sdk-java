...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.iotsecuretunneling.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.iotsecuretunneling.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotsecuretunneling.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.iotsecuretunneling.model.ResourceNotFoundException(
                null);
