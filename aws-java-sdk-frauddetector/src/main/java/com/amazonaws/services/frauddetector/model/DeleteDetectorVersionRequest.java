...
public class DeleteDetectorVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteDetectorVersionRequest withDetectorId(String detectorId) {
    ...
    public DeleteDetectorVersionRequest withDetectorVersionId(String detectorVersionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDetectorVersionRequest == false)
            return false;
    ...
    @Override
    public DeleteDetectorVersionRequest clone() {
        return (DeleteDetectorVersionRequest) super.clone();
    }
