 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/frauddetector-2019-11-15/OFIModelPerformance" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OFIModelPerformance implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Indicates the range of area under curve (auc) expected from the OFI model. A range greater than 0.1 indicates
     ...
     * </p>
     * 
     * @return Indicates the range of area under curve (auc) expected from the OFI model. A range greater than 0.1
     *         indicates higher model uncertainity.
     */
    ...
    public OFIModelPerformance withUncertaintyRange(UncertaintyRange uncertaintyRange) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OFIModelPerformance == false)
            return false;
        OFIModelPerformance other = (OFIModelPerformance) obj;
    ...
    public OFIModelPerformance clone() {
        try {
            return (OFIModelPerformance) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.frauddetector.model.transform.OFIModelPerformanceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
