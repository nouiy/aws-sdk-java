...
/**
 * OFIModelPerformanceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OFIModelPerformanceMarshaller {
    ...
    public static OFIModelPerformanceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OFIModelPerformance oFIModelPerformance, ProtocolMarshaller protocolMarshaller) {

        if (oFIModelPerformance == null) {
