...
/**
 * GetEventPredictionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetEventPredictionResultJsonUnmarshaller implements Unmarshaller<GetEventPredictionResult, JsonUnmarshallerContext> {

    public GetEventPredictionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetEventPredictionResult getEventPredictionResult = new GetEventPredictionResult();
    ...
    private static GetEventPredictionResultJsonUnmarshaller instance;

    public static GetEventPredictionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetEventPredictionResultJsonUnmarshaller();
        return instance;
    }
}
