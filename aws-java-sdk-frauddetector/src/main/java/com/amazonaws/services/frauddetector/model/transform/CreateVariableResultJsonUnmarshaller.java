...
/**
 * CreateVariableResult JSON Unmarshaller
 */
...
public class CreateVariableResultJsonUnmarshaller implements Unmarshaller<CreateVariableResult, JsonUnmarshallerContext> {
    ...
    public CreateVariableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateVariableResult createVariableResult = new CreateVariableResult();
