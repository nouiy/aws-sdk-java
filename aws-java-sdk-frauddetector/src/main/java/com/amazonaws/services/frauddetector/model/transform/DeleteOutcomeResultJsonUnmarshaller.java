...
/**
 * DeleteOutcomeResult JSON Unmarshaller
 */
...
public class DeleteOutcomeResultJsonUnmarshaller implements Unmarshaller<DeleteOutcomeResult, JsonUnmarshallerContext> {
    ...
    public DeleteOutcomeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteOutcomeResult deleteOutcomeResult = new DeleteOutcomeResult();
