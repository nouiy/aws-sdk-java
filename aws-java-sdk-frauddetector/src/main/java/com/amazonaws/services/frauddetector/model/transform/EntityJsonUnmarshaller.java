        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("entityType", targetDepth)) {
                    context.nextToken();
                    entity.setEntityType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("entityId", targetDepth)) {
                    context.nextToken();
                    entity.setEntityId(context.getUnmarshaller(String.class).unmarshall(context));
                }
