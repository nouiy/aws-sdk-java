...
/**
 * DeleteBatchImportJobResult JSON Unmarshaller
 */
...
public class DeleteBatchImportJobResultJsonUnmarshaller implements Unmarshaller<DeleteBatchImportJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteBatchImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBatchImportJobResult deleteBatchImportJobResult = new DeleteBatchImportJobResult();
