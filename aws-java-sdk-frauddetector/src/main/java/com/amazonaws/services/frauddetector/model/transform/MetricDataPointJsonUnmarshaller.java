        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fpr", targetDepth)) {
                    context.nextToken();
                    metricDataPoint.setFpr(context.getUnmarshaller(Float.class).unmarshall(context));
                }
                if (context.testExpression("precision", targetDepth)) {
                    context.nextToken();
                    metricDataPoint.setPrecision(context.getUnmarshaller(Float.class).unmarshall(context));
                }
                if (context.testExpression("tpr", targetDepth)) {
                    context.nextToken();
                    metricDataPoint.setTpr(context.getUnmarshaller(Float.class).unmarshall(context));
                }
                if (context.testExpression("threshold", targetDepth)) {
                    context.nextToken();
                    metricDataPoint.setThreshold(context.getUnmarshaller(Float.class).unmarshall(context));
                }
