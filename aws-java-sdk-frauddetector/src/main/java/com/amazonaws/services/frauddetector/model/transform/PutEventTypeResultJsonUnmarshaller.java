...
/**
 * PutEventTypeResult JSON Unmarshaller
 */
...
public class PutEventTypeResultJsonUnmarshaller implements Unmarshaller<PutEventTypeResult, JsonUnmarshallerContext> {
    ...
    public PutEventTypeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutEventTypeResult putEventTypeResult = new PutEventTypeResult();
