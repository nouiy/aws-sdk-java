...
/**
 * LabelSchema JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LabelSchemaJsonUnmarshaller implements Unmarshaller<LabelSchema, JsonUnmarshallerContext> {

    public LabelSchema unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static LabelSchemaJsonUnmarshaller instance;

    public static LabelSchemaJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LabelSchemaJsonUnmarshaller();
        return instance;
    }
}
