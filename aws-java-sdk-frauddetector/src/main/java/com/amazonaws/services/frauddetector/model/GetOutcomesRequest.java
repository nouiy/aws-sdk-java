...
public class GetOutcomesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the outcome or outcomes to get.
     */
    ...
    @Override
    public GetOutcomesRequest clone() {
        return (GetOutcomesRequest) super.clone();
    }
