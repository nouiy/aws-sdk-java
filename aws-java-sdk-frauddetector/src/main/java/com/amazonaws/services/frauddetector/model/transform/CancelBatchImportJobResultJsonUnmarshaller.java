...
/**
 * CancelBatchImportJobResult JSON Unmarshaller
 */
...
public class CancelBatchImportJobResultJsonUnmarshaller implements Unmarshaller<CancelBatchImportJobResult, JsonUnmarshallerContext> {
    ...
    public CancelBatchImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelBatchImportJobResult cancelBatchImportJobResult = new CancelBatchImportJobResult();
