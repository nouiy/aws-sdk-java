...
/**
 * CreateBatchPredictionJobResult JSON Unmarshaller
 */
...
public class CreateBatchPredictionJobResultJsonUnmarshaller implements Unmarshaller<CreateBatchPredictionJobResult, JsonUnmarshallerContext> {
    ...
    public CreateBatchPredictionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateBatchPredictionJobResult createBatchPredictionJobResult = new CreateBatchPredictionJobResult();
