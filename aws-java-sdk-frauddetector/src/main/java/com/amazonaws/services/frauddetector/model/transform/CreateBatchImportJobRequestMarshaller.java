...
public class CreateBatchImportJobRequestMarshaller {
    ...
    private static final CreateBatchImportJobRequestMarshaller instance = new CreateBatchImportJobRequestMarshaller();

    public static CreateBatchImportJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateBatchImportJobRequest createBatchImportJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBatchImportJobRequest.getJobId(), JOBID_BINDING);
            protocolMarshaller.marshall(createBatchImportJobRequest.getInputPath(), INPUTPATH_BINDING);
            protocolMarshaller.marshall(createBatchImportJobRequest.getOutputPath(), OUTPUTPATH_BINDING);
            protocolMarshaller.marshall(createBatchImportJobRequest.getEventTypeName(), EVENTTYPENAME_BINDING);
            protocolMarshaller.marshall(createBatchImportJobRequest.getIamRoleArn(), IAMROLEARN_BINDING);
            protocolMarshaller.marshall(createBatchImportJobRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
