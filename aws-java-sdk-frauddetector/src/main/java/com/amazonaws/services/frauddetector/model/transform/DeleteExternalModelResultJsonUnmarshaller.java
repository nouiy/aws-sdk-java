...
/**
 * DeleteExternalModelResult JSON Unmarshaller
 */
...
public class DeleteExternalModelResultJsonUnmarshaller implements Unmarshaller<DeleteExternalModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteExternalModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteExternalModelResult deleteExternalModelResult = new DeleteExternalModelResult();
