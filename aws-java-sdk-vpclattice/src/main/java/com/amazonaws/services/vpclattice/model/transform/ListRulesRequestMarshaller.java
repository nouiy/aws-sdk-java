...
public class ListRulesRequestMarshaller {
    ...
    public void marshall(ListRulesRequest listRulesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listRulesRequest.getListenerIdentifier(), LISTENERIDENTIFIER_BINDING);
            ...
            protocolMarshaller.marshall(listRulesRequest.getServiceIdentifier(), SERVICEIDENTIFIER_BINDING);
        } catch (Exception e) {
