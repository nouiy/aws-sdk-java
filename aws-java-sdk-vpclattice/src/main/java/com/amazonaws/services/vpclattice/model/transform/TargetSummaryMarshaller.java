...
public class TargetSummaryMarshaller {
    ...
    public void marshall(TargetSummary targetSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(targetSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(targetSummary.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(targetSummary.getReasonCode(), REASONCODE_BINDING);
            protocolMarshaller.marshall(targetSummary.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
