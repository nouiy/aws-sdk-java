...
public class UpdateListenerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateListenerResult == false)
            return false;
        UpdateListenerResult other = (UpdateListenerResult) obj;
    ...
    public UpdateListenerResult clone() {
        try {
            return (UpdateListenerResult) super.clone();
