...
public class DeregisterTargetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The targets to deregister.
     */
    ...
    public DeregisterTargetsRequest withTargets(Target... targets) {
    ...
    public DeregisterTargetsRequest withTargets(java.util.Collection<Target> targets) {
        setTargets(targets);
        return this;
    }
