...
public class DeleteServiceNetworkVpcAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteServiceNetworkVpcAssociationResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public DeleteServiceNetworkVpcAssociationResult withStatus(ServiceNetworkVpcAssociationStatus status) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteServiceNetworkVpcAssociationResult == false)
            return false;
        DeleteServiceNetworkVpcAssociationResult other = (DeleteServiceNetworkVpcAssociationResult) obj;
    ...
    @Override
    public DeleteServiceNetworkVpcAssociationResult clone() {
        try {
            return (DeleteServiceNetworkVpcAssociationResult) super.clone();
