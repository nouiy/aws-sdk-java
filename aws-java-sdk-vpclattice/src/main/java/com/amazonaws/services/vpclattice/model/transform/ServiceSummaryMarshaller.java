...
public class ServiceSummaryMarshaller {
    ...
    public void marshall(ServiceSummary serviceSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(serviceSummary.getCustomDomainName(), CUSTOMDOMAINNAME_BINDING);
            protocolMarshaller.marshall(serviceSummary.getDnsEntry(), DNSENTRY_BINDING);
            protocolMarshaller.marshall(serviceSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(serviceSummary.getLastUpdatedAt(), LASTUPDATEDAT_BINDING);
