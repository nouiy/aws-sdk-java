...
public class DeregisterTargetsRequestMarshaller {
    ...
    private static final DeregisterTargetsRequestMarshaller instance = new DeregisterTargetsRequestMarshaller();

    public static DeregisterTargetsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeregisterTargetsRequest deregisterTargetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deregisterTargetsRequest.getTargetGroupIdentifier(), TARGETGROUPIDENTIFIER_BINDING);
            protocolMarshaller.marshall(deregisterTargetsRequest.getTargets(), TARGETS_BINDING);
        } catch (Exception e) {
