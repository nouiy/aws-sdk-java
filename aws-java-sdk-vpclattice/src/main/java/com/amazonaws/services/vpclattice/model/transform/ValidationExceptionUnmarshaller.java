...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.vpclattice.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.vpclattice.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.vpclattice.model.ValidationException validationException = new com.amazonaws.services.vpclattice.model.ValidationException(null);
