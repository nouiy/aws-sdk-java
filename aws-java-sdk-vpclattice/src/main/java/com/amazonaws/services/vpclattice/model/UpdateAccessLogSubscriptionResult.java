...
public class UpdateAccessLogSubscriptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAccessLogSubscriptionResult == false)
            return false;
        UpdateAccessLogSubscriptionResult other = (UpdateAccessLogSubscriptionResult) obj;
    ...
    public UpdateAccessLogSubscriptionResult clone() {
        try {
            return (UpdateAccessLogSubscriptionResult) super.clone();
