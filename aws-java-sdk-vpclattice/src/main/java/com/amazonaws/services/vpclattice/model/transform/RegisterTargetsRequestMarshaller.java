...
public class RegisterTargetsRequestMarshaller {
    ...
    private static final RegisterTargetsRequestMarshaller instance = new RegisterTargetsRequestMarshaller();

    public static RegisterTargetsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RegisterTargetsRequest registerTargetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(registerTargetsRequest.getTargetGroupIdentifier(), TARGETGROUPIDENTIFIER_BINDING);
            protocolMarshaller.marshall(registerTargetsRequest.getTargets(), TARGETS_BINDING);
        } catch (Exception e) {
