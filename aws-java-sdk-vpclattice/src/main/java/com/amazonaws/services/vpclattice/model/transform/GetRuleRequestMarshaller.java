...
public class GetRuleRequestMarshaller {
    ...
    public void marshall(GetRuleRequest getRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRuleRequest.getListenerIdentifier(), LISTENERIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getRuleRequest.getRuleIdentifier(), RULEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getRuleRequest.getServiceIdentifier(), SERVICEIDENTIFIER_BINDING);
        } catch (Exception e) {
