...
public class CreateListenerRequestMarshaller {
    ...
    public void marshall(CreateListenerRequest createListenerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createListenerRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createListenerRequest.getDefaultAction(), DEFAULTACTION_BINDING);
            protocolMarshaller.marshall(createListenerRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createListenerRequest.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(createListenerRequest.getProtocol(), PROTOCOL_BINDING);
            protocolMarshaller.marshall(createListenerRequest.getServiceIdentifier(), SERVICEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(createListenerRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
