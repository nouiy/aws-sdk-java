...
public class ListRulesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setItems(java.util.Collection<RuleSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<RuleSummary>(items);
    }
    ...
    public ListRulesResult withItems(RuleSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<RuleSummary>(items.length));
        }
        for (RuleSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListRulesResult withItems(java.util.Collection<RuleSummary> items) {
        setItems(items);
        return this;
    }
