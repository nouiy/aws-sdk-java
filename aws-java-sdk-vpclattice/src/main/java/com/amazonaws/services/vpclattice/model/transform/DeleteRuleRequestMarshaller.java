...
public class DeleteRuleRequestMarshaller {
    ...
    public void marshall(DeleteRuleRequest deleteRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRuleRequest.getListenerIdentifier(), LISTENERIDENTIFIER_BINDING);
            protocolMarshaller.marshall(deleteRuleRequest.getRuleIdentifier(), RULEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(deleteRuleRequest.getServiceIdentifier(), SERVICEIDENTIFIER_BINDING);
        } catch (Exception e) {
