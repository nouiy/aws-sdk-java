...
public class ClusterContainsServicesExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ClusterContainsServicesExceptionUnmarshaller instance;

    public static ClusterContainsServicesExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClusterContainsServicesExceptionUnmarshaller();
        return instance;
    }
}
