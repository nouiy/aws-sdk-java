...
@SdkInternalApi
public class DeregisterTaskDefinitionRequestMarshaller {
    ...
    private static final DeregisterTaskDefinitionRequestMarshaller instance = new DeregisterTaskDefinitionRequestMarshaller();

    public static DeregisterTaskDefinitionRequestMarshaller getInstance() {
        return instance;
    }
