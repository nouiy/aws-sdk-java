...
public class DeregisterTaskDefinitionResultJsonUnmarshaller implements Unmarshaller<DeregisterTaskDefinitionResult, JsonUnmarshallerContext> {

    public DeregisterTaskDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskDefinition", targetDepth)) {
                    context.nextToken();
                    deregisterTaskDefinitionResult.setTaskDefinition(TaskDefinitionJsonUnmarshaller.getInstance().unmarshall(context));
                }
