...
class TasksRunning {
    ...
    static class IsSTOPPEDMatcher extends WaiterAcceptor<DescribeTasksResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("tasks")), new JmesPathField("lastStatus"));
    ...
    static class IsMISSINGMatcher extends WaiterAcceptor<DescribeTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<DescribeTasksResult> {
        private static final JsonNode expectedResult;
