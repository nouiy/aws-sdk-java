...
public class SubmitAttachmentStateChangesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SubmitAttachmentStateChangesResult withAcknowledgment(String acknowledgment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SubmitAttachmentStateChangesResult == false)
            return false;
        SubmitAttachmentStateChangesResult other = (SubmitAttachmentStateChangesResult) obj;
    ...
    @Override
    public SubmitAttachmentStateChangesResult clone() {
        try {
            return (SubmitAttachmentStateChangesResult) super.clone();
