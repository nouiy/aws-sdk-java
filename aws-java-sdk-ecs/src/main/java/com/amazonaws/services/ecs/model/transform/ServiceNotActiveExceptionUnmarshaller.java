...
public class ServiceNotActiveExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ServiceNotActiveExceptionUnmarshaller instance;

    public static ServiceNotActiveExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceNotActiveExceptionUnmarshaller();
        return instance;
    }
}
