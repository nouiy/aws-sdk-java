...
public class SubmitAttachmentStateChangesRequestMarshaller {
    ...
    private static final SubmitAttachmentStateChangesRequestMarshaller instance = new SubmitAttachmentStateChangesRequestMarshaller();

    public static SubmitAttachmentStateChangesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SubmitAttachmentStateChangesRequest submitAttachmentStateChangesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(submitAttachmentStateChangesRequest.getCluster(), CLUSTER_BINDING);
            protocolMarshaller.marshall(submitAttachmentStateChangesRequest.getAttachments(), ATTACHMENTS_BINDING);
        } catch (Exception e) {
