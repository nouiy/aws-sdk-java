...
/**
 * FSxWindowsFileServerVolumeConfiguration JSON Unmarshaller
 */
...
public class FSxWindowsFileServerVolumeConfigurationJsonUnmarshaller implements Unmarshaller<FSxWindowsFileServerVolumeConfiguration, JsonUnmarshallerContext> {
    ...
    public FSxWindowsFileServerVolumeConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fileSystemId", targetDepth)) {
                    context.nextToken();
                    fSxWindowsFileServerVolumeConfiguration.setFileSystemId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("rootDirectory", targetDepth)) {
                    context.nextToken();
                    fSxWindowsFileServerVolumeConfiguration.setRootDirectory(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("authorizationConfig", targetDepth)) {
                    context.nextToken();
                    fSxWindowsFileServerVolumeConfiguration.setAuthorizationConfig(FSxWindowsFileServerAuthorizationConfigJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
