...
/**
 * ExecuteCommandLogConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExecuteCommandLogConfigurationJsonUnmarshaller implements Unmarshaller<ExecuteCommandLogConfiguration, JsonUnmarshallerContext> {

    public ExecuteCommandLogConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExecuteCommandLogConfiguration executeCommandLogConfiguration = new ExecuteCommandLogConfiguration();
    ...
    private static ExecuteCommandLogConfigurationJsonUnmarshaller instance;

    public static ExecuteCommandLogConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExecuteCommandLogConfigurationJsonUnmarshaller();
        return instance;
    }
}
