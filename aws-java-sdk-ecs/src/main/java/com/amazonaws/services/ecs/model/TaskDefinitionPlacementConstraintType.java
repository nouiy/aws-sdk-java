...
public enum TaskDefinitionPlacementConstraintType {
    ...
    private TaskDefinitionPlacementConstraintType(String value) {
        this.value = value;
    }
    ...
    public static TaskDefinitionPlacementConstraintType fromValue(String value) {
        ...
        for (TaskDefinitionPlacementConstraintType enumEntry : TaskDefinitionPlacementConstraintType.values()) {
