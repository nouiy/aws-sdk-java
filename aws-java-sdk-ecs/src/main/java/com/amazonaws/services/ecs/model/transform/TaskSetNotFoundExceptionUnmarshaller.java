...
public class TaskSetNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TaskSetNotFoundExceptionUnmarshaller instance;

    public static TaskSetNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TaskSetNotFoundExceptionUnmarshaller();
        return instance;
    }
}
