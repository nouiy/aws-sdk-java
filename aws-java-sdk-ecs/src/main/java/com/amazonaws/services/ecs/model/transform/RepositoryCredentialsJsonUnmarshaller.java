...
/**
 * RepositoryCredentials JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RepositoryCredentialsJsonUnmarshaller implements Unmarshaller<RepositoryCredentials, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("credentialsParameter", targetDepth)) {
                    context.nextToken();
                    repositoryCredentials.setCredentialsParameter(context.getUnmarshaller(String.class).unmarshall(context));
                }
