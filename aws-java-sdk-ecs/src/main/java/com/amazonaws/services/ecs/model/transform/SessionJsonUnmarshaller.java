        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("streamUrl", targetDepth)) {
                    context.nextToken();
                    session.setStreamUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("tokenValue", targetDepth)) {
                    context.nextToken();
                    session.setTokenValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
