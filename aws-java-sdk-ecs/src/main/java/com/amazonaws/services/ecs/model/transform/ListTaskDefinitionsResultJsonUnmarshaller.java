...
public class ListTaskDefinitionsResultJsonUnmarshaller implements Unmarshaller<ListTaskDefinitionsResult, JsonUnmarshallerContext> {

    public ListTaskDefinitionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listTaskDefinitionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
