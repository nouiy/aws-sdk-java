...
public class SubmitTaskStateChangeResultJsonUnmarshaller implements Unmarshaller<SubmitTaskStateChangeResult, JsonUnmarshallerContext> {

    public SubmitTaskStateChangeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("acknowledgment", targetDepth)) {
                    context.nextToken();
                    submitTaskStateChangeResult.setAcknowledgment(context.getUnmarshaller(String.class).unmarshall(context));
                }
