...
public class ServiceEventJsonUnmarshaller implements Unmarshaller<ServiceEvent, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    serviceEvent.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("message", targetDepth)) {
                    context.nextToken();
                    serviceEvent.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ServiceEventJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceEventJsonUnmarshaller();
        return instance;
    }
}
