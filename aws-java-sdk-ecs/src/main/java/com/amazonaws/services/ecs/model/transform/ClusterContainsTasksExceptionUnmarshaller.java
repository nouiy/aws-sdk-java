...
public class ClusterContainsTasksExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ClusterContainsTasksExceptionUnmarshaller instance;

    public static ClusterContainsTasksExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClusterContainsTasksExceptionUnmarshaller();
        return instance;
    }
}
