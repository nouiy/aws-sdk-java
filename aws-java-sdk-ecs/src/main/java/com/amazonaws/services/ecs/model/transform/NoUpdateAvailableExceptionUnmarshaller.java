...
public class NoUpdateAvailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoUpdateAvailableExceptionUnmarshaller instance;

    public static NoUpdateAvailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoUpdateAvailableExceptionUnmarshaller();
        return instance;
    }
}
