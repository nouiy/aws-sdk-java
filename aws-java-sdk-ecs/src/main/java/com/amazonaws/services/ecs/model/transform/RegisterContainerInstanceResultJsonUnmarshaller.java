...
public class RegisterContainerInstanceResultJsonUnmarshaller implements Unmarshaller<RegisterContainerInstanceResult, JsonUnmarshallerContext> {

    public RegisterContainerInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("containerInstance", targetDepth)) {
                    context.nextToken();
                    registerContainerInstanceResult.setContainerInstance(ContainerInstanceJsonUnmarshaller.getInstance().unmarshall(context));
                }
