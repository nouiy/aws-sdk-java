...
public class DeleteCapacityProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The details of the capacity provider.
     */
    ...
    public DeleteCapacityProviderResult withCapacityProvider(CapacityProvider capacityProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCapacityProviderResult == false)
            return false;
        DeleteCapacityProviderResult other = (DeleteCapacityProviderResult) obj;
    ...
    @Override
    public DeleteCapacityProviderResult clone() {
        try {
            return (DeleteCapacityProviderResult) super.clone();
