...
public class PlatformUnknownExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PlatformUnknownExceptionUnmarshaller instance;

    public static PlatformUnknownExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PlatformUnknownExceptionUnmarshaller();
        return instance;
    }
}
