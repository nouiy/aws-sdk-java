...
public class DeregisterContainerInstanceResultJsonUnmarshaller implements Unmarshaller<DeregisterContainerInstanceResult, JsonUnmarshallerContext> {

    public DeregisterContainerInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("containerInstance", targetDepth)) {
                    context.nextToken();
                    deregisterContainerInstanceResult.setContainerInstance(ContainerInstanceJsonUnmarshaller.getInstance().unmarshall(context));
                }
