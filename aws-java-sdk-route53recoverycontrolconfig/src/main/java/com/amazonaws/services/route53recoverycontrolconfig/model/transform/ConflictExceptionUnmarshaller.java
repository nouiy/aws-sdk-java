...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.route53recoverycontrolconfig.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.route53recoverycontrolconfig.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.route53recoverycontrolconfig.model.ConflictException conflictException = new com.amazonaws.services.route53recoverycontrolconfig.model.ConflictException(
                null);
