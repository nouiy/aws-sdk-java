...
public class UpdateControlPanelRequestMarshaller {
    ...
    private static final UpdateControlPanelRequestMarshaller instance = new UpdateControlPanelRequestMarshaller();

    public static UpdateControlPanelRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateControlPanelRequest updateControlPanelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateControlPanelRequest.getControlPanelArn(), CONTROLPANELARN_BINDING);
            protocolMarshaller.marshall(updateControlPanelRequest.getControlPanelName(), CONTROLPANELNAME_BINDING);
        } catch (Exception e) {
