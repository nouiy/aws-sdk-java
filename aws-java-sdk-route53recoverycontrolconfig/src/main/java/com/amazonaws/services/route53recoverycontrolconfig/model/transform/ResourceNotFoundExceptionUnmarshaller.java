...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.route53recoverycontrolconfig.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.route53recoverycontrolconfig.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.route53recoverycontrolconfig.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.route53recoverycontrolconfig.model.ResourceNotFoundException(
                null);
