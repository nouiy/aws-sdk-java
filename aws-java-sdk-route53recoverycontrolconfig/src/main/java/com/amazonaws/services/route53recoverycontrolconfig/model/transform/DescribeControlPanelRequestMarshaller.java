...
public class DescribeControlPanelRequestMarshaller {
    ...
    private static final DescribeControlPanelRequestMarshaller instance = new DescribeControlPanelRequestMarshaller();

    public static DescribeControlPanelRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeControlPanelRequest describeControlPanelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeControlPanelRequest.getControlPanelArn(), CONTROLPANELARN_BINDING);
        } catch (Exception e) {
