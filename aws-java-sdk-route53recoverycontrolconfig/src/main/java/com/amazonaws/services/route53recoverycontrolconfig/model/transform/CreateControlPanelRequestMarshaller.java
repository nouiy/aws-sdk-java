...
public class CreateControlPanelRequestMarshaller {
    ...
    public static CreateControlPanelRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateControlPanelRequest createControlPanelRequest, ProtocolMarshaller protocolMarshaller) {
