...
public class DescribeRoutingControlFunction implements SdkFunction<DescribeRoutingControlRequest, DescribeRoutingControlResult> {
    ...
    /**
     * Constructs a new DescribeRoutingControlFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public DescribeRoutingControlFunction(AWSRoute53RecoveryControlConfig client) {
        this.client = client;
    }
    ...
    public DescribeRoutingControlResult apply(DescribeRoutingControlRequest describeRoutingControlRequest) {
        return client.describeRoutingControl(describeRoutingControlRequest);
    }
}
