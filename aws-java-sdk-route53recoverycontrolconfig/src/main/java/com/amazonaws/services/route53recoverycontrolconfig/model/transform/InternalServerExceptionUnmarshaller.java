...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.route53recoverycontrolconfig.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.route53recoverycontrolconfig.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.route53recoverycontrolconfig.model.InternalServerException internalServerException = new com.amazonaws.services.route53recoverycontrolconfig.model.InternalServerException(
                null);
