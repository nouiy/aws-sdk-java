...
/**
 * SectionalElement JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SectionalElementJsonUnmarshaller implements Unmarshaller<SectionalElement, JsonUnmarshallerContext> {

    public SectionalElement unmarshall(JsonUnmarshallerContext context) throws Exception {
        SectionalElement sectionalElement = new SectionalElement();
    ...
    private static SectionalElementJsonUnmarshaller instance;

    public static SectionalElementJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SectionalElementJsonUnmarshaller();
        return instance;
    }
}
