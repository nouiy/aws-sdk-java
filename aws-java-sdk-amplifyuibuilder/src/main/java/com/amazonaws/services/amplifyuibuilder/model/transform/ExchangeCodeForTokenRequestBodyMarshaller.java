...
/**
 * ExchangeCodeForTokenRequestBodyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ExchangeCodeForTokenRequestBodyMarshaller {
    ...
    public static ExchangeCodeForTokenRequestBodyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExchangeCodeForTokenRequestBody exchangeCodeForTokenRequestBody, ProtocolMarshaller protocolMarshaller) {

        if (exchangeCodeForTokenRequestBody == null) {
