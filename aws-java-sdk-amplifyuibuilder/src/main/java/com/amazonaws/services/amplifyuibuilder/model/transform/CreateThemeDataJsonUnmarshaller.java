...
/**
 * CreateThemeData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateThemeDataJsonUnmarshaller implements Unmarshaller<CreateThemeData, JsonUnmarshallerContext> {

    public CreateThemeData unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateThemeData createThemeData = new CreateThemeData();
    ...
    private static CreateThemeDataJsonUnmarshaller instance;

    public static CreateThemeDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateThemeDataJsonUnmarshaller();
        return instance;
    }
}
