...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/amplifyuibuilder-2021-08-11/ListThemes" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ListThemesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ThemeSummary> entities;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The list of themes for the Amplify app.
     */

    public java.util.List<ThemeSummary> getEntities() {
        return entities;
    }
    ...
    public void setEntities(java.util.Collection<ThemeSummary> entities) {
        if (entities == null) {
            this.entities = null;
            return;
        }

        this.entities = new java.util.ArrayList<ThemeSummary>(entities);
    }
    ...
    public ListThemesResult withEntities(ThemeSummary... entities) {
        if (this.entities == null) {
            setEntities(new java.util.ArrayList<ThemeSummary>(entities.length));
        }
        for (ThemeSummary ele : entities) {
    ...
    public ListThemesResult withEntities(java.util.Collection<ThemeSummary> entities) {
     ...
     * </p>
     * 
     * @return The pagination token that's returned if more results are available.
     */
