...
/**
 * FileUploaderFieldConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FileUploaderFieldConfigJsonUnmarshaller implements Unmarshaller<FileUploaderFieldConfig, JsonUnmarshallerContext> {

    public FileUploaderFieldConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        FileUploaderFieldConfig fileUploaderFieldConfig = new FileUploaderFieldConfig();
    ...
    private static FileUploaderFieldConfigJsonUnmarshaller instance;

    public static FileUploaderFieldConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileUploaderFieldConfigJsonUnmarshaller();
        return instance;
    }
}
