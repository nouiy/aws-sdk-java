...
public class SortPropertyMarshaller {
    ...
    public static SortPropertyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SortProperty sortProperty, ProtocolMarshaller protocolMarshaller) {
