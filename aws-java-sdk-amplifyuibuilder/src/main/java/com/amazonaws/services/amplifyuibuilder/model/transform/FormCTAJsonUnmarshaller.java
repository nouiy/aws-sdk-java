...
/**
 * FormCTA JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FormCTAJsonUnmarshaller implements Unmarshaller<FormCTA, JsonUnmarshallerContext> {

    public FormCTA unmarshall(JsonUnmarshallerContext context) throws Exception {
        FormCTA formCTA = new FormCTA();
    ...
    private static FormCTAJsonUnmarshaller instance;

    public static FormCTAJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FormCTAJsonUnmarshaller();
        return instance;
    }
}
