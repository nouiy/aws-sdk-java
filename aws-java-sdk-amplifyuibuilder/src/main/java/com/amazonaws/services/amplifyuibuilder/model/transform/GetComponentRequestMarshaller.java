...
public class GetComponentRequestMarshaller {
    ...
    public void marshall(GetComponentRequest getComponentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getComponentRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(getComponentRequest.getEnvironmentName(), ENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(getComponentRequest.getId(), ID_BINDING);
        } catch (Exception e) {
