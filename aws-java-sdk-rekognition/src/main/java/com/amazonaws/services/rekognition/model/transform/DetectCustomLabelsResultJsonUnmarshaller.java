...
/**
 * DetectCustomLabelsResult JSON Unmarshaller
 */
...
public class DetectCustomLabelsResultJsonUnmarshaller implements Unmarshaller<DetectCustomLabelsResult, JsonUnmarshallerContext> {
    ...
    public DetectCustomLabelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CustomLabels", targetDepth)) {
                    context.nextToken();
                    detectCustomLabelsResult.setCustomLabels(new ListUnmarshaller<CustomLabel>(CustomLabelJsonUnmarshaller.getInstance())
