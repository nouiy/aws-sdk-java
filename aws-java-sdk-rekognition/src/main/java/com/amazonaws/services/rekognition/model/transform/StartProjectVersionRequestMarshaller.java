...
public class StartProjectVersionRequestMarshaller {
    ...
    public static StartProjectVersionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartProjectVersionRequest startProjectVersionRequest, ProtocolMarshaller protocolMarshaller) {
