...
/**
 * ListDatasetLabelsResult JSON Unmarshaller
 */
...
public class ListDatasetLabelsResultJsonUnmarshaller implements Unmarshaller<ListDatasetLabelsResult, JsonUnmarshallerContext> {
    ...
    public ListDatasetLabelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DatasetLabelDescriptions", targetDepth)) {
                    context.nextToken();
                    listDatasetLabelsResult.setDatasetLabelDescriptions(new ListUnmarshaller<DatasetLabelDescription>(DatasetLabelDescriptionJsonUnmarshaller
                            .getInstance())
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDatasetLabelsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
