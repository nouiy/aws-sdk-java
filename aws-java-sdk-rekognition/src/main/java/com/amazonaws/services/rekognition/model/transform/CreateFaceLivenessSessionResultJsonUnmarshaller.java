...
/**
 * CreateFaceLivenessSessionResult JSON Unmarshaller
 */
...
public class CreateFaceLivenessSessionResultJsonUnmarshaller implements Unmarshaller<CreateFaceLivenessSessionResult, JsonUnmarshallerContext> {
    ...
    public CreateFaceLivenessSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SessionId", targetDepth)) {
                    context.nextToken();
                    createFaceLivenessSessionResult.setSessionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
