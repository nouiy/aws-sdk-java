...
public class SmileMarshaller {
    ...
    private static final SmileMarshaller instance = new SmileMarshaller();

    public static SmileMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Smile smile, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(smile.getValue(), VALUE_BINDING);
            protocolMarshaller.marshall(smile.getConfidence(), CONFIDENCE_BINDING);
        } catch (Exception e) {
