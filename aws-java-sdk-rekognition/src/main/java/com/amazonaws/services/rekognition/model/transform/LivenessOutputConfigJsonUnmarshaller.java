...
/**
 * LivenessOutputConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LivenessOutputConfigJsonUnmarshaller implements Unmarshaller<LivenessOutputConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("S3Bucket", targetDepth)) {
                    context.nextToken();
                    livenessOutputConfig.setS3Bucket(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("S3KeyPrefix", targetDepth)) {
                    context.nextToken();
                    livenessOutputConfig.setS3KeyPrefix(context.getUnmarshaller(String.class).unmarshall(context));
                }
