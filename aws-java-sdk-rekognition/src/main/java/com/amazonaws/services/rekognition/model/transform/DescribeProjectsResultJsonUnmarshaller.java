...
/**
 * DescribeProjectsResult JSON Unmarshaller
 */
...
public class DescribeProjectsResultJsonUnmarshaller implements Unmarshaller<DescribeProjectsResult, JsonUnmarshallerContext> {
    ...
    public DescribeProjectsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeProjectsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
