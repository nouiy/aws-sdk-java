...
/**
 * ListStreamProcessorsResult JSON Unmarshaller
 */
...
public class ListStreamProcessorsResultJsonUnmarshaller implements Unmarshaller<ListStreamProcessorsResult, JsonUnmarshallerContext> {
    ...
    public ListStreamProcessorsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listStreamProcessorsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
