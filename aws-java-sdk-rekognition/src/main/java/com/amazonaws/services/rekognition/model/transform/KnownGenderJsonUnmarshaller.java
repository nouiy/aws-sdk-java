...
/**
 * KnownGender JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KnownGenderJsonUnmarshaller implements Unmarshaller<KnownGender, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    knownGender.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
