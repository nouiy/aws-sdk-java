...
public class ImageQualityMarshaller {
    ...
    private static final MarshallingInfo<Float> BRIGHTNESS_BINDING = MarshallingInfo.builder(MarshallingType.FLOAT).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Brightness").build();
    private static final MarshallingInfo<Float> SHARPNESS_BINDING = MarshallingInfo.builder(MarshallingType.FLOAT).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Sharpness").build();
