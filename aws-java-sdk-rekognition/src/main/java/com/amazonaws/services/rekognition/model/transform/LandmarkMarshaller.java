...
public class LandmarkMarshaller {
    ...
    public void marshall(Landmark landmark, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(landmark.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(landmark.getX(), X_BINDING);
            protocolMarshaller.marshall(landmark.getY(), Y_BINDING);
        } catch (Exception e) {
