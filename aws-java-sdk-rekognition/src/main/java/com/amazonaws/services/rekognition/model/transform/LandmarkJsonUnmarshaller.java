...
/**
 * Landmark JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LandmarkJsonUnmarshaller implements Unmarshaller<Landmark, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    landmark.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Y", targetDepth)) {
                    context.nextToken();
                    landmark.setY(context.getUnmarshaller(Float.class).unmarshall(context));
                }
