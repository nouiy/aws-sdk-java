...
/**
 * UnindexedFace JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UnindexedFaceJsonUnmarshaller implements Unmarshaller<UnindexedFace, JsonUnmarshallerContext> {

    public UnindexedFace unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("FaceDetail", targetDepth)) {
                    context.nextToken();
                    unindexedFace.setFaceDetail(FaceDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
