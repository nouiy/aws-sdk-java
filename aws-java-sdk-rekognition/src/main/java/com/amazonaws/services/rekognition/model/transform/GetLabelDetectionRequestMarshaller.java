...
public class GetLabelDetectionRequestMarshaller {
    ...
    public static GetLabelDetectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetLabelDetectionRequest getLabelDetectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getLabelDetectionRequest.getJobId(), JOBID_BINDING);
