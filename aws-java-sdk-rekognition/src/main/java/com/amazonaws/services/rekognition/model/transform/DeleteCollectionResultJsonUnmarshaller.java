...
/**
 * DeleteCollectionResult JSON Unmarshaller
 */
...
public class DeleteCollectionResultJsonUnmarshaller implements Unmarshaller<DeleteCollectionResult, JsonUnmarshallerContext> {
    ...
    public DeleteCollectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StatusCode", targetDepth)) {
                    context.nextToken();
                    deleteCollectionResult.setStatusCode(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
