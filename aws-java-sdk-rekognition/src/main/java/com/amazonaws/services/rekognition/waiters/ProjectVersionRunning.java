...
class ProjectVersionRunning {
    ...
    static class IsRUNNINGMatcher extends WaiterAcceptor<DescribeProjectVersionsResult> {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeProjectVersionsResult> {
        private static final JsonNode expectedResult;
