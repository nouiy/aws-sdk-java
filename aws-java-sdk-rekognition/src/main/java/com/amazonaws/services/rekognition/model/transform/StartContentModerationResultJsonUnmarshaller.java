...
/**
 * StartContentModerationResult JSON Unmarshaller
 */
...
public class StartContentModerationResultJsonUnmarshaller implements Unmarshaller<StartContentModerationResult, JsonUnmarshallerContext> {
    ...
    public StartContentModerationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobId", targetDepth)) {
                    context.nextToken();
                    startContentModerationResult.setJobId(context.getUnmarshaller(String.class).unmarshall(context));
                }
