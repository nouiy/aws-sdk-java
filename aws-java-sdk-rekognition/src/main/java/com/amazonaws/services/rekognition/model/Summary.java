...
/**
 * <p>
 * The S3 bucket that contains the training summary. The training summary includes aggregated evaluation metrics for the
 * entire testing dataset and metrics for each individual label.
 * </p>
 * <p>
...
public class Summary implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.SummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
