...
/**
 * CreateStreamProcessorResult JSON Unmarshaller
 */
...
public class CreateStreamProcessorResultJsonUnmarshaller implements Unmarshaller<CreateStreamProcessorResult, JsonUnmarshallerContext> {
    ...
    public CreateStreamProcessorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamProcessorArn", targetDepth)) {
                    context.nextToken();
                    createStreamProcessorResult.setStreamProcessorArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
