...
@SdkInternalApi
public class StartLabelDetectionRequestMarshaller {
    ...
    public static StartLabelDetectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartLabelDetectionRequest startLabelDetectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startLabelDetectionRequest.getVideo(), VIDEO_BINDING);
            protocolMarshaller.marshall(startLabelDetectionRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
