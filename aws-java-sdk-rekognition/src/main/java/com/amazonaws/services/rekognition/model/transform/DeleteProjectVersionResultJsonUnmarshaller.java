...
/**
 * DeleteProjectVersionResult JSON Unmarshaller
 */
...
public class DeleteProjectVersionResultJsonUnmarshaller implements Unmarshaller<DeleteProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    deleteProjectVersionResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
