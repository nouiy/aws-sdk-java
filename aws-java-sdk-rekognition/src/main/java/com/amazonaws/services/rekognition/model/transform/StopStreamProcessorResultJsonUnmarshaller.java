...
/**
 * StopStreamProcessorResult JSON Unmarshaller
 */
...
public class StopStreamProcessorResultJsonUnmarshaller implements Unmarshaller<StopStreamProcessorResult, JsonUnmarshallerContext> {
    ...
    public StopStreamProcessorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopStreamProcessorResult stopStreamProcessorResult = new StopStreamProcessorResult();
