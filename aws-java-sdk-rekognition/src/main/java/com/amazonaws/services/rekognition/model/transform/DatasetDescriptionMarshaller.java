...
public class DatasetDescriptionMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> DATASETSTATS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DatasetStats").build();
    ...
    public void marshall(DatasetDescription datasetDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(datasetDescription.getStatusMessageCode(), STATUSMESSAGECODE_BINDING);
            protocolMarshaller.marshall(datasetDescription.getDatasetStats(), DATASETSTATS_BINDING);
        } catch (Exception e) {
