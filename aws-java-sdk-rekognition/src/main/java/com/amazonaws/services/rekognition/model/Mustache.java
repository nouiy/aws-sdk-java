...
public class Mustache implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Mustache == false)
            return false;
    ...
    @Override
    public Mustache clone() {
        try {
            return (Mustache) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.MustacheMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
