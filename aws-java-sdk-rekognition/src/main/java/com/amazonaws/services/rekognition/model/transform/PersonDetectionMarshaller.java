...
public class PersonDetectionMarshaller {
    ...
    public void marshall(PersonDetection personDetection, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(personDetection.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(personDetection.getPerson(), PERSON_BINDING);
        } catch (Exception e) {
