...
public class UpdateDatasetEntriesRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CHANGES_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(UpdateDatasetEntriesRequest updateDatasetEntriesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateDatasetEntriesRequest.getDatasetArn(), DATASETARN_BINDING);
