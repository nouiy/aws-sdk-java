...
/**
 * CelebrityRecognitionMarshaller
 */
...
public class CelebrityRecognitionMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CELEBRITY_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Celebrity").build();
    ...
    public void marshall(CelebrityRecognition celebrityRecognition, ProtocolMarshaller protocolMarshaller) {
        ...
        if (celebrityRecognition == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(celebrityRecognition.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(celebrityRecognition.getCelebrity(), CELEBRITY_BINDING);
        } catch (Exception e) {
