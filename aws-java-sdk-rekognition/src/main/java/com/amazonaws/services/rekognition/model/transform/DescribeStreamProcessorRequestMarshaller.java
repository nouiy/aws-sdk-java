...
@SdkInternalApi
public class DescribeStreamProcessorRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Name").build();

    private static final DescribeStreamProcessorRequestMarshaller instance = new DescribeStreamProcessorRequestMarshaller();

    public static DescribeStreamProcessorRequestMarshaller getInstance() {
        return instance;
    }
