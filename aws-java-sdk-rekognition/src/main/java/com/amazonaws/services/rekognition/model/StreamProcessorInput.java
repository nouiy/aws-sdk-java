...
public class StreamProcessorInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public StreamProcessorInput withKinesisVideoStream(KinesisVideoStream kinesisVideoStream) {
        setKinesisVideoStream(kinesisVideoStream);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getKinesisVideoStream() == null ^ this.getKinesisVideoStream() == null)
            return false;
        if (other.getKinesisVideoStream() != null && other.getKinesisVideoStream().equals(this.getKinesisVideoStream()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getKinesisVideoStream() == null) ? 0 : getKinesisVideoStream().hashCode());
        return hashCode;
    }
    ...
    public StreamProcessorInput clone() {
        try {
            return (StreamProcessorInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.StreamProcessorInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
