...
public class StartTextDetectionRequestMarshaller {
    ...
    private static final StartTextDetectionRequestMarshaller instance = new StartTextDetectionRequestMarshaller();

    public static StartTextDetectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartTextDetectionRequest startTextDetectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startTextDetectionRequest.getVideo(), VIDEO_BINDING);
            protocolMarshaller.marshall(startTextDetectionRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
            protocolMarshaller.marshall(startTextDetectionRequest.getNotificationChannel(), NOTIFICATIONCHANNEL_BINDING);
            protocolMarshaller.marshall(startTextDetectionRequest.getJobTag(), JOBTAG_BINDING);
            protocolMarshaller.marshall(startTextDetectionRequest.getFilters(), FILTERS_BINDING);
        } catch (Exception e) {
