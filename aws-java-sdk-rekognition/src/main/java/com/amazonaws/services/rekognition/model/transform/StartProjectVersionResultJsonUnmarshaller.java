...
/**
 * StartProjectVersionResult JSON Unmarshaller
 */
...
public class StartProjectVersionResultJsonUnmarshaller implements Unmarshaller<StartProjectVersionResult, JsonUnmarshallerContext> {
    ...
    public StartProjectVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    startProjectVersionResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
