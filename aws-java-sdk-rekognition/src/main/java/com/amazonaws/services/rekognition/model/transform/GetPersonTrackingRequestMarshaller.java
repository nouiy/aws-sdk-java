...
@SdkInternalApi
public class GetPersonTrackingRequestMarshaller {
    ...
    private static final GetPersonTrackingRequestMarshaller instance = new GetPersonTrackingRequestMarshaller();

    public static GetPersonTrackingRequestMarshaller getInstance() {
        return instance;
    }
