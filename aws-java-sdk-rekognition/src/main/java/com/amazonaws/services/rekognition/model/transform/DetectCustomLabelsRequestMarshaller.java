...
public class DetectCustomLabelsRequestMarshaller {
    ...
    private static final DetectCustomLabelsRequestMarshaller instance = new DetectCustomLabelsRequestMarshaller();

    public static DetectCustomLabelsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DetectCustomLabelsRequest detectCustomLabelsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(detectCustomLabelsRequest.getProjectVersionArn(), PROJECTVERSIONARN_BINDING);
            protocolMarshaller.marshall(detectCustomLabelsRequest.getImage(), IMAGE_BINDING);
            protocolMarshaller.marshall(detectCustomLabelsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(detectCustomLabelsRequest.getMinConfidence(), MINCONFIDENCE_BINDING);
        } catch (Exception e) {
