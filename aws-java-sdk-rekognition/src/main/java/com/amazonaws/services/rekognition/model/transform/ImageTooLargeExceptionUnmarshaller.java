...
public class ImageTooLargeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ImageTooLargeExceptionUnmarshaller instance;

    public static ImageTooLargeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImageTooLargeExceptionUnmarshaller();
        return instance;
    }
}
