        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    mouthOpen.setValue(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("Confidence", targetDepth)) {
                    context.nextToken();
                    mouthOpen.setConfidence(context.getUnmarshaller(Float.class).unmarshall(context));
                }
