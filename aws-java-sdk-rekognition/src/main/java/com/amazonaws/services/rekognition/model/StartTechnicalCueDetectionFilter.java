...
public class StartTechnicalCueDetectionFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public StartTechnicalCueDetectionFilter clone() {
        try {
            return (StartTechnicalCueDetectionFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.rekognition.model.transform.StartTechnicalCueDetectionFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
