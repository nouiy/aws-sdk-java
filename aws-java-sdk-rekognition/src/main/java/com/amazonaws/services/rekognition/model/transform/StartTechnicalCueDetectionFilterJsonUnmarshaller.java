...
/**
 * StartTechnicalCueDetectionFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartTechnicalCueDetectionFilterJsonUnmarshaller implements Unmarshaller<StartTechnicalCueDetectionFilter, JsonUnmarshallerContext> {

    public StartTechnicalCueDetectionFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
