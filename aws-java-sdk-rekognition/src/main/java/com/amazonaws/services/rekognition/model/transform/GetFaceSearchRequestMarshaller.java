...
@SdkInternalApi
public class GetFaceSearchRequestMarshaller {
    ...
    private static final GetFaceSearchRequestMarshaller instance = new GetFaceSearchRequestMarshaller();

    public static GetFaceSearchRequestMarshaller getInstance() {
        return instance;
    }
