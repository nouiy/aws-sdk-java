...
/**
 * ContentModerationDetection JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContentModerationDetectionJsonUnmarshaller implements Unmarshaller<ContentModerationDetection, JsonUnmarshallerContext> {

    public ContentModerationDetection unmarshall(JsonUnmarshallerContext context) throws Exception {
