...
/**
 * TrainingData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrainingDataJsonUnmarshaller implements Unmarshaller<TrainingData, JsonUnmarshallerContext> {

    public TrainingData unmarshall(JsonUnmarshallerContext context) throws Exception {
