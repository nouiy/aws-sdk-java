...
/**
 * RegisterDeviceRequestMarshaller
 */
...
public class RegisterDeviceRequestMarshaller {
    ...
    private static final RegisterDeviceRequestMarshaller instance = new RegisterDeviceRequestMarshaller();

    public static RegisterDeviceRequestMarshaller getInstance() {
        return instance;
    }
