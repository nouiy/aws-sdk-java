...
public class MalformedCertificateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MalformedCertificateExceptionUnmarshaller instance;

    public static MalformedCertificateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MalformedCertificateExceptionUnmarshaller();
        return instance;
    }
}
