...
public class RequestAlreadyProcessedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RequestAlreadyProcessedExceptionUnmarshaller instance;

    public static RequestAlreadyProcessedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RequestAlreadyProcessedExceptionUnmarshaller();
        return instance;
    }
}
