...
public class GetCertificateAuthorityCertificateRequestMarshaller {
    ...
    private static final GetCertificateAuthorityCertificateRequestMarshaller instance = new GetCertificateAuthorityCertificateRequestMarshaller();

    public static GetCertificateAuthorityCertificateRequestMarshaller getInstance() {
        return instance;
    }
