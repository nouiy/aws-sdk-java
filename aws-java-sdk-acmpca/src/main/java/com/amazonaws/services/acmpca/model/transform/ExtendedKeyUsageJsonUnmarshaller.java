    ...
    public ExtendedKeyUsage unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ExtendedKeyUsageType", targetDepth)) {
                    context.nextToken();
                    extendedKeyUsage.setExtendedKeyUsageType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ExtendedKeyUsageObjectIdentifier", targetDepth)) {
                    context.nextToken();
                    extendedKeyUsage.setExtendedKeyUsageObjectIdentifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
