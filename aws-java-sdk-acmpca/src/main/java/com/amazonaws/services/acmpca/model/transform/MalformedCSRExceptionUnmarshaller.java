...
public class MalformedCSRExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MalformedCSRExceptionUnmarshaller instance;

    public static MalformedCSRExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MalformedCSRExceptionUnmarshaller();
        return instance;
    }
}
