...
/**
 * RestoreCertificateAuthorityResult JSON Unmarshaller
 */
...
public class RestoreCertificateAuthorityResultJsonUnmarshaller implements Unmarshaller<RestoreCertificateAuthorityResult, JsonUnmarshallerContext> {
    ...
    public RestoreCertificateAuthorityResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RestoreCertificateAuthorityResult restoreCertificateAuthorityResult = new RestoreCertificateAuthorityResult();
