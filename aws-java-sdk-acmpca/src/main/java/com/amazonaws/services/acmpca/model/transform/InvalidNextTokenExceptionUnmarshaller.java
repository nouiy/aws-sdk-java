...
public class InvalidNextTokenExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidNextTokenExceptionUnmarshaller() {
        super(com.amazonaws.services.acmpca.model.InvalidNextTokenException.class, "InvalidNextTokenException");
    }

    @Override
    public com.amazonaws.services.acmpca.model.InvalidNextTokenException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.acmpca.model.InvalidNextTokenException invalidNextTokenException = new com.amazonaws.services.acmpca.model.InvalidNextTokenException(
                null);
