...
public class IssueCertificateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IssueCertificateResult == false)
            return false;
        IssueCertificateResult other = (IssueCertificateResult) obj;
    ...
    public IssueCertificateResult clone() {
        try {
            return (IssueCertificateResult) super.clone();
