...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.acmpca.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.acmpca.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.acmpca.model.LimitExceededException limitExceededException = new com.amazonaws.services.acmpca.model.LimitExceededException(null);
