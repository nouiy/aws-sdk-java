...
public class UnsupportedPlsLanguageExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedPlsLanguageExceptionUnmarshaller instance;

    public static UnsupportedPlsLanguageExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedPlsLanguageExceptionUnmarshaller();
        return instance;
    }
}
