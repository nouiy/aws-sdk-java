...
/**
 * GetSpeechSynthesisTaskRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetSpeechSynthesisTaskRequestMarshaller {
    ...
    private static final GetSpeechSynthesisTaskRequestMarshaller instance = new GetSpeechSynthesisTaskRequestMarshaller();

    public static GetSpeechSynthesisTaskRequestMarshaller getInstance() {
        return instance;
    }
