...
/**
 * LexiconDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LexiconDescriptionJsonUnmarshaller implements Unmarshaller<LexiconDescription, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    lexiconDescription.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Attributes", targetDepth)) {
                    context.nextToken();
                    lexiconDescription.setAttributes(LexiconAttributesJsonUnmarshaller.getInstance().unmarshall(context));
                }
