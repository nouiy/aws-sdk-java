...
public class InvalidS3BucketExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidS3BucketExceptionUnmarshaller instance;

    public static InvalidS3BucketExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidS3BucketExceptionUnmarshaller();
        return instance;
    }
}
