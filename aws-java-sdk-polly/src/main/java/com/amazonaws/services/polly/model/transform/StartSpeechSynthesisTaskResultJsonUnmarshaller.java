...
/**
 * StartSpeechSynthesisTaskResult JSON Unmarshaller
 */
...
public class StartSpeechSynthesisTaskResultJsonUnmarshaller implements Unmarshaller<StartSpeechSynthesisTaskResult, JsonUnmarshallerContext> {
    ...
    public StartSpeechSynthesisTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SynthesisTask", targetDepth)) {
                    context.nextToken();
                    startSpeechSynthesisTaskResult.setSynthesisTask(SynthesisTaskJsonUnmarshaller.getInstance().unmarshall(context));
                }
