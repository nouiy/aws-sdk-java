...
public class LexiconSizeExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LexiconSizeExceededExceptionUnmarshaller instance;

    public static LexiconSizeExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LexiconSizeExceededExceptionUnmarshaller();
        return instance;
    }
}
