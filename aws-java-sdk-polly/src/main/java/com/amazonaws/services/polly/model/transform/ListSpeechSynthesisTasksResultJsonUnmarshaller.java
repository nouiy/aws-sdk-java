...
/**
 * ListSpeechSynthesisTasksResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSpeechSynthesisTasksResultJsonUnmarshaller implements Unmarshaller<ListSpeechSynthesisTasksResult, JsonUnmarshallerContext> {

    public ListSpeechSynthesisTasksResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listSpeechSynthesisTasksResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
