...
public class SsmlMarksNotSupportedForTextTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SsmlMarksNotSupportedForTextTypeExceptionUnmarshaller instance;

    public static SsmlMarksNotSupportedForTextTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SsmlMarksNotSupportedForTextTypeExceptionUnmarshaller();
        return instance;
    }
}
