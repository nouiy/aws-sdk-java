...
public class UnsupportedPlsAlphabetExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedPlsAlphabetExceptionUnmarshaller instance;

    public static UnsupportedPlsAlphabetExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedPlsAlphabetExceptionUnmarshaller();
        return instance;
    }
}
