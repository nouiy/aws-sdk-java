...
public class CreateOriginRequestPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The fully qualified URI of the origin request policy just created.
     */
    ...
    public CreateOriginRequestPolicyResult withLocation(String location) {
    ...
    public CreateOriginRequestPolicyResult withETag(String eTag) {
        setETag(eTag);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateOriginRequestPolicyResult == false)
            return false;
        CreateOriginRequestPolicyResult other = (CreateOriginRequestPolicyResult) obj;
    ...
    @Override
    public CreateOriginRequestPolicyResult clone() {
        try {
            return (CreateOriginRequestPolicyResult) super.clone();
