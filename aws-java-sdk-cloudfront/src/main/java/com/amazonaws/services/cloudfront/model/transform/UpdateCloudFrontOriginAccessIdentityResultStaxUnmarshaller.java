...
/**
 * UpdateCloudFrontOriginAccessIdentityResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateCloudFrontOriginAccessIdentityResultStaxUnmarshaller implements
        Unmarshaller<UpdateCloudFrontOriginAccessIdentityResult, StaxUnmarshallerContext> {
    ...
    public UpdateCloudFrontOriginAccessIdentityResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        if (context.isStartOfDocument()) {
            ...
            updateCloudFrontOriginAccessIdentityResult.setETag(StringStaxUnmarshaller.getInstance().unmarshall(context));
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("CloudFrontOriginAccessIdentity", targetDepth)) {
                    updateCloudFrontOriginAccessIdentityResult.setCloudFrontOriginAccessIdentity(CloudFrontOriginAccessIdentityStaxUnmarshaller.getInstance()
                            .unmarshall(context));
                    continue;
                }
    ...
    public static UpdateCloudFrontOriginAccessIdentityResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateCloudFrontOriginAccessIdentityResultStaxUnmarshaller();
        return instance;
    }
}
