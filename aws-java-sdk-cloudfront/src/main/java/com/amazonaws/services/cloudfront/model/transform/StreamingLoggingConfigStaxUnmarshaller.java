...
public class StreamingLoggingConfigStaxUnmarshaller implements Unmarshaller<StreamingLoggingConfig, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Enabled", targetDepth)) {
                    streamingLoggingConfig.setEnabled(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Bucket", targetDepth)) {
                    streamingLoggingConfig.setBucket(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Prefix", targetDepth)) {
                    streamingLoggingConfig.setPrefix(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
