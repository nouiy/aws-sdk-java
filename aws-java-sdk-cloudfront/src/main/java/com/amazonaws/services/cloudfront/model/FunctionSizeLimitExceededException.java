...
public class FunctionSizeLimitExceededException extends com.amazonaws.services.cloudfront.model.AmazonCloudFrontException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new FunctionSizeLimitExceededException with the specified error message.
     *
     * @param message
