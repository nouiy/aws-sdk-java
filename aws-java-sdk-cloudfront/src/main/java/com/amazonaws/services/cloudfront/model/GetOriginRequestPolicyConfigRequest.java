...
public class GetOriginRequestPolicyConfigRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetOriginRequestPolicyConfigRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOriginRequestPolicyConfigRequest == false)
            return false;
        GetOriginRequestPolicyConfigRequest other = (GetOriginRequestPolicyConfigRequest) obj;
    ...
    @Override
    public GetOriginRequestPolicyConfigRequest clone() {
        return (GetOriginRequestPolicyConfigRequest) super.clone();
    }
