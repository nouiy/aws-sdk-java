...
/**
 * ForwardedValues StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ForwardedValuesStaxUnmarshaller implements Unmarshaller<ForwardedValues, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("QueryString", targetDepth)) {
                    forwardedValues.setQueryString(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
