...
public class LambdaFunctionAssociationStaxUnmarshaller implements Unmarshaller<LambdaFunctionAssociation, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("LambdaFunctionARN", targetDepth)) {
                    lambdaFunctionAssociation.setLambdaFunctionARN(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    private static LambdaFunctionAssociationStaxUnmarshaller instance;

    public static LambdaFunctionAssociationStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new LambdaFunctionAssociationStaxUnmarshaller();
        return instance;
    }
}
