...
/**
 * ListRealtimeLogConfigsResult StAX Unmarshaller
 */
...
public class ListRealtimeLogConfigsResultStaxUnmarshaller implements Unmarshaller<ListRealtimeLogConfigsResult, StaxUnmarshallerContext> {
    ...
    public ListRealtimeLogConfigsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("RealtimeLogConfigs", targetDepth)) {
                    listRealtimeLogConfigsResult.setRealtimeLogConfigs(RealtimeLogConfigsStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
