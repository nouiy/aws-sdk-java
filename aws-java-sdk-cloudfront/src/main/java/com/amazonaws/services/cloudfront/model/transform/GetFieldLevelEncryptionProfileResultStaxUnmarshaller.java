...
/**
 * GetFieldLevelEncryptionProfileResult StAX Unmarshaller
 */
...
public class GetFieldLevelEncryptionProfileResultStaxUnmarshaller implements Unmarshaller<GetFieldLevelEncryptionProfileResult, StaxUnmarshallerContext> {
    ...
    public GetFieldLevelEncryptionProfileResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        if (context.isStartOfDocument()) {
            ...
            getFieldLevelEncryptionProfileResult.setETag(StringStaxUnmarshaller.getInstance().unmarshall(context));
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("FieldLevelEncryptionProfile", targetDepth)) {
                    getFieldLevelEncryptionProfileResult.setFieldLevelEncryptionProfile(FieldLevelEncryptionProfileStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
