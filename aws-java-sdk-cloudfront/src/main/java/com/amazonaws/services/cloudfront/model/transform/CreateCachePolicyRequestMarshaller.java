...
/**
 * CreateCachePolicyRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateCachePolicyRequestMarshaller implements Marshaller<Request<CreateCachePolicyRequest>, CreateCachePolicyRequest> {

    public Request<CreateCachePolicyRequest> marshall(CreateCachePolicyRequest createCachePolicyRequest) {

        if (createCachePolicyRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        Request<CreateCachePolicyRequest> request = new DefaultRequest<CreateCachePolicyRequest>(createCachePolicyRequest, "AmazonCloudFront");
        ...
        try {
            ...
            CachePolicyConfig cachePolicyConfig = createCachePolicyRequest.getCachePolicyConfig();
