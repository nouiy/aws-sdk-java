 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2020-05-31/OriginRequestPolicyList" target="_top">AWS
 *      API Documentation</a>
 */
...
public class OriginRequestPolicyList implements Serializable, Cloneable {
     ...
     * that you should use in the <code>Marker</code> field of a subsequent request to continue listing origin request
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<OriginRequestPolicySummary> items;
    ...
    public java.util.List<OriginRequestPolicySummary> getItems() {
        if (items == null) {
            items = new com.amazonaws.internal.SdkInternalList<OriginRequestPolicySummary>();
        }
        return items;
    }
    ...
    public void setItems(java.util.Collection<OriginRequestPolicySummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new com.amazonaws.internal.SdkInternalList<OriginRequestPolicySummary>(items);
    }
    ...
    public OriginRequestPolicyList withItems(OriginRequestPolicySummary... items) {
        if (this.items == null) {
            setItems(new com.amazonaws.internal.SdkInternalList<OriginRequestPolicySummary>(items.length));
        }
    ...
    public OriginRequestPolicyList withItems(java.util.Collection<OriginRequestPolicySummary> items) {
        setItems(items);
        return this;
    }
