...
public class DeleteResponseHeadersPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param id
     *        The identifier for the response headers policy that you are deleting.</p>
     *        <p>
     *        To get the identifier, you can use <code>ListResponseHeadersPolicies</code>.
     */
     ...
     * </p>
     * 
     * @return The identifier for the response headers policy that you are deleting.</p>
     *         <p>
     *         To get the identifier, you can use <code>ListResponseHeadersPolicies</code>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteResponseHeadersPolicyRequest == false)
            return false;
        DeleteResponseHeadersPolicyRequest other = (DeleteResponseHeadersPolicyRequest) obj;
    ...
    public DeleteResponseHeadersPolicyRequest clone() {
        return (DeleteResponseHeadersPolicyRequest) super.clone();
    }
