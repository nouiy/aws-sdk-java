...
/**
 * OriginSslProtocols StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OriginSslProtocolsStaxUnmarshaller implements Unmarshaller<OriginSslProtocols, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    originSslProtocols.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
