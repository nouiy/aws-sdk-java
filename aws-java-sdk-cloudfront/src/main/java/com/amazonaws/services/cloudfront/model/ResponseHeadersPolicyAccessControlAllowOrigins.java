 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cloudfront-2020-05-31/ResponseHeadersPolicyAccessControlAllowOrigins"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseHeadersPolicyAccessControlAllowOrigins implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The number of origins in the list.
     */
     ...
     * </p>
     * 
     * @return The list of origins (domain names). You can specify <code>*</code> to allow all origins.
     */
    ...
    public ResponseHeadersPolicyAccessControlAllowOrigins withItems(java.util.Collection<String> items) {
        setItems(items);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResponseHeadersPolicyAccessControlAllowOrigins == false)
            return false;
        ResponseHeadersPolicyAccessControlAllowOrigins other = (ResponseHeadersPolicyAccessControlAllowOrigins) obj;
    ...
    public ResponseHeadersPolicyAccessControlAllowOrigins clone() {
        try {
            return (ResponseHeadersPolicyAccessControlAllowOrigins) super.clone();
