...
public class GetResponseHeadersPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetResponseHeadersPolicyResult withETag(String eTag) {
        setETag(eTag);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetResponseHeadersPolicyResult == false)
            return false;
        GetResponseHeadersPolicyResult other = (GetResponseHeadersPolicyResult) obj;
    ...
    @Override
    public GetResponseHeadersPolicyResult clone() {
        try {
            return (GetResponseHeadersPolicyResult) super.clone();
