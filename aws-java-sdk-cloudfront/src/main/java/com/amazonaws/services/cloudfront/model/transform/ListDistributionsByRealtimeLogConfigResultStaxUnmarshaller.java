...
/**
 * ListDistributionsByRealtimeLogConfigResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDistributionsByRealtimeLogConfigResultStaxUnmarshaller implements
        Unmarshaller<ListDistributionsByRealtimeLogConfigResult, StaxUnmarshallerContext> {

    public ListDistributionsByRealtimeLogConfigResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DistributionList", targetDepth)) {
                    listDistributionsByRealtimeLogConfigResult.setDistributionList(DistributionListStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
