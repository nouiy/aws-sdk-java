...
/**
 * OriginGroup StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OriginGroupStaxUnmarshaller implements Unmarshaller<OriginGroup, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    originGroup.setId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
