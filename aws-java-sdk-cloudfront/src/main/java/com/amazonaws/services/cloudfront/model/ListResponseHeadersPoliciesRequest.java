...
public class ListResponseHeadersPoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <li>
     * <p>
     * <code>custom</code> – Gets only the custom policies created in your Amazon Web Services account.
     * </p>
     * </li>
     * </ul>
     */
     ...
     * 
     * @param type
     *        A filter to get only the specified kind of response headers policies. Valid values are:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>managed</code> – Gets only the managed policies created by Amazon Web Services.
     ...
     * </ul>
     * 
     * @return A filter to get only the specified kind of response headers policies. Valid values are:</p>
     *         <ul>
     *         <li>
     *         <p>
     *         <code>managed</code> – Gets only the managed policies created by Amazon Web Services.
     ...
     *        the next page of the list, set this field’s value to the value of <code>NextMarker</code> from the current
     *        page’s response.
     */
