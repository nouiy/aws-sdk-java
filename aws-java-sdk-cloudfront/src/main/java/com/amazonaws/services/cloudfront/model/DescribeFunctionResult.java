...
public class DescribeFunctionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeFunctionResult withETag(String eTag) {
        setETag(eTag);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFunctionResult == false)
            return false;
        DescribeFunctionResult other = (DescribeFunctionResult) obj;
    ...
    @Override
    public DescribeFunctionResult clone() {
        try {
