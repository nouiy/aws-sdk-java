...
/**
 * OriginRequestPolicy StAX Unmarshaller
 */
...
public class OriginRequestPolicyStaxUnmarshaller implements Unmarshaller<OriginRequestPolicy, StaxUnmarshallerContext> {
    ...
    public OriginRequestPolicy unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Id", targetDepth)) {
                    originRequestPolicy.setId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("LastModifiedTime", targetDepth)) {
                    originRequestPolicy.setLastModifiedTime(DateStaxUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                    continue;
                }

                if (context.testExpression("OriginRequestPolicyConfig", targetDepth)) {
                    originRequestPolicy.setOriginRequestPolicyConfig(OriginRequestPolicyConfigStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
