...
/**
 * CachePolicyHeadersConfig StAX Unmarshaller
 */
...
public class CachePolicyHeadersConfigStaxUnmarshaller implements Unmarshaller<CachePolicyHeadersConfig, StaxUnmarshallerContext> {
    ...
    public CachePolicyHeadersConfig unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("HeaderBehavior", targetDepth)) {
                    cachePolicyHeadersConfig.setHeaderBehavior(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Headers", targetDepth)) {
                    cachePolicyHeadersConfig.setHeaders(HeadersStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
