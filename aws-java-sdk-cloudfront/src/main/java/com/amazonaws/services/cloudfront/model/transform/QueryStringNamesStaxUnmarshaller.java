...
/**
 * QueryStringNames StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class QueryStringNamesStaxUnmarshaller implements Unmarshaller<QueryStringNames, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    queryStringNames.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Items/Name", targetDepth)) {
                    queryStringNames.withItems(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
