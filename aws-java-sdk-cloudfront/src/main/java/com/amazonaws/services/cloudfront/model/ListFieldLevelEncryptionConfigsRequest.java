...
public class ListFieldLevelEncryptionConfigsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Use this when paginating results to indicate where to begin in your list of configurations. The results
     *         include configurations in the list that occur after the marker. To get the next page of results, set the
     *         <code>Marker</code> to the value of the <code>NextMarker</code> from the current page's response (which
     *         is also the ID of the last configuration on that page).
     */
    ...
    public ListFieldLevelEncryptionConfigsRequest withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public ListFieldLevelEncryptionConfigsRequest withMaxItems(String maxItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFieldLevelEncryptionConfigsRequest == false)
            return false;
        ListFieldLevelEncryptionConfigsRequest other = (ListFieldLevelEncryptionConfigsRequest) obj;
    ...
    @Override
    public ListFieldLevelEncryptionConfigsRequest clone() {
        return (ListFieldLevelEncryptionConfigsRequest) super.clone();
    }
