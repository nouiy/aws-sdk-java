...
public class ListDistributionsByCachePolicyIdResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDistributionsByCachePolicyIdResult == false)
            return false;
        ListDistributionsByCachePolicyIdResult other = (ListDistributionsByCachePolicyIdResult) obj;
    ...
    @Override
    public ListDistributionsByCachePolicyIdResult clone() {
        try {
            return (ListDistributionsByCachePolicyIdResult) super.clone();
