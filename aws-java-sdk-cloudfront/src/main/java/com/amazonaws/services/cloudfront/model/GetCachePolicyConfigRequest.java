...
public class GetCachePolicyConfigRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCachePolicyConfigRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCachePolicyConfigRequest == false)
            return false;
        GetCachePolicyConfigRequest other = (GetCachePolicyConfigRequest) obj;
    ...
    @Override
    public GetCachePolicyConfigRequest clone() {
        return (GetCachePolicyConfigRequest) super.clone();
    }
