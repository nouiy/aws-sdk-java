...
public class GetOriginRequestPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetOriginRequestPolicyRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetOriginRequestPolicyRequest == false)
            return false;
        GetOriginRequestPolicyRequest other = (GetOriginRequestPolicyRequest) obj;
    ...
    @Override
    public GetOriginRequestPolicyRequest clone() {
        return (GetOriginRequestPolicyRequest) super.clone();
    }
