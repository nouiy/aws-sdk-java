...
public class CustomErrorResponsesStaxUnmarshaller implements Unmarshaller<CustomErrorResponses, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Quantity", targetDepth)) {
                    customErrorResponses.setQuantity(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static CustomErrorResponsesStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomErrorResponsesStaxUnmarshaller();
        return instance;
    }
}
