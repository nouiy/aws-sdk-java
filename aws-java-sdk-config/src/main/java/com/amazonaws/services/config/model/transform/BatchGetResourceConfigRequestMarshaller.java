...
public class BatchGetResourceConfigRequestMarshaller {
    ...
    private static final BatchGetResourceConfigRequestMarshaller instance = new BatchGetResourceConfigRequestMarshaller();

    public static BatchGetResourceConfigRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(BatchGetResourceConfigRequest batchGetResourceConfigRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(batchGetResourceConfigRequest.getResourceKeys(), RESOURCEKEYS_BINDING);
        } catch (Exception e) {
