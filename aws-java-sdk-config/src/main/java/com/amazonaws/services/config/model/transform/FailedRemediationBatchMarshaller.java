...
/**
 * FailedRemediationBatchMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FailedRemediationBatchMarshaller {
    ...
    private static final FailedRemediationBatchMarshaller instance = new FailedRemediationBatchMarshaller();

    public static FailedRemediationBatchMarshaller getInstance() {
        return instance;
    }
