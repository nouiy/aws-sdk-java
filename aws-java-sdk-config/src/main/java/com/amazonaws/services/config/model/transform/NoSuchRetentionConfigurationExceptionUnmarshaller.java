...
public class NoSuchRetentionConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchRetentionConfigurationExceptionUnmarshaller instance;

    public static NoSuchRetentionConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchRetentionConfigurationExceptionUnmarshaller();
        return instance;
    }
}
