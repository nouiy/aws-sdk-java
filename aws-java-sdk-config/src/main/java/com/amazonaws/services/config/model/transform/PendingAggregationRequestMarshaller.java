...
/**
 * PendingAggregationRequestMarshaller
 */
...
public class PendingAggregationRequestMarshaller {
    ...
    public void marshall(PendingAggregationRequest pendingAggregationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        if (pendingAggregationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(pendingAggregationRequest.getRequesterAccountId(), REQUESTERACCOUNTID_BINDING);
            protocolMarshaller.marshall(pendingAggregationRequest.getRequesterAwsRegion(), REQUESTERAWSREGION_BINDING);
        } catch (Exception e) {
