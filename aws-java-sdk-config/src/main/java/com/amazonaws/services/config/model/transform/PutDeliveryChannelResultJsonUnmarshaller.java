...
public class PutDeliveryChannelResultJsonUnmarshaller implements Unmarshaller<PutDeliveryChannelResult, JsonUnmarshallerContext> {
    ...
    public PutDeliveryChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutDeliveryChannelResult putDeliveryChannelResult = new PutDeliveryChannelResult();
