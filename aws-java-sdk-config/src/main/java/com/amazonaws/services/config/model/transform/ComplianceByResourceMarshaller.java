...
public class ComplianceByResourceMarshaller {
    ...
    public void marshall(ComplianceByResource complianceByResource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(complianceByResource.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(complianceByResource.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(complianceByResource.getCompliance(), COMPLIANCE_BINDING);
        } catch (Exception e) {
