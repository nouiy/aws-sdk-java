...
public class NoSuchConfigRuleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchConfigRuleExceptionUnmarshaller instance;

    public static NoSuchConfigRuleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchConfigRuleExceptionUnmarshaller();
        return instance;
    }
}
