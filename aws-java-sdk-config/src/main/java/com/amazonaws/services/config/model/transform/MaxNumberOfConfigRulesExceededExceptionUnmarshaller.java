...
public class MaxNumberOfConfigRulesExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxNumberOfConfigRulesExceededExceptionUnmarshaller instance;

    public static MaxNumberOfConfigRulesExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxNumberOfConfigRulesExceededExceptionUnmarshaller();
        return instance;
    }
}
