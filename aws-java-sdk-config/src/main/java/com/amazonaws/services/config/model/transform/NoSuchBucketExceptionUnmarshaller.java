...
public class NoSuchBucketExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchBucketExceptionUnmarshaller instance;

    public static NoSuchBucketExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchBucketExceptionUnmarshaller();
        return instance;
    }
}
