...
public class LastDeliveryChannelDeleteFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LastDeliveryChannelDeleteFailedExceptionUnmarshaller instance;

    public static LastDeliveryChannelDeleteFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LastDeliveryChannelDeleteFailedExceptionUnmarshaller();
        return instance;
    }
}
