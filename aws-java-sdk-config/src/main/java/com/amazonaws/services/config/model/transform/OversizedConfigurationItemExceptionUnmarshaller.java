...
public class OversizedConfigurationItemExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OversizedConfigurationItemExceptionUnmarshaller instance;

    public static OversizedConfigurationItemExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OversizedConfigurationItemExceptionUnmarshaller();
        return instance;
    }
}
