...
public class DescribeConformancePacksRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeConformancePacksRequest withConformancePackNames(java.util.Collection<String> conformancePackNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeConformancePacksRequest == false)
            return false;
    ...
    public DescribeConformancePacksRequest clone() {
        return (DescribeConformancePacksRequest) super.clone();
    }
