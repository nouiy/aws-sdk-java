...
public class StartConfigRulesEvaluationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartConfigRulesEvaluationResult == false)
            return false;
        StartConfigRulesEvaluationResult other = (StartConfigRulesEvaluationResult) obj;
        return true;
    }
    ...
    @Override
    public StartConfigRulesEvaluationResult clone() {
        try {
            return (StartConfigRulesEvaluationResult) super.clone();
