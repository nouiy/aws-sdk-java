...
public class ConfigurationRecorderJsonUnmarshaller implements Unmarshaller<ConfigurationRecorder, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    configurationRecorder.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("roleARN", targetDepth)) {
                    context.nextToken();
                    configurationRecorder.setRoleARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ConfigurationRecorderJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConfigurationRecorderJsonUnmarshaller();
        return instance;
    }
}
