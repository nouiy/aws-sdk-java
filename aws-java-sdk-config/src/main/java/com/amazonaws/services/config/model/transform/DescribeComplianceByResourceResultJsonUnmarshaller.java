...
public class DescribeComplianceByResourceResultJsonUnmarshaller implements Unmarshaller<DescribeComplianceByResourceResult, JsonUnmarshallerContext> {

    public DescribeComplianceByResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeComplianceByResourceResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
