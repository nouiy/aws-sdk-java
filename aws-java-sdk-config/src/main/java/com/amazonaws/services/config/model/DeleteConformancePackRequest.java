...
public class DeleteConformancePackRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Name of the conformance pack you want to delete.
     */
    ...
    public String toString() {
        ...
        if (getConformancePackName() != null)
            sb.append("ConformancePackName: ").append(getConformancePackName());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteConformancePackRequest == false)
            return false;
        DeleteConformancePackRequest other = (DeleteConformancePackRequest) obj;
    ...
    @Override
    public DeleteConformancePackRequest clone() {
        return (DeleteConformancePackRequest) super.clone();
    }
