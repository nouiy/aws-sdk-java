...
public class InvalidLimitExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidLimitExceptionUnmarshaller instance;

    public static InvalidLimitExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidLimitExceptionUnmarshaller();
        return instance;
    }
}
