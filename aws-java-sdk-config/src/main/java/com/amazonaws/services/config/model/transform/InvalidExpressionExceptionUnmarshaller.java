...
public class InvalidExpressionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidExpressionExceptionUnmarshaller instance;

    public static InvalidExpressionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidExpressionExceptionUnmarshaller();
        return instance;
    }
}
