...
public class OrganizationAllFeaturesNotEnabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OrganizationAllFeaturesNotEnabledExceptionUnmarshaller instance;

    public static OrganizationAllFeaturesNotEnabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OrganizationAllFeaturesNotEnabledExceptionUnmarshaller();
        return instance;
    }
}
