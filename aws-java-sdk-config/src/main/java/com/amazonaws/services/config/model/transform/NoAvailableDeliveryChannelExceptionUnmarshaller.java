...
public class NoAvailableDeliveryChannelExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoAvailableDeliveryChannelExceptionUnmarshaller instance;

    public static NoAvailableDeliveryChannelExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoAvailableDeliveryChannelExceptionUnmarshaller();
        return instance;
    }
}
