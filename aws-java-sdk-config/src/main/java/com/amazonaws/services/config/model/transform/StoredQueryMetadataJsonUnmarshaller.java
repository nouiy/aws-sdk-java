...
/**
 * StoredQueryMetadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StoredQueryMetadataJsonUnmarshaller implements Unmarshaller<StoredQueryMetadata, JsonUnmarshallerContext> {

    public StoredQueryMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        StoredQueryMetadata storedQueryMetadata = new StoredQueryMetadata();
    ...
    private static StoredQueryMetadataJsonUnmarshaller instance;

    public static StoredQueryMetadataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StoredQueryMetadataJsonUnmarshaller();
        return instance;
    }
}
