...
public class InvalidConfigurationRecorderNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidConfigurationRecorderNameExceptionUnmarshaller instance;

    public static InvalidConfigurationRecorderNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidConfigurationRecorderNameExceptionUnmarshaller();
        return instance;
    }
}
