...
public class MaxNumberOfRetentionConfigurationsExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxNumberOfRetentionConfigurationsExceededExceptionUnmarshaller instance;

    public static MaxNumberOfRetentionConfigurationsExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxNumberOfRetentionConfigurationsExceededExceptionUnmarshaller();
        return instance;
    }
}
