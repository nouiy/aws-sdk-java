...
public class QueryInfoMarshaller {
    ...
    private static final MarshallingInfo<List> SELECTFIELDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("SelectFields").build();
