...
public class MaxNumberOfDeliveryChannelsExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MaxNumberOfDeliveryChannelsExceededExceptionUnmarshaller instance;

    public static MaxNumberOfDeliveryChannelsExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxNumberOfDeliveryChannelsExceededExceptionUnmarshaller();
        return instance;
    }
}
