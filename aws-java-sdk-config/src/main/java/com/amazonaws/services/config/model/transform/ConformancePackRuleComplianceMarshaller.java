...
/**
 * ConformancePackRuleComplianceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ConformancePackRuleComplianceMarshaller {
    ...
    public static ConformancePackRuleComplianceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ConformancePackRuleCompliance conformancePackRuleCompliance, ProtocolMarshaller protocolMarshaller) {

        if (conformancePackRuleCompliance == null) {
