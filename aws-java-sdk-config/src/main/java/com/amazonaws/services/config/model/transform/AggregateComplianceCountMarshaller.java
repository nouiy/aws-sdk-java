...
/**
 * AggregateComplianceCountMarshaller
 */
...
public class AggregateComplianceCountMarshaller {
    ...
    public void marshall(AggregateComplianceCount aggregateComplianceCount, ProtocolMarshaller protocolMarshaller) {
        ...
        if (aggregateComplianceCount == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(aggregateComplianceCount.getGroupName(), GROUPNAME_BINDING);
            protocolMarshaller.marshall(aggregateComplianceCount.getComplianceSummary(), COMPLIANCESUMMARY_BINDING);
        } catch (Exception e) {
