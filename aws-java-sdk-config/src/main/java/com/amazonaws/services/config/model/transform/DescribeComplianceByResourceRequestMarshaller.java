...
/**
 * DescribeComplianceByResourceRequestMarshaller
 */
...
public class DescribeComplianceByResourceRequestMarshaller {
    ...
    private static final DescribeComplianceByResourceRequestMarshaller instance = new DescribeComplianceByResourceRequestMarshaller();

    public static DescribeComplianceByResourceRequestMarshaller getInstance() {
        return instance;
    }
