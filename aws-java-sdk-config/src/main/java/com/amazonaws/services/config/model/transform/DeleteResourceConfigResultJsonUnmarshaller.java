...
/**
 * DeleteResourceConfigResult JSON Unmarshaller
 */
...
public class DeleteResourceConfigResultJsonUnmarshaller implements Unmarshaller<DeleteResourceConfigResult, JsonUnmarshallerContext> {
    ...
    public DeleteResourceConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteResourceConfigResult deleteResourceConfigResult = new DeleteResourceConfigResult();
