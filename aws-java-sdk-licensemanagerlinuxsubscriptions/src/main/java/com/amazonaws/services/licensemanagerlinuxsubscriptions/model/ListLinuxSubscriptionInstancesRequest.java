...
public class ListLinuxSubscriptionInstancesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLinuxSubscriptionInstancesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLinuxSubscriptionInstancesRequest == false)
            return false;
        ListLinuxSubscriptionInstancesRequest other = (ListLinuxSubscriptionInstancesRequest) obj;
    ...
    public ListLinuxSubscriptionInstancesRequest clone() {
        return (ListLinuxSubscriptionInstancesRequest) super.clone();
    }
