...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ResourceNotFoundException(
                null);
