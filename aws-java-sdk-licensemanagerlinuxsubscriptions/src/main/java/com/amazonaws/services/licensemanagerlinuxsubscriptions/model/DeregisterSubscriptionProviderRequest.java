...
public class DeregisterSubscriptionProviderRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeregisterSubscriptionProviderRequest withSubscriptionProviderArn(String subscriptionProviderArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeregisterSubscriptionProviderRequest == false)
            return false;
    ...
    @Override
    public DeregisterSubscriptionProviderRequest clone() {
