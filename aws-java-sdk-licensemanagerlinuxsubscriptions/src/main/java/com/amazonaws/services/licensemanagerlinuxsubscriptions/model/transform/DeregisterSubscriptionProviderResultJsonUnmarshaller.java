...
/**
 * DeregisterSubscriptionProviderResult JSON Unmarshaller
 */
...
public class DeregisterSubscriptionProviderResultJsonUnmarshaller implements Unmarshaller<DeregisterSubscriptionProviderResult, JsonUnmarshallerContext> {
    ...
    public DeregisterSubscriptionProviderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterSubscriptionProviderResult deregisterSubscriptionProviderResult = new DeregisterSubscriptionProviderResult();

        return deregisterSubscriptionProviderResult;
    }
