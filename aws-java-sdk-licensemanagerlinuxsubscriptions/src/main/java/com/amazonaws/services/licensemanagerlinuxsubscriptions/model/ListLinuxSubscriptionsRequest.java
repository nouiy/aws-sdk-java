...
public class ListLinuxSubscriptionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * An array of structures that you can use to filter the results to those that match one or more sets of key-value
     * pairs that you specify. For example, you can filter by the name of <code>Subscription</code> with an optional
     ...
     *         key-value pairs that you specify. For example, you can filter by the name of <code>Subscription</code>
     *         with an optional operator to see subscriptions that match, partially match, or don't match a certain
     *         subscription's name.</p>
     *         <p>
     *         The valid names for this filter are:
     *         </p>
     *         <ul>
    ...
    public ListLinuxSubscriptionsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLinuxSubscriptionsRequest == false)
            return false;
        ListLinuxSubscriptionsRequest other = (ListLinuxSubscriptionsRequest) obj;
    ...
    public ListLinuxSubscriptionsRequest clone() {
        return (ListLinuxSubscriptionsRequest) super.clone();
    }
