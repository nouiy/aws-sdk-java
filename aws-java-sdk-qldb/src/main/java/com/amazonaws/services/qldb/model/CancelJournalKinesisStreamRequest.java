...
public class CancelJournalKinesisStreamRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public CancelJournalKinesisStreamRequest clone() {
        return (CancelJournalKinesisStreamRequest) super.clone();
    }
