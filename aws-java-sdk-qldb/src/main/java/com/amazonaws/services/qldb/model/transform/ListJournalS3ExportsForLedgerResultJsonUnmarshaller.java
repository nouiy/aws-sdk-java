...
/**
 * ListJournalS3ExportsForLedgerResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListJournalS3ExportsForLedgerResultJsonUnmarshaller implements Unmarshaller<ListJournalS3ExportsForLedgerResult, JsonUnmarshallerContext> {

    public ListJournalS3ExportsForLedgerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
