...
/**
 * DescribeJournalS3ExportResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeJournalS3ExportResultJsonUnmarshaller implements Unmarshaller<DescribeJournalS3ExportResult, JsonUnmarshallerContext> {

    public DescribeJournalS3ExportResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ExportDescription", targetDepth)) {
                    context.nextToken();
                    describeJournalS3ExportResult.setExportDescription(JournalS3ExportDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
