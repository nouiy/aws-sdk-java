        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Proof", targetDepth)) {
                    context.nextToken();
                    getRevisionResult.setProof(ValueHolderJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Revision", targetDepth)) {
                    context.nextToken();
                    getRevisionResult.setRevision(ValueHolderJsonUnmarshaller.getInstance().unmarshall(context));
                }
