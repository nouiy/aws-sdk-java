...
public class DeleteLedgerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the ledger that you want to delete.
     */
    ...
    @Override
    public DeleteLedgerRequest clone() {
        return (DeleteLedgerRequest) super.clone();
    }
