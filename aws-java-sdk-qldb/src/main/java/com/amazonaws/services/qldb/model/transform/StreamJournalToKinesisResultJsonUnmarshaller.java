...
/**
 * StreamJournalToKinesisResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StreamJournalToKinesisResultJsonUnmarshaller implements Unmarshaller<StreamJournalToKinesisResult, JsonUnmarshallerContext> {

    public StreamJournalToKinesisResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamId", targetDepth)) {
                    context.nextToken();
                    streamJournalToKinesisResult.setStreamId(context.getUnmarshaller(String.class).unmarshall(context));
                }
