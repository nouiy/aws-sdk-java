...
public class UpdateLedgerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateLedgerResult withCreationDateTime(java.util.Date creationDateTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLedgerResult == false)
            return false;
        UpdateLedgerResult other = (UpdateLedgerResult) obj;
    ...
    public UpdateLedgerResult clone() {
        try {
            return (UpdateLedgerResult) super.clone();
