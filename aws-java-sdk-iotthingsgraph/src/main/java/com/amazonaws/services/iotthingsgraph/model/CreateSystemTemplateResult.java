...
public class CreateSystemTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSystemTemplateResult == false)
            return false;
        CreateSystemTemplateResult other = (CreateSystemTemplateResult) obj;
    ...
    @Override
    public CreateSystemTemplateResult clone() {
        try {
            return (CreateSystemTemplateResult) super.clone();
