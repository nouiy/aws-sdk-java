...
public class CreateFlowTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateFlowTemplateResult == false)
            return false;
        CreateFlowTemplateResult other = (CreateFlowTemplateResult) obj;
    ...
    @Override
    public CreateFlowTemplateResult clone() {
        try {
            return (CreateFlowTemplateResult) super.clone();
