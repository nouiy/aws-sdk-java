...
public class GetSystemTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param id
     *        The ID of the system to get. This ID must be in the user's namespace.</p>
     *        <p>
     *        The ID should be in the following format.
     *        </p>
     *        <p>
     ...
     * </p>
     * 
     * @return The ID of the system to get. This ID must be in the user's namespace.</p>
     *         <p>
     *         The ID should be in the following format.
     *         </p>
     *         <p>
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSystemTemplateRequest == false)
            return false;
        GetSystemTemplateRequest other = (GetSystemTemplateRequest) obj;
    ...
    public GetSystemTemplateRequest clone() {
        return (GetSystemTemplateRequest) super.clone();
    }
