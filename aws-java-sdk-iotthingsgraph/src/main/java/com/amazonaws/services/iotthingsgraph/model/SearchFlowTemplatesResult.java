...
public class SearchFlowTemplatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of objects that contain summary information about each workflow in the result set.
     */
    ...
    public SearchFlowTemplatesResult withSummaries(FlowTemplateSummary... summaries) {
    ...
    public SearchFlowTemplatesResult withSummaries(java.util.Collection<FlowTemplateSummary> summaries) {
    ...
    public SearchFlowTemplatesResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchFlowTemplatesResult == false)
            return false;
        SearchFlowTemplatesResult other = (SearchFlowTemplatesResult) obj;
    ...
    public SearchFlowTemplatesResult clone() {
        try {
            return (SearchFlowTemplatesResult) super.clone();
