...
/**
 * AssociateEntityToThingResult JSON Unmarshaller
 */
...
public class AssociateEntityToThingResultJsonUnmarshaller implements Unmarshaller<AssociateEntityToThingResult, JsonUnmarshallerContext> {
    ...
    public AssociateEntityToThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateEntityToThingResult associateEntityToThingResult = new AssociateEntityToThingResult();

        return associateEntityToThingResult;
    }
