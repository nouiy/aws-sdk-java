...
public class DissociateEntityFromThingRequestMarshaller {
    ...
    private static final DissociateEntityFromThingRequestMarshaller instance = new DissociateEntityFromThingRequestMarshaller();

    public static DissociateEntityFromThingRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DissociateEntityFromThingRequest dissociateEntityFromThingRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dissociateEntityFromThingRequest.getThingName(), THINGNAME_BINDING);
            protocolMarshaller.marshall(dissociateEntityFromThingRequest.getEntityType(), ENTITYTYPE_BINDING);
        } catch (Exception e) {
