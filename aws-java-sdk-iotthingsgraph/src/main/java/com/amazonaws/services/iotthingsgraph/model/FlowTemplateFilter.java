 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotthingsgraph-2018-09-06/FlowTemplateFilter" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FlowTemplateFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public FlowTemplateFilter withValue(java.util.Collection<String> value) {
        setValue(value);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FlowTemplateFilter == false)
            return false;
        FlowTemplateFilter other = (FlowTemplateFilter) obj;
    ...
    public FlowTemplateFilter clone() {
        try {
            return (FlowTemplateFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotthingsgraph.model.transform.FlowTemplateFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
