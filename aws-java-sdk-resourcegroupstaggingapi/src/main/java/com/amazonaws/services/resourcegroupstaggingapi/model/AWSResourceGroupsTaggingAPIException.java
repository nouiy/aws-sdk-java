...
public class AWSResourceGroupsTaggingAPIException extends com.amazonaws.AmazonServiceException {
     ...
     */
    public AWSResourceGroupsTaggingAPIException(String message) {
        super(message);
    }
