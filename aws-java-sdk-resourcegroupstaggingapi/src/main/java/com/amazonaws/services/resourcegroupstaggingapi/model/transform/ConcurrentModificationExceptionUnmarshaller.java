...
public class ConcurrentModificationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConcurrentModificationExceptionUnmarshaller() {
        super(com.amazonaws.services.resourcegroupstaggingapi.model.ConcurrentModificationException.class, "ConcurrentModificationException");
    }

    @Override
    public com.amazonaws.services.resourcegroupstaggingapi.model.ConcurrentModificationException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.resourcegroupstaggingapi.model.ConcurrentModificationException concurrentModificationException = new com.amazonaws.services.resourcegroupstaggingapi.model.ConcurrentModificationException(
                null);
