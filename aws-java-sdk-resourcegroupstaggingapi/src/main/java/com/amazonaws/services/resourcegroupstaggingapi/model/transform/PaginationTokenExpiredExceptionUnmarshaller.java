...
public class PaginationTokenExpiredExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PaginationTokenExpiredExceptionUnmarshaller instance;

    public static PaginationTokenExpiredExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PaginationTokenExpiredExceptionUnmarshaller();
        return instance;
    }
}
