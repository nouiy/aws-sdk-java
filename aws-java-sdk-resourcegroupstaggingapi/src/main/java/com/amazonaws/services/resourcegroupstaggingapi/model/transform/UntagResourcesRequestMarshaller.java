...
/**
 * UntagResourcesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UntagResourcesRequestMarshaller {
    ...
    private static final UntagResourcesRequestMarshaller instance = new UntagResourcesRequestMarshaller();

    public static UntagResourcesRequestMarshaller getInstance() {
        return instance;
    }
