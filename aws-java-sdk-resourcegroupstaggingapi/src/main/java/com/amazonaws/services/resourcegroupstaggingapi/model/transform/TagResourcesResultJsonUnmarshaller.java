...
/**
 * TagResourcesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagResourcesResultJsonUnmarshaller implements Unmarshaller<TagResourcesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FailedResourcesMap", targetDepth)) {
                    context.nextToken();
                    tagResourcesResult.setFailedResourcesMap(new MapUnmarshaller<String, FailureInfo>(context.getUnmarshaller(String.class),
