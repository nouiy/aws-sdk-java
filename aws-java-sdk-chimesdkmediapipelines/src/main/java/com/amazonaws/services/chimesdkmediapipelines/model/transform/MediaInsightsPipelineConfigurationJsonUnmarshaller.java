...
/**
 * MediaInsightsPipelineConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MediaInsightsPipelineConfigurationJsonUnmarshaller implements Unmarshaller<MediaInsightsPipelineConfiguration, JsonUnmarshallerContext> {

    public MediaInsightsPipelineConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        MediaInsightsPipelineConfiguration mediaInsightsPipelineConfiguration = new MediaInsightsPipelineConfiguration();
    ...
    private static MediaInsightsPipelineConfigurationJsonUnmarshaller instance;

    public static MediaInsightsPipelineConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MediaInsightsPipelineConfigurationJsonUnmarshaller();
        return instance;
    }
}
