        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamArn", targetDepth)) {
                    context.nextToken();
                    streamConfiguration.setStreamArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FragmentNumber", targetDepth)) {
                    context.nextToken();
                    streamConfiguration.setFragmentNumber(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("StreamChannelDefinition", targetDepth)) {
                    context.nextToken();
                    streamConfiguration.setStreamChannelDefinition(StreamChannelDefinitionJsonUnmarshaller.getInstance().unmarshall(context));
                }
