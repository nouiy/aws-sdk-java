...
public class InvalidInputExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InvalidInputExceptionUnmarshaller() {
        super(com.amazonaws.services.migrationhub.model.InvalidInputException.class, "InvalidInputException");
    }

    @Override
    public com.amazonaws.services.migrationhub.model.InvalidInputException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.migrationhub.model.InvalidInputException invalidInputException = new com.amazonaws.services.migrationhub.model.InvalidInputException(
                null);
