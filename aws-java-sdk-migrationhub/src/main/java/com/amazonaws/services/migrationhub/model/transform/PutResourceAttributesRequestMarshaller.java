...
/**
 * PutResourceAttributesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutResourceAttributesRequestMarshaller {
    ...
    private static final PutResourceAttributesRequestMarshaller instance = new PutResourceAttributesRequestMarshaller();

    public static PutResourceAttributesRequestMarshaller getInstance() {
        return instance;
    }
