...
/**
 * CreatedArtifact JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreatedArtifactJsonUnmarshaller implements Unmarshaller<CreatedArtifact, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    createdArtifact.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Description", targetDepth)) {
                    context.nextToken();
                    createdArtifact.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
