...
/**
 * ListCreatedArtifactsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCreatedArtifactsResultJsonUnmarshaller implements Unmarshaller<ListCreatedArtifactsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listCreatedArtifactsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
