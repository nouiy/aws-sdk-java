...
public class TaskMarshaller {
    ...
    public void marshall(Task task, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(task.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(task.getStatusDetail(), STATUSDETAIL_BINDING);
            protocolMarshaller.marshall(task.getProgressPercent(), PROGRESSPERCENT_BINDING);
        } catch (Exception e) {
