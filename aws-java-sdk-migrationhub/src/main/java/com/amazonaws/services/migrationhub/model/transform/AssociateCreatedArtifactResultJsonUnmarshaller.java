...
/**
 * AssociateCreatedArtifactResult JSON Unmarshaller
 */
...
public class AssociateCreatedArtifactResultJsonUnmarshaller implements Unmarshaller<AssociateCreatedArtifactResult, JsonUnmarshallerContext> {
    ...
    public AssociateCreatedArtifactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateCreatedArtifactResult associateCreatedArtifactResult = new AssociateCreatedArtifactResult();
