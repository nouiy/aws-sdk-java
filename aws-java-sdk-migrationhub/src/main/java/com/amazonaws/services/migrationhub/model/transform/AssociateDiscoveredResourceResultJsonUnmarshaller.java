...
/**
 * AssociateDiscoveredResourceResult JSON Unmarshaller
 */
...
public class AssociateDiscoveredResourceResultJsonUnmarshaller implements Unmarshaller<AssociateDiscoveredResourceResult, JsonUnmarshallerContext> {
    ...
    public AssociateDiscoveredResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateDiscoveredResourceResult associateDiscoveredResourceResult = new AssociateDiscoveredResourceResult();
