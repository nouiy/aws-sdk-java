...
public class CreateContactRequestMarshaller {
    ...
    public void marshall(CreateContactRequest createContactRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createContactRequest.getAlias(), ALIAS_BINDING);
            protocolMarshaller.marshall(createContactRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(createContactRequest.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(createContactRequest.getPlan(), PLAN_BINDING);
            protocolMarshaller.marshall(createContactRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createContactRequest.getIdempotencyToken(), IDEMPOTENCYTOKEN_BINDING);
        } catch (Exception e) {
