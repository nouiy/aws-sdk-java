...
public class CreateContactChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getContactChannelArn() != null)
            sb.append("ContactChannelArn: ").append(getContactChannelArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateContactChannelResult == false)
            return false;
        CreateContactChannelResult other = (CreateContactChannelResult) obj;
    ...
    public CreateContactChannelResult clone() {
        try {
            return (CreateContactChannelResult) super.clone();
