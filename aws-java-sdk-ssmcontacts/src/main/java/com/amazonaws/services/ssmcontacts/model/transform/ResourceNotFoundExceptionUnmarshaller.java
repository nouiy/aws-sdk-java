...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.ssmcontacts.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.ssmcontacts.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ssmcontacts.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.ssmcontacts.model.ResourceNotFoundException(
                null);
