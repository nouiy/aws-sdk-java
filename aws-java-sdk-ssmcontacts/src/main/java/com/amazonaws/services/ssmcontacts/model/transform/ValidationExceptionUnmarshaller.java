...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.ssmcontacts.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.ssmcontacts.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ssmcontacts.model.ValidationException validationException = new com.amazonaws.services.ssmcontacts.model.ValidationException(
                null);
