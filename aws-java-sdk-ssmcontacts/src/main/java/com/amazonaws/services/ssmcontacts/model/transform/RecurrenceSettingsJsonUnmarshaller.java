...
/**
 * RecurrenceSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RecurrenceSettingsJsonUnmarshaller implements Unmarshaller<RecurrenceSettings, JsonUnmarshallerContext> {

    public RecurrenceSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        RecurrenceSettings recurrenceSettings = new RecurrenceSettings();
    ...
    private static RecurrenceSettingsJsonUnmarshaller instance;

    public static RecurrenceSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RecurrenceSettingsJsonUnmarshaller();
        return instance;
    }
}
