...
/**
 * HandOffTimeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HandOffTimeMarshaller {
    ...
    private static final HandOffTimeMarshaller instance = new HandOffTimeMarshaller();

    public static HandOffTimeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HandOffTime handOffTime, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(handOffTime.getHourOfDay(), HOUROFDAY_BINDING);
            protocolMarshaller.marshall(handOffTime.getMinuteOfHour(), MINUTEOFHOUR_BINDING);
        } catch (Exception e) {
