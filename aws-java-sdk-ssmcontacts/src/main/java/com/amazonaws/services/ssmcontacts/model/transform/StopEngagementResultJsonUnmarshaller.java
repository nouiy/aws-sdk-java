...
/**
 * StopEngagementResult JSON Unmarshaller
 */
...
public class StopEngagementResultJsonUnmarshaller implements Unmarshaller<StopEngagementResult, JsonUnmarshallerContext> {
    ...
    public StopEngagementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopEngagementResult stopEngagementResult = new StopEngagementResult();
