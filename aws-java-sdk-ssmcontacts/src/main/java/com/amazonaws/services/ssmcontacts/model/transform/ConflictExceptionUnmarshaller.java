...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.ssmcontacts.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.ssmcontacts.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ssmcontacts.model.ConflictException conflictException = new com.amazonaws.services.ssmcontacts.model.ConflictException(null);
