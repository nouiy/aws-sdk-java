...
public class ListContactsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> ALIASPREFIX_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AliasPrefix").build();
    ...
    public void marshall(ListContactsRequest listContactsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listContactsRequest.getAliasPrefix(), ALIASPREFIX_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getType(), TYPE_BINDING);
        } catch (Exception e) {
