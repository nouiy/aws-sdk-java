...
public class GetRotationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the on-call rotation to retrieve information about.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRotationRequest == false)
            return false;
        GetRotationRequest other = (GetRotationRequest) obj;
    ...
    @Override
    public GetRotationRequest clone() {
        return (GetRotationRequest) super.clone();
    }
