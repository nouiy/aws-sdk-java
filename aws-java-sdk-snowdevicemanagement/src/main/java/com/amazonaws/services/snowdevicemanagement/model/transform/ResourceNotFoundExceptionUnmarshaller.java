...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.snowdevicemanagement.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.snowdevicemanagement.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.snowdevicemanagement.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.snowdevicemanagement.model.ResourceNotFoundException(
                null);
