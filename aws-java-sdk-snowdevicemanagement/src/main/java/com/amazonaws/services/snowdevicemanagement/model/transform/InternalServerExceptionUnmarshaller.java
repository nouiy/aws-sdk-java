...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.snowdevicemanagement.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.snowdevicemanagement.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.snowdevicemanagement.model.InternalServerException internalServerException = new com.amazonaws.services.snowdevicemanagement.model.InternalServerException(
                null);
