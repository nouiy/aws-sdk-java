...
/**
 * SecurityGroupIdentifierMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SecurityGroupIdentifierMarshaller {
    ...
    private static final SecurityGroupIdentifierMarshaller instance = new SecurityGroupIdentifierMarshaller();

    public static SecurityGroupIdentifierMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SecurityGroupIdentifier securityGroupIdentifier, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(securityGroupIdentifier.getGroupId(), GROUPID_BINDING);
            protocolMarshaller.marshall(securityGroupIdentifier.getGroupName(), GROUPNAME_BINDING);
        } catch (Exception e) {
