...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.snowdevicemanagement.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.snowdevicemanagement.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.snowdevicemanagement.model.ThrottlingException throttlingException = new com.amazonaws.services.snowdevicemanagement.model.ThrottlingException(
                null);
