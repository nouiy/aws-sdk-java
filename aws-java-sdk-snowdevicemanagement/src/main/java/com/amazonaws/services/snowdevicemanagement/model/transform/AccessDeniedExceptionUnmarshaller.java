...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.snowdevicemanagement.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.snowdevicemanagement.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.snowdevicemanagement.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.snowdevicemanagement.model.AccessDeniedException(
                null);
