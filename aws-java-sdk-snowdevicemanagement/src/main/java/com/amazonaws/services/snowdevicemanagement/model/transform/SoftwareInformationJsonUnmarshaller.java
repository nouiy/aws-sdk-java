...
/**
 * SoftwareInformation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SoftwareInformationJsonUnmarshaller implements Unmarshaller<SoftwareInformation, JsonUnmarshallerContext> {

    public SoftwareInformation unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SoftwareInformationJsonUnmarshaller instance;

    public static SoftwareInformationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SoftwareInformationJsonUnmarshaller();
        return instance;
    }
}
