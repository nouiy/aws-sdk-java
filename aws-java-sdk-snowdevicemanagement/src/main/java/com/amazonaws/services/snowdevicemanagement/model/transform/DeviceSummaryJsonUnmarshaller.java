        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("associatedWithJob", targetDepth)) {
                    context.nextToken();
                    deviceSummary.setAssociatedWithJob(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("managedDeviceArn", targetDepth)) {
                    context.nextToken();
                    deviceSummary.setManagedDeviceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("managedDeviceId", targetDepth)) {
                    context.nextToken();
                    deviceSummary.setManagedDeviceId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("tags", targetDepth)) {
                    context.nextToken();
                    deviceSummary.setTags(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
