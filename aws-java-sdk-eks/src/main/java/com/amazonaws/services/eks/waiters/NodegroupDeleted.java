...
class NodegroupDeleted {
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<DescribeNodegroupResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("nodegroup"), new JmesPathField("status"));
         ...
         */
        @Override
        public boolean matches(DescribeNodegroupResult result) {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeNodegroupResult> {
        /**
