...
class ClusterDeleted {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeClusterResult> {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsPENDINGMatcher extends WaiterAcceptor<DescribeClusterResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeClusterResult> {
        /**
