...
/**
 * DescribeAddonVersionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeAddonVersionsRequestMarshaller {

    private static final MarshallingInfo<String> KUBERNETESVERSION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("kubernetesVersion").build();
    ...
    public static DescribeAddonVersionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeAddonVersionsRequest describeAddonVersionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeAddonVersionsRequest.getKubernetesVersion(), KUBERNETESVERSION_BINDING);
