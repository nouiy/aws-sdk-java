...
public class ResourceInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceInUseExceptionUnmarshaller() {
        super(com.amazonaws.services.eks.model.ResourceInUseException.class, "ResourceInUseException");
    }

    @Override
    public com.amazonaws.services.eks.model.ResourceInUseException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.eks.model.ResourceInUseException resourceInUseException = new com.amazonaws.services.eks.model.ResourceInUseException(null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("clusterName", targetDepth)) {
                    context.nextToken();
                    resourceInUseException.setClusterName(context.getUnmarshaller(String.class).unmarshall(context));
                }
