...
class NodegroupActive {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeNodegroupResult> {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeNodegroupResult> {
        private static final JsonNode expectedResult;
