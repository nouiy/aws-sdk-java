...
@SdkInternalApi
public class AddonInfoMarshaller {
    ...
    public static AddonInfoMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddonInfo addonInfo, ProtocolMarshaller protocolMarshaller) {
