        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    launchTemplateSpecification.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    launchTemplateSpecification.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
