...
public class InsightMarshaller {
    ...
    public void marshall(Insight insight, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(insight.getId(), ID_BINDING);
            protocolMarshaller.marshall(insight.getName(), NAME_BINDING);
            protocolMarshaller.marshall(insight.getCategory(), CATEGORY_BINDING);
            protocolMarshaller.marshall(insight.getKubernetesVersion(), KUBERNETESVERSION_BINDING);
            protocolMarshaller.marshall(insight.getLastRefreshTime(), LASTREFRESHTIME_BINDING);
            protocolMarshaller.marshall(insight.getLastTransitionTime(), LASTTRANSITIONTIME_BINDING);
            protocolMarshaller.marshall(insight.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(insight.getInsightStatus(), INSIGHTSTATUS_BINDING);
            protocolMarshaller.marshall(insight.getRecommendation(), RECOMMENDATION_BINDING);
            ...
            protocolMarshaller.marshall(insight.getCategorySpecificSummary(), CATEGORYSPECIFICSUMMARY_BINDING);
        } catch (Exception e) {
