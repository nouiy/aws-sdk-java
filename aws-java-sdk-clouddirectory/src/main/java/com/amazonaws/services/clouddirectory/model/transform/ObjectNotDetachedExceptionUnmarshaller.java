...
public class ObjectNotDetachedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ObjectNotDetachedExceptionUnmarshaller instance;

    public static ObjectNotDetachedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ObjectNotDetachedExceptionUnmarshaller();
        return instance;
    }
}
