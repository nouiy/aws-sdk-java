...
public class UnsupportedIndexTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedIndexTypeExceptionUnmarshaller instance;

    public static UnsupportedIndexTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedIndexTypeExceptionUnmarshaller();
        return instance;
    }
}
