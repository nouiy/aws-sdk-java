...
public class DeleteFacetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteFacetRequest withSchemaArn(String schemaArn) {
     ...
     * </p>
     * 
     * @return The name of the facet to delete.
     */
    ...
    public DeleteFacetRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteFacetRequest == false)
            return false;
        DeleteFacetRequest other = (DeleteFacetRequest) obj;
    ...
    @Override
    public DeleteFacetRequest clone() {
        return (DeleteFacetRequest) super.clone();
    }
