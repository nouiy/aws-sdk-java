 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/BatchCreateObjectResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchCreateObjectResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchCreateObjectResponse == false)
            return false;
        BatchCreateObjectResponse other = (BatchCreateObjectResponse) obj;
    ...
    public BatchCreateObjectResponse clone() {
        try {
            return (BatchCreateObjectResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.clouddirectory.model.transform.BatchCreateObjectResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
