...
public class NotIndexExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NotIndexExceptionUnmarshaller instance;

    public static NotIndexExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotIndexExceptionUnmarshaller();
        return instance;
    }
}
