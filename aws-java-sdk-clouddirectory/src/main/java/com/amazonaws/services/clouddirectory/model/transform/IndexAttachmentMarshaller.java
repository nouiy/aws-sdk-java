...
public class IndexAttachmentMarshaller {
    ...
    private static final MarshallingInfo<List> INDEXEDATTRIBUTES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IndexedAttributes").build();
    ...
    public void marshall(IndexAttachment indexAttachment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(indexAttachment.getIndexedAttributes(), INDEXEDATTRIBUTES_BINDING);
            protocolMarshaller.marshall(indexAttachment.getObjectIdentifier(), OBJECTIDENTIFIER_BINDING);
        } catch (Exception e) {
