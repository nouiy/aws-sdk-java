...
public class BatchWriteExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Index", targetDepth)) {
                    context.nextToken();
                    batchWriteException.setIndex(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    batchWriteException.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static BatchWriteExceptionUnmarshaller instance;

    public static BatchWriteExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BatchWriteExceptionUnmarshaller();
        return instance;
    }
}
