...
public class FacetNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FacetNotFoundExceptionUnmarshaller instance;

    public static FacetNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FacetNotFoundExceptionUnmarshaller();
        return instance;
    }
}
