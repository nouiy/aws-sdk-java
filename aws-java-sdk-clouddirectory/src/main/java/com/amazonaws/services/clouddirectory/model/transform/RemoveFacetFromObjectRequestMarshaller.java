...
@SdkInternalApi
public class RemoveFacetFromObjectRequestMarshaller {
    ...
    private static final RemoveFacetFromObjectRequestMarshaller instance = new RemoveFacetFromObjectRequestMarshaller();

    public static RemoveFacetFromObjectRequestMarshaller getInstance() {
        return instance;
    }
