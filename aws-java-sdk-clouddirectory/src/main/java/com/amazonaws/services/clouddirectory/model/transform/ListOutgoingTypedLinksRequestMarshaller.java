...
@SdkInternalApi
public class ListOutgoingTypedLinksRequestMarshaller {
    ...
    private static final ListOutgoingTypedLinksRequestMarshaller instance = new ListOutgoingTypedLinksRequestMarshaller();

    public static ListOutgoingTypedLinksRequestMarshaller getInstance() {
        return instance;
    }
