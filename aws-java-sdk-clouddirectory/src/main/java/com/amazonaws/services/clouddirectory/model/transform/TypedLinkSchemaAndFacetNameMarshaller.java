...
/**
 * TypedLinkSchemaAndFacetNameMarshaller
 */
...
public class TypedLinkSchemaAndFacetNameMarshaller {
    ...
    private static final MarshallingInfo<String> TYPEDLINKNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TypedLinkName").build();
    ...
    public void marshall(TypedLinkSchemaAndFacetName typedLinkSchemaAndFacetName, ProtocolMarshaller protocolMarshaller) {
        ...
        if (typedLinkSchemaAndFacetName == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(typedLinkSchemaAndFacetName.getSchemaArn(), SCHEMAARN_BINDING);
            protocolMarshaller.marshall(typedLinkSchemaAndFacetName.getTypedLinkName(), TYPEDLINKNAME_BINDING);
        } catch (Exception e) {
