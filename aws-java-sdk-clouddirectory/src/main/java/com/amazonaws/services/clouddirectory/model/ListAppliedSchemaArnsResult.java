...
public class ListAppliedSchemaArnsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListAppliedSchemaArnsResult withSchemaArns(String... schemaArns) {
    ...
    public ListAppliedSchemaArnsResult withSchemaArns(java.util.Collection<String> schemaArns) {
    ...
    public ListAppliedSchemaArnsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAppliedSchemaArnsResult == false)
            return false;
        ListAppliedSchemaArnsResult other = (ListAppliedSchemaArnsResult) obj;
    ...
    @Override
    public ListAppliedSchemaArnsResult clone() {
        try {
            return (ListAppliedSchemaArnsResult) super.clone();
