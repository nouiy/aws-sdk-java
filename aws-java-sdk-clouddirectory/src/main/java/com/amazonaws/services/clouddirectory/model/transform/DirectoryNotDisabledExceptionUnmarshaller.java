...
public class DirectoryNotDisabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DirectoryNotDisabledExceptionUnmarshaller instance;

    public static DirectoryNotDisabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DirectoryNotDisabledExceptionUnmarshaller();
        return instance;
    }
}
