...
public class LinkAttributeUpdateMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ATTRIBUTEACTION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AttributeAction").build();
