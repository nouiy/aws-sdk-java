...
public class ObjectAlreadyDetachedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ObjectAlreadyDetachedExceptionUnmarshaller instance;

    public static ObjectAlreadyDetachedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ObjectAlreadyDetachedExceptionUnmarshaller();
        return instance;
    }
}
