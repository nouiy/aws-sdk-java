...
public class RetryableConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RetryableConflictExceptionUnmarshaller instance;

    public static RetryableConflictExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RetryableConflictExceptionUnmarshaller();
        return instance;
    }
}
