...
/**
 * BatchUpdateLinkAttributesResponse JSON Unmarshaller
 */
...
public class BatchUpdateLinkAttributesResponseJsonUnmarshaller implements Unmarshaller<BatchUpdateLinkAttributesResponse, JsonUnmarshallerContext> {
    ...
    public BatchUpdateLinkAttributesResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchUpdateLinkAttributesResponse batchUpdateLinkAttributesResponse = new BatchUpdateLinkAttributesResponse();
