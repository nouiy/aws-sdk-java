...
public class StillContainsLinksExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static StillContainsLinksExceptionUnmarshaller instance;

    public static StillContainsLinksExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StillContainsLinksExceptionUnmarshaller();
        return instance;
    }
}
