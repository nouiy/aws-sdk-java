...
/**
 * BatchDetachFromIndexMarshaller
 */
...
public class BatchDetachFromIndexMarshaller {
    ...
    public void marshall(BatchDetachFromIndex batchDetachFromIndex, ProtocolMarshaller protocolMarshaller) {
        ...
        if (batchDetachFromIndex == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(batchDetachFromIndex.getIndexReference(), INDEXREFERENCE_BINDING);
            protocolMarshaller.marshall(batchDetachFromIndex.getTargetReference(), TARGETREFERENCE_BINDING);
        } catch (Exception e) {
