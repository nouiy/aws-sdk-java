...
public class NotPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NotPolicyExceptionUnmarshaller instance;

    public static NotPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotPolicyExceptionUnmarshaller();
        return instance;
    }
}
