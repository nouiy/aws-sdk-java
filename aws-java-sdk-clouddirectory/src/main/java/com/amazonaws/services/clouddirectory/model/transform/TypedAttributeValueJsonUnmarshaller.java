...
public class TypedAttributeValueJsonUnmarshaller implements Unmarshaller<TypedAttributeValue, JsonUnmarshallerContext> {

    public TypedAttributeValue unmarshall(JsonUnmarshallerContext context) throws Exception {
        TypedAttributeValue typedAttributeValue = new TypedAttributeValue();
    ...
    private static TypedAttributeValueJsonUnmarshaller instance;

    public static TypedAttributeValueJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TypedAttributeValueJsonUnmarshaller();
        return instance;
    }
}
