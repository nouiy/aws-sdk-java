...
public class FacetAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FacetAlreadyExistsExceptionUnmarshaller instance;

    public static FacetAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FacetAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
