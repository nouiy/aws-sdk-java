...
/**
 * BatchListObjectPoliciesMarshaller
 */
...
public class BatchListObjectPoliciesMarshaller {
    ...
    public void marshall(BatchListObjectPolicies batchListObjectPolicies, ProtocolMarshaller protocolMarshaller) {
        ...
        if (batchListObjectPolicies == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(batchListObjectPolicies.getObjectReference(), OBJECTREFERENCE_BINDING);
            protocolMarshaller.marshall(batchListObjectPolicies.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(batchListObjectPolicies.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
