...
/**
 * BatchDetachPolicyResponse JSON Unmarshaller
 */
...
public class BatchDetachPolicyResponseJsonUnmarshaller implements Unmarshaller<BatchDetachPolicyResponse, JsonUnmarshallerContext> {
    ...
    public BatchDetachPolicyResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchDetachPolicyResponse batchDetachPolicyResponse = new BatchDetachPolicyResponse();
