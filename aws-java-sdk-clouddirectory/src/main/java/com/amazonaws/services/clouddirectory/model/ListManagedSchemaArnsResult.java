...
public class ListManagedSchemaArnsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARNs for all AWS managed schemas.
     */
    ...
    public ListManagedSchemaArnsResult withSchemaArns(String... schemaArns) {
    ...
    public ListManagedSchemaArnsResult withSchemaArns(java.util.Collection<String> schemaArns) {
    ...
    public ListManagedSchemaArnsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListManagedSchemaArnsResult == false)
            return false;
        ListManagedSchemaArnsResult other = (ListManagedSchemaArnsResult) obj;
    ...
    @Override
    public ListManagedSchemaArnsResult clone() {
        try {
            return (ListManagedSchemaArnsResult) super.clone();
