...
public class CannotListParentOfRootExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CannotListParentOfRootExceptionUnmarshaller instance;

    public static CannotListParentOfRootExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CannotListParentOfRootExceptionUnmarshaller();
        return instance;
    }
}
