 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/BatchListIndexResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchListIndexResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchListIndexResponse withIndexAttachments(java.util.Collection<IndexAttachment> indexAttachments) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchListIndexResponse == false)
            return false;
    ...
    public BatchListIndexResponse clone() {
        try {
            return (BatchListIndexResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.clouddirectory.model.transform.BatchListIndexResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
