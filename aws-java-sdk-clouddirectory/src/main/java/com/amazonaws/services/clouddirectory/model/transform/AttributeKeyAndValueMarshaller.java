...
@SdkInternalApi
public class AttributeKeyAndValueMarshaller {
    ...
    private static final AttributeKeyAndValueMarshaller instance = new AttributeKeyAndValueMarshaller();

    public static AttributeKeyAndValueMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(AttributeKeyAndValue attributeKeyAndValue, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attributeKeyAndValue.getKey(), KEY_BINDING);
            protocolMarshaller.marshall(attributeKeyAndValue.getValue(), VALUE_BINDING);
        } catch (Exception e) {
