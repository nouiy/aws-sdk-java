...
public class DeleteObjectRequestMarshaller {
    ...
    public void marshall(DeleteObjectRequest deleteObjectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteObjectRequest.getDirectoryArn(), DIRECTORYARN_BINDING);
            protocolMarshaller.marshall(deleteObjectRequest.getObjectReference(), OBJECTREFERENCE_BINDING);
        } catch (Exception e) {
