...
public class GetLinkAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetLinkAttributesResult withAttributes(AttributeKeyAndValue... attributes) {
    ...
    public GetLinkAttributesResult withAttributes(java.util.Collection<AttributeKeyAndValue> attributes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLinkAttributesResult == false)
            return false;
        GetLinkAttributesResult other = (GetLinkAttributesResult) obj;
    ...
    public GetLinkAttributesResult clone() {
        try {
            return (GetLinkAttributesResult) super.clone();
