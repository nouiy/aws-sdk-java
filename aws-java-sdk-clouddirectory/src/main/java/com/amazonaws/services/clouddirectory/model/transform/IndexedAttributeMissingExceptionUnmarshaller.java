...
public class IndexedAttributeMissingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IndexedAttributeMissingExceptionUnmarshaller instance;

    public static IndexedAttributeMissingExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IndexedAttributeMissingExceptionUnmarshaller();
        return instance;
    }
}
