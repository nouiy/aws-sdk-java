 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/BatchListIncomingTypedLinksResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchListIncomingTypedLinksResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchListIncomingTypedLinksResponse withLinkSpecifiers(java.util.Collection<TypedLinkSpecifier> linkSpecifiers) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchListIncomingTypedLinksResponse == false)
            return false;
    ...
    public BatchListIncomingTypedLinksResponse clone() {
        try {
            return (BatchListIncomingTypedLinksResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.clouddirectory.model.transform.BatchListIncomingTypedLinksResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
