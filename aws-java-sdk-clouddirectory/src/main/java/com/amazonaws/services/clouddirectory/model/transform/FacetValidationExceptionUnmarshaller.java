...
public class FacetValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FacetValidationExceptionUnmarshaller instance;

    public static FacetValidationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FacetValidationExceptionUnmarshaller();
        return instance;
    }
}
