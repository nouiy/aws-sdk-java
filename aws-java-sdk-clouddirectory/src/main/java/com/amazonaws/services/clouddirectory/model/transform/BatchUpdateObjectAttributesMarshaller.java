...
public class BatchUpdateObjectAttributesMarshaller {
    ...
    public void marshall(BatchUpdateObjectAttributes batchUpdateObjectAttributes, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(batchUpdateObjectAttributes.getObjectReference(), OBJECTREFERENCE_BINDING);
            protocolMarshaller.marshall(batchUpdateObjectAttributes.getAttributeUpdates(), ATTRIBUTEUPDATES_BINDING);
        } catch (Exception e) {
