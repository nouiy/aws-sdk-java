...
public class AddFacetToObjectResultJsonUnmarshaller implements Unmarshaller<AddFacetToObjectResult, JsonUnmarshallerContext> {
    ...
    public AddFacetToObjectResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AddFacetToObjectResult addFacetToObjectResult = new AddFacetToObjectResult();
