...
public class BatchListObjectParents implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchListObjectParents == false)
            return false;
        BatchListObjectParents other = (BatchListObjectParents) obj;
    ...
    public BatchListObjectParents clone() {
        try {
            return (BatchListObjectParents) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.clouddirectory.model.transform.BatchListObjectParentsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
