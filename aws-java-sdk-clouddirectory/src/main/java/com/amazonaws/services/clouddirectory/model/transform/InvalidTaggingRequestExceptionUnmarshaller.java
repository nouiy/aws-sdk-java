...
public class InvalidTaggingRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTaggingRequestExceptionUnmarshaller instance;

    public static InvalidTaggingRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTaggingRequestExceptionUnmarshaller();
        return instance;
    }
}
