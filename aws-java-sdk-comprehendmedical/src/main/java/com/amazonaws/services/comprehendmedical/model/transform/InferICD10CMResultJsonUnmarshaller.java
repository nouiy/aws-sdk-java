...
/**
 * InferICD10CMResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InferICD10CMResultJsonUnmarshaller implements Unmarshaller<InferICD10CMResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("PaginationToken", targetDepth)) {
                    context.nextToken();
                    inferICD10CMResult.setPaginationToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ModelVersion", targetDepth)) {
                    context.nextToken();
                    inferICD10CMResult.setModelVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
