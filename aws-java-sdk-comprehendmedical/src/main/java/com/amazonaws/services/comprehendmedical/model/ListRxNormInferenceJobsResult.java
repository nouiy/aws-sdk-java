...
public class ListRxNormInferenceJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListRxNormInferenceJobsResult withComprehendMedicalAsyncJobPropertiesList(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRxNormInferenceJobsResult == false)
            return false;
        ListRxNormInferenceJobsResult other = (ListRxNormInferenceJobsResult) obj;
    ...
    public ListRxNormInferenceJobsResult clone() {
        try {
            return (ListRxNormInferenceJobsResult) super.clone();
