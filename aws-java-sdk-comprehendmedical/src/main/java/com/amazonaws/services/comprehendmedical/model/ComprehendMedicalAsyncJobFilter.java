 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehendmedical-2018-10-30/ComprehendMedicalAsyncJobFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComprehendMedicalAsyncJobFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public ComprehendMedicalAsyncJobFilter withJobStatus(String jobStatus) {
    ...
    public ComprehendMedicalAsyncJobFilter withJobStatus(JobStatus jobStatus) {
    ...
    public ComprehendMedicalAsyncJobFilter withSubmitTimeBefore(java.util.Date submitTimeBefore) {
    ...
    public ComprehendMedicalAsyncJobFilter withSubmitTimeAfter(java.util.Date submitTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ComprehendMedicalAsyncJobFilter == false)
            return false;
        ComprehendMedicalAsyncJobFilter other = (ComprehendMedicalAsyncJobFilter) obj;
    ...
    @Override
    public ComprehendMedicalAsyncJobFilter clone() {
        try {
            return (ComprehendMedicalAsyncJobFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehendmedical.model.transform.ComprehendMedicalAsyncJobFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
