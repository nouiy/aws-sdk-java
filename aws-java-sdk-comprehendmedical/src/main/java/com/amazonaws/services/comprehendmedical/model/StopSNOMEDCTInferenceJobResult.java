...
public class StopSNOMEDCTInferenceJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopSNOMEDCTInferenceJobResult == false)
            return false;
        StopSNOMEDCTInferenceJobResult other = (StopSNOMEDCTInferenceJobResult) obj;
    ...
    public StopSNOMEDCTInferenceJobResult clone() {
        try {
            return (StopSNOMEDCTInferenceJobResult) super.clone();
