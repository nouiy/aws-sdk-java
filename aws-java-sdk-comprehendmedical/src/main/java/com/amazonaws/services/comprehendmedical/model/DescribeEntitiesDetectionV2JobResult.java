...
public class DescribeEntitiesDetectionV2JobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeEntitiesDetectionV2JobResult == false)
            return false;
        DescribeEntitiesDetectionV2JobResult other = (DescribeEntitiesDetectionV2JobResult) obj;
    ...
    @Override
    public DescribeEntitiesDetectionV2JobResult clone() {
        try {
            return (DescribeEntitiesDetectionV2JobResult) super.clone();
