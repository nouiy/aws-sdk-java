...
/**
 * DeleteAnomalySubscriptionResult JSON Unmarshaller
 */
...
public class DeleteAnomalySubscriptionResultJsonUnmarshaller implements Unmarshaller<DeleteAnomalySubscriptionResult, JsonUnmarshallerContext> {
    ...
    public DeleteAnomalySubscriptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAnomalySubscriptionResult deleteAnomalySubscriptionResult = new DeleteAnomalySubscriptionResult();
