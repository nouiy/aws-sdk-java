...
/**
 * CostCategoryRuleMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CostCategoryRuleMarshaller {
    ...
    public static CostCategoryRuleMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CostCategoryRule costCategoryRule, ProtocolMarshaller protocolMarshaller) {

        if (costCategoryRule == null) {
