...
public class DeleteCostCategoryDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getCostCategoryArn() != null)
            sb.append("CostCategoryArn: ").append(getCostCategoryArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    @Override
    public DeleteCostCategoryDefinitionRequest clone() {
        return (DeleteCostCategoryDefinitionRequest) super.clone();
    }
