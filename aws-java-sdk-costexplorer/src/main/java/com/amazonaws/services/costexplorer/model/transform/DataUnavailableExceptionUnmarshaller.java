...
public class DataUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DataUnavailableExceptionUnmarshaller instance;

    public static DataUnavailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataUnavailableExceptionUnmarshaller();
        return instance;
    }
}
