...
/**
 * EBSResourceUtilization JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EBSResourceUtilizationJsonUnmarshaller implements Unmarshaller<EBSResourceUtilization, JsonUnmarshallerContext> {

    public EBSResourceUtilization unmarshall(JsonUnmarshallerContext context) throws Exception {
        EBSResourceUtilization eBSResourceUtilization = new EBSResourceUtilization();
    ...
    private static EBSResourceUtilizationJsonUnmarshaller instance;

    public static EBSResourceUtilizationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EBSResourceUtilizationJsonUnmarshaller();
        return instance;
    }
}
