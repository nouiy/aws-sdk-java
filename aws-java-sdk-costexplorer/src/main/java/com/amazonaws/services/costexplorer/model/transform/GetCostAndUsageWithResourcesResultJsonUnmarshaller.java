...
/**
 * GetCostAndUsageWithResourcesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCostAndUsageWithResourcesResultJsonUnmarshaller implements Unmarshaller<GetCostAndUsageWithResourcesResult, JsonUnmarshallerContext> {

    public GetCostAndUsageWithResourcesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    getCostAndUsageWithResourcesResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("DimensionValueAttributes", targetDepth)) {
                    context.nextToken();
                    getCostAndUsageWithResourcesResult.setDimensionValueAttributes(new ListUnmarshaller<DimensionValuesWithAttributes>(
