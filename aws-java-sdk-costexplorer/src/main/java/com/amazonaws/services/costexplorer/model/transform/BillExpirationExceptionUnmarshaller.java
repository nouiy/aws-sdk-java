...
public class BillExpirationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static BillExpirationExceptionUnmarshaller instance;

    public static BillExpirationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new BillExpirationExceptionUnmarshaller();
        return instance;
    }
}
