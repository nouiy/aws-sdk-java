...
/**
 * GetRightsizingRecommendationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetRightsizingRecommendationResultJsonUnmarshaller implements Unmarshaller<GetRightsizingRecommendationResult, JsonUnmarshallerContext> {

    public GetRightsizingRecommendationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetRightsizingRecommendationResult getRightsizingRecommendationResult = new GetRightsizingRecommendationResult();
    ...
    private static GetRightsizingRecommendationResultJsonUnmarshaller instance;

    public static GetRightsizingRecommendationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetRightsizingRecommendationResultJsonUnmarshaller();
        return instance;
    }
}
