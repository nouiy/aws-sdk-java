...
/**
 * TagValues JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagValuesJsonUnmarshaller implements Unmarshaller<TagValues, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    tagValues.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
