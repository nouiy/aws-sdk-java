        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Amount", targetDepth)) {
                    context.nextToken();
                    metricValue.setAmount(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Unit", targetDepth)) {
                    context.nextToken();
                    metricValue.setUnit(context.getUnmarshaller(String.class).unmarshall(context));
                }
