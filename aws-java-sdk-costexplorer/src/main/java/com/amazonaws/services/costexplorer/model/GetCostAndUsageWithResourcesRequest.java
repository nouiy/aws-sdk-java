...
public class GetCostAndUsageWithResourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        14 days (the start date cannot be earlier than 14 days ago). The start date is inclusive, but the end date
    ...
    public GetCostAndUsageWithResourcesRequest withGroupBy(java.util.Collection<GroupDefinition> groupBy) {
        setGroupBy(groupBy);
        return this;
    }
    ...
    @Override
    public GetCostAndUsageWithResourcesRequest clone() {
        return (GetCostAndUsageWithResourcesRequest) super.clone();
    }
