...
public class CreateAnomalyMonitorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAnomalyMonitorResult == false)
            return false;
        CreateAnomalyMonitorResult other = (CreateAnomalyMonitorResult) obj;
    ...
    public CreateAnomalyMonitorResult clone() {
        try {
            return (CreateAnomalyMonitorResult) super.clone();
