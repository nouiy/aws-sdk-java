        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    subscriber.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    subscriber.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
