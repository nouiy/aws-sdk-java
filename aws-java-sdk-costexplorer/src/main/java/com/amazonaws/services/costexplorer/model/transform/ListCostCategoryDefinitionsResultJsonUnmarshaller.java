...
/**
 * ListCostCategoryDefinitionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCostCategoryDefinitionsResultJsonUnmarshaller implements Unmarshaller<ListCostCategoryDefinitionsResult, JsonUnmarshallerContext> {

    public ListCostCategoryDefinitionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listCostCategoryDefinitionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
