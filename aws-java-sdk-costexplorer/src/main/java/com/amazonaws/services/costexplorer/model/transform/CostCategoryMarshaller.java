...
/**
 * CostCategoryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CostCategoryMarshaller {
    ...
    private static final CostCategoryMarshaller instance = new CostCategoryMarshaller();

    public static CostCategoryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CostCategory costCategory, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(costCategory.getCostCategoryArn(), COSTCATEGORYARN_BINDING);
            protocolMarshaller.marshall(costCategory.getEffectiveStart(), EFFECTIVESTART_BINDING);
            protocolMarshaller.marshall(costCategory.getEffectiveEnd(), EFFECTIVEEND_BINDING);
