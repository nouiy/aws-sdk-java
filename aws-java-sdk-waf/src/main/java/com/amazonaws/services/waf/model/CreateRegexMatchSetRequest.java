...
public class CreateRegexMatchSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public CreateRegexMatchSetRequest clone() {
        return (CreateRegexMatchSetRequest) super.clone();
    }
