...
public class ListActivatedRulesInRuleGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param nextMarker
     *        If you specify a value for <code>Limit</code> and you have more <code>ActivatedRules</code> than the value
     *        of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to
     *        list another group of <code>ActivatedRules</code>. For the second and subsequent
     *        <code>ListActivatedRulesInRuleGroup</code> requests, specify the value of <code>NextMarker</code> from the
     *        previous response to get information about another batch of <code>ActivatedRules</code>.
     */
     ...
     * 
     * @param limit
     *        Specifies the number of <code>ActivatedRules</code> that you want AWS WAF to return for this request. If
    ...
    public ListActivatedRulesInRuleGroupRequest withLimit(Integer limit) {
        setLimit(limit);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListActivatedRulesInRuleGroupRequest == false)
            return false;
    ...
    @Override
    public ListActivatedRulesInRuleGroupRequest clone() {
        return (ListActivatedRulesInRuleGroupRequest) super.clone();
    }
