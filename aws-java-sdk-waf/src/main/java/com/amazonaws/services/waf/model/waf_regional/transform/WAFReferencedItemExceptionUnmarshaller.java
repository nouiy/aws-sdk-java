...
public class WAFReferencedItemExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static WAFReferencedItemExceptionUnmarshaller instance;

    public static WAFReferencedItemExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new WAFReferencedItemExceptionUnmarshaller();
        return instance;
    }
}
