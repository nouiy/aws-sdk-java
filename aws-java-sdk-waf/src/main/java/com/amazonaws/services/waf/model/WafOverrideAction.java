 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/WafOverrideAction" target="_top">AWS API
 *      Documentation</a>
 */
...
public class WafOverrideAction implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * <code>COUNT</code> overrides the action specified by the individual rule within a <code>RuleGroup</code> . If set
     * to <code>NONE</code>, the rule's action will take place.
     * </p>
     */
    private String type;
     ...
     *        If set to <code>NONE</code>, the rule's action will take place.
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.waf.model.waf_regional.transform.WafOverrideActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
