...
public class UpdateRuleGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The <code>ChangeToken</code> that you used to submit the <code>UpdateRuleGroup</code> request. You can also use
     ...
     * 
     * @param changeToken
     *        The <code>ChangeToken</code> that you used to submit the <code>UpdateRuleGroup</code> request. You can
     ...
     * </p>
     * 
     * @return The <code>ChangeToken</code> that you used to submit the <code>UpdateRuleGroup</code> request. You can
     *         also use this value to query the status of the request. For more information, see
     *         <a>GetChangeTokenStatus</a>.
     */
    ...
    public UpdateRuleGroupResult withChangeToken(String changeToken) {
