        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RuleGroupId", targetDepth)) {
                    context.nextToken();
                    ruleGroup.setRuleGroupId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("MetricName", targetDepth)) {
                    context.nextToken();
                    ruleGroup.setMetricName(context.getUnmarshaller(String.class).unmarshall(context));
                }
