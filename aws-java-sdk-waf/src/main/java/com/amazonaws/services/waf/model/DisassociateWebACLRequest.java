...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DisassociateWebACL" target="_top">AWS
 *      API Documentation</a>
 */
...
public class DisassociateWebACLRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        application load balancer or Amazon API Gateway stage.</p>
     *        <p>
     *        The ARN should be in one of the following formats:
     *        </p>
     *        <ul>
     ...
     * </ul>
     * 
     * @return The ARN (Amazon Resource Name) of the resource from which the web ACL is being removed, either an
     *         application load balancer or Amazon API Gateway stage.</p>
     *         <p>
     *         The ARN should be in one of the following formats:
     *         </p>
