...
public class UpdateByteMatchSetResultJsonUnmarshaller implements Unmarshaller<UpdateByteMatchSetResult, JsonUnmarshallerContext> {
    ...
    private static UpdateByteMatchSetResultJsonUnmarshaller instance;

    public static UpdateByteMatchSetResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateByteMatchSetResultJsonUnmarshaller();
        return instance;
    }
}
