...
public class DeleteXssMatchSetRequestMarshaller {
    ...
    private static final DeleteXssMatchSetRequestMarshaller instance = new DeleteXssMatchSetRequestMarshaller();

    public static DeleteXssMatchSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteXssMatchSetRequest deleteXssMatchSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteXssMatchSetRequest.getXssMatchSetId(), XSSMATCHSETID_BINDING);
            protocolMarshaller.marshall(deleteXssMatchSetRequest.getChangeToken(), CHANGETOKEN_BINDING);
        } catch (Exception e) {
