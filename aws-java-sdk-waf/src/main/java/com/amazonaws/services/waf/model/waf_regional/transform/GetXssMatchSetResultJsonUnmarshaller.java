...
public class GetXssMatchSetResultJsonUnmarshaller implements Unmarshaller<GetXssMatchSetResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("XssMatchSet", targetDepth)) {
                    context.nextToken();
                    getXssMatchSetResult.setXssMatchSet(XssMatchSetJsonUnmarshaller.getInstance().unmarshall(context));
                }
