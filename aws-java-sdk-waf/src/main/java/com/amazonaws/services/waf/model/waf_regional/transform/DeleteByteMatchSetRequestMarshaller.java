...
public class DeleteByteMatchSetRequestMarshaller {
    ...
    private static final DeleteByteMatchSetRequestMarshaller instance = new DeleteByteMatchSetRequestMarshaller();

    public static DeleteByteMatchSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteByteMatchSetRequest deleteByteMatchSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteByteMatchSetRequest.getByteMatchSetId(), BYTEMATCHSETID_BINDING);
            protocolMarshaller.marshall(deleteByteMatchSetRequest.getChangeToken(), CHANGETOKEN_BINDING);
        } catch (Exception e) {
