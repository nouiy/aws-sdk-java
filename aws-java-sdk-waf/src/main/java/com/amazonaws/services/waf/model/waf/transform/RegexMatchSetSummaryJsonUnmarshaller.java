...
/**
 * RegexMatchSetSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegexMatchSetSummaryJsonUnmarshaller implements Unmarshaller<RegexMatchSetSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RegexMatchSetId", targetDepth)) {
                    context.nextToken();
                    regexMatchSetSummary.setRegexMatchSetId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    regexMatchSetSummary.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
