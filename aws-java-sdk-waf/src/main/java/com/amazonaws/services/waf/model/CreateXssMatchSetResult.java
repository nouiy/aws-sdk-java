...
public class CreateXssMatchSetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * 
     * @param changeToken
     *        The <code>ChangeToken</code> that you used to submit the <code>CreateXssMatchSet</code> request. You can
    ...
    public CreateXssMatchSetResult withChangeToken(String changeToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateXssMatchSetResult == false)
            return false;
        CreateXssMatchSetResult other = (CreateXssMatchSetResult) obj;
    ...
    public CreateXssMatchSetResult clone() {
        try {
            return (CreateXssMatchSetResult) super.clone();
