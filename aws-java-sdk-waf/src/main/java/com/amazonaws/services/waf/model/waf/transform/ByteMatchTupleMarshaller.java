...
public class ByteMatchTupleMarshaller {
    ...
    private static final MarshallingInfo<java.nio.ByteBuffer> TARGETSTRING_BINDING = MarshallingInfo.builder(MarshallingType.BYTE_BUFFER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("TargetString").build();
