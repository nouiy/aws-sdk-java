...
/**
 * UpdateRateBasedRuleResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateRateBasedRuleResultJsonUnmarshaller implements Unmarshaller<UpdateRateBasedRuleResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChangeToken", targetDepth)) {
                    context.nextToken();
                    updateRateBasedRuleResult.setChangeToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
