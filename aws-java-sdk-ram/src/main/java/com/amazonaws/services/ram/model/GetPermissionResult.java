...
public class GetPermissionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetPermissionResult withPermission(ResourceSharePermissionDetail permission) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPermissionResult == false)
            return false;
        GetPermissionResult other = (GetPermissionResult) obj;
    ...
    @Override
    public GetPermissionResult clone() {
        try {
            return (GetPermissionResult) super.clone();
