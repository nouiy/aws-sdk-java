...
public class ResourceShareInvitationAlreadyAcceptedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceShareInvitationAlreadyAcceptedExceptionUnmarshaller instance;

    public static ResourceShareInvitationAlreadyAcceptedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceShareInvitationAlreadyAcceptedExceptionUnmarshaller();
        return instance;
    }
}
