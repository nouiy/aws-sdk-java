...
public class EnableSharingWithAwsOrganizationRequestMarshaller {
    ...
    private static final EnableSharingWithAwsOrganizationRequestMarshaller instance = new EnableSharingWithAwsOrganizationRequestMarshaller();

    public static EnableSharingWithAwsOrganizationRequestMarshaller getInstance() {
        return instance;
    }
