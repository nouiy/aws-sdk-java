...
public class ResourceShareInvitationArnNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceShareInvitationArnNotFoundExceptionUnmarshaller instance;

    public static ResourceShareInvitationArnNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceShareInvitationArnNotFoundExceptionUnmarshaller();
        return instance;
    }
}
