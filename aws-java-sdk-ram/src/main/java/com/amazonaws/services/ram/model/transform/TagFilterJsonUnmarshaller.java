        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tagKey", targetDepth)) {
                    context.nextToken();
                    tagFilter.setTagKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("tagValues", targetDepth)) {
                    context.nextToken();
                    tagFilter.setTagValues(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
