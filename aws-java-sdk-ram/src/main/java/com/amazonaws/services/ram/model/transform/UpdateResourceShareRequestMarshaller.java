...
/**
 * UpdateResourceShareRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateResourceShareRequestMarshaller {
    ...
    private static final UpdateResourceShareRequestMarshaller instance = new UpdateResourceShareRequestMarshaller();

    public static UpdateResourceShareRequestMarshaller getInstance() {
        return instance;
    }
