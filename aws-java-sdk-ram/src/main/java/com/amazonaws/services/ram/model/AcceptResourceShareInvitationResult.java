...
public class AcceptResourceShareInvitationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return An object that contains information about the specified invitation.
     */
    ...
    public AcceptResourceShareInvitationResult withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptResourceShareInvitationResult == false)
            return false;
        AcceptResourceShareInvitationResult other = (AcceptResourceShareInvitationResult) obj;
    ...
    public AcceptResourceShareInvitationResult clone() {
        try {
            return (AcceptResourceShareInvitationResult) super.clone();
