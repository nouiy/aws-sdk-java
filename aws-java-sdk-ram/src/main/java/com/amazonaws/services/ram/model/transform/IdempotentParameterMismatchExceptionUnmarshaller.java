...
public class IdempotentParameterMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private IdempotentParameterMismatchExceptionUnmarshaller() {
        super(com.amazonaws.services.ram.model.IdempotentParameterMismatchException.class, "IdempotentParameterMismatchException");
    }

    @Override
    public com.amazonaws.services.ram.model.IdempotentParameterMismatchException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ram.model.IdempotentParameterMismatchException idempotentParameterMismatchException = new com.amazonaws.services.ram.model.IdempotentParameterMismatchException(
                null);
