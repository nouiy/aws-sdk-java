...
/**
 * GetResourceShareAssociationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetResourceShareAssociationsResultJsonUnmarshaller implements Unmarshaller<GetResourceShareAssociationsResult, JsonUnmarshallerContext> {

    public GetResourceShareAssociationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    getResourceShareAssociationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
