...
public class PromoteResourceShareCreatedFromPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PromoteResourceShareCreatedFromPolicyResult == false)
            return false;
        PromoteResourceShareCreatedFromPolicyResult other = (PromoteResourceShareCreatedFromPolicyResult) obj;
    ...
    public PromoteResourceShareCreatedFromPolicyResult clone() {
        try {
            return (PromoteResourceShareCreatedFromPolicyResult) super.clone();
