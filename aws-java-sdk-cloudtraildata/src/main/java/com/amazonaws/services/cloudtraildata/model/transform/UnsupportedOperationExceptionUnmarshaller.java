...
public class UnsupportedOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnsupportedOperationExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudtraildata.model.UnsupportedOperationException.class, "UnsupportedOperationException");
    }

    @Override
    public com.amazonaws.services.cloudtraildata.model.UnsupportedOperationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudtraildata.model.UnsupportedOperationException unsupportedOperationException = new com.amazonaws.services.cloudtraildata.model.UnsupportedOperationException(
                null);
