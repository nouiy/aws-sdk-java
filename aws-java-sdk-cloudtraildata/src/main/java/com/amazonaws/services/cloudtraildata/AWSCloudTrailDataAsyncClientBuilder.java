...
/**
 * Fluent builder for {@link com.amazonaws.services.cloudtraildata.AWSCloudTrailDataAsync}. Use of the builder is
...
public final class AWSCloudTrailDataAsyncClientBuilder extends AwsAsyncClientBuilder<AWSCloudTrailDataAsyncClientBuilder, AWSCloudTrailDataAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSCloudTrailDataAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSCloudTrailDataAsync.
     */
    @Override
    protected AWSCloudTrailDataAsync build(AwsAsyncClientParams params) {
        return new AWSCloudTrailDataAsyncClient(params);
    }
