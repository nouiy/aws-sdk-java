...
public class CreateJourneyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateJourneyResult withJourneyResponse(JourneyResponse journeyResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateJourneyResult == false)
            return false;
        CreateJourneyResult other = (CreateJourneyResult) obj;
    ...
    @Override
    public CreateJourneyResult clone() {
        try {
            return (CreateJourneyResult) super.clone();
