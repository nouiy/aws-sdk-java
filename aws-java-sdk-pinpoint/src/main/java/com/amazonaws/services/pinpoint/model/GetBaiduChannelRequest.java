...
public class GetBaiduChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetBaiduChannelRequest clone() {
        return (GetBaiduChannelRequest) super.clone();
    }
