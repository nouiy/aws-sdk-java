...
public class GetExportJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public GetExportJobsResult clone() {
        try {
            return (GetExportJobsResult) super.clone();
