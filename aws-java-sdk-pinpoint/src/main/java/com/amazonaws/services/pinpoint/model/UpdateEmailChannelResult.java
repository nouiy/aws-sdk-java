...
public class UpdateEmailChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateEmailChannelResult withEmailChannelResponse(EmailChannelResponse emailChannelResponse) {
        setEmailChannelResponse(emailChannelResponse);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEmailChannelResponse() == null ^ this.getEmailChannelResponse() == null)
            return false;
        if (other.getEmailChannelResponse() != null && other.getEmailChannelResponse().equals(this.getEmailChannelResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getEmailChannelResponse() == null) ? 0 : getEmailChannelResponse().hashCode());
        return hashCode;
    }

    @Override
    public UpdateEmailChannelResult clone() {
        try {
            return (UpdateEmailChannelResult) super.clone();
