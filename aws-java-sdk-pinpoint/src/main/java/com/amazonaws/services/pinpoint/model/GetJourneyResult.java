...
public class GetJourneyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetJourneyResult withJourneyResponse(JourneyResponse journeyResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetJourneyResult == false)
            return false;
        GetJourneyResult other = (GetJourneyResult) obj;
    ...
    @Override
    public GetJourneyResult clone() {
        try {
            return (GetJourneyResult) super.clone();
