...
public class EventItemResponseMarshaller {
    ...
    public void marshall(EventItemResponse eventItemResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(eventItemResponse.getMessage(), MESSAGE_BINDING);
            protocolMarshaller.marshall(eventItemResponse.getStatusCode(), STATUSCODE_BINDING);
        } catch (Exception e) {
