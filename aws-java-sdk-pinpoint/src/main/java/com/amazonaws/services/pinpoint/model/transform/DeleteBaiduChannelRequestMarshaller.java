...
/**
 * DeleteBaiduChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteBaiduChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final DeleteBaiduChannelRequestMarshaller instance = new DeleteBaiduChannelRequestMarshaller();

    public static DeleteBaiduChannelRequestMarshaller getInstance() {
        return instance;
    }
