...
public class DeleteRecommenderConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteRecommenderConfigurationResult withRecommenderConfigurationResponse(RecommenderConfigurationResponse recommenderConfigurationResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRecommenderConfigurationResult == false)
            return false;
        DeleteRecommenderConfigurationResult other = (DeleteRecommenderConfigurationResult) obj;
    ...
    @Override
    public DeleteRecommenderConfigurationResult clone() {
        try {
            return (DeleteRecommenderConfigurationResult) super.clone();
