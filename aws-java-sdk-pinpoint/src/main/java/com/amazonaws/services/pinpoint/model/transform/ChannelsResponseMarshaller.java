...
/**
 * ChannelsResponseMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ChannelsResponseMarshaller {

    private static final MarshallingInfo<Map> CHANNELS_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(ChannelsResponse channelsResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(channelsResponse.getChannels(), CHANNELS_BINDING);
        } catch (Exception e) {
