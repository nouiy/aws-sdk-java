...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/GetApnsVoipSandboxChannel" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetApnsVoipSandboxChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetApnsVoipSandboxChannelResult == false)
            return false;
        GetApnsVoipSandboxChannelResult other = (GetApnsVoipSandboxChannelResult) obj;
    ...
    @Override
    public GetApnsVoipSandboxChannelResult clone() {
        try {
            return (GetApnsVoipSandboxChannelResult) super.clone();
