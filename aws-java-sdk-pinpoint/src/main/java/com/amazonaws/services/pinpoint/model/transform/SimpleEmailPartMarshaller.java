...
/**
 * SimpleEmailPartMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SimpleEmailPartMarshaller {
    ...
    private static final SimpleEmailPartMarshaller instance = new SimpleEmailPartMarshaller();

    public static SimpleEmailPartMarshaller getInstance() {
        return instance;
    }
