...
public class CreateRecommenderConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateRecommenderConfigurationResult withRecommenderConfigurationResponse(RecommenderConfigurationResponse recommenderConfigurationResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRecommenderConfigurationResult == false)
            return false;
        CreateRecommenderConfigurationResult other = (CreateRecommenderConfigurationResult) obj;
    ...
    @Override
    public CreateRecommenderConfigurationResult clone() {
        try {
            return (CreateRecommenderConfigurationResult) super.clone();
