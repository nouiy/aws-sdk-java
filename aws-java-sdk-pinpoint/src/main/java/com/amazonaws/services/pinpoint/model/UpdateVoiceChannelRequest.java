...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/UpdateVoiceChannel" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateVoiceChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateVoiceChannelRequest withVoiceChannelRequest(VoiceChannelRequest voiceChannelRequest) {
        setVoiceChannelRequest(voiceChannelRequest);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getVoiceChannelRequest() == null ^ this.getVoiceChannelRequest() == null)
            return false;
        if (other.getVoiceChannelRequest() != null && other.getVoiceChannelRequest().equals(this.getVoiceChannelRequest()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getVoiceChannelRequest() == null) ? 0 : getVoiceChannelRequest().hashCode());
        return hashCode;
    }

    @Override
    public UpdateVoiceChannelRequest clone() {
        return (UpdateVoiceChannelRequest) super.clone();
    }
