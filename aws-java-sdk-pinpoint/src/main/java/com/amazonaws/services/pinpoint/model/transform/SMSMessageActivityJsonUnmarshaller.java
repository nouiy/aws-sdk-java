...
/**
 * SMSMessageActivity JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SMSMessageActivityJsonUnmarshaller implements Unmarshaller<SMSMessageActivity, JsonUnmarshallerContext> {

    public SMSMessageActivity unmarshall(JsonUnmarshallerContext context) throws Exception {
        SMSMessageActivity sMSMessageActivity = new SMSMessageActivity();
    ...
    private static SMSMessageActivityJsonUnmarshaller instance;

    public static SMSMessageActivityJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SMSMessageActivityJsonUnmarshaller();
        return instance;
    }
}
