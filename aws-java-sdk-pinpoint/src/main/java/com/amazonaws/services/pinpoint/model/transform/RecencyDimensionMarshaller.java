...
public class RecencyDimensionMarshaller {
    ...
    private static final MarshallingInfo<String> RECENCYTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RecencyType").build();
    ...
    public void marshall(RecencyDimension recencyDimension, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recencyDimension.getDuration(), DURATION_BINDING);
            protocolMarshaller.marshall(recencyDimension.getRecencyType(), RECENCYTYPE_BINDING);
        } catch (Exception e) {
