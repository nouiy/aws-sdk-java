...
/**
 * DefaultButtonConfigurationMarshaller
 */
...
public class DefaultButtonConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Integer> BORDERRADIUS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BorderRadius").build();
