...
public class SendOTPMessageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SendOTPMessageResult withMessageResponse(MessageResponse messageResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SendOTPMessageResult == false)
            return false;
        SendOTPMessageResult other = (SendOTPMessageResult) obj;
    ...
    @Override
    public SendOTPMessageResult clone() {
        try {
            return (SendOTPMessageResult) super.clone();
