...
public class GetSegmentExportJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetSegmentExportJobsResult withExportJobsResponse(ExportJobsResponse exportJobsResponse) {
        setExportJobsResponse(exportJobsResponse);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSegmentExportJobsResult == false)
            return false;
        GetSegmentExportJobsResult other = (GetSegmentExportJobsResult) obj;
        if (other.getExportJobsResponse() == null ^ this.getExportJobsResponse() == null)
            return false;
        if (other.getExportJobsResponse() != null && other.getExportJobsResponse().equals(this.getExportJobsResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getExportJobsResponse() == null) ? 0 : getExportJobsResponse().hashCode());
        return hashCode;
    }

    @Override
    public GetSegmentExportJobsResult clone() {
        try {
            return (GetSegmentExportJobsResult) super.clone();
