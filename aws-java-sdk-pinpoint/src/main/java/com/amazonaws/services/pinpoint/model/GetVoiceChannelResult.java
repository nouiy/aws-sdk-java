...
public class GetVoiceChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public GetVoiceChannelResult clone() {
        try {
            return (GetVoiceChannelResult) super.clone();
