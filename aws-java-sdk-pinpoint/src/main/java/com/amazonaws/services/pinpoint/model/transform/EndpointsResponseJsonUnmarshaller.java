...
/**
 * EndpointsResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EndpointsResponseJsonUnmarshaller implements Unmarshaller<EndpointsResponse, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Item", targetDepth)) {
                    context.nextToken();
                    endpointsResponse.setItem(new ListUnmarshaller<EndpointResponse>(EndpointResponseJsonUnmarshaller.getInstance())
