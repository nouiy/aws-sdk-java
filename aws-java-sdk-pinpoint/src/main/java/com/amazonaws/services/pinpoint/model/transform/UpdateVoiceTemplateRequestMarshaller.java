...
/**
 * UpdateVoiceTemplateRequestMarshaller
 */
...
public class UpdateVoiceTemplateRequestMarshaller {
    ...
    private static final UpdateVoiceTemplateRequestMarshaller instance = new UpdateVoiceTemplateRequestMarshaller();

    public static UpdateVoiceTemplateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateVoiceTemplateRequest updateVoiceTemplateRequest, ProtocolMarshaller protocolMarshaller) {
