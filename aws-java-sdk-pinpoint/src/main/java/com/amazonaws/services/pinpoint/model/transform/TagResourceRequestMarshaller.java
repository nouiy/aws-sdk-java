...
public class TagResourceRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> TAGSMODEL_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(TagResourceRequest tagResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(tagResourceRequest.getTagsModel(), TAGSMODEL_BINDING);
        } catch (Exception e) {
