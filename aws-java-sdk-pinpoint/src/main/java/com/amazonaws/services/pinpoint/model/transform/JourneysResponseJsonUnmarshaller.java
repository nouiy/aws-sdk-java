...
/**
 * JourneysResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JourneysResponseJsonUnmarshaller implements Unmarshaller<JourneysResponse, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    journeysResponse.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
