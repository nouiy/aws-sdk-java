...
/**
 * GPSPointDimension JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GPSPointDimensionJsonUnmarshaller implements Unmarshaller<GPSPointDimension, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Coordinates", targetDepth)) {
                    context.nextToken();
                    gPSPointDimension.setCoordinates(GPSCoordinatesJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("RangeInKilometers", targetDepth)) {
                    context.nextToken();
                    gPSPointDimension.setRangeInKilometers(context.getUnmarshaller(Double.class).unmarshall(context));
                }
