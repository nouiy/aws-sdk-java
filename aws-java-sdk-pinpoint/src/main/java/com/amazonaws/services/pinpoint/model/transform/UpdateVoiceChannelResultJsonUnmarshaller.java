...
/**
 * UpdateVoiceChannelResult JSON Unmarshaller
 */
...
public class UpdateVoiceChannelResultJsonUnmarshaller implements Unmarshaller<UpdateVoiceChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateVoiceChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            updateVoiceChannelResult.setVoiceChannelResponse(VoiceChannelResponseJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
