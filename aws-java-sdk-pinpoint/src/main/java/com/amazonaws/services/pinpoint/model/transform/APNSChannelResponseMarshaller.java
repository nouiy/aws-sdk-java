...
public class APNSChannelResponseMarshaller {
    ...
    public void marshall(APNSChannelResponse aPNSChannelResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(aPNSChannelResponse.getDefaultAuthenticationMethod(), DEFAULTAUTHENTICATIONMETHOD_BINDING);
            protocolMarshaller.marshall(aPNSChannelResponse.getEnabled(), ENABLED_BINDING);
            protocolMarshaller.marshall(aPNSChannelResponse.getHasCredential(), HASCREDENTIAL_BINDING);
            protocolMarshaller.marshall(aPNSChannelResponse.getHasTokenKey(), HASTOKENKEY_BINDING);
