...
public class GetAdmChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetAdmChannelRequest clone() {
        return (GetAdmChannelRequest) super.clone();
    }
