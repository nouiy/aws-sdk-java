...
public class DeleteJourneyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteJourneyResult withJourneyResponse(JourneyResponse journeyResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteJourneyResult == false)
            return false;
        DeleteJourneyResult other = (DeleteJourneyResult) obj;
    ...
    @Override
    public DeleteJourneyResult clone() {
        try {
            return (DeleteJourneyResult) super.clone();
