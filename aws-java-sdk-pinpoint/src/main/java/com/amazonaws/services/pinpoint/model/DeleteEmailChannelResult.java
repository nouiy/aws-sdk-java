...
public class DeleteEmailChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteEmailChannelResult clone() {
        try {
            return (DeleteEmailChannelResult) super.clone();
