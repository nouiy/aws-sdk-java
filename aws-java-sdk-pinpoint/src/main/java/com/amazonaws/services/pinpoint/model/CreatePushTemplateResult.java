...
public class CreatePushTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreatePushTemplateResult withCreateTemplateMessageBody(CreateTemplateMessageBody createTemplateMessageBody) {
    ...
    @Override
    public CreatePushTemplateResult clone() {
        try {
            return (CreatePushTemplateResult) super.clone();
