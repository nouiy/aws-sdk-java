...
public class VerifyOTPMessageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VerifyOTPMessageResult == false)
            return false;
        VerifyOTPMessageResult other = (VerifyOTPMessageResult) obj;
        if (other.getVerificationResponse() == null ^ this.getVerificationResponse() == null)
            return false;
        if (other.getVerificationResponse() != null && other.getVerificationResponse().equals(this.getVerificationResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getVerificationResponse() == null) ? 0 : getVerificationResponse().hashCode());
        return hashCode;
    }
