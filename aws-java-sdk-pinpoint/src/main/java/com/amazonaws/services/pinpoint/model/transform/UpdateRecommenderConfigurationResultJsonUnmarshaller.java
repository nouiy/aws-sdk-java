...
/**
 * UpdateRecommenderConfigurationResult JSON Unmarshaller
 */
...
public class UpdateRecommenderConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateRecommenderConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateRecommenderConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            updateRecommenderConfigurationResult.setRecommenderConfigurationResponse(RecommenderConfigurationResponseJsonUnmarshaller.getInstance().unmarshall(
                    context));
            token = context.nextToken();
        }
