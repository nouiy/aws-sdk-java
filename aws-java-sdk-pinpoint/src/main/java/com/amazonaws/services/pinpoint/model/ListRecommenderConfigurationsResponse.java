...
/**
 * <p>
 * Provides information about all the recommender model configurations that are associated with your Amazon Pinpoint
 * account.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/ListRecommenderConfigurationsResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListRecommenderConfigurationsResponse implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return An array of responses, one for each recommender model configuration that's associated with your Amazon
     *         Pinpoint account.
     */
    ...
    public ListRecommenderConfigurationsResponse withItem(RecommenderConfigurationResponse... item) {
        if (this.item == null) {
            setItem(new java.util.ArrayList<RecommenderConfigurationResponse>(item.length));
        }
        for (RecommenderConfigurationResponse ele : item) {
            this.item.add(ele);
        }
        return this;
    }
    ...
    public ListRecommenderConfigurationsResponse withItem(java.util.Collection<RecommenderConfigurationResponse> item) {
        setItem(item);
        return this;
    }
    ...
    public ListRecommenderConfigurationsResponse clone() {
        try {
            return (ListRecommenderConfigurationsResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.ListRecommenderConfigurationsResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
