...
public class GetJourneyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getJourneyId() != null)
            sb.append("JourneyId: ").append(getJourneyId());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetJourneyRequest == false)
            return false;
        GetJourneyRequest other = (GetJourneyRequest) obj;
    ...
    @Override
    public GetJourneyRequest clone() {
        return (GetJourneyRequest) super.clone();
    }
