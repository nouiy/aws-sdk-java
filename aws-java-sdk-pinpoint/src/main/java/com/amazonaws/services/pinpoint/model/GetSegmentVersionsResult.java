...
public class GetSegmentVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetSegmentVersionsResult withSegmentsResponse(SegmentsResponse segmentsResponse) {
        setSegmentsResponse(segmentsResponse);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSegmentVersionsResult == false)
            return false;
        ...
        if (other.getSegmentsResponse() == null ^ this.getSegmentsResponse() == null)
            return false;
        if (other.getSegmentsResponse() != null && other.getSegmentsResponse().equals(this.getSegmentsResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSegmentsResponse() == null) ? 0 : getSegmentsResponse().hashCode());
        return hashCode;
    }

    @Override
    public GetSegmentVersionsResult clone() {
        try {
            return (GetSegmentVersionsResult) super.clone();
