        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Dimensions", targetDepth)) {
                    context.nextToken();
                    eventFilter.setDimensions(EventDimensionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("FilterType", targetDepth)) {
                    context.nextToken();
                    eventFilter.setFilterType(context.getUnmarshaller(String.class).unmarshall(context));
                }
