...
public class SendMessagesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMessageRequest() == null ^ this.getMessageRequest() == null)
            return false;
        if (other.getMessageRequest() != null && other.getMessageRequest().equals(this.getMessageRequest()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getMessageRequest() == null) ? 0 : getMessageRequest().hashCode());
        return hashCode;
    }

    @Override
    public SendMessagesRequest clone() {
        return (SendMessagesRequest) super.clone();
    }
