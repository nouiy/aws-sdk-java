...
/**
 * GetJourneyExecutionMetricsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetJourneyExecutionMetricsResultJsonUnmarshaller implements Unmarshaller<GetJourneyExecutionMetricsResult, JsonUnmarshallerContext> {

    public GetJourneyExecutionMetricsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
