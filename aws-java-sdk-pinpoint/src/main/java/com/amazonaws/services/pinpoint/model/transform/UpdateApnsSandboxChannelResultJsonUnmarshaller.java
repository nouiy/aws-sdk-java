...
/**
 * UpdateApnsSandboxChannelResult JSON Unmarshaller
 */
...
public class UpdateApnsSandboxChannelResultJsonUnmarshaller implements Unmarshaller<UpdateApnsSandboxChannelResult, JsonUnmarshallerContext> {
    ...
    public UpdateApnsSandboxChannelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            updateApnsSandboxChannelResult.setAPNSSandboxChannelResponse(APNSSandboxChannelResponseJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
