...
/**
 * RawEmail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RawEmailJsonUnmarshaller implements Unmarshaller<RawEmail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Data", targetDepth)) {
                    context.nextToken();
                    rawEmail.setData(context.getUnmarshaller(java.nio.ByteBuffer.class).unmarshall(context));
                }
