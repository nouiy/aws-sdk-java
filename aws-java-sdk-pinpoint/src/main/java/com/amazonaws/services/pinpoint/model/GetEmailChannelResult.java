...
public class GetEmailChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetEmailChannelResult clone() {
        try {
            return (GetEmailChannelResult) super.clone();
