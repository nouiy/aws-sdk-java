...
/**
 * CampaignEventFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CampaignEventFilterJsonUnmarshaller implements Unmarshaller<CampaignEventFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Dimensions", targetDepth)) {
                    context.nextToken();
                    campaignEventFilter.setDimensions(EventDimensionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("FilterType", targetDepth)) {
                    context.nextToken();
                    campaignEventFilter.setFilterType(context.getUnmarshaller(String.class).unmarshall(context));
                }
