...
/**
 * UpdateJourneyResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateJourneyResultJsonUnmarshaller implements Unmarshaller<UpdateJourneyResult, JsonUnmarshallerContext> {
    ...
    public UpdateJourneyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            updateJourneyResult.setJourneyResponse(JourneyResponseJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
