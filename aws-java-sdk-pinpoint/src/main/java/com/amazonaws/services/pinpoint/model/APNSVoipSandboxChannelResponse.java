 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/APNSVoipSandboxChannelResponse"
...
public class APNSVoipSandboxChannelResponse implements Serializable, Cloneable, StructuredPojo {
     ...
     * 
     * @param platform
     *        The type of messaging or notification platform for the channel. For the APNs VoIP sandbox channel, this
    ...
    public APNSVoipSandboxChannelResponse withVersion(Integer version) {
        setVersion(version);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof APNSVoipSandboxChannelResponse == false)
            return false;
    ...
    @Override
    public APNSVoipSandboxChannelResponse clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.APNSVoipSandboxChannelResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
