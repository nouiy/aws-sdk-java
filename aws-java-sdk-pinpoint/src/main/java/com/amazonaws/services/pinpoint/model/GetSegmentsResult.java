...
public class GetSegmentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public GetSegmentsResult clone() {
        try {
            return (GetSegmentsResult) super.clone();
