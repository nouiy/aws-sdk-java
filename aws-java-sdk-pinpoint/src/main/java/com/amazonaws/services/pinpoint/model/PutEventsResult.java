...
public class PutEventsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutEventsResult withEventsResponse(EventsResponse eventsResponse) {
        setEventsResponse(eventsResponse);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getEventsResponse() == null ^ this.getEventsResponse() == null)
            return false;
        if (other.getEventsResponse() != null && other.getEventsResponse().equals(this.getEventsResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getEventsResponse() == null) ? 0 : getEventsResponse().hashCode());
        return hashCode;
    }
