...
public class CampaignsResponseMarshaller {
    ...
    public void marshall(CampaignsResponse campaignsResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(campaignsResponse.getItem(), ITEM_BINDING);
            protocolMarshaller.marshall(campaignsResponse.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
