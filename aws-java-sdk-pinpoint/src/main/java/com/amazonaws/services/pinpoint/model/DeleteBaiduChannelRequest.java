...
public class DeleteBaiduChannelRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteBaiduChannelRequest clone() {
        return (DeleteBaiduChannelRequest) super.clone();
    }
