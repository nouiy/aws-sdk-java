...
public class DeleteAdmChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public DeleteAdmChannelResult clone() {
        try {
            return (DeleteAdmChannelResult) super.clone();
