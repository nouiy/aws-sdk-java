...
public class GetChannelsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetChannelsRequest withApplicationId(String applicationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetChannelsRequest == false)
            return false;
        GetChannelsRequest other = (GetChannelsRequest) obj;
    ...
    @Override
    public GetChannelsRequest clone() {
        return (GetChannelsRequest) super.clone();
    }
