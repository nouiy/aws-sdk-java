 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/JourneysResponse" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JourneysResponse implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<JourneyResponse> item;
    /**
     * <p>
    ...
    public java.util.List<JourneyResponse> getItem() {
        return item;
    }
    ...
    public void setItem(java.util.Collection<JourneyResponse> item) {
        if (item == null) {
            this.item = null;
            return;
        }

        this.item = new java.util.ArrayList<JourneyResponse>(item);
    }
    ...
    public JourneysResponse withItem(JourneyResponse... item) {
        if (this.item == null) {
            setItem(new java.util.ArrayList<JourneyResponse>(item.length));
        }
        for (JourneyResponse ele : item) {
            this.item.add(ele);
        }
        return this;
    }
    ...
    public JourneysResponse withItem(java.util.Collection<JourneyResponse> item) {
        setItem(item);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JourneysResponse == false)
            return false;
    ...
    @Override
    public JourneysResponse clone() {
        try {
            return (JourneysResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.JourneysResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
