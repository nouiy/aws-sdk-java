...
public class DeleteInAppTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteInAppTemplateRequest withTemplateName(String templateName) {
    ...
    public DeleteInAppTemplateRequest withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteInAppTemplateRequest == false)
            return false;
        DeleteInAppTemplateRequest other = (DeleteInAppTemplateRequest) obj;
    ...
    @Override
    public DeleteInAppTemplateRequest clone() {
