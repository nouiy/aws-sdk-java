...
public class DeleteSegmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteSegmentResult == false)
            return false;
    ...
    @Override
    public DeleteSegmentResult clone() {
        try {
            return (DeleteSegmentResult) super.clone();
