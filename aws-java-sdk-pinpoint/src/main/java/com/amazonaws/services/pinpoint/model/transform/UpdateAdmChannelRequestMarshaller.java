...
/**
 * UpdateAdmChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateAdmChannelRequestMarshaller {

    private static final MarshallingInfo<StructuredPojo> ADMCHANNELREQUEST_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).isExplicitPayloadMember(true).build();
    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final UpdateAdmChannelRequestMarshaller instance = new UpdateAdmChannelRequestMarshaller();

    public static UpdateAdmChannelRequestMarshaller getInstance() {
        return instance;
    }
