...
@SdkInternalApi
public class ExportJobsResponseMarshaller {
    ...
    private static final ExportJobsResponseMarshaller instance = new ExportJobsResponseMarshaller();

    public static ExportJobsResponseMarshaller getInstance() {
        return instance;
    }
