...
/**
 * DeleteApnsVoipChannelRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteApnsVoipChannelRequestMarshaller {

    private static final MarshallingInfo<String> APPLICATIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("application-id").build();

    private static final DeleteApnsVoipChannelRequestMarshaller instance = new DeleteApnsVoipChannelRequestMarshaller();

    public static DeleteApnsVoipChannelRequestMarshaller getInstance() {
        return instance;
    }
