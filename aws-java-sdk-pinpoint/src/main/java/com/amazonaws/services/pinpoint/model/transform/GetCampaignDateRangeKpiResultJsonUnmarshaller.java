...
/**
 * GetCampaignDateRangeKpiResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetCampaignDateRangeKpiResultJsonUnmarshaller implements Unmarshaller<GetCampaignDateRangeKpiResult, JsonUnmarshallerContext> {

    public GetCampaignDateRangeKpiResult unmarshall(JsonUnmarshallerContext context) throws Exception {
