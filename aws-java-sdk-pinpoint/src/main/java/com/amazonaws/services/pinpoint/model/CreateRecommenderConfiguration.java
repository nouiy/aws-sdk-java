...
public class CreateRecommenderConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see CreateRecommenderConfiguration#withAttributes
    ...
    public CreateRecommenderConfiguration clone() {
        try {
            return (CreateRecommenderConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.CreateRecommenderConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
