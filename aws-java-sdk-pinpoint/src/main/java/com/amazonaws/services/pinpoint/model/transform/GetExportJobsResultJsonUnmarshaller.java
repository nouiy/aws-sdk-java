...
/**
 * GetExportJobsResult JSON Unmarshaller
 */
...
public class GetExportJobsResultJsonUnmarshaller implements Unmarshaller<GetExportJobsResult, JsonUnmarshallerContext> {
    ...
    public GetExportJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetExportJobsResult getExportJobsResult = new GetExportJobsResult();
        ...
        while (true) {
            ...
            getExportJobsResult.setExportJobsResponse(ExportJobsResponseJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
