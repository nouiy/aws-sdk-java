...
/**
 * SimpleEmailPart JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SimpleEmailPartJsonUnmarshaller implements Unmarshaller<SimpleEmailPart, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Charset", targetDepth)) {
                    context.nextToken();
                    simpleEmailPart.setCharset(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Data", targetDepth)) {
                    context.nextToken();
                    simpleEmailPart.setData(context.getUnmarshaller(String.class).unmarshall(context));
                }
