...
public class GetApplicationSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public GetApplicationSettingsResult clone() {
        try {
            return (GetApplicationSettingsResult) super.clone();
