...
/**
 * CreateRecommenderConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateRecommenderConfigurationJsonUnmarshaller implements Unmarshaller<CreateRecommenderConfiguration, JsonUnmarshallerContext> {

    public CreateRecommenderConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
