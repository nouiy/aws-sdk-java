...
public class DeleteApnsSandboxChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public DeleteApnsSandboxChannelResult clone() {
        try {
            return (DeleteApnsSandboxChannelResult) super.clone();
