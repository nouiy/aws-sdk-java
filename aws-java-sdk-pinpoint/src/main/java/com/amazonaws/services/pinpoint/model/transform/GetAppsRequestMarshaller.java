...
/**
 * GetAppsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetAppsRequestMarshaller {
    ...
    private static final GetAppsRequestMarshaller instance = new GetAppsRequestMarshaller();

    public static GetAppsRequestMarshaller getInstance() {
        return instance;
    }
