...
@SdkInternalApi
public class InAppTemplateResponseMarshaller {
    ...
    private static final InAppTemplateResponseMarshaller instance = new InAppTemplateResponseMarshaller();

    public static InAppTemplateResponseMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InAppTemplateResponse inAppTemplateResponse, ProtocolMarshaller protocolMarshaller) {

        if (inAppTemplateResponse == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(inAppTemplateResponse.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getCreationDate(), CREATIONDATE_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getCustomConfig(), CUSTOMCONFIG_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getLayout(), LAYOUT_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getTemplateDescription(), TEMPLATEDESCRIPTION_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getTemplateName(), TEMPLATENAME_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getTemplateType(), TEMPLATETYPE_BINDING);
            protocolMarshaller.marshall(inAppTemplateResponse.getVersion(), VERSION_BINDING);
        } catch (Exception e) {
