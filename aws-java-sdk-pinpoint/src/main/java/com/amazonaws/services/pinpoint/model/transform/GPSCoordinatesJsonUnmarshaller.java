...
/**
 * GPSCoordinates JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GPSCoordinatesJsonUnmarshaller implements Unmarshaller<GPSCoordinates, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Latitude", targetDepth)) {
                    context.nextToken();
                    gPSCoordinates.setLatitude(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("Longitude", targetDepth)) {
                    context.nextToken();
                    gPSCoordinates.setLongitude(context.getUnmarshaller(Double.class).unmarshall(context));
                }
