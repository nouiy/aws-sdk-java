...
public class DeleteJourneyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteJourneyRequest clone() {
        return (DeleteJourneyRequest) super.clone();
    }
