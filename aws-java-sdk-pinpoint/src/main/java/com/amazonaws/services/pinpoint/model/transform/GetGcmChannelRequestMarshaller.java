...
/**
 * GetGcmChannelRequestMarshaller
 */
...
public class GetGcmChannelRequestMarshaller {
    ...
    private static final GetGcmChannelRequestMarshaller instance = new GetGcmChannelRequestMarshaller();

    public static GetGcmChannelRequestMarshaller getInstance() {
        return instance;
    }
