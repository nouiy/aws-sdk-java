...
public class UpdateRecommenderConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateRecommenderConfigurationResult withRecommenderConfigurationResponse(RecommenderConfigurationResponse recommenderConfigurationResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateRecommenderConfigurationResult == false)
            return false;
        UpdateRecommenderConfigurationResult other = (UpdateRecommenderConfigurationResult) obj;
    ...
    @Override
    public UpdateRecommenderConfigurationResult clone() {
        try {
            return (UpdateRecommenderConfigurationResult) super.clone();
