...
public class GetImportJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public GetImportJobsResult clone() {
        try {
            return (GetImportJobsResult) super.clone();
