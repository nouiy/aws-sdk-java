...
/**
 * EventItemResponse JSON Unmarshaller
 */
...
public class EventItemResponseJsonUnmarshaller implements Unmarshaller<EventItemResponse, JsonUnmarshallerContext> {
    ...
    public EventItemResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    eventItemResponse.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("StatusCode", targetDepth)) {
                    context.nextToken();
                    eventItemResponse.setStatusCode(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
