...
public class GetAppsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetAppsResult withApplicationsResponse(ApplicationsResponse applicationsResponse) {
        setApplicationsResponse(applicationsResponse);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getApplicationsResponse() == null ^ this.getApplicationsResponse() == null)
            return false;
        if (other.getApplicationsResponse() != null && other.getApplicationsResponse().equals(this.getApplicationsResponse()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getApplicationsResponse() == null) ? 0 : getApplicationsResponse().hashCode());
        return hashCode;
    }

    @Override
    public GetAppsResult clone() {
        try {
            return (GetAppsResult) super.clone();
