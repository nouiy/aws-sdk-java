...
public class DisassociateExternalConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateExternalConnectionResult == false)
            return false;
        DisassociateExternalConnectionResult other = (DisassociateExternalConnectionResult) obj;
    ...
    @Override
    public DisassociateExternalConnectionResult clone() {
        try {
            return (DisassociateExternalConnectionResult) super.clone();
