...
/**
 * UpdateRepositoryResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateRepositoryResultJsonUnmarshaller implements Unmarshaller<UpdateRepositoryResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("repository", targetDepth)) {
                    context.nextToken();
                    updateRepositoryResult.setRepository(RepositoryDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
