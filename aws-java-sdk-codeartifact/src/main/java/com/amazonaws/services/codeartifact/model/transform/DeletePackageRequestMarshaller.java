...
public class DeletePackageRequestMarshaller {
    ...
    public void marshall(DeletePackageRequest deletePackageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deletePackageRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(deletePackageRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(deletePackageRequest.getRepository(), REPOSITORY_BINDING);
            protocolMarshaller.marshall(deletePackageRequest.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(deletePackageRequest.getNamespace(), NAMESPACE_BINDING);
            protocolMarshaller.marshall(deletePackageRequest.getPackage(), PACKAGE_BINDING);
        } catch (Exception e) {
