...
public class DescribeDomainRequestMarshaller {
    ...
    public void marshall(DescribeDomainRequest describeDomainRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeDomainRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(describeDomainRequest.getDomainOwner(), DOMAINOWNER_BINDING);
        } catch (Exception e) {
