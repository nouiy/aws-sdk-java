...
/**
 * UpdateRepositoryRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateRepositoryRequestMarshaller {
    ...
    private static final UpdateRepositoryRequestMarshaller instance = new UpdateRepositoryRequestMarshaller();

    public static UpdateRepositoryRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateRepositoryRequest updateRepositoryRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateRepositoryRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(updateRepositoryRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(updateRepositoryRequest.getRepository(), REPOSITORY_BINDING);
            protocolMarshaller.marshall(updateRepositoryRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateRepositoryRequest.getUpstreams(), UPSTREAMS_BINDING);
        } catch (Exception e) {
