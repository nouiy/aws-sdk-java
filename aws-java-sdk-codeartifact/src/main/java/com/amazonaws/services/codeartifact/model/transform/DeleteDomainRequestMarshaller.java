...
public class DeleteDomainRequestMarshaller {
    ...
    public void marshall(DeleteDomainRequest deleteDomainRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteDomainRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(deleteDomainRequest.getDomainOwner(), DOMAINOWNER_BINDING);
        } catch (Exception e) {
