...
/**
 * PutRepositoryPermissionsPolicyRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutRepositoryPermissionsPolicyRequestMarshaller {
    ...
    private static final PutRepositoryPermissionsPolicyRequestMarshaller instance = new PutRepositoryPermissionsPolicyRequestMarshaller();

    public static PutRepositoryPermissionsPolicyRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutRepositoryPermissionsPolicyRequest putRepositoryPermissionsPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putRepositoryPermissionsPolicyRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(putRepositoryPermissionsPolicyRequest.getDomainOwner(), DOMAINOWNER_BINDING);
            protocolMarshaller.marshall(putRepositoryPermissionsPolicyRequest.getRepository(), REPOSITORY_BINDING);
            protocolMarshaller.marshall(putRepositoryPermissionsPolicyRequest.getPolicyRevision(), POLICYREVISION_BINDING);
            protocolMarshaller.marshall(putRepositoryPermissionsPolicyRequest.getPolicyDocument(), POLICYDOCUMENT_BINDING);
        } catch (Exception e) {
