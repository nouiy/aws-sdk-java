...
public class ResourcePolicyMarshaller {
    ...
    public void marshall(ResourcePolicy resourcePolicy, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourcePolicy.getResourceArn(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(resourcePolicy.getRevision(), REVISION_BINDING);
            protocolMarshaller.marshall(resourcePolicy.getDocument(), DOCUMENT_BINDING);
        } catch (Exception e) {
