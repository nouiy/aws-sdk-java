...
/**
 * DisposePackageVersionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisposePackageVersionsResultJsonUnmarshaller implements Unmarshaller<DisposePackageVersionsResult, JsonUnmarshallerContext> {

    public DisposePackageVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("successfulVersions", targetDepth)) {
                    context.nextToken();
                    disposePackageVersionsResult.setSuccessfulVersions(new MapUnmarshaller<String, SuccessfulPackageVersionInfo>(context
                ...
                if (context.testExpression("failedVersions", targetDepth)) {
                    context.nextToken();
                    disposePackageVersionsResult.setFailedVersions(new MapUnmarshaller<String, PackageVersionError>(context.getUnmarshaller(String.class),
