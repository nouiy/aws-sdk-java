...
public class DetectedLanguageLowConfidenceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DetectedLanguageCode", targetDepth)) {
                    context.nextToken();
                    detectedLanguageLowConfidenceException.setDetectedLanguageCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static DetectedLanguageLowConfidenceExceptionUnmarshaller instance;

    public static DetectedLanguageLowConfidenceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DetectedLanguageLowConfidenceExceptionUnmarshaller();
        return instance;
    }
}
