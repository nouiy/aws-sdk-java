...
/**
 * ParallelDataDataLocation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParallelDataDataLocationJsonUnmarshaller implements Unmarshaller<ParallelDataDataLocation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RepositoryType", targetDepth)) {
                    context.nextToken();
                    parallelDataDataLocation.setRepositoryType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Location", targetDepth)) {
                    context.nextToken();
                    parallelDataDataLocation.setLocation(context.getUnmarshaller(String.class).unmarshall(context));
                }
