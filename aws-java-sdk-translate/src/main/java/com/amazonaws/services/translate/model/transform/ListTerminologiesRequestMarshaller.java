...
/**
 * ListTerminologiesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListTerminologiesRequestMarshaller {
    ...
    private static final ListTerminologiesRequestMarshaller instance = new ListTerminologiesRequestMarshaller();

    public static ListTerminologiesRequestMarshaller getInstance() {
        return instance;
    }
