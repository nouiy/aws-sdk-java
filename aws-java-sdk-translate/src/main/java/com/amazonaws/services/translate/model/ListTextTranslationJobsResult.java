...
public class ListTextTranslationJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @param textTranslationJobPropertiesList
     *        A list containing the properties of each job that is returned.
     */
    ...
    public void setTextTranslationJobPropertiesList(java.util.Collection<TextTranslationJobProperties> textTranslationJobPropertiesList) {
        ...
        this.textTranslationJobPropertiesList = new java.util.ArrayList<TextTranslationJobProperties>(textTranslationJobPropertiesList);
    }
     ...
     * {@link #setTextTranslationJobPropertiesList(java.util.Collection)} or
     * {@link #withTextTranslationJobPropertiesList(java.util.Collection)} if you want to override the existing values.
     * </p>
     * 
     * @param textTranslationJobPropertiesList
     *        A list containing the properties of each job that is returned.
    ...
    public ListTextTranslationJobsResult withTextTranslationJobPropertiesList(TextTranslationJobProperties... textTranslationJobPropertiesList) {
        if (this.textTranslationJobPropertiesList == null) {
            setTextTranslationJobPropertiesList(new java.util.ArrayList<TextTranslationJobProperties>(textTranslationJobPropertiesList.length));
        }
        for (TextTranslationJobProperties ele : textTranslationJobPropertiesList) {
            this.textTranslationJobPropertiesList.add(ele);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getTextTranslationJobPropertiesList() != null)
            sb.append("TextTranslationJobPropertiesList: ").append(getTextTranslationJobPropertiesList()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTextTranslationJobPropertiesList() == null ^ this.getTextTranslationJobPropertiesList() == null)
            return false;
        if (other.getTextTranslationJobPropertiesList() != null
                && other.getTextTranslationJobPropertiesList().equals(this.getTextTranslationJobPropertiesList()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTextTranslationJobPropertiesList() == null) ? 0 : getTextTranslationJobPropertiesList().hashCode());
    ...
    public ListTextTranslationJobsResult clone() {
        try {
            return (ListTextTranslationJobsResult) super.clone();
