...
public class ListTerminologiesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return If the result of the request to ListTerminologies was truncated, include the NextToken to fetch the next
     *         group of custom terminologies.
     */
    ...
    public ListTerminologiesRequest clone() {
        return (ListTerminologiesRequest) super.clone();
    }
