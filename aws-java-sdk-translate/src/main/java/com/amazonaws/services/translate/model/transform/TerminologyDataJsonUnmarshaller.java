...
/**
 * TerminologyData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TerminologyDataJsonUnmarshaller implements Unmarshaller<TerminologyData, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("File", targetDepth)) {
                    context.nextToken();
                    terminologyData.setFile(context.getUnmarshaller(java.nio.ByteBuffer.class).unmarshall(context));
                }
                if (context.testExpression("Format", targetDepth)) {
                    context.nextToken();
                    terminologyData.setFormat(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Directionality", targetDepth)) {
                    context.nextToken();
                    terminologyData.setDirectionality(context.getUnmarshaller(String.class).unmarshall(context));
                }
