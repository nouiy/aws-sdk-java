...
/**
 * TerminologyDataLocation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TerminologyDataLocationJsonUnmarshaller implements Unmarshaller<TerminologyDataLocation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RepositoryType", targetDepth)) {
                    context.nextToken();
                    terminologyDataLocation.setRepositoryType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Location", targetDepth)) {
                    context.nextToken();
                    terminologyDataLocation.setLocation(context.getUnmarshaller(String.class).unmarshall(context));
                }
