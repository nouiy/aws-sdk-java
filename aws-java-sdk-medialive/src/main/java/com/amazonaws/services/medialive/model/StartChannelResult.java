...
public class StartChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartChannelResult withDestinations(OutputDestination... destinations) {
    ...
    public StartChannelResult withDestinations(java.util.Collection<OutputDestination> destinations) {
    ...
    public StartChannelResult withEgressEndpoints(ChannelEgressEndpoint... egressEndpoints) {
    ...
    public StartChannelResult withEgressEndpoints(java.util.Collection<ChannelEgressEndpoint> egressEndpoints) {
    ...
    public StartChannelResult withInputAttachments(InputAttachment... inputAttachments) {
    ...
    public StartChannelResult withInputAttachments(java.util.Collection<InputAttachment> inputAttachments) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartChannelResult == false)
            return false;
        StartChannelResult other = (StartChannelResult) obj;
    ...
    public StartChannelResult clone() {
        try {
            return (StartChannelResult) super.clone();
