...
public class CancelInputDeviceTransferRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The unique ID of the input device to cancel. For example, hd-123456789abcdef.
     * 
     * @return The unique ID of the input device to cancel. For example, hd-123456789abcdef.
     */
    ...
    public CancelInputDeviceTransferRequest withInputDeviceId(String inputDeviceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelInputDeviceTransferRequest == false)
            return false;
        CancelInputDeviceTransferRequest other = (CancelInputDeviceTransferRequest) obj;
    ...
    @Override
    public CancelInputDeviceTransferRequest clone() {
        return (CancelInputDeviceTransferRequest) super.clone();
    }
