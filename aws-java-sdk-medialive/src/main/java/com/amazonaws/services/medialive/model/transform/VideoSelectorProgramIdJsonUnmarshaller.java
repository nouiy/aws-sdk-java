...
/**
 * VideoSelectorProgramId JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VideoSelectorProgramIdJsonUnmarshaller implements Unmarshaller<VideoSelectorProgramId, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("programId", targetDepth)) {
                    context.nextToken();
                    videoSelectorProgramId.setProgramId(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
