...
public class InputSourceMarshaller {
    ...
    public void marshall(InputSource inputSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputSource.getPasswordParam(), PASSWORDPARAM_BINDING);
            protocolMarshaller.marshall(inputSource.getUrl(), URL_BINDING);
            protocolMarshaller.marshall(inputSource.getUsername(), USERNAME_BINDING);
        } catch (Exception e) {
