...
/**
 * Scte35TimeSignalApos JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Scte35TimeSignalAposJsonUnmarshaller implements Unmarshaller<Scte35TimeSignalApos, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("adAvailOffset", targetDepth)) {
                    context.nextToken();
                    scte35TimeSignalApos.setAdAvailOffset(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("noRegionalBlackoutFlag", targetDepth)) {
                    context.nextToken();
                    scte35TimeSignalApos.setNoRegionalBlackoutFlag(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("webDeliveryAllowedFlag", targetDepth)) {
                    context.nextToken();
                    scte35TimeSignalApos.setWebDeliveryAllowedFlag(context.getUnmarshaller(String.class).unmarshall(context));
                }
