...
public class DescribeInputFunction implements SdkFunction<DescribeInputRequest, DescribeInputResult> {
    ...
    /**
     * Constructs a new DescribeInputFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public DescribeInputFunction(AWSMediaLive client) {
        this.client = client;
    }
    ...
    public DescribeInputResult apply(DescribeInputRequest describeInputRequest) {
        return client.describeInput(describeInputRequest);
    }
}
