...
public class DescribeInputDeviceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeInputDeviceRequest clone() {
        return (DescribeInputDeviceRequest) super.clone();
    }
