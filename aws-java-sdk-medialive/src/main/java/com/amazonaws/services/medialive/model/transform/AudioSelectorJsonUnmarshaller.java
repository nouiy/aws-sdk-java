...
/**
 * AudioSelector JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AudioSelectorJsonUnmarshaller implements Unmarshaller<AudioSelector, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    audioSelector.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("selectorSettings", targetDepth)) {
                    context.nextToken();
                    audioSelector.setSelectorSettings(AudioSelectorSettingsJsonUnmarshaller.getInstance().unmarshall(context));
                }
