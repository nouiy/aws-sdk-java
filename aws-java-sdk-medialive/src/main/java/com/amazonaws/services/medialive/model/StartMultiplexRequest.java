...
public class StartMultiplexRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartMultiplexRequest withMultiplexId(String multiplexId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMultiplexRequest == false)
            return false;
        StartMultiplexRequest other = (StartMultiplexRequest) obj;
    ...
    @Override
    public StartMultiplexRequest clone() {
        return (StartMultiplexRequest) super.clone();
    }
