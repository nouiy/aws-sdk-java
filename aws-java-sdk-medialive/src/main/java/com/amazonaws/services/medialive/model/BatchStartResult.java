...
public class BatchStartResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchStartResult withFailed(BatchFailedResultModel... failed) {
        if (this.failed == null) {
    ...
    public BatchStartResult withFailed(java.util.Collection<BatchFailedResultModel> failed) {
        setFailed(failed);
        return this;
    }
    ...
    public BatchStartResult withSuccessful(java.util.Collection<BatchSuccessfulResultModel> successful) {
