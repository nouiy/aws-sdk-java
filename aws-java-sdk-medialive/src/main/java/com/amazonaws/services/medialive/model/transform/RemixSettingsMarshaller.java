...
public class RemixSettingsMarshaller {
    ...
    private static final MarshallingInfo<List> CHANNELMAPPINGS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("channelMappings").build();
