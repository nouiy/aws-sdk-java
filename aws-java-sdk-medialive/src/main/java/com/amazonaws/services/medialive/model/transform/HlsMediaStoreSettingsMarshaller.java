...
/**
 * HlsMediaStoreSettingsMarshaller
 */
...
public class HlsMediaStoreSettingsMarshaller {
    ...
    private static final MarshallingInfo<String> MEDIASTORESTORAGECLASS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("mediaStoreStorageClass").build();
    ...
    public void marshall(HlsMediaStoreSettings hlsMediaStoreSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(hlsMediaStoreSettings.getConnectionRetryInterval(), CONNECTIONRETRYINTERVAL_BINDING);
            protocolMarshaller.marshall(hlsMediaStoreSettings.getFilecacheDuration(), FILECACHEDURATION_BINDING);
            protocolMarshaller.marshall(hlsMediaStoreSettings.getMediaStoreStorageClass(), MEDIASTORESTORAGECLASS_BINDING);
            protocolMarshaller.marshall(hlsMediaStoreSettings.getNumRetries(), NUMRETRIES_BINDING);
            protocolMarshaller.marshall(hlsMediaStoreSettings.getRestartDelay(), RESTARTDELAY_BINDING);
        } catch (Exception e) {
