...
public class EmbeddedSourceSettingsMarshaller {
    ...
    private static final MarshallingInfo<String> SCTE20DETECTION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("scte20Detection").build();
    ...
    public void marshall(EmbeddedSourceSettings embeddedSourceSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(embeddedSourceSettings.getScte20Detection(), SCTE20DETECTION_BINDING);
