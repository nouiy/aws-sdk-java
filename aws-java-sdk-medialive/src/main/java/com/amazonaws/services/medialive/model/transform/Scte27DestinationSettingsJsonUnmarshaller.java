...
/**
 * Scte27DestinationSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Scte27DestinationSettingsJsonUnmarshaller implements Unmarshaller<Scte27DestinationSettings, JsonUnmarshallerContext> {
    ...
    public static Scte27DestinationSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new Scte27DestinationSettingsJsonUnmarshaller();
        return instance;
    }
}
