...
/**
 * StaticImageDeactivateScheduleActionSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StaticImageDeactivateScheduleActionSettingsJsonUnmarshaller implements
        Unmarshaller<StaticImageDeactivateScheduleActionSettings, JsonUnmarshallerContext> {

    public StaticImageDeactivateScheduleActionSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fadeOut", targetDepth)) {
                    context.nextToken();
                    staticImageDeactivateScheduleActionSettings.setFadeOut(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("layer", targetDepth)) {
                    context.nextToken();
                    staticImageDeactivateScheduleActionSettings.setLayer(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
