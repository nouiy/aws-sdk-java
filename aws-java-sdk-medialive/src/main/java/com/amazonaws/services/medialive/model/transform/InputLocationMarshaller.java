...
public class InputLocationMarshaller {
    ...
    public void marshall(InputLocation inputLocation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputLocation.getPasswordParam(), PASSWORDPARAM_BINDING);
            protocolMarshaller.marshall(inputLocation.getUri(), URI_BINDING);
            protocolMarshaller.marshall(inputLocation.getUsername(), USERNAME_BINDING);
        } catch (Exception e) {
