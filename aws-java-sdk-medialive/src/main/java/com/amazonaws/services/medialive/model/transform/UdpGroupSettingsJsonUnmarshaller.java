...
/**
 * UdpGroupSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UdpGroupSettingsJsonUnmarshaller implements Unmarshaller<UdpGroupSettings, JsonUnmarshallerContext> {

    public UdpGroupSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        UdpGroupSettings udpGroupSettings = new UdpGroupSettings();
    ...
    private static UdpGroupSettingsJsonUnmarshaller instance;

    public static UdpGroupSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UdpGroupSettingsJsonUnmarshaller();
        return instance;
    }
}
