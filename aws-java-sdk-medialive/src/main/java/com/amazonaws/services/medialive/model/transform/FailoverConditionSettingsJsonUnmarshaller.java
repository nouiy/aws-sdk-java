...
/**
 * FailoverConditionSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FailoverConditionSettingsJsonUnmarshaller implements Unmarshaller<FailoverConditionSettings, JsonUnmarshallerContext> {

    public FailoverConditionSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        FailoverConditionSettings failoverConditionSettings = new FailoverConditionSettings();
    ...
    private static FailoverConditionSettingsJsonUnmarshaller instance;

    public static FailoverConditionSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FailoverConditionSettingsJsonUnmarshaller();
        return instance;
    }
}
