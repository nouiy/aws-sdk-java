 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/MultiplexProgram" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MultiplexProgram implements Serializable, Cloneable, StructuredPojo {
    ...
    public MultiplexProgram withPipelineDetails(MultiplexProgramPipelineDetail... pipelineDetails) {
    ...
    public MultiplexProgram withPipelineDetails(java.util.Collection<MultiplexProgramPipelineDetail> pipelineDetails) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MultiplexProgram == false)
            return false;
    ...
    public MultiplexProgram clone() {
        try {
            return (MultiplexProgram) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.MultiplexProgramMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
