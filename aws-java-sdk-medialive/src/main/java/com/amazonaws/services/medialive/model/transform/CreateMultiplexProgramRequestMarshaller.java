...
@SdkInternalApi
public class CreateMultiplexProgramRequestMarshaller {
    ...
    private static final CreateMultiplexProgramRequestMarshaller instance = new CreateMultiplexProgramRequestMarshaller();

    public static CreateMultiplexProgramRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateMultiplexProgramRequest createMultiplexProgramRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createMultiplexProgramRequest.getMultiplexId(), MULTIPLEXID_BINDING);
            protocolMarshaller.marshall(createMultiplexProgramRequest.getMultiplexProgramSettings(), MULTIPLEXPROGRAMSETTINGS_BINDING);
            protocolMarshaller.marshall(createMultiplexProgramRequest.getProgramName(), PROGRAMNAME_BINDING);
            protocolMarshaller.marshall(createMultiplexProgramRequest.getRequestId(), REQUESTID_BINDING);
        } catch (Exception e) {
