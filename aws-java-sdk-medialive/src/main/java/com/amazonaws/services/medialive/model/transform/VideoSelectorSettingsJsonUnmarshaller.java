...
/**
 * VideoSelectorSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VideoSelectorSettingsJsonUnmarshaller implements Unmarshaller<VideoSelectorSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("videoSelectorPid", targetDepth)) {
                    context.nextToken();
                    videoSelectorSettings.setVideoSelectorPid(VideoSelectorPidJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("videoSelectorProgramId", targetDepth)) {
                    context.nextToken();
                    videoSelectorSettings.setVideoSelectorProgramId(VideoSelectorProgramIdJsonUnmarshaller.getInstance().unmarshall(context));
                }
