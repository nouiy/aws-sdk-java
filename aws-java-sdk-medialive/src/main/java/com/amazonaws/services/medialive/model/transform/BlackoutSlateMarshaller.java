...
/**
 * BlackoutSlateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BlackoutSlateMarshaller {

    private static final MarshallingInfo<StructuredPojo> BLACKOUTSLATEIMAGE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("blackoutSlateImage").build();
    private static final MarshallingInfo<String> NETWORKENDBLACKOUT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("networkEndBlackout").build();
    private static final MarshallingInfo<StructuredPojo> NETWORKENDBLACKOUTIMAGE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("networkEndBlackoutImage").build();
