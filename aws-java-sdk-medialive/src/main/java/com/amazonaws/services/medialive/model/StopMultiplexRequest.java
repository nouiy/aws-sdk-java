...
public class StopMultiplexRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StopMultiplexRequest withMultiplexId(String multiplexId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopMultiplexRequest == false)
            return false;
        StopMultiplexRequest other = (StopMultiplexRequest) obj;
    ...
    @Override
    public StopMultiplexRequest clone() {
        return (StopMultiplexRequest) super.clone();
    }
