 ...
 * Hls S3 Settings
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/medialive-2017-10-14/HlsS3Settings" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HlsS3Settings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HlsS3Settings == false)
            return false;
        HlsS3Settings other = (HlsS3Settings) obj;
    ...
    public HlsS3Settings clone() {
        try {
            return (HlsS3Settings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.medialive.model.transform.HlsS3SettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
