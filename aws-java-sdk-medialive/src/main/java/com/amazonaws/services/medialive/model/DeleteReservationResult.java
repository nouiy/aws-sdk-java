...
public class DeleteReservationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteReservationResult == false)
            return false;
        DeleteReservationResult other = (DeleteReservationResult) obj;
    ...
    public DeleteReservationResult clone() {
        try {
            return (DeleteReservationResult) super.clone();
