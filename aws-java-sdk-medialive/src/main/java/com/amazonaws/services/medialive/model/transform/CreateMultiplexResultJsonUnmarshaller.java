...
/**
 * CreateMultiplexResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateMultiplexResultJsonUnmarshaller implements Unmarshaller<CreateMultiplexResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("multiplex", targetDepth)) {
                    context.nextToken();
                    createMultiplexResult.setMultiplex(MultiplexJsonUnmarshaller.getInstance().unmarshall(context));
                }
