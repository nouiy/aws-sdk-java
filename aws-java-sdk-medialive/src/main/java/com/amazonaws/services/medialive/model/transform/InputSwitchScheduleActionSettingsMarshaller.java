...
/**
 * InputSwitchScheduleActionSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InputSwitchScheduleActionSettingsMarshaller {
    ...
    public static InputSwitchScheduleActionSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InputSwitchScheduleActionSettings inputSwitchScheduleActionSettings, ProtocolMarshaller protocolMarshaller) {

        if (inputSwitchScheduleActionSettings == null) {
