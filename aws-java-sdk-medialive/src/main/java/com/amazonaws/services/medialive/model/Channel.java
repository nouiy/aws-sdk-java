...
public class Channel implements Serializable, Cloneable, StructuredPojo {
    ...
    public Channel withPipelineDetails(PipelineDetail... pipelineDetails) {
    ...
    public Channel withPipelineDetails(java.util.Collection<PipelineDetail> pipelineDetails) {
