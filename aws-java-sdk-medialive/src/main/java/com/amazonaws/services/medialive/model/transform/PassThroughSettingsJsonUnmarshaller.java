...
/**
 * PassThroughSettings JSON Unmarshaller
 */
...
public class PassThroughSettingsJsonUnmarshaller implements Unmarshaller<PassThroughSettings, JsonUnmarshallerContext> {
    ...
    public PassThroughSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        PassThroughSettings passThroughSettings = new PassThroughSettings();
