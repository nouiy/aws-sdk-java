...
/**
 * CreateInputSecurityGroupRequestMarshaller
 */
...
public class CreateInputSecurityGroupRequestMarshaller {
    ...
    private static final CreateInputSecurityGroupRequestMarshaller instance = new CreateInputSecurityGroupRequestMarshaller();

    public static CreateInputSecurityGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateInputSecurityGroupRequest createInputSecurityGroupRequest, ProtocolMarshaller protocolMarshaller) {
