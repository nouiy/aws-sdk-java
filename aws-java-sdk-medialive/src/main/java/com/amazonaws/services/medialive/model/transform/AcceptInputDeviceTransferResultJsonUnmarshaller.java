...
/**
 * AcceptInputDeviceTransferResult JSON Unmarshaller
 */
...
public class AcceptInputDeviceTransferResultJsonUnmarshaller implements Unmarshaller<AcceptInputDeviceTransferResult, JsonUnmarshallerContext> {
    ...
    public AcceptInputDeviceTransferResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AcceptInputDeviceTransferResult acceptInputDeviceTransferResult = new AcceptInputDeviceTransferResult();

        return acceptInputDeviceTransferResult;
    }
