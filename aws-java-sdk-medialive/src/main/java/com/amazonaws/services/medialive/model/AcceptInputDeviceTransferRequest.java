...
public class AcceptInputDeviceTransferRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * The unique ID of the input device to accept. For example, hd-123456789abcdef.
     * 
     * @return The unique ID of the input device to accept. For example, hd-123456789abcdef.
     */
    ...
    public AcceptInputDeviceTransferRequest withInputDeviceId(String inputDeviceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptInputDeviceTransferRequest == false)
            return false;
        AcceptInputDeviceTransferRequest other = (AcceptInputDeviceTransferRequest) obj;
    ...
    @Override
    public AcceptInputDeviceTransferRequest clone() {
        return (AcceptInputDeviceTransferRequest) super.clone();
    }
