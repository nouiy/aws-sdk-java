...
/**
 * Scte35ReturnToNetworkScheduleActionSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Scte35ReturnToNetworkScheduleActionSettingsJsonUnmarshaller implements
        Unmarshaller<Scte35ReturnToNetworkScheduleActionSettings, JsonUnmarshallerContext> {

    public Scte35ReturnToNetworkScheduleActionSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("spliceEventId", targetDepth)) {
                    context.nextToken();
                    scte35ReturnToNetworkScheduleActionSettings.setSpliceEventId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
