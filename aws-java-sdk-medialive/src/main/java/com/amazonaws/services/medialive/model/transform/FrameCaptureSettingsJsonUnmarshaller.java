        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("captureInterval", targetDepth)) {
                    context.nextToken();
                    frameCaptureSettings.setCaptureInterval(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("captureIntervalUnits", targetDepth)) {
                    context.nextToken();
                    frameCaptureSettings.setCaptureIntervalUnits(context.getUnmarshaller(String.class).unmarshall(context));
                }
