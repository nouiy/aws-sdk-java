...
public class UpdateReservationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public UpdateReservationResult clone() {
        try {
            return (UpdateReservationResult) super.clone();
