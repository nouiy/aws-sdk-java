...
public enum Scte35DeviceRestrictions {
    ...
    private Scte35DeviceRestrictions(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return Scte35DeviceRestrictions corresponding to the value
     *
    ...
    public static Scte35DeviceRestrictions fromValue(String value) {
        ...
        for (Scte35DeviceRestrictions enumEntry : Scte35DeviceRestrictions.values()) {
