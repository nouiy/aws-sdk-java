...
public class ListOfferingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListOfferingsRequest withChannelConfiguration(String channelConfiguration) {
    ...
    public ListOfferingsRequest withMaxResults(Integer maxResults) {
    ...
    public ListOfferingsRequest withMaximumBitrate(String maximumBitrate) {
    ...
    public ListOfferingsRequest withMaximumFramerate(String maximumFramerate) {
    ...
    public ListOfferingsRequest withResolution(String resolution) {
    ...
    public ListOfferingsRequest withResourceType(String resourceType) {
    ...
    public ListOfferingsRequest withSpecialFeature(String specialFeature) {
    ...
    public ListOfferingsRequest withVideoQuality(String videoQuality) {
