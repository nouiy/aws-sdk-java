...
/**
 * DescribeMultiplexProgramResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeMultiplexProgramResultJsonUnmarshaller implements Unmarshaller<DescribeMultiplexProgramResult, JsonUnmarshallerContext> {

    public DescribeMultiplexProgramResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeMultiplexProgramResult describeMultiplexProgramResult = new DescribeMultiplexProgramResult();
    ...
    private static DescribeMultiplexProgramResultJsonUnmarshaller instance;

    public static DescribeMultiplexProgramResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeMultiplexProgramResultJsonUnmarshaller();
        return instance;
    }
}
