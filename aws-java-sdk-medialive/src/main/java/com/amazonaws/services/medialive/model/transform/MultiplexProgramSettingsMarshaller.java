...
/**
 * MultiplexProgramSettingsMarshaller
 */
...
public class MultiplexProgramSettingsMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> SERVICEDESCRIPTOR_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("serviceDescriptor").build();
    private static final MarshallingInfo<StructuredPojo> VIDEOSETTINGS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("videoSettings").build();
