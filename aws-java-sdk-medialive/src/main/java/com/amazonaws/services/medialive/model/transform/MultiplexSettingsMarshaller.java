...
/**
 * MultiplexSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MultiplexSettingsMarshaller {

    private static final MarshallingInfo<Integer> MAXIMUMVIDEOBUFFERDELAYMILLISECONDS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("maximumVideoBufferDelayMilliseconds").build();
    private static final MarshallingInfo<Integer> TRANSPORTSTREAMBITRATE_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("transportStreamBitrate").build();
    ...
    private static final MarshallingInfo<Integer> TRANSPORTSTREAMRESERVEDBITRATE_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("transportStreamReservedBitrate").build();
