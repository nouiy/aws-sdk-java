...
public class DeleteMultiplexResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteMultiplexResult withAvailabilityZones(java.util.Collection<String> availabilityZones) {
    ...
    public DeleteMultiplexResult withDestinations(java.util.Collection<MultiplexOutputDestination> destinations) {
     ...
     *
     * @see DeleteMultiplexResult#withTags
    ...
    @Override
    public DeleteMultiplexResult clone() {
        try {
            return (DeleteMultiplexResult) super.clone();
