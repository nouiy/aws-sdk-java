...
/**
 * UdpContainerSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UdpContainerSettingsMarshaller {
    ...
    private static final UdpContainerSettingsMarshaller instance = new UdpContainerSettingsMarshaller();

    public static UdpContainerSettingsMarshaller getInstance() {
        return instance;
    }
