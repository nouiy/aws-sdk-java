...
public class BatchStopResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchStopResult withFailed(BatchFailedResultModel... failed) {
        if (this.failed == null) {
    ...
    public BatchStopResult withFailed(java.util.Collection<BatchFailedResultModel> failed) {
        setFailed(failed);
        return this;
    }
    ...
    public BatchStopResult withSuccessful(BatchSuccessfulResultModel... successful) {
    ...
    public BatchStopResult withSuccessful(java.util.Collection<BatchSuccessfulResultModel> successful) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchStopResult == false)
            return false;
        BatchStopResult other = (BatchStopResult) obj;
    ...
    public BatchStopResult clone() {
        try {
            return (BatchStopResult) super.clone();
