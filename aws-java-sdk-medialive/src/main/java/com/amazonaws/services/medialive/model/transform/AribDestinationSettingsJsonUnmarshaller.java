...
/**
 * AribDestinationSettings JSON Unmarshaller
 */
...
public class AribDestinationSettingsJsonUnmarshaller implements Unmarshaller<AribDestinationSettings, JsonUnmarshallerContext> {
    ...
    public AribDestinationSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        AribDestinationSettings aribDestinationSettings = new AribDestinationSettings();
