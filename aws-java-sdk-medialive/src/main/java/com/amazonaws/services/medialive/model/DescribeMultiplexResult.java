...
public class DescribeMultiplexResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeMultiplexResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public DescribeMultiplexResult withAvailabilityZones(String... availabilityZones) {
    ...
    public DescribeMultiplexResult withAvailabilityZones(java.util.Collection<String> availabilityZones) {
    ...
    public DescribeMultiplexResult withDestinations(MultiplexOutputDestination... destinations) {
    ...
    public DescribeMultiplexResult withDestinations(java.util.Collection<MultiplexOutputDestination> destinations) {
    ...
    public DescribeMultiplexResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public DescribeMultiplexResult withMultiplexSettings(MultiplexSettings multiplexSettings) {
    ...
    public DescribeMultiplexResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public DescribeMultiplexResult withPipelinesRunningCount(Integer pipelinesRunningCount) {
    ...
    public DescribeMultiplexResult withProgramCount(Integer programCount) {
    ...
    public DescribeMultiplexResult withState(String state) {
        setState(state);
        return this;
    }
    ...
    public DescribeMultiplexResult withState(MultiplexState state) {
    ...
    public DescribeMultiplexResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeMultiplexResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DescribeMultiplexResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public DescribeMultiplexResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMultiplexResult == false)
            return false;
        DescribeMultiplexResult other = (DescribeMultiplexResult) obj;
    ...
    @Override
    public DescribeMultiplexResult clone() {
        try {
            return (DescribeMultiplexResult) super.clone();
