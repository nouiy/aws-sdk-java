...
public class SentimentResponseMarshaller {
    ...
    private static final MarshallingInfo<String> SENTIMENTLABEL_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("sentimentLabel").build();
    private static final MarshallingInfo<String> SENTIMENTSCORE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public void marshall(SentimentResponse sentimentResponse, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sentimentResponse.getSentimentLabel(), SENTIMENTLABEL_BINDING);
