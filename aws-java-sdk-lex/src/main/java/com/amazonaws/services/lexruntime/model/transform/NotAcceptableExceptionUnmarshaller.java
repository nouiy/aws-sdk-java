...
public class NotAcceptableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NotAcceptableExceptionUnmarshaller instance;

    public static NotAcceptableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotAcceptableExceptionUnmarshaller();
        return instance;
    }
}
