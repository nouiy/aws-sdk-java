...
/**
 * EdgeMetricMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EdgeMetricMarshaller {
    ...
    private static final EdgeMetricMarshaller instance = new EdgeMetricMarshaller();

    public static EdgeMetricMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EdgeMetric edgeMetric, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(edgeMetric.getDimension(), DIMENSION_BINDING);
            protocolMarshaller.marshall(edgeMetric.getMetricName(), METRICNAME_BINDING);
            protocolMarshaller.marshall(edgeMetric.getValue(), VALUE_BINDING);
            protocolMarshaller.marshall(edgeMetric.getTimestamp(), TIMESTAMP_BINDING);
        } catch (Exception e) {
