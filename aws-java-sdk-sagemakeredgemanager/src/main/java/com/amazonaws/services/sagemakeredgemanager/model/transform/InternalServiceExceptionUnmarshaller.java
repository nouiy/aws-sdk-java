...
public class InternalServiceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServiceExceptionUnmarshaller() {
        super(com.amazonaws.services.sagemakeredgemanager.model.InternalServiceException.class, "InternalServiceException");
    }

    @Override
    public com.amazonaws.services.sagemakeredgemanager.model.InternalServiceException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.sagemakeredgemanager.model.InternalServiceException internalServiceException = new com.amazonaws.services.sagemakeredgemanager.model.InternalServiceException(
                null);
