...
/**
 * SendHeartbeatResult JSON Unmarshaller
 */
...
public class SendHeartbeatResultJsonUnmarshaller implements Unmarshaller<SendHeartbeatResult, JsonUnmarshallerContext> {
    ...
    public SendHeartbeatResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SendHeartbeatResult sendHeartbeatResult = new SendHeartbeatResult();
