...
public class GetServiceQuotaIncreaseRequestFromTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public GetServiceQuotaIncreaseRequestFromTemplateResult withServiceQuotaIncreaseRequestInTemplate(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServiceQuotaIncreaseRequestFromTemplateResult == false)
            return false;
        GetServiceQuotaIncreaseRequestFromTemplateResult other = (GetServiceQuotaIncreaseRequestFromTemplateResult) obj;
    ...
    @Override
    public GetServiceQuotaIncreaseRequestFromTemplateResult clone() {
        try {
            return (GetServiceQuotaIncreaseRequestFromTemplateResult) super.clone();
