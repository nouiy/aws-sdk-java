...
/**
 * MetricInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricInfoJsonUnmarshaller implements Unmarshaller<MetricInfo, JsonUnmarshallerContext> {

    public MetricInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static MetricInfoJsonUnmarshaller instance;

    public static MetricInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MetricInfoJsonUnmarshaller();
        return instance;
    }
}
