...
public class NoSuchResourceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoSuchResourceExceptionUnmarshaller instance;

    public static NoSuchResourceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchResourceExceptionUnmarshaller();
        return instance;
    }
}
