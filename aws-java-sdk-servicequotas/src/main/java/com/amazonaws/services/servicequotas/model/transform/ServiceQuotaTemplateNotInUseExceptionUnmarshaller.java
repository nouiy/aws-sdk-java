...
public class ServiceQuotaTemplateNotInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ServiceQuotaTemplateNotInUseExceptionUnmarshaller instance;

    public static ServiceQuotaTemplateNotInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceQuotaTemplateNotInUseExceptionUnmarshaller();
        return instance;
    }
}
