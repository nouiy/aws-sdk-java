...
public class TemplatesNotAvailableInRegionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TemplatesNotAvailableInRegionExceptionUnmarshaller instance;

    public static TemplatesNotAvailableInRegionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TemplatesNotAvailableInRegionExceptionUnmarshaller();
        return instance;
    }
}
