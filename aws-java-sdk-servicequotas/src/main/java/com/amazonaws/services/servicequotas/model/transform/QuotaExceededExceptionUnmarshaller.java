...
public class QuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static QuotaExceededExceptionUnmarshaller instance;

    public static QuotaExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new QuotaExceededExceptionUnmarshaller();
        return instance;
    }
}
