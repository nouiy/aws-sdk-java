...
/**
 * GetServiceQuotaResult JSON Unmarshaller
 */
...
public class GetServiceQuotaResultJsonUnmarshaller implements Unmarshaller<GetServiceQuotaResult, JsonUnmarshallerContext> {
    ...
    public GetServiceQuotaResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Quota", targetDepth)) {
                    context.nextToken();
                    getServiceQuotaResult.setQuota(ServiceQuotaJsonUnmarshaller.getInstance().unmarshall(context));
                }
