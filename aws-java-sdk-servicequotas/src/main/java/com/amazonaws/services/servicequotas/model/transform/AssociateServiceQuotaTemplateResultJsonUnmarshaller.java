...
/**
 * AssociateServiceQuotaTemplateResult JSON Unmarshaller
 */
...
public class AssociateServiceQuotaTemplateResultJsonUnmarshaller implements Unmarshaller<AssociateServiceQuotaTemplateResult, JsonUnmarshallerContext> {
    ...
    public AssociateServiceQuotaTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateServiceQuotaTemplateResult associateServiceQuotaTemplateResult = new AssociateServiceQuotaTemplateResult();
