...
public class TooManyTagsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyTagsExceptionUnmarshaller() {
        super(com.amazonaws.services.servicequotas.model.TooManyTagsException.class, "TooManyTagsException");
    }

    @Override
    public com.amazonaws.services.servicequotas.model.TooManyTagsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.servicequotas.model.TooManyTagsException tooManyTagsException = new com.amazonaws.services.servicequotas.model.TooManyTagsException(
                null);
