...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.opsworkscm.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.opsworkscm.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.opsworkscm.model.LimitExceededException limitExceededException = new com.amazonaws.services.opsworkscm.model.LimitExceededException(
                null);
