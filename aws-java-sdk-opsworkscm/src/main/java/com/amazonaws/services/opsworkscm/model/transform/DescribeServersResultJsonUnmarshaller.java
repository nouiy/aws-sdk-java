...
/**
 * DescribeServersResult JSON Unmarshaller
 */
...
public class DescribeServersResultJsonUnmarshaller implements Unmarshaller<DescribeServersResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeServersResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static DescribeServersResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeServersResultJsonUnmarshaller();
        return instance;
    }
}
