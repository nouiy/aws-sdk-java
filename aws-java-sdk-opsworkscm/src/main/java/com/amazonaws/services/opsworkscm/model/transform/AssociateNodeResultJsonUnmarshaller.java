...
/**
 * AssociateNodeResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociateNodeResultJsonUnmarshaller implements Unmarshaller<AssociateNodeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NodeAssociationStatusToken", targetDepth)) {
                    context.nextToken();
                    associateNodeResult.setNodeAssociationStatusToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
