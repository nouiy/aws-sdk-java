...
class NodeAssociated {
    ...
    static class IsSUCCESSMatcher extends WaiterAcceptor<DescribeNodeAssociationStatusResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("NodeAssociationStatus");
         ...
         */
        @Override
        public boolean matches(DescribeNodeAssociationStatusResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeNodeAssociationStatusResult> {
        private static final JsonNode expectedResult;
