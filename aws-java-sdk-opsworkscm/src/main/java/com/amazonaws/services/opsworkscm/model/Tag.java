...
/**
 * <p>
 * A map that contains tag keys and tag values to attach to an AWS OpsWorks for Chef Automate or AWS OpsWorks for Puppet
 * Enterprise server. Leading and trailing white spaces are trimmed from both the key and value. A maximum of 50
 * user-applied tags is allowed for tag-supported AWS OpsWorks-CM resources.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/Tag" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Tag implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * An optional tag value, such as <code>Production</code> or <code>test-owcm-server</code>. The value can be a
     ...
     * 
     * @param value
     *        An optional tag value, such as <code>Production</code> or <code>test-owcm-server</code>. The value can be
     ...
     * </p>
     * 
     * @return An optional tag value, such as <code>Production</code> or <code>test-owcm-server</code>. The value can be
     *         a maximum of 255 characters, and contain only Unicode letters, numbers, or separators, or the following
     *         special characters: <code>+ - = . _ : /</code>
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opsworkscm.model.transform.TagMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
