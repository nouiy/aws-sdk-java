...
/**
 * RestoreServerRequestMarshaller
 */
...
public class RestoreServerRequestMarshaller {
    ...
    private static final RestoreServerRequestMarshaller instance = new RestoreServerRequestMarshaller();

    public static RestoreServerRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RestoreServerRequest restoreServerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(restoreServerRequest.getBackupId(), BACKUPID_BINDING);
            protocolMarshaller.marshall(restoreServerRequest.getServerName(), SERVERNAME_BINDING);
            protocolMarshaller.marshall(restoreServerRequest.getInstanceType(), INSTANCETYPE_BINDING);
            protocolMarshaller.marshall(restoreServerRequest.getKeyPair(), KEYPAIR_BINDING);
        } catch (Exception e) {
