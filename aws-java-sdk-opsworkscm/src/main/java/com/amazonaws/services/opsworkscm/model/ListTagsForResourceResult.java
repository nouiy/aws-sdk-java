...
public class ListTagsForResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A token that you can use as the value of <code>NextToken</code> in subsequent calls to the API to show more
     * results.
     * </p>
     */
     ...
     * 
     * @param nextToken
     *        A token that you can use as the value of <code>NextToken</code> in subsequent calls to the API to show
     *        more results.
     */
     ...
     * </p>
     * 
     * @return A token that you can use as the value of <code>NextToken</code> in subsequent calls to the API to show
     *         more results.
     */
