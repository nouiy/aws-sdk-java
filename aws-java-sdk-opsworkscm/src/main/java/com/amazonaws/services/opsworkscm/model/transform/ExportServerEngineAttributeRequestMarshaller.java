...
@SdkInternalApi
public class ExportServerEngineAttributeRequestMarshaller {

    private static final MarshallingInfo<String> EXPORTATTRIBUTENAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ExportAttributeName").build();
    ...
    private static final MarshallingInfo<List> INPUTATTRIBUTES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("InputAttributes").build();

    private static final ExportServerEngineAttributeRequestMarshaller instance = new ExportServerEngineAttributeRequestMarshaller();

    public static ExportServerEngineAttributeRequestMarshaller getInstance() {
        return instance;
    }
