...
/**
 * ListContactFlowsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListContactFlowsResultJsonUnmarshaller implements Unmarshaller<ListContactFlowsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listContactFlowsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
