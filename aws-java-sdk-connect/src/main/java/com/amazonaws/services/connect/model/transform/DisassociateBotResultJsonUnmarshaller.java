...
/**
 * DisassociateBotResult JSON Unmarshaller
 */
...
public class DisassociateBotResultJsonUnmarshaller implements Unmarshaller<DisassociateBotResult, JsonUnmarshallerContext> {
    ...
    public DisassociateBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateBotResult disassociateBotResult = new DisassociateBotResult();

        return disassociateBotResult;
    }
