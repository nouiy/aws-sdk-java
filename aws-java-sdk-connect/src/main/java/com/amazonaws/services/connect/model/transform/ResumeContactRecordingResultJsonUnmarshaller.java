...
/**
 * ResumeContactRecordingResult JSON Unmarshaller
 */
...
public class ResumeContactRecordingResultJsonUnmarshaller implements Unmarshaller<ResumeContactRecordingResult, JsonUnmarshallerContext> {
    ...
    public ResumeContactRecordingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResumeContactRecordingResult resumeContactRecordingResult = new ResumeContactRecordingResult();

        return resumeContactRecordingResult;
    }
