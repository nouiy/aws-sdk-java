...
/**
 * StartOutboundVoiceContactResult JSON Unmarshaller
 */
...
public class StartOutboundVoiceContactResultJsonUnmarshaller implements Unmarshaller<StartOutboundVoiceContactResult, JsonUnmarshallerContext> {
    ...
    public StartOutboundVoiceContactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ContactId", targetDepth)) {
                    context.nextToken();
                    startOutboundVoiceContactResult.setContactId(context.getUnmarshaller(String.class).unmarshall(context));
                }
