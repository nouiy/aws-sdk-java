...
@SdkInternalApi
public class ChatMessageMarshaller {
     ...
     */
    public void marshall(ChatMessage chatMessage, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(chatMessage.getContentType(), CONTENTTYPE_BINDING);
            protocolMarshaller.marshall(chatMessage.getContent(), CONTENT_BINDING);
        } catch (Exception e) {
