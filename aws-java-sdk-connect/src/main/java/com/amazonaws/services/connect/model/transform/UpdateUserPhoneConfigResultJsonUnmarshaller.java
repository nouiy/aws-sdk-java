...
/**
 * UpdateUserPhoneConfigResult JSON Unmarshaller
 */
...
public class UpdateUserPhoneConfigResultJsonUnmarshaller implements Unmarshaller<UpdateUserPhoneConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateUserPhoneConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateUserPhoneConfigResult updateUserPhoneConfigResult = new UpdateUserPhoneConfigResult();
