...
/**
 * UpdateAuthenticationProfileResult JSON Unmarshaller
 */
...
public class UpdateAuthenticationProfileResultJsonUnmarshaller implements Unmarshaller<UpdateAuthenticationProfileResult, JsonUnmarshallerContext> {
    ...
    public UpdateAuthenticationProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAuthenticationProfileResult updateAuthenticationProfileResult = new UpdateAuthenticationProfileResult();

        return updateAuthenticationProfileResult;
    }
