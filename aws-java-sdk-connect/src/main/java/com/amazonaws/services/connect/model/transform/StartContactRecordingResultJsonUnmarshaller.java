...
/**
 * StartContactRecordingResult JSON Unmarshaller
 */
...
public class StartContactRecordingResultJsonUnmarshaller implements Unmarshaller<StartContactRecordingResult, JsonUnmarshallerContext> {
    ...
    public StartContactRecordingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartContactRecordingResult startContactRecordingResult = new StartContactRecordingResult();

        return startContactRecordingResult;
    }
