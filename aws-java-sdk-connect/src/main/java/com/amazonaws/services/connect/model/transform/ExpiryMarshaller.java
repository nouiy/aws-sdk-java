...
public class ExpiryMarshaller {
    ...
    private static final ExpiryMarshaller instance = new ExpiryMarshaller();

    public static ExpiryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Expiry expiry, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(expiry.getDurationInSeconds(), DURATIONINSECONDS_BINDING);
            protocolMarshaller.marshall(expiry.getExpiryTimestamp(), EXPIRYTIMESTAMP_BINDING);
        } catch (Exception e) {
