...
/**
 * ListPhoneNumbersV2Result JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListPhoneNumbersV2ResultJsonUnmarshaller implements Unmarshaller<ListPhoneNumbersV2Result, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listPhoneNumbersV2Result.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ListPhoneNumbersSummaryList", targetDepth)) {
                    context.nextToken();
                    listPhoneNumbersV2Result.setListPhoneNumbersSummaryList(new ListUnmarshaller<ListPhoneNumbersSummary>(
