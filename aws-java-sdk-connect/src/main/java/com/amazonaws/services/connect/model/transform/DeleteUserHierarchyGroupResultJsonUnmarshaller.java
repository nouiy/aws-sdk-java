...
/**
 * DeleteUserHierarchyGroupResult JSON Unmarshaller
 */
...
public class DeleteUserHierarchyGroupResultJsonUnmarshaller implements Unmarshaller<DeleteUserHierarchyGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteUserHierarchyGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteUserHierarchyGroupResult deleteUserHierarchyGroupResult = new DeleteUserHierarchyGroupResult();

        return deleteUserHierarchyGroupResult;
    }
