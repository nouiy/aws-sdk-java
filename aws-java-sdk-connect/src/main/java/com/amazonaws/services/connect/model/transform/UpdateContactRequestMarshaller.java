...
public class UpdateContactRequestMarshaller {
    ...
    public void marshall(UpdateContactRequest updateContactRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateContactRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(updateContactRequest.getContactId(), CONTACTID_BINDING);
            protocolMarshaller.marshall(updateContactRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateContactRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateContactRequest.getReferences(), REFERENCES_BINDING);
        } catch (Exception e) {
