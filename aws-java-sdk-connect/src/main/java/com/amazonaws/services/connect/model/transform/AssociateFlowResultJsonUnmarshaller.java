...
/**
 * AssociateFlowResult JSON Unmarshaller
 */
...
public class AssociateFlowResultJsonUnmarshaller implements Unmarshaller<AssociateFlowResult, JsonUnmarshallerContext> {
    ...
    public AssociateFlowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateFlowResult associateFlowResult = new AssociateFlowResult();

        return associateFlowResult;
    }
