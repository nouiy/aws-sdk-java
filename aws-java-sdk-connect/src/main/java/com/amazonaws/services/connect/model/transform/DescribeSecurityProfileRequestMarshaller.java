...
public class DescribeSecurityProfileRequestMarshaller {
    ...
    public void marshall(DescribeSecurityProfileRequest describeSecurityProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeSecurityProfileRequest.getSecurityProfileId(), SECURITYPROFILEID_BINDING);
            protocolMarshaller.marshall(describeSecurityProfileRequest.getInstanceId(), INSTANCEID_BINDING);
        } catch (Exception e) {
