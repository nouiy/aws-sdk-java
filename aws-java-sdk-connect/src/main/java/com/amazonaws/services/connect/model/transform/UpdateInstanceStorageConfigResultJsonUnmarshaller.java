...
/**
 * UpdateInstanceStorageConfigResult JSON Unmarshaller
 */
...
public class UpdateInstanceStorageConfigResultJsonUnmarshaller implements Unmarshaller<UpdateInstanceStorageConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateInstanceStorageConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateInstanceStorageConfigResult updateInstanceStorageConfigResult = new UpdateInstanceStorageConfigResult();

        return updateInstanceStorageConfigResult;
    }
