...
/**
 * CreateUserHierarchyGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateUserHierarchyGroupRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Name").build();
    private static final MarshallingInfo<String> PARENTGROUPID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static CreateUserHierarchyGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateUserHierarchyGroupRequest createUserHierarchyGroupRequest, ProtocolMarshaller protocolMarshaller) {
