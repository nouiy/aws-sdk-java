...
public class SearchRoutingProfilesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SearchRoutingProfilesRequest withSearchCriteria(RoutingProfileSearchCriteria searchCriteria) {
    ...
    @Override
    public SearchRoutingProfilesRequest clone() {
        return (SearchRoutingProfilesRequest) super.clone();
    }
