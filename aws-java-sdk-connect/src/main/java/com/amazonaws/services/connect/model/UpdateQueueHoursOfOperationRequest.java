...
public class UpdateQueueHoursOfOperationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public UpdateQueueHoursOfOperationRequest clone() {
