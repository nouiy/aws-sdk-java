...
/**
 * AgentHierarchyGroup JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AgentHierarchyGroupJsonUnmarshaller implements Unmarshaller<AgentHierarchyGroup, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Arn", targetDepth)) {
                    context.nextToken();
                    agentHierarchyGroup.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
