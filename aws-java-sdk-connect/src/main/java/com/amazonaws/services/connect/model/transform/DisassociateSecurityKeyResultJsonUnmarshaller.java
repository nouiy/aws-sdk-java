...
/**
 * DisassociateSecurityKeyResult JSON Unmarshaller
 */
...
public class DisassociateSecurityKeyResultJsonUnmarshaller implements Unmarshaller<DisassociateSecurityKeyResult, JsonUnmarshallerContext> {
    ...
    public DisassociateSecurityKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateSecurityKeyResult disassociateSecurityKeyResult = new DisassociateSecurityKeyResult();

        return disassociateSecurityKeyResult;
    }
