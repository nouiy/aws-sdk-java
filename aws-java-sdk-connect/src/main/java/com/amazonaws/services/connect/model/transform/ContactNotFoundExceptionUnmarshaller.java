...
public class ContactNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ContactNotFoundExceptionUnmarshaller instance;

    public static ContactNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ContactNotFoundExceptionUnmarshaller();
        return instance;
    }
}
