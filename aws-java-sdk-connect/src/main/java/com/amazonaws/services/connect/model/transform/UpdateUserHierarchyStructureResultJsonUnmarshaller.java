...
/**
 * UpdateUserHierarchyStructureResult JSON Unmarshaller
 */
...
public class UpdateUserHierarchyStructureResultJsonUnmarshaller implements Unmarshaller<UpdateUserHierarchyStructureResult, JsonUnmarshallerContext> {
    ...
    public UpdateUserHierarchyStructureResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateUserHierarchyStructureResult updateUserHierarchyStructureResult = new UpdateUserHierarchyStructureResult();

        return updateUserHierarchyStructureResult;
    }
