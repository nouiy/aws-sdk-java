...
/**
 * DeleteContactFlowResult JSON Unmarshaller
 */
...
public class DeleteContactFlowResultJsonUnmarshaller implements Unmarshaller<DeleteContactFlowResult, JsonUnmarshallerContext> {
    ...
    public DeleteContactFlowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteContactFlowResult deleteContactFlowResult = new DeleteContactFlowResult();

        return deleteContactFlowResult;
    }
