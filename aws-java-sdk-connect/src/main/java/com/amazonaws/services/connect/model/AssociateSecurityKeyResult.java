...
public class AssociateSecurityKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateSecurityKeyResult clone() {
        try {
            return (AssociateSecurityKeyResult) super.clone();
