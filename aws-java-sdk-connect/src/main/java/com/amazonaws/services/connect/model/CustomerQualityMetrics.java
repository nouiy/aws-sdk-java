 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/CustomerQualityMetrics" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomerQualityMetrics implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Information about the audio quality of the Customer
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomerQualityMetrics == false)
            return false;
        CustomerQualityMetrics other = (CustomerQualityMetrics) obj;
    ...
    public CustomerQualityMetrics clone() {
        try {
            return (CustomerQualityMetrics) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.CustomerQualityMetricsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
