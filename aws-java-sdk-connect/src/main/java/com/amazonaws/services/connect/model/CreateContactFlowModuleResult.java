...
public class CreateContactFlowModuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateContactFlowModuleResult == false)
            return false;
        CreateContactFlowModuleResult other = (CreateContactFlowModuleResult) obj;
    ...
    public CreateContactFlowModuleResult clone() {
        try {
            return (CreateContactFlowModuleResult) super.clone();
