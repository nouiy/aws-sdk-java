...
/**
 * CreateUseCaseResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateUseCaseResultJsonUnmarshaller implements Unmarshaller<CreateUseCaseResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UseCaseId", targetDepth)) {
                    context.nextToken();
                    createUseCaseResult.setUseCaseId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("UseCaseArn", targetDepth)) {
                    context.nextToken();
                    createUseCaseResult.setUseCaseArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
