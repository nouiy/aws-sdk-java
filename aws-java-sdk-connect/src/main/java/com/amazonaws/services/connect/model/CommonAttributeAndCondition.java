 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/CommonAttributeAndCondition"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CommonAttributeAndCondition implements Serializable, Cloneable, StructuredPojo {
    ...
    public CommonAttributeAndCondition withTagConditions(TagCondition... tagConditions) {
    ...
    public CommonAttributeAndCondition withTagConditions(java.util.Collection<TagCondition> tagConditions) {
    ...
    public String toString() {
        ...
        if (getTagConditions() != null)
            sb.append("TagConditions: ").append(getTagConditions());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CommonAttributeAndCondition == false)
            return false;
        CommonAttributeAndCondition other = (CommonAttributeAndCondition) obj;
    ...
    public CommonAttributeAndCondition clone() {
        try {
            return (CommonAttributeAndCondition) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.CommonAttributeAndConditionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
