...
public class CustomerMarshaller {
    ...
    private static final CustomerMarshaller instance = new CustomerMarshaller();

    public static CustomerMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Customer customer, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(customer.getDeviceInfo(), DEVICEINFO_BINDING);
            protocolMarshaller.marshall(customer.getCapabilities(), CAPABILITIES_BINDING);
        } catch (Exception e) {
