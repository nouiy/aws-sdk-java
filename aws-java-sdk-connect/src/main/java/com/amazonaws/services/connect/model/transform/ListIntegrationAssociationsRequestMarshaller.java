...
public class ListIntegrationAssociationsRequestMarshaller {
    ...
    private static final ListIntegrationAssociationsRequestMarshaller instance = new ListIntegrationAssociationsRequestMarshaller();

    public static ListIntegrationAssociationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListIntegrationAssociationsRequest listIntegrationAssociationsRequest, ProtocolMarshaller protocolMarshaller) {
