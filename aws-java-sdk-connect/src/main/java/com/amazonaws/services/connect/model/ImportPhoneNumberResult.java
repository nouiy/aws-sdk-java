...
public class ImportPhoneNumberResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ImportPhoneNumberResult withPhoneNumberId(String phoneNumberId) {
    ...
    public ImportPhoneNumberResult withPhoneNumberArn(String phoneNumberArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportPhoneNumberResult == false)
            return false;
        ImportPhoneNumberResult other = (ImportPhoneNumberResult) obj;
    ...
    @Override
    public ImportPhoneNumberResult clone() {
        try {
