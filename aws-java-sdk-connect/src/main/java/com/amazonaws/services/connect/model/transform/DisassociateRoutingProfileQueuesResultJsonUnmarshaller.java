...
/**
 * DisassociateRoutingProfileQueuesResult JSON Unmarshaller
 */
...
public class DisassociateRoutingProfileQueuesResultJsonUnmarshaller implements Unmarshaller<DisassociateRoutingProfileQueuesResult, JsonUnmarshallerContext> {
    ...
    public DisassociateRoutingProfileQueuesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateRoutingProfileQueuesResult disassociateRoutingProfileQueuesResult = new DisassociateRoutingProfileQueuesResult();

        return disassociateRoutingProfileQueuesResult;
    }
