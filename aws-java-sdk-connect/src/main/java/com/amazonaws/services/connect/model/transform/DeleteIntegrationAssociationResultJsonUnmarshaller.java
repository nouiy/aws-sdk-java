...
/**
 * DeleteIntegrationAssociationResult JSON Unmarshaller
 */
...
public class DeleteIntegrationAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteIntegrationAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteIntegrationAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIntegrationAssociationResult deleteIntegrationAssociationResult = new DeleteIntegrationAssociationResult();

        return deleteIntegrationAssociationResult;
    }
