...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/DeleteContactFlowModule" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteContactFlowModuleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteContactFlowModuleRequest withInstanceId(String instanceId) {
    ...
    public DeleteContactFlowModuleRequest withContactFlowModuleId(String contactFlowModuleId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteContactFlowModuleRequest == false)
            return false;
        DeleteContactFlowModuleRequest other = (DeleteContactFlowModuleRequest) obj;
    ...
    @Override
    public DeleteContactFlowModuleRequest clone() {
        return (DeleteContactFlowModuleRequest) super.clone();
    }
