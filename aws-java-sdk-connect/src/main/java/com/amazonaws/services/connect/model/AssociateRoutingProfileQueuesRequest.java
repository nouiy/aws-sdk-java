...
public class AssociateRoutingProfileQueuesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The queues to associate with this routing profile.
     */
    ...
    public AssociateRoutingProfileQueuesRequest withQueueConfigs(RoutingProfileQueueConfig... queueConfigs) {
    ...
    public AssociateRoutingProfileQueuesRequest withQueueConfigs(java.util.Collection<RoutingProfileQueueConfig> queueConfigs) {
    ...
    public AssociateRoutingProfileQueuesRequest clone() {
        return (AssociateRoutingProfileQueuesRequest) super.clone();
    }
