...
public class DeleteQuickConnectRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteQuickConnectRequest withInstanceId(String instanceId) {
    ...
    public DeleteQuickConnectRequest withQuickConnectId(String quickConnectId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteQuickConnectRequest == false)
            return false;
        DeleteQuickConnectRequest other = (DeleteQuickConnectRequest) obj;
    ...
    @Override
    public DeleteQuickConnectRequest clone() {
