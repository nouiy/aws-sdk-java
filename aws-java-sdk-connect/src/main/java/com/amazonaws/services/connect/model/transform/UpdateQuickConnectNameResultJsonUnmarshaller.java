...
/**
 * UpdateQuickConnectNameResult JSON Unmarshaller
 */
...
public class UpdateQuickConnectNameResultJsonUnmarshaller implements Unmarshaller<UpdateQuickConnectNameResult, JsonUnmarshallerContext> {
    ...
    public UpdateQuickConnectNameResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQuickConnectNameResult updateQuickConnectNameResult = new UpdateQuickConnectNameResult();

        return updateQuickConnectNameResult;
    }
