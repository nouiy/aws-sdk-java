...
/**
 * UpdateContactScheduleResult JSON Unmarshaller
 */
...
public class UpdateContactScheduleResultJsonUnmarshaller implements Unmarshaller<UpdateContactScheduleResult, JsonUnmarshallerContext> {
    ...
    public UpdateContactScheduleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateContactScheduleResult updateContactScheduleResult = new UpdateContactScheduleResult();

        return updateContactScheduleResult;
    }
