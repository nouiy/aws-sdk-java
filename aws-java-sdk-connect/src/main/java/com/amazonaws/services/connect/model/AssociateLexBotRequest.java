...
public class AssociateLexBotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getLexBot() != null)
            sb.append("LexBot: ").append(getLexBot());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateLexBotRequest == false)
            return false;
    ...
    @Override
    public AssociateLexBotRequest clone() {
        return (AssociateLexBotRequest) super.clone();
    }
