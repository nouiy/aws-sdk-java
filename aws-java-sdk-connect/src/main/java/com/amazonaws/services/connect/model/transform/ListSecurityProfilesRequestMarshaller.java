...
@SdkInternalApi
public class ListSecurityProfilesRequestMarshaller {
    ...
    public static ListSecurityProfilesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListSecurityProfilesRequest listSecurityProfilesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listSecurityProfilesRequest.getInstanceId(), INSTANCEID_BINDING);
