...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/DeleteUserHierarchyGroup" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteUserHierarchyGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteUserHierarchyGroupRequest withHierarchyGroupId(String hierarchyGroupId) {
    ...
    public DeleteUserHierarchyGroupRequest withInstanceId(String instanceId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteUserHierarchyGroupRequest == false)
            return false;
        DeleteUserHierarchyGroupRequest other = (DeleteUserHierarchyGroupRequest) obj;
    ...
    @Override
    public DeleteUserHierarchyGroupRequest clone() {
        return (DeleteUserHierarchyGroupRequest) super.clone();
    }
