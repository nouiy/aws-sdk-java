...
/**
 * HoursOfOperationConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HoursOfOperationConfigMarshaller {
    ...
    private static final HoursOfOperationConfigMarshaller instance = new HoursOfOperationConfigMarshaller();

    public static HoursOfOperationConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HoursOfOperationConfig hoursOfOperationConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(hoursOfOperationConfig.getDay(), DAY_BINDING);
            protocolMarshaller.marshall(hoursOfOperationConfig.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(hoursOfOperationConfig.getEndTime(), ENDTIME_BINDING);
        } catch (Exception e) {
