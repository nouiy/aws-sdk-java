...
public class AssociateQueueQuickConnectsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateQueueQuickConnectsRequest withQuickConnectIds(java.util.Collection<String> quickConnectIds) {
    ...
    @Override
    public AssociateQueueQuickConnectsRequest clone() {
        return (AssociateQueueQuickConnectsRequest) super.clone();
    }
