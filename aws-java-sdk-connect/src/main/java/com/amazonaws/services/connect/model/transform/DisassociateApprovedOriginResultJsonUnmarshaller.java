...
/**
 * DisassociateApprovedOriginResult JSON Unmarshaller
 */
...
public class DisassociateApprovedOriginResultJsonUnmarshaller implements Unmarshaller<DisassociateApprovedOriginResult, JsonUnmarshallerContext> {
    ...
    public DisassociateApprovedOriginResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateApprovedOriginResult disassociateApprovedOriginResult = new DisassociateApprovedOriginResult();

        return disassociateApprovedOriginResult;
    }
