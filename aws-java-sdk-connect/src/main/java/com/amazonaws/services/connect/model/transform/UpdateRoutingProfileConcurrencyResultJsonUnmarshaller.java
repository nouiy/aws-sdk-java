...
/**
 * UpdateRoutingProfileConcurrencyResult JSON Unmarshaller
 */
...
public class UpdateRoutingProfileConcurrencyResultJsonUnmarshaller implements Unmarshaller<UpdateRoutingProfileConcurrencyResult, JsonUnmarshallerContext> {
    ...
    public UpdateRoutingProfileConcurrencyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRoutingProfileConcurrencyResult updateRoutingProfileConcurrencyResult = new UpdateRoutingProfileConcurrencyResult();

        return updateRoutingProfileConcurrencyResult;
    }
