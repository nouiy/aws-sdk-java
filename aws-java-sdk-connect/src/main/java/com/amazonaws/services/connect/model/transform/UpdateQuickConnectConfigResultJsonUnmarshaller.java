...
/**
 * UpdateQuickConnectConfigResult JSON Unmarshaller
 */
...
public class UpdateQuickConnectConfigResultJsonUnmarshaller implements Unmarshaller<UpdateQuickConnectConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateQuickConnectConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQuickConnectConfigResult updateQuickConnectConfigResult = new UpdateQuickConnectConfigResult();

        return updateQuickConnectConfigResult;
    }
