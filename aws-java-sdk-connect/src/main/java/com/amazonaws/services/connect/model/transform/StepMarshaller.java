...
public class StepMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> EXPIRY_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Expiry").build();
    private static final MarshallingInfo<StructuredPojo> EXPRESSION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(Step step, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(step.getExpiry(), EXPIRY_BINDING);
            protocolMarshaller.marshall(step.getExpression(), EXPRESSION_BINDING);
