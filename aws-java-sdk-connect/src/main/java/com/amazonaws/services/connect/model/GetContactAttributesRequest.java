...
public class GetContactAttributesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetContactAttributesRequest clone() {
        return (GetContactAttributesRequest) super.clone();
    }
