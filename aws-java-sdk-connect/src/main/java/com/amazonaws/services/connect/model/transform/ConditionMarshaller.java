...
public class ConditionMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> NUMBERCONDITION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("NumberCondition").build();
    ...
    public void marshall(Condition condition, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(condition.getStringCondition(), STRINGCONDITION_BINDING);
            protocolMarshaller.marshall(condition.getNumberCondition(), NUMBERCONDITION_BINDING);
        } catch (Exception e) {
