...
/**
 * SegmentAttributeValue JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SegmentAttributeValueJsonUnmarshaller implements Unmarshaller<SegmentAttributeValue, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ValueString", targetDepth)) {
                    context.nextToken();
                    segmentAttributeValue.setValueString(context.getUnmarshaller(String.class).unmarshall(context));
                }
