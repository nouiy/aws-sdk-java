...
public class CreateUserHierarchyGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getParentGroupId() == null ^ this.getParentGroupId() == null)
            return false;
        if (other.getParentGroupId() != null && other.getParentGroupId().equals(this.getParentGroupId()) == false)
            return false;
    ...
    public CreateUserHierarchyGroupRequest clone() {
        return (CreateUserHierarchyGroupRequest) super.clone();
    }
