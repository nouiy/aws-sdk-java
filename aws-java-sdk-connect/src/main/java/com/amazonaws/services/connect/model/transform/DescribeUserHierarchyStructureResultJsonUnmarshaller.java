...
/**
 * DescribeUserHierarchyStructureResult JSON Unmarshaller
 */
...
public class DescribeUserHierarchyStructureResultJsonUnmarshaller implements Unmarshaller<DescribeUserHierarchyStructureResult, JsonUnmarshallerContext> {
    ...
    public DescribeUserHierarchyStructureResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("HierarchyStructure", targetDepth)) {
                    context.nextToken();
                    describeUserHierarchyStructureResult.setHierarchyStructure(HierarchyStructureJsonUnmarshaller.getInstance().unmarshall(context));
                }
