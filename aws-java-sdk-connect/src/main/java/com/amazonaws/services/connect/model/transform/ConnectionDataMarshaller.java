...
public class ConnectionDataMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> MEETING_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Meeting").build();
    ...
    public void marshall(ConnectionData connectionData, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(connectionData.getAttendee(), ATTENDEE_BINDING);
            protocolMarshaller.marshall(connectionData.getMeeting(), MEETING_BINDING);
        } catch (Exception e) {
