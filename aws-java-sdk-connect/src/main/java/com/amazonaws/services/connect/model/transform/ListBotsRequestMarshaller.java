...
public class ListBotsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> LEXVERSION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("lexVersion").build();
    ...
    public void marshall(ListBotsRequest listBotsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listBotsRequest.getInstanceId(), INSTANCEID_BINDING);
            ...
            protocolMarshaller.marshall(listBotsRequest.getLexVersion(), LEXVERSION_BINDING);
        } catch (Exception e) {
