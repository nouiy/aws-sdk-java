...
public class ListAnalyticsDataAssociationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {

    /**
     * <p>
     * An array of successful results: <code>DataSetId</code>, <code>TargetAccountId</code>,
     * <code>ResourceShareId</code>, <code>ResourceShareArn</code>. This is a paginated API, so <code>nextToken</code>
     ...
     * </p>
     * 
     * @return An array of successful results: <code>DataSetId</code>, <code>TargetAccountId</code>,
    ...
    public ListAnalyticsDataAssociationsResult withResults(AnalyticsDataAssociationResult... results) {
        if (this.results == null) {
            setResults(new java.util.ArrayList<AnalyticsDataAssociationResult>(results.length));
        }
        for (AnalyticsDataAssociationResult ele : results) {
    ...
    public ListAnalyticsDataAssociationsResult withResults(java.util.Collection<AnalyticsDataAssociationResult> results) {
        setResults(results);
        return this;
    }
    ...
    public ListAnalyticsDataAssociationsResult clone() {
        try {
            return (ListAnalyticsDataAssociationsResult) super.clone();
