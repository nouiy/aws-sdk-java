...
/**
 * CrossChannelBehavior JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CrossChannelBehaviorJsonUnmarshaller implements Unmarshaller<CrossChannelBehavior, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BehaviorType", targetDepth)) {
                    context.nextToken();
                    crossChannelBehavior.setBehaviorType(context.getUnmarshaller(String.class).unmarshall(context));
                }
