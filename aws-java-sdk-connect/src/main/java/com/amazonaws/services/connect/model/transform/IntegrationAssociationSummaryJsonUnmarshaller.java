...
/**
 * IntegrationAssociationSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IntegrationAssociationSummaryJsonUnmarshaller implements Unmarshaller<IntegrationAssociationSummary, JsonUnmarshallerContext> {

    public IntegrationAssociationSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
