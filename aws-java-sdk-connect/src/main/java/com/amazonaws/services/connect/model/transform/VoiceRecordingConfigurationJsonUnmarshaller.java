...
/**
 * VoiceRecordingConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VoiceRecordingConfigurationJsonUnmarshaller implements Unmarshaller<VoiceRecordingConfiguration, JsonUnmarshallerContext> {
    ...
    public VoiceRecordingConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VoiceRecordingTrack", targetDepth)) {
                    context.nextToken();
                    voiceRecordingConfiguration.setVoiceRecordingTrack(context.getUnmarshaller(String.class).unmarshall(context));
                }
