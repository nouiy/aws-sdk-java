...
/**
 * UpdateQueueOutboundCallerConfigResult JSON Unmarshaller
 */
...
public class UpdateQueueOutboundCallerConfigResultJsonUnmarshaller implements Unmarshaller<UpdateQueueOutboundCallerConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateQueueOutboundCallerConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQueueOutboundCallerConfigResult updateQueueOutboundCallerConfigResult = new UpdateQueueOutboundCallerConfigResult();

        return updateQueueOutboundCallerConfigResult;
    }
