...
public class ListLambdaFunctionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListLambdaFunctionsRequest clone() {
        return (ListLambdaFunctionsRequest) super.clone();
    }
