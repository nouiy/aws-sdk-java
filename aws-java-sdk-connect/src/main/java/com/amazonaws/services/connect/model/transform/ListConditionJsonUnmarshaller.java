    ...
    public ListCondition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TargetListType", targetDepth)) {
                    context.nextToken();
                    listCondition.setTargetListType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Conditions", targetDepth)) {
                    context.nextToken();
                    listCondition.setConditions(new ListUnmarshaller<Condition>(ConditionJsonUnmarshaller.getInstance())
