...
public class AssociateBotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public AssociateBotRequest withInstanceId(String instanceId) {
    ...
    public AssociateBotRequest withLexBot(LexBot lexBot) {
        setLexBot(lexBot);
        return this;
    }
    ...
    public AssociateBotRequest withLexV2Bot(LexV2Bot lexV2Bot) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateBotRequest == false)
            return false;
    ...
    @Override
    public AssociateBotRequest clone() {
        return (AssociateBotRequest) super.clone();
    }
