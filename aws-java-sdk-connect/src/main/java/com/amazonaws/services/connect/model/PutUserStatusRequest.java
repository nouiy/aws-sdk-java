...
public class PutUserStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public PutUserStatusRequest clone() {
        return (PutUserStatusRequest) super.clone();
    }
