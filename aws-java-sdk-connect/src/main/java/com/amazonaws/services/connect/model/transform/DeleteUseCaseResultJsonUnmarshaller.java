...
/**
 * DeleteUseCaseResult JSON Unmarshaller
 */
...
public class DeleteUseCaseResultJsonUnmarshaller implements Unmarshaller<DeleteUseCaseResult, JsonUnmarshallerContext> {
    ...
    public DeleteUseCaseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteUseCaseResult deleteUseCaseResult = new DeleteUseCaseResult();

        return deleteUseCaseResult;
    }
