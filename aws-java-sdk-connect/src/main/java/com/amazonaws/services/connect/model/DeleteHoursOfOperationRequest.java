...
public class DeleteHoursOfOperationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteHoursOfOperationRequest clone() {
        return (DeleteHoursOfOperationRequest) super.clone();
    }
