        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StringCondition", targetDepth)) {
                    context.nextToken();
                    condition.setStringCondition(StringConditionJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("NumberCondition", targetDepth)) {
                    context.nextToken();
                    condition.setNumberCondition(NumberConditionJsonUnmarshaller.getInstance().unmarshall(context));
                }
