...
/**
 * EvaluationFormQuestionTypeProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EvaluationFormQuestionTypePropertiesJsonUnmarshaller implements Unmarshaller<EvaluationFormQuestionTypeProperties, JsonUnmarshallerContext> {

    public EvaluationFormQuestionTypeProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
