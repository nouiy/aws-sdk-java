...
/**
 * DescribeUserHierarchyGroupResult JSON Unmarshaller
 */
...
public class DescribeUserHierarchyGroupResultJsonUnmarshaller implements Unmarshaller<DescribeUserHierarchyGroupResult, JsonUnmarshallerContext> {
    ...
    public DescribeUserHierarchyGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("HierarchyGroup", targetDepth)) {
                    context.nextToken();
                    describeUserHierarchyGroupResult.setHierarchyGroup(HierarchyGroupJsonUnmarshaller.getInstance().unmarshall(context));
                }
