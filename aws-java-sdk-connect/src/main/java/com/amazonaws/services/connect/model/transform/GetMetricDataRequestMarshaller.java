...
public class GetMetricDataRequestMarshaller {
    ...
    private static final MarshallingInfo<List> HISTORICALMETRICS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("HistoricalMetrics").build();
    ...
    public void marshall(GetMetricDataRequest getMetricDataRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getMetricDataRequest.getInstanceId(), INSTANCEID_BINDING);
            ...
            protocolMarshaller.marshall(getMetricDataRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(getMetricDataRequest.getGroupings(), GROUPINGS_BINDING);
            protocolMarshaller.marshall(getMetricDataRequest.getHistoricalMetrics(), HISTORICALMETRICS_BINDING);
            protocolMarshaller.marshall(getMetricDataRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(getMetricDataRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
