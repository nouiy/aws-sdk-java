...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.apigatewaymanagementapi.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.apigatewaymanagementapi.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.apigatewaymanagementapi.model.LimitExceededException limitExceededException = new com.amazonaws.services.apigatewaymanagementapi.model.LimitExceededException(
                null);
