...
public class CopyImageRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SOURCEIMAGENAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SourceImageName").build();
    private static final MarshallingInfo<String> DESTINATIONIMAGENAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DestinationImageName").build();
    ...
    private static final MarshallingInfo<String> DESTINATIONIMAGEDESCRIPTION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DestinationImageDescription").build();

    private static final CopyImageRequestMarshaller instance = new CopyImageRequestMarshaller();

    public static CopyImageRequestMarshaller getInstance() {
        return instance;
    }
