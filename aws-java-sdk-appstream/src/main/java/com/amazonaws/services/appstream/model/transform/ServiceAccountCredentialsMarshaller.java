...
/**
 * ServiceAccountCredentialsMarshaller
 */
...
public class ServiceAccountCredentialsMarshaller {
    ...
    private static final MarshallingInfo<String> ACCOUNTPASSWORD_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AccountPassword").build();
    ...
    public void marshall(ServiceAccountCredentials serviceAccountCredentials, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(serviceAccountCredentials.getAccountName(), ACCOUNTNAME_BINDING);
            protocolMarshaller.marshall(serviceAccountCredentials.getAccountPassword(), ACCOUNTPASSWORD_BINDING);
        } catch (Exception e) {
