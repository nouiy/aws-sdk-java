...
public class BatchDisassociateUserStackResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchDisassociateUserStackResult withErrors(java.util.Collection<UserStackAssociationError> errors) {
        setErrors(errors);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDisassociateUserStackResult == false)
            return false;
        BatchDisassociateUserStackResult other = (BatchDisassociateUserStackResult) obj;
    ...
    public BatchDisassociateUserStackResult clone() {
        try {
            return (BatchDisassociateUserStackResult) super.clone();
