...
/**
 * DisassociateApplicationFleetResult JSON Unmarshaller
 */
...
public class DisassociateApplicationFleetResultJsonUnmarshaller implements Unmarshaller<DisassociateApplicationFleetResult, JsonUnmarshallerContext> {
    ...
    public DisassociateApplicationFleetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateApplicationFleetResult disassociateApplicationFleetResult = new DisassociateApplicationFleetResult();
