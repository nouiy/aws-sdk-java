...
public class InvalidAccountStatusExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAccountStatusExceptionUnmarshaller instance;

    public static InvalidAccountStatusExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAccountStatusExceptionUnmarshaller();
        return instance;
    }
}
