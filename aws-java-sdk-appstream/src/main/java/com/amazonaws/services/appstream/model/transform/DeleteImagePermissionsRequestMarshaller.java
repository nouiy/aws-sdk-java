...
/**
 * DeleteImagePermissionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteImagePermissionsRequestMarshaller {
    ...
    private static final DeleteImagePermissionsRequestMarshaller instance = new DeleteImagePermissionsRequestMarshaller();

    public static DeleteImagePermissionsRequestMarshaller getInstance() {
        return instance;
    }
