...
public class DomainJoinInfoMarshaller {
    ...
    public void marshall(DomainJoinInfo domainJoinInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(domainJoinInfo.getDirectoryName(), DIRECTORYNAME_BINDING);
            protocolMarshaller.marshall(domainJoinInfo.getOrganizationalUnitDistinguishedName(), ORGANIZATIONALUNITDISTINGUISHEDNAME_BINDING);
        } catch (Exception e) {
