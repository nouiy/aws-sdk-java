...
/**
 * ImagePermissionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ImagePermissionsMarshaller {

    private static final MarshallingInfo<Boolean> ALLOWFLEET_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("allowFleet").build();
    private static final MarshallingInfo<Boolean> ALLOWIMAGEBUILDER_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("allowImageBuilder").build();
