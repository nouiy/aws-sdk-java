...
public class CreateImageBuilderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateImageBuilderResult == false)
            return false;
        CreateImageBuilderResult other = (CreateImageBuilderResult) obj;
    ...
    @Override
    public CreateImageBuilderResult clone() {
        try {
            return (CreateImageBuilderResult) super.clone();
