...
public class CreateApplicationRequestMarshaller {
    ...
    public void marshall(CreateApplicationRequest createApplicationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createApplicationRequest.getIconS3Location(), ICONS3LOCATION_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getLaunchPath(), LAUNCHPATH_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getWorkingDirectory(), WORKINGDIRECTORY_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getLaunchParameters(), LAUNCHPARAMETERS_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getPlatforms(), PLATFORMS_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getInstanceFamilies(), INSTANCEFAMILIES_BINDING);
            protocolMarshaller.marshall(createApplicationRequest.getAppBlockArn(), APPBLOCKARN_BINDING);
