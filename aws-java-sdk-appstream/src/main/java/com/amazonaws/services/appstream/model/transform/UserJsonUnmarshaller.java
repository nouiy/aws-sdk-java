        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Enabled", targetDepth)) {
                    context.nextToken();
                    user.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                ...
                if (context.testExpression("CreatedTime", targetDepth)) {
                    context.nextToken();
                    user.setCreatedTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("AuthenticationType", targetDepth)) {
                    context.nextToken();
                    user.setAuthenticationType(context.getUnmarshaller(String.class).unmarshall(context));
                }
