...
/**
 * DescribeImageBuildersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeImageBuildersRequestMarshaller {
    ...
    private static final DescribeImageBuildersRequestMarshaller instance = new DescribeImageBuildersRequestMarshaller();

    public static DescribeImageBuildersRequestMarshaller getInstance() {
        return instance;
    }
