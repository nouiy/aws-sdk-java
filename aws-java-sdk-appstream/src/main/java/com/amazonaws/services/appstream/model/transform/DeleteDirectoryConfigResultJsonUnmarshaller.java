...
/**
 * DeleteDirectoryConfigResult JSON Unmarshaller
 */
...
public class DeleteDirectoryConfigResultJsonUnmarshaller implements Unmarshaller<DeleteDirectoryConfigResult, JsonUnmarshallerContext> {
    ...
    public DeleteDirectoryConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDirectoryConfigResult deleteDirectoryConfigResult = new DeleteDirectoryConfigResult();
