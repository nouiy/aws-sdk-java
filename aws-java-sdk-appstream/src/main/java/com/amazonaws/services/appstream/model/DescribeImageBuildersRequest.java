...
public class DescribeImageBuildersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeImageBuildersRequest withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeImageBuildersRequest == false)
            return false;
    ...
    public DescribeImageBuildersRequest clone() {
        return (DescribeImageBuildersRequest) super.clone();
    }
