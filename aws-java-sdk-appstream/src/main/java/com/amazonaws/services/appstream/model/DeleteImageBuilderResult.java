...
public class DeleteImageBuilderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteImageBuilderResult == false)
            return false;
        DeleteImageBuilderResult other = (DeleteImageBuilderResult) obj;
    ...
    @Override
    public DeleteImageBuilderResult clone() {
        try {
            return (DeleteImageBuilderResult) super.clone();
