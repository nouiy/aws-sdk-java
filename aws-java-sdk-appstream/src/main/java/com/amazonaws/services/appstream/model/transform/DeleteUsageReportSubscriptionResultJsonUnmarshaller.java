...
/**
 * DeleteUsageReportSubscriptionResult JSON Unmarshaller
 */
...
public class DeleteUsageReportSubscriptionResultJsonUnmarshaller implements Unmarshaller<DeleteUsageReportSubscriptionResult, JsonUnmarshallerContext> {
    ...
    public DeleteUsageReportSubscriptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteUsageReportSubscriptionResult deleteUsageReportSubscriptionResult = new DeleteUsageReportSubscriptionResult();
