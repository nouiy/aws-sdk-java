...
/**
 * DirectoryConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DirectoryConfigJsonUnmarshaller implements Unmarshaller<DirectoryConfig, JsonUnmarshallerContext> {

    public DirectoryConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DirectoryConfigJsonUnmarshaller instance;

    public static DirectoryConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DirectoryConfigJsonUnmarshaller();
        return instance;
    }
}
