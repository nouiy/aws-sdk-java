...
public class CreateVoiceProfileDomainResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The requested voice profile domain.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateVoiceProfileDomainResult == false)
            return false;
        CreateVoiceProfileDomainResult other = (CreateVoiceProfileDomainResult) obj;
    ...
    public CreateVoiceProfileDomainResult clone() {
        try {
            return (CreateVoiceProfileDomainResult) super.clone();
