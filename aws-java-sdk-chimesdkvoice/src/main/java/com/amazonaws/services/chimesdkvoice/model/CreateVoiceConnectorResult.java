...
public class CreateVoiceConnectorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The details of the Voice Connector.
     */
    ...
    public CreateVoiceConnectorResult withVoiceConnector(VoiceConnector voiceConnector) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateVoiceConnectorResult == false)
            return false;
        CreateVoiceConnectorResult other = (CreateVoiceConnectorResult) obj;
    ...
    @Override
    public CreateVoiceConnectorResult clone() {
        try {
            return (CreateVoiceConnectorResult) super.clone();
