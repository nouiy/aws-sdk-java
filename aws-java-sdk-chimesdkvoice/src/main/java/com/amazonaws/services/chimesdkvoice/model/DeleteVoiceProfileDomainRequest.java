...
public class DeleteVoiceProfileDomainRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteVoiceProfileDomainRequest withVoiceProfileDomainId(String voiceProfileDomainId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVoiceProfileDomainRequest == false)
            return false;
        DeleteVoiceProfileDomainRequest other = (DeleteVoiceProfileDomainRequest) obj;
    ...
    @Override
    public DeleteVoiceProfileDomainRequest clone() {
        return (DeleteVoiceProfileDomainRequest) super.clone();
    }
