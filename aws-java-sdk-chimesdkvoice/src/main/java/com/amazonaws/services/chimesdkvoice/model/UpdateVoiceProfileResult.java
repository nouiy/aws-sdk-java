...
public class UpdateVoiceProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateVoiceProfileResult == false)
            return false;
        UpdateVoiceProfileResult other = (UpdateVoiceProfileResult) obj;
    ...
    public UpdateVoiceProfileResult clone() {
        try {
            return (UpdateVoiceProfileResult) super.clone();
