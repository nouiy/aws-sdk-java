...
public class GetSipMediaApplicationAlexaSkillConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetSipMediaApplicationAlexaSkillConfigurationRequest withSipMediaApplicationId(String sipMediaApplicationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSipMediaApplicationAlexaSkillConfigurationRequest == false)
            return false;
        GetSipMediaApplicationAlexaSkillConfigurationRequest other = (GetSipMediaApplicationAlexaSkillConfigurationRequest) obj;
    ...
    @Override
    public GetSipMediaApplicationAlexaSkillConfigurationRequest clone() {
        return (GetSipMediaApplicationAlexaSkillConfigurationRequest) super.clone();
    }
