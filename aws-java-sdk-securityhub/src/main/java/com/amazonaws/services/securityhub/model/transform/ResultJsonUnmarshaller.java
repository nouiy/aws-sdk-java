        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AccountId", targetDepth)) {
                    context.nextToken();
                    result.setAccountId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ProcessingResult", targetDepth)) {
                    context.nextToken();
                    result.setProcessingResult(context.getUnmarshaller(String.class).unmarshall(context));
                }
