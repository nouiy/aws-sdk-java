...
public class DeleteInsightResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the insight that was deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteInsightResult == false)
            return false;
        DeleteInsightResult other = (DeleteInsightResult) obj;
    ...
    public DeleteInsightResult clone() {
        try {
            return (DeleteInsightResult) super.clone();
