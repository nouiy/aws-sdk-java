...
public class CreateActionTargetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateActionTargetResult == false)
            return false;
        CreateActionTargetResult other = (CreateActionTargetResult) obj;
    ...
    public CreateActionTargetResult clone() {
        try {
            return (CreateActionTargetResult) super.clone();
