...
public class CreateFindingAggregatorRequestMarshaller {
    ...
    private static final CreateFindingAggregatorRequestMarshaller instance = new CreateFindingAggregatorRequestMarshaller();

    public static CreateFindingAggregatorRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateFindingAggregatorRequest createFindingAggregatorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createFindingAggregatorRequest.getRegionLinkingMode(), REGIONLINKINGMODE_BINDING);
            protocolMarshaller.marshall(createFindingAggregatorRequest.getRegions(), REGIONS_BINDING);
        } catch (Exception e) {
