...
public class TargetMarshaller {
    ...
    public void marshall(Target target, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(target.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(target.getOrganizationalUnitId(), ORGANIZATIONALUNITID_BINDING);
            protocolMarshaller.marshall(target.getRootId(), ROOTID_BINDING);
        } catch (Exception e) {
