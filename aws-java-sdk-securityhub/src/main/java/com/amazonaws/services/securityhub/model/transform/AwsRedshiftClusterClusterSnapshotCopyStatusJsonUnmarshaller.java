...
/**
 * AwsRedshiftClusterClusterSnapshotCopyStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsRedshiftClusterClusterSnapshotCopyStatusJsonUnmarshaller implements
        Unmarshaller<AwsRedshiftClusterClusterSnapshotCopyStatus, JsonUnmarshallerContext> {

    public AwsRedshiftClusterClusterSnapshotCopyStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsRedshiftClusterClusterSnapshotCopyStatus awsRedshiftClusterClusterSnapshotCopyStatus = new AwsRedshiftClusterClusterSnapshotCopyStatus();
    ...
    private static AwsRedshiftClusterClusterSnapshotCopyStatusJsonUnmarshaller instance;

    public static AwsRedshiftClusterClusterSnapshotCopyStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsRedshiftClusterClusterSnapshotCopyStatusJsonUnmarshaller();
        return instance;
    }
}
