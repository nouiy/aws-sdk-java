 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails withPermissions(java.util.Collection<String> permissions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails == false)
            return false;
    ...
    @Override
    public AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails clone() {
        try {
            return (AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetailsMarshaller.getInstance()
