...
public class DeclineInvitationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeclineInvitationsResult withUnprocessedAccounts(Result... unprocessedAccounts) {
    ...
    public DeclineInvitationsResult withUnprocessedAccounts(java.util.Collection<Result> unprocessedAccounts) {
