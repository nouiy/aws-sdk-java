...
public class AwsCodeBuildProjectVpcConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public AwsCodeBuildProjectVpcConfig withSecurityGroupIds(java.util.Collection<String> securityGroupIds) {
    ...
    @Override
    public AwsCodeBuildProjectVpcConfig clone() {
        try {
            return (AwsCodeBuildProjectVpcConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsCodeBuildProjectVpcConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
