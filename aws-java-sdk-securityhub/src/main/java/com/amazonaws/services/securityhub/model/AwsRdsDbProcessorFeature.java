...
public class AwsRdsDbProcessorFeature implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsRdsDbProcessorFeature == false)
            return false;
        AwsRdsDbProcessorFeature other = (AwsRdsDbProcessorFeature) obj;
    ...
    @Override
    public AwsRdsDbProcessorFeature clone() {
        try {
            return (AwsRdsDbProcessorFeature) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsRdsDbProcessorFeatureMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
