 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsElbLoadBalancerSourceSecurityGroup"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsElbLoadBalancerSourceSecurityGroup implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getOwnerAlias() != null)
            sb.append("OwnerAlias: ").append(getOwnerAlias());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsElbLoadBalancerSourceSecurityGroup == false)
            return false;
    ...
    public AwsElbLoadBalancerSourceSecurityGroup clone() {
        try {
            return (AwsElbLoadBalancerSourceSecurityGroup) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsElbLoadBalancerSourceSecurityGroupMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
