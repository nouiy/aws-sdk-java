...
/**
 * AwsWafRateBasedRuleDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsWafRateBasedRuleDetailsJsonUnmarshaller implements Unmarshaller<AwsWafRateBasedRuleDetails, JsonUnmarshallerContext> {

    public AwsWafRateBasedRuleDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsWafRateBasedRuleDetails awsWafRateBasedRuleDetails = new AwsWafRateBasedRuleDetails();
    ...
    private static AwsWafRateBasedRuleDetailsJsonUnmarshaller instance;

    public static AwsWafRateBasedRuleDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsWafRateBasedRuleDetailsJsonUnmarshaller();
        return instance;
    }
}
