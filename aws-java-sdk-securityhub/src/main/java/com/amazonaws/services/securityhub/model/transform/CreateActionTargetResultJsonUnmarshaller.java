...
/**
 * CreateActionTargetResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateActionTargetResultJsonUnmarshaller implements Unmarshaller<CreateActionTargetResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActionTargetArn", targetDepth)) {
                    context.nextToken();
                    createActionTargetResult.setActionTargetArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
