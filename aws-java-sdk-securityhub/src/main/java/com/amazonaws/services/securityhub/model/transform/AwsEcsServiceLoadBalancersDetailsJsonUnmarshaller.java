...
/**
 * AwsEcsServiceLoadBalancersDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEcsServiceLoadBalancersDetailsJsonUnmarshaller implements Unmarshaller<AwsEcsServiceLoadBalancersDetails, JsonUnmarshallerContext> {

    public AwsEcsServiceLoadBalancersDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsEcsServiceLoadBalancersDetails awsEcsServiceLoadBalancersDetails = new AwsEcsServiceLoadBalancersDetails();
    ...
    private static AwsEcsServiceLoadBalancersDetailsJsonUnmarshaller instance;

    public static AwsEcsServiceLoadBalancersDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsEcsServiceLoadBalancersDetailsJsonUnmarshaller();
        return instance;
    }
}
