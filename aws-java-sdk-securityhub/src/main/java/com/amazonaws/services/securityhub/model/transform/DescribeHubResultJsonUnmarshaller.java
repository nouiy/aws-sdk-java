        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SubscribedAt", targetDepth)) {
                    context.nextToken();
                    describeHubResult.setSubscribedAt(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("AutoEnableControls", targetDepth)) {
                    context.nextToken();
                    describeHubResult.setAutoEnableControls(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("ControlFindingGenerator", targetDepth)) {
                    context.nextToken();
                    describeHubResult.setControlFindingGenerator(context.getUnmarshaller(String.class).unmarshall(context));
                }
