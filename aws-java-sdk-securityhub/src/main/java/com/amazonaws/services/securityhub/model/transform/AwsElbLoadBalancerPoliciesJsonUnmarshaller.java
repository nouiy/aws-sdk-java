...
/**
 * AwsElbLoadBalancerPolicies JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsElbLoadBalancerPoliciesJsonUnmarshaller implements Unmarshaller<AwsElbLoadBalancerPolicies, JsonUnmarshallerContext> {

    public AwsElbLoadBalancerPolicies unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsElbLoadBalancerPolicies awsElbLoadBalancerPolicies = new AwsElbLoadBalancerPolicies();
    ...
    private static AwsElbLoadBalancerPoliciesJsonUnmarshaller instance;

    public static AwsElbLoadBalancerPoliciesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsElbLoadBalancerPoliciesJsonUnmarshaller();
        return instance;
    }
}
