        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActionTargetArn", targetDepth)) {
                    context.nextToken();
                    actionTarget.setActionTargetArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    actionTarget.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
