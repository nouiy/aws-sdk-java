...
/**
 * DisableImportFindingsForProductResult JSON Unmarshaller
 */
...
public class DisableImportFindingsForProductResultJsonUnmarshaller implements Unmarshaller<DisableImportFindingsForProductResult, JsonUnmarshallerContext> {
    ...
    public DisableImportFindingsForProductResult unmarshall(JsonUnmarshallerContext context) throws Exception {
