 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsDynamoDbTableReplicaGlobalSecondaryIndex"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsDynamoDbTableReplicaGlobalSecondaryIndex implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Replica-specific configuration for the provisioned throughput for the index.
     */
    ...
    public AwsDynamoDbTableReplicaGlobalSecondaryIndex withProvisionedThroughputOverride(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsDynamoDbTableReplicaGlobalSecondaryIndex == false)
            return false;
        AwsDynamoDbTableReplicaGlobalSecondaryIndex other = (AwsDynamoDbTableReplicaGlobalSecondaryIndex) obj;
    ...
    public AwsDynamoDbTableReplicaGlobalSecondaryIndex clone() {
        try {
            return (AwsDynamoDbTableReplicaGlobalSecondaryIndex) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsDynamoDbTableReplicaGlobalSecondaryIndexMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
