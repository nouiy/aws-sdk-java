 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2VpnConnectionOptionsTunnelOptionsDetails"
...
public class AwsEc2VpnConnectionOptionsTunnelOptionsDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<String> ikeVersions;
    /**
     * <p>
     ...
     * </p>
     */
    private java.util.List<Integer> phase1DhGroupNumbers;
    /**
     * <p>
     * The permitted encryption algorithms for the VPN tunnel for phase 1 IKE negotiations.
     * </p>
     */
    private java.util.List<String> phase1EncryptionAlgorithms;
    /**
     * <p>
     * The permitted integrity algorithms for the VPN tunnel for phase 1 IKE negotiations.
     * </p>
     */
    private java.util.List<String> phase1IntegrityAlgorithms;
    /**
     * <p>
     ...
     * </p>
     */
    private java.util.List<Integer> phase2DhGroupNumbers;
    /**
     * <p>
     * The permitted encryption algorithms for the VPN tunnel for phase 2 IKE negotiations.
     * </p>
     */
    private java.util.List<String> phase2EncryptionAlgorithms;
    /**
     * <p>
     * The permitted integrity algorithms for the VPN tunnel for phase 2 IKE negotiations.
     * </p>
     */
    private java.util.List<String> phase2IntegrityAlgorithms;
    /**
     * <p>
    ...
    public java.util.List<String> getIkeVersions() {
        return ikeVersions;
    }
    ...
    public void setIkeVersions(java.util.Collection<String> ikeVersions) {
        if (ikeVersions == null) {
            this.ikeVersions = null;
            return;
        }

        this.ikeVersions = new java.util.ArrayList<String>(ikeVersions);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withIkeVersions(String... ikeVersions) {
        if (this.ikeVersions == null) {
            setIkeVersions(new java.util.ArrayList<String>(ikeVersions.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withIkeVersions(java.util.Collection<String> ikeVersions) {
    ...
    public java.util.List<Integer> getPhase1DhGroupNumbers() {
    ...
    public void setPhase1DhGroupNumbers(java.util.Collection<Integer> phase1DhGroupNumbers) {
        if (phase1DhGroupNumbers == null) {
            this.phase1DhGroupNumbers = null;
            return;
        }

        this.phase1DhGroupNumbers = new java.util.ArrayList<Integer>(phase1DhGroupNumbers);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase1DhGroupNumbers(Integer... phase1DhGroupNumbers) {
        if (this.phase1DhGroupNumbers == null) {
            setPhase1DhGroupNumbers(new java.util.ArrayList<Integer>(phase1DhGroupNumbers.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase1DhGroupNumbers(java.util.Collection<Integer> phase1DhGroupNumbers) {
    ...
    public java.util.List<String> getPhase1EncryptionAlgorithms() {
    ...
    public void setPhase1EncryptionAlgorithms(java.util.Collection<String> phase1EncryptionAlgorithms) {
        if (phase1EncryptionAlgorithms == null) {
            this.phase1EncryptionAlgorithms = null;
            return;
        }

        this.phase1EncryptionAlgorithms = new java.util.ArrayList<String>(phase1EncryptionAlgorithms);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase1EncryptionAlgorithms(String... phase1EncryptionAlgorithms) {
        if (this.phase1EncryptionAlgorithms == null) {
            setPhase1EncryptionAlgorithms(new java.util.ArrayList<String>(phase1EncryptionAlgorithms.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase1EncryptionAlgorithms(java.util.Collection<String> phase1EncryptionAlgorithms) {
    ...
    public java.util.List<String> getPhase1IntegrityAlgorithms() {
    ...
    public void setPhase1IntegrityAlgorithms(java.util.Collection<String> phase1IntegrityAlgorithms) {
        if (phase1IntegrityAlgorithms == null) {
            this.phase1IntegrityAlgorithms = null;
            return;
        }

        this.phase1IntegrityAlgorithms = new java.util.ArrayList<String>(phase1IntegrityAlgorithms);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase1IntegrityAlgorithms(String... phase1IntegrityAlgorithms) {
        if (this.phase1IntegrityAlgorithms == null) {
            setPhase1IntegrityAlgorithms(new java.util.ArrayList<String>(phase1IntegrityAlgorithms.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase1IntegrityAlgorithms(java.util.Collection<String> phase1IntegrityAlgorithms) {
    ...
    public java.util.List<Integer> getPhase2DhGroupNumbers() {
    ...
    public void setPhase2DhGroupNumbers(java.util.Collection<Integer> phase2DhGroupNumbers) {
        if (phase2DhGroupNumbers == null) {
            this.phase2DhGroupNumbers = null;
            return;
        }

        this.phase2DhGroupNumbers = new java.util.ArrayList<Integer>(phase2DhGroupNumbers);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase2DhGroupNumbers(Integer... phase2DhGroupNumbers) {
        if (this.phase2DhGroupNumbers == null) {
            setPhase2DhGroupNumbers(new java.util.ArrayList<Integer>(phase2DhGroupNumbers.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase2DhGroupNumbers(java.util.Collection<Integer> phase2DhGroupNumbers) {
    ...
    public java.util.List<String> getPhase2EncryptionAlgorithms() {
    ...
    public void setPhase2EncryptionAlgorithms(java.util.Collection<String> phase2EncryptionAlgorithms) {
        if (phase2EncryptionAlgorithms == null) {
            this.phase2EncryptionAlgorithms = null;
            return;
        }

        this.phase2EncryptionAlgorithms = new java.util.ArrayList<String>(phase2EncryptionAlgorithms);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase2EncryptionAlgorithms(String... phase2EncryptionAlgorithms) {
        if (this.phase2EncryptionAlgorithms == null) {
            setPhase2EncryptionAlgorithms(new java.util.ArrayList<String>(phase2EncryptionAlgorithms.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase2EncryptionAlgorithms(java.util.Collection<String> phase2EncryptionAlgorithms) {
    ...
    public java.util.List<String> getPhase2IntegrityAlgorithms() {
    ...
    public void setPhase2IntegrityAlgorithms(java.util.Collection<String> phase2IntegrityAlgorithms) {
        if (phase2IntegrityAlgorithms == null) {
            this.phase2IntegrityAlgorithms = null;
            return;
        }

        this.phase2IntegrityAlgorithms = new java.util.ArrayList<String>(phase2IntegrityAlgorithms);
    }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase2IntegrityAlgorithms(String... phase2IntegrityAlgorithms) {
        if (this.phase2IntegrityAlgorithms == null) {
            setPhase2IntegrityAlgorithms(new java.util.ArrayList<String>(phase2IntegrityAlgorithms.length));
        }
    ...
    public AwsEc2VpnConnectionOptionsTunnelOptionsDetails withPhase2IntegrityAlgorithms(java.util.Collection<String> phase2IntegrityAlgorithms) {
