...
/**
 * AwsCertificateManagerCertificateRenewalSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsCertificateManagerCertificateRenewalSummaryJsonUnmarshaller implements
        Unmarshaller<AwsCertificateManagerCertificateRenewalSummary, JsonUnmarshallerContext> {

    public AwsCertificateManagerCertificateRenewalSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsCertificateManagerCertificateRenewalSummary awsCertificateManagerCertificateRenewalSummary = new AwsCertificateManagerCertificateRenewalSummary();
    ...
    private static AwsCertificateManagerCertificateRenewalSummaryJsonUnmarshaller instance;

    public static AwsCertificateManagerCertificateRenewalSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsCertificateManagerCertificateRenewalSummaryJsonUnmarshaller();
        return instance;
    }
}
