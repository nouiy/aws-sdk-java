...
/**
 * AwsCloudFrontDistributionOrigins JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsCloudFrontDistributionOriginsJsonUnmarshaller implements Unmarshaller<AwsCloudFrontDistributionOrigins, JsonUnmarshallerContext> {

    public AwsCloudFrontDistributionOrigins unmarshall(JsonUnmarshallerContext context) throws Exception {
