 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsS3BucketObjectLockConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsS3BucketObjectLockConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setRule(AwsS3BucketObjectLockConfigurationRuleDetails rule) {
        this.rule = rule;
    }
    ...
    public AwsS3BucketObjectLockConfigurationRuleDetails getRule() {
        return this.rule;
    }
    ...
    public String toString() {
        ...
        if (getObjectLockEnabled() != null)
            sb.append("ObjectLockEnabled: ").append(getObjectLockEnabled()).append(",");
        if (getRule() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsS3BucketObjectLockConfiguration == false)
            return false;
        ...
        if (other.getObjectLockEnabled() == null ^ this.getObjectLockEnabled() == null)
            return false;
        if (other.getObjectLockEnabled() != null && other.getObjectLockEnabled().equals(this.getObjectLockEnabled()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getObjectLockEnabled() == null) ? 0 : getObjectLockEnabled().hashCode());
    ...
    public AwsS3BucketObjectLockConfiguration clone() {
        try {
            return (AwsS3BucketObjectLockConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsS3BucketObjectLockConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
