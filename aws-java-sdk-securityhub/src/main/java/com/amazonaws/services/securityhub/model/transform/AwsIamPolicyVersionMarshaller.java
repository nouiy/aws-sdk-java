...
@SdkInternalApi
public class AwsIamPolicyVersionMarshaller {
    ...
    private static final AwsIamPolicyVersionMarshaller instance = new AwsIamPolicyVersionMarshaller();

    public static AwsIamPolicyVersionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AwsIamPolicyVersion awsIamPolicyVersion, ProtocolMarshaller protocolMarshaller) {

        if (awsIamPolicyVersion == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(awsIamPolicyVersion.getVersionId(), VERSIONID_BINDING);
            protocolMarshaller.marshall(awsIamPolicyVersion.getIsDefaultVersion(), ISDEFAULTVERSION_BINDING);
            protocolMarshaller.marshall(awsIamPolicyVersion.getCreateDate(), CREATEDATE_BINDING);
        } catch (Exception e) {
