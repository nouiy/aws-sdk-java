 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsWafRateBasedRuleDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsWafRateBasedRuleDetails implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<AwsWafRateBasedRuleMatchPredicate> matchPredicates;
    ...
    public java.util.List<AwsWafRateBasedRuleMatchPredicate> getMatchPredicates() {
    ...
    public void setMatchPredicates(java.util.Collection<AwsWafRateBasedRuleMatchPredicate> matchPredicates) {
        if (matchPredicates == null) {
            this.matchPredicates = null;
            return;
        }

        this.matchPredicates = new java.util.ArrayList<AwsWafRateBasedRuleMatchPredicate>(matchPredicates);
    }
    ...
    public AwsWafRateBasedRuleDetails withMatchPredicates(AwsWafRateBasedRuleMatchPredicate... matchPredicates) {
        if (this.matchPredicates == null) {
            setMatchPredicates(new java.util.ArrayList<AwsWafRateBasedRuleMatchPredicate>(matchPredicates.length));
        }
        for (AwsWafRateBasedRuleMatchPredicate ele : matchPredicates) {
    ...
    public AwsWafRateBasedRuleDetails withMatchPredicates(java.util.Collection<AwsWafRateBasedRuleMatchPredicate> matchPredicates) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsWafRateBasedRuleDetails == false)
            return false;
    ...
    @Override
    public AwsWafRateBasedRuleDetails clone() {
        try {
            return (AwsWafRateBasedRuleDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsWafRateBasedRuleDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
