...
/**
 * DeleteConfigurationPolicyResult JSON Unmarshaller
 */
...
public class DeleteConfigurationPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteConfigurationPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteConfigurationPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConfigurationPolicyResult deleteConfigurationPolicyResult = new DeleteConfigurationPolicyResult();

        return deleteConfigurationPolicyResult;
    }
