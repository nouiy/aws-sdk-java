 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsRdsDbInstanceEndpoint"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsRdsDbInstanceEndpoint implements Serializable, Cloneable, StructuredPojo {
    ...
    public AwsRdsDbInstanceEndpoint clone() {
        try {
            return (AwsRdsDbInstanceEndpoint) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsRdsDbInstanceEndpointMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
