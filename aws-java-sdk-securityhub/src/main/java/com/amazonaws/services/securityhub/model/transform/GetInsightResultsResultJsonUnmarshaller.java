...
/**
 * GetInsightResultsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetInsightResultsResultJsonUnmarshaller implements Unmarshaller<GetInsightResultsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("InsightResults", targetDepth)) {
                    context.nextToken();
                    getInsightResultsResult.setInsightResults(InsightResultsJsonUnmarshaller.getInstance().unmarshall(context));
                }
