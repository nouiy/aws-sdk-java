...
public class DescribeStandardsControlsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeStandardsControlsResult withControls(StandardsControl... controls) {
        if (this.controls == null) {
            setControls(new java.util.ArrayList<StandardsControl>(controls.length));
        }
        for (StandardsControl ele : controls) {
    ...
    public DescribeStandardsControlsResult withControls(java.util.Collection<StandardsControl> controls) {
    ...
    public DescribeStandardsControlsResult clone() {
        try {
            return (DescribeStandardsControlsResult) super.clone();
