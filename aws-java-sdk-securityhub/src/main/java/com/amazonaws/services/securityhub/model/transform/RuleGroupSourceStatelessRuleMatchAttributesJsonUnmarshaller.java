...
/**
 * RuleGroupSourceStatelessRuleMatchAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RuleGroupSourceStatelessRuleMatchAttributesJsonUnmarshaller implements
        Unmarshaller<RuleGroupSourceStatelessRuleMatchAttributes, JsonUnmarshallerContext> {

    public RuleGroupSourceStatelessRuleMatchAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        RuleGroupSourceStatelessRuleMatchAttributes ruleGroupSourceStatelessRuleMatchAttributes = new RuleGroupSourceStatelessRuleMatchAttributes();
                ...
                if (context.testExpression("DestinationPorts", targetDepth)) {
                    ...
                    ruleGroupSourceStatelessRuleMatchAttributes
                            .setDestinationPorts(new ListUnmarshaller<RuleGroupSourceStatelessRuleMatchAttributesDestinationPorts>(
                                    RuleGroupSourceStatelessRuleMatchAttributesDestinationPortsJsonUnmarshaller.getInstance())
    ...
    private static RuleGroupSourceStatelessRuleMatchAttributesJsonUnmarshaller instance;

    public static RuleGroupSourceStatelessRuleMatchAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RuleGroupSourceStatelessRuleMatchAttributesJsonUnmarshaller();
        return instance;
    }
}
