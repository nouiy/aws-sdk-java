 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AssociationSetDetails" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssociationSetDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public AssociationStateDetails getAssociationState() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociationSetDetails == false)
            return false;
    ...
    public AssociationSetDetails clone() {
        try {
            return (AssociationSetDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AssociationSetDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
