...
/**
 * DeleteFindingAggregatorResult JSON Unmarshaller
 */
...
public class DeleteFindingAggregatorResultJsonUnmarshaller implements Unmarshaller<DeleteFindingAggregatorResult, JsonUnmarshallerContext> {
    ...
    public DeleteFindingAggregatorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFindingAggregatorResult deleteFindingAggregatorResult = new DeleteFindingAggregatorResult();

        return deleteFindingAggregatorResult;
    }
