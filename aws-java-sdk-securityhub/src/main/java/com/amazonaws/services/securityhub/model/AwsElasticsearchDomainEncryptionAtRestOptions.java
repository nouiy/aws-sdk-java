 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsElasticsearchDomainEncryptionAtRestOptions"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsElasticsearchDomainEncryptionAtRestOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    public AwsElasticsearchDomainEncryptionAtRestOptions clone() {
        try {
            return (AwsElasticsearchDomainEncryptionAtRestOptions) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsElasticsearchDomainEncryptionAtRestOptionsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
