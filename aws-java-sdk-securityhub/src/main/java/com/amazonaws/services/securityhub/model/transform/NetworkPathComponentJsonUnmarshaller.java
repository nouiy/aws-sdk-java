...
/**
 * NetworkPathComponent JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NetworkPathComponentJsonUnmarshaller implements Unmarshaller<NetworkPathComponent, JsonUnmarshallerContext> {

    public NetworkPathComponent unmarshall(JsonUnmarshallerContext context) throws Exception {
        NetworkPathComponent networkPathComponent = new NetworkPathComponent();
    ...
    private static NetworkPathComponentJsonUnmarshaller instance;

    public static NetworkPathComponentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NetworkPathComponentJsonUnmarshaller();
        return instance;
    }
}
