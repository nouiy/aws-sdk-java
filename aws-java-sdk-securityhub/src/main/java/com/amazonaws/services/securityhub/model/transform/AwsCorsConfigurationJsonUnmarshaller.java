...
/**
 * AwsCorsConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsCorsConfigurationJsonUnmarshaller implements Unmarshaller<AwsCorsConfiguration, JsonUnmarshallerContext> {

    public AwsCorsConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsCorsConfiguration awsCorsConfiguration = new AwsCorsConfiguration();
    ...
    private static AwsCorsConfigurationJsonUnmarshaller instance;

    public static AwsCorsConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AwsCorsConfigurationJsonUnmarshaller();
        return instance;
    }
}
