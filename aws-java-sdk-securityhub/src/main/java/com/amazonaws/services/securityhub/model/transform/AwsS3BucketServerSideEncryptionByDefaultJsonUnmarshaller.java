...
/**
 * AwsS3BucketServerSideEncryptionByDefault JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsS3BucketServerSideEncryptionByDefaultJsonUnmarshaller implements
        Unmarshaller<AwsS3BucketServerSideEncryptionByDefault, JsonUnmarshallerContext> {

    public AwsS3BucketServerSideEncryptionByDefault unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SSEAlgorithm", targetDepth)) {
                    context.nextToken();
                    awsS3BucketServerSideEncryptionByDefault.setSSEAlgorithm(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("KMSMasterKeyID", targetDepth)) {
                    context.nextToken();
                    awsS3BucketServerSideEncryptionByDefault.setKMSMasterKeyID(context.getUnmarshaller(String.class).unmarshall(context));
                }
