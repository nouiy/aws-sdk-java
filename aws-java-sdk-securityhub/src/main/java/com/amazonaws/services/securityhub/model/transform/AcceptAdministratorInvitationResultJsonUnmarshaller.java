...
/**
 * AcceptAdministratorInvitationResult JSON Unmarshaller
 */
...
public class AcceptAdministratorInvitationResultJsonUnmarshaller implements Unmarshaller<AcceptAdministratorInvitationResult, JsonUnmarshallerContext> {
    ...
    public AcceptAdministratorInvitationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AcceptAdministratorInvitationResult acceptAdministratorInvitationResult = new AcceptAdministratorInvitationResult();

        return acceptAdministratorInvitationResult;
    }
