...
public class IncompatiblePolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IncompatiblePolicyExceptionUnmarshaller instance;

    public static IncompatiblePolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncompatiblePolicyExceptionUnmarshaller();
        return instance;
    }
}
