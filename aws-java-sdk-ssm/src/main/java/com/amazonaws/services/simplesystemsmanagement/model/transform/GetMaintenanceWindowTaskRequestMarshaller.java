...
@SdkInternalApi
public class GetMaintenanceWindowTaskRequestMarshaller {
    ...
    private static final GetMaintenanceWindowTaskRequestMarshaller instance = new GetMaintenanceWindowTaskRequestMarshaller();

    public static GetMaintenanceWindowTaskRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetMaintenanceWindowTaskRequest getMaintenanceWindowTaskRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getMaintenanceWindowTaskRequest.getWindowId(), WINDOWID_BINDING);
            protocolMarshaller.marshall(getMaintenanceWindowTaskRequest.getWindowTaskId(), WINDOWTASKID_BINDING);
        } catch (Exception e) {
