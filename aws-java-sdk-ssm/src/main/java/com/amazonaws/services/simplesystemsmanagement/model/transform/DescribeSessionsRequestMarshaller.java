...
public class DescribeSessionsRequestMarshaller {
    ...
    public void marshall(DescribeSessionsRequest describeSessionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeSessionsRequest.getState(), STATE_BINDING);
            protocolMarshaller.marshall(describeSessionsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(describeSessionsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(describeSessionsRequest.getFilters(), FILTERS_BINDING);
        } catch (Exception e) {
