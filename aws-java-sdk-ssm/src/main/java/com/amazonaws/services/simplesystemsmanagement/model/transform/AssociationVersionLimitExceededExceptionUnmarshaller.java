...
public class AssociationVersionLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.AssociationVersionLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return associationVersionLimitExceededException;
    }

    private static AssociationVersionLimitExceededExceptionUnmarshaller instance;

    public static AssociationVersionLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssociationVersionLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
