...
public class MaintenanceWindowTaskInvocationParametersJsonUnmarshaller implements
        Unmarshaller<MaintenanceWindowTaskInvocationParameters, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RunCommand", targetDepth)) {
                    context.nextToken();
                    maintenanceWindowTaskInvocationParameters.setRunCommand(MaintenanceWindowRunCommandParametersJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
                if (context.testExpression("Automation", targetDepth)) {
                    context.nextToken();
                    maintenanceWindowTaskInvocationParameters.setAutomation(MaintenanceWindowAutomationParametersJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
                if (context.testExpression("StepFunctions", targetDepth)) {
                    context.nextToken();
                    maintenanceWindowTaskInvocationParameters.setStepFunctions(MaintenanceWindowStepFunctionsParametersJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
                if (context.testExpression("Lambda", targetDepth)) {
                    context.nextToken();
                    maintenanceWindowTaskInvocationParameters.setLambda(MaintenanceWindowLambdaParametersJsonUnmarshaller.getInstance().unmarshall(context));
                }
