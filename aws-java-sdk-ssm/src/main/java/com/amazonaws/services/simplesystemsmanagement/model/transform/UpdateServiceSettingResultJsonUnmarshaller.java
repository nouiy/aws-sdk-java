...
/**
 * UpdateServiceSettingResult JSON Unmarshaller
 */
...
public class UpdateServiceSettingResultJsonUnmarshaller implements Unmarshaller<UpdateServiceSettingResult, JsonUnmarshallerContext> {
    ...
    public UpdateServiceSettingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateServiceSettingResult updateServiceSettingResult = new UpdateServiceSettingResult();
