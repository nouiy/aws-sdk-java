...
public class ParameterVersionLabelLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.ParameterVersionLabelLimitExceededException unmarshallFromContext(
        ...
        return parameterVersionLabelLimitExceededException;
    }

    private static ParameterVersionLabelLimitExceededExceptionUnmarshaller instance;

    public static ParameterVersionLabelLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterVersionLabelLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
