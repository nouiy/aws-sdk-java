...
/**
 * GetParametersResult JSON Unmarshaller
 */
...
public class GetParametersResultJsonUnmarshaller implements Unmarshaller<GetParametersResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("InvalidParameters", targetDepth)) {
                    context.nextToken();
                    getParametersResult.setInvalidParameters(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
    ...
    public static GetParametersResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetParametersResultJsonUnmarshaller();
        return instance;
    }
}
