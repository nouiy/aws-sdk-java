...
public class MaintenanceWindowExecutionMarshaller {
    ...
    public void marshall(MaintenanceWindowExecution maintenanceWindowExecution, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(maintenanceWindowExecution.getWindowId(), WINDOWID_BINDING);
            protocolMarshaller.marshall(maintenanceWindowExecution.getWindowExecutionId(), WINDOWEXECUTIONID_BINDING);
            protocolMarshaller.marshall(maintenanceWindowExecution.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(maintenanceWindowExecution.getStatusDetails(), STATUSDETAILS_BINDING);
            protocolMarshaller.marshall(maintenanceWindowExecution.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(maintenanceWindowExecution.getEndTime(), ENDTIME_BINDING);
        } catch (Exception e) {
