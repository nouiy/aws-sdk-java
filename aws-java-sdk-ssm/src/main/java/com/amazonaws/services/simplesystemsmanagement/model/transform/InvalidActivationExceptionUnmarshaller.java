...
public class InvalidActivationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidActivationException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidActivationException;
    }

    private static InvalidActivationExceptionUnmarshaller instance;

    public static InvalidActivationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidActivationExceptionUnmarshaller();
        return instance;
    }
}
