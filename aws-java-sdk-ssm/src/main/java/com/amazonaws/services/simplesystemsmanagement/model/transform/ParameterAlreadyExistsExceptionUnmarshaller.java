...
public class ParameterAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.ParameterAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return parameterAlreadyExistsException;
    }

    private static ParameterAlreadyExistsExceptionUnmarshaller instance;

    public static ParameterAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
