...
public class CreateAssociationResultJsonUnmarshaller implements Unmarshaller<CreateAssociationResult, JsonUnmarshallerContext> {

    public CreateAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AssociationDescription", targetDepth)) {
                    context.nextToken();
                    createAssociationResult.setAssociationDescription(AssociationDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
