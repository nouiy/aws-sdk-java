...
public class FeatureNotAvailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static FeatureNotAvailableExceptionUnmarshaller instance;

    public static FeatureNotAvailableExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FeatureNotAvailableExceptionUnmarshaller();
        return instance;
    }
}
