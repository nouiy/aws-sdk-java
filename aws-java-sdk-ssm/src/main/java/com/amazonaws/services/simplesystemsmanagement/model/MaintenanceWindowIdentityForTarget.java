...
public class MaintenanceWindowIdentityForTarget implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MaintenanceWindowIdentityForTarget == false)
            return false;
        MaintenanceWindowIdentityForTarget other = (MaintenanceWindowIdentityForTarget) obj;
    ...
    public MaintenanceWindowIdentityForTarget clone() {
        try {
            return (MaintenanceWindowIdentityForTarget) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simplesystemsmanagement.model.transform.MaintenanceWindowIdentityForTargetMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
