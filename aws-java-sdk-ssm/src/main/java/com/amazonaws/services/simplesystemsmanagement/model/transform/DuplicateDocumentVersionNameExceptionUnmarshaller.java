...
public class DuplicateDocumentVersionNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.DuplicateDocumentVersionNameException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return duplicateDocumentVersionNameException;
    }

    private static DuplicateDocumentVersionNameExceptionUnmarshaller instance;

    public static DuplicateDocumentVersionNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateDocumentVersionNameExceptionUnmarshaller();
        return instance;
    }
}
