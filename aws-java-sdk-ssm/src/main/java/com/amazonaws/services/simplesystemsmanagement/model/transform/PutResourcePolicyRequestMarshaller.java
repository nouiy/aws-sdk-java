...
public class PutResourcePolicyRequestMarshaller {
    ...
    public void marshall(PutResourcePolicyRequest putResourcePolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(putResourcePolicyRequest.getPolicyId(), POLICYID_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getPolicyHash(), POLICYHASH_BINDING);
        } catch (Exception e) {
