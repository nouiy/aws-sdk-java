...
public class InvalidResultAttributeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidResultAttributeExceptionUnmarshaller instance;

    public static InvalidResultAttributeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidResultAttributeExceptionUnmarshaller();
        return instance;
    }
}
