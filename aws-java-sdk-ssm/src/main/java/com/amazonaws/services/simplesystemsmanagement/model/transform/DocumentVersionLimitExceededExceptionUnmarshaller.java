...
public class DocumentVersionLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.DocumentVersionLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return documentVersionLimitExceededException;
    }

    private static DocumentVersionLimitExceededExceptionUnmarshaller instance;

    public static DocumentVersionLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DocumentVersionLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
