...
public class MaxDocumentSizeExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.MaxDocumentSizeExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return maxDocumentSizeExceededException;
    }

    private static MaxDocumentSizeExceededExceptionUnmarshaller instance;

    public static MaxDocumentSizeExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MaxDocumentSizeExceededExceptionUnmarshaller();
        return instance;
    }
}
