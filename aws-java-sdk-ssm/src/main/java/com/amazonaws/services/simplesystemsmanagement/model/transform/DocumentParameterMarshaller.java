...
public class DocumentParameterMarshaller {
    ...
    public void marshall(DocumentParameter documentParameter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(documentParameter.getName(), NAME_BINDING);
            protocolMarshaller.marshall(documentParameter.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(documentParameter.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(documentParameter.getDefaultValue(), DEFAULTVALUE_BINDING);
        } catch (Exception e) {
