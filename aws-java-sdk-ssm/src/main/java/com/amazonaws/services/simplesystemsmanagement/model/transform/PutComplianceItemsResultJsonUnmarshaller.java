...
/**
 * PutComplianceItemsResult JSON Unmarshaller
 */
...
public class PutComplianceItemsResultJsonUnmarshaller implements Unmarshaller<PutComplianceItemsResult, JsonUnmarshallerContext> {
    ...
    public PutComplianceItemsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutComplianceItemsResult putComplianceItemsResult = new PutComplianceItemsResult();
