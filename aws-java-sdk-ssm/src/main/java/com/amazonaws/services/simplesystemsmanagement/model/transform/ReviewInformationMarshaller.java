...
public class ReviewInformationMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> REVIEWEDTIME_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ReviewedTime").timestampFormat("unixTimestamp").build();
