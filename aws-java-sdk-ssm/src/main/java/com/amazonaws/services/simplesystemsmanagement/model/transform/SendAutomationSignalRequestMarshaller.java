...
@SdkInternalApi
public class SendAutomationSignalRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SIGNALTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SignalType").build();
    ...
    private static final SendAutomationSignalRequestMarshaller instance = new SendAutomationSignalRequestMarshaller();

    public static SendAutomationSignalRequestMarshaller getInstance() {
        return instance;
    }
