...
public class ParameterLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.ParameterLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return parameterLimitExceededException;
    }

    private static ParameterLimitExceededExceptionUnmarshaller instance;

    public static ParameterLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
