...
public class GetParametersByPathResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of parameters found in the specified hierarchy.
     */
    ...
    public GetParametersByPathResult clone() {
        try {
            return (GetParametersByPathResult) super.clone();
