...
public class OpsItemInvalidParameterExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OpsItemInvalidParameterExceptionUnmarshaller instance;

    public static OpsItemInvalidParameterExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OpsItemInvalidParameterExceptionUnmarshaller();
        return instance;
    }
}
