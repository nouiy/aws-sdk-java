...
public class InventoryFilterMarshaller {
    ...
    public void marshall(InventoryFilter inventoryFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inventoryFilter.getKey(), KEY_BINDING);
            protocolMarshaller.marshall(inventoryFilter.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(inventoryFilter.getType(), TYPE_BINDING);
        } catch (Exception e) {
