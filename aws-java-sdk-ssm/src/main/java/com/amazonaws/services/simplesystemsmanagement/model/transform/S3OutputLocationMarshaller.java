...
public class S3OutputLocationMarshaller {
    ...
    public void marshall(S3OutputLocation s3OutputLocation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3OutputLocation.getOutputS3Region(), OUTPUTS3REGION_BINDING);
            protocolMarshaller.marshall(s3OutputLocation.getOutputS3BucketName(), OUTPUTS3BUCKETNAME_BINDING);
            protocolMarshaller.marshall(s3OutputLocation.getOutputS3KeyPrefix(), OUTPUTS3KEYPREFIX_BINDING);
        } catch (Exception e) {
