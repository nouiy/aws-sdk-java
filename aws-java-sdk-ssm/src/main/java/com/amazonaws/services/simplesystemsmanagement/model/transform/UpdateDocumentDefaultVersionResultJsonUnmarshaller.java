...
/**
 * UpdateDocumentDefaultVersionResult JSON Unmarshaller
 */
...
public class UpdateDocumentDefaultVersionResultJsonUnmarshaller implements Unmarshaller<UpdateDocumentDefaultVersionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Description", targetDepth)) {
                    context.nextToken();
                    updateDocumentDefaultVersionResult.setDescription(DocumentDefaultVersionDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    public static UpdateDocumentDefaultVersionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateDocumentDefaultVersionResultJsonUnmarshaller();
        return instance;
    }
}
