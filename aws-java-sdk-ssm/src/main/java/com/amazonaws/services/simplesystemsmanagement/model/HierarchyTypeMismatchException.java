...
public class HierarchyTypeMismatchException extends com.amazonaws.services.simplesystemsmanagement.model.AWSSimpleSystemsManagementException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new HierarchyTypeMismatchException with the specified error message.
     *
     * @param message
