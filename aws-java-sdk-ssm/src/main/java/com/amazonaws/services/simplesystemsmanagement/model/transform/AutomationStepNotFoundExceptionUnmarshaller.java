...
public class AutomationStepNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AutomationStepNotFoundExceptionUnmarshaller instance;

    public static AutomationStepNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutomationStepNotFoundExceptionUnmarshaller();
        return instance;
    }
}
