...
public class ParameterNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ParameterNotFoundExceptionUnmarshaller instance;

    public static ParameterNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterNotFoundExceptionUnmarshaller();
        return instance;
    }
}
