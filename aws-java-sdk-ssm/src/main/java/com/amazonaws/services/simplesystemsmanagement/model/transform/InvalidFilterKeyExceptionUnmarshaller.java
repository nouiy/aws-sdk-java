...
public class InvalidFilterKeyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidFilterKeyException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidFilterKeyException;
    }

    private static InvalidFilterKeyExceptionUnmarshaller instance;

    public static InvalidFilterKeyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFilterKeyExceptionUnmarshaller();
        return instance;
    }
}
