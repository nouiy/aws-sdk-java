...
public class PatchGroupPatchBaselineMappingJsonUnmarshaller implements Unmarshaller<PatchGroupPatchBaselineMapping, JsonUnmarshallerContext> {

    public PatchGroupPatchBaselineMapping unmarshall(JsonUnmarshallerContext context) throws Exception {
        PatchGroupPatchBaselineMapping patchGroupPatchBaselineMapping = new PatchGroupPatchBaselineMapping();
    ...
    private static PatchGroupPatchBaselineMappingJsonUnmarshaller instance;

    public static PatchGroupPatchBaselineMappingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PatchGroupPatchBaselineMappingJsonUnmarshaller();
        return instance;
    }
}
