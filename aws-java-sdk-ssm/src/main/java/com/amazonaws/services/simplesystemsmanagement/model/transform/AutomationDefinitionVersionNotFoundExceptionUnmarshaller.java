...
public class AutomationDefinitionVersionNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AutomationDefinitionVersionNotFoundExceptionUnmarshaller instance;

    public static AutomationDefinitionVersionNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutomationDefinitionVersionNotFoundExceptionUnmarshaller();
        return instance;
    }
}
