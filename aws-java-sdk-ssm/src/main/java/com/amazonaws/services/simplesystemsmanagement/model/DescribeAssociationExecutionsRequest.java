...
public class DescribeAssociationExecutionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<AssociationExecutionFilter> filters;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The association ID for which you want to view execution history details.
     */
    ...
    public java.util.List<AssociationExecutionFilter> getFilters() {
        if (filters == null) {
            filters = new com.amazonaws.internal.SdkInternalList<AssociationExecutionFilter>();
        }
        return filters;
    }
    ...
    public void setFilters(java.util.Collection<AssociationExecutionFilter> filters) {
        ...
        this.filters = new com.amazonaws.internal.SdkInternalList<AssociationExecutionFilter>(filters);
    }
    ...
    public DescribeAssociationExecutionsRequest withFilters(AssociationExecutionFilter... filters) {
        if (this.filters == null) {
            setFilters(new com.amazonaws.internal.SdkInternalList<AssociationExecutionFilter>(filters.length));
        }
        for (AssociationExecutionFilter ele : filters) {
    ...
    public DescribeAssociationExecutionsRequest withFilters(java.util.Collection<AssociationExecutionFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    @Override
    public DescribeAssociationExecutionsRequest clone() {
        return (DescribeAssociationExecutionsRequest) super.clone();
    }
