...
public class GetMaintenanceWindowRequestMarshaller {
    ...
    private static final GetMaintenanceWindowRequestMarshaller instance = new GetMaintenanceWindowRequestMarshaller();

    public static GetMaintenanceWindowRequestMarshaller getInstance() {
        return instance;
    }
