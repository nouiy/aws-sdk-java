...
/**
 * RegisterTargetWithMaintenanceWindowResult JSON Unmarshaller
 */
...
public class RegisterTargetWithMaintenanceWindowResultJsonUnmarshaller implements
    ...
    public RegisterTargetWithMaintenanceWindowResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WindowTargetId", targetDepth)) {
                    context.nextToken();
                    registerTargetWithMaintenanceWindowResult.setWindowTargetId(context.getUnmarshaller(String.class).unmarshall(context));
                }
