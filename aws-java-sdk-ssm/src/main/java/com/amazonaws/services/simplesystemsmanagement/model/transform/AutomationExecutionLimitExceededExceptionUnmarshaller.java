...
public class AutomationExecutionLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AutomationExecutionLimitExceededExceptionUnmarshaller instance;

    public static AutomationExecutionLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutomationExecutionLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
