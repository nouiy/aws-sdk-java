...
@SdkInternalApi
public class DescribeActivationsRequestMarshaller {
    ...
    private static final DescribeActivationsRequestMarshaller instance = new DescribeActivationsRequestMarshaller();

    public static DescribeActivationsRequestMarshaller getInstance() {
        return instance;
    }
