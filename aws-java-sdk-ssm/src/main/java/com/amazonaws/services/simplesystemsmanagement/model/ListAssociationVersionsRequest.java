...
public class ListAssociationVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The association ID for which you want to view all versions.
     */
    ...
    @Override
    public ListAssociationVersionsRequest clone() {
        return (ListAssociationVersionsRequest) super.clone();
    }
