...
public class InvalidAutomationStatusUpdateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAutomationStatusUpdateExceptionUnmarshaller instance;

    public static InvalidAutomationStatusUpdateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAutomationStatusUpdateExceptionUnmarshaller();
        return instance;
    }
}
