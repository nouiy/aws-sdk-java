...
/**
 * GetOpsSummaryRequestMarshaller
 */
...
public class GetOpsSummaryRequestMarshaller {
    ...
    private static final GetOpsSummaryRequestMarshaller instance = new GetOpsSummaryRequestMarshaller();

    public static GetOpsSummaryRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetOpsSummaryRequest getOpsSummaryRequest, ProtocolMarshaller protocolMarshaller) {
