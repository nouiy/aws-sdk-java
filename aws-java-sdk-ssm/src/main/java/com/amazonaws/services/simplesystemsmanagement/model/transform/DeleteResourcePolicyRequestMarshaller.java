...
public class DeleteResourcePolicyRequestMarshaller {
    ...
    public void marshall(DeleteResourcePolicyRequest deleteResourcePolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(deleteResourcePolicyRequest.getPolicyId(), POLICYID_BINDING);
            protocolMarshaller.marshall(deleteResourcePolicyRequest.getPolicyHash(), POLICYHASH_BINDING);
        } catch (Exception e) {
