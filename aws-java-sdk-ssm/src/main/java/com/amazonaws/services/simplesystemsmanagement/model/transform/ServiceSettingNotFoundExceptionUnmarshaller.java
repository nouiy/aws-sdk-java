...
public class ServiceSettingNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.ServiceSettingNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return serviceSettingNotFoundException;
    }

    private static ServiceSettingNotFoundExceptionUnmarshaller instance;

    public static ServiceSettingNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceSettingNotFoundExceptionUnmarshaller();
        return instance;
    }
}
