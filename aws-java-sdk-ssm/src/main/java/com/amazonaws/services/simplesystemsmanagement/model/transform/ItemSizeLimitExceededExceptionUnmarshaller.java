...
public class ItemSizeLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TypeName", targetDepth)) {
                    context.nextToken();
                    itemSizeLimitExceededException.setTypeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ItemSizeLimitExceededExceptionUnmarshaller instance;

    public static ItemSizeLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ItemSizeLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
