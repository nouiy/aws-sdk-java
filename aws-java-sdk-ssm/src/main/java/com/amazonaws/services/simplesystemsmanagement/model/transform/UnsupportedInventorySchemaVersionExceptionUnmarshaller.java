...
public class UnsupportedInventorySchemaVersionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedInventorySchemaVersionExceptionUnmarshaller instance;

    public static UnsupportedInventorySchemaVersionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedInventorySchemaVersionExceptionUnmarshaller();
        return instance;
    }
}
