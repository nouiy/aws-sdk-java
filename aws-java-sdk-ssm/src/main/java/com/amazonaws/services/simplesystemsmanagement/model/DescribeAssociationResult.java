...
public class DescribeAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAssociationResult == false)
            return false;
        DescribeAssociationResult other = (DescribeAssociationResult) obj;
    ...
    public DescribeAssociationResult clone() {
        try {
            return (DescribeAssociationResult) super.clone();
