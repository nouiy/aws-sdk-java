...
public class InvalidScheduleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidScheduleException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidScheduleException;
    }

    private static InvalidScheduleExceptionUnmarshaller instance;

    public static InvalidScheduleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidScheduleExceptionUnmarshaller();
        return instance;
    }
}
