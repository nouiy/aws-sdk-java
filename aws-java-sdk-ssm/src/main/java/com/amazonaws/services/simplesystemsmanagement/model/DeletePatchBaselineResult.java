...
public class DeletePatchBaselineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePatchBaselineResult == false)
            return false;
        DeletePatchBaselineResult other = (DeletePatchBaselineResult) obj;
    ...
    public DeletePatchBaselineResult clone() {
        try {
            return (DeletePatchBaselineResult) super.clone();
