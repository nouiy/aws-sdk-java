...
@SdkInternalApi
public class ListComplianceSummariesRequestMarshaller {
    ...
    private static final ListComplianceSummariesRequestMarshaller instance = new ListComplianceSummariesRequestMarshaller();

    public static ListComplianceSummariesRequestMarshaller getInstance() {
        return instance;
    }
