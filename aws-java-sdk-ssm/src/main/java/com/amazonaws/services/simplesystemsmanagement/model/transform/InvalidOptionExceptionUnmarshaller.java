...
public class InvalidOptionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidOptionExceptionUnmarshaller instance;

    public static InvalidOptionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidOptionExceptionUnmarshaller();
        return instance;
    }
}
