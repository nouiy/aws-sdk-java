...
public class UnsupportedOperatingSystemExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.UnsupportedOperatingSystemException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return unsupportedOperatingSystemException;
    }

    private static UnsupportedOperatingSystemExceptionUnmarshaller instance;

    public static UnsupportedOperatingSystemExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedOperatingSystemExceptionUnmarshaller();
        return instance;
    }
}
