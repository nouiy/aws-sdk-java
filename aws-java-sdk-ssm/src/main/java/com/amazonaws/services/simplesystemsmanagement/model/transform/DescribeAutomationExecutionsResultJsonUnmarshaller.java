...
/**
 * DescribeAutomationExecutionsResult JSON Unmarshaller
 */
...
public class DescribeAutomationExecutionsResultJsonUnmarshaller implements Unmarshaller<DescribeAutomationExecutionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeAutomationExecutionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static DescribeAutomationExecutionsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeAutomationExecutionsResultJsonUnmarshaller();
        return instance;
    }
}
