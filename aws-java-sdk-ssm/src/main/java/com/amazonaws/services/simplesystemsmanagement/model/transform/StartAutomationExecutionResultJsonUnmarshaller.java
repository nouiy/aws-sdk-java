...
/**
 * StartAutomationExecutionResult JSON Unmarshaller
 */
...
public class StartAutomationExecutionResultJsonUnmarshaller implements Unmarshaller<StartAutomationExecutionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AutomationExecutionId", targetDepth)) {
                    context.nextToken();
                    startAutomationExecutionResult.setAutomationExecutionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static StartAutomationExecutionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StartAutomationExecutionResultJsonUnmarshaller();
        return instance;
    }
}
