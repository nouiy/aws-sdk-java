...
@SdkInternalApi
public class PatchFilterMarshaller {
    ...
    private static final PatchFilterMarshaller instance = new PatchFilterMarshaller();

    public static PatchFilterMarshaller getInstance() {
        return instance;
    }
