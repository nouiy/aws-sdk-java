...
public class InvocationDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvocationDoesNotExistException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invocationDoesNotExistException;
    }

    private static InvocationDoesNotExistExceptionUnmarshaller instance;

    public static InvocationDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvocationDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
