...
public class ParameterPatternMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ParameterPatternMismatchExceptionUnmarshaller instance;

    public static ParameterPatternMismatchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterPatternMismatchExceptionUnmarshaller();
        return instance;
    }
}
