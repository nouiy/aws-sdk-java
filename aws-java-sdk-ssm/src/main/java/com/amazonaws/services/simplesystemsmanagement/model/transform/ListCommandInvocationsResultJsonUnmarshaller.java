...
public class ListCommandInvocationsResultJsonUnmarshaller implements Unmarshaller<ListCommandInvocationsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listCommandInvocationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ListCommandInvocationsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListCommandInvocationsResultJsonUnmarshaller();
        return instance;
    }
}
