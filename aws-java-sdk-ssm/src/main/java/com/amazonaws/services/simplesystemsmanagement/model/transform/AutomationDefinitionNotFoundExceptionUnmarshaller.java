...
public class AutomationDefinitionNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AutomationDefinitionNotFoundExceptionUnmarshaller instance;

    public static AutomationDefinitionNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutomationDefinitionNotFoundExceptionUnmarshaller();
        return instance;
    }
}
