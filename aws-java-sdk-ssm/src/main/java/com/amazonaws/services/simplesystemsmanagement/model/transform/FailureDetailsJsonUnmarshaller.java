        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FailureStage", targetDepth)) {
                    context.nextToken();
                    failureDetails.setFailureStage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FailureType", targetDepth)) {
                    context.nextToken();
                    failureDetails.setFailureType(context.getUnmarshaller(String.class).unmarshall(context));
                }
