...
public class S3OutputUrlJsonUnmarshaller implements Unmarshaller<S3OutputUrl, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OutputUrl", targetDepth)) {
                    context.nextToken();
                    s3OutputUrl.setOutputUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
