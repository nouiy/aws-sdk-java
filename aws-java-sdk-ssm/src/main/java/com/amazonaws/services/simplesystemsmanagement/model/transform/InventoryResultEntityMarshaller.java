...
@SdkInternalApi
public class InventoryResultEntityMarshaller {
    ...
    private static final InventoryResultEntityMarshaller instance = new InventoryResultEntityMarshaller();

    public static InventoryResultEntityMarshaller getInstance() {
        return instance;
    }
