...
public class AutomationExecutionNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AutomationExecutionNotFoundExceptionUnmarshaller instance;

    public static AutomationExecutionNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AutomationExecutionNotFoundExceptionUnmarshaller();
        return instance;
    }
}
