...
public class PatchFilterGroupMarshaller {
    ...
    private static final MarshallingInfo<List> PATCHFILTERS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("PatchFilters").build();
    ...
    public void marshall(PatchFilterGroup patchFilterGroup, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(patchFilterGroup.getPatchFilters(), PATCHFILTERS_BINDING);
        } catch (Exception e) {
