...
public class GetMaintenanceWindowExecutionTaskInvocationRequestMarshaller {
    ...
    private static final GetMaintenanceWindowExecutionTaskInvocationRequestMarshaller instance = new GetMaintenanceWindowExecutionTaskInvocationRequestMarshaller();

    public static GetMaintenanceWindowExecutionTaskInvocationRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetMaintenanceWindowExecutionTaskInvocationRequest getMaintenanceWindowExecutionTaskInvocationRequest,
        ...
        try {
            protocolMarshaller.marshall(getMaintenanceWindowExecutionTaskInvocationRequest.getWindowExecutionId(), WINDOWEXECUTIONID_BINDING);
            protocolMarshaller.marshall(getMaintenanceWindowExecutionTaskInvocationRequest.getTaskId(), TASKID_BINDING);
            protocolMarshaller.marshall(getMaintenanceWindowExecutionTaskInvocationRequest.getInvocationId(), INVOCATIONID_BINDING);
        } catch (Exception e) {
