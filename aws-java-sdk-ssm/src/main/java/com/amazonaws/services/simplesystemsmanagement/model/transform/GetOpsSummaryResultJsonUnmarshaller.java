...
/**
 * GetOpsSummaryResult JSON Unmarshaller
 */
...
public class GetOpsSummaryResultJsonUnmarshaller implements Unmarshaller<GetOpsSummaryResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    getOpsSummaryResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static GetOpsSummaryResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetOpsSummaryResultJsonUnmarshaller();
        return instance;
    }
}
