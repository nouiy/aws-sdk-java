...
public class InvalidPolicyTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidPolicyTypeExceptionUnmarshaller instance;

    public static InvalidPolicyTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidPolicyTypeExceptionUnmarshaller();
        return instance;
    }
}
