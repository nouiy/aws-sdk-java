...
public class InvalidAllowedPatternExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAllowedPatternExceptionUnmarshaller instance;

    public static InvalidAllowedPatternExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAllowedPatternExceptionUnmarshaller();
        return instance;
    }
}
