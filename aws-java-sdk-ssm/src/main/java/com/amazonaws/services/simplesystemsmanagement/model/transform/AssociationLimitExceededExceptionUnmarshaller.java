...
public class AssociationLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.AssociationLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return associationLimitExceededException;
    }

    private static AssociationLimitExceededExceptionUnmarshaller instance;

    public static AssociationLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssociationLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
