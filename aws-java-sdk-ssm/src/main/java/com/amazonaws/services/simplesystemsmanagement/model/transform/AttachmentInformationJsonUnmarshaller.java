...
/**
 * AttachmentInformation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AttachmentInformationJsonUnmarshaller implements Unmarshaller<AttachmentInformation, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    attachmentInformation.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
