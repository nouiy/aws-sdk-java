...
public class ResourceDataSyncNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SyncName", targetDepth)) {
                    context.nextToken();
                    resourceDataSyncNotFoundException.setSyncName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SyncType", targetDepth)) {
                    context.nextToken();
                    resourceDataSyncNotFoundException.setSyncType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ResourceDataSyncNotFoundExceptionUnmarshaller instance;

    public static ResourceDataSyncNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncNotFoundExceptionUnmarshaller();
        return instance;
    }
}
