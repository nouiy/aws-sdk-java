...
public class InvalidUpdateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidUpdateExceptionUnmarshaller instance;

    public static InvalidUpdateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidUpdateExceptionUnmarshaller();
        return instance;
    }
}
