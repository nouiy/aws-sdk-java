...
public class ListAssociationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * the <code>InstanceID</code> attribute. Associations targeting the managed node that are part of the Target
     * Attributes <code>ResourceGroup</code> or <code>Tags</code> aren't returned.
     * </p>
     * </note>
     */
     ...
     *         created using the <code>InstanceID</code> attribute. Associations targeting the managed node that are
     *         part of the Target Attributes <code>ResourceGroup</code> or <code>Tags</code> aren't returned.
     *         </p>
     */
     ...
     *        <p>
     *        Filtering associations using the <code>InstanceID</code> attribute only returns legacy associations
     *        created using the <code>InstanceID</code> attribute. Associations targeting the managed node that are part
     *        of the Target Attributes <code>ResourceGroup</code> or <code>Tags</code> aren't returned.
     *        </p>
     */
