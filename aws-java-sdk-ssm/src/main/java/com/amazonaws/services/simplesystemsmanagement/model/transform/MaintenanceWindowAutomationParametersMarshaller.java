...
public class MaintenanceWindowAutomationParametersMarshaller {
    ...
    public void marshall(MaintenanceWindowAutomationParameters maintenanceWindowAutomationParameters, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(maintenanceWindowAutomationParameters.getDocumentVersion(), DOCUMENTVERSION_BINDING);
            protocolMarshaller.marshall(maintenanceWindowAutomationParameters.getParameters(), PARAMETERS_BINDING);
        } catch (Exception e) {
