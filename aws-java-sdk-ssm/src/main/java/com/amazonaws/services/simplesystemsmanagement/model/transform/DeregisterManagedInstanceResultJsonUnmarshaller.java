...
/**
 * DeregisterManagedInstanceResult JSON Unmarshaller
 */
...
public class DeregisterManagedInstanceResultJsonUnmarshaller implements Unmarshaller<DeregisterManagedInstanceResult, JsonUnmarshallerContext> {
    ...
    public DeregisterManagedInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterManagedInstanceResult deregisterManagedInstanceResult = new DeregisterManagedInstanceResult();
