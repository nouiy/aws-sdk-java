...
public class PatchBaselineIdentityJsonUnmarshaller implements Unmarshaller<PatchBaselineIdentity, JsonUnmarshallerContext> {
    ...
    public static PatchBaselineIdentityJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PatchBaselineIdentityJsonUnmarshaller();
        return instance;
    }
}
