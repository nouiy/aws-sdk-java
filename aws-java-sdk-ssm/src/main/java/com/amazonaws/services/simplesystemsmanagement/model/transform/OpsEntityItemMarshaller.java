...
public class OpsEntityItemMarshaller {
    ...
    private static final OpsEntityItemMarshaller instance = new OpsEntityItemMarshaller();

    public static OpsEntityItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OpsEntityItem opsEntityItem, ProtocolMarshaller protocolMarshaller) {

        if (opsEntityItem == null) {
