...
@SdkInternalApi
public class ServiceSettingMarshaller {
    ...
    private static final ServiceSettingMarshaller instance = new ServiceSettingMarshaller();

    public static ServiceSettingMarshaller getInstance() {
        return instance;
    }
