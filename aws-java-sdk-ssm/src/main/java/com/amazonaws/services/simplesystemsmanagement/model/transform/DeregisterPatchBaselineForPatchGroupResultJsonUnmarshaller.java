...
/**
 * DeregisterPatchBaselineForPatchGroupResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeregisterPatchBaselineForPatchGroupResultJsonUnmarshaller implements
        Unmarshaller<DeregisterPatchBaselineForPatchGroupResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BaselineId", targetDepth)) {
                    context.nextToken();
                    deregisterPatchBaselineForPatchGroupResult.setBaselineId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("PatchGroup", targetDepth)) {
                    context.nextToken();
                    deregisterPatchBaselineForPatchGroupResult.setPatchGroup(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static DeregisterPatchBaselineForPatchGroupResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeregisterPatchBaselineForPatchGroupResultJsonUnmarshaller();
        return instance;
    }
}
