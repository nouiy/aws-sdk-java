...
public class InvalidItemContentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TypeName", targetDepth)) {
                    context.nextToken();
                    invalidItemContentException.setTypeName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidItemContentExceptionUnmarshaller instance;

    public static InvalidItemContentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidItemContentExceptionUnmarshaller();
        return instance;
    }
}
