...
@SdkInternalApi
public class GetParameterRequestMarshaller {
    ...
    private static final GetParameterRequestMarshaller instance = new GetParameterRequestMarshaller();

    public static GetParameterRequestMarshaller getInstance() {
        return instance;
    }
