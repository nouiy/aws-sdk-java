...
@SdkInternalApi
public class DescribeActivationsFilterMarshaller {
    ...
    private static final DescribeActivationsFilterMarshaller instance = new DescribeActivationsFilterMarshaller();

    public static DescribeActivationsFilterMarshaller getInstance() {
        return instance;
    }
