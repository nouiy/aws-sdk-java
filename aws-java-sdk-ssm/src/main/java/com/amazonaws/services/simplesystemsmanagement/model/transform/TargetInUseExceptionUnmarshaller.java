...
public class TargetInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TargetInUseExceptionUnmarshaller instance;

    public static TargetInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TargetInUseExceptionUnmarshaller();
        return instance;
    }
}
