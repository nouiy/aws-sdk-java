...
public class ResourceDataSyncAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SyncName", targetDepth)) {
                    context.nextToken();
                    resourceDataSyncAlreadyExistsException.setSyncName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ResourceDataSyncAlreadyExistsExceptionUnmarshaller instance;

    public static ResourceDataSyncAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceDataSyncAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
