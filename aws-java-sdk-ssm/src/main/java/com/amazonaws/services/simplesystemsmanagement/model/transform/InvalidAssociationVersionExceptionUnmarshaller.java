...
public class InvalidAssociationVersionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidAssociationVersionException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        return invalidAssociationVersionException;
    }

    private static InvalidAssociationVersionExceptionUnmarshaller instance;

    public static InvalidAssociationVersionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAssociationVersionExceptionUnmarshaller();
        return instance;
    }
}
