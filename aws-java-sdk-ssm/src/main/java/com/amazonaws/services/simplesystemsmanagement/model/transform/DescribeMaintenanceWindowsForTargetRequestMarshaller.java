...
/**
 * DescribeMaintenanceWindowsForTargetRequestMarshaller
 */
...
public class DescribeMaintenanceWindowsForTargetRequestMarshaller {
    ...
    private static final DescribeMaintenanceWindowsForTargetRequestMarshaller instance = new DescribeMaintenanceWindowsForTargetRequestMarshaller();

    public static DescribeMaintenanceWindowsForTargetRequestMarshaller getInstance() {
        return instance;
    }
