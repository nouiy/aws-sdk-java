...
/**
 * AttachmentsSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AttachmentsSourceJsonUnmarshaller implements Unmarshaller<AttachmentsSource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    attachmentsSource.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    attachmentsSource.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
