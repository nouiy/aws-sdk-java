...
/**
 * DisassociateOpsItemRelatedItemResult JSON Unmarshaller
 */
...
public class DisassociateOpsItemRelatedItemResultJsonUnmarshaller implements Unmarshaller<DisassociateOpsItemRelatedItemResult, JsonUnmarshallerContext> {
    ...
    public DisassociateOpsItemRelatedItemResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateOpsItemRelatedItemResult disassociateOpsItemRelatedItemResult = new DisassociateOpsItemRelatedItemResult();

        return disassociateOpsItemRelatedItemResult;
    }
