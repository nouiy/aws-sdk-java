...
/**
 * InventoryGroup JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InventoryGroupJsonUnmarshaller implements Unmarshaller<InventoryGroup, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    inventoryGroup.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static InventoryGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new InventoryGroupJsonUnmarshaller();
        return instance;
    }
}
