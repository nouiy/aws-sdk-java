...
public class PatchRuleGroupMarshaller {
    ...
    private static final MarshallingInfo<List> PATCHRULES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("PatchRules").build();
    ...
    public void marshall(PatchRuleGroup patchRuleGroup, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(patchRuleGroup.getPatchRules(), PATCHRULES_BINDING);
        } catch (Exception e) {
