...
/**
 * SendAutomationSignalResult JSON Unmarshaller
 */
...
public class SendAutomationSignalResultJsonUnmarshaller implements Unmarshaller<SendAutomationSignalResult, JsonUnmarshallerContext> {
    ...
    public SendAutomationSignalResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SendAutomationSignalResult sendAutomationSignalResult = new SendAutomationSignalResult();
