...
public class AssociatedInstancesExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AssociatedInstancesExceptionUnmarshaller instance;

    public static AssociatedInstancesExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssociatedInstancesExceptionUnmarshaller();
        return instance;
    }
}
