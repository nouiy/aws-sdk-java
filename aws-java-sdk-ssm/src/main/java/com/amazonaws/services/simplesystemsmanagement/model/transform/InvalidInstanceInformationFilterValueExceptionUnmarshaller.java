...
public class InvalidInstanceInformationFilterValueExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simplesystemsmanagement.model.InvalidInstanceInformationFilterValueException unmarshallFromContext(
        ...
        return invalidInstanceInformationFilterValueException;
    }

    private static InvalidInstanceInformationFilterValueExceptionUnmarshaller instance;

    public static InvalidInstanceInformationFilterValueExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidInstanceInformationFilterValueExceptionUnmarshaller();
        return instance;
    }
}
