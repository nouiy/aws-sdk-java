...
/**
 * TargetLocation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TargetLocationJsonUnmarshaller implements Unmarshaller<TargetLocation, JsonUnmarshallerContext> {

    public TargetLocation unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static TargetLocationJsonUnmarshaller instance;

    public static TargetLocationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TargetLocationJsonUnmarshaller();
        return instance;
    }
}
