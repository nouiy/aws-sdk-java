...
public class DescribeInstancePatchStatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeInstancePatchStatesResult withInstancePatchStates(java.util.Collection<InstancePatchState> instancePatchStates) {
    ...
    @Override
    public DescribeInstancePatchStatesResult clone() {
        try {
