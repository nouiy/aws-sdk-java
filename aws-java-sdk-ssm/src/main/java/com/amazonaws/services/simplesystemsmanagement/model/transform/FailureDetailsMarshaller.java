...
public class FailureDetailsMarshaller {
    ...
    private static final MarshallingInfo<String> FAILURESTAGE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("FailureStage").build();
    ...
    public void marshall(FailureDetails failureDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(failureDetails.getFailureStage(), FAILURESTAGE_BINDING);
            protocolMarshaller.marshall(failureDetails.getFailureType(), FAILURETYPE_BINDING);
            protocolMarshaller.marshall(failureDetails.getDetails(), DETAILS_BINDING);
        } catch (Exception e) {
