...
public class CustomSchemaCountLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CustomSchemaCountLimitExceededExceptionUnmarshaller instance;

    public static CustomSchemaCountLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomSchemaCountLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
