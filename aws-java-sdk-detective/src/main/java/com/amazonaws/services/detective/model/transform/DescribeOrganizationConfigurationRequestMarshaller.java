...
/**
 * DescribeOrganizationConfigurationRequestMarshaller
 */
...
public class DescribeOrganizationConfigurationRequestMarshaller {
    ...
    public static DescribeOrganizationConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeOrganizationConfigurationRequest describeOrganizationConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeOrganizationConfigurationRequest.getGraphArn(), GRAPHARN_BINDING);
        } catch (Exception e) {
