...
public class RejectInvitationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param graphArn
     *        The ARN of the behavior graph to reject the invitation to.</p>
     *        <p>
     *        The member account's current member status in the behavior graph must be <code>INVITED</code>.
     */
     ...
     * </p>
     * 
     * @return The ARN of the behavior graph to reject the invitation to.</p>
     *         <p>
     *         The member account's current member status in the behavior graph must be <code>INVITED</code>.
     */
    ...
    public RejectInvitationRequest withGraphArn(String graphArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectInvitationRequest == false)
            return false;
        RejectInvitationRequest other = (RejectInvitationRequest) obj;
