...
/**
 * StartMonitoringMemberResult JSON Unmarshaller
 */
...
public class StartMonitoringMemberResultJsonUnmarshaller implements Unmarshaller<StartMonitoringMemberResult, JsonUnmarshallerContext> {
    ...
    public StartMonitoringMemberResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartMonitoringMemberResult startMonitoringMemberResult = new StartMonitoringMemberResult();

        return startMonitoringMemberResult;
    }
