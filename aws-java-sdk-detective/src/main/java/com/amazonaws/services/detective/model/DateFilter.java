 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/detective-2018-10-26/DateFilter" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DateFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getStartInclusive() != null)
            sb.append("StartInclusive: ").append(getStartInclusive()).append(",");
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.detective.model.transform.DateFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
