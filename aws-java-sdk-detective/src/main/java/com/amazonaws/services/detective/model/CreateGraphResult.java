...
public class CreateGraphResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateGraphResult == false)
            return false;
        CreateGraphResult other = (CreateGraphResult) obj;
    ...
    public CreateGraphResult clone() {
        try {
            return (CreateGraphResult) super.clone();
