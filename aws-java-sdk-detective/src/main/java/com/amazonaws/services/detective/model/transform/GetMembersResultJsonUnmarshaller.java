        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MemberDetails", targetDepth)) {
                    context.nextToken();
                    getMembersResult.setMemberDetails(new ListUnmarshaller<MemberDetail>(MemberDetailJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("UnprocessedAccounts", targetDepth)) {
                    context.nextToken();
                    getMembersResult.setUnprocessedAccounts(new ListUnmarshaller<UnprocessedAccount>(UnprocessedAccountJsonUnmarshaller.getInstance())
