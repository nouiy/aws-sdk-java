...
/**
 * EgressEndpointMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EgressEndpointMarshaller {
    ...
    private static final EgressEndpointMarshaller instance = new EgressEndpointMarshaller();

    public static EgressEndpointMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EgressEndpoint egressEndpoint, ProtocolMarshaller protocolMarshaller) {
