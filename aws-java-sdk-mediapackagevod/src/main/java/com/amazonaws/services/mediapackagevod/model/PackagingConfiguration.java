 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackage-vod-2018-11-07/PackagingConfiguration"
...
public class PackagingConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public PackagingConfiguration withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see PackagingConfiguration#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PackagingConfiguration addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public PackagingConfiguration clearTagsEntries() {
        this.tags = null;
        return this;
    }
