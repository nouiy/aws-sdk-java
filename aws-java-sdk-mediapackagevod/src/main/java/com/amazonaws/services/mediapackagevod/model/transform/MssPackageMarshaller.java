...
public class MssPackageMarshaller {
    ...
    private static final MarshallingInfo<List> MSSMANIFESTS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("mssManifests").build();
    ...
    public void marshall(MssPackage mssPackage, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(mssPackage.getMssManifests(), MSSMANIFESTS_BINDING);
