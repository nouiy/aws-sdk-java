...
/**
 * EgressEndpoint JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EgressEndpointJsonUnmarshaller implements Unmarshaller<EgressEndpoint, JsonUnmarshallerContext> {
    ...
    public static EgressEndpointJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EgressEndpointJsonUnmarshaller();
        return instance;
    }
}
