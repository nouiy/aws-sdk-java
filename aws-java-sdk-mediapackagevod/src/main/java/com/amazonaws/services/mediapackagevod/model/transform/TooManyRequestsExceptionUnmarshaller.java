...
public class TooManyRequestsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyRequestsExceptionUnmarshaller() {
        super(com.amazonaws.services.mediapackagevod.model.TooManyRequestsException.class, "TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.mediapackagevod.model.TooManyRequestsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mediapackagevod.model.TooManyRequestsException tooManyRequestsException = new com.amazonaws.services.mediapackagevod.model.TooManyRequestsException(
                null);
