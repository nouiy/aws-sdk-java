...
/**
 * ListPackagingConfigurationsResult JSON Unmarshaller
 */
...
public class ListPackagingConfigurationsResultJsonUnmarshaller implements Unmarshaller<ListPackagingConfigurationsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listPackagingConfigurationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ListPackagingConfigurationsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListPackagingConfigurationsResultJsonUnmarshaller();
        return instance;
    }
}
