...
/**
 * ListPackagingGroupsResult JSON Unmarshaller
 */
...
public class ListPackagingGroupsResultJsonUnmarshaller implements Unmarshaller<ListPackagingGroupsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listPackagingGroupsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ListPackagingGroupsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListPackagingGroupsResultJsonUnmarshaller();
        return instance;
    }
}
