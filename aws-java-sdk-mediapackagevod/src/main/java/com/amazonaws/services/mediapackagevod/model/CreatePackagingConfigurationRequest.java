...
public class CreatePackagingConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreatePackagingConfigurationRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreatePackagingConfigurationRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreatePackagingConfigurationRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreatePackagingConfigurationRequest clearTagsEntries() {
        this.tags = null;
        return this;
    }
