...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.mediapackagevod.model.InternalServerErrorException.class, "InternalServerErrorException");
    }

    @Override
    public com.amazonaws.services.mediapackagevod.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mediapackagevod.model.InternalServerErrorException internalServerErrorException = new com.amazonaws.services.mediapackagevod.model.InternalServerErrorException(
                null);
