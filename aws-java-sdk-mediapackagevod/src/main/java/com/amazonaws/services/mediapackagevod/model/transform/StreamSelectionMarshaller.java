...
public class StreamSelectionMarshaller {
    ...
    private static final MarshallingInfo<Integer> MAXVIDEOBITSPERSECOND_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("maxVideoBitsPerSecond").build();
    private static final MarshallingInfo<Integer> MINVIDEOBITSPERSECOND_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("minVideoBitsPerSecond").build();
