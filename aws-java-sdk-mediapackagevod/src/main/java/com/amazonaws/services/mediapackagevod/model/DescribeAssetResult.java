...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackage-vod-2018-11-07/DescribeAsset" target="_top">AWS API
 *      Documentation</a>
 */
...
public class DescribeAssetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAssetResult withEgressEndpoints(java.util.Collection<EgressEndpoint> egressEndpoints) {
    ...
    public DescribeAssetResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeAssetResult#withTags
