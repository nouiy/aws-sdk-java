...
/**
 * MssManifestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MssManifestMarshaller {
    ...
    private static final MssManifestMarshaller instance = new MssManifestMarshaller();

    public static MssManifestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MssManifest mssManifest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(mssManifest.getManifestName(), MANIFESTNAME_BINDING);
            protocolMarshaller.marshall(mssManifest.getStreamSelection(), STREAMSELECTION_BINDING);
        } catch (Exception e) {
