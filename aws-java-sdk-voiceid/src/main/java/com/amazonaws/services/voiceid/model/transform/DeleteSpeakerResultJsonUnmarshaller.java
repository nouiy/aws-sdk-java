...
/**
 * DeleteSpeakerResult JSON Unmarshaller
 */
...
public class DeleteSpeakerResultJsonUnmarshaller implements Unmarshaller<DeleteSpeakerResult, JsonUnmarshallerContext> {
    ...
    public DeleteSpeakerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSpeakerResult deleteSpeakerResult = new DeleteSpeakerResult();
