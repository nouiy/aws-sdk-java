...
/**
 * FraudDetectionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FraudDetectionResultJsonUnmarshaller implements Unmarshaller<FraudDetectionResult, JsonUnmarshallerContext> {

    public FraudDetectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FraudDetectionResultJsonUnmarshaller instance;

    public static FraudDetectionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FraudDetectionResultJsonUnmarshaller();
        return instance;
    }
}
