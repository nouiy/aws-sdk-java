 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/voice-id-2021-09-27/SpeakerSummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpeakerSummary implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A timestamp showing the speaker's creation time.
     */
    ...
    public SpeakerSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public SpeakerSummary withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SpeakerSummary == false)
            return false;
    ...
    public SpeakerSummary clone() {
        try {
            return (SpeakerSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.voiceid.model.transform.SpeakerSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
