...
public class CreateWatchlistResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the newly created watchlist.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateWatchlistResult == false)
            return false;
        CreateWatchlistResult other = (CreateWatchlistResult) obj;
    ...
    public CreateWatchlistResult clone() {
        try {
            return (CreateWatchlistResult) super.clone();
