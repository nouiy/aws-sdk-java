...
public class DescribeSpeakerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the specified speaker.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSpeakerResult == false)
            return false;
        DescribeSpeakerResult other = (DescribeSpeakerResult) obj;
    ...
    public DescribeSpeakerResult clone() {
        try {
            return (DescribeSpeakerResult) super.clone();
