...
/**
 * DocumentAttributeConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DocumentAttributeConfigurationMarshaller {
    ...
    public static DocumentAttributeConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DocumentAttributeConfiguration documentAttributeConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (documentAttributeConfiguration == null) {
