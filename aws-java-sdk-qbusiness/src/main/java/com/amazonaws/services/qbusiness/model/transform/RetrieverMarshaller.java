...
@SdkInternalApi
public class RetrieverMarshaller {
    ...
    public static RetrieverMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Retriever retriever, ProtocolMarshaller protocolMarshaller) {
