...
/**
 * InlineDocumentEnrichmentConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InlineDocumentEnrichmentConfigurationMarshaller {
    ...
    public static InlineDocumentEnrichmentConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InlineDocumentEnrichmentConfiguration inlineDocumentEnrichmentConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (inlineDocumentEnrichmentConfiguration == null) {
