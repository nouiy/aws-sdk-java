...
public class TopicConfigurationMarshaller {
    ...
    private static final TopicConfigurationMarshaller instance = new TopicConfigurationMarshaller();

    public static TopicConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TopicConfiguration topicConfiguration, ProtocolMarshaller protocolMarshaller) {
