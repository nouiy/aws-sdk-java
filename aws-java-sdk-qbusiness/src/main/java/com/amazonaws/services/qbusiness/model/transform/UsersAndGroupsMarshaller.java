...
public class UsersAndGroupsMarshaller {
    ...
    public static UsersAndGroupsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UsersAndGroups usersAndGroups, ProtocolMarshaller protocolMarshaller) {
