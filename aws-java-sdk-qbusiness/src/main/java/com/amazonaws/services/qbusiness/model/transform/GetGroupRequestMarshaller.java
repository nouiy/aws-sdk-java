...
public class GetGroupRequestMarshaller {
    ...
    public void marshall(GetGroupRequest getGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getGroupRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(getGroupRequest.getDataSourceId(), DATASOURCEID_BINDING);
            protocolMarshaller.marshall(getGroupRequest.getGroupName(), GROUPNAME_BINDING);
            protocolMarshaller.marshall(getGroupRequest.getIndexId(), INDEXID_BINDING);
        } catch (Exception e) {
