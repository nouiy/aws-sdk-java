...
/**
 * Retriever JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RetrieverJsonUnmarshaller implements Unmarshaller<Retriever, JsonUnmarshallerContext> {

    public Retriever unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static RetrieverJsonUnmarshaller instance;

    public static RetrieverJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RetrieverJsonUnmarshaller();
        return instance;
    }
}
