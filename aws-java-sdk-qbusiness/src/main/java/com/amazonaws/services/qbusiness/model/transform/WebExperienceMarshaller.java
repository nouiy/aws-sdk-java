...
public class WebExperienceMarshaller {
    ...
    public static WebExperienceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WebExperience webExperience, ProtocolMarshaller protocolMarshaller) {
