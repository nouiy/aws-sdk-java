...
public class ListIndicesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setIndices(java.util.Collection<Index> indices) {
        if (indices == null) {
            this.indices = null;
            return;
        }

        this.indices = new java.util.ArrayList<Index>(indices);
    }
     ...
     * {@link #setIndices(java.util.Collection)} or {@link #withIndices(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param indices
    ...
    public ListIndicesResult withIndices(Index... indices) {
        if (this.indices == null) {
            setIndices(new java.util.ArrayList<Index>(indices.length));
        }
        for (Index ele : indices) {
            this.indices.add(ele);
        }
        return this;
    }
    ...
    public ListIndicesResult withIndices(java.util.Collection<Index> indices) {
        setIndices(indices);
        return this;
    }
