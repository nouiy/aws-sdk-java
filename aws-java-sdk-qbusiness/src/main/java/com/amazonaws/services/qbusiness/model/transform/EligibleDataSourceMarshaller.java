...
public class EligibleDataSourceMarshaller {
    ...
    public static EligibleDataSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EligibleDataSource eligibleDataSource, ProtocolMarshaller protocolMarshaller) {

        if (eligibleDataSource == null) {
