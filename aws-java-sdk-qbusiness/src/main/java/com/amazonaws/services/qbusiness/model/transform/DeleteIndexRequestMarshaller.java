...
public class DeleteIndexRequestMarshaller {
    ...
    public void marshall(DeleteIndexRequest deleteIndexRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteIndexRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(deleteIndexRequest.getIndexId(), INDEXID_BINDING);
        } catch (Exception e) {
