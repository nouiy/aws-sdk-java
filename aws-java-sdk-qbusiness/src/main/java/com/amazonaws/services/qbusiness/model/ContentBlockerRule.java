...
public class ContentBlockerRule implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ContentBlockerRule == false)
            return false;
    ...
    @Override
    public ContentBlockerRule clone() {
        try {
            return (ContentBlockerRule) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.qbusiness.model.transform.ContentBlockerRuleMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
