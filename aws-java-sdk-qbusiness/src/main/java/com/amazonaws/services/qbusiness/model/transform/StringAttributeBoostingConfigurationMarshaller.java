...
/**
 * StringAttributeBoostingConfigurationMarshaller
 */
...
public class StringAttributeBoostingConfigurationMarshaller {
    ...
    public static StringAttributeBoostingConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StringAttributeBoostingConfiguration stringAttributeBoostingConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (stringAttributeBoostingConfiguration == null) {
