...
public class ModifyBackupAttributesRequestMarshaller {
    ...
    private static final ModifyBackupAttributesRequestMarshaller instance = new ModifyBackupAttributesRequestMarshaller();

    public static ModifyBackupAttributesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ModifyBackupAttributesRequest modifyBackupAttributesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(modifyBackupAttributesRequest.getBackupId(), BACKUPID_BINDING);
            protocolMarshaller.marshall(modifyBackupAttributesRequest.getNeverExpires(), NEVEREXPIRES_BINDING);
        } catch (Exception e) {
