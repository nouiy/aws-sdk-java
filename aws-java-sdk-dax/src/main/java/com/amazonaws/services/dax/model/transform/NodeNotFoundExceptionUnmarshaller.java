...
public class NodeNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NodeNotFoundExceptionUnmarshaller instance;

    public static NodeNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NodeNotFoundExceptionUnmarshaller();
        return instance;
    }
}
