...
public class UpdateBandwidthRateLimitResultJsonUnmarshaller implements Unmarshaller<UpdateBandwidthRateLimitResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    updateBandwidthRateLimitResult.setGatewayARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static UpdateBandwidthRateLimitResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateBandwidthRateLimitResultJsonUnmarshaller();
        return instance;
    }
}
