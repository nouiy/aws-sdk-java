...
public class VolumeRecoveryPointInfoMarshaller {
    ...
    private static final MarshallingInfo<String> VOLUMERECOVERYPOINTTIME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("VolumeRecoveryPointTime").build();
    ...
    public void marshall(VolumeRecoveryPointInfo volumeRecoveryPointInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(volumeRecoveryPointInfo.getVolumeARN(), VOLUMEARN_BINDING);
            protocolMarshaller.marshall(volumeRecoveryPointInfo.getVolumeSizeInBytes(), VOLUMESIZEINBYTES_BINDING);
            protocolMarshaller.marshall(volumeRecoveryPointInfo.getVolumeUsageInBytes(), VOLUMEUSAGEINBYTES_BINDING);
            protocolMarshaller.marshall(volumeRecoveryPointInfo.getVolumeRecoveryPointTime(), VOLUMERECOVERYPOINTTIME_BINDING);
        } catch (Exception e) {
