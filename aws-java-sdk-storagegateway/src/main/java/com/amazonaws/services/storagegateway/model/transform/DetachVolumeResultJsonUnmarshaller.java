...
/**
 * DetachVolumeResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DetachVolumeResultJsonUnmarshaller implements Unmarshaller<DetachVolumeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VolumeARN", targetDepth)) {
                    context.nextToken();
                    detachVolumeResult.setVolumeARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
