...
@SdkInternalApi
public class StartGatewayRequestMarshaller {
    ...
    private static final StartGatewayRequestMarshaller instance = new StartGatewayRequestMarshaller();

    public static StartGatewayRequestMarshaller getInstance() {
        return instance;
    }
