...
/**
 * Fluent builder for {@link com.amazonaws.services.storagegateway.AWSStorageGateway}. Use of the builder is preferred
 * over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AWSStorageGatewayClientBuilder extends AwsSyncClientBuilder<AWSStorageGatewayClientBuilder, AWSStorageGateway> {
    ...
    /**
     * Construct a synchronous implementation of AWSStorageGateway using the current builder configuration.
     *
     * @param params
