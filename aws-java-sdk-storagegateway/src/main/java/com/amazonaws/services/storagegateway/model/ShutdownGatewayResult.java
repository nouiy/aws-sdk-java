...
public class ShutdownGatewayResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ShutdownGatewayResult == false)
            return false;
        ShutdownGatewayResult other = (ShutdownGatewayResult) obj;
    ...
    public ShutdownGatewayResult clone() {
        try {
            return (ShutdownGatewayResult) super.clone();
