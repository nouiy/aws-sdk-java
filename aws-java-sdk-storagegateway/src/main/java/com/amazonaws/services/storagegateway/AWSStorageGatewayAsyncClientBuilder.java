...
/**
 * Fluent builder for {@link com.amazonaws.services.storagegateway.AWSStorageGatewayAsync}. Use of the builder is
 * preferred over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AWSStorageGatewayAsyncClientBuilder extends AwsAsyncClientBuilder<AWSStorageGatewayAsyncClientBuilder, AWSStorageGatewayAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSStorageGatewayAsync using the current builder configuration.
     *
     * @param params
