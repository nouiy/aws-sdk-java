...
/**
 * UpdateSMBFileShareResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateSMBFileShareResultJsonUnmarshaller implements Unmarshaller<UpdateSMBFileShareResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FileShareARN", targetDepth)) {
                    context.nextToken();
                    updateSMBFileShareResult.setFileShareARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
