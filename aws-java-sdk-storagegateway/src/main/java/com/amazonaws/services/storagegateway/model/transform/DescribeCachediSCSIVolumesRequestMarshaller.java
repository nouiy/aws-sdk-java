...
/**
 * DescribeCachediSCSIVolumesRequestMarshaller
 */
...
public class DescribeCachediSCSIVolumesRequestMarshaller {
    ...
    private static final DescribeCachediSCSIVolumesRequestMarshaller instance = new DescribeCachediSCSIVolumesRequestMarshaller();

    public static DescribeCachediSCSIVolumesRequestMarshaller getInstance() {
        return instance;
    }
