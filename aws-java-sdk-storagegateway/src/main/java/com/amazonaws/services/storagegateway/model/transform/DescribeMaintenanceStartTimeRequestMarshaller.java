...
/**
 * DescribeMaintenanceStartTimeRequestMarshaller
 */
...
public class DescribeMaintenanceStartTimeRequestMarshaller {
    ...
    private static final DescribeMaintenanceStartTimeRequestMarshaller instance = new DescribeMaintenanceStartTimeRequestMarshaller();

    public static DescribeMaintenanceStartTimeRequestMarshaller getInstance() {
        return instance;
    }
