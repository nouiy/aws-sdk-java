...
/**
 * CancelArchivalRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CancelArchivalRequestMarshaller {
    ...
    private static final CancelArchivalRequestMarshaller instance = new CancelArchivalRequestMarshaller();

    public static CancelArchivalRequestMarshaller getInstance() {
        return instance;
    }
