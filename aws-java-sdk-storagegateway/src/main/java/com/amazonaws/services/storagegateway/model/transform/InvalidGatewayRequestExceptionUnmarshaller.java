...
public class InvalidGatewayRequestExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidGatewayRequestExceptionUnmarshaller instance;

    public static InvalidGatewayRequestExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidGatewayRequestExceptionUnmarshaller();
        return instance;
    }
}
