...
public class DeleteTapePoolResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the custom tape pool being deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTapePoolResult == false)
            return false;
        DeleteTapePoolResult other = (DeleteTapePoolResult) obj;
    ...
    public DeleteTapePoolResult clone() {
        try {
            return (DeleteTapePoolResult) super.clone();
