...
public class SetLocalConsolePasswordResultJsonUnmarshaller implements Unmarshaller<SetLocalConsolePasswordResult, JsonUnmarshallerContext> {

    public SetLocalConsolePasswordResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("GatewayARN", targetDepth)) {
                    context.nextToken();
                    setLocalConsolePasswordResult.setGatewayARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
