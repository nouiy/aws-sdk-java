...
public class DescribeGatewayInformationRequestMarshaller {
    ...
    private static final DescribeGatewayInformationRequestMarshaller instance = new DescribeGatewayInformationRequestMarshaller();

    public static DescribeGatewayInformationRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DescribeGatewayInformationRequest describeGatewayInformationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeGatewayInformationRequest.getGatewayARN(), GATEWAYARN_BINDING);
        } catch (Exception e) {
