...
public class AssociateFileSystemResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the newly created file system association.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateFileSystemResult == false)
            return false;
        AssociateFileSystemResult other = (AssociateFileSystemResult) obj;
    ...
    public AssociateFileSystemResult clone() {
        try {
            return (AssociateFileSystemResult) super.clone();
