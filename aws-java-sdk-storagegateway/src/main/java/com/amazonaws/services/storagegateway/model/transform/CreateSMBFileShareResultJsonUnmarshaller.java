...
/**
 * CreateSMBFileShareResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateSMBFileShareResultJsonUnmarshaller implements Unmarshaller<CreateSMBFileShareResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FileShareARN", targetDepth)) {
                    context.nextToken();
                    createSMBFileShareResult.setFileShareARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
