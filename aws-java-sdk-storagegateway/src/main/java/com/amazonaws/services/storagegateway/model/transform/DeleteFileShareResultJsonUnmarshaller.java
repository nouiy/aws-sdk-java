...
/**
 * DeleteFileShareResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFileShareResultJsonUnmarshaller implements Unmarshaller<DeleteFileShareResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FileShareARN", targetDepth)) {
                    context.nextToken();
                    deleteFileShareResult.setFileShareARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
