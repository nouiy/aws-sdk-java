...
@SdkInternalApi
public class ListLocalDisksRequestMarshaller {
    ...
    private static final ListLocalDisksRequestMarshaller instance = new ListLocalDisksRequestMarshaller();

    public static ListLocalDisksRequestMarshaller getInstance() {
        return instance;
    }
