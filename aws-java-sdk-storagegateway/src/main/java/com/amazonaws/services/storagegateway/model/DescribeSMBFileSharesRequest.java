...
public class DescribeSMBFileSharesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeSMBFileSharesRequest withFileShareARNList(java.util.Collection<String> fileShareARNList) {
    ...
    @Override
    public DescribeSMBFileSharesRequest clone() {
        return (DescribeSMBFileSharesRequest) super.clone();
    }
