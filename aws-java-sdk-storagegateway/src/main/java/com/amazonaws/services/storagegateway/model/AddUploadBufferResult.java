...
public class AddUploadBufferResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddUploadBufferResult == false)
            return false;
    ...
    @Override
    public AddUploadBufferResult clone() {
        try {
            return (AddUploadBufferResult) super.clone();
