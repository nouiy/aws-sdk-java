...
public class AddWorkingStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddWorkingStorageResult == false)
            return false;
        AddWorkingStorageResult other = (AddWorkingStorageResult) obj;
    ...
    @Override
    public AddWorkingStorageResult clone() {
        try {
            return (AddWorkingStorageResult) super.clone();
