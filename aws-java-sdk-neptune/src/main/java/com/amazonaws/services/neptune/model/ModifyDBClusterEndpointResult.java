 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBClusterEndpoint" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModifyDBClusterEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyDBClusterEndpointResult withStaticMembers(java.util.Collection<String> staticMembers) {
    ...
    public ModifyDBClusterEndpointResult withExcludedMembers(java.util.Collection<String> excludedMembers) {
    ...
    @Override
    public ModifyDBClusterEndpointResult clone() {
        try {
            return (ModifyDBClusterEndpointResult) super.clone();
