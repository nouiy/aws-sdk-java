        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("maxAttempts", targetDepth)) {
                    context.nextToken();
                    retryPolicy.setMaxAttempts(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("maxFailedAttemptsPerHour", targetDepth)) {
                    context.nextToken();
                    retryPolicy.setMaxFailedAttemptsPerHour(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
