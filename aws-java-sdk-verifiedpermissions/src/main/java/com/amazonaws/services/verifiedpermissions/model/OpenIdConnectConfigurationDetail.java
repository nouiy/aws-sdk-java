 ...
 * >ConfigurationDetail</a> structure, which is a parameter to <a
 * href="https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_GetIdentitySource.html"
 * >GetIdentitySource</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectConfigurationDetail"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenIdConnectConfigurationDetail implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private OpenIdConnectGroupConfigurationDetail groupConfiguration;
    /**
     * <p>
     ...
     * </p>
     */
    private OpenIdConnectTokenSelectionDetail tokenSelection;
    ...
    public OpenIdConnectConfigurationDetail withIssuer(String issuer) {
        setIssuer(issuer);
        return this;
    }
    ...
    public OpenIdConnectConfigurationDetail withEntityIdPrefix(String entityIdPrefix) {
    ...
    public void setGroupConfiguration(OpenIdConnectGroupConfigurationDetail groupConfiguration) {
    ...
    public OpenIdConnectGroupConfigurationDetail getGroupConfiguration() {
    ...
    public OpenIdConnectConfigurationDetail withGroupConfiguration(OpenIdConnectGroupConfigurationDetail groupConfiguration) {
    ...
    public void setTokenSelection(OpenIdConnectTokenSelectionDetail tokenSelection) {
    ...
    public OpenIdConnectTokenSelectionDetail getTokenSelection() {
    ...
    public OpenIdConnectConfigurationDetail withTokenSelection(OpenIdConnectTokenSelectionDetail tokenSelection) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenIdConnectConfigurationDetail == false)
            return false;
        OpenIdConnectConfigurationDetail other = (OpenIdConnectConfigurationDetail) obj;
    ...
    @Override
    public OpenIdConnectConfigurationDetail clone() {
        try {
            return (OpenIdConnectConfigurationDetail) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.OpenIdConnectConfigurationDetailMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
