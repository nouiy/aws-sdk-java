 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectIdentityTokenConfigurationDetail"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenIdConnectIdentityTokenConfigurationDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenIdConnectIdentityTokenConfigurationDetail withClientIds(java.util.Collection<String> clientIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenIdConnectIdentityTokenConfigurationDetail == false)
            return false;
        OpenIdConnectIdentityTokenConfigurationDetail other = (OpenIdConnectIdentityTokenConfigurationDetail) obj;
    ...
    public OpenIdConnectIdentityTokenConfigurationDetail clone() {
        try {
            return (OpenIdConnectIdentityTokenConfigurationDetail) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.OpenIdConnectIdentityTokenConfigurationDetailMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
