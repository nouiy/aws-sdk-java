        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cognitoUserPoolConfiguration", targetDepth)) {
                    context.nextToken();
                    configurationItem.setCognitoUserPoolConfiguration(CognitoUserPoolConfigurationItemJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("openIdConnectConfiguration", targetDepth)) {
                    context.nextToken();
                    configurationItem.setOpenIdConnectConfiguration(OpenIdConnectConfigurationItemJsonUnmarshaller.getInstance().unmarshall(context));
                }
