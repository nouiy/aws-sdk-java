 ...
 * >CognitoUserPoolConfigurationItem</a> structure and is a response parameter to <a
 * href="http://forums.aws.amazon.com/verifiedpermissions/latest/apireference/API_ListIdentitySources.html"
 * >ListIdentitySources</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/CognitoGroupConfigurationItem"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CognitoGroupConfigurationItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CognitoGroupConfigurationItem == false)
            return false;
        CognitoGroupConfigurationItem other = (CognitoGroupConfigurationItem) obj;
    ...
    public CognitoGroupConfigurationItem clone() {
        try {
            return (CognitoGroupConfigurationItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.CognitoGroupConfigurationItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
