 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectAccessTokenConfigurationDetail"
...
public class OpenIdConnectAccessTokenConfigurationDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenIdConnectAccessTokenConfigurationDetail withPrincipalIdClaim(String principalIdClaim) {
    ...
    public OpenIdConnectAccessTokenConfigurationDetail withAudiences(String... audiences) {
    ...
    public OpenIdConnectAccessTokenConfigurationDetail withAudiences(java.util.Collection<String> audiences) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenIdConnectAccessTokenConfigurationDetail == false)
            return false;
    ...
    @Override
    public OpenIdConnectAccessTokenConfigurationDetail clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.OpenIdConnectAccessTokenConfigurationDetailMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
