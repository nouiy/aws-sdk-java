 ...
 * >ListIdentitySourcea</a>.
 * </p>
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectGroupConfigurationItem"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenIdConnectGroupConfigurationItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenIdConnectGroupConfigurationItem withGroupClaim(String groupClaim) {
    ...
    public OpenIdConnectGroupConfigurationItem withGroupEntityType(String groupEntityType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenIdConnectGroupConfigurationItem == false)
            return false;
        OpenIdConnectGroupConfigurationItem other = (OpenIdConnectGroupConfigurationItem) obj;
    ...
    @Override
    public OpenIdConnectGroupConfigurationItem clone() {
        try {
            return (OpenIdConnectGroupConfigurationItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.OpenIdConnectGroupConfigurationItemMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
