 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectTokenSelection"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenIdConnectTokenSelection implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private OpenIdConnectAccessTokenConfiguration accessTokenOnly;
    /**
     * <p>
     ...
     * </p>
     */
    private OpenIdConnectIdentityTokenConfiguration identityTokenOnly;
    ...
    public void setAccessTokenOnly(OpenIdConnectAccessTokenConfiguration accessTokenOnly) {
    ...
    public OpenIdConnectAccessTokenConfiguration getAccessTokenOnly() {
    ...
    public OpenIdConnectTokenSelection withAccessTokenOnly(OpenIdConnectAccessTokenConfiguration accessTokenOnly) {
    ...
    public void setIdentityTokenOnly(OpenIdConnectIdentityTokenConfiguration identityTokenOnly) {
    ...
    public OpenIdConnectIdentityTokenConfiguration getIdentityTokenOnly() {
    ...
    public OpenIdConnectTokenSelection withIdentityTokenOnly(OpenIdConnectIdentityTokenConfiguration identityTokenOnly) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenIdConnectTokenSelection == false)
            return false;
        OpenIdConnectTokenSelection other = (OpenIdConnectTokenSelection) obj;
    ...
    @Override
    public OpenIdConnectTokenSelection clone() {
        try {
            return (OpenIdConnectTokenSelection) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.OpenIdConnectTokenSelectionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
