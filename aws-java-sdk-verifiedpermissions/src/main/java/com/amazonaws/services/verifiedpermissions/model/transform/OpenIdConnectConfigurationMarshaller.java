...
/**
 * OpenIdConnectConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OpenIdConnectConfigurationMarshaller {
    ...
    private static final OpenIdConnectConfigurationMarshaller instance = new OpenIdConnectConfigurationMarshaller();

    public static OpenIdConnectConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OpenIdConnectConfiguration openIdConnectConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(openIdConnectConfiguration.getIssuer(), ISSUER_BINDING);
            protocolMarshaller.marshall(openIdConnectConfiguration.getEntityIdPrefix(), ENTITYIDPREFIX_BINDING);
            protocolMarshaller.marshall(openIdConnectConfiguration.getGroupConfiguration(), GROUPCONFIGURATION_BINDING);
            protocolMarshaller.marshall(openIdConnectConfiguration.getTokenSelection(), TOKENSELECTION_BINDING);
        } catch (Exception e) {
