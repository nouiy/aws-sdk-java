 ...
 * </p>
 * <p>
 * This data type is part of an <a href=
 * "https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_CognitoUserPoolConfigurationItem.html"
 * >CognitoUserPoolConfigurationDetail</a> structure and is a response parameter to <a
 * href="https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_GetIdentitySource.html"
 * >GetIdentitySource</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/CognitoGroupConfigurationDetail"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CognitoGroupConfigurationDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public CognitoGroupConfigurationDetail withGroupEntityType(String groupEntityType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CognitoGroupConfigurationDetail == false)
            return false;
        CognitoGroupConfigurationDetail other = (CognitoGroupConfigurationDetail) obj;
    ...
    @Override
    public CognitoGroupConfigurationDetail clone() {
        try {
            return (CognitoGroupConfigurationDetail) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.CognitoGroupConfigurationDetailMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
