 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/OpenIdConnectGroupConfigurationDetail"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenIdConnectGroupConfigurationDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    public OpenIdConnectGroupConfigurationDetail withGroupClaim(String groupClaim) {
    ...
    public OpenIdConnectGroupConfigurationDetail withGroupEntityType(String groupEntityType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenIdConnectGroupConfigurationDetail == false)
            return false;
        OpenIdConnectGroupConfigurationDetail other = (OpenIdConnectGroupConfigurationDetail) obj;
    ...
    @Override
    public OpenIdConnectGroupConfigurationDetail clone() {
        try {
            return (OpenIdConnectGroupConfigurationDetail) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.OpenIdConnectGroupConfigurationDetailMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
