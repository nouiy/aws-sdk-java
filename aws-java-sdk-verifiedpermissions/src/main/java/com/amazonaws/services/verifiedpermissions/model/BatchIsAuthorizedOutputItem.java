 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/verifiedpermissions-2021-12-01/BatchIsAuthorizedOutputItem"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchIsAuthorizedOutputItem implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchIsAuthorizedInputItem getRequest() {
        return this.request;
    }
    ...
    public BatchIsAuthorizedOutputItem withDeterminingPolicies(DeterminingPolicyItem... determiningPolicies) {
    ...
    public BatchIsAuthorizedOutputItem withDeterminingPolicies(java.util.Collection<DeterminingPolicyItem> determiningPolicies) {
    ...
    public BatchIsAuthorizedOutputItem withErrors(EvaluationErrorItem... errors) {
        if (this.errors == null) {
    ...
    public BatchIsAuthorizedOutputItem withErrors(java.util.Collection<EvaluationErrorItem> errors) {
        setErrors(errors);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchIsAuthorizedOutputItem == false)
            return false;
    ...
    public BatchIsAuthorizedOutputItem clone() {
        try {
            return (BatchIsAuthorizedOutputItem) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.verifiedpermissions.model.transform.BatchIsAuthorizedOutputItemMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
