...
/**
 * ReplaceableItem StAX Unmarshaller
 */
...
public class ReplaceableItemStaxUnmarshaller implements Unmarshaller<ReplaceableItem, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Attribute", targetDepth)) {
                    replaceableItem.withAttributes(ReplaceableAttributeStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static ReplaceableItemStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReplaceableItemStaxUnmarshaller();
        return instance;
    }
}
