...
/**
 * DeletableItem StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeletableItemStaxUnmarshaller implements Unmarshaller<DeletableItem, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ItemName", targetDepth)) {
                    deletableItem.setName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
