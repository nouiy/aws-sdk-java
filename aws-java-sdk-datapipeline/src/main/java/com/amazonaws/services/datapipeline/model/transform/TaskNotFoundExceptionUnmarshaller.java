...
public class TaskNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TaskNotFoundExceptionUnmarshaller instance;

    public static TaskNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TaskNotFoundExceptionUnmarshaller();
        return instance;
    }
}
