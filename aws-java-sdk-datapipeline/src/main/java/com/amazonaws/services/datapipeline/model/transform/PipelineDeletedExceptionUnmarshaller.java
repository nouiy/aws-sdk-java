...
public class PipelineDeletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PipelineDeletedExceptionUnmarshaller instance;

    public static PipelineDeletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PipelineDeletedExceptionUnmarshaller();
        return instance;
    }
}
