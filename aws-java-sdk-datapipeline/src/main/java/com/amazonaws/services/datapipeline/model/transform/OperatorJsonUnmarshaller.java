...
public class OperatorJsonUnmarshaller implements Unmarshaller<Operator, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("type", targetDepth)) {
                    context.nextToken();
                    operator.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static OperatorJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OperatorJsonUnmarshaller();
        return instance;
    }
}
