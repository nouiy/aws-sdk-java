...
public class TaskObjectMarshaller {
    ...
    private static final MarshallingInfo<String> ATTEMPTID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("attemptId").build();
    private static final MarshallingInfo<Map> OBJECTS_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
