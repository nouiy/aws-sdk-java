...
public class ParameterAttributeJsonUnmarshaller implements Unmarshaller<ParameterAttribute, JsonUnmarshallerContext> {
    ...
    public static ParameterAttributeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterAttributeJsonUnmarshaller();
        return instance;
    }
}
