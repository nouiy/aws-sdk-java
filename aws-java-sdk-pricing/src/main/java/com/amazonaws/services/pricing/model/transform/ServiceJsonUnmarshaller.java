        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ServiceCode", targetDepth)) {
                    context.nextToken();
                    service.setServiceCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("AttributeNames", targetDepth)) {
                    context.nextToken();
                    service.setAttributeNames(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
