...
public class GetProductsRequestMarshaller {
    ...
    public void marshall(GetProductsRequest getProductsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getProductsRequest.getServiceCode(), SERVICECODE_BINDING);
            protocolMarshaller.marshall(getProductsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(getProductsRequest.getFormatVersion(), FORMATVERSION_BINDING);
            protocolMarshaller.marshall(getProductsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(getProductsRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
