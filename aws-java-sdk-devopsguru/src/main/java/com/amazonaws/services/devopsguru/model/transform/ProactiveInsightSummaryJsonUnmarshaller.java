...
/**
 * ProactiveInsightSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProactiveInsightSummaryJsonUnmarshaller implements Unmarshaller<ProactiveInsightSummary, JsonUnmarshallerContext> {

    public ProactiveInsightSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProactiveInsightSummary proactiveInsightSummary = new ProactiveInsightSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Severity", targetDepth)) {
                    context.nextToken();
                    proactiveInsightSummary.setSeverity(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ProactiveInsightSummaryJsonUnmarshaller instance;

    public static ProactiveInsightSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProactiveInsightSummaryJsonUnmarshaller();
        return instance;
    }
}
