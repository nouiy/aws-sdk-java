 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/devops-guru-2020-12-01/ListAnomaliesForInsightFilters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListAnomaliesForInsightFilters implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAnomaliesForInsightFilters == false)
            return false;
    ...
    @Override
    public ListAnomaliesForInsightFilters clone() {
        try {
            return (ListAnomaliesForInsightFilters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.devopsguru.model.transform.ListAnomaliesForInsightFiltersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
