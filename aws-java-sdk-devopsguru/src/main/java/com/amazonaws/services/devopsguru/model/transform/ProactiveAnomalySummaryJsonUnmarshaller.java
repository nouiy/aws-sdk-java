...
/**
 * ProactiveAnomalySummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProactiveAnomalySummaryJsonUnmarshaller implements Unmarshaller<ProactiveAnomalySummary, JsonUnmarshallerContext> {

    public ProactiveAnomalySummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProactiveAnomalySummary proactiveAnomalySummary = new ProactiveAnomalySummary();
    ...
    private static ProactiveAnomalySummaryJsonUnmarshaller instance;

    public static ProactiveAnomalySummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProactiveAnomalySummaryJsonUnmarshaller();
        return instance;
    }
}
