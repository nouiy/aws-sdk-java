...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.devopsguru.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.devopsguru.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.devopsguru.model.ConflictException conflictException = new com.amazonaws.services.devopsguru.model.ConflictException(null);
