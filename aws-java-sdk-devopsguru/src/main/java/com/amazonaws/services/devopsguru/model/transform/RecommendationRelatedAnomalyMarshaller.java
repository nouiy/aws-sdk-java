...
/**
 * RecommendationRelatedAnomalyMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecommendationRelatedAnomalyMarshaller {
    ...
    public static RecommendationRelatedAnomalyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecommendationRelatedAnomaly recommendationRelatedAnomaly, ProtocolMarshaller protocolMarshaller) {

        if (recommendationRelatedAnomaly == null) {
