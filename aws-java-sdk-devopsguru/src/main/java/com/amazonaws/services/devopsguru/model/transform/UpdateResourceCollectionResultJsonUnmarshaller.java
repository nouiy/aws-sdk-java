...
/**
 * UpdateResourceCollectionResult JSON Unmarshaller
 */
...
public class UpdateResourceCollectionResultJsonUnmarshaller implements Unmarshaller<UpdateResourceCollectionResult, JsonUnmarshallerContext> {
    ...
    public UpdateResourceCollectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateResourceCollectionResult updateResourceCollectionResult = new UpdateResourceCollectionResult();
