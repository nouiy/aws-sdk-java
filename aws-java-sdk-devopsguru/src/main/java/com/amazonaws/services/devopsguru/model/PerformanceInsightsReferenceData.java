 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/devops-guru-2020-12-01/PerformanceInsightsReferenceData"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PerformanceInsightsReferenceData implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setComparisonValues(PerformanceInsightsReferenceComparisonValues comparisonValues) {
    ...
    public String toString() {
        ...
        if (getComparisonValues() != null)
            sb.append("ComparisonValues: ").append(getComparisonValues());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PerformanceInsightsReferenceData == false)
            return false;
        ...
        if (other.getName() != null && other.getName().equals(this.getName()) == false)
            return false;
        if (other.getComparisonValues() == null ^ this.getComparisonValues() == null)
            return false;
        if (other.getComparisonValues() != null && other.getComparisonValues().equals(this.getComparisonValues()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getComparisonValues() == null) ? 0 : getComparisonValues().hashCode());
        return hashCode;
    }
    ...
    public PerformanceInsightsReferenceData clone() {
        try {
            return (PerformanceInsightsReferenceData) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.devopsguru.model.transform.PerformanceInsightsReferenceDataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
