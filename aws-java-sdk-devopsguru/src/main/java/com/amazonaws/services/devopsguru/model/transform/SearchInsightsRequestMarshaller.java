...
/**
 * SearchInsightsRequestMarshaller
 */
...
public class SearchInsightsRequestMarshaller {
    ...
    private static final SearchInsightsRequestMarshaller instance = new SearchInsightsRequestMarshaller();

    public static SearchInsightsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchInsightsRequest searchInsightsRequest, ProtocolMarshaller protocolMarshaller) {
