...
/**
 * TagHealth JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagHealthJsonUnmarshaller implements Unmarshaller<TagHealth, JsonUnmarshallerContext> {

    public TagHealth unmarshall(JsonUnmarshallerContext context) throws Exception {
        TagHealth tagHealth = new TagHealth();
    ...
    private static TagHealthJsonUnmarshaller instance;

    public static TagHealthJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TagHealthJsonUnmarshaller();
        return instance;
    }
}
