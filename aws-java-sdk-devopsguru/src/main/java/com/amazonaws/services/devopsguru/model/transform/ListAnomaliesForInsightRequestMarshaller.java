...
@SdkInternalApi
public class ListAnomaliesForInsightRequestMarshaller {
    ...
    public static ListAnomaliesForInsightRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAnomaliesForInsightRequest listAnomaliesForInsightRequest, ProtocolMarshaller protocolMarshaller) {
