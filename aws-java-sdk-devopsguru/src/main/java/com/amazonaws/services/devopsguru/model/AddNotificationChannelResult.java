...
public class AddNotificationChannelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddNotificationChannelResult == false)
            return false;
        AddNotificationChannelResult other = (AddNotificationChannelResult) obj;
    ...
    public AddNotificationChannelResult clone() {
        try {
            return (AddNotificationChannelResult) super.clone();
