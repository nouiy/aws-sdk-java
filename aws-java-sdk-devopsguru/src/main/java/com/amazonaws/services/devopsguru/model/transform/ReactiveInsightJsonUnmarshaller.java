...
/**
 * ReactiveInsight JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReactiveInsightJsonUnmarshaller implements Unmarshaller<ReactiveInsight, JsonUnmarshallerContext> {

    public ReactiveInsight unmarshall(JsonUnmarshallerContext context) throws Exception {
        ReactiveInsight reactiveInsight = new ReactiveInsight();
    ...
    private static ReactiveInsightJsonUnmarshaller instance;

    public static ReactiveInsightJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReactiveInsightJsonUnmarshaller();
        return instance;
    }
}
