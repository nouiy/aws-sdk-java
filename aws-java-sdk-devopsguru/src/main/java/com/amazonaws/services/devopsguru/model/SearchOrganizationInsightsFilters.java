 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/devops-guru-2020-12-01/SearchOrganizationInsightsFilters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchOrganizationInsightsFilters implements Serializable, Cloneable, StructuredPojo {
    ...
    public SearchOrganizationInsightsFilters withSeverities(java.util.Collection<String> severities) {
    ...
    public SearchOrganizationInsightsFilters withStatuses(java.util.Collection<String> statuses) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchOrganizationInsightsFilters == false)
            return false;
    ...
    public SearchOrganizationInsightsFilters clone() {
        try {
            return (SearchOrganizationInsightsFilters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.devopsguru.model.transform.SearchOrganizationInsightsFiltersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
