...
public class PutFeedbackRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> INSIGHTFEEDBACK_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("InsightFeedback").build();
    ...
    public void marshall(PutFeedbackRequest putFeedbackRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putFeedbackRequest.getInsightFeedback(), INSIGHTFEEDBACK_BINDING);
        } catch (Exception e) {
