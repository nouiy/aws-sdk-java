...
public class ListEventsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListEventsResult withEvents(Event... events) {
        if (this.events == null) {
    ...
    public ListEventsResult withEvents(java.util.Collection<Event> events) {
        setEvents(events);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEventsResult == false)
            return false;
        ListEventsResult other = (ListEventsResult) obj;
    ...
    public ListEventsResult clone() {
        try {
            return (ListEventsResult) super.clone();
