...
/**
 * UpdateServiceIntegrationResult JSON Unmarshaller
 */
...
public class UpdateServiceIntegrationResultJsonUnmarshaller implements Unmarshaller<UpdateServiceIntegrationResult, JsonUnmarshallerContext> {
    ...
    public UpdateServiceIntegrationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateServiceIntegrationResult updateServiceIntegrationResult = new UpdateServiceIntegrationResult();
