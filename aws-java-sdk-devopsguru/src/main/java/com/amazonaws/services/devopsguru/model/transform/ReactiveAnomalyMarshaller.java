...
public class ReactiveAnomalyMarshaller {
    ...
    public void marshall(ReactiveAnomaly reactiveAnomaly, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(reactiveAnomaly.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(reactiveAnomaly.getName(), NAME_BINDING);
            protocolMarshaller.marshall(reactiveAnomaly.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(reactiveAnomaly.getCausalAnomalyId(), CAUSALANOMALYID_BINDING);
            protocolMarshaller.marshall(reactiveAnomaly.getAnomalyResources(), ANOMALYRESOURCES_BINDING);
        } catch (Exception e) {
