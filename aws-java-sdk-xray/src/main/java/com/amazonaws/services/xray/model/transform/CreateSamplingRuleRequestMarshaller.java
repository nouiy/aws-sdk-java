...
@SdkInternalApi
public class CreateSamplingRuleRequestMarshaller {
    ...
    public static CreateSamplingRuleRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateSamplingRuleRequest createSamplingRuleRequest, ProtocolMarshaller protocolMarshaller) {
