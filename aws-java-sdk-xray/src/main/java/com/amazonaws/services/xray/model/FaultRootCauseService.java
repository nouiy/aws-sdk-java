 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/FaultRootCauseService" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FaultRootCauseService implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<FaultRootCauseEntity> entityPath;
    /**
     * <p>
    ...
    public FaultRootCauseService withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
    ...
    public java.util.List<FaultRootCauseEntity> getEntityPath() {
        return entityPath;
    }
    ...
    public void setEntityPath(java.util.Collection<FaultRootCauseEntity> entityPath) {
        if (entityPath == null) {
            this.entityPath = null;
            return;
        }

        this.entityPath = new java.util.ArrayList<FaultRootCauseEntity>(entityPath);
    }
    ...
    public FaultRootCauseService withEntityPath(FaultRootCauseEntity... entityPath) {
        if (this.entityPath == null) {
            setEntityPath(new java.util.ArrayList<FaultRootCauseEntity>(entityPath.length));
        }
        for (FaultRootCauseEntity ele : entityPath) {
    ...
    public FaultRootCauseService withEntityPath(java.util.Collection<FaultRootCauseEntity> entityPath) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FaultRootCauseService == false)
            return false;
    ...
    public FaultRootCauseService clone() {
        try {
            return (FaultRootCauseService) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.xray.model.transform.FaultRootCauseServiceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
