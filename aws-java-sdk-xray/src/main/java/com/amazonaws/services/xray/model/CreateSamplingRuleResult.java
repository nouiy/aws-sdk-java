...
public class CreateSamplingRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSamplingRuleResult == false)
            return false;
        CreateSamplingRuleResult other = (CreateSamplingRuleResult) obj;
    ...
    @Override
    public CreateSamplingRuleResult clone() {
        try {
            return (CreateSamplingRuleResult) super.clone();
