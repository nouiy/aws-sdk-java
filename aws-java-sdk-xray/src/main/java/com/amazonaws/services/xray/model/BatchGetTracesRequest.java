...
public class BatchGetTracesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BatchGetTracesRequest withTraceIds(String... traceIds) {
    ...
    public BatchGetTracesRequest withTraceIds(java.util.Collection<String> traceIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetTracesRequest == false)
            return false;
        BatchGetTracesRequest other = (BatchGetTracesRequest) obj;
