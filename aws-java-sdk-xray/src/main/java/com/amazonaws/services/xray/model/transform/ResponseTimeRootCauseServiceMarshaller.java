...
/**
 * ResponseTimeRootCauseServiceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ResponseTimeRootCauseServiceMarshaller {
    ...
    private static final ResponseTimeRootCauseServiceMarshaller instance = new ResponseTimeRootCauseServiceMarshaller();

    public static ResponseTimeRootCauseServiceMarshaller getInstance() {
        return instance;
    }
