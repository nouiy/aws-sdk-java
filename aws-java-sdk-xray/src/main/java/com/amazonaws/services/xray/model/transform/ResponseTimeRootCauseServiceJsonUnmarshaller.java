...
/**
 * ResponseTimeRootCauseService JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseTimeRootCauseServiceJsonUnmarshaller implements Unmarshaller<ResponseTimeRootCauseService, JsonUnmarshallerContext> {

    public ResponseTimeRootCauseService unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResponseTimeRootCauseService responseTimeRootCauseService = new ResponseTimeRootCauseService();
    ...
    private static ResponseTimeRootCauseServiceJsonUnmarshaller instance;

    public static ResponseTimeRootCauseServiceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResponseTimeRootCauseServiceJsonUnmarshaller();
        return instance;
    }
}
