...
/**
 * SamplingRuleUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SamplingRuleUpdateJsonUnmarshaller implements Unmarshaller<SamplingRuleUpdate, JsonUnmarshallerContext> {

    public SamplingRuleUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        SamplingRuleUpdate samplingRuleUpdate = new SamplingRuleUpdate();
    ...
    private static SamplingRuleUpdateJsonUnmarshaller instance;

    public static SamplingRuleUpdateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SamplingRuleUpdateJsonUnmarshaller();
        return instance;
    }
}
