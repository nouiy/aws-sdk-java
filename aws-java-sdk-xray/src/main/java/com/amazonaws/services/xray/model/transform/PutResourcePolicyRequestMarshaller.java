...
public class PutResourcePolicyRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> BYPASSPOLICYLOCKOUTCHECK_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BypassPolicyLockoutCheck").build();
    ...
    public void marshall(PutResourcePolicyRequest putResourcePolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putResourcePolicyRequest.getPolicyName(), POLICYNAME_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getPolicyDocument(), POLICYDOCUMENT_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getPolicyRevisionId(), POLICYREVISIONID_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getBypassPolicyLockoutCheck(), BYPASSPOLICYLOCKOUTCHECK_BINDING);
        } catch (Exception e) {
