...
public class DeleteSamplingRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteSamplingRuleResult == false)
            return false;
        DeleteSamplingRuleResult other = (DeleteSamplingRuleResult) obj;
    ...
    @Override
    public DeleteSamplingRuleResult clone() {
        try {
            return (DeleteSamplingRuleResult) super.clone();
