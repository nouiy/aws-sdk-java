...
public class RuleLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RuleLimitExceededExceptionUnmarshaller instance;

    public static RuleLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RuleLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
