 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/ResponseTimeRootCauseService" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseTimeRootCauseService implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<ResponseTimeRootCauseEntity> entityPath;
    /**
     * <p>
    ...
    public ResponseTimeRootCauseService withNames(java.util.Collection<String> names) {
        setNames(names);
        return this;
    }
    ...
    public java.util.List<ResponseTimeRootCauseEntity> getEntityPath() {
        return entityPath;
    }
    ...
    public void setEntityPath(java.util.Collection<ResponseTimeRootCauseEntity> entityPath) {
        if (entityPath == null) {
            this.entityPath = null;
            return;
        }

        this.entityPath = new java.util.ArrayList<ResponseTimeRootCauseEntity>(entityPath);
    }
    ...
    public ResponseTimeRootCauseService withEntityPath(ResponseTimeRootCauseEntity... entityPath) {
        if (this.entityPath == null) {
            setEntityPath(new java.util.ArrayList<ResponseTimeRootCauseEntity>(entityPath.length));
        }
        for (ResponseTimeRootCauseEntity ele : entityPath) {
    ...
    public ResponseTimeRootCauseService withEntityPath(java.util.Collection<ResponseTimeRootCauseEntity> entityPath) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResponseTimeRootCauseService == false)
            return false;
    ...
    public ResponseTimeRootCauseService clone() {
        try {
            return (ResponseTimeRootCauseService) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.xray.model.transform.ResponseTimeRootCauseServiceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
