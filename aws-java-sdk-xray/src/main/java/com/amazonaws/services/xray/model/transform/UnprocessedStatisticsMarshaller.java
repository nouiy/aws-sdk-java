...
/**
 * UnprocessedStatisticsMarshaller
 */
...
public class UnprocessedStatisticsMarshaller {
    ...
    public void marshall(UnprocessedStatistics unprocessedStatistics, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(unprocessedStatistics.getRuleName(), RULENAME_BINDING);
            protocolMarshaller.marshall(unprocessedStatistics.getErrorCode(), ERRORCODE_BINDING);
            protocolMarshaller.marshall(unprocessedStatistics.getMessage(), MESSAGE_BINDING);
        } catch (Exception e) {
