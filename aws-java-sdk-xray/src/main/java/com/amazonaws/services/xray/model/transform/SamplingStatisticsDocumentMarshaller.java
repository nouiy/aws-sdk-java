...
/**
 * SamplingStatisticsDocumentMarshaller
 */
...
public class SamplingStatisticsDocumentMarshaller {
    ...
    public void marshall(SamplingStatisticsDocument samplingStatisticsDocument, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(samplingStatisticsDocument.getRuleName(), RULENAME_BINDING);
            protocolMarshaller.marshall(samplingStatisticsDocument.getClientID(), CLIENTID_BINDING);
            protocolMarshaller.marshall(samplingStatisticsDocument.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(samplingStatisticsDocument.getRequestCount(), REQUESTCOUNT_BINDING);
            protocolMarshaller.marshall(samplingStatisticsDocument.getSampledCount(), SAMPLEDCOUNT_BINDING);
            protocolMarshaller.marshall(samplingStatisticsDocument.getBorrowCount(), BORROWCOUNT_BINDING);
        } catch (Exception e) {
