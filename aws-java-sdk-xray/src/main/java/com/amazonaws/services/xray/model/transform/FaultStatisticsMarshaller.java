...
public class FaultStatisticsMarshaller {
    ...
    public void marshall(FaultStatistics faultStatistics, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(faultStatistics.getOtherCount(), OTHERCOUNT_BINDING);
            protocolMarshaller.marshall(faultStatistics.getTotalCount(), TOTALCOUNT_BINDING);
        } catch (Exception e) {
