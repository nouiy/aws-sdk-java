...
/**
 * FaultRootCauseService JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FaultRootCauseServiceJsonUnmarshaller implements Unmarshaller<FaultRootCauseService, JsonUnmarshallerContext> {

    public FaultRootCauseService unmarshall(JsonUnmarshallerContext context) throws Exception {
        FaultRootCauseService faultRootCauseService = new FaultRootCauseService();
    ...
    private static FaultRootCauseServiceJsonUnmarshaller instance;

    public static FaultRootCauseServiceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FaultRootCauseServiceJsonUnmarshaller();
        return instance;
    }
}
