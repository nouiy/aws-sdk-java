...
public class CreateSavingsPlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSavingsPlanResult withSavingsPlanId(String savingsPlanId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSavingsPlanResult == false)
            return false;
        CreateSavingsPlanResult other = (CreateSavingsPlanResult) obj;
    ...
    @Override
    public CreateSavingsPlanResult clone() {
        try {
            return (CreateSavingsPlanResult) super.clone();
