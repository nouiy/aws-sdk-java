...
public class DeleteQueuedSavingsPlanRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteQueuedSavingsPlanRequest == false)
            return false;
        DeleteQueuedSavingsPlanRequest other = (DeleteQueuedSavingsPlanRequest) obj;
    ...
    @Override
    public DeleteQueuedSavingsPlanRequest clone() {
        return (DeleteQueuedSavingsPlanRequest) super.clone();
    }
