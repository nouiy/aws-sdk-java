...
public enum SavingsPlansFilterName {
    ...
    private SavingsPlansFilterName(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return SavingsPlansFilterName corresponding to the value
     *
    ...
    public static SavingsPlansFilterName fromValue(String value) {
        ...
        for (SavingsPlansFilterName enumEntry : SavingsPlansFilterName.values()) {
