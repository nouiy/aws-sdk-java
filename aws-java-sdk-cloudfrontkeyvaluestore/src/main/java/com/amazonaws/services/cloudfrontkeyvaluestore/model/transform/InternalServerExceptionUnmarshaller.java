...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudfrontkeyvaluestore.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.cloudfrontkeyvaluestore.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudfrontkeyvaluestore.model.InternalServerException internalServerException = new com.amazonaws.services.cloudfrontkeyvaluestore.model.InternalServerException(
                null);
