...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudfrontkeyvaluestore.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.cloudfrontkeyvaluestore.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.cloudfrontkeyvaluestore.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.cloudfrontkeyvaluestore.model.ResourceNotFoundException(
                null);
