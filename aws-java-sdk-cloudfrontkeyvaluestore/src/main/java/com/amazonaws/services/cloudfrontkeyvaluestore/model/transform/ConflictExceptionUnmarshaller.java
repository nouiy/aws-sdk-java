...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudfrontkeyvaluestore.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.cloudfrontkeyvaluestore.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudfrontkeyvaluestore.model.ConflictException conflictException = new com.amazonaws.services.cloudfrontkeyvaluestore.model.ConflictException(
                null);
