    ...
    public DeleteKeyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        if (context.isStartOfDocument()) {
            if (context.getHeader("ETag") != null) {
                ...
                deleteKeyResult.setETag(context.getUnmarshaller(String.class).unmarshall(context));
            }
        }
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ItemCount", targetDepth)) {
                    context.nextToken();
                    deleteKeyResult.setItemCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("TotalSizeInBytes", targetDepth)) {
                    context.nextToken();
                    deleteKeyResult.setTotalSizeInBytes(context.getUnmarshaller(Long.class).unmarshall(context));
                }
