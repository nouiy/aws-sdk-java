...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudfrontkeyvaluestore.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.cloudfrontkeyvaluestore.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudfrontkeyvaluestore.model.ValidationException validationException = new com.amazonaws.services.cloudfrontkeyvaluestore.model.ValidationException(
                null);
