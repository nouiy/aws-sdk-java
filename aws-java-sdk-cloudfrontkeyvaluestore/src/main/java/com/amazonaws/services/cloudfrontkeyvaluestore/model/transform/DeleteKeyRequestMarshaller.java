...
public class DeleteKeyRequestMarshaller {
    ...
    public void marshall(DeleteKeyRequest deleteKeyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteKeyRequest.getKvsARN(), KVSARN_BINDING);
            protocolMarshaller.marshall(deleteKeyRequest.getKey(), KEY_BINDING);
            protocolMarshaller.marshall(deleteKeyRequest.getIfMatch(), IFMATCH_BINDING);
        } catch (Exception e) {
