...
public class IntentMarshaller {
    ...
    private static final MarshallingInfo<String> CONFIRMATIONSTATE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("confirmationState").build();
    ...
    public void marshall(Intent intent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(intent.getName(), NAME_BINDING);
            protocolMarshaller.marshall(intent.getSlots(), SLOTS_BINDING);
            protocolMarshaller.marshall(intent.getState(), STATE_BINDING);
            protocolMarshaller.marshall(intent.getConfirmationState(), CONFIRMATIONSTATE_BINDING);
        } catch (Exception e) {
