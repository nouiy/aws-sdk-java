...
/**
 * DialogAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DialogActionJsonUnmarshaller implements Unmarshaller<DialogAction, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("slotElicitationStyle", targetDepth)) {
                    context.nextToken();
                    dialogAction.setSlotElicitationStyle(context.getUnmarshaller(String.class).unmarshall(context));
                }
