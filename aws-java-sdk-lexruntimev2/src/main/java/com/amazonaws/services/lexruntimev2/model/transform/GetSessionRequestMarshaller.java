...
public class GetSessionRequestMarshaller {
    ...
    public void marshall(GetSessionRequest getSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getSessionRequest.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(getSessionRequest.getBotAliasId(), BOTALIASID_BINDING);
            protocolMarshaller.marshall(getSessionRequest.getLocaleId(), LOCALEID_BINDING);
