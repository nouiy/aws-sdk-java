...
/**
 * SentimentResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SentimentResponseJsonUnmarshaller implements Unmarshaller<SentimentResponse, JsonUnmarshallerContext> {

    public SentimentResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("sentiment", targetDepth)) {
                    context.nextToken();
                    sentimentResponse.setSentiment(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("sentimentScore", targetDepth)) {
                    context.nextToken();
                    sentimentResponse.setSentimentScore(SentimentScoreJsonUnmarshaller.getInstance().unmarshall(context));
                }
