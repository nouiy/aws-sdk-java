...
/**
 * PutCodeBindingRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutCodeBindingRequestMarshaller {
    ...
    private static final PutCodeBindingRequestMarshaller instance = new PutCodeBindingRequestMarshaller();

    public static PutCodeBindingRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutCodeBindingRequest putCodeBindingRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putCodeBindingRequest.getLanguage(), LANGUAGE_BINDING);
            protocolMarshaller.marshall(putCodeBindingRequest.getRegistryName(), REGISTRYNAME_BINDING);
            protocolMarshaller.marshall(putCodeBindingRequest.getSchemaName(), SCHEMANAME_BINDING);
            protocolMarshaller.marshall(putCodeBindingRequest.getSchemaVersion(), SCHEMAVERSION_BINDING);
        } catch (Exception e) {
