...
public class UpdateDiscovererResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDiscovererResult withDescription(String description) {
    ...
    public UpdateDiscovererResult withDiscovererArn(String discovererArn) {
    ...
    public UpdateDiscovererResult withDiscovererId(String discovererId) {
    ...
    public UpdateDiscovererResult withSourceArn(String sourceArn) {
    ...
    public UpdateDiscovererResult withState(String state) {
        setState(state);
        return this;
    }
    ...
    public UpdateDiscovererResult withState(DiscovererState state) {
    ...
    public UpdateDiscovererResult withCrossAccount(Boolean crossAccount) {
    ...
    public UpdateDiscovererResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateDiscovererResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateDiscovererResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UpdateDiscovererResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDiscovererResult == false)
            return false;
        UpdateDiscovererResult other = (UpdateDiscovererResult) obj;
    ...
    @Override
    public UpdateDiscovererResult clone() {
        try {
            return (UpdateDiscovererResult) super.clone();
