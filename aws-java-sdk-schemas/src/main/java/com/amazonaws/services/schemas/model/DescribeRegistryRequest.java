...
public class DescribeRegistryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeRegistryRequest withRegistryName(String registryName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeRegistryRequest == false)
            return false;
        DescribeRegistryRequest other = (DescribeRegistryRequest) obj;
    ...
    @Override
    public DescribeRegistryRequest clone() {
        return (DescribeRegistryRequest) super.clone();
    }
