...
public class StartDiscovererRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartDiscovererRequest withDiscovererId(String discovererId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartDiscovererRequest == false)
            return false;
        StartDiscovererRequest other = (StartDiscovererRequest) obj;
    ...
    @Override
    public StartDiscovererRequest clone() {
        return (StartDiscovererRequest) super.clone();
    }
