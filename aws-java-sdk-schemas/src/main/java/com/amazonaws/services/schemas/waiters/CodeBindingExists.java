...
class CodeBindingExists {
    ...
    static class IsCREATE_COMPLETEMatcher extends WaiterAcceptor<DescribeCodeBindingResult> {
    ...
    static class IsCREATE_IN_PROGRESSMatcher extends WaiterAcceptor<DescribeCodeBindingResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeCodeBindingResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsNotFoundExceptionMatcher extends WaiterAcceptor<DescribeCodeBindingResult> {
        /**
