...
public class DescribeCodeBindingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeCodeBindingRequest withLanguage(String language) {
    ...
    public DescribeCodeBindingRequest withRegistryName(String registryName) {
    ...
    public DescribeCodeBindingRequest withSchemaName(String schemaName) {
    ...
    public DescribeCodeBindingRequest withSchemaVersion(String schemaVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCodeBindingRequest == false)
            return false;
        DescribeCodeBindingRequest other = (DescribeCodeBindingRequest) obj;
    ...
    @Override
    public DescribeCodeBindingRequest clone() {
