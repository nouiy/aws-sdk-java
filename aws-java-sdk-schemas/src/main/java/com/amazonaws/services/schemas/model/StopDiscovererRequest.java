...
public class StopDiscovererRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StopDiscovererRequest withDiscovererId(String discovererId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopDiscovererRequest == false)
            return false;
        StopDiscovererRequest other = (StopDiscovererRequest) obj;
    ...
    @Override
    public StopDiscovererRequest clone() {
        return (StopDiscovererRequest) super.clone();
    }
