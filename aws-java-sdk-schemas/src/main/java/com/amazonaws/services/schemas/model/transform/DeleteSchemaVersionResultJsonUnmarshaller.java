...
/**
 * DeleteSchemaVersionResult JSON Unmarshaller
 */
...
public class DeleteSchemaVersionResultJsonUnmarshaller implements Unmarshaller<DeleteSchemaVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteSchemaVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSchemaVersionResult deleteSchemaVersionResult = new DeleteSchemaVersionResult();
