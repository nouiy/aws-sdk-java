...
public class DeleteDiscovererRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteDiscovererRequest withDiscovererId(String discovererId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDiscovererRequest == false)
            return false;
        DeleteDiscovererRequest other = (DeleteDiscovererRequest) obj;
    ...
    @Override
    public DeleteDiscovererRequest clone() {
        return (DeleteDiscovererRequest) super.clone();
    }
