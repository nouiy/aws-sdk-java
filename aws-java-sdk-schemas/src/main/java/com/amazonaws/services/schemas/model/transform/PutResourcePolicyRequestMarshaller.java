...
public class PutResourcePolicyRequestMarshaller {
    ...
    private static final MarshallingInfo<String> POLICY_BINDING = MarshallingInfo.builder(MarshallingType.JSON_VALUE)
    ...
    public void marshall(PutResourcePolicyRequest putResourcePolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(putResourcePolicyRequest.getRegistryName(), REGISTRYNAME_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getRevisionId(), REVISIONID_BINDING);
        } catch (Exception e) {
