...
public class StartDiscovererResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartDiscovererResult withDiscovererId(String discovererId) {
    ...
    public StartDiscovererResult withState(String state) {
        setState(state);
        return this;
    }
    ...
    public StartDiscovererResult withState(DiscovererState state) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartDiscovererResult == false)
            return false;
        StartDiscovererResult other = (StartDiscovererResult) obj;
    ...
    @Override
    public StartDiscovererResult clone() {
        try {
