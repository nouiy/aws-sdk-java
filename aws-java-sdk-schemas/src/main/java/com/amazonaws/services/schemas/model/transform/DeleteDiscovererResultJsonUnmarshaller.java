...
/**
 * DeleteDiscovererResult JSON Unmarshaller
 */
...
public class DeleteDiscovererResultJsonUnmarshaller implements Unmarshaller<DeleteDiscovererResult, JsonUnmarshallerContext> {
    ...
    public DeleteDiscovererResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDiscovererResult deleteDiscovererResult = new DeleteDiscovererResult();
