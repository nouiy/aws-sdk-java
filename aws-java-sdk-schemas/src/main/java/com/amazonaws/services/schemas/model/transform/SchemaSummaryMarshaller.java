...
public class SchemaSummaryMarshaller {
    ...
    private static final MarshallingInfo<Long> VERSIONCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("VersionCount").build();
