...
public class ListSchemasRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SCHEMANAMEPREFIX_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("schemaNamePrefix").build();
    ...
    public void marshall(ListSchemasRequest listSchemasRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listSchemasRequest.getLimit(), LIMIT_BINDING);
            protocolMarshaller.marshall(listSchemasRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listSchemasRequest.getRegistryName(), REGISTRYNAME_BINDING);
            protocolMarshaller.marshall(listSchemasRequest.getSchemaNamePrefix(), SCHEMANAMEPREFIX_BINDING);
        } catch (Exception e) {
