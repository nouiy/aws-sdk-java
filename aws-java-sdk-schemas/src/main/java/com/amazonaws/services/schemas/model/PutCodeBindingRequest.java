...
public class PutCodeBindingRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutCodeBindingRequest withLanguage(String language) {
    ...
    public PutCodeBindingRequest withRegistryName(String registryName) {
    ...
    public PutCodeBindingRequest withSchemaName(String schemaName) {
    ...
    public PutCodeBindingRequest withSchemaVersion(String schemaVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutCodeBindingRequest == false)
            return false;
        PutCodeBindingRequest other = (PutCodeBindingRequest) obj;
    ...
    @Override
    public PutCodeBindingRequest clone() {
        return (PutCodeBindingRequest) super.clone();
    }
