...
public class CreateSchemaResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSchemaResult withLastModified(java.util.Date lastModified) {
    ...
    public CreateSchemaResult withSchemaVersion(String schemaVersion) {
    ...
    public CreateSchemaResult withType(String type) {
        setType(type);
        return this;
    }
    ...
    public CreateSchemaResult withVersionCreatedDate(java.util.Date versionCreatedDate) {
