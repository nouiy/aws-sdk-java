...
/**
 * StopInferenceSchedulerResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopInferenceSchedulerResultJsonUnmarshaller implements Unmarshaller<StopInferenceSchedulerResult, JsonUnmarshallerContext> {

    public StopInferenceSchedulerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopInferenceSchedulerResult stopInferenceSchedulerResult = new StopInferenceSchedulerResult();
    ...
    private static StopInferenceSchedulerResultJsonUnmarshaller instance;

    public static StopInferenceSchedulerResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StopInferenceSchedulerResultJsonUnmarshaller();
        return instance;
    }
}
