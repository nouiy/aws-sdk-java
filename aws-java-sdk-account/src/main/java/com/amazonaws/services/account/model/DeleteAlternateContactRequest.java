...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/account-2021-02-01/DeleteAlternateContact" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteAlternateContactRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAlternateContactRequest withAccountId(String accountId) {
     ...
     * </p>
     * 
     * @return Specifies which of the alternate contacts to delete.
     * @see AlternateContactType
     */
    ...
    public DeleteAlternateContactRequest withAlternateContactType(String alternateContactType) {
    ...
    public DeleteAlternateContactRequest withAlternateContactType(AlternateContactType alternateContactType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAlternateContactRequest == false)
            return false;
        DeleteAlternateContactRequest other = (DeleteAlternateContactRequest) obj;
    ...
    @Override
    public DeleteAlternateContactRequest clone() {
        return (DeleteAlternateContactRequest) super.clone();
    }
