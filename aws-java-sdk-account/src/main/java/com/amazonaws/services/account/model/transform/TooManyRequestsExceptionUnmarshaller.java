...
public class TooManyRequestsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyRequestsExceptionUnmarshaller() {
        super(com.amazonaws.services.account.model.TooManyRequestsException.class, "TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.account.model.TooManyRequestsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.account.model.TooManyRequestsException tooManyRequestsException = new com.amazonaws.services.account.model.TooManyRequestsException(
                null);
