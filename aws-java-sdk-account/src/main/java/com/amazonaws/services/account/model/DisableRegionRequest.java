...
public class DisableRegionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DisableRegionRequest withAccountId(String accountId) {
