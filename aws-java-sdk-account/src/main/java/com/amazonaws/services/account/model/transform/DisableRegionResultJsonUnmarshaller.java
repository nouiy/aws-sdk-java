...
/**
 * DisableRegionResult JSON Unmarshaller
 */
...
public class DisableRegionResultJsonUnmarshaller implements Unmarshaller<DisableRegionResult, JsonUnmarshallerContext> {
    ...
    public DisableRegionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisableRegionResult disableRegionResult = new DisableRegionResult();

        return disableRegionResult;
    }
