...
public class StartPrimaryEmailUpdateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The new primary email address (also known as the root user email address) to use in the specified
     *         account.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartPrimaryEmailUpdateRequest == false)
            return false;
        StartPrimaryEmailUpdateRequest other = (StartPrimaryEmailUpdateRequest) obj;
    ...
    public StartPrimaryEmailUpdateRequest clone() {
        return (StartPrimaryEmailUpdateRequest) super.clone();
    }
