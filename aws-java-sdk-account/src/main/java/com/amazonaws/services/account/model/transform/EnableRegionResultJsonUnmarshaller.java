...
/**
 * EnableRegionResult JSON Unmarshaller
 */
...
public class EnableRegionResultJsonUnmarshaller implements Unmarshaller<EnableRegionResult, JsonUnmarshallerContext> {
    ...
    public EnableRegionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        EnableRegionResult enableRegionResult = new EnableRegionResult();

        return enableRegionResult;
    }
