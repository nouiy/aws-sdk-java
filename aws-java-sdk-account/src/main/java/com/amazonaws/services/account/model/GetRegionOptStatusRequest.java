...
public class GetRegionOptStatusRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * Specifies the Region-code for a given Region name (for example, <code>af-south-1</code>). This function will
     ...
     * 
     * @param regionName
     *        Specifies the Region-code for a given Region name (for example, <code>af-south-1</code>). This function
     *        will return the status of whatever Region you pass into this parameter.
     */
     ...
     * </p>
     * 
     * @return Specifies the Region-code for a given Region name (for example, <code>af-south-1</code>). This function
     *         will return the status of whatever Region you pass into this parameter.
     */
    ...
    public GetRegionOptStatusRequest withRegionName(String regionName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRegionOptStatusRequest == false)
            return false;
        GetRegionOptStatusRequest other = (GetRegionOptStatusRequest) obj;
    ...
    public GetRegionOptStatusRequest clone() {
        return (GetRegionOptStatusRequest) super.clone();
    }
