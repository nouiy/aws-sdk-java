...
public class GetPrimaryEmailRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetPrimaryEmailRequest withAccountId(String accountId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetPrimaryEmailRequest == false)
            return false;
        GetPrimaryEmailRequest other = (GetPrimaryEmailRequest) obj;
    ...
    @Override
    public GetPrimaryEmailRequest clone() {
        return (GetPrimaryEmailRequest) super.clone();
    }
