...
public class RegionMarshaller {
    ...
    private static final MarshallingInfo<String> REGIONOPTSTATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RegionOptStatus").build();
    ...
    public void marshall(Region region, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(region.getRegionName(), REGIONNAME_BINDING);
            protocolMarshaller.marshall(region.getRegionOptStatus(), REGIONOPTSTATUS_BINDING);
        } catch (Exception e) {
