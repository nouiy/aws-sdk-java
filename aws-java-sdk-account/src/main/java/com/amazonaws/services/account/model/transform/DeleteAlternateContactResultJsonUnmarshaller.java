...
/**
 * DeleteAlternateContactResult JSON Unmarshaller
 */
...
public class DeleteAlternateContactResultJsonUnmarshaller implements Unmarshaller<DeleteAlternateContactResult, JsonUnmarshallerContext> {
    ...
    public DeleteAlternateContactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAlternateContactResult deleteAlternateContactResult = new DeleteAlternateContactResult();

        return deleteAlternateContactResult;
    }
