...
/**
 * WorkerLogDeliveryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WorkerLogDeliveryMarshaller {
    ...
    private static final WorkerLogDeliveryMarshaller instance = new WorkerLogDeliveryMarshaller();

    public static WorkerLogDeliveryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WorkerLogDelivery workerLogDelivery, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(workerLogDelivery.getCloudWatchLogs(), CLOUDWATCHLOGS_BINDING);
            protocolMarshaller.marshall(workerLogDelivery.getFirehose(), FIREHOSE_BINDING);
            protocolMarshaller.marshall(workerLogDelivery.getS3(), S3_BINDING);
        } catch (Exception e) {
