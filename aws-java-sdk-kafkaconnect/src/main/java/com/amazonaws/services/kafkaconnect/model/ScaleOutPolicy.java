 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/ScaleOutPolicy" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScaleOutPolicy implements Serializable, Cloneable, StructuredPojo {
    ...
    public ScaleOutPolicy withCpuUtilizationPercentage(Integer cpuUtilizationPercentage) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScaleOutPolicy == false)
            return false;
        ScaleOutPolicy other = (ScaleOutPolicy) obj;
    ...
    @Override
    public ScaleOutPolicy clone() {
        try {
            return (ScaleOutPolicy) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.ScaleOutPolicyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
