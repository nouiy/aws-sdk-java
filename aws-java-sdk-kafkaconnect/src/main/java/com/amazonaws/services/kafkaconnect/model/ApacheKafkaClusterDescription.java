 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/ApacheKafkaClusterDescription"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApacheKafkaClusterDescription implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setVpc(VpcDescription vpc) {
        this.vpc = vpc;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ApacheKafkaClusterDescription == false)
            return false;
    ...
    public ApacheKafkaClusterDescription clone() {
        try {
            return (ApacheKafkaClusterDescription) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.ApacheKafkaClusterDescriptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
