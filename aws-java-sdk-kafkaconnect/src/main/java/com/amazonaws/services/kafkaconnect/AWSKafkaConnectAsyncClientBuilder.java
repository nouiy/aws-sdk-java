...
/**
 * Fluent builder for {@link com.amazonaws.services.kafkaconnect.AWSKafkaConnectAsync}. Use of the builder is preferred
...
public final class AWSKafkaConnectAsyncClientBuilder extends AwsAsyncClientBuilder<AWSKafkaConnectAsyncClientBuilder, AWSKafkaConnectAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSKafkaConnectAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSKafkaConnectAsync.
     */
    @Override
    protected AWSKafkaConnectAsync build(AwsAsyncClientParams params) {
        return new AWSKafkaConnectAsyncClient(params);
    }
