...
/**
 * WorkerConfigurationSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WorkerConfigurationSummaryMarshaller {
    ...
    public static WorkerConfigurationSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WorkerConfigurationSummary workerConfigurationSummary, ProtocolMarshaller protocolMarshaller) {

        if (workerConfigurationSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(workerConfigurationSummary.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(workerConfigurationSummary.getDescription(), DESCRIPTION_BINDING);
