 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafkaconnect-2021-09-14/Vpc" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Vpc implements Serializable, Cloneable, StructuredPojo {
    ...
    public Vpc withSecurityGroups(java.util.Collection<String> securityGroups) {
    ...
    public Vpc withSubnets(java.util.Collection<String> subnets) {
        setSubnets(subnets);
        return this;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafkaconnect.model.transform.VpcMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
