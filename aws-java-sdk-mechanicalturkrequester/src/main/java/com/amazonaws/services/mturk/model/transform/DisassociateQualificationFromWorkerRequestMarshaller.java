...
/**
 * DisassociateQualificationFromWorkerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DisassociateQualificationFromWorkerRequestMarshaller {
    ...
    private static final DisassociateQualificationFromWorkerRequestMarshaller instance = new DisassociateQualificationFromWorkerRequestMarshaller();

    public static DisassociateQualificationFromWorkerRequestMarshaller getInstance() {
        return instance;
    }
