...
/**
 * UpdateNotificationSettingsResult JSON Unmarshaller
 */
...
public class UpdateNotificationSettingsResultJsonUnmarshaller implements Unmarshaller<UpdateNotificationSettingsResult, JsonUnmarshallerContext> {
    ...
    public UpdateNotificationSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateNotificationSettingsResult updateNotificationSettingsResult = new UpdateNotificationSettingsResult();
