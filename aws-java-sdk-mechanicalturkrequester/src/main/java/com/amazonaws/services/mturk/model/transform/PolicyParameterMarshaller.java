...
public class PolicyParameterMarshaller {
    ...
    private static final MarshallingInfo<List> MAPENTRIES_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("MapEntries").build();
    ...
    public void marshall(PolicyParameter policyParameter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(policyParameter.getKey(), KEY_BINDING);
            protocolMarshaller.marshall(policyParameter.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(policyParameter.getMapEntries(), MAPENTRIES_BINDING);
        } catch (Exception e) {
