...
/**
 * PolicyParameter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PolicyParameterJsonUnmarshaller implements Unmarshaller<PolicyParameter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    policyParameter.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static PolicyParameterJsonUnmarshaller instance;

    public static PolicyParameterJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyParameterJsonUnmarshaller();
        return instance;
    }
}
