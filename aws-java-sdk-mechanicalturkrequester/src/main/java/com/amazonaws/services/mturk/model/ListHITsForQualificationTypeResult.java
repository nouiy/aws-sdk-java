...
public class ListHITsForQualificationTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListHITsForQualificationTypeResult withHITs(HIT... hITs) {
        if (this.hITs == null) {
    ...
    public ListHITsForQualificationTypeResult withHITs(java.util.Collection<HIT> hITs) {
        setHITs(hITs);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListHITsForQualificationTypeResult == false)
            return false;
        ListHITsForQualificationTypeResult other = (ListHITsForQualificationTypeResult) obj;
    ...
    public ListHITsForQualificationTypeResult clone() {
        try {
            return (ListHITsForQualificationTypeResult) super.clone();
