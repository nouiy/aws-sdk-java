...
/**
 * ListReviewableHITsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListReviewableHITsRequestMarshaller {
    ...
    private static final ListReviewableHITsRequestMarshaller instance = new ListReviewableHITsRequestMarshaller();

    public static ListReviewableHITsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListReviewableHITsRequest listReviewableHITsRequest, ProtocolMarshaller protocolMarshaller) {
