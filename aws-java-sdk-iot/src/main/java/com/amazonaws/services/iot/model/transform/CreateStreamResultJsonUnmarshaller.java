        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("streamId", targetDepth)) {
                    context.nextToken();
                    createStreamResult.setStreamId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("streamArn", targetDepth)) {
                    context.nextToken();
                    createStreamResult.setStreamArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("description", targetDepth)) {
                    context.nextToken();
                    createStreamResult.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("streamVersion", targetDepth)) {
                    context.nextToken();
                    createStreamResult.setStreamVersion(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
