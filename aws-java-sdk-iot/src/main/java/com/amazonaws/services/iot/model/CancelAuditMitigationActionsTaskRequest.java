...
public class CancelAuditMitigationActionsTaskRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier for the task that you want to cancel.
     */
    ...
    public CancelAuditMitigationActionsTaskRequest clone() {
        return (CancelAuditMitigationActionsTaskRequest) super.clone();
    }
