...
/**
 * SecurityProfileTargetMappingMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SecurityProfileTargetMappingMarshaller {

    private static final MarshallingInfo<StructuredPojo> SECURITYPROFILEIDENTIFIER_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("securityProfileIdentifier").build();
