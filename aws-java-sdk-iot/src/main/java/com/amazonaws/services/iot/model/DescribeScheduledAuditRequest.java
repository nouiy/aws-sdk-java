...
public class DescribeScheduledAuditRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the scheduled audit whose information you want to get.
     */
    ...
    @Override
    public DescribeScheduledAuditRequest clone() {
        return (DescribeScheduledAuditRequest) super.clone();
    }
