...
/**
 * RegisterThingResult JSON Unmarshaller
 */
...
public class RegisterThingResultJsonUnmarshaller implements Unmarshaller<RegisterThingResult, JsonUnmarshallerContext> {
    ...
    public RegisterThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("certificatePem", targetDepth)) {
                    context.nextToken();
                    registerThingResult.setCertificatePem(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("resourceArns", targetDepth)) {
                    context.nextToken();
                    registerThingResult.setResourceArns(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
