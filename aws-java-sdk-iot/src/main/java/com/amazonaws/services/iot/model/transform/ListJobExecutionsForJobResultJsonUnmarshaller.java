...
/**
 * ListJobExecutionsForJobResult JSON Unmarshaller
 */
...
public class ListJobExecutionsForJobResultJsonUnmarshaller implements Unmarshaller<ListJobExecutionsForJobResult, JsonUnmarshallerContext> {
    ...
    public ListJobExecutionsForJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listJobExecutionsForJobResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
