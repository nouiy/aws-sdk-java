...
/**
 * UpdateThingGroupsForThingResult JSON Unmarshaller
 */
...
public class UpdateThingGroupsForThingResultJsonUnmarshaller implements Unmarshaller<UpdateThingGroupsForThingResult, JsonUnmarshallerContext> {
    ...
    public UpdateThingGroupsForThingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateThingGroupsForThingResult updateThingGroupsForThingResult = new UpdateThingGroupsForThingResult();
