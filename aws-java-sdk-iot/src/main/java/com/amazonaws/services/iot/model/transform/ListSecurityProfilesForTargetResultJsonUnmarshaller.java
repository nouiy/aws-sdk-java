...
/**
 * ListSecurityProfilesForTargetResult JSON Unmarshaller
 */
...
public class ListSecurityProfilesForTargetResultJsonUnmarshaller implements Unmarshaller<ListSecurityProfilesForTargetResult, JsonUnmarshallerContext> {
    ...
    public ListSecurityProfilesForTargetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listSecurityProfilesForTargetResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
