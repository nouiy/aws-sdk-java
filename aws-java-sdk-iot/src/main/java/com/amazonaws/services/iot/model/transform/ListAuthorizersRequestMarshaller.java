...
@SdkInternalApi
public class ListAuthorizersRequestMarshaller {
    ...
    private static final ListAuthorizersRequestMarshaller instance = new ListAuthorizersRequestMarshaller();

    public static ListAuthorizersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListAuthorizersRequest listAuthorizersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listAuthorizersRequest.getPageSize(), PAGESIZE_BINDING);
            protocolMarshaller.marshall(listAuthorizersRequest.getMarker(), MARKER_BINDING);
            protocolMarshaller.marshall(listAuthorizersRequest.getAscendingOrder(), ASCENDINGORDER_BINDING);
            protocolMarshaller.marshall(listAuthorizersRequest.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
