...
public class TransferAlreadyCompletedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TransferAlreadyCompletedExceptionUnmarshaller instance;

    public static TransferAlreadyCompletedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TransferAlreadyCompletedExceptionUnmarshaller();
        return instance;
    }
}
