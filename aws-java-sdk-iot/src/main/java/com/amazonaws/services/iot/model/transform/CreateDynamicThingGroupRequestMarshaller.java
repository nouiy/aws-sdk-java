...
public class CreateDynamicThingGroupRequestMarshaller {
    ...
    private static final CreateDynamicThingGroupRequestMarshaller instance = new CreateDynamicThingGroupRequestMarshaller();

    public static CreateDynamicThingGroupRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CreateDynamicThingGroupRequest createDynamicThingGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createDynamicThingGroupRequest.getThingGroupName(), THINGGROUPNAME_BINDING);
            protocolMarshaller.marshall(createDynamicThingGroupRequest.getThingGroupProperties(), THINGGROUPPROPERTIES_BINDING);
            protocolMarshaller.marshall(createDynamicThingGroupRequest.getIndexName(), INDEXNAME_BINDING);
            protocolMarshaller.marshall(createDynamicThingGroupRequest.getQueryString(), QUERYSTRING_BINDING);
            protocolMarshaller.marshall(createDynamicThingGroupRequest.getQueryVersion(), QUERYVERSION_BINDING);
            protocolMarshaller.marshall(createDynamicThingGroupRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
