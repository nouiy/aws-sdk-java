...
public class VpcDestinationConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public VpcDestinationConfiguration withSecurityGroups(java.util.Collection<String> securityGroups) {
    ...
    public VpcDestinationConfiguration clone() {
        try {
            return (VpcDestinationConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.VpcDestinationConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
