...
/**
 * DeleteThingGroupResult JSON Unmarshaller
 */
...
public class DeleteThingGroupResultJsonUnmarshaller implements Unmarshaller<DeleteThingGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteThingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteThingGroupResult deleteThingGroupResult = new DeleteThingGroupResult();
