...
/**
 * PutVerificationStateOnViolationResult JSON Unmarshaller
 */
...
public class PutVerificationStateOnViolationResultJsonUnmarshaller implements Unmarshaller<PutVerificationStateOnViolationResult, JsonUnmarshallerContext> {
    ...
    public PutVerificationStateOnViolationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
