...
public class ExplicitDenyJsonUnmarshaller implements Unmarshaller<ExplicitDeny, JsonUnmarshallerContext> {

    public ExplicitDeny unmarshall(JsonUnmarshallerContext context) throws Exception {
