...
public class CreateRoleAliasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public CreateRoleAliasResult clone() {
        try {
            return (CreateRoleAliasResult) super.clone();
