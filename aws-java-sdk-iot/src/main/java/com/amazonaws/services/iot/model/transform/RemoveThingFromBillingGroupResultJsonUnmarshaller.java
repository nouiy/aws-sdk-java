...
/**
 * RemoveThingFromBillingGroupResult JSON Unmarshaller
 */
...
public class RemoveThingFromBillingGroupResultJsonUnmarshaller implements Unmarshaller<RemoveThingFromBillingGroupResult, JsonUnmarshallerContext> {
    ...
    public RemoveThingFromBillingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveThingFromBillingGroupResult removeThingFromBillingGroupResult = new RemoveThingFromBillingGroupResult();
