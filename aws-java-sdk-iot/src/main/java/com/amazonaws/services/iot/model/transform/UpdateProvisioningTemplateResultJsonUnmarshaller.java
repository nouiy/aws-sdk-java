...
/**
 * UpdateProvisioningTemplateResult JSON Unmarshaller
 */
...
public class UpdateProvisioningTemplateResultJsonUnmarshaller implements Unmarshaller<UpdateProvisioningTemplateResult, JsonUnmarshallerContext> {
    ...
    public UpdateProvisioningTemplateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateProvisioningTemplateResult updateProvisioningTemplateResult = new UpdateProvisioningTemplateResult();

        return updateProvisioningTemplateResult;
    }
