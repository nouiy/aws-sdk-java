...
public class ThingGroupMetadataJsonUnmarshaller implements Unmarshaller<ThingGroupMetadata, JsonUnmarshallerContext> {

    public ThingGroupMetadata unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("parentGroupName", targetDepth)) {
                    context.nextToken();
                    thingGroupMetadata.setParentGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("creationDate", targetDepth)) {
                    context.nextToken();
                    thingGroupMetadata.setCreationDate(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
