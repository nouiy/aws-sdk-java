...
public class IndexNotReadyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IndexNotReadyExceptionUnmarshaller instance;

    public static IndexNotReadyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IndexNotReadyExceptionUnmarshaller();
        return instance;
    }
}
