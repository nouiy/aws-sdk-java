...
/**
 * RateIncreaseCriteria JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RateIncreaseCriteriaJsonUnmarshaller implements Unmarshaller<RateIncreaseCriteria, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("numberOfNotifiedThings", targetDepth)) {
                    context.nextToken();
                    rateIncreaseCriteria.setNumberOfNotifiedThings(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("numberOfSucceededThings", targetDepth)) {
                    context.nextToken();
                    rateIncreaseCriteria.setNumberOfSucceededThings(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
