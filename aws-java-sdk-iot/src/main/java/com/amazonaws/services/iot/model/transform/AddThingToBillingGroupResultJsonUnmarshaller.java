...
/**
 * AddThingToBillingGroupResult JSON Unmarshaller
 */
...
public class AddThingToBillingGroupResultJsonUnmarshaller implements Unmarshaller<AddThingToBillingGroupResult, JsonUnmarshallerContext> {
    ...
    public AddThingToBillingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AddThingToBillingGroupResult addThingToBillingGroupResult = new AddThingToBillingGroupResult();
