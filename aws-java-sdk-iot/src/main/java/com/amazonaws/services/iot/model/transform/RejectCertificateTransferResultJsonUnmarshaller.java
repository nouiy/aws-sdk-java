...
public class RejectCertificateTransferResultJsonUnmarshaller implements Unmarshaller<RejectCertificateTransferResult, JsonUnmarshallerContext> {
    ...
    public RejectCertificateTransferResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RejectCertificateTransferResult rejectCertificateTransferResult = new RejectCertificateTransferResult();

        return rejectCertificateTransferResult;
    }
