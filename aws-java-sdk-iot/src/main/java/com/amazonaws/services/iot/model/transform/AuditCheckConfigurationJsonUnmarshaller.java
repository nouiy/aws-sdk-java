...
public class AuditCheckConfigurationJsonUnmarshaller implements Unmarshaller<AuditCheckConfiguration, JsonUnmarshallerContext> {

    public AuditCheckConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("enabled", targetDepth)) {
                    context.nextToken();
                    auditCheckConfiguration.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
