...
/**
 * DeleteProvisioningTemplateVersionResult JSON Unmarshaller
 */
...
public class DeleteProvisioningTemplateVersionResultJsonUnmarshaller implements Unmarshaller<DeleteProvisioningTemplateVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteProvisioningTemplateVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
