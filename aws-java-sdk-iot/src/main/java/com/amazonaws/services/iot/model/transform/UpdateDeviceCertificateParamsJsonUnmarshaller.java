...
/**
 * UpdateDeviceCertificateParams JSON Unmarshaller
 */
...
public class UpdateDeviceCertificateParamsJsonUnmarshaller implements Unmarshaller<UpdateDeviceCertificateParams, JsonUnmarshallerContext> {
    ...
    public UpdateDeviceCertificateParams unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("action", targetDepth)) {
                    context.nextToken();
                    updateDeviceCertificateParams.setAction(context.getUnmarshaller(String.class).unmarshall(context));
                }
