...
public class CancelCertificateTransferResultJsonUnmarshaller implements Unmarshaller<CancelCertificateTransferResult, JsonUnmarshallerContext> {
    ...
    public CancelCertificateTransferResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelCertificateTransferResult cancelCertificateTransferResult = new CancelCertificateTransferResult();

        return cancelCertificateTransferResult;
    }
