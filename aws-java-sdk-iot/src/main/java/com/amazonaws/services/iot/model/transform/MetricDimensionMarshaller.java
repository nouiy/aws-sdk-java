...
public class MetricDimensionMarshaller {
    ...
    public void marshall(MetricDimension metricDimension, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(metricDimension.getDimensionName(), DIMENSIONNAME_BINDING);
            protocolMarshaller.marshall(metricDimension.getOperator(), OPERATOR_BINDING);
        } catch (Exception e) {
