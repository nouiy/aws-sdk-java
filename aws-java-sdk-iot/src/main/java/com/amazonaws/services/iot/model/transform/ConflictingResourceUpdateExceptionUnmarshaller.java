...
public class ConflictingResourceUpdateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ConflictingResourceUpdateExceptionUnmarshaller instance;

    public static ConflictingResourceUpdateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConflictingResourceUpdateExceptionUnmarshaller();
        return instance;
    }
}
