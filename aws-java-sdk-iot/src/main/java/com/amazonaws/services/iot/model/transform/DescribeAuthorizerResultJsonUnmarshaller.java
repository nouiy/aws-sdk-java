...
/**
 * DescribeAuthorizerResult JSON Unmarshaller
 */
...
public class DescribeAuthorizerResultJsonUnmarshaller implements Unmarshaller<DescribeAuthorizerResult, JsonUnmarshallerContext> {
    ...
    public DescribeAuthorizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("authorizerDescription", targetDepth)) {
                    context.nextToken();
                    describeAuthorizerResult.setAuthorizerDescription(AuthorizerDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
