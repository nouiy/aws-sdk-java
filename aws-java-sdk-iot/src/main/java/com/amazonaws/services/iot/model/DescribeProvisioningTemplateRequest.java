...
public class DescribeProvisioningTemplateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeProvisioningTemplateRequest clone() {
        return (DescribeProvisioningTemplateRequest) super.clone();
    }
