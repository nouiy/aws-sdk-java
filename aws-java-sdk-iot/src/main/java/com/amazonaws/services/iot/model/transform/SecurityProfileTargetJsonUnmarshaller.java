...
public class SecurityProfileTargetJsonUnmarshaller implements Unmarshaller<SecurityProfileTarget, JsonUnmarshallerContext> {

    public SecurityProfileTarget unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    securityProfileTarget.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
