...
/**
 * MetricsExportConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricsExportConfigJsonUnmarshaller implements Unmarshaller<MetricsExportConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("mqttTopic", targetDepth)) {
                    context.nextToken();
                    metricsExportConfig.setMqttTopic(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    metricsExportConfig.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
