...
public class ThingGroupPropertiesJsonUnmarshaller implements Unmarshaller<ThingGroupProperties, JsonUnmarshallerContext> {

    public ThingGroupProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("thingGroupDescription", targetDepth)) {
                    context.nextToken();
                    thingGroupProperties.setThingGroupDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("attributePayload", targetDepth)) {
                    context.nextToken();
                    thingGroupProperties.setAttributePayload(AttributePayloadJsonUnmarshaller.getInstance().unmarshall(context));
                }
