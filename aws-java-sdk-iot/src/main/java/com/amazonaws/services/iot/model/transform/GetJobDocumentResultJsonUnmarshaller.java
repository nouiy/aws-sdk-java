...
/**
 * GetJobDocumentResult JSON Unmarshaller
 */
...
public class GetJobDocumentResultJsonUnmarshaller implements Unmarshaller<GetJobDocumentResult, JsonUnmarshallerContext> {
    ...
    public GetJobDocumentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("document", targetDepth)) {
                    context.nextToken();
                    getJobDocumentResult.setDocument(context.getUnmarshaller(String.class).unmarshall(context));
                }
