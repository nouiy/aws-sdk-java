...
/**
 * BucketsAggregationType JSON Unmarshaller
 */
...
public class BucketsAggregationTypeJsonUnmarshaller implements Unmarshaller<BucketsAggregationType, JsonUnmarshallerContext> {
    ...
    public BucketsAggregationType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("termsAggregation", targetDepth)) {
                    context.nextToken();
                    bucketsAggregationType.setTermsAggregation(TermsAggregationJsonUnmarshaller.getInstance().unmarshall(context));
                }
