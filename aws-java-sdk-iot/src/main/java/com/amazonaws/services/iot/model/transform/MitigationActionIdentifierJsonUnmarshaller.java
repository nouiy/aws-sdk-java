...
/**
 * MitigationActionIdentifier JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MitigationActionIdentifierJsonUnmarshaller implements Unmarshaller<MitigationActionIdentifier, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("actionName", targetDepth)) {
                    context.nextToken();
                    mitigationActionIdentifier.setActionName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("actionArn", targetDepth)) {
                    context.nextToken();
                    mitigationActionIdentifier.setActionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("creationDate", targetDepth)) {
                    context.nextToken();
                    mitigationActionIdentifier.setCreationDate(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
