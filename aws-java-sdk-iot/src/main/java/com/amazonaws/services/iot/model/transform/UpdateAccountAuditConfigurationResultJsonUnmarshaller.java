...
/**
 * UpdateAccountAuditConfigurationResult JSON Unmarshaller
 */
...
public class UpdateAccountAuditConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateAccountAuditConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateAccountAuditConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAccountAuditConfigurationResult updateAccountAuditConfigurationResult = new UpdateAccountAuditConfigurationResult();
