...
/**
 * DeleteAuditSuppressionResult JSON Unmarshaller
 */
...
public class DeleteAuditSuppressionResultJsonUnmarshaller implements Unmarshaller<DeleteAuditSuppressionResult, JsonUnmarshallerContext> {
    ...
    public DeleteAuditSuppressionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAuditSuppressionResult deleteAuditSuppressionResult = new DeleteAuditSuppressionResult();

        return deleteAuditSuppressionResult;
    }
