...
/**
 * ListActiveViolationsResult JSON Unmarshaller
 */
...
public class ListActiveViolationsResultJsonUnmarshaller implements Unmarshaller<ListActiveViolationsResult, JsonUnmarshallerContext> {
    ...
    public ListActiveViolationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listActiveViolationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
