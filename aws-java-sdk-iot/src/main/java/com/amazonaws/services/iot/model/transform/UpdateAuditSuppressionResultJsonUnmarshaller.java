...
/**
 * UpdateAuditSuppressionResult JSON Unmarshaller
 */
...
public class UpdateAuditSuppressionResultJsonUnmarshaller implements Unmarshaller<UpdateAuditSuppressionResult, JsonUnmarshallerContext> {
    ...
    public UpdateAuditSuppressionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAuditSuppressionResult updateAuditSuppressionResult = new UpdateAuditSuppressionResult();

        return updateAuditSuppressionResult;
    }
