...
public class VersionConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static VersionConflictExceptionUnmarshaller instance;

    public static VersionConflictExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new VersionConflictExceptionUnmarshaller();
        return instance;
    }
}
