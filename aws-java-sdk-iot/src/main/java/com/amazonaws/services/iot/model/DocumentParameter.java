...
public class DocumentParameter implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getExample() != null)
            sb.append("Example: ").append(getExample()).append(",");
        if (getOptional() != null)
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.DocumentParameterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
