...
/**
 * CreateTopicRuleDestinationResult JSON Unmarshaller
 */
...
public class CreateTopicRuleDestinationResultJsonUnmarshaller implements Unmarshaller<CreateTopicRuleDestinationResult, JsonUnmarshallerContext> {
    ...
    public CreateTopicRuleDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("topicRuleDestination", targetDepth)) {
                    context.nextToken();
                    createTopicRuleDestinationResult.setTopicRuleDestination(TopicRuleDestinationJsonUnmarshaller.getInstance().unmarshall(context));
                }
