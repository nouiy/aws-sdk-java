...
/**
 * TopicRuleDestinationConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TopicRuleDestinationConfigurationMarshaller {
    ...
    public static TopicRuleDestinationConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TopicRuleDestinationConfiguration topicRuleDestinationConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (topicRuleDestinationConfiguration == null) {
