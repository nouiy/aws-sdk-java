...
public class GetLoggingOptionsResultJsonUnmarshaller implements Unmarshaller<GetLoggingOptionsResult, JsonUnmarshallerContext> {
    ...
    public GetLoggingOptionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    getLoggingOptionsResult.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("logLevel", targetDepth)) {
                    context.nextToken();
                    getLoggingOptionsResult.setLogLevel(context.getUnmarshaller(String.class).unmarshall(context));
                }
