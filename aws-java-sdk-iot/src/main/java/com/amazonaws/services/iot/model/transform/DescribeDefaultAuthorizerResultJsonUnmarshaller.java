...
/**
 * DescribeDefaultAuthorizerResult JSON Unmarshaller
 */
...
public class DescribeDefaultAuthorizerResultJsonUnmarshaller implements Unmarshaller<DescribeDefaultAuthorizerResult, JsonUnmarshallerContext> {
    ...
    public DescribeDefaultAuthorizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("authorizerDescription", targetDepth)) {
                    context.nextToken();
                    describeDefaultAuthorizerResult.setAuthorizerDescription(AuthorizerDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
                }
