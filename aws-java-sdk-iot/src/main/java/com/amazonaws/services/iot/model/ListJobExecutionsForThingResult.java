...
public class ListJobExecutionsForThingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListJobExecutionsForThingResult withExecutionSummaries(JobExecutionSummaryForThing... executionSummaries) {
        if (this.executionSummaries == null) {
            setExecutionSummaries(new java.util.ArrayList<JobExecutionSummaryForThing>(executionSummaries.length));
        }
        for (JobExecutionSummaryForThing ele : executionSummaries) {
    ...
    public ListJobExecutionsForThingResult withExecutionSummaries(java.util.Collection<JobExecutionSummaryForThing> executionSummaries) {
    ...
    @Override
    public ListJobExecutionsForThingResult clone() {
        try {
            return (ListJobExecutionsForThingResult) super.clone();
