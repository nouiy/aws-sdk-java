...
public class AuthInfoJsonUnmarshaller implements Unmarshaller<AuthInfo, JsonUnmarshallerContext> {

    public AuthInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("actionType", targetDepth)) {
                    context.nextToken();
                    authInfo.setActionType(context.getUnmarshaller(String.class).unmarshall(context));
                }
