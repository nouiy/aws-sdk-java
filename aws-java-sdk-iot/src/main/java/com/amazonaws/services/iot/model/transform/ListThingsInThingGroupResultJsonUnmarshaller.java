...
/**
 * ListThingsInThingGroupResult JSON Unmarshaller
 */
...
public class ListThingsInThingGroupResultJsonUnmarshaller implements Unmarshaller<ListThingsInThingGroupResult, JsonUnmarshallerContext> {
    ...
    public ListThingsInThingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("things", targetDepth)) {
                    context.nextToken();
                    listThingsInThingGroupResult.setThings(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listThingsInThingGroupResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
