...
public class UpdateDomainConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the domain configuration that was updated.
     */
     ...
     * </p>
     * 
     * @return The ARN of the domain configuration that was updated.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDomainConfigurationResult == false)
            return false;
        UpdateDomainConfigurationResult other = (UpdateDomainConfigurationResult) obj;
    ...
    public UpdateDomainConfigurationResult clone() {
        try {
            return (UpdateDomainConfigurationResult) super.clone();
