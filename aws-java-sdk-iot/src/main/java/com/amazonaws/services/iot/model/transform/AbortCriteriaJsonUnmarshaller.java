...
/**
 * AbortCriteria JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AbortCriteriaJsonUnmarshaller implements Unmarshaller<AbortCriteria, JsonUnmarshallerContext> {

    public AbortCriteria unmarshall(JsonUnmarshallerContext context) throws Exception {
