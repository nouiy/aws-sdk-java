...
/**
 * UpdateEventConfigurationsResult JSON Unmarshaller
 */
...
public class UpdateEventConfigurationsResultJsonUnmarshaller implements Unmarshaller<UpdateEventConfigurationsResult, JsonUnmarshallerContext> {
    ...
    public UpdateEventConfigurationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateEventConfigurationsResult updateEventConfigurationsResult = new UpdateEventConfigurationsResult();
