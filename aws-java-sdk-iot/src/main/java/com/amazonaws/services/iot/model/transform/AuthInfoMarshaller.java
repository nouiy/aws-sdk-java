...
@SdkInternalApi
public class AuthInfoMarshaller {
    ...
    private static final AuthInfoMarshaller instance = new AuthInfoMarshaller();

    public static AuthInfoMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AuthInfo authInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(authInfo.getActionType(), ACTIONTYPE_BINDING);
            protocolMarshaller.marshall(authInfo.getResources(), RESOURCES_BINDING);
        } catch (Exception e) {
