...
public class SqlParseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SqlParseExceptionUnmarshaller instance;

    public static SqlParseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SqlParseExceptionUnmarshaller();
        return instance;
    }
}
