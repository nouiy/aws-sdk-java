...
/**
 * ListProvisioningTemplatesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListProvisioningTemplatesResultJsonUnmarshaller implements Unmarshaller<ListProvisioningTemplatesResult, JsonUnmarshallerContext> {

    public ListProvisioningTemplatesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listProvisioningTemplatesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
