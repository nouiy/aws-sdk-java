...
public class ListScheduledAuditsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListScheduledAuditsRequest clone() {
        return (ListScheduledAuditsRequest) super.clone();
    }
