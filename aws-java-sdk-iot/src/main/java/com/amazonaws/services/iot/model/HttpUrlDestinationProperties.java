...
public class HttpUrlDestinationProperties implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The URL used to confirm the HTTP topic rule destination URL.
     */
    ...
    public HttpUrlDestinationProperties clone() {
        try {
            return (HttpUrlDestinationProperties) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.HttpUrlDestinationPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
