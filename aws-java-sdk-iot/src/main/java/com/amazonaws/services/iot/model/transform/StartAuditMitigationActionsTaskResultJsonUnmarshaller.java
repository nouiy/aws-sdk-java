...
/**
 * StartAuditMitigationActionsTaskResult JSON Unmarshaller
 */
...
public class StartAuditMitigationActionsTaskResultJsonUnmarshaller implements Unmarshaller<StartAuditMitigationActionsTaskResult, JsonUnmarshallerContext> {
    ...
    public StartAuditMitigationActionsTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskId", targetDepth)) {
                    context.nextToken();
                    startAuditMitigationActionsTaskResult.setTaskId(context.getUnmarshaller(String.class).unmarshall(context));
                }
