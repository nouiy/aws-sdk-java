...
/**
 * CreateScheduledAuditResult JSON Unmarshaller
 */
...
public class CreateScheduledAuditResultJsonUnmarshaller implements Unmarshaller<CreateScheduledAuditResult, JsonUnmarshallerContext> {
    ...
    public CreateScheduledAuditResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("scheduledAuditArn", targetDepth)) {
                    context.nextToken();
                    createScheduledAuditResult.setScheduledAuditArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
