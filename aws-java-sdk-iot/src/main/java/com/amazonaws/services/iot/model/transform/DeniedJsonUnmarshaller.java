...
public class DeniedJsonUnmarshaller implements Unmarshaller<Denied, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("implicitDeny", targetDepth)) {
                    context.nextToken();
                    denied.setImplicitDeny(ImplicitDenyJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("explicitDeny", targetDepth)) {
                    context.nextToken();
                    denied.setExplicitDeny(ExplicitDenyJsonUnmarshaller.getInstance().unmarshall(context));
                }
