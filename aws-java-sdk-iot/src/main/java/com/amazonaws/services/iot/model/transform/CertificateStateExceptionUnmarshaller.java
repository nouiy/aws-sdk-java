...
public class CertificateStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CertificateStateExceptionUnmarshaller instance;

    public static CertificateStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CertificateStateExceptionUnmarshaller();
        return instance;
    }
}
