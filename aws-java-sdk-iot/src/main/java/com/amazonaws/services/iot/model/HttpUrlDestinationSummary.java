...
public class HttpUrlDestinationSummary implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The URL used to confirm ownership of or access to the HTTP topic rule destination URL.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HttpUrlDestinationSummary == false)
            return false;
        HttpUrlDestinationSummary other = (HttpUrlDestinationSummary) obj;
    ...
    public HttpUrlDestinationSummary clone() {
        try {
            return (HttpUrlDestinationSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.HttpUrlDestinationSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
