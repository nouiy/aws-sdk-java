...
/**
 * DeleteTopicRuleDestinationResult JSON Unmarshaller
 */
...
public class DeleteTopicRuleDestinationResultJsonUnmarshaller implements Unmarshaller<DeleteTopicRuleDestinationResult, JsonUnmarshallerContext> {
    ...
    public DeleteTopicRuleDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTopicRuleDestinationResult deleteTopicRuleDestinationResult = new DeleteTopicRuleDestinationResult();

        return deleteTopicRuleDestinationResult;
    }
