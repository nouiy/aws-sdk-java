...
/**
 * LogTargetConfigurationMarshaller
 */
...
public class LogTargetConfigurationMarshaller {
    ...
    public void marshall(LogTargetConfiguration logTargetConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(logTargetConfiguration.getLogTarget(), LOGTARGET_BINDING);
            protocolMarshaller.marshall(logTargetConfiguration.getLogLevel(), LOGLEVEL_BINDING);
        } catch (Exception e) {
