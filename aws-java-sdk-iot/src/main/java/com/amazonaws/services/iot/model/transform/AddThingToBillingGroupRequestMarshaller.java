...
@SdkInternalApi
public class AddThingToBillingGroupRequestMarshaller {
    ...
    private static final AddThingToBillingGroupRequestMarshaller instance = new AddThingToBillingGroupRequestMarshaller();

    public static AddThingToBillingGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddThingToBillingGroupRequest addThingToBillingGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(addThingToBillingGroupRequest.getBillingGroupName(), BILLINGGROUPNAME_BINDING);
            protocolMarshaller.marshall(addThingToBillingGroupRequest.getBillingGroupArn(), BILLINGGROUPARN_BINDING);
            protocolMarshaller.marshall(addThingToBillingGroupRequest.getThingName(), THINGNAME_BINDING);
            protocolMarshaller.marshall(addThingToBillingGroupRequest.getThingArn(), THINGARN_BINDING);
        } catch (Exception e) {
