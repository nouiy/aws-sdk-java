...
/**
 * UpdateTopicRuleDestinationResult JSON Unmarshaller
 */
...
public class UpdateTopicRuleDestinationResultJsonUnmarshaller implements Unmarshaller<UpdateTopicRuleDestinationResult, JsonUnmarshallerContext> {
    ...
    public UpdateTopicRuleDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateTopicRuleDestinationResult updateTopicRuleDestinationResult = new UpdateTopicRuleDestinationResult();

        return updateTopicRuleDestinationResult;
    }
