...
/**
 * SecurityProfileIdentifierMarshaller
 */
...
public class SecurityProfileIdentifierMarshaller {
    ...
    public void marshall(SecurityProfileIdentifier securityProfileIdentifier, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(securityProfileIdentifier.getName(), NAME_BINDING);
            protocolMarshaller.marshall(securityProfileIdentifier.getArn(), ARN_BINDING);
        } catch (Exception e) {
