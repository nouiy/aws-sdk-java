...
/**
 * HttpAuthorization JSON Unmarshaller
 */
...
public class HttpAuthorizationJsonUnmarshaller implements Unmarshaller<HttpAuthorization, JsonUnmarshallerContext> {
    ...
    public HttpAuthorization unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("sigv4", targetDepth)) {
                    context.nextToken();
                    httpAuthorization.setSigv4(SigV4AuthorizationJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static HttpAuthorizationJsonUnmarshaller instance;
