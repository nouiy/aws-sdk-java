...
public class AttachSecurityProfileRequestMarshaller {
    ...
    private static final AttachSecurityProfileRequestMarshaller instance = new AttachSecurityProfileRequestMarshaller();

    public static AttachSecurityProfileRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AttachSecurityProfileRequest attachSecurityProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attachSecurityProfileRequest.getSecurityProfileName(), SECURITYPROFILENAME_BINDING);
            protocolMarshaller.marshall(attachSecurityProfileRequest.getSecurityProfileTargetArn(), SECURITYPROFILETARGETARN_BINDING);
        } catch (Exception e) {
