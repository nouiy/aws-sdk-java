...
/**
 * DescribeEventConfigurationsResult JSON Unmarshaller
 */
...
public class DescribeEventConfigurationsResultJsonUnmarshaller implements Unmarshaller<DescribeEventConfigurationsResult, JsonUnmarshallerContext> {
    ...
    public DescribeEventConfigurationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("eventConfigurations", targetDepth)) {
                    context.nextToken();
                    describeEventConfigurationsResult.setEventConfigurations(new MapUnmarshaller<String, Configuration>(context.getUnmarshaller(String.class),
