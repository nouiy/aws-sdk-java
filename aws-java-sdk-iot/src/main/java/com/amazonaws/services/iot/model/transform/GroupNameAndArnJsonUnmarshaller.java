...
public class GroupNameAndArnJsonUnmarshaller implements Unmarshaller<GroupNameAndArn, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("groupName", targetDepth)) {
                    context.nextToken();
                    groupNameAndArn.setGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("groupArn", targetDepth)) {
                    context.nextToken();
                    groupNameAndArn.setGroupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
