...
public class ResourceRegistrationFailureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceRegistrationFailureExceptionUnmarshaller instance;

    public static ResourceRegistrationFailureExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceRegistrationFailureExceptionUnmarshaller();
        return instance;
    }
}
