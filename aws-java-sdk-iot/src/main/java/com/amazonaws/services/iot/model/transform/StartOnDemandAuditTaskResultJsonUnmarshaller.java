...
/**
 * StartOnDemandAuditTaskResult JSON Unmarshaller
 */
...
public class StartOnDemandAuditTaskResultJsonUnmarshaller implements Unmarshaller<StartOnDemandAuditTaskResult, JsonUnmarshallerContext> {
    ...
    public StartOnDemandAuditTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("taskId", targetDepth)) {
                    context.nextToken();
                    startOnDemandAuditTaskResult.setTaskId(context.getUnmarshaller(String.class).unmarshall(context));
                }
