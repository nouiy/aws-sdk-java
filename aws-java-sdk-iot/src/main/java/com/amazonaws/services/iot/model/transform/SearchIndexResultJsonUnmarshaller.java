...
/**
 * SearchIndexResult JSON Unmarshaller
 */
...
public class SearchIndexResultJsonUnmarshaller implements Unmarshaller<SearchIndexResult, JsonUnmarshallerContext> {
    ...
    public SearchIndexResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    searchIndexResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
