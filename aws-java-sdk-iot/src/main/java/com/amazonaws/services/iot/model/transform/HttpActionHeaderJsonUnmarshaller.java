...
/**
 * HttpActionHeader JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HttpActionHeaderJsonUnmarshaller implements Unmarshaller<HttpActionHeader, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("key", targetDepth)) {
                    context.nextToken();
                    httpActionHeader.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("value", targetDepth)) {
                    context.nextToken();
                    httpActionHeader.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
