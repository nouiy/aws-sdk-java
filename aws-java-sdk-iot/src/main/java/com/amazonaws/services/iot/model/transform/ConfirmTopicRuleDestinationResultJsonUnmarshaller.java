...
/**
 * ConfirmTopicRuleDestinationResult JSON Unmarshaller
 */
...
public class ConfirmTopicRuleDestinationResultJsonUnmarshaller implements Unmarshaller<ConfirmTopicRuleDestinationResult, JsonUnmarshallerContext> {
    ...
    public ConfirmTopicRuleDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ConfirmTopicRuleDestinationResult confirmTopicRuleDestinationResult = new ConfirmTopicRuleDestinationResult();

        return confirmTopicRuleDestinationResult;
    }
