...
public class MitigationAction implements Serializable, Cloneable, StructuredPojo {
    ...
    public MitigationAction clone() {
        try {
            return (MitigationAction) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.MitigationActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
