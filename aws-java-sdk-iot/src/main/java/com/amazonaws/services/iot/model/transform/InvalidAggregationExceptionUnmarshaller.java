...
public class InvalidAggregationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidAggregationExceptionUnmarshaller instance;

    public static InvalidAggregationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidAggregationExceptionUnmarshaller();
        return instance;
    }
}
