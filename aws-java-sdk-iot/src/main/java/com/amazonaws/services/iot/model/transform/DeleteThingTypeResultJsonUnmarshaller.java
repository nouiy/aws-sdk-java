...
/**
 * DeleteThingTypeResult JSON Unmarshaller
 */
...
public class DeleteThingTypeResultJsonUnmarshaller implements Unmarshaller<DeleteThingTypeResult, JsonUnmarshallerContext> {
    ...
    public DeleteThingTypeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteThingTypeResult deleteThingTypeResult = new DeleteThingTypeResult();
