...
/**
 * ListProvisioningTemplateVersionsResult JSON Unmarshaller
 */
...
public class ListProvisioningTemplateVersionsResultJsonUnmarshaller implements Unmarshaller<ListProvisioningTemplateVersionsResult, JsonUnmarshallerContext> {
    ...
    public ListProvisioningTemplateVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listProvisioningTemplateVersionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
