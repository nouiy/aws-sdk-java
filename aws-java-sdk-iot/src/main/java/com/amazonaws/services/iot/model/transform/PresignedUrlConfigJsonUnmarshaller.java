...
public class PresignedUrlConfigJsonUnmarshaller implements Unmarshaller<PresignedUrlConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    presignedUrlConfig.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
