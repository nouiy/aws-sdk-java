...
/**
 * AuditSuppressionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AuditSuppressionMarshaller {
    ...
    private static final AuditSuppressionMarshaller instance = new AuditSuppressionMarshaller();

    public static AuditSuppressionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AuditSuppression auditSuppression, ProtocolMarshaller protocolMarshaller) {

        if (auditSuppression == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(auditSuppression.getCheckName(), CHECKNAME_BINDING);
            protocolMarshaller.marshall(auditSuppression.getResourceIdentifier(), RESOURCEIDENTIFIER_BINDING);
            protocolMarshaller.marshall(auditSuppression.getExpirationDate(), EXPIRATIONDATE_BINDING);
            protocolMarshaller.marshall(auditSuppression.getSuppressIndefinitely(), SUPPRESSINDEFINITELY_BINDING);
            protocolMarshaller.marshall(auditSuppression.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
