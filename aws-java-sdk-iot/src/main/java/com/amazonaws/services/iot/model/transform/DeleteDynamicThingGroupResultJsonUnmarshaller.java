...
/**
 * DeleteDynamicThingGroupResult JSON Unmarshaller
 */
...
public class DeleteDynamicThingGroupResultJsonUnmarshaller implements Unmarshaller<DeleteDynamicThingGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteDynamicThingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDynamicThingGroupResult deleteDynamicThingGroupResult = new DeleteDynamicThingGroupResult();
