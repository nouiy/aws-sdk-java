...
/**
 * StopThingRegistrationTaskResult JSON Unmarshaller
 */
...
public class StopThingRegistrationTaskResultJsonUnmarshaller implements Unmarshaller<StopThingRegistrationTaskResult, JsonUnmarshallerContext> {
    ...
    public StopThingRegistrationTaskResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopThingRegistrationTaskResult stopThingRegistrationTaskResult = new StopThingRegistrationTaskResult();
