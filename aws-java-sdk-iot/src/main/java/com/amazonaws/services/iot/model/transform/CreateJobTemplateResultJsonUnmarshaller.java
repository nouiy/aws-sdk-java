        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("jobTemplateArn", targetDepth)) {
                    context.nextToken();
                    createJobTemplateResult.setJobTemplateArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("jobTemplateId", targetDepth)) {
                    context.nextToken();
                    createJobTemplateResult.setJobTemplateId(context.getUnmarshaller(String.class).unmarshall(context));
                }
