...
/**
 * TopicRuleDestinationSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TopicRuleDestinationSummaryMarshaller {
    ...
    public static TopicRuleDestinationSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TopicRuleDestinationSummary topicRuleDestinationSummary, ProtocolMarshaller protocolMarshaller) {

        if (topicRuleDestinationSummary == null) {
