...
/**
 * RemoveThingFromThingGroupResult JSON Unmarshaller
 */
...
public class RemoveThingFromThingGroupResultJsonUnmarshaller implements Unmarshaller<RemoveThingFromThingGroupResult, JsonUnmarshallerContext> {
    ...
    public RemoveThingFromThingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveThingFromThingGroupResult removeThingFromThingGroupResult = new RemoveThingFromThingGroupResult();
