...
public class CreateBillingGroupRequestMarshaller {
    ...
    public void marshall(CreateBillingGroupRequest createBillingGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBillingGroupRequest.getBillingGroupName(), BILLINGGROUPNAME_BINDING);
            protocolMarshaller.marshall(createBillingGroupRequest.getBillingGroupProperties(), BILLINGGROUPPROPERTIES_BINDING);
