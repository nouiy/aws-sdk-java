...
/**
 * UpdateRoleAliasRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateRoleAliasRequestMarshaller {
    ...
    private static final UpdateRoleAliasRequestMarshaller instance = new UpdateRoleAliasRequestMarshaller();

    public static UpdateRoleAliasRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateRoleAliasRequest updateRoleAliasRequest, ProtocolMarshaller protocolMarshaller) {
