...
/**
 * MetricToRetain JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricToRetainJsonUnmarshaller implements Unmarshaller<MetricToRetain, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("metric", targetDepth)) {
                    context.nextToken();
                    metricToRetain.setMetric(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("metricDimension", targetDepth)) {
                    context.nextToken();
                    metricToRetain.setMetricDimension(MetricDimensionJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("exportMetric", targetDepth)) {
                    context.nextToken();
                    metricToRetain.setExportMetric(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
