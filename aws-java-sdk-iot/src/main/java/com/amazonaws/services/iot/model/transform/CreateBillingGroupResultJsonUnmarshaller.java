...
/**
 * CreateBillingGroupResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("billingGroupName", targetDepth)) {
                    context.nextToken();
                    createBillingGroupResult.setBillingGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("billingGroupArn", targetDepth)) {
                    context.nextToken();
                    createBillingGroupResult.setBillingGroupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("billingGroupId", targetDepth)) {
                    context.nextToken();
                    createBillingGroupResult.setBillingGroupId(context.getUnmarshaller(String.class).unmarshall(context));
                }
