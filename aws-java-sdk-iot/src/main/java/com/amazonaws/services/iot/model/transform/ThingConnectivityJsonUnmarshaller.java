...
/**
 * ThingConnectivity JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ThingConnectivityJsonUnmarshaller implements Unmarshaller<ThingConnectivity, JsonUnmarshallerContext> {

    public ThingConnectivity unmarshall(JsonUnmarshallerContext context) throws Exception {
