...
public class DetachPolicyRequestMarshaller {
    ...
    public void marshall(DetachPolicyRequest detachPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(detachPolicyRequest.getPolicyName(), POLICYNAME_BINDING);
            protocolMarshaller.marshall(detachPolicyRequest.getTarget(), TARGET_BINDING);
        } catch (Exception e) {
