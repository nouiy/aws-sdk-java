...
/**
 * ValidateSecurityProfileBehaviorsResult JSON Unmarshaller
 */
...
public class ValidateSecurityProfileBehaviorsResultJsonUnmarshaller implements Unmarshaller<ValidateSecurityProfileBehaviorsResult, JsonUnmarshallerContext> {
    ...
    public ValidateSecurityProfileBehaviorsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("valid", targetDepth)) {
                    context.nextToken();
                    validateSecurityProfileBehaviorsResult.setValid(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
