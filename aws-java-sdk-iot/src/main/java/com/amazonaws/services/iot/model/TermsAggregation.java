...
public class TermsAggregation implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The number of buckets to return in the response. Default to 10.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getMaxBuckets() == null ^ this.getMaxBuckets() == null)
            return false;
        if (other.getMaxBuckets() != null && other.getMaxBuckets().equals(this.getMaxBuckets()) == false)
            return false;
        return true;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iot.model.transform.TermsAggregationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
