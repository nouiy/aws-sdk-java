...
public class ThingGroupIndexingConfigurationJsonUnmarshaller implements Unmarshaller<ThingGroupIndexingConfiguration, JsonUnmarshallerContext> {

    public ThingGroupIndexingConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
