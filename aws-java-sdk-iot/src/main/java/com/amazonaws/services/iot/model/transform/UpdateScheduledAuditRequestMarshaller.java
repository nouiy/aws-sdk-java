...
/**
 * UpdateScheduledAuditRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateScheduledAuditRequestMarshaller {
    ...
    private static final UpdateScheduledAuditRequestMarshaller instance = new UpdateScheduledAuditRequestMarshaller();

    public static UpdateScheduledAuditRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(UpdateScheduledAuditRequest updateScheduledAuditRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateScheduledAuditRequest.getFrequency(), FREQUENCY_BINDING);
            protocolMarshaller.marshall(updateScheduledAuditRequest.getDayOfMonth(), DAYOFMONTH_BINDING);
            protocolMarshaller.marshall(updateScheduledAuditRequest.getDayOfWeek(), DAYOFWEEK_BINDING);
            protocolMarshaller.marshall(updateScheduledAuditRequest.getTargetCheckNames(), TARGETCHECKNAMES_BINDING);
            protocolMarshaller.marshall(updateScheduledAuditRequest.getScheduledAuditName(), SCHEDULEDAUDITNAME_BINDING);
        } catch (Exception e) {
