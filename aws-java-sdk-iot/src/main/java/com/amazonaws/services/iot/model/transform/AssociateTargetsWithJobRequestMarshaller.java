...
public class AssociateTargetsWithJobRequestMarshaller {
    ...
    public static AssociateTargetsWithJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociateTargetsWithJobRequest associateTargetsWithJobRequest, ProtocolMarshaller protocolMarshaller) {
