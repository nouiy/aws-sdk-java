...
/**
 * ListSecurityProfilesResult JSON Unmarshaller
 */
...
public class ListSecurityProfilesResultJsonUnmarshaller implements Unmarshaller<ListSecurityProfilesResult, JsonUnmarshallerContext> {
    ...
    public ListSecurityProfilesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("securityProfileIdentifiers", targetDepth)) {
                    context.nextToken();
                    listSecurityProfilesResult.setSecurityProfileIdentifiers(new ListUnmarshaller<SecurityProfileIdentifier>(
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listSecurityProfilesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
