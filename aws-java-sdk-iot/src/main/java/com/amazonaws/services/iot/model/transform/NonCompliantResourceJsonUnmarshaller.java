...
public class NonCompliantResourceJsonUnmarshaller implements Unmarshaller<NonCompliantResource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("resourceType", targetDepth)) {
                    context.nextToken();
                    nonCompliantResource.setResourceType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("resourceIdentifier", targetDepth)) {
                    context.nextToken();
                    nonCompliantResource.setResourceIdentifier(ResourceIdentifierJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("additionalInfo", targetDepth)) {
                    context.nextToken();
                    nonCompliantResource.setAdditionalInfo(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
