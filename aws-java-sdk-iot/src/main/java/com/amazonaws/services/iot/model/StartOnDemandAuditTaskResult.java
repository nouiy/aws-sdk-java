...
public class StartOnDemandAuditTaskResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the on-demand audit you started.
     */
    ...
    public StartOnDemandAuditTaskResult clone() {
        try {
            return (StartOnDemandAuditTaskResult) super.clone();
