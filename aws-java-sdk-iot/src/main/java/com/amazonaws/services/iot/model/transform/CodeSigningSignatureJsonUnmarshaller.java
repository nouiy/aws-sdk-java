...
public class CodeSigningSignatureJsonUnmarshaller implements Unmarshaller<CodeSigningSignature, JsonUnmarshallerContext> {

    public CodeSigningSignature unmarshall(JsonUnmarshallerContext context) throws Exception {
