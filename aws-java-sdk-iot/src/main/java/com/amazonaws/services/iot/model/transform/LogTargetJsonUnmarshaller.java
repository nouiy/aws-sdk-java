...
public class LogTargetJsonUnmarshaller implements Unmarshaller<LogTarget, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("targetType", targetDepth)) {
                    context.nextToken();
                    logTarget.setTargetType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("targetName", targetDepth)) {
                    context.nextToken();
                    logTarget.setTargetName(context.getUnmarshaller(String.class).unmarshall(context));
                }
