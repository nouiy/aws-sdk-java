...
public class DeleteAuditSuppressionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteAuditSuppressionRequest withResourceIdentifier(ResourceIdentifier resourceIdentifier) {
    ...
    @Override
    public DeleteAuditSuppressionRequest clone() {
        return (DeleteAuditSuppressionRequest) super.clone();
    }
