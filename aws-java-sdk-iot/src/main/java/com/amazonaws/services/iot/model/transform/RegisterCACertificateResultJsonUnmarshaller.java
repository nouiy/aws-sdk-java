...
public class RegisterCACertificateResultJsonUnmarshaller implements Unmarshaller<RegisterCACertificateResult, JsonUnmarshallerContext> {
    ...
    public RegisterCACertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("certificateArn", targetDepth)) {
                    context.nextToken();
                    registerCACertificateResult.setCertificateArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("certificateId", targetDepth)) {
                    context.nextToken();
                    registerCACertificateResult.setCertificateId(context.getUnmarshaller(String.class).unmarshall(context));
                }
