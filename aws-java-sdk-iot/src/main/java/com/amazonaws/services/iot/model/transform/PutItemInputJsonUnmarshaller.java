...
public class PutItemInputJsonUnmarshaller implements Unmarshaller<PutItemInput, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tableName", targetDepth)) {
                    context.nextToken();
                    putItemInput.setTableName(context.getUnmarshaller(String.class).unmarshall(context));
                }
