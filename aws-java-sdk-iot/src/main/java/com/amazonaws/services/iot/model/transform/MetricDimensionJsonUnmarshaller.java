        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("dimensionName", targetDepth)) {
                    context.nextToken();
                    metricDimension.setDimensionName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("operator", targetDepth)) {
                    context.nextToken();
                    metricDimension.setOperator(context.getUnmarshaller(String.class).unmarshall(context));
                }
