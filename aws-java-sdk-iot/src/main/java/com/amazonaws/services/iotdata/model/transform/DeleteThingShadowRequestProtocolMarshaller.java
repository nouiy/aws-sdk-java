...
public class DeleteThingShadowRequestProtocolMarshaller implements Marshaller<Request<DeleteThingShadowRequest>, DeleteThingShadowRequest> {
    ...
    public DeleteThingShadowRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DeleteThingShadowRequest> marshall(DeleteThingShadowRequest deleteThingShadowRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DeleteThingShadowRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    deleteThingShadowRequest);

            protocolMarshaller.startMarshalling();
            DeleteThingShadowRequestMarshaller.getInstance().marshall(deleteThingShadowRequest, protocolMarshaller);
