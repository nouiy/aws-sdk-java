...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplaceagreement.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.marketplaceagreement.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplaceagreement.model.ValidationException validationException = new com.amazonaws.services.marketplaceagreement.model.ValidationException(
                null);
