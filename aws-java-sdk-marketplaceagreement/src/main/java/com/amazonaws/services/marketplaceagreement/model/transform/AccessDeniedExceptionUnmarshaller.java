...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplaceagreement.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.marketplaceagreement.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplaceagreement.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.marketplaceagreement.model.AccessDeniedException(
                null);
