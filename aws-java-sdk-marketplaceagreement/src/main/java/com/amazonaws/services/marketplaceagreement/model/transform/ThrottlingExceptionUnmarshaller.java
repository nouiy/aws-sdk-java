...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplaceagreement.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.marketplaceagreement.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplaceagreement.model.ThrottlingException throttlingException = new com.amazonaws.services.marketplaceagreement.model.ThrottlingException(
                null);
