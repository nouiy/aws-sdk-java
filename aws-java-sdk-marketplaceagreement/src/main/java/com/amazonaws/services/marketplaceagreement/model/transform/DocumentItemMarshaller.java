...
public class DocumentItemMarshaller {
    ...
    public void marshall(DocumentItem documentItem, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(documentItem.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(documentItem.getUrl(), URL_BINDING);
            protocolMarshaller.marshall(documentItem.getVersion(), VERSION_BINDING);
        } catch (Exception e) {
