...
/**
 * UpdatePublishingDestinationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePublishingDestinationResultJsonUnmarshaller implements Unmarshaller<UpdatePublishingDestinationResult, JsonUnmarshallerContext> {

    public UpdatePublishingDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
