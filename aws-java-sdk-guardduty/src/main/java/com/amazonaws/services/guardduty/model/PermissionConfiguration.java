 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/PermissionConfiguration" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PermissionConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public PermissionConfiguration withBucketLevelPermissions(BucketLevelPermissions bucketLevelPermissions) {
    ...
    public PermissionConfiguration withAccountLevelPermissions(AccountLevelPermissions accountLevelPermissions) {
    ...
    public String toString() {
        ...
        if (getBucketLevelPermissions() != null)
            sb.append("BucketLevelPermissions: ").append(getBucketLevelPermissions()).append(",");
        if (getAccountLevelPermissions() != null)
            sb.append("AccountLevelPermissions: ").append(getAccountLevelPermissions());
        sb.append("}");
        return sb.toString();
    }
    ...
    @Override
    public PermissionConfiguration clone() {
        try {
            return (PermissionConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.PermissionConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
