...
/**
 * RemotePortDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RemotePortDetailsJsonUnmarshaller implements Unmarshaller<RemotePortDetails, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("port", targetDepth)) {
                    context.nextToken();
                    remotePortDetails.setPort(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("portName", targetDepth)) {
                    context.nextToken();
                    remotePortDetails.setPortName(context.getUnmarshaller(String.class).unmarshall(context));
                }
