...
/**
 * RemotePortDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RemotePortDetailsMarshaller {
    ...
    private static final RemotePortDetailsMarshaller instance = new RemotePortDetailsMarshaller();

    public static RemotePortDetailsMarshaller getInstance() {
        return instance;
    }
