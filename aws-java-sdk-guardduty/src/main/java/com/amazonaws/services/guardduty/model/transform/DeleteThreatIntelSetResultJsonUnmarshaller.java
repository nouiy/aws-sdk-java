...
/**
 * DeleteThreatIntelSetResult JSON Unmarshaller
 */
...
public class DeleteThreatIntelSetResultJsonUnmarshaller implements Unmarshaller<DeleteThreatIntelSetResult, JsonUnmarshallerContext> {
    ...
    public DeleteThreatIntelSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteThreatIntelSetResult deleteThreatIntelSetResult = new DeleteThreatIntelSetResult();
