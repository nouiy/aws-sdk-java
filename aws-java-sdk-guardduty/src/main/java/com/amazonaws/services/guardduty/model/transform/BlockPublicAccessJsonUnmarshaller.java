...
/**
 * BlockPublicAccess JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BlockPublicAccessJsonUnmarshaller implements Unmarshaller<BlockPublicAccess, JsonUnmarshallerContext> {

    public BlockPublicAccess unmarshall(JsonUnmarshallerContext context) throws Exception {
        BlockPublicAccess blockPublicAccess = new BlockPublicAccess();
    ...
    private static BlockPublicAccessJsonUnmarshaller instance;

    public static BlockPublicAccessJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BlockPublicAccessJsonUnmarshaller();
        return instance;
    }
}
