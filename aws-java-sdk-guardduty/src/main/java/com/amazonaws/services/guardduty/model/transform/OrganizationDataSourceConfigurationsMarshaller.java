...
/**
 * OrganizationDataSourceConfigurationsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OrganizationDataSourceConfigurationsMarshaller {
    ...
    public static OrganizationDataSourceConfigurationsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OrganizationDataSourceConfigurations organizationDataSourceConfigurations, ProtocolMarshaller protocolMarshaller) {

        if (organizationDataSourceConfigurations == null) {
