...
/**
 * RdsDbUserDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RdsDbUserDetailsJsonUnmarshaller implements Unmarshaller<RdsDbUserDetails, JsonUnmarshallerContext> {

    public RdsDbUserDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        RdsDbUserDetails rdsDbUserDetails = new RdsDbUserDetails();
    ...
    private static RdsDbUserDetailsJsonUnmarshaller instance;

    public static RdsDbUserDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RdsDbUserDetailsJsonUnmarshaller();
        return instance;
    }
}
