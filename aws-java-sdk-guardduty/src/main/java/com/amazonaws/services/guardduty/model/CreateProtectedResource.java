 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/CreateProtectedResource" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateProtectedResource implements Serializable, Cloneable, StructuredPojo {
    ...
    public CreateS3BucketResource getS3Bucket() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateProtectedResource == false)
            return false;
    ...
    public CreateProtectedResource clone() {
        try {
            return (CreateProtectedResource) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.CreateProtectedResourceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
