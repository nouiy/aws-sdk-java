...
public class DeletePublishingDestinationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique ID of the detector associated with the publishing destination to delete.
     */
     ...
     * </p>
     * 
     * @return The ID of the publishing destination to delete.
     */
    ...
    @Override
    public DeletePublishingDestinationRequest clone() {
        return (DeletePublishingDestinationRequest) super.clone();
    }
