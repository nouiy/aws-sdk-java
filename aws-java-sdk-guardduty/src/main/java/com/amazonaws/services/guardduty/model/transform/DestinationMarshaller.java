...
public class DestinationMarshaller {
    ...
    public void marshall(Destination destination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(destination.getDestinationId(), DESTINATIONID_BINDING);
            protocolMarshaller.marshall(destination.getDestinationType(), DESTINATIONTYPE_BINDING);
