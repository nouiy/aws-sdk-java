...
public class StopMonitoringMembersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of account IDs for the member accounts to stop monitoring.
     */
    ...
    @Override
    public StopMonitoringMembersRequest clone() {
        return (StopMonitoringMembersRequest) super.clone();
    }
