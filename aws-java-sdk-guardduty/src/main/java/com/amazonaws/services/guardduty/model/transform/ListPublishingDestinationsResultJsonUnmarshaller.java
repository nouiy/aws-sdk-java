...
/**
 * ListPublishingDestinationsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListPublishingDestinationsResultJsonUnmarshaller implements Unmarshaller<ListPublishingDestinationsResult, JsonUnmarshallerContext> {

    public ListPublishingDestinationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listPublishingDestinationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
