        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("destinationId", targetDepth)) {
                    context.nextToken();
                    destination.setDestinationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("destinationType", targetDepth)) {
                    context.nextToken();
                    destination.setDestinationType(context.getUnmarshaller(String.class).unmarshall(context));
                }
