...
public class DeleteFilterRequestMarshaller {
    ...
    public void marshall(DeleteFilterRequest deleteFilterRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteFilterRequest.getDetectorId(), DETECTORID_BINDING);
            protocolMarshaller.marshall(deleteFilterRequest.getFilterName(), FILTERNAME_BINDING);
        } catch (Exception e) {
