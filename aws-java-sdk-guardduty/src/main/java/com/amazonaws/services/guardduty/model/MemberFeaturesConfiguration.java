 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/guardduty-2017-11-28/MemberFeaturesConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MemberFeaturesConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public MemberFeaturesConfiguration withName(String name) {
        setName(name);
        return this;
    }
    ...
    public MemberFeaturesConfiguration withName(OrgFeature name) {
    ...
    public MemberFeaturesConfiguration withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public MemberFeaturesConfiguration withStatus(FeatureStatus status) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MemberFeaturesConfiguration == false)
            return false;
        MemberFeaturesConfiguration other = (MemberFeaturesConfiguration) obj;
    ...
    @Override
    public MemberFeaturesConfiguration clone() {
        try {
            return (MemberFeaturesConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.guardduty.model.transform.MemberFeaturesConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
