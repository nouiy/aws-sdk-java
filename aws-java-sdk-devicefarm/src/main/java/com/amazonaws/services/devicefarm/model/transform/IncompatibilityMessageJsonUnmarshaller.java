...
public class IncompatibilityMessageJsonUnmarshaller implements Unmarshaller<IncompatibilityMessage, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("message", targetDepth)) {
                    context.nextToken();
                    incompatibilityMessage.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("type", targetDepth)) {
                    context.nextToken();
                    incompatibilityMessage.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static IncompatibilityMessageJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncompatibilityMessageJsonUnmarshaller();
        return instance;
    }
}
