...
public class GetVPCEConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVPCEConfigurationResult == false)
            return false;
        GetVPCEConfigurationResult other = (GetVPCEConfigurationResult) obj;
    ...
    @Override
    public GetVPCEConfigurationResult clone() {
        try {
            return (GetVPCEConfigurationResult) super.clone();
