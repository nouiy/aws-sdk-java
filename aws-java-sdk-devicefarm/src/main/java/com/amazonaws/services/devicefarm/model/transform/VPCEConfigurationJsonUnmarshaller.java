...
public class VPCEConfigurationJsonUnmarshaller implements Unmarshaller<VPCEConfiguration, JsonUnmarshallerContext> {

    public VPCEConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        VPCEConfiguration vPCEConfiguration = new VPCEConfiguration();
    ...
    private static VPCEConfigurationJsonUnmarshaller instance;

    public static VPCEConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VPCEConfigurationJsonUnmarshaller();
        return instance;
    }
}
