...
/**
 * DeleteNetworkProfileResult JSON Unmarshaller
 */
...
public class DeleteNetworkProfileResultJsonUnmarshaller implements Unmarshaller<DeleteNetworkProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteNetworkProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteNetworkProfileResult deleteNetworkProfileResult = new DeleteNetworkProfileResult();
