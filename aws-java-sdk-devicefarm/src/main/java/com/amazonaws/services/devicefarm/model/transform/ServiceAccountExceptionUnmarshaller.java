...
public class ServiceAccountExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ServiceAccountExceptionUnmarshaller instance;

    public static ServiceAccountExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServiceAccountExceptionUnmarshaller();
        return instance;
    }
}
