...
/**
 * Fluent builder for {@link com.amazonaws.services.devicefarm.AWSDeviceFarmAsync}. Use of the builder is preferred over
 * using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AWSDeviceFarmAsyncClientBuilder extends AwsAsyncClientBuilder<AWSDeviceFarmAsyncClientBuilder, AWSDeviceFarmAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSDeviceFarmAsync using the current builder configuration.
     *
     * @param params
