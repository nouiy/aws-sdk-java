...
/**
 * DeviceSelectionResultMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeviceSelectionResultMarshaller {

    private static final MarshallingInfo<List> FILTERS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("filters").build();
    private static final MarshallingInfo<Integer> MATCHEDDEVICESCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("matchedDevicesCount").build();
    ...
    private static final DeviceSelectionResultMarshaller instance = new DeviceSelectionResultMarshaller();

    public static DeviceSelectionResultMarshaller getInstance() {
        return instance;
    }
