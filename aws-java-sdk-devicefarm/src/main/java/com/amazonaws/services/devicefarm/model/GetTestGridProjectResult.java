...
public class GetTestGridProjectResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTestGridProjectResult == false)
            return false;
        GetTestGridProjectResult other = (GetTestGridProjectResult) obj;
    ...
    @Override
    public GetTestGridProjectResult clone() {
        try {
            return (GetTestGridProjectResult) super.clone();
