...
@SdkInternalApi
public class GetOfferingStatusRequestMarshaller {

    private static final MarshallingInfo<String> NEXTTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("nextToken").build();

    private static final GetOfferingStatusRequestMarshaller instance = new GetOfferingStatusRequestMarshaller();

    public static GetOfferingStatusRequestMarshaller getInstance() {
        return instance;
    }
