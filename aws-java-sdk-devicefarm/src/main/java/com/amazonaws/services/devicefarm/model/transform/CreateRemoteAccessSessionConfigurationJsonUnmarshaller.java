...
public class CreateRemoteAccessSessionConfigurationJsonUnmarshaller implements Unmarshaller<CreateRemoteAccessSessionConfiguration, JsonUnmarshallerContext> {
    ...
    private static CreateRemoteAccessSessionConfigurationJsonUnmarshaller instance;

    public static CreateRemoteAccessSessionConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateRemoteAccessSessionConfigurationJsonUnmarshaller();
        return instance;
    }
}
