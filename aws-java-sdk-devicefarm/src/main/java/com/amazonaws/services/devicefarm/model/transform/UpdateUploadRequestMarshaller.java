...
/**
 * UpdateUploadRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateUploadRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> EDITCONTENT_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("editContent").build();

    private static final UpdateUploadRequestMarshaller instance = new UpdateUploadRequestMarshaller();

    public static UpdateUploadRequestMarshaller getInstance() {
        return instance;
    }
