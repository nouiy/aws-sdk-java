...
public class CreateUploadResultJsonUnmarshaller implements Unmarshaller<CreateUploadResult, JsonUnmarshallerContext> {

    public CreateUploadResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("upload", targetDepth)) {
                    context.nextToken();
                    createUploadResult.setUpload(UploadJsonUnmarshaller.getInstance().unmarshall(context));
                }
