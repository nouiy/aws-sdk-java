...
public class UpdateInstanceProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateInstanceProfileResult == false)
            return false;
        UpdateInstanceProfileResult other = (UpdateInstanceProfileResult) obj;
    ...
    @Override
    public UpdateInstanceProfileResult clone() {
        try {
            return (UpdateInstanceProfileResult) super.clone();
