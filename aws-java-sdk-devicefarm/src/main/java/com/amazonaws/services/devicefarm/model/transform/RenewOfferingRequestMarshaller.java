...
/**
 * RenewOfferingRequestMarshaller
 */
...
public class RenewOfferingRequestMarshaller {
    ...
    private static final RenewOfferingRequestMarshaller instance = new RenewOfferingRequestMarshaller();

    public static RenewOfferingRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(RenewOfferingRequest renewOfferingRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(renewOfferingRequest.getOfferingId(), OFFERINGID_BINDING);
            protocolMarshaller.marshall(renewOfferingRequest.getQuantity(), QUANTITY_BINDING);
        } catch (Exception e) {
