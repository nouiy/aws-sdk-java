...
public class TagOperationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("resourceName", targetDepth)) {
                    context.nextToken();
                    tagOperationException.setResourceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static TagOperationExceptionUnmarshaller instance;

    public static TagOperationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TagOperationExceptionUnmarshaller();
        return instance;
    }
}
