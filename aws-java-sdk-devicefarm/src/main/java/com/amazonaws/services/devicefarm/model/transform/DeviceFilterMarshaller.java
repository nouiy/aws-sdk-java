...
/**
 * DeviceFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeviceFilterMarshaller {
    ...
    private static final DeviceFilterMarshaller instance = new DeviceFilterMarshaller();

    public static DeviceFilterMarshaller getInstance() {
        return instance;
    }
