...
public class ScheduleRunResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the scheduled run.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ScheduleRunResult == false)
            return false;
        ScheduleRunResult other = (ScheduleRunResult) obj;
    ...
    public ScheduleRunResult clone() {
        try {
            return (ScheduleRunResult) super.clone();
