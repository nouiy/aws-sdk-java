...
/**
 * ExecutionConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExecutionConfigurationJsonUnmarshaller implements Unmarshaller<ExecutionConfiguration, JsonUnmarshallerContext> {

    public ExecutionConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ExecutionConfigurationJsonUnmarshaller instance;

    public static ExecutionConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExecutionConfigurationJsonUnmarshaller();
        return instance;
    }
}
