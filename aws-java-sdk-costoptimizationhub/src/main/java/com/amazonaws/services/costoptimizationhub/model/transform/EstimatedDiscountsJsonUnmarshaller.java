...
/**
 * EstimatedDiscounts JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EstimatedDiscountsJsonUnmarshaller implements Unmarshaller<EstimatedDiscounts, JsonUnmarshallerContext> {

    public EstimatedDiscounts unmarshall(JsonUnmarshallerContext context) throws Exception {
        EstimatedDiscounts estimatedDiscounts = new EstimatedDiscounts();
    ...
    private static EstimatedDiscountsJsonUnmarshaller instance;

    public static EstimatedDiscountsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EstimatedDiscountsJsonUnmarshaller();
        return instance;
    }
}
