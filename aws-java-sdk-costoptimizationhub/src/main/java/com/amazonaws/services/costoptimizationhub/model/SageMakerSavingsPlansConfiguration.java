 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/SageMakerSavingsPlansConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SageMakerSavingsPlansConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SageMakerSavingsPlansConfiguration == false)
            return false;
    ...
    public SageMakerSavingsPlansConfiguration clone() {
        try {
            return (SageMakerSavingsPlansConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.SageMakerSavingsPlansConfigurationMarshaller.getInstance()
