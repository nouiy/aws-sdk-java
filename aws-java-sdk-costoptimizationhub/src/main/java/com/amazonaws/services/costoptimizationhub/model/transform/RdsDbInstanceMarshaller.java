...
public class RdsDbInstanceMarshaller {
    ...
    public void marshall(RdsDbInstance rdsDbInstance, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rdsDbInstance.getConfiguration(), CONFIGURATION_BINDING);
            protocolMarshaller.marshall(rdsDbInstance.getCostCalculation(), COSTCALCULATION_BINDING);
        } catch (Exception e) {
