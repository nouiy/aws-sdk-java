...
/**
 * ListEnrollmentStatusesRequestMarshaller
 */
...
public class ListEnrollmentStatusesRequestMarshaller {
    ...
    public static ListEnrollmentStatusesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListEnrollmentStatusesRequest listEnrollmentStatusesRequest, ProtocolMarshaller protocolMarshaller) {

        if (listEnrollmentStatusesRequest == null) {
