 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/ElastiCacheReservedInstancesConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ElastiCacheReservedInstancesConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ElastiCacheReservedInstancesConfiguration == false)
            return false;
        ElastiCacheReservedInstancesConfiguration other = (ElastiCacheReservedInstancesConfiguration) obj;
    ...
    public ElastiCacheReservedInstancesConfiguration clone() {
        try {
            return (ElastiCacheReservedInstancesConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.ElastiCacheReservedInstancesConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
