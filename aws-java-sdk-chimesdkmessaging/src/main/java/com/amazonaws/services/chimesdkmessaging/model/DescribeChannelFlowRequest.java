...
public class DescribeChannelFlowRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeChannelFlowRequest withChannelFlowArn(String channelFlowArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeChannelFlowRequest == false)
            return false;
        DescribeChannelFlowRequest other = (DescribeChannelFlowRequest) obj;
    ...
    @Override
    public DescribeChannelFlowRequest clone() {
        return (DescribeChannelFlowRequest) super.clone();
    }
