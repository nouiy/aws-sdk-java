...
/**
 * CreateChannelFlowResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateChannelFlowResultJsonUnmarshaller implements Unmarshaller<CreateChannelFlowResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelFlowArn", targetDepth)) {
                    context.nextToken();
                    createChannelFlowResult.setChannelFlowArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
