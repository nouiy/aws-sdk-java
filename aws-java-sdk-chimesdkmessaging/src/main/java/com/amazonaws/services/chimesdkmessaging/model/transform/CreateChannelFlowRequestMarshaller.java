...
public class CreateChannelFlowRequestMarshaller {
    ...
    public static CreateChannelFlowRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateChannelFlowRequest createChannelFlowRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createChannelFlowRequest.getAppInstanceArn(), APPINSTANCEARN_BINDING);
            protocolMarshaller.marshall(createChannelFlowRequest.getProcessors(), PROCESSORS_BINDING);
            protocolMarshaller.marshall(createChannelFlowRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createChannelFlowRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createChannelFlowRequest.getClientRequestToken(), CLIENTREQUESTTOKEN_BINDING);
        } catch (Exception e) {
