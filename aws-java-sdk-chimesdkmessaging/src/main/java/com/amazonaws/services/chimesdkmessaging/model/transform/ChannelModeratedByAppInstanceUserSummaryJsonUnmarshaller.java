...
/**
 * ChannelModeratedByAppInstanceUserSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChannelModeratedByAppInstanceUserSummaryJsonUnmarshaller implements
        Unmarshaller<ChannelModeratedByAppInstanceUserSummary, JsonUnmarshallerContext> {

    public ChannelModeratedByAppInstanceUserSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelSummary", targetDepth)) {
                    context.nextToken();
                    channelModeratedByAppInstanceUserSummary.setChannelSummary(ChannelSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
