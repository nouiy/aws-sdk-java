...
/**
 * DescribeChannelFlowResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeChannelFlowResultJsonUnmarshaller implements Unmarshaller<DescribeChannelFlowResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelFlow", targetDepth)) {
                    context.nextToken();
                    describeChannelFlowResult.setChannelFlow(ChannelFlowJsonUnmarshaller.getInstance().unmarshall(context));
                }
