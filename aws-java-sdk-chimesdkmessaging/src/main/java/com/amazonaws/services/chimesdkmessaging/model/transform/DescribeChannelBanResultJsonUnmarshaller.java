...
/**
 * DescribeChannelBanResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeChannelBanResultJsonUnmarshaller implements Unmarshaller<DescribeChannelBanResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelBan", targetDepth)) {
                    context.nextToken();
                    describeChannelBanResult.setChannelBan(ChannelBanJsonUnmarshaller.getInstance().unmarshall(context));
                }
