        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceArn", targetDepth)) {
                    context.nextToken();
                    lambdaConfiguration.setResourceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("InvocationType", targetDepth)) {
                    context.nextToken();
                    lambdaConfiguration.setInvocationType(context.getUnmarshaller(String.class).unmarshall(context));
                }
