 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/CloudwatchLogsLogDestinationParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CloudwatchLogsLogDestinationParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CloudwatchLogsLogDestinationParameters == false)
            return false;
        CloudwatchLogsLogDestinationParameters other = (CloudwatchLogsLogDestinationParameters) obj;
    ...
    @Override
    public CloudwatchLogsLogDestinationParameters clone() {
        try {
            return (CloudwatchLogsLogDestinationParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.CloudwatchLogsLogDestinationParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
