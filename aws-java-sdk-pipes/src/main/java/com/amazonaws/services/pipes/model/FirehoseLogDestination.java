 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/FirehoseLogDestination" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FirehoseLogDestination implements Serializable, Cloneable, StructuredPojo {
     ...
     *        The Amazon Resource Name (ARN) of the Kinesis Data Firehose delivery stream to which EventBridge delivers
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the Kinesis Data Firehose delivery stream to which EventBridge delivers
     *         the pipe log records.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FirehoseLogDestination == false)
            return false;
        FirehoseLogDestination other = (FirehoseLogDestination) obj;
    ...
    public FirehoseLogDestination clone() {
        try {
            return (FirehoseLogDestination) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.FirehoseLogDestinationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
