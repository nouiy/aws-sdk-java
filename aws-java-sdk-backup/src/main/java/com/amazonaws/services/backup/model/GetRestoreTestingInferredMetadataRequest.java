...
public class GetRestoreTestingInferredMetadataRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * to the account used to create them and the Amazon Web ServicesRegion where they are created. They consist of
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetRestoreTestingInferredMetadataRequest == false)
            return false;
        GetRestoreTestingInferredMetadataRequest other = (GetRestoreTestingInferredMetadataRequest) obj;
    ...
    public GetRestoreTestingInferredMetadataRequest clone() {
        return (GetRestoreTestingInferredMetadataRequest) super.clone();
    }
