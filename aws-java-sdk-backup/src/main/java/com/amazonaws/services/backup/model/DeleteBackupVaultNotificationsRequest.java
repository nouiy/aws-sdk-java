...
public class DeleteBackupVaultNotificationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteBackupVaultNotificationsRequest withBackupVaultName(String backupVaultName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBackupVaultNotificationsRequest == false)
            return false;
        DeleteBackupVaultNotificationsRequest other = (DeleteBackupVaultNotificationsRequest) obj;
    ...
    @Override
    public DeleteBackupVaultNotificationsRequest clone() {
        return (DeleteBackupVaultNotificationsRequest) super.clone();
    }
