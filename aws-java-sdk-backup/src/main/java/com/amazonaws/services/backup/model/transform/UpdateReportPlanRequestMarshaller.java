...
public class UpdateReportPlanRequestMarshaller {
    ...
    private static final UpdateReportPlanRequestMarshaller instance = new UpdateReportPlanRequestMarshaller();

    public static UpdateReportPlanRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateReportPlanRequest updateReportPlanRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateReportPlanRequest.getReportPlanName(), REPORTPLANNAME_BINDING);
            protocolMarshaller.marshall(updateReportPlanRequest.getReportPlanDescription(), REPORTPLANDESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateReportPlanRequest.getReportDeliveryChannel(), REPORTDELIVERYCHANNEL_BINDING);
            protocolMarshaller.marshall(updateReportPlanRequest.getReportSetting(), REPORTSETTING_BINDING);
            protocolMarshaller.marshall(updateReportPlanRequest.getIdempotencyToken(), IDEMPOTENCYTOKEN_BINDING);
        } catch (Exception e) {
