...
public class DeleteRecoveryPointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteRecoveryPointRequest withBackupVaultName(String backupVaultName) {
    ...
    public DeleteRecoveryPointRequest withRecoveryPointArn(String recoveryPointArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRecoveryPointRequest == false)
            return false;
        DeleteRecoveryPointRequest other = (DeleteRecoveryPointRequest) obj;
    ...
    @Override
    public DeleteRecoveryPointRequest clone() {
        return (DeleteRecoveryPointRequest) super.clone();
    }
