...
public class GetBackupVaultAccessPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetBackupVaultAccessPolicyRequest clone() {
