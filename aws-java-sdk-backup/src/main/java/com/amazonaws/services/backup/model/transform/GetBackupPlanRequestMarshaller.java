...
public class GetBackupPlanRequestMarshaller {
    ...
    private static final GetBackupPlanRequestMarshaller instance = new GetBackupPlanRequestMarshaller();

    public static GetBackupPlanRequestMarshaller getInstance() {
        return instance;
    }
