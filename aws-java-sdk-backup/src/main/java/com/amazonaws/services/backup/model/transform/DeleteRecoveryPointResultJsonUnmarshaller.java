...
/**
 * DeleteRecoveryPointResult JSON Unmarshaller
 */
...
public class DeleteRecoveryPointResultJsonUnmarshaller implements Unmarshaller<DeleteRecoveryPointResult, JsonUnmarshallerContext> {
    ...
    public DeleteRecoveryPointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRecoveryPointResult deleteRecoveryPointResult = new DeleteRecoveryPointResult();
