...
public class ListBackupPlansRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> INCLUDEDELETED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("includeDeleted").build();

    private static final ListBackupPlansRequestMarshaller instance = new ListBackupPlansRequestMarshaller();

    public static ListBackupPlansRequestMarshaller getInstance() {
        return instance;
    }
