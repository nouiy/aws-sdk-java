...
/**
 * ListRecoveryPointsByResourceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListRecoveryPointsByResourceResultJsonUnmarshaller implements Unmarshaller<ListRecoveryPointsByResourceResult, JsonUnmarshallerContext> {

    public ListRecoveryPointsByResourceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listRecoveryPointsByResourceResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
