 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/RestoreTestingPlanForUpdate" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RestoreTestingPlanForUpdate implements Serializable, Cloneable, StructuredPojo {
    ...
    public RestoreTestingPlanForUpdate withRecoveryPointSelection(RestoreTestingRecoveryPointSelection recoveryPointSelection) {
    ...
    public RestoreTestingPlanForUpdate withScheduleExpression(String scheduleExpression) {
    ...
    public RestoreTestingPlanForUpdate withScheduleExpressionTimezone(String scheduleExpressionTimezone) {
    ...
    public RestoreTestingPlanForUpdate withStartWindowHours(Integer startWindowHours) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreTestingPlanForUpdate == false)
            return false;
    ...
    @Override
    public RestoreTestingPlanForUpdate clone() {
        try {
            return (RestoreTestingPlanForUpdate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.backup.model.transform.RestoreTestingPlanForUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
