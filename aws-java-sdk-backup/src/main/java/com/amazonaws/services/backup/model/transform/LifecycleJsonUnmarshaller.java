        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MoveToColdStorageAfterDays", targetDepth)) {
                    context.nextToken();
                    lifecycle.setMoveToColdStorageAfterDays(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("DeleteAfterDays", targetDepth)) {
                    context.nextToken();
                    lifecycle.setDeleteAfterDays(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("OptInToArchiveForSupportedResources", targetDepth)) {
                    context.nextToken();
                    lifecycle.setOptInToArchiveForSupportedResources(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
