...
public class DeleteRestoreTestingPlanRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Required unique name of the restore testing plan you wish to delete.
     */
    ...
    public DeleteRestoreTestingPlanRequest withRestoreTestingPlanName(String restoreTestingPlanName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRestoreTestingPlanRequest == false)
            return false;
        DeleteRestoreTestingPlanRequest other = (DeleteRestoreTestingPlanRequest) obj;
    ...
    @Override
    public DeleteRestoreTestingPlanRequest clone() {
        return (DeleteRestoreTestingPlanRequest) super.clone();
    }
