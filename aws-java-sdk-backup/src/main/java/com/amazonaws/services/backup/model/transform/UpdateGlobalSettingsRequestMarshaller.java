...
public class UpdateGlobalSettingsRequestMarshaller {
    ...
    private static final MarshallingInfo<Map> GLOBALSETTINGS_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("GlobalSettings").build();
    ...
    public void marshall(UpdateGlobalSettingsRequest updateGlobalSettingsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateGlobalSettingsRequest.getGlobalSettings(), GLOBALSETTINGS_BINDING);
        } catch (Exception e) {
