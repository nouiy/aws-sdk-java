...
public class ListBackupPlanVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListBackupPlanVersionsRequest withBackupPlanId(String backupPlanId) {
    ...
    public ListBackupPlanVersionsRequest withNextToken(String nextToken) {
    ...
    public ListBackupPlanVersionsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListBackupPlanVersionsRequest == false)
            return false;
        ListBackupPlanVersionsRequest other = (ListBackupPlanVersionsRequest) obj;
    ...
    @Override
    public ListBackupPlanVersionsRequest clone() {
        return (ListBackupPlanVersionsRequest) super.clone();
    }
