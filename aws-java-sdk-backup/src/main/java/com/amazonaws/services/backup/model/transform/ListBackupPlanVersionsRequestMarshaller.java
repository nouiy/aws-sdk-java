...
/**
 * ListBackupPlanVersionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListBackupPlanVersionsRequestMarshaller {
    ...
    private static final ListBackupPlanVersionsRequestMarshaller instance = new ListBackupPlanVersionsRequestMarshaller();

    public static ListBackupPlanVersionsRequestMarshaller getInstance() {
        return instance;
    }
