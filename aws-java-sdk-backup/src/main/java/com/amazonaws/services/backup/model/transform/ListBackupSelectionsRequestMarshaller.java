...
public class ListBackupSelectionsRequestMarshaller {
    ...
    private static final ListBackupSelectionsRequestMarshaller instance = new ListBackupSelectionsRequestMarshaller();

    public static ListBackupSelectionsRequestMarshaller getInstance() {
        return instance;
    }
