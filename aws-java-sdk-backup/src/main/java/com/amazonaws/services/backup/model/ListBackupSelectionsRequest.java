...
public class ListBackupSelectionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListBackupSelectionsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListBackupSelectionsRequest == false)
            return false;
        ListBackupSelectionsRequest other = (ListBackupSelectionsRequest) obj;
    ...
    public ListBackupSelectionsRequest clone() {
        return (ListBackupSelectionsRequest) super.clone();
    }
