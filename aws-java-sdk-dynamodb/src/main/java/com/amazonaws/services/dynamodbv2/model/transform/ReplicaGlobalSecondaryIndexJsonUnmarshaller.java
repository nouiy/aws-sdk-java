...
/**
 * ReplicaGlobalSecondaryIndex JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReplicaGlobalSecondaryIndexJsonUnmarshaller implements Unmarshaller<ReplicaGlobalSecondaryIndex, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IndexName", targetDepth)) {
                    context.nextToken();
                    replicaGlobalSecondaryIndex.setIndexName(context.getUnmarshaller(String.class).unmarshall(context));
                }
