...
public class DeleteReplicaActionJsonUnmarshaller implements Unmarshaller<DeleteReplicaAction, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RegionName", targetDepth)) {
                    context.nextToken();
                    deleteReplicaAction.setRegionName(context.getUnmarshaller(String.class).unmarshall(context));
                }
