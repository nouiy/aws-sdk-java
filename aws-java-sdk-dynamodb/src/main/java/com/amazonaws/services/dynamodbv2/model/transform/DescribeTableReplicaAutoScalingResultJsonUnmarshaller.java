...
/**
 * DescribeTableReplicaAutoScalingResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeTableReplicaAutoScalingResultJsonUnmarshaller implements Unmarshaller<DescribeTableReplicaAutoScalingResult, JsonUnmarshallerContext> {

    public DescribeTableReplicaAutoScalingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TableAutoScalingDescription", targetDepth)) {
                    context.nextToken();
                    describeTableReplicaAutoScalingResult.setTableAutoScalingDescription(TableAutoScalingDescriptionJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
