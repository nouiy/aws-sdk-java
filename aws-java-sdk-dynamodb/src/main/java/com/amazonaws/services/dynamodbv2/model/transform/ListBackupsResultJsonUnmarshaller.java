...
/**
 * ListBackupsResult JSON Unmarshaller
 */
...
public class ListBackupsResultJsonUnmarshaller implements Unmarshaller<ListBackupsResult, JsonUnmarshallerContext> {
    ...
    public ListBackupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("LastEvaluatedBackupArn", targetDepth)) {
                    context.nextToken();
                    listBackupsResult.setLastEvaluatedBackupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
