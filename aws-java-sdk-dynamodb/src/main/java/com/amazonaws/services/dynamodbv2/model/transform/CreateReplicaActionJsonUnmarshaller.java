...
public class CreateReplicaActionJsonUnmarshaller implements Unmarshaller<CreateReplicaAction, JsonUnmarshallerContext> {

    public CreateReplicaAction unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RegionName", targetDepth)) {
                    context.nextToken();
                    createReplicaAction.setRegionName(context.getUnmarshaller(String.class).unmarshall(context));
                }
