 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/GlobalSecondaryIndexAutoScalingUpdate"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GlobalSecondaryIndexAutoScalingUpdate implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getProvisionedWriteCapacityAutoScalingUpdate() != null)
            sb.append("ProvisionedWriteCapacityAutoScalingUpdate: ").append(getProvisionedWriteCapacityAutoScalingUpdate());
        sb.append("}");
        return sb.toString();
    }
    ...
    public GlobalSecondaryIndexAutoScalingUpdate clone() {
        try {
            return (GlobalSecondaryIndexAutoScalingUpdate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.dynamodbv2.model.transform.GlobalSecondaryIndexAutoScalingUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
