...
/**
 * DescribeContinuousBackupsResult JSON Unmarshaller
 */
...
public class DescribeContinuousBackupsResultJsonUnmarshaller implements Unmarshaller<DescribeContinuousBackupsResult, JsonUnmarshallerContext> {
    ...
    public DescribeContinuousBackupsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ContinuousBackupsDescription", targetDepth)) {
                    context.nextToken();
                    describeContinuousBackupsResult.setContinuousBackupsDescription(ContinuousBackupsDescriptionJsonUnmarshaller.getInstance().unmarshall(
                            context));
                }
