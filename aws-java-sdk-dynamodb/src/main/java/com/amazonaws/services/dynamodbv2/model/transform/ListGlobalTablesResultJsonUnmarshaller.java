...
/**
 * ListGlobalTablesResult JSON Unmarshaller
 */
...
public class ListGlobalTablesResultJsonUnmarshaller implements Unmarshaller<ListGlobalTablesResult, JsonUnmarshallerContext> {
    ...
    public ListGlobalTablesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("LastEvaluatedGlobalTableName", targetDepth)) {
                    context.nextToken();
                    listGlobalTablesResult.setLastEvaluatedGlobalTableName(context.getUnmarshaller(String.class).unmarshall(context));
                }
