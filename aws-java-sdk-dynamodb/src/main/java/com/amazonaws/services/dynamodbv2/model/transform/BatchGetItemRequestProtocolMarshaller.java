...
@SdkInternalApi
public class BatchGetItemRequestProtocolMarshaller implements Marshaller<Request<BatchGetItemRequest>, BatchGetItemRequest> {
    ...
    public BatchGetItemRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<BatchGetItemRequest> marshall(BatchGetItemRequest batchGetItemRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<BatchGetItemRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    batchGetItemRequest);
