...
/**
 * TableCreationParametersMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TableCreationParametersMarshaller {
    ...
    private static final TableCreationParametersMarshaller instance = new TableCreationParametersMarshaller();

    public static TableCreationParametersMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TableCreationParameters tableCreationParameters, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tableCreationParameters.getTableName(), TABLENAME_BINDING);
            protocolMarshaller.marshall(tableCreationParameters.getAttributeDefinitions(), ATTRIBUTEDEFINITIONS_BINDING);
