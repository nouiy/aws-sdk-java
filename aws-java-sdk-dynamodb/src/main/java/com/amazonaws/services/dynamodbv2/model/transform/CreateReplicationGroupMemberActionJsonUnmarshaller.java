...
/**
 * CreateReplicationGroupMemberAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateReplicationGroupMemberActionJsonUnmarshaller implements Unmarshaller<CreateReplicationGroupMemberAction, JsonUnmarshallerContext> {

    public CreateReplicationGroupMemberAction unmarshall(JsonUnmarshallerContext context) throws Exception {
