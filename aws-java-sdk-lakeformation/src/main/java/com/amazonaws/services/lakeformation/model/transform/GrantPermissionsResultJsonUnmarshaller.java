...
/**
 * GrantPermissionsResult JSON Unmarshaller
 */
...
public class GrantPermissionsResultJsonUnmarshaller implements Unmarshaller<GrantPermissionsResult, JsonUnmarshallerContext> {
    ...
    public GrantPermissionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GrantPermissionsResult grantPermissionsResult = new GrantPermissionsResult();
