...
/**
 * ExtendTransactionResult JSON Unmarshaller
 */
...
public class ExtendTransactionResultJsonUnmarshaller implements Unmarshaller<ExtendTransactionResult, JsonUnmarshallerContext> {
    ...
    public ExtendTransactionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExtendTransactionResult extendTransactionResult = new ExtendTransactionResult();

        return extendTransactionResult;
    }
