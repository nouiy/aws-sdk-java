...
/**
 * RevokePermissionsResult JSON Unmarshaller
 */
...
public class RevokePermissionsResultJsonUnmarshaller implements Unmarshaller<RevokePermissionsResult, JsonUnmarshallerContext> {
    ...
    public RevokePermissionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RevokePermissionsResult revokePermissionsResult = new RevokePermissionsResult();
