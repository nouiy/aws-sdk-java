...
/**
 * GrantPermissionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GrantPermissionsRequestMarshaller {
    ...
    private static final GrantPermissionsRequestMarshaller instance = new GrantPermissionsRequestMarshaller();

    public static GrantPermissionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GrantPermissionsRequest grantPermissionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(grantPermissionsRequest.getCatalogId(), CATALOGID_BINDING);
            protocolMarshaller.marshall(grantPermissionsRequest.getPrincipal(), PRINCIPAL_BINDING);
            protocolMarshaller.marshall(grantPermissionsRequest.getResource(), RESOURCE_BINDING);
            protocolMarshaller.marshall(grantPermissionsRequest.getPermissions(), PERMISSIONS_BINDING);
            protocolMarshaller.marshall(grantPermissionsRequest.getPermissionsWithGrantOption(), PERMISSIONSWITHGRANTOPTION_BINDING);
        } catch (Exception e) {
