...
/**
 * PutDataLakeSettingsResult JSON Unmarshaller
 */
...
public class PutDataLakeSettingsResultJsonUnmarshaller implements Unmarshaller<PutDataLakeSettingsResult, JsonUnmarshallerContext> {
    ...
    public PutDataLakeSettingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutDataLakeSettingsResult putDataLakeSettingsResult = new PutDataLakeSettingsResult();
