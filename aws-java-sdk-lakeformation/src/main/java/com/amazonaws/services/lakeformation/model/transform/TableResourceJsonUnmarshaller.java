...
/**
 * TableResource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TableResourceJsonUnmarshaller implements Unmarshaller<TableResource, JsonUnmarshallerContext> {

    public TableResource unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static TableResourceJsonUnmarshaller instance;

    public static TableResourceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TableResourceJsonUnmarshaller();
        return instance;
    }
}
