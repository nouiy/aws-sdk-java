...
public class CreateLFTagRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateLFTagRequest withTagValues(java.util.Collection<String> tagValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLFTagRequest == false)
            return false;
        CreateLFTagRequest other = (CreateLFTagRequest) obj;
    ...
    public CreateLFTagRequest clone() {
        return (CreateLFTagRequest) super.clone();
    }
