...
/**
 * DeleteDataCellsFilterResult JSON Unmarshaller
 */
...
public class DeleteDataCellsFilterResultJsonUnmarshaller implements Unmarshaller<DeleteDataCellsFilterResult, JsonUnmarshallerContext> {
    ...
    public DeleteDataCellsFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDataCellsFilterResult deleteDataCellsFilterResult = new DeleteDataCellsFilterResult();

        return deleteDataCellsFilterResult;
    }
