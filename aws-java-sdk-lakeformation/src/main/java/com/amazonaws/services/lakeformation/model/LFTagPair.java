...
public class LFTagPair implements Serializable, Cloneable, StructuredPojo {
    ...
    public LFTagPair withTagValues(java.util.Collection<String> tagValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LFTagPair == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lakeformation.model.transform.LFTagPairMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
