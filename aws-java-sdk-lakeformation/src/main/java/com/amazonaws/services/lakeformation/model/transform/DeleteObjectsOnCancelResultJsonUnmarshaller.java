...
/**
 * DeleteObjectsOnCancelResult JSON Unmarshaller
 */
...
public class DeleteObjectsOnCancelResultJsonUnmarshaller implements Unmarshaller<DeleteObjectsOnCancelResult, JsonUnmarshallerContext> {
    ...
    public DeleteObjectsOnCancelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteObjectsOnCancelResult deleteObjectsOnCancelResult = new DeleteObjectsOnCancelResult();

        return deleteObjectsOnCancelResult;
    }
