...
public class GetLFTagResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetLFTagResult withCatalogId(String catalogId) {
    ...
    public GetLFTagResult withTagKey(String tagKey) {
        setTagKey(tagKey);
        return this;
    }
    ...
    public GetLFTagResult withTagValues(String... tagValues) {
    ...
    public GetLFTagResult withTagValues(java.util.Collection<String> tagValues) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLFTagResult == false)
            return false;
        GetLFTagResult other = (GetLFTagResult) obj;
    ...
    @Override
    public GetLFTagResult clone() {
        try {
            return (GetLFTagResult) super.clone();
