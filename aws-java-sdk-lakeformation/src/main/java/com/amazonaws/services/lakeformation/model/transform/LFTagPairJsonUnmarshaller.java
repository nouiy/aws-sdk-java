...
/**
 * LFTagPair JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LFTagPairJsonUnmarshaller implements Unmarshaller<LFTagPair, JsonUnmarshallerContext> {

    public LFTagPair unmarshall(JsonUnmarshallerContext context) throws Exception {
        LFTagPair lFTagPair = new LFTagPair();
    ...
    private static LFTagPairJsonUnmarshaller instance;

    public static LFTagPairJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LFTagPairJsonUnmarshaller();
        return instance;
    }
}
