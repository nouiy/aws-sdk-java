...
public class GetQueryStateRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetQueryStateRequest withQueryId(String queryId) {
        setQueryId(queryId);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetQueryStateRequest == false)
            return false;
        GetQueryStateRequest other = (GetQueryStateRequest) obj;
    ...
    @Override
    public GetQueryStateRequest clone() {
        return (GetQueryStateRequest) super.clone();
    }
