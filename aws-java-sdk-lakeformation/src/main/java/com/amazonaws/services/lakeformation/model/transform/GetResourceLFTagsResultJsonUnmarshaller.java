...
/**
 * GetResourceLFTagsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetResourceLFTagsResultJsonUnmarshaller implements Unmarshaller<GetResourceLFTagsResult, JsonUnmarshallerContext> {

    public GetResourceLFTagsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetResourceLFTagsResult getResourceLFTagsResult = new GetResourceLFTagsResult();
    ...
    private static GetResourceLFTagsResultJsonUnmarshaller instance;

    public static GetResourceLFTagsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetResourceLFTagsResultJsonUnmarshaller();
        return instance;
    }
}
