...
public class BatchGrantPermissionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchGrantPermissionsResult withFailures(BatchPermissionsFailureEntry... failures) {
    ...
    public BatchGrantPermissionsResult withFailures(java.util.Collection<BatchPermissionsFailureEntry> failures) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGrantPermissionsResult == false)
            return false;
        BatchGrantPermissionsResult other = (BatchGrantPermissionsResult) obj;
    ...
    @Override
    public BatchGrantPermissionsResult clone() {
        try {
            return (BatchGrantPermissionsResult) super.clone();
