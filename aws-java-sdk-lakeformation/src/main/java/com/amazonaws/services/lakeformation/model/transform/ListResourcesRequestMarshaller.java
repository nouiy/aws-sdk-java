...
public class ListResourcesRequestMarshaller {
    ...
    private static final MarshallingInfo<List> FILTERCONDITIONLIST_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("FilterConditionList").build();
    ...
    public void marshall(ListResourcesRequest listResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listResourcesRequest.getFilterConditionList(), FILTERCONDITIONLIST_BINDING);
