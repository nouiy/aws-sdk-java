...
public class UpdateFileSystemRequestMarshaller {
    ...
    public void marshall(UpdateFileSystemRequest updateFileSystemRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateFileSystemRequest.getThroughputMode(), THROUGHPUTMODE_BINDING);
            protocolMarshaller.marshall(updateFileSystemRequest.getProvisionedThroughputInMibps(), PROVISIONEDTHROUGHPUTINMIBPS_BINDING);
        } catch (Exception e) {
