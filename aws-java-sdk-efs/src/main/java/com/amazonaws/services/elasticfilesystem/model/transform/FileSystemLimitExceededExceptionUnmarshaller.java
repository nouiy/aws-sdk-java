...
public class FileSystemLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.elasticfilesystem.model.FileSystemLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    fileSystemLimitExceededException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return fileSystemLimitExceededException;
    }

    private static FileSystemLimitExceededExceptionUnmarshaller instance;

    public static FileSystemLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new FileSystemLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
