...
/**
 * CreationInfoMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreationInfoMarshaller {

    private static final MarshallingInfo<Long> OWNERUID_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("OwnerUid").build();
    private static final MarshallingInfo<Long> OWNERGID_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("OwnerGid").build();
