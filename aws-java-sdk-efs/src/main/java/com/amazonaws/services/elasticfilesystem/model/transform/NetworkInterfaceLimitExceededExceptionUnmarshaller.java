...
public class NetworkInterfaceLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    networkInterfaceLimitExceededException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static NetworkInterfaceLimitExceededExceptionUnmarshaller instance;

    public static NetworkInterfaceLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NetworkInterfaceLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
