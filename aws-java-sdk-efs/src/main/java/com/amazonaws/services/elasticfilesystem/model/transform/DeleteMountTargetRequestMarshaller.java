...
/**
 * DeleteMountTargetRequestMarshaller
 */
...
public class DeleteMountTargetRequestMarshaller {
    ...
    private static final DeleteMountTargetRequestMarshaller instance = new DeleteMountTargetRequestMarshaller();

    public static DeleteMountTargetRequestMarshaller getInstance() {
        return instance;
    }
