...
public class MountTargetNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    mountTargetNotFoundException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static MountTargetNotFoundExceptionUnmarshaller instance;

    public static MountTargetNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MountTargetNotFoundExceptionUnmarshaller();
        return instance;
    }
}
