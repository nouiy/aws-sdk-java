...
public class PutBackupPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutBackupPolicyResult == false)
            return false;
        PutBackupPolicyResult other = (PutBackupPolicyResult) obj;
    ...
    public PutBackupPolicyResult clone() {
        try {
            return (PutBackupPolicyResult) super.clone();
