...
public class IncorrectMountTargetStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.elasticfilesystem.model.IncorrectMountTargetStateException unmarshallFromContext(JsonUnmarshallerContext context)
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ErrorCode", targetDepth)) {
                    context.nextToken();
                    incorrectMountTargetStateException.setErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return incorrectMountTargetStateException;
    }

    private static IncorrectMountTargetStateExceptionUnmarshaller instance;

    public static IncorrectMountTargetStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncorrectMountTargetStateExceptionUnmarshaller();
        return instance;
    }
}
