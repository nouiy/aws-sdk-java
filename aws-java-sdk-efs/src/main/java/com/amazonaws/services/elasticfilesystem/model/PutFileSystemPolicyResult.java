...
public class PutFileSystemPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutFileSystemPolicyResult withFileSystemId(String fileSystemId) {
    ...
    public PutFileSystemPolicyResult withPolicy(String policy) {
        setPolicy(policy);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutFileSystemPolicyResult == false)
            return false;
        PutFileSystemPolicyResult other = (PutFileSystemPolicyResult) obj;
    ...
    public PutFileSystemPolicyResult clone() {
        try {
            return (PutFileSystemPolicyResult) super.clone();
