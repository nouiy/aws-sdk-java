...
@SdkInternalApi
public class DescribeStreamSummaryRequestMarshaller {
    ...
    public static DescribeStreamSummaryRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeStreamSummaryRequest describeStreamSummaryRequest, ProtocolMarshaller protocolMarshaller) {
