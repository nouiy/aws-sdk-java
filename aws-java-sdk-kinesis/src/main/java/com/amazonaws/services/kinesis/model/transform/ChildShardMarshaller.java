...
public class ChildShardMarshaller {
    ...
    private static final MarshallingInfo<List> PARENTSHARDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("ParentShards").build();
