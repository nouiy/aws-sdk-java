...
/**
 * DescribeStreamSummaryResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamDescriptionSummary", targetDepth)) {
                    context.nextToken();
                    describeStreamSummaryResult.setStreamDescriptionSummary(StreamDescriptionSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
