...
public class ConsumerJsonUnmarshaller implements Unmarshaller<Consumer, JsonUnmarshallerContext> {
    ...
    private static ConsumerJsonUnmarshaller instance;

    public static ConsumerJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConsumerJsonUnmarshaller();
        return instance;
    }
}
