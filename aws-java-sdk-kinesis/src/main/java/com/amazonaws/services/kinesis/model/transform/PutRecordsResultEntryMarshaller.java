...
public class PutRecordsResultEntryMarshaller {
    ...
    public void marshall(PutRecordsResultEntry putRecordsResultEntry, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putRecordsResultEntry.getSequenceNumber(), SEQUENCENUMBER_BINDING);
            protocolMarshaller.marshall(putRecordsResultEntry.getShardId(), SHARDID_BINDING);
            protocolMarshaller.marshall(putRecordsResultEntry.getErrorCode(), ERRORCODE_BINDING);
            protocolMarshaller.marshall(putRecordsResultEntry.getErrorMessage(), ERRORMESSAGE_BINDING);
        } catch (Exception e) {
