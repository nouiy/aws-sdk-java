...
public class ListApplicationsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> EXCLUSIVESTARTAPPLICATIONNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ExclusiveStartApplicationName").build();
