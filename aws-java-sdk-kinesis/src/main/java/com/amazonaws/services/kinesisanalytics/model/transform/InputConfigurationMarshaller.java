...
public class InputConfigurationMarshaller {
    ...
    public void marshall(InputConfiguration inputConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputConfiguration.getId(), ID_BINDING);
            protocolMarshaller.marshall(inputConfiguration.getInputStartingPositionConfiguration(), INPUTSTARTINGPOSITIONCONFIGURATION_BINDING);
        } catch (Exception e) {
