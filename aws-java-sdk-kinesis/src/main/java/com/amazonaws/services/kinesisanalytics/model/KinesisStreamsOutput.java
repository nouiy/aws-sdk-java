...
/**
 * <p>
 * When configuring application output, identifies an Amazon Kinesis stream as the destination. You provide the stream
 * Amazon Resource Name (ARN) and also an IAM role ARN that Amazon Kinesis Analytics can use to write to the stream on
 * your behalf.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kinesisanalytics-2015-08-14/KinesisStreamsOutput"
...
public class KinesisStreamsOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisanalytics.model.transform.KinesisStreamsOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
