...
/**
 * StartDeliveryStreamEncryptionResult JSON Unmarshaller
 */
...
public class StartDeliveryStreamEncryptionResultJsonUnmarshaller implements Unmarshaller<StartDeliveryStreamEncryptionResult, JsonUnmarshallerContext> {
    ...
    public StartDeliveryStreamEncryptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartDeliveryStreamEncryptionResult startDeliveryStreamEncryptionResult = new StartDeliveryStreamEncryptionResult();

        return startDeliveryStreamEncryptionResult;
    }
