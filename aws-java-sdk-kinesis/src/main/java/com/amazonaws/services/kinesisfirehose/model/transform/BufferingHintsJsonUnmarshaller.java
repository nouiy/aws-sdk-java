...
public class BufferingHintsJsonUnmarshaller implements Unmarshaller<BufferingHints, JsonUnmarshallerContext> {
    ...
    private static BufferingHintsJsonUnmarshaller instance;

    public static BufferingHintsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BufferingHintsJsonUnmarshaller();
        return instance;
    }
}
