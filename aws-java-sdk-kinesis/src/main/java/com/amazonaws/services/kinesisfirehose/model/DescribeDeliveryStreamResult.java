...
public class DescribeDeliveryStreamResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDeliveryStreamDescription() == null ^ this.getDeliveryStreamDescription() == null)
            return false;
        if (other.getDeliveryStreamDescription() != null && other.getDeliveryStreamDescription().equals(this.getDeliveryStreamDescription()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDeliveryStreamDescription() == null) ? 0 : getDeliveryStreamDescription().hashCode());
        return hashCode;
    }
