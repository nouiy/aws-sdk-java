 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/firehose-2015-08-04/IcebergDestinationConfiguration"
...
public class IcebergDestinationConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public IcebergDestinationConfiguration withDestinationTableConfigurationList(
    ...
    public IcebergDestinationConfiguration withS3BackupMode(String s3BackupMode) {
    ...
    public IcebergDestinationConfiguration withS3BackupMode(IcebergS3BackupMode s3BackupMode) {
     ...
     *        Configuration describing where the destination Apache Iceberg Tables are persisted. </p>
     *        <p>
     *        Amazon Data Firehose is in preview release and is subject to change.
     */
     ...
     * </p>
     * 
     * @return Configuration describing where the destination Apache Iceberg Tables are persisted. </p>
     *         <p>
     *         Amazon Data Firehose is in preview release and is subject to change.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IcebergDestinationConfiguration == false)
            return false;
    ...
    @Override
    public IcebergDestinationConfiguration clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisfirehose.model.transform.IcebergDestinationConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
