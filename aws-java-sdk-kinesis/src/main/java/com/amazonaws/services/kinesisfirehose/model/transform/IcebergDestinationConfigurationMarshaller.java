...
/**
 * IcebergDestinationConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IcebergDestinationConfigurationMarshaller {
    ...
    private static final IcebergDestinationConfigurationMarshaller instance = new IcebergDestinationConfigurationMarshaller();

    public static IcebergDestinationConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IcebergDestinationConfiguration icebergDestinationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(icebergDestinationConfiguration.getDestinationTableConfigurationList(), DESTINATIONTABLECONFIGURATIONLIST_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getBufferingHints(), BUFFERINGHINTS_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getCloudWatchLoggingOptions(), CLOUDWATCHLOGGINGOPTIONS_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getProcessingConfiguration(), PROCESSINGCONFIGURATION_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getS3BackupMode(), S3BACKUPMODE_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getRetryOptions(), RETRYOPTIONS_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getRoleARN(), ROLEARN_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getCatalogConfiguration(), CATALOGCONFIGURATION_BINDING);
            protocolMarshaller.marshall(icebergDestinationConfiguration.getS3Configuration(), S3CONFIGURATION_BINDING);
        } catch (Exception e) {
