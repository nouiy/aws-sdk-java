...
@SdkInternalApi
public class HttpEndpointDestinationUpdateMarshaller {
    ...
    public static HttpEndpointDestinationUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HttpEndpointDestinationUpdate httpEndpointDestinationUpdate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(httpEndpointDestinationUpdate.getEndpointConfiguration(), ENDPOINTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(httpEndpointDestinationUpdate.getBufferingHints(), BUFFERINGHINTS_BINDING);
            protocolMarshaller.marshall(httpEndpointDestinationUpdate.getCloudWatchLoggingOptions(), CLOUDWATCHLOGGINGOPTIONS_BINDING);
            protocolMarshaller.marshall(httpEndpointDestinationUpdate.getRequestConfiguration(), REQUESTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(httpEndpointDestinationUpdate.getProcessingConfiguration(), PROCESSINGCONFIGURATION_BINDING);
            protocolMarshaller.marshall(httpEndpointDestinationUpdate.getRoleARN(), ROLEARN_BINDING);
