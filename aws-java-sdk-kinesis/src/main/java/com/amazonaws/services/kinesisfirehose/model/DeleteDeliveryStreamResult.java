...
public class DeleteDeliveryStreamResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDeliveryStreamResult == false)
            return false;
        DeleteDeliveryStreamResult other = (DeleteDeliveryStreamResult) obj;
        return true;
    }
    ...
    @Override
    public DeleteDeliveryStreamResult clone() {
        try {
            return (DeleteDeliveryStreamResult) super.clone();
