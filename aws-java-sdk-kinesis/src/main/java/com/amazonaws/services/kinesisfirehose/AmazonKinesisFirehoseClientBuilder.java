...
/**
 * Fluent builder for {@link com.amazonaws.services.kinesisfirehose.AmazonKinesisFirehose}. Use of the builder is
 * preferred over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AmazonKinesisFirehoseClientBuilder extends AwsSyncClientBuilder<AmazonKinesisFirehoseClientBuilder, AmazonKinesisFirehose> {
    ...
    /**
     * Construct a synchronous implementation of AmazonKinesisFirehose using the current builder configuration.
     *
     * @param params
