...
/**
 * HttpEndpointRequestConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class HttpEndpointRequestConfigurationMarshaller {

    private static final MarshallingInfo<String> CONTENTENCODING_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ContentEncoding").build();
    private static final MarshallingInfo<List> COMMONATTRIBUTES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
