 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/firehose-2015-08-04/SplunkDestinationUpdate" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SplunkDestinationUpdate implements Serializable, Cloneable, StructuredPojo {
    ...
    public SplunkDestinationUpdate withSecretsManagerConfiguration(SecretsManagerConfiguration secretsManagerConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SplunkDestinationUpdate == false)
            return false;
    ...
    public SplunkDestinationUpdate clone() {
        try {
            return (SplunkDestinationUpdate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisfirehose.model.transform.SplunkDestinationUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
