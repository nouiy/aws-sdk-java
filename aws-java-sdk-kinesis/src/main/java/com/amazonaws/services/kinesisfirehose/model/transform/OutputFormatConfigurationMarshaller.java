...
/**
 * OutputFormatConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OutputFormatConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> SERIALIZER_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("Serializer").build();
    ...
    public void marshall(OutputFormatConfiguration outputFormatConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(outputFormatConfiguration.getSerializer(), SERIALIZER_BINDING);
        } catch (Exception e) {
