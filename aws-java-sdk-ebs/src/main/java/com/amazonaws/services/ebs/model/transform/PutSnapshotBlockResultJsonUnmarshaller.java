...
/**
 * PutSnapshotBlockResult JSON Unmarshaller
 */
...
public class PutSnapshotBlockResultJsonUnmarshaller implements Unmarshaller<PutSnapshotBlockResult, JsonUnmarshallerContext> {
    ...
    public PutSnapshotBlockResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        if (context.isStartOfDocument()) {
            if (context.getHeader("x-amz-Checksum") != null) {
                ...
                putSnapshotBlockResult.setChecksum(context.getUnmarshaller(String.class).unmarshall(context));
            }
            if (context.getHeader("x-amz-Checksum-Algorithm") != null) {
                context.setCurrentHeader("x-amz-Checksum-Algorithm");
                putSnapshotBlockResult.setChecksumAlgorithm(context.getUnmarshaller(String.class).unmarshall(context));
            }
        }
