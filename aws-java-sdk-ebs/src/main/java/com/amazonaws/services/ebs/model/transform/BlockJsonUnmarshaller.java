        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("BlockIndex", targetDepth)) {
                    context.nextToken();
                    block.setBlockIndex(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("BlockToken", targetDepth)) {
                    context.nextToken();
                    block.setBlockToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
