...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplacedeployment.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.marketplacedeployment.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplacedeployment.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.marketplacedeployment.model.ResourceNotFoundException(
                null);
