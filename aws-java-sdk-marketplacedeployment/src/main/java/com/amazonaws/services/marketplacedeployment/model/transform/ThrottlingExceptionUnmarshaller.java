...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplacedeployment.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.marketplacedeployment.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplacedeployment.model.ThrottlingException throttlingException = new com.amazonaws.services.marketplacedeployment.model.ThrottlingException(
                null);
