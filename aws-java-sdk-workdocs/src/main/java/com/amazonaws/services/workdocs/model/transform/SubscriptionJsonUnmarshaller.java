        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SubscriptionId", targetDepth)) {
                    context.nextToken();
                    subscription.setSubscriptionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("EndPoint", targetDepth)) {
                    context.nextToken();
                    subscription.setEndPoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Protocol", targetDepth)) {
                    context.nextToken();
                    subscription.setProtocol(context.getUnmarshaller(String.class).unmarshall(context));
                }
