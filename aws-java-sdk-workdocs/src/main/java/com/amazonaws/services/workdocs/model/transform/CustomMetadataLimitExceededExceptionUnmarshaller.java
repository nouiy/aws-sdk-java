...
public class CustomMetadataLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CustomMetadataLimitExceededExceptionUnmarshaller instance;

    public static CustomMetadataLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomMetadataLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
