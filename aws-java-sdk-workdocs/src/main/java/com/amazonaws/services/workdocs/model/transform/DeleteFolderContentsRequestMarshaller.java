...
/**
 * DeleteFolderContentsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteFolderContentsRequestMarshaller {
    ...
    private static final DeleteFolderContentsRequestMarshaller instance = new DeleteFolderContentsRequestMarshaller();

    public static DeleteFolderContentsRequestMarshaller getInstance() {
        return instance;
    }
