...
/**
 * ResourcePathComponentMarshaller
 */
...
public class ResourcePathComponentMarshaller {
    ...
    public void marshall(ResourcePathComponent resourcePathComponent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourcePathComponent.getId(), ID_BINDING);
            protocolMarshaller.marshall(resourcePathComponent.getName(), NAME_BINDING);
        } catch (Exception e) {
