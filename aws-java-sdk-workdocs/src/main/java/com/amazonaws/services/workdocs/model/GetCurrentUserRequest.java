...
public class GetCurrentUserRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetCurrentUserRequest withAuthenticationToken(String authenticationToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCurrentUserRequest == false)
            return false;
        GetCurrentUserRequest other = (GetCurrentUserRequest) obj;
    ...
    public GetCurrentUserRequest clone() {
        return (GetCurrentUserRequest) super.clone();
    }
