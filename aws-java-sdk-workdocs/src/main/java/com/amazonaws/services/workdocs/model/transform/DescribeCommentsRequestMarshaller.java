...
public class DescribeCommentsRequestMarshaller {
    ...
    private static final DescribeCommentsRequestMarshaller instance = new DescribeCommentsRequestMarshaller();

    public static DescribeCommentsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeCommentsRequest describeCommentsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeCommentsRequest.getAuthenticationToken(), AUTHENTICATIONTOKEN_BINDING);
            protocolMarshaller.marshall(describeCommentsRequest.getDocumentId(), DOCUMENTID_BINDING);
            protocolMarshaller.marshall(describeCommentsRequest.getVersionId(), VERSIONID_BINDING);
            protocolMarshaller.marshall(describeCommentsRequest.getLimit(), LIMIT_BINDING);
            protocolMarshaller.marshall(describeCommentsRequest.getMarker(), MARKER_BINDING);
        } catch (Exception e) {
