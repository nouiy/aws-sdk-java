...
public class PermissionInfoMarshaller {
    ...
    public void marshall(PermissionInfo permissionInfo, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(permissionInfo.getRole(), ROLE_BINDING);
            protocolMarshaller.marshall(permissionInfo.getType(), TYPE_BINDING);
        } catch (Exception e) {
