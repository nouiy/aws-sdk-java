...
/**
 * DeleteFolderContentsResult JSON Unmarshaller
 */
...
public class DeleteFolderContentsResultJsonUnmarshaller implements Unmarshaller<DeleteFolderContentsResult, JsonUnmarshallerContext> {
    ...
    public DeleteFolderContentsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFolderContentsResult deleteFolderContentsResult = new DeleteFolderContentsResult();
