...
/**
 * RemoveAllResourcePermissionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RemoveAllResourcePermissionsRequestMarshaller {
    ...
    private static final RemoveAllResourcePermissionsRequestMarshaller instance = new RemoveAllResourcePermissionsRequestMarshaller();

    public static RemoveAllResourcePermissionsRequestMarshaller getInstance() {
        return instance;
    }
