...
@SdkInternalApi
public class CreateLabelsRequestMarshaller {
    ...
    private static final CreateLabelsRequestMarshaller instance = new CreateLabelsRequestMarshaller();

    public static CreateLabelsRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(CreateLabelsRequest createLabelsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createLabelsRequest.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(createLabelsRequest.getLabels(), LABELS_BINDING);
            protocolMarshaller.marshall(createLabelsRequest.getAuthenticationToken(), AUTHENTICATIONTOKEN_BINDING);
        } catch (Exception e) {
