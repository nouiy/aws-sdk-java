...
/**
 * DeleteLabelsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteLabelsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> LABELS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.QUERY_PARAM)
    ...
    private static final DeleteLabelsRequestMarshaller instance = new DeleteLabelsRequestMarshaller();

    public static DeleteLabelsRequestMarshaller getInstance() {
        return instance;
    }
