...
public class TooManySubscriptionsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TooManySubscriptionsExceptionUnmarshaller instance;

    public static TooManySubscriptionsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TooManySubscriptionsExceptionUnmarshaller();
        return instance;
    }
}
