...
/**
 * DeleteLabelsResult JSON Unmarshaller
 */
...
public class DeleteLabelsResultJsonUnmarshaller implements Unmarshaller<DeleteLabelsResult, JsonUnmarshallerContext> {
    ...
    public DeleteLabelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLabelsResult deleteLabelsResult = new DeleteLabelsResult();
