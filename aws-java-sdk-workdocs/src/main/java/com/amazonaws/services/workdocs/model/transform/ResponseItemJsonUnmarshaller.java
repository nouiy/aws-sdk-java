...
/**
 * ResponseItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseItemJsonUnmarshaller implements Unmarshaller<ResponseItem, JsonUnmarshallerContext> {

    public ResponseItem unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ResponseItemJsonUnmarshaller instance;

    public static ResponseItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResponseItemJsonUnmarshaller();
        return instance;
    }
}
