...
public class DeactivatingLastSystemUserExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeactivatingLastSystemUserExceptionUnmarshaller instance;

    public static DeactivatingLastSystemUserExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeactivatingLastSystemUserExceptionUnmarshaller();
        return instance;
    }
}
