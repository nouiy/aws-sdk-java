...
public class IllegalUserStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IllegalUserStateExceptionUnmarshaller instance;

    public static IllegalUserStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IllegalUserStateExceptionUnmarshaller();
        return instance;
    }
}
