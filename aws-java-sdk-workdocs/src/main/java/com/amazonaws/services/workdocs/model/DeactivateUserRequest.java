...
public class DeactivateUserRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeactivateUserRequest withAuthenticationToken(String authenticationToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeactivateUserRequest == false)
            return false;
        DeactivateUserRequest other = (DeactivateUserRequest) obj;
    ...
    public DeactivateUserRequest clone() {
        return (DeactivateUserRequest) super.clone();
    }
