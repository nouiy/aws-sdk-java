...
public class GetFolderPathRequestMarshaller {
    ...
    private static final GetFolderPathRequestMarshaller instance = new GetFolderPathRequestMarshaller();

    public static GetFolderPathRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetFolderPathRequest getFolderPathRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(getFolderPathRequest.getMarker(), MARKER_BINDING);
        } catch (Exception e) {
