...
public class StorageLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static StorageLimitExceededExceptionUnmarshaller instance;

    public static StorageLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StorageLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
