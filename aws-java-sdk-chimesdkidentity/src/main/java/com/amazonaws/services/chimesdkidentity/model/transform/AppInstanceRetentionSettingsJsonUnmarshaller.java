...
/**
 * AppInstanceRetentionSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AppInstanceRetentionSettingsJsonUnmarshaller implements Unmarshaller<AppInstanceRetentionSettings, JsonUnmarshallerContext> {

    public AppInstanceRetentionSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ChannelRetentionSettings", targetDepth)) {
                    context.nextToken();
                    appInstanceRetentionSettings.setChannelRetentionSettings(ChannelRetentionSettingsJsonUnmarshaller.getInstance().unmarshall(context));
                }
