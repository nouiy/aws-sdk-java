...
/**
 * AppInstanceUserEndpointSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AppInstanceUserEndpointSummaryJsonUnmarshaller implements Unmarshaller<AppInstanceUserEndpointSummary, JsonUnmarshallerContext> {

    public AppInstanceUserEndpointSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
