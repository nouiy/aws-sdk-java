...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.chimesdkidentity.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.chimesdkidentity.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.chimesdkidentity.model.ConflictException conflictException = new com.amazonaws.services.chimesdkidentity.model.ConflictException(
                null);
