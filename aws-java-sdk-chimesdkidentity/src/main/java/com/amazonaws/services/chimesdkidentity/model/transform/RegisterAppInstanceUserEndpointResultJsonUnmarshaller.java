...
/**
 * RegisterAppInstanceUserEndpointResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegisterAppInstanceUserEndpointResultJsonUnmarshaller implements Unmarshaller<RegisterAppInstanceUserEndpointResult, JsonUnmarshallerContext> {

    public RegisterAppInstanceUserEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AppInstanceUserArn", targetDepth)) {
                    context.nextToken();
                    registerAppInstanceUserEndpointResult.setAppInstanceUserArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("EndpointId", targetDepth)) {
                    context.nextToken();
                    registerAppInstanceUserEndpointResult.setEndpointId(context.getUnmarshaller(String.class).unmarshall(context));
                }
