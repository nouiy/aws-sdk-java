...
/**
 * AppInstanceAdminSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AppInstanceAdminSummaryJsonUnmarshaller implements Unmarshaller<AppInstanceAdminSummary, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Admin", targetDepth)) {
                    context.nextToken();
                    appInstanceAdminSummary.setAdmin(IdentityJsonUnmarshaller.getInstance().unmarshall(context));
                }
