...
/**
 * DeleteAppInstanceResult JSON Unmarshaller
 */
...
public class DeleteAppInstanceResultJsonUnmarshaller implements Unmarshaller<DeleteAppInstanceResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppInstanceResult deleteAppInstanceResult = new DeleteAppInstanceResult();
