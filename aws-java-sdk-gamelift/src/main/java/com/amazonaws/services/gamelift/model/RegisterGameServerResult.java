...
public class RegisterGameServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RegisterGameServerResult == false)
            return false;
        RegisterGameServerResult other = (RegisterGameServerResult) obj;
    ...
    public RegisterGameServerResult clone() {
        try {
            return (RegisterGameServerResult) super.clone();
