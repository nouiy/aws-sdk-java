...
/**
 * StopMatchmakingResult JSON Unmarshaller
 */
...
public class StopMatchmakingResultJsonUnmarshaller implements Unmarshaller<StopMatchmakingResult, JsonUnmarshallerContext> {
    ...
    public StopMatchmakingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopMatchmakingResult stopMatchmakingResult = new StopMatchmakingResult();

        return stopMatchmakingResult;
    }
