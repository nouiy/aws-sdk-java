...
public class UpdateAliasRequestMarshaller {
    ...
    public void marshall(UpdateAliasRequest updateAliasRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateAliasRequest.getAliasId(), ALIASID_BINDING);
            ...
            protocolMarshaller.marshall(updateAliasRequest.getRoutingStrategy(), ROUTINGSTRATEGY_BINDING);
        } catch (Exception e) {
