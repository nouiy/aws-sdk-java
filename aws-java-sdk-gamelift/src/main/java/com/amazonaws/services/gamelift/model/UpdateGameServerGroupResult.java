...
public class UpdateGameServerGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An object that describes the game server group resource with updated properties.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateGameServerGroupResult == false)
            return false;
        UpdateGameServerGroupResult other = (UpdateGameServerGroupResult) obj;
    ...
    public UpdateGameServerGroupResult clone() {
        try {
            return (UpdateGameServerGroupResult) super.clone();
