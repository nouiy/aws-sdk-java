...
@SdkInternalApi
public class StartMatchBackfillRequestMarshaller {
    ...
    private static final StartMatchBackfillRequestMarshaller instance = new StartMatchBackfillRequestMarshaller();

    public static StartMatchBackfillRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(StartMatchBackfillRequest startMatchBackfillRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startMatchBackfillRequest.getTicketId(), TICKETID_BINDING);
            protocolMarshaller.marshall(startMatchBackfillRequest.getConfigurationName(), CONFIGURATIONNAME_BINDING);
            protocolMarshaller.marshall(startMatchBackfillRequest.getGameSessionArn(), GAMESESSIONARN_BINDING);
            protocolMarshaller.marshall(startMatchBackfillRequest.getPlayers(), PLAYERS_BINDING);
        } catch (Exception e) {
