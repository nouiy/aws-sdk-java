...
public class ListAliasesRequestMarshaller {
    ...
    private static final MarshallingInfo<String> ROUTINGSTRATEGYTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RoutingStrategyType").build();
    ...
    public void marshall(ListAliasesRequest listAliasesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listAliasesRequest.getRoutingStrategyType(), ROUTINGSTRATEGYTYPE_BINDING);
            protocolMarshaller.marshall(listAliasesRequest.getName(), NAME_BINDING);
