...
public class StartMatchmakingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * Ticket representing the matchmaking request. This object include the information included in the request, ticket
     ...
     * </p>
     * 
     * @return Ticket representing the matchmaking request. This object include the information included in the request,
     *         ticket status, and match results as generated during the matchmaking process.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMatchmakingResult == false)
            return false;
        StartMatchmakingResult other = (StartMatchmakingResult) obj;
    ...
    public StartMatchmakingResult clone() {
        try {
            return (StartMatchmakingResult) super.clone();
