...
public class CreateBuildResultJsonUnmarshaller implements Unmarshaller<CreateBuildResult, JsonUnmarshallerContext> {

    public CreateBuildResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateBuildResult createBuildResult = new CreateBuildResult();
    ...
    public static CreateBuildResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateBuildResultJsonUnmarshaller();
        return instance;
    }
}
