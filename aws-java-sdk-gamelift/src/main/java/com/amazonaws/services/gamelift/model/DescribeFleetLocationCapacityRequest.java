...
public class DescribeFleetLocationCapacityRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A unique identifier for the fleet to request location capacity for. You can use either the fleet ID or
     *         ARN value.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFleetLocationCapacityRequest == false)
            return false;
        DescribeFleetLocationCapacityRequest other = (DescribeFleetLocationCapacityRequest) obj;
    ...
    public DescribeFleetLocationCapacityRequest clone() {
        return (DescribeFleetLocationCapacityRequest) super.clone();
    }
