...
/**
 * DeleteGameSessionQueueResult JSON Unmarshaller
 */
...
public class DeleteGameSessionQueueResultJsonUnmarshaller implements Unmarshaller<DeleteGameSessionQueueResult, JsonUnmarshallerContext> {
    ...
    public DeleteGameSessionQueueResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteGameSessionQueueResult deleteGameSessionQueueResult = new DeleteGameSessionQueueResult();

        return deleteGameSessionQueueResult;
    }
