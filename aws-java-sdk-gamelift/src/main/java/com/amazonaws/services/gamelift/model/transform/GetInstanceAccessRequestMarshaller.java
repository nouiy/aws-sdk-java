...
public class GetInstanceAccessRequestMarshaller {
    ...
    private static final GetInstanceAccessRequestMarshaller instance = new GetInstanceAccessRequestMarshaller();

    public static GetInstanceAccessRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GetInstanceAccessRequest getInstanceAccessRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getInstanceAccessRequest.getFleetId(), FLEETID_BINDING);
            protocolMarshaller.marshall(getInstanceAccessRequest.getInstanceId(), INSTANCEID_BINDING);
        } catch (Exception e) {
