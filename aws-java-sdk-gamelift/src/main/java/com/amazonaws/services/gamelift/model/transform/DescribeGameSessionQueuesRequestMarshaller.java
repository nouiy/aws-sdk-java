...
@SdkInternalApi
public class DescribeGameSessionQueuesRequestMarshaller {
    ...
    private static final DescribeGameSessionQueuesRequestMarshaller instance = new DescribeGameSessionQueuesRequestMarshaller();

    public static DescribeGameSessionQueuesRequestMarshaller getInstance() {
        return instance;
    }
