...
public class DescribeGameSessionDetailsResultJsonUnmarshaller implements Unmarshaller<DescribeGameSessionDetailsResult, JsonUnmarshallerContext> {
    ...
    private static DescribeGameSessionDetailsResultJsonUnmarshaller instance;

    public static DescribeGameSessionDetailsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeGameSessionDetailsResultJsonUnmarshaller();
        return instance;
    }
}
