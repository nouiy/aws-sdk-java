...
public class UpdateFleetCapacityResultJsonUnmarshaller implements Unmarshaller<UpdateFleetCapacityResult, JsonUnmarshallerContext> {
    ...
    private static UpdateFleetCapacityResultJsonUnmarshaller instance;

    public static UpdateFleetCapacityResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateFleetCapacityResultJsonUnmarshaller();
        return instance;
    }
}
