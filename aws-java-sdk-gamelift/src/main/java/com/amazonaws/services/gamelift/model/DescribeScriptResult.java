...
public class DescribeScriptResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeScriptResult == false)
            return false;
        DescribeScriptResult other = (DescribeScriptResult) obj;
    ...
    @Override
    public DescribeScriptResult clone() {
        try {
            return (DescribeScriptResult) super.clone();
