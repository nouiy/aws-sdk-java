...
@SdkInternalApi
public class DescribeScriptRequestMarshaller {
    ...
    private static final DescribeScriptRequestMarshaller instance = new DescribeScriptRequestMarshaller();

    public static DescribeScriptRequestMarshaller getInstance() {
        return instance;
    }
