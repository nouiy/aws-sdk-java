...
public class FilterConfigurationMarshaller {
    ...
    private static final MarshallingInfo<List> ALLOWEDLOCATIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AllowedLocations").build();
    ...
    public void marshall(FilterConfiguration filterConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filterConfiguration.getAllowedLocations(), ALLOWEDLOCATIONS_BINDING);
        } catch (Exception e) {
