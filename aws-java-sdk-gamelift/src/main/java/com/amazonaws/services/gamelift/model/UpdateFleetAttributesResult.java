...
public class UpdateFleetAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateFleetAttributesResult withFleetArn(String fleetArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateFleetAttributesResult == false)
            return false;
        UpdateFleetAttributesResult other = (UpdateFleetAttributesResult) obj;
    ...
    public UpdateFleetAttributesResult clone() {
        try {
            return (UpdateFleetAttributesResult) super.clone();
