...
public class GameSessionFullExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static GameSessionFullExceptionUnmarshaller instance;

    public static GameSessionFullExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new GameSessionFullExceptionUnmarshaller();
        return instance;
    }
}
