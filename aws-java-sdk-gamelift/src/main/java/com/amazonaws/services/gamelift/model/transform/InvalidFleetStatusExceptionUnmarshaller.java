...
public class InvalidFleetStatusExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidFleetStatusExceptionUnmarshaller instance;

    public static InvalidFleetStatusExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidFleetStatusExceptionUnmarshaller();
        return instance;
    }
}
