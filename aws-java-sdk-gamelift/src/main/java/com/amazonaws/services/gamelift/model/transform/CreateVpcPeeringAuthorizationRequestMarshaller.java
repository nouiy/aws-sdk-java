...
@SdkInternalApi
public class CreateVpcPeeringAuthorizationRequestMarshaller {
    ...
    private static final CreateVpcPeeringAuthorizationRequestMarshaller instance = new CreateVpcPeeringAuthorizationRequestMarshaller();

    public static CreateVpcPeeringAuthorizationRequestMarshaller getInstance() {
        return instance;
    }
