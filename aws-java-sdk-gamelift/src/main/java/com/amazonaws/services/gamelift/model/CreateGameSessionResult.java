...
public class CreateGameSessionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateGameSessionResult == false)
            return false;
        CreateGameSessionResult other = (CreateGameSessionResult) obj;
    ...
    public CreateGameSessionResult clone() {
        try {
            return (CreateGameSessionResult) super.clone();
