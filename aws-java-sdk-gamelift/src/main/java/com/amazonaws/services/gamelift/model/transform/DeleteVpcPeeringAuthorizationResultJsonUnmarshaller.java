...
/**
 * DeleteVpcPeeringAuthorizationResult JSON Unmarshaller
 */
...
public class DeleteVpcPeeringAuthorizationResultJsonUnmarshaller implements Unmarshaller<DeleteVpcPeeringAuthorizationResult, JsonUnmarshallerContext> {
    ...
    public DeleteVpcPeeringAuthorizationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteVpcPeeringAuthorizationResult deleteVpcPeeringAuthorizationResult = new DeleteVpcPeeringAuthorizationResult();

        return deleteVpcPeeringAuthorizationResult;
    }
