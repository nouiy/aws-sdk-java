...
public class TerminalRoutingStrategyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TerminalRoutingStrategyExceptionUnmarshaller instance;

    public static TerminalRoutingStrategyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TerminalRoutingStrategyExceptionUnmarshaller();
        return instance;
    }
}
