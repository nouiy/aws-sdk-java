...
public class InvalidGameSessionStatusExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidGameSessionStatusExceptionUnmarshaller instance;

    public static InvalidGameSessionStatusExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidGameSessionStatusExceptionUnmarshaller();
        return instance;
    }
}
