...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.iotdeviceadvisor.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.iotdeviceadvisor.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotdeviceadvisor.model.ConflictException conflictException = new com.amazonaws.services.iotdeviceadvisor.model.ConflictException(
                null);
