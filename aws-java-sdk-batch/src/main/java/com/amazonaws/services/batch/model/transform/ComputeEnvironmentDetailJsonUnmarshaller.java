...
public class ComputeEnvironmentDetailJsonUnmarshaller implements Unmarshaller<ComputeEnvironmentDetail, JsonUnmarshallerContext> {
    ...
    private static ComputeEnvironmentDetailJsonUnmarshaller instance;

    public static ComputeEnvironmentDetailJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComputeEnvironmentDetailJsonUnmarshaller();
        return instance;
    }
}
