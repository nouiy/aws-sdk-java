...
/**
 * EksContainerOverride JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EksContainerOverrideJsonUnmarshaller implements Unmarshaller<EksContainerOverride, JsonUnmarshallerContext> {

    public EksContainerOverride unmarshall(JsonUnmarshallerContext context) throws Exception {
        EksContainerOverride eksContainerOverride = new EksContainerOverride();
    ...
    private static EksContainerOverrideJsonUnmarshaller instance;

    public static EksContainerOverrideJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EksContainerOverrideJsonUnmarshaller();
        return instance;
    }
}
