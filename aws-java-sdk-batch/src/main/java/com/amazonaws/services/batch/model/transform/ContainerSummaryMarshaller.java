...
public class ContainerSummaryMarshaller {
    ...
    public void marshall(ContainerSummary containerSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(containerSummary.getExitCode(), EXITCODE_BINDING);
            protocolMarshaller.marshall(containerSummary.getReason(), REASON_BINDING);
        } catch (Exception e) {
