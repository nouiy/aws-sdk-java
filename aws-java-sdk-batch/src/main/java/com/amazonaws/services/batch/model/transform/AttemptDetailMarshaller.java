...
public class AttemptDetailMarshaller {
    ...
    public void marshall(AttemptDetail attemptDetail, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attemptDetail.getContainer(), CONTAINER_BINDING);
            protocolMarshaller.marshall(attemptDetail.getStartedAt(), STARTEDAT_BINDING);
            protocolMarshaller.marshall(attemptDetail.getStoppedAt(), STOPPEDAT_BINDING);
            protocolMarshaller.marshall(attemptDetail.getStatusReason(), STATUSREASON_BINDING);
        } catch (Exception e) {
