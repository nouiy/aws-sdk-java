...
@SdkInternalApi
public class EksAttemptDetailMarshaller {
    ...
    private static final EksAttemptDetailMarshaller instance = new EksAttemptDetailMarshaller();

    public static EksAttemptDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EksAttemptDetail eksAttemptDetail, ProtocolMarshaller protocolMarshaller) {

        if (eksAttemptDetail == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(eksAttemptDetail.getStoppedAt(), STOPPEDAT_BINDING);
            protocolMarshaller.marshall(eksAttemptDetail.getStatusReason(), STATUSREASON_BINDING);
        } catch (Exception e) {
