...
public class DescribeSchedulingPoliciesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<SchedulingPolicyDetail> schedulingPolicies;
    ...
    public java.util.List<SchedulingPolicyDetail> getSchedulingPolicies() {
    ...
    public void setSchedulingPolicies(java.util.Collection<SchedulingPolicyDetail> schedulingPolicies) {
        if (schedulingPolicies == null) {
            this.schedulingPolicies = null;
            return;
        }

        this.schedulingPolicies = new java.util.ArrayList<SchedulingPolicyDetail>(schedulingPolicies);
    }
    ...
    public DescribeSchedulingPoliciesResult withSchedulingPolicies(SchedulingPolicyDetail... schedulingPolicies) {
        if (this.schedulingPolicies == null) {
            setSchedulingPolicies(new java.util.ArrayList<SchedulingPolicyDetail>(schedulingPolicies.length));
        }
    ...
    public DescribeSchedulingPoliciesResult withSchedulingPolicies(java.util.Collection<SchedulingPolicyDetail> schedulingPolicies) {
