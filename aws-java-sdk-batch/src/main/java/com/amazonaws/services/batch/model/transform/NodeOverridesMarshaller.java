...
public class NodeOverridesMarshaller {
    ...
    private static final NodeOverridesMarshaller instance = new NodeOverridesMarshaller();

    public static NodeOverridesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NodeOverrides nodeOverrides, ProtocolMarshaller protocolMarshaller) {
