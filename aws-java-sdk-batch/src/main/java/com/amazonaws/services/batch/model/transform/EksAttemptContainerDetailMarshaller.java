...
/**
 * EksAttemptContainerDetailMarshaller
 */
...
public class EksAttemptContainerDetailMarshaller {
    ...
    private static final EksAttemptContainerDetailMarshaller instance = new EksAttemptContainerDetailMarshaller();

    public static EksAttemptContainerDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EksAttemptContainerDetail eksAttemptContainerDetail, ProtocolMarshaller protocolMarshaller) {

        if (eksAttemptContainerDetail == null) {
