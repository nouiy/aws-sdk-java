...
/**
 * EksContainerOverrideMarshaller
 */
...
public class EksContainerOverrideMarshaller {
    ...
    private static final EksContainerOverrideMarshaller instance = new EksContainerOverrideMarshaller();

    public static EksContainerOverrideMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EksContainerOverride eksContainerOverride, ProtocolMarshaller protocolMarshaller) {

        if (eksContainerOverride == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(eksContainerOverride.getEnv(), ENV_BINDING);
            protocolMarshaller.marshall(eksContainerOverride.getResources(), RESOURCES_BINDING);
        } catch (Exception e) {
