...
public class InternalServerErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.mediapackage.model.InternalServerErrorException.class, "InternalServerErrorException");
    }

    @Override
    public com.amazonaws.services.mediapackage.model.InternalServerErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mediapackage.model.InternalServerErrorException internalServerErrorException = new com.amazonaws.services.mediapackage.model.InternalServerErrorException(
                null);
