...
public class TooManyRequestsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyRequestsExceptionUnmarshaller() {
        super(com.amazonaws.services.mediapackage.model.TooManyRequestsException.class, "TooManyRequestsException");
    }

    @Override
    public com.amazonaws.services.mediapackage.model.TooManyRequestsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.mediapackage.model.TooManyRequestsException tooManyRequestsException = new com.amazonaws.services.mediapackage.model.TooManyRequestsException(
                null);
