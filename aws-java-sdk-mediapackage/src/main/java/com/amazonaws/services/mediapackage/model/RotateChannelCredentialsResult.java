...
public class RotateChannelCredentialsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public RotateChannelCredentialsResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RotateChannelCredentialsResult == false)
            return false;
        RotateChannelCredentialsResult other = (RotateChannelCredentialsResult) obj;
    ...
    public RotateChannelCredentialsResult clone() {
        try {
            return (RotateChannelCredentialsResult) super.clone();
