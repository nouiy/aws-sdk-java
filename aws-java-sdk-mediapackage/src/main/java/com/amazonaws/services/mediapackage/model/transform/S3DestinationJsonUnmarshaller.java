        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("manifestKey", targetDepth)) {
                    context.nextToken();
                    s3Destination.setManifestKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("roleArn", targetDepth)) {
                    context.nextToken();
                    s3Destination.setRoleArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
