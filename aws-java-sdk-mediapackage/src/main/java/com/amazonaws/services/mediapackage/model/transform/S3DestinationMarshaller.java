...
public class S3DestinationMarshaller {
    ...
    private static final MarshallingInfo<String> MANIFESTKEY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("manifestKey").build();
    ...
    public void marshall(S3Destination s3Destination, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(s3Destination.getManifestKey(), MANIFESTKEY_BINDING);
            protocolMarshaller.marshall(s3Destination.getRoleArn(), ROLEARN_BINDING);
        } catch (Exception e) {
