...
public class CmafEncryptionMarshaller {
    ...
    private static final CmafEncryptionMarshaller instance = new CmafEncryptionMarshaller();

    public static CmafEncryptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CmafEncryption cmafEncryption, ProtocolMarshaller protocolMarshaller) {

        if (cmafEncryption == null) {
