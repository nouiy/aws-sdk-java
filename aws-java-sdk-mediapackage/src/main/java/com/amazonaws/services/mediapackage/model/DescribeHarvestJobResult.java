...
public class DescribeHarvestJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeHarvestJobResult == false)
            return false;
        DescribeHarvestJobResult other = (DescribeHarvestJobResult) obj;
    ...
    public DescribeHarvestJobResult clone() {
        try {
            return (DescribeHarvestJobResult) super.clone();
