 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediapackage-2017-10-12/CmafPackage" target="_top">AWS API
 *      Documentation</a>
 */
...
public class CmafPackage implements Serializable, Cloneable, StructuredPojo {
    ...
    public CmafPackage withSegmentPrefix(String segmentPrefix) {
    ...
    public CmafPackage withStreamSelection(StreamSelection streamSelection) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediapackage.model.transform.CmafPackageMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
