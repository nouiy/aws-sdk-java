...
public class DatasetContentVersionValue implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DatasetContentVersionValue == false)
            return false;
    ...
    public DatasetContentVersionValue clone() {
        try {
            return (DatasetContentVersionValue) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotanalytics.model.transform.DatasetContentVersionValueMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
