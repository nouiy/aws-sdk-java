...
public class StartPipelineReprocessingResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartPipelineReprocessingResult == false)
            return false;
        StartPipelineReprocessingResult other = (StartPipelineReprocessingResult) obj;
    ...
    public StartPipelineReprocessingResult clone() {
        try {
            return (StartPipelineReprocessingResult) super.clone();
