...
/**
 * DeleteDatasetContentRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteDatasetContentRequestMarshaller {
    ...
    private static final DeleteDatasetContentRequestMarshaller instance = new DeleteDatasetContentRequestMarshaller();

    public static DeleteDatasetContentRequestMarshaller getInstance() {
        return instance;
    }
