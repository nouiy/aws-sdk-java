...
/**
 * DatasetTriggerMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DatasetTriggerMarshaller {
    ...
    public static DatasetTriggerMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DatasetTrigger datasetTrigger, ProtocolMarshaller protocolMarshaller) {

        if (datasetTrigger == null) {
