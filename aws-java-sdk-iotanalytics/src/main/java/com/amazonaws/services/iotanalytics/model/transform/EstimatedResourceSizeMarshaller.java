...
/**
 * EstimatedResourceSizeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EstimatedResourceSizeMarshaller {
    ...
    public static EstimatedResourceSizeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EstimatedResourceSize estimatedResourceSize, ProtocolMarshaller protocolMarshaller) {

        if (estimatedResourceSize == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(estimatedResourceSize.getEstimatedSizeInBytes(), ESTIMATEDSIZEINBYTES_BINDING);
            protocolMarshaller.marshall(estimatedResourceSize.getEstimatedOn(), ESTIMATEDON_BINDING);
        } catch (Exception e) {
