        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("entryName", targetDepth)) {
                    context.nextToken();
                    datasetEntry.setEntryName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("dataURI", targetDepth)) {
                    context.nextToken();
                    datasetEntry.setDataURI(context.getUnmarshaller(String.class).unmarshall(context));
                }
