        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("stringValue", targetDepth)) {
                    context.nextToken();
                    variable.setStringValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("doubleValue", targetDepth)) {
                    context.nextToken();
                    variable.setDoubleValue(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("datasetContentVersionValue", targetDepth)) {
                    context.nextToken();
                    variable.setDatasetContentVersionValue(DatasetContentVersionValueJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("outputFileUriValue", targetDepth)) {
                    context.nextToken();
                    variable.setOutputFileUriValue(OutputFileUriValueJsonUnmarshaller.getInstance().unmarshall(context));
                }
