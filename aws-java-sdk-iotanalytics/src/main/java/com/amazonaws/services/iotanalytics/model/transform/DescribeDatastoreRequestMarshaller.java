...
public class DescribeDatastoreRequestMarshaller {
    ...
    public static DescribeDatastoreRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeDatastoreRequest describeDatastoreRequest, ProtocolMarshaller protocolMarshaller) {
