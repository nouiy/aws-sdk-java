        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("pipelineName", targetDepth)) {
                    context.nextToken();
                    createPipelineResult.setPipelineName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("pipelineArn", targetDepth)) {
                    context.nextToken();
                    createPipelineResult.setPipelineArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
