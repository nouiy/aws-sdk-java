...
/**
 * GitHubCodeDestination JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GitHubCodeDestinationJsonUnmarshaller implements Unmarshaller<GitHubCodeDestination, JsonUnmarshallerContext> {

    public GitHubCodeDestination unmarshall(JsonUnmarshallerContext context) throws Exception {
        GitHubCodeDestination gitHubCodeDestination = new GitHubCodeDestination();
    ...
    private static GitHubCodeDestinationJsonUnmarshaller instance;

    public static GitHubCodeDestinationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GitHubCodeDestinationJsonUnmarshaller();
        return instance;
    }
}
