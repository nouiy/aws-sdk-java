...
@SdkInternalApi
public class ListTagsForProjectRequestMarshaller {
    ...
    private static final ListTagsForProjectRequestMarshaller instance = new ListTagsForProjectRequestMarshaller();

    public static ListTagsForProjectRequestMarshaller getInstance() {
        return instance;
    }
