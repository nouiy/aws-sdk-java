...
public class UserProfileSummaryMarshaller {
    ...
    public void marshall(UserProfileSummary userProfileSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(userProfileSummary.getUserArn(), USERARN_BINDING);
            protocolMarshaller.marshall(userProfileSummary.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(userProfileSummary.getEmailAddress(), EMAILADDRESS_BINDING);
            protocolMarshaller.marshall(userProfileSummary.getSshPublicKey(), SSHPUBLICKEY_BINDING);
        } catch (Exception e) {
