...
@SdkInternalApi
public class ToolchainMarshaller {
    ...
    private static final MarshallingInfo<Map> STACKPARAMETERS_BINDING = MarshallingInfo.builder(MarshallingType.MAP).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("stackParameters").build();

    private static final ToolchainMarshaller instance = new ToolchainMarshaller();

    public static ToolchainMarshaller getInstance() {
        return instance;
    }
