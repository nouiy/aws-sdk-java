...
public class CreateUserProfileRequestMarshaller {
    ...
    public void marshall(CreateUserProfileRequest createUserProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createUserProfileRequest.getUserArn(), USERARN_BINDING);
            protocolMarshaller.marshall(createUserProfileRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(createUserProfileRequest.getEmailAddress(), EMAILADDRESS_BINDING);
