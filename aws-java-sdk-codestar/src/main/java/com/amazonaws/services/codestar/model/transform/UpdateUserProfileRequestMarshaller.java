...
public class UpdateUserProfileRequestMarshaller {
    ...
    public void marshall(UpdateUserProfileRequest updateUserProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateUserProfileRequest.getUserArn(), USERARN_BINDING);
            protocolMarshaller.marshall(updateUserProfileRequest.getDisplayName(), DISPLAYNAME_BINDING);
            protocolMarshaller.marshall(updateUserProfileRequest.getEmailAddress(), EMAILADDRESS_BINDING);
