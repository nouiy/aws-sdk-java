...
public class S3LocationMarshaller {
    ...
    private static final MarshallingInfo<String> BUCKETKEY_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("bucketKey").build();
    ...
    public void marshall(S3Location s3Location, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(s3Location.getBucketKey(), BUCKETKEY_BINDING);
        } catch (Exception e) {
