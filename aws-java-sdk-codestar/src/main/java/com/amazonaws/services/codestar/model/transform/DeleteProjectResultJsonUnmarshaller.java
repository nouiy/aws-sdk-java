        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("stackId", targetDepth)) {
                    context.nextToken();
                    deleteProjectResult.setStackId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("projectArn", targetDepth)) {
                    context.nextToken();
                    deleteProjectResult.setProjectArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
