...
/**
 * AssociateMemberAccountResult JSON Unmarshaller
 */
...
public class AssociateMemberAccountResultJsonUnmarshaller implements Unmarshaller<AssociateMemberAccountResult, JsonUnmarshallerContext> {
    ...
    public AssociateMemberAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateMemberAccountResult associateMemberAccountResult = new AssociateMemberAccountResult();
