...
/**
 * ClassificationType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClassificationTypeJsonUnmarshaller implements Unmarshaller<ClassificationType, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("oneTime", targetDepth)) {
                    context.nextToken();
                    classificationType.setOneTime(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("continuous", targetDepth)) {
                    context.nextToken();
                    classificationType.setContinuous(context.getUnmarshaller(String.class).unmarshall(context));
                }
