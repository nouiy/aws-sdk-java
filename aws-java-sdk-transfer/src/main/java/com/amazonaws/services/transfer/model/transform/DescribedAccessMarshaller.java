...
/**
 * DescribedAccessMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribedAccessMarshaller {
    ...
    private static final DescribedAccessMarshaller instance = new DescribedAccessMarshaller();

    public static DescribedAccessMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribedAccess describedAccess, ProtocolMarshaller protocolMarshaller) {

        if (describedAccess == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(describedAccess.getHomeDirectory(), HOMEDIRECTORY_BINDING);
            protocolMarshaller.marshall(describedAccess.getHomeDirectoryMappings(), HOMEDIRECTORYMAPPINGS_BINDING);
            protocolMarshaller.marshall(describedAccess.getHomeDirectoryType(), HOMEDIRECTORYTYPE_BINDING);
            protocolMarshaller.marshall(describedAccess.getPolicy(), POLICY_BINDING);
            protocolMarshaller.marshall(describedAccess.getPosixProfile(), POSIXPROFILE_BINDING);
            protocolMarshaller.marshall(describedAccess.getRole(), ROLE_BINDING);
            protocolMarshaller.marshall(describedAccess.getExternalId(), EXTERNALID_BINDING);
        } catch (Exception e) {
