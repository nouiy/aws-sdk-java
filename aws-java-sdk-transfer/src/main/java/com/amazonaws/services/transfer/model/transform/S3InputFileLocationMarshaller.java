...
public class S3InputFileLocationMarshaller {
    ...
    public void marshall(S3InputFileLocation s3InputFileLocation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3InputFileLocation.getBucket(), BUCKET_BINDING);
            protocolMarshaller.marshall(s3InputFileLocation.getKey(), KEY_BINDING);
        } catch (Exception e) {
