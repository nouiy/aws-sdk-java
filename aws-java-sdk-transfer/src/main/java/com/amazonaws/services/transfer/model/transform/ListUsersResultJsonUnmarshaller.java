        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ServerId", targetDepth)) {
                    context.nextToken();
                    listUsersResult.setServerId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Users", targetDepth)) {
                    context.nextToken();
                    listUsersResult.setUsers(new ListUnmarshaller<ListedUser>(ListedUserJsonUnmarshaller.getInstance())
