...
public class FileLocationMarshaller {
    ...
    public void marshall(FileLocation fileLocation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(fileLocation.getS3FileLocation(), S3FILELOCATION_BINDING);
            protocolMarshaller.marshall(fileLocation.getEfsFileLocation(), EFSFILELOCATION_BINDING);
        } catch (Exception e) {
