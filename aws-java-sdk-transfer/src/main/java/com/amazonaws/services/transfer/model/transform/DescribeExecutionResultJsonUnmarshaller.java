        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WorkflowId", targetDepth)) {
                    context.nextToken();
                    describeExecutionResult.setWorkflowId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Execution", targetDepth)) {
                    context.nextToken();
                    describeExecutionResult.setExecution(DescribedExecutionJsonUnmarshaller.getInstance().unmarshall(context));
                }
