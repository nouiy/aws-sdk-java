...
/**
 * CreateAccessRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateAccessRequestMarshaller {
    ...
    private static final CreateAccessRequestMarshaller instance = new CreateAccessRequestMarshaller();

    public static CreateAccessRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateAccessRequest createAccessRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createAccessRequest.getHomeDirectory(), HOMEDIRECTORY_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getHomeDirectoryType(), HOMEDIRECTORYTYPE_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getHomeDirectoryMappings(), HOMEDIRECTORYMAPPINGS_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getPolicy(), POLICY_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getPosixProfile(), POSIXPROFILE_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getRole(), ROLE_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getServerId(), SERVERID_BINDING);
            protocolMarshaller.marshall(createAccessRequest.getExternalId(), EXTERNALID_BINDING);
        } catch (Exception e) {
