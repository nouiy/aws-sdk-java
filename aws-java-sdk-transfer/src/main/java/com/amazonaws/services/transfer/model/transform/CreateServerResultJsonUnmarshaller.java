...
/**
 * CreateServerResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateServerResultJsonUnmarshaller implements Unmarshaller<CreateServerResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ServerId", targetDepth)) {
                    context.nextToken();
                    createServerResult.setServerId(context.getUnmarshaller(String.class).unmarshall(context));
                }
