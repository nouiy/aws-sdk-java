...
@SdkInternalApi
public class DescribedExecutionMarshaller {
    ...
    private static final DescribedExecutionMarshaller instance = new DescribedExecutionMarshaller();

    public static DescribedExecutionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribedExecution describedExecution, ProtocolMarshaller protocolMarshaller) {

        if (describedExecution == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(describedExecution.getExecutionId(), EXECUTIONID_BINDING);
            protocolMarshaller.marshall(describedExecution.getInitialFileLocation(), INITIALFILELOCATION_BINDING);
            protocolMarshaller.marshall(describedExecution.getServiceMetadata(), SERVICEMETADATA_BINDING);
            protocolMarshaller.marshall(describedExecution.getExecutionRole(), EXECUTIONROLE_BINDING);
            protocolMarshaller.marshall(describedExecution.getLoggingConfiguration(), LOGGINGCONFIGURATION_BINDING);
            protocolMarshaller.marshall(describedExecution.getPosixProfile(), POSIXPROFILE_BINDING);
            protocolMarshaller.marshall(describedExecution.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(describedExecution.getResults(), RESULTS_BINDING);
        } catch (Exception e) {
