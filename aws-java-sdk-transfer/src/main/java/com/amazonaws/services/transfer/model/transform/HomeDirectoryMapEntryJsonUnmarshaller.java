...
/**
 * HomeDirectoryMapEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HomeDirectoryMapEntryJsonUnmarshaller implements Unmarshaller<HomeDirectoryMapEntry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Entry", targetDepth)) {
                    context.nextToken();
                    homeDirectoryMapEntry.setEntry(context.getUnmarshaller(String.class).unmarshall(context));
                }
