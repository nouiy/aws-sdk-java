        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LoggingRole", targetDepth)) {
                    context.nextToken();
                    loggingConfiguration.setLoggingRole(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LogGroupName", targetDepth)) {
                    context.nextToken();
                    loggingConfiguration.setLogGroupName(context.getUnmarshaller(String.class).unmarshall(context));
                }
