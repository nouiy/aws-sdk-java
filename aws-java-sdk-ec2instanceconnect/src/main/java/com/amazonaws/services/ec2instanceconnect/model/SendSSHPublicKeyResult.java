...
public class SendSSHPublicKeyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public SendSSHPublicKeyResult withRequestId(String requestId) {
    ...
    public SendSSHPublicKeyResult withSuccess(Boolean success) {
        setSuccess(success);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SendSSHPublicKeyResult == false)
            return false;
        SendSSHPublicKeyResult other = (SendSSHPublicKeyResult) obj;
    ...
    @Override
    public SendSSHPublicKeyResult clone() {
        try {
            return (SendSSHPublicKeyResult) super.clone();
