...
/**
 * GetSignalingChannelEndpointResult JSON Unmarshaller
 */
...
public class GetSignalingChannelEndpointResultJsonUnmarshaller implements Unmarshaller<GetSignalingChannelEndpointResult, JsonUnmarshallerContext> {
    ...
    public GetSignalingChannelEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
