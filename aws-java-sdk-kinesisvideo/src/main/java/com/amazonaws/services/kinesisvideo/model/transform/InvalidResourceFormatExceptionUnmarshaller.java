...
public class InvalidResourceFormatExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidResourceFormatExceptionUnmarshaller instance;

    public static InvalidResourceFormatExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidResourceFormatExceptionUnmarshaller();
        return instance;
    }
}
