...
public class DeviceStreamLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DeviceStreamLimitExceededExceptionUnmarshaller instance;

    public static DeviceStreamLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeviceStreamLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
