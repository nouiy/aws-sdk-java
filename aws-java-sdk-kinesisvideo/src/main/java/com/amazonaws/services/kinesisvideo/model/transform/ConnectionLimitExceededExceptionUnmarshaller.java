...
public class ConnectionLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ConnectionLimitExceededExceptionUnmarshaller instance;

    public static ConnectionLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConnectionLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
