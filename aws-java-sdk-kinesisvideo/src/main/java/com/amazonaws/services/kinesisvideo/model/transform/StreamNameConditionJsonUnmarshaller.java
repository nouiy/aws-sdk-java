...
/**
 * StreamNameCondition JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ComparisonOperator", targetDepth)) {
                    context.nextToken();
                    streamNameCondition.setComparisonOperator(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ComparisonValue", targetDepth)) {
                    context.nextToken();
                    streamNameCondition.setComparisonValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
