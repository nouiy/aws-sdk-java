...
/**
 * ImageGenerationConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImageGenerationConfigurationJsonUnmarshaller implements Unmarshaller<ImageGenerationConfiguration, JsonUnmarshallerContext> {

    public ImageGenerationConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
