...
public class ListSignalingChannelsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ChannelInfo> channelInfoList;
    /**
     * <p>
     ...
     * {@link #setChannelInfoList(java.util.Collection)} or {@link #withChannelInfoList(java.util.Collection)} if you
    ...
    public ListSignalingChannelsResult withChannelInfoList(ChannelInfo... channelInfoList) {
        if (this.channelInfoList == null) {
            setChannelInfoList(new java.util.ArrayList<ChannelInfo>(channelInfoList.length));
        }
        for (ChannelInfo ele : channelInfoList) {
            this.channelInfoList.add(ele);
        }
        return this;
    }
    ...
    public String toString() {
        ...
        if (getChannelInfoList() != null)
            sb.append("ChannelInfoList: ").append(getChannelInfoList()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getChannelInfoList() == null ^ this.getChannelInfoList() == null)
            return false;
        if (other.getChannelInfoList() != null && other.getChannelInfoList().equals(this.getChannelInfoList()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getChannelInfoList() == null) ? 0 : getChannelInfoList().hashCode());
        hashCode = prime * hashCode + ((getNextToken() == null) ? 0 : getNextToken().hashCode());
        return hashCode;
    }

    @Override
    public ListSignalingChannelsResult clone() {
        try {
