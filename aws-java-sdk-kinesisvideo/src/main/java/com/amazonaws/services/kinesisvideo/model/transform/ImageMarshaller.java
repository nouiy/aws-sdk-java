...
public class ImageMarshaller {
    ...
    private static final MarshallingInfo<String> IMAGECONTENT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ImageContent").build();
    ...
    public void marshall(Image image, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(image.getTimeStamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(image.getError(), ERROR_BINDING);
            protocolMarshaller.marshall(image.getImageContent(), IMAGECONTENT_BINDING);
        } catch (Exception e) {
