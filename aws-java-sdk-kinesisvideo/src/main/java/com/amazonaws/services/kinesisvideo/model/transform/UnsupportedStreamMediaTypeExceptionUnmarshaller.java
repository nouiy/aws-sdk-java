...
public class UnsupportedStreamMediaTypeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedStreamMediaTypeExceptionUnmarshaller instance;

    public static UnsupportedStreamMediaTypeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedStreamMediaTypeExceptionUnmarshaller();
        return instance;
    }
}
