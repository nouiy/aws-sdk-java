...
@SdkInternalApi
public class ClipTimestampRangeMarshaller {
    ...
    private static final ClipTimestampRangeMarshaller instance = new ClipTimestampRangeMarshaller();

    public static ClipTimestampRangeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ClipTimestampRange clipTimestampRange, ProtocolMarshaller protocolMarshaller) {

        if (clipTimestampRange == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(clipTimestampRange.getStartTimestamp(), STARTTIMESTAMP_BINDING);
            protocolMarshaller.marshall(clipTimestampRange.getEndTimestamp(), ENDTIMESTAMP_BINDING);
        } catch (Exception e) {
