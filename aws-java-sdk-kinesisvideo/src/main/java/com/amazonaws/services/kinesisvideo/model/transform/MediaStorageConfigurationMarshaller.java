...
/**
 * MediaStorageConfigurationMarshaller
 */
...
public class MediaStorageConfigurationMarshaller {
    ...
    public void marshall(MediaStorageConfiguration mediaStorageConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(mediaStorageConfiguration.getStreamARN(), STREAMARN_BINDING);
            protocolMarshaller.marshall(mediaStorageConfiguration.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
