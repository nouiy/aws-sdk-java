...
public class UpdateNotificationConfigurationRequestMarshaller {
    ...
    private static final UpdateNotificationConfigurationRequestMarshaller instance = new UpdateNotificationConfigurationRequestMarshaller();

    public static UpdateNotificationConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateNotificationConfigurationRequest updateNotificationConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateNotificationConfigurationRequest.getStreamName(), STREAMNAME_BINDING);
            protocolMarshaller.marshall(updateNotificationConfigurationRequest.getStreamARN(), STREAMARN_BINDING);
            protocolMarshaller.marshall(updateNotificationConfigurationRequest.getNotificationConfiguration(), NOTIFICATIONCONFIGURATION_BINDING);
        } catch (Exception e) {
