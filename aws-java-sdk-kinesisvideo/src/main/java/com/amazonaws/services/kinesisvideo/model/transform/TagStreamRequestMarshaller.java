...
/**
 * TagStreamRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TagStreamRequestMarshaller {
    ...
    private static final TagStreamRequestMarshaller instance = new TagStreamRequestMarshaller();

    public static TagStreamRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(TagStreamRequest tagStreamRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(tagStreamRequest.getStreamARN(), STREAMARN_BINDING);
            protocolMarshaller.marshall(tagStreamRequest.getStreamName(), STREAMNAME_BINDING);
            protocolMarshaller.marshall(tagStreamRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
