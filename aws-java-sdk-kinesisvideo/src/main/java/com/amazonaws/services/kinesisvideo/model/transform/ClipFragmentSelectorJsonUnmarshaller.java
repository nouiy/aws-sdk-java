...
/**
 * ClipFragmentSelector JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClipFragmentSelectorJsonUnmarshaller implements Unmarshaller<ClipFragmentSelector, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FragmentSelectorType", targetDepth)) {
                    context.nextToken();
                    clipFragmentSelector.setFragmentSelectorType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TimestampRange", targetDepth)) {
                    context.nextToken();
                    clipFragmentSelector.setTimestampRange(ClipTimestampRangeJsonUnmarshaller.getInstance().unmarshall(context));
                }
