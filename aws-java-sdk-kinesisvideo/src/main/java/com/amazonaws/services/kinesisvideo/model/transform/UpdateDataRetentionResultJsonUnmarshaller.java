...
/**
 * UpdateDataRetentionResult JSON Unmarshaller
 */
...
public class UpdateDataRetentionResultJsonUnmarshaller implements Unmarshaller<UpdateDataRetentionResult, JsonUnmarshallerContext> {
    ...
    public UpdateDataRetentionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateDataRetentionResult updateDataRetentionResult = new UpdateDataRetentionResult();
