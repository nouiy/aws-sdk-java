...
public class DescribeImageGenerationConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the stream from which to retrieve the image generation configuration. You must specify either
     *         the <code>StreamName</code> or the <code>StreamARN</code>.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the Kinesis video stream from which to retrieve the image generation
     *         configuration. You must specify either the <code>StreamName</code> or the <code>StreamARN</code>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeImageGenerationConfigurationRequest == false)
            return false;
        DescribeImageGenerationConfigurationRequest other = (DescribeImageGenerationConfigurationRequest) obj;
    ...
    public DescribeImageGenerationConfigurationRequest clone() {
        return (DescribeImageGenerationConfigurationRequest) super.clone();
    }
