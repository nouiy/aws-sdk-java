...
/**
 * DASHFragmentSelector JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DASHFragmentSelectorJsonUnmarshaller implements Unmarshaller<DASHFragmentSelector, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FragmentSelectorType", targetDepth)) {
                    context.nextToken();
                    dASHFragmentSelector.setFragmentSelectorType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TimestampRange", targetDepth)) {
                    context.nextToken();
                    dASHFragmentSelector.setTimestampRange(DASHTimestampRangeJsonUnmarshaller.getInstance().unmarshall(context));
                }
