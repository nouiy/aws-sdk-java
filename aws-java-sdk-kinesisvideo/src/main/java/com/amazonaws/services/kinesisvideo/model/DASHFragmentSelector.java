 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-archived-media-2017-09-30/DASHFragmentSelector"
...
public class DASHFragmentSelector implements Serializable, Cloneable, StructuredPojo {
     ...
     *        fragment (up to the <a>GetDASHStreamingSessionURLInput$MaxManifestFragmentResults</a> value) are included.
     *        </p>
     *        <p>
     ...
     *        <p>
     *        When <code>FragmentSelectorType</code> is set to <code>PRODUCER_TIMESTAMP</code> and
     *        <a>GetDASHStreamingSessionURLInput$PlaybackMode</a> is <code>LIVE</code>, the producer timestamps are used
    ...
    public DASHFragmentSelector withFragmentSelectorType(DASHFragmentSelectorType fragmentSelectorType) {
    ...
    @Override
    public DASHFragmentSelector clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisvideo.model.transform.DASHFragmentSelectorMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
