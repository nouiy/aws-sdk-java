...
/**
 * NotificationDestinationConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NotificationDestinationConfigJsonUnmarshaller implements Unmarshaller<NotificationDestinationConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Uri", targetDepth)) {
                    context.nextToken();
                    notificationDestinationConfig.setUri(context.getUnmarshaller(String.class).unmarshall(context));
                }
