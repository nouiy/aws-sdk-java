        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TimeStamp", targetDepth)) {
                    context.nextToken();
                    image.setTimeStamp(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
                if (context.testExpression("Error", targetDepth)) {
                    context.nextToken();
                    image.setError(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ImageContent", targetDepth)) {
                    context.nextToken();
                    image.setImageContent(context.getUnmarshaller(String.class).unmarshall(context));
                }
