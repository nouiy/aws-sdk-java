...
public class NotificationConfigurationMarshaller {
    ...
    public void marshall(NotificationConfiguration notificationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(notificationConfiguration.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(notificationConfiguration.getDestinationConfig(), DESTINATIONCONFIG_BINDING);
        } catch (Exception e) {
