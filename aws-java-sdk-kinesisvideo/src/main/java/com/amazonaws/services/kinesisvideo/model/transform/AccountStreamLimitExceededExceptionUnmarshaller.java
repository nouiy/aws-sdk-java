...
public class AccountStreamLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AccountStreamLimitExceededExceptionUnmarshaller instance;

    public static AccountStreamLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountStreamLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
