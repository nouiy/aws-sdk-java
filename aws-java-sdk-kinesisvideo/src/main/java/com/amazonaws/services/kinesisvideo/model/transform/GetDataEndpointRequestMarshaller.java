...
/**
 * GetDataEndpointRequestMarshaller
 */
...
public class GetDataEndpointRequestMarshaller {
    ...
    private static final GetDataEndpointRequestMarshaller instance = new GetDataEndpointRequestMarshaller();

    public static GetDataEndpointRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetDataEndpointRequest getDataEndpointRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getDataEndpointRequest.getStreamName(), STREAMNAME_BINDING);
            protocolMarshaller.marshall(getDataEndpointRequest.getStreamARN(), STREAMARN_BINDING);
            protocolMarshaller.marshall(getDataEndpointRequest.getAPIName(), APINAME_BINDING);
        } catch (Exception e) {
