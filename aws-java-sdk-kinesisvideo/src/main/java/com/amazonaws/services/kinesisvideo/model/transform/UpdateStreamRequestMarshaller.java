...
public class UpdateStreamRequestMarshaller {
    ...
    public void marshall(UpdateStreamRequest updateStreamRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateStreamRequest.getStreamName(), STREAMNAME_BINDING);
            protocolMarshaller.marshall(updateStreamRequest.getStreamARN(), STREAMARN_BINDING);
            protocolMarshaller.marshall(updateStreamRequest.getCurrentVersion(), CURRENTVERSION_BINDING);
            protocolMarshaller.marshall(updateStreamRequest.getDeviceName(), DEVICENAME_BINDING);
            protocolMarshaller.marshall(updateStreamRequest.getMediaType(), MEDIATYPE_BINDING);
        } catch (Exception e) {
