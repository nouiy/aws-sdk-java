...
/**
 * GetHLSStreamingSessionURLResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetHLSStreamingSessionURLResultJsonUnmarshaller implements Unmarshaller<GetHLSStreamingSessionURLResult, JsonUnmarshallerContext> {

    public GetHLSStreamingSessionURLResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("HLSStreamingSessionURL", targetDepth)) {
                    context.nextToken();
                    getHLSStreamingSessionURLResult.setHLSStreamingSessionURL(context.getUnmarshaller(String.class).unmarshall(context));
                }
