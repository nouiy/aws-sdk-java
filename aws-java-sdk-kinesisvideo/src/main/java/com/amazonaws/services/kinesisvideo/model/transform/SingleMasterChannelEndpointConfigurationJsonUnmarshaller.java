...
/**
 * SingleMasterChannelEndpointConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SingleMasterChannelEndpointConfigurationJsonUnmarshaller implements
        Unmarshaller<SingleMasterChannelEndpointConfiguration, JsonUnmarshallerContext> {

    public SingleMasterChannelEndpointConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Role", targetDepth)) {
                    context.nextToken();
                    singleMasterChannelEndpointConfiguration.setRole(context.getUnmarshaller(String.class).unmarshall(context));
                }
