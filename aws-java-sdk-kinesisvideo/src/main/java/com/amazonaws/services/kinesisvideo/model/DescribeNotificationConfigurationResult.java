...
public class DescribeNotificationConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The structure that contains the information required for notifications. If the structure is null, the
     *         configuration will be deleted from the stream.
     */
    ...
    public DescribeNotificationConfigurationResult clone() {
        try {
            return (DescribeNotificationConfigurationResult) super.clone();
