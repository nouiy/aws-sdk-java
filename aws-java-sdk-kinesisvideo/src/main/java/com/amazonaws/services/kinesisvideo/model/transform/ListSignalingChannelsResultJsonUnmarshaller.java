...
/**
 * ListSignalingChannelsResult JSON Unmarshaller
 */
...
public class ListSignalingChannelsResultJsonUnmarshaller implements Unmarshaller<ListSignalingChannelsResult, JsonUnmarshallerContext> {
    ...
    public ListSignalingChannelsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listSignalingChannelsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
