...
/**
 * GetDataEndpointResult JSON Unmarshaller
 */
...
public class GetDataEndpointResultJsonUnmarshaller implements Unmarshaller<GetDataEndpointResult, JsonUnmarshallerContext> {
    ...
    public GetDataEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DataEndpoint", targetDepth)) {
                    context.nextToken();
                    getDataEndpointResult.setDataEndpoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
