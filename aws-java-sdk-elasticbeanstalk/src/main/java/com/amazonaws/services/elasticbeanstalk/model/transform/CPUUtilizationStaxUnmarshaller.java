...
public class CPUUtilizationStaxUnmarshaller implements Unmarshaller<CPUUtilization, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("User", targetDepth)) {
                    cPUUtilization.setUser(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Nice", targetDepth)) {
                    cPUUtilization.setNice(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("System", targetDepth)) {
                    cPUUtilization.setSystem(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Idle", targetDepth)) {
                    cPUUtilization.setIdle(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("IOWait", targetDepth)) {
                    cPUUtilization.setIOWait(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("IRQ", targetDepth)) {
                    cPUUtilization.setIRQ(DoubleStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
