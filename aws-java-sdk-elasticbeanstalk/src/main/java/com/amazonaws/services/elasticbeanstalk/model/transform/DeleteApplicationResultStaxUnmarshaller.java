...
public class DeleteApplicationResultStaxUnmarshaller implements Unmarshaller<DeleteApplicationResult, StaxUnmarshallerContext> {

    public DeleteApplicationResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    public static DeleteApplicationResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DeleteApplicationResultStaxUnmarshaller();
        return instance;
    }
}
