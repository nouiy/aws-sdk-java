...
public class ServiceUnavailableExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceUnavailableExceptionUnmarshaller() {
        super(com.amazonaws.services.sagemakerfeaturestoreruntime.model.ServiceUnavailableException.class, "ServiceUnavailable");
    }

    @Override
    public com.amazonaws.services.sagemakerfeaturestoreruntime.model.ServiceUnavailableException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.sagemakerfeaturestoreruntime.model.ServiceUnavailableException serviceUnavailableException = new com.amazonaws.services.sagemakerfeaturestoreruntime.model.ServiceUnavailableException(
                null);
