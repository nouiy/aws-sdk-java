...
public class AmazonSageMakerFeatureStoreRuntimeException extends com.amazonaws.AmazonServiceException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new AmazonSageMakerFeatureStoreRuntimeException with the specified error message.
     *
     * @param message
