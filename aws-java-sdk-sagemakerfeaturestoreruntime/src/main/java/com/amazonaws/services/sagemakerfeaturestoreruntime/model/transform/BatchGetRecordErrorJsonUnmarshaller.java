...
/**
 * BatchGetRecordError JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetRecordErrorJsonUnmarshaller implements Unmarshaller<BatchGetRecordError, JsonUnmarshallerContext> {

    public BatchGetRecordError unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchGetRecordError batchGetRecordError = new BatchGetRecordError();
    ...
    private static BatchGetRecordErrorJsonUnmarshaller instance;

    public static BatchGetRecordErrorJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BatchGetRecordErrorJsonUnmarshaller();
        return instance;
    }
}
