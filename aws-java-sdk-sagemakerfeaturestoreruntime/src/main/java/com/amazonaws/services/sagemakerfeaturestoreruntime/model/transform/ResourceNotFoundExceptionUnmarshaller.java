...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.sagemakerfeaturestoreruntime.model.ResourceNotFoundException.class, "ResourceNotFound");
    }

    @Override
    public com.amazonaws.services.sagemakerfeaturestoreruntime.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.sagemakerfeaturestoreruntime.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.sagemakerfeaturestoreruntime.model.ResourceNotFoundException(
                null);
