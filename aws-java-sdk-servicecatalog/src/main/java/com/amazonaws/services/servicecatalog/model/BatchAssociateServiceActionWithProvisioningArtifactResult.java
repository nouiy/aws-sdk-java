...
public class BatchAssociateServiceActionWithProvisioningArtifactResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public BatchAssociateServiceActionWithProvisioningArtifactResult withFailedServiceActionAssociations(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchAssociateServiceActionWithProvisioningArtifactResult == false)
            return false;
        BatchAssociateServiceActionWithProvisioningArtifactResult other = (BatchAssociateServiceActionWithProvisioningArtifactResult) obj;
    ...
    @Override
    public BatchAssociateServiceActionWithProvisioningArtifactResult clone() {
        try {
            return (BatchAssociateServiceActionWithProvisioningArtifactResult) super.clone();
