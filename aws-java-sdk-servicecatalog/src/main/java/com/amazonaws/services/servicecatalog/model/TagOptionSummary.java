...
public class TagOptionSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public TagOptionSummary clone() {
        try {
            return (TagOptionSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.servicecatalog.model.transform.TagOptionSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
