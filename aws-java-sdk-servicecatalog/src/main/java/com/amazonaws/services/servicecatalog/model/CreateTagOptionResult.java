...
public class CreateTagOptionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public CreateTagOptionResult clone() {
        try {
            return (CreateTagOptionResult) super.clone();
