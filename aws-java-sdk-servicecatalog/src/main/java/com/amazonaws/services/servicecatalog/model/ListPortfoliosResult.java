...
public class ListPortfoliosResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListPortfoliosResult withPortfolioDetails(PortfolioDetail... portfolioDetails) {
    ...
    public ListPortfoliosResult withPortfolioDetails(java.util.Collection<PortfolioDetail> portfolioDetails) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPortfoliosResult == false)
            return false;
        ListPortfoliosResult other = (ListPortfoliosResult) obj;
    ...
    public ListPortfoliosResult clone() {
        try {
            return (ListPortfoliosResult) super.clone();
