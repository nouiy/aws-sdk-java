...
/**
 * AcceptPortfolioShareResult JSON Unmarshaller
 */
...
public class AcceptPortfolioShareResultJsonUnmarshaller implements Unmarshaller<AcceptPortfolioShareResult, JsonUnmarshallerContext> {
    ...
    public AcceptPortfolioShareResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AcceptPortfolioShareResult acceptPortfolioShareResult = new AcceptPortfolioShareResult();
