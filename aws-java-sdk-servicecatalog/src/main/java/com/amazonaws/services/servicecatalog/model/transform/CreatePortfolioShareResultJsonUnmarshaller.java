...
/**
 * CreatePortfolioShareResult JSON Unmarshaller
 */
...
public class CreatePortfolioShareResultJsonUnmarshaller implements Unmarshaller<CreatePortfolioShareResult, JsonUnmarshallerContext> {
    ...
    public CreatePortfolioShareResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreatePortfolioShareResult createPortfolioShareResult = new CreatePortfolioShareResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("PortfolioShareToken", targetDepth)) {
                    context.nextToken();
                    createPortfolioShareResult.setPortfolioShareToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
