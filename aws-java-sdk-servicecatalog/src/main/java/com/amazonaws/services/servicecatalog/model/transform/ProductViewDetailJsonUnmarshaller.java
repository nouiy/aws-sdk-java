...
/**
 * ProductViewDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProductViewDetailJsonUnmarshaller implements Unmarshaller<ProductViewDetail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProductViewSummary", targetDepth)) {
                    context.nextToken();
                    productViewDetail.setProductViewSummary(ProductViewSummaryJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    productViewDetail.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ProductARN", targetDepth)) {
                    context.nextToken();
                    productViewDetail.setProductARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
