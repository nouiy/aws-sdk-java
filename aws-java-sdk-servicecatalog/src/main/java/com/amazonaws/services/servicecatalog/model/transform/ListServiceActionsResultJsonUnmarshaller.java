...
/**
 * ListServiceActionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListServiceActionsResultJsonUnmarshaller implements Unmarshaller<ListServiceActionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    listServiceActionsResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
