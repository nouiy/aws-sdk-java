...
public class ListServiceActionsForProvisioningArtifactResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public ListServiceActionsForProvisioningArtifactResult withServiceActionSummaries(ServiceActionSummary... serviceActionSummaries) {
    ...
    public ListServiceActionsForProvisioningArtifactResult withServiceActionSummaries(java.util.Collection<ServiceActionSummary> serviceActionSummaries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServiceActionsForProvisioningArtifactResult == false)
            return false;
        ListServiceActionsForProvisioningArtifactResult other = (ListServiceActionsForProvisioningArtifactResult) obj;
    ...
    public ListServiceActionsForProvisioningArtifactResult clone() {
        try {
            return (ListServiceActionsForProvisioningArtifactResult) super.clone();
