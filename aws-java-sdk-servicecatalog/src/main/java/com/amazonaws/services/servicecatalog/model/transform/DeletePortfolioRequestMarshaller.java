...
@SdkInternalApi
public class DeletePortfolioRequestMarshaller {
    ...
    private static final DeletePortfolioRequestMarshaller instance = new DeletePortfolioRequestMarshaller();

    public static DeletePortfolioRequestMarshaller getInstance() {
        return instance;
    }
