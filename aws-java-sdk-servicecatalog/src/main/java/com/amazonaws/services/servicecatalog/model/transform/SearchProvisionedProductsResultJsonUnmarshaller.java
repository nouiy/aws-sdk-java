...
/**
 * SearchProvisionedProductsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchProvisionedProductsResultJsonUnmarshaller implements Unmarshaller<SearchProvisionedProductsResult, JsonUnmarshallerContext> {

    public SearchProvisionedProductsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("TotalResultsCount", targetDepth)) {
                    context.nextToken();
                    searchProvisionedProductsResult.setTotalResultsCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("NextPageToken", targetDepth)) {
                    context.nextToken();
                    searchProvisionedProductsResult.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
