...
/**
 * ProvisionedProductPlanSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProvisionedProductPlanSummaryJsonUnmarshaller implements Unmarshaller<ProvisionedProductPlanSummary, JsonUnmarshallerContext> {

    public ProvisionedProductPlanSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProvisionedProductPlanSummary provisionedProductPlanSummary = new ProvisionedProductPlanSummary();
    ...
    private static ProvisionedProductPlanSummaryJsonUnmarshaller instance;

    public static ProvisionedProductPlanSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProvisionedProductPlanSummaryJsonUnmarshaller();
        return instance;
    }
}
