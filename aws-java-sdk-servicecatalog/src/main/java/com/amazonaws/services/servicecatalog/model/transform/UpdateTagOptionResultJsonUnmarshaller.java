...
/**
 * UpdateTagOptionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateTagOptionResultJsonUnmarshaller implements Unmarshaller<UpdateTagOptionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TagOptionDetail", targetDepth)) {
                    context.nextToken();
                    updateTagOptionResult.setTagOptionDetail(TagOptionDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
