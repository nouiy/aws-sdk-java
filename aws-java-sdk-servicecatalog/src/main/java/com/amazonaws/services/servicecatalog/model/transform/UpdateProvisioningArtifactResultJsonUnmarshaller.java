...
/**
 * UpdateProvisioningArtifactResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateProvisioningArtifactResultJsonUnmarshaller implements Unmarshaller<UpdateProvisioningArtifactResult, JsonUnmarshallerContext> {

    public UpdateProvisioningArtifactResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Info", targetDepth)) {
                    context.nextToken();
                    updateProvisioningArtifactResult.setInfo(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                            .getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    updateProvisioningArtifactResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
