...
public class ListLaunchPathsRequestMarshaller {
    ...
    private static final ListLaunchPathsRequestMarshaller instance = new ListLaunchPathsRequestMarshaller();

    public static ListLaunchPathsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListLaunchPathsRequest listLaunchPathsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listLaunchPathsRequest.getAcceptLanguage(), ACCEPTLANGUAGE_BINDING);
            protocolMarshaller.marshall(listLaunchPathsRequest.getProductId(), PRODUCTID_BINDING);
            protocolMarshaller.marshall(listLaunchPathsRequest.getPageSize(), PAGESIZE_BINDING);
            protocolMarshaller.marshall(listLaunchPathsRequest.getPageToken(), PAGETOKEN_BINDING);
        } catch (Exception e) {
