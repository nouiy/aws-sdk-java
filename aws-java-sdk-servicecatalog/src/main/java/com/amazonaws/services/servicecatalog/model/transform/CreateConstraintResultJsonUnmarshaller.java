...
/**
 * CreateConstraintResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateConstraintResultJsonUnmarshaller implements Unmarshaller<CreateConstraintResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ConstraintDetail", targetDepth)) {
                    context.nextToken();
                    createConstraintResult.setConstraintDetail(ConstraintDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ConstraintParameters", targetDepth)) {
                    context.nextToken();
                    createConstraintResult.setConstraintParameters(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    createConstraintResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
