...
public class ExecuteProvisionedProductPlanResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ExecuteProvisionedProductPlanResult withRecordDetail(RecordDetail recordDetail) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExecuteProvisionedProductPlanResult == false)
            return false;
        ExecuteProvisionedProductPlanResult other = (ExecuteProvisionedProductPlanResult) obj;
    ...
    @Override
    public ExecuteProvisionedProductPlanResult clone() {
        try {
            return (ExecuteProvisionedProductPlanResult) super.clone();
