...
/**
 * CopyProductResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CopyProductResultJsonUnmarshaller implements Unmarshaller<CopyProductResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CopyProductToken", targetDepth)) {
                    context.nextToken();
                    copyProductResult.setCopyProductToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
