...
/**
 * DeleteTagOptionResult JSON Unmarshaller
 */
...
public class DeleteTagOptionResultJsonUnmarshaller implements Unmarshaller<DeleteTagOptionResult, JsonUnmarshallerContext> {
    ...
    public DeleteTagOptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTagOptionResult deleteTagOptionResult = new DeleteTagOptionResult();
