...
public class PrincipalMarshaller {
    ...
    public void marshall(Principal principal, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(principal.getPrincipalARN(), PRINCIPALARN_BINDING);
            protocolMarshaller.marshall(principal.getPrincipalType(), PRINCIPALTYPE_BINDING);
        } catch (Exception e) {
