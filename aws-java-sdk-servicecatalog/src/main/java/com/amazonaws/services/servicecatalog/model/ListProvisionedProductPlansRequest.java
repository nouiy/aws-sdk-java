...
public class ListProvisionedProductPlansRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListProvisionedProductPlansRequest withAcceptLanguage(String acceptLanguage) {
    ...
    public ListProvisionedProductPlansRequest withProvisionProductId(String provisionProductId) {
    ...
    public ListProvisionedProductPlansRequest withPageSize(Integer pageSize) {
    ...
    public ListProvisionedProductPlansRequest withPageToken(String pageToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListProvisionedProductPlansRequest == false)
            return false;
    ...
    @Override
    public ListProvisionedProductPlansRequest clone() {
