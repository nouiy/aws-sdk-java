...
public class TagOptionNotMigratedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TagOptionNotMigratedExceptionUnmarshaller instance;

    public static TagOptionNotMigratedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TagOptionNotMigratedExceptionUnmarshaller();
        return instance;
    }
}
