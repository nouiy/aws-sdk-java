...
public class ProductViewAggregationValueMarshaller {
    ...
    private static final MarshallingInfo<Integer> APPROXIMATECOUNT_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ApproximateCount").build();
    ...
    public void marshall(ProductViewAggregationValue productViewAggregationValue, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(productViewAggregationValue.getValue(), VALUE_BINDING);
            protocolMarshaller.marshall(productViewAggregationValue.getApproximateCount(), APPROXIMATECOUNT_BINDING);
        } catch (Exception e) {
