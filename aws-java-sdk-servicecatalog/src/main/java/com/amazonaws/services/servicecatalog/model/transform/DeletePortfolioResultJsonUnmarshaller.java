...
/**
 * DeletePortfolioResult JSON Unmarshaller
 */
...
public class DeletePortfolioResultJsonUnmarshaller implements Unmarshaller<DeletePortfolioResult, JsonUnmarshallerContext> {
    ...
    public DeletePortfolioResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePortfolioResult deletePortfolioResult = new DeletePortfolioResult();
