...
/**
 * DisassociateServiceActionFromProvisioningArtifactRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DisassociateServiceActionFromProvisioningArtifactRequestMarshaller {
    ...
    public static DisassociateServiceActionFromProvisioningArtifactRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DisassociateServiceActionFromProvisioningArtifactRequest disassociateServiceActionFromProvisioningArtifactRequest,
        ...
        try {
            protocolMarshaller.marshall(disassociateServiceActionFromProvisioningArtifactRequest.getProductId(), PRODUCTID_BINDING);
