...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudwatchrum.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.cloudwatchrum.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudwatchrum.model.InternalServerException internalServerException = new com.amazonaws.services.cloudwatchrum.model.InternalServerException(
                null);
