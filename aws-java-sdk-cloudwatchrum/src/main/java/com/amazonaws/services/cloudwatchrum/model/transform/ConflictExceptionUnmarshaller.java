...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudwatchrum.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.cloudwatchrum.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudwatchrum.model.ConflictException conflictException = new com.amazonaws.services.cloudwatchrum.model.ConflictException(null);
