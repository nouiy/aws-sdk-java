...
/**
 * Fluent builder for {@link com.amazonaws.services.cloudwatchrum.AWSCloudWatchRUMAsync}. Use of the builder is
...
public final class AWSCloudWatchRUMAsyncClientBuilder extends AwsAsyncClientBuilder<AWSCloudWatchRUMAsyncClientBuilder, AWSCloudWatchRUMAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AWSCloudWatchRUMAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSCloudWatchRUMAsync.
     */
    @Override
    protected AWSCloudWatchRUMAsync build(AwsAsyncClientParams params) {
        return new AWSCloudWatchRUMAsyncClient(params);
    }
