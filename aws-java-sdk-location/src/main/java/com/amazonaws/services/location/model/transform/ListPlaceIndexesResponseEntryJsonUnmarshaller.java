...
/**
 * ListPlaceIndexesResponseEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListPlaceIndexesResponseEntryJsonUnmarshaller implements Unmarshaller<ListPlaceIndexesResponseEntry, JsonUnmarshallerContext> {

    public ListPlaceIndexesResponseEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
