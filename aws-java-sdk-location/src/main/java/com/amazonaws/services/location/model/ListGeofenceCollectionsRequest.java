...
public class ListGeofenceCollectionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListGeofenceCollectionsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListGeofenceCollectionsRequest == false)
            return false;
        ListGeofenceCollectionsRequest other = (ListGeofenceCollectionsRequest) obj;
    ...
    @Override
    public ListGeofenceCollectionsRequest clone() {
        return (ListGeofenceCollectionsRequest) super.clone();
    }
