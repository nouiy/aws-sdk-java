...
/**
 * CreateMapResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateMapResultJsonUnmarshaller implements Unmarshaller<CreateMapResult, JsonUnmarshallerContext> {
    ...
    private static CreateMapResultJsonUnmarshaller instance;

    public static CreateMapResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateMapResultJsonUnmarshaller();
        return instance;
    }
}
