...
/**
 * BatchGetDevicePositionError JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetDevicePositionErrorJsonUnmarshaller implements Unmarshaller<BatchGetDevicePositionError, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeviceId", targetDepth)) {
                    context.nextToken();
                    batchGetDevicePositionError.setDeviceId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Error", targetDepth)) {
                    context.nextToken();
                    batchGetDevicePositionError.setError(BatchItemErrorJsonUnmarshaller.getInstance().unmarshall(context));
                }
