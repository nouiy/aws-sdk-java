...
@SdkInternalApi
public class UpdateGeofenceCollectionRequestMarshaller {
    ...
    public static UpdateGeofenceCollectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateGeofenceCollectionRequest updateGeofenceCollectionRequest, ProtocolMarshaller protocolMarshaller) {
