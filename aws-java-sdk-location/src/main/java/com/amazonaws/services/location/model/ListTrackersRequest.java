...
public class ListTrackersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListTrackersRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTrackersRequest == false)
            return false;
        ListTrackersRequest other = (ListTrackersRequest) obj;
    ...
    @Override
    public ListTrackersRequest clone() {
        return (ListTrackersRequest) super.clone();
    }
