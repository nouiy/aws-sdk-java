...
/**
 * ListDevicePositionsResult JSON Unmarshaller
 */
...
public class ListDevicePositionsResultJsonUnmarshaller implements Unmarshaller<ListDevicePositionsResult, JsonUnmarshallerContext> {
    ...
    public ListDevicePositionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Entries", targetDepth)) {
                    context.nextToken();
                    listDevicePositionsResult.setEntries(new ListUnmarshaller<ListDevicePositionsResponseEntry>(
                            ListDevicePositionsResponseEntryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDevicePositionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
