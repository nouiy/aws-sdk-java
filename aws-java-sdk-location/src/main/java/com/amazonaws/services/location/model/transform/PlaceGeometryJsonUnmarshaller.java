...
/**
 * PlaceGeometry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PlaceGeometryJsonUnmarshaller implements Unmarshaller<PlaceGeometry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Point", targetDepth)) {
                    context.nextToken();
                    placeGeometry.setPoint(new ListUnmarshaller<Double>(context.getUnmarshaller(Double.class))
