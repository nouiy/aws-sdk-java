...
/**
 * ListGeofencesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListGeofencesResultJsonUnmarshaller implements Unmarshaller<ListGeofencesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Entries", targetDepth)) {
                    context.nextToken();
                    listGeofencesResult.setEntries(new ListUnmarshaller<ListGeofenceResponseEntry>(ListGeofenceResponseEntryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listGeofencesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
