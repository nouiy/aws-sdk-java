...
/**
 * SearchPlaceIndexForPositionSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchPlaceIndexForPositionSummaryJsonUnmarshaller implements Unmarshaller<SearchPlaceIndexForPositionSummary, JsonUnmarshallerContext> {

    public SearchPlaceIndexForPositionSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Position", targetDepth)) {
                    context.nextToken();
                    searchPlaceIndexForPositionSummary.setPosition(new ListUnmarshaller<Double>(context.getUnmarshaller(Double.class))
