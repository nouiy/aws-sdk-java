...
public class GetMapStyleDescriptorRequestMarshaller {
    ...
    private static final GetMapStyleDescriptorRequestMarshaller instance = new GetMapStyleDescriptorRequestMarshaller();

    public static GetMapStyleDescriptorRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetMapStyleDescriptorRequest getMapStyleDescriptorRequest, ProtocolMarshaller protocolMarshaller) {
