...
/**
 * ListTrackersResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListTrackersResultJsonUnmarshaller implements Unmarshaller<ListTrackersResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Entries", targetDepth)) {
                    context.nextToken();
                    listTrackersResult.setEntries(new ListUnmarshaller<ListTrackersResponseEntry>(ListTrackersResponseEntryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listTrackersResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
