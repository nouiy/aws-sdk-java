...
/**
 * CreateRouteCalculatorRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateRouteCalculatorRequestMarshaller {
    ...
    private static final CreateRouteCalculatorRequestMarshaller instance = new CreateRouteCalculatorRequestMarshaller();

    public static CreateRouteCalculatorRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateRouteCalculatorRequest createRouteCalculatorRequest, ProtocolMarshaller protocolMarshaller) {
