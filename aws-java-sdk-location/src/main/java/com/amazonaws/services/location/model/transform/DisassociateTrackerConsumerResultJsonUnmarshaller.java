...
/**
 * DisassociateTrackerConsumerResult JSON Unmarshaller
 */
...
public class DisassociateTrackerConsumerResultJsonUnmarshaller implements Unmarshaller<DisassociateTrackerConsumerResult, JsonUnmarshallerContext> {
    ...
    public DisassociateTrackerConsumerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
