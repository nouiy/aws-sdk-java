...
@SdkInternalApi
public class BatchUpdateDevicePositionErrorMarshaller {
    ...
    public static BatchUpdateDevicePositionErrorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchUpdateDevicePositionError batchUpdateDevicePositionError, ProtocolMarshaller protocolMarshaller) {

        if (batchUpdateDevicePositionError == null) {
