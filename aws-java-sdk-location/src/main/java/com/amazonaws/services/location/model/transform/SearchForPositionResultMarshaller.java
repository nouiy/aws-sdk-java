...
/**
 * SearchForPositionResultMarshaller
 */
...
public class SearchForPositionResultMarshaller {
    ...
    public static SearchForPositionResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchForPositionResult searchForPositionResult, ProtocolMarshaller protocolMarshaller) {

        if (searchForPositionResult == null) {
