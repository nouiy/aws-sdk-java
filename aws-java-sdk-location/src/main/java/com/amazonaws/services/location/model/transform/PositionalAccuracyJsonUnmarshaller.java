...
/**
 * PositionalAccuracy JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PositionalAccuracyJsonUnmarshaller implements Unmarshaller<PositionalAccuracy, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Horizontal", targetDepth)) {
                    context.nextToken();
                    positionalAccuracy.setHorizontal(context.getUnmarshaller(Double.class).unmarshall(context));
                }
