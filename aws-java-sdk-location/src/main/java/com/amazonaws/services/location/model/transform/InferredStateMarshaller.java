...
public class InferredStateMarshaller {
    ...
    private static final MarshallingInfo<Double> DEVIATIONDISTANCE_BINDING = MarshallingInfo.builder(MarshallingType.DOUBLE)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("DeviationDistance").build();
    private static final MarshallingInfo<Boolean> PROXYDETECTED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ProxyDetected").build();
