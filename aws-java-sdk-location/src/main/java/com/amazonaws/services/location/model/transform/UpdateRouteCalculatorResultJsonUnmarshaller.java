...
/**
 * UpdateRouteCalculatorResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateRouteCalculatorResultJsonUnmarshaller implements Unmarshaller<UpdateRouteCalculatorResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("UpdateTime", targetDepth)) {
                    context.nextToken();
                    updateRouteCalculatorResult.setUpdateTime(DateJsonUnmarshallerFactory.getInstance("iso8601").unmarshall(context));
                }
