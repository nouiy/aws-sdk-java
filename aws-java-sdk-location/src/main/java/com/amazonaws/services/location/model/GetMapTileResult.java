...
public class GetMapTileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Contains Mapbox Vector Tile (MVT) data.
     */
     ...
     * </p>
     * 
     * @return The map tile's content type. For example, <code>application/vnd.mapbox-vector-tile</code>.
     */
    ...
    @Override
    public GetMapTileResult clone() {
        try {
            return (GetMapTileResult) super.clone();
