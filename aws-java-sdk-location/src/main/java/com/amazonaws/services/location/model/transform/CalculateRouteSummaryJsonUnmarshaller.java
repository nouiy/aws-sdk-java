...
/**
 * CalculateRouteSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CalculateRouteSummaryJsonUnmarshaller implements Unmarshaller<CalculateRouteSummary, JsonUnmarshallerContext> {

    public CalculateRouteSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
