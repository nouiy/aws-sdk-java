 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/location-2020-11-19/ListDevicePositionsResponseEntry"
...
public class ListDevicePositionsResponseEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public ListDevicePositionsResponseEntry withPosition(java.util.Collection<Double> position) {
     ...
     *
     * @see ListDevicePositionsResponseEntry#withPositionProperties
    ...
    @Override
    public ListDevicePositionsResponseEntry clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.location.model.transform.ListDevicePositionsResponseEntryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
