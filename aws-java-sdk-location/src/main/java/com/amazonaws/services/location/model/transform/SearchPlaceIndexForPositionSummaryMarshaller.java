...
public class SearchPlaceIndexForPositionSummaryMarshaller {
    ...
    public static SearchPlaceIndexForPositionSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SearchPlaceIndexForPositionSummary searchPlaceIndexForPositionSummary, ProtocolMarshaller protocolMarshaller) {

        if (searchPlaceIndexForPositionSummary == null) {
