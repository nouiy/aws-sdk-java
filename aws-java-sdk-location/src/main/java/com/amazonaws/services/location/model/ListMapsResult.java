...
public class ListMapsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Contains a list of maps in your AWS account
     */
    ...
    public void setEntries(java.util.Collection<ListMapsResponseEntry> entries) {
        ...
        this.entries = new java.util.ArrayList<ListMapsResponseEntry>(entries);
    }
    ...
    public ListMapsResult withEntries(ListMapsResponseEntry... entries) {
        if (this.entries == null) {
            setEntries(new java.util.ArrayList<ListMapsResponseEntry>(entries.length));
        }
        for (ListMapsResponseEntry ele : entries) {
    ...
    public ListMapsResult withEntries(java.util.Collection<ListMapsResponseEntry> entries) {
        setEntries(entries);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMapsResult == false)
            return false;
        ListMapsResult other = (ListMapsResult) obj;
    ...
    public ListMapsResult clone() {
        try {
            return (ListMapsResult) super.clone();
