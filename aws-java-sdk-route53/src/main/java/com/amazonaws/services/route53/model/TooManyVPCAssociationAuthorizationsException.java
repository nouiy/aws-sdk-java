 ...
 * another VPC to be associated with the hosted zone, submit a <code>DeleteVPCAssociationAuthorization</code> request to
 * remove an existing authorization. To get a list of existing authorizations, submit a
...
public class TooManyVPCAssociationAuthorizationsException extends com.amazonaws.services.route53.model.AmazonRoute53Exception {
    ...
    /**
     * Constructs a new TooManyVPCAssociationAuthorizationsException with the specified error message.
     *
     * @param message
