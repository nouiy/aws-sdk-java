...
public class NoSuchDelegationSetExceptionUnmarshaller extends StandardErrorUnmarshaller {

    public NoSuchDelegationSetExceptionUnmarshaller() {
        super(NoSuchDelegationSetException.class);
    }
