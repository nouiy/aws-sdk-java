        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Type", targetDepth)) {
                    hostedZoneLimit.setType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Value", targetDepth)) {
                    hostedZoneLimit.setValue(LongStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
