...
public class CreateVPCAssociationAuthorizationRequestMarshaller implements
        Marshaller<Request<CreateVPCAssociationAuthorizationRequest>, CreateVPCAssociationAuthorizationRequest> {

    public Request<CreateVPCAssociationAuthorizationRequest> marshall(CreateVPCAssociationAuthorizationRequest createVPCAssociationAuthorizationRequest) {
