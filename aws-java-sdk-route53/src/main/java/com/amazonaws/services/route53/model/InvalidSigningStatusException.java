...
public class InvalidSigningStatusException extends com.amazonaws.services.route53.model.AmazonRoute53Exception {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new InvalidSigningStatusException with the specified error message.
     *
     * @param message
