...
public class GetTrafficPolicyResultStaxUnmarshaller implements Unmarshaller<GetTrafficPolicyResult, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("TrafficPolicy", targetDepth)) {
                    getTrafficPolicyResult.setTrafficPolicy(TrafficPolicyStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
