...
public class CreateTrafficPolicyVersionRequestMarshaller implements Marshaller<Request<CreateTrafficPolicyVersionRequest>, CreateTrafficPolicyVersionRequest> {
    ...
    public Request<CreateTrafficPolicyVersionRequest> marshall(CreateTrafficPolicyVersionRequest createTrafficPolicyVersionRequest) {
        ...
        Request<CreateTrafficPolicyVersionRequest> request = new DefaultRequest<CreateTrafficPolicyVersionRequest>(createTrafficPolicyVersionRequest,
                "AmazonRoute53");
        ...
        try {
            ...
            if (createTrafficPolicyVersionRequest != null) {
                ...
                if (createTrafficPolicyVersionRequest.getDocument() != null) {
                    xmlWriter.startElement("Document").value(createTrafficPolicyVersionRequest.getDocument()).endElement();
                }

                if (createTrafficPolicyVersionRequest.getComment() != null) {
