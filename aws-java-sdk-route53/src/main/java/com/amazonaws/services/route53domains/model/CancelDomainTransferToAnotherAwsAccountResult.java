...
public class CancelDomainTransferToAnotherAwsAccountResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public CancelDomainTransferToAnotherAwsAccountResult clone() {
        try {
            return (CancelDomainTransferToAnotherAwsAccountResult) super.clone();
