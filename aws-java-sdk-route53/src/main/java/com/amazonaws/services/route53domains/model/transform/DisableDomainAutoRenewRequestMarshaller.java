...
/**
 * DisableDomainAutoRenewRequestMarshaller
 */
...
public class DisableDomainAutoRenewRequestMarshaller {
    ...
    private static final DisableDomainAutoRenewRequestMarshaller instance = new DisableDomainAutoRenewRequestMarshaller();

    public static DisableDomainAutoRenewRequestMarshaller getInstance() {
        return instance;
    }
