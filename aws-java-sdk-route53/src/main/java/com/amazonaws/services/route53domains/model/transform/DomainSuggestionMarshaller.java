...
public class DomainSuggestionMarshaller {
    ...
    public void marshall(DomainSuggestion domainSuggestion, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(domainSuggestion.getDomainName(), DOMAINNAME_BINDING);
            protocolMarshaller.marshall(domainSuggestion.getAvailability(), AVAILABILITY_BINDING);
        } catch (Exception e) {
