...
public class RejectDomainTransferFromAnotherAwsAccountRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public RejectDomainTransferFromAnotherAwsAccountRequest clone() {
        return (RejectDomainTransferFromAnotherAwsAccountRequest) super.clone();
    }
