...
/**
 * Fluent builder for {@link com.amazonaws.services.route53domains.AmazonRoute53Domains}. Use of the builder is
...
public final class AmazonRoute53DomainsClientBuilder extends AwsSyncClientBuilder<AmazonRoute53DomainsClientBuilder, AmazonRoute53Domains> {
    ...
    /**
     * Construct a synchronous implementation of AmazonRoute53Domains using the current builder configuration.
     *
     * @param params
