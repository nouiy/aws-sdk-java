...
/**
 * GetDomainSuggestionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDomainSuggestionsResultJsonUnmarshaller implements Unmarshaller<GetDomainSuggestionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SuggestionsList", targetDepth)) {
                    context.nextToken();
                    getDomainSuggestionsResult.setSuggestionsList(new ListUnmarshaller<DomainSuggestion>(DomainSuggestionJsonUnmarshaller.getInstance())
