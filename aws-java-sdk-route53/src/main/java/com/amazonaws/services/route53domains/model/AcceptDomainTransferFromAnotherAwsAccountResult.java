...
public class AcceptDomainTransferFromAnotherAwsAccountResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptDomainTransferFromAnotherAwsAccountResult == false)
            return false;
        AcceptDomainTransferFromAnotherAwsAccountResult other = (AcceptDomainTransferFromAnotherAwsAccountResult) obj;
    ...
    public AcceptDomainTransferFromAnotherAwsAccountResult clone() {
        try {
            return (AcceptDomainTransferFromAnotherAwsAccountResult) super.clone();
