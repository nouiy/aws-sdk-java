...
@SdkInternalApi
public class PutEventsResultEntryMarshaller {
    ...
    private static final PutEventsResultEntryMarshaller instance = new PutEventsResultEntryMarshaller();

    public static PutEventsResultEntryMarshaller getInstance() {
        return instance;
    }
