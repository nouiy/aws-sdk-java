...
public class LoaMarshaller {
    ...
    private static final MarshallingInfo<java.nio.ByteBuffer> LOACONTENT_BINDING = MarshallingInfo.builder(MarshallingType.BYTE_BUFFER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("loaContent").build();
    ...
    public void marshall(Loa loa, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(loa.getLoaContent(), LOACONTENT_BINDING);
            protocolMarshaller.marshall(loa.getLoaContentType(), LOACONTENTTYPE_BINDING);
        } catch (Exception e) {
