...
public class DirectConnectServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DirectConnectServerExceptionUnmarshaller instance;

    public static DirectConnectServerExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DirectConnectServerExceptionUnmarshaller();
        return instance;
    }
}
