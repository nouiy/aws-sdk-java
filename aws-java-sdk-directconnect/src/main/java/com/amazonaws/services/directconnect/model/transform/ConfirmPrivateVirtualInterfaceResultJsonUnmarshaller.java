...
public class ConfirmPrivateVirtualInterfaceResultJsonUnmarshaller implements Unmarshaller<ConfirmPrivateVirtualInterfaceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("virtualInterfaceState", targetDepth)) {
                    context.nextToken();
                    confirmPrivateVirtualInterfaceResult.setVirtualInterfaceState(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ConfirmPrivateVirtualInterfaceResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConfirmPrivateVirtualInterfaceResultJsonUnmarshaller();
        return instance;
    }
}
