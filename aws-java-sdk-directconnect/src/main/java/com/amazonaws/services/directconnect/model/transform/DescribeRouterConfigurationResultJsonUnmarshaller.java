...
/**
 * DescribeRouterConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeRouterConfigurationResultJsonUnmarshaller implements Unmarshaller<DescribeRouterConfigurationResult, JsonUnmarshallerContext> {

    public DescribeRouterConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DescribeRouterConfigurationResult describeRouterConfigurationResult = new DescribeRouterConfigurationResult();
    ...
    private static DescribeRouterConfigurationResultJsonUnmarshaller instance;

    public static DescribeRouterConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeRouterConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
