...
public class AllocateTransitVirtualInterfaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AllocateTransitVirtualInterfaceResult == false)
            return false;
        AllocateTransitVirtualInterfaceResult other = (AllocateTransitVirtualInterfaceResult) obj;
    ...
    @Override
    public AllocateTransitVirtualInterfaceResult clone() {
        try {
            return (AllocateTransitVirtualInterfaceResult) super.clone();
