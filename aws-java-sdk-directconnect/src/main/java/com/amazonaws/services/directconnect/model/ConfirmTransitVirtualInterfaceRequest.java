...
public class ConfirmTransitVirtualInterfaceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ConfirmTransitVirtualInterfaceRequest clone() {
