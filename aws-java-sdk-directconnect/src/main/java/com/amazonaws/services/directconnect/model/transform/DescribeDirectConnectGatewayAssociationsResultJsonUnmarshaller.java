...
/**
 * DescribeDirectConnectGatewayAssociationsResult JSON Unmarshaller
 */
...
public class DescribeDirectConnectGatewayAssociationsResultJsonUnmarshaller implements
    ...
    public DescribeDirectConnectGatewayAssociationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeDirectConnectGatewayAssociationsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
