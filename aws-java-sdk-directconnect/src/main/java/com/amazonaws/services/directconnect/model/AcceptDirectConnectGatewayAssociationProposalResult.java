...
public class AcceptDirectConnectGatewayAssociationProposalResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public AcceptDirectConnectGatewayAssociationProposalResult withDirectConnectGatewayAssociation(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptDirectConnectGatewayAssociationProposalResult == false)
            return false;
        AcceptDirectConnectGatewayAssociationProposalResult other = (AcceptDirectConnectGatewayAssociationProposalResult) obj;
    ...
    @Override
    public AcceptDirectConnectGatewayAssociationProposalResult clone() {
        try {
            return (AcceptDirectConnectGatewayAssociationProposalResult) super.clone();
