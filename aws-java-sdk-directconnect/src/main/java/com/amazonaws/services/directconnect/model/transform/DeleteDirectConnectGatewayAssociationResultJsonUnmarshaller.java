...
/**
 * DeleteDirectConnectGatewayAssociationResult JSON Unmarshaller
 */
...
public class DeleteDirectConnectGatewayAssociationResultJsonUnmarshaller implements
    ...
    public DeleteDirectConnectGatewayAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("directConnectGatewayAssociation", targetDepth)) {
                    context.nextToken();
                    deleteDirectConnectGatewayAssociationResult.setDirectConnectGatewayAssociation(DirectConnectGatewayAssociationJsonUnmarshaller
