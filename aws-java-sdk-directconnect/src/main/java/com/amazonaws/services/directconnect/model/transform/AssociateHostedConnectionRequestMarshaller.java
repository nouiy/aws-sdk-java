...
/**
 * AssociateHostedConnectionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateHostedConnectionRequestMarshaller {
    ...
    private static final MarshallingInfo<String> PARENTCONNECTIONID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("parentConnectionId").build();

    private static final AssociateHostedConnectionRequestMarshaller instance = new AssociateHostedConnectionRequestMarshaller();

    public static AssociateHostedConnectionRequestMarshaller getInstance() {
        return instance;
    }
