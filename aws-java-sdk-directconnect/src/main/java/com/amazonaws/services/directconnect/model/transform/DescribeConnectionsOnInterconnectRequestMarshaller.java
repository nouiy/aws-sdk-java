...
/**
 * DescribeConnectionsOnInterconnectRequestMarshaller
 */
...
public class DescribeConnectionsOnInterconnectRequestMarshaller {
    ...
    private static final DescribeConnectionsOnInterconnectRequestMarshaller instance = new DescribeConnectionsOnInterconnectRequestMarshaller();

    public static DescribeConnectionsOnInterconnectRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DescribeConnectionsOnInterconnectRequest describeConnectionsOnInterconnectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeConnectionsOnInterconnectRequest.getInterconnectId(), INTERCONNECTID_BINDING);
        } catch (Exception e) {
