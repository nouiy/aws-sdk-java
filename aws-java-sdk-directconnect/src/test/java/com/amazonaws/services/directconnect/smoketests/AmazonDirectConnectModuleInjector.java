...
public class AmazonDirectConnectModuleInjector implements InjectorSource {
    ...
    public Injector getInjector() {
        return Guice.createInjector(Stage.PRODUCTION, CucumberModules.SCENARIO, new AmazonDirectConnectModule());
    }

    static class AmazonDirectConnectModule extends AbstractModule {

        @Override
        protected void configure() {
            bind(AmazonWebServiceClient.class).to(AmazonDirectConnectClient.class);
        }
    }
}
