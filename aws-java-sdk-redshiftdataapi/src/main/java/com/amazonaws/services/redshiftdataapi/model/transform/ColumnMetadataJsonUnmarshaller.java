        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("columnDefault", targetDepth)) {
                    context.nextToken();
                    columnMetadata.setColumnDefault(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("length", targetDepth)) {
                    context.nextToken();
                    columnMetadata.setLength(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
