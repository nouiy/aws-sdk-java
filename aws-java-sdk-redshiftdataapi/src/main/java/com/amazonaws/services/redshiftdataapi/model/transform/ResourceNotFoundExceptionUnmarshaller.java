...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.redshiftdataapi.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.redshiftdataapi.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.redshiftdataapi.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.redshiftdataapi.model.ResourceNotFoundException(
                null);
