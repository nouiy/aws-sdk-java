...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.redshiftdataapi.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.redshiftdataapi.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.redshiftdataapi.model.ValidationException validationException = new com.amazonaws.services.redshiftdataapi.model.ValidationException(
                null);
