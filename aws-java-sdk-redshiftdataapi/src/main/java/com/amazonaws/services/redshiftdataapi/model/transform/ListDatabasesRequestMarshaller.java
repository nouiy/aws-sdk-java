...
public class ListDatabasesRequestMarshaller {
    ...
    public void marshall(ListDatabasesRequest listDatabasesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDatabasesRequest.getClusterIdentifier(), CLUSTERIDENTIFIER_BINDING);
            protocolMarshaller.marshall(listDatabasesRequest.getDatabase(), DATABASE_BINDING);
            protocolMarshaller.marshall(listDatabasesRequest.getDbUser(), DBUSER_BINDING);
