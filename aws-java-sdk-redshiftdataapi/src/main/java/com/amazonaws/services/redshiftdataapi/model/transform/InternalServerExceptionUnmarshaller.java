...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.redshiftdataapi.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.redshiftdataapi.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.redshiftdataapi.model.InternalServerException internalServerException = new com.amazonaws.services.redshiftdataapi.model.InternalServerException(
                null);
