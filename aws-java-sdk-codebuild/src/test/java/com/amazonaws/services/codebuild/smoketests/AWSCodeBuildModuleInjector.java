...
public class AWSCodeBuildModuleInjector implements InjectorSource {
    ...
    public Injector getInjector() {
        return Guice.createInjector(Stage.PRODUCTION, CucumberModules.SCENARIO, new AWSCodeBuildModule());
    }

    static class AWSCodeBuildModule extends AbstractModule {

        @Override
        protected void configure() {
            bind(AmazonWebServiceClient.class).to(AWSCodeBuildClient.class);
        }
    }
}
