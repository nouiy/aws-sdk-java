...
public class OAuthProviderExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OAuthProviderExceptionUnmarshaller instance;

    public static OAuthProviderExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OAuthProviderExceptionUnmarshaller();
        return instance;
    }
}
