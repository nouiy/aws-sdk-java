...
public class CreateReportGroupRequestMarshaller {
    ...
    public static CreateReportGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateReportGroupRequest createReportGroupRequest, ProtocolMarshaller protocolMarshaller) {
