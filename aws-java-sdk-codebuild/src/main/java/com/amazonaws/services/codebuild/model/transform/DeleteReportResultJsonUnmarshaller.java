...
/**
 * DeleteReportResult JSON Unmarshaller
 */
...
public class DeleteReportResultJsonUnmarshaller implements Unmarshaller<DeleteReportResult, JsonUnmarshallerContext> {
    ...
    public DeleteReportResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteReportResult deleteReportResult = new DeleteReportResult();
