...
/**
 * DeleteReportGroupResult JSON Unmarshaller
 */
...
public class DeleteReportGroupResultJsonUnmarshaller implements Unmarshaller<DeleteReportGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteReportGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteReportGroupResult deleteReportGroupResult = new DeleteReportGroupResult();
