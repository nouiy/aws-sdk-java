...
public class ListSharedProjectsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <li>
     * <p>
     * <code>MODIFIED_TIME</code>: List based on when information about the shared project was last changed.
     * </p>
     * </li>
     * </ul>
     */
    ...
    /**
     * <p>
     * The maximum number of paginated shared build projects returned per response. Use <code>nextToken</code> to
     * iterate pages in the list of returned <code>Project</code> objects. The default value is 100.
     * </p>
     */
     ...
     * 
     * @param sortOrder
     *        The order in which to list shared build projects. Valid values include:</p>
     *        <ul>
     *        <li>
     *        <p>
     *        <code>ASCENDING</code>: List in ascending order.
     ...
     * </ul>
     * 
     * @return The order in which to list shared build projects. Valid values include:</p>
     *         <ul>
     *         <li>
     *         <p>
     *         <code>ASCENDING</code>: List in ascending order.
     ...
     * </p>
     * 
     * @return The maximum number of paginated shared build projects returned per response. Use <code>nextToken</code>
     *         to iterate pages in the list of returned <code>Project</code> objects. The default value is 100.
     */
    ...
    public ListSharedProjectsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSharedProjectsRequest == false)
            return false;
        ListSharedProjectsRequest other = (ListSharedProjectsRequest) obj;
    ...
    public ListSharedProjectsRequest clone() {
        return (ListSharedProjectsRequest) super.clone();
    }
