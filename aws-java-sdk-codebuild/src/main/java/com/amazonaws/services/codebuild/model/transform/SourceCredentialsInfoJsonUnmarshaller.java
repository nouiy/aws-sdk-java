...
/**
 * SourceCredentialsInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceCredentialsInfoJsonUnmarshaller implements Unmarshaller<SourceCredentialsInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    sourceCredentialsInfo.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("serverType", targetDepth)) {
                    context.nextToken();
                    sourceCredentialsInfo.setServerType(context.getUnmarshaller(String.class).unmarshall(context));
                }
