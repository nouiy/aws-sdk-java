...
public class RetryBuildBatchResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RetryBuildBatchResult == false)
            return false;
        RetryBuildBatchResult other = (RetryBuildBatchResult) obj;
    ...
    @Override
    public RetryBuildBatchResult clone() {
        try {
