...
public class ListBuildsForProjectResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public ListBuildsForProjectResult clone() {
        try {
            return (ListBuildsForProjectResult) super.clone();
