...
public class AccountLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AccountLimitExceededExceptionUnmarshaller instance;

    public static AccountLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
