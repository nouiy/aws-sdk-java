...
/**
 * StopBuildResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopBuildResultJsonUnmarshaller implements Unmarshaller<StopBuildResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("build", targetDepth)) {
                    context.nextToken();
                    stopBuildResult.setBuild(BuildJsonUnmarshaller.getInstance().unmarshall(context));
                }
