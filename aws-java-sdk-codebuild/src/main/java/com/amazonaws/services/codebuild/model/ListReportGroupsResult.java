...
public class ListReportGroupsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListReportGroupsResult withNextToken(String nextToken) {
    ...
    public ListReportGroupsResult withReportGroups(String... reportGroups) {
    ...
    public ListReportGroupsResult withReportGroups(java.util.Collection<String> reportGroups) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListReportGroupsResult == false)
            return false;
        ListReportGroupsResult other = (ListReportGroupsResult) obj;
    ...
    @Override
    public ListReportGroupsResult clone() {
        try {
