...
public class ListBuildBatchesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * <code>ListBuildBatches</code> to retrieve the next set of items.
     * </p>
     */
    ...
    public ListBuildBatchesResult withIds(java.util.Collection<String> ids) {
        setIds(ids);
        return this;
    }
