...
public class ListSSHPublicKeysResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListSSHPublicKeysResult withSSHPublicKeys(SSHPublicKeyMetadata... sSHPublicKeys) {
        if (this.sSHPublicKeys == null) {
            setSSHPublicKeys(new com.amazonaws.internal.SdkInternalList<SSHPublicKeyMetadata>(sSHPublicKeys.length));
        }
