...
/**
 * PutRolePermissionsBoundaryResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutRolePermissionsBoundaryResultStaxUnmarshaller implements Unmarshaller<PutRolePermissionsBoundaryResult, StaxUnmarshallerContext> {

    public PutRolePermissionsBoundaryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
