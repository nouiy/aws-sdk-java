...
public class DetachUserPolicyResultStaxUnmarshaller implements Unmarshaller<DetachUserPolicyResult, StaxUnmarshallerContext> {

    public DetachUserPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
