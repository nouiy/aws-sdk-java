...
public class UpdateSSHPublicKeyResultStaxUnmarshaller implements Unmarshaller<UpdateSSHPublicKeyResult, StaxUnmarshallerContext> {

    public UpdateSSHPublicKeyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
