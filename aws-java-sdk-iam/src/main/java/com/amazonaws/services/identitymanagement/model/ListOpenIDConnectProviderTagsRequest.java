...
public class ListOpenIDConnectProviderTagsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The ARN of the OpenID Connect (OIDC) identity provider whose tags you want to see.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The ARN of the OpenID Connect (OIDC) identity provider whose tags you want to see.</p>
     *         <p>
     *         This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string
     *         of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also
     *         include any of the following characters: _+=,.@-
    ...
    public ListOpenIDConnectProviderTagsRequest withMaxItems(Integer maxItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListOpenIDConnectProviderTagsRequest == false)
            return false;
        ListOpenIDConnectProviderTagsRequest other = (ListOpenIDConnectProviderTagsRequest) obj;
    ...
    @Override
    public ListOpenIDConnectProviderTagsRequest clone() {
        return (ListOpenIDConnectProviderTagsRequest) super.clone();
    }
