...
public class DeleteGroupPolicyResultStaxUnmarshaller implements Unmarshaller<DeleteGroupPolicyResult, StaxUnmarshallerContext> {

    public DeleteGroupPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
