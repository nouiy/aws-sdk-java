...
public class UploadSSHPublicKeyResultStaxUnmarshaller implements Unmarshaller<UploadSSHPublicKeyResult, StaxUnmarshallerContext> {

    public UploadSSHPublicKeyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
