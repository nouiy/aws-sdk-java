...
/**
 * GenerateOrganizationsAccessReportResult StAX Unmarshaller
 */
...
public class GenerateOrganizationsAccessReportResultStaxUnmarshaller implements Unmarshaller<GenerateOrganizationsAccessReportResult, StaxUnmarshallerContext> {
    ...
    public GenerateOrganizationsAccessReportResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("JobId", targetDepth)) {
                    generateOrganizationsAccessReportResult.setJobId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
