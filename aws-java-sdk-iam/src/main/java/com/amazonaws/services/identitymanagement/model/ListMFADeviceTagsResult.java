...
public class ListMFADeviceTagsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The list of tags that are currently attached to the virtual MFA device. Each tag consists of a key name and an
     ...
     * </p>
     * 
     * @return The list of tags that are currently attached to the virtual MFA device. Each tag consists of a key name
     ...
     * 
     * @param tags
     *        The list of tags that are currently attached to the virtual MFA device. Each tag consists of a key name
    ...
    public ListMFADeviceTagsResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public ListMFADeviceTagsResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public ListMFADeviceTagsResult withIsTruncated(Boolean isTruncated) {
    ...
    public ListMFADeviceTagsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMFADeviceTagsResult == false)
            return false;
        ListMFADeviceTagsResult other = (ListMFADeviceTagsResult) obj;
    ...
    @Override
    public ListMFADeviceTagsResult clone() {
        try {
            return (ListMFADeviceTagsResult) super.clone();
