...
public class ListSAMLProvidersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * {@link #setSAMLProviderList(java.util.Collection)} or {@link #withSAMLProviderList(java.util.Collection)} if you
    ...
    public ListSAMLProvidersResult withSAMLProviderList(SAMLProviderListEntry... sAMLProviderList) {
        if (this.sAMLProviderList == null) {
            setSAMLProviderList(new com.amazonaws.internal.SdkInternalList<SAMLProviderListEntry>(sAMLProviderList.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSAMLProviderList() == null ^ this.getSAMLProviderList() == null)
            return false;
        if (other.getSAMLProviderList() != null && other.getSAMLProviderList().equals(this.getSAMLProviderList()) == false)
            return false;
        return true;
    }
