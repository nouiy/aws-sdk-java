...
public class GetAccessKeyLastUsedResultStaxUnmarshaller implements Unmarshaller<GetAccessKeyLastUsedResult, StaxUnmarshallerContext> {
    ...
    public GetAccessKeyLastUsedResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("UserName", targetDepth)) {
                    getAccessKeyLastUsedResult.setUserName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
