...
public class ListInstanceProfileTagsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The list of tags that are currently attached to the IAM instance profile. Each tag consists of a key name and an
     ...
     * </p>
     * 
     * @return The list of tags that are currently attached to the IAM instance profile. Each tag consists of a key name
     *         and an associated value. If no tags are attached to the specified resource, the response contains an
     *         empty list.
     */
     ...
     * 
     * @param tags
     *        The list of tags that are currently attached to the IAM instance profile. Each tag consists of a key name
    ...
    public ListInstanceProfileTagsResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public ListInstanceProfileTagsResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public ListInstanceProfileTagsResult withIsTruncated(Boolean isTruncated) {
    ...
    public ListInstanceProfileTagsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListInstanceProfileTagsResult == false)
            return false;
        ListInstanceProfileTagsResult other = (ListInstanceProfileTagsResult) obj;
    ...
    @Override
    public ListInstanceProfileTagsResult clone() {
        try {
            return (ListInstanceProfileTagsResult) super.clone();
