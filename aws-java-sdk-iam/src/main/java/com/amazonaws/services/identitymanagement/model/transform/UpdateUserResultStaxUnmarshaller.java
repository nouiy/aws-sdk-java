...
public class UpdateUserResultStaxUnmarshaller implements Unmarshaller<UpdateUserResult, StaxUnmarshallerContext> {

    public UpdateUserResult unmarshall(StaxUnmarshallerContext context) throws Exception {
