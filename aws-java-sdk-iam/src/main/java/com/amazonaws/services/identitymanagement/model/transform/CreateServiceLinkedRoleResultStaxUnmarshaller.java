...
/**
 * CreateServiceLinkedRoleResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateServiceLinkedRoleResultStaxUnmarshaller implements Unmarshaller<CreateServiceLinkedRoleResult, StaxUnmarshallerContext> {

    public CreateServiceLinkedRoleResult unmarshall(StaxUnmarshallerContext context) throws Exception {
