...
public class GetGroupPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for GetGroupPolicyRequest object. Callers should use the setter or fluent setter (with...)
    ...
    /**
     * Constructs a new GetGroupPolicyRequest object. Callers should use the setter or fluent setter (with...) methods
