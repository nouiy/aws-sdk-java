...
public class DeleteGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for DeleteGroupRequest object. Callers should use the setter or fluent setter (with...)
    ...
    /**
     * Constructs a new DeleteGroupRequest object. Callers should use the setter or fluent setter (with...) methods to
