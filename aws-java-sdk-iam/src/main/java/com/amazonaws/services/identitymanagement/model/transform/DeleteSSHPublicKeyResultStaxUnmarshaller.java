...
public class DeleteSSHPublicKeyResultStaxUnmarshaller implements Unmarshaller<DeleteSSHPublicKeyResult, StaxUnmarshallerContext> {

    public DeleteSSHPublicKeyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
