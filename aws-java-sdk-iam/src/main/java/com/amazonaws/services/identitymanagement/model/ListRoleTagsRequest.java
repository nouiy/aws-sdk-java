...
public class ListRoleTagsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param roleName
     *        The name of the IAM role for which you want to see the list of tags.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The name of the IAM role for which you want to see the list of tags.</p>
     *         <p>
     *         This parameter accepts (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string
     *         of characters that consist of upper and lowercase alphanumeric characters with no spaces. You can also
     *         include any of the following characters: _+=,.@-
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRoleTagsRequest == false)
            return false;
