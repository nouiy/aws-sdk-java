...
public class DeleteAccountAliasResultStaxUnmarshaller implements Unmarshaller<DeleteAccountAliasResult, StaxUnmarshallerContext> {

    public DeleteAccountAliasResult unmarshall(StaxUnmarshallerContext context) throws Exception {
