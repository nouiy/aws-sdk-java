...
public class RemoveUserFromGroupResultStaxUnmarshaller implements Unmarshaller<RemoveUserFromGroupResult, StaxUnmarshallerContext> {

    public RemoveUserFromGroupResult unmarshall(StaxUnmarshallerContext context) throws Exception {
