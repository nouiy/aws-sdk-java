 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iam-2010-05-08/ListSigningCertificates" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSigningCertificatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<SigningCertificate> certificates;
    /**
     * <p>
    ...
    public java.util.List<SigningCertificate> getCertificates() {
        if (certificates == null) {
            certificates = new com.amazonaws.internal.SdkInternalList<SigningCertificate>();
        }
        return certificates;
    }
    ...
    public void setCertificates(java.util.Collection<SigningCertificate> certificates) {
        ...
        this.certificates = new com.amazonaws.internal.SdkInternalList<SigningCertificate>(certificates);
    }
    ...
    public ListSigningCertificatesResult withCertificates(SigningCertificate... certificates) {
        if (this.certificates == null) {
            setCertificates(new com.amazonaws.internal.SdkInternalList<SigningCertificate>(certificates.length));
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSigningCertificatesResult == false)
            return false;
