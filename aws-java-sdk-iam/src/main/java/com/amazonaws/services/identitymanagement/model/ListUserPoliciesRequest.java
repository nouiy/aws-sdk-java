...
public class ListUserPoliciesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * Default constructor for ListUserPoliciesRequest object. Callers should use the setter or fluent setter (with...)
    ...
    /**
     * Constructs a new ListUserPoliciesRequest object. Callers should use the setter or fluent setter (with...) methods
     * to initialize any additional object members.
     * 
     * @param userName
     *        The name of the user to list policies for.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The name of the user to list policies for.</p>
     *         <p>
     *         This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string
     *         of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also
     *         include any of the following characters: _+=,.@-
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListUserPoliciesRequest == false)
            return false;
