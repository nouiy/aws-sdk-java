...
/**
 * GetServiceLinkedRoleDeletionStatusResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetServiceLinkedRoleDeletionStatusResultStaxUnmarshaller implements
        Unmarshaller<GetServiceLinkedRoleDeletionStatusResult, StaxUnmarshallerContext> {

    public GetServiceLinkedRoleDeletionStatusResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Status", targetDepth)) {
                    getServiceLinkedRoleDeletionStatusResult.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
