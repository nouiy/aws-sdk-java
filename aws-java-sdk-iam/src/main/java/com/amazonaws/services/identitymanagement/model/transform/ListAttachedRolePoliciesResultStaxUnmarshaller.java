...
public class ListAttachedRolePoliciesResultStaxUnmarshaller implements Unmarshaller<ListAttachedRolePoliciesResult, StaxUnmarshallerContext> {

    public ListAttachedRolePoliciesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("IsTruncated", targetDepth)) {
                    listAttachedRolePoliciesResult.setIsTruncated(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Marker", targetDepth)) {
                    listAttachedRolePoliciesResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
