...
public class DeleteRoleResultStaxUnmarshaller implements Unmarshaller<DeleteRoleResult, StaxUnmarshallerContext> {

    public DeleteRoleResult unmarshall(StaxUnmarshallerContext context) throws Exception {
