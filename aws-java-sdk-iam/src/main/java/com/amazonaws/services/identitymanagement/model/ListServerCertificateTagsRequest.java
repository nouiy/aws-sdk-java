...
public class ListServerCertificateTagsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The name of the IAM server certificate whose tags you want to see.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The name of the IAM server certificate whose tags you want to see.</p>
     *         <p>
     *         This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string
     *         of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also
     *         include any of the following characters: _+=,.@-
    ...
    public ListServerCertificateTagsRequest withMaxItems(Integer maxItems) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServerCertificateTagsRequest == false)
            return false;
        ListServerCertificateTagsRequest other = (ListServerCertificateTagsRequest) obj;
    ...
    @Override
    public ListServerCertificateTagsRequest clone() {
