...
public class DeleteLoginProfileResultStaxUnmarshaller implements Unmarshaller<DeleteLoginProfileResult, StaxUnmarshallerContext> {

    public DeleteLoginProfileResult unmarshall(StaxUnmarshallerContext context) throws Exception {
