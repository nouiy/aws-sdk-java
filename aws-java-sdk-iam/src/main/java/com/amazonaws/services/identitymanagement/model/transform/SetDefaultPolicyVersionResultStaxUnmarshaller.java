...
public class SetDefaultPolicyVersionResultStaxUnmarshaller implements Unmarshaller<SetDefaultPolicyVersionResult, StaxUnmarshallerContext> {

    public SetDefaultPolicyVersionResult unmarshall(StaxUnmarshallerContext context) throws Exception {
