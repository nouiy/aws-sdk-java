...
/**
 * CreateServiceSpecificCredentialResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateServiceSpecificCredentialResultStaxUnmarshaller implements Unmarshaller<CreateServiceSpecificCredentialResult, StaxUnmarshallerContext> {

    public CreateServiceSpecificCredentialResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ServiceSpecificCredential", targetDepth)) {
                    createServiceSpecificCredentialResult.setServiceSpecificCredential(ServiceSpecificCredentialStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
