...
public class PutGroupPolicyResultStaxUnmarshaller implements Unmarshaller<PutGroupPolicyResult, StaxUnmarshallerContext> {

    public PutGroupPolicyResult unmarshall(StaxUnmarshallerContext context) throws Exception {
