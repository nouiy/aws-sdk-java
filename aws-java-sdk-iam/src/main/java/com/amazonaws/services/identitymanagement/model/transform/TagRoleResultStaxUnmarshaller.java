...
/**
 * TagRoleResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TagRoleResultStaxUnmarshaller implements Unmarshaller<TagRoleResult, StaxUnmarshallerContext> {

    public TagRoleResult unmarshall(StaxUnmarshallerContext context) throws Exception {
