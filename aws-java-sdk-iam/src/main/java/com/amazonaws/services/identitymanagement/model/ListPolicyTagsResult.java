...
public class ListPolicyTagsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The list of tags that are currently attached to the IAM customer managed policy. Each tag consists of a key name
     * and an associated value. If no tags are attached to the specified resource, the response contains an empty list.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The list of tags that are currently attached to the IAM customer managed policy. Each tag consists of a
     ...
     * 
     * @param tags
     *        The list of tags that are currently attached to the IAM customer managed policy. Each tag consists of a
     *        key name and an associated value. If no tags are attached to the specified resource, the response contains
     *        an empty list.
     */
    ...
    public ListPolicyTagsResult withTags(Tag... tags) {
        if (this.tags == null) {
    ...
    public ListPolicyTagsResult withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public ListPolicyTagsResult withIsTruncated(Boolean isTruncated) {
    ...
    public ListPolicyTagsResult withMarker(String marker) {
        setMarker(marker);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListPolicyTagsResult == false)
            return false;
        ListPolicyTagsResult other = (ListPolicyTagsResult) obj;
    ...
    @Override
    public ListPolicyTagsResult clone() {
        try {
            return (ListPolicyTagsResult) super.clone();
