...
/**
 * DeleteRolePermissionsBoundaryResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteRolePermissionsBoundaryResultStaxUnmarshaller implements Unmarshaller<DeleteRolePermissionsBoundaryResult, StaxUnmarshallerContext> {

    public DeleteRolePermissionsBoundaryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
