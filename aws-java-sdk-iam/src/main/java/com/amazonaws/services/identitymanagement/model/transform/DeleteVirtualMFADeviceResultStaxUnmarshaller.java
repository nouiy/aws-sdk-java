...
public class DeleteVirtualMFADeviceResultStaxUnmarshaller implements Unmarshaller<DeleteVirtualMFADeviceResult, StaxUnmarshallerContext> {

    public DeleteVirtualMFADeviceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
