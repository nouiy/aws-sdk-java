...
public class ListSigningCertificatesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param userName
     *        The name of the IAM user whose signing certificates you want to examine.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The name of the IAM user whose signing certificates you want to examine.</p>
     *         <p>
     *         This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string
     *         of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also
     *         include any of the following characters: _+=,.@-
