...
public class RemoveClientIDFromOpenIDConnectProviderResultStaxUnmarshaller implements
        Unmarshaller<RemoveClientIDFromOpenIDConnectProviderResult, StaxUnmarshallerContext> {

    public RemoveClientIDFromOpenIDConnectProviderResult unmarshall(StaxUnmarshallerContext context) throws Exception {
