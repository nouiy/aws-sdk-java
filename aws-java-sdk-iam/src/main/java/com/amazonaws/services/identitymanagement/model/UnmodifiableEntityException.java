...
public class UnmodifiableEntityException extends com.amazonaws.services.identitymanagement.model.AmazonIdentityManagementException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new UnmodifiableEntityException with the specified error message.
     *
     * @param message
