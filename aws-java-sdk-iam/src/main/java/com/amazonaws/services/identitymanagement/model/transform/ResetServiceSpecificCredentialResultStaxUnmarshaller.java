...
/**
 * ResetServiceSpecificCredentialResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResetServiceSpecificCredentialResultStaxUnmarshaller implements Unmarshaller<ResetServiceSpecificCredentialResult, StaxUnmarshallerContext> {

    public ResetServiceSpecificCredentialResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ServiceSpecificCredential", targetDepth)) {
                    resetServiceSpecificCredentialResult.setServiceSpecificCredential(ServiceSpecificCredentialStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }
