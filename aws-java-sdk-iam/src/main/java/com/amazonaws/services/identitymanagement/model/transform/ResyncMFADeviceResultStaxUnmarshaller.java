...
public class ResyncMFADeviceResultStaxUnmarshaller implements Unmarshaller<ResyncMFADeviceResult, StaxUnmarshallerContext> {

    public ResyncMFADeviceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
