...
/**
 * DeleteUserPermissionsBoundaryResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteUserPermissionsBoundaryResultStaxUnmarshaller implements Unmarshaller<DeleteUserPermissionsBoundaryResult, StaxUnmarshallerContext> {

    public DeleteUserPermissionsBoundaryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
