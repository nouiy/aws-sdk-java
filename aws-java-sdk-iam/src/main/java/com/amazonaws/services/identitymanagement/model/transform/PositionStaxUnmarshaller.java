...
public class PositionStaxUnmarshaller implements Unmarshaller<Position, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Line", targetDepth)) {
                    position.setLine(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Column", targetDepth)) {
                    position.setColumn(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
