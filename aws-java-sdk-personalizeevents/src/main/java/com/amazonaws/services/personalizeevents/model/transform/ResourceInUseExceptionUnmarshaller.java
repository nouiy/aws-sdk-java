...
public class ResourceInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceInUseExceptionUnmarshaller() {
        super(com.amazonaws.services.personalizeevents.model.ResourceInUseException.class, "ResourceInUseException");
    }

    @Override
    public com.amazonaws.services.personalizeevents.model.ResourceInUseException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.personalizeevents.model.ResourceInUseException resourceInUseException = new com.amazonaws.services.personalizeevents.model.ResourceInUseException(
                null);
