 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-sms-voice-2018-09-05/PlainTextMessageType"
...
public class PlainTextMessageType implements Serializable, Cloneable, StructuredPojo {
     ...
     * The plain (not SSML-formatted) text to deliver to the recipient.
     * 
     * @return The plain (not SSML-formatted) text to deliver to the recipient.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PlainTextMessageType == false)
            return false;
        PlainTextMessageType other = (PlainTextMessageType) obj;
    ...
    @Override
    public PlainTextMessageType clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpointsmsvoice.model.transform.PlainTextMessageTypeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
