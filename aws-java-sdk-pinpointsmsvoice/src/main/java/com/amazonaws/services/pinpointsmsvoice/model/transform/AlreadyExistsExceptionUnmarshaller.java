...
public class AlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AlreadyExistsExceptionUnmarshaller() {
        super(com.amazonaws.services.pinpointsmsvoice.model.AlreadyExistsException.class, "AlreadyExistsException");
    }

    @Override
    public com.amazonaws.services.pinpointsmsvoice.model.AlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pinpointsmsvoice.model.AlreadyExistsException alreadyExistsException = new com.amazonaws.services.pinpointsmsvoice.model.AlreadyExistsException(
                null);
