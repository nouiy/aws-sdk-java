...
public class ListConfigurationSetsRequestMarshaller {
    ...
    private static final ListConfigurationSetsRequestMarshaller instance = new ListConfigurationSetsRequestMarshaller();

    public static ListConfigurationSetsRequestMarshaller getInstance() {
        return instance;
    }
