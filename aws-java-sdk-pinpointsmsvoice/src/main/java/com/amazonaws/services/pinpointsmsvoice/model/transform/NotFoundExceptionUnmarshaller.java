...
public class NotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private NotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.pinpointsmsvoice.model.NotFoundException.class, "NotFoundException");
    }

    @Override
    public com.amazonaws.services.pinpointsmsvoice.model.NotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pinpointsmsvoice.model.NotFoundException notFoundException = new com.amazonaws.services.pinpointsmsvoice.model.NotFoundException(
                null);
