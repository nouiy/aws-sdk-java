...
/**
 * GreengrassOutputDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GreengrassOutputDetailsJsonUnmarshaller implements Unmarshaller<GreengrassOutputDetails, JsonUnmarshallerContext> {

    public GreengrassOutputDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        GreengrassOutputDetails greengrassOutputDetails = new GreengrassOutputDetails();
    ...
    private static GreengrassOutputDetailsJsonUnmarshaller instance;

    public static GreengrassOutputDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GreengrassOutputDetailsJsonUnmarshaller();
        return instance;
    }
}
