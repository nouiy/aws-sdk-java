...
public class DeleteModelRequestMarshaller {
    ...
    public void marshall(DeleteModelRequest deleteModelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteModelRequest.getProjectName(), PROJECTNAME_BINDING);
            protocolMarshaller.marshall(deleteModelRequest.getModelVersion(), MODELVERSION_BINDING);
            protocolMarshaller.marshall(deleteModelRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
