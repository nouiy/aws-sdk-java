 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/lookoutvision-2020-11-20/ModelPackagingJobMetadata"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelPackagingJobMetadata implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The project that contains the model that is in the model package.
     */
     ...
     * </p>
     * 
     * @return The version of the model that is in the model package.
     */
    ...
    public ModelPackagingJobMetadata withCreationTimestamp(java.util.Date creationTimestamp) {
    ...
    public ModelPackagingJobMetadata withLastUpdatedTimestamp(java.util.Date lastUpdatedTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModelPackagingJobMetadata == false)
            return false;
        ModelPackagingJobMetadata other = (ModelPackagingJobMetadata) obj;
    ...
    public ModelPackagingJobMetadata clone() {
        try {
            return (ModelPackagingJobMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.lookoutforvision.model.transform.ModelPackagingJobMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
