...
public class DescribeDatasetRequestMarshaller {
    ...
    public void marshall(DescribeDatasetRequest describeDatasetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeDatasetRequest.getProjectName(), PROJECTNAME_BINDING);
            protocolMarshaller.marshall(describeDatasetRequest.getDatasetType(), DATASETTYPE_BINDING);
        } catch (Exception e) {
