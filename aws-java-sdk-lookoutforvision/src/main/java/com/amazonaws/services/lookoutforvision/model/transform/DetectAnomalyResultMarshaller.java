...
@SdkInternalApi
public class DetectAnomalyResultMarshaller {
    ...
    private static final MarshallingInfo<Boolean> ISANOMALOUS_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
    ...
    public static DetectAnomalyResultMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DetectAnomalyResult detectAnomalyResult, ProtocolMarshaller protocolMarshaller) {
