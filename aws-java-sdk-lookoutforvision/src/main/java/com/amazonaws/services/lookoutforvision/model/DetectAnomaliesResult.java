...
public class DetectAnomaliesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetectAnomaliesResult == false)
            return false;
        DetectAnomaliesResult other = (DetectAnomaliesResult) obj;
        if (other.getDetectAnomalyResult() == null ^ this.getDetectAnomalyResult() == null)
            return false;
        if (other.getDetectAnomalyResult() != null && other.getDetectAnomalyResult().equals(this.getDetectAnomalyResult()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDetectAnomalyResult() == null) ? 0 : getDetectAnomalyResult().hashCode());
        return hashCode;
    }
