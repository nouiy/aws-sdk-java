...
public class ListModelPackagingJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the project for which you want to list the model packaging jobs.
     */
    ...
    public ListModelPackagingJobsRequest withProjectName(String projectName) {
    ...
    public ListModelPackagingJobsRequest withNextToken(String nextToken) {
    ...
    public ListModelPackagingJobsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelPackagingJobsRequest == false)
            return false;
        ListModelPackagingJobsRequest other = (ListModelPackagingJobsRequest) obj;
    ...
    @Override
    public ListModelPackagingJobsRequest clone() {
        return (ListModelPackagingJobsRequest) super.clone();
    }
