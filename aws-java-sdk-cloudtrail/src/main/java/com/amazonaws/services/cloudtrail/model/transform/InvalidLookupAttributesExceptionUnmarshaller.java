...
public class InvalidLookupAttributesExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidLookupAttributesExceptionUnmarshaller instance;

    public static InvalidLookupAttributesExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidLookupAttributesExceptionUnmarshaller();
        return instance;
    }
}
