...
public class InvalidTrailNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidTrailNameExceptionUnmarshaller instance;

    public static InvalidTrailNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidTrailNameExceptionUnmarshaller();
        return instance;
    }
}
