...
public class CloudTrailAccessNotEnabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CloudTrailAccessNotEnabledExceptionUnmarshaller instance;

    public static CloudTrailAccessNotEnabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CloudTrailAccessNotEnabledExceptionUnmarshaller();
        return instance;
    }
}
