...
public class TrailNotProvidedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TrailNotProvidedExceptionUnmarshaller instance;

    public static TrailNotProvidedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrailNotProvidedExceptionUnmarshaller();
        return instance;
    }
}
