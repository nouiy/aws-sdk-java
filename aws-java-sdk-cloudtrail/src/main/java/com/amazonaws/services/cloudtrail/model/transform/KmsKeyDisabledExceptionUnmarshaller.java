...
public class KmsKeyDisabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static KmsKeyDisabledExceptionUnmarshaller instance;

    public static KmsKeyDisabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new KmsKeyDisabledExceptionUnmarshaller();
        return instance;
    }
}
