...
public class InvalidCloudWatchLogsRoleArnExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidCloudWatchLogsRoleArnExceptionUnmarshaller instance;

    public static InvalidCloudWatchLogsRoleArnExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCloudWatchLogsRoleArnExceptionUnmarshaller();
        return instance;
    }
}
