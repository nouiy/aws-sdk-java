...
/**
 * QueryStatisticsForDescribeQueryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class QueryStatisticsForDescribeQueryMarshaller {

    private static final MarshallingInfo<Long> EVENTSMATCHED_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
