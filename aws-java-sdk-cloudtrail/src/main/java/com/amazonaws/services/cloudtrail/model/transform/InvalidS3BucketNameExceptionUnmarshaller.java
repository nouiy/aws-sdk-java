...
public class InvalidS3BucketNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidS3BucketNameExceptionUnmarshaller instance;

    public static InvalidS3BucketNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidS3BucketNameExceptionUnmarshaller();
        return instance;
    }
}
