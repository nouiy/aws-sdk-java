...
/**
 * ListPublicKeysRequestMarshaller
 */
...
public class ListPublicKeysRequestMarshaller {
    ...
    private static final ListPublicKeysRequestMarshaller instance = new ListPublicKeysRequestMarshaller();

    public static ListPublicKeysRequestMarshaller getInstance() {
        return instance;
    }
