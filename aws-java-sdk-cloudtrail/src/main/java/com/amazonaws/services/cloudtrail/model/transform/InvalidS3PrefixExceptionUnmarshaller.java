...
public class InvalidS3PrefixExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidS3PrefixExceptionUnmarshaller instance;

    public static InvalidS3PrefixExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidS3PrefixExceptionUnmarshaller();
        return instance;
    }
}
