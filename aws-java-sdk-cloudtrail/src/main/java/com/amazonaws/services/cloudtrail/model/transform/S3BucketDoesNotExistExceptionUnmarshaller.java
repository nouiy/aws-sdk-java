...
public class S3BucketDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static S3BucketDoesNotExistExceptionUnmarshaller instance;

    public static S3BucketDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new S3BucketDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
