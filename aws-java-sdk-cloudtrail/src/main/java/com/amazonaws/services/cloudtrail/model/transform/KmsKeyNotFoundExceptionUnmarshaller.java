...
public class KmsKeyNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static KmsKeyNotFoundExceptionUnmarshaller instance;

    public static KmsKeyNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new KmsKeyNotFoundExceptionUnmarshaller();
        return instance;
    }
}
