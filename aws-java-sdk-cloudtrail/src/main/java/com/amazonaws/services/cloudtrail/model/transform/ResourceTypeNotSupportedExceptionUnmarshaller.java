...
public class ResourceTypeNotSupportedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceTypeNotSupportedExceptionUnmarshaller instance;

    public static ResourceTypeNotSupportedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceTypeNotSupportedExceptionUnmarshaller();
        return instance;
    }
}
