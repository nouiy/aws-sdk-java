...
public class InsufficientEncryptionPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InsufficientEncryptionPolicyExceptionUnmarshaller instance;

    public static InsufficientEncryptionPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InsufficientEncryptionPolicyExceptionUnmarshaller();
        return instance;
    }
}
