...
public class UpdateEventDataStoreRequestMarshaller {
    ...
    public static UpdateEventDataStoreRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateEventDataStoreRequest updateEventDataStoreRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateEventDataStoreRequest.getEventDataStore(), EVENTDATASTORE_BINDING);
            protocolMarshaller.marshall(updateEventDataStoreRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateEventDataStoreRequest.getAdvancedEventSelectors(), ADVANCEDEVENTSELECTORS_BINDING);
            protocolMarshaller.marshall(updateEventDataStoreRequest.getMultiRegionEnabled(), MULTIREGIONENABLED_BINDING);
