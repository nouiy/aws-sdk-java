...
public class InsufficientDependencyServiceAccessPermissionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InsufficientDependencyServiceAccessPermissionExceptionUnmarshaller instance;

    public static InsufficientDependencyServiceAccessPermissionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InsufficientDependencyServiceAccessPermissionExceptionUnmarshaller();
        return instance;
    }
}
