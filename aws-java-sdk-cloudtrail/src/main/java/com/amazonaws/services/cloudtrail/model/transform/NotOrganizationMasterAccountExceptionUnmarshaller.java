...
public class NotOrganizationMasterAccountExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NotOrganizationMasterAccountExceptionUnmarshaller instance;

    public static NotOrganizationMasterAccountExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotOrganizationMasterAccountExceptionUnmarshaller();
        return instance;
    }
}
