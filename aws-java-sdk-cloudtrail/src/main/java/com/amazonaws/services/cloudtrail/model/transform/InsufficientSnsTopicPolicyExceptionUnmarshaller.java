...
public class InsufficientSnsTopicPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InsufficientSnsTopicPolicyExceptionUnmarshaller instance;

    public static InsufficientSnsTopicPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InsufficientSnsTopicPolicyExceptionUnmarshaller();
        return instance;
    }
}
