...
/**
 * VmServer JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VmServerJsonUnmarshaller implements Unmarshaller<VmServer, JsonUnmarshallerContext> {

    public VmServer unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static VmServerJsonUnmarshaller instance;

    public static VmServerJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VmServerJsonUnmarshaller();
        return instance;
    }
}
