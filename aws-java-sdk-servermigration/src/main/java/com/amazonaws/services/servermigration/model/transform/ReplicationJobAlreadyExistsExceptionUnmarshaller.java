...
public class ReplicationJobAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ReplicationJobAlreadyExistsExceptionUnmarshaller instance;

    public static ReplicationJobAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ReplicationJobAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
