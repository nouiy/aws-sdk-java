...
/**
 * PutAppLaunchConfigurationResult JSON Unmarshaller
 */
...
public class PutAppLaunchConfigurationResultJsonUnmarshaller implements Unmarshaller<PutAppLaunchConfigurationResult, JsonUnmarshallerContext> {
    ...
    public PutAppLaunchConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAppLaunchConfigurationResult putAppLaunchConfigurationResult = new PutAppLaunchConfigurationResult();
