...
/**
 * NotifyAppValidationOutputResult JSON Unmarshaller
 */
...
public class NotifyAppValidationOutputResultJsonUnmarshaller implements Unmarshaller<NotifyAppValidationOutputResult, JsonUnmarshallerContext> {
    ...
    public NotifyAppValidationOutputResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        NotifyAppValidationOutputResult notifyAppValidationOutputResult = new NotifyAppValidationOutputResult();

        return notifyAppValidationOutputResult;
    }
