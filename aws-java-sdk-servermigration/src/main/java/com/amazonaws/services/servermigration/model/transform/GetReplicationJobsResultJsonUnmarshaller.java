...
public class GetReplicationJobsResultJsonUnmarshaller implements Unmarshaller<GetReplicationJobsResult, JsonUnmarshallerContext> {
    ...
    public GetReplicationJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetReplicationJobsResult getReplicationJobsResult = new GetReplicationJobsResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    getReplicationJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static GetReplicationJobsResultJsonUnmarshaller instance;

    public static GetReplicationJobsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetReplicationJobsResultJsonUnmarshaller();
        return instance;
    }
}
