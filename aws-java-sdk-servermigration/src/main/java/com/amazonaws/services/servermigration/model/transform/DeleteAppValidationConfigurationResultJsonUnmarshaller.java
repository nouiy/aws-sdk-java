...
/**
 * DeleteAppValidationConfigurationResult JSON Unmarshaller
 */
...
public class DeleteAppValidationConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteAppValidationConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppValidationConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppValidationConfigurationResult deleteAppValidationConfigurationResult = new DeleteAppValidationConfigurationResult();

        return deleteAppValidationConfigurationResult;
    }
