...
public class ServerCannotBeReplicatedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ServerCannotBeReplicatedExceptionUnmarshaller instance;

    public static ServerCannotBeReplicatedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ServerCannotBeReplicatedExceptionUnmarshaller();
        return instance;
    }
}
