...
public class ImportServerCatalogRequestMarshaller {
    ...
    private static final ImportServerCatalogRequestMarshaller instance = new ImportServerCatalogRequestMarshaller();

    public static ImportServerCatalogRequestMarshaller getInstance() {
        return instance;
    }
