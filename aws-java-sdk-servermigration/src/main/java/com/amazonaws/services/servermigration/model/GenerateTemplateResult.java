...
public class GenerateTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GenerateTemplateResult == false)
            return false;
        GenerateTemplateResult other = (GenerateTemplateResult) obj;
    ...
    public GenerateTemplateResult clone() {
        try {
            return (GenerateTemplateResult) super.clone();
