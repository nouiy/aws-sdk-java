...
/**
 * ImportAppCatalogResult JSON Unmarshaller
 */
...
public class ImportAppCatalogResultJsonUnmarshaller implements Unmarshaller<ImportAppCatalogResult, JsonUnmarshallerContext> {
    ...
    public ImportAppCatalogResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ImportAppCatalogResult importAppCatalogResult = new ImportAppCatalogResult();

        return importAppCatalogResult;
    }
