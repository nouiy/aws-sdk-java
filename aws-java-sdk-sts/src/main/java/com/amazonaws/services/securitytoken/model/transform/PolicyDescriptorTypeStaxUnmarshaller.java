...
/**
 * PolicyDescriptorType StAX Unmarshaller
 */
...
public class PolicyDescriptorTypeStaxUnmarshaller implements Unmarshaller<PolicyDescriptorType, StaxUnmarshallerContext> {
    ...
    public PolicyDescriptorType unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("arn", targetDepth)) {
                    policyDescriptorType.setArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
