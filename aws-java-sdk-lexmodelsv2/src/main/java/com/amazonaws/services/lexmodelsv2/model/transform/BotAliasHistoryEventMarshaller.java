...
/**
 * BotAliasHistoryEventMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class BotAliasHistoryEventMarshaller {
    ...
    private static final BotAliasHistoryEventMarshaller instance = new BotAliasHistoryEventMarshaller();

    public static BotAliasHistoryEventMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BotAliasHistoryEvent botAliasHistoryEvent, ProtocolMarshaller protocolMarshaller) {

        if (botAliasHistoryEvent == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(botAliasHistoryEvent.getBotVersion(), BOTVERSION_BINDING);
            protocolMarshaller.marshall(botAliasHistoryEvent.getStartDate(), STARTDATE_BINDING);
            protocolMarshaller.marshall(botAliasHistoryEvent.getEndDate(), ENDDATE_BINDING);
        } catch (Exception e) {
