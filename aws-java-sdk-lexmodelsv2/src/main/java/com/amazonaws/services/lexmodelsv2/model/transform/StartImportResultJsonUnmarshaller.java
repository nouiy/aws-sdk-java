        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("resourceSpecification", targetDepth)) {
                    context.nextToken();
                    startImportResult.setResourceSpecification(ImportResourceSpecificationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("creationDateTime", targetDepth)) {
                    context.nextToken();
                    startImportResult.setCreationDateTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
