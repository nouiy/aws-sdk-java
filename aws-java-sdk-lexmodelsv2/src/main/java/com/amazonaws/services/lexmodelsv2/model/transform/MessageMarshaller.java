...
public class MessageMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CUSTOMPAYLOAD_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("customPayload").build();
