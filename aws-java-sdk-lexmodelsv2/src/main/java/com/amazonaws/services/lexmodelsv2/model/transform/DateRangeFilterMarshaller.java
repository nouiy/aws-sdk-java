...
/**
 * DateRangeFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DateRangeFilterMarshaller {
    ...
    private static final DateRangeFilterMarshaller instance = new DateRangeFilterMarshaller();

    public static DateRangeFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DateRangeFilter dateRangeFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dateRangeFilter.getStartDateTime(), STARTDATETIME_BINDING);
            protocolMarshaller.marshall(dateRangeFilter.getEndDateTime(), ENDDATETIME_BINDING);
        } catch (Exception e) {
