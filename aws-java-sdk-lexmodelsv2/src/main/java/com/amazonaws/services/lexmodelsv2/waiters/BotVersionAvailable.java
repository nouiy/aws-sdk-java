...
class BotVersionAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeBotVersionResult> {
         ...
         */
        @Override
        public boolean matches(DescribeBotVersionResult result) {
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeBotVersionResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeBotVersionResult> {
        private static final JsonNode expectedResult;
