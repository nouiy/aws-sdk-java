...
public class ExportSummaryMarshaller {
    ...
    public void marshall(ExportSummary exportSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(exportSummary.getExportId(), EXPORTID_BINDING);
            protocolMarshaller.marshall(exportSummary.getResourceSpecification(), RESOURCESPECIFICATION_BINDING);
            protocolMarshaller.marshall(exportSummary.getFileFormat(), FILEFORMAT_BINDING);
            protocolMarshaller.marshall(exportSummary.getExportStatus(), EXPORTSTATUS_BINDING);
            protocolMarshaller.marshall(exportSummary.getCreationDateTime(), CREATIONDATETIME_BINDING);
            protocolMarshaller.marshall(exportSummary.getLastUpdatedDateTime(), LASTUPDATEDDATETIME_BINDING);
        } catch (Exception e) {
