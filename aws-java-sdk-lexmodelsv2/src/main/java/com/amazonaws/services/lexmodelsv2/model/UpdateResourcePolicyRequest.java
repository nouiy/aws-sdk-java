...
public class UpdateResourcePolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The identifier of the revision of the policy to update. If this revision ID doesn't match the current revision
     ...
     * </p>
     * 
     * @return The identifier of the revision of the policy to update. If this revision ID doesn't match the current
     *         revision ID, Amazon Lex throws an exception.</p>
     *         <p>
     *         If you don't specify a revision, Amazon Lex overwrites the contents of the policy with the new values.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateResourcePolicyRequest == false)
            return false;
        UpdateResourcePolicyRequest other = (UpdateResourcePolicyRequest) obj;
    ...
    public UpdateResourcePolicyRequest clone() {
        return (UpdateResourcePolicyRequest) super.clone();
    }
