...
/**
 * SlotTypeSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SlotTypeSummaryJsonUnmarshaller implements Unmarshaller<SlotTypeSummary, JsonUnmarshallerContext> {

    public SlotTypeSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        SlotTypeSummary slotTypeSummary = new SlotTypeSummary();
    ...
    private static SlotTypeSummaryJsonUnmarshaller instance;

    public static SlotTypeSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SlotTypeSummaryJsonUnmarshaller();
        return instance;
    }
}
