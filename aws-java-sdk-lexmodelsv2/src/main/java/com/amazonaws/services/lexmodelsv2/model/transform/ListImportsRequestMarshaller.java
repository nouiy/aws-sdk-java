...
public class ListImportsRequestMarshaller {
    ...
    public void marshall(ListImportsRequest listImportsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listImportsRequest.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(listImportsRequest.getBotVersion(), BOTVERSION_BINDING);
            protocolMarshaller.marshall(listImportsRequest.getSortBy(), SORTBY_BINDING);
