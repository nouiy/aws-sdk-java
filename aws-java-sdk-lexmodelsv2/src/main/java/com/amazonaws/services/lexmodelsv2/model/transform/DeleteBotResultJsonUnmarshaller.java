...
/**
 * DeleteBotResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteBotResultJsonUnmarshaller implements Unmarshaller<DeleteBotResult, JsonUnmarshallerContext> {

    public DeleteBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBotResult deleteBotResult = new DeleteBotResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("botId", targetDepth)) {
                    context.nextToken();
                    deleteBotResult.setBotId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("botStatus", targetDepth)) {
                    context.nextToken();
                    deleteBotResult.setBotStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
