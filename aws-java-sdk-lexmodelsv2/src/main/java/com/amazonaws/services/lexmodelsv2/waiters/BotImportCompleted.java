...
class BotImportCompleted {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeImportResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("importStatus");
         ...
         */
        @Override
        public boolean matches(DescribeImportResult result) {
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeImportResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeImportResult> {
        private static final JsonNode expectedResult;
