...
@SdkInternalApi
public class BotSortByMarshaller {
    ...
    private static final BotSortByMarshaller instance = new BotSortByMarshaller();

    public static BotSortByMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BotSortBy botSortBy, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(botSortBy.getAttribute(), ATTRIBUTE_BINDING);
            protocolMarshaller.marshall(botSortBy.getOrder(), ORDER_BINDING);
        } catch (Exception e) {
