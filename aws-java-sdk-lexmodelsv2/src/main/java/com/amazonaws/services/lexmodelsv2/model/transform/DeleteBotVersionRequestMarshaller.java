...
public class DeleteBotVersionRequestMarshaller {
    ...
    public void marshall(DeleteBotVersionRequest deleteBotVersionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteBotVersionRequest.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(deleteBotVersionRequest.getBotVersion(), BOTVERSION_BINDING);
            protocolMarshaller.marshall(deleteBotVersionRequest.getSkipResourceInUseCheck(), SKIPRESOURCEINUSECHECK_BINDING);
        } catch (Exception e) {
