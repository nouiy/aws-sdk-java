...
/**
 * PromptSpecification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PromptSpecificationJsonUnmarshaller implements Unmarshaller<PromptSpecification, JsonUnmarshallerContext> {

    public PromptSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        PromptSpecification promptSpecification = new PromptSpecification();
    ...
    private static PromptSpecificationJsonUnmarshaller instance;

    public static PromptSpecificationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PromptSpecificationJsonUnmarshaller();
        return instance;
    }
}
