...
@SdkInternalApi
public class VoiceSettingsMarshaller {
    ...
    public static VoiceSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VoiceSettings voiceSettings, ProtocolMarshaller protocolMarshaller) {
