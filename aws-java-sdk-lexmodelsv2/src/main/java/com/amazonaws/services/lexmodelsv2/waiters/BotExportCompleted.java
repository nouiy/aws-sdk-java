...
class BotExportCompleted {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeExportResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("exportStatus");
         ...
         */
        @Override
        public boolean matches(DescribeExportResult result) {
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeExportResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeExportResult> {
        private static final JsonNode expectedResult;
