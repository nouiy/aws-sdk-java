...
/**
 * StillWaitingResponseSpecification JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StillWaitingResponseSpecificationJsonUnmarshaller implements Unmarshaller<StillWaitingResponseSpecification, JsonUnmarshallerContext> {

    public StillWaitingResponseSpecification unmarshall(JsonUnmarshallerContext context) throws Exception {
        StillWaitingResponseSpecification stillWaitingResponseSpecification = new StillWaitingResponseSpecification();
    ...
    private static StillWaitingResponseSpecificationJsonUnmarshaller instance;

    public static StillWaitingResponseSpecificationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StillWaitingResponseSpecificationJsonUnmarshaller();
        return instance;
    }
}
