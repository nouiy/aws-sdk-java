...
/**
 * CreateSlotRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateSlotRequestMarshaller {
    ...
    public static CreateSlotRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateSlotRequest createSlotRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createSlotRequest.getSlotName(), SLOTNAME_BINDING);
            protocolMarshaller.marshall(createSlotRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createSlotRequest.getSlotTypeId(), SLOTTYPEID_BINDING);
            protocolMarshaller.marshall(createSlotRequest.getValueElicitationSetting(), VALUEELICITATIONSETTING_BINDING);
            protocolMarshaller.marshall(createSlotRequest.getObfuscationSetting(), OBFUSCATIONSETTING_BINDING);
            protocolMarshaller.marshall(createSlotRequest.getBotId(), BOTID_BINDING);
