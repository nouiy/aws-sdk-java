...
class BotAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeBotResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("botStatus");
         ...
         */
        @Override
        public boolean matches(DescribeBotResult result) {
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeBotResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeBotResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsInactiveMatcher extends WaiterAcceptor<DescribeBotResult> {
        private static final JsonNode expectedResult;
