...
public class DeleteResourcePolicyStatementResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * 
     * @param resourceArn
     *        The Amazon Resource Name (ARN) of the bot or bot alias that the resource policy statement was removed
     *        from.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the bot or bot alias that the resource policy statement was removed
     *         from.
     */
    ...
    public DeleteResourcePolicyStatementResult withResourceArn(String resourceArn) {
    ...
    public DeleteResourcePolicyStatementResult withRevisionId(String revisionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteResourcePolicyStatementResult == false)
            return false;
        DeleteResourcePolicyStatementResult other = (DeleteResourcePolicyStatementResult) obj;
    ...
    @Override
    public DeleteResourcePolicyStatementResult clone() {
        try {
            return (DeleteResourcePolicyStatementResult) super.clone();
