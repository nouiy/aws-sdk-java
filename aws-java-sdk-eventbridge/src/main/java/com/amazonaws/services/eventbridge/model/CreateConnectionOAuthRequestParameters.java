 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/eventbridge-2015-10-07/CreateConnectionOAuthRequestParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateConnectionOAuthRequestParameters implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * A <code>CreateConnectionOAuthClientRequestParameters</code> object that contains the client parameters for OAuth
     * authorization.
     * </p>
     */
    ...
    /**
     * <p>
     * A <code>ConnectionHttpParameters</code> object that contains details about the additional parameters to use for
     * the connection.
     * </p>
     */
     ...
     *        A <code>CreateConnectionOAuthClientRequestParameters</code> object that contains the client parameters for
     *        OAuth authorization.
     */
     ...
     * </p>
     * 
     * @return A <code>CreateConnectionOAuthClientRequestParameters</code> object that contains the client parameters
     *         for OAuth authorization.
     */

    public CreateConnectionOAuthClientRequestParameters getClientParameters() {
     ...
     * </p>
     * 
     * @return The method to use for the authorization request.
     * @see ConnectionOAuthHttpMethod
     */
     ...
     *        A <code>ConnectionHttpParameters</code> object that contains details about the additional parameters to
     ...
     * </p>
     * 
     * @return A <code>ConnectionHttpParameters</code> object that contains details about the additional parameters to
     *         use for the connection.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConnectionOAuthRequestParameters == false)
            return false;
        CreateConnectionOAuthRequestParameters other = (CreateConnectionOAuthRequestParameters) obj;
    ...
    public CreateConnectionOAuthRequestParameters clone() {
        try {
            return (CreateConnectionOAuthRequestParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.eventbridge.model.transform.CreateConnectionOAuthRequestParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
