 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/eventbridge-2015-10-07/EndpointEventBus" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EndpointEventBus implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EndpointEventBus == false)
            return false;
        EndpointEventBus other = (EndpointEventBus) obj;
    ...
    public EndpointEventBus clone() {
        try {
            return (EndpointEventBus) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.eventbridge.model.transform.EndpointEventBusMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
