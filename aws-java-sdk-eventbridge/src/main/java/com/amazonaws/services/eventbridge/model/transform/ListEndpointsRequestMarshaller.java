...
public class ListEndpointsRequestMarshaller {
    ...
    public void marshall(ListEndpointsRequest listEndpointsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listEndpointsRequest.getNamePrefix(), NAMEPREFIX_BINDING);
            protocolMarshaller.marshall(listEndpointsRequest.getHomeRegion(), HOMEREGION_BINDING);
