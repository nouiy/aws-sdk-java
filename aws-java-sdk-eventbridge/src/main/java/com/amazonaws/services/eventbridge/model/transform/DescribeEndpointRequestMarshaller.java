...
public class DescribeEndpointRequestMarshaller {
    ...
    public void marshall(DescribeEndpointRequest describeEndpointRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeEndpointRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(describeEndpointRequest.getHomeRegion(), HOMEREGION_BINDING);
        } catch (Exception e) {
