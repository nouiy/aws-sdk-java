...
public class UpdateArchiveRequestMarshaller {
    ...
    public void marshall(UpdateArchiveRequest updateArchiveRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateArchiveRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateArchiveRequest.getEventPattern(), EVENTPATTERN_BINDING);
            protocolMarshaller.marshall(updateArchiveRequest.getRetentionDays(), RETENTIONDAYS_BINDING);
        } catch (Exception e) {
