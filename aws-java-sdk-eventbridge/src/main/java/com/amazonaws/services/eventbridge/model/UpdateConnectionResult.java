...
public class UpdateConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the connection that was updated.
     */
     ...
     * </p>
     * 
     * @return The state of the connection that was updated.
     * @see ConnectionState
     */
    ...
    public UpdateConnectionResult withCreationTime(java.util.Date creationTime) {
    ...
    public UpdateConnectionResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public UpdateConnectionResult withLastAuthorizedTime(java.util.Date lastAuthorizedTime) {
