...
/**
 * DeleteHumanLoopResult JSON Unmarshaller
 */
...
public class DeleteHumanLoopResultJsonUnmarshaller implements Unmarshaller<DeleteHumanLoopResult, JsonUnmarshallerContext> {
    ...
    public DeleteHumanLoopResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteHumanLoopResult deleteHumanLoopResult = new DeleteHumanLoopResult();
