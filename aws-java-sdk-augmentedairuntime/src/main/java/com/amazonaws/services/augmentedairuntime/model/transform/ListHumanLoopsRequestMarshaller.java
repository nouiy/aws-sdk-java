...
@SdkInternalApi
public class ListHumanLoopsRequestMarshaller {
    ...
    private static final ListHumanLoopsRequestMarshaller instance = new ListHumanLoopsRequestMarshaller();

    public static ListHumanLoopsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListHumanLoopsRequest listHumanLoopsRequest, ProtocolMarshaller protocolMarshaller) {
