...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.augmentedairuntime.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.augmentedairuntime.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.augmentedairuntime.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.augmentedairuntime.model.ResourceNotFoundException(
                null);
