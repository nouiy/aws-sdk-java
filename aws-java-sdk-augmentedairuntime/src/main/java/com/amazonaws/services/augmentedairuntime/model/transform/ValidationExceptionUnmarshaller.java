...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.augmentedairuntime.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.augmentedairuntime.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.augmentedairuntime.model.ValidationException validationException = new com.amazonaws.services.augmentedairuntime.model.ValidationException(
                null);
