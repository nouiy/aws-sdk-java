...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.augmentedairuntime.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.augmentedairuntime.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.augmentedairuntime.model.InternalServerException internalServerException = new com.amazonaws.services.augmentedairuntime.model.InternalServerException(
                null);
