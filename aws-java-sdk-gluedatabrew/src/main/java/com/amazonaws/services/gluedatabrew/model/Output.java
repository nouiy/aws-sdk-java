...
public class Output implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Maximum number of files to be generated by the job and written to the output folder. For output partitioned by
     * column(s), the MaxOutputFiles value is the maximum number of files per partition.
     * </p>
     */
    ...
    public void setMaxOutputFiles(Integer maxOutputFiles) {
     ...
     * </p>
     * 
     * @return Maximum number of files to be generated by the job and written to the output folder. For output
     *         partitioned by column(s), the MaxOutputFiles value is the maximum number of files per partition.
     */

    public Integer getMaxOutputFiles() {
    ...
    public Output withMaxOutputFiles(Integer maxOutputFiles) {
        setMaxOutputFiles(maxOutputFiles);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getMaxOutputFiles() != null)
            sb.append("MaxOutputFiles: ").append(getMaxOutputFiles());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getFormatOptions() != null && other.getFormatOptions().equals(this.getFormatOptions()) == false)
            return false;
        if (other.getMaxOutputFiles() == null ^ this.getMaxOutputFiles() == null)
            return false;
        if (other.getMaxOutputFiles() != null && other.getMaxOutputFiles().equals(this.getMaxOutputFiles()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getMaxOutputFiles() == null) ? 0 : getMaxOutputFiles().hashCode());
        return hashCode;
    }
