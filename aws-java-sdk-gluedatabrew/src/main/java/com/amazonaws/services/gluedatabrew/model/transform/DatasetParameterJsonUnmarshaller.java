        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    datasetParameter.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    datasetParameter.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("DatetimeOptions", targetDepth)) {
                    context.nextToken();
                    datasetParameter.setDatetimeOptions(DatetimeOptionsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("CreateColumn", targetDepth)) {
                    context.nextToken();
                    datasetParameter.setCreateColumn(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("Filter", targetDepth)) {
                    context.nextToken();
                    datasetParameter.setFilter(FilterExpressionJsonUnmarshaller.getInstance().unmarshall(context));
                }
