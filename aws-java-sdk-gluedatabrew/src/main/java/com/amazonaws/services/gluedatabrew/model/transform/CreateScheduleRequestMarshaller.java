...
public class CreateScheduleRequestMarshaller {
    ...
    public void marshall(CreateScheduleRequest createScheduleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createScheduleRequest.getJobNames(), JOBNAMES_BINDING);
            protocolMarshaller.marshall(createScheduleRequest.getCronExpression(), CRONEXPRESSION_BINDING);
            protocolMarshaller.marshall(createScheduleRequest.getTags(), TAGS_BINDING);
