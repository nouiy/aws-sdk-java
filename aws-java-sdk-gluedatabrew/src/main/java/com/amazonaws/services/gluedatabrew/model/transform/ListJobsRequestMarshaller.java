...
public class ListJobsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> DATASETNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("datasetName").build();
    ...
    private static final MarshallingInfo<String> PROJECTNAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("projectName").build();
    ...
    public void marshall(ListJobsRequest listJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listJobsRequest.getDatasetName(), DATASETNAME_BINDING);
            ...
            protocolMarshaller.marshall(listJobsRequest.getProjectName(), PROJECTNAME_BINDING);
        } catch (Exception e) {
