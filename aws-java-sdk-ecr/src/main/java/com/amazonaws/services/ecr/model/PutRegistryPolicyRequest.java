...
public class PutRegistryPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        text. For more information, see <a
     ...
     * </p>
     * 
     * @return The JSON policy text to apply to your registry. The policy text follows the same format as IAM policy
     *         text. For more information, see <a
     *         href="https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-permissions.html">Registry
     *         permissions</a> in the <i>Amazon Elastic Container Registry User Guide</i>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutRegistryPolicyRequest == false)
            return false;
        PutRegistryPolicyRequest other = (PutRegistryPolicyRequest) obj;
    ...
    public PutRegistryPolicyRequest clone() {
        return (PutRegistryPolicyRequest) super.clone();
    }
