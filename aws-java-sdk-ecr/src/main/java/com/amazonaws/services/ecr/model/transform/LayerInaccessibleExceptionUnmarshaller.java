...
public class LayerInaccessibleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LayerInaccessibleExceptionUnmarshaller instance;

    public static LayerInaccessibleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LayerInaccessibleExceptionUnmarshaller();
        return instance;
    }
}
