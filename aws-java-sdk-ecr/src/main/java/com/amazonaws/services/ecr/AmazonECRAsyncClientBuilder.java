...
/**
 * Fluent builder for {@link com.amazonaws.services.ecr.AmazonECRAsync}. Use of the builder is preferred over using
...
public final class AmazonECRAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonECRAsyncClientBuilder, AmazonECRAsync> {
     ...
     * @return Fully configured implementation of AmazonECRAsync.
     */
    @Override
    protected AmazonECRAsync build(AwsAsyncClientParams params) {
