...
public class ValidatePullThroughCacheRuleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The repository name prefix associated with the pull through cache rule.
     */
     ...
     * </p>
     * 
     * @return The registry ID associated with the pull through cache rule. If you do not specify a registry, the
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ValidatePullThroughCacheRuleRequest == false)
            return false;
        ValidatePullThroughCacheRuleRequest other = (ValidatePullThroughCacheRuleRequest) obj;
    ...
    public ValidatePullThroughCacheRuleRequest clone() {
        return (ValidatePullThroughCacheRuleRequest) super.clone();
    }
