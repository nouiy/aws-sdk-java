...
public class CreatePullThroughCacheRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The date and time, in JavaScript date format, when the pull through cache rule was created.
     */
    ...
    public CreatePullThroughCacheRuleResult withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePullThroughCacheRuleResult == false)
            return false;
        CreatePullThroughCacheRuleResult other = (CreatePullThroughCacheRuleResult) obj;
