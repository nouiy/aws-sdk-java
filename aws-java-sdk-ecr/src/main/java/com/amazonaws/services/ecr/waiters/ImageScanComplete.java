...
class ImageScanComplete {
    ...
    static class IsCOMPLETEMatcher extends WaiterAcceptor<DescribeImageScanFindingsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("imageScanStatus"), new JmesPathField("status"));
         ...
         */
        @Override
        public boolean matches(DescribeImageScanFindingsResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeImageScanFindingsResult> {
        private static final JsonNode expectedResult;
