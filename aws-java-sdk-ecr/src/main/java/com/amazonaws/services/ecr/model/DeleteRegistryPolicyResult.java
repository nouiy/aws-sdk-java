...
public class DeleteRegistryPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The contents of the registry permissions policy that was deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteRegistryPolicyResult == false)
            return false;
        DeleteRegistryPolicyResult other = (DeleteRegistryPolicyResult) obj;
    ...
    public DeleteRegistryPolicyResult clone() {
        try {
            return (DeleteRegistryPolicyResult) super.clone();
