...
public class PutImageTagMutabilityResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutImageTagMutabilityResult == false)
            return false;
    ...
    @Override
    public PutImageTagMutabilityResult clone() {
        try {
            return (PutImageTagMutabilityResult) super.clone();
