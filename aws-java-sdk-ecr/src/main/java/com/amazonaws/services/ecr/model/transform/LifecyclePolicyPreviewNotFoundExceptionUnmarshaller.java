...
public class LifecyclePolicyPreviewNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LifecyclePolicyPreviewNotFoundExceptionUnmarshaller instance;

    public static LifecyclePolicyPreviewNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LifecyclePolicyPreviewNotFoundExceptionUnmarshaller();
        return instance;
    }
}
