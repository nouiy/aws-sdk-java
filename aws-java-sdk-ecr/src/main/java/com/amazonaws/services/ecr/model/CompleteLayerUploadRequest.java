...
public class CompleteLayerUploadRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The Amazon Web Services account ID associated with the registry to which to upload layers. If you do not specify
     ...
     * 
     * @param registryId
     *        The Amazon Web Services account ID associated with the registry to which to upload layers. If you do not
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID associated with the registry to which to upload layers. If you do not
     *         specify a registry, the default registry is assumed.
     */
