...
public class LifecyclePolicyNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static LifecyclePolicyNotFoundExceptionUnmarshaller instance;

    public static LifecyclePolicyNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new LifecyclePolicyNotFoundExceptionUnmarshaller();
        return instance;
    }
}
