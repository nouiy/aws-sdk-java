...
/**
 * RepositoryAnalysis JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RepositoryAnalysisJsonUnmarshaller implements Unmarshaller<RepositoryAnalysis, JsonUnmarshallerContext> {

    public RepositoryAnalysis unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static RepositoryAnalysisJsonUnmarshaller instance;

    public static RepositoryAnalysisJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RepositoryAnalysisJsonUnmarshaller();
        return instance;
    }
}
