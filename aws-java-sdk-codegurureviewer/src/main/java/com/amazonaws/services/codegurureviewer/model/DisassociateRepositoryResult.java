...
public class DisassociateRepositoryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisassociateRepositoryResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DisassociateRepositoryResult#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateRepositoryResult == false)
            return false;
    ...
    public DisassociateRepositoryResult clone() {
        try {
            return (DisassociateRepositoryResult) super.clone();
