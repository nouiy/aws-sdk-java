...
@SdkInternalApi
public class RecommendationFeedbackMarshaller {
    ...
    private static final RecommendationFeedbackMarshaller instance = new RecommendationFeedbackMarshaller();

    public static RecommendationFeedbackMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecommendationFeedback recommendationFeedback, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recommendationFeedback.getCodeReviewArn(), CODEREVIEWARN_BINDING);
            protocolMarshaller.marshall(recommendationFeedback.getRecommendationId(), RECOMMENDATIONID_BINDING);
            protocolMarshaller.marshall(recommendationFeedback.getReactions(), REACTIONS_BINDING);
            protocolMarshaller.marshall(recommendationFeedback.getUserId(), USERID_BINDING);
            protocolMarshaller.marshall(recommendationFeedback.getCreatedTimeStamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(recommendationFeedback.getLastUpdatedTimeStamp(), LASTUPDATEDTIMESTAMP_BINDING);
        } catch (Exception e) {
