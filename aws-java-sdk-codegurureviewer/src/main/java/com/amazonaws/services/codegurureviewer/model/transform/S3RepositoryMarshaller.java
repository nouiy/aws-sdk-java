...
public class S3RepositoryMarshaller {
    ...
    public void marshall(S3Repository s3Repository, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3Repository.getName(), NAME_BINDING);
            protocolMarshaller.marshall(s3Repository.getBucketName(), BUCKETNAME_BINDING);
        } catch (Exception e) {
