...
public class SetStackPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetStackPolicyResult == false)
            return false;
        SetStackPolicyResult other = (SetStackPolicyResult) obj;
        return true;
    }
    ...
    @Override
    public SetStackPolicyResult clone() {
        try {
            return (SetStackPolicyResult) super.clone();
