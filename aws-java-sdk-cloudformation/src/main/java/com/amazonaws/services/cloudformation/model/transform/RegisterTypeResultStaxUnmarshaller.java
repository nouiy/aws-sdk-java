...
/**
 * RegisterTypeResult StAX Unmarshaller
 */
...
public class RegisterTypeResultStaxUnmarshaller implements Unmarshaller<RegisterTypeResult, StaxUnmarshallerContext> {
    ...
    public RegisterTypeResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("RegistrationToken", targetDepth)) {
                    registerTypeResult.setRegistrationToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
