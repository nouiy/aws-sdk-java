...
public class ContinueUpdateRollbackResultStaxUnmarshaller implements Unmarshaller<ContinueUpdateRollbackResult, StaxUnmarshallerContext> {

    public ContinueUpdateRollbackResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    public static ContinueUpdateRollbackResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new ContinueUpdateRollbackResultStaxUnmarshaller();
        return instance;
    }
}
