...
/**
 * DetectStackResourceDriftResult StAX Unmarshaller
 */
...
public class DetectStackResourceDriftResultStaxUnmarshaller implements Unmarshaller<DetectStackResourceDriftResult, StaxUnmarshallerContext> {
    ...
    public DetectStackResourceDriftResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("StackResourceDrift", targetDepth)) {
                    detectStackResourceDriftResult.setStackResourceDrift(StackResourceDriftStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
