...
class StackImportComplete {
    ...
    static class IsIMPORT_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"IMPORT_COMPLETE\"");
    ...
    static class IsIMPORT_ROLLBACK_IN_PROGRESSMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"IMPORT_ROLLBACK_IN_PROGRESS\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsIMPORT_ROLLBACK_FAILEDMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"IMPORT_ROLLBACK_FAILED\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
    ...
    static class IsIMPORT_ROLLBACK_COMPLETEMatcher extends WaiterAcceptor<DescribeStacksResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"IMPORT_ROLLBACK_COMPLETE\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
