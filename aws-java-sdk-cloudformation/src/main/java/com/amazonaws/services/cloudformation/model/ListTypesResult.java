...
public class ListTypesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public java.util.List<TypeSummary> getTypeSummaries() {
        if (typeSummaries == null) {
            typeSummaries = new com.amazonaws.internal.SdkInternalList<TypeSummary>();
        }
    ...
    public void setTypeSummaries(java.util.Collection<TypeSummary> typeSummaries) {
        ...
        this.typeSummaries = new com.amazonaws.internal.SdkInternalList<TypeSummary>(typeSummaries);
    }
     ...
     * {@link #setTypeSummaries(java.util.Collection)} or {@link #withTypeSummaries(java.util.Collection)} if you want
    ...
    public ListTypesResult withTypeSummaries(TypeSummary... typeSummaries) {
        if (this.typeSummaries == null) {
            setTypeSummaries(new com.amazonaws.internal.SdkInternalList<TypeSummary>(typeSummaries.length));
        }
    ...
    public ListTypesResult withTypeSummaries(java.util.Collection<TypeSummary> typeSummaries) {
        setTypeSummaries(typeSummaries);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getTypeSummaries() != null)
            sb.append("TypeSummaries: ").append(getTypeSummaries()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getTypeSummaries() == null ^ this.getTypeSummaries() == null)
            return false;
        if (other.getTypeSummaries() != null && other.getTypeSummaries().equals(this.getTypeSummaries()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getTypeSummaries() == null) ? 0 : getTypeSummaries().hashCode());
