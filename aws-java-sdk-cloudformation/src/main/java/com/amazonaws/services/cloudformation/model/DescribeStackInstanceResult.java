...
public class DescribeStackInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeStackInstanceResult withStackInstance(StackInstance stackInstance) {
        setStackInstance(stackInstance);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getStackInstance() == null ^ this.getStackInstance() == null)
            return false;
        if (other.getStackInstance() != null && other.getStackInstance().equals(this.getStackInstance()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getStackInstance() == null) ? 0 : getStackInstance().hashCode());
        return hashCode;
    }
    ...
    public DescribeStackInstanceResult clone() {
        try {
            return (DescribeStackInstanceResult) super.clone();
