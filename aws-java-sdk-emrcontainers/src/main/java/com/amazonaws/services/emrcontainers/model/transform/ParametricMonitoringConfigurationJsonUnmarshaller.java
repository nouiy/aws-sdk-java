...
/**
 * ParametricMonitoringConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParametricMonitoringConfigurationJsonUnmarshaller implements Unmarshaller<ParametricMonitoringConfiguration, JsonUnmarshallerContext> {

    public ParametricMonitoringConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ParametricMonitoringConfiguration parametricMonitoringConfiguration = new ParametricMonitoringConfiguration();
    ...
    private static ParametricMonitoringConfigurationJsonUnmarshaller instance;

    public static ParametricMonitoringConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParametricMonitoringConfigurationJsonUnmarshaller();
        return instance;
    }
}
