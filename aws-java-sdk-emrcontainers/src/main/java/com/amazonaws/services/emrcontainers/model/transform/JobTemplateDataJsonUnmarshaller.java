...
/**
 * JobTemplateData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JobTemplateDataJsonUnmarshaller implements Unmarshaller<JobTemplateData, JsonUnmarshallerContext> {

    public JobTemplateData unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static JobTemplateDataJsonUnmarshaller instance;

    public static JobTemplateDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new JobTemplateDataJsonUnmarshaller();
        return instance;
    }
}
