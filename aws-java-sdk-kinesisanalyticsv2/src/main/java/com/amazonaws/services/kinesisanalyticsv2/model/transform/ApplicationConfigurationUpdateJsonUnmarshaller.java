...
/**
 * ApplicationConfigurationUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApplicationConfigurationUpdateJsonUnmarshaller implements Unmarshaller<ApplicationConfigurationUpdate, JsonUnmarshallerContext> {

    public ApplicationConfigurationUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ApplicationConfigurationUpdate applicationConfigurationUpdate = new ApplicationConfigurationUpdate();
    ...
    private static ApplicationConfigurationUpdateJsonUnmarshaller instance;

    public static ApplicationConfigurationUpdateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApplicationConfigurationUpdateJsonUnmarshaller();
        return instance;
    }
}
