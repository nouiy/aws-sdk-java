...
/**
 * FlinkApplicationConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FlinkApplicationConfigurationJsonUnmarshaller implements Unmarshaller<FlinkApplicationConfiguration, JsonUnmarshallerContext> {

    public FlinkApplicationConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        FlinkApplicationConfiguration flinkApplicationConfiguration = new FlinkApplicationConfiguration();
    ...
    private static FlinkApplicationConfigurationJsonUnmarshaller instance;

    public static FlinkApplicationConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FlinkApplicationConfigurationJsonUnmarshaller();
        return instance;
    }
}
