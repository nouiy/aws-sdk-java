...
/**
 * RunConfigurationUpdateMarshaller
 */
...
public class RunConfigurationUpdateMarshaller {
    ...
    private static final RunConfigurationUpdateMarshaller instance = new RunConfigurationUpdateMarshaller();

    public static RunConfigurationUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RunConfigurationUpdate runConfigurationUpdate, ProtocolMarshaller protocolMarshaller) {
