...
/**
 * RunConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RunConfigurationJsonUnmarshaller implements Unmarshaller<RunConfiguration, JsonUnmarshallerContext> {

    public RunConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static RunConfigurationJsonUnmarshaller instance;

    public static RunConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RunConfigurationJsonUnmarshaller();
        return instance;
    }
}
