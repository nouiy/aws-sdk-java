...
/**
 * ZeppelinApplicationConfigurationUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ZeppelinApplicationConfigurationUpdateJsonUnmarshaller implements Unmarshaller<ZeppelinApplicationConfigurationUpdate, JsonUnmarshallerContext> {

    public ZeppelinApplicationConfigurationUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ZeppelinApplicationConfigurationUpdate zeppelinApplicationConfigurationUpdate = new ZeppelinApplicationConfigurationUpdate();
    ...
    private static ZeppelinApplicationConfigurationUpdateJsonUnmarshaller instance;

    public static ZeppelinApplicationConfigurationUpdateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ZeppelinApplicationConfigurationUpdateJsonUnmarshaller();
        return instance;
    }
}
