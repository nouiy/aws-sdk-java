...
public class OutputUpdate implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Describes a Kinesis data stream as the destination for the output.
     */
     ...
     * </p>
     * 
     * @return Describes a Kinesis Data Firehose delivery stream as the destination for the output.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisanalyticsv2.model.transform.OutputUpdateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
