 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/KinesisFirehoseInputDescription"
...
public class KinesisFirehoseInputDescription implements Serializable, Cloneable, StructuredPojo {
     ...
     * 
     * @param roleARN
     *        The ARN of the IAM role that Kinesis Data Analytics assumes to access the stream.</p> <note>
     *        <p>
     *        Provided for backward compatibility. Applications that are created with the current API version have an
     *        application-level service execution role rather than a resource-level role.
     *        </p>
     ...
     * </note>
     * 
     * @return The ARN of the IAM role that Kinesis Data Analytics assumes to access the stream.</p> <note>
     *         <p>
     *         Provided for backward compatibility. Applications that are created with the current API version have an
     *         application-level service execution role rather than a resource-level role.
     *         </p>
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisanalyticsv2.model.transform.KinesisFirehoseInputDescriptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
