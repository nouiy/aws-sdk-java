...
/**
 * ListApplicationSnapshotsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListApplicationSnapshotsRequestMarshaller {
    ...
    private static final ListApplicationSnapshotsRequestMarshaller instance = new ListApplicationSnapshotsRequestMarshaller();

    public static ListApplicationSnapshotsRequestMarshaller getInstance() {
        return instance;
    }
