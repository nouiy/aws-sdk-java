...
public class ApplicationSnapshotConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ApplicationSnapshotConfiguration == false)
            return false;
        ApplicationSnapshotConfiguration other = (ApplicationSnapshotConfiguration) obj;
    ...
    @Override
    public ApplicationSnapshotConfiguration clone() {
        try {
            return (ApplicationSnapshotConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisanalyticsv2.model.transform.ApplicationSnapshotConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
