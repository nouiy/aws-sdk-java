...
/**
 * ApplicationCodeConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ApplicationCodeConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> CODECONTENT_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("CodeContent").build();
