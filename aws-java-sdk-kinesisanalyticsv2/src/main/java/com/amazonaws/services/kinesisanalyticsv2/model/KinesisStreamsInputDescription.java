 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/KinesisStreamsInputDescription"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KinesisStreamsInputDescription implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KinesisStreamsInputDescription == false)
            return false;
        KinesisStreamsInputDescription other = (KinesisStreamsInputDescription) obj;
    ...
    @Override
    public KinesisStreamsInputDescription clone() {
        try {
            return (KinesisStreamsInputDescription) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kinesisanalyticsv2.model.transform.KinesisStreamsInputDescriptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
