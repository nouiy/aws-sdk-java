...
/**
 * SqlApplicationConfigurationDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SqlApplicationConfigurationDescriptionJsonUnmarshaller implements Unmarshaller<SqlApplicationConfigurationDescription, JsonUnmarshallerContext> {

    public SqlApplicationConfigurationDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
        SqlApplicationConfigurationDescription sqlApplicationConfigurationDescription = new SqlApplicationConfigurationDescription();
    ...
    private static SqlApplicationConfigurationDescriptionJsonUnmarshaller instance;

    public static SqlApplicationConfigurationDescriptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SqlApplicationConfigurationDescriptionJsonUnmarshaller();
        return instance;
    }
}
