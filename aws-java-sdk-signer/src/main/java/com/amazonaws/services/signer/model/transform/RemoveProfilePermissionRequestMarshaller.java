...
public class RemoveProfilePermissionRequestMarshaller {
    ...
    private static final RemoveProfilePermissionRequestMarshaller instance = new RemoveProfilePermissionRequestMarshaller();

    public static RemoveProfilePermissionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RemoveProfilePermissionRequest removeProfilePermissionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(removeProfilePermissionRequest.getProfileName(), PROFILENAME_BINDING);
            protocolMarshaller.marshall(removeProfilePermissionRequest.getRevisionId(), REVISIONID_BINDING);
            protocolMarshaller.marshall(removeProfilePermissionRequest.getStatementId(), STATEMENTID_BINDING);
        } catch (Exception e) {
