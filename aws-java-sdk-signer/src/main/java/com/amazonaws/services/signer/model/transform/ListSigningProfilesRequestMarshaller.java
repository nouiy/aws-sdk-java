...
public class ListSigningProfilesRequestMarshaller {
    ...
    private static final MarshallingInfo<Boolean> INCLUDECANCELED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("includeCanceled").build();
    ...
    public static ListSigningProfilesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListSigningProfilesRequest listSigningProfilesRequest, ProtocolMarshaller protocolMarshaller) {
