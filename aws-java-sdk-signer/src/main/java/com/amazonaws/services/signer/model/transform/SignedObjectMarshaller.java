...
/**
 * SignedObjectMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SignedObjectMarshaller {
    ...
    private static final SignedObjectMarshaller instance = new SignedObjectMarshaller();

    public static SignedObjectMarshaller getInstance() {
        return instance;
    }
