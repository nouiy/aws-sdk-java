...
/**
 * RevokeSigningProfileResult JSON Unmarshaller
 */
...
public class RevokeSigningProfileResultJsonUnmarshaller implements Unmarshaller<RevokeSigningProfileResult, JsonUnmarshallerContext> {
    ...
    public RevokeSigningProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RevokeSigningProfileResult revokeSigningProfileResult = new RevokeSigningProfileResult();

        return revokeSigningProfileResult;
    }
