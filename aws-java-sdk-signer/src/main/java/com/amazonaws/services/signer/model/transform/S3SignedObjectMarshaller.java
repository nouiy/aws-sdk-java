...
public class S3SignedObjectMarshaller {
    ...
    public void marshall(S3SignedObject s3SignedObject, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3SignedObject.getBucketName(), BUCKETNAME_BINDING);
            protocolMarshaller.marshall(s3SignedObject.getKey(), KEY_BINDING);
        } catch (Exception e) {
