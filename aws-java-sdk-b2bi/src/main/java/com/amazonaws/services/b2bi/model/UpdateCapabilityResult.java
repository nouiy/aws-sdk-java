...
public class UpdateCapabilityResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateCapabilityResult withCapabilityId(String capabilityId) {
    ...
    public UpdateCapabilityResult withCapabilityArn(String capabilityArn) {
    ...
    public UpdateCapabilityResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UpdateCapabilityResult withType(String type) {
        setType(type);
        return this;
    }
    ...
    public UpdateCapabilityResult withType(CapabilityType type) {
    ...
    public UpdateCapabilityResult withConfiguration(CapabilityConfiguration configuration) {
    ...
    public UpdateCapabilityResult withInstructionsDocuments(S3Location... instructionsDocuments) {
    ...
    public UpdateCapabilityResult withInstructionsDocuments(java.util.Collection<S3Location> instructionsDocuments) {
    ...
    public UpdateCapabilityResult withCreatedAt(java.util.Date createdAt) {
    ...
    public UpdateCapabilityResult withModifiedAt(java.util.Date modifiedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCapabilityResult == false)
            return false;
        UpdateCapabilityResult other = (UpdateCapabilityResult) obj;
    ...
    @Override
    public UpdateCapabilityResult clone() {
        try {
            return (UpdateCapabilityResult) super.clone();
