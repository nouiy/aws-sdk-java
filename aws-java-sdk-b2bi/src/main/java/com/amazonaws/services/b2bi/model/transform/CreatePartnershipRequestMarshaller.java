...
public class CreatePartnershipRequestMarshaller {
    ...
    private static final CreatePartnershipRequestMarshaller instance = new CreatePartnershipRequestMarshaller();

    public static CreatePartnershipRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreatePartnershipRequest createPartnershipRequest, ProtocolMarshaller protocolMarshaller) {

        if (createPartnershipRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createPartnershipRequest.getProfileId(), PROFILEID_BINDING);
            protocolMarshaller.marshall(createPartnershipRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createPartnershipRequest.getEmail(), EMAIL_BINDING);
            protocolMarshaller.marshall(createPartnershipRequest.getPhone(), PHONE_BINDING);
            protocolMarshaller.marshall(createPartnershipRequest.getCapabilities(), CAPABILITIES_BINDING);
            protocolMarshaller.marshall(createPartnershipRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createPartnershipRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
