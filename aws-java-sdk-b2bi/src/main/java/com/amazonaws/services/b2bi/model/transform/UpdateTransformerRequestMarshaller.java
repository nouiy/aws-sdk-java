...
/**
 * UpdateTransformerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateTransformerRequestMarshaller {
    ...
    private static final UpdateTransformerRequestMarshaller instance = new UpdateTransformerRequestMarshaller();

    public static UpdateTransformerRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateTransformerRequest updateTransformerRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateTransformerRequest.getTransformerId(), TRANSFORMERID_BINDING);
            protocolMarshaller.marshall(updateTransformerRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateTransformerRequest.getFileFormat(), FILEFORMAT_BINDING);
            protocolMarshaller.marshall(updateTransformerRequest.getMappingTemplate(), MAPPINGTEMPLATE_BINDING);
            protocolMarshaller.marshall(updateTransformerRequest.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(updateTransformerRequest.getEdiType(), EDITYPE_BINDING);
            protocolMarshaller.marshall(updateTransformerRequest.getSampleDocument(), SAMPLEDOCUMENT_BINDING);
        } catch (Exception e) {
