...
public class ListProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Returns an array of <code>ProfileSummary</code> objects.
     */
    ...
    public void setProfiles(java.util.Collection<ProfileSummary> profiles) {
        if (profiles == null) {
            this.profiles = null;
            return;
        }

        this.profiles = new java.util.ArrayList<ProfileSummary>(profiles);
    }
    ...
    public ListProfilesResult withProfiles(ProfileSummary... profiles) {
        if (this.profiles == null) {
            setProfiles(new java.util.ArrayList<ProfileSummary>(profiles.length));
        }
    ...
    public ListProfilesResult withProfiles(java.util.Collection<ProfileSummary> profiles) {
