...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.pcaconnectorscep.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.pcaconnectorscep.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pcaconnectorscep.model.ConflictException conflictException = new com.amazonaws.services.pcaconnectorscep.model.ConflictException(
                null);
