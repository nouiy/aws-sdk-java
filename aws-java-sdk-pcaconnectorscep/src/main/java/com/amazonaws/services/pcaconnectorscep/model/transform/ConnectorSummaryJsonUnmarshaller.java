        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    connectorSummary.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("MobileDeviceManagement", targetDepth)) {
                    context.nextToken();
                    connectorSummary.setMobileDeviceManagement(MobileDeviceManagementJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("OpenIdConfiguration", targetDepth)) {
                    context.nextToken();
                    connectorSummary.setOpenIdConfiguration(OpenIdConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("Endpoint", targetDepth)) {
                    context.nextToken();
                    connectorSummary.setEndpoint(context.getUnmarshaller(String.class).unmarshall(context));
                }
