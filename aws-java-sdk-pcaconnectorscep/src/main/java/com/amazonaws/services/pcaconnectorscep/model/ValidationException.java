...
public class ValidationException extends com.amazonaws.services.pcaconnectorscep.model.AWSPcaConnectorScepException {
    private static final long serialVersionUID = 1L;

    /**
     * <p>
     * The reason for the validation error, if available. The service doesn't return a reason for every validation
     * exception.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The reason for the validation error, if available. The service doesn't return a reason for every
     *         validation exception.
     * @see ValidationExceptionReason
     */
