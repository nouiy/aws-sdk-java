...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.pcaconnectorscep.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.pcaconnectorscep.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pcaconnectorscep.model.ValidationException validationException = new com.amazonaws.services.pcaconnectorscep.model.ValidationException(
                null);
