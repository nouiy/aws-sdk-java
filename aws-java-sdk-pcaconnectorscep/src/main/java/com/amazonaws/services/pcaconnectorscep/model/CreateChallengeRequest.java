...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-scep-2018-05-10/CreateChallenge" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateChallengeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the connector that you want to create a challenge for.
     */
    ...
    public CreateChallengeRequest withClientToken(String clientToken) {
    ...
    public CreateChallengeRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateChallengeRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateChallengeRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateChallengeRequest == false)
            return false;
        CreateChallengeRequest other = (CreateChallengeRequest) obj;
    ...
    public CreateChallengeRequest clone() {
        return (CreateChallengeRequest) super.clone();
    }
