...
public class ConnectorMarshaller {
    ...
    public void marshall(Connector connector, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(connector.getCertificateAuthorityArn(), CERTIFICATEAUTHORITYARN_BINDING);
            protocolMarshaller.marshall(connector.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(connector.getMobileDeviceManagement(), MOBILEDEVICEMANAGEMENT_BINDING);
            protocolMarshaller.marshall(connector.getOpenIdConfiguration(), OPENIDCONFIGURATION_BINDING);
            protocolMarshaller.marshall(connector.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(connector.getStatusReason(), STATUSREASON_BINDING);
            protocolMarshaller.marshall(connector.getEndpoint(), ENDPOINT_BINDING);
            protocolMarshaller.marshall(connector.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(connector.getUpdatedAt(), UPDATEDAT_BINDING);
        } catch (Exception e) {
