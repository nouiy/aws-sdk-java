...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.pcaconnectorscep.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.pcaconnectorscep.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pcaconnectorscep.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.pcaconnectorscep.model.ResourceNotFoundException(
                null);
