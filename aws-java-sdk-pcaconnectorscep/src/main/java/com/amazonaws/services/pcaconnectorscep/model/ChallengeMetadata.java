 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-scep-2018-05-10/ChallengeMetadata"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChallengeMetadata implements Serializable, Cloneable, StructuredPojo {
    ...
    public ChallengeMetadata withCreatedAt(java.util.Date createdAt) {
    ...
    public ChallengeMetadata withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ChallengeMetadata == false)
            return false;
        ChallengeMetadata other = (ChallengeMetadata) obj;
    ...
    public ChallengeMetadata clone() {
        try {
            return (ChallengeMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pcaconnectorscep.model.transform.ChallengeMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
