 ...
 * href="https://docs.aws.amazon.com/C4SCEP_API/pca-connector-scep/latest/APIReference/API_GetChallengeMetadata.html"
 * >GetChallengeMetadata</a> action.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pca-connector-scep-2018-05-10/ChallengeMetadataSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChallengeMetadataSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ChallengeMetadataSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public ChallengeMetadataSummary withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ChallengeMetadataSummary == false)
            return false;
        ChallengeMetadataSummary other = (ChallengeMetadataSummary) obj;
    ...
    public ChallengeMetadataSummary clone() {
        try {
            return (ChallengeMetadataSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pcaconnectorscep.model.transform.ChallengeMetadataSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
