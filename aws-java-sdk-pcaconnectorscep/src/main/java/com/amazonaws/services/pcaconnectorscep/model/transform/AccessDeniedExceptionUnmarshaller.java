...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.pcaconnectorscep.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.pcaconnectorscep.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pcaconnectorscep.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.pcaconnectorscep.model.AccessDeniedException(
                null);
