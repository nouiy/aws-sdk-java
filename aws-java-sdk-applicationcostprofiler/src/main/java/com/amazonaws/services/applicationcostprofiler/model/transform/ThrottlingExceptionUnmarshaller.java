...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationcostprofiler.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.applicationcostprofiler.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.applicationcostprofiler.model.ThrottlingException throttlingException = new com.amazonaws.services.applicationcostprofiler.model.ThrottlingException(
                null);
