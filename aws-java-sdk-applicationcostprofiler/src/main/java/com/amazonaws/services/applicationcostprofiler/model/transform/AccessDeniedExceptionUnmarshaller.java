...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationcostprofiler.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.applicationcostprofiler.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.applicationcostprofiler.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.applicationcostprofiler.model.AccessDeniedException(
                null);
