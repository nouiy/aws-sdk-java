...
/**
 * PutReportDefinitionResult JSON Unmarshaller
 */
...
public class PutReportDefinitionResultJsonUnmarshaller implements Unmarshaller<PutReportDefinitionResult, JsonUnmarshallerContext> {
    ...
    public PutReportDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutReportDefinitionResult putReportDefinitionResult = new PutReportDefinitionResult();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("reportId", targetDepth)) {
                    context.nextToken();
                    putReportDefinitionResult.setReportId(context.getUnmarshaller(String.class).unmarshall(context));
                }
