...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationcostprofiler.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.applicationcostprofiler.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.applicationcostprofiler.model.ValidationException validationException = new com.amazonaws.services.applicationcostprofiler.model.ValidationException(
                null);
