...
/**
 * PutReportDefinitionRequestMarshaller
 */
...
public class PutReportDefinitionRequestMarshaller {
    ...
    public static PutReportDefinitionRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(PutReportDefinitionRequest putReportDefinitionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putReportDefinitionRequest.getReportId(), REPORTID_BINDING);
            protocolMarshaller.marshall(putReportDefinitionRequest.getReportDescription(), REPORTDESCRIPTION_BINDING);
            protocolMarshaller.marshall(putReportDefinitionRequest.getReportFrequency(), REPORTFREQUENCY_BINDING);
            protocolMarshaller.marshall(putReportDefinitionRequest.getFormat(), FORMAT_BINDING);
            protocolMarshaller.marshall(putReportDefinitionRequest.getDestinationS3Location(), DESTINATIONS3LOCATION_BINDING);
        } catch (Exception e) {
