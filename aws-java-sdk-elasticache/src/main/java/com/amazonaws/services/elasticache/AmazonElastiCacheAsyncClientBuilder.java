...
/**
 * Fluent builder for {@link com.amazonaws.services.elasticache.AmazonElastiCacheAsync}. Use of the builder is preferred
 * over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AmazonElastiCacheAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonElastiCacheAsyncClientBuilder, AmazonElastiCacheAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonElastiCacheAsync using the current builder configuration.
     *
     * @param params
