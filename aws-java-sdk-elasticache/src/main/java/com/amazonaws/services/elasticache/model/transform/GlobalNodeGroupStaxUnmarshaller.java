        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("GlobalNodeGroupId", targetDepth)) {
                    globalNodeGroup.setGlobalNodeGroupId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Slots", targetDepth)) {
                    globalNodeGroup.setSlots(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
