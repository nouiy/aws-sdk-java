        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("SubnetOutpostArn", targetDepth)) {
                    subnetOutpost.setSubnetOutpostArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
