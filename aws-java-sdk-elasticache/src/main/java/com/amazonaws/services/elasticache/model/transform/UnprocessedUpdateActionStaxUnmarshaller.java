...
/**
 * UnprocessedUpdateAction StAX Unmarshaller
 */
...
public class UnprocessedUpdateActionStaxUnmarshaller implements Unmarshaller<UnprocessedUpdateAction, StaxUnmarshallerContext> {
    ...
    public UnprocessedUpdateAction unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ReplicationGroupId", targetDepth)) {
                    unprocessedUpdateAction.setReplicationGroupId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("ErrorType", targetDepth)) {
                    unprocessedUpdateAction.setErrorType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ErrorMessage", targetDepth)) {
                    unprocessedUpdateAction.setErrorMessage(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
