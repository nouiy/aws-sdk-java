...
/**
 * NodeGroupUpdateStatus StAX Unmarshaller
 */
...
public class NodeGroupUpdateStatusStaxUnmarshaller implements Unmarshaller<NodeGroupUpdateStatus, StaxUnmarshallerContext> {
    ...
    public NodeGroupUpdateStatus unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("NodeGroupId", targetDepth)) {
                    nodeGroupUpdateStatus.setNodeGroupId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("NodeGroupMemberUpdateStatus", targetDepth)) {
                    nodeGroupUpdateStatus.withNodeGroupMemberUpdateStatus(new ArrayList<NodeGroupMemberUpdateStatus>());
                    continue;
                }

                if (context.testExpression("NodeGroupMemberUpdateStatus/NodeGroupMemberUpdateStatus", targetDepth)) {
                    nodeGroupUpdateStatus.withNodeGroupMemberUpdateStatus(NodeGroupMemberUpdateStatusStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
