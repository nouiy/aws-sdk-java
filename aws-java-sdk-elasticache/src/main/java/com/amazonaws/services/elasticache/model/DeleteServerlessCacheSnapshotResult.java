...
public class DeleteServerlessCacheSnapshotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteServerlessCacheSnapshotResult == false)
            return false;
        DeleteServerlessCacheSnapshotResult other = (DeleteServerlessCacheSnapshotResult) obj;
    ...
    public DeleteServerlessCacheSnapshotResult clone() {
        try {
            return (DeleteServerlessCacheSnapshotResult) super.clone();
