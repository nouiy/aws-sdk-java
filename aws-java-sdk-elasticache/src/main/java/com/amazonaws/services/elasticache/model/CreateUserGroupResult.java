...
public class CreateUserGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateUserGroupResult withUserIds(String... userIds) {
    ...
    public CreateUserGroupResult withUserIds(java.util.Collection<String> userIds) {
        setUserIds(userIds);
        return this;
    }
    ...
    public CreateUserGroupResult withReplicationGroups(String... replicationGroups) {
    ...
    public CreateUserGroupResult withReplicationGroups(java.util.Collection<String> replicationGroups) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateUserGroupResult == false)
            return false;
        CreateUserGroupResult other = (CreateUserGroupResult) obj;
    ...
    public CreateUserGroupResult clone() {
        try {
            return (CreateUserGroupResult) super.clone();
