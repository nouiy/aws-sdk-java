...
public class ListFiltersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A token returned from the previous call to <code>ListFilters</code> for getting the next set of filters (if they
     * exist).
     * </p>
     */
     ...
     * </p>
     * 
     * @return The ARN of the dataset group that contains the filters.
     */
     ...
     * 
     * @param nextToken
     *        A token returned from the previous call to <code>ListFilters</code> for getting the next set of filters
     *        (if they exist).
     */
     ...
     * </p>
     * 
     * @return A token returned from the previous call to <code>ListFilters</code> for getting the next set of filters
     *         (if they exist).
     */
     ...
     * </p>
     * 
     * @return The maximum number of filters to return.
     */
