...
/**
 * DeleteRecommenderResult JSON Unmarshaller
 */
...
public class DeleteRecommenderResultJsonUnmarshaller implements Unmarshaller<DeleteRecommenderResult, JsonUnmarshallerContext> {
    ...
    public DeleteRecommenderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRecommenderResult deleteRecommenderResult = new DeleteRecommenderResult();
