...
/**
 * CreateFilterResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateFilterResultJsonUnmarshaller implements Unmarshaller<CreateFilterResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("filterArn", targetDepth)) {
                    context.nextToken();
                    createFilterResult.setFilterArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
