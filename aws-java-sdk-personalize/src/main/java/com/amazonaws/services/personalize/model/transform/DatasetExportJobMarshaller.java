...
/**
 * DatasetExportJobMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DatasetExportJobMarshaller {
    ...
    private static final DatasetExportJobMarshaller instance = new DatasetExportJobMarshaller();

    public static DatasetExportJobMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DatasetExportJob datasetExportJob, ProtocolMarshaller protocolMarshaller) {

        if (datasetExportJob == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(datasetExportJob.getJobName(), JOBNAME_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getDatasetExportJobArn(), DATASETEXPORTJOBARN_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getDatasetArn(), DATASETARN_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getIngestionMode(), INGESTIONMODE_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getJobOutput(), JOBOUTPUT_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getCreationDateTime(), CREATIONDATETIME_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getLastUpdatedDateTime(), LASTUPDATEDDATETIME_BINDING);
            protocolMarshaller.marshall(datasetExportJob.getFailureReason(), FAILUREREASON_BINDING);
        } catch (Exception e) {
