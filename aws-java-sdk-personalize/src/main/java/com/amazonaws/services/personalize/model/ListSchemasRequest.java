...
public class ListSchemasRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A token returned from the previous call to <code>ListSchemas</code> for getting the next set of schemas (if they
     * exist).
     * </p>
     */
     ...
     * 
     * @param nextToken
     *        A token returned from the previous call to <code>ListSchemas</code> for getting the next set of schemas
     *        (if they exist).
     */
     ...
     * </p>
     * 
     * @return A token returned from the previous call to <code>ListSchemas</code> for getting the next set of schemas
     *         (if they exist).
     */
     ...
     * </p>
     * 
     * @return The maximum number of schemas to return.
     */
