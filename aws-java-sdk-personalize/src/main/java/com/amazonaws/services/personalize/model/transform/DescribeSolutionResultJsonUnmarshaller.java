...
/**
 * DescribeSolutionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeSolutionResultJsonUnmarshaller implements Unmarshaller<DescribeSolutionResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("solution", targetDepth)) {
                    context.nextToken();
                    describeSolutionResult.setSolution(SolutionJsonUnmarshaller.getInstance().unmarshall(context));
                }
