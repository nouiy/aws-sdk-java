...
/**
 * ListSolutionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSolutionsResultJsonUnmarshaller implements Unmarshaller<ListSolutionsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("solutions", targetDepth)) {
                    context.nextToken();
                    listSolutionsResult.setSolutions(new ListUnmarshaller<SolutionSummary>(SolutionSummaryJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listSolutionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
