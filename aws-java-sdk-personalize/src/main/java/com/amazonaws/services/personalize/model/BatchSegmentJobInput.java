 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/personalize-2018-05-22/BatchSegmentJobInput" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchSegmentJobInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchSegmentJobInput == false)
            return false;
    ...
    public BatchSegmentJobInput clone() {
        try {
            return (BatchSegmentJobInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.personalize.model.transform.BatchSegmentJobInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
