...
public class DescribeCampaignResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The properties of the campaign.
     */
    ...
    public DescribeCampaignResult clone() {
        try {
            return (DescribeCampaignResult) super.clone();
