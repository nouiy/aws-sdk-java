...
/**
 * StopSolutionVersionCreationResult JSON Unmarshaller
 */
...
public class StopSolutionVersionCreationResultJsonUnmarshaller implements Unmarshaller<StopSolutionVersionCreationResult, JsonUnmarshallerContext> {
    ...
    public StopSolutionVersionCreationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopSolutionVersionCreationResult stopSolutionVersionCreationResult = new StopSolutionVersionCreationResult();

        return stopSolutionVersionCreationResult;
    }
