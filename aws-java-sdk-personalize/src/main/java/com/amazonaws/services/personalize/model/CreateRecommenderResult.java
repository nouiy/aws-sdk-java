...
public class CreateRecommenderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateRecommenderResult withRecommenderArn(String recommenderArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRecommenderResult == false)
            return false;
        CreateRecommenderResult other = (CreateRecommenderResult) obj;
    ...
    @Override
    public CreateRecommenderResult clone() {
        try {
            return (CreateRecommenderResult) super.clone();
