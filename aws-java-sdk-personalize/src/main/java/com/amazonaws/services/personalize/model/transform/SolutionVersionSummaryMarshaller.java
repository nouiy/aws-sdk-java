...
/**
 * SolutionVersionSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SolutionVersionSummaryMarshaller {
    ...
    private static final SolutionVersionSummaryMarshaller instance = new SolutionVersionSummaryMarshaller();

    public static SolutionVersionSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SolutionVersionSummary solutionVersionSummary, ProtocolMarshaller protocolMarshaller) {

        if (solutionVersionSummary == null) {
