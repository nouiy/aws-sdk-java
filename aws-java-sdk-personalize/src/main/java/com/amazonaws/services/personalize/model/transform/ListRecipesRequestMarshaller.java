...
@SdkInternalApi
public class ListRecipesRequestMarshaller {

    private static final MarshallingInfo<String> RECIPEPROVIDER_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("recipeProvider").build();
    ...
    public static ListRecipesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListRecipesRequest listRecipesRequest, ProtocolMarshaller protocolMarshaller) {
