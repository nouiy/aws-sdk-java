...
/**
 * CategoricalHyperParameterRange JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CategoricalHyperParameterRangeJsonUnmarshaller implements Unmarshaller<CategoricalHyperParameterRange, JsonUnmarshallerContext> {

    public CategoricalHyperParameterRange unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    categoricalHyperParameterRange.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
