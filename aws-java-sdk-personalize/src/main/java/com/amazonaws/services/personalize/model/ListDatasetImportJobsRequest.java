...
public class ListDatasetImportJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the dataset to list the dataset import jobs for.
     */
     ...
     * </p>
     * 
     * @return The maximum number of dataset import jobs to return.
     */
    ...
    public ListDatasetImportJobsRequest clone() {
        return (ListDatasetImportJobsRequest) super.clone();
    }
