...
public class ListJobRunsRequestMarshaller {
    ...
    private static final MarshallingInfo<java.util.Date> CREATEDATAFTER_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("createdAtAfter").timestampFormat("iso8601").build();
    private static final MarshallingInfo<java.util.Date> CREATEDATBEFORE_BINDING = MarshallingInfo.builder(MarshallingType.DATE)
    ...
    public void marshall(ListJobRunsRequest listJobRunsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listJobRunsRequest.getApplicationId(), APPLICATIONID_BINDING);
