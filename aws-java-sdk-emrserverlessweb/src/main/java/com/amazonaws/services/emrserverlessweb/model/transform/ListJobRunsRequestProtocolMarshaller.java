...
public class ListJobRunsRequestProtocolMarshaller implements Marshaller<Request<ListJobRunsRequest>, ListJobRunsRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.REST_JSON)
            .requestUri("/applications/{applicationId}/jobruns").httpMethodName(HttpMethodName.GET).hasExplicitPayloadMember(false).hasPayloadMembers(false)
            .serviceName("AWSEMRServerlessWeb").build();
