...
/**
 * Client for accessing EMR Serverless Web Service asynchronously. Each asynchronous method will return a Java Future
...
public class AWSEMRServerlessWebAsyncClient extends AWSEMRServerlessWebClient implements AWSEMRServerlessWebAsync {

    private static final int DEFAULT_THREAD_POOL_SIZE = 50;

    private final java.util.concurrent.ExecutorService executorService;

    public static AWSEMRServerlessWebAsyncClientBuilder asyncBuilder() {
        return AWSEMRServerlessWebAsyncClientBuilder.standard();
    }

    /**
     * Constructs a new asynchronous client to invoke service methods on EMR Serverless Web Service using the specified
     * parameters.
     *
     * @param asyncClientParams
     *        Object providing client parameters.
     */
    AWSEMRServerlessWebAsyncClient(AwsAsyncClientParams asyncClientParams) {
     ...
     */
    AWSEMRServerlessWebAsyncClient(AwsAsyncClientParams asyncClientParams, boolean endpointDiscoveryEnabled) {
