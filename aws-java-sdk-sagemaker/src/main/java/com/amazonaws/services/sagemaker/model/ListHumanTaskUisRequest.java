...
public class ListHumanTaskUisRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A filter that returns only human task user interfaces with a creation time greater than or equal to the
     *         specified timestamp.
     */
     ...
     * </p>
     * 
     * @return A filter that returns only human task user interfaces that were created before the specified timestamp.
     */
    ...
    public ListHumanTaskUisRequest clone() {
        return (ListHumanTaskUisRequest) super.clone();
    }
