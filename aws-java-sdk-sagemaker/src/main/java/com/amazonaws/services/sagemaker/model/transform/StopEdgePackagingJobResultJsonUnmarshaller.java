...
/**
 * StopEdgePackagingJobResult JSON Unmarshaller
 */
...
public class StopEdgePackagingJobResultJsonUnmarshaller implements Unmarshaller<StopEdgePackagingJobResult, JsonUnmarshallerContext> {
    ...
    public StopEdgePackagingJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopEdgePackagingJobResult stopEdgePackagingJobResult = new StopEdgePackagingJobResult();

        return stopEdgePackagingJobResult;
    }
