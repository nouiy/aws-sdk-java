...
/**
 * OidcConfigForResponse JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OidcConfigForResponseJsonUnmarshaller implements Unmarshaller<OidcConfigForResponse, JsonUnmarshallerContext> {

    public OidcConfigForResponse unmarshall(JsonUnmarshallerContext context) throws Exception {
        OidcConfigForResponse oidcConfigForResponse = new OidcConfigForResponse();
    ...
    private static OidcConfigForResponseJsonUnmarshaller instance;

    public static OidcConfigForResponseJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OidcConfigForResponseJsonUnmarshaller();
        return instance;
    }
}
