...
/**
 * ModelPackageGroupMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ModelPackageGroupMarshaller {
    ...
    private static final ModelPackageGroupMarshaller instance = new ModelPackageGroupMarshaller();

    public static ModelPackageGroupMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ModelPackageGroup modelPackageGroup, ProtocolMarshaller protocolMarshaller) {

        if (modelPackageGroup == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(modelPackageGroup.getModelPackageGroupName(), MODELPACKAGEGROUPNAME_BINDING);
            protocolMarshaller.marshall(modelPackageGroup.getModelPackageGroupArn(), MODELPACKAGEGROUPARN_BINDING);
            protocolMarshaller.marshall(modelPackageGroup.getModelPackageGroupDescription(), MODELPACKAGEGROUPDESCRIPTION_BINDING);
            protocolMarshaller.marshall(modelPackageGroup.getCreationTime(), CREATIONTIME_BINDING);
            protocolMarshaller.marshall(modelPackageGroup.getCreatedBy(), CREATEDBY_BINDING);
            protocolMarshaller.marshall(modelPackageGroup.getModelPackageGroupStatus(), MODELPACKAGEGROUPSTATUS_BINDING);
            protocolMarshaller.marshall(modelPackageGroup.getTags(), TAGS_BINDING);
        } catch (Exception e) {
