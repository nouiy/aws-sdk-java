...
/**
 * StopProcessingJobResult JSON Unmarshaller
 */
...
public class StopProcessingJobResultJsonUnmarshaller implements Unmarshaller<StopProcessingJobResult, JsonUnmarshallerContext> {
    ...
    public StopProcessingJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopProcessingJobResult stopProcessingJobResult = new StopProcessingJobResult();

        return stopProcessingJobResult;
    }
