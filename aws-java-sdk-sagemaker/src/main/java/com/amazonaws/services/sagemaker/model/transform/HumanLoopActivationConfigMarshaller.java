...
/**
 * HumanLoopActivationConfigMarshaller
 */
...
public class HumanLoopActivationConfigMarshaller {
    ...
    private static final HumanLoopActivationConfigMarshaller instance = new HumanLoopActivationConfigMarshaller();

    public static HumanLoopActivationConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HumanLoopActivationConfig humanLoopActivationConfig, ProtocolMarshaller protocolMarshaller) {
