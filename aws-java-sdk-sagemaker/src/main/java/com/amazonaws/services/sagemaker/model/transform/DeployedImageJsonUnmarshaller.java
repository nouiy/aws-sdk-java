...
/**
 * DeployedImage JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeployedImageJsonUnmarshaller implements Unmarshaller<DeployedImage, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SpecifiedImage", targetDepth)) {
                    context.nextToken();
                    deployedImage.setSpecifiedImage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResolvedImage", targetDepth)) {
                    context.nextToken();
                    deployedImage.setResolvedImage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResolutionTime", targetDepth)) {
                    context.nextToken();
                    deployedImage.setResolutionTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
