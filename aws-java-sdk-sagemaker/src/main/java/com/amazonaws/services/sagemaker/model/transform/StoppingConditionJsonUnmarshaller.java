...
/**
 * StoppingCondition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StoppingConditionJsonUnmarshaller implements Unmarshaller<StoppingCondition, JsonUnmarshallerContext> {
    ...
    private static StoppingConditionJsonUnmarshaller instance;

    public static StoppingConditionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StoppingConditionJsonUnmarshaller();
        return instance;
    }
}
