...
/**
 * NetworkConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NetworkConfigJsonUnmarshaller implements Unmarshaller<NetworkConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("VpcConfig", targetDepth)) {
                    context.nextToken();
                    networkConfig.setVpcConfig(VpcConfigJsonUnmarshaller.getInstance().unmarshall(context));
                }
