...
/**
 * DataCaptureConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataCaptureConfigJsonUnmarshaller implements Unmarshaller<DataCaptureConfig, JsonUnmarshallerContext> {

    public DataCaptureConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        DataCaptureConfig dataCaptureConfig = new DataCaptureConfig();
    ...
    private static DataCaptureConfigJsonUnmarshaller instance;

    public static DataCaptureConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DataCaptureConfigJsonUnmarshaller();
        return instance;
    }
}
