...
/**
 * ContextSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ContextSourceMarshaller {
    ...
    private static final ContextSourceMarshaller instance = new ContextSourceMarshaller();

    public static ContextSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ContextSource contextSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(contextSource.getSourceUri(), SOURCEURI_BINDING);
            protocolMarshaller.marshall(contextSource.getSourceType(), SOURCETYPE_BINDING);
            protocolMarshaller.marshall(contextSource.getSourceId(), SOURCEID_BINDING);
        } catch (Exception e) {
