...
/**
 * ActionSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ActionSourceMarshaller {
    ...
    private static final ActionSourceMarshaller instance = new ActionSourceMarshaller();

    public static ActionSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ActionSource actionSource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(actionSource.getSourceUri(), SOURCEURI_BINDING);
            protocolMarshaller.marshall(actionSource.getSourceType(), SOURCETYPE_BINDING);
            protocolMarshaller.marshall(actionSource.getSourceId(), SOURCEID_BINDING);
        } catch (Exception e) {
