...
/**
 * ModelQualityJobInputMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ModelQualityJobInputMarshaller {
    ...
    private static final ModelQualityJobInputMarshaller instance = new ModelQualityJobInputMarshaller();

    public static ModelQualityJobInputMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ModelQualityJobInput modelQualityJobInput, ProtocolMarshaller protocolMarshaller) {

        if (modelQualityJobInput == null) {
