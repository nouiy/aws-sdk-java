...
public class UpdateWorkforceRequestMarshaller {
    ...
    public static UpdateWorkforceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateWorkforceRequest updateWorkforceRequest, ProtocolMarshaller protocolMarshaller) {
