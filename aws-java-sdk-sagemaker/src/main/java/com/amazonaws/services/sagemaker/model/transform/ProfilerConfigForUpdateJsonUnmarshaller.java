...
/**
 * ProfilerConfigForUpdate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProfilerConfigForUpdateJsonUnmarshaller implements Unmarshaller<ProfilerConfigForUpdate, JsonUnmarshallerContext> {

    public ProfilerConfigForUpdate unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProfilerConfigForUpdate profilerConfigForUpdate = new ProfilerConfigForUpdate();
    ...
    private static ProfilerConfigForUpdateJsonUnmarshaller instance;

    public static ProfilerConfigForUpdateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProfilerConfigForUpdateJsonUnmarshaller();
        return instance;
    }
}
