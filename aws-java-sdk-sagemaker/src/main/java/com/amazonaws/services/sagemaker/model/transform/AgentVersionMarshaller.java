...
public class AgentVersionMarshaller {
    ...
    private static final MarshallingInfo<Long> AGENTCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("AgentCount").build();
    ...
    public void marshall(AgentVersion agentVersion, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(agentVersion.getAgentCount(), AGENTCOUNT_BINDING);
        } catch (Exception e) {
