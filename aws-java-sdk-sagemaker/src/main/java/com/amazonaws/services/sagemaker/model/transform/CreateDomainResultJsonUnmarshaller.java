        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainArn", targetDepth)) {
                    context.nextToken();
                    createDomainResult.setDomainArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Url", targetDepth)) {
                    context.nextToken();
                    createDomainResult.setUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
