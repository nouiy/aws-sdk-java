...
public class DeleteUserProfileRequestMarshaller {
    ...
    public void marshall(DeleteUserProfileRequest deleteUserProfileRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteUserProfileRequest.getDomainId(), DOMAINID_BINDING);
            protocolMarshaller.marshall(deleteUserProfileRequest.getUserProfileName(), USERPROFILENAME_BINDING);
        } catch (Exception e) {
