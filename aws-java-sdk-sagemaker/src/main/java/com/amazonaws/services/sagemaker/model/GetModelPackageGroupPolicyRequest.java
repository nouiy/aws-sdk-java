...
public class GetModelPackageGroupPolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the model group for which to get the resource policy.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetModelPackageGroupPolicyRequest == false)
            return false;
        GetModelPackageGroupPolicyRequest other = (GetModelPackageGroupPolicyRequest) obj;
    ...
    public GetModelPackageGroupPolicyRequest clone() {
        return (GetModelPackageGroupPolicyRequest) super.clone();
    }
