 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/ModelQualityBaselineConfig"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelQualityBaselineConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModelQualityBaselineConfig == false)
            return false;
    ...
    @Override
    public ModelQualityBaselineConfig clone() {
        try {
            return (ModelQualityBaselineConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.ModelQualityBaselineConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
