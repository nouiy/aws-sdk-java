...
public class DeleteContextResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteContextResult == false)
            return false;
        DeleteContextResult other = (DeleteContextResult) obj;
    ...
    public DeleteContextResult clone() {
        try {
            return (DeleteContextResult) super.clone();
