...
/**
 * DescribeNotebookInstanceRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeNotebookInstanceRequestMarshaller {
    ...
    private static final DescribeNotebookInstanceRequestMarshaller instance = new DescribeNotebookInstanceRequestMarshaller();

    public static DescribeNotebookInstanceRequestMarshaller getInstance() {
        return instance;
    }
