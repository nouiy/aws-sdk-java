...
/**
 * StopCompilationJobResult JSON Unmarshaller
 */
...
public class StopCompilationJobResultJsonUnmarshaller implements Unmarshaller<StopCompilationJobResult, JsonUnmarshallerContext> {
    ...
    public StopCompilationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopCompilationJobResult stopCompilationJobResult = new StopCompilationJobResult();
