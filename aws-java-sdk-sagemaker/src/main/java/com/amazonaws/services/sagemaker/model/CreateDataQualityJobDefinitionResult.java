...
public class CreateDataQualityJobDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateDataQualityJobDefinitionResult withJobDefinitionArn(String jobDefinitionArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDataQualityJobDefinitionResult == false)
            return false;
        CreateDataQualityJobDefinitionResult other = (CreateDataQualityJobDefinitionResult) obj;
    ...
    @Override
    public CreateDataQualityJobDefinitionResult clone() {
        try {
            return (CreateDataQualityJobDefinitionResult) super.clone();
