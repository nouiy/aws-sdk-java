...
public class CreateTrialComponentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTrialComponentResult == false)
            return false;
        CreateTrialComponentResult other = (CreateTrialComponentResult) obj;
    ...
    public CreateTrialComponentResult clone() {
        try {
            return (CreateTrialComponentResult) super.clone();
