...
public class DeleteModelBiasJobDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the model bias job definition to delete.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteModelBiasJobDefinitionRequest == false)
            return false;
        DeleteModelBiasJobDefinitionRequest other = (DeleteModelBiasJobDefinitionRequest) obj;
    ...
    @Override
    public DeleteModelBiasJobDefinitionRequest clone() {
        return (DeleteModelBiasJobDefinitionRequest) super.clone();
    }
