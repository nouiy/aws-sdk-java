...
/**
 * SearchExpression JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchExpressionJsonUnmarshaller implements Unmarshaller<SearchExpression, JsonUnmarshallerContext> {

    public SearchExpression unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("Operator", targetDepth)) {
                    context.nextToken();
                    searchExpression.setOperator(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static SearchExpressionJsonUnmarshaller instance;

    public static SearchExpressionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SearchExpressionJsonUnmarshaller();
        return instance;
    }
}
