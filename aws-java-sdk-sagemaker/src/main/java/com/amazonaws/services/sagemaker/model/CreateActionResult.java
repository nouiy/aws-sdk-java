...
public class CreateActionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateActionResult withActionArn(String actionArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateActionResult == false)
            return false;
        CreateActionResult other = (CreateActionResult) obj;
    ...
    @Override
    public CreateActionResult clone() {
        try {
            return (CreateActionResult) super.clone();
