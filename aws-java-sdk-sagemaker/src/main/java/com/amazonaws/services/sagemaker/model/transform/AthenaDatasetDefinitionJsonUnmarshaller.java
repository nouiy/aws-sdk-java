...
/**
 * AthenaDatasetDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AthenaDatasetDefinitionJsonUnmarshaller implements Unmarshaller<AthenaDatasetDefinition, JsonUnmarshallerContext> {

    public AthenaDatasetDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        AthenaDatasetDefinition athenaDatasetDefinition = new AthenaDatasetDefinition();
    ...
    private static AthenaDatasetDefinitionJsonUnmarshaller instance;

    public static AthenaDatasetDefinitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AthenaDatasetDefinitionJsonUnmarshaller();
        return instance;
    }
}
