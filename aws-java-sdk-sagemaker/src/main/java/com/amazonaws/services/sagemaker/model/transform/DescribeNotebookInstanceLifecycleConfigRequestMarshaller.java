...
@SdkInternalApi
public class DescribeNotebookInstanceLifecycleConfigRequestMarshaller {
    ...
    private static final DescribeNotebookInstanceLifecycleConfigRequestMarshaller instance = new DescribeNotebookInstanceLifecycleConfigRequestMarshaller();

    public static DescribeNotebookInstanceLifecycleConfigRequestMarshaller getInstance() {
        return instance;
    }
