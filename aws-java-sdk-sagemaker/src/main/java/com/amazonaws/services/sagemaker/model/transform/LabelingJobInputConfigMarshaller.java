...
/**
 * LabelingJobInputConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LabelingJobInputConfigMarshaller {
    ...
    private static final LabelingJobInputConfigMarshaller instance = new LabelingJobInputConfigMarshaller();

    public static LabelingJobInputConfigMarshaller getInstance() {
        return instance;
    }
