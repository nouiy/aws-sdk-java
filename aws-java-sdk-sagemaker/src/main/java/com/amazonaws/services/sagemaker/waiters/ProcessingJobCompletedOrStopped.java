...
class ProcessingJobCompletedOrStopped {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeProcessingJobResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("ProcessingJobStatus");
    ...
    static class IsStoppedMatcher extends WaiterAcceptor<DescribeProcessingJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeProcessingJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsValidationExceptionMatcher extends WaiterAcceptor<DescribeProcessingJobResult> {
        /**
