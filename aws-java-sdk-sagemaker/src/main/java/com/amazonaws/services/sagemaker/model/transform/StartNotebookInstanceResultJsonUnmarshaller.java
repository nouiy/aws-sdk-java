...
/**
 * StartNotebookInstanceResult JSON Unmarshaller
 */
...
public class StartNotebookInstanceResultJsonUnmarshaller implements Unmarshaller<StartNotebookInstanceResult, JsonUnmarshallerContext> {
    ...
    public StartNotebookInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartNotebookInstanceResult startNotebookInstanceResult = new StartNotebookInstanceResult();
