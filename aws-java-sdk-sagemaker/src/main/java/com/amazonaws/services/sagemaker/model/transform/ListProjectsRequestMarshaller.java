...
public class ListProjectsRequestMarshaller {
    ...
    public void marshall(ListProjectsRequest listProjectsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listProjectsRequest.getCreationTimeAfter(), CREATIONTIMEAFTER_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getCreationTimeBefore(), CREATIONTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listProjectsRequest.getNameContains(), NAMECONTAINS_BINDING);
