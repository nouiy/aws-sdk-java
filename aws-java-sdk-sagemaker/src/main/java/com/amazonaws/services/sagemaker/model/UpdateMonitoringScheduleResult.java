...
public class UpdateMonitoringScheduleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateMonitoringScheduleResult withMonitoringScheduleArn(String monitoringScheduleArn) {
    ...
    public String toString() {
        ...
        if (getMonitoringScheduleArn() != null)
            sb.append("MonitoringScheduleArn: ").append(getMonitoringScheduleArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMonitoringScheduleResult == false)
            return false;
        UpdateMonitoringScheduleResult other = (UpdateMonitoringScheduleResult) obj;
    ...
    @Override
    public UpdateMonitoringScheduleResult clone() {
        try {
            return (UpdateMonitoringScheduleResult) super.clone();
