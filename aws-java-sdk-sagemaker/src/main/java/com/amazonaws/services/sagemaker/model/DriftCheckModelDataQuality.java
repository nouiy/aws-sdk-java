 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DriftCheckModelDataQuality"
...
public class DriftCheckModelDataQuality implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DriftCheckModelDataQuality == false)
            return false;
        DriftCheckModelDataQuality other = (DriftCheckModelDataQuality) obj;
    ...
    public DriftCheckModelDataQuality clone() {
        try {
            return (DriftCheckModelDataQuality) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.DriftCheckModelDataQualityMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
