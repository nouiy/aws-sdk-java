 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/TensorBoardAppSettings" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TensorBoardAppSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TensorBoardAppSettings == false)
            return false;
        TensorBoardAppSettings other = (TensorBoardAppSettings) obj;
    ...
    @Override
    public TensorBoardAppSettings clone() {
        try {
            return (TensorBoardAppSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.TensorBoardAppSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
