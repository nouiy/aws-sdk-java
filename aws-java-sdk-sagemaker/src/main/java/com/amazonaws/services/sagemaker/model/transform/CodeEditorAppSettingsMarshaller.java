...
/**
 * CodeEditorAppSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CodeEditorAppSettingsMarshaller {
    ...
    private static final CodeEditorAppSettingsMarshaller instance = new CodeEditorAppSettingsMarshaller();

    public static CodeEditorAppSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CodeEditorAppSettings codeEditorAppSettings, ProtocolMarshaller protocolMarshaller) {
