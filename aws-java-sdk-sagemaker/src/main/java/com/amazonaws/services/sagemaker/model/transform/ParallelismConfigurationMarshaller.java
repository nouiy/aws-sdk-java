...
public class ParallelismConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Integer> MAXPARALLELEXECUTIONSTEPS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MaxParallelExecutionSteps").build();
    ...
    public void marshall(ParallelismConfiguration parallelismConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(parallelismConfiguration.getMaxParallelExecutionSteps(), MAXPARALLELEXECUTIONSTEPS_BINDING);
        } catch (Exception e) {
