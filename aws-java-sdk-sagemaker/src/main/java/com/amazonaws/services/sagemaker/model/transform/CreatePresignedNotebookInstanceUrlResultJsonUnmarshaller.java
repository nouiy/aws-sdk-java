...
/**
 * CreatePresignedNotebookInstanceUrlResult JSON Unmarshaller
 */
...
public class CreatePresignedNotebookInstanceUrlResultJsonUnmarshaller implements
    ...
    public CreatePresignedNotebookInstanceUrlResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AuthorizedUrl", targetDepth)) {
                    context.nextToken();
                    createPresignedNotebookInstanceUrlResult.setAuthorizedUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
