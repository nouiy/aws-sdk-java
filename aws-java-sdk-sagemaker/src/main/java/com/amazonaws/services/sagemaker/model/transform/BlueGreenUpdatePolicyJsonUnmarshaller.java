...
/**
 * BlueGreenUpdatePolicy JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BlueGreenUpdatePolicyJsonUnmarshaller implements Unmarshaller<BlueGreenUpdatePolicy, JsonUnmarshallerContext> {

    public BlueGreenUpdatePolicy unmarshall(JsonUnmarshallerContext context) throws Exception {
        BlueGreenUpdatePolicy blueGreenUpdatePolicy = new BlueGreenUpdatePolicy();
    ...
    private static BlueGreenUpdatePolicyJsonUnmarshaller instance;

    public static BlueGreenUpdatePolicyJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BlueGreenUpdatePolicyJsonUnmarshaller();
        return instance;
    }
}
