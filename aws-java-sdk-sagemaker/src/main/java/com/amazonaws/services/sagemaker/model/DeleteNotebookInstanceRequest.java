...
public class DeleteNotebookInstanceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the Amazon SageMaker notebook instance to delete.
     */
    ...
    @Override
    public DeleteNotebookInstanceRequest clone() {
        return (DeleteNotebookInstanceRequest) super.clone();
    }
