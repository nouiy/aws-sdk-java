...
public class ListAliasesRequestMarshaller {
    ...
    public void marshall(ListAliasesRequest listAliasesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listAliasesRequest.getImageName(), IMAGENAME_BINDING);
            protocolMarshaller.marshall(listAliasesRequest.getAlias(), ALIAS_BINDING);
            protocolMarshaller.marshall(listAliasesRequest.getVersion(), VERSION_BINDING);
