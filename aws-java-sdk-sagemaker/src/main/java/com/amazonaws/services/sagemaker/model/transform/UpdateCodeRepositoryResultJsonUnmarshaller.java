...
/**
 * UpdateCodeRepositoryResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateCodeRepositoryResultJsonUnmarshaller implements Unmarshaller<UpdateCodeRepositoryResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CodeRepositoryArn", targetDepth)) {
                    context.nextToken();
                    updateCodeRepositoryResult.setCodeRepositoryArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
