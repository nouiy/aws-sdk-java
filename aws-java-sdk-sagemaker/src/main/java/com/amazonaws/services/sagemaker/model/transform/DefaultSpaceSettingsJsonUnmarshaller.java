...
/**
 * DefaultSpaceSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DefaultSpaceSettingsJsonUnmarshaller implements Unmarshaller<DefaultSpaceSettings, JsonUnmarshallerContext> {

    public DefaultSpaceSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        DefaultSpaceSettings defaultSpaceSettings = new DefaultSpaceSettings();
    ...
    private static DefaultSpaceSettingsJsonUnmarshaller instance;

    public static DefaultSpaceSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DefaultSpaceSettingsJsonUnmarshaller();
        return instance;
    }
}
