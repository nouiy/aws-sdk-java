...
public class DescribeModelPackageGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeModelPackageGroupRequest withModelPackageGroupName(String modelPackageGroupName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeModelPackageGroupRequest == false)
            return false;
        DescribeModelPackageGroupRequest other = (DescribeModelPackageGroupRequest) obj;
    ...
    @Override
    public DescribeModelPackageGroupRequest clone() {
        return (DescribeModelPackageGroupRequest) super.clone();
    }
