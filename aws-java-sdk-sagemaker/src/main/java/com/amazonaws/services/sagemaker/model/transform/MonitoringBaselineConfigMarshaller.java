...
/**
 * MonitoringBaselineConfigMarshaller
 */
...
public class MonitoringBaselineConfigMarshaller {
    ...
    private static final MonitoringBaselineConfigMarshaller instance = new MonitoringBaselineConfigMarshaller();

    public static MonitoringBaselineConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MonitoringBaselineConfig monitoringBaselineConfig, ProtocolMarshaller protocolMarshaller) {

        if (monitoringBaselineConfig == null) {
