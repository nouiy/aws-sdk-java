...
/**
 * ListSubscribedWorkteamsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListSubscribedWorkteamsRequestMarshaller {
    ...
    private static final ListSubscribedWorkteamsRequestMarshaller instance = new ListSubscribedWorkteamsRequestMarshaller();

    public static ListSubscribedWorkteamsRequestMarshaller getInstance() {
        return instance;
    }
