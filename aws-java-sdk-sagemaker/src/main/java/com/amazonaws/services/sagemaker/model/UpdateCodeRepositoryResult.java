...
public class UpdateCodeRepositoryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCodeRepositoryResult == false)
            return false;
        UpdateCodeRepositoryResult other = (UpdateCodeRepositoryResult) obj;
    ...
    public UpdateCodeRepositoryResult clone() {
        try {
            return (UpdateCodeRepositoryResult) super.clone();
