 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/ModelExplainabilityJobInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModelExplainabilityJobInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModelExplainabilityJobInput == false)
            return false;
        ModelExplainabilityJobInput other = (ModelExplainabilityJobInput) obj;
    ...
    public ModelExplainabilityJobInput clone() {
        try {
            return (ModelExplainabilityJobInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.ModelExplainabilityJobInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
