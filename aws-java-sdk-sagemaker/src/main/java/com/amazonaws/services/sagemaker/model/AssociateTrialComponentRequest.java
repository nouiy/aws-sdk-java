...
public class AssociateTrialComponentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the component to associated with the trial.
     */
     ...
     * </p>
     * 
     * @return The name of the trial to associate with.
     */
    ...
    public AssociateTrialComponentRequest clone() {
        return (AssociateTrialComponentRequest) super.clone();
    }
