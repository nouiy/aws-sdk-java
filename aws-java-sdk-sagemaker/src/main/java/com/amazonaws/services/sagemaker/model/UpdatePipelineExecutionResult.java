...
public class UpdatePipelineExecutionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the updated pipeline execution.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePipelineExecutionResult == false)
            return false;
        UpdatePipelineExecutionResult other = (UpdatePipelineExecutionResult) obj;
    ...
    public UpdatePipelineExecutionResult clone() {
        try {
            return (UpdatePipelineExecutionResult) super.clone();
