...
class ImageVersionCreated {
    ...
    static class IsCREATEDMatcher extends WaiterAcceptor<DescribeImageVersionResult> {
    ...
    static class IsCREATE_FAILEDMatcher extends WaiterAcceptor<DescribeImageVersionResult> {
        private static final JsonNode expectedResult;
