...
public class EdgeMarshaller {
    ...
    public void marshall(Edge edge, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(edge.getSourceArn(), SOURCEARN_BINDING);
            protocolMarshaller.marshall(edge.getDestinationArn(), DESTINATIONARN_BINDING);
            protocolMarshaller.marshall(edge.getAssociationType(), ASSOCIATIONTYPE_BINDING);
        } catch (Exception e) {
