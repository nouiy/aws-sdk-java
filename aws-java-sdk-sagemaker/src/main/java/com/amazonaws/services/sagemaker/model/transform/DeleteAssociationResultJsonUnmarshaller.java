...
public class DeleteAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SourceArn", targetDepth)) {
                    context.nextToken();
                    deleteAssociationResult.setSourceArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("DestinationArn", targetDepth)) {
                    context.nextToken();
                    deleteAssociationResult.setDestinationArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
