...
public class DescribeWorkforceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeWorkforceResult clone() {
        try {
            return (DescribeWorkforceResult) super.clone();
