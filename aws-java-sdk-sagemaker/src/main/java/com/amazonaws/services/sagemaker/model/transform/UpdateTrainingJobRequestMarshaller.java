...
public class UpdateTrainingJobRequestMarshaller {
    ...
    public static UpdateTrainingJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateTrainingJobRequest updateTrainingJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateTrainingJobRequest.getTrainingJobName(), TRAININGJOBNAME_BINDING);
