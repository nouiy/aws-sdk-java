...
/**
 * PropertyNameSuggestionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PropertyNameSuggestionMarshaller {
    ...
    private static final PropertyNameSuggestionMarshaller instance = new PropertyNameSuggestionMarshaller();

    public static PropertyNameSuggestionMarshaller getInstance() {
        return instance;
    }
