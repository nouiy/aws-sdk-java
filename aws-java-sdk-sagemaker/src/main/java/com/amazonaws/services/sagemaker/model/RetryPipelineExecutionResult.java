...
public class RetryPipelineExecutionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RetryPipelineExecutionResult == false)
            return false;
        RetryPipelineExecutionResult other = (RetryPipelineExecutionResult) obj;
    ...
    public RetryPipelineExecutionResult clone() {
        try {
            return (RetryPipelineExecutionResult) super.clone();
