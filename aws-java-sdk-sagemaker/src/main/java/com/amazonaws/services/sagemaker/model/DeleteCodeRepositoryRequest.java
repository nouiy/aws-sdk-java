...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteCodeRepository" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteCodeRepositoryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteCodeRepositoryRequest withCodeRepositoryName(String codeRepositoryName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteCodeRepositoryRequest == false)
            return false;
        DeleteCodeRepositoryRequest other = (DeleteCodeRepositoryRequest) obj;
    ...
    @Override
    public DeleteCodeRepositoryRequest clone() {
        return (DeleteCodeRepositoryRequest) super.clone();
    }
