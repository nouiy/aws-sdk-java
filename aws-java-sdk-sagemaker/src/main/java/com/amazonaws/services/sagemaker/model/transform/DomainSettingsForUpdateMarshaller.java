...
/**
 * DomainSettingsForUpdateMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DomainSettingsForUpdateMarshaller {

    private static final MarshallingInfo<StructuredPojo> RSTUDIOSERVERPRODOMAINSETTINGSFORUPDATE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static DomainSettingsForUpdateMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DomainSettingsForUpdate domainSettingsForUpdate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(domainSettingsForUpdate.getDockerSettings(), DOCKERSETTINGS_BINDING);
        } catch (Exception e) {
