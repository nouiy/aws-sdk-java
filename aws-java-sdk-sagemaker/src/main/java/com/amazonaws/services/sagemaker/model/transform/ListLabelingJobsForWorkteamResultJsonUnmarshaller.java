...
/**
 * ListLabelingJobsForWorkteamResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListLabelingJobsForWorkteamResultJsonUnmarshaller implements Unmarshaller<ListLabelingJobsForWorkteamResult, JsonUnmarshallerContext> {

    public ListLabelingJobsForWorkteamResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listLabelingJobsForWorkteamResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
