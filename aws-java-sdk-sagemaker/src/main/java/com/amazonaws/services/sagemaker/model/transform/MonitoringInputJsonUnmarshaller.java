...
/**
 * MonitoringInput JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MonitoringInputJsonUnmarshaller implements Unmarshaller<MonitoringInput, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EndpointInput", targetDepth)) {
                    context.nextToken();
                    monitoringInput.setEndpointInput(EndpointInputJsonUnmarshaller.getInstance().unmarshall(context));
                }
