...
public class SendPipelineExecutionStepFailureResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public SendPipelineExecutionStepFailureResult withPipelineExecutionArn(String pipelineExecutionArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SendPipelineExecutionStepFailureResult == false)
            return false;
        SendPipelineExecutionStepFailureResult other = (SendPipelineExecutionStepFailureResult) obj;
    ...
    @Override
    public SendPipelineExecutionStepFailureResult clone() {
        try {
            return (SendPipelineExecutionStepFailureResult) super.clone();
