...
public class DescribeAppImageConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeAppImageConfigResult withCreationTime(java.util.Date creationTime) {
    ...
    public DescribeAppImageConfigResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAppImageConfigResult == false)
            return false;
        DescribeAppImageConfigResult other = (DescribeAppImageConfigResult) obj;
    ...
    public DescribeAppImageConfigResult clone() {
        try {
            return (DescribeAppImageConfigResult) super.clone();
