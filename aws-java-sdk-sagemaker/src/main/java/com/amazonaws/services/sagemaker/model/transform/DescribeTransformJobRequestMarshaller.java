...
/**
 * DescribeTransformJobRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeTransformJobRequestMarshaller {
    ...
    private static final DescribeTransformJobRequestMarshaller instance = new DescribeTransformJobRequestMarshaller();

    public static DescribeTransformJobRequestMarshaller getInstance() {
        return instance;
    }
