...
public class UserContextMarshaller {
    ...
    private static final MarshallingInfo<String> USERPROFILEARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UserProfileArn").build();
    ...
    public void marshall(UserContext userContext, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(userContext.getUserProfileArn(), USERPROFILEARN_BINDING);
            protocolMarshaller.marshall(userContext.getUserProfileName(), USERPROFILENAME_BINDING);
            protocolMarshaller.marshall(userContext.getDomainId(), DOMAINID_BINDING);
        } catch (Exception e) {
