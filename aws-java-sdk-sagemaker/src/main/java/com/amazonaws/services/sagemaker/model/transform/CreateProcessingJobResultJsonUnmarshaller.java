...
/**
 * CreateProcessingJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateProcessingJobResultJsonUnmarshaller implements Unmarshaller<CreateProcessingJobResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProcessingJobArn", targetDepth)) {
                    context.nextToken();
                    createProcessingJobResult.setProcessingJobArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
