...
public class StopPipelineExecutionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopPipelineExecutionResult withPipelineExecutionArn(String pipelineExecutionArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopPipelineExecutionResult == false)
            return false;
        StopPipelineExecutionResult other = (StopPipelineExecutionResult) obj;
    ...
    public StopPipelineExecutionResult clone() {
        try {
            return (StopPipelineExecutionResult) super.clone();
