...
public class ProjectSummaryMarshaller {
    ...
    public void marshall(ProjectSummary projectSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(projectSummary.getProjectDescription(), PROJECTDESCRIPTION_BINDING);
            ...
            protocolMarshaller.marshall(projectSummary.getCreationTime(), CREATIONTIME_BINDING);
