...
/**
 * DeleteAppImageConfigResult JSON Unmarshaller
 */
...
public class DeleteAppImageConfigResultJsonUnmarshaller implements Unmarshaller<DeleteAppImageConfigResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppImageConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppImageConfigResult deleteAppImageConfigResult = new DeleteAppImageConfigResult();

        return deleteAppImageConfigResult;
    }
