...
public class UpdateProjectRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> SERVICECATALOGPROVISIONINGUPDATEDETAILS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ServiceCatalogProvisioningUpdateDetails").build();
    ...
    public void marshall(UpdateProjectRequest updateProjectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateProjectRequest.getServiceCatalogProvisioningUpdateDetails(), SERVICECATALOGPROVISIONINGUPDATEDETAILS_BINDING);
