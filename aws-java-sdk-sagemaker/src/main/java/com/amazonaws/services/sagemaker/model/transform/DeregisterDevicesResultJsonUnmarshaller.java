...
/**
 * DeregisterDevicesResult JSON Unmarshaller
 */
...
public class DeregisterDevicesResultJsonUnmarshaller implements Unmarshaller<DeregisterDevicesResult, JsonUnmarshallerContext> {
    ...
    public DeregisterDevicesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterDevicesResult deregisterDevicesResult = new DeregisterDevicesResult();

        return deregisterDevicesResult;
    }
