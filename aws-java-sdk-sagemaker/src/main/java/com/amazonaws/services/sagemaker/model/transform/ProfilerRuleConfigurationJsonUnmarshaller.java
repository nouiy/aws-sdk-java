...
/**
 * ProfilerRuleConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProfilerRuleConfigurationJsonUnmarshaller implements Unmarshaller<ProfilerRuleConfiguration, JsonUnmarshallerContext> {

    public ProfilerRuleConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProfilerRuleConfiguration profilerRuleConfiguration = new ProfilerRuleConfiguration();
    ...
    private static ProfilerRuleConfigurationJsonUnmarshaller instance;

    public static ProfilerRuleConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProfilerRuleConfigurationJsonUnmarshaller();
        return instance;
    }
}
