...
@SdkInternalApi
public class StopLabelingJobRequestMarshaller {
    ...
    private static final StopLabelingJobRequestMarshaller instance = new StopLabelingJobRequestMarshaller();

    public static StopLabelingJobRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(StopLabelingJobRequest stopLabelingJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(stopLabelingJobRequest.getLabelingJobName(), LABELINGJOBNAME_BINDING);
        } catch (Exception e) {
