...
public class ListProcessingJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A string in the processing job name. This filter returns only processing jobs whose name contains the specified
     * string.
     * </p>
     */
    ...
    /**
     * <p>
     * If the result of the previous <code>ListProcessingJobs</code> request was truncated, the response includes a
     * <code>NextToken</code>. To retrieve the next set of processing jobs, use the token in the next request.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A filter that returns only processing jobs created after the specified time.
     */
    ...
    public ListProcessingJobsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
    ...
    public ListProcessingJobsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
     ...
     * </p>
     * 
     * @return A filter that returns only processing jobs modified after the specified time.
     */
    ...
    public ListProcessingJobsRequest withLastModifiedTimeAfter(java.util.Date lastModifiedTimeAfter) {
     ...
     * </p>
     * 
     * @return A filter that returns only processing jobs modified before the specified time.
     */
    ...
    public ListProcessingJobsRequest withLastModifiedTimeBefore(java.util.Date lastModifiedTimeBefore) {
     ...
     * </p>
     * 
     * @return A string in the processing job name. This filter returns only processing jobs whose name contains the
     *         specified string.
     */
     ...
     * </p>
     * 
     * @return A filter that retrieves only processing jobs with a specific status.
     * @see ProcessingJobStatus
     */
     ...
     * 
     * @param nextToken
     *        If the result of the previous <code>ListProcessingJobs</code> request was truncated, the response includes
     *        a <code>NextToken</code>. To retrieve the next set of processing jobs, use the token in the next request.
     */
     ...
     * </p>
     * 
     * @return If the result of the previous <code>ListProcessingJobs</code> request was truncated, the response
     *         includes a <code>NextToken</code>. To retrieve the next set of processing jobs, use the token in the next
     *         request.
     */
     ...
     * </p>
     * 
     * @return The maximum number of processing jobs to return in the response.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListProcessingJobsRequest == false)
            return false;
        ListProcessingJobsRequest other = (ListProcessingJobsRequest) obj;
