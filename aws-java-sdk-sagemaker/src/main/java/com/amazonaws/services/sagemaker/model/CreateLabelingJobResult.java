...
public class CreateLabelingJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the labeling job. You use this ARN to identify the labeling job.
     */
    ...
    public CreateLabelingJobResult clone() {
        try {
            return (CreateLabelingJobResult) super.clone();
