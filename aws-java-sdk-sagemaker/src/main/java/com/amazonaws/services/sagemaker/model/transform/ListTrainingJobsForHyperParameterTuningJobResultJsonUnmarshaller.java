...
/**
 * ListTrainingJobsForHyperParameterTuningJobResult JSON Unmarshaller
 */
...
public class ListTrainingJobsForHyperParameterTuningJobResultJsonUnmarshaller implements
    ...
    public ListTrainingJobsForHyperParameterTuningJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listTrainingJobsForHyperParameterTuningJobResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
