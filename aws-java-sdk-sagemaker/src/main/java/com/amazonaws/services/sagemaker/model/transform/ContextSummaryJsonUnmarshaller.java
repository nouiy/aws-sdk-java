...
/**
 * ContextSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContextSummaryJsonUnmarshaller implements Unmarshaller<ContextSummary, JsonUnmarshallerContext> {

    public ContextSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ContextSummaryJsonUnmarshaller instance;

    public static ContextSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ContextSummaryJsonUnmarshaller();
        return instance;
    }
}
