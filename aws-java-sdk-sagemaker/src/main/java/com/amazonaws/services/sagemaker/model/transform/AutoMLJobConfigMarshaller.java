...
/**
 * AutoMLJobConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AutoMLJobConfigMarshaller {
    ...
    public static AutoMLJobConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AutoMLJobConfig autoMLJobConfig, ProtocolMarshaller protocolMarshaller) {

        if (autoMLJobConfig == null) {
