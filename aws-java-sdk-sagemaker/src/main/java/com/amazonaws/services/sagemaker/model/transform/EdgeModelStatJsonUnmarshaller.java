...
/**
 * EdgeModelStat JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EdgeModelStatJsonUnmarshaller implements Unmarshaller<EdgeModelStat, JsonUnmarshallerContext> {

    public EdgeModelStat unmarshall(JsonUnmarshallerContext context) throws Exception {
        EdgeModelStat edgeModelStat = new EdgeModelStat();
    ...
    private static EdgeModelStatJsonUnmarshaller instance;

    public static EdgeModelStatJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new EdgeModelStatJsonUnmarshaller();
        return instance;
    }
}
