...
/**
 * AppImageConfigDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AppImageConfigDetailsJsonUnmarshaller implements Unmarshaller<AppImageConfigDetails, JsonUnmarshallerContext> {

    public AppImageConfigDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        AppImageConfigDetails appImageConfigDetails = new AppImageConfigDetails();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("JupyterLabAppImageConfig", targetDepth)) {
                    context.nextToken();
                    appImageConfigDetails.setJupyterLabAppImageConfig(JupyterLabAppImageConfigJsonUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static AppImageConfigDetailsJsonUnmarshaller instance;

    public static AppImageConfigDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AppImageConfigDetailsJsonUnmarshaller();
        return instance;
    }
}
