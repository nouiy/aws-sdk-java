...
public class UpdateTrialResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTrialResult == false)
            return false;
        UpdateTrialResult other = (UpdateTrialResult) obj;
    ...
    public UpdateTrialResult clone() {
        try {
            return (UpdateTrialResult) super.clone();
