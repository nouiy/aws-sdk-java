...
public class CreateExperimentRequestMarshaller {
    ...
    public void marshall(CreateExperimentRequest createExperimentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createExperimentRequest.getExperimentName(), EXPERIMENTNAME_BINDING);
            protocolMarshaller.marshall(createExperimentRequest.getDisplayName(), DISPLAYNAME_BINDING);
