...
class ImageDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeImageResult> {
        /**
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<DescribeImageResult> {
