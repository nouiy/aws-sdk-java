...
public class DescribeWorkteamResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeWorkteamResult withWorkteam(Workteam workteam) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeWorkteamResult == false)
            return false;
        DescribeWorkteamResult other = (DescribeWorkteamResult) obj;
    ...
    @Override
    public DescribeWorkteamResult clone() {
        try {
            return (DescribeWorkteamResult) super.clone();
