...
public class DescribeWorkteamRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the work team to return a description of.
     */
    ...
    @Override
    public DescribeWorkteamRequest clone() {
