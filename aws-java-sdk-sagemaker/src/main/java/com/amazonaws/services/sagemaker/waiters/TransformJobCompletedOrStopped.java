...
class TransformJobCompletedOrStopped {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeTransformJobResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("TransformJobStatus");
         ...
         */
        @Override
        public boolean matches(DescribeTransformJobResult result) {
    ...
    static class IsStoppedMatcher extends WaiterAcceptor<DescribeTransformJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeTransformJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsValidationExceptionMatcher extends WaiterAcceptor<DescribeTransformJobResult> {
        /**
