...
class ImageVersionDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<DescribeImageVersionResult> {
        /**
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<DescribeImageVersionResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathField("ImageVersionStatus");
         ...
         */
        @Override
        public boolean matches(DescribeImageVersionResult result) {
    ...
    static class IsValidationExceptionMatcher extends WaiterAcceptor<DescribeImageVersionResult> {
        /**
         * Takes the response exception and determines whether this exception matches the expected exception, by
         * comparing the respective error codes.
         * 
