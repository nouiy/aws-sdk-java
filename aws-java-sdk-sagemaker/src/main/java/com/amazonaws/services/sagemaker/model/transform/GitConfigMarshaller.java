...
@SdkInternalApi
public class GitConfigMarshaller {
    ...
    private static final GitConfigMarshaller instance = new GitConfigMarshaller();

    public static GitConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GitConfig gitConfig, ProtocolMarshaller protocolMarshaller) {
