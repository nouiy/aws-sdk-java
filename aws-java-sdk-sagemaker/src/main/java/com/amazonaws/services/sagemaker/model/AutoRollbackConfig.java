...
public class AutoRollbackConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public AutoRollbackConfig withAlarms(java.util.Collection<Alarm> alarms) {
        setAlarms(alarms);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutoRollbackConfig == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.AutoRollbackConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
