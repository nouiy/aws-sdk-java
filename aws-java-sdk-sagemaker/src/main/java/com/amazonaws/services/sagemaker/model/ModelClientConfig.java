 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/ModelClientConfig" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ModelClientConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public ModelClientConfig withInvocationsTimeoutInSeconds(Integer invocationsTimeoutInSeconds) {
        setInvocationsTimeoutInSeconds(invocationsTimeoutInSeconds);
        return this;
    }
    ...
    public ModelClientConfig withInvocationsMaxRetries(Integer invocationsMaxRetries) {
        setInvocationsMaxRetries(invocationsMaxRetries);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getInvocationsTimeoutInSeconds() != null)
            sb.append("InvocationsTimeoutInSeconds: ").append(getInvocationsTimeoutInSeconds()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getInvocationsTimeoutInSeconds() == null ^ this.getInvocationsTimeoutInSeconds() == null)
            return false;
        if (other.getInvocationsTimeoutInSeconds() != null && other.getInvocationsTimeoutInSeconds().equals(this.getInvocationsTimeoutInSeconds()) == false)
            return false;
        if (other.getInvocationsMaxRetries() == null ^ this.getInvocationsMaxRetries() == null)
            return false;
        if (other.getInvocationsMaxRetries() != null && other.getInvocationsMaxRetries().equals(this.getInvocationsMaxRetries()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getInvocationsTimeoutInSeconds() == null) ? 0 : getInvocationsTimeoutInSeconds().hashCode());
        hashCode = prime * hashCode + ((getInvocationsMaxRetries() == null) ? 0 : getInvocationsMaxRetries().hashCode());
        return hashCode;
    }

    @Override
    public ModelClientConfig clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.ModelClientConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
