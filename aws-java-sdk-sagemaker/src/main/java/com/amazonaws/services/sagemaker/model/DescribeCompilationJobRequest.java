...
public class DescribeCompilationJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the model compilation job that you want information about.
     */
    ...
    @Override
    public DescribeCompilationJobRequest clone() {
        return (DescribeCompilationJobRequest) super.clone();
    }
