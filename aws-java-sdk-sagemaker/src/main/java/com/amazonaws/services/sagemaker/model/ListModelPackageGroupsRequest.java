...
public class ListModelPackageGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * If the result of the previous <code>ListModelPackageGroups</code> request was truncated, the response includes a
     * <code>NextToken</code>. To retrieve the next set of model groups, use the token in the next request.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A filter that returns only model groups created after the specified time.
     */
    ...
    public ListModelPackageGroupsRequest withCreationTimeAfter(java.util.Date creationTimeAfter) {
     ...
     * </p>
     * 
     * @return A filter that returns only model groups created before the specified time.
     */
    ...
    public ListModelPackageGroupsRequest withCreationTimeBefore(java.util.Date creationTimeBefore) {
     ...
     * </p>
     * 
     * @return A string in the model group name. This filter returns only model groups whose name contains the specified
     *         string.
     */
     ...
     * 
     * @param nextToken
     *        If the result of the previous <code>ListModelPackageGroups</code> request was truncated, the response
     *        includes a <code>NextToken</code>. To retrieve the next set of model groups, use the token in the next
     *        request.
     */
     ...
     * </p>
     * 
     * @return If the result of the previous <code>ListModelPackageGroups</code> request was truncated, the response
     *         includes a <code>NextToken</code>. To retrieve the next set of model groups, use the token in the next
     *         request.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListModelPackageGroupsRequest == false)
            return false;
        ListModelPackageGroupsRequest other = (ListModelPackageGroupsRequest) obj;
    ...
    public ListModelPackageGroupsRequest clone() {
        return (ListModelPackageGroupsRequest) super.clone();
    }
