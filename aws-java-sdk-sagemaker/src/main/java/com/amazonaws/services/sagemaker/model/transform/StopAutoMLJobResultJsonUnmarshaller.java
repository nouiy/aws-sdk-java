...
/**
 * StopAutoMLJobResult JSON Unmarshaller
 */
...
public class StopAutoMLJobResultJsonUnmarshaller implements Unmarshaller<StopAutoMLJobResult, JsonUnmarshallerContext> {
    ...
    public StopAutoMLJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopAutoMLJobResult stopAutoMLJobResult = new StopAutoMLJobResult();

        return stopAutoMLJobResult;
    }
