...
public class PolicyDetailsMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> ACTOR_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("actor").build();
    ...
    public void marshall(PolicyDetails policyDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(policyDetails.getAction(), ACTION_BINDING);
            protocolMarshaller.marshall(policyDetails.getActor(), ACTOR_BINDING);
        } catch (Exception e) {
