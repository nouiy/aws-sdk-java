...
public class DescribeClassificationJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeClassificationJobRequest clone() {
        return (DescribeClassificationJobRequest) super.clone();
    }
