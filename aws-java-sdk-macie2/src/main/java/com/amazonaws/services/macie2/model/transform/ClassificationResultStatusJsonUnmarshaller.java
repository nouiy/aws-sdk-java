...
/**
 * ClassificationResultStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClassificationResultStatusJsonUnmarshaller implements Unmarshaller<ClassificationResultStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("code", targetDepth)) {
                    context.nextToken();
                    classificationResultStatus.setCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("reason", targetDepth)) {
                    context.nextToken();
                    classificationResultStatus.setReason(context.getUnmarshaller(String.class).unmarshall(context));
                }
