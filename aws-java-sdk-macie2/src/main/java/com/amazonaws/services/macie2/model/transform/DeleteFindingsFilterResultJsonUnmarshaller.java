...
/**
 * DeleteFindingsFilterResult JSON Unmarshaller
 */
...
public class DeleteFindingsFilterResultJsonUnmarshaller implements Unmarshaller<DeleteFindingsFilterResult, JsonUnmarshallerContext> {
    ...
    public DeleteFindingsFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFindingsFilterResult deleteFindingsFilterResult = new DeleteFindingsFilterResult();
