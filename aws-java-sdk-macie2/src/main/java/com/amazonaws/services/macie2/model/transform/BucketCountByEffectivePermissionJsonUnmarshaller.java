...
/**
 * BucketCountByEffectivePermission JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BucketCountByEffectivePermissionJsonUnmarshaller implements Unmarshaller<BucketCountByEffectivePermission, JsonUnmarshallerContext> {

    public BucketCountByEffectivePermission unmarshall(JsonUnmarshallerContext context) throws Exception {
        BucketCountByEffectivePermission bucketCountByEffectivePermission = new BucketCountByEffectivePermission();
    ...
    private static BucketCountByEffectivePermissionJsonUnmarshaller instance;

    public static BucketCountByEffectivePermissionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BucketCountByEffectivePermissionJsonUnmarshaller();
        return instance;
    }
}
