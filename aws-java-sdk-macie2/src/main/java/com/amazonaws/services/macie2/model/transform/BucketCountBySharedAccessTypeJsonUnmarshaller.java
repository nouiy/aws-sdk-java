...
/**
 * BucketCountBySharedAccessType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BucketCountBySharedAccessTypeJsonUnmarshaller implements Unmarshaller<BucketCountBySharedAccessType, JsonUnmarshallerContext> {

    public BucketCountBySharedAccessType unmarshall(JsonUnmarshallerContext context) throws Exception {
