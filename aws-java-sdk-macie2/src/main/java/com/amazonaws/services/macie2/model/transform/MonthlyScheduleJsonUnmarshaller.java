...
/**
 * MonthlySchedule JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MonthlyScheduleJsonUnmarshaller implements Unmarshaller<MonthlySchedule, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("dayOfMonth", targetDepth)) {
                    context.nextToken();
                    monthlySchedule.setDayOfMonth(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
