...
public class SearchResourcesRequestMarshaller {
    ...
    public void marshall(SearchResourcesRequest searchResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchResourcesRequest.getBucketCriteria(), BUCKETCRITERIA_BINDING);
            ...
            protocolMarshaller.marshall(searchResourcesRequest.getSortCriteria(), SORTCRITERIA_BINDING);
        } catch (Exception e) {
