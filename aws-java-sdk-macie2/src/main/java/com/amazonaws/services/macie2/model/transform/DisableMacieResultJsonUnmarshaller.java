...
/**
 * DisableMacieResult JSON Unmarshaller
 */
...
public class DisableMacieResultJsonUnmarshaller implements Unmarshaller<DisableMacieResult, JsonUnmarshallerContext> {
    ...
    public DisableMacieResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisableMacieResult disableMacieResult = new DisableMacieResult();
