...
public class SearchResourcesSortCriteria implements Serializable, Cloneable, StructuredPojo {
     ...
     * @param attributeName
     *        The property to sort the results by.
     * @see SearchResourcesSortAttributeName
     */
    ...
    public SearchResourcesSortCriteria withAttributeName(String attributeName) {
    ...
    public SearchResourcesSortCriteria withAttributeName(SearchResourcesSortAttributeName attributeName) {
    ...
    public SearchResourcesSortCriteria withOrderBy(String orderBy) {
        setOrderBy(orderBy);
        return this;
    }
    ...
    public SearchResourcesSortCriteria withOrderBy(OrderBy orderBy) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchResourcesSortCriteria == false)
            return false;
        SearchResourcesSortCriteria other = (SearchResourcesSortCriteria) obj;
    ...
    @Override
    public SearchResourcesSortCriteria clone() {
        try {
            return (SearchResourcesSortCriteria) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.macie2.model.transform.SearchResourcesSortCriteriaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
