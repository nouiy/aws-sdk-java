...
/**
 * <p>
 * The property to use in a condition that determines whether an S3 bucket is included or excluded from a classification
...
public enum SimpleCriterionKeyForJob {
     ...
     * @param value
     *        real value
     * @return SimpleCriterionKeyForJob corresponding to the value
     *
    ...
    public static SimpleCriterionKeyForJob fromValue(String value) {
        ...
        for (SimpleCriterionKeyForJob enumEntry : SimpleCriterionKeyForJob.values()) {
