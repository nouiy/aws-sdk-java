...
public class SearchResourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SearchResourcesBucketCriteria getBucketCriteria() {
    ...
    public void setSortCriteria(SearchResourcesSortCriteria sortCriteria) {
    ...
    public SearchResourcesSortCriteria getSortCriteria() {
