...
public class PutClassificationExportConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutClassificationExportConfigurationResult == false)
            return false;
        PutClassificationExportConfigurationResult other = (PutClassificationExportConfigurationResult) obj;
    ...
    public PutClassificationExportConfigurationResult clone() {
        try {
            return (PutClassificationExportConfigurationResult) super.clone();
