...
public class SeverityLevelMarshaller {
    ...
    private static final MarshallingInfo<Long> OCCURRENCESTHRESHOLD_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("occurrencesThreshold").build();
    ...
    public void marshall(SeverityLevel severityLevel, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(severityLevel.getOccurrencesThreshold(), OCCURRENCESTHRESHOLD_BINDING);
            protocolMarshaller.marshall(severityLevel.getSeverity(), SEVERITY_BINDING);
        } catch (Exception e) {
