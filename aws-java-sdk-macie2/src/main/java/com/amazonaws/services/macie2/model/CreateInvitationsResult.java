...
public class CreateInvitationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     *        An array of objects, one for each account whose invitation hasn't been processed. Each object identifies
     *        the account and explains why the invitation hasn't been processed for the account.
     */
    ...
    public CreateInvitationsResult withUnprocessedAccounts(UnprocessedAccount... unprocessedAccounts) {
    ...
    public CreateInvitationsResult withUnprocessedAccounts(java.util.Collection<UnprocessedAccount> unprocessedAccounts) {
    ...
    @Override
    public CreateInvitationsResult clone() {
        try {
            return (CreateInvitationsResult) super.clone();
