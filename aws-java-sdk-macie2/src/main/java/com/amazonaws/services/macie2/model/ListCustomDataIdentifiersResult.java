...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/macie2-2020-01-01/ListCustomDataIdentifiers" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCustomDataIdentifiersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of objects, one for each custom data identifier.
     */
    ...
    public ListCustomDataIdentifiersResult withItems(CustomDataIdentifierSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<CustomDataIdentifierSummary>(items.length));
        }
        for (CustomDataIdentifierSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListCustomDataIdentifiersResult withItems(java.util.Collection<CustomDataIdentifierSummary> items) {
        setItems(items);
        return this;
    }
    ...
    @Override
    public ListCustomDataIdentifiersResult clone() {
        try {
            return (ListCustomDataIdentifiersResult) super.clone();
