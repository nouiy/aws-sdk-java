...
/**
 * SensitiveDataItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SensitiveDataItemJsonUnmarshaller implements Unmarshaller<SensitiveDataItem, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("category", targetDepth)) {
                    context.nextToken();
                    sensitiveDataItem.setCategory(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("totalCount", targetDepth)) {
                    context.nextToken();
                    sensitiveDataItem.setTotalCount(context.getUnmarshaller(Long.class).unmarshall(context));
                }
