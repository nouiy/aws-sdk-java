...
/**
 * UsageStatisticsFilterMarshaller
 */
...
public class UsageStatisticsFilterMarshaller {
    ...
    private static final UsageStatisticsFilterMarshaller instance = new UsageStatisticsFilterMarshaller();

    public static UsageStatisticsFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UsageStatisticsFilter usageStatisticsFilter, ProtocolMarshaller protocolMarshaller) {

        if (usageStatisticsFilter == null) {
