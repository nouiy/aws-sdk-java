...
public class AWSOpsWorksModuleInjector implements InjectorSource {
    ...
    public Injector getInjector() {
        return Guice.createInjector(Stage.PRODUCTION, CucumberModules.SCENARIO, new AWSOpsWorksModule());
    }

    static class AWSOpsWorksModule extends AbstractModule {

        @Override
        protected void configure() {
            bind(AmazonWebServiceClient.class).to(AWSOpsWorksClient.class);
        }
    }
}
