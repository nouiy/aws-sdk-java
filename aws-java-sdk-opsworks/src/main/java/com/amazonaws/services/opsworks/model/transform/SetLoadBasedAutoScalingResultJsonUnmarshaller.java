...
public class SetLoadBasedAutoScalingResultJsonUnmarshaller implements Unmarshaller<SetLoadBasedAutoScalingResult, JsonUnmarshallerContext> {
    ...
    public SetLoadBasedAutoScalingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SetLoadBasedAutoScalingResult setLoadBasedAutoScalingResult = new SetLoadBasedAutoScalingResult();
