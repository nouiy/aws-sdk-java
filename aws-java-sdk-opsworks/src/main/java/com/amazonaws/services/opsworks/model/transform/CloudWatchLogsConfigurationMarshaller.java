...
/**
 * CloudWatchLogsConfigurationMarshaller
 */
...
public class CloudWatchLogsConfigurationMarshaller {
    ...
    private static final MarshallingInfo<List> LOGSTREAMS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("LogStreams").build();
