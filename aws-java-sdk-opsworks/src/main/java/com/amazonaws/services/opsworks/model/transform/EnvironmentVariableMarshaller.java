...
public class EnvironmentVariableMarshaller {
    ...
    private static final MarshallingInfo<Boolean> SECURE_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Secure").build();
    ...
    public void marshall(EnvironmentVariable environmentVariable, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(environmentVariable.getKey(), KEY_BINDING);
            protocolMarshaller.marshall(environmentVariable.getValue(), VALUE_BINDING);
            protocolMarshaller.marshall(environmentVariable.getSecure(), SECURE_BINDING);
        } catch (Exception e) {
