...
public class DescribeCommandsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> COMMANDIDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("CommandIds").build();

    private static final DescribeCommandsRequestMarshaller instance = new DescribeCommandsRequestMarshaller();

    public static DescribeCommandsRequestMarshaller getInstance() {
        return instance;
    }
