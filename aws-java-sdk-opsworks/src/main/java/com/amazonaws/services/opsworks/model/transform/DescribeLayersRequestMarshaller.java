...
public class DescribeLayersRequestMarshaller {
    ...
    private static final DescribeLayersRequestMarshaller instance = new DescribeLayersRequestMarshaller();

    public static DescribeLayersRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeLayersRequest describeLayersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeLayersRequest.getStackId(), STACKID_BINDING);
            protocolMarshaller.marshall(describeLayersRequest.getLayerIds(), LAYERIDS_BINDING);
        } catch (Exception e) {
