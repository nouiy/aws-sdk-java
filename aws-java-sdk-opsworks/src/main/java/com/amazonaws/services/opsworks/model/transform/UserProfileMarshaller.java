...
public class UserProfileMarshaller {
    ...
    public void marshall(UserProfile userProfile, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(userProfile.getIamUserArn(), IAMUSERARN_BINDING);
            protocolMarshaller.marshall(userProfile.getName(), NAME_BINDING);
            protocolMarshaller.marshall(userProfile.getSshUsername(), SSHUSERNAME_BINDING);
            protocolMarshaller.marshall(userProfile.getSshPublicKey(), SSHPUBLICKEY_BINDING);
            protocolMarshaller.marshall(userProfile.getAllowSelfManagement(), ALLOWSELFMANAGEMENT_BINDING);
        } catch (Exception e) {
