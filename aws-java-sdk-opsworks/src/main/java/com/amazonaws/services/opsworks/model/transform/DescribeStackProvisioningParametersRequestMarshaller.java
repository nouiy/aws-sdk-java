...
/**
 * DescribeStackProvisioningParametersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeStackProvisioningParametersRequestMarshaller {
    ...
    private static final DescribeStackProvisioningParametersRequestMarshaller instance = new DescribeStackProvisioningParametersRequestMarshaller();

    public static DescribeStackProvisioningParametersRequestMarshaller getInstance() {
        return instance;
    }
