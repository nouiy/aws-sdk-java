...
class DeploymentSuccessful {
    ...
    static class IsSuccessfulMatcher extends WaiterAcceptor<DescribeDeploymentsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("Deployments")), new JmesPathField("Status"));
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeDeploymentsResult> {
        private static final JsonNode expectedResult;
