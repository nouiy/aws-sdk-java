...
public class SslConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> CHAIN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Chain").build();
    ...
    public void marshall(SslConfiguration sslConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(sslConfiguration.getCertificate(), CERTIFICATE_BINDING);
            protocolMarshaller.marshall(sslConfiguration.getPrivateKey(), PRIVATEKEY_BINDING);
            protocolMarshaller.marshall(sslConfiguration.getChain(), CHAIN_BINDING);
        } catch (Exception e) {
