...
/**
 * GetHostnameSuggestionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetHostnameSuggestionRequestMarshaller {
    ...
    private static final GetHostnameSuggestionRequestMarshaller instance = new GetHostnameSuggestionRequestMarshaller();

    public static GetHostnameSuggestionRequestMarshaller getInstance() {
        return instance;
    }
