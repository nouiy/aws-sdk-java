...
public class KmsEncryptionConfigJsonUnmarshaller implements Unmarshaller<KmsEncryptionConfig, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CmkType", targetDepth)) {
                    context.nextToken();
                    kmsEncryptionConfig.setCmkType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("KmsKeyId", targetDepth)) {
                    context.nextToken();
                    kmsEncryptionConfig.setKmsKeyId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static KmsEncryptionConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new KmsEncryptionConfigJsonUnmarshaller();
        return instance;
    }
}
