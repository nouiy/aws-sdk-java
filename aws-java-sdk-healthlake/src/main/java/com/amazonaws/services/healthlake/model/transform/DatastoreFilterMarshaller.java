...
/**
 * DatastoreFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DatastoreFilterMarshaller {
    ...
    private static final DatastoreFilterMarshaller instance = new DatastoreFilterMarshaller();

    public static DatastoreFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DatastoreFilter datastoreFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(datastoreFilter.getDatastoreName(), DATASTORENAME_BINDING);
            protocolMarshaller.marshall(datastoreFilter.getDatastoreStatus(), DATASTORESTATUS_BINDING);
            protocolMarshaller.marshall(datastoreFilter.getCreatedBefore(), CREATEDBEFORE_BINDING);
            protocolMarshaller.marshall(datastoreFilter.getCreatedAfter(), CREATEDAFTER_BINDING);
        } catch (Exception e) {
