...
public class KmsEncryptionConfigMarshaller {
    ...
    private static final MarshallingInfo<String> CMKTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("CmkType").build();
    ...
    public void marshall(KmsEncryptionConfig kmsEncryptionConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(kmsEncryptionConfig.getCmkType(), CMKTYPE_BINDING);
            protocolMarshaller.marshall(kmsEncryptionConfig.getKmsKeyId(), KMSKEYID_BINDING);
        } catch (Exception e) {
