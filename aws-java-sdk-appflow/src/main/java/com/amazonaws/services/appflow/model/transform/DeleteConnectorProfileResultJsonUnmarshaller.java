...
/**
 * DeleteConnectorProfileResult JSON Unmarshaller
 */
...
public class DeleteConnectorProfileResultJsonUnmarshaller implements Unmarshaller<DeleteConnectorProfileResult, JsonUnmarshallerContext> {
    ...
    public DeleteConnectorProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConnectorProfileResult deleteConnectorProfileResult = new DeleteConnectorProfileResult();
