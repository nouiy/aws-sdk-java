...
public class DescribeConnectorsRequestMarshaller {
    ...
    private static final DescribeConnectorsRequestMarshaller instance = new DescribeConnectorsRequestMarshaller();

    public static DescribeConnectorsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeConnectorsRequest describeConnectorsRequest, ProtocolMarshaller protocolMarshaller) {
