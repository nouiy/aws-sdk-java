 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/ZendeskMetadata" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ZendeskMetadata implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The desired authorization scope for the Zendesk account.
     */
    ...
    public ZendeskMetadata withOAuthScopes(java.util.Collection<String> oAuthScopes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ZendeskMetadata == false)
            return false;
        ZendeskMetadata other = (ZendeskMetadata) obj;
    ...
    public ZendeskMetadata clone() {
        try {
            return (ZendeskMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appflow.model.transform.ZendeskMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
