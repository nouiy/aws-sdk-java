...
/**
 * UnregisterConnectorResult JSON Unmarshaller
 */
...
public class UnregisterConnectorResultJsonUnmarshaller implements Unmarshaller<UnregisterConnectorResult, JsonUnmarshallerContext> {
    ...
    public UnregisterConnectorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UnregisterConnectorResult unregisterConnectorResult = new UnregisterConnectorResult();
