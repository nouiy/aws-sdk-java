...
/**
 * OAuth2Defaults JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OAuth2DefaultsJsonUnmarshaller implements Unmarshaller<OAuth2Defaults, JsonUnmarshallerContext> {

    public OAuth2Defaults unmarshall(JsonUnmarshallerContext context) throws Exception {
        OAuth2Defaults oAuth2Defaults = new OAuth2Defaults();
    ...
    private static OAuth2DefaultsJsonUnmarshaller instance;

    public static OAuth2DefaultsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new OAuth2DefaultsJsonUnmarshaller();
        return instance;
    }
}
