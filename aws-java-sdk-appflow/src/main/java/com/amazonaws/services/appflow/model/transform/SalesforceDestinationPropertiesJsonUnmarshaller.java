...
/**
 * SalesforceDestinationProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SalesforceDestinationPropertiesJsonUnmarshaller implements Unmarshaller<SalesforceDestinationProperties, JsonUnmarshallerContext> {

    public SalesforceDestinationProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        SalesforceDestinationProperties salesforceDestinationProperties = new SalesforceDestinationProperties();
    ...
    private static SalesforceDestinationPropertiesJsonUnmarshaller instance;

    public static SalesforceDestinationPropertiesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SalesforceDestinationPropertiesJsonUnmarshaller();
        return instance;
    }
}
