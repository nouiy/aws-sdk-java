...
/**
 * OAuthCredentialsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OAuthCredentialsMarshaller {
    ...
    private static final OAuthCredentialsMarshaller instance = new OAuthCredentialsMarshaller();

    public static OAuthCredentialsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OAuthCredentials oAuthCredentials, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(oAuthCredentials.getClientId(), CLIENTID_BINDING);
            protocolMarshaller.marshall(oAuthCredentials.getClientSecret(), CLIENTSECRET_BINDING);
            protocolMarshaller.marshall(oAuthCredentials.getAccessToken(), ACCESSTOKEN_BINDING);
            protocolMarshaller.marshall(oAuthCredentials.getRefreshToken(), REFRESHTOKEN_BINDING);
            protocolMarshaller.marshall(oAuthCredentials.getOAuthRequest(), OAUTHREQUEST_BINDING);
        } catch (Exception e) {
