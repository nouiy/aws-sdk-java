        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("putFailuresCount", targetDepth)) {
                    context.nextToken();
                    errorInfo.setPutFailuresCount(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("executionMessage", targetDepth)) {
                    context.nextToken();
                    errorInfo.setExecutionMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
