...
/**
 * SnowflakeConnectorProfileProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SnowflakeConnectorProfilePropertiesJsonUnmarshaller implements Unmarshaller<SnowflakeConnectorProfileProperties, JsonUnmarshallerContext> {

    public SnowflakeConnectorProfileProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        SnowflakeConnectorProfileProperties snowflakeConnectorProfileProperties = new SnowflakeConnectorProfileProperties();
    ...
    private static SnowflakeConnectorProfilePropertiesJsonUnmarshaller instance;

    public static SnowflakeConnectorProfilePropertiesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SnowflakeConnectorProfilePropertiesJsonUnmarshaller();
        return instance;
    }
}
