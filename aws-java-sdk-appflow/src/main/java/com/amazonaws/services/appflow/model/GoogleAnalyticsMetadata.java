 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appflow-2020-08-23/GoogleAnalyticsMetadata" target="_top">AWS
 *      API Documentation</a>
 */
...
public class GoogleAnalyticsMetadata implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The desired authorization scope for the Google Analytics account.
     */
    ...
    public GoogleAnalyticsMetadata withOAuthScopes(java.util.Collection<String> oAuthScopes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GoogleAnalyticsMetadata == false)
            return false;
        GoogleAnalyticsMetadata other = (GoogleAnalyticsMetadata) obj;
    ...
    @Override
    public GoogleAnalyticsMetadata clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appflow.model.transform.GoogleAnalyticsMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
