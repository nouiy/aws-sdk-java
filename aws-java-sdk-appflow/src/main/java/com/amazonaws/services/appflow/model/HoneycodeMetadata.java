...
public class HoneycodeMetadata implements Serializable, Cloneable, StructuredPojo {
    ...
    public HoneycodeMetadata withOAuthScopes(java.util.Collection<String> oAuthScopes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HoneycodeMetadata == false)
            return false;
    ...
    @Override
    public HoneycodeMetadata clone() {
        try {
            return (HoneycodeMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appflow.model.transform.HoneycodeMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
