...
public class RegisterConnectorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the connector being registered.
     */
    ...
    public RegisterConnectorResult withConnectorArn(String connectorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RegisterConnectorResult == false)
            return false;
        RegisterConnectorResult other = (RegisterConnectorResult) obj;
    ...
    @Override
    public RegisterConnectorResult clone() {
        try {
