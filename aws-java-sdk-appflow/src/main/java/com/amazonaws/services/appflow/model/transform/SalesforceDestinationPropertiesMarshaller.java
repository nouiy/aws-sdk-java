...
/**
 * SalesforceDestinationPropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SalesforceDestinationPropertiesMarshaller {
    ...
    public static SalesforceDestinationPropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SalesforceDestinationProperties salesforceDestinationProperties, ProtocolMarshaller protocolMarshaller) {

        if (salesforceDestinationProperties == null) {
