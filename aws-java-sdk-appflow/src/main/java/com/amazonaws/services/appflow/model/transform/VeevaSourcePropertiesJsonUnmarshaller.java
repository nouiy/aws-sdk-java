...
/**
 * VeevaSourceProperties JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VeevaSourcePropertiesJsonUnmarshaller implements Unmarshaller<VeevaSourceProperties, JsonUnmarshallerContext> {

    public VeevaSourceProperties unmarshall(JsonUnmarshallerContext context) throws Exception {
        VeevaSourceProperties veevaSourceProperties = new VeevaSourceProperties();
    ...
    private static VeevaSourcePropertiesJsonUnmarshaller instance;

    public static VeevaSourcePropertiesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VeevaSourcePropertiesJsonUnmarshaller();
        return instance;
    }
}
