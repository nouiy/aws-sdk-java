...
/**
 * UpsolverS3OutputFormatConfig JSON Unmarshaller
 */
...
public class UpsolverS3OutputFormatConfigJsonUnmarshaller implements Unmarshaller<UpsolverS3OutputFormatConfig, JsonUnmarshallerContext> {
    ...
    public UpsolverS3OutputFormatConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("fileType", targetDepth)) {
                    context.nextToken();
                    upsolverS3OutputFormatConfig.setFileType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("prefixConfig", targetDepth)) {
                    context.nextToken();
                    upsolverS3OutputFormatConfig.setPrefixConfig(PrefixConfigJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("aggregationConfig", targetDepth)) {
                    context.nextToken();
                    upsolverS3OutputFormatConfig.setAggregationConfig(AggregationConfigJsonUnmarshaller.getInstance().unmarshall(context));
                }
