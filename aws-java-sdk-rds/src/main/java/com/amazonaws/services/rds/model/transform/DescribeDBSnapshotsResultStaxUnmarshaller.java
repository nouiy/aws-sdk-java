...
/**
 * DescribeDBSnapshotsResult StAX Unmarshaller
 */
...
public class DescribeDBSnapshotsResultStaxUnmarshaller implements Unmarshaller<DescribeDBSnapshotsResult, StaxUnmarshallerContext> {
    ...
    public DescribeDBSnapshotsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBSnapshots", targetDepth)) {
                    describeDBSnapshotsResult.withDBSnapshots(new ArrayList<DBSnapshot>());
                    continue;
                }

                if (context.testExpression("DBSnapshots/DBSnapshot", targetDepth)) {
                    describeDBSnapshotsResult.withDBSnapshots(DBSnapshotStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeDBSnapshotsResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeDBSnapshotsResultStaxUnmarshaller();
        return instance;
    }
}
