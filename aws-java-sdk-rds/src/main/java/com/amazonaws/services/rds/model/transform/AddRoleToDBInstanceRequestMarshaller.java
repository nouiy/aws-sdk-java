...
/**
 * AddRoleToDBInstanceRequest Marshaller
 */
...
public class AddRoleToDBInstanceRequestMarshaller implements Marshaller<Request<AddRoleToDBInstanceRequest>, AddRoleToDBInstanceRequest> {
    ...
    public Request<AddRoleToDBInstanceRequest> marshall(AddRoleToDBInstanceRequest addRoleToDBInstanceRequest) {
        ...
        Request<AddRoleToDBInstanceRequest> request = new DefaultRequest<AddRoleToDBInstanceRequest>(addRoleToDBInstanceRequest, "AmazonRDS");
        request.addParameter("Action", "AddRoleToDBInstance");
        request.addParameter("Version", "2014-10-31");
        request.setHttpMethod(HttpMethodName.POST);

        if (addRoleToDBInstanceRequest.getDBInstanceIdentifier() != null) {
            request.addParameter("DBInstanceIdentifier", StringUtils.fromString(addRoleToDBInstanceRequest.getDBInstanceIdentifier()));
        }

        if (addRoleToDBInstanceRequest.getRoleArn() != null) {
            request.addParameter("RoleArn", StringUtils.fromString(addRoleToDBInstanceRequest.getRoleArn()));
        }

        if (addRoleToDBInstanceRequest.getFeatureName() != null) {
            request.addParameter("FeatureName", StringUtils.fromString(addRoleToDBInstanceRequest.getFeatureName()));
        }
