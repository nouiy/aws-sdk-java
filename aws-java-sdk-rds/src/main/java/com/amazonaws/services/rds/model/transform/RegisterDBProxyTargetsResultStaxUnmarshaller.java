...
/**
 * RegisterDBProxyTargetsResult StAX Unmarshaller
 */
...
public class RegisterDBProxyTargetsResultStaxUnmarshaller implements Unmarshaller<RegisterDBProxyTargetsResult, StaxUnmarshallerContext> {
    ...
    public RegisterDBProxyTargetsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBProxyTargets", targetDepth)) {
                    registerDBProxyTargetsResult.withDBProxyTargets(new ArrayList<DBProxyTarget>());
                    continue;
                }

                if (context.testExpression("DBProxyTargets/member", targetDepth)) {
                    registerDBProxyTargetsResult.withDBProxyTargets(DBProxyTargetStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
