...
/**
 * DescribeOptionGroupOptionsResult StAX Unmarshaller
 */
...
public class DescribeOptionGroupOptionsResultStaxUnmarshaller implements Unmarshaller<DescribeOptionGroupOptionsResult, StaxUnmarshallerContext> {
    ...
    public DescribeOptionGroupOptionsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("OptionGroupOptions", targetDepth)) {
                    describeOptionGroupOptionsResult.withOptionGroupOptions(new ArrayList<OptionGroupOption>());
                    continue;
                }

                if (context.testExpression("OptionGroupOptions/OptionGroupOption", targetDepth)) {
                    describeOptionGroupOptionsResult.withOptionGroupOptions(OptionGroupOptionStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static DescribeOptionGroupOptionsResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeOptionGroupOptionsResultStaxUnmarshaller();
        return instance;
    }
}
