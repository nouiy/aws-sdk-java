...
class DBInstanceDeleted {
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeDBInstancesResult> {
        ...
        private static final JmesPathExpression ast = new OpEquals(new JmesPathLengthFunction(new JmesPathField("DBInstances")), new JmesPathLiteral("0"));
    ...
    static class IsDBInstanceNotFoundMatcher extends WaiterAcceptor<DescribeDBInstancesResult> {
        /**
    ...
    static class IsCreatingMatcher extends WaiterAcceptor<DescribeDBInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsModifyingMatcher extends WaiterAcceptor<DescribeDBInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsRebootingMatcher extends WaiterAcceptor<DescribeDBInstancesResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsResettingmastercredentialsMatcher extends WaiterAcceptor<DescribeDBInstancesResult> {
        private static final JsonNode expectedResult;
