...
public class RegisterDBProxyTargetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RegisterDBProxyTargetsRequest withDBInstanceIdentifiers(java.util.Collection<String> dBInstanceIdentifiers) {
    ...
    public RegisterDBProxyTargetsRequest withDBClusterIdentifiers(java.util.Collection<String> dBClusterIdentifiers) {
    ...
    @Override
    public RegisterDBProxyTargetsRequest clone() {
