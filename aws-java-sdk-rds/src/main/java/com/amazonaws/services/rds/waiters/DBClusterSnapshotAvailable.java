...
class DBClusterSnapshotAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeDBClusterSnapshotsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("DBClusterSnapshots")), new JmesPathField(
                "Status"));
         ...
         */
        @Override
        public boolean matches(DescribeDBClusterSnapshotsResult result) {
    ...
    static class IsDeletedMatcher extends WaiterAcceptor<DescribeDBClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsDeletingMatcher extends WaiterAcceptor<DescribeDBClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeDBClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatiblerestoreMatcher extends WaiterAcceptor<DescribeDBClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIncompatibleparametersMatcher extends WaiterAcceptor<DescribeDBClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
