...
public class DescribeDBProxyTargetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The identifier of the <code>DBProxyTarget</code> to describe.
     */
    ...
    public DescribeDBProxyTargetsRequest withFilters(Filter... filters) {
    ...
    public DescribeDBProxyTargetsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDBProxyTargetsRequest == false)
            return false;
        DescribeDBProxyTargetsRequest other = (DescribeDBProxyTargetsRequest) obj;
    ...
    @Override
    public DescribeDBProxyTargetsRequest clone() {
        return (DescribeDBProxyTargetsRequest) super.clone();
    }
