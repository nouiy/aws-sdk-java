...
/**
 * SourceRegion StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceRegionStaxUnmarshaller implements Unmarshaller<SourceRegion, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("RegionName", targetDepth)) {
                    sourceRegion.setRegionName(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Endpoint", targetDepth)) {
                    sourceRegion.setEndpoint(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
