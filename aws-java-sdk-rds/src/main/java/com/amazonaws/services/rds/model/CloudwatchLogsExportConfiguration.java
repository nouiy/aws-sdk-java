...
public class CloudwatchLogsExportConfiguration implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<String> enableLogTypes;
    /**
     * <p>
     * The list of log types to disable.
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<String> disableLogTypes;
    ...
    public CloudwatchLogsExportConfiguration withEnableLogTypes(String... enableLogTypes) {
        if (this.enableLogTypes == null) {
            setEnableLogTypes(new com.amazonaws.internal.SdkInternalList<String>(enableLogTypes.length));
        }
    ...
    public java.util.List<String> getDisableLogTypes() {
        if (disableLogTypes == null) {
            disableLogTypes = new com.amazonaws.internal.SdkInternalList<String>();
        }
    ...
    public void setDisableLogTypes(java.util.Collection<String> disableLogTypes) {
        ...
        this.disableLogTypes = new com.amazonaws.internal.SdkInternalList<String>(disableLogTypes);
    }
    ...
    public CloudwatchLogsExportConfiguration withDisableLogTypes(String... disableLogTypes) {
        if (this.disableLogTypes == null) {
            setDisableLogTypes(new com.amazonaws.internal.SdkInternalList<String>(disableLogTypes.length));
        }
