...
/**
 * InstallationMediaFailureCause StAX Unmarshaller
 */
...
public class InstallationMediaFailureCauseStaxUnmarshaller implements Unmarshaller<InstallationMediaFailureCause, StaxUnmarshallerContext> {
    ...
    public InstallationMediaFailureCause unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Message", targetDepth)) {
                    installationMediaFailureCause.setMessage(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
