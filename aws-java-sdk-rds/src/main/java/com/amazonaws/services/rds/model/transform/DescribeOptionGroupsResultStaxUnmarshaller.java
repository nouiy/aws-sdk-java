...
/**
 * DescribeOptionGroupsResult StAX Unmarshaller
 */
...
public class DescribeOptionGroupsResultStaxUnmarshaller implements Unmarshaller<DescribeOptionGroupsResult, StaxUnmarshallerContext> {
    ...
    public DescribeOptionGroupsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    describeOptionGroupsResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
