...
import com.amazonaws.services.rds.model.transform.StartDBInstanceAutomatedBackupsReplicationRequestMarshaller;

/**
 * Handler for pre-signing {@link StartDBInstanceAutomatedBackupsReplicationRequest}.
 */
public class StartDBInstanceAutomatedBackupsReplicationPresignHandler extends PresignRequestHandler<StartDBInstanceAutomatedBackupsReplicationRequest> {
    public StartDBInstanceAutomatedBackupsReplicationPresignHandler() {
    ...
    protected PresignableRequest adaptRequest(final StartDBInstanceAutomatedBackupsReplicationRequest originalRequest) {
        return new PresignableRequest() {
            ...
            public Request<?> marshall() {
                return new StartDBInstanceAutomatedBackupsReplicationRequestMarshaller().marshall(originalRequest);
            }
        };
    }
}
