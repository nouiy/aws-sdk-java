 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rds-2014-10-31/PendingCloudwatchLogsExports" target="_top">AWS
 *      API Documentation</a>
 */
...
public class PendingCloudwatchLogsExports implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<String> logTypesToEnable;
    /**
     * <p>
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<String> logTypesToDisable;
    ...
    public java.util.List<String> getLogTypesToEnable() {
        if (logTypesToEnable == null) {
            logTypesToEnable = new com.amazonaws.internal.SdkInternalList<String>();
        }
    ...
    public void setLogTypesToEnable(java.util.Collection<String> logTypesToEnable) {
        ...
        this.logTypesToEnable = new com.amazonaws.internal.SdkInternalList<String>(logTypesToEnable);
    }
    ...
    public java.util.List<String> getLogTypesToDisable() {
        if (logTypesToDisable == null) {
            logTypesToDisable = new com.amazonaws.internal.SdkInternalList<String>();
        }
    ...
    public void setLogTypesToDisable(java.util.Collection<String> logTypesToDisable) {
        ...
        this.logTypesToDisable = new com.amazonaws.internal.SdkInternalList<String>(logTypesToDisable);
    }
    ...
    public PendingCloudwatchLogsExports withLogTypesToDisable(String... logTypesToDisable) {
        if (this.logTypesToDisable == null) {
            setLogTypesToDisable(new com.amazonaws.internal.SdkInternalList<String>(logTypesToDisable.length));
        }
