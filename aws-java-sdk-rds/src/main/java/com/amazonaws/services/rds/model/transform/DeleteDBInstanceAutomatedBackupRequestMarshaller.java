...
/**
 * DeleteDBInstanceAutomatedBackupRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteDBInstanceAutomatedBackupRequestMarshaller implements
        Marshaller<Request<DeleteDBInstanceAutomatedBackupRequest>, DeleteDBInstanceAutomatedBackupRequest> {

    public Request<DeleteDBInstanceAutomatedBackupRequest> marshall(DeleteDBInstanceAutomatedBackupRequest deleteDBInstanceAutomatedBackupRequest) {
        ...
        Request<DeleteDBInstanceAutomatedBackupRequest> request = new DefaultRequest<DeleteDBInstanceAutomatedBackupRequest>(
                deleteDBInstanceAutomatedBackupRequest, "AmazonRDS");
