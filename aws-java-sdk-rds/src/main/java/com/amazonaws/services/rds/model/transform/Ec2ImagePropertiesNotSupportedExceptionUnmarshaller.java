...
public class Ec2ImagePropertiesNotSupportedExceptionUnmarshaller extends StandardErrorUnmarshaller {
    ...
    public AmazonServiceException unmarshall(Node node) throws Exception {
        ...
        if (errorCode == null || !errorCode.equals("Ec2ImagePropertiesNotSupportedFault"))
            return null;

        Ec2ImagePropertiesNotSupportedException e = (Ec2ImagePropertiesNotSupportedException) super.unmarshall(node);
