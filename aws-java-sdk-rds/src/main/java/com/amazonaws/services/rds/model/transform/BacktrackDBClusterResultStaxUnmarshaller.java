...
/**
 * BacktrackDBClusterResult StAX Unmarshaller
 */
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("DBClusterIdentifier", targetDepth)) {
                    backtrackDBClusterResult.setDBClusterIdentifier(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("BacktrackIdentifier", targetDepth)) {
                    backtrackDBClusterResult.setBacktrackIdentifier(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Status", targetDepth)) {
                    backtrackDBClusterResult.setStatus(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
