...
public class DeleteDBProxyEndpointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the DB proxy endpoint to delete.
     */
    ...
    public String toString() {
        ...
        if (getDBProxyEndpointName() != null)
            sb.append("DBProxyEndpointName: ").append(getDBProxyEndpointName());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDBProxyEndpointRequest == false)
            return false;
        DeleteDBProxyEndpointRequest other = (DeleteDBProxyEndpointRequest) obj;
    ...
    @Override
    public DeleteDBProxyEndpointRequest clone() {
        return (DeleteDBProxyEndpointRequest) super.clone();
    }
