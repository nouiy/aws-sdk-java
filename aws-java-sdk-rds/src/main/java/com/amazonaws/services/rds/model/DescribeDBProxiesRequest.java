...
public class DescribeDBProxiesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeDBProxiesRequest withFilters(Filter... filters) {
    ...
    public DescribeDBProxiesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeDBProxiesRequest withMaxRecords(Integer maxRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDBProxiesRequest == false)
            return false;
        DescribeDBProxiesRequest other = (DescribeDBProxiesRequest) obj;
    ...
    @Override
    public DescribeDBProxiesRequest clone() {
        return (DescribeDBProxiesRequest) super.clone();
    }
