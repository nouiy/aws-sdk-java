...
public class CreateReturnShippingLabelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateReturnShippingLabelResult == false)
            return false;
        CreateReturnShippingLabelResult other = (CreateReturnShippingLabelResult) obj;
    ...
    public CreateReturnShippingLabelResult clone() {
        try {
            return (CreateReturnShippingLabelResult) super.clone();
