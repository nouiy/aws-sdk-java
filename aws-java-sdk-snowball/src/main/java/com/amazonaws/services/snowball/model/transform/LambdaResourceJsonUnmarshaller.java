...
/**
 * LambdaResource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaResourceJsonUnmarshaller implements Unmarshaller<LambdaResource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("LambdaArn", targetDepth)) {
                    context.nextToken();
                    lambdaResource.setLambdaArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
