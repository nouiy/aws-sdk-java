...
public class KMSRequestFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static KMSRequestFailedExceptionUnmarshaller instance;

    public static KMSRequestFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new KMSRequestFailedExceptionUnmarshaller();
        return instance;
    }
}
