...
/**
 * Ec2AmiResource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Ec2AmiResourceJsonUnmarshaller implements Unmarshaller<Ec2AmiResource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AmiId", targetDepth)) {
                    context.nextToken();
                    ec2AmiResource.setAmiId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SnowballAmiId", targetDepth)) {
                    context.nextToken();
                    ec2AmiResource.setSnowballAmiId(context.getUnmarshaller(String.class).unmarshall(context));
                }
