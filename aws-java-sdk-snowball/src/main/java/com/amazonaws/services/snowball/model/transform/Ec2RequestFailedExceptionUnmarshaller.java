...
public class Ec2RequestFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static Ec2RequestFailedExceptionUnmarshaller instance;

    public static Ec2RequestFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new Ec2RequestFailedExceptionUnmarshaller();
        return instance;
    }
}
