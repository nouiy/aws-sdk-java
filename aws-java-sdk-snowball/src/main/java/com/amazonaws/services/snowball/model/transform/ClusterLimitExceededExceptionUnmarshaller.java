...
public class ClusterLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ClusterLimitExceededExceptionUnmarshaller instance;

    public static ClusterLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ClusterLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
