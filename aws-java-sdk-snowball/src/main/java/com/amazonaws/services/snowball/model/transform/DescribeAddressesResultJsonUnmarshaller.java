...
public class DescribeAddressesResultJsonUnmarshaller implements Unmarshaller<DescribeAddressesResult, JsonUnmarshallerContext> {

    public DescribeAddressesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
