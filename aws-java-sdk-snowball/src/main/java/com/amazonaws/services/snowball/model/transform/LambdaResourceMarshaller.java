...
public class LambdaResourceMarshaller {
    ...
    private static final MarshallingInfo<List> EVENTTRIGGERS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("EventTriggers").build();
    ...
    public void marshall(LambdaResource lambdaResource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(lambdaResource.getLambdaArn(), LAMBDAARN_BINDING);
            protocolMarshaller.marshall(lambdaResource.getEventTriggers(), EVENTTRIGGERS_BINDING);
        } catch (Exception e) {
