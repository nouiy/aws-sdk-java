...
/**
 * EKSOnDeviceServiceConfigurationMarshaller
 */
...
public class EKSOnDeviceServiceConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> EKSANYWHEREVERSION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EKSAnywhereVersion").build();
    ...
    public void marshall(EKSOnDeviceServiceConfiguration eKSOnDeviceServiceConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(eKSOnDeviceServiceConfiguration.getKubernetesVersion(), KUBERNETESVERSION_BINDING);
            protocolMarshaller.marshall(eKSOnDeviceServiceConfiguration.getEKSAnywhereVersion(), EKSANYWHEREVERSION_BINDING);
        } catch (Exception e) {
