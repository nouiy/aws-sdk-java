...
/**
 * OnDeviceServiceConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OnDeviceServiceConfigurationMarshaller {

    private static final MarshallingInfo<StructuredPojo> NFSONDEVICESERVICE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static OnDeviceServiceConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OnDeviceServiceConfiguration onDeviceServiceConfiguration, ProtocolMarshaller protocolMarshaller) {
