...
public class BatchSnoozeAlarmResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchSnoozeAlarmResult withErrorEntries(java.util.Collection<BatchAlarmActionErrorEntry> errorEntries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchSnoozeAlarmResult == false)
            return false;
        BatchSnoozeAlarmResult other = (BatchSnoozeAlarmResult) obj;
    ...
    @Override
    public BatchSnoozeAlarmResult clone() {
        try {
            return (BatchSnoozeAlarmResult) super.clone();
