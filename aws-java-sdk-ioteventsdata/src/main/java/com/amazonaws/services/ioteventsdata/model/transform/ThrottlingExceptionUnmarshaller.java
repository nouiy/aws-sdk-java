...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.ioteventsdata.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.ioteventsdata.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ioteventsdata.model.ThrottlingException throttlingException = new com.amazonaws.services.ioteventsdata.model.ThrottlingException(
                null);
