...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.ioteventsdata.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.ioteventsdata.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ioteventsdata.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.ioteventsdata.model.ResourceNotFoundException(
                null);
