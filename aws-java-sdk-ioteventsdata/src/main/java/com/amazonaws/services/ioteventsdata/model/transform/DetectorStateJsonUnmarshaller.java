...
/**
 * DetectorState JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DetectorStateJsonUnmarshaller implements Unmarshaller<DetectorState, JsonUnmarshallerContext> {

    public DetectorState unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static DetectorStateJsonUnmarshaller instance;

    public static DetectorStateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DetectorStateJsonUnmarshaller();
        return instance;
    }
}
