...
public class BatchResetAlarmResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchResetAlarmResult withErrorEntries(BatchAlarmActionErrorEntry... errorEntries) {
    ...
    public BatchResetAlarmResult withErrorEntries(java.util.Collection<BatchAlarmActionErrorEntry> errorEntries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchResetAlarmResult == false)
            return false;
        BatchResetAlarmResult other = (BatchResetAlarmResult) obj;
    ...
    @Override
    public BatchResetAlarmResult clone() {
        try {
            return (BatchResetAlarmResult) super.clone();
