...
public class BatchAcknowledgeAlarmResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchAcknowledgeAlarmResult withErrorEntries(BatchAlarmActionErrorEntry... errorEntries) {
    ...
    public BatchAcknowledgeAlarmResult withErrorEntries(java.util.Collection<BatchAlarmActionErrorEntry> errorEntries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchAcknowledgeAlarmResult == false)
            return false;
        BatchAcknowledgeAlarmResult other = (BatchAcknowledgeAlarmResult) obj;
    ...
    public BatchAcknowledgeAlarmResult clone() {
        try {
            return (BatchAcknowledgeAlarmResult) super.clone();
