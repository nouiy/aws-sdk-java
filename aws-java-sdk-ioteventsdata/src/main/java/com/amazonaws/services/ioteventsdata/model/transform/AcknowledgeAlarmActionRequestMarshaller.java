...
/**
 * AcknowledgeAlarmActionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AcknowledgeAlarmActionRequestMarshaller {
    ...
    private static final AcknowledgeAlarmActionRequestMarshaller instance = new AcknowledgeAlarmActionRequestMarshaller();

    public static AcknowledgeAlarmActionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AcknowledgeAlarmActionRequest acknowledgeAlarmActionRequest, ProtocolMarshaller protocolMarshaller) {

        if (acknowledgeAlarmActionRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(acknowledgeAlarmActionRequest.getRequestId(), REQUESTID_BINDING);
            protocolMarshaller.marshall(acknowledgeAlarmActionRequest.getAlarmModelName(), ALARMMODELNAME_BINDING);
            protocolMarshaller.marshall(acknowledgeAlarmActionRequest.getKeyValue(), KEYVALUE_BINDING);
            protocolMarshaller.marshall(acknowledgeAlarmActionRequest.getNote(), NOTE_BINDING);
        } catch (Exception e) {
