...
/**
 * DocumentClassifierFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocumentClassifierFilterJsonUnmarshaller implements Unmarshaller<DocumentClassifierFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SubmitTimeAfter", targetDepth)) {
                    context.nextToken();
                    documentClassifierFilter.setSubmitTimeAfter(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
