...
/**
 * SentimentDetectionJobFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SentimentDetectionJobFilterJsonUnmarshaller implements Unmarshaller<SentimentDetectionJobFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("JobName", targetDepth)) {
                    context.nextToken();
                    sentimentDetectionJobFilter.setJobName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("JobStatus", targetDepth)) {
                    context.nextToken();
                    sentimentDetectionJobFilter.setJobStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
