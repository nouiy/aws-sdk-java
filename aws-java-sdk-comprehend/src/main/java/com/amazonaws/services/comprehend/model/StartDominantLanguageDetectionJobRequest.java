...
public class StartDominantLanguageDetectionJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An identifier for the job.
     */
    ...
    public StartDominantLanguageDetectionJobRequest clone() {
        return (StartDominantLanguageDetectionJobRequest) super.clone();
    }
