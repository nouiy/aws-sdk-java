...
/**
 * EntityTypesListItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntityTypesListItemJsonUnmarshaller implements Unmarshaller<EntityTypesListItem, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    entityTypesListItem.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
