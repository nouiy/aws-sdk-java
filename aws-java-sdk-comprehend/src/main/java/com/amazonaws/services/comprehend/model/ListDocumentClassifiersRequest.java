...
public class ListDocumentClassifiersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ListDocumentClassifiersRequest clone() {
        return (ListDocumentClassifiersRequest) super.clone();
    }
