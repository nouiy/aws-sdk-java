...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/BatchDetectKeyPhrases" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchDetectKeyPhrasesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<BatchDetectKeyPhrasesItemResult> resultList;
    /**
     * <p>
    ...
    public java.util.List<BatchDetectKeyPhrasesItemResult> getResultList() {
        return resultList;
    }
    ...
    public void setResultList(java.util.Collection<BatchDetectKeyPhrasesItemResult> resultList) {
        if (resultList == null) {
            this.resultList = null;
            return;
        }

        this.resultList = new java.util.ArrayList<BatchDetectKeyPhrasesItemResult>(resultList);
    }
    ...
    public BatchDetectKeyPhrasesResult withResultList(BatchDetectKeyPhrasesItemResult... resultList) {
        if (this.resultList == null) {
            setResultList(new java.util.ArrayList<BatchDetectKeyPhrasesItemResult>(resultList.length));
        }
        for (BatchDetectKeyPhrasesItemResult ele : resultList) {
    ...
    public BatchDetectKeyPhrasesResult withResultList(java.util.Collection<BatchDetectKeyPhrasesItemResult> resultList) {
    ...
    public BatchDetectKeyPhrasesResult withErrorList(BatchItemError... errorList) {
    ...
    public BatchDetectKeyPhrasesResult withErrorList(java.util.Collection<BatchItemError> errorList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDetectKeyPhrasesResult == false)
            return false;
        BatchDetectKeyPhrasesResult other = (BatchDetectKeyPhrasesResult) obj;
    ...
    @Override
    public BatchDetectKeyPhrasesResult clone() {
        try {
            return (BatchDetectKeyPhrasesResult) super.clone();
