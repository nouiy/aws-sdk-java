...
public class EntityRecognizerEntityList implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EntityRecognizerEntityList == false)
            return false;
        EntityRecognizerEntityList other = (EntityRecognizerEntityList) obj;
    ...
    @Override
    public EntityRecognizerEntityList clone() {
        try {
            return (EntityRecognizerEntityList) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.EntityRecognizerEntityListMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
