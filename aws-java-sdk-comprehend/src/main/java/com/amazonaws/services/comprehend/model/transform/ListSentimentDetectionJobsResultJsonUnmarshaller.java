...
/**
 * ListSentimentDetectionJobsResult JSON Unmarshaller
 */
...
public class ListSentimentDetectionJobsResultJsonUnmarshaller implements Unmarshaller<ListSentimentDetectionJobsResult, JsonUnmarshallerContext> {
    ...
    public ListSentimentDetectionJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listSentimentDetectionJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
