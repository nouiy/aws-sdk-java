 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/PiiEntitiesDetectionJobFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PiiEntitiesDetectionJobFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public PiiEntitiesDetectionJobFilter withJobStatus(String jobStatus) {
    ...
    public PiiEntitiesDetectionJobFilter withJobStatus(JobStatus jobStatus) {
    ...
    public PiiEntitiesDetectionJobFilter withSubmitTimeBefore(java.util.Date submitTimeBefore) {
    ...
    public PiiEntitiesDetectionJobFilter withSubmitTimeAfter(java.util.Date submitTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PiiEntitiesDetectionJobFilter == false)
            return false;
        PiiEntitiesDetectionJobFilter other = (PiiEntitiesDetectionJobFilter) obj;
    ...
    @Override
    public PiiEntitiesDetectionJobFilter clone() {
        try {
            return (PiiEntitiesDetectionJobFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.PiiEntitiesDetectionJobFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
