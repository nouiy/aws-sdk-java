...
/**
 * DeleteEntityRecognizerResult JSON Unmarshaller
 */
...
public class DeleteEntityRecognizerResultJsonUnmarshaller implements Unmarshaller<DeleteEntityRecognizerResult, JsonUnmarshallerContext> {
    ...
    public DeleteEntityRecognizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEntityRecognizerResult deleteEntityRecognizerResult = new DeleteEntityRecognizerResult();
