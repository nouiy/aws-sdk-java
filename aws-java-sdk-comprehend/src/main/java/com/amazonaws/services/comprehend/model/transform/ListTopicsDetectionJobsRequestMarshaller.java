...
@SdkInternalApi
public class ListTopicsDetectionJobsRequestMarshaller {
    ...
    private static final ListTopicsDetectionJobsRequestMarshaller instance = new ListTopicsDetectionJobsRequestMarshaller();

    public static ListTopicsDetectionJobsRequestMarshaller getInstance() {
        return instance;
    }
