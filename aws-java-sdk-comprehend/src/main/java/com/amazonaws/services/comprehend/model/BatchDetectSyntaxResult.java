...
public class BatchDetectSyntaxResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchDetectSyntaxResult withResultList(java.util.Collection<BatchDetectSyntaxItemResult> resultList) {
    ...
    @Override
    public BatchDetectSyntaxResult clone() {
        try {
            return (BatchDetectSyntaxResult) super.clone();
