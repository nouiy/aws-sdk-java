...
/**
 * DocumentLabel JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocumentLabelJsonUnmarshaller implements Unmarshaller<DocumentLabel, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    documentLabel.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
