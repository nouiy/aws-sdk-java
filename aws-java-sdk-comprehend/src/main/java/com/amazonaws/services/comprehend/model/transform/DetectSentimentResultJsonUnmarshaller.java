...
/**
 * DetectSentimentResult JSON Unmarshaller
 */
...
public class DetectSentimentResultJsonUnmarshaller implements Unmarshaller<DetectSentimentResult, JsonUnmarshallerContext> {
    ...
    public DetectSentimentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Sentiment", targetDepth)) {
                    context.nextToken();
                    detectSentimentResult.setSentiment(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("SentimentScore", targetDepth)) {
                    context.nextToken();
                    detectSentimentResult.setSentimentScore(SentimentScoreJsonUnmarshaller.getInstance().unmarshall(context));
                }
