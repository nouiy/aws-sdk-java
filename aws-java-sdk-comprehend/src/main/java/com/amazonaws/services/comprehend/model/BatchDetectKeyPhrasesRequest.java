...
public class BatchDetectKeyPhrasesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public BatchDetectKeyPhrasesRequest clone() {
        return (BatchDetectKeyPhrasesRequest) super.clone();
    }
