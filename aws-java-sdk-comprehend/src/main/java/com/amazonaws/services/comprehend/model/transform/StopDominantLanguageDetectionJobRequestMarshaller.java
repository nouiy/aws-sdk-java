...
public class StopDominantLanguageDetectionJobRequestMarshaller {
    ...
    private static final StopDominantLanguageDetectionJobRequestMarshaller instance = new StopDominantLanguageDetectionJobRequestMarshaller();

    public static StopDominantLanguageDetectionJobRequestMarshaller getInstance() {
        return instance;
    }
