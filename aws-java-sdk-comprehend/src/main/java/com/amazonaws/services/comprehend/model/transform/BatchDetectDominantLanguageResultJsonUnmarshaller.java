...
/**
 * BatchDetectDominantLanguageResult JSON Unmarshaller
 */
...
public class BatchDetectDominantLanguageResultJsonUnmarshaller implements Unmarshaller<BatchDetectDominantLanguageResult, JsonUnmarshallerContext> {
    ...
    public BatchDetectDominantLanguageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
