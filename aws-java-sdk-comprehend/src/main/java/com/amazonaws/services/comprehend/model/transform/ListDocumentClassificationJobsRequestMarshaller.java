...
@SdkInternalApi
public class ListDocumentClassificationJobsRequestMarshaller {
    ...
    private static final ListDocumentClassificationJobsRequestMarshaller instance = new ListDocumentClassificationJobsRequestMarshaller();

    public static ListDocumentClassificationJobsRequestMarshaller getInstance() {
        return instance;
    }
