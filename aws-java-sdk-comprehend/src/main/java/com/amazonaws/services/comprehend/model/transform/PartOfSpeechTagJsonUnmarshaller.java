...
/**
 * PartOfSpeechTag JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PartOfSpeechTagJsonUnmarshaller implements Unmarshaller<PartOfSpeechTag, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Tag", targetDepth)) {
                    context.nextToken();
                    partOfSpeechTag.setTag(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Score", targetDepth)) {
                    context.nextToken();
                    partOfSpeechTag.setScore(context.getUnmarshaller(Float.class).unmarshall(context));
                }
