...
public class StartDocumentClassificationJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public StartDocumentClassificationJobResult clone() {
        try {
            return (StartDocumentClassificationJobResult) super.clone();
