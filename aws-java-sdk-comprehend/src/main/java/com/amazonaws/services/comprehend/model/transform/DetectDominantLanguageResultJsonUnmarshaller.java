...
/**
 * DetectDominantLanguageResult JSON Unmarshaller
 */
...
public class DetectDominantLanguageResultJsonUnmarshaller implements Unmarshaller<DetectDominantLanguageResult, JsonUnmarshallerContext> {
    ...
    public DetectDominantLanguageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Languages", targetDepth)) {
                    context.nextToken();
                    detectDominantLanguageResult.setLanguages(new ListUnmarshaller<DominantLanguage>(DominantLanguageJsonUnmarshaller.getInstance())
