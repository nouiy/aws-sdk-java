...
/**
 * SentimentDetectionJobFilterMarshaller
 */
...
public class SentimentDetectionJobFilterMarshaller {
    ...
    public void marshall(SentimentDetectionJobFilter sentimentDetectionJobFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        if (sentimentDetectionJobFilter == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(sentimentDetectionJobFilter.getJobName(), JOBNAME_BINDING);
            protocolMarshaller.marshall(sentimentDetectionJobFilter.getJobStatus(), JOBSTATUS_BINDING);
            protocolMarshaller.marshall(sentimentDetectionJobFilter.getSubmitTimeBefore(), SUBMITTIMEBEFORE_BINDING);
            protocolMarshaller.marshall(sentimentDetectionJobFilter.getSubmitTimeAfter(), SUBMITTIMEAFTER_BINDING);
        } catch (Exception e) {
