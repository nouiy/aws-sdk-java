...
public class ListEntityRecognizersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * Filters the list of entities returned. You can filter on <code>Status</code>, <code>SubmitTimeBefore</code>, or
     ...
     * 
     * @param filter
     *        Filters the list of entities returned. You can filter on <code>Status</code>,
     *        <code>SubmitTimeBefore</code>, or <code>SubmitTimeAfter</code>. You can only set one filter at a time.
     */
     ...
     * </p>
     * 
     * @return Filters the list of entities returned. You can filter on <code>Status</code>,
     *         <code>SubmitTimeBefore</code>, or <code>SubmitTimeAfter</code>. You can only set one filter at a time.
     */
     ...
     * </p>
     * 
     * @return The maximum number of results to return on each page. The default is 100.
     */
    ...
    @Override
    public ListEntityRecognizersRequest clone() {
        return (ListEntityRecognizersRequest) super.clone();
    }
