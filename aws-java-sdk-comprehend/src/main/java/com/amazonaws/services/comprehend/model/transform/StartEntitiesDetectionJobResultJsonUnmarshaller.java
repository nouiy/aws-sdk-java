...
/**
 * StartEntitiesDetectionJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartEntitiesDetectionJobResultJsonUnmarshaller implements Unmarshaller<StartEntitiesDetectionJobResult, JsonUnmarshallerContext> {

    public StartEntitiesDetectionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
