...
/**
 * EntityRecognizerMetadataEntityTypesListItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntityRecognizerMetadataEntityTypesListItemJsonUnmarshaller implements
        Unmarshaller<EntityRecognizerMetadataEntityTypesListItem, JsonUnmarshallerContext> {

    public EntityRecognizerMetadataEntityTypesListItem unmarshall(JsonUnmarshallerContext context) throws Exception {
