...
/**
 * StopTrainingDocumentClassifierResult JSON Unmarshaller
 */
...
public class StopTrainingDocumentClassifierResultJsonUnmarshaller implements Unmarshaller<StopTrainingDocumentClassifierResult, JsonUnmarshallerContext> {
    ...
    public StopTrainingDocumentClassifierResult unmarshall(JsonUnmarshallerContext context) throws Exception {
