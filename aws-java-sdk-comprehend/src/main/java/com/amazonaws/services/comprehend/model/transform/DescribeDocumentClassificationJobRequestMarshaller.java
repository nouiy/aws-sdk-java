...
public class DescribeDocumentClassificationJobRequestMarshaller {
    ...
    private static final DescribeDocumentClassificationJobRequestMarshaller instance = new DescribeDocumentClassificationJobRequestMarshaller();

    public static DescribeDocumentClassificationJobRequestMarshaller getInstance() {
        return instance;
    }
