...
public class DescribePiiEntitiesDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribePiiEntitiesDetectionJobResult == false)
            return false;
        DescribePiiEntitiesDetectionJobResult other = (DescribePiiEntitiesDetectionJobResult) obj;
        if (other.getPiiEntitiesDetectionJobProperties() == null ^ this.getPiiEntitiesDetectionJobProperties() == null)
            return false;
        if (other.getPiiEntitiesDetectionJobProperties() != null
                && other.getPiiEntitiesDetectionJobProperties().equals(this.getPiiEntitiesDetectionJobProperties()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getPiiEntitiesDetectionJobProperties() == null) ? 0 : getPiiEntitiesDetectionJobProperties().hashCode());
        return hashCode;
    }

    @Override
    public DescribePiiEntitiesDetectionJobResult clone() {
        try {
