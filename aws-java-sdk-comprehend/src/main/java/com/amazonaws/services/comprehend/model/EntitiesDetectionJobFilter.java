 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/EntitiesDetectionJobFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntitiesDetectionJobFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public EntitiesDetectionJobFilter withJobStatus(String jobStatus) {
    ...
    public EntitiesDetectionJobFilter withJobStatus(JobStatus jobStatus) {
    ...
    public EntitiesDetectionJobFilter withSubmitTimeBefore(java.util.Date submitTimeBefore) {
    ...
    public EntitiesDetectionJobFilter withSubmitTimeAfter(java.util.Date submitTimeAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EntitiesDetectionJobFilter == false)
            return false;
    ...
    @Override
    public EntitiesDetectionJobFilter clone() {
        try {
            return (EntitiesDetectionJobFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.EntitiesDetectionJobFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
