...
public class BatchDetectSentimentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public BatchDetectSentimentRequest clone() {
        return (BatchDetectSentimentRequest) super.clone();
    }
