...
public class ListEventsDetectionJobsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEventsDetectionJobsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEventsDetectionJobsRequest == false)
            return false;
    ...
    @Override
    public ListEventsDetectionJobsRequest clone() {
        return (ListEventsDetectionJobsRequest) super.clone();
    }
