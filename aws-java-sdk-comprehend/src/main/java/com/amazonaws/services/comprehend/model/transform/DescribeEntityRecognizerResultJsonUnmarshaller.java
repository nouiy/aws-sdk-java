...
/**
 * DescribeEntityRecognizerResult JSON Unmarshaller
 */
...
public class DescribeEntityRecognizerResultJsonUnmarshaller implements Unmarshaller<DescribeEntityRecognizerResult, JsonUnmarshallerContext> {
    ...
    public DescribeEntityRecognizerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EntityRecognizerProperties", targetDepth)) {
                    context.nextToken();
                    describeEntityRecognizerResult.setEntityRecognizerProperties(EntityRecognizerPropertiesJsonUnmarshaller.getInstance().unmarshall(context));
                }
