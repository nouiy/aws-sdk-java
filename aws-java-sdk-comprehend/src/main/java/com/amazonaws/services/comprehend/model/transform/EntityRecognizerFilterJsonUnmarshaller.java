...
/**
 * EntityRecognizerFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EntityRecognizerFilterJsonUnmarshaller implements Unmarshaller<EntityRecognizerFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("SubmitTimeAfter", targetDepth)) {
                    context.nextToken();
                    entityRecognizerFilter.setSubmitTimeAfter(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
