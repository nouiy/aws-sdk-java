...
/**
 * DescribeKeyPhrasesDetectionJobResult JSON Unmarshaller
 */
...
public class DescribeKeyPhrasesDetectionJobResultJsonUnmarshaller implements Unmarshaller<DescribeKeyPhrasesDetectionJobResult, JsonUnmarshallerContext> {
    ...
    public DescribeKeyPhrasesDetectionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KeyPhrasesDetectionJobProperties", targetDepth)) {
                    context.nextToken();
                    describeKeyPhrasesDetectionJobResult.setKeyPhrasesDetectionJobProperties(KeyPhrasesDetectionJobPropertiesJsonUnmarshaller.getInstance()
                            .unmarshall(context));
                }
