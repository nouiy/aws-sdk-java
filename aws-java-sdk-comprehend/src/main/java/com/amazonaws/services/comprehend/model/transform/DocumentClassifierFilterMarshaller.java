...
/**
 * DocumentClassifierFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DocumentClassifierFilterMarshaller {
    ...
    private static final DocumentClassifierFilterMarshaller instance = new DocumentClassifierFilterMarshaller();

    public static DocumentClassifierFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DocumentClassifierFilter documentClassifierFilter, ProtocolMarshaller protocolMarshaller) {

        if (documentClassifierFilter == null) {
