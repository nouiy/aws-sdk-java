 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/comprehend-2017-11-27/KeyPhrasesDetectionJobProperties"
...
public class KeyPhrasesDetectionJobProperties implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The current status of the key phrases detection job. If the status is <code>FAILED</code>, the
     ...
     * your key phrases detection job. For more information, see <a
     ...
     * </p>
     * 
     * @return The identifier assigned to the key phrases detection job.
     */
     ...
     * </p>
     * 
     * @return The name that you assigned the key phrases detection job.
     */
     ...
     * </p>
     * 
     * @return The current status of the key phrases detection job. If the status is <code>FAILED</code>, the
     *         <code>Message</code> field shows the reason for the failure.
     * @see JobStatus
     */
     ...
     * </p>
     * 
     * @return The time that the key phrases detection job was submitted for processing.
     */
    ...
    public KeyPhrasesDetectionJobProperties withSubmitTime(java.util.Date submitTime) {
     ...
     * </p>
     * 
     * @return The time that the key phrases detection job completed.
     */
    ...
    public KeyPhrasesDetectionJobProperties withEndTime(java.util.Date endTime) {
        setEndTime(endTime);
        return this;
    }
     ...
     * </p>
     * 
     * @return The input data configuration that you supplied when you created the key phrases detection job.
     */
     ...
     * </p>
     * 
     * @return The output data configuration that you supplied when you created the key phrases detection job.
     */
     ...
     *        for your key phrases detection job. For more information, see <a
     *        href="https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html">Amazon VPC</a>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KeyPhrasesDetectionJobProperties == false)
            return false;
        KeyPhrasesDetectionJobProperties other = (KeyPhrasesDetectionJobProperties) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.comprehend.model.transform.KeyPhrasesDetectionJobPropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
