...
public class KmsKeyValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static KmsKeyValidationExceptionUnmarshaller instance;

    public static KmsKeyValidationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new KmsKeyValidationExceptionUnmarshaller();
        return instance;
    }
}
