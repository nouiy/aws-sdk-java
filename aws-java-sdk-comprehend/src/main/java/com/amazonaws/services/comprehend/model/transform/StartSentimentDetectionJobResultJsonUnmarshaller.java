...
/**
 * StartSentimentDetectionJobResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StartSentimentDetectionJobResultJsonUnmarshaller implements Unmarshaller<StartSentimentDetectionJobResult, JsonUnmarshallerContext> {

    public StartSentimentDetectionJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
