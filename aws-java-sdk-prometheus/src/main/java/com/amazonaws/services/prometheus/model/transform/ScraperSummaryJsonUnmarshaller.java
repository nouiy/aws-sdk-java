...
/**
 * ScraperSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScraperSummaryJsonUnmarshaller implements Unmarshaller<ScraperSummary, JsonUnmarshallerContext> {

    public ScraperSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        ScraperSummary scraperSummary = new ScraperSummary();
    ...
    private static ScraperSummaryJsonUnmarshaller instance;

    public static ScraperSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ScraperSummaryJsonUnmarshaller();
        return instance;
    }
}
