...
public class PutAlertManagerDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutAlertManagerDefinitionResult == false)
            return false;
        PutAlertManagerDefinitionResult other = (PutAlertManagerDefinitionResult) obj;
    ...
    public PutAlertManagerDefinitionResult clone() {
        try {
            return (PutAlertManagerDefinitionResult) super.clone();
