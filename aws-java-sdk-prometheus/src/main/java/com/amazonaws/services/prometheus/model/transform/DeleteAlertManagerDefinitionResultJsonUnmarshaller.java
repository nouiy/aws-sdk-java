...
/**
 * DeleteAlertManagerDefinitionResult JSON Unmarshaller
 */
...
public class DeleteAlertManagerDefinitionResultJsonUnmarshaller implements Unmarshaller<DeleteAlertManagerDefinitionResult, JsonUnmarshallerContext> {
    ...
    public DeleteAlertManagerDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAlertManagerDefinitionResult deleteAlertManagerDefinitionResult = new DeleteAlertManagerDefinitionResult();
