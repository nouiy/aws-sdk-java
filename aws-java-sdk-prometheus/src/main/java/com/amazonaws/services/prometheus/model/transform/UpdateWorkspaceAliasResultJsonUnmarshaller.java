...
/**
 * UpdateWorkspaceAliasResult JSON Unmarshaller
 */
...
public class UpdateWorkspaceAliasResultJsonUnmarshaller implements Unmarshaller<UpdateWorkspaceAliasResult, JsonUnmarshallerContext> {
    ...
    public UpdateWorkspaceAliasResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateWorkspaceAliasResult updateWorkspaceAliasResult = new UpdateWorkspaceAliasResult();
