...
public class CreateAlertManagerDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAlertManagerDefinitionResult == false)
            return false;
        CreateAlertManagerDefinitionResult other = (CreateAlertManagerDefinitionResult) obj;
    ...
    public CreateAlertManagerDefinitionResult clone() {
        try {
            return (CreateAlertManagerDefinitionResult) super.clone();
