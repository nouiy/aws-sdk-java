...
/**
 * Fluent builder for {@link com.amazonaws.services.prometheus.AmazonPrometheusAsync}. Use of the builder is preferred
...
public final class AmazonPrometheusAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonPrometheusAsyncClientBuilder, AmazonPrometheusAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonPrometheusAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonPrometheusAsync.
     */
    @Override
    protected AmazonPrometheusAsync build(AwsAsyncClientParams params) {
        return new AmazonPrometheusAsyncClient(params);
    }
