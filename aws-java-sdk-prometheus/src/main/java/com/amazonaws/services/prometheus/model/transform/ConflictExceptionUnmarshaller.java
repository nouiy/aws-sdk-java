...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.prometheus.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.prometheus.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.prometheus.model.ConflictException conflictException = new com.amazonaws.services.prometheus.model.ConflictException(null);
