...
class WorkspaceActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeWorkspaceResult> {
    ...
    static class IsUPDATINGMatcher extends WaiterAcceptor<DescribeWorkspaceResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<DescribeWorkspaceResult> {
        private static final JsonNode expectedResult;
