...
/**
 * ModuleLoggingConfigurationMarshaller
 */
...
public class ModuleLoggingConfigurationMarshaller {
    ...
    public static ModuleLoggingConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ModuleLoggingConfiguration moduleLoggingConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (moduleLoggingConfiguration == null) {
