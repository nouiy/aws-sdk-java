...
public class DeleteScheduledActionRequestMarshaller {
    ...
    private static final DeleteScheduledActionRequestMarshaller instance = new DeleteScheduledActionRequestMarshaller();

    public static DeleteScheduledActionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteScheduledActionRequest deleteScheduledActionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteScheduledActionRequest.getServiceNamespace(), SERVICENAMESPACE_BINDING);
            protocolMarshaller.marshall(deleteScheduledActionRequest.getScheduledActionName(), SCHEDULEDACTIONNAME_BINDING);
            protocolMarshaller.marshall(deleteScheduledActionRequest.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(deleteScheduledActionRequest.getScalableDimension(), SCALABLEDIMENSION_BINDING);
        } catch (Exception e) {
