...
public class StepScalingPolicyConfigurationJsonUnmarshaller implements Unmarshaller<StepScalingPolicyConfiguration, JsonUnmarshallerContext> {
    ...
    public static StepScalingPolicyConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new StepScalingPolicyConfigurationJsonUnmarshaller();
        return instance;
    }
}
