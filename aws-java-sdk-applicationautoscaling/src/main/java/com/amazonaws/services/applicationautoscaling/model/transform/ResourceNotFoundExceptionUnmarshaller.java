...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationautoscaling.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.applicationautoscaling.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.applicationautoscaling.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.applicationautoscaling.model.ResourceNotFoundException(
                null);
