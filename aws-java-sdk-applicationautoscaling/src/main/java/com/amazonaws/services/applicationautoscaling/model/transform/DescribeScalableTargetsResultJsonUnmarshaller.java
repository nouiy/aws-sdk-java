...
public class DescribeScalableTargetsResultJsonUnmarshaller implements Unmarshaller<DescribeScalableTargetsResult, JsonUnmarshallerContext> {

    public DescribeScalableTargetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeScalableTargetsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
