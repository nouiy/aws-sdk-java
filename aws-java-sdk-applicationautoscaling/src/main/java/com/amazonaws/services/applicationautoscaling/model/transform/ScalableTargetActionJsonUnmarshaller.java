...
/**
 * ScalableTargetAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScalableTargetActionJsonUnmarshaller implements Unmarshaller<ScalableTargetAction, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("MinCapacity", targetDepth)) {
                    context.nextToken();
                    scalableTargetAction.setMinCapacity(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("MaxCapacity", targetDepth)) {
                    context.nextToken();
                    scalableTargetAction.setMaxCapacity(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
