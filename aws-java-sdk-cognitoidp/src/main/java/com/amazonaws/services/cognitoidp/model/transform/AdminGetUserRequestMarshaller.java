...
@SdkInternalApi
public class AdminGetUserRequestMarshaller {
    ...
    private static final AdminGetUserRequestMarshaller instance = new AdminGetUserRequestMarshaller();

    public static AdminGetUserRequestMarshaller getInstance() {
        return instance;
    }
