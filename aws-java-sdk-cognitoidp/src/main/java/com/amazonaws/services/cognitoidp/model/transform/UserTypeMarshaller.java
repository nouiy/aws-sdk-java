...
public class UserTypeMarshaller {
    ...
    public void marshall(UserType userType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(userType.getUsername(), USERNAME_BINDING);
            protocolMarshaller.marshall(userType.getAttributes(), ATTRIBUTES_BINDING);
            protocolMarshaller.marshall(userType.getUserCreateDate(), USERCREATEDATE_BINDING);
            protocolMarshaller.marshall(userType.getUserLastModifiedDate(), USERLASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(userType.getEnabled(), ENABLED_BINDING);
            protocolMarshaller.marshall(userType.getUserStatus(), USERSTATUS_BINDING);
            protocolMarshaller.marshall(userType.getMFAOptions(), MFAOPTIONS_BINDING);
        } catch (Exception e) {
