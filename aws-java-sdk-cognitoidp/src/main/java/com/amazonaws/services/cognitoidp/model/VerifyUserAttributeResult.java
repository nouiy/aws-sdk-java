...
public class VerifyUserAttributeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VerifyUserAttributeResult == false)
            return false;
        VerifyUserAttributeResult other = (VerifyUserAttributeResult) obj;
        return true;
    }
    ...
    public VerifyUserAttributeResult clone() {
        try {
            return (VerifyUserAttributeResult) super.clone();
