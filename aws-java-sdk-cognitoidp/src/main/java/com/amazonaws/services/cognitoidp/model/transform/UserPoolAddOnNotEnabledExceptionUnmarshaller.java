...
public class UserPoolAddOnNotEnabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UserPoolAddOnNotEnabledExceptionUnmarshaller instance;

    public static UserPoolAddOnNotEnabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserPoolAddOnNotEnabledExceptionUnmarshaller();
        return instance;
    }
}
