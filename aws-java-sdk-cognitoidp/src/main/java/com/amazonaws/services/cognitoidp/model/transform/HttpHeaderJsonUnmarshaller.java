        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("headerName", targetDepth)) {
                    context.nextToken();
                    httpHeader.setHeaderName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("headerValue", targetDepth)) {
                    context.nextToken();
                    httpHeader.setHeaderValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
