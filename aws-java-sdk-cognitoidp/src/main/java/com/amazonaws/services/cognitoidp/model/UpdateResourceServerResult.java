...
public class UpdateResourceServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateResourceServerResult withResourceServer(ResourceServerType resourceServer) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateResourceServerResult == false)
            return false;
        UpdateResourceServerResult other = (UpdateResourceServerResult) obj;
    ...
    @Override
    public UpdateResourceServerResult clone() {
        try {
            return (UpdateResourceServerResult) super.clone();
