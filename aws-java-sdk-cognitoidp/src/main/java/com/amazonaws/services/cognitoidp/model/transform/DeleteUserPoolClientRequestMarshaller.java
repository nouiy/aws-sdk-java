...
public class DeleteUserPoolClientRequestMarshaller {
    ...
    private static final DeleteUserPoolClientRequestMarshaller instance = new DeleteUserPoolClientRequestMarshaller();

    public static DeleteUserPoolClientRequestMarshaller getInstance() {
        return instance;
    }
