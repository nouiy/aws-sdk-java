...
@SdkInternalApi
public class RevokeTokenRequestMarshaller {
    ...
    private static final RevokeTokenRequestMarshaller instance = new RevokeTokenRequestMarshaller();

    public static RevokeTokenRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RevokeTokenRequest revokeTokenRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(revokeTokenRequest.getToken(), TOKEN_BINDING);
            protocolMarshaller.marshall(revokeTokenRequest.getClientId(), CLIENTID_BINDING);
            protocolMarshaller.marshall(revokeTokenRequest.getClientSecret(), CLIENTSECRET_BINDING);
        } catch (Exception e) {
