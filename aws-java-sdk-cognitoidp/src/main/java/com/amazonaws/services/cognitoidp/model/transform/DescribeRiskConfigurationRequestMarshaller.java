...
@SdkInternalApi
public class DescribeRiskConfigurationRequestMarshaller {
    ...
    private static final DescribeRiskConfigurationRequestMarshaller instance = new DescribeRiskConfigurationRequestMarshaller();

    public static DescribeRiskConfigurationRequestMarshaller getInstance() {
        return instance;
    }
