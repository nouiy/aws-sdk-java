...
/**
 * EventFeedbackType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EventFeedbackTypeJsonUnmarshaller implements Unmarshaller<EventFeedbackType, JsonUnmarshallerContext> {

    public EventFeedbackType unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FeedbackValue", targetDepth)) {
                    context.nextToken();
                    eventFeedbackType.setFeedbackValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Provider", targetDepth)) {
                    context.nextToken();
                    eventFeedbackType.setProvider(context.getUnmarshaller(String.class).unmarshall(context));
                }
