...
/**
 * RecoveryOptionType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RecoveryOptionTypeJsonUnmarshaller implements Unmarshaller<RecoveryOptionType, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Priority", targetDepth)) {
                    context.nextToken();
                    recoveryOptionType.setPriority(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    recoveryOptionType.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
