...
/**
 * DeleteResourceServerResult JSON Unmarshaller
 */
...
public class DeleteResourceServerResultJsonUnmarshaller implements Unmarshaller<DeleteResourceServerResult, JsonUnmarshallerContext> {
    ...
    public DeleteResourceServerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteResourceServerResult deleteResourceServerResult = new DeleteResourceServerResult();
