...
public class SetUserSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SetUserSettingsResult == false)
            return false;
        SetUserSettingsResult other = (SetUserSettingsResult) obj;
        return true;
    }
    ...
    @Override
    public SetUserSettingsResult clone() {
        try {
            return (SetUserSettingsResult) super.clone();
