...
public class DescribeResourceServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeResourceServerResult == false)
            return false;
        DescribeResourceServerResult other = (DescribeResourceServerResult) obj;
    ...
    @Override
    public DescribeResourceServerResult clone() {
        try {
            return (DescribeResourceServerResult) super.clone();
