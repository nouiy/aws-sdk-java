...
/**
 * AdminUpdateDeviceStatusResult JSON Unmarshaller
 */
...
public class AdminUpdateDeviceStatusResultJsonUnmarshaller implements Unmarshaller<AdminUpdateDeviceStatusResult, JsonUnmarshallerContext> {
    ...
    public AdminUpdateDeviceStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AdminUpdateDeviceStatusResult adminUpdateDeviceStatusResult = new AdminUpdateDeviceStatusResult();
