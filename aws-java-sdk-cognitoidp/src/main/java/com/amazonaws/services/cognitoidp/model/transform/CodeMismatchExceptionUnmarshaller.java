...
public class CodeMismatchExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CodeMismatchExceptionUnmarshaller instance;

    public static CodeMismatchExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeMismatchExceptionUnmarshaller();
        return instance;
    }
}
