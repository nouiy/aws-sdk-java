...
@SdkInternalApi
public class ListUserPoolsRequestMarshaller {
    ...
    private static final ListUserPoolsRequestMarshaller instance = new ListUserPoolsRequestMarshaller();

    public static ListUserPoolsRequestMarshaller getInstance() {
        return instance;
    }
