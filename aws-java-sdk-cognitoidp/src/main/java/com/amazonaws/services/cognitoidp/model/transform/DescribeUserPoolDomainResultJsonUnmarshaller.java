...
/**
 * DescribeUserPoolDomainResult JSON Unmarshaller
 */
...
public class DescribeUserPoolDomainResultJsonUnmarshaller implements Unmarshaller<DescribeUserPoolDomainResult, JsonUnmarshallerContext> {
    ...
    public DescribeUserPoolDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DomainDescription", targetDepth)) {
                    context.nextToken();
                    describeUserPoolDomainResult.setDomainDescription(DomainDescriptionTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
