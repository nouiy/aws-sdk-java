...
public class GetDeviceRequestMarshaller {
    ...
    public void marshall(GetDeviceRequest getDeviceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getDeviceRequest.getDeviceKey(), DEVICEKEY_BINDING);
            protocolMarshaller.marshall(getDeviceRequest.getAccessToken(), ACCESSTOKEN_BINDING);
        } catch (Exception e) {
