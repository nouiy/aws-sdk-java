...
/**
 * GetSigningCertificateResult JSON Unmarshaller
 */
...
public class GetSigningCertificateResultJsonUnmarshaller implements Unmarshaller<GetSigningCertificateResult, JsonUnmarshallerContext> {
    ...
    public GetSigningCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Certificate", targetDepth)) {
                    context.nextToken();
                    getSigningCertificateResult.setCertificate(context.getUnmarshaller(String.class).unmarshall(context));
                }
