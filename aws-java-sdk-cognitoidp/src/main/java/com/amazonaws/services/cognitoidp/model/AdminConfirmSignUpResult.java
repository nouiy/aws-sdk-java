...
public class AdminConfirmSignUpResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdminConfirmSignUpResult == false)
            return false;
        AdminConfirmSignUpResult other = (AdminConfirmSignUpResult) obj;
        return true;
    }
    ...
    @Override
    public AdminConfirmSignUpResult clone() {
        try {
            return (AdminConfirmSignUpResult) super.clone();
