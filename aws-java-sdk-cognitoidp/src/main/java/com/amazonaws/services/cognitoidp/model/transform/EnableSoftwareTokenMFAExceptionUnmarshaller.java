...
public class EnableSoftwareTokenMFAExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static EnableSoftwareTokenMFAExceptionUnmarshaller instance;

    public static EnableSoftwareTokenMFAExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new EnableSoftwareTokenMFAExceptionUnmarshaller();
        return instance;
    }
}
