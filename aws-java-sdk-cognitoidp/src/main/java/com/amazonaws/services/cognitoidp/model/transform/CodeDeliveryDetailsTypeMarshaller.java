...
public class CodeDeliveryDetailsTypeMarshaller {
    ...
    public void marshall(CodeDeliveryDetailsType codeDeliveryDetailsType, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(codeDeliveryDetailsType.getDestination(), DESTINATION_BINDING);
            protocolMarshaller.marshall(codeDeliveryDetailsType.getDeliveryMedium(), DELIVERYMEDIUM_BINDING);
            protocolMarshaller.marshall(codeDeliveryDetailsType.getAttributeName(), ATTRIBUTENAME_BINDING);
        } catch (Exception e) {
