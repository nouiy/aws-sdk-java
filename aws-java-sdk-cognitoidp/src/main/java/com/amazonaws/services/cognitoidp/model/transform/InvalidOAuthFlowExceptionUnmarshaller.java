...
public class InvalidOAuthFlowExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidOAuthFlowExceptionUnmarshaller instance;

    public static InvalidOAuthFlowExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidOAuthFlowExceptionUnmarshaller();
        return instance;
    }
}
