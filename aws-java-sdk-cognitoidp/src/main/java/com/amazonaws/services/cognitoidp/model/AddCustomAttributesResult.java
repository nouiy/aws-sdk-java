...
public class AddCustomAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddCustomAttributesResult == false)
            return false;
        AddCustomAttributesResult other = (AddCustomAttributesResult) obj;
        return true;
    }
    ...
    @Override
    public AddCustomAttributesResult clone() {
        try {
            return (AddCustomAttributesResult) super.clone();
