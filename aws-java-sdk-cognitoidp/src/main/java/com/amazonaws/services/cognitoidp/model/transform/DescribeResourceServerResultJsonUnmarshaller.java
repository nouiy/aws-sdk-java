...
/**
 * DescribeResourceServerResult JSON Unmarshaller
 */
...
public class DescribeResourceServerResultJsonUnmarshaller implements Unmarshaller<DescribeResourceServerResult, JsonUnmarshallerContext> {
    ...
    public DescribeResourceServerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceServer", targetDepth)) {
                    context.nextToken();
                    describeResourceServerResult.setResourceServer(ResourceServerTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
