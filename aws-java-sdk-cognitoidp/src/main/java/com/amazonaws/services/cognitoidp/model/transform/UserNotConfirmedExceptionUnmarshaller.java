...
public class UserNotConfirmedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UserNotConfirmedExceptionUnmarshaller instance;

    public static UserNotConfirmedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserNotConfirmedExceptionUnmarshaller();
        return instance;
    }
}
