...
public class UnsupportedUserStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedUserStateExceptionUnmarshaller instance;

    public static UnsupportedUserStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedUserStateExceptionUnmarshaller();
        return instance;
    }
}
