...
public class ForgetDeviceResultJsonUnmarshaller implements Unmarshaller<ForgetDeviceResult, JsonUnmarshallerContext> {
    ...
    public ForgetDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ForgetDeviceResult forgetDeviceResult = new ForgetDeviceResult();

        return forgetDeviceResult;
    }

    private static ForgetDeviceResultJsonUnmarshaller instance;

    public static ForgetDeviceResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ForgetDeviceResultJsonUnmarshaller();
        return instance;
    }
}
