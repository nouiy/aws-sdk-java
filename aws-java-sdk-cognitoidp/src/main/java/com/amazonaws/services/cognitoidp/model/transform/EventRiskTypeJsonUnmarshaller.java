...
/**
 * EventRiskType JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EventRiskTypeJsonUnmarshaller implements Unmarshaller<EventRiskType, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RiskDecision", targetDepth)) {
                    context.nextToken();
                    eventRiskType.setRiskDecision(context.getUnmarshaller(String.class).unmarshall(context));
                }
