...
public class DescribeIdentityProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public DescribeIdentityProviderResult clone() {
        try {
            return (DescribeIdentityProviderResult) super.clone();
