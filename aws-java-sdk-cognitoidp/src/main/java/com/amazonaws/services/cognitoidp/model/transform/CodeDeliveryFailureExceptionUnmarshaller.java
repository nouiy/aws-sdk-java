...
public class CodeDeliveryFailureExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CodeDeliveryFailureExceptionUnmarshaller instance;

    public static CodeDeliveryFailureExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeDeliveryFailureExceptionUnmarshaller();
        return instance;
    }
}
