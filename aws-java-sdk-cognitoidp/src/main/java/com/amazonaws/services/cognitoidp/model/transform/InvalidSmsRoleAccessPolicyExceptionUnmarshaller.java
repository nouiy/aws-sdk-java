...
public class InvalidSmsRoleAccessPolicyExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSmsRoleAccessPolicyExceptionUnmarshaller instance;

    public static InvalidSmsRoleAccessPolicyExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSmsRoleAccessPolicyExceptionUnmarshaller();
        return instance;
    }
}
