...
public class InvalidLambdaResponseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidLambdaResponseExceptionUnmarshaller instance;

    public static InvalidLambdaResponseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidLambdaResponseExceptionUnmarshaller();
        return instance;
    }
}
