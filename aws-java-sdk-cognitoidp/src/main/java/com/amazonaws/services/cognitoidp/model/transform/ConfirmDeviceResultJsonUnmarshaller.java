...
/**
 * ConfirmDeviceResult JSON Unmarshaller
 */
...
public class ConfirmDeviceResultJsonUnmarshaller implements Unmarshaller<ConfirmDeviceResult, JsonUnmarshallerContext> {
    ...
    public ConfirmDeviceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UserConfirmationNecessary", targetDepth)) {
                    context.nextToken();
                    confirmDeviceResult.setUserConfirmationNecessary(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
