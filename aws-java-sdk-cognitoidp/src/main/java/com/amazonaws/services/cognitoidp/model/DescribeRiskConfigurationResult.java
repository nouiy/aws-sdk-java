...
public class DescribeRiskConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeRiskConfigurationResult withRiskConfiguration(RiskConfigurationType riskConfiguration) {
    ...
    @Override
    public DescribeRiskConfigurationResult clone() {
        try {
