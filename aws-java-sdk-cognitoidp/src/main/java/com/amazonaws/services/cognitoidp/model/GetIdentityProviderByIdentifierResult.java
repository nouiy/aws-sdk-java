...
public class GetIdentityProviderByIdentifierResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetIdentityProviderByIdentifierResult withIdentityProvider(IdentityProviderType identityProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIdentityProviderByIdentifierResult == false)
            return false;
        GetIdentityProviderByIdentifierResult other = (GetIdentityProviderByIdentifierResult) obj;
    ...
    @Override
    public GetIdentityProviderByIdentifierResult clone() {
        try {
            return (GetIdentityProviderByIdentifierResult) super.clone();
