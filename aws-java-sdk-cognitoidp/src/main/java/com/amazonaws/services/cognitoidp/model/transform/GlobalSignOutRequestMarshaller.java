...
public class GlobalSignOutRequestMarshaller {
    ...
    private static final GlobalSignOutRequestMarshaller instance = new GlobalSignOutRequestMarshaller();

    public static GlobalSignOutRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(GlobalSignOutRequest globalSignOutRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(globalSignOutRequest.getAccessToken(), ACCESSTOKEN_BINDING);
        } catch (Exception e) {
