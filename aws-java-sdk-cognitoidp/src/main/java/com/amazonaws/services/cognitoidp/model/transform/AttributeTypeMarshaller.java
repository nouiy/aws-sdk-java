...
@SdkInternalApi
public class AttributeTypeMarshaller {
    ...
    private static final AttributeTypeMarshaller instance = new AttributeTypeMarshaller();

    public static AttributeTypeMarshaller getInstance() {
        return instance;
    }
