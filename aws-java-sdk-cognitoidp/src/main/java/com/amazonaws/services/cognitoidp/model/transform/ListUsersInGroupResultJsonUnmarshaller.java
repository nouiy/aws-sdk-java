...
/**
 * ListUsersInGroupResult JSON Unmarshaller
 */
...
public class ListUsersInGroupResultJsonUnmarshaller implements Unmarshaller<ListUsersInGroupResult, JsonUnmarshallerContext> {
    ...
    public ListUsersInGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Users", targetDepth)) {
                    context.nextToken();
                    listUsersInGroupResult.setUsers(new ListUnmarshaller<UserType>(UserTypeJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listUsersInGroupResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
