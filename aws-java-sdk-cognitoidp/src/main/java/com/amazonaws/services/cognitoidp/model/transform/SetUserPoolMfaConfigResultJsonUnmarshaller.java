...
/**
 * SetUserPoolMfaConfigResult JSON Unmarshaller
 */
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SmsMfaConfiguration", targetDepth)) {
                    context.nextToken();
                    setUserPoolMfaConfigResult.setSmsMfaConfiguration(SmsMfaConfigTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("SoftwareTokenMfaConfiguration", targetDepth)) {
                    context.nextToken();
                    setUserPoolMfaConfigResult.setSoftwareTokenMfaConfiguration(SoftwareTokenMfaConfigTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("MfaConfiguration", targetDepth)) {
                    context.nextToken();
                    setUserPoolMfaConfigResult.setMfaConfiguration(context.getUnmarshaller(String.class).unmarshall(context));
                }
