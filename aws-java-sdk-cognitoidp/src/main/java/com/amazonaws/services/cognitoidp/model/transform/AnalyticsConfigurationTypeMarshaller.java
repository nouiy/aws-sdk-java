...
/**
 * AnalyticsConfigurationTypeMarshaller
 */
...
public class AnalyticsConfigurationTypeMarshaller {
    ...
    private static final MarshallingInfo<Boolean> USERDATASHARED_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("UserDataShared").build();
