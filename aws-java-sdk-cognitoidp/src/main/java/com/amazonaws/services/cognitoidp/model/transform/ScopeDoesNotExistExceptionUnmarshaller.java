...
public class ScopeDoesNotExistExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ScopeDoesNotExistExceptionUnmarshaller instance;

    public static ScopeDoesNotExistExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ScopeDoesNotExistExceptionUnmarshaller();
        return instance;
    }
}
