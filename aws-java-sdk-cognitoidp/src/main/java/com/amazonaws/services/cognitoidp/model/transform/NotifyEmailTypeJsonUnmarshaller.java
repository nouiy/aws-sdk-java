        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Subject", targetDepth)) {
                    context.nextToken();
                    notifyEmailType.setSubject(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("HtmlBody", targetDepth)) {
                    context.nextToken();
                    notifyEmailType.setHtmlBody(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("TextBody", targetDepth)) {
                    context.nextToken();
                    notifyEmailType.setTextBody(context.getUnmarshaller(String.class).unmarshall(context));
                }
