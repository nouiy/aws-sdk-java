...
public class AdminConfirmSignUpResultJsonUnmarshaller implements Unmarshaller<AdminConfirmSignUpResult, JsonUnmarshallerContext> {
    ...
    public AdminConfirmSignUpResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AdminConfirmSignUpResult adminConfirmSignUpResult = new AdminConfirmSignUpResult();
