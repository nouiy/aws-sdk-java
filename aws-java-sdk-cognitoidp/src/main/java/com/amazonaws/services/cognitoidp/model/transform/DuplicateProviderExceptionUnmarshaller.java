...
public class DuplicateProviderExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicateProviderExceptionUnmarshaller instance;

    public static DuplicateProviderExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateProviderExceptionUnmarshaller();
        return instance;
    }
}
