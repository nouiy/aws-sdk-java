...
public class InvalidUserPoolConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidUserPoolConfigurationExceptionUnmarshaller instance;

    public static InvalidUserPoolConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidUserPoolConfigurationExceptionUnmarshaller();
        return instance;
    }
}
