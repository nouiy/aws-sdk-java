...
public class AddCustomAttributesRequestMarshaller {
    ...
    private static final AddCustomAttributesRequestMarshaller instance = new AddCustomAttributesRequestMarshaller();

    public static AddCustomAttributesRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(AddCustomAttributesRequest addCustomAttributesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(addCustomAttributesRequest.getUserPoolId(), USERPOOLID_BINDING);
            protocolMarshaller.marshall(addCustomAttributesRequest.getCustomAttributes(), CUSTOMATTRIBUTES_BINDING);
        } catch (Exception e) {
