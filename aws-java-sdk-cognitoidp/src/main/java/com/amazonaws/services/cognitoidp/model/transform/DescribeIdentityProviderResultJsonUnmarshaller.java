...
/**
 * DescribeIdentityProviderResult JSON Unmarshaller
 */
...
public class DescribeIdentityProviderResultJsonUnmarshaller implements Unmarshaller<DescribeIdentityProviderResult, JsonUnmarshallerContext> {
    ...
    public DescribeIdentityProviderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IdentityProvider", targetDepth)) {
                    context.nextToken();
                    describeIdentityProviderResult.setIdentityProvider(IdentityProviderTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
