...
/**
 * UpdateResourceServerResult JSON Unmarshaller
 */
...
public class UpdateResourceServerResultJsonUnmarshaller implements Unmarshaller<UpdateResourceServerResult, JsonUnmarshallerContext> {
    ...
    public UpdateResourceServerResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceServer", targetDepth)) {
                    context.nextToken();
                    updateResourceServerResult.setResourceServer(ResourceServerTypeJsonUnmarshaller.getInstance().unmarshall(context));
                }
