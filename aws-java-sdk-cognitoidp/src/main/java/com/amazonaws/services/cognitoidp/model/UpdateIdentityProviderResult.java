...
public class UpdateIdentityProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateIdentityProviderResult withIdentityProvider(IdentityProviderType identityProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateIdentityProviderResult == false)
            return false;
        UpdateIdentityProviderResult other = (UpdateIdentityProviderResult) obj;
    ...
    @Override
    public UpdateIdentityProviderResult clone() {
        try {
            return (UpdateIdentityProviderResult) super.clone();
