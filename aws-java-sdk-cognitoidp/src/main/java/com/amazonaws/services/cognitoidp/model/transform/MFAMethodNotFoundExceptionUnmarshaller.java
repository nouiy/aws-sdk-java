...
public class MFAMethodNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static MFAMethodNotFoundExceptionUnmarshaller instance;

    public static MFAMethodNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MFAMethodNotFoundExceptionUnmarshaller();
        return instance;
    }
}
