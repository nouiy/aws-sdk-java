...
public class DeleteUserPoolClientResultJsonUnmarshaller implements Unmarshaller<DeleteUserPoolClientResult, JsonUnmarshallerContext> {
    ...
    public DeleteUserPoolClientResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteUserPoolClientResult deleteUserPoolClientResult = new DeleteUserPoolClientResult();
