...
public class ExpiredCodeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ExpiredCodeExceptionUnmarshaller instance;

    public static ExpiredCodeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExpiredCodeExceptionUnmarshaller();
        return instance;
    }
}
