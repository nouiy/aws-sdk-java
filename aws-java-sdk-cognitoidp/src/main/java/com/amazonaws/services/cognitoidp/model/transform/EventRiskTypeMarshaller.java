...
/**
 * EventRiskTypeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EventRiskTypeMarshaller {

    private static final MarshallingInfo<String> RISKDECISION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static EventRiskTypeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(EventRiskType eventRiskType, ProtocolMarshaller protocolMarshaller) {

        if (eventRiskType == null) {
