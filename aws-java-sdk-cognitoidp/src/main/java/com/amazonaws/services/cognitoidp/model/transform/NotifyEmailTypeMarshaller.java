...
/**
 * NotifyEmailTypeMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NotifyEmailTypeMarshaller {
    ...
    private static final MarshallingInfo<String> TEXTBODY_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("TextBody").build();

    private static final NotifyEmailTypeMarshaller instance = new NotifyEmailTypeMarshaller();

    public static NotifyEmailTypeMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NotifyEmailType notifyEmailType, ProtocolMarshaller protocolMarshaller) {
