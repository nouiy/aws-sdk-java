...
/**
 * DeregisterWorkspaceDirectoryResult JSON Unmarshaller
 */
...
public class DeregisterWorkspaceDirectoryResultJsonUnmarshaller implements Unmarshaller<DeregisterWorkspaceDirectoryResult, JsonUnmarshallerContext> {
    ...
    public DeregisterWorkspaceDirectoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterWorkspaceDirectoryResult deregisterWorkspaceDirectoryResult = new DeregisterWorkspaceDirectoryResult();
