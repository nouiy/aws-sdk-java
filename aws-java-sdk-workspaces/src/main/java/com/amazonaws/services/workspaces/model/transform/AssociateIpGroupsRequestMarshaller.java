...
/**
 * AssociateIpGroupsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateIpGroupsRequestMarshaller {
    ...
    private static final AssociateIpGroupsRequestMarshaller instance = new AssociateIpGroupsRequestMarshaller();

    public static AssociateIpGroupsRequestMarshaller getInstance() {
        return instance;
    }
