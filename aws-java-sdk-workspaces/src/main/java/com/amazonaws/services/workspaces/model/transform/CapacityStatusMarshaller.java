...
/**
 * CapacityStatusMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CapacityStatusMarshaller {
    ...
    private static final CapacityStatusMarshaller instance = new CapacityStatusMarshaller();

    public static CapacityStatusMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CapacityStatus capacityStatus, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(capacityStatus.getAvailableUserSessions(), AVAILABLEUSERSESSIONS_BINDING);
            protocolMarshaller.marshall(capacityStatus.getDesiredUserSessions(), DESIREDUSERSESSIONS_BINDING);
            protocolMarshaller.marshall(capacityStatus.getActualUserSessions(), ACTUALUSERSESSIONS_BINDING);
            protocolMarshaller.marshall(capacityStatus.getActiveUserSessions(), ACTIVEUSERSESSIONS_BINDING);
        } catch (Exception e) {
