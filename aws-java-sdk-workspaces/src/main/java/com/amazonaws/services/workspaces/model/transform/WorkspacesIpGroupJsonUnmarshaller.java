...
/**
 * WorkspacesIpGroup JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WorkspacesIpGroupJsonUnmarshaller implements Unmarshaller<WorkspacesIpGroup, JsonUnmarshallerContext> {

    public WorkspacesIpGroup unmarshall(JsonUnmarshallerContext context) throws Exception {
        WorkspacesIpGroup workspacesIpGroup = new WorkspacesIpGroup();
    ...
    private static WorkspacesIpGroupJsonUnmarshaller instance;

    public static WorkspacesIpGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkspacesIpGroupJsonUnmarshaller();
        return instance;
    }
}
