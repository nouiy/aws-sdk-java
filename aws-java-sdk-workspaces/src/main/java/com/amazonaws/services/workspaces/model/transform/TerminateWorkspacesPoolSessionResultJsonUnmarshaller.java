...
/**
 * TerminateWorkspacesPoolSessionResult JSON Unmarshaller
 */
...
public class TerminateWorkspacesPoolSessionResultJsonUnmarshaller implements Unmarshaller<TerminateWorkspacesPoolSessionResult, JsonUnmarshallerContext> {
    ...
    public TerminateWorkspacesPoolSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        TerminateWorkspacesPoolSessionResult terminateWorkspacesPoolSessionResult = new TerminateWorkspacesPoolSessionResult();
