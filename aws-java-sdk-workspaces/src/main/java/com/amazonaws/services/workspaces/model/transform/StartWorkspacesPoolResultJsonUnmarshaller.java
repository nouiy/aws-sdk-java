...
/**
 * StartWorkspacesPoolResult JSON Unmarshaller
 */
...
public class StartWorkspacesPoolResultJsonUnmarshaller implements Unmarshaller<StartWorkspacesPoolResult, JsonUnmarshallerContext> {
    ...
    public StartWorkspacesPoolResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartWorkspacesPoolResult startWorkspacesPoolResult = new StartWorkspacesPoolResult();
