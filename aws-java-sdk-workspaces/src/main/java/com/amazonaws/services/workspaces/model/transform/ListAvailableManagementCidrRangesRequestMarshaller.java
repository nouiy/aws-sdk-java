...
@SdkInternalApi
public class ListAvailableManagementCidrRangesRequestMarshaller {

    private static final MarshallingInfo<String> MANAGEMENTCIDRRANGECONSTRAINT_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ManagementCidrRangeConstraint").build();
    private static final MarshallingInfo<Integer> MAXRESULTS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MaxResults").build();
    private static final MarshallingInfo<String> NEXTTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("NextToken").build();

    private static final ListAvailableManagementCidrRangesRequestMarshaller instance = new ListAvailableManagementCidrRangesRequestMarshaller();

    public static ListAvailableManagementCidrRangesRequestMarshaller getInstance() {
        return instance;
    }
