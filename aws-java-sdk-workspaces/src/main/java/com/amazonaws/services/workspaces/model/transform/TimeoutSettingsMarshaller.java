...
/**
 * TimeoutSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TimeoutSettingsMarshaller {
    ...
    private static final TimeoutSettingsMarshaller instance = new TimeoutSettingsMarshaller();

    public static TimeoutSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TimeoutSettings timeoutSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(timeoutSettings.getDisconnectTimeoutInSeconds(), DISCONNECTTIMEOUTINSECONDS_BINDING);
            protocolMarshaller.marshall(timeoutSettings.getIdleDisconnectTimeoutInSeconds(), IDLEDISCONNECTTIMEOUTINSECONDS_BINDING);
            protocolMarshaller.marshall(timeoutSettings.getMaxUserDurationInSeconds(), MAXUSERDURATIONINSECONDS_BINDING);
        } catch (Exception e) {
