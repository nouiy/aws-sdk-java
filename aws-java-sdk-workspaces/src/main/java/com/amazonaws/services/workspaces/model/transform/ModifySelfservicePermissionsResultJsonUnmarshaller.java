...
/**
 * ModifySelfservicePermissionsResult JSON Unmarshaller
 */
...
public class ModifySelfservicePermissionsResultJsonUnmarshaller implements Unmarshaller<ModifySelfservicePermissionsResult, JsonUnmarshallerContext> {
    ...
    public ModifySelfservicePermissionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModifySelfservicePermissionsResult modifySelfservicePermissionsResult = new ModifySelfservicePermissionsResult();
