 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/workspaces-2015-04-08/ApplicationSettingsResponse"
...
public class ApplicationSettingsResponse implements Serializable, Cloneable, StructuredPojo {
     ...
     * enabled for the first time for an account in an Amazon Web Services Region, an S3 bucket is created. The bucket
     ...
     * </p>
     * 
     * @return Specifies whether persistent application settings are enabled for users during their pool sessions.
     * @see ApplicationSettingsStatusEnum
     */
     ...
     *        created. The bucket is unique to the Amazon Web Services account and the Region.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.workspaces.model.transform.ApplicationSettingsResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
