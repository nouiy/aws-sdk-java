...
public class DescribeClientPropertiesRequestMarshaller {
    ...
    private static final DescribeClientPropertiesRequestMarshaller instance = new DescribeClientPropertiesRequestMarshaller();

    public static DescribeClientPropertiesRequestMarshaller getInstance() {
        return instance;
    }
