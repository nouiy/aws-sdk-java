...
public class DescribeWorkspacesPoolSessionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public java.util.List<WorkspacesPoolSession> getSessions() {
        if (sessions == null) {
            sessions = new com.amazonaws.internal.SdkInternalList<WorkspacesPoolSession>();
        }
        return sessions;
    }
    ...
    public void setSessions(java.util.Collection<WorkspacesPoolSession> sessions) {
        ...
        this.sessions = new com.amazonaws.internal.SdkInternalList<WorkspacesPoolSession>(sessions);
    }
    ...
    public DescribeWorkspacesPoolSessionsResult withSessions(WorkspacesPoolSession... sessions) {
        if (this.sessions == null) {
            setSessions(new com.amazonaws.internal.SdkInternalList<WorkspacesPoolSession>(sessions.length));
        }
        for (WorkspacesPoolSession ele : sessions) {
    ...
    public DescribeWorkspacesPoolSessionsResult withSessions(java.util.Collection<WorkspacesPoolSession> sessions) {
    ...
    public DescribeWorkspacesPoolSessionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeWorkspacesPoolSessionsResult == false)
            return false;
        DescribeWorkspacesPoolSessionsResult other = (DescribeWorkspacesPoolSessionsResult) obj;
    ...
    public DescribeWorkspacesPoolSessionsResult clone() {
        try {
            return (DescribeWorkspacesPoolSessionsResult) super.clone();
