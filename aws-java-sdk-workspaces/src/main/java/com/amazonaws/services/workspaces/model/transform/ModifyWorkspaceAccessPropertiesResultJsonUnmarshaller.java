...
/**
 * ModifyWorkspaceAccessPropertiesResult JSON Unmarshaller
 */
...
public class ModifyWorkspaceAccessPropertiesResultJsonUnmarshaller implements Unmarshaller<ModifyWorkspaceAccessPropertiesResult, JsonUnmarshallerContext> {
    ...
    public ModifyWorkspaceAccessPropertiesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModifyWorkspaceAccessPropertiesResult modifyWorkspaceAccessPropertiesResult = new ModifyWorkspaceAccessPropertiesResult();
