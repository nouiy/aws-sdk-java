...
public class ResourceCreationFailedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ResourceCreationFailedExceptionUnmarshaller instance;

    public static ResourceCreationFailedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResourceCreationFailedExceptionUnmarshaller();
        return instance;
    }
}
