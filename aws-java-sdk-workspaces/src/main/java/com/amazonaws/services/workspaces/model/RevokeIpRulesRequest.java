...
public class RevokeIpRulesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<String> userRules;
    ...
    public java.util.List<String> getUserRules() {
        if (userRules == null) {
            userRules = new com.amazonaws.internal.SdkInternalList<String>();
        }
        return userRules;
    }
    ...
    public void setUserRules(java.util.Collection<String> userRules) {
        if (userRules == null) {
            this.userRules = null;
            return;
        }

        this.userRules = new com.amazonaws.internal.SdkInternalList<String>(userRules);
    }
    ...
    public RevokeIpRulesRequest withUserRules(String... userRules) {
        if (this.userRules == null) {
            setUserRules(new com.amazonaws.internal.SdkInternalList<String>(userRules.length));
        }
        for (String ele : userRules) {
    ...
    public RevokeIpRulesRequest withUserRules(java.util.Collection<String> userRules) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RevokeIpRulesRequest == false)
            return false;
    ...
    public RevokeIpRulesRequest clone() {
        return (RevokeIpRulesRequest) super.clone();
    }
