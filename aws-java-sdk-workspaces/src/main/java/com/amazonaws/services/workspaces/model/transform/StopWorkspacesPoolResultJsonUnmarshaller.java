...
/**
 * StopWorkspacesPoolResult JSON Unmarshaller
 */
...
public class StopWorkspacesPoolResultJsonUnmarshaller implements Unmarshaller<StopWorkspacesPoolResult, JsonUnmarshallerContext> {
    ...
    public StopWorkspacesPoolResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopWorkspacesPoolResult stopWorkspacesPoolResult = new StopWorkspacesPoolResult();
