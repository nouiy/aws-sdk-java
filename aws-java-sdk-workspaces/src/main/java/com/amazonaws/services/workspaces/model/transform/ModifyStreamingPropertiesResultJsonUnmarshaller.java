...
/**
 * ModifyStreamingPropertiesResult JSON Unmarshaller
 */
...
public class ModifyStreamingPropertiesResultJsonUnmarshaller implements Unmarshaller<ModifyStreamingPropertiesResult, JsonUnmarshallerContext> {
    ...
    public ModifyStreamingPropertiesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ModifyStreamingPropertiesResult modifyStreamingPropertiesResult = new ModifyStreamingPropertiesResult();
