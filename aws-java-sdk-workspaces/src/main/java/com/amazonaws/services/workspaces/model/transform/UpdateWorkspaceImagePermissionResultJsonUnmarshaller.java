...
/**
 * UpdateWorkspaceImagePermissionResult JSON Unmarshaller
 */
...
public class UpdateWorkspaceImagePermissionResultJsonUnmarshaller implements Unmarshaller<UpdateWorkspaceImagePermissionResult, JsonUnmarshallerContext> {
    ...
    public UpdateWorkspaceImagePermissionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateWorkspaceImagePermissionResult updateWorkspaceImagePermissionResult = new UpdateWorkspaceImagePermissionResult();
