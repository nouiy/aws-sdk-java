...
@SdkInternalApi
public class OrderByMarshaller {
    ...
    private static final OrderByMarshaller instance = new OrderByMarshaller();

    public static OrderByMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OrderBy orderBy, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(orderBy.getOrder(), ORDER_BINDING);
            protocolMarshaller.marshall(orderBy.getPropertyName(), PROPERTYNAME_BINDING);
        } catch (Exception e) {
