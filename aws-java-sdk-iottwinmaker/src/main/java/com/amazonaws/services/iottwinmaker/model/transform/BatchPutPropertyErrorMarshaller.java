...
/**
 * BatchPutPropertyErrorMarshaller
 */
...
public class BatchPutPropertyErrorMarshaller {
    ...
    public static BatchPutPropertyErrorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(BatchPutPropertyError batchPutPropertyError, ProtocolMarshaller protocolMarshaller) {

        if (batchPutPropertyError == null) {
