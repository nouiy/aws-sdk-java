...
public class DeleteSceneRequestMarshaller {
    ...
    public static DeleteSceneRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteSceneRequest deleteSceneRequest, ProtocolMarshaller protocolMarshaller) {
