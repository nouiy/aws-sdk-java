...
/**
 * Fluent builder for {@link com.amazonaws.services.iottwinmaker.AWSIoTTwinMaker}. Use of the builder is preferred over
...
public final class AWSIoTTwinMakerClientBuilder extends AwsSyncClientBuilder<AWSIoTTwinMakerClientBuilder, AWSIoTTwinMaker> {
     ...
     * @return Fully configured implementation of AWSIoTTwinMaker.
     */
    @Override
    protected AWSIoTTwinMaker build(AwsSyncClientParams params) {
        return new AWSIoTTwinMakerClient(params);
    }
