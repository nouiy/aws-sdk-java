...
public class ListComponentsRequestMarshaller {
    ...
    public void marshall(ListComponentsRequest listComponentsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listComponentsRequest.getWorkspaceId(), WORKSPACEID_BINDING);
            protocolMarshaller.marshall(listComponentsRequest.getEntityId(), ENTITYID_BINDING);
            protocolMarshaller.marshall(listComponentsRequest.getComponentPath(), COMPONENTPATH_BINDING);
