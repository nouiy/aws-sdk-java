...
public class ComponentRequestMarshaller {
    ...
    public static ComponentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ComponentRequest componentRequest, ProtocolMarshaller protocolMarshaller) {
