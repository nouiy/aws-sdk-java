...
/**
 * FunctionRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FunctionRequestJsonUnmarshaller implements Unmarshaller<FunctionRequest, JsonUnmarshallerContext> {

    public FunctionRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FunctionRequestJsonUnmarshaller instance;

    public static FunctionRequestJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FunctionRequestJsonUnmarshaller();
        return instance;
    }
}
