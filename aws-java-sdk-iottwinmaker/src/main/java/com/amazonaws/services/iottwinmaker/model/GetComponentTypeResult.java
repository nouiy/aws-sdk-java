...
public class GetComponentTypeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.Map<String, CompositeComponentTypeResponse> compositeComponentTypes;
    ...
    public java.util.Map<String, CompositeComponentTypeResponse> getCompositeComponentTypes() {
    ...
    public void setCompositeComponentTypes(java.util.Map<String, CompositeComponentTypeResponse> compositeComponentTypes) {
    ...
    public GetComponentTypeResult withCompositeComponentTypes(java.util.Map<String, CompositeComponentTypeResponse> compositeComponentTypes) {
     ...
     *
     * @see GetComponentTypeResult#withCompositeComponentTypes
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetComponentTypeResult addCompositeComponentTypesEntry(String key, CompositeComponentTypeResponse value) {
        if (null == this.compositeComponentTypes) {
            this.compositeComponentTypes = new java.util.HashMap<String, CompositeComponentTypeResponse>();
        }
    ...
    public GetComponentTypeResult clearCompositeComponentTypesEntries() {
