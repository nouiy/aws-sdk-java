...
/**
 * ComponentUpdateRequest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentUpdateRequestJsonUnmarshaller implements Unmarshaller<ComponentUpdateRequest, JsonUnmarshallerContext> {

    public ComponentUpdateRequest unmarshall(JsonUnmarshallerContext context) throws Exception {
        ComponentUpdateRequest componentUpdateRequest = new ComponentUpdateRequest();
    ...
    private static ComponentUpdateRequestJsonUnmarshaller instance;

    public static ComponentUpdateRequestJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ComponentUpdateRequestJsonUnmarshaller();
        return instance;
    }
}
