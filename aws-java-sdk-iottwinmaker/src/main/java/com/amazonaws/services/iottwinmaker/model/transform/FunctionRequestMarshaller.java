...
public class FunctionRequestMarshaller {
    ...
    public static FunctionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FunctionRequest functionRequest, ProtocolMarshaller protocolMarshaller) {
