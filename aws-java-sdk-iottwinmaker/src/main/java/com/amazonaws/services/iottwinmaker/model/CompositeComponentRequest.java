 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iottwinmaker-2021-11-29/CompositeComponentRequest"
...
public class CompositeComponentRequest implements Serializable, Cloneable, StructuredPojo {
    ...
    public CompositeComponentRequest withProperties(java.util.Map<String, PropertyRequest> properties) {
    ...
    public CompositeComponentRequest withPropertyGroups(java.util.Map<String, ComponentPropertyGroupRequest> propertyGroups) {
