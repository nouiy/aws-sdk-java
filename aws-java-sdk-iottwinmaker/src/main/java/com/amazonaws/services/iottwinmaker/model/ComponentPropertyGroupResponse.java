 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iottwinmaker-2021-11-29/ComponentPropertyGroupResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ComponentPropertyGroupResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public ComponentPropertyGroupResponse withGroupType(String groupType) {
    ...
    public ComponentPropertyGroupResponse withGroupType(GroupType groupType) {
    ...
    public ComponentPropertyGroupResponse withPropertyNames(java.util.Collection<String> propertyNames) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ComponentPropertyGroupResponse == false)
            return false;
    ...
    @Override
    public ComponentPropertyGroupResponse clone() {
        try {
            return (ComponentPropertyGroupResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iottwinmaker.model.transform.ComponentPropertyGroupResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
