...
public class DeleteEntityRequestMarshaller {
    ...
    public static DeleteEntityRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteEntityRequest deleteEntityRequest, ProtocolMarshaller protocolMarshaller) {
