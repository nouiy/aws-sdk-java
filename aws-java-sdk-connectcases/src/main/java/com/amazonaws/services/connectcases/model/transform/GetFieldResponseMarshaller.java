...
public class GetFieldResponseMarshaller {
    ...
    private static final GetFieldResponseMarshaller instance = new GetFieldResponseMarshaller();

    public static GetFieldResponseMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetFieldResponse getFieldResponse, ProtocolMarshaller protocolMarshaller) {

        if (getFieldResponse == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(getFieldResponse.getType(), TYPE_BINDING);
        } catch (Exception e) {
