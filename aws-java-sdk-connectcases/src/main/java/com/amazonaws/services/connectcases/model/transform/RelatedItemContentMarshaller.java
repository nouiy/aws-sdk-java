...
/**
 * RelatedItemContentMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RelatedItemContentMarshaller {
    ...
    private static final RelatedItemContentMarshaller instance = new RelatedItemContentMarshaller();

    public static RelatedItemContentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RelatedItemContent relatedItemContent, ProtocolMarshaller protocolMarshaller) {

        if (relatedItemContent == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(relatedItemContent.getComment(), COMMENT_BINDING);
            protocolMarshaller.marshall(relatedItemContent.getContact(), CONTACT_BINDING);
        } catch (Exception e) {
