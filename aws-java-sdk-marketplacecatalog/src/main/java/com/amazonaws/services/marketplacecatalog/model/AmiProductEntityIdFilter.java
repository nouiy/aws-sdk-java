 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/AmiProductEntityIdFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AmiProductEntityIdFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public AmiProductEntityIdFilter withValueList(String... valueList) {
    ...
    public AmiProductEntityIdFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AmiProductEntityIdFilter == false)
            return false;
        AmiProductEntityIdFilter other = (AmiProductEntityIdFilter) obj;
    ...
    @Override
    public AmiProductEntityIdFilter clone() {
        try {
            return (AmiProductEntityIdFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.AmiProductEntityIdFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
