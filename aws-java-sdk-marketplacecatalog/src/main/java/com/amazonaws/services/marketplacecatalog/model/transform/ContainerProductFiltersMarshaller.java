...
/**
 * ContainerProductFiltersMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ContainerProductFiltersMarshaller {
    ...
    private static final ContainerProductFiltersMarshaller instance = new ContainerProductFiltersMarshaller();

    public static ContainerProductFiltersMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ContainerProductFilters containerProductFilters, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(containerProductFilters.getEntityId(), ENTITYID_BINDING);
            protocolMarshaller.marshall(containerProductFilters.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(containerProductFilters.getProductTitle(), PRODUCTTITLE_BINDING);
            protocolMarshaller.marshall(containerProductFilters.getVisibility(), VISIBILITY_BINDING);
        } catch (Exception e) {
