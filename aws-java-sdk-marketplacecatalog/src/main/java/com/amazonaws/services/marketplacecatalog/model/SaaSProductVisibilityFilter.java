 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/SaaSProductVisibilityFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SaaSProductVisibilityFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public SaaSProductVisibilityFilter withValueList(String... valueList) {
    ...
    public SaaSProductVisibilityFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public SaaSProductVisibilityFilter withValueList(SaaSProductVisibilityString... valueList) {
        java.util.ArrayList<String> valueListCopy = new java.util.ArrayList<String>(valueList.length);
        for (SaaSProductVisibilityString value : valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SaaSProductVisibilityFilter == false)
            return false;
        SaaSProductVisibilityFilter other = (SaaSProductVisibilityFilter) obj;
    ...
    @Override
    public SaaSProductVisibilityFilter clone() {
        try {
            return (SaaSProductVisibilityFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.SaaSProductVisibilityFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
