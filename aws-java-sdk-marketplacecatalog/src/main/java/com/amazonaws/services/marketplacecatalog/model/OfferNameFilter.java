 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferNameFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OfferNameFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>Name</code> of an offer with list input.
     */
    ...
    public OfferNameFilter withValueList(String... valueList) {
    ...
    public OfferNameFilter withValueList(java.util.Collection<String> valueList) {
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>Name</code> of an offer with wild card input.
     */
    ...
    public OfferNameFilter withWildCardValue(String wildCardValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OfferNameFilter == false)
            return false;
        OfferNameFilter other = (OfferNameFilter) obj;
    ...
    @Override
    public OfferNameFilter clone() {
        try {
            return (OfferNameFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.OfferNameFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
