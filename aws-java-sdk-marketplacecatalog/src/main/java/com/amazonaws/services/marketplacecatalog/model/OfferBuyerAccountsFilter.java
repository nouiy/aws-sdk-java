 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferBuyerAccountsFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OfferBuyerAccountsFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public OfferBuyerAccountsFilter withWildCardValue(String wildCardValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OfferBuyerAccountsFilter == false)
            return false;
    ...
    @Override
    public OfferBuyerAccountsFilter clone() {
        try {
            return (OfferBuyerAccountsFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.OfferBuyerAccountsFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
