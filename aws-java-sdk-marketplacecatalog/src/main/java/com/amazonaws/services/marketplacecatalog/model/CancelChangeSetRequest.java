...
public class CancelChangeSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Required. The unique identifier of the <code>StartChangeSet</code> request that you want to cancel.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelChangeSetRequest == false)
            return false;
        CancelChangeSetRequest other = (CancelChangeSetRequest) obj;
    ...
    @Override
    public CancelChangeSetRequest clone() {
        return (CancelChangeSetRequest) super.clone();
    }
