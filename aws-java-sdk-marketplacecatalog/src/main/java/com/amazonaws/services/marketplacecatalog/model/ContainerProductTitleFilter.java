 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/ContainerProductTitleFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContainerProductTitleFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public ContainerProductTitleFilter withValueList(String... valueList) {
    ...
    public ContainerProductTitleFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public ContainerProductTitleFilter withWildCardValue(String wildCardValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ContainerProductTitleFilter == false)
            return false;
        ContainerProductTitleFilter other = (ContainerProductTitleFilter) obj;
    ...
    @Override
    public ContainerProductTitleFilter clone() {
        try {
            return (ContainerProductTitleFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.ContainerProductTitleFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
