 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/ResaleAuthorizationResellerLegalNameFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResaleAuthorizationResellerLegalNameFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on the ResellerLegalNameProductName of a ResaleAuthorization with list input.
     */
    ...
    public ResaleAuthorizationResellerLegalNameFilter withValueList(String... valueList) {
    ...
    public ResaleAuthorizationResellerLegalNameFilter withValueList(java.util.Collection<String> valueList) {
     ...
     * </p>
     * 
     * @return Allows filtering on the ResellerLegalName of a ResaleAuthorization with wild card input.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResaleAuthorizationResellerLegalNameFilter == false)
            return false;
        ResaleAuthorizationResellerLegalNameFilter other = (ResaleAuthorizationResellerLegalNameFilter) obj;
    ...
    public ResaleAuthorizationResellerLegalNameFilter clone() {
        try {
            return (ResaleAuthorizationResellerLegalNameFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.ResaleAuthorizationResellerLegalNameFilterMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
