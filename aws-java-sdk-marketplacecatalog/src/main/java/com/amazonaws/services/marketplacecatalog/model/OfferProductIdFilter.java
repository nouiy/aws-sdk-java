 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferProductIdFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OfferProductIdFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>ProductId</code> of an offer with list input.
     */
    ...
    public OfferProductIdFilter withValueList(String... valueList) {
    ...
    public OfferProductIdFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OfferProductIdFilter == false)
            return false;
        OfferProductIdFilter other = (OfferProductIdFilter) obj;
    ...
    @Override
    public OfferProductIdFilter clone() {
        try {
            return (OfferProductIdFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.OfferProductIdFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
