 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/OfferStateFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OfferStateFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>State</code> of an offer with list input.
    ...
    public OfferStateFilter withValueList(String... valueList) {
    ...
    public OfferStateFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public OfferStateFilter withValueList(OfferStateString... valueList) {
        java.util.ArrayList<String> valueListCopy = new java.util.ArrayList<String>(valueList.length);
        for (OfferStateString value : valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OfferStateFilter == false)
            return false;
        OfferStateFilter other = (OfferStateFilter) obj;
    ...
    @Override
    public OfferStateFilter clone() {
        try {
            return (OfferStateFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.OfferStateFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
