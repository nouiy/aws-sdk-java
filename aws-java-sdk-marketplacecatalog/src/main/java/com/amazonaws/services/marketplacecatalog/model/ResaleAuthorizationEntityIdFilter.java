 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/ResaleAuthorizationEntityIdFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResaleAuthorizationEntityIdFilter implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Allows filtering on <code>EntityId</code> of a ResaleAuthorization with list input.
     */
    ...
    public ResaleAuthorizationEntityIdFilter withValueList(String... valueList) {
    ...
    public ResaleAuthorizationEntityIdFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResaleAuthorizationEntityIdFilter == false)
            return false;
    ...
    @Override
    public ResaleAuthorizationEntityIdFilter clone() {
        try {
            return (ResaleAuthorizationEntityIdFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.ResaleAuthorizationEntityIdFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
