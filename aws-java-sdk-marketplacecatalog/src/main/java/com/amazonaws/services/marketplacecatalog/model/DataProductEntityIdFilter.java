 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/DataProductEntityIdFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DataProductEntityIdFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    public DataProductEntityIdFilter withValueList(String... valueList) {
    ...
    public DataProductEntityIdFilter withValueList(java.util.Collection<String> valueList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DataProductEntityIdFilter == false)
            return false;
        DataProductEntityIdFilter other = (DataProductEntityIdFilter) obj;
    ...
    public DataProductEntityIdFilter clone() {
        try {
            return (DataProductEntityIdFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.DataProductEntityIdFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
