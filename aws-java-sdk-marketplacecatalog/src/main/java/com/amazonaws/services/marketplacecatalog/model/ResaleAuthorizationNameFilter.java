 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-catalog-2018-09-17/ResaleAuthorizationNameFilter"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResaleAuthorizationNameFilter implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Allows filtering on the <code>Name</code> of a ResaleAuthorization with wild card input.
     * </p>
     */
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>Name</code> of a ResaleAuthorization with list input.
     */
    ...
    public ResaleAuthorizationNameFilter withValueList(String... valueList) {
    ...
    public ResaleAuthorizationNameFilter withValueList(java.util.Collection<String> valueList) {
     ...
     * </p>
     * 
     * @return Allows filtering on the <code>Name</code> of a ResaleAuthorization with wild card input.
     */
    ...
    public ResaleAuthorizationNameFilter withWildCardValue(String wildCardValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResaleAuthorizationNameFilter == false)
            return false;
        ResaleAuthorizationNameFilter other = (ResaleAuthorizationNameFilter) obj;
    ...
    @Override
    public ResaleAuthorizationNameFilter clone() {
        try {
            return (ResaleAuthorizationNameFilter) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.marketplacecatalog.model.transform.ResaleAuthorizationNameFilterMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
