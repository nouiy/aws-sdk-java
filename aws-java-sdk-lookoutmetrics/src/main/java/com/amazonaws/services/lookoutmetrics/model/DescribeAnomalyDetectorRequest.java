...
public class DescribeAnomalyDetectorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the detector to describe.
     */
    ...
    public DescribeAnomalyDetectorRequest withAnomalyDetectorArn(String anomalyDetectorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAnomalyDetectorRequest == false)
            return false;
        DescribeAnomalyDetectorRequest other = (DescribeAnomalyDetectorRequest) obj;
    ...
    @Override
    public DescribeAnomalyDetectorRequest clone() {
        return (DescribeAnomalyDetectorRequest) super.clone();
    }
