...
public enum AnomalyDetectorFailureType {
    ...
    private AnomalyDetectorFailureType(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return AnomalyDetectorFailureType corresponding to the value
     *
    ...
    public static AnomalyDetectorFailureType fromValue(String value) {
        ...
        for (AnomalyDetectorFailureType enumEntry : AnomalyDetectorFailureType.values()) {
