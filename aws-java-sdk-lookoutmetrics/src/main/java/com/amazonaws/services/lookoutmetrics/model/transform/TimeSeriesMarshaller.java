...
public class TimeSeriesMarshaller {
    ...
    private static final MarshallingInfo<List> METRICVALUELIST_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MetricValueList").build();
