        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SNSConfiguration", targetDepth)) {
                    context.nextToken();
                    action.setSNSConfiguration(SNSConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("LambdaConfiguration", targetDepth)) {
                    context.nextToken();
                    action.setLambdaConfiguration(LambdaConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
