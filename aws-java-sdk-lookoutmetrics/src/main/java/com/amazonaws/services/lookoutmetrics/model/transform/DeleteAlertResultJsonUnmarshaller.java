...
/**
 * DeleteAlertResult JSON Unmarshaller
 */
...
public class DeleteAlertResultJsonUnmarshaller implements Unmarshaller<DeleteAlertResult, JsonUnmarshallerContext> {
    ...
    public DeleteAlertResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAlertResult deleteAlertResult = new DeleteAlertResult();
