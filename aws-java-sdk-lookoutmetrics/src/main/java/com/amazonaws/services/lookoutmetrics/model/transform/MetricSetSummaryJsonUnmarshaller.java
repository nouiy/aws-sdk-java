...
/**
 * MetricSetSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricSetSummaryJsonUnmarshaller implements Unmarshaller<MetricSetSummary, JsonUnmarshallerContext> {

    public MetricSetSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        MetricSetSummary metricSetSummary = new MetricSetSummary();
    ...
    private static MetricSetSummaryJsonUnmarshaller instance;

    public static MetricSetSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MetricSetSummaryJsonUnmarshaller();
        return instance;
    }
}
