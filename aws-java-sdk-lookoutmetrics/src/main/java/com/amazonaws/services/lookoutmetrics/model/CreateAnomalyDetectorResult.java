...
public class CreateAnomalyDetectorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAnomalyDetectorResult == false)
            return false;
        CreateAnomalyDetectorResult other = (CreateAnomalyDetectorResult) obj;
    ...
    @Override
    public CreateAnomalyDetectorResult clone() {
        try {
            return (CreateAnomalyDetectorResult) super.clone();
