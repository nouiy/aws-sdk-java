...
public class VpcConfigurationMarshaller {
    ...
    private static final MarshallingInfo<List> SUBNETIDLIST_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("SubnetIdList").build();
