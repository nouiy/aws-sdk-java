        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SubnetIdList", targetDepth)) {
                    context.nextToken();
                    vpcConfiguration.setSubnetIdList(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("SecurityGroupIdList", targetDepth)) {
                    context.nextToken();
                    vpcConfiguration.setSecurityGroupIdList(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
