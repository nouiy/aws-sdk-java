...
public class BackTestAnomalyDetectorRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public BackTestAnomalyDetectorRequest withAnomalyDetectorArn(String anomalyDetectorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BackTestAnomalyDetectorRequest == false)
            return false;
        BackTestAnomalyDetectorRequest other = (BackTestAnomalyDetectorRequest) obj;
    ...
    @Override
    public BackTestAnomalyDetectorRequest clone() {
        return (BackTestAnomalyDetectorRequest) super.clone();
    }
