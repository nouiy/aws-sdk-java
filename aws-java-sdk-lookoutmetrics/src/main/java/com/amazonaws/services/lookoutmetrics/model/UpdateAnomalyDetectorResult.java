...
public class UpdateAnomalyDetectorResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the updated detector.
     */
    ...
    public UpdateAnomalyDetectorResult withAnomalyDetectorArn(String anomalyDetectorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAnomalyDetectorResult == false)
            return false;
        UpdateAnomalyDetectorResult other = (UpdateAnomalyDetectorResult) obj;
    ...
    @Override
    public UpdateAnomalyDetectorResult clone() {
        try {
            return (UpdateAnomalyDetectorResult) super.clone();
