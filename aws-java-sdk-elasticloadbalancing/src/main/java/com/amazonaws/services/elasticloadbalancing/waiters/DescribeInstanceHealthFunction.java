...
public class DescribeInstanceHealthFunction implements SdkFunction<DescribeInstanceHealthRequest, DescribeInstanceHealthResult> {
    ...
    /**
     * Constructs a new DescribeInstanceHealthFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public DescribeInstanceHealthFunction(AmazonElasticLoadBalancing client) {
        this.client = client;
    }
     ...
     */
    @Override
    public DescribeInstanceHealthResult apply(DescribeInstanceHealthRequest describeInstanceHealthRequest) {
