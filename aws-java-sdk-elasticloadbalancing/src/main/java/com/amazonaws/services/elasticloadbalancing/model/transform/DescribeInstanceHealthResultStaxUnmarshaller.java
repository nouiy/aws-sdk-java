...
/**
 * DescribeInstanceHealthResult StAX Unmarshaller
 */
...
public class DescribeInstanceHealthResultStaxUnmarshaller implements Unmarshaller<DescribeInstanceHealthResult, StaxUnmarshallerContext> {
    ...
    public DescribeInstanceHealthResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("InstanceStates", targetDepth)) {
                    describeInstanceHealthResult.withInstanceStates(new ArrayList<InstanceState>());
                    continue;
                }

                if (context.testExpression("InstanceStates/member", targetDepth)) {
                    describeInstanceHealthResult.withInstanceStates(InstanceStateStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
