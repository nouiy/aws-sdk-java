...
public class GetDeploymentStatusRequestMarshaller {
    ...
    private static final GetDeploymentStatusRequestMarshaller instance = new GetDeploymentStatusRequestMarshaller();

    public static GetDeploymentStatusRequestMarshaller getInstance() {
        return instance;
    }
