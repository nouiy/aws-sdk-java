...
public class CreateCoreDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateCoreDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateCoreDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public CreateCoreDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateCoreDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public CreateCoreDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public CreateCoreDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public CreateCoreDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCoreDefinitionResult == false)
            return false;
        CreateCoreDefinitionResult other = (CreateCoreDefinitionResult) obj;
    ...
    @Override
    public CreateCoreDefinitionResult clone() {
        try {
