...
public class ListCoreDefinitionVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListCoreDefinitionVersionsResult withVersions(VersionInformation... versions) {
    ...
    public ListCoreDefinitionVersionsResult withVersions(java.util.Collection<VersionInformation> versions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCoreDefinitionVersionsResult == false)
            return false;
        ListCoreDefinitionVersionsResult other = (ListCoreDefinitionVersionsResult) obj;
    ...
    @Override
    public ListCoreDefinitionVersionsResult clone() {
        try {
            return (ListCoreDefinitionVersionsResult) super.clone();
