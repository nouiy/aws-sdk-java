        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CertificateArn", targetDepth)) {
                    context.nextToken();
                    device.setCertificateArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("SyncShadow", targetDepth)) {
                    context.nextToken();
                    device.setSyncShadow(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("ThingArn", targetDepth)) {
                    context.nextToken();
                    device.setThingArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
