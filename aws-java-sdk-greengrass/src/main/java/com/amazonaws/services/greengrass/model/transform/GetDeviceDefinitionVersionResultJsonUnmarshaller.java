...
/**
 * GetDeviceDefinitionVersionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDeviceDefinitionVersionResultJsonUnmarshaller implements Unmarshaller<GetDeviceDefinitionVersionResult, JsonUnmarshallerContext> {

    public GetDeviceDefinitionVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetDeviceDefinitionVersionResult getDeviceDefinitionVersionResult = new GetDeviceDefinitionVersionResult();
    ...
    private static GetDeviceDefinitionVersionResultJsonUnmarshaller instance;

    public static GetDeviceDefinitionVersionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetDeviceDefinitionVersionResultJsonUnmarshaller();
        return instance;
    }
}
