...
/**
 * UpdateResourceDefinitionResult JSON Unmarshaller
 */
...
public class UpdateResourceDefinitionResultJsonUnmarshaller implements Unmarshaller<UpdateResourceDefinitionResult, JsonUnmarshallerContext> {
    ...
    public UpdateResourceDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateResourceDefinitionResult updateResourceDefinitionResult = new UpdateResourceDefinitionResult();

        return updateResourceDefinitionResult;
    }
