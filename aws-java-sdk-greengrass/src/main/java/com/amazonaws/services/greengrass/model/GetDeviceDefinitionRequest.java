...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/GetDeviceDefinition" target="_top">AWS API
 *      Documentation</a>
 */
...
public class GetDeviceDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDeviceDefinitionRequest == false)
            return false;
        GetDeviceDefinitionRequest other = (GetDeviceDefinitionRequest) obj;
    ...
    @Override
    public GetDeviceDefinitionRequest clone() {
        return (GetDeviceDefinitionRequest) super.clone();
    }
