...
/**
 * UpdateConnectivityInfoResult JSON Unmarshaller
 */
...
public class UpdateConnectivityInfoResultJsonUnmarshaller implements Unmarshaller<UpdateConnectivityInfoResult, JsonUnmarshallerContext> {
    ...
    public UpdateConnectivityInfoResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("message", targetDepth)) {
                    context.nextToken();
                    updateConnectivityInfoResult.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Version", targetDepth)) {
                    context.nextToken();
                    updateConnectivityInfoResult.setVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
