...
/**
 * DeleteFunctionDefinitionResult JSON Unmarshaller
 */
...
public class DeleteFunctionDefinitionResultJsonUnmarshaller implements Unmarshaller<DeleteFunctionDefinitionResult, JsonUnmarshallerContext> {
    ...
    public DeleteFunctionDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFunctionDefinitionResult deleteFunctionDefinitionResult = new DeleteFunctionDefinitionResult();
