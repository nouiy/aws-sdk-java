...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/CreateLoggerDefinition" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateLoggerDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateLoggerDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateLoggerDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public CreateLoggerDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateLoggerDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public CreateLoggerDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public CreateLoggerDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public CreateLoggerDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLoggerDefinitionResult == false)
            return false;
        CreateLoggerDefinitionResult other = (CreateLoggerDefinitionResult) obj;
    ...
    @Override
    public CreateLoggerDefinitionResult clone() {
        try {
            return (CreateLoggerDefinitionResult) super.clone();
