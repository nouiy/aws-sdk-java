...
/**
 * FunctionDefinitionVersion JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FunctionDefinitionVersionJsonUnmarshaller implements Unmarshaller<FunctionDefinitionVersion, JsonUnmarshallerContext> {
    ...
    private static FunctionDefinitionVersionJsonUnmarshaller instance;

    public static FunctionDefinitionVersionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FunctionDefinitionVersionJsonUnmarshaller();
        return instance;
    }
}
