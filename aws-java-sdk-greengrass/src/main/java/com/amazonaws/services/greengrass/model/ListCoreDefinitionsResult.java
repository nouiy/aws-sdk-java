...
public class ListCoreDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListCoreDefinitionsResult withDefinitions(DefinitionInformation... definitions) {
    ...
    public ListCoreDefinitionsResult withDefinitions(java.util.Collection<DefinitionInformation> definitions) {
    ...
    public ListCoreDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCoreDefinitionsResult == false)
            return false;
        ListCoreDefinitionsResult other = (ListCoreDefinitionsResult) obj;
    ...
    @Override
    public ListCoreDefinitionsResult clone() {
        try {
            return (ListCoreDefinitionsResult) super.clone();
