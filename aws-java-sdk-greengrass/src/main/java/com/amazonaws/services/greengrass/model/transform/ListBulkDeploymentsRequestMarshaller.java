...
/**
 * ListBulkDeploymentsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListBulkDeploymentsRequestMarshaller {
    ...
    private static final ListBulkDeploymentsRequestMarshaller instance = new ListBulkDeploymentsRequestMarshaller();

    public static ListBulkDeploymentsRequestMarshaller getInstance() {
        return instance;
    }
