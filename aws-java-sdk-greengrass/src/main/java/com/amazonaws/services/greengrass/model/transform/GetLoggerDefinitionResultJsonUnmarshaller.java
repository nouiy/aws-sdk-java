...
/**
 * GetLoggerDefinitionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetLoggerDefinitionResultJsonUnmarshaller implements Unmarshaller<GetLoggerDefinitionResult, JsonUnmarshallerContext> {

    public GetLoggerDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetLoggerDefinitionResult getLoggerDefinitionResult = new GetLoggerDefinitionResult();
    ...
    private static GetLoggerDefinitionResultJsonUnmarshaller instance;

    public static GetLoggerDefinitionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetLoggerDefinitionResultJsonUnmarshaller();
        return instance;
    }
}
