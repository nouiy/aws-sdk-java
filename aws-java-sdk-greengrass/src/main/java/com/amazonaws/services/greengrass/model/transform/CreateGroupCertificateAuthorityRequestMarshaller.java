...
/**
 * CreateGroupCertificateAuthorityRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateGroupCertificateAuthorityRequestMarshaller {
    ...
    private static final CreateGroupCertificateAuthorityRequestMarshaller instance = new CreateGroupCertificateAuthorityRequestMarshaller();

    public static CreateGroupCertificateAuthorityRequestMarshaller getInstance() {
        return instance;
    }
