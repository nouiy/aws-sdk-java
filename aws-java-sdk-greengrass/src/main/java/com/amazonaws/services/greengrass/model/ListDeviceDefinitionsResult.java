...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/greengrass-2017-06-07/ListDeviceDefinitions" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDeviceDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListDeviceDefinitionsResult withDefinitions(DefinitionInformation... definitions) {
    ...
    public ListDeviceDefinitionsResult withDefinitions(java.util.Collection<DefinitionInformation> definitions) {
    ...
    public ListDeviceDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDeviceDefinitionsResult == false)
            return false;
        ListDeviceDefinitionsResult other = (ListDeviceDefinitionsResult) obj;
    ...
    @Override
    public ListDeviceDefinitionsResult clone() {
        try {
            return (ListDeviceDefinitionsResult) super.clone();
