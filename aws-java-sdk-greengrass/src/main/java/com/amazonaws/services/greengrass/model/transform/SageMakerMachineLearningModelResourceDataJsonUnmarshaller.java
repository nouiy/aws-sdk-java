...
/**
 * SageMakerMachineLearningModelResourceData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SageMakerMachineLearningModelResourceDataJsonUnmarshaller implements
        Unmarshaller<SageMakerMachineLearningModelResourceData, JsonUnmarshallerContext> {

    public SageMakerMachineLearningModelResourceData unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SageMakerMachineLearningModelResourceDataJsonUnmarshaller instance;

    public static SageMakerMachineLearningModelResourceDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SageMakerMachineLearningModelResourceDataJsonUnmarshaller();
        return instance;
    }
}
