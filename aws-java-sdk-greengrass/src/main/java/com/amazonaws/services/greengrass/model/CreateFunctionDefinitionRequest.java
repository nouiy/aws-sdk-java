...
public class CreateFunctionDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateFunctionDefinitionRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateFunctionDefinitionRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateFunctionDefinitionRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateFunctionDefinitionRequest clearTagsEntries() {
        this.tags = null;
        return this;
    }
