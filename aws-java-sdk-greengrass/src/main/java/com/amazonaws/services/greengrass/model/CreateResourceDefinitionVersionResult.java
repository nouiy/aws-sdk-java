...
public class CreateResourceDefinitionVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateResourceDefinitionVersionResult == false)
            return false;
        CreateResourceDefinitionVersionResult other = (CreateResourceDefinitionVersionResult) obj;
    ...
    @Override
    public CreateResourceDefinitionVersionResult clone() {
        try {
            return (CreateResourceDefinitionVersionResult) super.clone();
