...
/**
 * UpdateSubscriptionDefinitionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateSubscriptionDefinitionRequestMarshaller {
    ...
    private static final UpdateSubscriptionDefinitionRequestMarshaller instance = new UpdateSubscriptionDefinitionRequestMarshaller();

    public static UpdateSubscriptionDefinitionRequestMarshaller getInstance() {
        return instance;
    }
