...
public class ListDeviceDefinitionVersionsRequestMarshaller {
    ...
    private static final ListDeviceDefinitionVersionsRequestMarshaller instance = new ListDeviceDefinitionVersionsRequestMarshaller();

    public static ListDeviceDefinitionVersionsRequestMarshaller getInstance() {
        return instance;
    }
