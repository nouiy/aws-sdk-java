...
public class ResourceMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> RESOURCEDATACONTAINER_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ResourceDataContainer").build();
    ...
    public void marshall(Resource resource, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(resource.getResourceDataContainer(), RESOURCEDATACONTAINER_BINDING);
        } catch (Exception e) {
