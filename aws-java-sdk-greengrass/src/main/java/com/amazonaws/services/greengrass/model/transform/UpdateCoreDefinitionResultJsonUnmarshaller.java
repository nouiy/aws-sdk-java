...
/**
 * UpdateCoreDefinitionResult JSON Unmarshaller
 */
...
public class UpdateCoreDefinitionResultJsonUnmarshaller implements Unmarshaller<UpdateCoreDefinitionResult, JsonUnmarshallerContext> {
    ...
    public UpdateCoreDefinitionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateCoreDefinitionResult updateCoreDefinitionResult = new UpdateCoreDefinitionResult();
