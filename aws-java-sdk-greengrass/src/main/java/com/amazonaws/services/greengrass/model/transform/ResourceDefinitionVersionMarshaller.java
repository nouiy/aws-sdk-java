...
/**
 * ResourceDefinitionVersionMarshaller
 */
...
public class ResourceDefinitionVersionMarshaller {
    ...
    public void marshall(ResourceDefinitionVersion resourceDefinitionVersion, ProtocolMarshaller protocolMarshaller) {
        ...
        if (resourceDefinitionVersion == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(resourceDefinitionVersion.getResources(), RESOURCES_BINDING);
        } catch (Exception e) {
