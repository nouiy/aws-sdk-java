...
public class VersionInformationMarshaller {
    ...
    public void marshall(VersionInformation versionInformation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(versionInformation.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(versionInformation.getCreationTimestamp(), CREATIONTIMESTAMP_BINDING);
            protocolMarshaller.marshall(versionInformation.getId(), ID_BINDING);
            protocolMarshaller.marshall(versionInformation.getVersion(), VERSION_BINDING);
        } catch (Exception e) {
