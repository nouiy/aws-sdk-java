...
public class CreateSubscriptionDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateSubscriptionDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateSubscriptionDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public CreateSubscriptionDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateSubscriptionDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public CreateSubscriptionDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public CreateSubscriptionDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public CreateSubscriptionDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSubscriptionDefinitionResult == false)
            return false;
        CreateSubscriptionDefinitionResult other = (CreateSubscriptionDefinitionResult) obj;
    ...
    @Override
    public CreateSubscriptionDefinitionResult clone() {
        try {
            return (CreateSubscriptionDefinitionResult) super.clone();
