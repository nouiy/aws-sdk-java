...
/**
 * ListResourceDefinitionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListResourceDefinitionsRequestMarshaller {
    ...
    private static final ListResourceDefinitionsRequestMarshaller instance = new ListResourceDefinitionsRequestMarshaller();

    public static ListResourceDefinitionsRequestMarshaller getInstance() {
        return instance;
    }
