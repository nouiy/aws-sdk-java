...
public class CreateSubscriptionDefinitionVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSubscriptionDefinitionVersionResult == false)
            return false;
        CreateSubscriptionDefinitionVersionResult other = (CreateSubscriptionDefinitionVersionResult) obj;
    ...
    public CreateSubscriptionDefinitionVersionResult clone() {
        try {
            return (CreateSubscriptionDefinitionVersionResult) super.clone();
