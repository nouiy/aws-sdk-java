...
public class CreateLoggerDefinitionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateLoggerDefinitionRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateLoggerDefinitionRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateLoggerDefinitionRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLoggerDefinitionRequest == false)
            return false;
        CreateLoggerDefinitionRequest other = (CreateLoggerDefinitionRequest) obj;
    ...
    public CreateLoggerDefinitionRequest clone() {
        return (CreateLoggerDefinitionRequest) super.clone();
    }
