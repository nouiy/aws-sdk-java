...
public class GetCoreDefinitionVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCoreDefinitionVersionResult == false)
            return false;
        GetCoreDefinitionVersionResult other = (GetCoreDefinitionVersionResult) obj;
    ...
    public GetCoreDefinitionVersionResult clone() {
        try {
            return (GetCoreDefinitionVersionResult) super.clone();
