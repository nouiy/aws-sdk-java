...
/**
 * DeleteResourceDefinitionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteResourceDefinitionRequestMarshaller {
    ...
    private static final DeleteResourceDefinitionRequestMarshaller instance = new DeleteResourceDefinitionRequestMarshaller();

    public static DeleteResourceDefinitionRequestMarshaller getInstance() {
        return instance;
    }
