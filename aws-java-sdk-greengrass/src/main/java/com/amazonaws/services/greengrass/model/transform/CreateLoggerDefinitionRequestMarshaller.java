...
/**
 * CreateLoggerDefinitionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateLoggerDefinitionRequestMarshaller {
    ...
    private static final CreateLoggerDefinitionRequestMarshaller instance = new CreateLoggerDefinitionRequestMarshaller();

    public static CreateLoggerDefinitionRequestMarshaller getInstance() {
        return instance;
    }
