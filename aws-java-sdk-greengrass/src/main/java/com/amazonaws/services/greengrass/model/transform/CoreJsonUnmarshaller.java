...
/**
 * Core JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CoreJsonUnmarshaller implements Unmarshaller<Core, JsonUnmarshallerContext> {

    public Core unmarshall(JsonUnmarshallerContext context) throws Exception {
        Core core = new Core();
    ...
    private static CoreJsonUnmarshaller instance;

    public static CoreJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CoreJsonUnmarshaller();
        return instance;
    }
}
