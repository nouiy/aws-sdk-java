...
@SdkInternalApi
public class ListLoggerDefinitionsRequestMarshaller {
    ...
    private static final ListLoggerDefinitionsRequestMarshaller instance = new ListLoggerDefinitionsRequestMarshaller();

    public static ListLoggerDefinitionsRequestMarshaller getInstance() {
        return instance;
    }
