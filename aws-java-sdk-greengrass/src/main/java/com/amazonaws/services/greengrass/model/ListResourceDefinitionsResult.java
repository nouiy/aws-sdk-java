...
public class ListResourceDefinitionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListResourceDefinitionsResult withDefinitions(java.util.Collection<DefinitionInformation> definitions) {
    ...
    public ListResourceDefinitionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResourceDefinitionsResult == false)
            return false;
        ListResourceDefinitionsResult other = (ListResourceDefinitionsResult) obj;
    ...
    @Override
    public ListResourceDefinitionsResult clone() {
        try {
            return (ListResourceDefinitionsResult) super.clone();
