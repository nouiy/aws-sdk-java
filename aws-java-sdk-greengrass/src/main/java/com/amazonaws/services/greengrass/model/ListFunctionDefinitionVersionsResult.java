...
public class ListFunctionDefinitionVersionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public ListFunctionDefinitionVersionsResult withNextToken(String nextToken) {
    ...
    public ListFunctionDefinitionVersionsResult withVersions(VersionInformation... versions) {
    ...
    public ListFunctionDefinitionVersionsResult withVersions(java.util.Collection<VersionInformation> versions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFunctionDefinitionVersionsResult == false)
            return false;
        ListFunctionDefinitionVersionsResult other = (ListFunctionDefinitionVersionsResult) obj;
    ...
    @Override
    public ListFunctionDefinitionVersionsResult clone() {
        try {
            return (ListFunctionDefinitionVersionsResult) super.clone();
