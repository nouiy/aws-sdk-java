...
public class GetConnectorDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetConnectorDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetConnectorDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public GetConnectorDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetConnectorDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public GetConnectorDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public GetConnectorDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public GetConnectorDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetConnectorDefinitionResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetConnectorDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetConnectorDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public GetConnectorDefinitionResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConnectorDefinitionResult == false)
            return false;
        GetConnectorDefinitionResult other = (GetConnectorDefinitionResult) obj;
    ...
    @Override
    public GetConnectorDefinitionResult clone() {
        try {
            return (GetConnectorDefinitionResult) super.clone();
