...
public class CreateResourceDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateResourceDefinitionResult == false)
            return false;
        CreateResourceDefinitionResult other = (CreateResourceDefinitionResult) obj;
    ...
    @Override
    public CreateResourceDefinitionResult clone() {
        try {
            return (CreateResourceDefinitionResult) super.clone();
