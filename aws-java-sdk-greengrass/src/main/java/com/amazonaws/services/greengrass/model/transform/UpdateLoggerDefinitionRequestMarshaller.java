...
/**
 * UpdateLoggerDefinitionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateLoggerDefinitionRequestMarshaller {
    ...
    private static final UpdateLoggerDefinitionRequestMarshaller instance = new UpdateLoggerDefinitionRequestMarshaller();

    public static UpdateLoggerDefinitionRequestMarshaller getInstance() {
        return instance;
    }
