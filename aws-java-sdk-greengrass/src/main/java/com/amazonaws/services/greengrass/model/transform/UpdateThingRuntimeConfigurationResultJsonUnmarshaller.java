...
/**
 * UpdateThingRuntimeConfigurationResult JSON Unmarshaller
 */
...
public class UpdateThingRuntimeConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateThingRuntimeConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateThingRuntimeConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateThingRuntimeConfigurationResult updateThingRuntimeConfigurationResult = new UpdateThingRuntimeConfigurationResult();

        return updateThingRuntimeConfigurationResult;
    }
