...
public class DefinitionInformation implements Serializable, Cloneable, StructuredPojo {
     ...
     *
     * @see DefinitionInformation#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DefinitionInformation addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DefinitionInformation == false)
            return false;
    ...
    @Override
    public DefinitionInformation clone() {
        try {
            return (DefinitionInformation) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.greengrass.model.transform.DefinitionInformationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
