...
public class GetResourceDefinitionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetResourceDefinitionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public GetResourceDefinitionResult withCreationTimestamp(String creationTimestamp) {
    ...
    public GetResourceDefinitionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetResourceDefinitionResult withLastUpdatedTimestamp(String lastUpdatedTimestamp) {
    ...
    public GetResourceDefinitionResult withLatestVersion(String latestVersion) {
    ...
    public GetResourceDefinitionResult withLatestVersionArn(String latestVersionArn) {
    ...
    public GetResourceDefinitionResult withName(String name) {
        setName(name);
        return this;
    }
     ...
     *
     * @see GetResourceDefinitionResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetResourceDefinitionResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public GetResourceDefinitionResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetResourceDefinitionResult == false)
            return false;
        GetResourceDefinitionResult other = (GetResourceDefinitionResult) obj;
    ...
    @Override
    public GetResourceDefinitionResult clone() {
        try {
            return (GetResourceDefinitionResult) super.clone();
