...
public class ListFunctionDefinitionVersionsRequestMarshaller {
    ...
    private static final ListFunctionDefinitionVersionsRequestMarshaller instance = new ListFunctionDefinitionVersionsRequestMarshaller();

    public static ListFunctionDefinitionVersionsRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ListFunctionDefinitionVersionsRequest listFunctionDefinitionVersionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listFunctionDefinitionVersionsRequest.getFunctionDefinitionId(), FUNCTIONDEFINITIONID_BINDING);
            protocolMarshaller.marshall(listFunctionDefinitionVersionsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listFunctionDefinitionVersionsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
