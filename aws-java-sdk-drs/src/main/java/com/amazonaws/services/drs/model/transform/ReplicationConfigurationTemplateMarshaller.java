...
public class ReplicationConfigurationTemplateMarshaller {
    ...
    public void marshall(ReplicationConfigurationTemplate replicationConfigurationTemplate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(replicationConfigurationTemplate.getAutoReplicateNewDisks(), AUTOREPLICATENEWDISKS_BINDING);
            ...
            protocolMarshaller.marshall(replicationConfigurationTemplate.getPitPolicy(), PITPOLICY_BINDING);
