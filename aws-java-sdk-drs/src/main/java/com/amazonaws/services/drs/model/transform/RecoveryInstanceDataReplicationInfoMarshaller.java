...
/**
 * RecoveryInstanceDataReplicationInfoMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecoveryInstanceDataReplicationInfoMarshaller {
    ...
    public static RecoveryInstanceDataReplicationInfoMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecoveryInstanceDataReplicationInfo recoveryInstanceDataReplicationInfo, ProtocolMarshaller protocolMarshaller) {

        if (recoveryInstanceDataReplicationInfo == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(recoveryInstanceDataReplicationInfo.getDataReplicationError(), DATAREPLICATIONERROR_BINDING);
            protocolMarshaller.marshall(recoveryInstanceDataReplicationInfo.getDataReplicationInitiation(), DATAREPLICATIONINITIATION_BINDING);
            protocolMarshaller.marshall(recoveryInstanceDataReplicationInfo.getDataReplicationState(), DATAREPLICATIONSTATE_BINDING);
            protocolMarshaller.marshall(recoveryInstanceDataReplicationInfo.getEtaDateTime(), ETADATETIME_BINDING);
