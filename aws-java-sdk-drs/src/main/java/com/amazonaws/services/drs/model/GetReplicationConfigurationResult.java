...
public class GetReplicationConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetReplicationConfigurationResult withAutoReplicateNewDisks(Boolean autoReplicateNewDisks) {
    ...
    public GetReplicationConfigurationResult withPitPolicy(PITPolicyRule... pitPolicy) {
    ...
    public GetReplicationConfigurationResult withPitPolicy(java.util.Collection<PITPolicyRule> pitPolicy) {
