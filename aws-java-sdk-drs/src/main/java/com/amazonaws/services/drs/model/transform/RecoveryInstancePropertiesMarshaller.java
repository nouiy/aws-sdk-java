...
/**
 * RecoveryInstancePropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RecoveryInstancePropertiesMarshaller {
    ...
    private static final RecoveryInstancePropertiesMarshaller instance = new RecoveryInstancePropertiesMarshaller();

    public static RecoveryInstancePropertiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RecoveryInstanceProperties recoveryInstanceProperties, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recoveryInstanceProperties.getCpus(), CPUS_BINDING);
            protocolMarshaller.marshall(recoveryInstanceProperties.getDisks(), DISKS_BINDING);
            protocolMarshaller.marshall(recoveryInstanceProperties.getIdentificationHints(), IDENTIFICATIONHINTS_BINDING);
            protocolMarshaller.marshall(recoveryInstanceProperties.getLastUpdatedDateTime(), LASTUPDATEDDATETIME_BINDING);
            protocolMarshaller.marshall(recoveryInstanceProperties.getNetworkInterfaces(), NETWORKINTERFACES_BINDING);
            protocolMarshaller.marshall(recoveryInstanceProperties.getOs(), OS_BINDING);
            protocolMarshaller.marshall(recoveryInstanceProperties.getRamBytes(), RAMBYTES_BINDING);
        } catch (Exception e) {
