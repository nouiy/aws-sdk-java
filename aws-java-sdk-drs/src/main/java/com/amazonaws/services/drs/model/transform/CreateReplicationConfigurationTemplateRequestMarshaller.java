...
public class CreateReplicationConfigurationTemplateRequestMarshaller {
    ...
    public void marshall(CreateReplicationConfigurationTemplateRequest createReplicationConfigurationTemplateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createReplicationConfigurationTemplateRequest.getAutoReplicateNewDisks(), AUTOREPLICATENEWDISKS_BINDING);
            ...
            protocolMarshaller.marshall(createReplicationConfigurationTemplateRequest.getPitPolicy(), PITPOLICY_BINDING);
            protocolMarshaller
