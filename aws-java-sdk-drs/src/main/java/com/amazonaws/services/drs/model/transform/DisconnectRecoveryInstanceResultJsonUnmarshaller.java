...
/**
 * DisconnectRecoveryInstanceResult JSON Unmarshaller
 */
...
public class DisconnectRecoveryInstanceResultJsonUnmarshaller implements Unmarshaller<DisconnectRecoveryInstanceResult, JsonUnmarshallerContext> {
    ...
    public DisconnectRecoveryInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisconnectRecoveryInstanceResult disconnectRecoveryInstanceResult = new DisconnectRecoveryInstanceResult();
