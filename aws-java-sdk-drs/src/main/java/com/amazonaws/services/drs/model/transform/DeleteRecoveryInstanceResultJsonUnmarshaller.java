...
/**
 * DeleteRecoveryInstanceResult JSON Unmarshaller
 */
...
public class DeleteRecoveryInstanceResultJsonUnmarshaller implements Unmarshaller<DeleteRecoveryInstanceResult, JsonUnmarshallerContext> {
    ...
    public DeleteRecoveryInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRecoveryInstanceResult deleteRecoveryInstanceResult = new DeleteRecoveryInstanceResult();
