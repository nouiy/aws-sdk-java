...
public enum RecoveryInstanceDataReplicationState {
     ...
     * @param value
     *        real value
     * @return RecoveryInstanceDataReplicationState corresponding to the value
     *
    ...
    public static RecoveryInstanceDataReplicationState fromValue(String value) {
        ...
        for (RecoveryInstanceDataReplicationState enumEntry : RecoveryInstanceDataReplicationState.values()) {
