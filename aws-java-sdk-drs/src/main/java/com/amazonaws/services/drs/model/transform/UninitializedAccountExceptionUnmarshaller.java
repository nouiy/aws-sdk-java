...
public class UninitializedAccountExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UninitializedAccountExceptionUnmarshaller() {
        super(com.amazonaws.services.drs.model.UninitializedAccountException.class, "UninitializedAccountException");
    }

    @Override
    public com.amazonaws.services.drs.model.UninitializedAccountException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.drs.model.UninitializedAccountException uninitializedAccountException = new com.amazonaws.services.drs.model.UninitializedAccountException(
                null);
