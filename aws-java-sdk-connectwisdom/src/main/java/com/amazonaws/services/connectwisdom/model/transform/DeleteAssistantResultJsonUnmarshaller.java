...
/**
 * DeleteAssistantResult JSON Unmarshaller
 */
...
public class DeleteAssistantResultJsonUnmarshaller implements Unmarshaller<DeleteAssistantResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssistantResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssistantResult deleteAssistantResult = new DeleteAssistantResult();
