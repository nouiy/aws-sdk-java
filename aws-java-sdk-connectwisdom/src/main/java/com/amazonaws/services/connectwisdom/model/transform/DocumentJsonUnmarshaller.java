        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("contentReference", targetDepth)) {
                    context.nextToken();
                    document.setContentReference(ContentReferenceJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("excerpt", targetDepth)) {
                    context.nextToken();
                    document.setExcerpt(DocumentTextJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("title", targetDepth)) {
                    context.nextToken();
                    document.setTitle(DocumentTextJsonUnmarshaller.getInstance().unmarshall(context));
                }
