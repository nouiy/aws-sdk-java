...
/**
 * DeleteQuickResponseResult JSON Unmarshaller
 */
...
public class DeleteQuickResponseResultJsonUnmarshaller implements Unmarshaller<DeleteQuickResponseResult, JsonUnmarshallerContext> {
    ...
    public DeleteQuickResponseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteQuickResponseResult deleteQuickResponseResult = new DeleteQuickResponseResult();
