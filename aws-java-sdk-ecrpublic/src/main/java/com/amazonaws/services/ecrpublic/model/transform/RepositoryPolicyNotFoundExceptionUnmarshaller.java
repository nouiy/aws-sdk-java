...
public class RepositoryPolicyNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private RepositoryPolicyNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.ecrpublic.model.RepositoryPolicyNotFoundException.class, "RepositoryPolicyNotFoundException");
    }

    @Override
    public com.amazonaws.services.ecrpublic.model.RepositoryPolicyNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ecrpublic.model.RepositoryPolicyNotFoundException repositoryPolicyNotFoundException = new com.amazonaws.services.ecrpublic.model.RepositoryPolicyNotFoundException(
                null);
