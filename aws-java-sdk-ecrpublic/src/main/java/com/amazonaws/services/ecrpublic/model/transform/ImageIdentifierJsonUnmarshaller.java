...
public class ImageIdentifierJsonUnmarshaller implements Unmarshaller<ImageIdentifier, JsonUnmarshallerContext> {

    public ImageIdentifier unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ImageIdentifierJsonUnmarshaller instance;

    public static ImageIdentifierJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImageIdentifierJsonUnmarshaller();
        return instance;
    }
}
