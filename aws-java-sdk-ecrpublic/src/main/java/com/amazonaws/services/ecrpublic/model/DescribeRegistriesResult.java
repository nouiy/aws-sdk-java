...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ecr-public-2020-10-30/DescribeRegistries" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeRegistriesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setRegistries(java.util.Collection<Registry> registries) {
        ...
        this.registries = new java.util.ArrayList<Registry>(registries);
    }
    ...
    public DescribeRegistriesResult withRegistries(Registry... registries) {
        if (this.registries == null) {
            setRegistries(new java.util.ArrayList<Registry>(registries.length));
        }
        for (Registry ele : registries) {
    ...
    public DescribeRegistriesResult withRegistries(java.util.Collection<Registry> registries) {
