...
public class NotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private NotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.cloud9.model.NotFoundException.class, "NotFoundException");
    }

    @Override
    public com.amazonaws.services.cloud9.model.NotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloud9.model.NotFoundException notFoundException = new com.amazonaws.services.cloud9.model.NotFoundException(null);
