...
/**
 * DeleteEnvironmentMembershipResult JSON Unmarshaller
 */
...
public class DeleteEnvironmentMembershipResultJsonUnmarshaller implements Unmarshaller<DeleteEnvironmentMembershipResult, JsonUnmarshallerContext> {
    ...
    public DeleteEnvironmentMembershipResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEnvironmentMembershipResult deleteEnvironmentMembershipResult = new DeleteEnvironmentMembershipResult();
