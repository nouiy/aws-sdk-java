...
/**
 * DescribeEnvironmentMembershipsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeEnvironmentMembershipsRequestMarshaller {
    ...
    private static final DescribeEnvironmentMembershipsRequestMarshaller instance = new DescribeEnvironmentMembershipsRequestMarshaller();

    public static DescribeEnvironmentMembershipsRequestMarshaller getInstance() {
        return instance;
    }
