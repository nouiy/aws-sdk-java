...
/**
 * Fluent builder for {@link com.amazonaws.services.cloud9.AWSCloud9Async}. Use of the builder is preferred over using
...
public final class AWSCloud9AsyncClientBuilder extends AwsAsyncClientBuilder<AWSCloud9AsyncClientBuilder, AWSCloud9Async> {
    ...
    /**
     * Construct an asynchronous implementation of AWSCloud9Async using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AWSCloud9Async.
     */
    @Override
    protected AWSCloud9Async build(AwsAsyncClientParams params) {
