...
public class CreateEnvironmentEC2Request extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * Because Amazon Linux AMI has ended standard support as of December 31, 2020, we recommend you choose Amazon Linux
     * 2, which includes long term support through 2023.
     * </p>
     * <p>
     * From December 31, 2023, the parameter for Amazon Linux will no longer be available when you specify an AMI for
     * your instance. Amazon Linux 2 will then become the default AMI, which is used to launch your instance if no
     ...
     *        request. Because Amazon Linux AMI has ended standard support as of December 31, 2020, we recommend you
