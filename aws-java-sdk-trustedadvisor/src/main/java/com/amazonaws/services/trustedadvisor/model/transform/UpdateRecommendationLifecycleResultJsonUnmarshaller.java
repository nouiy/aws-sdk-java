...
/**
 * UpdateRecommendationLifecycleResult JSON Unmarshaller
 */
...
public class UpdateRecommendationLifecycleResultJsonUnmarshaller implements Unmarshaller<UpdateRecommendationLifecycleResult, JsonUnmarshallerContext> {
    ...
    public UpdateRecommendationLifecycleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRecommendationLifecycleResult updateRecommendationLifecycleResult = new UpdateRecommendationLifecycleResult();
