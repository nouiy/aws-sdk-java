...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.trustedadvisor.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.trustedadvisor.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.trustedadvisor.model.ThrottlingException throttlingException = new com.amazonaws.services.trustedadvisor.model.ThrottlingException(
                null);
