...
/**
 * OrganizationRecommendationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OrganizationRecommendationMarshaller {
    ...
    private static final OrganizationRecommendationMarshaller instance = new OrganizationRecommendationMarshaller();

    public static OrganizationRecommendationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OrganizationRecommendation organizationRecommendation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(organizationRecommendation.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getAwsServices(), AWSSERVICES_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getCheckArn(), CHECKARN_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getCreatedAt(), CREATEDAT_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getCreatedBy(), CREATEDBY_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getId(), ID_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getLastUpdatedAt(), LASTUPDATEDAT_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getLifecycleStage(), LIFECYCLESTAGE_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getName(), NAME_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getPillarSpecificAggregates(), PILLARSPECIFICAGGREGATES_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getPillars(), PILLARS_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getResolvedAt(), RESOLVEDAT_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getResourcesAggregates(), RESOURCESAGGREGATES_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getSource(), SOURCE_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getUpdateReason(), UPDATEREASON_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getUpdateReasonCode(), UPDATEREASONCODE_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getUpdatedOnBehalfOf(), UPDATEDONBEHALFOF_BINDING);
            protocolMarshaller.marshall(organizationRecommendation.getUpdatedOnBehalfOfJobTitle(), UPDATEDONBEHALFOFJOBTITLE_BINDING);
        } catch (Exception e) {
