...
public class ResourceNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceNotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.trustedadvisor.model.ResourceNotFoundException.class, "ResourceNotFoundException");
    }

    @Override
    public com.amazonaws.services.trustedadvisor.model.ResourceNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.trustedadvisor.model.ResourceNotFoundException resourceNotFoundException = new com.amazonaws.services.trustedadvisor.model.ResourceNotFoundException(
                null);
