...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.trustedadvisor.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.trustedadvisor.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.trustedadvisor.model.ConflictException conflictException = new com.amazonaws.services.trustedadvisor.model.ConflictException(
                null);
