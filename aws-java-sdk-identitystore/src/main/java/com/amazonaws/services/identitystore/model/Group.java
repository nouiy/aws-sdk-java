...
public class Group implements Serializable, Cloneable, StructuredPojo {
     ...
     * attribute. The characters <code>&lt;&gt;;:%</code> are excluded. This value is specified at the time the group is
    ...
    public Group withExternalIds(java.util.Collection<ExternalId> externalIds) {
     ...
     * </p>
     * 
     * @return A string containing a description of the specified group.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.identitystore.model.transform.GroupMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
