...
public class DisassociateLinkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisassociateLinkResult withLinkAssociation(LinkAssociation linkAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateLinkResult == false)
            return false;
        DisassociateLinkResult other = (DisassociateLinkResult) obj;
    ...
    @Override
    public DisassociateLinkResult clone() {
        try {
            return (DisassociateLinkResult) super.clone();
