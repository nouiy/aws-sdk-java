...
public class CreateGlobalNetworkResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateGlobalNetworkResult withGlobalNetwork(GlobalNetwork globalNetwork) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateGlobalNetworkResult == false)
            return false;
        CreateGlobalNetworkResult other = (CreateGlobalNetworkResult) obj;
    ...
    @Override
    public CreateGlobalNetworkResult clone() {
        try {
            return (CreateGlobalNetworkResult) super.clone();
