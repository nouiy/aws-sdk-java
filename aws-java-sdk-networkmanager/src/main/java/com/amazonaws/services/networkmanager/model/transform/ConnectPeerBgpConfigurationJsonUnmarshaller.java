...
/**
 * ConnectPeerBgpConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConnectPeerBgpConfigurationJsonUnmarshaller implements Unmarshaller<ConnectPeerBgpConfiguration, JsonUnmarshallerContext> {

    public ConnectPeerBgpConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ConnectPeerBgpConfiguration connectPeerBgpConfiguration = new ConnectPeerBgpConfiguration();
    ...
    private static ConnectPeerBgpConfigurationJsonUnmarshaller instance;

    public static ConnectPeerBgpConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ConnectPeerBgpConfigurationJsonUnmarshaller();
        return instance;
    }
}
