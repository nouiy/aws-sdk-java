...
public class CreateVpcAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateVpcAttachmentResult withVpcAttachment(VpcAttachment vpcAttachment) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateVpcAttachmentResult == false)
            return false;
        CreateVpcAttachmentResult other = (CreateVpcAttachmentResult) obj;
    ...
    @Override
    public CreateVpcAttachmentResult clone() {
        try {
            return (CreateVpcAttachmentResult) super.clone();
