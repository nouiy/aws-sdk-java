...
/**
 * NetworkRouteDestinationMarshaller
 */
...
public class NetworkRouteDestinationMarshaller {
    ...
    private static final NetworkRouteDestinationMarshaller instance = new NetworkRouteDestinationMarshaller();

    public static NetworkRouteDestinationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NetworkRouteDestination networkRouteDestination, ProtocolMarshaller protocolMarshaller) {

        if (networkRouteDestination == null) {
