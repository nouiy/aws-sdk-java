...
public class CreateDeviceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDeviceResult == false)
            return false;
        CreateDeviceResult other = (CreateDeviceResult) obj;
    ...
    @Override
    public CreateDeviceResult clone() {
        try {
            return (CreateDeviceResult) super.clone();
