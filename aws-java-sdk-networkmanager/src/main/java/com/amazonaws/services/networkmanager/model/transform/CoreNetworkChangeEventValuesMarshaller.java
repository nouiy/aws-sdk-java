...
/**
 * CoreNetworkChangeEventValuesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CoreNetworkChangeEventValuesMarshaller {
    ...
    private static final CoreNetworkChangeEventValuesMarshaller instance = new CoreNetworkChangeEventValuesMarshaller();

    public static CoreNetworkChangeEventValuesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CoreNetworkChangeEventValues coreNetworkChangeEventValues, ProtocolMarshaller protocolMarshaller) {

        if (coreNetworkChangeEventValues == null) {
