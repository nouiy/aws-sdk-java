...
public class GetConnectPeerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Returns information about a core network Connect peer.
     */
    ...
    public GetConnectPeerResult withConnectPeer(ConnectPeer connectPeer) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConnectPeerResult == false)
            return false;
        GetConnectPeerResult other = (GetConnectPeerResult) obj;
    ...
    @Override
    public GetConnectPeerResult clone() {
        try {
            return (GetConnectPeerResult) super.clone();
