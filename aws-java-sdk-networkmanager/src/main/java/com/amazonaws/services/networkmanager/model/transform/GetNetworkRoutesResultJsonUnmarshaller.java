...
/**
 * GetNetworkRoutesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetNetworkRoutesResultJsonUnmarshaller implements Unmarshaller<GetNetworkRoutesResult, JsonUnmarshallerContext> {

    public GetNetworkRoutesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetNetworkRoutesResult getNetworkRoutesResult = new GetNetworkRoutesResult();
    ...
    private static GetNetworkRoutesResultJsonUnmarshaller instance;

    public static GetNetworkRoutesResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetNetworkRoutesResultJsonUnmarshaller();
        return instance;
    }
}
