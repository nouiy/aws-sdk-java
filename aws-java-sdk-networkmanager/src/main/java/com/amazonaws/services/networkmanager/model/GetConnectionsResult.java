...
public class GetConnectionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetConnectionsResult withConnections(Connection... connections) {
    ...
    public GetConnectionsResult withConnections(java.util.Collection<Connection> connections) {
