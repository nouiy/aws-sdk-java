...
public class GetCoreNetworkPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The details about a core network policy.
     */
    ...
    public GetCoreNetworkPolicyResult withCoreNetworkPolicy(CoreNetworkPolicy coreNetworkPolicy) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetCoreNetworkPolicyResult == false)
            return false;
        GetCoreNetworkPolicyResult other = (GetCoreNetworkPolicyResult) obj;
    ...
    @Override
    public GetCoreNetworkPolicyResult clone() {
        try {
            return (GetCoreNetworkPolicyResult) super.clone();
