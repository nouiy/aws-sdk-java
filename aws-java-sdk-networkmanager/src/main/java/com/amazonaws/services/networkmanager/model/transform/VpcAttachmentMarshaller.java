...
/**
 * VpcAttachmentMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VpcAttachmentMarshaller {
    ...
    private static final VpcAttachmentMarshaller instance = new VpcAttachmentMarshaller();

    public static VpcAttachmentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VpcAttachment vpcAttachment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(vpcAttachment.getAttachment(), ATTACHMENT_BINDING);
            protocolMarshaller.marshall(vpcAttachment.getSubnetArns(), SUBNETARNS_BINDING);
            protocolMarshaller.marshall(vpcAttachment.getOptions(), OPTIONS_BINDING);
        } catch (Exception e) {
