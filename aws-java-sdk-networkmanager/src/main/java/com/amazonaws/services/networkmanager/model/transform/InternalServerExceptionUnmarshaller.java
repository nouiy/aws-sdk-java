...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.networkmanager.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.networkmanager.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.networkmanager.model.InternalServerException internalServerException = new com.amazonaws.services.networkmanager.model.InternalServerException(
                null);
