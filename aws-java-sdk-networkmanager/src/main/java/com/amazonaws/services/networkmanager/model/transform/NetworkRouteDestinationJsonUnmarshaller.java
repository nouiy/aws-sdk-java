...
/**
 * NetworkRouteDestination JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NetworkRouteDestinationJsonUnmarshaller implements Unmarshaller<NetworkRouteDestination, JsonUnmarshallerContext> {

    public NetworkRouteDestination unmarshall(JsonUnmarshallerContext context) throws Exception {
        NetworkRouteDestination networkRouteDestination = new NetworkRouteDestination();
    ...
    private static NetworkRouteDestinationJsonUnmarshaller instance;

    public static NetworkRouteDestinationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NetworkRouteDestinationJsonUnmarshaller();
        return instance;
    }
}
