...
/**
 * ConnectAttachmentMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ConnectAttachmentMarshaller {
    ...
    private static final ConnectAttachmentMarshaller instance = new ConnectAttachmentMarshaller();

    public static ConnectAttachmentMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ConnectAttachment connectAttachment, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(connectAttachment.getAttachment(), ATTACHMENT_BINDING);
            protocolMarshaller.marshall(connectAttachment.getTransportAttachmentId(), TRANSPORTATTACHMENTID_BINDING);
            protocolMarshaller.marshall(connectAttachment.getOptions(), OPTIONS_BINDING);
        } catch (Exception e) {
