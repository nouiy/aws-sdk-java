...
/**
 * PermissionsErrorContextMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PermissionsErrorContextMarshaller {

    private static final MarshallingInfo<String> MISSINGPERMISSION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MissingPermission").build();
