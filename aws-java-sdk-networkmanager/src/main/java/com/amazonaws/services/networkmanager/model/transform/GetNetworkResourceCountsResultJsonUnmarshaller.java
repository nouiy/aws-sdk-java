...
/**
 * GetNetworkResourceCountsResult JSON Unmarshaller
 */
...
public class GetNetworkResourceCountsResultJsonUnmarshaller implements Unmarshaller<GetNetworkResourceCountsResult, JsonUnmarshallerContext> {
    ...
    public GetNetworkResourceCountsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NetworkResourceCounts", targetDepth)) {
                    context.nextToken();
                    getNetworkResourceCountsResult.setNetworkResourceCounts(new ListUnmarshaller<NetworkResourceCount>(NetworkResourceCountJsonUnmarshaller
                            .getInstance())
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    getNetworkResourceCountsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
