...
/**
 * PathComponent JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PathComponentJsonUnmarshaller implements Unmarshaller<PathComponent, JsonUnmarshallerContext> {

    public PathComponent unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PathComponentJsonUnmarshaller instance;

    public static PathComponentJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PathComponentJsonUnmarshaller();
        return instance;
    }
}
