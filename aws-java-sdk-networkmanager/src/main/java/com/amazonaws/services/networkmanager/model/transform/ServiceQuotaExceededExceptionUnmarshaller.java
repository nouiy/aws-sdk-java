...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.networkmanager.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.networkmanager.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.networkmanager.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.networkmanager.model.ServiceQuotaExceededException(
                null);
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("LimitCode", targetDepth)) {
                    context.nextToken();
                    serviceQuotaExceededException.setLimitCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
