...
/**
 * RetentionPropertiesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RetentionPropertiesMarshaller {

    private static final MarshallingInfo<Long> MEMORYSTORERETENTIONPERIODINHOURS_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MemoryStoreRetentionPeriodInHours").build();
    private static final MarshallingInfo<Long> MAGNETICSTORERETENTIONPERIODINDAYS_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MagneticStoreRetentionPeriodInDays").build();
