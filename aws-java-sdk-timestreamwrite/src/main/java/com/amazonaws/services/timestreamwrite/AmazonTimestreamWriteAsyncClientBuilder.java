...
/**
 * Fluent builder for {@link com.amazonaws.services.timestreamwrite.AmazonTimestreamWriteAsync}. Use of the builder is
 * preferred over using constructors of the client class.
 **/
@NotThreadSafe
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public final class AmazonTimestreamWriteAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonTimestreamWriteAsyncClientBuilder, AmazonTimestreamWriteAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonTimestreamWriteAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonTimestreamWriteAsync.
     */
    @Override
