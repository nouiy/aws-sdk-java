...
/**
 * SummarizedAttackVector JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SummarizedAttackVectorJsonUnmarshaller implements Unmarshaller<SummarizedAttackVector, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("VectorType", targetDepth)) {
                    context.nextToken();
                    summarizedAttackVector.setVectorType(context.getUnmarshaller(String.class).unmarshall(context));
                }
