...
public class OptimisticLockExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static OptimisticLockExceptionUnmarshaller instance;

    public static OptimisticLockExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new OptimisticLockExceptionUnmarshaller();
        return instance;
    }
}
