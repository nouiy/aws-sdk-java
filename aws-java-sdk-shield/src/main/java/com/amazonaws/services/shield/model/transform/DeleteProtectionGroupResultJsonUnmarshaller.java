...
/**
 * DeleteProtectionGroupResult JSON Unmarshaller
 */
...
public class DeleteProtectionGroupResultJsonUnmarshaller implements Unmarshaller<DeleteProtectionGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteProtectionGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteProtectionGroupResult deleteProtectionGroupResult = new DeleteProtectionGroupResult();

        return deleteProtectionGroupResult;
    }
