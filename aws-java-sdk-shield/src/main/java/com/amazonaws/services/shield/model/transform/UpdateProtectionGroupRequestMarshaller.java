...
@SdkInternalApi
public class UpdateProtectionGroupRequestMarshaller {
    ...
    private static final UpdateProtectionGroupRequestMarshaller instance = new UpdateProtectionGroupRequestMarshaller();

    public static UpdateProtectionGroupRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateProtectionGroupRequest updateProtectionGroupRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateProtectionGroupRequest.getProtectionGroupId(), PROTECTIONGROUPID_BINDING);
            protocolMarshaller.marshall(updateProtectionGroupRequest.getAggregation(), AGGREGATION_BINDING);
            protocolMarshaller.marshall(updateProtectionGroupRequest.getPattern(), PATTERN_BINDING);
            protocolMarshaller.marshall(updateProtectionGroupRequest.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(updateProtectionGroupRequest.getMembers(), MEMBERS_BINDING);
        } catch (Exception e) {
