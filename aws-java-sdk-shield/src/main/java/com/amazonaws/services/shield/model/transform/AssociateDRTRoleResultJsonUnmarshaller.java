...
/**
 * AssociateDRTRoleResult JSON Unmarshaller
 */
...
public class AssociateDRTRoleResultJsonUnmarshaller implements Unmarshaller<AssociateDRTRoleResult, JsonUnmarshallerContext> {
    ...
    public AssociateDRTRoleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateDRTRoleResult associateDRTRoleResult = new AssociateDRTRoleResult();
