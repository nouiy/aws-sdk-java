...
public class AttackSummaryMarshaller {
    ...
    public void marshall(AttackSummary attackSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(attackSummary.getAttackId(), ATTACKID_BINDING);
            protocolMarshaller.marshall(attackSummary.getResourceArn(), RESOURCEARN_BINDING);
            protocolMarshaller.marshall(attackSummary.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(attackSummary.getEndTime(), ENDTIME_BINDING);
            protocolMarshaller.marshall(attackSummary.getAttackVectors(), ATTACKVECTORS_BINDING);
        } catch (Exception e) {
