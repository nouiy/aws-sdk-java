...
/**
 * DisassociateHealthCheckResult JSON Unmarshaller
 */
...
public class DisassociateHealthCheckResultJsonUnmarshaller implements Unmarshaller<DisassociateHealthCheckResult, JsonUnmarshallerContext> {
    ...
    public DisassociateHealthCheckResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateHealthCheckResult disassociateHealthCheckResult = new DisassociateHealthCheckResult();

        return disassociateHealthCheckResult;
    }
