...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/shield-2016-06-02/GetSubscriptionState" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetSubscriptionStateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getSubscriptionState() == null ^ this.getSubscriptionState() == null)
            return false;
        if (other.getSubscriptionState() != null && other.getSubscriptionState().equals(this.getSubscriptionState()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSubscriptionState() == null) ? 0 : getSubscriptionState().hashCode());
        return hashCode;
    }
