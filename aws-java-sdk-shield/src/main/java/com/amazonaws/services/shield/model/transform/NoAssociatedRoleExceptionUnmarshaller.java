...
public class NoAssociatedRoleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NoAssociatedRoleExceptionUnmarshaller instance;

    public static NoAssociatedRoleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoAssociatedRoleExceptionUnmarshaller();
        return instance;
    }
}
