...
public class CustomIndicesInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public CustomIndicesInput withOperations(java.util.Collection<Operation> operations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomIndicesInput == false)
            return false;
    ...
    public CustomIndicesInput clone() {
        try {
            return (CustomIndicesInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.CustomIndicesInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
