...
/**
 * ExportVectorEnrichmentJobRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ExportVectorEnrichmentJobRequestMarshaller {
    ...
    private static final ExportVectorEnrichmentJobRequestMarshaller instance = new ExportVectorEnrichmentJobRequestMarshaller();

    public static ExportVectorEnrichmentJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExportVectorEnrichmentJobRequest exportVectorEnrichmentJobRequest, ProtocolMarshaller protocolMarshaller) {
