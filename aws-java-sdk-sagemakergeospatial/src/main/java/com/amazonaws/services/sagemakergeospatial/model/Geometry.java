...
public class Geometry implements Serializable, Cloneable, StructuredPojo {
    ...
    public Geometry withCoordinates(java.util.List<java.util.List<Double>>... coordinates) {
    ...
    public Geometry withCoordinates(java.util.Collection<java.util.List<java.util.List<Double>>> coordinates) {
