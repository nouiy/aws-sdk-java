...
public class ExportErrorDetailsOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportErrorDetailsOutput == false)
            return false;
        ExportErrorDetailsOutput other = (ExportErrorDetailsOutput) obj;
    ...
    public ExportErrorDetailsOutput clone() {
        try {
            return (ExportErrorDetailsOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.ExportErrorDetailsOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
