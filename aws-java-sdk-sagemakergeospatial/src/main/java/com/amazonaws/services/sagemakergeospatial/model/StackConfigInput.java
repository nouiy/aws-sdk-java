...
public class StackConfigInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public StackConfigInput withTargetBands(java.util.Collection<String> targetBands) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StackConfigInput == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemakergeospatial.model.transform.StackConfigInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
