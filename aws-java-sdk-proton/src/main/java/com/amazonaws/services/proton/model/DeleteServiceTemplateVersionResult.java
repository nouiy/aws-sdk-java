...
public class DeleteServiceTemplateVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteServiceTemplateVersionResult withServiceTemplateVersion(ServiceTemplateVersion serviceTemplateVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteServiceTemplateVersionResult == false)
            return false;
        DeleteServiceTemplateVersionResult other = (DeleteServiceTemplateVersionResult) obj;
    ...
    @Override
    public DeleteServiceTemplateVersionResult clone() {
        try {
            return (DeleteServiceTemplateVersionResult) super.clone();
