...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/GetServiceTemplateVersion" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetServiceTemplateVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetServiceTemplateVersionRequest withMajorVersion(String majorVersion) {
    ...
    public GetServiceTemplateVersionRequest withMinorVersion(String minorVersion) {
    ...
    public GetServiceTemplateVersionRequest withTemplateName(String templateName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServiceTemplateVersionRequest == false)
            return false;
        GetServiceTemplateVersionRequest other = (GetServiceTemplateVersionRequest) obj;
    ...
    @Override
    public GetServiceTemplateVersionRequest clone() {
        return (GetServiceTemplateVersionRequest) super.clone();
    }
