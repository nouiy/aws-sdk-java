...
public class GetServiceSyncBlockerSummaryRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * The name of the service instance that you want to get the service sync blocker summary for. If given bothe the
     * instance name and the service name, only the instance is blocked.
     * </p>
     */
    private String serviceInstanceName;
    /**
     * <p>
     * The name of the service that you want to get the service sync blocker summary for. If given only the service
     * name, all instances are blocked.
     * </p>
     */
     ...
     *        the instance name and the service name, only the instance is blocked.
     */
     ...
     * </p>
     * 
     * @return The name of the service instance that you want to get the service sync blocker summary for. If given
     ...
     * </p>
     * 
     * @return The name of the service that you want to get the service sync blocker summary for. If given only the
     *         service name, all instances are blocked.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServiceSyncBlockerSummaryRequest == false)
            return false;
        GetServiceSyncBlockerSummaryRequest other = (GetServiceSyncBlockerSummaryRequest) obj;
