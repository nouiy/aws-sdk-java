...
public class CreateEnvironmentAccountConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEnvironmentAccountConnectionResult == false)
            return false;
        CreateEnvironmentAccountConnectionResult other = (CreateEnvironmentAccountConnectionResult) obj;
    ...
    public CreateEnvironmentAccountConnectionResult clone() {
        try {
            return (CreateEnvironmentAccountConnectionResult) super.clone();
