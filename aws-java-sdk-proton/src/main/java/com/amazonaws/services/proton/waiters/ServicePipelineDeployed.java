...
class ServicePipelineDeployed {
    ...
    static class IsSUCCEEDEDMatcher extends WaiterAcceptor<GetServiceResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("service"), new JmesPathField("pipeline"), new JmesPathField(
                "deploymentStatus"));
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetServiceResult> {
        private static final JsonNode expectedResult;
