...
class ServiceDeleted {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetServiceResult> {
        /**
    ...
    static class IsDELETE_FAILEDMatcher extends WaiterAcceptor<GetServiceResult> {
