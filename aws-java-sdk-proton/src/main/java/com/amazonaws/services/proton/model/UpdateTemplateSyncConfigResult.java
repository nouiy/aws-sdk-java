...
public class UpdateTemplateSyncConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateTemplateSyncConfigResult withTemplateSyncConfig(TemplateSyncConfig templateSyncConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTemplateSyncConfigResult == false)
            return false;
        UpdateTemplateSyncConfigResult other = (UpdateTemplateSyncConfigResult) obj;
    ...
    @Override
    public UpdateTemplateSyncConfigResult clone() {
        try {
            return (UpdateTemplateSyncConfigResult) super.clone();
