...
public class RepositoryBranch implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RepositoryBranch == false)
            return false;
        RepositoryBranch other = (RepositoryBranch) obj;
    ...
    public RepositoryBranch clone() {
        try {
            return (RepositoryBranch) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.proton.model.transform.RepositoryBranchMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
