...
public class CreateServiceSyncConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateServiceSyncConfigResult withServiceSyncConfig(ServiceSyncConfig serviceSyncConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateServiceSyncConfigResult == false)
            return false;
        CreateServiceSyncConfigResult other = (CreateServiceSyncConfigResult) obj;
    ...
    @Override
    public CreateServiceSyncConfigResult clone() {
        try {
            return (CreateServiceSyncConfigResult) super.clone();
