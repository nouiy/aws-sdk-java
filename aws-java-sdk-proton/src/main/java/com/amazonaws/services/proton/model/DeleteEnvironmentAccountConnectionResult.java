...
public class DeleteEnvironmentAccountConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteEnvironmentAccountConnectionResult withEnvironmentAccountConnection(EnvironmentAccountConnection environmentAccountConnection) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteEnvironmentAccountConnectionResult == false)
            return false;
        DeleteEnvironmentAccountConnectionResult other = (DeleteEnvironmentAccountConnectionResult) obj;
    ...
    @Override
    public DeleteEnvironmentAccountConnectionResult clone() {
        try {
            return (DeleteEnvironmentAccountConnectionResult) super.clone();
