...
public enum ListServiceInstancesFilterBy {
    ...
    private ListServiceInstancesFilterBy(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return ListServiceInstancesFilterBy corresponding to the value
     *
    ...
    public static ListServiceInstancesFilterBy fromValue(String value) {
        ...
        for (ListServiceInstancesFilterBy enumEntry : ListServiceInstancesFilterBy.values()) {
