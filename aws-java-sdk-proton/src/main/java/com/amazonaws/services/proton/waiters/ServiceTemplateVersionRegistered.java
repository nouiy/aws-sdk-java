...
class ServiceTemplateVersionRegistered {
    ...
    static class IsDRAFTMatcher extends WaiterAcceptor<GetServiceTemplateVersionResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("serviceTemplateVersion"), new JmesPathField("status"));
         ...
         */
        @Override
        public boolean matches(GetServiceTemplateVersionResult result) {
    ...
    static class IsPUBLISHEDMatcher extends WaiterAcceptor<GetServiceTemplateVersionResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsREGISTRATION_FAILEDMatcher extends WaiterAcceptor<GetServiceTemplateVersionResult> {
        private static final JsonNode expectedResult;
