...
class EnvironmentDeployed {
    ...
    static class IsSUCCEEDEDMatcher extends WaiterAcceptor<GetEnvironmentResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("environment"), new JmesPathField("deploymentStatus"));
         ...
         */
        @Override
        public boolean matches(GetEnvironmentResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetEnvironmentResult> {
        private static final JsonNode expectedResult;
