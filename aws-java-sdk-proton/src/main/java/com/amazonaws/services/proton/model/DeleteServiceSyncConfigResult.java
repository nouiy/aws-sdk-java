...
public class DeleteServiceSyncConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The detailed data for the service sync config.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteServiceSyncConfigResult == false)
            return false;
        DeleteServiceSyncConfigResult other = (DeleteServiceSyncConfigResult) obj;
    ...
    @Override
    public DeleteServiceSyncConfigResult clone() {
        try {
