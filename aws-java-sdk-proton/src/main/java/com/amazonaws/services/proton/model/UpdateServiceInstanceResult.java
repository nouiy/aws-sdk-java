...
public class UpdateServiceInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateServiceInstanceResult withServiceInstance(ServiceInstance serviceInstance) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateServiceInstanceResult == false)
            return false;
        UpdateServiceInstanceResult other = (UpdateServiceInstanceResult) obj;
    ...
    @Override
    public UpdateServiceInstanceResult clone() {
        try {
            return (UpdateServiceInstanceResult) super.clone();
