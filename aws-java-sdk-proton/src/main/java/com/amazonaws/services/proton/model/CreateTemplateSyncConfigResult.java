...
public class CreateTemplateSyncConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateTemplateSyncConfigResult == false)
            return false;
        CreateTemplateSyncConfigResult other = (CreateTemplateSyncConfigResult) obj;
    ...
    public CreateTemplateSyncConfigResult clone() {
        try {
            return (CreateTemplateSyncConfigResult) super.clone();
