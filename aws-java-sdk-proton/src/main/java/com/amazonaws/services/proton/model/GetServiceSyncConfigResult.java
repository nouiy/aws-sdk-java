...
public class GetServiceSyncConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The detailed data of the requested service sync configuration.
     */
    ...
    public GetServiceSyncConfigResult withServiceSyncConfig(ServiceSyncConfig serviceSyncConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServiceSyncConfigResult == false)
            return false;
        GetServiceSyncConfigResult other = (GetServiceSyncConfigResult) obj;
    ...
    @Override
    public GetServiceSyncConfigResult clone() {
        try {
            return (GetServiceSyncConfigResult) super.clone();
