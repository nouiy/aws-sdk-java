...
public class UpdateServicePipelineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateServicePipelineResult withPipeline(ServicePipeline pipeline) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateServicePipelineResult == false)
            return false;
        UpdateServicePipelineResult other = (UpdateServicePipelineResult) obj;
    ...
    @Override
    public UpdateServicePipelineResult clone() {
        try {
            return (UpdateServicePipelineResult) super.clone();
