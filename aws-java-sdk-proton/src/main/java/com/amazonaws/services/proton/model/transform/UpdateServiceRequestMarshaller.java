...
public class UpdateServiceRequestMarshaller {
    ...
    public void marshall(UpdateServiceRequest updateServiceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateServiceRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateServiceRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateServiceRequest.getSpec(), SPEC_BINDING);
        } catch (Exception e) {
