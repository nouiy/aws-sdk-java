...
public class ListEnvironmentTemplatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<EnvironmentTemplateSummary> templates;
    ...
    public java.util.List<EnvironmentTemplateSummary> getTemplates() {
        return templates;
    }
    ...
    public void setTemplates(java.util.Collection<EnvironmentTemplateSummary> templates) {
        if (templates == null) {
            this.templates = null;
            return;
        }

        this.templates = new java.util.ArrayList<EnvironmentTemplateSummary>(templates);
    }
    ...
    public ListEnvironmentTemplatesResult withTemplates(EnvironmentTemplateSummary... templates) {
        if (this.templates == null) {
            setTemplates(new java.util.ArrayList<EnvironmentTemplateSummary>(templates.length));
        }
        for (EnvironmentTemplateSummary ele : templates) {
    ...
    public ListEnvironmentTemplatesResult withTemplates(java.util.Collection<EnvironmentTemplateSummary> templates) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEnvironmentTemplatesResult == false)
            return false;
        ListEnvironmentTemplatesResult other = (ListEnvironmentTemplatesResult) obj;
    ...
    public ListEnvironmentTemplatesResult clone() {
        try {
            return (ListEnvironmentTemplatesResult) super.clone();
