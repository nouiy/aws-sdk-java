 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/proton-2020-07-20/EnvironmentTemplateSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EnvironmentTemplateSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public EnvironmentTemplateSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public EnvironmentTemplateSummary withLastModifiedAt(java.util.Date lastModifiedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnvironmentTemplateSummary == false)
            return false;
    ...
    public EnvironmentTemplateSummary clone() {
        try {
            return (EnvironmentTemplateSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.proton.model.transform.EnvironmentTemplateSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
