...
public class InternalServiceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServiceExceptionUnmarshaller() {
        super(com.amazonaws.services.connectcontactlens.model.InternalServiceException.class, "InternalServiceException");
    }

    @Override
    public com.amazonaws.services.connectcontactlens.model.InternalServiceException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.connectcontactlens.model.InternalServiceException internalServiceException = new com.amazonaws.services.connectcontactlens.model.InternalServiceException(
                null);
