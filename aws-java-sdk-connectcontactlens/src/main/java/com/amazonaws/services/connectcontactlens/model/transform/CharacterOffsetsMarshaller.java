...
/**
 * CharacterOffsetsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CharacterOffsetsMarshaller {
    ...
    private static final CharacterOffsetsMarshaller instance = new CharacterOffsetsMarshaller();

    public static CharacterOffsetsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CharacterOffsets characterOffsets, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(characterOffsets.getBeginOffsetChar(), BEGINOFFSETCHAR_BINDING);
            protocolMarshaller.marshall(characterOffsets.getEndOffsetChar(), ENDOFFSETCHAR_BINDING);
        } catch (Exception e) {
