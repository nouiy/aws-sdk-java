...
public class DeleteFirewallDomainListResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteFirewallDomainListResult == false)
            return false;
        DeleteFirewallDomainListResult other = (DeleteFirewallDomainListResult) obj;
    ...
    public DeleteFirewallDomainListResult clone() {
        try {
            return (DeleteFirewallDomainListResult) super.clone();
