...
public class AssociateResolverQueryLogConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return A complex type that contains settings for a specified association between an Amazon VPC and a query
     *         logging configuration.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateResolverQueryLogConfigResult == false)
            return false;
        AssociateResolverQueryLogConfigResult other = (AssociateResolverQueryLogConfigResult) obj;
    ...
    @Override
    public AssociateResolverQueryLogConfigResult clone() {
        try {
            return (AssociateResolverQueryLogConfigResult) super.clone();
