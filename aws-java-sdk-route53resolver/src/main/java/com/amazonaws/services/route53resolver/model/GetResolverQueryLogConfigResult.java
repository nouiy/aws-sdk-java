...
public class GetResolverQueryLogConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetResolverQueryLogConfigResult withResolverQueryLogConfig(ResolverQueryLogConfig resolverQueryLogConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetResolverQueryLogConfigResult == false)
            return false;
        GetResolverQueryLogConfigResult other = (GetResolverQueryLogConfigResult) obj;
    ...
    @Override
    public GetResolverQueryLogConfigResult clone() {
        try {
            return (GetResolverQueryLogConfigResult) super.clone();
