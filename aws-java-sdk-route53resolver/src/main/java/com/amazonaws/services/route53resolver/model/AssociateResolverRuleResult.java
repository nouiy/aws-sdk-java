...
public class AssociateResolverRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * Information about the <code>AssociateResolverRule</code> request, including the status of the request.
     * </p>
     */
    ...
    public AssociateResolverRuleResult withResolverRuleAssociation(ResolverRuleAssociation resolverRuleAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateResolverRuleResult == false)
            return false;
        AssociateResolverRuleResult other = (AssociateResolverRuleResult) obj;
    ...
    @Override
    public AssociateResolverRuleResult clone() {
        try {
            return (AssociateResolverRuleResult) super.clone();
