...
public class UpdateResolverConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array that contains settings for the specified Resolver configuration.
     */
    ...
    public UpdateResolverConfigResult withResolverConfig(ResolverConfig resolverConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateResolverConfigResult == false)
            return false;
        UpdateResolverConfigResult other = (UpdateResolverConfigResult) obj;
    ...
    @Override
    public UpdateResolverConfigResult clone() {
        try {
            return (UpdateResolverConfigResult) super.clone();
