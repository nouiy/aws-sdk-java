...
public class UpdateFirewallDomainsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateFirewallDomainsResult == false)
            return false;
        UpdateFirewallDomainsResult other = (UpdateFirewallDomainsResult) obj;
    ...
    public UpdateFirewallDomainsResult clone() {
        try {
            return (UpdateFirewallDomainsResult) super.clone();
