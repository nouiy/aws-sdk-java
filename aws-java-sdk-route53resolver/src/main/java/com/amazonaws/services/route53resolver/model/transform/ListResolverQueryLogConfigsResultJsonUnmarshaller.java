...
/**
 * ListResolverQueryLogConfigsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListResolverQueryLogConfigsResultJsonUnmarshaller implements Unmarshaller<ListResolverQueryLogConfigsResult, JsonUnmarshallerContext> {

    public ListResolverQueryLogConfigsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListResolverQueryLogConfigsResult listResolverQueryLogConfigsResult = new ListResolverQueryLogConfigsResult();
    ...
    private static ListResolverQueryLogConfigsResultJsonUnmarshaller instance;

    public static ListResolverQueryLogConfigsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListResolverQueryLogConfigsResultJsonUnmarshaller();
        return instance;
    }
}
