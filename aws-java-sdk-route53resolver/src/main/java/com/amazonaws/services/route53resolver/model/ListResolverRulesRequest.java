...
public class ListResolverRulesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListResolverRulesRequest withMaxResults(Integer maxResults) {
    ...
    public ListResolverRulesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResolverRulesRequest == false)
            return false;
        ListResolverRulesRequest other = (ListResolverRulesRequest) obj;
    ...
    public ListResolverRulesRequest clone() {
        return (ListResolverRulesRequest) super.clone();
    }
