...
public class AssociateFirewallRuleGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateFirewallRuleGroupResult == false)
            return false;
        AssociateFirewallRuleGroupResult other = (AssociateFirewallRuleGroupResult) obj;
    ...
    public AssociateFirewallRuleGroupResult clone() {
        try {
            return (AssociateFirewallRuleGroupResult) super.clone();
