...
/**
 * ResolverQueryLogConfigAssociation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResolverQueryLogConfigAssociationJsonUnmarshaller implements Unmarshaller<ResolverQueryLogConfigAssociation, JsonUnmarshallerContext> {

    public ResolverQueryLogConfigAssociation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ResolverQueryLogConfigAssociation resolverQueryLogConfigAssociation = new ResolverQueryLogConfigAssociation();
    ...
    private static ResolverQueryLogConfigAssociationJsonUnmarshaller instance;

    public static ResolverQueryLogConfigAssociationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResolverQueryLogConfigAssociationJsonUnmarshaller();
        return instance;
    }
}
