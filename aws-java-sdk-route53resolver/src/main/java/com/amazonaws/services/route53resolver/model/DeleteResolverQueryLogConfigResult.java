...
public class DeleteResolverQueryLogConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteResolverQueryLogConfigResult == false)
            return false;
        DeleteResolverQueryLogConfigResult other = (DeleteResolverQueryLogConfigResult) obj;
    ...
    public DeleteResolverQueryLogConfigResult clone() {
        try {
            return (DeleteResolverQueryLogConfigResult) super.clone();
