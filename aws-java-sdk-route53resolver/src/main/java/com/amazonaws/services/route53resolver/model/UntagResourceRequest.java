...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The Amazon Resource Name (ARN) for the resource that you want to remove tags from. To get the ARN for a resource,
     * use the applicable <code>Get</code> or <code>List</code> command:
     * </p>
     * <ul>
     * <li>
     * <p>
     ...
     * </ul>
     * 
     * @return The Amazon Resource Name (ARN) for the resource that you want to remove tags from. To get the ARN for a
     *         resource, use the applicable <code>Get</code> or <code>List</code> command: </p>
     *         <ul>
     *         <li>
     *         <p>
