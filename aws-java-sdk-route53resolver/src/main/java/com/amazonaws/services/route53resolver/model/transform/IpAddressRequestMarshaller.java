...
/**
 * IpAddressRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class IpAddressRequestMarshaller {
    ...
    private static final IpAddressRequestMarshaller instance = new IpAddressRequestMarshaller();

    public static IpAddressRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IpAddressRequest ipAddressRequest, ProtocolMarshaller protocolMarshaller) {
