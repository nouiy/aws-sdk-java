...
/**
 * StartCanaryResult JSON Unmarshaller
 */
...
public class StartCanaryResultJsonUnmarshaller implements Unmarshaller<StartCanaryResult, JsonUnmarshallerContext> {
    ...
    public StartCanaryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StartCanaryResult startCanaryResult = new StartCanaryResult();
