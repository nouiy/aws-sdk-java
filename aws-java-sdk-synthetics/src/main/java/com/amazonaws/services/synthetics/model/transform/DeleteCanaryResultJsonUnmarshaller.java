...
/**
 * DeleteCanaryResult JSON Unmarshaller
 */
...
public class DeleteCanaryResultJsonUnmarshaller implements Unmarshaller<DeleteCanaryResult, JsonUnmarshallerContext> {
    ...
    public DeleteCanaryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCanaryResult deleteCanaryResult = new DeleteCanaryResult();
