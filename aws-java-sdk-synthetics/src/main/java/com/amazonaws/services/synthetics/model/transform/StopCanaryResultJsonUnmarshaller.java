...
/**
 * StopCanaryResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopCanaryResultJsonUnmarshaller implements Unmarshaller<StopCanaryResult, JsonUnmarshallerContext> {

    public StopCanaryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopCanaryResult stopCanaryResult = new StopCanaryResult();
