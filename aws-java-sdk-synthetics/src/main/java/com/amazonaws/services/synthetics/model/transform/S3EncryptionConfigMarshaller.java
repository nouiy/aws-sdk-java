...
public class S3EncryptionConfigMarshaller {
    ...
    public void marshall(S3EncryptionConfig s3EncryptionConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(s3EncryptionConfig.getEncryptionMode(), ENCRYPTIONMODE_BINDING);
            protocolMarshaller.marshall(s3EncryptionConfig.getKmsKeyArn(), KMSKEYARN_BINDING);
        } catch (Exception e) {
