 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/synthetics-2017-10-11/CanaryRunTimeline" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CanaryRunTimeline implements Serializable, Cloneable, StructuredPojo {
    ...
    public CanaryRunTimeline clone() {
        try {
            return (CanaryRunTimeline) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.synthetics.model.transform.CanaryRunTimelineMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
