...
public class DBInstanceStatusInfo implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A Boolean value that is <code>true</code> if the instance is operating normally, or <code>false</code> if the
     ...
     * </p>
     * 
     * @return This value is currently "<code>read replication</code>."
     */
     ...
     * 
     * @param normal
     *        A Boolean value that is <code>true</code> if the instance is operating normally, or <code>false</code> if
     ...
     * </p>
     * 
     * @return A Boolean value that is <code>true</code> if the instance is operating normally, or <code>false</code> if
     *         the instance is in an error state.
     */
