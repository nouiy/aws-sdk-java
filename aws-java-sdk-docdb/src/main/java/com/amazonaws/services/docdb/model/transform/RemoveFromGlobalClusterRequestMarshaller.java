...
/**
 * RemoveFromGlobalClusterRequest Marshaller
 */
...
public class RemoveFromGlobalClusterRequestMarshaller implements Marshaller<Request<RemoveFromGlobalClusterRequest>, RemoveFromGlobalClusterRequest> {
    ...
    public Request<RemoveFromGlobalClusterRequest> marshall(RemoveFromGlobalClusterRequest removeFromGlobalClusterRequest) {
        ...
        Request<RemoveFromGlobalClusterRequest> request = new DefaultRequest<RemoveFromGlobalClusterRequest>(removeFromGlobalClusterRequest, "AmazonDocDB");
        ...
        if (removeFromGlobalClusterRequest.getGlobalClusterIdentifier() != null) {
            request.addParameter("GlobalClusterIdentifier", StringUtils.fromString(removeFromGlobalClusterRequest.getGlobalClusterIdentifier()));
        }

        if (removeFromGlobalClusterRequest.getDbClusterIdentifier() != null) {
            request.addParameter("DbClusterIdentifier", StringUtils.fromString(removeFromGlobalClusterRequest.getDbClusterIdentifier()));
        }
