 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/EventSubscription" target="_top">AWS API
 *      Documentation</a>
 */
...
public class EventSubscription implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * The <code>no-permission</code> status indicates that Amazon DocumentDB no longer has permission to post to the
     * SNS topic. The <code>topic-not-exist</code> status indicates that the topic was deleted after the subscription
     * was created.
     * </p>
     */
    ...
    /**
     * <p>
     * A Boolean value indicating whether the subscription is enabled. A value of <code>true</code> indicates that the
     ...
     * </p>
     * 
     * @return The Amazon DocumentDB event notification subscription ID.
     */
     ...
     * </p>
     * 
     * @return The topic ARN of the Amazon DocumentDB event notification subscription.
     */
     ...
     * 
     * @param status
     *        The status of the Amazon DocumentDB event notification subscription.</p>
     *        <p>
     *        Constraints:
     *        </p>
     *        <p>
     ...
     *        </p>
     *        <p>
     *        The <code>no-permission</code> status indicates that Amazon DocumentDB no longer has permission to post to
     *        the SNS topic. The <code>topic-not-exist</code> status indicates that the topic was deleted after the
     ...
     * </p>
     * 
     * @return The status of the Amazon DocumentDB event notification subscription.</p>
     *         <p>
     *         Constraints:
     *         </p>
     *         <p>
     ...
     *         </p>
     *         <p>
     *         The <code>no-permission</code> status indicates that Amazon DocumentDB no longer has permission to post
     *         to the SNS topic. The <code>topic-not-exist</code> status indicates that the topic was deleted after the
     *         subscription was created.
     */
     ...
     * </p>
     * 
     * @return The time at which the Amazon DocumentDB event notification subscription was created.
     */
     ...
     * </p>
     * 
     * @return The source type for the Amazon DocumentDB event notification subscription.
     */
     ...
     * </p>
     * 
     * @return A list of source IDs for the Amazon DocumentDB event notification subscription.
     */
     ...
     * </p>
     * 
     * @return A list of event categories for the Amazon DocumentDB event notification subscription.
     */
     ...
     * 
     * @param enabled
     *        A Boolean value indicating whether the subscription is enabled. A value of <code>true</code> indicates
     ...
     * </p>
     * 
     * @return A Boolean value indicating whether the subscription is enabled. A value of <code>true</code> indicates
     *         that the subscription is enabled.
     */
