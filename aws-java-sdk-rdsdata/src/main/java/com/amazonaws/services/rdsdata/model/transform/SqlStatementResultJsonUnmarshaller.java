...
/**
 * SqlStatementResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SqlStatementResultJsonUnmarshaller implements Unmarshaller<SqlStatementResult, JsonUnmarshallerContext> {

    public SqlStatementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SqlStatementResultJsonUnmarshaller instance;

    public static SqlStatementResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SqlStatementResultJsonUnmarshaller();
        return instance;
    }
}
