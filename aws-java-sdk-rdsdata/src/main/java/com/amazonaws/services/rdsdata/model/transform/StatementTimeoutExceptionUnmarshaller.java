...
public class StatementTimeoutExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("dbConnectionId", targetDepth)) {
                    context.nextToken();
                    statementTimeoutException.setDbConnectionId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
    ...
    private static StatementTimeoutExceptionUnmarshaller instance;

    public static StatementTimeoutExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new StatementTimeoutExceptionUnmarshaller();
        return instance;
    }
}
