...
/**
 * ResponseInspection JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ResponseInspectionJsonUnmarshaller implements Unmarshaller<ResponseInspection, JsonUnmarshallerContext> {

    public ResponseInspection unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ResponseInspectionJsonUnmarshaller instance;

    public static ResponseInspectionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ResponseInspectionJsonUnmarshaller();
        return instance;
    }
}
