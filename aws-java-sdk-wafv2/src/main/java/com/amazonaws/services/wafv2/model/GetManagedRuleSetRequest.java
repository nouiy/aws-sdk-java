...
public class GetManagedRuleSetRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetManagedRuleSetRequest withName(String name) {
        setName(name);
        return this;
    }
    ...
    public GetManagedRuleSetRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public GetManagedRuleSetRequest withScope(Scope scope) {
    ...
    public GetManagedRuleSetRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetManagedRuleSetRequest == false)
            return false;
        GetManagedRuleSetRequest other = (GetManagedRuleSetRequest) obj;
    ...
    @Override
    public GetManagedRuleSetRequest clone() {
        return (GetManagedRuleSetRequest) super.clone();
    }
