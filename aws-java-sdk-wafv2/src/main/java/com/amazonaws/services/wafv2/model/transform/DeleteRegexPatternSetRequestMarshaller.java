...
public class DeleteRegexPatternSetRequestMarshaller {
    ...
    public void marshall(DeleteRegexPatternSetRequest deleteRegexPatternSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteRegexPatternSetRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(deleteRegexPatternSetRequest.getScope(), SCOPE_BINDING);
            protocolMarshaller.marshall(deleteRegexPatternSetRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(deleteRegexPatternSetRequest.getLockToken(), LOCKTOKEN_BINDING);
        } catch (Exception e) {
