...
/**
 * GetRuleGroupResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetRuleGroupResultJsonUnmarshaller implements Unmarshaller<GetRuleGroupResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("RuleGroup", targetDepth)) {
                    context.nextToken();
                    getRuleGroupResult.setRuleGroup(RuleGroupJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("LockToken", targetDepth)) {
                    context.nextToken();
                    getRuleGroupResult.setLockToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
