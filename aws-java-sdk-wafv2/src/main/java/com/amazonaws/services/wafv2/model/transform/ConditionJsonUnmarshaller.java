        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ActionCondition", targetDepth)) {
                    context.nextToken();
                    condition.setActionCondition(ActionConditionJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("LabelNameCondition", targetDepth)) {
                    context.nextToken();
                    condition.setLabelNameCondition(LabelNameConditionJsonUnmarshaller.getInstance().unmarshall(context));
                }
