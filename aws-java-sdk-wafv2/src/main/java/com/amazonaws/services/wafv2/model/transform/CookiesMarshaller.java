...
@SdkInternalApi
public class CookiesMarshaller {
    ...
    private static final CookiesMarshaller instance = new CookiesMarshaller();

    public static CookiesMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Cookies cookies, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(cookies.getMatchPattern(), MATCHPATTERN_BINDING);
            protocolMarshaller.marshall(cookies.getMatchScope(), MATCHSCOPE_BINDING);
            protocolMarshaller.marshall(cookies.getOversizeHandling(), OVERSIZEHANDLING_BINDING);
        } catch (Exception e) {
