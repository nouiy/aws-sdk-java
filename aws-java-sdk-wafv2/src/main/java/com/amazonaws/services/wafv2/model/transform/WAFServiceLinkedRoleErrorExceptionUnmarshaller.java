...
public class WAFServiceLinkedRoleErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private WAFServiceLinkedRoleErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.wafv2.model.WAFServiceLinkedRoleErrorException.class, "WAFServiceLinkedRoleErrorException");
    }

    @Override
    public com.amazonaws.services.wafv2.model.WAFServiceLinkedRoleErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.wafv2.model.WAFServiceLinkedRoleErrorException wAFServiceLinkedRoleErrorException = new com.amazonaws.services.wafv2.model.WAFServiceLinkedRoleErrorException(
                null);
