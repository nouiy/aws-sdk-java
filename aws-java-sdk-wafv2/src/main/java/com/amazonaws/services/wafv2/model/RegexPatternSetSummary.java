 ...
 * information like the ID, that you can use to retrieve and manage a <code>RegexPatternSet</code>, and the ARN, that
 * you provide to the <a>RegexPatternSetReferenceStatement</a> to use the pattern set in a <a>Rule</a>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/RegexPatternSetSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class RegexPatternSetSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public RegexPatternSetSummary withLockToken(String lockToken) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.RegexPatternSetSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
