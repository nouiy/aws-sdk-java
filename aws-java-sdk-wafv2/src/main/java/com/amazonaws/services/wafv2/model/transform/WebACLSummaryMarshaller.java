...
public class WebACLSummaryMarshaller {
    ...
    public void marshall(WebACLSummary webACLSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(webACLSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(webACLSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(webACLSummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(webACLSummary.getLockToken(), LOCKTOKEN_BINDING);
            protocolMarshaller.marshall(webACLSummary.getARN(), ARN_BINDING);
        } catch (Exception e) {
