 ...
 * case, <code>EndTime</code> is the time that WAF received the 5,000th request.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wafv2-2019-07-29/TimeWindow" target="_top">AWS API
 *      Documentation</a>
 */
...
public class TimeWindow implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wafv2.model.transform.TimeWindowMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
