...
public class CreateIPSetRequestMarshaller {
    ...
    public void marshall(CreateIPSetRequest createIPSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createIPSetRequest.getScope(), SCOPE_BINDING);
            protocolMarshaller.marshall(createIPSetRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createIPSetRequest.getIPAddressVersion(), IPADDRESSVERSION_BINDING);
            protocolMarshaller.marshall(createIPSetRequest.getAddresses(), ADDRESSES_BINDING);
