...
public class ListManagedRuleSetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListManagedRuleSetsRequest withScope(String scope) {
        setScope(scope);
        return this;
    }
    ...
    public ListManagedRuleSetsRequest withNextMarker(String nextMarker) {
    ...
    public ListManagedRuleSetsRequest withLimit(Integer limit) {
        setLimit(limit);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListManagedRuleSetsRequest == false)
            return false;
        ListManagedRuleSetsRequest other = (ListManagedRuleSetsRequest) obj;
    ...
    @Override
    public ListManagedRuleSetsRequest clone() {
