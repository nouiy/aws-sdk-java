...
/**
 * ManagedRuleGroupSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ManagedRuleGroupSummaryMarshaller {
    ...
    private static final ManagedRuleGroupSummaryMarshaller instance = new ManagedRuleGroupSummaryMarshaller();

    public static ManagedRuleGroupSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ManagedRuleGroupSummary managedRuleGroupSummary, ProtocolMarshaller protocolMarshaller) {

        if (managedRuleGroupSummary == null) {
