...
@SdkInternalApi
public class GeoMatchStatementMarshaller {
    ...
    public static GeoMatchStatementMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GeoMatchStatement geoMatchStatement, ProtocolMarshaller protocolMarshaller) {
