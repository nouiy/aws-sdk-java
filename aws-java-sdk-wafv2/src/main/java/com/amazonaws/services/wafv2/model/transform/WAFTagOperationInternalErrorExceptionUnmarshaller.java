...
public class WAFTagOperationInternalErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private WAFTagOperationInternalErrorExceptionUnmarshaller() {
        super(com.amazonaws.services.wafv2.model.WAFTagOperationInternalErrorException.class, "WAFTagOperationInternalErrorException");
    }

    @Override
    public com.amazonaws.services.wafv2.model.WAFTagOperationInternalErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.wafv2.model.WAFTagOperationInternalErrorException wAFTagOperationInternalErrorException = new com.amazonaws.services.wafv2.model.WAFTagOperationInternalErrorException(
                null);
