...
/**
 * UpdateRowDataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateRowDataMarshaller {
    ...
    private static final UpdateRowDataMarshaller instance = new UpdateRowDataMarshaller();

    public static UpdateRowDataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateRowData updateRowData, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateRowData.getRowId(), ROWID_BINDING);
            protocolMarshaller.marshall(updateRowData.getCellsToUpdate(), CELLSTOUPDATE_BINDING);
        } catch (Exception e) {
