        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("formula", targetDepth)) {
                    context.nextToken();
                    filter.setFormula(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("contextRowId", targetDepth)) {
                    context.nextToken();
                    filter.setContextRowId(context.getUnmarshaller(String.class).unmarshall(context));
                }
