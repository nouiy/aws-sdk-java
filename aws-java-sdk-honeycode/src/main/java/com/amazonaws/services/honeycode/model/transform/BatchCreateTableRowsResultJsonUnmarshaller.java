...
/**
 * BatchCreateTableRowsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchCreateTableRowsResultJsonUnmarshaller implements Unmarshaller<BatchCreateTableRowsResult, JsonUnmarshallerContext> {

    public BatchCreateTableRowsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchCreateTableRowsResult batchCreateTableRowsResult = new BatchCreateTableRowsResult();
    ...
    private static BatchCreateTableRowsResultJsonUnmarshaller instance;

    public static BatchCreateTableRowsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BatchCreateTableRowsResultJsonUnmarshaller();
        return instance;
    }
}
