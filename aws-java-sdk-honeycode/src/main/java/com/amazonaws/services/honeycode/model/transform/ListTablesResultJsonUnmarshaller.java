        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tables", targetDepth)) {
                    context.nextToken();
                    listTablesResult.setTables(new ListUnmarshaller<Table>(TableJsonUnmarshaller.getInstance())
                ...
                if (context.testExpression("workbookCursor", targetDepth)) {
                    context.nextToken();
                    listTablesResult.setWorkbookCursor(context.getUnmarshaller(Long.class).unmarshall(context));
                }
