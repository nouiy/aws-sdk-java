...
public class DeviceStatusDetailMarshaller {
    ...
    private static final DeviceStatusDetailMarshaller instance = new DeviceStatusDetailMarshaller();

    public static DeviceStatusDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeviceStatusDetail deviceStatusDetail, ProtocolMarshaller protocolMarshaller) {
