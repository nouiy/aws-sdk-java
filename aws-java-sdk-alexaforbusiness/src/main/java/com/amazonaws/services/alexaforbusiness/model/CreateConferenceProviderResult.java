...
public class CreateConferenceProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConferenceProviderResult == false)
            return false;
        CreateConferenceProviderResult other = (CreateConferenceProviderResult) obj;
    ...
    public CreateConferenceProviderResult clone() {
        try {
            return (CreateConferenceProviderResult) super.clone();
