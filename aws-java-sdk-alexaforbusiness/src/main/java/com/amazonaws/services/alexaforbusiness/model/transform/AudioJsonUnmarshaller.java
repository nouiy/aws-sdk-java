        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Locale", targetDepth)) {
                    context.nextToken();
                    audio.setLocale(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Location", targetDepth)) {
                    context.nextToken();
                    audio.setLocation(context.getUnmarshaller(String.class).unmarshall(context));
                }
