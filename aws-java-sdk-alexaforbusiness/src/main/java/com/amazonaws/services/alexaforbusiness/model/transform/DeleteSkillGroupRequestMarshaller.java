...
/**
 * DeleteSkillGroupRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteSkillGroupRequestMarshaller {
    ...
    private static final DeleteSkillGroupRequestMarshaller instance = new DeleteSkillGroupRequestMarshaller();

    public static DeleteSkillGroupRequestMarshaller getInstance() {
        return instance;
    }
