...
/**
 * GetAddressBookResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetAddressBookResultJsonUnmarshaller implements Unmarshaller<GetAddressBookResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AddressBook", targetDepth)) {
                    context.nextToken();
                    getAddressBookResult.setAddressBook(AddressBookJsonUnmarshaller.getInstance().unmarshall(context));
                }
