...
/**
 * DeleteAddressBookRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteAddressBookRequestMarshaller {
    ...
    private static final DeleteAddressBookRequestMarshaller instance = new DeleteAddressBookRequestMarshaller();

    public static DeleteAddressBookRequestMarshaller getInstance() {
        return instance;
    }
