...
public class NameInUseExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static NameInUseExceptionUnmarshaller instance;

    public static NameInUseExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NameInUseExceptionUnmarshaller();
        return instance;
    }
}
