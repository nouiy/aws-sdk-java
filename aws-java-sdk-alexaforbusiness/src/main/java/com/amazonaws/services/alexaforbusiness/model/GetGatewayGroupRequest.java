...
public class GetGatewayGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the gateway group to get.
     */
    ...
    public GetGatewayGroupRequest clone() {
        return (GetGatewayGroupRequest) super.clone();
    }
