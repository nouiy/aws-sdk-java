...
public class UpdateRoomRequestMarshaller {
    ...
    public void marshall(UpdateRoomRequest updateRoomRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateRoomRequest.getRoomArn(), ROOMARN_BINDING);
            protocolMarshaller.marshall(updateRoomRequest.getRoomName(), ROOMNAME_BINDING);
            protocolMarshaller.marshall(updateRoomRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(updateRoomRequest.getProviderCalendarId(), PROVIDERCALENDARID_BINDING);
            protocolMarshaller.marshall(updateRoomRequest.getProfileArn(), PROFILEARN_BINDING);
        } catch (Exception e) {
