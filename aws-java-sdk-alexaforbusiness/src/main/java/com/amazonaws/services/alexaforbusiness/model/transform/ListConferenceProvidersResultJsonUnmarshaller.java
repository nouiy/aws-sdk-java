...
/**
 * ListConferenceProvidersResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListConferenceProvidersResultJsonUnmarshaller implements Unmarshaller<ListConferenceProvidersResult, JsonUnmarshallerContext> {

    public ListConferenceProvidersResult unmarshall(JsonUnmarshallerContext context) throws Exception {
