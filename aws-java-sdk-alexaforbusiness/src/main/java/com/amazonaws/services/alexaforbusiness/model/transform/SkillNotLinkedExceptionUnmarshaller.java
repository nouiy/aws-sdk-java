...
public class SkillNotLinkedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SkillNotLinkedExceptionUnmarshaller instance;

    public static SkillNotLinkedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SkillNotLinkedExceptionUnmarshaller();
        return instance;
    }
}
