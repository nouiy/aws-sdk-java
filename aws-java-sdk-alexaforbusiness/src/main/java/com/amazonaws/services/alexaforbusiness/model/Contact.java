 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/alexaforbusiness-2017-11-09/Contact" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Contact implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The phone number of the contact. The phone number type defaults to WORK. You can either specify PhoneNumber or
     ...
     * 
     * @param phoneNumber
     *        The phone number of the contact. The phone number type defaults to WORK. You can either specify
     ...
     * </p>
     * 
     * @return The phone number of the contact. The phone number type defaults to WORK. You can either specify
     *         PhoneNumber or PhoneNumbers. We recommend that you use PhoneNumbers, which lets you specify the phone
     *         number type and multiple numbers.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.alexaforbusiness.model.transform.ContactMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
