...
public class InvalidSecretsManagerResourceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidSecretsManagerResourceExceptionUnmarshaller instance;

    public static InvalidSecretsManagerResourceExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidSecretsManagerResourceExceptionUnmarshaller();
        return instance;
    }
}
