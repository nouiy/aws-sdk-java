...
/**
 * DeleteBusinessReportScheduleResult JSON Unmarshaller
 */
...
public class DeleteBusinessReportScheduleResultJsonUnmarshaller implements Unmarshaller<DeleteBusinessReportScheduleResult, JsonUnmarshallerContext> {
    ...
    public DeleteBusinessReportScheduleResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteBusinessReportScheduleResult deleteBusinessReportScheduleResult = new DeleteBusinessReportScheduleResult();
