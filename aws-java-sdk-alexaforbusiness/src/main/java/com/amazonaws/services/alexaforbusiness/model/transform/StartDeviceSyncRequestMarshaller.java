...
@SdkInternalApi
public class StartDeviceSyncRequestMarshaller {
    ...
    private static final StartDeviceSyncRequestMarshaller instance = new StartDeviceSyncRequestMarshaller();

    public static StartDeviceSyncRequestMarshaller getInstance() {
        return instance;
    }
