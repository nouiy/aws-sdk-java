...
/**
 * UpdateConferenceProviderResult JSON Unmarshaller
 */
...
public class UpdateConferenceProviderResultJsonUnmarshaller implements Unmarshaller<UpdateConferenceProviderResult, JsonUnmarshallerContext> {
    ...
    public UpdateConferenceProviderResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateConferenceProviderResult updateConferenceProviderResult = new UpdateConferenceProviderResult();
