...
public class DeleteBusinessReportScheduleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteBusinessReportScheduleRequest clone() {
        return (DeleteBusinessReportScheduleRequest) super.clone();
    }
