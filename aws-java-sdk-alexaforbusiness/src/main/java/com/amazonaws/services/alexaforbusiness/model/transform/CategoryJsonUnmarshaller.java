        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CategoryId", targetDepth)) {
                    context.nextToken();
                    category.setCategoryId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("CategoryName", targetDepth)) {
                    context.nextToken();
                    category.setCategoryName(context.getUnmarshaller(String.class).unmarshall(context));
                }
