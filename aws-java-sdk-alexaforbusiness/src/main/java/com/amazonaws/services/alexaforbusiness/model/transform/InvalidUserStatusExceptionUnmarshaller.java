...
public class InvalidUserStatusExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidUserStatusExceptionUnmarshaller instance;

    public static InvalidUserStatusExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidUserStatusExceptionUnmarshaller();
        return instance;
    }
}
