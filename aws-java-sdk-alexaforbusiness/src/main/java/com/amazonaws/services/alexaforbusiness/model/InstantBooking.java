...
/**
 * <p>
 * Settings for the instant booking feature that are applied to a room profile. When users start their meeting with
 * Alexa, Alexa automatically books the room for the configured duration if the room is available.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/alexaforbusiness-2017-11-09/InstantBooking" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstantBooking implements Serializable, Cloneable, StructuredPojo {
    ...
    public InstantBooking withDurationInMinutes(Integer durationInMinutes) {
    ...
    public InstantBooking withEnabled(Boolean enabled) {
        setEnabled(enabled);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstantBooking == false)
            return false;
        InstantBooking other = (InstantBooking) obj;
    ...
    @Override
    public InstantBooking clone() {
        try {
            return (InstantBooking) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.alexaforbusiness.model.transform.InstantBookingMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
