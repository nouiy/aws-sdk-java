 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/alexaforbusiness-2017-11-09/EndOfMeetingReminder"
...
public class EndOfMeetingReminder implements Serializable, Cloneable, StructuredPojo {
    ...
    public EndOfMeetingReminder withReminderAtMinutes(Integer... reminderAtMinutes) {
    ...
    public EndOfMeetingReminder withReminderAtMinutes(java.util.Collection<Integer> reminderAtMinutes) {
    ...
    public EndOfMeetingReminder withReminderType(String reminderType) {
    ...
    public EndOfMeetingReminder withReminderType(EndOfMeetingReminderType reminderType) {
    ...
    public EndOfMeetingReminder withEnabled(Boolean enabled) {
        setEnabled(enabled);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EndOfMeetingReminder == false)
            return false;
    ...
    @Override
    public EndOfMeetingReminder clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.alexaforbusiness.model.transform.EndOfMeetingReminderMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
