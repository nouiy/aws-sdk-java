...
/**
 * DeleteRoomSkillParameterRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteRoomSkillParameterRequestMarshaller {
    ...
    private static final DeleteRoomSkillParameterRequestMarshaller instance = new DeleteRoomSkillParameterRequestMarshaller();

    public static DeleteRoomSkillParameterRequestMarshaller getInstance() {
        return instance;
    }
