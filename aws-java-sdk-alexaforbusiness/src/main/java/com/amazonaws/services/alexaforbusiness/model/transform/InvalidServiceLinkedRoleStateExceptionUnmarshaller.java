...
public class InvalidServiceLinkedRoleStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidServiceLinkedRoleStateExceptionUnmarshaller instance;

    public static InvalidServiceLinkedRoleStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidServiceLinkedRoleStateExceptionUnmarshaller();
        return instance;
    }
}
