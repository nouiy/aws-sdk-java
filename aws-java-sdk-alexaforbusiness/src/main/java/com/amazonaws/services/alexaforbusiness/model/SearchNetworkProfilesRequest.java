...
public class SearchNetworkProfilesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The filters to use to list a specified set of network profiles. Valid filters are NetworkProfileName,
    ...
    public SearchNetworkProfilesRequest withFilters(Filter... filters) {
    ...
    public SearchNetworkProfilesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * </p>
     * 
     * @return The sort order to use to list the specified set of network profiles. Valid sort criteria includes
     *         NetworkProfileName, Ssid, and SecurityType.
     */
    ...
    public SearchNetworkProfilesRequest withSortCriteria(Sort... sortCriteria) {
    ...
    public SearchNetworkProfilesRequest withSortCriteria(java.util.Collection<Sort> sortCriteria) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SearchNetworkProfilesRequest == false)
            return false;
        SearchNetworkProfilesRequest other = (SearchNetworkProfilesRequest) obj;
    ...
    public SearchNetworkProfilesRequest clone() {
        return (SearchNetworkProfilesRequest) super.clone();
    }
