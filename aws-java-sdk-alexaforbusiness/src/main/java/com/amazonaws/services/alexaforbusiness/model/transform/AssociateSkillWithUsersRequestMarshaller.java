...
/**
 * AssociateSkillWithUsersRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssociateSkillWithUsersRequestMarshaller {
    ...
    private static final AssociateSkillWithUsersRequestMarshaller instance = new AssociateSkillWithUsersRequestMarshaller();

    public static AssociateSkillWithUsersRequestMarshaller getInstance() {
        return instance;
    }
