 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/alexaforbusiness-2017-11-09/DeviceStatusDetail"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeviceStatusDetail implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public DeviceStatusDetail clone() {
        try {
            return (DeviceStatusDetail) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.alexaforbusiness.model.transform.DeviceStatusDetailMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
