...
public class SearchUsersRequestMarshaller {
    ...
    public void marshall(SearchUsersRequest searchUsersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchUsersRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(searchUsersRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(searchUsersRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(searchUsersRequest.getSortCriteria(), SORTCRITERIA_BINDING);
        } catch (Exception e) {
