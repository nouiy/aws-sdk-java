...
@SdkInternalApi
public class CreateParticipantConnectionRequestMarshaller {
    ...
    public static CreateParticipantConnectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateParticipantConnectionRequest createParticipantConnectionRequest, ProtocolMarshaller protocolMarshaller) {
