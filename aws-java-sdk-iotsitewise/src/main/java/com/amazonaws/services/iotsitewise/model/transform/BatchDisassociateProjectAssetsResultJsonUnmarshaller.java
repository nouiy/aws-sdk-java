...
/**
 * BatchDisassociateProjectAssetsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchDisassociateProjectAssetsResultJsonUnmarshaller implements Unmarshaller<BatchDisassociateProjectAssetsResult, JsonUnmarshallerContext> {

    public BatchDisassociateProjectAssetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
