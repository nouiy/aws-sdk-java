 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/TimeSeriesSummary" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TimeSeriesSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public TimeSeriesSummary withTimeSeriesCreationDate(java.util.Date timeSeriesCreationDate) {
    ...
    public TimeSeriesSummary withTimeSeriesLastUpdateDate(java.util.Date timeSeriesLastUpdateDate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimeSeriesSummary == false)
            return false;
    ...
    public TimeSeriesSummary clone() {
        try {
            return (TimeSeriesSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.TimeSeriesSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
