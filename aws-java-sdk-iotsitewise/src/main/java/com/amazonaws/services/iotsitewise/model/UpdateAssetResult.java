...
public class UpdateAssetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {

    /**
     * <p>
     * The status of the asset, which contains a state (<code>UPDATING</code> after successfully calling this operation)
     ...
     * 
     * @param assetStatus
     *        The status of the asset, which contains a state (<code>UPDATING</code> after successfully calling this
     ...
     * </p>
     * 
     * @return The status of the asset, which contains a state (<code>UPDATING</code> after successfully calling this
     *         operation) and any error message.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAssetResult == false)
            return false;
        UpdateAssetResult other = (UpdateAssetResult) obj;
