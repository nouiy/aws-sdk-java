...
public class ListAssetModelCompositeModelsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return A list that summarizes each composite model.
     */
    ...
    public ListAssetModelCompositeModelsResult withAssetModelCompositeModelSummaries(AssetModelCompositeModelSummary... assetModelCompositeModelSummaries) {
    ...
    public ListAssetModelCompositeModelsResult withAssetModelCompositeModelSummaries(
    ...
    public ListAssetModelCompositeModelsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAssetModelCompositeModelsResult == false)
            return false;
        ListAssetModelCompositeModelsResult other = (ListAssetModelCompositeModelsResult) obj;
    ...
    @Override
    public ListAssetModelCompositeModelsResult clone() {
        try {
            return (ListAssetModelCompositeModelsResult) super.clone();
