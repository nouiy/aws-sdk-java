...
public class CreateAssetModelCompositeModelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the composed asset model. You can use this ID when you call other IoT SiteWise APIs.
     */
    ...
    public CreateAssetModelCompositeModelResult withAssetModelCompositeModelId(String assetModelCompositeModelId) {
    ...
    public CreateAssetModelCompositeModelResult withAssetModelCompositeModelPath(AssetModelCompositeModelPathSegment... assetModelCompositeModelPath) {
    ...
    public CreateAssetModelCompositeModelResult withAssetModelCompositeModelPath(
    ...
    public CreateAssetModelCompositeModelResult withAssetModelStatus(AssetModelStatus assetModelStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAssetModelCompositeModelResult == false)
            return false;
        CreateAssetModelCompositeModelResult other = (CreateAssetModelCompositeModelResult) obj;
    ...
    @Override
    public CreateAssetModelCompositeModelResult clone() {
        try {
            return (CreateAssetModelCompositeModelResult) super.clone();
