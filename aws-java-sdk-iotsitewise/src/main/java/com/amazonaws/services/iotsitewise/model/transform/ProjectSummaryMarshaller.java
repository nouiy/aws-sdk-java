...
public class ProjectSummaryMarshaller {
    ...
    public void marshall(ProjectSummary projectSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(projectSummary.getCreationDate(), CREATIONDATE_BINDING);
            protocolMarshaller.marshall(projectSummary.getLastUpdateDate(), LASTUPDATEDATE_BINDING);
        } catch (Exception e) {
