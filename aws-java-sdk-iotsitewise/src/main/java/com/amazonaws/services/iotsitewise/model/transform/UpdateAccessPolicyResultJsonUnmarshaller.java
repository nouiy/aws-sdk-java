...
/**
 * UpdateAccessPolicyResult JSON Unmarshaller
 */
...
public class UpdateAccessPolicyResultJsonUnmarshaller implements Unmarshaller<UpdateAccessPolicyResult, JsonUnmarshallerContext> {
    ...
    public UpdateAccessPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAccessPolicyResult updateAccessPolicyResult = new UpdateAccessPolicyResult();
