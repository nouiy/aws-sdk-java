...
class AssetModelActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeAssetModelResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("assetModelStatus"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(DescribeAssetModelResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeAssetModelResult> {
        private static final JsonNode expectedResult;
