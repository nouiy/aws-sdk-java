...
/**
 * TumblingWindow JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TumblingWindowJsonUnmarshaller implements Unmarshaller<TumblingWindow, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("interval", targetDepth)) {
                    context.nextToken();
                    tumblingWindow.setInterval(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("offset", targetDepth)) {
                    context.nextToken();
                    tumblingWindow.setOffset(context.getUnmarshaller(String.class).unmarshall(context));
                }
