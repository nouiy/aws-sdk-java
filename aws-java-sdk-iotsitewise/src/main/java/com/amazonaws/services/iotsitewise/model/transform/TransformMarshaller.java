...
@SdkInternalApi
public class TransformMarshaller {
    ...
    public static TransformMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Transform transform, ProtocolMarshaller protocolMarshaller) {
