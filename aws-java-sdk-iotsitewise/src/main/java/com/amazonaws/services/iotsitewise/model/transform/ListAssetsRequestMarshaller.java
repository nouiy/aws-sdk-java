...
public class ListAssetsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> ASSETMODELID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("assetModelId").build();
    ...
    public void marshall(ListAssetsRequest listAssetsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listAssetsRequest.getAssetModelId(), ASSETMODELID_BINDING);
            protocolMarshaller.marshall(listAssetsRequest.getFilter(), FILTER_BINDING);
        } catch (Exception e) {
