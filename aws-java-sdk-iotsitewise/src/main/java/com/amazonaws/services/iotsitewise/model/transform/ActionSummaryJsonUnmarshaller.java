        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("actionId", targetDepth)) {
                    context.nextToken();
                    actionSummary.setActionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("actionDefinitionId", targetDepth)) {
                    context.nextToken();
                    actionSummary.setActionDefinitionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("targetResource", targetDepth)) {
                    context.nextToken();
                    actionSummary.setTargetResource(TargetResourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
