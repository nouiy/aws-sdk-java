...
/**
 * AssociateAssetsResult JSON Unmarshaller
 */
...
public class AssociateAssetsResultJsonUnmarshaller implements Unmarshaller<AssociateAssetsResult, JsonUnmarshallerContext> {
    ...
    public AssociateAssetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateAssetsResult associateAssetsResult = new AssociateAssetsResult();
