 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/CustomerManagedS3Storage"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomerManagedS3Storage implements Serializable, Cloneable, StructuredPojo {
    ...
    public CustomerManagedS3Storage withS3ResourceArn(String s3ResourceArn) {
        setS3ResourceArn(s3ResourceArn);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getS3ResourceArn() != null)
            sb.append("S3ResourceArn: ").append(getS3ResourceArn()).append(",");
        if (getRoleArn() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CustomerManagedS3Storage == false)
            return false;
        CustomerManagedS3Storage other = (CustomerManagedS3Storage) obj;
        if (other.getS3ResourceArn() == null ^ this.getS3ResourceArn() == null)
            return false;
        if (other.getS3ResourceArn() != null && other.getS3ResourceArn().equals(this.getS3ResourceArn()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getS3ResourceArn() == null) ? 0 : getS3ResourceArn().hashCode());
    ...
    public CustomerManagedS3Storage clone() {
        try {
            return (CustomerManagedS3Storage) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.CustomerManagedS3StorageMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
