...
public class UpdateGatewayRequestMarshaller {
    ...
    public void marshall(UpdateGatewayRequest updateGatewayRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateGatewayRequest.getGatewayId(), GATEWAYID_BINDING);
            protocolMarshaller.marshall(updateGatewayRequest.getGatewayName(), GATEWAYNAME_BINDING);
        } catch (Exception e) {
