...
class AssetActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribeAssetResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("assetStatus"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(DescribeAssetResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<DescribeAssetResult> {
        private static final JsonNode expectedResult;
