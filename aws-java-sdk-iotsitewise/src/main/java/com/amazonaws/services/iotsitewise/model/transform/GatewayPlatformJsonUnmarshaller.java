...
/**
 * GatewayPlatform JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GatewayPlatformJsonUnmarshaller implements Unmarshaller<GatewayPlatform, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("greengrass", targetDepth)) {
                    context.nextToken();
                    gatewayPlatform.setGreengrass(GreengrassJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("greengrassV2", targetDepth)) {
                    context.nextToken();
                    gatewayPlatform.setGreengrassV2(GreengrassV2JsonUnmarshaller.getInstance().unmarshall(context));
                }
