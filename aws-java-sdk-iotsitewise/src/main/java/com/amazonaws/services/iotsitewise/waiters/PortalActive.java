...
class PortalActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<DescribePortalResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("portalStatus"), new JmesPathField("state"));
         ...
         */
        @Override
        public boolean matches(DescribePortalResult result) {
