...
/**
 * <p>
 * Contains current status information for an asset model. For more information, see <a
 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotsitewise-2019-12-02/AssetModelStatus" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssetModelStatus implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public AssetModelStatus clone() {
        try {
            return (AssetModelStatus) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.iotsitewise.model.transform.AssetModelStatusMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
