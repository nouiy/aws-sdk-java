...
/**
 * AssetModelPropertyDefinition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssetModelPropertyDefinitionJsonUnmarshaller implements Unmarshaller<AssetModelPropertyDefinition, JsonUnmarshallerContext> {

    public AssetModelPropertyDefinition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    assetModelPropertyDefinition.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
