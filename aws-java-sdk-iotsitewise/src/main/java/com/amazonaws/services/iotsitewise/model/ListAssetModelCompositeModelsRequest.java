...
public class ListAssetModelCompositeModelsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAssetModelCompositeModelsRequest withAssetModelId(String assetModelId) {
    ...
    public ListAssetModelCompositeModelsRequest withNextToken(String nextToken) {
    ...
    public ListAssetModelCompositeModelsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAssetModelCompositeModelsRequest == false)
            return false;
        ListAssetModelCompositeModelsRequest other = (ListAssetModelCompositeModelsRequest) obj;
    ...
    @Override
    public ListAssetModelCompositeModelsRequest clone() {
        return (ListAssetModelCompositeModelsRequest) super.clone();
    }
