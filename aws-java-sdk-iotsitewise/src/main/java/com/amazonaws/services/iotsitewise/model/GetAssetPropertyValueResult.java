...
public class GetAssetPropertyValueResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAssetPropertyValueResult == false)
            return false;
        GetAssetPropertyValueResult other = (GetAssetPropertyValueResult) obj;
    ...
    public GetAssetPropertyValueResult clone() {
        try {
            return (GetAssetPropertyValueResult) super.clone();
