        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("actionId", targetDepth)) {
                    context.nextToken();
                    describeActionResult.setActionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("targetResource", targetDepth)) {
                    context.nextToken();
                    describeActionResult.setTargetResource(TargetResourceJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("actionDefinitionId", targetDepth)) {
                    context.nextToken();
                    describeActionResult.setActionDefinitionId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("actionPayload", targetDepth)) {
                    context.nextToken();
                    describeActionResult.setActionPayload(ActionPayloadJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("executionTime", targetDepth)) {
                    context.nextToken();
                    describeActionResult.setExecutionTime(DateJsonUnmarshallerFactory.getInstance("unixTimestamp").unmarshall(context));
                }
