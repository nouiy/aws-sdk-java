...
/**
 * GatewayPlatformMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GatewayPlatformMarshaller {
    ...
    public static GatewayPlatformMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GatewayPlatform gatewayPlatform, ProtocolMarshaller protocolMarshaller) {

        if (gatewayPlatform == null) {
