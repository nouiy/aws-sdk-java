...
/**
 * AssetModelPropertyDefinitionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AssetModelPropertyDefinitionMarshaller {
    ...
    private static final AssetModelPropertyDefinitionMarshaller instance = new AssetModelPropertyDefinitionMarshaller();

    public static AssetModelPropertyDefinitionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssetModelPropertyDefinition assetModelPropertyDefinition, ProtocolMarshaller protocolMarshaller) {

        if (assetModelPropertyDefinition == null) {
        ...
        try {
            ...
            protocolMarshaller.marshall(assetModelPropertyDefinition.getId(), ID_BINDING);
            protocolMarshaller.marshall(assetModelPropertyDefinition.getExternalId(), EXTERNALID_BINDING);
        } catch (Exception e) {
