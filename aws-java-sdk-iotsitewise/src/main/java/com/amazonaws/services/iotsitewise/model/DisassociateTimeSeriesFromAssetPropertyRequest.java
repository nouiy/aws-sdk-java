...
public class DisassociateTimeSeriesFromAssetPropertyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DisassociateTimeSeriesFromAssetPropertyRequest withClientToken(String clientToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateTimeSeriesFromAssetPropertyRequest == false)
            return false;
        DisassociateTimeSeriesFromAssetPropertyRequest other = (DisassociateTimeSeriesFromAssetPropertyRequest) obj;
    ...
    @Override
    public DisassociateTimeSeriesFromAssetPropertyRequest clone() {
        return (DisassociateTimeSeriesFromAssetPropertyRequest) super.clone();
    }
