...
public class CompositeModelProperty implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The external ID of the composite model that contains the property. For more information, see <a
     ...
     * </p>
     * 
     * @return The external ID of the composite model that contains the property. For more information, see <a
     *         href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/object-ids.html#external-ids">Using
     *         external IDs</a> in the <i>IoT SiteWise User Guide</i>.
     */
