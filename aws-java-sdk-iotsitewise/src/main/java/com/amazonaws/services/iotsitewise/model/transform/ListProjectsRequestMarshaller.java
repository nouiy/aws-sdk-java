...
public class ListProjectsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> PORTALID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("portalId").build();
    ...
    public void marshall(ListProjectsRequest listProjectsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listProjectsRequest.getPortalId(), PORTALID_BINDING);
