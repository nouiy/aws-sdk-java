...
public class DeleteProjectRequestMarshaller {
    ...
    public void marshall(DeleteProjectRequest deleteProjectRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteProjectRequest.getProjectId(), PROJECTID_BINDING);
            protocolMarshaller.marshall(deleteProjectRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
