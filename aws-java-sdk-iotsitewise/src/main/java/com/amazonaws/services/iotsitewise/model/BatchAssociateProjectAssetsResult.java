...
public class BatchAssociateProjectAssetsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public BatchAssociateProjectAssetsResult withErrors(AssetErrorDetails... errors) {
        if (this.errors == null) {
    ...
    public BatchAssociateProjectAssetsResult withErrors(java.util.Collection<AssetErrorDetails> errors) {
        setErrors(errors);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchAssociateProjectAssetsResult == false)
            return false;
        BatchAssociateProjectAssetsResult other = (BatchAssociateProjectAssetsResult) obj;
