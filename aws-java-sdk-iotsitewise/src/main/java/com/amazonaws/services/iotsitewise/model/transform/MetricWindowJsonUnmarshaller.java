...
/**
 * MetricWindow JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricWindowJsonUnmarshaller implements Unmarshaller<MetricWindow, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("tumbling", targetDepth)) {
                    context.nextToken();
                    metricWindow.setTumbling(TumblingWindowJsonUnmarshaller.getInstance().unmarshall(context));
                }
