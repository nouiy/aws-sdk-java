        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("assetId", targetDepth)) {
                    context.nextToken();
                    createAssetResult.setAssetId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("assetArn", targetDepth)) {
                    context.nextToken();
                    createAssetResult.setAssetArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("assetStatus", targetDepth)) {
                    context.nextToken();
                    createAssetResult.setAssetStatus(AssetStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
