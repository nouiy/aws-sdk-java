...
/**
 * DisassociateAssetsResult JSON Unmarshaller
 */
...
public class DisassociateAssetsResultJsonUnmarshaller implements Unmarshaller<DisassociateAssetsResult, JsonUnmarshallerContext> {
    ...
    public DisassociateAssetsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateAssetsResult disassociateAssetsResult = new DisassociateAssetsResult();
