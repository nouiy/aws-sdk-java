...
public class CreateGatewayRequestMarshaller {
    ...
    public void marshall(CreateGatewayRequest createGatewayRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createGatewayRequest.getGatewayName(), GATEWAYNAME_BINDING);
            protocolMarshaller.marshall(createGatewayRequest.getGatewayPlatform(), GATEWAYPLATFORM_BINDING);
