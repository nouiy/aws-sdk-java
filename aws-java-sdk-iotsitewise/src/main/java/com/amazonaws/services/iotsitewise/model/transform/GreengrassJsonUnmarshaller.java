...
/**
 * Greengrass JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GreengrassJsonUnmarshaller implements Unmarshaller<Greengrass, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("groupArn", targetDepth)) {
                    context.nextToken();
                    greengrass.setGroupArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
