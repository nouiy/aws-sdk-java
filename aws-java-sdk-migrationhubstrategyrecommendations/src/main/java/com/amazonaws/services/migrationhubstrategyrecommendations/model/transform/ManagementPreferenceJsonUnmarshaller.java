...
/**
 * ManagementPreference JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ManagementPreferenceJsonUnmarshaller implements Unmarshaller<ManagementPreference, JsonUnmarshallerContext> {

    public ManagementPreference unmarshall(JsonUnmarshallerContext context) throws Exception {
        ManagementPreference managementPreference = new ManagementPreference();
    ...
    private static ManagementPreferenceJsonUnmarshaller instance;

    public static ManagementPreferenceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ManagementPreferenceJsonUnmarshaller();
        return instance;
    }
}
