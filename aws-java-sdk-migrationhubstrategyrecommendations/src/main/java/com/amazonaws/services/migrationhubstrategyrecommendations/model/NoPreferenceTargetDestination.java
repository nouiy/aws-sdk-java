...
public enum NoPreferenceTargetDestination {
    ...
    private NoPreferenceTargetDestination(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return NoPreferenceTargetDestination corresponding to the value
     *
    ...
    public static NoPreferenceTargetDestination fromValue(String value) {
        ...
        for (NoPreferenceTargetDestination enumEntry : NoPreferenceTargetDestination.values()) {
