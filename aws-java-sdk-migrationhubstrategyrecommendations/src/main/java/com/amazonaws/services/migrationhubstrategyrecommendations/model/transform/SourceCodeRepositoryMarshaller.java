...
/**
 * SourceCodeRepositoryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SourceCodeRepositoryMarshaller {
    ...
    private static final MarshallingInfo<String> VERSIONCONTROLTYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("versionControlType").build();

    private static final SourceCodeRepositoryMarshaller instance = new SourceCodeRepositoryMarshaller();

    public static SourceCodeRepositoryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SourceCodeRepository sourceCodeRepository, ProtocolMarshaller protocolMarshaller) {
