...
/**
 * UpdateServerConfigResult JSON Unmarshaller
 */
...
public class UpdateServerConfigResultJsonUnmarshaller implements Unmarshaller<UpdateServerConfigResult, JsonUnmarshallerContext> {
    ...
    public UpdateServerConfigResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateServerConfigResult updateServerConfigResult = new UpdateServerConfigResult();
