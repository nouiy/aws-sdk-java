...
/**
 * SourceCode JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SourceCodeJsonUnmarshaller implements Unmarshaller<SourceCode, JsonUnmarshallerContext> {

    public SourceCode unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SourceCodeJsonUnmarshaller instance;

    public static SourceCodeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SourceCodeJsonUnmarshaller();
        return instance;
    }
}
