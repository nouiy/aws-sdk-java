...
public class DeleteAccountAssignmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteAccountAssignmentResult withAccountAssignmentDeletionStatus(AccountAssignmentOperationStatus accountAssignmentDeletionStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAccountAssignmentResult == false)
            return false;
        DeleteAccountAssignmentResult other = (DeleteAccountAssignmentResult) obj;
    ...
    @Override
    public DeleteAccountAssignmentResult clone() {
        try {
