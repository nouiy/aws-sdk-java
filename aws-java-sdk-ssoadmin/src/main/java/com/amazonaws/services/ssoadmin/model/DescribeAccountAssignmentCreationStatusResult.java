...
public class DescribeAccountAssignmentCreationStatusResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public DescribeAccountAssignmentCreationStatusResult withAccountAssignmentCreationStatus(AccountAssignmentOperationStatus accountAssignmentCreationStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAccountAssignmentCreationStatusResult == false)
            return false;
        DescribeAccountAssignmentCreationStatusResult other = (DescribeAccountAssignmentCreationStatusResult) obj;
    ...
    @Override
    public DescribeAccountAssignmentCreationStatusResult clone() {
        try {
            return (DescribeAccountAssignmentCreationStatusResult) super.clone();
