...
public class RedshiftDataShareAsset implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RedshiftDataShareAsset == false)
            return false;
        RedshiftDataShareAsset other = (RedshiftDataShareAsset) obj;
    ...
    public RedshiftDataShareAsset clone() {
        try {
            return (RedshiftDataShareAsset) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.dataexchange.model.transform.RedshiftDataShareAssetMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
