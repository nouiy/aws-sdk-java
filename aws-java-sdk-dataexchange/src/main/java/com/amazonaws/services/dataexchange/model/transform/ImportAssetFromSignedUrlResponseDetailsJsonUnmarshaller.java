...
/**
 * ImportAssetFromSignedUrlResponseDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportAssetFromSignedUrlResponseDetailsJsonUnmarshaller implements Unmarshaller<ImportAssetFromSignedUrlResponseDetails, JsonUnmarshallerContext> {

    public ImportAssetFromSignedUrlResponseDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
