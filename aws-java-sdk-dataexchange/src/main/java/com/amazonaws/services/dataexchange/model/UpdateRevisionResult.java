...
public class UpdateRevisionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateRevisionResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UpdateRevisionResult withComment(String comment) {
        setComment(comment);
        return this;
    }
    ...
    public UpdateRevisionResult withCreatedAt(java.util.Date createdAt) {
    ...
    public UpdateRevisionResult withDataSetId(String dataSetId) {
     ...
     *        this read-only state, you can publish the revision to your products.</p>
     *        <p>
    ...
    public UpdateRevisionResult withFinalized(Boolean finalized) {
    ...
    public UpdateRevisionResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public UpdateRevisionResult withSourceId(String sourceId) {
    ...
    public UpdateRevisionResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateRevisionResult == false)
            return false;
        UpdateRevisionResult other = (UpdateRevisionResult) obj;
    ...
    @Override
    public UpdateRevisionResult clone() {
        try {
