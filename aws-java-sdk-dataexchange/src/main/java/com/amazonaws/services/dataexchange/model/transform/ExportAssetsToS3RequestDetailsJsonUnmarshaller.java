...
/**
 * ExportAssetsToS3RequestDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportAssetsToS3RequestDetailsJsonUnmarshaller implements Unmarshaller<ExportAssetsToS3RequestDetails, JsonUnmarshallerContext> {

    public ExportAssetsToS3RequestDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AssetDestinations", targetDepth)) {
                    context.nextToken();
                    exportAssetsToS3RequestDetails.setAssetDestinations(new ListUnmarshaller<AssetDestinationEntry>(AssetDestinationEntryJsonUnmarshaller
                            .getInstance())
