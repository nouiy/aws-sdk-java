...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.dataexchange.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.dataexchange.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.dataexchange.model.ConflictException conflictException = new com.amazonaws.services.dataexchange.model.ConflictException(null);
