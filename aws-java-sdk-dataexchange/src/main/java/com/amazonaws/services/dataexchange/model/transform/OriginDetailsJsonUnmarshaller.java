...
/**
 * OriginDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OriginDetailsJsonUnmarshaller implements Unmarshaller<OriginDetails, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ProductId", targetDepth)) {
                    context.nextToken();
                    originDetails.setProductId(context.getUnmarshaller(String.class).unmarshall(context));
                }
