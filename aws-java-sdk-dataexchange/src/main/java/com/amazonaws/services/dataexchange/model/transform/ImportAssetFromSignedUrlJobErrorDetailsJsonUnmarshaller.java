...
/**
 * ImportAssetFromSignedUrlJobErrorDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportAssetFromSignedUrlJobErrorDetailsJsonUnmarshaller implements Unmarshaller<ImportAssetFromSignedUrlJobErrorDetails, JsonUnmarshallerContext> {

    public ImportAssetFromSignedUrlJobErrorDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("AssetName", targetDepth)) {
                    context.nextToken();
                    importAssetFromSignedUrlJobErrorDetails.setAssetName(context.getUnmarshaller(String.class).unmarshall(context));
                }
