...
public class ListJobsRequestMarshaller {
    ...
    public void marshall(ListJobsRequest listJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listJobsRequest.getDataSetId(), DATASETID_BINDING);
            ...
            protocolMarshaller.marshall(listJobsRequest.getRevisionId(), REVISIONID_BINDING);
        } catch (Exception e) {
