...
public class ListRevisionAssetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListRevisionAssetsRequest withDataSetId(String dataSetId) {
    ...
    public ListRevisionAssetsRequest withMaxResults(Integer maxResults) {
    ...
    public ListRevisionAssetsRequest withNextToken(String nextToken) {
    ...
    public ListRevisionAssetsRequest withRevisionId(String revisionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListRevisionAssetsRequest == false)
            return false;
        ListRevisionAssetsRequest other = (ListRevisionAssetsRequest) obj;
    ...
    @Override
    public ListRevisionAssetsRequest clone() {
        return (ListRevisionAssetsRequest) super.clone();
    }
