...
/**
 * AssetSourceEntry JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AssetSourceEntryJsonUnmarshaller implements Unmarshaller<AssetSourceEntry, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Bucket", targetDepth)) {
                    context.nextToken();
                    assetSourceEntry.setBucket(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Key", targetDepth)) {
                    context.nextToken();
                    assetSourceEntry.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
