...
/**
 * S3SnapshotAsset JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3SnapshotAssetJsonUnmarshaller implements Unmarshaller<S3SnapshotAsset, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Size", targetDepth)) {
                    context.nextToken();
                    s3SnapshotAsset.setSize(context.getUnmarshaller(Double.class).unmarshall(context));
                }
