...
public class CreateDataSetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDataSetResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateDataSetResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateDataSetResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateDataSetResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateDataSetResult withUpdatedAt(java.util.Date updatedAt) {
