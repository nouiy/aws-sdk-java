...
public class GetEventActionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetEventActionResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetEventActionResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEventActionResult == false)
            return false;
        GetEventActionResult other = (GetEventActionResult) obj;
    ...
    public GetEventActionResult clone() {
        try {
            return (GetEventActionResult) super.clone();
