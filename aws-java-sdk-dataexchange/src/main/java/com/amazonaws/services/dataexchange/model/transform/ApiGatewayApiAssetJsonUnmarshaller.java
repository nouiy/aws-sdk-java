...
/**
 * ApiGatewayApiAsset JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApiGatewayApiAssetJsonUnmarshaller implements Unmarshaller<ApiGatewayApiAsset, JsonUnmarshallerContext> {

    public ApiGatewayApiAsset unmarshall(JsonUnmarshallerContext context) throws Exception {
        ApiGatewayApiAsset apiGatewayApiAsset = new ApiGatewayApiAsset();
    ...
    private static ApiGatewayApiAssetJsonUnmarshaller instance;

    public static ApiGatewayApiAssetJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApiGatewayApiAssetJsonUnmarshaller();
        return instance;
    }
}
