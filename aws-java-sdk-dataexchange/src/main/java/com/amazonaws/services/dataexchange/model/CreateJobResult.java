...
public class CreateJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateJobResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public CreateJobResult withCreatedAt(java.util.Date createdAt) {
    ...
    public CreateJobResult withDetails(ResponseDetails details) {
        setDetails(details);
        return this;
    }
    ...
    public CreateJobResult withErrors(JobError... errors) {
        if (this.errors == null) {
    ...
    public CreateJobResult withErrors(java.util.Collection<JobError> errors) {
        setErrors(errors);
        return this;
    }
    ...
    public CreateJobResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public CreateJobResult withState(String state) {
        setState(state);
        return this;
    }
    ...
    public CreateJobResult withState(State state) {
    ...
    public CreateJobResult withType(String type) {
        setType(type);
        return this;
    }
    ...
    public CreateJobResult withType(Type type) {
    ...
    public CreateJobResult withUpdatedAt(java.util.Date updatedAt) {
