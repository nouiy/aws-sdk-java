...
public class TypeAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simpleworkflow.model.TypeAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return typeAlreadyExistsException;
    }

    private static TypeAlreadyExistsExceptionUnmarshaller instance;

    public static TypeAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TypeAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
