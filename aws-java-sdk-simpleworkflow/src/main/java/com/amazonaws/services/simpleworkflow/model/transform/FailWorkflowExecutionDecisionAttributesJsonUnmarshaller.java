...
public class FailWorkflowExecutionDecisionAttributesJsonUnmarshaller implements Unmarshaller<FailWorkflowExecutionDecisionAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("reason", targetDepth)) {
                    context.nextToken();
                    failWorkflowExecutionDecisionAttributes.setReason(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    failWorkflowExecutionDecisionAttributes.setDetails(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static FailWorkflowExecutionDecisionAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FailWorkflowExecutionDecisionAttributesJsonUnmarshaller();
        return instance;
    }
}
