...
public class DefaultUndefinedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DefaultUndefinedExceptionUnmarshaller instance;

    public static DefaultUndefinedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DefaultUndefinedExceptionUnmarshaller();
        return instance;
    }
}
