...
public class WorkflowTypeInfosJsonUnmarshaller implements Unmarshaller<WorkflowTypeInfos, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("typeInfos", targetDepth)) {
                    context.nextToken();
                    workflowTypeInfos.setTypeInfos(new ListUnmarshaller<WorkflowTypeInfo>(WorkflowTypeInfoJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextPageToken", targetDepth)) {
                    context.nextToken();
                    workflowTypeInfos.setNextPageToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static WorkflowTypeInfosJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowTypeInfosJsonUnmarshaller();
        return instance;
    }
}
