...
public class DomainAlreadyExistsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.simpleworkflow.model.DomainAlreadyExistsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return domainAlreadyExistsException;
    }

    private static DomainAlreadyExistsExceptionUnmarshaller instance;

    public static DomainAlreadyExistsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainAlreadyExistsExceptionUnmarshaller();
        return instance;
    }
}
