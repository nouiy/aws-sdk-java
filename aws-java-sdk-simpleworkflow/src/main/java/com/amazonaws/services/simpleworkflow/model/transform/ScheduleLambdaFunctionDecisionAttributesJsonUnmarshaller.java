...
public class ScheduleLambdaFunctionDecisionAttributesJsonUnmarshaller implements
    ...
    public ScheduleLambdaFunctionDecisionAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        ScheduleLambdaFunctionDecisionAttributes scheduleLambdaFunctionDecisionAttributes = new ScheduleLambdaFunctionDecisionAttributes();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    scheduleLambdaFunctionDecisionAttributes.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("startToCloseTimeout", targetDepth)) {
                    context.nextToken();
                    scheduleLambdaFunctionDecisionAttributes.setStartToCloseTimeout(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ScheduleLambdaFunctionDecisionAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ScheduleLambdaFunctionDecisionAttributesJsonUnmarshaller();
        return instance;
    }
}
