...
@SdkInternalApi
public class DeprecateDomainRequestMarshaller {

    private static final MarshallingInfo<String> NAME_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("name").build();

    private static final DeprecateDomainRequestMarshaller instance = new DeprecateDomainRequestMarshaller();

    public static DeprecateDomainRequestMarshaller getInstance() {
        return instance;
    }
