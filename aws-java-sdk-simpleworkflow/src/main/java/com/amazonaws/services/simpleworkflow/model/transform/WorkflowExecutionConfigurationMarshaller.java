...
public class WorkflowExecutionConfigurationMarshaller {
    ...
    public void marshall(WorkflowExecutionConfiguration workflowExecutionConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(workflowExecutionConfiguration.getTaskStartToCloseTimeout(), TASKSTARTTOCLOSETIMEOUT_BINDING);
            protocolMarshaller.marshall(workflowExecutionConfiguration.getExecutionStartToCloseTimeout(), EXECUTIONSTARTTOCLOSETIMEOUT_BINDING);
            protocolMarshaller.marshall(workflowExecutionConfiguration.getTaskList(), TASKLIST_BINDING);
            protocolMarshaller.marshall(workflowExecutionConfiguration.getTaskPriority(), TASKPRIORITY_BINDING);
            protocolMarshaller.marshall(workflowExecutionConfiguration.getChildPolicy(), CHILDPOLICY_BINDING);
            protocolMarshaller.marshall(workflowExecutionConfiguration.getLambdaRole(), LAMBDAROLE_BINDING);
        } catch (Exception e) {
