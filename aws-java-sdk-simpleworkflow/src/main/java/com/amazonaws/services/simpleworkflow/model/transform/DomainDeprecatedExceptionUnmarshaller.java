...
public class DomainDeprecatedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DomainDeprecatedExceptionUnmarshaller instance;

    public static DomainDeprecatedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainDeprecatedExceptionUnmarshaller();
        return instance;
    }
}
