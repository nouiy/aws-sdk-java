...
public class ActivityTaskCancelRequestedEventAttributesJsonUnmarshaller implements
        Unmarshaller<ActivityTaskCancelRequestedEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("decisionTaskCompletedEventId", targetDepth)) {
                    context.nextToken();
                    activityTaskCancelRequestedEventAttributes.setDecisionTaskCompletedEventId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("activityId", targetDepth)) {
                    context.nextToken();
                    activityTaskCancelRequestedEventAttributes.setActivityId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ActivityTaskCancelRequestedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ActivityTaskCancelRequestedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
