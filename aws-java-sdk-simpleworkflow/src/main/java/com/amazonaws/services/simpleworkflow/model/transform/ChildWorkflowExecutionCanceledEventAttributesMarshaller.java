...
@SdkInternalApi
public class ChildWorkflowExecutionCanceledEventAttributesMarshaller {
    ...
    private static final ChildWorkflowExecutionCanceledEventAttributesMarshaller instance = new ChildWorkflowExecutionCanceledEventAttributesMarshaller();

    public static ChildWorkflowExecutionCanceledEventAttributesMarshaller getInstance() {
        return instance;
    }
