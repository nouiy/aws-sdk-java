...
public class ExternalWorkflowExecutionSignaledEventAttributesJsonUnmarshaller implements
        Unmarshaller<ExternalWorkflowExecutionSignaledEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("initiatedEventId", targetDepth)) {
                    context.nextToken();
                    externalWorkflowExecutionSignaledEventAttributes.setInitiatedEventId(context.getUnmarshaller(Long.class).unmarshall(context));
                }
    ...
    public static ExternalWorkflowExecutionSignaledEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExternalWorkflowExecutionSignaledEventAttributesJsonUnmarshaller();
        return instance;
    }
}
