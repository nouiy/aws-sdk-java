...
@SdkInternalApi
public class RequestCancelExternalWorkflowExecutionFailedEventAttributesMarshaller {
    ...
    private static final RequestCancelExternalWorkflowExecutionFailedEventAttributesMarshaller instance = new RequestCancelExternalWorkflowExecutionFailedEventAttributesMarshaller();

    public static RequestCancelExternalWorkflowExecutionFailedEventAttributesMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(RequestCancelExternalWorkflowExecutionFailedEventAttributes requestCancelExternalWorkflowExecutionFailedEventAttributes,
        ...
        try {
            protocolMarshaller.marshall(requestCancelExternalWorkflowExecutionFailedEventAttributes.getWorkflowId(), WORKFLOWID_BINDING);
            protocolMarshaller.marshall(requestCancelExternalWorkflowExecutionFailedEventAttributes.getRunId(), RUNID_BINDING);
            protocolMarshaller.marshall(requestCancelExternalWorkflowExecutionFailedEventAttributes.getCause(), CAUSE_BINDING);
            protocolMarshaller.marshall(requestCancelExternalWorkflowExecutionFailedEventAttributes.getInitiatedEventId(), INITIATEDEVENTID_BINDING);
            protocolMarshaller.marshall(requestCancelExternalWorkflowExecutionFailedEventAttributes.getDecisionTaskCompletedEventId(),
                    DECISIONTASKCOMPLETEDEVENTID_BINDING);
            protocolMarshaller.marshall(requestCancelExternalWorkflowExecutionFailedEventAttributes.getControl(), CONTROL_BINDING);
        } catch (Exception e) {
