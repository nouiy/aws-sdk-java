...
@SdkInternalApi
public class StartChildWorkflowExecutionFailedEventAttributesMarshaller {
    ...
    private static final StartChildWorkflowExecutionFailedEventAttributesMarshaller instance = new StartChildWorkflowExecutionFailedEventAttributesMarshaller();

    public static StartChildWorkflowExecutionFailedEventAttributesMarshaller getInstance() {
        return instance;
    }
