...
@SdkInternalApi
public class StartLambdaFunctionFailedEventAttributesMarshaller {
    ...
    private static final StartLambdaFunctionFailedEventAttributesMarshaller instance = new StartLambdaFunctionFailedEventAttributesMarshaller();

    public static StartLambdaFunctionFailedEventAttributesMarshaller getInstance() {
        return instance;
    }
