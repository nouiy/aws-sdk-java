...
@SdkInternalApi
public class DecisionTaskStartedEventAttributesMarshaller {
    ...
    private static final DecisionTaskStartedEventAttributesMarshaller instance = new DecisionTaskStartedEventAttributesMarshaller();

    public static DecisionTaskStartedEventAttributesMarshaller getInstance() {
        return instance;
    }
