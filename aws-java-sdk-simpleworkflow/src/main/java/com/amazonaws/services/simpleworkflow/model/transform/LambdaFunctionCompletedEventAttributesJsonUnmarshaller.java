...
public class LambdaFunctionCompletedEventAttributesJsonUnmarshaller implements Unmarshaller<LambdaFunctionCompletedEventAttributes, JsonUnmarshallerContext> {
    ...
    private static LambdaFunctionCompletedEventAttributesJsonUnmarshaller instance;

    public static LambdaFunctionCompletedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LambdaFunctionCompletedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
