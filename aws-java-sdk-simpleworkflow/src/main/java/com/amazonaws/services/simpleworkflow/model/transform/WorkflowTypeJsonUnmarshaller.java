...
public class WorkflowTypeJsonUnmarshaller implements Unmarshaller<WorkflowType, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    workflowType.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("version", targetDepth)) {
                    context.nextToken();
                    workflowType.setVersion(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static WorkflowTypeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new WorkflowTypeJsonUnmarshaller();
        return instance;
    }
}
