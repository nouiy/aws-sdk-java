...
public class CancelWorkflowExecutionDecisionAttributesJsonUnmarshaller implements
        Unmarshaller<CancelWorkflowExecutionDecisionAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("details", targetDepth)) {
                    context.nextToken();
                    cancelWorkflowExecutionDecisionAttributes.setDetails(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static CancelWorkflowExecutionDecisionAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CancelWorkflowExecutionDecisionAttributesJsonUnmarshaller();
        return instance;
    }
}
