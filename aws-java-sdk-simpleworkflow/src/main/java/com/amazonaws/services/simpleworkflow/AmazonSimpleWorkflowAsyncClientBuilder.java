...
/**
 * Fluent builder for {@link com.amazonaws.services.simpleworkflow.AmazonSimpleWorkflowAsync}. Use of the builder is
...
public final class AmazonSimpleWorkflowAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonSimpleWorkflowAsyncClientBuilder, AmazonSimpleWorkflowAsync> {
    ...
    private static final ClientConfigurationFactory CLIENT_CONFIG_FACTORY = new com.amazonaws.services.simpleworkflow.AmazonSimpleWorkflowClientConfigurationFactory();;
     ...
     * @return Fully configured implementation of AmazonSimpleWorkflowAsync.
     */
    @Override
    protected AmazonSimpleWorkflowAsync build(AwsAsyncClientParams params) {
        return new AmazonSimpleWorkflowAsyncClient(params);
    }
