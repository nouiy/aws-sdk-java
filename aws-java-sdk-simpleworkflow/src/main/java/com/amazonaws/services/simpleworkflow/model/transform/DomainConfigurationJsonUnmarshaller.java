...
public class DomainConfigurationJsonUnmarshaller implements Unmarshaller<DomainConfiguration, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("workflowExecutionRetentionPeriodInDays", targetDepth)) {
                    context.nextToken();
                    domainConfiguration.setWorkflowExecutionRetentionPeriodInDays(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static DomainConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DomainConfigurationJsonUnmarshaller();
        return instance;
    }
}
