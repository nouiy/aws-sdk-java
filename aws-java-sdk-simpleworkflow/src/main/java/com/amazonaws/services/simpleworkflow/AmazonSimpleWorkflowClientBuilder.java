...
/**
 * Fluent builder for {@link com.amazonaws.services.simpleworkflow.AmazonSimpleWorkflow}. Use of the builder is
...
public final class AmazonSimpleWorkflowClientBuilder extends AwsSyncClientBuilder<AmazonSimpleWorkflowClientBuilder, AmazonSimpleWorkflow> {
     ...
     * @return Fully configured implementation of AmazonSimpleWorkflow.
     */
    @Override
    protected AmazonSimpleWorkflow build(AwsSyncClientParams params) {
        return new AmazonSimpleWorkflowClient(params);
    }
