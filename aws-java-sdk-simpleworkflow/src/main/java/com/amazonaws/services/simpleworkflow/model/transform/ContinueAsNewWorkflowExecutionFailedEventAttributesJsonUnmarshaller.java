...
public class ContinueAsNewWorkflowExecutionFailedEventAttributesJsonUnmarshaller implements
        Unmarshaller<ContinueAsNewWorkflowExecutionFailedEventAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cause", targetDepth)) {
                    context.nextToken();
                    continueAsNewWorkflowExecutionFailedEventAttributes.setCause(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static ContinueAsNewWorkflowExecutionFailedEventAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ContinueAsNewWorkflowExecutionFailedEventAttributesJsonUnmarshaller();
        return instance;
    }
}
