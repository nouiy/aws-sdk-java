...
public class CompleteWorkflowExecutionDecisionAttributesJsonUnmarshaller implements
        Unmarshaller<CompleteWorkflowExecutionDecisionAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("result", targetDepth)) {
                    context.nextToken();
                    completeWorkflowExecutionDecisionAttributes.setResult(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static CompleteWorkflowExecutionDecisionAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CompleteWorkflowExecutionDecisionAttributesJsonUnmarshaller();
        return instance;
    }
}
