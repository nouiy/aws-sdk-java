...
@SdkInternalApi
public class StartTimerFailedEventAttributesMarshaller {
    ...
    private static final StartTimerFailedEventAttributesMarshaller instance = new StartTimerFailedEventAttributesMarshaller();

    public static StartTimerFailedEventAttributesMarshaller getInstance() {
        return instance;
    }
