...
public class WorkflowExecutionOpenCountsMarshaller {
    ...
    private static final MarshallingInfo<Integer> OPENCHILDWORKFLOWEXECUTIONS_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("openChildWorkflowExecutions").build();
    ...
    public void marshall(WorkflowExecutionOpenCounts workflowExecutionOpenCounts, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(workflowExecutionOpenCounts.getOpenActivityTasks(), OPENACTIVITYTASKS_BINDING);
            protocolMarshaller.marshall(workflowExecutionOpenCounts.getOpenDecisionTasks(), OPENDECISIONTASKS_BINDING);
            protocolMarshaller.marshall(workflowExecutionOpenCounts.getOpenTimers(), OPENTIMERS_BINDING);
            protocolMarshaller.marshall(workflowExecutionOpenCounts.getOpenChildWorkflowExecutions(), OPENCHILDWORKFLOWEXECUTIONS_BINDING);
            protocolMarshaller.marshall(workflowExecutionOpenCounts.getOpenLambdaFunctions(), OPENLAMBDAFUNCTIONS_BINDING);
        } catch (Exception e) {
