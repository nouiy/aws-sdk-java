...
@SdkInternalApi
public class CloseStatusFilterMarshaller {

    private static final MarshallingInfo<String> STATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("status").build();

    private static final CloseStatusFilterMarshaller instance = new CloseStatusFilterMarshaller();

    public static CloseStatusFilterMarshaller getInstance() {
        return instance;
    }
