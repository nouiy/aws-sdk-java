...
public class DeprecateWorkflowTypeRequestMarshaller {
    ...
    private static final DeprecateWorkflowTypeRequestMarshaller instance = new DeprecateWorkflowTypeRequestMarshaller();

    public static DeprecateWorkflowTypeRequestMarshaller getInstance() {
        return instance;
    }
