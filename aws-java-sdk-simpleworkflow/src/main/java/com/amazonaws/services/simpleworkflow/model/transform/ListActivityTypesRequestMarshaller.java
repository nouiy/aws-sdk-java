...
public class ListActivityTypesRequestMarshaller {
    ...
    private static final ListActivityTypesRequestMarshaller instance = new ListActivityTypesRequestMarshaller();

    public static ListActivityTypesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListActivityTypesRequest listActivityTypesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listActivityTypesRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(listActivityTypesRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(listActivityTypesRequest.getRegistrationStatus(), REGISTRATIONSTATUS_BINDING);
            protocolMarshaller.marshall(listActivityTypesRequest.getNextPageToken(), NEXTPAGETOKEN_BINDING);
            protocolMarshaller.marshall(listActivityTypesRequest.getMaximumPageSize(), MAXIMUMPAGESIZE_BINDING);
            protocolMarshaller.marshall(listActivityTypesRequest.getReverseOrder(), REVERSEORDER_BINDING);
        } catch (Exception e) {
