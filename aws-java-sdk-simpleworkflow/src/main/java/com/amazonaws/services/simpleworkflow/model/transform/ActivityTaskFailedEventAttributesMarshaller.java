...
@SdkInternalApi
public class ActivityTaskFailedEventAttributesMarshaller {
    ...
    private static final ActivityTaskFailedEventAttributesMarshaller instance = new ActivityTaskFailedEventAttributesMarshaller();

    public static ActivityTaskFailedEventAttributesMarshaller getInstance() {
        return instance;
    }
