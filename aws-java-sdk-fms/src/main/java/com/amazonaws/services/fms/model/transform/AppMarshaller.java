...
public class AppMarshaller {
    ...
    private static final MarshallingInfo<Long> PORT_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(App app, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(app.getAppName(), APPNAME_BINDING);
            protocolMarshaller.marshall(app.getProtocol(), PROTOCOL_BINDING);
            protocolMarshaller.marshall(app.getPort(), PORT_BINDING);
        } catch (Exception e) {
