        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ComplianceStatus", targetDepth)) {
                    context.nextToken();
                    evaluationResult.setComplianceStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ViolatorCount", targetDepth)) {
                    context.nextToken();
                    evaluationResult.setViolatorCount(context.getUnmarshaller(Long.class).unmarshall(context));
                }
                if (context.testExpression("EvaluationLimitExceeded", targetDepth)) {
                    context.nextToken();
                    evaluationResult.setEvaluationLimitExceeded(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
