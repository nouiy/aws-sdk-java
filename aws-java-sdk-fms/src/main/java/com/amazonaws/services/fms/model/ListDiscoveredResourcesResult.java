...
public class ListDiscoveredResourcesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<DiscoveredResource> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return Details of the resources that were discovered.
     */

    public java.util.List<DiscoveredResource> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<DiscoveredResource> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<DiscoveredResource>(items);
    }
    ...
    public ListDiscoveredResourcesResult withItems(DiscoveredResource... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<DiscoveredResource>(items.length));
        }
        for (DiscoveredResource ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListDiscoveredResourcesResult withItems(java.util.Collection<DiscoveredResource> items) {
        setItems(items);
        return this;
    }
