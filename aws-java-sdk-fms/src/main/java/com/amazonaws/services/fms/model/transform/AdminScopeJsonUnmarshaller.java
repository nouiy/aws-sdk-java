...
/**
 * AdminScope JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AdminScopeJsonUnmarshaller implements Unmarshaller<AdminScope, JsonUnmarshallerContext> {

    public AdminScope unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static AdminScopeJsonUnmarshaller instance;

    public static AdminScopeJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AdminScopeJsonUnmarshaller();
        return instance;
    }
}
