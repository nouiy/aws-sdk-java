...
@SdkInternalApi
public class ComplianceViolatorMarshaller {

    private static final MarshallingInfo<String> RESOURCEID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ResourceId").build();
    private static final MarshallingInfo<String> VIOLATIONREASON_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static ComplianceViolatorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ComplianceViolator complianceViolator, ProtocolMarshaller protocolMarshaller) {

        if (complianceViolator == null) {
