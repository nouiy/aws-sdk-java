...
/**
 * AssociateAdminAccountResult JSON Unmarshaller
 */
...
public class AssociateAdminAccountResultJsonUnmarshaller implements Unmarshaller<AssociateAdminAccountResult, JsonUnmarshallerContext> {
    ...
    public AssociateAdminAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateAdminAccountResult associateAdminAccountResult = new AssociateAdminAccountResult();
