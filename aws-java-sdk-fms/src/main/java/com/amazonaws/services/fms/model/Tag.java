...
/**
 * <p>
 * A collection of key:value pairs associated with an Amazon Web Services resource. The key:value pair can be anything
 * you define. Typically, the tag key represents a category (such as "environment") and the tag value represents a
 * specific value within that category (such as "test," "development," or "production"). You can add up to 50 tags to
 * each Amazon Web Services resource.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/fms-2018-01-01/Tag" target="_top">AWS API Documentation</a>
 */
...
public class Tag implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.fms.model.transform.TagMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
