...
/**
 * AppsListDataSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AppsListDataSummaryMarshaller {
    ...
    private static final AppsListDataSummaryMarshaller instance = new AppsListDataSummaryMarshaller();

    public static AppsListDataSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AppsListDataSummary appsListDataSummary, ProtocolMarshaller protocolMarshaller) {

        if (appsListDataSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(appsListDataSummary.getListArn(), LISTARN_BINDING);
            protocolMarshaller.marshall(appsListDataSummary.getListId(), LISTID_BINDING);
            protocolMarshaller.marshall(appsListDataSummary.getListName(), LISTNAME_BINDING);
            protocolMarshaller.marshall(appsListDataSummary.getAppsList(), APPSLIST_BINDING);
        } catch (Exception e) {
