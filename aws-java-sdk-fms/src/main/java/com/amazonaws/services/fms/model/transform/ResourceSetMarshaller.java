...
public class ResourceSetMarshaller {
    ...
    public void marshall(ResourceSet resourceSet, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceSet.getId(), ID_BINDING);
            protocolMarshaller.marshall(resourceSet.getName(), NAME_BINDING);
            protocolMarshaller.marshall(resourceSet.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(resourceSet.getUpdateToken(), UPDATETOKEN_BINDING);
            protocolMarshaller.marshall(resourceSet.getResourceTypeList(), RESOURCETYPELIST_BINDING);
            protocolMarshaller.marshall(resourceSet.getLastUpdateTime(), LASTUPDATETIME_BINDING);
        } catch (Exception e) {
