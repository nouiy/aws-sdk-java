...
/**
 * DeleteAppsListResult JSON Unmarshaller
 */
...
public class DeleteAppsListResultJsonUnmarshaller implements Unmarshaller<DeleteAppsListResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppsListResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppsListResult deleteAppsListResult = new DeleteAppsListResult();

        return deleteAppsListResult;
    }
