...
public class RouteMarshaller {
    ...
    public void marshall(Route route, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(route.getDestinationType(), DESTINATIONTYPE_BINDING);
            protocolMarshaller.marshall(route.getTargetType(), TARGETTYPE_BINDING);
            protocolMarshaller.marshall(route.getDestination(), DESTINATION_BINDING);
