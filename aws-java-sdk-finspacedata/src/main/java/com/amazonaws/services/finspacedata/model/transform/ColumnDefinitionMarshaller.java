...
public class ColumnDefinitionMarshaller {
    ...
    public void marshall(ColumnDefinition columnDefinition, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(columnDefinition.getDataType(), DATATYPE_BINDING);
            protocolMarshaller.marshall(columnDefinition.getColumnName(), COLUMNNAME_BINDING);
            protocolMarshaller.marshall(columnDefinition.getColumnDescription(), COLUMNDESCRIPTION_BINDING);
        } catch (Exception e) {
