        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("columns", targetDepth)) {
                    context.nextToken();
                    schemaDefinition.setColumns(new ListUnmarshaller<ColumnDefinition>(ColumnDefinitionJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("primaryKeyColumns", targetDepth)) {
                    context.nextToken();
                    schemaDefinition.setPrimaryKeyColumns(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
