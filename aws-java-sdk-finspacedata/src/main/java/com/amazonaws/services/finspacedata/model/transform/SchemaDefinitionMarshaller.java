...
public class SchemaDefinitionMarshaller {
    ...
    private static final MarshallingInfo<List> PRIMARYKEYCOLUMNS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("primaryKeyColumns").build();
    ...
    public void marshall(SchemaDefinition schemaDefinition, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(schemaDefinition.getPrimaryKeyColumns(), PRIMARYKEYCOLUMNS_BINDING);
        } catch (Exception e) {
