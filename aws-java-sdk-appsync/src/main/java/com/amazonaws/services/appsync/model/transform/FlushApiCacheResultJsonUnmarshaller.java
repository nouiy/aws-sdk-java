...
/**
 * FlushApiCacheResult JSON Unmarshaller
 */
...
public class FlushApiCacheResultJsonUnmarshaller implements Unmarshaller<FlushApiCacheResult, JsonUnmarshallerContext> {
    ...
    public FlushApiCacheResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        FlushApiCacheResult flushApiCacheResult = new FlushApiCacheResult();

        return flushApiCacheResult;
    }
