...
public class LambdaDataSourceConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LambdaDataSourceConfig == false)
            return false;
        LambdaDataSourceConfig other = (LambdaDataSourceConfig) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appsync.model.transform.LambdaDataSourceConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
