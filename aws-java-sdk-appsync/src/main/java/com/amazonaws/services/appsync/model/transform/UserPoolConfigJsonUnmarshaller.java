...
/**
 * UserPoolConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UserPoolConfigJsonUnmarshaller implements Unmarshaller<UserPoolConfig, JsonUnmarshallerContext> {

    public UserPoolConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static UserPoolConfigJsonUnmarshaller instance;

    public static UserPoolConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UserPoolConfigJsonUnmarshaller();
        return instance;
    }
}
