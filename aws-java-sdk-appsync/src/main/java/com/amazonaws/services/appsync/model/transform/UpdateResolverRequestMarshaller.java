...
public class UpdateResolverRequestMarshaller {
    ...
    public void marshall(UpdateResolverRequest updateResolverRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(updateResolverRequest.getSyncConfig(), SYNCCONFIG_BINDING);
            protocolMarshaller.marshall(updateResolverRequest.getCachingConfig(), CACHINGCONFIG_BINDING);
            protocolMarshaller.marshall(updateResolverRequest.getMaxBatchSize(), MAXBATCHSIZE_BINDING);
            protocolMarshaller.marshall(updateResolverRequest.getRuntime(), RUNTIME_BINDING);
            protocolMarshaller.marshall(updateResolverRequest.getCode(), CODE_BINDING);
        } catch (Exception e) {
