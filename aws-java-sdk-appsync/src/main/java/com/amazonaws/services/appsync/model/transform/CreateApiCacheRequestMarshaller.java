...
@SdkInternalApi
public class CreateApiCacheRequestMarshaller {
    ...
    public static CreateApiCacheRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateApiCacheRequest createApiCacheRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createApiCacheRequest.getApiId(), APIID_BINDING);
            protocolMarshaller.marshall(createApiCacheRequest.getTtl(), TTL_BINDING);
            protocolMarshaller.marshall(createApiCacheRequest.getTransitEncryptionEnabled(), TRANSITENCRYPTIONENABLED_BINDING);
