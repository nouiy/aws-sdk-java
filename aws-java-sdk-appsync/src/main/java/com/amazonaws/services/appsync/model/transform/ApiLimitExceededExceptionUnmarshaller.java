...
public class ApiLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ApiLimitExceededExceptionUnmarshaller instance;

    public static ApiLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApiLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
