...
public class GraphQLSchemaExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static GraphQLSchemaExceptionUnmarshaller instance;

    public static GraphQLSchemaExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new GraphQLSchemaExceptionUnmarshaller();
        return instance;
    }
}
