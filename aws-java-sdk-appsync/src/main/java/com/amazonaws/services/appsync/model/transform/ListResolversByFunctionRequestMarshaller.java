...
/**
 * ListResolversByFunctionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListResolversByFunctionRequestMarshaller {
    ...
    private static final ListResolversByFunctionRequestMarshaller instance = new ListResolversByFunctionRequestMarshaller();

    public static ListResolversByFunctionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListResolversByFunctionRequest listResolversByFunctionRequest, ProtocolMarshaller protocolMarshaller) {
