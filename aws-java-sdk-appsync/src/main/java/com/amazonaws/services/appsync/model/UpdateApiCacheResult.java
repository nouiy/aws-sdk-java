...
public class UpdateApiCacheResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateApiCacheResult withApiCache(ApiCache apiCache) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApiCacheResult == false)
            return false;
        UpdateApiCacheResult other = (UpdateApiCacheResult) obj;
    ...
    public UpdateApiCacheResult clone() {
        try {
            return (UpdateApiCacheResult) super.clone();
