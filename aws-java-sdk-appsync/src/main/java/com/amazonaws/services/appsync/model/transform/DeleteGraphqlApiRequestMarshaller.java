...
/**
 * DeleteGraphqlApiRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteGraphqlApiRequestMarshaller {
    ...
    private static final DeleteGraphqlApiRequestMarshaller instance = new DeleteGraphqlApiRequestMarshaller();

    public static DeleteGraphqlApiRequestMarshaller getInstance() {
        return instance;
    }
