...
public class UpdateApiCacheRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateApiCacheRequest withHealthMetricsConfig(String healthMetricsConfig) {
    ...
    public UpdateApiCacheRequest withHealthMetricsConfig(CacheHealthMetricsConfig healthMetricsConfig) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateApiCacheRequest == false)
            return false;
        UpdateApiCacheRequest other = (UpdateApiCacheRequest) obj;
    ...
    public UpdateApiCacheRequest clone() {
        return (UpdateApiCacheRequest) super.clone();
    }
