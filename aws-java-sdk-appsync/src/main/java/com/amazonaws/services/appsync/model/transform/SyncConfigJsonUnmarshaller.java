...
/**
 * SyncConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SyncConfigJsonUnmarshaller implements Unmarshaller<SyncConfig, JsonUnmarshallerContext> {

    public SyncConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SyncConfigJsonUnmarshaller instance;

    public static SyncConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SyncConfigJsonUnmarshaller();
        return instance;
    }
}
