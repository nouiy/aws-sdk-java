...
public class ListDomainNamesRequestMarshaller {
    ...
    public void marshall(ListDomainNamesRequest listDomainNamesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDomainNamesRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listDomainNamesRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
