...
public class ApiKeyLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ApiKeyLimitExceededExceptionUnmarshaller instance;

    public static ApiKeyLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApiKeyLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
