...
/**
 * ApiAssociation JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApiAssociationJsonUnmarshaller implements Unmarshaller<ApiAssociation, JsonUnmarshallerContext> {

    public ApiAssociation unmarshall(JsonUnmarshallerContext context) throws Exception {
        ApiAssociation apiAssociation = new ApiAssociation();
    ...
    private static ApiAssociationJsonUnmarshaller instance;

    public static ApiAssociationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApiAssociationJsonUnmarshaller();
        return instance;
    }
}
