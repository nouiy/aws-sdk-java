...
public class ApiKeyValidityOutOfBoundsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ApiKeyValidityOutOfBoundsExceptionUnmarshaller instance;

    public static ApiKeyValidityOutOfBoundsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApiKeyValidityOutOfBoundsExceptionUnmarshaller();
        return instance;
    }
}
