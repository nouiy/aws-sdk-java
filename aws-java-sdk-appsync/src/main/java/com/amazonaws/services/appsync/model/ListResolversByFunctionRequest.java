...
public class ListResolversByFunctionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListResolversByFunctionRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListResolversByFunctionRequest == false)
            return false;
        ListResolversByFunctionRequest other = (ListResolversByFunctionRequest) obj;
    ...
    @Override
    public ListResolversByFunctionRequest clone() {
        return (ListResolversByFunctionRequest) super.clone();
    }
