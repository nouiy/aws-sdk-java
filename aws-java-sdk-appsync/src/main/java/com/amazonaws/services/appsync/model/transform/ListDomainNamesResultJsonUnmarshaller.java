...
public class ListDomainNamesResultJsonUnmarshaller implements Unmarshaller<ListDomainNamesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("domainNameConfigs", targetDepth)) {
                    context.nextToken();
                    listDomainNamesResult.setDomainNameConfigs(new ListUnmarshaller<DomainNameConfig>(DomainNameConfigJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listDomainNamesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
