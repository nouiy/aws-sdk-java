...
/**
 * Fluent builder for {@link com.amazonaws.services.pinpointemail.AmazonPinpointEmailAsync}. Use of the builder is
...
public final class AmazonPinpointEmailAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonPinpointEmailAsyncClientBuilder, AmazonPinpointEmailAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonPinpointEmailAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonPinpointEmailAsync.
     */
    @Override
    protected AmazonPinpointEmailAsync build(AwsAsyncClientParams params) {
