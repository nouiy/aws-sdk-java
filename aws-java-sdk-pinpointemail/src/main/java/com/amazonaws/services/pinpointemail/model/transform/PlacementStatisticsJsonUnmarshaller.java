...
/**
 * PlacementStatistics JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PlacementStatisticsJsonUnmarshaller implements Unmarshaller<PlacementStatistics, JsonUnmarshallerContext> {

    public PlacementStatistics unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static PlacementStatisticsJsonUnmarshaller instance;

    public static PlacementStatisticsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PlacementStatisticsJsonUnmarshaller();
        return instance;
    }
}
