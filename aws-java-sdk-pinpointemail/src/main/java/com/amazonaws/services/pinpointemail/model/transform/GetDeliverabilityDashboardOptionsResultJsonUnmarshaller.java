...
/**
 * GetDeliverabilityDashboardOptionsResult JSON Unmarshaller
 */
...
public class GetDeliverabilityDashboardOptionsResultJsonUnmarshaller implements Unmarshaller<GetDeliverabilityDashboardOptionsResult, JsonUnmarshallerContext> {
    ...
    public GetDeliverabilityDashboardOptionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
