...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListTagsForResource" target="_top">AWS
 *      API Documentation</a>
 */
...
public class ListTagsForResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * <code>Key</code>) and an associated tag value (<code>Value</code>)
     * </p>
     */
     ...
     * </p>
     * 
     * @return An array that lists all the tags that are associated with the resource. Each tag consists of a required
     ...
     * 
     * @param tags
     *        An array that lists all the tags that are associated with the resource. Each tag consists of a required
     *        tag key (<code>Key</code>) and an associated tag value (<code>Value</code>)
     */
