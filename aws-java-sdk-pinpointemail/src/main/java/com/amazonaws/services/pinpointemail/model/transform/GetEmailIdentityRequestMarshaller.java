...
public class GetEmailIdentityRequestMarshaller {
    ...
    private static final GetEmailIdentityRequestMarshaller instance = new GetEmailIdentityRequestMarshaller();

    public static GetEmailIdentityRequestMarshaller getInstance() {
        return instance;
    }
