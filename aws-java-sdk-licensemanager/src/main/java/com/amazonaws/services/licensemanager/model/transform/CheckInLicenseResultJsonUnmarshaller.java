...
/**
 * CheckInLicenseResult JSON Unmarshaller
 */
...
public class CheckInLicenseResultJsonUnmarshaller implements Unmarshaller<CheckInLicenseResult, JsonUnmarshallerContext> {
    ...
    public CheckInLicenseResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CheckInLicenseResult checkInLicenseResult = new CheckInLicenseResult();

        return checkInLicenseResult;
    }
