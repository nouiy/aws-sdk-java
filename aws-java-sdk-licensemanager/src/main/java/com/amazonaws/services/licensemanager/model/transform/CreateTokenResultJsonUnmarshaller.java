        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("TokenId", targetDepth)) {
                    context.nextToken();
                    createTokenResult.setTokenId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Token", targetDepth)) {
                    context.nextToken();
                    createTokenResult.setToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
