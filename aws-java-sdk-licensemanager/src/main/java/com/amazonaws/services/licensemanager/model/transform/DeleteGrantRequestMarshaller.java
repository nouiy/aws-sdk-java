...
/**
 * DeleteGrantRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteGrantRequestMarshaller {
    ...
    private static final DeleteGrantRequestMarshaller instance = new DeleteGrantRequestMarshaller();

    public static DeleteGrantRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteGrantRequest deleteGrantRequest, ProtocolMarshaller protocolMarshaller) {
