...
public class ManagedResourceSummaryMarshaller {
    ...
    private static final MarshallingInfo<Long> ASSOCIATIONCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
    ...
    public void marshall(ManagedResourceSummary managedResourceSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(managedResourceSummary.getResourceType(), RESOURCETYPE_BINDING);
            protocolMarshaller.marshall(managedResourceSummary.getAssociationCount(), ASSOCIATIONCOUNT_BINDING);
        } catch (Exception e) {
