...
/**
 * DeleteLicenseConfigurationResult JSON Unmarshaller
 */
...
public class DeleteLicenseConfigurationResultJsonUnmarshaller implements Unmarshaller<DeleteLicenseConfigurationResult, JsonUnmarshallerContext> {
    ...
    public DeleteLicenseConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLicenseConfigurationResult deleteLicenseConfigurationResult = new DeleteLicenseConfigurationResult();
