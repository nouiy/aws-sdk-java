...
public class RejectGrantResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public RejectGrantResult withGrantArn(String grantArn) {
    ...
    public RejectGrantResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public RejectGrantResult withStatus(GrantStatus status) {
    ...
    public RejectGrantResult withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectGrantResult == false)
            return false;
        RejectGrantResult other = (RejectGrantResult) obj;
    ...
    @Override
    public RejectGrantResult clone() {
        try {
