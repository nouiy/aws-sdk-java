...
/**
 * UpdateLicenseConfigurationResult JSON Unmarshaller
 */
...
public class UpdateLicenseConfigurationResultJsonUnmarshaller implements Unmarshaller<UpdateLicenseConfigurationResult, JsonUnmarshallerContext> {
    ...
    public UpdateLicenseConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateLicenseConfigurationResult updateLicenseConfigurationResult = new UpdateLicenseConfigurationResult();
