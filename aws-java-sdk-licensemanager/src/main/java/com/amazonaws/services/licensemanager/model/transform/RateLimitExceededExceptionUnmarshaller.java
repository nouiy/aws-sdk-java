...
public class RateLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static RateLimitExceededExceptionUnmarshaller instance;

    public static RateLimitExceededExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new RateLimitExceededExceptionUnmarshaller();
        return instance;
    }
}
