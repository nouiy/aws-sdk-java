...
@SdkInternalApi
public class ListResourceInventoryRequestMarshaller {
    ...
    private static final ListResourceInventoryRequestMarshaller instance = new ListResourceInventoryRequestMarshaller();

    public static ListResourceInventoryRequestMarshaller getInstance() {
        return instance;
    }
