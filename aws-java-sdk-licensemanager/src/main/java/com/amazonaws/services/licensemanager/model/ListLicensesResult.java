...
public class ListLicensesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListLicensesResult withLicenses(License... licenses) {
    ...
    public ListLicensesResult withLicenses(java.util.Collection<License> licenses) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLicensesResult == false)
            return false;
        ListLicensesResult other = (ListLicensesResult) obj;
    ...
    @Override
    public ListLicensesResult clone() {
        try {
            return (ListLicensesResult) super.clone();
