...
/**
 * ReceivedMetadataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ReceivedMetadataMarshaller {
    ...
    private static final ReceivedMetadataMarshaller instance = new ReceivedMetadataMarshaller();

    public static ReceivedMetadataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ReceivedMetadata receivedMetadata, ProtocolMarshaller protocolMarshaller) {
