...
public class ListLicenseSpecificationsForResourceRequestMarshaller {
    ...
    private static final ListLicenseSpecificationsForResourceRequestMarshaller instance = new ListLicenseSpecificationsForResourceRequestMarshaller();

    public static ListLicenseSpecificationsForResourceRequestMarshaller getInstance() {
        return instance;
    }
