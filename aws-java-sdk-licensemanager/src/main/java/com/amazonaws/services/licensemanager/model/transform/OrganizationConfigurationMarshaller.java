...
public class OrganizationConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Boolean> ENABLEINTEGRATION_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EnableIntegration").build();
    ...
    public void marshall(OrganizationConfiguration organizationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(organizationConfiguration.getEnableIntegration(), ENABLEINTEGRATION_BINDING);
        } catch (Exception e) {
