...
public class DescribeEventsForOrganizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DescribeEventsForOrganizationResult withEvents(OrganizationEvent... events) {
        if (this.events == null) {
            setEvents(new java.util.ArrayList<OrganizationEvent>(events.length));
        }
        for (OrganizationEvent ele : events) {
            this.events.add(ele);
        }
        return this;
    }
    ...
    public DescribeEventsForOrganizationResult withEvents(java.util.Collection<OrganizationEvent> events) {
        setEvents(events);
        return this;
    }
    ...
    @Override
    public DescribeEventsForOrganizationResult clone() {
        try {
            return (DescribeEventsForOrganizationResult) super.clone();
