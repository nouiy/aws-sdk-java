...
/**
 * ListSolFunctionInstanceInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListSolFunctionInstanceInfoJsonUnmarshaller implements Unmarshaller<ListSolFunctionInstanceInfo, JsonUnmarshallerContext> {

    public ListSolFunctionInstanceInfo unmarshall(JsonUnmarshallerContext context) throws Exception {
        ListSolFunctionInstanceInfo listSolFunctionInstanceInfo = new ListSolFunctionInstanceInfo();
    ...
    private static ListSolFunctionInstanceInfoJsonUnmarshaller instance;

    public static ListSolFunctionInstanceInfoJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListSolFunctionInstanceInfoJsonUnmarshaller();
        return instance;
    }
}
