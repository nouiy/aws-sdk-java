...
public class DescribeConfigurationRevisionRequestMarshaller {
    ...
    private static final MarshallingInfo<String> CONFIGURATIONREVISION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("configuration-revision").build();
    ...
    public void marshall(DescribeConfigurationRevisionRequest describeConfigurationRevisionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeConfigurationRevisionRequest.getConfigurationId(), CONFIGURATIONID_BINDING);
            protocolMarshaller.marshall(describeConfigurationRevisionRequest.getConfigurationRevision(), CONFIGURATIONREVISION_BINDING);
        } catch (Exception e) {
