...
public class ListBrokersRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListBrokersRequest withMaxResults(Integer maxResults) {
    ...
    public ListBrokersRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListBrokersRequest == false)
            return false;
        ListBrokersRequest other = (ListBrokersRequest) obj;
    ...
    @Override
    public ListBrokersRequest clone() {
        return (ListBrokersRequest) super.clone();
    }
