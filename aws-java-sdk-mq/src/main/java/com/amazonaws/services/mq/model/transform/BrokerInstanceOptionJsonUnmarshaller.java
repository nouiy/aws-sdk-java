...
/**
 * BrokerInstanceOption JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BrokerInstanceOptionJsonUnmarshaller implements Unmarshaller<BrokerInstanceOption, JsonUnmarshallerContext> {

    public BrokerInstanceOption unmarshall(JsonUnmarshallerContext context) throws Exception {
        BrokerInstanceOption brokerInstanceOption = new BrokerInstanceOption();
    ...
    private static BrokerInstanceOptionJsonUnmarshaller instance;

    public static BrokerInstanceOptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BrokerInstanceOptionJsonUnmarshaller();
        return instance;
    }
}
