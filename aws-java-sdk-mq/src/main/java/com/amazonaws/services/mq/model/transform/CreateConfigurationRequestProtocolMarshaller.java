...
@SdkInternalApi
public class CreateConfigurationRequestProtocolMarshaller implements Marshaller<Request<CreateConfigurationRequest>, CreateConfigurationRequest> {
    ...
    public Request<CreateConfigurationRequest> marshall(CreateConfigurationRequest createConfigurationRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<CreateConfigurationRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
