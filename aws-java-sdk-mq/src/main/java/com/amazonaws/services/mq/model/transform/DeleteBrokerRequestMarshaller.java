...
/**
 * DeleteBrokerRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteBrokerRequestMarshaller {
    ...
    private static final DeleteBrokerRequestMarshaller instance = new DeleteBrokerRequestMarshaller();

    public static DeleteBrokerRequestMarshaller getInstance() {
        return instance;
    }
