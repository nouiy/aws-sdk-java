...
public class DeleteBrokerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteBrokerRequest withBrokerId(String brokerId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBrokerRequest == false)
            return false;
        DeleteBrokerRequest other = (DeleteBrokerRequest) obj;
    ...
    @Override
    public DeleteBrokerRequest clone() {
        return (DeleteBrokerRequest) super.clone();
    }
