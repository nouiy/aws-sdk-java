...
public class ConfigurationRevisionJsonUnmarshaller implements Unmarshaller<ConfigurationRevision, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("revision", targetDepth)) {
                    context.nextToken();
                    configurationRevision.setRevision(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
