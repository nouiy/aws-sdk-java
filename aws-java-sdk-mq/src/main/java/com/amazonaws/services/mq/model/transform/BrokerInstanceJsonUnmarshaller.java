...
/**
 * BrokerInstance JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BrokerInstanceJsonUnmarshaller implements Unmarshaller<BrokerInstance, JsonUnmarshallerContext> {
    ...
    private static BrokerInstanceJsonUnmarshaller instance;

    public static BrokerInstanceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BrokerInstanceJsonUnmarshaller();
        return instance;
    }
}
