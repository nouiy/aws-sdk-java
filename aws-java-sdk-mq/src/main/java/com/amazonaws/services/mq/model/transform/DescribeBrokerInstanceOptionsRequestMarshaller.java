...
public class DescribeBrokerInstanceOptionsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> HOSTINSTANCETYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("hostInstanceType").build();
    ...
    public static DescribeBrokerInstanceOptionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribeBrokerInstanceOptionsRequest describeBrokerInstanceOptionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeBrokerInstanceOptionsRequest.getEngineType(), ENGINETYPE_BINDING);
