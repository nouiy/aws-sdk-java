...
public class AccessDeniedException extends com.amazonaws.services.ssooidc.model.AWSSSOOIDCException {
     ...
     * </p>
     * 
     * @return Single error code. For this exception the value will be <code>access_denied</code>.
     */
    ...
    public AccessDeniedException withError(String error) {
        setError(error);
        return this;
    }
    ...
    public AccessDeniedException withError_description(String error_description) {
