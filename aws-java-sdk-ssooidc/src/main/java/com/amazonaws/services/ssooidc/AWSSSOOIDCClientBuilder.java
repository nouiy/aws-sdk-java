...
/**
 * Fluent builder for {@link com.amazonaws.services.ssooidc.AWSSSOOIDC}. Use of the builder is preferred over using
...
public final class AWSSSOOIDCClientBuilder extends AwsSyncClientBuilder<AWSSSOOIDCClientBuilder, AWSSSOOIDC> {
     ...
     * @return Fully configured implementation of AWSSSOOIDC.
     */
    @Override
    protected AWSSSOOIDC build(AwsSyncClientParams params) {
        return new AWSSSOOIDCClient(params);
    }
