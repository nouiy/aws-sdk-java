...
public class AWSSSOOIDCAsyncClient extends AWSSSOOIDCClient implements AWSSSOOIDCAsync {
    ...
    @Override
    public java.util.concurrent.Future<CreateTokenWithIAMResult> createTokenWithIAMAsync(final CreateTokenWithIAMRequest request,
            final com.amazonaws.handlers.AsyncHandler<CreateTokenWithIAMRequest, CreateTokenWithIAMResult> asyncHandler) {
        final CreateTokenWithIAMRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<CreateTokenWithIAMResult>() {
            @Override
            public CreateTokenWithIAMResult call() throws Exception {
                CreateTokenWithIAMResult result = null;

                try {
                    result = executeCreateTokenWithIAM(finalRequest);
                } catch (Exception ex) {
                    if (asyncHandler != null) {
                        asyncHandler.onError(ex);
                    }
