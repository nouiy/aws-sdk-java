...
public class UnsupportedGrantTypeException extends com.amazonaws.services.ssooidc.model.AWSSSOOIDCException {
     ...
     * </p>
     * 
     * @return Single error code. For this exception the value will be <code>unsupported_grant_type</code>.
     */
    ...
    public UnsupportedGrantTypeException withError(String error) {
        setError(error);
        return this;
    }
    ...
    public UnsupportedGrantTypeException withError_description(String error_description) {
