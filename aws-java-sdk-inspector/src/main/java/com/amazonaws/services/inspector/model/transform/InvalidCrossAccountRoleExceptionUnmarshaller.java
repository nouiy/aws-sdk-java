...
public class InvalidCrossAccountRoleExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("canRetry", targetDepth)) {
                    context.nextToken();
                    invalidCrossAccountRoleException.setCanRetry(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("errorCode", targetDepth)) {
                    context.nextToken();
                    invalidCrossAccountRoleException.setInspectorErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static InvalidCrossAccountRoleExceptionUnmarshaller instance;

    public static InvalidCrossAccountRoleExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCrossAccountRoleExceptionUnmarshaller();
        return instance;
    }
}
