...
public class UnsubscribeFromEventResultJsonUnmarshaller implements Unmarshaller<UnsubscribeFromEventResult, JsonUnmarshallerContext> {
    ...
    public UnsubscribeFromEventResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UnsubscribeFromEventResult unsubscribeFromEventResult = new UnsubscribeFromEventResult();
