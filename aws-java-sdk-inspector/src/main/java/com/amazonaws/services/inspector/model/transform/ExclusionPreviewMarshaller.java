...
/**
 * ExclusionPreviewMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ExclusionPreviewMarshaller {
    ...
    private static final ExclusionPreviewMarshaller instance = new ExclusionPreviewMarshaller();

    public static ExclusionPreviewMarshaller getInstance() {
        return instance;
    }
