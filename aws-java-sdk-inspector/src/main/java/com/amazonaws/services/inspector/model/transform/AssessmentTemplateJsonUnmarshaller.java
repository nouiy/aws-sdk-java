...
public class AssessmentTemplateJsonUnmarshaller implements Unmarshaller<AssessmentTemplate, JsonUnmarshallerContext> {
    ...
    private static AssessmentTemplateJsonUnmarshaller instance;

    public static AssessmentTemplateJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AssessmentTemplateJsonUnmarshaller();
        return instance;
    }
}
