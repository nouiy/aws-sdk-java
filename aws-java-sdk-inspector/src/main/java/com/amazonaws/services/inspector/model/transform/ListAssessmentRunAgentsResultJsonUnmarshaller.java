...
public class ListAssessmentRunAgentsResultJsonUnmarshaller implements Unmarshaller<ListAssessmentRunAgentsResult, JsonUnmarshallerContext> {
    ...
    private static ListAssessmentRunAgentsResultJsonUnmarshaller instance;

    public static ListAssessmentRunAgentsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListAssessmentRunAgentsResultJsonUnmarshaller();
        return instance;
    }
}
