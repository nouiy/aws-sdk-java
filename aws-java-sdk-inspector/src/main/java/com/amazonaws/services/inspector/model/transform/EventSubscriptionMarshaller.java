...
public class EventSubscriptionMarshaller {
    ...
    public void marshall(EventSubscription eventSubscription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(eventSubscription.getEvent(), EVENT_BINDING);
            protocolMarshaller.marshall(eventSubscription.getSubscribedAt(), SUBSCRIBEDAT_BINDING);
        } catch (Exception e) {
