...
public class NoSuchEntityExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("canRetry", targetDepth)) {
                    context.nextToken();
                    noSuchEntityException.setCanRetry(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("errorCode", targetDepth)) {
                    context.nextToken();
                    noSuchEntityException.setInspectorErrorCode(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static NoSuchEntityExceptionUnmarshaller instance;

    public static NoSuchEntityExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NoSuchEntityExceptionUnmarshaller();
        return instance;
    }
}
