...
public class AgentsAlreadyRunningAssessmentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AgentsAlreadyRunningAssessmentExceptionUnmarshaller instance;

    public static AgentsAlreadyRunningAssessmentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AgentsAlreadyRunningAssessmentExceptionUnmarshaller();
        return instance;
    }
}
