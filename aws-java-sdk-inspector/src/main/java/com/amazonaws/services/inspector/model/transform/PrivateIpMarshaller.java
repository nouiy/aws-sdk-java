...
@SdkInternalApi
public class PrivateIpMarshaller {
    ...
    private static final PrivateIpMarshaller instance = new PrivateIpMarshaller();

    public static PrivateIpMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PrivateIp privateIp, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(privateIp.getPrivateDnsName(), PRIVATEDNSNAME_BINDING);
            protocolMarshaller.marshall(privateIp.getPrivateIpAddress(), PRIVATEIPADDRESS_BINDING);
        } catch (Exception e) {
