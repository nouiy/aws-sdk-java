...
public class PreviewGenerationInProgressExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PreviewGenerationInProgressExceptionUnmarshaller instance;

    public static PreviewGenerationInProgressExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PreviewGenerationInProgressExceptionUnmarshaller();
        return instance;
    }
}
