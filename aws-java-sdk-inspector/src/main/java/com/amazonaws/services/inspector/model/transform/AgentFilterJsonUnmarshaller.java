...
public class AgentFilterJsonUnmarshaller implements Unmarshaller<AgentFilter, JsonUnmarshallerContext> {

    public AgentFilter unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    public static AgentFilterJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AgentFilterJsonUnmarshaller();
        return instance;
    }
}
