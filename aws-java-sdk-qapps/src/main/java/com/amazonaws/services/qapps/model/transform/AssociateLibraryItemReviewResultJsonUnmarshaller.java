...
/**
 * AssociateLibraryItemReviewResult JSON Unmarshaller
 */
...
public class AssociateLibraryItemReviewResultJsonUnmarshaller implements Unmarshaller<AssociateLibraryItemReviewResult, JsonUnmarshallerContext> {
    ...
    public AssociateLibraryItemReviewResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateLibraryItemReviewResult associateLibraryItemReviewResult = new AssociateLibraryItemReviewResult();
