...
/**
 * StopQAppSessionResult JSON Unmarshaller
 */
...
public class StopQAppSessionResultJsonUnmarshaller implements Unmarshaller<StopQAppSessionResult, JsonUnmarshallerContext> {
    ...
    public StopQAppSessionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopQAppSessionResult stopQAppSessionResult = new StopQAppSessionResult();
