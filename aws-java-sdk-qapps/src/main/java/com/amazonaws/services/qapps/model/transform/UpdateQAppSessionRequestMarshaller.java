...
@SdkInternalApi
public class UpdateQAppSessionRequestMarshaller {
    ...
    private static final UpdateQAppSessionRequestMarshaller instance = new UpdateQAppSessionRequestMarshaller();

    public static UpdateQAppSessionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateQAppSessionRequest updateQAppSessionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateQAppSessionRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(updateQAppSessionRequest.getSessionId(), SESSIONID_BINDING);
            protocolMarshaller.marshall(updateQAppSessionRequest.getValues(), VALUES_BINDING);
        } catch (Exception e) {
