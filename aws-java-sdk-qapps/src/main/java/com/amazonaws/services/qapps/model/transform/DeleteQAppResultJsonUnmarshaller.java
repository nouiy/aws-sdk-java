...
/**
 * DeleteQAppResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteQAppResultJsonUnmarshaller implements Unmarshaller<DeleteQAppResult, JsonUnmarshallerContext> {

    public DeleteQAppResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteQAppResult deleteQAppResult = new DeleteQAppResult();
