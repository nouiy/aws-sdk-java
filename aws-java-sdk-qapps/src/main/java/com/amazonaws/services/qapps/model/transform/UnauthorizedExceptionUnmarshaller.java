...
public class UnauthorizedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private UnauthorizedExceptionUnmarshaller() {
        super(com.amazonaws.services.qapps.model.UnauthorizedException.class, "UnauthorizedException");
    }

    @Override
    public com.amazonaws.services.qapps.model.UnauthorizedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.qapps.model.UnauthorizedException unauthorizedException = new com.amazonaws.services.qapps.model.UnauthorizedException(null);
