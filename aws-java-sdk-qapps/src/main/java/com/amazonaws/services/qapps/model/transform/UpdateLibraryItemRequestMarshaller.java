...
public class UpdateLibraryItemRequestMarshaller {
    ...
    private static final UpdateLibraryItemRequestMarshaller instance = new UpdateLibraryItemRequestMarshaller();

    public static UpdateLibraryItemRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateLibraryItemRequest updateLibraryItemRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateLibraryItemRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(updateLibraryItemRequest.getLibraryItemId(), LIBRARYITEMID_BINDING);
            protocolMarshaller.marshall(updateLibraryItemRequest.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(updateLibraryItemRequest.getCategories(), CATEGORIES_BINDING);
        } catch (Exception e) {
