...
public class ImportDocumentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportDocumentResult == false)
            return false;
        ImportDocumentResult other = (ImportDocumentResult) obj;
    ...
    public ImportDocumentResult clone() {
        try {
            return (ImportDocumentResult) super.clone();
