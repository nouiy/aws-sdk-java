...
@SdkInternalApi
public class GetQAppRequestMarshaller {
    ...
    private static final GetQAppRequestMarshaller instance = new GetQAppRequestMarshaller();

    public static GetQAppRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetQAppRequest getQAppRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getQAppRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(getQAppRequest.getAppId(), APPID_BINDING);
        } catch (Exception e) {
