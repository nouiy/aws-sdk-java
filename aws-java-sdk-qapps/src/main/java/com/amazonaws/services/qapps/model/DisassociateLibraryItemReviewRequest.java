...
public class DisassociateLibraryItemReviewRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier of the library item to remove the review from.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateLibraryItemReviewRequest == false)
            return false;
        DisassociateLibraryItemReviewRequest other = (DisassociateLibraryItemReviewRequest) obj;
    ...
    @Override
    public DisassociateLibraryItemReviewRequest clone() {
        return (DisassociateLibraryItemReviewRequest) super.clone();
    }
