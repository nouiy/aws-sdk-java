...
public class AssociateLibraryItemReviewRequestMarshaller {
    ...
    private static final AssociateLibraryItemReviewRequestMarshaller instance = new AssociateLibraryItemReviewRequestMarshaller();

    public static AssociateLibraryItemReviewRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AssociateLibraryItemReviewRequest associateLibraryItemReviewRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(associateLibraryItemReviewRequest.getInstanceId(), INSTANCEID_BINDING);
            protocolMarshaller.marshall(associateLibraryItemReviewRequest.getLibraryItemId(), LIBRARYITEMID_BINDING);
        } catch (Exception e) {
