...
/**
 * DeleteLibraryItemResult JSON Unmarshaller
 */
...
public class DeleteLibraryItemResultJsonUnmarshaller implements Unmarshaller<DeleteLibraryItemResult, JsonUnmarshallerContext> {
    ...
    public DeleteLibraryItemResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLibraryItemResult deleteLibraryItemResult = new DeleteLibraryItemResult();
