...
/**
 * AssociateQAppWithUserResult JSON Unmarshaller
 */
...
public class AssociateQAppWithUserResultJsonUnmarshaller implements Unmarshaller<AssociateQAppWithUserResult, JsonUnmarshallerContext> {
    ...
    public AssociateQAppWithUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateQAppWithUserResult associateQAppWithUserResult = new AssociateQAppWithUserResult();
