 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/qapps-2023-11-27/LibraryItemMember" target="_top">AWS API
 *      Documentation</a>
 */
...
public class LibraryItemMember implements Serializable, Cloneable, StructuredPojo {
    ...
    public LibraryItemMember withLibraryItemId(String libraryItemId) {
    ...
    public LibraryItemMember withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public LibraryItemMember withAppVersion(Integer appVersion) {
     ...
     * </p>
     * 
     * @return The categories associated with the library item.
     */
    ...
    public LibraryItemMember withCategories(Category... categories) {
    ...
    public LibraryItemMember withCategories(java.util.Collection<Category> categories) {
    ...
    public LibraryItemMember withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public LibraryItemMember withCreatedAt(java.util.Date createdAt) {
    ...
    public LibraryItemMember withCreatedBy(String createdBy) {
    ...
    public LibraryItemMember withUpdatedAt(java.util.Date updatedAt) {
    ...
    public LibraryItemMember withUpdatedBy(String updatedBy) {
    ...
    public LibraryItemMember withRatingCount(Integer ratingCount) {
    ...
    public LibraryItemMember withIsRatedByUser(Boolean isRatedByUser) {
    ...
    public LibraryItemMember withUserCount(Integer userCount) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LibraryItemMember == false)
            return false;
        LibraryItemMember other = (LibraryItemMember) obj;
    ...
    @Override
    public LibraryItemMember clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.qapps.model.transform.LibraryItemMemberMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
