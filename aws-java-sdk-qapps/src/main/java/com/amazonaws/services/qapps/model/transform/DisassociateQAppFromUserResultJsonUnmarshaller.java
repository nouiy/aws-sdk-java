...
/**
 * DisassociateQAppFromUserResult JSON Unmarshaller
 */
...
public class DisassociateQAppFromUserResultJsonUnmarshaller implements Unmarshaller<DisassociateQAppFromUserResult, JsonUnmarshallerContext> {
    ...
    public DisassociateQAppFromUserResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateQAppFromUserResult disassociateQAppFromUserResult = new DisassociateQAppFromUserResult();
