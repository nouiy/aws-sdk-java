...
public class UpdateQAppSessionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateQAppSessionResult == false)
            return false;
        UpdateQAppSessionResult other = (UpdateQAppSessionResult) obj;
    ...
    public UpdateQAppSessionResult clone() {
        try {
            return (UpdateQAppSessionResult) super.clone();
