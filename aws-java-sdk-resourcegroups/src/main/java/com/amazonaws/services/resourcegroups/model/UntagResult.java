...
public class UntagResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UntagResult withKeys(String... keys) {
        if (this.keys == null) {
    ...
    public UntagResult withKeys(java.util.Collection<String> keys) {
        setKeys(keys);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UntagResult == false)
            return false;
        UntagResult other = (UntagResult) obj;
