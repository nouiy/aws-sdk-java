...
public class GroupQueryMarshaller {
    ...
    public void marshall(GroupQuery groupQuery, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(groupQuery.getGroupName(), GROUPNAME_BINDING);
            protocolMarshaller.marshall(groupQuery.getResourceQuery(), RESOURCEQUERY_BINDING);
        } catch (Exception e) {
