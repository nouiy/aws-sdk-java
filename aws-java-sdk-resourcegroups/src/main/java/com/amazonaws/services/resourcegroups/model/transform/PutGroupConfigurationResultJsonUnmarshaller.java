...
/**
 * PutGroupConfigurationResult JSON Unmarshaller
 */
...
public class PutGroupConfigurationResultJsonUnmarshaller implements Unmarshaller<PutGroupConfigurationResult, JsonUnmarshallerContext> {
    ...
    public PutGroupConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutGroupConfigurationResult putGroupConfigurationResult = new PutGroupConfigurationResult();

        return putGroupConfigurationResult;
    }
