...
/**
 * GroupResourcesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GroupResourcesResultJsonUnmarshaller implements Unmarshaller<GroupResourcesResult, JsonUnmarshallerContext> {

    public GroupResourcesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GroupResourcesResult groupResourcesResult = new GroupResourcesResult();
    ...
    private static GroupResourcesResultJsonUnmarshaller instance;

    public static GroupResourcesResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GroupResourcesResultJsonUnmarshaller();
        return instance;
    }
}
