...
public class NotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private NotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.resourcegroups.model.NotFoundException.class, "NotFoundException");
    }

    @Override
    public com.amazonaws.services.resourcegroups.model.NotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.resourcegroups.model.NotFoundException notFoundException = new com.amazonaws.services.resourcegroups.model.NotFoundException(
                null);
