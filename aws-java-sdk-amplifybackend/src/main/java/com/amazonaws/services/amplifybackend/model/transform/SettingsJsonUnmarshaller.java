        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("mfaTypes", targetDepth)) {
                    context.nextToken();
                    settings.setMfaTypes(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("smsMessage", targetDepth)) {
                    context.nextToken();
                    settings.setSmsMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
