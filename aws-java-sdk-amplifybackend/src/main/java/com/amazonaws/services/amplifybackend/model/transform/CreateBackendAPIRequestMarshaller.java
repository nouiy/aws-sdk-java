...
public class CreateBackendAPIRequestMarshaller {
    ...
    private static final CreateBackendAPIRequestMarshaller instance = new CreateBackendAPIRequestMarshaller();

    public static CreateBackendAPIRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateBackendAPIRequest createBackendAPIRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBackendAPIRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(createBackendAPIRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(createBackendAPIRequest.getResourceConfig(), RESOURCECONFIG_BINDING);
            protocolMarshaller.marshall(createBackendAPIRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
