...
public class UpdateBackendStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateBackendStorageResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public UpdateBackendStorageResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public UpdateBackendStorageResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public UpdateBackendStorageResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateBackendStorageResult == false)
            return false;
        UpdateBackendStorageResult other = (UpdateBackendStorageResult) obj;
    ...
    @Override
    public UpdateBackendStorageResult clone() {
        try {
            return (UpdateBackendStorageResult) super.clone();
