...
public class GetBackendAPIRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBackendAPIRequest withResourceConfig(BackendAPIResourceConfig resourceConfig) {
    ...
    public GetBackendAPIRequest withResourceName(String resourceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBackendAPIRequest == false)
            return false;
        GetBackendAPIRequest other = (GetBackendAPIRequest) obj;
    ...
    @Override
    public GetBackendAPIRequest clone() {
