...
@SdkInternalApi
public class CreateBackendAuthRequestMarshaller {
    ...
    private static final CreateBackendAuthRequestMarshaller instance = new CreateBackendAuthRequestMarshaller();

    public static CreateBackendAuthRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateBackendAuthRequest createBackendAuthRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createBackendAuthRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(createBackendAuthRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(createBackendAuthRequest.getResourceConfig(), RESOURCECONFIG_BINDING);
            protocolMarshaller.marshall(createBackendAuthRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
