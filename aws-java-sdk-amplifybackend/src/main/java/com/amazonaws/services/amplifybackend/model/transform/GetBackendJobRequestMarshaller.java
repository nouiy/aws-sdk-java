...
public class GetBackendJobRequestMarshaller {
    ...
    private static final GetBackendJobRequestMarshaller instance = new GetBackendJobRequestMarshaller();

    public static GetBackendJobRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetBackendJobRequest getBackendJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getBackendJobRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(getBackendJobRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(getBackendJobRequest.getJobId(), JOBID_BINDING);
        } catch (Exception e) {
