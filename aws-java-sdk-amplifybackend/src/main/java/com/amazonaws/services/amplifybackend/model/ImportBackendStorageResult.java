...
public class ImportBackendStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportBackendStorageResult == false)
            return false;
        ImportBackendStorageResult other = (ImportBackendStorageResult) obj;
    ...
    public ImportBackendStorageResult clone() {
        try {
            return (ImportBackendStorageResult) super.clone();
