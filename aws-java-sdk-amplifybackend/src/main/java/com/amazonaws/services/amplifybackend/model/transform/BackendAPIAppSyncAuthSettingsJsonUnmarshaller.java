...
/**
 * BackendAPIAppSyncAuthSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BackendAPIAppSyncAuthSettingsJsonUnmarshaller implements Unmarshaller<BackendAPIAppSyncAuthSettings, JsonUnmarshallerContext> {

    public BackendAPIAppSyncAuthSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        BackendAPIAppSyncAuthSettings backendAPIAppSyncAuthSettings = new BackendAPIAppSyncAuthSettings();
    ...
    private static BackendAPIAppSyncAuthSettingsJsonUnmarshaller instance;

    public static BackendAPIAppSyncAuthSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BackendAPIAppSyncAuthSettingsJsonUnmarshaller();
        return instance;
    }
}
