...
public class DeleteBackendStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteBackendStorageResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public DeleteBackendStorageResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public DeleteBackendStorageResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public DeleteBackendStorageResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBackendStorageResult == false)
            return false;
        DeleteBackendStorageResult other = (DeleteBackendStorageResult) obj;
    ...
    @Override
    public DeleteBackendStorageResult clone() {
        try {
            return (DeleteBackendStorageResult) super.clone();
