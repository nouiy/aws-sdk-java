...
public class CreateBackendStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateBackendStorageResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public CreateBackendStorageResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public CreateBackendStorageResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public CreateBackendStorageResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBackendStorageResult == false)
            return false;
        CreateBackendStorageResult other = (CreateBackendStorageResult) obj;
    ...
    @Override
    public CreateBackendStorageResult clone() {
        try {
            return (CreateBackendStorageResult) super.clone();
