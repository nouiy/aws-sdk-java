...
/**
 * BackendAPIResourceConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BackendAPIResourceConfigJsonUnmarshaller implements Unmarshaller<BackendAPIResourceConfig, JsonUnmarshallerContext> {

    public BackendAPIResourceConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        BackendAPIResourceConfig backendAPIResourceConfig = new BackendAPIResourceConfig();
    ...
    private static BackendAPIResourceConfigJsonUnmarshaller instance;

    public static BackendAPIResourceConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BackendAPIResourceConfigJsonUnmarshaller();
        return instance;
    }
}
