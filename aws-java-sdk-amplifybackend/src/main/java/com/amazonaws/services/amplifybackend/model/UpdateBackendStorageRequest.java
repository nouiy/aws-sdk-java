...
public class UpdateBackendStorageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     */
    private UpdateBackendStorageResourceConfig resourceConfig;
    /**
     * <p>
    ...
    public void setResourceConfig(UpdateBackendStorageResourceConfig resourceConfig) {
     ...
     * </p>
     * 
     * @return The resource configuration for updating backend storage.
     */

    public UpdateBackendStorageResourceConfig getResourceConfig() {
    ...
    public UpdateBackendStorageRequest withResourceConfig(UpdateBackendStorageResourceConfig resourceConfig) {
    ...
    public UpdateBackendStorageRequest withResourceName(String resourceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateBackendStorageRequest == false)
            return false;
        UpdateBackendStorageRequest other = (UpdateBackendStorageRequest) obj;
    ...
    @Override
    public UpdateBackendStorageRequest clone() {
        return (UpdateBackendStorageRequest) super.clone();
    }
