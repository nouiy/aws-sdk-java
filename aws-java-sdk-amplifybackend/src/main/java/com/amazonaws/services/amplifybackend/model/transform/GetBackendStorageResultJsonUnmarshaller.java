...
/**
 * GetBackendStorageResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetBackendStorageResultJsonUnmarshaller implements Unmarshaller<GetBackendStorageResult, JsonUnmarshallerContext> {

    public GetBackendStorageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetBackendStorageResult getBackendStorageResult = new GetBackendStorageResult();
    ...
    private static GetBackendStorageResultJsonUnmarshaller instance;

    public static GetBackendStorageResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetBackendStorageResultJsonUnmarshaller();
        return instance;
    }
}
