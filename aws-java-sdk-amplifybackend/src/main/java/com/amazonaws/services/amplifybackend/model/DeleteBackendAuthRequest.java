...
public class DeleteBackendAuthRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteBackendAuthRequest withResourceName(String resourceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBackendAuthRequest == false)
            return false;
        DeleteBackendAuthRequest other = (DeleteBackendAuthRequest) obj;
    ...
    @Override
    public DeleteBackendAuthRequest clone() {
        return (DeleteBackendAuthRequest) super.clone();
    }
