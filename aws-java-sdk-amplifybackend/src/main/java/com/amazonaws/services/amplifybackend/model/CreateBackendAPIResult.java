...
public class CreateBackendAPIResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBackendAPIResult == false)
            return false;
        CreateBackendAPIResult other = (CreateBackendAPIResult) obj;
    ...
    public CreateBackendAPIResult clone() {
        try {
            return (CreateBackendAPIResult) super.clone();
