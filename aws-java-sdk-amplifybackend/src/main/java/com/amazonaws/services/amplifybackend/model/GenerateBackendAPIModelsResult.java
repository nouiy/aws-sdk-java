...
public class GenerateBackendAPIModelsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GenerateBackendAPIModelsResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public GenerateBackendAPIModelsResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public GenerateBackendAPIModelsResult withError(String error) {
        setError(error);
        return this;
    }
    ...
    public GenerateBackendAPIModelsResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public GenerateBackendAPIModelsResult withOperation(String operation) {
    ...
    public GenerateBackendAPIModelsResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GenerateBackendAPIModelsResult == false)
            return false;
        GenerateBackendAPIModelsResult other = (GenerateBackendAPIModelsResult) obj;
    ...
    @Override
    public GenerateBackendAPIModelsResult clone() {
        try {
            return (GenerateBackendAPIModelsResult) super.clone();
