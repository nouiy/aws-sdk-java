...
/**
 * UpdateBackendAPIRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateBackendAPIRequestMarshaller {
    ...
    private static final UpdateBackendAPIRequestMarshaller instance = new UpdateBackendAPIRequestMarshaller();

    public static UpdateBackendAPIRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateBackendAPIRequest updateBackendAPIRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateBackendAPIRequest.getAppId(), APPID_BINDING);
            protocolMarshaller.marshall(updateBackendAPIRequest.getBackendEnvironmentName(), BACKENDENVIRONMENTNAME_BINDING);
            protocolMarshaller.marshall(updateBackendAPIRequest.getResourceConfig(), RESOURCECONFIG_BINDING);
            protocolMarshaller.marshall(updateBackendAPIRequest.getResourceName(), RESOURCENAME_BINDING);
        } catch (Exception e) {
