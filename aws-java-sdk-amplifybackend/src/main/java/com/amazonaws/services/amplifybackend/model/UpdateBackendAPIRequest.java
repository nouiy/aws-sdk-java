...
public class UpdateBackendAPIRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Defines the resource configuration for the data model in your Amplify project.
     */
    ...
    public UpdateBackendAPIRequest withResourceConfig(BackendAPIResourceConfig resourceConfig) {
    ...
    public UpdateBackendAPIRequest withResourceName(String resourceName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateBackendAPIRequest == false)
            return false;
        UpdateBackendAPIRequest other = (UpdateBackendAPIRequest) obj;
    ...
    @Override
    public UpdateBackendAPIRequest clone() {
        return (UpdateBackendAPIRequest) super.clone();
    }
