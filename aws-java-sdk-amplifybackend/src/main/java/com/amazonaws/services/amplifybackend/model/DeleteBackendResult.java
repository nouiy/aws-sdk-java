...
public class DeleteBackendResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteBackendResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public DeleteBackendResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public DeleteBackendResult withError(String error) {
        setError(error);
        return this;
    }
    ...
    public DeleteBackendResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public DeleteBackendResult withOperation(String operation) {
    ...
    public DeleteBackendResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteBackendResult == false)
            return false;
        DeleteBackendResult other = (DeleteBackendResult) obj;
    ...
    @Override
    public DeleteBackendResult clone() {
        try {
