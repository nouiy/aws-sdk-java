...
public class CreateBackendAuthResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateBackendAuthResult == false)
            return false;
        CreateBackendAuthResult other = (CreateBackendAuthResult) obj;
    ...
    @Override
    public CreateBackendAuthResult clone() {
        try {
            return (CreateBackendAuthResult) super.clone();
