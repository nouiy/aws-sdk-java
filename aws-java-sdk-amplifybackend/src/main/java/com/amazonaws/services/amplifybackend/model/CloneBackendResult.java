...
public class CloneBackendResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CloneBackendResult withAppId(String appId) {
        setAppId(appId);
        return this;
    }
    ...
    public CloneBackendResult withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public CloneBackendResult withError(String error) {
        setError(error);
        return this;
    }
    ...
    public CloneBackendResult withJobId(String jobId) {
        setJobId(jobId);
        return this;
    }
    ...
    public CloneBackendResult withOperation(String operation) {
    ...
    public CloneBackendResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CloneBackendResult == false)
            return false;
        CloneBackendResult other = (CloneBackendResult) obj;
    ...
    @Override
    public CloneBackendResult clone() {
        try {
            return (CloneBackendResult) super.clone();
