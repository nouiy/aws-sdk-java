...
public class GetBackendRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBackendRequest withBackendEnvironmentName(String backendEnvironmentName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBackendRequest == false)
            return false;
        GetBackendRequest other = (GetBackendRequest) obj;
    ...
    @Override
    public GetBackendRequest clone() {
        return (GetBackendRequest) super.clone();
    }
