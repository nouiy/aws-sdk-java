...
public class CreateSiteRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> OPERATINGADDRESS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("OperatingAddress").build();
    ...
    public void marshall(CreateSiteRequest createSiteRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createSiteRequest.getNotes(), NOTES_BINDING);
            protocolMarshaller.marshall(createSiteRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createSiteRequest.getOperatingAddress(), OPERATINGADDRESS_BINDING);
            protocolMarshaller.marshall(createSiteRequest.getShippingAddress(), SHIPPINGADDRESS_BINDING);
            protocolMarshaller.marshall(createSiteRequest.getRackPhysicalProperties(), RACKPHYSICALPROPERTIES_BINDING);
        } catch (Exception e) {
