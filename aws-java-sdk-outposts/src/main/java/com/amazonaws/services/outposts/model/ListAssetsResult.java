...
public class ListAssetsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setAssets(java.util.Collection<AssetInfo> assets) {
        ...
        this.assets = new java.util.ArrayList<AssetInfo>(assets);
    }
    ...
    public ListAssetsResult withAssets(AssetInfo... assets) {
        if (this.assets == null) {
            setAssets(new java.util.ArrayList<AssetInfo>(assets.length));
        }
        for (AssetInfo ele : assets) {
            this.assets.add(ele);
        }
        return this;
    }
    ...
    public ListAssetsResult withAssets(java.util.Collection<AssetInfo> assets) {
        setAssets(assets);
        return this;
    }
