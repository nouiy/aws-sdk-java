...
/**
 * CreateOutpostRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateOutpostRequestMarshaller {
    ...
    public static CreateOutpostRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateOutpostRequest createOutpostRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createOutpostRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createOutpostRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createOutpostRequest.getSiteId(), SITEID_BINDING);
