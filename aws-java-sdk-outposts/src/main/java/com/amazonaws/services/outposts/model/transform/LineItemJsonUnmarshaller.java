...
/**
 * LineItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LineItemJsonUnmarshaller implements Unmarshaller<LineItem, JsonUnmarshallerContext> {

    public LineItem unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static LineItemJsonUnmarshaller instance;

    public static LineItemJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LineItemJsonUnmarshaller();
        return instance;
    }
}
