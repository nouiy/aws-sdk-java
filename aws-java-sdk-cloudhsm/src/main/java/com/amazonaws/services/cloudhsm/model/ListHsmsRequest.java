...
public class ListHsmsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The <code>NextToken</code> value from a previous call to <code>ListHsms</code>. Pass null if this is the first
     * call.
     * </p>
     */
     ...
     * 
     * @param nextToken
     *        The <code>NextToken</code> value from a previous call to <code>ListHsms</code>. Pass null if this is the
     *        first call.
     */
     ...
     * </p>
     * 
     * @return The <code>NextToken</code> value from a previous call to <code>ListHsms</code>. Pass null if this is the
     *         first call.
     */
