...
/**
 * DeleteHapgRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DeleteHapgRequestMarshaller {
    ...
    private static final DeleteHapgRequestMarshaller instance = new DeleteHapgRequestMarshaller();

    public static DeleteHapgRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DeleteHapgRequest deleteHapgRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteHapgRequest.getHapgArn(), HAPGARN_BINDING);
        } catch (Exception e) {
