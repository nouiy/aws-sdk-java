 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/PredictiveScalingCustomizedLoadMetric"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredictiveScalingCustomizedLoadMetric implements Serializable, Cloneable {

    /**
     * <p>
     * One or more metric data queries to provide the data points for a load metric. Use multiple metric data queries
     ...
     * </p>
     * 
     * @return One or more metric data queries to provide the data points for a load metric. Use multiple metric data
     ...
     *        One or more metric data queries to provide the data points for a load metric. Use multiple metric data
     *        queries only if you are performing a math expression on returned data.
     */
    ...
    public PredictiveScalingCustomizedLoadMetric withMetricDataQueries(java.util.Collection<MetricDataQuery> metricDataQueries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PredictiveScalingCustomizedLoadMetric == false)
            return false;
        PredictiveScalingCustomizedLoadMetric other = (PredictiveScalingCustomizedLoadMetric) obj;
    ...
    @Override
    public PredictiveScalingCustomizedLoadMetric clone() {
        try {
            return (PredictiveScalingCustomizedLoadMetric) super.clone();
