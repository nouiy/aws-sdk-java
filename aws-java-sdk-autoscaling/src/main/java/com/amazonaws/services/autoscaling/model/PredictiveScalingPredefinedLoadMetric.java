 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/autoscaling-2011-01-01/PredictiveScalingPredefinedLoadMetric"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredictiveScalingPredefinedLoadMetric implements Serializable, Cloneable {
    ...
    public PredictiveScalingPredefinedLoadMetric withPredefinedMetricType(String predefinedMetricType) {
    ...
    public PredictiveScalingPredefinedLoadMetric withPredefinedMetricType(PredefinedLoadMetricType predefinedMetricType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PredictiveScalingPredefinedLoadMetric == false)
            return false;
        PredictiveScalingPredefinedLoadMetric other = (PredictiveScalingPredefinedLoadMetric) obj;
    ...
    @Override
    public PredictiveScalingPredefinedLoadMetric clone() {
        try {
            return (PredictiveScalingPredefinedLoadMetric) super.clone();
