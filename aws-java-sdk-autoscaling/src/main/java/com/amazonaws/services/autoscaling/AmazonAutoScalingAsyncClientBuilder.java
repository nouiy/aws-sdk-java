...
/**
 * Fluent builder for {@link com.amazonaws.services.autoscaling.AmazonAutoScalingAsync}. Use of the builder is preferred
...
public final class AmazonAutoScalingAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonAutoScalingAsyncClientBuilder, AmazonAutoScalingAsync> {
    ...
    public static AmazonAutoScalingAsyncClientBuilder standard() {
        return new AmazonAutoScalingAsyncClientBuilder();
    }
     ...
     */
    public static AmazonAutoScalingAsync defaultClient() {
        return standard().build();
    }

    private AmazonAutoScalingAsyncClientBuilder() {
     ...
     * @return Fully configured implementation of AmazonAutoScalingAsync.
     */
    @Override
    protected AmazonAutoScalingAsync build(AwsAsyncClientParams params) {
