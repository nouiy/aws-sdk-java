...
public class EnabledMetricStaxUnmarshaller implements Unmarshaller<EnabledMetric, StaxUnmarshallerContext> {
    ...
    public EnabledMetric unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Metric", targetDepth)) {
                    enabledMetric.setMetric(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Granularity", targetDepth)) {
                    enabledMetric.setGranularity(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
