        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ResourceId", targetDepth)) {
                    tag.setResourceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ResourceType", targetDepth)) {
                    tag.setResourceType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("PropagateAtLaunch", targetDepth)) {
                    tag.setPropagateAtLaunch(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
