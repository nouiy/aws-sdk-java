...
public class DescribeNotificationConfigurationsResultStaxUnmarshaller implements
        Unmarshaller<DescribeNotificationConfigurationsResult, StaxUnmarshallerContext> {
