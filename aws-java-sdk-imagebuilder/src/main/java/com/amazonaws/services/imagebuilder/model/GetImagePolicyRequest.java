...
public class GetImagePolicyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the image whose policy you want to retrieve.
     */
    ...
    @Override
    public GetImagePolicyRequest clone() {
        return (GetImagePolicyRequest) super.clone();
    }
