...
public class CreateDistributionConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateDistributionConfigurationResult withRequestId(String requestId) {
    ...
    public CreateDistributionConfigurationResult withClientToken(String clientToken) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the distribution configuration that was created by this request.
     */
    ...
    public CreateDistributionConfigurationResult withDistributionConfigurationArn(String distributionConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDistributionConfigurationResult == false)
            return false;
        CreateDistributionConfigurationResult other = (CreateDistributionConfigurationResult) obj;
    ...
    @Override
    public CreateDistributionConfigurationResult clone() {
        try {
            return (CreateDistributionConfigurationResult) super.clone();
