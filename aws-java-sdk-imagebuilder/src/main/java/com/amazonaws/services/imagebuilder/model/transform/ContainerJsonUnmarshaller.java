        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("region", targetDepth)) {
                    context.nextToken();
                    container.setRegion(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("imageUris", targetDepth)) {
                    context.nextToken();
                    container.setImageUris(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
