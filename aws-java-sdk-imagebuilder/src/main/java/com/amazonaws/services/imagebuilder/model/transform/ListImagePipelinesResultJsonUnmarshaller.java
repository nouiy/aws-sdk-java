...
/**
 * ListImagePipelinesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListImagePipelinesResultJsonUnmarshaller implements Unmarshaller<ListImagePipelinesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("requestId", targetDepth)) {
                    context.nextToken();
                    listImagePipelinesResult.setRequestId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listImagePipelinesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
