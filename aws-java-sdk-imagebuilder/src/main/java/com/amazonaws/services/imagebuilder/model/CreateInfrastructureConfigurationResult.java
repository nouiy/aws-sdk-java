...
public class CreateInfrastructureConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public CreateInfrastructureConfigurationResult withRequestId(String requestId) {
    ...
    public CreateInfrastructureConfigurationResult withClientToken(String clientToken) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the infrastructure configuration that was created by this request.
     */
    ...
    public CreateInfrastructureConfigurationResult withInfrastructureConfigurationArn(String infrastructureConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateInfrastructureConfigurationResult == false)
            return false;
        CreateInfrastructureConfigurationResult other = (CreateInfrastructureConfigurationResult) obj;
    ...
    @Override
    public CreateInfrastructureConfigurationResult clone() {
        try {
            return (CreateInfrastructureConfigurationResult) super.clone();
