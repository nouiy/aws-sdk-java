        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("clientToken", targetDepth)) {
                    context.nextToken();
                    createImageResult.setClientToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("imageBuildVersionArn", targetDepth)) {
                    context.nextToken();
                    createImageResult.setImageBuildVersionArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
