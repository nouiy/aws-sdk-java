...
public class CreateImageRequestMarshaller {
    ...
    public void marshall(CreateImageRequest createImageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createImageRequest.getContainerRecipeArn(), CONTAINERRECIPEARN_BINDING);
            ...
            protocolMarshaller.marshall(createImageRequest.getImageScanningConfiguration(), IMAGESCANNINGCONFIGURATION_BINDING);
        } catch (Exception e) {
