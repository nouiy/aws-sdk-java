...
public class ListImageScanFindingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The image scan findings for your account that meet your request filter criteria.
     */
    ...
    public ListImageScanFindingsResult withFindings(ImageScanFinding... findings) {
    ...
    public ListImageScanFindingsResult withFindings(java.util.Collection<ImageScanFinding> findings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListImageScanFindingsResult == false)
            return false;
        ListImageScanFindingsResult other = (ListImageScanFindingsResult) obj;
    ...
    public ListImageScanFindingsResult clone() {
        try {
            return (ListImageScanFindingsResult) super.clone();
