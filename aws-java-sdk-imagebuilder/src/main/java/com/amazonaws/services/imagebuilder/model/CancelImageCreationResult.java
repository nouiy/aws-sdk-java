...
public class CancelImageCreationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelImageCreationResult == false)
            return false;
        CancelImageCreationResult other = (CancelImageCreationResult) obj;
    ...
    public CancelImageCreationResult clone() {
        try {
            return (CancelImageCreationResult) super.clone();
