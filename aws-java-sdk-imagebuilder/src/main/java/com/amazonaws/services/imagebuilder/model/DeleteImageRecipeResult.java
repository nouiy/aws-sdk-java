...
public class DeleteImageRecipeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the image recipe that was deleted.
     */
    ...
    public DeleteImageRecipeResult clone() {
        try {
            return (DeleteImageRecipeResult) super.clone();
