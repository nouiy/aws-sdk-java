...
public class CreateImagePipelineResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateImagePipelineResult withRequestId(String requestId) {
    ...
    public CreateImagePipelineResult withClientToken(String clientToken) {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the image pipeline that was created by this request.
     */
    ...
    public CreateImagePipelineResult withImagePipelineArn(String imagePipelineArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateImagePipelineResult == false)
            return false;
        CreateImagePipelineResult other = (CreateImagePipelineResult) obj;
    ...
    @Override
    public CreateImagePipelineResult clone() {
        try {
            return (CreateImagePipelineResult) super.clone();
