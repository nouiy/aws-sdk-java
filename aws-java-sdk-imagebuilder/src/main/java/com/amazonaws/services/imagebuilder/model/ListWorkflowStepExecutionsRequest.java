...
public class ListWorkflowStepExecutionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListWorkflowStepExecutionsRequest withMaxResults(Integer maxResults) {
    ...
    public ListWorkflowStepExecutionsRequest withWorkflowExecutionId(String workflowExecutionId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListWorkflowStepExecutionsRequest == false)
            return false;
        ListWorkflowStepExecutionsRequest other = (ListWorkflowStepExecutionsRequest) obj;
    ...
    @Override
    public ListWorkflowStepExecutionsRequest clone() {
        return (ListWorkflowStepExecutionsRequest) super.clone();
    }
