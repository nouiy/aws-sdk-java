...
public class AccountAggregationMarshaller {
    ...
    public void marshall(AccountAggregation accountAggregation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accountAggregation.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(accountAggregation.getSeverityCounts(), SEVERITYCOUNTS_BINDING);
        } catch (Exception e) {
