...
public class UpdateRecoveryGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateRecoveryGroupResult withCells(java.util.Collection<String> cells) {
        setCells(cells);
        return this;
    }
    ...
    public UpdateRecoveryGroupResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
