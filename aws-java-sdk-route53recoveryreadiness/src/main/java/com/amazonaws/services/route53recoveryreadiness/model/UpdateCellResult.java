...
public class UpdateCellResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateCellResult withCells(String... cells) {
        if (this.cells == null) {
    ...
    public UpdateCellResult withCells(java.util.Collection<String> cells) {
        setCells(cells);
        return this;
    }
    ...
    public UpdateCellResult withParentReadinessScopes(String... parentReadinessScopes) {
    ...
    public UpdateCellResult withParentReadinessScopes(java.util.Collection<String> parentReadinessScopes) {
    ...
    public UpdateCellResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateCellResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateCellResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCellResult == false)
            return false;
        UpdateCellResult other = (UpdateCellResult) obj;
    ...
    @Override
    public UpdateCellResult clone() {
        try {
            return (UpdateCellResult) super.clone();
