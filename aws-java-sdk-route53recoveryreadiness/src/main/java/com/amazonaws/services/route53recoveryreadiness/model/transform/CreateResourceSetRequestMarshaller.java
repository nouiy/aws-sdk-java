...
/**
 * CreateResourceSetRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateResourceSetRequestMarshaller {
    ...
    private static final CreateResourceSetRequestMarshaller instance = new CreateResourceSetRequestMarshaller();

    public static CreateResourceSetRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateResourceSetRequest createResourceSetRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createResourceSetRequest.getResourceSetName(), RESOURCESETNAME_BINDING);
            protocolMarshaller.marshall(createResourceSetRequest.getResourceSetType(), RESOURCESETTYPE_BINDING);
            protocolMarshaller.marshall(createResourceSetRequest.getResources(), RESOURCES_BINDING);
            protocolMarshaller.marshall(createResourceSetRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
