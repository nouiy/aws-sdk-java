...
public class CreateCellRequestMarshaller {
    ...
    private static final CreateCellRequestMarshaller instance = new CreateCellRequestMarshaller();

    public static CreateCellRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateCellRequest createCellRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createCellRequest.getCellName(), CELLNAME_BINDING);
            protocolMarshaller.marshall(createCellRequest.getCells(), CELLS_BINDING);
            protocolMarshaller.marshall(createCellRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
