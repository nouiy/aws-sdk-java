...
public class GetResourceSetResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetResourceSetResult withResources(Resource... resources) {
    ...
    public GetResourceSetResult withResources(java.util.Collection<Resource> resources) {
    ...
    public GetResourceSetResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetResourceSetResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetResourceSetResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
