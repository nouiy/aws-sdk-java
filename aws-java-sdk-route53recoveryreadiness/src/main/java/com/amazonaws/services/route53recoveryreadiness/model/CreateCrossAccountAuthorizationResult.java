...
public class CreateCrossAccountAuthorizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public CreateCrossAccountAuthorizationResult withCrossAccountAuthorization(String crossAccountAuthorization) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateCrossAccountAuthorizationResult == false)
            return false;
        CreateCrossAccountAuthorizationResult other = (CreateCrossAccountAuthorizationResult) obj;
    ...
    @Override
    public CreateCrossAccountAuthorizationResult clone() {
        try {
            return (CreateCrossAccountAuthorizationResult) super.clone();
