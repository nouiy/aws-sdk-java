...
public class GetReadinessCheckResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetReadinessCheckResult withReadinessCheckArn(String readinessCheckArn) {
    ...
    public GetReadinessCheckResult withReadinessCheckName(String readinessCheckName) {
    ...
    public GetReadinessCheckResult withResourceSet(String resourceSet) {
    ...
    public GetReadinessCheckResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see GetReadinessCheckResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public GetReadinessCheckResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public GetReadinessCheckResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetReadinessCheckResult == false)
            return false;
        GetReadinessCheckResult other = (GetReadinessCheckResult) obj;
    ...
    @Override
    public GetReadinessCheckResult clone() {
        try {
            return (GetReadinessCheckResult) super.clone();
