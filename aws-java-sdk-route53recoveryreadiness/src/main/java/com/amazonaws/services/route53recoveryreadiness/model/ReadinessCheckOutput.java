...
public class ReadinessCheckOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public ReadinessCheckOutput withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ReadinessCheckOutput#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReadinessCheckOutput == false)
            return false;
    ...
    public ReadinessCheckOutput clone() {
        try {
            return (ReadinessCheckOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.route53recoveryreadiness.model.transform.ReadinessCheckOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
