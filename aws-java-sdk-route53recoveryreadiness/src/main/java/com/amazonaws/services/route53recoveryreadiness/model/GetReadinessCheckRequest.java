...
public class GetReadinessCheckRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetReadinessCheckRequest withReadinessCheckName(String readinessCheckName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetReadinessCheckRequest == false)
            return false;
        GetReadinessCheckRequest other = (GetReadinessCheckRequest) obj;
    ...
    @Override
    public GetReadinessCheckRequest clone() {
        return (GetReadinessCheckRequest) super.clone();
    }
