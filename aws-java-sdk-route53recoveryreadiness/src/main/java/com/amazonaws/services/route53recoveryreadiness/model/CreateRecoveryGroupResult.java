...
public class CreateRecoveryGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateRecoveryGroupResult withCells(String... cells) {
        if (this.cells == null) {
    ...
    public CreateRecoveryGroupResult withCells(java.util.Collection<String> cells) {
        setCells(cells);
        return this;
    }
    ...
    public CreateRecoveryGroupResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateRecoveryGroupResult#withTags
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateRecoveryGroupResult == false)
            return false;
        CreateRecoveryGroupResult other = (CreateRecoveryGroupResult) obj;
    ...
    public CreateRecoveryGroupResult clone() {
        try {
            return (CreateRecoveryGroupResult) super.clone();
