...
/**
 * DeleteRecoveryGroupResult JSON Unmarshaller
 */
...
public class DeleteRecoveryGroupResultJsonUnmarshaller implements Unmarshaller<DeleteRecoveryGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteRecoveryGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRecoveryGroupResult deleteRecoveryGroupResult = new DeleteRecoveryGroupResult();
