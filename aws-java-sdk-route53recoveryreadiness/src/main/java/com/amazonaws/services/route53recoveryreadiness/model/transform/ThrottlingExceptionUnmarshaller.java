...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.route53recoveryreadiness.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.route53recoveryreadiness.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.route53recoveryreadiness.model.ThrottlingException throttlingException = new com.amazonaws.services.route53recoveryreadiness.model.ThrottlingException(
                null);
