...
public class DescribeServiceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner service that you want a description for.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeServiceRequest == false)
            return false;
        DescribeServiceRequest other = (DescribeServiceRequest) obj;
    ...
    @Override
    public DescribeServiceRequest clone() {
        return (DescribeServiceRequest) super.clone();
    }
