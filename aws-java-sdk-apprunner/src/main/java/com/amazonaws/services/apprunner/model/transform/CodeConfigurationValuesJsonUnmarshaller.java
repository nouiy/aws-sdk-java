...
/**
 * CodeConfigurationValues JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CodeConfigurationValuesJsonUnmarshaller implements Unmarshaller<CodeConfigurationValues, JsonUnmarshallerContext> {

    public CodeConfigurationValues unmarshall(JsonUnmarshallerContext context) throws Exception {
        CodeConfigurationValues codeConfigurationValues = new CodeConfigurationValues();
    ...
    private static CodeConfigurationValuesJsonUnmarshaller instance;

    public static CodeConfigurationValuesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CodeConfigurationValuesJsonUnmarshaller();
        return instance;
    }
}
