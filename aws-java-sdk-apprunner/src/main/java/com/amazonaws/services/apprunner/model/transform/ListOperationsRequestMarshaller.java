...
public class ListOperationsRequestMarshaller {
    ...
    public void marshall(ListOperationsRequest listOperationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listOperationsRequest.getServiceArn(), SERVICEARN_BINDING);
            protocolMarshaller.marshall(listOperationsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listOperationsRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
