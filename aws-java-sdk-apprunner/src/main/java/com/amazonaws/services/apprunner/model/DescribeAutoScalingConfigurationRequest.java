...
public class DescribeAutoScalingConfigurationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     *        The Amazon Resource Name (ARN) of the App Runner auto scaling configuration that you want a description
     *        for.</p>
     *        <p>
     *        The ARN can be a full auto scaling configuration ARN, or a partial ARN ending with either
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner auto scaling configuration that you want a description
     *         for.</p>
     *         <p>
     *         The ARN can be a full auto scaling configuration ARN, or a partial ARN ending with either
     *         <code>.../<i>name</i> </code> or <code>.../<i>name</i>/<i>revision</i> </code>. If a revision isn't
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeAutoScalingConfigurationRequest == false)
            return false;
        DescribeAutoScalingConfigurationRequest other = (DescribeAutoScalingConfigurationRequest) obj;
    ...
    public DescribeAutoScalingConfigurationRequest clone() {
        return (DescribeAutoScalingConfigurationRequest) super.clone();
    }
