...
public class DescribeCustomDomainsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the App Runner service that you want associated custom domain names to
     *         be described for.
     */
     ...
     * </p>
     * 
     * @return The maximum number of results that each response (result page) can include. It's used for a paginated
     *         request.</p>
     *         <p>
     *         If you don't specify <code>MaxResults</code>, the request retrieves all available results in a single
     *         response.
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeCustomDomainsRequest == false)
            return false;
        DescribeCustomDomainsRequest other = (DescribeCustomDomainsRequest) obj;
    ...
    public DescribeCustomDomainsRequest clone() {
        return (DescribeCustomDomainsRequest) super.clone();
    }
