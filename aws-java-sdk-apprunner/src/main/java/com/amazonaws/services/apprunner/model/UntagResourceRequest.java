...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param resourceArn
     *        The Amazon Resource Name (ARN) of the resource that you want to remove tags from.</p>
     *        <p>
     *        It must be the ARN of an App Runner resource.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the resource that you want to remove tags from.</p>
     *         <p>
     *         It must be the ARN of an App Runner resource.
     */
     ...
     * </p>
     * 
     * @return A list of tag keys that you want to remove.
     */
