...
public class OperationSummaryMarshaller {
    ...
    public void marshall(OperationSummary operationSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(operationSummary.getTargetArn(), TARGETARN_BINDING);
            protocolMarshaller.marshall(operationSummary.getStartedAt(), STARTEDAT_BINDING);
            protocolMarshaller.marshall(operationSummary.getEndedAt(), ENDEDAT_BINDING);
            protocolMarshaller.marshall(operationSummary.getUpdatedAt(), UPDATEDAT_BINDING);
        } catch (Exception e) {
