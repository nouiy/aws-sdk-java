...
public class ListVpcConnectorsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListVpcConnectorsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListVpcConnectorsRequest == false)
            return false;
        ListVpcConnectorsRequest other = (ListVpcConnectorsRequest) obj;
    ...
    @Override
    public ListVpcConnectorsRequest clone() {
        return (ListVpcConnectorsRequest) super.clone();
    }
