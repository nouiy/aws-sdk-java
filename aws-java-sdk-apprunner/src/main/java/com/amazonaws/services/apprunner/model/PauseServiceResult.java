...
public class PauseServiceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A description of the App Runner service that this request just paused.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PauseServiceResult == false)
            return false;
        PauseServiceResult other = (PauseServiceResult) obj;
    ...
    @Override
    public PauseServiceResult clone() {
        try {
            return (PauseServiceResult) super.clone();
