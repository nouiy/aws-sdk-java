 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/apprunner-2020-05-15/ConnectionSummary" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ConnectionSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public ConnectionSummary withProviderType(String providerType) {
    ...
    public ConnectionSummary withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public ConnectionSummary withStatus(ConnectionStatus status) {
    ...
    public ConnectionSummary withCreatedAt(java.util.Date createdAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionSummary == false)
            return false;
        ConnectionSummary other = (ConnectionSummary) obj;
    ...
    @Override
    public ConnectionSummary clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.apprunner.model.transform.ConnectionSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
