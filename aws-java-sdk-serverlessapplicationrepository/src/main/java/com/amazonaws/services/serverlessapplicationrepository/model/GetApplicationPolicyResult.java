...
public class GetApplicationPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetApplicationPolicyResult withStatements(ApplicationPolicyStatement... statements) {
    ...
    public GetApplicationPolicyResult withStatements(java.util.Collection<ApplicationPolicyStatement> statements) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetApplicationPolicyResult == false)
            return false;
        GetApplicationPolicyResult other = (GetApplicationPolicyResult) obj;
