...
/**
 * UnshareApplicationResult JSON Unmarshaller
 */
...
public class UnshareApplicationResultJsonUnmarshaller implements Unmarshaller<UnshareApplicationResult, JsonUnmarshallerContext> {
    ...
    public UnshareApplicationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UnshareApplicationResult unshareApplicationResult = new UnshareApplicationResult();
