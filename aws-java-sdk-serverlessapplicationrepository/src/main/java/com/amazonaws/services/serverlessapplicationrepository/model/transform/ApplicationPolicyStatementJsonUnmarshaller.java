...
/**
 * ApplicationPolicyStatement JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ApplicationPolicyStatementJsonUnmarshaller implements Unmarshaller<ApplicationPolicyStatement, JsonUnmarshallerContext> {

    public ApplicationPolicyStatement unmarshall(JsonUnmarshallerContext context) throws Exception {
        ApplicationPolicyStatement applicationPolicyStatement = new ApplicationPolicyStatement();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("statementId", targetDepth)) {
                    context.nextToken();
                    applicationPolicyStatement.setStatementId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static ApplicationPolicyStatementJsonUnmarshaller instance;

    public static ApplicationPolicyStatementJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ApplicationPolicyStatementJsonUnmarshaller();
        return instance;
    }
}
