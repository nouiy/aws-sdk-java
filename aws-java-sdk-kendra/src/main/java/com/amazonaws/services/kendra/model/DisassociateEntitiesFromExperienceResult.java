...
public class DisassociateEntitiesFromExperienceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DisassociateEntitiesFromExperienceResult withFailedEntityList(FailedEntity... failedEntityList) {
    ...
    public DisassociateEntitiesFromExperienceResult withFailedEntityList(java.util.Collection<FailedEntity> failedEntityList) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateEntitiesFromExperienceResult == false)
            return false;
        DisassociateEntitiesFromExperienceResult other = (DisassociateEntitiesFromExperienceResult) obj;
    ...
    public DisassociateEntitiesFromExperienceResult clone() {
        try {
            return (DisassociateEntitiesFromExperienceResult) super.clone();
