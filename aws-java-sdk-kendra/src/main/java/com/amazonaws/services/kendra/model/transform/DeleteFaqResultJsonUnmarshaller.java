...
/**
 * DeleteFaqResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFaqResultJsonUnmarshaller implements Unmarshaller<DeleteFaqResult, JsonUnmarshallerContext> {

    public DeleteFaqResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteFaqResult deleteFaqResult = new DeleteFaqResult();

        return deleteFaqResult;
    }
