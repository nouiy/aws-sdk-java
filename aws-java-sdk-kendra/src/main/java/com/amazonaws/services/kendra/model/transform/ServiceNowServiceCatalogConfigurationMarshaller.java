...
/**
 * ServiceNowServiceCatalogConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ServiceNowServiceCatalogConfigurationMarshaller {
    ...
    private static final ServiceNowServiceCatalogConfigurationMarshaller instance = new ServiceNowServiceCatalogConfigurationMarshaller();

    public static ServiceNowServiceCatalogConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ServiceNowServiceCatalogConfiguration serviceNowServiceCatalogConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (serviceNowServiceCatalogConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(serviceNowServiceCatalogConfiguration.getCrawlAttachments(), CRAWLATTACHMENTS_BINDING);
            protocolMarshaller.marshall(serviceNowServiceCatalogConfiguration.getIncludeAttachmentFilePatterns(), INCLUDEATTACHMENTFILEPATTERNS_BINDING);
            protocolMarshaller.marshall(serviceNowServiceCatalogConfiguration.getExcludeAttachmentFilePatterns(), EXCLUDEATTACHMENTFILEPATTERNS_BINDING);
            protocolMarshaller.marshall(serviceNowServiceCatalogConfiguration.getDocumentDataFieldName(), DOCUMENTDATAFIELDNAME_BINDING);
            protocolMarshaller.marshall(serviceNowServiceCatalogConfiguration.getDocumentTitleFieldName(), DOCUMENTTITLEFIELDNAME_BINDING);
            protocolMarshaller.marshall(serviceNowServiceCatalogConfiguration.getFieldMappings(), FIELDMAPPINGS_BINDING);
        } catch (Exception e) {
