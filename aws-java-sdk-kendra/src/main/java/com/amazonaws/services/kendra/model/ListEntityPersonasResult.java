...
public class ListEntityPersonasResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<PersonasSummary> summaryItems;
    /**
     * <p>
    ...
    public java.util.List<PersonasSummary> getSummaryItems() {
        return summaryItems;
    }
    ...
    public void setSummaryItems(java.util.Collection<PersonasSummary> summaryItems) {
        if (summaryItems == null) {
            this.summaryItems = null;
            return;
        }

        this.summaryItems = new java.util.ArrayList<PersonasSummary>(summaryItems);
    }
    ...
    public ListEntityPersonasResult withSummaryItems(PersonasSummary... summaryItems) {
        if (this.summaryItems == null) {
            setSummaryItems(new java.util.ArrayList<PersonasSummary>(summaryItems.length));
        }
        for (PersonasSummary ele : summaryItems) {
    ...
    public ListEntityPersonasResult withSummaryItems(java.util.Collection<PersonasSummary> summaryItems) {
    ...
    public ListEntityPersonasResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEntityPersonasResult == false)
            return false;
        ListEntityPersonasResult other = (ListEntityPersonasResult) obj;
    ...
    @Override
    public ListEntityPersonasResult clone() {
        try {
