...
/**
 * UpdateQuerySuggestionsBlockListResult JSON Unmarshaller
 */
...
public class UpdateQuerySuggestionsBlockListResultJsonUnmarshaller implements Unmarshaller<UpdateQuerySuggestionsBlockListResult, JsonUnmarshallerContext> {
    ...
    public UpdateQuerySuggestionsBlockListResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateQuerySuggestionsBlockListResult updateQuerySuggestionsBlockListResult = new UpdateQuerySuggestionsBlockListResult();

        return updateQuerySuggestionsBlockListResult;
    }
