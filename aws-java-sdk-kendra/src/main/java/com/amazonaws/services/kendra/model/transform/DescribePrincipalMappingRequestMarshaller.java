...
public class DescribePrincipalMappingRequestMarshaller {
    ...
    private static final DescribePrincipalMappingRequestMarshaller instance = new DescribePrincipalMappingRequestMarshaller();

    public static DescribePrincipalMappingRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DescribePrincipalMappingRequest describePrincipalMappingRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describePrincipalMappingRequest.getIndexId(), INDEXID_BINDING);
            protocolMarshaller.marshall(describePrincipalMappingRequest.getDataSourceId(), DATASOURCEID_BINDING);
            protocolMarshaller.marshall(describePrincipalMappingRequest.getGroupId(), GROUPID_BINDING);
        } catch (Exception e) {
