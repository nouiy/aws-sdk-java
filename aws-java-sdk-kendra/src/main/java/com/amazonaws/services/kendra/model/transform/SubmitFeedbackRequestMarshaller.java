...
public class SubmitFeedbackRequestMarshaller {
    ...
    private static final MarshallingInfo<List> CLICKFEEDBACKITEMS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ClickFeedbackItems").build();
    private static final MarshallingInfo<List> RELEVANCEFEEDBACKITEMS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RelevanceFeedbackItems").build();
