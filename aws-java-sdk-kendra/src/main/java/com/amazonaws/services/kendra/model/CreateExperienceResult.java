...
public class CreateExperienceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateExperienceResult == false)
            return false;
        CreateExperienceResult other = (CreateExperienceResult) obj;
    ...
    public CreateExperienceResult clone() {
        try {
            return (CreateExperienceResult) super.clone();
