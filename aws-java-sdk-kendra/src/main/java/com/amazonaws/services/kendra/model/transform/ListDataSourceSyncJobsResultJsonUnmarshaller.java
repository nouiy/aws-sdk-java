...
/**
 * ListDataSourceSyncJobsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDataSourceSyncJobsResultJsonUnmarshaller implements Unmarshaller<ListDataSourceSyncJobsResult, JsonUnmarshallerContext> {

    public ListDataSourceSyncJobsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listDataSourceSyncJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
