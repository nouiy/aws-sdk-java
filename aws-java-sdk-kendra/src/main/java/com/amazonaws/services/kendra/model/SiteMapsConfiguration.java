...
public class SiteMapsConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<String> siteMaps;
    ...
    public java.util.List<String> getSiteMaps() {
        return siteMaps;
    }
    ...
    public void setSiteMaps(java.util.Collection<String> siteMaps) {
        if (siteMaps == null) {
            this.siteMaps = null;
            return;
        }

        this.siteMaps = new java.util.ArrayList<String>(siteMaps);
    }
     ...
     * {@link #setSiteMaps(java.util.Collection)} or {@link #withSiteMaps(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param siteMaps
    ...
    public SiteMapsConfiguration withSiteMaps(String... siteMaps) {
        if (this.siteMaps == null) {
            setSiteMaps(new java.util.ArrayList<String>(siteMaps.length));
        }
        for (String ele : siteMaps) {
            this.siteMaps.add(ele);
        }
        return this;
    }
    ...
    public SiteMapsConfiguration withSiteMaps(java.util.Collection<String> siteMaps) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SiteMapsConfiguration == false)
            return false;
        SiteMapsConfiguration other = (SiteMapsConfiguration) obj;
        if (other.getSiteMaps() == null ^ this.getSiteMaps() == null)
            return false;
        if (other.getSiteMaps() != null && other.getSiteMaps().equals(this.getSiteMaps()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSiteMaps() == null) ? 0 : getSiteMaps().hashCode());
        return hashCode;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kendra.model.transform.SiteMapsConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
