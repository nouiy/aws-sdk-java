...
/**
 * DeleteExperienceResult JSON Unmarshaller
 */
...
public class DeleteExperienceResultJsonUnmarshaller implements Unmarshaller<DeleteExperienceResult, JsonUnmarshallerContext> {
    ...
    public DeleteExperienceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteExperienceResult deleteExperienceResult = new DeleteExperienceResult();

        return deleteExperienceResult;
    }
