 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/kendra-2019-02-03/SalesforceStandardKnowledgeArticleTypeConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SalesforceStandardKnowledgeArticleTypeConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public SalesforceStandardKnowledgeArticleTypeConfiguration withFieldMappings(java.util.Collection<DataSourceToIndexFieldMapping> fieldMappings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SalesforceStandardKnowledgeArticleTypeConfiguration == false)
            return false;
    ...
    public SalesforceStandardKnowledgeArticleTypeConfiguration clone() {
        try {
            return (SalesforceStandardKnowledgeArticleTypeConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kendra.model.transform.SalesforceStandardKnowledgeArticleTypeConfigurationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
