...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A list of tag keys to remove from the index, FAQ, or data source. If a tag key does not exist on the resource, it
     * is ignored.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the index, FAQ, or data source to remove the tag from.
     */
     ...
     * </p>
     * 
     * @return A list of tag keys to remove from the index, FAQ, or data source. If a tag key does not exist on the
     ...
     * 
     * @param tagKeys
     *        A list of tag keys to remove from the index, FAQ, or data source. If a tag key does not exist on the
     *        resource, it is ignored.
     */
