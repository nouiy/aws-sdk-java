...
public class AuthenticationConfigurationMarshaller {
    ...
    private static final MarshallingInfo<List> BASICAUTHENTICATION_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BasicAuthentication").build();
    ...
    public void marshall(AuthenticationConfiguration authenticationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(authenticationConfiguration.getBasicAuthentication(), BASICAUTHENTICATION_BINDING);
        } catch (Exception e) {
