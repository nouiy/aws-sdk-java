...
/**
 * DocumentAttributeValueCountPairMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DocumentAttributeValueCountPairMarshaller {

    private static final MarshallingInfo<StructuredPojo> DOCUMENTATTRIBUTEVALUE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static DocumentAttributeValueCountPairMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DocumentAttributeValueCountPair documentAttributeValueCountPair, ProtocolMarshaller protocolMarshaller) {

        if (documentAttributeValueCountPair == null) {
