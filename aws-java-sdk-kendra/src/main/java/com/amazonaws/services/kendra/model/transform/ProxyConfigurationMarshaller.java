...
public class ProxyConfigurationMarshaller {
    ...
    public void marshall(ProxyConfiguration proxyConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(proxyConfiguration.getHost(), HOST_BINDING);
            protocolMarshaller.marshall(proxyConfiguration.getPort(), PORT_BINDING);
            protocolMarshaller.marshall(proxyConfiguration.getCredentials(), CREDENTIALS_BINDING);
        } catch (Exception e) {
