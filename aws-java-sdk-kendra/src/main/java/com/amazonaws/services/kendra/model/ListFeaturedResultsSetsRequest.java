...
public class ListFeaturedResultsSetsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * pagination token to retrieve the next set of featured results sets.
     * </p>
     */
     ...
     * </p>
     * 
     * @return If the response is truncated, Amazon Kendra returns a pagination token in the response. You can use this
     *         pagination token to retrieve the next set of featured results sets.
     */
     ...
     * </p>
     * 
     * @return The maximum number of featured results sets to return.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFeaturedResultsSetsRequest == false)
            return false;
        ListFeaturedResultsSetsRequest other = (ListFeaturedResultsSetsRequest) obj;
    ...
    public ListFeaturedResultsSetsRequest clone() {
        return (ListFeaturedResultsSetsRequest) super.clone();
    }
