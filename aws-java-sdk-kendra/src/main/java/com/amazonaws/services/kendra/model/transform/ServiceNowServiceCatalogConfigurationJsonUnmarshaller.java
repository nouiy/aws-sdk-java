...
/**
 * ServiceNowServiceCatalogConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ServiceNowServiceCatalogConfigurationJsonUnmarshaller implements Unmarshaller<ServiceNowServiceCatalogConfiguration, JsonUnmarshallerContext> {

    public ServiceNowServiceCatalogConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
