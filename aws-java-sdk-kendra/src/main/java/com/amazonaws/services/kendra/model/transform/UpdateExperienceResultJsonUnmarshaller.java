...
/**
 * UpdateExperienceResult JSON Unmarshaller
 */
...
public class UpdateExperienceResultJsonUnmarshaller implements Unmarshaller<UpdateExperienceResult, JsonUnmarshallerContext> {
    ...
    public UpdateExperienceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateExperienceResult updateExperienceResult = new UpdateExperienceResult();

        return updateExperienceResult;
    }
