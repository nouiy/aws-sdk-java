...
public class ListDataSourceSyncJobsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListDataSourceSyncJobsResult withHistory(DataSourceSyncJob... history) {
        if (this.history == null) {
            setHistory(new java.util.ArrayList<DataSourceSyncJob>(history.length));
        }
        for (DataSourceSyncJob ele : history) {
