...
@SdkInternalApi
public class ListAgentsRequestMarshaller {
    ...
    private static final ListAgentsRequestMarshaller instance = new ListAgentsRequestMarshaller();

    public static ListAgentsRequestMarshaller getInstance() {
        return instance;
    }
