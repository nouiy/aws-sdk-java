...
/**
 * UpdateTaskExecutionResult JSON Unmarshaller
 */
...
public class UpdateTaskExecutionResultJsonUnmarshaller implements Unmarshaller<UpdateTaskExecutionResult, JsonUnmarshallerContext> {
    ...
    public UpdateTaskExecutionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateTaskExecutionResult updateTaskExecutionResult = new UpdateTaskExecutionResult();

        return updateTaskExecutionResult;
    }
