...
public class ListLocationsRequestMarshaller {
    ...
    private static final ListLocationsRequestMarshaller instance = new ListLocationsRequestMarshaller();

    public static ListLocationsRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(ListLocationsRequest listLocationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(listLocationsRequest.getFilters(), FILTERS_BINDING);
        } catch (Exception e) {
