...
/**
 * CancelTaskExecutionResult JSON Unmarshaller
 */
...
public class CancelTaskExecutionResultJsonUnmarshaller implements Unmarshaller<CancelTaskExecutionResult, JsonUnmarshallerContext> {
    ...
    public CancelTaskExecutionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelTaskExecutionResult cancelTaskExecutionResult = new CancelTaskExecutionResult();
