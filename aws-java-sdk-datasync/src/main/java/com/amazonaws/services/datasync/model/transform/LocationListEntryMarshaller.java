...
/**
 * LocationListEntryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LocationListEntryMarshaller {
    ...
    private static final LocationListEntryMarshaller instance = new LocationListEntryMarshaller();

    public static LocationListEntryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LocationListEntry locationListEntry, ProtocolMarshaller protocolMarshaller) {
