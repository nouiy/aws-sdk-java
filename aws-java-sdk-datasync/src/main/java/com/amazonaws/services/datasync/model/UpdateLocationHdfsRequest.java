...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datasync-2018-11-09/UpdateLocationHdfs" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateLocationHdfsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateLocationHdfsRequest withNameNodes(java.util.Collection<HdfsNameNode> nameNodes) {
    ...
    public UpdateLocationHdfsRequest withKerberosKeytab(java.nio.ByteBuffer kerberosKeytab) {
    ...
    public UpdateLocationHdfsRequest withAgentArns(java.util.Collection<String> agentArns) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateLocationHdfsRequest == false)
            return false;
    ...
    public UpdateLocationHdfsRequest clone() {
        return (UpdateLocationHdfsRequest) super.clone();
    }
