...
/**
 * OnPremConfigMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OnPremConfigMarshaller {
    ...
    private static final OnPremConfigMarshaller instance = new OnPremConfigMarshaller();

    public static OnPremConfigMarshaller getInstance() {
        return instance;
    }
