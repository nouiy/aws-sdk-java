...
/**
 * DescribeTaskExecutionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeTaskExecutionRequestMarshaller {
    ...
    private static final DescribeTaskExecutionRequestMarshaller instance = new DescribeTaskExecutionRequestMarshaller();

    public static DescribeTaskExecutionRequestMarshaller getInstance() {
        return instance;
    }
