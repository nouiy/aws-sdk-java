...
public class PrivateLinkConfigMarshaller {
    ...
    private static final PrivateLinkConfigMarshaller instance = new PrivateLinkConfigMarshaller();

    public static PrivateLinkConfigMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PrivateLinkConfig privateLinkConfig, ProtocolMarshaller protocolMarshaller) {

        if (privateLinkConfig == null) {
