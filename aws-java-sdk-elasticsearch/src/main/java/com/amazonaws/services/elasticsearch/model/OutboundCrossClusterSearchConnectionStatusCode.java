...
public enum OutboundCrossClusterSearchConnectionStatusCode {
     ...
     * @param value
     *        real value
     * @return OutboundCrossClusterSearchConnectionStatusCode corresponding to the value
     *
    ...
    public static OutboundCrossClusterSearchConnectionStatusCode fromValue(String value) {
        ...
        for (OutboundCrossClusterSearchConnectionStatusCode enumEntry : OutboundCrossClusterSearchConnectionStatusCode.values()) {
