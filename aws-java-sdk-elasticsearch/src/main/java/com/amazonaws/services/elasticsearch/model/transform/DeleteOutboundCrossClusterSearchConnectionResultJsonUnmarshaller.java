...
/**
 * DeleteOutboundCrossClusterSearchConnectionResult JSON Unmarshaller
 */
...
public class DeleteOutboundCrossClusterSearchConnectionResultJsonUnmarshaller implements
    ...
    public DeleteOutboundCrossClusterSearchConnectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CrossClusterSearchConnection", targetDepth)) {
                    context.nextToken();
                    deleteOutboundCrossClusterSearchConnectionResult.setCrossClusterSearchConnection(OutboundCrossClusterSearchConnectionJsonUnmarshaller
