...
public class GetCompatibleElasticsearchVersionsRequestMarshaller {
    ...
    private static final GetCompatibleElasticsearchVersionsRequestMarshaller instance = new GetCompatibleElasticsearchVersionsRequestMarshaller();

    public static GetCompatibleElasticsearchVersionsRequestMarshaller getInstance() {
        return instance;
    }
