...
/**
 * AutoTuneOptionsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AutoTuneOptionsMarshaller {
    ...
    private static final MarshallingInfo<String> ROLLBACKONDISABLE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
    ...
    public static AutoTuneOptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AutoTuneOptions autoTuneOptions, ProtocolMarshaller protocolMarshaller) {
