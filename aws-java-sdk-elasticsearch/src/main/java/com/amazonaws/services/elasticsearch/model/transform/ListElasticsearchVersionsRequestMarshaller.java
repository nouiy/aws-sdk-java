...
/**
 * ListElasticsearchVersionsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListElasticsearchVersionsRequestMarshaller {
    ...
    private static final ListElasticsearchVersionsRequestMarshaller instance = new ListElasticsearchVersionsRequestMarshaller();

    public static ListElasticsearchVersionsRequestMarshaller getInstance() {
        return instance;
    }
