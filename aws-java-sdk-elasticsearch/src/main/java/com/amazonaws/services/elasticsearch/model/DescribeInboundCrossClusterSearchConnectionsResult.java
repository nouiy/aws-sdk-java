...
public class DescribeInboundCrossClusterSearchConnectionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public void setCrossClusterSearchConnections(java.util.Collection<InboundCrossClusterSearchConnection> crossClusterSearchConnections) {
        if (crossClusterSearchConnections == null) {
            this.crossClusterSearchConnections = null;
            return;
        }

        this.crossClusterSearchConnections = new java.util.ArrayList<InboundCrossClusterSearchConnection>(crossClusterSearchConnections);
    }
    ...
    public DescribeInboundCrossClusterSearchConnectionsResult withCrossClusterSearchConnections(
        ...
        if (this.crossClusterSearchConnections == null) {
            setCrossClusterSearchConnections(new java.util.ArrayList<InboundCrossClusterSearchConnection>(crossClusterSearchConnections.length));
        }
        for (InboundCrossClusterSearchConnection ele : crossClusterSearchConnections) {
    ...
    public DescribeInboundCrossClusterSearchConnectionsResult clone() {
        try {
            return (DescribeInboundCrossClusterSearchConnectionsResult) super.clone();
