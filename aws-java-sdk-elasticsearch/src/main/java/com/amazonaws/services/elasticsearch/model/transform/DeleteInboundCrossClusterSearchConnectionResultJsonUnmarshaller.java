...
/**
 * DeleteInboundCrossClusterSearchConnectionResult JSON Unmarshaller
 */
...
public class DeleteInboundCrossClusterSearchConnectionResultJsonUnmarshaller implements
    ...
    public DeleteInboundCrossClusterSearchConnectionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("CrossClusterSearchConnection", targetDepth)) {
                    context.nextToken();
                    deleteInboundCrossClusterSearchConnectionResult.setCrossClusterSearchConnection(InboundCrossClusterSearchConnectionJsonUnmarshaller
