...
public class AcceptInboundCrossClusterSearchConnectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public AcceptInboundCrossClusterSearchConnectionResult withCrossClusterSearchConnection(InboundCrossClusterSearchConnection crossClusterSearchConnection) {
    ...
    @Override
    public AcceptInboundCrossClusterSearchConnectionResult clone() {
        try {
            return (AcceptInboundCrossClusterSearchConnectionResult) super.clone();
