...
public class RejectInboundCrossClusterSearchConnectionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public RejectInboundCrossClusterSearchConnectionRequest withCrossClusterSearchConnectionId(String crossClusterSearchConnectionId) {
    ...
    @Override
    public RejectInboundCrossClusterSearchConnectionRequest clone() {
        return (RejectInboundCrossClusterSearchConnectionRequest) super.clone();
    }
