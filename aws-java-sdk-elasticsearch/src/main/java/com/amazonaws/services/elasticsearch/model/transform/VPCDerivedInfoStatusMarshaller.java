...
/**
 * VPCDerivedInfoStatusMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VPCDerivedInfoStatusMarshaller {
    ...
    private static final VPCDerivedInfoStatusMarshaller instance = new VPCDerivedInfoStatusMarshaller();

    public static VPCDerivedInfoStatusMarshaller getInstance() {
        return instance;
    }
