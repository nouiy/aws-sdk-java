...
/**
 * DescribeReservedElasticsearchInstanceOfferingsResult JSON Unmarshaller
 */
...
public class DescribeReservedElasticsearchInstanceOfferingsResultJsonUnmarshaller implements
    ...
    public DescribeReservedElasticsearchInstanceOfferingsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    describeReservedElasticsearchInstanceOfferingsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
