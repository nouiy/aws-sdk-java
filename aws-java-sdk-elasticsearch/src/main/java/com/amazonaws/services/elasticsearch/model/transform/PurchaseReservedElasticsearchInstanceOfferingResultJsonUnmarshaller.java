...
/**
 * PurchaseReservedElasticsearchInstanceOfferingResult JSON Unmarshaller
 */
...
public class PurchaseReservedElasticsearchInstanceOfferingResultJsonUnmarshaller implements
    ...
    public PurchaseReservedElasticsearchInstanceOfferingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ReservedElasticsearchInstanceId", targetDepth)) {
                    context.nextToken();
                    purchaseReservedElasticsearchInstanceOfferingResult.setReservedElasticsearchInstanceId(context.getUnmarshaller(String.class).unmarshall(
                            context));
                }
                if (context.testExpression("ReservationName", targetDepth)) {
                    context.nextToken();
                    purchaseReservedElasticsearchInstanceOfferingResult.setReservationName(context.getUnmarshaller(String.class).unmarshall(context));
                }
