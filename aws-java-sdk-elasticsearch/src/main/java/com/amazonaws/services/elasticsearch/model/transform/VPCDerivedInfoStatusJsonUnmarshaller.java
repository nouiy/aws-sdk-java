...
/**
 * VPCDerivedInfoStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VPCDerivedInfoStatusJsonUnmarshaller implements Unmarshaller<VPCDerivedInfoStatus, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Options", targetDepth)) {
                    context.nextToken();
                    vPCDerivedInfoStatus.setOptions(VPCDerivedInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    vPCDerivedInfoStatus.setStatus(OptionStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
