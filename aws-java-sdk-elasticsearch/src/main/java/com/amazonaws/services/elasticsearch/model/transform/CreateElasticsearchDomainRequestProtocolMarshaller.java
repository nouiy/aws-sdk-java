...
@SdkInternalApi
public class CreateElasticsearchDomainRequestProtocolMarshaller implements
    ...
    public CreateElasticsearchDomainRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<CreateElasticsearchDomainRequest> marshall(CreateElasticsearchDomainRequest createElasticsearchDomainRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<CreateElasticsearchDomainRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(
                    SDK_OPERATION_BINDING, createElasticsearchDomainRequest);

            protocolMarshaller.startMarshalling();
            CreateElasticsearchDomainRequestMarshaller.getInstance().marshall(createElasticsearchDomainRequest, protocolMarshaller);
