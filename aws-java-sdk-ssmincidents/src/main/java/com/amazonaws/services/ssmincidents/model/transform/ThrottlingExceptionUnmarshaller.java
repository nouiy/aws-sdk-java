...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.ssmincidents.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.ssmincidents.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.ssmincidents.model.ThrottlingException throttlingException = new com.amazonaws.services.ssmincidents.model.ThrottlingException(
                null);
