...
public class TriggerDetailsMarshaller {
    ...
    private static final MarshallingInfo<String> RAWDATA_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("rawData").build();
    ...
    private static final MarshallingInfo<String> TRIGGERARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("triggerArn").build();
    ...
    public void marshall(TriggerDetails triggerDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(triggerDetails.getRawData(), RAWDATA_BINDING);
            protocolMarshaller.marshall(triggerDetails.getSource(), SOURCE_BINDING);
            protocolMarshaller.marshall(triggerDetails.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(triggerDetails.getTriggerArn(), TRIGGERARN_BINDING);
        } catch (Exception e) {
