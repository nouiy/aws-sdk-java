...
/**
 * IncidentRecordSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IncidentRecordSummaryJsonUnmarshaller implements Unmarshaller<IncidentRecordSummary, JsonUnmarshallerContext> {

    public IncidentRecordSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        IncidentRecordSummary incidentRecordSummary = new IncidentRecordSummary();
    ...
    private static IncidentRecordSummaryJsonUnmarshaller instance;

    public static IncidentRecordSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncidentRecordSummaryJsonUnmarshaller();
        return instance;
    }
}
