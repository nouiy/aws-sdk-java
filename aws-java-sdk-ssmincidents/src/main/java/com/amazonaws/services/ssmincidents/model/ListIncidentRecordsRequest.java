...
public class ListIncidentRecordsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListIncidentRecordsRequest withFilters(Filter... filters) {
    ...
    public ListIncidentRecordsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public ListIncidentRecordsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIncidentRecordsRequest == false)
            return false;
        ListIncidentRecordsRequest other = (ListIncidentRecordsRequest) obj;
    ...
    @Override
    public ListIncidentRecordsRequest clone() {
        return (ListIncidentRecordsRequest) super.clone();
    }
