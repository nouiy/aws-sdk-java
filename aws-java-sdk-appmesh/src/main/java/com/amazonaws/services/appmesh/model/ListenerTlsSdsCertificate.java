...
/**
 * <p>
 * An object that represents the listener's Secret Discovery Service certificate. The proxy must be configured with a
 * local SDS provider via a Unix Domain Socket. See App Mesh <a
 * href="https://docs.aws.amazon.com/app-mesh/latest/userguide/tls.html">TLS documentation</a> for more info.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/ListenerTlsSdsCertificate" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListenerTlsSdsCertificate implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A reference to an object that represents the name of the secret requested from the Secret Discovery
     *         Service provider representing Transport Layer Security (TLS) materials like a certificate or certificate
     *         chain.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListenerTlsSdsCertificate == false)
            return false;
        ListenerTlsSdsCertificate other = (ListenerTlsSdsCertificate) obj;
    ...
    @Override
    public ListenerTlsSdsCertificate clone() {
        try {
            return (ListenerTlsSdsCertificate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.ListenerTlsSdsCertificateMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
