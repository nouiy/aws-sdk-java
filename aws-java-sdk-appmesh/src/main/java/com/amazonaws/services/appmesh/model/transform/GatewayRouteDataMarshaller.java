...
/**
 * GatewayRouteDataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GatewayRouteDataMarshaller {
    ...
    private static final GatewayRouteDataMarshaller instance = new GatewayRouteDataMarshaller();

    public static GatewayRouteDataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GatewayRouteData gatewayRouteData, ProtocolMarshaller protocolMarshaller) {

        if (gatewayRouteData == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(gatewayRouteData.getGatewayRouteName(), GATEWAYROUTENAME_BINDING);
            protocolMarshaller.marshall(gatewayRouteData.getMeshName(), MESHNAME_BINDING);
            protocolMarshaller.marshall(gatewayRouteData.getMetadata(), METADATA_BINDING);
            protocolMarshaller.marshall(gatewayRouteData.getSpec(), SPEC_BINDING);
            protocolMarshaller.marshall(gatewayRouteData.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(gatewayRouteData.getVirtualGatewayName(), VIRTUALGATEWAYNAME_BINDING);
        } catch (Exception e) {
