...
public class DescribeMeshResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMeshResult == false)
            return false;
        DescribeMeshResult other = (DescribeMeshResult) obj;
    ...
    public DescribeMeshResult clone() {
        try {
            return (DescribeMeshResult) super.clone();
