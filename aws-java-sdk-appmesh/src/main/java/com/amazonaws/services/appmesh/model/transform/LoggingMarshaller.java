...
@SdkInternalApi
public class LoggingMarshaller {
    ...
    private static final LoggingMarshaller instance = new LoggingMarshaller();

    public static LoggingMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(Logging logging, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(logging.getAccessLog(), ACCESSLOG_BINDING);
        } catch (Exception e) {
