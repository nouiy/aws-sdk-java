...
public class TcpRouteAction implements Serializable, Cloneable, StructuredPojo {
    ...
    public TcpRouteAction clone() {
        try {
            return (TcpRouteAction) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.TcpRouteActionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
