...
public class CreateVirtualNodeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateVirtualNodeResult withVirtualNode(VirtualNodeData virtualNode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateVirtualNodeResult == false)
            return false;
        CreateVirtualNodeResult other = (CreateVirtualNodeResult) obj;
    ...
    @Override
    public CreateVirtualNodeResult clone() {
        try {
            return (CreateVirtualNodeResult) super.clone();
