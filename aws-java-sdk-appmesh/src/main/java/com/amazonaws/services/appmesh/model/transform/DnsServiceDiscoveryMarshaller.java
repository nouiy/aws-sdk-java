...
public class DnsServiceDiscoveryMarshaller {
    ...
    public static DnsServiceDiscoveryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DnsServiceDiscovery dnsServiceDiscovery, ProtocolMarshaller protocolMarshaller) {
