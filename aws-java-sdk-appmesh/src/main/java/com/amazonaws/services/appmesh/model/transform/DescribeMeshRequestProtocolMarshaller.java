...
/**
 * DescribeMeshRequest Marshaller
 */
...
public class DescribeMeshRequestProtocolMarshaller implements Marshaller<Request<DescribeMeshRequest>, DescribeMeshRequest> {
    ...
    public DescribeMeshRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DescribeMeshRequest> marshall(DescribeMeshRequest describeMeshRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DescribeMeshRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    describeMeshRequest);

            protocolMarshaller.startMarshalling();
            DescribeMeshRequestMarshaller.getInstance().marshall(describeMeshRequest, protocolMarshaller);
