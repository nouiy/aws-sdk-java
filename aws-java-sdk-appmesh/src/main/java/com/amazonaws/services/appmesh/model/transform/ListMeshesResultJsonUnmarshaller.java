...
/**
 * ListMeshesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListMeshesResultJsonUnmarshaller implements Unmarshaller<ListMeshesResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listMeshesResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
