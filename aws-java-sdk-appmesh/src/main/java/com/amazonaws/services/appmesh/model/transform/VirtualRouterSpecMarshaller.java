...
public class VirtualRouterSpecMarshaller {
    ...
    public static VirtualRouterSpecMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VirtualRouterSpec virtualRouterSpec, ProtocolMarshaller protocolMarshaller) {
