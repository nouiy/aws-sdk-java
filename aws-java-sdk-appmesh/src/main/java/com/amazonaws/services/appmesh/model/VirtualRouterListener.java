 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/VirtualRouterListener" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VirtualRouterListener implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public VirtualRouterListener clone() {
        try {
            return (VirtualRouterListener) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.VirtualRouterListenerMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
