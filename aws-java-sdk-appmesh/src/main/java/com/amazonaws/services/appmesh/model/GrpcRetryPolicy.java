 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/GrpcRetryPolicy" target="_top">AWS API
 *      Documentation</a>
 */
...
public class GrpcRetryPolicy implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.List<String> grpcRetryEvents;
    /**
     * <p>
     ...
     * @see GrpcRetryPolicyEvent
     */

    public java.util.List<String> getGrpcRetryEvents() {
    ...
    public void setGrpcRetryEvents(java.util.Collection<String> grpcRetryEvents) {
        if (grpcRetryEvents == null) {
            this.grpcRetryEvents = null;
            return;
        }

        this.grpcRetryEvents = new java.util.ArrayList<String>(grpcRetryEvents);
    }
     ...
     * {@link #setGrpcRetryEvents(java.util.Collection)} or {@link #withGrpcRetryEvents(java.util.Collection)} if you
    ...
    public GrpcRetryPolicy withGrpcRetryEvents(String... grpcRetryEvents) {
        if (this.grpcRetryEvents == null) {
            setGrpcRetryEvents(new java.util.ArrayList<String>(grpcRetryEvents.length));
        }
    ...
    public GrpcRetryPolicy withGrpcRetryEvents(java.util.Collection<String> grpcRetryEvents) {
        setGrpcRetryEvents(grpcRetryEvents);
        return this;
    }
    ...
    public GrpcRetryPolicy withGrpcRetryEvents(GrpcRetryPolicyEvent... grpcRetryEvents) {
        java.util.ArrayList<String> grpcRetryEventsCopy = new java.util.ArrayList<String>(grpcRetryEvents.length);
        for (GrpcRetryPolicyEvent value : grpcRetryEvents) {
            grpcRetryEventsCopy.add(value.toString());
        }
        if (getGrpcRetryEvents() == null) {
            setGrpcRetryEvents(grpcRetryEventsCopy);
        } else {
            getGrpcRetryEvents().addAll(grpcRetryEventsCopy);
        }
        return this;
    }
    ...
    public GrpcRetryPolicy withHttpRetryEvents(java.util.Collection<String> httpRetryEvents) {
    ...
    public GrpcRetryPolicy withTcpRetryEvents(java.util.Collection<String> tcpRetryEvents) {
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getGrpcRetryEvents() != null)
            sb.append("GrpcRetryEvents: ").append(getGrpcRetryEvents()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GrpcRetryPolicy == false)
            return false;
        GrpcRetryPolicy other = (GrpcRetryPolicy) obj;
        if (other.getGrpcRetryEvents() == null ^ this.getGrpcRetryEvents() == null)
            return false;
        if (other.getGrpcRetryEvents() != null && other.getGrpcRetryEvents().equals(this.getGrpcRetryEvents()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getGrpcRetryEvents() == null) ? 0 : getGrpcRetryEvents().hashCode());
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.GrpcRetryPolicyMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
