...
public class CreateGatewayRouteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The full description of your gateway route following the create call.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateGatewayRouteResult == false)
            return false;
        CreateGatewayRouteResult other = (CreateGatewayRouteResult) obj;
    ...
    public CreateGatewayRouteResult clone() {
        try {
            return (CreateGatewayRouteResult) super.clone();
