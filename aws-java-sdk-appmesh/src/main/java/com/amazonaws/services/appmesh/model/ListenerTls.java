 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/ListenerTls" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListenerTls implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public ListenerTls clone() {
        try {
            return (ListenerTls) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.ListenerTlsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
