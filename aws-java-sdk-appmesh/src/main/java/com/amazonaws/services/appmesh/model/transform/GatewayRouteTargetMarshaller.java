...
public class GatewayRouteTargetMarshaller {
    ...
    private static final GatewayRouteTargetMarshaller instance = new GatewayRouteTargetMarshaller();

    public static GatewayRouteTargetMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GatewayRouteTarget gatewayRouteTarget, ProtocolMarshaller protocolMarshaller) {

        if (gatewayRouteTarget == null) {
