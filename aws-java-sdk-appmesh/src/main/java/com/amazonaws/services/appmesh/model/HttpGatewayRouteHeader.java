 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/HttpGatewayRouteHeader" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HttpGatewayRouteHeader implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A name for the HTTP header in the gateway route that will be matched on.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HttpGatewayRouteHeader == false)
            return false;
        HttpGatewayRouteHeader other = (HttpGatewayRouteHeader) obj;
    ...
    public HttpGatewayRouteHeader clone() {
        try {
            return (HttpGatewayRouteHeader) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.HttpGatewayRouteHeaderMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
