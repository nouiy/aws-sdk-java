...
public class DeleteVirtualRouterResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteVirtualRouterResult withVirtualRouter(VirtualRouterData virtualRouter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVirtualRouterResult == false)
            return false;
        DeleteVirtualRouterResult other = (DeleteVirtualRouterResult) obj;
    ...
    @Override
    public DeleteVirtualRouterResult clone() {
        try {
            return (DeleteVirtualRouterResult) super.clone();
