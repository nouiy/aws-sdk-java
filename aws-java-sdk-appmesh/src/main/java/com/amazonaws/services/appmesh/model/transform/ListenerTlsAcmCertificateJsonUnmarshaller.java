...
/**
 * ListenerTlsAcmCertificate JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListenerTlsAcmCertificateJsonUnmarshaller implements Unmarshaller<ListenerTlsAcmCertificate, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("certificateArn", targetDepth)) {
                    context.nextToken();
                    listenerTlsAcmCertificate.setCertificateArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
