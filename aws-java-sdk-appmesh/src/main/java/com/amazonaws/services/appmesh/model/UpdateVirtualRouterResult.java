...
public class UpdateVirtualRouterResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A full description of the virtual router that was updated.
     */
    ...
    public UpdateVirtualRouterResult clone() {
        try {
            return (UpdateVirtualRouterResult) super.clone();
