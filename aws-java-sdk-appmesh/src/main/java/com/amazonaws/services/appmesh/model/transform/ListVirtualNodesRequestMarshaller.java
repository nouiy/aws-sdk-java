...
/**
 * ListVirtualNodesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListVirtualNodesRequestMarshaller {
    ...
    private static final ListVirtualNodesRequestMarshaller instance = new ListVirtualNodesRequestMarshaller();

    public static ListVirtualNodesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListVirtualNodesRequest listVirtualNodesRequest, ProtocolMarshaller protocolMarshaller) {
