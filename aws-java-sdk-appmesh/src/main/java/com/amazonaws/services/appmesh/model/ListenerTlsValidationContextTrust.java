 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/ListenerTlsValidationContextTrust"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListenerTlsValidationContextTrust implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListenerTlsValidationContextTrust == false)
            return false;
    ...
    @Override
    public ListenerTlsValidationContextTrust clone() {
        try {
            return (ListenerTlsValidationContextTrust) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.ListenerTlsValidationContextTrustMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
