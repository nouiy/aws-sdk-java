...
@SdkInternalApi
public class HttpRouteMatchMarshaller {
    ...
    private static final HttpRouteMatchMarshaller instance = new HttpRouteMatchMarshaller();

    public static HttpRouteMatchMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(HttpRouteMatch httpRouteMatch, ProtocolMarshaller protocolMarshaller) {
