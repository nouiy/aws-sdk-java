 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/VirtualGatewayFileAccessLog"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VirtualGatewayFileAccessLog implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VirtualGatewayFileAccessLog == false)
            return false;
    ...
    public VirtualGatewayFileAccessLog clone() {
        try {
            return (VirtualGatewayFileAccessLog) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.VirtualGatewayFileAccessLogMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
