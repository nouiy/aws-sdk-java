...
/**
 * DeleteVirtualGatewayResult JSON Unmarshaller
 */
...
public class DeleteVirtualGatewayResultJsonUnmarshaller implements Unmarshaller<DeleteVirtualGatewayResult, JsonUnmarshallerContext> {
    ...
    public DeleteVirtualGatewayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            deleteVirtualGatewayResult.setVirtualGateway(VirtualGatewayDataJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
