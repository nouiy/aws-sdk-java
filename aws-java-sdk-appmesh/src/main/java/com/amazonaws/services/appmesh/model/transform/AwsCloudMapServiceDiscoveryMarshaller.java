...
@SdkInternalApi
public class AwsCloudMapServiceDiscoveryMarshaller {
    ...
    private static final AwsCloudMapServiceDiscoveryMarshaller instance = new AwsCloudMapServiceDiscoveryMarshaller();

    public static AwsCloudMapServiceDiscoveryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AwsCloudMapServiceDiscovery awsCloudMapServiceDiscovery, ProtocolMarshaller protocolMarshaller) {

        if (awsCloudMapServiceDiscovery == null) {
