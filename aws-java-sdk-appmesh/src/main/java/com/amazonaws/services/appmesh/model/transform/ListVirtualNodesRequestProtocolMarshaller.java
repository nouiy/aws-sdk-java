...
/**
 * ListVirtualNodesRequest Marshaller
 */
...
public class ListVirtualNodesRequestProtocolMarshaller implements Marshaller<Request<ListVirtualNodesRequest>, ListVirtualNodesRequest> {
    ...
    public ListVirtualNodesRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ListVirtualNodesRequest> marshall(ListVirtualNodesRequest listVirtualNodesRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<ListVirtualNodesRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    listVirtualNodesRequest);

            protocolMarshaller.startMarshalling();
            ListVirtualNodesRequestMarshaller.getInstance().marshall(listVirtualNodesRequest, protocolMarshaller);
