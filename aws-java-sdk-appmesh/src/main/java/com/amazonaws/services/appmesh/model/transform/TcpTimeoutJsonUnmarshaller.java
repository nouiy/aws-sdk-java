...
/**
 * TcpTimeout JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TcpTimeoutJsonUnmarshaller implements Unmarshaller<TcpTimeout, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("idle", targetDepth)) {
                    context.nextToken();
                    tcpTimeout.setIdle(DurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
