 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/VirtualGatewayClientPolicyTls"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VirtualGatewayClientPolicyTls implements Serializable, Cloneable, StructuredPojo {
    ...
    public VirtualGatewayClientPolicyTls withPorts(Integer... ports) {
        if (this.ports == null) {
    ...
    public VirtualGatewayClientPolicyTls withPorts(java.util.Collection<Integer> ports) {
        setPorts(ports);
        return this;
    }
    ...
    public VirtualGatewayClientPolicyTls clone() {
        try {
            return (VirtualGatewayClientPolicyTls) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.VirtualGatewayClientPolicyTlsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
