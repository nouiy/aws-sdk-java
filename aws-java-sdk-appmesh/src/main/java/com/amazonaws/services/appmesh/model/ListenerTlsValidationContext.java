 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/appmesh-2019-01-25/ListenerTlsValidationContext"
...
public class ListenerTlsValidationContext implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return A reference to an object that represents the SANs for a listener's Transport Layer Security (TLS)
     *         validation context.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListenerTlsValidationContext == false)
            return false;
        ListenerTlsValidationContext other = (ListenerTlsValidationContext) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.appmesh.model.transform.ListenerTlsValidationContextMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
