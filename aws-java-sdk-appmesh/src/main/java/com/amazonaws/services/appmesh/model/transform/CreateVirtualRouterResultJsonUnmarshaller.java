...
/**
 * CreateVirtualRouterResult JSON Unmarshaller
 */
...
public class CreateVirtualRouterResultJsonUnmarshaller implements Unmarshaller<CreateVirtualRouterResult, JsonUnmarshallerContext> {
    ...
    public CreateVirtualRouterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            createVirtualRouterResult.setVirtualRouter(VirtualRouterDataJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
