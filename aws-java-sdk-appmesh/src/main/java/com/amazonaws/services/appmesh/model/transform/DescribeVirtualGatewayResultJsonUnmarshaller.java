...
/**
 * DescribeVirtualGatewayResult JSON Unmarshaller
 */
...
public class DescribeVirtualGatewayResultJsonUnmarshaller implements Unmarshaller<DescribeVirtualGatewayResult, JsonUnmarshallerContext> {
    ...
    public DescribeVirtualGatewayResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            describeVirtualGatewayResult.setVirtualGateway(VirtualGatewayDataJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
