...
/**
 * VirtualServiceBackendMarshaller
 */
...
public class VirtualServiceBackendMarshaller {
    ...
    private static final VirtualServiceBackendMarshaller instance = new VirtualServiceBackendMarshaller();

    public static VirtualServiceBackendMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VirtualServiceBackend virtualServiceBackend, ProtocolMarshaller protocolMarshaller) {

        if (virtualServiceBackend == null) {
