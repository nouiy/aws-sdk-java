...
public class ListConfigurationHistoryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ConfigurationEvent> eventList;
    /**
     * <p>
    ...
    public java.util.List<ConfigurationEvent> getEventList() {
        return eventList;
    }
    ...
    public void setEventList(java.util.Collection<ConfigurationEvent> eventList) {
        if (eventList == null) {
            this.eventList = null;
            return;
        }

        this.eventList = new java.util.ArrayList<ConfigurationEvent>(eventList);
    }
    ...
    public ListConfigurationHistoryResult withEventList(ConfigurationEvent... eventList) {
        if (this.eventList == null) {
            setEventList(new java.util.ArrayList<ConfigurationEvent>(eventList.length));
        }
    ...
    public ListConfigurationHistoryResult withEventList(java.util.Collection<ConfigurationEvent> eventList) {
    ...
    public String toString() {
        ...
        if (getEventList() != null)
            sb.append("EventList: ").append(getEventList()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListConfigurationHistoryResult == false)
            return false;
