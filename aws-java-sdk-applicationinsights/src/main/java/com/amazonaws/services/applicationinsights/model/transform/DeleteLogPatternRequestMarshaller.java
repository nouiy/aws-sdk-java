...
public class DeleteLogPatternRequestMarshaller {
    ...
    private static final DeleteLogPatternRequestMarshaller instance = new DeleteLogPatternRequestMarshaller();

    public static DeleteLogPatternRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteLogPatternRequest deleteLogPatternRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteLogPatternRequest.getResourceGroupName(), RESOURCEGROUPNAME_BINDING);
            protocolMarshaller.marshall(deleteLogPatternRequest.getPatternSetName(), PATTERNSETNAME_BINDING);
            protocolMarshaller.marshall(deleteLogPatternRequest.getPatternName(), PATTERNNAME_BINDING);
        } catch (Exception e) {
