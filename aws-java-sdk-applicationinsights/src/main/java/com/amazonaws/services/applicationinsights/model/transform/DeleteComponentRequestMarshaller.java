...
public class DeleteComponentRequestMarshaller {
    ...
    public void marshall(DeleteComponentRequest deleteComponentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteComponentRequest.getResourceGroupName(), RESOURCEGROUPNAME_BINDING);
            protocolMarshaller.marshall(deleteComponentRequest.getComponentName(), COMPONENTNAME_BINDING);
        } catch (Exception e) {
