...
public class ListTagsForResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * An array that lists all the tags that are associated with the application. Each tag consists of a required tag
     * key (<code>Key</code>) and an associated tag value (<code>Value</code>).
     * </p>
     */
     ...
     * </p>
     * 
     * @return An array that lists all the tags that are associated with the application. Each tag consists of a
     *         required tag key (<code>Key</code>) and an associated tag value (<code>Value</code>).
     */
     ...
     * 
     * @param tags
     *        An array that lists all the tags that are associated with the application. Each tag consists of a required
