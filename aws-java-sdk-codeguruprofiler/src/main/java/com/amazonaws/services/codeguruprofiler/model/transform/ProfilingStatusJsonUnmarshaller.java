...
/**
 * ProfilingStatus JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProfilingStatusJsonUnmarshaller implements Unmarshaller<ProfilingStatus, JsonUnmarshallerContext> {

    public ProfilingStatus unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProfilingStatus profilingStatus = new ProfilingStatus();
    ...
    private static ProfilingStatusJsonUnmarshaller instance;

    public static ProfilingStatusJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProfilingStatusJsonUnmarshaller();
        return instance;
    }
}
