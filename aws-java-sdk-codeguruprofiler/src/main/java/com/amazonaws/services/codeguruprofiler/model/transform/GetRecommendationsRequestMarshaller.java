...
public class GetRecommendationsRequestMarshaller {
    ...
    public void marshall(GetRecommendationsRequest getRecommendationsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getRecommendationsRequest.getEndTime(), ENDTIME_BINDING);
            protocolMarshaller.marshall(getRecommendationsRequest.getLocale(), LOCALE_BINDING);
            protocolMarshaller.marshall(getRecommendationsRequest.getProfilingGroupName(), PROFILINGGROUPNAME_BINDING);
            protocolMarshaller.marshall(getRecommendationsRequest.getStartTime(), STARTTIME_BINDING);
        } catch (Exception e) {
