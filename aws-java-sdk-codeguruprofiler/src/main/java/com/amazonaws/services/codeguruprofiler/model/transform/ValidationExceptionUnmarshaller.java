...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.codeguruprofiler.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.codeguruprofiler.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeguruprofiler.model.ValidationException validationException = new com.amazonaws.services.codeguruprofiler.model.ValidationException(
                null);
