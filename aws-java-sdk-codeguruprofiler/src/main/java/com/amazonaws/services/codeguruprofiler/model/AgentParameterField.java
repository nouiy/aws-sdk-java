...
public enum AgentParameterField {
    ...
    private AgentParameterField(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return AgentParameterField corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static AgentParameterField fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (AgentParameterField enumEntry : AgentParameterField.values()) {
