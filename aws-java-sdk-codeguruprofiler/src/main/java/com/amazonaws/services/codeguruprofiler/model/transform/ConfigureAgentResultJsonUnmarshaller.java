...
/**
 * ConfigureAgentResult JSON Unmarshaller
 */
...
public class ConfigureAgentResultJsonUnmarshaller implements Unmarshaller<ConfigureAgentResult, JsonUnmarshallerContext> {
    ...
    public ConfigureAgentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            configureAgentResult.setConfiguration(AgentConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
