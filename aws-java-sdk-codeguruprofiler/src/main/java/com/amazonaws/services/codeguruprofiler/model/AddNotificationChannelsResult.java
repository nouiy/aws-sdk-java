...
public class AddNotificationChannelsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddNotificationChannelsResult == false)
            return false;
        AddNotificationChannelsResult other = (AddNotificationChannelsResult) obj;
    ...
    @Override
    public AddNotificationChannelsResult clone() {
        try {
            return (AddNotificationChannelsResult) super.clone();
