...
public class RemoveNotificationChannelRequestMarshaller {
    ...
    private static final RemoveNotificationChannelRequestMarshaller instance = new RemoveNotificationChannelRequestMarshaller();

    public static RemoveNotificationChannelRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RemoveNotificationChannelRequest removeNotificationChannelRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(removeNotificationChannelRequest.getChannelId(), CHANNELID_BINDING);
            protocolMarshaller.marshall(removeNotificationChannelRequest.getProfilingGroupName(), PROFILINGGROUPNAME_BINDING);
        } catch (Exception e) {
