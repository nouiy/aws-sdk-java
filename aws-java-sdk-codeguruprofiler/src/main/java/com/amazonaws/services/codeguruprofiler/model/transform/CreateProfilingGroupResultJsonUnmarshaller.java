...
/**
 * CreateProfilingGroupResult JSON Unmarshaller
 */
...
public class CreateProfilingGroupResultJsonUnmarshaller implements Unmarshaller<CreateProfilingGroupResult, JsonUnmarshallerContext> {
    ...
    public CreateProfilingGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            createProfilingGroupResult.setProfilingGroup(ProfilingGroupDescriptionJsonUnmarshaller.getInstance().unmarshall(context));
            token = context.nextToken();
        }
