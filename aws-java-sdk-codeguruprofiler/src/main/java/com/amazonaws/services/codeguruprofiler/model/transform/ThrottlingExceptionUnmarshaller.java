...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.codeguruprofiler.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.codeguruprofiler.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.codeguruprofiler.model.ThrottlingException throttlingException = new com.amazonaws.services.codeguruprofiler.model.ThrottlingException(
                null);
