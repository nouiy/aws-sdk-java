...
public class RemovePermissionRequestMarshaller {
    ...
    public void marshall(RemovePermissionRequest removePermissionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(removePermissionRequest.getActionGroup(), ACTIONGROUP_BINDING);
            protocolMarshaller.marshall(removePermissionRequest.getProfilingGroupName(), PROFILINGGROUPNAME_BINDING);
