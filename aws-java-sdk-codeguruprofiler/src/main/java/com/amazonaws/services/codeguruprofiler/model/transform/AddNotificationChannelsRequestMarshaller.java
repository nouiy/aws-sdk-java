...
public class AddNotificationChannelsRequestMarshaller {
    ...
    private static final AddNotificationChannelsRequestMarshaller instance = new AddNotificationChannelsRequestMarshaller();

    public static AddNotificationChannelsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddNotificationChannelsRequest addNotificationChannelsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(addNotificationChannelsRequest.getChannels(), CHANNELS_BINDING);
            protocolMarshaller.marshall(addNotificationChannelsRequest.getProfilingGroupName(), PROFILINGGROUPNAME_BINDING);
        } catch (Exception e) {
