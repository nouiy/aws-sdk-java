...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.cleanrooms.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.cleanrooms.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cleanrooms.model.ValidationException validationException = new com.amazonaws.services.cleanrooms.model.ValidationException(null);
