...
/**
 * ProtectedQuery JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ProtectedQueryJsonUnmarshaller implements Unmarshaller<ProtectedQuery, JsonUnmarshallerContext> {

    public ProtectedQuery unmarshall(JsonUnmarshallerContext context) throws Exception {
        ProtectedQuery protectedQuery = new ProtectedQuery();
    ...
    private static ProtectedQueryJsonUnmarshaller instance;

    public static ProtectedQueryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ProtectedQueryJsonUnmarshaller();
        return instance;
    }
}
