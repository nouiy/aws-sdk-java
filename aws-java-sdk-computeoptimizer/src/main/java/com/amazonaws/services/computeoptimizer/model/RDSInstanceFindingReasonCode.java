...
public enum RDSInstanceFindingReasonCode {
    ...
    NewGenerationDBInstanceClassAvailable("NewGenerationDBInstanceClassAvailable"),
     ...
     * @param value
     *        real value
     * @return RDSInstanceFindingReasonCode corresponding to the value
     *
    ...
    public static RDSInstanceFindingReasonCode fromValue(String value) {
        ...
        for (RDSInstanceFindingReasonCode enumEntry : RDSInstanceFindingReasonCode.values()) {
