...
/**
 * ExportRDSDatabaseRecommendationsRequestMarshaller
 */
...
public class ExportRDSDatabaseRecommendationsRequestMarshaller {
    ...
    private static final ExportRDSDatabaseRecommendationsRequestMarshaller instance = new ExportRDSDatabaseRecommendationsRequestMarshaller();

    public static ExportRDSDatabaseRecommendationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExportRDSDatabaseRecommendationsRequest exportRDSDatabaseRecommendationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (exportRDSDatabaseRecommendationsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getAccountIds(), ACCOUNTIDS_BINDING);
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getFieldsToExport(), FIELDSTOEXPORT_BINDING);
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getS3DestinationConfig(), S3DESTINATIONCONFIG_BINDING);
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getFileFormat(), FILEFORMAT_BINDING);
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getIncludeMemberAccounts(), INCLUDEMEMBERACCOUNTS_BINDING);
            protocolMarshaller.marshall(exportRDSDatabaseRecommendationsRequest.getRecommendationPreferences(), RECOMMENDATIONPREFERENCES_BINDING);
        } catch (Exception e) {
