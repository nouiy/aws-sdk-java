 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/RDSStorageSavingsOpportunityAfterDiscounts"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RDSStorageSavingsOpportunityAfterDiscounts implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * The estimated monthly savings possible as a percentage of monthly cost by adopting Compute Optimizer’s Amazon RDS
    ...
    /**
     * <p>
     * The estimated monthly savings possible by adopting Compute Optimizer’s Amazon RDS storage recommendations. This
     * includes any applicable Savings Plans discounts.
     * </p>
     */
    private RDSStorageEstimatedMonthlySavings estimatedMonthlySavings;
    ...
    public void setEstimatedMonthlySavings(RDSStorageEstimatedMonthlySavings estimatedMonthlySavings) {
     ...
     * </p>
     * 
     * @return The estimated monthly savings possible by adopting Compute Optimizer’s Amazon RDS storage
     *         recommendations. This includes any applicable Savings Plans discounts.
     */

    public RDSStorageEstimatedMonthlySavings getEstimatedMonthlySavings() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RDSStorageSavingsOpportunityAfterDiscounts == false)
            return false;
        RDSStorageSavingsOpportunityAfterDiscounts other = (RDSStorageSavingsOpportunityAfterDiscounts) obj;
    ...
    public RDSStorageSavingsOpportunityAfterDiscounts clone() {
        try {
            return (RDSStorageSavingsOpportunityAfterDiscounts) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.RDSStorageSavingsOpportunityAfterDiscountsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
