...
public class ExportEBSVolumeRecommendationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ExportEBSVolumeRecommendationsRequest withAccountIds(java.util.Collection<String> accountIds) {
    ...
    public ExportEBSVolumeRecommendationsRequest withFilters(java.util.Collection<EBSFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public ExportEBSVolumeRecommendationsRequest withFieldsToExport(String... fieldsToExport) {
    ...
    public ExportEBSVolumeRecommendationsRequest withFieldsToExport(java.util.Collection<String> fieldsToExport) {
    ...
    public ExportEBSVolumeRecommendationsRequest withFieldsToExport(ExportableVolumeField... fieldsToExport) {
        java.util.ArrayList<String> fieldsToExportCopy = new java.util.ArrayList<String>(fieldsToExport.length);
        for (ExportableVolumeField value : fieldsToExport) {
    ...
    public ExportEBSVolumeRecommendationsRequest withFileFormat(String fileFormat) {
    ...
    public ExportEBSVolumeRecommendationsRequest withFileFormat(FileFormat fileFormat) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportEBSVolumeRecommendationsRequest == false)
            return false;
        ExportEBSVolumeRecommendationsRequest other = (ExportEBSVolumeRecommendationsRequest) obj;
    ...
    @Override
    public ExportEBSVolumeRecommendationsRequest clone() {
        return (ExportEBSVolumeRecommendationsRequest) super.clone();
    }
