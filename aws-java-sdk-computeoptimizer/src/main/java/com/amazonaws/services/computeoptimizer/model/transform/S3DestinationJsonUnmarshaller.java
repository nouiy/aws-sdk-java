        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("key", targetDepth)) {
                    context.nextToken();
                    s3Destination.setKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("metadataKey", targetDepth)) {
                    context.nextToken();
                    s3Destination.setMetadataKey(context.getUnmarshaller(String.class).unmarshall(context));
                }
