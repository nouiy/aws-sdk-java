...
/**
 * DeleteRecommendationPreferencesResult JSON Unmarshaller
 */
...
public class DeleteRecommendationPreferencesResultJsonUnmarshaller implements Unmarshaller<DeleteRecommendationPreferencesResult, JsonUnmarshallerContext> {
    ...
    public DeleteRecommendationPreferencesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRecommendationPreferencesResult deleteRecommendationPreferencesResult = new DeleteRecommendationPreferencesResult();
