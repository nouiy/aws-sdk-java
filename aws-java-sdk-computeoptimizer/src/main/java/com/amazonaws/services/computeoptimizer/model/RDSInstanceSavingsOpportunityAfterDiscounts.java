 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/RDSInstanceSavingsOpportunityAfterDiscounts"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RDSInstanceSavingsOpportunityAfterDiscounts implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * The estimated monthly savings possible by adopting Compute Optimizer’s Amazon RDS instance recommendations. This
     ...
     *        The estimated monthly savings possible by adopting Compute Optimizer’s Amazon RDS instance
     *        recommendations. This includes any applicable Savings Plans discounts.
     */

    public void setEstimatedMonthlySavings(RDSInstanceEstimatedMonthlySavings estimatedMonthlySavings) {
     ...
     * </p>
     * 
     * @return The estimated monthly savings possible by adopting Compute Optimizer’s Amazon RDS instance
     *         recommendations. This includes any applicable Savings Plans discounts.
     */

    public RDSInstanceEstimatedMonthlySavings getEstimatedMonthlySavings() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RDSInstanceSavingsOpportunityAfterDiscounts == false)
            return false;
    ...
    public RDSInstanceSavingsOpportunityAfterDiscounts clone() {
        try {
            return (RDSInstanceSavingsOpportunityAfterDiscounts) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.RDSInstanceSavingsOpportunityAfterDiscountsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
