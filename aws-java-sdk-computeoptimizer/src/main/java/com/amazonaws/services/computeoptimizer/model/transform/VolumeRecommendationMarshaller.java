...
/**
 * VolumeRecommendationMarshaller
 */
...
public class VolumeRecommendationMarshaller {
    ...
    private static final MarshallingInfo<List> VOLUMERECOMMENDATIONOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
    ...
    public void marshall(VolumeRecommendation volumeRecommendation, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(volumeRecommendation.getVolumeArn(), VOLUMEARN_BINDING);
            protocolMarshaller.marshall(volumeRecommendation.getAccountId(), ACCOUNTID_BINDING);
            protocolMarshaller.marshall(volumeRecommendation.getCurrentConfiguration(), CURRENTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(volumeRecommendation.getFinding(), FINDING_BINDING);
