...
public class ExportRDSDatabaseRecommendationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportRDSDatabaseRecommendationsResult == false)
            return false;
        ExportRDSDatabaseRecommendationsResult other = (ExportRDSDatabaseRecommendationsResult) obj;
    ...
    public ExportRDSDatabaseRecommendationsResult clone() {
        try {
            return (ExportRDSDatabaseRecommendationsResult) super.clone();
