...
/**
 * DescribeRecommendationExportJobsResult JSON Unmarshaller
 */
...
public class DescribeRecommendationExportJobsResultJsonUnmarshaller implements Unmarshaller<DescribeRecommendationExportJobsResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    describeRecommendationExportJobsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static DescribeRecommendationExportJobsResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeRecommendationExportJobsResultJsonUnmarshaller();
        return instance;
    }
}
