...
public class ExportEBSVolumeRecommendationsRequestMarshaller {
    ...
    private static final ExportEBSVolumeRecommendationsRequestMarshaller instance = new ExportEBSVolumeRecommendationsRequestMarshaller();

    public static ExportEBSVolumeRecommendationsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ExportEBSVolumeRecommendationsRequest exportEBSVolumeRecommendationsRequest, ProtocolMarshaller protocolMarshaller) {

        if (exportEBSVolumeRecommendationsRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(exportEBSVolumeRecommendationsRequest.getAccountIds(), ACCOUNTIDS_BINDING);
            protocolMarshaller.marshall(exportEBSVolumeRecommendationsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(exportEBSVolumeRecommendationsRequest.getFieldsToExport(), FIELDSTOEXPORT_BINDING);
            protocolMarshaller.marshall(exportEBSVolumeRecommendationsRequest.getS3DestinationConfig(), S3DESTINATIONCONFIG_BINDING);
            protocolMarshaller.marshall(exportEBSVolumeRecommendationsRequest.getFileFormat(), FILEFORMAT_BINDING);
            protocolMarshaller.marshall(exportEBSVolumeRecommendationsRequest.getIncludeMemberAccounts(), INCLUDEMEMBERACCOUNTS_BINDING);
        } catch (Exception e) {
