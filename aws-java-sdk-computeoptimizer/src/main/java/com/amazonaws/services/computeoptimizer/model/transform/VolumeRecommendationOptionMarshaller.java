...
/**
 * VolumeRecommendationOptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VolumeRecommendationOptionMarshaller {
    ...
    public static VolumeRecommendationOptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VolumeRecommendationOption volumeRecommendationOption, ProtocolMarshaller protocolMarshaller) {

        if (volumeRecommendationOption == null) {
