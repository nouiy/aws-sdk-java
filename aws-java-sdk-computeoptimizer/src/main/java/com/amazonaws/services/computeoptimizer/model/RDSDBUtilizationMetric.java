 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/RDSDBUtilizationMetric"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RDSDBUtilizationMetric implements Serializable, Cloneable, StructuredPojo {
    ...
    public RDSDBUtilizationMetric withName(String name) {
        setName(name);
        return this;
    }
    ...
    public RDSDBUtilizationMetric withName(RDSDBMetricName name) {
    ...
    public RDSDBUtilizationMetric withStatistic(String statistic) {
    ...
    public RDSDBUtilizationMetric withStatistic(RDSDBMetricStatistic statistic) {
    ...
    public RDSDBUtilizationMetric withValue(Double value) {
        setValue(value);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RDSDBUtilizationMetric == false)
            return false;
    ...
    @Override
    public RDSDBUtilizationMetric clone() {
        try {
            return (RDSDBUtilizationMetric) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.RDSDBUtilizationMetricMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
