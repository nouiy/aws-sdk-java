...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/ExportRDSDatabaseRecommendations"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExportRDSDatabaseRecommendationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Web Services account IDs for the export Amazon RDS recommendations. </p>
     *         <p>
     ...
     * 
     * @param accountIds
     *        The Amazon Web Services account IDs for the export Amazon RDS recommendations. </p>
     *        <p>
     *        If your account is the management account or the delegated administrator of an organization, use this
     *        parameter to specify the member account you want to export recommendations to.
     *        </p>
    ...
    public ExportRDSDatabaseRecommendationsRequest withAccountIds(java.util.Collection<String> accountIds) {
     ...
     * </p>
     * 
     * @return An array of objects to specify a filter that exports a more specific set of Amazon RDS recommendations.
     */
    ...
    public ExportRDSDatabaseRecommendationsRequest withFilters(RDSDBRecommendationFilter... filters) {
    ...
    public ExportRDSDatabaseRecommendationsRequest withFilters(java.util.Collection<RDSDBRecommendationFilter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public ExportRDSDatabaseRecommendationsRequest withFieldsToExport(java.util.Collection<String> fieldsToExport) {
    ...
    public ExportRDSDatabaseRecommendationsRequest withFieldsToExport(ExportableRDSDBField... fieldsToExport) {
        ...
        for (ExportableRDSDBField value : fieldsToExport) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportRDSDatabaseRecommendationsRequest == false)
            return false;
        ExportRDSDatabaseRecommendationsRequest other = (ExportRDSDatabaseRecommendationsRequest) obj;
