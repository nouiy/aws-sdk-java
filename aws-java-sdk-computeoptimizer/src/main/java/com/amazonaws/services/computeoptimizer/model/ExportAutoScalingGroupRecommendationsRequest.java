...
public class ExportAutoScalingGroupRecommendationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ExportAutoScalingGroupRecommendationsRequest withFieldsToExport(ExportableAutoScalingGroupField... fieldsToExport) {
        java.util.ArrayList<String> fieldsToExportCopy = new java.util.ArrayList<String>(fieldsToExport.length);
        for (ExportableAutoScalingGroupField value : fieldsToExport) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportAutoScalingGroupRecommendationsRequest == false)
            return false;
    ...
    @Override
    public ExportAutoScalingGroupRecommendationsRequest clone() {
        return (ExportAutoScalingGroupRecommendationsRequest) super.clone();
    }
