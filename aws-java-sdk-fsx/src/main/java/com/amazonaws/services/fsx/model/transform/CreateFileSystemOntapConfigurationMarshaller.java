...
/**
 * CreateFileSystemOntapConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateFileSystemOntapConfigurationMarshaller {
    ...
    public static CreateFileSystemOntapConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateFileSystemOntapConfiguration createFileSystemOntapConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (createFileSystemOntapConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getAutomaticBackupRetentionDays(), AUTOMATICBACKUPRETENTIONDAYS_BINDING);
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getDailyAutomaticBackupStartTime(), DAILYAUTOMATICBACKUPSTARTTIME_BINDING);
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getDeploymentType(), DEPLOYMENTTYPE_BINDING);
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getEndpointIpAddressRange(), ENDPOINTIPADDRESSRANGE_BINDING);
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getFsxAdminPassword(), FSXADMINPASSWORD_BINDING);
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getDiskIopsConfiguration(), DISKIOPSCONFIGURATION_BINDING);
            protocolMarshaller.marshall(createFileSystemOntapConfiguration.getPreferredSubnetId(), PREFERREDSUBNETID_BINDING);
