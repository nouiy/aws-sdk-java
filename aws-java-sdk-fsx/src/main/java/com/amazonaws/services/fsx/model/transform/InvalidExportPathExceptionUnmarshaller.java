...
public class InvalidExportPathExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.InvalidExportPathException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return invalidExportPathException;
    }

    private static InvalidExportPathExceptionUnmarshaller instance;

    public static InvalidExportPathExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidExportPathExceptionUnmarshaller();
        return instance;
    }
}
