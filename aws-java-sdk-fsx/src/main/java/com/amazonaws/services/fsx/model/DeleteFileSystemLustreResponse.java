...
/**
 * <p>
 * The response object for the Amazon FSx for Lustre file system being deleted in the <code>DeleteFileSystem</code>
 * operation.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/fsx-2018-03-01/DeleteFileSystemLustreResponse" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFileSystemLustreResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    public DeleteFileSystemLustreResponse withFinalBackupTags(java.util.Collection<Tag> finalBackupTags) {
    ...
    public DeleteFileSystemLustreResponse clone() {
        try {
            return (DeleteFileSystemLustreResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.fsx.model.transform.DeleteFileSystemLustreResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
