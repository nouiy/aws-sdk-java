...
public class DescribeFileSystemsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> FILESYSTEMIDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("FileSystemIds").build();
