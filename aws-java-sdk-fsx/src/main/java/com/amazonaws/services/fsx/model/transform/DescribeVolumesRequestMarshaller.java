...
public class DescribeVolumesRequestMarshaller {
    ...
    public void marshall(DescribeVolumesRequest describeVolumesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(describeVolumesRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(describeVolumesRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(describeVolumesRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
