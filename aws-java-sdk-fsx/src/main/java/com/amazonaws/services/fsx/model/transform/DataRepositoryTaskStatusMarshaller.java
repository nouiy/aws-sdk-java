...
/**
 * DataRepositoryTaskStatusMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DataRepositoryTaskStatusMarshaller {
    ...
    private static final MarshallingInfo<Long> SUCCEEDEDCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.LONG)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("SucceededCount").build();
    private static final MarshallingInfo<Long> FAILEDCOUNT_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public static DataRepositoryTaskStatusMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DataRepositoryTaskStatus dataRepositoryTaskStatus, ProtocolMarshaller protocolMarshaller) {

        if (dataRepositoryTaskStatus == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(dataRepositoryTaskStatus.getTotalCount(), TOTALCOUNT_BINDING);
