...
public class CreateFileSystemFromBackupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateFileSystemFromBackupResult clone() {
        try {
            return (CreateFileSystemFromBackupResult) super.clone();
