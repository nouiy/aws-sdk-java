 ...
 * system. Use the API operation to monitor the status of the aliases Amazon FSx is removing from the file system.
 * </p>
 * 
...
public class DisassociateFileSystemAliasesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return An array of one or more DNS aliases that Amazon FSx is attempting to disassociate from the file system.
     */
    ...
    public DisassociateFileSystemAliasesResult withAliases(Alias... aliases) {
    ...
    public DisassociateFileSystemAliasesResult withAliases(java.util.Collection<Alias> aliases) {
        setAliases(aliases);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateFileSystemAliasesResult == false)
            return false;
        DisassociateFileSystemAliasesResult other = (DisassociateFileSystemAliasesResult) obj;
    ...
    public DisassociateFileSystemAliasesResult clone() {
        try {
            return (DisassociateFileSystemAliasesResult) super.clone();
