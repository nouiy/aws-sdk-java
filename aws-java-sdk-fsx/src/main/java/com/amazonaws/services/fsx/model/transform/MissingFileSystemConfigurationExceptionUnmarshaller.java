...
public class MissingFileSystemConfigurationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.MissingFileSystemConfigurationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return missingFileSystemConfigurationException;
    }

    private static MissingFileSystemConfigurationExceptionUnmarshaller instance;

    public static MissingFileSystemConfigurationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new MissingFileSystemConfigurationExceptionUnmarshaller();
        return instance;
    }
}
