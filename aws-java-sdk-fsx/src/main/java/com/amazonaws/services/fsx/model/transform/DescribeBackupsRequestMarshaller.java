...
public class DescribeBackupsRequestMarshaller {
    ...
    private static final MarshallingInfo<List> BACKUPIDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("BackupIds").build();
    ...
    public void marshall(DescribeBackupsRequest describeBackupsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeBackupsRequest.getBackupIds(), BACKUPIDS_BINDING);
