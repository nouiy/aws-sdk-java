...
/**
 * CreateVolumeResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateVolumeResultJsonUnmarshaller implements Unmarshaller<CreateVolumeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Volume", targetDepth)) {
                    context.nextToken();
                    createVolumeResult.setVolume(VolumeJsonUnmarshaller.getInstance().unmarshall(context));
                }
