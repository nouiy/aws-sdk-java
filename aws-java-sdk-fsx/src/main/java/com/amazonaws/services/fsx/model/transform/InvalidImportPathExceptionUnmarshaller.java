...
public class InvalidImportPathExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.InvalidImportPathException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return invalidImportPathException;
    }

    private static InvalidImportPathExceptionUnmarshaller instance;

    public static InvalidImportPathExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidImportPathExceptionUnmarshaller();
        return instance;
    }
}
