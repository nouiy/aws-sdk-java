...
public class NotServiceResourceErrorExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.fsx.model.NotServiceResourceErrorException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ResourceARN", targetDepth)) {
                    context.nextToken();
                    notServiceResourceErrorException.setResourceARN(context.getUnmarshaller(String.class).unmarshall(context));
                }
        ...
        return notServiceResourceErrorException;
    }

    private static NotServiceResourceErrorExceptionUnmarshaller instance;

    public static NotServiceResourceErrorExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotServiceResourceErrorExceptionUnmarshaller();
        return instance;
    }
}
