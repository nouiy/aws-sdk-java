...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudwatchevidently.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.cloudwatchevidently.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudwatchevidently.model.ValidationException validationException = new com.amazonaws.services.cloudwatchevidently.model.ValidationException(
                null);
