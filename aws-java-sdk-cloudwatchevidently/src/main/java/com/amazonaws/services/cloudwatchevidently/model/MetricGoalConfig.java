 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/evidently-2021-02-01/MetricGoalConfig" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricGoalConfig implements Serializable, Cloneable, StructuredPojo {
    ...
    public MetricGoalConfig withDesiredChange(String desiredChange) {
    ...
    public MetricGoalConfig withDesiredChange(ChangeDirectionEnum desiredChange) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MetricGoalConfig == false)
            return false;
    ...
    @Override
    public MetricGoalConfig clone() {
        try {
            return (MetricGoalConfig) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cloudwatchevidently.model.transform.MetricGoalConfigMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
