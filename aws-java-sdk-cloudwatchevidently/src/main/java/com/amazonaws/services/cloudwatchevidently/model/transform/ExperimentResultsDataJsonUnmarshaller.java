...
/**
 * ExperimentResultsData JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExperimentResultsDataJsonUnmarshaller implements Unmarshaller<ExperimentResultsData, JsonUnmarshallerContext> {

    public ExperimentResultsData unmarshall(JsonUnmarshallerContext context) throws Exception {
        ExperimentResultsData experimentResultsData = new ExperimentResultsData();
    ...
    private static ExperimentResultsDataJsonUnmarshaller instance;

    public static ExperimentResultsDataJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ExperimentResultsDataJsonUnmarshaller();
        return instance;
    }
}
