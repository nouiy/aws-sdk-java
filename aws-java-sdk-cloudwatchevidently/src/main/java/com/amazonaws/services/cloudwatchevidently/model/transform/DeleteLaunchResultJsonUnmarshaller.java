...
/**
 * DeleteLaunchResult JSON Unmarshaller
 */
...
public class DeleteLaunchResultJsonUnmarshaller implements Unmarshaller<DeleteLaunchResult, JsonUnmarshallerContext> {
    ...
    public DeleteLaunchResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLaunchResult deleteLaunchResult = new DeleteLaunchResult();
