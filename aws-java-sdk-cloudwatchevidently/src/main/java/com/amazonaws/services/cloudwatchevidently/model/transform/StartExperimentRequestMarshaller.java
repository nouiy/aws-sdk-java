...
@SdkInternalApi
public class StartExperimentRequestMarshaller {
    ...
    private static final StartExperimentRequestMarshaller instance = new StartExperimentRequestMarshaller();

    public static StartExperimentRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartExperimentRequest startExperimentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startExperimentRequest.getAnalysisCompleteTime(), ANALYSISCOMPLETETIME_BINDING);
            protocolMarshaller.marshall(startExperimentRequest.getExperiment(), EXPERIMENT_BINDING);
            protocolMarshaller.marshall(startExperimentRequest.getProject(), PROJECT_BINDING);
        } catch (Exception e) {
