        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    healthCheckConfig.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ResourcePath", targetDepth)) {
                    context.nextToken();
                    healthCheckConfig.setResourcePath(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("FailureThreshold", targetDepth)) {
                    context.nextToken();
                    healthCheckConfig.setFailureThreshold(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
