...
/**
 * UpdateInstanceCustomHealthStatusRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateInstanceCustomHealthStatusRequestMarshaller {
    ...
    private static final UpdateInstanceCustomHealthStatusRequestMarshaller instance = new UpdateInstanceCustomHealthStatusRequestMarshaller();

    public static UpdateInstanceCustomHealthStatusRequestMarshaller getInstance() {
        return instance;
    }
