...
/**
 * CreateHttpNamespaceResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateHttpNamespaceResultJsonUnmarshaller implements Unmarshaller<CreateHttpNamespaceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OperationId", targetDepth)) {
                    context.nextToken();
                    createHttpNamespaceResult.setOperationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
