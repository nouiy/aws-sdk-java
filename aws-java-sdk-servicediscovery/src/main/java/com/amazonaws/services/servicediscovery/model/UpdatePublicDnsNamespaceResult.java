...
public class UpdatePublicDnsNamespaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePublicDnsNamespaceResult == false)
            return false;
        UpdatePublicDnsNamespaceResult other = (UpdatePublicDnsNamespaceResult) obj;
    ...
    public UpdatePublicDnsNamespaceResult clone() {
        try {
            return (UpdatePublicDnsNamespaceResult) super.clone();
