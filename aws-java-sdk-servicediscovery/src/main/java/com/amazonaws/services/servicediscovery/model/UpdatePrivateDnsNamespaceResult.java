...
public class UpdatePrivateDnsNamespaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdatePrivateDnsNamespaceResult withOperationId(String operationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePrivateDnsNamespaceResult == false)
            return false;
        UpdatePrivateDnsNamespaceResult other = (UpdatePrivateDnsNamespaceResult) obj;
    ...
    @Override
    public UpdatePrivateDnsNamespaceResult clone() {
        try {
            return (UpdatePrivateDnsNamespaceResult) super.clone();
