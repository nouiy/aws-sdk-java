...
public class ListInstancesRequestMarshaller {
    ...
    public void marshall(ListInstancesRequest listInstancesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listInstancesRequest.getServiceId(), SERVICEID_BINDING);
            protocolMarshaller.marshall(listInstancesRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listInstancesRequest.getMaxResults(), MAXRESULTS_BINDING);
        } catch (Exception e) {
