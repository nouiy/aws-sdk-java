 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/PrivateDnsNamespacePropertiesChange"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PrivateDnsNamespacePropertiesChange implements Serializable, Cloneable, StructuredPojo {
    ...
    public PrivateDnsPropertiesMutableChange getDnsProperties() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PrivateDnsNamespacePropertiesChange == false)
            return false;
    ...
    @Override
    public PrivateDnsNamespacePropertiesChange clone() {
        try {
            return (PrivateDnsNamespacePropertiesChange) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.servicediscovery.model.transform.PrivateDnsNamespacePropertiesChangeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
