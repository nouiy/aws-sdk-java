...
@SdkInternalApi
public class GetNamespaceRequestMarshaller {

    private static final MarshallingInfo<String> ID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Id").build();

    private static final GetNamespaceRequestMarshaller instance = new GetNamespaceRequestMarshaller();

    public static GetNamespaceRequestMarshaller getInstance() {
        return instance;
    }
