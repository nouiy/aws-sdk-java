...
public class CreatePublicDnsNamespaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreatePublicDnsNamespaceResult withOperationId(String operationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePublicDnsNamespaceResult == false)
            return false;
        CreatePublicDnsNamespaceResult other = (CreatePublicDnsNamespaceResult) obj;
    ...
    @Override
    public CreatePublicDnsNamespaceResult clone() {
        try {
            return (CreatePublicDnsNamespaceResult) super.clone();
