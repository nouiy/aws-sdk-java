...
public class CustomHealthNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    public com.amazonaws.services.servicediscovery.model.CustomHealthNotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        ...
        return customHealthNotFoundException;
    }

    private static CustomHealthNotFoundExceptionUnmarshaller instance;

    public static CustomHealthNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CustomHealthNotFoundExceptionUnmarshaller();
        return instance;
    }
}
