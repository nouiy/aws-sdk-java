...
public class RegisterInstanceResultJsonUnmarshaller implements Unmarshaller<RegisterInstanceResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("OperationId", targetDepth)) {
                    context.nextToken();
                    registerInstanceResult.setOperationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static RegisterInstanceResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new RegisterInstanceResultJsonUnmarshaller();
        return instance;
    }
}
