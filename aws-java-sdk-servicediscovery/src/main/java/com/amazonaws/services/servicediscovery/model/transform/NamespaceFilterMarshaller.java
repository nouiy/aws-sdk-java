...
/**
 * NamespaceFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class NamespaceFilterMarshaller {
    ...
    private static final NamespaceFilterMarshaller instance = new NamespaceFilterMarshaller();

    public static NamespaceFilterMarshaller getInstance() {
        return instance;
    }
