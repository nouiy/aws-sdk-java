...
public class CreateHttpNamespaceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateHttpNamespaceRequest withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    @Override
    public CreateHttpNamespaceRequest clone() {
        return (CreateHttpNamespaceRequest) super.clone();
    }
