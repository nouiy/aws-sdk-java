...
/**
 * NamespaceFilter JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NamespaceFilterJsonUnmarshaller implements Unmarshaller<NamespaceFilter, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    namespaceFilter.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("Condition", targetDepth)) {
                    context.nextToken();
                    namespaceFilter.setCondition(context.getUnmarshaller(String.class).unmarshall(context));
                }
