...
public class UpdateHttpNamespaceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateHttpNamespaceResult withOperationId(String operationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateHttpNamespaceResult == false)
            return false;
        UpdateHttpNamespaceResult other = (UpdateHttpNamespaceResult) obj;
    ...
    @Override
    public UpdateHttpNamespaceResult clone() {
        try {
            return (UpdateHttpNamespaceResult) super.clone();
