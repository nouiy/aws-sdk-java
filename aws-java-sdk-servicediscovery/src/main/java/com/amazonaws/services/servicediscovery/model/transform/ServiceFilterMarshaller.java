...
public class ServiceFilterMarshaller {
    ...
    public void marshall(ServiceFilter serviceFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(serviceFilter.getName(), NAME_BINDING);
            protocolMarshaller.marshall(serviceFilter.getValues(), VALUES_BINDING);
            protocolMarshaller.marshall(serviceFilter.getCondition(), CONDITION_BINDING);
        } catch (Exception e) {
