...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.appconfigdata.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.appconfigdata.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.appconfigdata.model.InternalServerException internalServerException = new com.amazonaws.services.appconfigdata.model.InternalServerException(
                null);
