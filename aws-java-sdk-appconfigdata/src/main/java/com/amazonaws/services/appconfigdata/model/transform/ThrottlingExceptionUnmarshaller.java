...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.appconfigdata.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.appconfigdata.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.appconfigdata.model.ThrottlingException throttlingException = new com.amazonaws.services.appconfigdata.model.ThrottlingException(
                null);
