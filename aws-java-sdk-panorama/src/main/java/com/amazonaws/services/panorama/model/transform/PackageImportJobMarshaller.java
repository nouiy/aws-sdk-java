...
public class PackageImportJobMarshaller {
    ...
    public static PackageImportJobMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PackageImportJob packageImportJob, ProtocolMarshaller protocolMarshaller) {

        if (packageImportJob == null) {
