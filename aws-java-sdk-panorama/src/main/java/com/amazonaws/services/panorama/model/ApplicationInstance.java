 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/panorama-2019-07-24/ApplicationInstance" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ApplicationInstance implements Serializable, Cloneable, StructuredPojo {
    ...
    public ApplicationInstance withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ApplicationInstance#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ApplicationInstance addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.panorama.model.transform.ApplicationInstanceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
