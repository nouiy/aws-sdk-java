...
/**
 * RegisterPackageVersionResult JSON Unmarshaller
 */
...
public class RegisterPackageVersionResultJsonUnmarshaller implements Unmarshaller<RegisterPackageVersionResult, JsonUnmarshallerContext> {
    ...
    public RegisterPackageVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RegisterPackageVersionResult registerPackageVersionResult = new RegisterPackageVersionResult();
