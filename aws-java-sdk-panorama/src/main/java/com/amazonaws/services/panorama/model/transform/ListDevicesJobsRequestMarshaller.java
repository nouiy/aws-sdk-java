...
public class ListDevicesJobsRequestMarshaller {
    ...
    public static ListDevicesJobsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListDevicesJobsRequest listDevicesJobsRequest, ProtocolMarshaller protocolMarshaller) {
