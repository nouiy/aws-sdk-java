...
public class NodeInputPortMarshaller {
    ...
    public static NodeInputPortMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(NodeInputPort nodeInputPort, ProtocolMarshaller protocolMarshaller) {

        if (nodeInputPort == null) {
