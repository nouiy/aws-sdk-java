...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.panorama.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.panorama.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.panorama.model.ValidationException validationException = new com.amazonaws.services.panorama.model.ValidationException(null);
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("ErrorArguments", targetDepth)) {
                    ...
                    validationException.setErrorArguments(new ListUnmarshaller<ValidationExceptionErrorArgument>(
                            ValidationExceptionErrorArgumentJsonUnmarshaller.getInstance())
