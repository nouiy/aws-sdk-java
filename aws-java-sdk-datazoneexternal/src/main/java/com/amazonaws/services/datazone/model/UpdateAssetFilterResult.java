...
public class UpdateAssetFilterResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAssetFilterResult withCreatedAt(java.util.Date createdAt) {
     ...
     * </p>
     * 
     * @return The ID of the domain where the asset filter was created.
     */
    ...
    public UpdateAssetFilterResult withEffectiveColumnNames(String... effectiveColumnNames) {
    ...
    public UpdateAssetFilterResult withEffectiveColumnNames(java.util.Collection<String> effectiveColumnNames) {
     ...
     * </p>
     * 
     * @return The error message that is displayed if the action is not completed successfully.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAssetFilterResult == false)
            return false;
        UpdateAssetFilterResult other = (UpdateAssetFilterResult) obj;
    ...
    public UpdateAssetFilterResult clone() {
        try {
            return (UpdateAssetFilterResult) super.clone();
