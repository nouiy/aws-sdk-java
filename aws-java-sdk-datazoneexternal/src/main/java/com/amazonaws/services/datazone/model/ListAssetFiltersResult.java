...
public class ListAssetFiltersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<AssetFilterSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of the <code>ListAssetFilters</code> action.
     */

    public java.util.List<AssetFilterSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<AssetFilterSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<AssetFilterSummary>(items);
    }
    ...
    public ListAssetFiltersResult withItems(AssetFilterSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<AssetFilterSummary>(items.length));
        }
        for (AssetFilterSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListAssetFiltersResult withItems(java.util.Collection<AssetFilterSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public ListAssetFiltersResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAssetFiltersResult == false)
            return false;
        ListAssetFiltersResult other = (ListAssetFiltersResult) obj;
    ...
    public ListAssetFiltersResult clone() {
        try {
            return (ListAssetFiltersResult) super.clone();
