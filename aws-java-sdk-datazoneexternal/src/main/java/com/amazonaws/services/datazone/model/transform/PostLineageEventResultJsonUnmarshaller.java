...
/**
 * PostLineageEventResult JSON Unmarshaller
 */
...
public class PostLineageEventResultJsonUnmarshaller implements Unmarshaller<PostLineageEventResult, JsonUnmarshallerContext> {
    ...
    public PostLineageEventResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PostLineageEventResult postLineageEventResult = new PostLineageEventResult();

        return postLineageEventResult;
    }
