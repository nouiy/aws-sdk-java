...
/**
 * DeleteAssetFilterResult JSON Unmarshaller
 */
...
public class DeleteAssetFilterResultJsonUnmarshaller implements Unmarshaller<DeleteAssetFilterResult, JsonUnmarshallerContext> {
    ...
    public DeleteAssetFilterResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAssetFilterResult deleteAssetFilterResult = new DeleteAssetFilterResult();

        return deleteAssetFilterResult;
    }
