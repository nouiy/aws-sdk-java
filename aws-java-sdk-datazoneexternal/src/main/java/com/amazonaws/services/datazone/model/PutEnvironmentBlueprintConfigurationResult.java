...
public class PutEnvironmentBlueprintConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The timestamp of when the environment blueprint was created.
     */
    ...
    public PutEnvironmentBlueprintConfigurationResult withCreatedAt(java.util.Date createdAt) {
    ...
    public PutEnvironmentBlueprintConfigurationResult withEnabledRegions(String... enabledRegions) {
    ...
    public PutEnvironmentBlueprintConfigurationResult withEnabledRegions(java.util.Collection<String> enabledRegions) {
    ...
    public PutEnvironmentBlueprintConfigurationResult withProvisioningConfigurations(ProvisioningConfiguration... provisioningConfigurations) {
    ...
    public PutEnvironmentBlueprintConfigurationResult withProvisioningConfigurations(java.util.Collection<ProvisioningConfiguration> provisioningConfigurations) {
    ...
    public PutEnvironmentBlueprintConfigurationResult withRegionalParameters(java.util.Map<String, java.util.Map<String, String>> regionalParameters) {
     ...
     *
     * @see PutEnvironmentBlueprintConfigurationResult#withRegionalParameters
     * @returns a reference to this object so that method calls can be chained together.
     */

    public PutEnvironmentBlueprintConfigurationResult addRegionalParametersEntry(String key, java.util.Map<String, String> value) {
    ...
    public PutEnvironmentBlueprintConfigurationResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutEnvironmentBlueprintConfigurationResult == false)
            return false;
        PutEnvironmentBlueprintConfigurationResult other = (PutEnvironmentBlueprintConfigurationResult) obj;
    ...
    public PutEnvironmentBlueprintConfigurationResult clone() {
        try {
            return (PutEnvironmentBlueprintConfigurationResult) super.clone();
