...
public class RowFilterMarshaller {
    ...
    public void marshall(RowFilter rowFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(rowFilter.getAnd(), AND_BINDING);
            protocolMarshaller.marshall(rowFilter.getExpression(), EXPRESSION_BINDING);
            protocolMarshaller.marshall(rowFilter.getOr(), OR_BINDING);
        } catch (Exception e) {
