 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/NotLikeExpression" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NotLikeExpression implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The value that might not be like the expression.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NotLikeExpression == false)
            return false;
    ...
    public NotLikeExpression clone() {
        try {
            return (NotLikeExpression) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.NotLikeExpressionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
