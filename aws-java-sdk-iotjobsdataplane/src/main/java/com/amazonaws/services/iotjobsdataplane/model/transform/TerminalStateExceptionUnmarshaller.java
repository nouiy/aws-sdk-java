...
public class TerminalStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TerminalStateExceptionUnmarshaller instance;

    public static TerminalStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TerminalStateExceptionUnmarshaller();
        return instance;
    }
}
