...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iot-roborunner-2018-05-10/GetDestination" target="_top">AWS API
 *      Documentation</a>
 */
...
public class GetDestinationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetDestinationResult withId(String id) {
        setId(id);
        return this;
    }
    ...
    public GetDestinationResult withSite(String site) {
        setSite(site);
        return this;
    }
    ...
    public GetDestinationResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetDestinationResult withUpdatedAt(java.util.Date updatedAt) {
    ...
    public GetDestinationResult withState(String state) {
        setState(state);
        return this;
    }
    ...
    public GetDestinationResult withState(DestinationState state) {
    ...
    public GetDestinationResult withAdditionalFixedProperties(String additionalFixedProperties) {
