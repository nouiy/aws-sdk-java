...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.iotroborunner.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.iotroborunner.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.iotroborunner.model.ThrottlingException throttlingException = new com.amazonaws.services.iotroborunner.model.ThrottlingException(
                null);
