...
public class UpdateDestinationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateDestinationRequest withId(String id) {
        setId(id);
        return this;
    }
    ...
    public UpdateDestinationRequest withState(String state) {
        setState(state);
        return this;
    }
    ...
    public UpdateDestinationRequest withState(DestinationState state) {
    ...
    public UpdateDestinationRequest withAdditionalFixedProperties(String additionalFixedProperties) {
