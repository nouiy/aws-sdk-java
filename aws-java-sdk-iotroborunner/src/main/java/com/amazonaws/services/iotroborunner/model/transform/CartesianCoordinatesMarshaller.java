...
/**
 * CartesianCoordinatesMarshaller
 */
...
public class CartesianCoordinatesMarshaller {
    ...
    private static final MarshallingInfo<Double> Z_BINDING = MarshallingInfo.builder(MarshallingType.DOUBLE).marshallLocation(MarshallLocation.PAYLOAD)
