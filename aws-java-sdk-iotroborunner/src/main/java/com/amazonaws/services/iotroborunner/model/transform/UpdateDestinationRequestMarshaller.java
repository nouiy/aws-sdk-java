...
public class UpdateDestinationRequestMarshaller {
    ...
    public void marshall(UpdateDestinationRequest updateDestinationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateDestinationRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(updateDestinationRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updateDestinationRequest.getState(), STATE_BINDING);
            protocolMarshaller.marshall(updateDestinationRequest.getAdditionalFixedProperties(), ADDITIONALFIXEDPROPERTIES_BINDING);
        } catch (Exception e) {
