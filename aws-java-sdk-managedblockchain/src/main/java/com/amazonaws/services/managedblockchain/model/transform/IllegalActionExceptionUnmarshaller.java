...
public class IllegalActionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IllegalActionExceptionUnmarshaller instance;

    public static IllegalActionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IllegalActionExceptionUnmarshaller();
        return instance;
    }
}
