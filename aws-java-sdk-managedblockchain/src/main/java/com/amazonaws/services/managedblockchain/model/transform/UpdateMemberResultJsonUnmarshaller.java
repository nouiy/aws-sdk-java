...
/**
 * UpdateMemberResult JSON Unmarshaller
 */
...
public class UpdateMemberResultJsonUnmarshaller implements Unmarshaller<UpdateMemberResult, JsonUnmarshallerContext> {
    ...
    public UpdateMemberResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateMemberResult updateMemberResult = new UpdateMemberResult();
