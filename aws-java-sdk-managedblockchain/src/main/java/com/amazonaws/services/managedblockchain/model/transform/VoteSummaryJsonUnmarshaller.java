...
/**
 * VoteSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VoteSummaryJsonUnmarshaller implements Unmarshaller<VoteSummary, JsonUnmarshallerContext> {

    public VoteSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static VoteSummaryJsonUnmarshaller instance;

    public static VoteSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new VoteSummaryJsonUnmarshaller();
        return instance;
    }
}
