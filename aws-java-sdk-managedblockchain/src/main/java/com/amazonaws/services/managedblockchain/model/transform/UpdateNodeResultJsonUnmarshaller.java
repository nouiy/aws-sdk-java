...
/**
 * UpdateNodeResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateNodeResultJsonUnmarshaller implements Unmarshaller<UpdateNodeResult, JsonUnmarshallerContext> {

    public UpdateNodeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateNodeResult updateNodeResult = new UpdateNodeResult();
