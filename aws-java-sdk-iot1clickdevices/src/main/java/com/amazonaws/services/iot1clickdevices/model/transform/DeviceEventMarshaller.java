...
public class DeviceEventMarshaller {
    ...
    private static final MarshallingInfo<String> STDEVENT_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("stdEvent").build();
    ...
    public void marshall(DeviceEvent deviceEvent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deviceEvent.getDevice(), DEVICE_BINDING);
            protocolMarshaller.marshall(deviceEvent.getStdEvent(), STDEVENT_BINDING);
        } catch (Exception e) {
