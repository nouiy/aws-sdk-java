...
/**
 * InitiateDeviceClaimRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InitiateDeviceClaimRequestMarshaller {
    ...
    private static final InitiateDeviceClaimRequestMarshaller instance = new InitiateDeviceClaimRequestMarshaller();

    public static InitiateDeviceClaimRequestMarshaller getInstance() {
        return instance;
    }
