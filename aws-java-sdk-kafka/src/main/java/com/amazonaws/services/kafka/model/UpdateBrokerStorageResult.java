...
public class UpdateBrokerStorageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateBrokerStorageResult withClusterArn(String clusterArn) {
    ...
    public UpdateBrokerStorageResult withClusterOperationArn(String clusterOperationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateBrokerStorageResult == false)
            return false;
        UpdateBrokerStorageResult other = (UpdateBrokerStorageResult) obj;
    ...
    @Override
    public UpdateBrokerStorageResult clone() {
        try {
