...
public class UpdateSecurityResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSecurityResult withClusterArn(String clusterArn) {
    ...
    public UpdateSecurityResult withClusterOperationArn(String clusterOperationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSecurityResult == false)
            return false;
        UpdateSecurityResult other = (UpdateSecurityResult) obj;
    ...
    @Override
    public UpdateSecurityResult clone() {
        try {
            return (UpdateSecurityResult) super.clone();
