...
public class DeleteClusterRequestMarshaller {
    ...
    public void marshall(DeleteClusterRequest deleteClusterRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteClusterRequest.getClusterArn(), CLUSTERARN_BINDING);
            protocolMarshaller.marshall(deleteClusterRequest.getCurrentVersion(), CURRENTVERSION_BINDING);
        } catch (Exception e) {
