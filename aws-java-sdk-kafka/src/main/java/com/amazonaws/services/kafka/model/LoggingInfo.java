...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kafka-2018-11-14/LoggingInfo" target="_top">AWS API
 *      Documentation</a>
 */
...
public class LoggingInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public String toString() {
        ...
        if (getBrokerLogs() != null)
            sb.append("BrokerLogs: ").append(getBrokerLogs());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getBrokerLogs() == null ^ this.getBrokerLogs() == null)
            return false;
        if (other.getBrokerLogs() != null && other.getBrokerLogs().equals(this.getBrokerLogs()) == false)
            return false;
        return true;
    }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafka.model.transform.LoggingInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
