...
/**
 * ClusterOperationStep JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ClusterOperationStepJsonUnmarshaller implements Unmarshaller<ClusterOperationStep, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("stepInfo", targetDepth)) {
                    context.nextToken();
                    clusterOperationStep.setStepInfo(ClusterOperationStepInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("stepName", targetDepth)) {
                    context.nextToken();
                    clusterOperationStep.setStepName(context.getUnmarshaller(String.class).unmarshall(context));
                }
