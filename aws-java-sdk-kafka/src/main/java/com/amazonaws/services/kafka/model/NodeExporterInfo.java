...
public class NodeExporterInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public NodeExporterInfo clone() {
        try {
            return (NodeExporterInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.kafka.model.transform.NodeExporterInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
