...
/**
 * Firehose JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FirehoseJsonUnmarshaller implements Unmarshaller<Firehose, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("deliveryStream", targetDepth)) {
                    context.nextToken();
                    firehose.setDeliveryStream(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("enabled", targetDepth)) {
                    context.nextToken();
                    firehose.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
