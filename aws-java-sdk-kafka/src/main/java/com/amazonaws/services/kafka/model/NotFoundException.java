...
public class NotFoundException extends com.amazonaws.services.kafka.model.AWSKafkaException {
    ...
    public NotFoundException withInvalidParameter(String invalidParameter) {
