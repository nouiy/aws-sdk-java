...
/**
 * UpdateBrokerCountResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateBrokerCountResultJsonUnmarshaller implements Unmarshaller<UpdateBrokerCountResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("clusterArn", targetDepth)) {
                    context.nextToken();
                    updateBrokerCountResult.setClusterArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("clusterOperationArn", targetDepth)) {
                    context.nextToken();
                    updateBrokerCountResult.setClusterOperationArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
