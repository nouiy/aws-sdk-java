...
/**
 * UpdateSecurityRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UpdateSecurityRequestMarshaller {
    ...
    private static final UpdateSecurityRequestMarshaller instance = new UpdateSecurityRequestMarshaller();

    public static UpdateSecurityRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateSecurityRequest updateSecurityRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateSecurityRequest.getClientAuthentication(), CLIENTAUTHENTICATION_BINDING);
            protocolMarshaller.marshall(updateSecurityRequest.getClusterArn(), CLUSTERARN_BINDING);
            protocolMarshaller.marshall(updateSecurityRequest.getCurrentVersion(), CURRENTVERSION_BINDING);
            protocolMarshaller.marshall(updateSecurityRequest.getEncryptionInfo(), ENCRYPTIONINFO_BINDING);
        } catch (Exception e) {
