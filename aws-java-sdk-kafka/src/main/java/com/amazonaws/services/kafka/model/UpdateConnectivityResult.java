...
public class UpdateConnectivityResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateConnectivityResult withClusterArn(String clusterArn) {
    ...
    public UpdateConnectivityResult withClusterOperationArn(String clusterOperationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConnectivityResult == false)
            return false;
        UpdateConnectivityResult other = (UpdateConnectivityResult) obj;
    ...
    @Override
    public UpdateConnectivityResult clone() {
        try {
            return (UpdateConnectivityResult) super.clone();
