...
public class BadRequestException extends com.amazonaws.services.kafka.model.AWSKafkaException {
    ...
    public BadRequestException withInvalidParameter(String invalidParameter) {
