...
/**
 * OpenMonitoringInfo JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OpenMonitoringInfoJsonUnmarshaller implements Unmarshaller<OpenMonitoringInfo, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("prometheus", targetDepth)) {
                    context.nextToken();
                    openMonitoringInfo.setPrometheus(PrometheusInfoJsonUnmarshaller.getInstance().unmarshall(context));
                }
