...
/**
 * Scram JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ScramJsonUnmarshaller implements Unmarshaller<Scram, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("enabled", targetDepth)) {
                    context.nextToken();
                    scram.setEnabled(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
