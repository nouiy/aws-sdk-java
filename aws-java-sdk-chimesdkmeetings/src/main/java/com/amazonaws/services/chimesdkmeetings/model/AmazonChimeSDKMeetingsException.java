...
public class AmazonChimeSDKMeetingsException extends com.amazonaws.AmazonServiceException {

    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new AmazonChimeSDKMeetingsException with the specified error message.
     *
     * @param message
