...
public class UpdateAttendeeCapabilitiesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAttendeeCapabilitiesResult withAttendee(Attendee attendee) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAttendeeCapabilitiesResult == false)
            return false;
        UpdateAttendeeCapabilitiesResult other = (UpdateAttendeeCapabilitiesResult) obj;
    ...
    @Override
    public UpdateAttendeeCapabilitiesResult clone() {
        try {
            return (UpdateAttendeeCapabilitiesResult) super.clone();
