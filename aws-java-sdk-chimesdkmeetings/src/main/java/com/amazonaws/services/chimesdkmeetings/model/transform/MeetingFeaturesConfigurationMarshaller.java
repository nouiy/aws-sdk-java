...
/**
 * MeetingFeaturesConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MeetingFeaturesConfigurationMarshaller {
    ...
    public static MeetingFeaturesConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MeetingFeaturesConfiguration meetingFeaturesConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (meetingFeaturesConfiguration == null) {
