...
/**
 * DeleteMeetingResult JSON Unmarshaller
 */
...
public class DeleteMeetingResultJsonUnmarshaller implements Unmarshaller<DeleteMeetingResult, JsonUnmarshallerContext> {
    ...
    public DeleteMeetingResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMeetingResult deleteMeetingResult = new DeleteMeetingResult();
