...
@SdkInternalApi
public class UpdateVodSourceRequestMarshaller {
    ...
    private static final UpdateVodSourceRequestMarshaller instance = new UpdateVodSourceRequestMarshaller();

    public static UpdateVodSourceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateVodSourceRequest updateVodSourceRequest, ProtocolMarshaller protocolMarshaller) {

        if (updateVodSourceRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(updateVodSourceRequest.getHttpPackageConfigurations(), HTTPPACKAGECONFIGURATIONS_BINDING);
            protocolMarshaller.marshall(updateVodSourceRequest.getSourceLocationName(), SOURCELOCATIONNAME_BINDING);
            protocolMarshaller.marshall(updateVodSourceRequest.getVodSourceName(), VODSOURCENAME_BINDING);
        } catch (Exception e) {
