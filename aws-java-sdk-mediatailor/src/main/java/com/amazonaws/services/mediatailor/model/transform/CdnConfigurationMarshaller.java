...
/**
 * CdnConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CdnConfigurationMarshaller {

    private static final MarshallingInfo<String> ADSEGMENTURLPREFIX_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AdSegmentUrlPrefix").build();
    private static final MarshallingInfo<String> CONTENTSEGMENTURLPREFIX_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ContentSegmentUrlPrefix").build();
