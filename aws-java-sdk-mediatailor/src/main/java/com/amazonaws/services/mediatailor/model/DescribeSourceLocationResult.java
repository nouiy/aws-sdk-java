...
public class DescribeSourceLocationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeSourceLocationResult withCreationTime(java.util.Date creationTime) {
    ...
    public DescribeSourceLocationResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public DescribeSourceLocationResult withSegmentDeliveryConfigurations(SegmentDeliveryConfiguration... segmentDeliveryConfigurations) {
    ...
    public DescribeSourceLocationResult withSegmentDeliveryConfigurations(java.util.Collection<SegmentDeliveryConfiguration> segmentDeliveryConfigurations) {
    ...
    public DescribeSourceLocationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeSourceLocationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DescribeSourceLocationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSourceLocationResult == false)
            return false;
        DescribeSourceLocationResult other = (DescribeSourceLocationResult) obj;
    ...
    public DescribeSourceLocationResult clone() {
        try {
            return (DescribeSourceLocationResult) super.clone();
