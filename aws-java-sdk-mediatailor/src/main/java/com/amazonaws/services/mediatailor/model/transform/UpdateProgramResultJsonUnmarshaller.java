...
/**
 * UpdateProgramResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateProgramResultJsonUnmarshaller implements Unmarshaller<UpdateProgramResult, JsonUnmarshallerContext> {

    public UpdateProgramResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateProgramResult updateProgramResult = new UpdateProgramResult();
    ...
    private static UpdateProgramResultJsonUnmarshaller instance;

    public static UpdateProgramResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new UpdateProgramResultJsonUnmarshaller();
        return instance;
    }
}
