...
/**
 * Transition JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransitionJsonUnmarshaller implements Unmarshaller<Transition, JsonUnmarshallerContext> {

    public Transition unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("RelativeProgram", targetDepth)) {
                    context.nextToken();
    ...
    private static TransitionJsonUnmarshaller instance;

    public static TransitionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TransitionJsonUnmarshaller();
        return instance;
    }
}
