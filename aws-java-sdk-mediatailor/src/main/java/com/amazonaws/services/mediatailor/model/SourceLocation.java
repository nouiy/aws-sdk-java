...
public class SourceLocation implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The ARN of the SourceLocation.
     */
    ...
    public SourceLocation withCreationTime(java.util.Date creationTime) {
     ...
     * </p>
     * 
     * @return The default segment delivery configuration.
     */
    ...
    public SourceLocation withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public SourceLocation withSegmentDeliveryConfigurations(SegmentDeliveryConfiguration... segmentDeliveryConfigurations) {
    ...
    public SourceLocation withSegmentDeliveryConfigurations(java.util.Collection<SegmentDeliveryConfiguration> segmentDeliveryConfigurations) {
    ...
    public SourceLocation withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see SourceLocation#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public SourceLocation addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SourceLocation == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediatailor.model.transform.SourceLocationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
