...
public class ListTLSInspectionConfigurationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListTLSInspectionConfigurationsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTLSInspectionConfigurationsRequest == false)
            return false;
        ListTLSInspectionConfigurationsRequest other = (ListTLSInspectionConfigurationsRequest) obj;
    ...
    public ListTLSInspectionConfigurationsRequest clone() {
        return (ListTLSInspectionConfigurationsRequest) super.clone();
    }
