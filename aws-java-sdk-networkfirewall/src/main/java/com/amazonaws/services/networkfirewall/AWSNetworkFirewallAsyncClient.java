...
public class AWSNetworkFirewallAsyncClient extends AWSNetworkFirewallClient implements AWSNetworkFirewallAsync {
    ...
    public java.util.concurrent.Future<UpdateFirewallEncryptionConfigurationResult> updateFirewallEncryptionConfigurationAsync(
            ...
            final com.amazonaws.handlers.AsyncHandler<UpdateFirewallEncryptionConfigurationRequest, UpdateFirewallEncryptionConfigurationResult> asyncHandler) {
        final UpdateFirewallEncryptionConfigurationRequest finalRequest = beforeClientExecution(request);

        return executorService.submit(new java.util.concurrent.Callable<UpdateFirewallEncryptionConfigurationResult>() {
            @Override
