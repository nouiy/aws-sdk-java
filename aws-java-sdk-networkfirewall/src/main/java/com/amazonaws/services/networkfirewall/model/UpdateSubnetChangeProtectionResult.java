...
public class UpdateSubnetChangeProtectionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSubnetChangeProtectionResult withUpdateToken(String updateToken) {
    ...
    public UpdateSubnetChangeProtectionResult withFirewallArn(String firewallArn) {
    ...
    public UpdateSubnetChangeProtectionResult withFirewallName(String firewallName) {
    ...
    public UpdateSubnetChangeProtectionResult withSubnetChangeProtection(Boolean subnetChangeProtection) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSubnetChangeProtectionResult == false)
            return false;
        UpdateSubnetChangeProtectionResult other = (UpdateSubnetChangeProtectionResult) obj;
    ...
    @Override
    public UpdateSubnetChangeProtectionResult clone() {
        try {
