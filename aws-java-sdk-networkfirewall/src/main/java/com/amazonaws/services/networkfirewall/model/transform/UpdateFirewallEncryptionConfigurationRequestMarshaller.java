...
public class UpdateFirewallEncryptionConfigurationRequestMarshaller {
    ...
    private static final UpdateFirewallEncryptionConfigurationRequestMarshaller instance = new UpdateFirewallEncryptionConfigurationRequestMarshaller();

    public static UpdateFirewallEncryptionConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateFirewallEncryptionConfigurationRequest updateFirewallEncryptionConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updateFirewallEncryptionConfigurationRequest.getUpdateToken(), UPDATETOKEN_BINDING);
            protocolMarshaller.marshall(updateFirewallEncryptionConfigurationRequest.getFirewallArn(), FIREWALLARN_BINDING);
            protocolMarshaller.marshall(updateFirewallEncryptionConfigurationRequest.getFirewallName(), FIREWALLNAME_BINDING);
            protocolMarshaller.marshall(updateFirewallEncryptionConfigurationRequest.getEncryptionConfiguration(), ENCRYPTIONCONFIGURATION_BINDING);
        } catch (Exception e) {
