...
public class AssociateSubnetsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateSubnetsResult withSubnetMappings(SubnetMapping... subnetMappings) {
    ...
    public AssociateSubnetsResult withSubnetMappings(java.util.Collection<SubnetMapping> subnetMappings) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateSubnetsResult == false)
            return false;
        AssociateSubnetsResult other = (AssociateSubnetsResult) obj;
    ...
    public AssociateSubnetsResult clone() {
        try {
            return (AssociateSubnetsResult) super.clone();
