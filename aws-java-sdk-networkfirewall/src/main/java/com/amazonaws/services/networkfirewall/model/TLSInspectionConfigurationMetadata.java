 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/network-firewall-2020-11-12/TLSInspectionConfigurationMetadata"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TLSInspectionConfigurationMetadata implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TLSInspectionConfigurationMetadata == false)
            return false;
        TLSInspectionConfigurationMetadata other = (TLSInspectionConfigurationMetadata) obj;
    ...
    public TLSInspectionConfigurationMetadata clone() {
        try {
            return (TLSInspectionConfigurationMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.networkfirewall.model.transform.TLSInspectionConfigurationMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
