...
/**
 * CreateRuleGroupResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateRuleGroupResultJsonUnmarshaller implements Unmarshaller<CreateRuleGroupResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("UpdateToken", targetDepth)) {
                    context.nextToken();
                    createRuleGroupResult.setUpdateToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RuleGroupResponse", targetDepth)) {
                    context.nextToken();
                    createRuleGroupResult.setRuleGroupResponse(RuleGroupResponseJsonUnmarshaller.getInstance().unmarshall(context));
                }
