...
/**
 * ListCreateAccountStatusResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListCreateAccountStatusResultJsonUnmarshaller implements Unmarshaller<ListCreateAccountStatusResult, JsonUnmarshallerContext> {

    public ListCreateAccountStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("NextToken", targetDepth)) {
                    context.nextToken();
                    listCreateAccountStatusResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
