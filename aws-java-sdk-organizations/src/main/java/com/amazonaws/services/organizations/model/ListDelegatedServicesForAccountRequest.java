...
public class ListDelegatedServicesForAccountRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDelegatedServicesForAccountRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDelegatedServicesForAccountRequest == false)
            return false;
        ListDelegatedServicesForAccountRequest other = (ListDelegatedServicesForAccountRequest) obj;
    ...
    @Override
    public ListDelegatedServicesForAccountRequest clone() {
        return (ListDelegatedServicesForAccountRequest) super.clone();
    }
