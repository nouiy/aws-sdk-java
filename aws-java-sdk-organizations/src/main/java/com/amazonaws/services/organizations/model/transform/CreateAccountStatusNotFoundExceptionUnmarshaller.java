...
public class CreateAccountStatusNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static CreateAccountStatusNotFoundExceptionUnmarshaller instance;

    public static CreateAccountStatusNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new CreateAccountStatusNotFoundExceptionUnmarshaller();
        return instance;
    }
}
