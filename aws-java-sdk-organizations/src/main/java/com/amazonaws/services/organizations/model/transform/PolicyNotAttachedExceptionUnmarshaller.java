...
public class PolicyNotAttachedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PolicyNotAttachedExceptionUnmarshaller instance;

    public static PolicyNotAttachedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyNotAttachedExceptionUnmarshaller();
        return instance;
    }
}
