...
/**
 * DescribeOrganizationalUnitRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribeOrganizationalUnitRequestMarshaller {
    ...
    private static final DescribeOrganizationalUnitRequestMarshaller instance = new DescribeOrganizationalUnitRequestMarshaller();

    public static DescribeOrganizationalUnitRequestMarshaller getInstance() {
        return instance;
    }
