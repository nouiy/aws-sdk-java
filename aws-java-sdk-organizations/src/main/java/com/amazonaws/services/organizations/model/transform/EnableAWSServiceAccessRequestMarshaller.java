...
/**
 * EnableAWSServiceAccessRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EnableAWSServiceAccessRequestMarshaller {
    ...
    private static final EnableAWSServiceAccessRequestMarshaller instance = new EnableAWSServiceAccessRequestMarshaller();

    public static EnableAWSServiceAccessRequestMarshaller getInstance() {
        return instance;
    }
