...
public class ListHandshakesForAccountResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListHandshakesForAccountResult withHandshakes(Handshake... handshakes) {
    ...
    public ListHandshakesForAccountResult withHandshakes(java.util.Collection<Handshake> handshakes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListHandshakesForAccountResult == false)
            return false;
        ListHandshakesForAccountResult other = (ListHandshakesForAccountResult) obj;
    ...
    public ListHandshakesForAccountResult clone() {
        try {
            return (ListHandshakesForAccountResult) super.clone();
