...
public class InvalidHandshakeTransitionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidHandshakeTransitionExceptionUnmarshaller instance;

    public static InvalidHandshakeTransitionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidHandshakeTransitionExceptionUnmarshaller();
        return instance;
    }
}
