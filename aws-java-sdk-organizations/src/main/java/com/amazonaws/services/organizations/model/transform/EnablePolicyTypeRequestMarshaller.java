...
/**
 * EnablePolicyTypeRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class EnablePolicyTypeRequestMarshaller {
    ...
    private static final EnablePolicyTypeRequestMarshaller instance = new EnablePolicyTypeRequestMarshaller();

    public static EnablePolicyTypeRequestMarshaller getInstance() {
        return instance;
    }
