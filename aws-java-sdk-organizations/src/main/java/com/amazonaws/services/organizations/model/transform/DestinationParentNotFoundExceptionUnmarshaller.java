...
public class DestinationParentNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DestinationParentNotFoundExceptionUnmarshaller instance;

    public static DestinationParentNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DestinationParentNotFoundExceptionUnmarshaller();
        return instance;
    }
}
