...
/**
 * DescribeHandshakeResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeHandshakeResultJsonUnmarshaller implements Unmarshaller<DescribeHandshakeResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Handshake", targetDepth)) {
                    context.nextToken();
                    describeHandshakeResult.setHandshake(HandshakeJsonUnmarshaller.getInstance().unmarshall(context));
                }
