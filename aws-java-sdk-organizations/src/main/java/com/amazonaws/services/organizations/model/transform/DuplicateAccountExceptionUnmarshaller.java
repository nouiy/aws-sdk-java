...
public class DuplicateAccountExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicateAccountExceptionUnmarshaller instance;

    public static DuplicateAccountExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateAccountExceptionUnmarshaller();
        return instance;
    }
}
