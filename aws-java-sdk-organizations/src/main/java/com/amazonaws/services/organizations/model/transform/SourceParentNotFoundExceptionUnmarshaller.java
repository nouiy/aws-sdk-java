...
public class SourceParentNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static SourceParentNotFoundExceptionUnmarshaller instance;

    public static SourceParentNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new SourceParentNotFoundExceptionUnmarshaller();
        return instance;
    }
}
