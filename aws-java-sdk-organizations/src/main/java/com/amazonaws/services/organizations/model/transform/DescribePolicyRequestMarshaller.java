...
/**
 * DescribePolicyRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DescribePolicyRequestMarshaller {
    ...
    private static final DescribePolicyRequestMarshaller instance = new DescribePolicyRequestMarshaller();

    public static DescribePolicyRequestMarshaller getInstance() {
        return instance;
    }
