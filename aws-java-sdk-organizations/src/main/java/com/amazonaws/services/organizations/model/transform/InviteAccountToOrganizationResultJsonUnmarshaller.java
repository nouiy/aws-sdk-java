...
/**
 * InviteAccountToOrganizationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InviteAccountToOrganizationResultJsonUnmarshaller implements Unmarshaller<InviteAccountToOrganizationResult, JsonUnmarshallerContext> {

    public InviteAccountToOrganizationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Handshake", targetDepth)) {
                    context.nextToken();
                    inviteAccountToOrganizationResult.setHandshake(HandshakeJsonUnmarshaller.getInstance().unmarshall(context));
                }
