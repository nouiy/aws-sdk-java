...
/**
 * ListHandshakesForAccountRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListHandshakesForAccountRequestMarshaller {
    ...
    private static final ListHandshakesForAccountRequestMarshaller instance = new ListHandshakesForAccountRequestMarshaller();

    public static ListHandshakesForAccountRequestMarshaller getInstance() {
        return instance;
    }
