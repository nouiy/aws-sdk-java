...
public class PolicyTypeNotEnabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PolicyTypeNotEnabledExceptionUnmarshaller instance;

    public static PolicyTypeNotEnabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PolicyTypeNotEnabledExceptionUnmarshaller();
        return instance;
    }
}
