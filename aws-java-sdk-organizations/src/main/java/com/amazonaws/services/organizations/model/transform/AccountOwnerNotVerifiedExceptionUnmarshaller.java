...
public class AccountOwnerNotVerifiedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AccountOwnerNotVerifiedExceptionUnmarshaller instance;

    public static AccountOwnerNotVerifiedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountOwnerNotVerifiedExceptionUnmarshaller();
        return instance;
    }
}
