...
public class UnsupportedAPIEndpointExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static UnsupportedAPIEndpointExceptionUnmarshaller instance;

    public static UnsupportedAPIEndpointExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsupportedAPIEndpointExceptionUnmarshaller();
        return instance;
    }
}
