...
public class HandshakeAlreadyInStateExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static HandshakeAlreadyInStateExceptionUnmarshaller instance;

    public static HandshakeAlreadyInStateExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new HandshakeAlreadyInStateExceptionUnmarshaller();
        return instance;
    }
}
