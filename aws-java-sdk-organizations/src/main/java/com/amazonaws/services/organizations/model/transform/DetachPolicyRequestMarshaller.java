...
public class DetachPolicyRequestMarshaller {
    ...
    public void marshall(DetachPolicyRequest detachPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(detachPolicyRequest.getPolicyId(), POLICYID_BINDING);
            protocolMarshaller.marshall(detachPolicyRequest.getTargetId(), TARGETID_BINDING);
        } catch (Exception e) {
