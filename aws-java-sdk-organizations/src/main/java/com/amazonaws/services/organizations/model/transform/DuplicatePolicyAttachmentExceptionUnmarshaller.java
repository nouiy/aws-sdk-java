...
public class DuplicatePolicyAttachmentExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicatePolicyAttachmentExceptionUnmarshaller instance;

    public static DuplicatePolicyAttachmentExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicatePolicyAttachmentExceptionUnmarshaller();
        return instance;
    }
}
