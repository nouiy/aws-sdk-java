...
/**
 * MoveAccountResult JSON Unmarshaller
 */
...
public class MoveAccountResultJsonUnmarshaller implements Unmarshaller<MoveAccountResult, JsonUnmarshallerContext> {
    ...
    public MoveAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        MoveAccountResult moveAccountResult = new MoveAccountResult();

        return moveAccountResult;
    }
