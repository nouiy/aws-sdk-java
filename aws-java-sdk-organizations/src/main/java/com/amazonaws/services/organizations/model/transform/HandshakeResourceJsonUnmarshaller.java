...
/**
 * HandshakeResource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HandshakeResourceJsonUnmarshaller implements Unmarshaller<HandshakeResource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    handshakeResource.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Type", targetDepth)) {
                    context.nextToken();
                    handshakeResource.setType(context.getUnmarshaller(String.class).unmarshall(context));
                }
