...
public class AlreadyInOrganizationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AlreadyInOrganizationExceptionUnmarshaller instance;

    public static AlreadyInOrganizationExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AlreadyInOrganizationExceptionUnmarshaller();
        return instance;
    }
}
