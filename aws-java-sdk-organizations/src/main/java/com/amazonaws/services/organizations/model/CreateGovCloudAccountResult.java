...
public class CreateGovCloudAccountResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateGovCloudAccountResult withCreateAccountStatus(CreateAccountStatus createAccountStatus) {
    ...
    @Override
    public CreateGovCloudAccountResult clone() {
        try {
            return (CreateGovCloudAccountResult) super.clone();
