...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/organizations-2016-11-28/DescribeHandshake" target="_top">AWS
 *      API Documentation</a>
 */
...
public class DescribeHandshakeRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The unique identifier (ID) of the handshake that you want information about. You can get the ID from the original
     * call to <a>InviteAccountToOrganization</a>, or from a call to <a>ListHandshakesForAccount</a> or
     ...
     * 
     * @param handshakeId
     *        The unique identifier (ID) of the handshake that you want information about. You can get the ID from the
     *        original call to <a>InviteAccountToOrganization</a>, or from a call to <a>ListHandshakesForAccount</a> or
     *        <a>ListHandshakesForOrganization</a>.</p>
     *        <p>
     ...
     * </p>
     * 
     * @return The unique identifier (ID) of the handshake that you want information about. You can get the ID from the
     *         original call to <a>InviteAccountToOrganization</a>, or from a call to <a>ListHandshakesForAccount</a> or
     *         <a>ListHandshakesForOrganization</a>.</p>
     *         <p>
     *         The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> for handshake ID string requires "h-"
    ...
    @Override
    public DescribeHandshakeRequest clone() {
        return (DescribeHandshakeRequest) super.clone();
    }
