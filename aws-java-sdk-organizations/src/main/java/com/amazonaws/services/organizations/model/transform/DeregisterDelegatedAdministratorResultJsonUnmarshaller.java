...
/**
 * DeregisterDelegatedAdministratorResult JSON Unmarshaller
 */
...
public class DeregisterDelegatedAdministratorResultJsonUnmarshaller implements Unmarshaller<DeregisterDelegatedAdministratorResult, JsonUnmarshallerContext> {
    ...
    public DeregisterDelegatedAdministratorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterDelegatedAdministratorResult deregisterDelegatedAdministratorResult = new DeregisterDelegatedAdministratorResult();

        return deregisterDelegatedAdministratorResult;
    }
