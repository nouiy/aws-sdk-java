...
public class DuplicateOrganizationalUnitExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicateOrganizationalUnitExceptionUnmarshaller instance;

    public static DuplicateOrganizationalUnitExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateOrganizationalUnitExceptionUnmarshaller();
        return instance;
    }
}
