...
/**
 * DataflowDetailMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DataflowDetailMarshaller {
    ...
    private static final DataflowDetailMarshaller instance = new DataflowDetailMarshaller();

    public static DataflowDetailMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DataflowDetail dataflowDetail, ProtocolMarshaller protocolMarshaller) {

        if (dataflowDetail == null) {
