...
public class GetDataflowEndpointGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetDataflowEndpointGroupRequest withDataflowEndpointGroupId(String dataflowEndpointGroupId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDataflowEndpointGroupRequest == false)
            return false;
    ...
    @Override
    public GetDataflowEndpointGroupRequest clone() {
        return (GetDataflowEndpointGroupRequest) super.clone();
    }
