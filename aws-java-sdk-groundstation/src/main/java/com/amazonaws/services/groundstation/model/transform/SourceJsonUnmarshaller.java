        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("configDetails", targetDepth)) {
                    context.nextToken();
                    source.setConfigDetails(ConfigDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("configId", targetDepth)) {
                    context.nextToken();
                    source.setConfigId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("configType", targetDepth)) {
                    context.nextToken();
                    source.setConfigType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("dataflowSourceRegion", targetDepth)) {
                    context.nextToken();
                    source.setDataflowSourceRegion(context.getUnmarshaller(String.class).unmarshall(context));
                }
