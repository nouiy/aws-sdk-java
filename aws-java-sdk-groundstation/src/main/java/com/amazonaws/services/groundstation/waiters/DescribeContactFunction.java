...
public class DescribeContactFunction implements SdkFunction<DescribeContactRequest, DescribeContactResult> {
    ...
    /**
     * Constructs a new DescribeContactFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public DescribeContactFunction(AWSGroundStation client) {
        this.client = client;
    }
    ...
    public DescribeContactResult apply(DescribeContactRequest describeContactRequest) {
        return client.describeContact(describeContactRequest);
    }
}
