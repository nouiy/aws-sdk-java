...
public class DeleteDataflowEndpointGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteDataflowEndpointGroupResult withDataflowEndpointGroupId(String dataflowEndpointGroupId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDataflowEndpointGroupResult == false)
            return false;
        DeleteDataflowEndpointGroupResult other = (DeleteDataflowEndpointGroupResult) obj;
    ...
    @Override
    public DeleteDataflowEndpointGroupResult clone() {
        try {
            return (DeleteDataflowEndpointGroupResult) super.clone();
