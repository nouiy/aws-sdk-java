        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("componentType", targetDepth)) {
                    context.nextToken();
                    componentVersion.setComponentType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("versions", targetDepth)) {
                    context.nextToken();
                    componentVersion.setVersions(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
