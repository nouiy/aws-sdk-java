...
public class ReserveContactResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReserveContactResult == false)
            return false;
        ReserveContactResult other = (ReserveContactResult) obj;
    ...
    public ReserveContactResult clone() {
        try {
            return (ReserveContactResult) super.clone();
