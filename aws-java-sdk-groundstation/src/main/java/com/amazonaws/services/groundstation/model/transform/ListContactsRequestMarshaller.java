...
public class ListContactsRequestMarshaller {
    ...
    public void marshall(ListContactsRequest listContactsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listContactsRequest.getEndTime(), ENDTIME_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getGroundStation(), GROUNDSTATION_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getMissionProfileArn(), MISSIONPROFILEARN_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getNextToken(), NEXTTOKEN_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getSatelliteArn(), SATELLITEARN_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(listContactsRequest.getStatusList(), STATUSLIST_BINDING);
        } catch (Exception e) {
