...
public class UpdateMissionProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateMissionProfileResult withMissionProfileId(String missionProfileId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMissionProfileResult == false)
            return false;
        UpdateMissionProfileResult other = (UpdateMissionProfileResult) obj;
    ...
    @Override
    public UpdateMissionProfileResult clone() {
        try {
            return (UpdateMissionProfileResult) super.clone();
