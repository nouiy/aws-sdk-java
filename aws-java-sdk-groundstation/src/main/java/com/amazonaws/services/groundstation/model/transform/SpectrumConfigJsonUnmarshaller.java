...
/**
 * SpectrumConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpectrumConfigJsonUnmarshaller implements Unmarshaller<SpectrumConfig, JsonUnmarshallerContext> {

    public SpectrumConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SpectrumConfigJsonUnmarshaller instance;

    public static SpectrumConfigJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SpectrumConfigJsonUnmarshaller();
        return instance;
    }
}
