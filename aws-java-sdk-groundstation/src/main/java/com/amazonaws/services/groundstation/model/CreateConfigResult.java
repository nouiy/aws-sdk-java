...
public class CreateConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateConfigResult withConfigArn(String configArn) {
    ...
    public CreateConfigResult withConfigId(String configId) {
    ...
    public CreateConfigResult withConfigType(String configType) {
    ...
    public CreateConfigResult withConfigType(ConfigCapabilityType configType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateConfigResult == false)
            return false;
        CreateConfigResult other = (CreateConfigResult) obj;
    ...
    @Override
    public CreateConfigResult clone() {
        try {
            return (CreateConfigResult) super.clone();
