...
public class UpdateConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateConfigResult withConfigArn(String configArn) {
    ...
    public UpdateConfigResult withConfigId(String configId) {
    ...
    public UpdateConfigResult withConfigType(String configType) {
    ...
    public UpdateConfigResult withConfigType(ConfigCapabilityType configType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfigResult == false)
            return false;
        UpdateConfigResult other = (UpdateConfigResult) obj;
    ...
    @Override
    public UpdateConfigResult clone() {
        try {
            return (UpdateConfigResult) super.clone();
