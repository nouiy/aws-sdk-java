...
/**
 * TestHypervisorConfigurationResult JSON Unmarshaller
 */
...
public class TestHypervisorConfigurationResultJsonUnmarshaller implements Unmarshaller<TestHypervisorConfigurationResult, JsonUnmarshallerContext> {
    ...
    public TestHypervisorConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        TestHypervisorConfigurationResult testHypervisorConfigurationResult = new TestHypervisorConfigurationResult();
