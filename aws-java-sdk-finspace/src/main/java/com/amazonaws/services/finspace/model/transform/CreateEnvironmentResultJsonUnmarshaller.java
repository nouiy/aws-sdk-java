        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("environmentArn", targetDepth)) {
                    context.nextToken();
                    createEnvironmentResult.setEnvironmentArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("environmentUrl", targetDepth)) {
                    context.nextToken();
                    createEnvironmentResult.setEnvironmentUrl(context.getUnmarshaller(String.class).unmarshall(context));
                }
