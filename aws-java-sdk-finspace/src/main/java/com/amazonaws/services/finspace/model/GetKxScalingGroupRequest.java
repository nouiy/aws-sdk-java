...
public class GetKxScalingGroupRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetKxScalingGroupRequest withEnvironmentId(String environmentId) {
    ...
    public GetKxScalingGroupRequest withScalingGroupName(String scalingGroupName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetKxScalingGroupRequest == false)
            return false;
        GetKxScalingGroupRequest other = (GetKxScalingGroupRequest) obj;
    ...
    @Override
    public GetKxScalingGroupRequest clone() {
