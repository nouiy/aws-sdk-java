...
public class GetKxVolumeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetKxVolumeResult withAvailabilityZoneIds(java.util.Collection<String> availabilityZoneIds) {
    ...
    public GetKxVolumeResult withAttachedClusters(java.util.Collection<KxAttachedCluster> attachedClusters) {
