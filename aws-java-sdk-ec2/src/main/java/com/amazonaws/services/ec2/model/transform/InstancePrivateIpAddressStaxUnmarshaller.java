...
public class InstancePrivateIpAddressStaxUnmarshaller implements Unmarshaller<InstancePrivateIpAddress, StaxUnmarshallerContext> {
    ...
    public InstancePrivateIpAddress unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("primary", targetDepth)) {
                    instancePrivateIpAddress.setPrimary(BooleanStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
    ...
    public static InstancePrivateIpAddressStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new InstancePrivateIpAddressStaxUnmarshaller();
        return instance;
    }
}
