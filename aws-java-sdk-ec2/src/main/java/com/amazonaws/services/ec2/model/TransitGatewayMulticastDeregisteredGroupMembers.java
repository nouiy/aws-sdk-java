 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TransitGatewayMulticastDeregisteredGroupMembers"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransitGatewayMulticastDeregisteredGroupMembers implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The network interface IDs of the deregistered members.
     */
    ...
    public TransitGatewayMulticastDeregisteredGroupMembers withDeregisteredNetworkInterfaceIds(String... deregisteredNetworkInterfaceIds) {
    ...
    public TransitGatewayMulticastDeregisteredGroupMembers withDeregisteredNetworkInterfaceIds(java.util.Collection<String> deregisteredNetworkInterfaceIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TransitGatewayMulticastDeregisteredGroupMembers == false)
            return false;
        TransitGatewayMulticastDeregisteredGroupMembers other = (TransitGatewayMulticastDeregisteredGroupMembers) obj;
    ...
    public TransitGatewayMulticastDeregisteredGroupMembers clone() {
        try {
            return (TransitGatewayMulticastDeregisteredGroupMembers) super.clone();
