...
import com.amazonaws.services.ec2.model.transform.GetTransitGatewayPrefixListReferencesRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetTransitGatewayPrefixListReferencesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<GetTransitGatewayPrefixListReferencesRequest> {
     ...
     * <li>
     * <p>
     * <code>is-blackhole</code> - Whether traffic matching the route is blocked (<code>true</code> | <code>false</code>
     * ).
     * </p>
     * </li>
     * <li>
     ...
     * <li>
     * <p>
     * <code>state</code> - The state of the prefix list reference (<code>pending</code> | <code>available</code> |
    ...
    public GetTransitGatewayPrefixListReferencesRequest withFilters(Filter... filters) {
    ...
    public GetTransitGatewayPrefixListReferencesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public GetTransitGatewayPrefixListReferencesRequest withMaxResults(Integer maxResults) {
     ...
     */
    @Override
    public Request<GetTransitGatewayPrefixListReferencesRequest> getDryRunRequest() {
        Request<GetTransitGatewayPrefixListReferencesRequest> request = new GetTransitGatewayPrefixListReferencesRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTransitGatewayPrefixListReferencesRequest == false)
            return false;
        GetTransitGatewayPrefixListReferencesRequest other = (GetTransitGatewayPrefixListReferencesRequest) obj;
    ...
    @Override
    public GetTransitGatewayPrefixListReferencesRequest clone() {
        return (GetTransitGatewayPrefixListReferencesRequest) super.clone();
    }
}
