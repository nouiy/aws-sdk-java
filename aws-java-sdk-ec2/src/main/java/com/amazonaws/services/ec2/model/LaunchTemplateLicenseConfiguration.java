 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateLicenseConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LaunchTemplateLicenseConfiguration implements Serializable, Cloneable {
    ...
    public LaunchTemplateLicenseConfiguration withLicenseConfigurationArn(String licenseConfigurationArn) {
    ...
    @Override
    public LaunchTemplateLicenseConfiguration clone() {
        try {
            return (LaunchTemplateLicenseConfiguration) super.clone();
