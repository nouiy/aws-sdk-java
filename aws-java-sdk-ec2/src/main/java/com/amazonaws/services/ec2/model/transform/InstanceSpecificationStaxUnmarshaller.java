...
/**
 * InstanceSpecification StAX Unmarshaller
 */
...
public class InstanceSpecificationStaxUnmarshaller implements Unmarshaller<InstanceSpecification, StaxUnmarshallerContext> {
    ...
    public InstanceSpecification unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("InstanceId", targetDepth)) {
                    instanceSpecification.setInstanceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
