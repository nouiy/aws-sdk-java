...
public class RestoreManagedPrefixListVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RestoreManagedPrefixListVersionResult == false)
            return false;
        RestoreManagedPrefixListVersionResult other = (RestoreManagedPrefixListVersionResult) obj;
    ...
    @Override
    public RestoreManagedPrefixListVersionResult clone() {
        try {
            return (RestoreManagedPrefixListVersionResult) super.clone();
