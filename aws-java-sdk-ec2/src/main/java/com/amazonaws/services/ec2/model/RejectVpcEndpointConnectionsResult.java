...
public class RejectVpcEndpointConnectionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the endpoints that were not rejected, if applicable.
     */
    ...
    public RejectVpcEndpointConnectionsResult withUnsuccessful(UnsuccessfulItem... unsuccessful) {
    ...
    public RejectVpcEndpointConnectionsResult withUnsuccessful(java.util.Collection<UnsuccessfulItem> unsuccessful) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectVpcEndpointConnectionsResult == false)
            return false;
        RejectVpcEndpointConnectionsResult other = (RejectVpcEndpointConnectionsResult) obj;
    ...
    public RejectVpcEndpointConnectionsResult clone() {
        try {
            return (RejectVpcEndpointConnectionsResult) super.clone();
