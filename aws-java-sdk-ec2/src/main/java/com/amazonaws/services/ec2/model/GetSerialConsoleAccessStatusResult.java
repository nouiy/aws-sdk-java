...
public class GetSerialConsoleAccessStatusResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSerialConsoleAccessStatusResult == false)
            return false;
        GetSerialConsoleAccessStatusResult other = (GetSerialConsoleAccessStatusResult) obj;
    ...
    @Override
    public GetSerialConsoleAccessStatusResult clone() {
        try {
            return (GetSerialConsoleAccessStatusResult) super.clone();
