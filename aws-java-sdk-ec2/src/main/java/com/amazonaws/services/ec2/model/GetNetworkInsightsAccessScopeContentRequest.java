...
public class GetNetworkInsightsAccessScopeContentRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<GetNetworkInsightsAccessScopeContentRequest> {
    ...
    public Request<GetNetworkInsightsAccessScopeContentRequest> getDryRunRequest() {
        Request<GetNetworkInsightsAccessScopeContentRequest> request = new GetNetworkInsightsAccessScopeContentRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetNetworkInsightsAccessScopeContentRequest == false)
            return false;
        GetNetworkInsightsAccessScopeContentRequest other = (GetNetworkInsightsAccessScopeContentRequest) obj;
    ...
    @Override
    public GetNetworkInsightsAccessScopeContentRequest clone() {
