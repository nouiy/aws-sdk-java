...
public class RegisterInstanceEventNotificationAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
     ...
     * </p>
     * 
     * @return The resulting set of tag keys.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RegisterInstanceEventNotificationAttributesResult == false)
            return false;
        RegisterInstanceEventNotificationAttributesResult other = (RegisterInstanceEventNotificationAttributesResult) obj;
    ...
    @Override
    public RegisterInstanceEventNotificationAttributesResult clone() {
        try {
            return (RegisterInstanceEventNotificationAttributesResult) super.clone();
