 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ThroughResourcesStatementRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ThroughResourcesStatementRequest implements Serializable, Cloneable {
    ...
    public ThroughResourcesStatementRequest withResourceStatement(ResourceStatementRequest resourceStatement) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ThroughResourcesStatementRequest == false)
            return false;
        ThroughResourcesStatementRequest other = (ThroughResourcesStatementRequest) obj;
    ...
    @Override
    public ThroughResourcesStatementRequest clone() {
        try {
            return (ThroughResourcesStatementRequest) super.clone();
