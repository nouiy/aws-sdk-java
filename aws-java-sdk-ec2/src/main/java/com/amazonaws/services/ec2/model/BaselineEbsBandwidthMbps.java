 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/BaselineEbsBandwidthMbps" target="_top">AWS API
 *      Documentation</a>
 */
...
public class BaselineEbsBandwidthMbps implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The minimum baseline bandwidth, in Mbps. If this parameter is not specified, there is no minimum limit.
     */
     ...
     * </p>
     * 
     * @return The maximum baseline bandwidth, in Mbps. If this parameter is not specified, there is no maximum limit.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BaselineEbsBandwidthMbps == false)
            return false;
        BaselineEbsBandwidthMbps other = (BaselineEbsBandwidthMbps) obj;
