 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/PathStatement" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PathStatement implements Serializable, Cloneable {
    ...
    public void setPacketHeaderStatement(PacketHeaderStatement packetHeaderStatement) {
    ...
    public PacketHeaderStatement getPacketHeaderStatement() {
    ...
    public PathStatement withPacketHeaderStatement(PacketHeaderStatement packetHeaderStatement) {
    ...
    public PathStatement withResourceStatement(ResourceStatement resourceStatement) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PathStatement == false)
            return false;
    ...
    @Override
    public PathStatement clone() {
        try {
            return (PathStatement) super.clone();
