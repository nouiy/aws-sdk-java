...
public class DisassociateAddressResultStaxUnmarshaller implements Unmarshaller<DisassociateAddressResult, StaxUnmarshallerContext> {

    public DisassociateAddressResult unmarshall(StaxUnmarshallerContext context) throws Exception {
