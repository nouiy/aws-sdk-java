...
public class ReplaceNetworkAclEntryResultStaxUnmarshaller implements Unmarshaller<ReplaceNetworkAclEntryResult, StaxUnmarshallerContext> {

    public ReplaceNetworkAclEntryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
