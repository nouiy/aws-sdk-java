 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/SpotMaintenanceStrategies" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpotMaintenanceStrategies implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SpotMaintenanceStrategies == false)
            return false;
        SpotMaintenanceStrategies other = (SpotMaintenanceStrategies) obj;
    ...
    public SpotMaintenanceStrategies clone() {
        try {
            return (SpotMaintenanceStrategies) super.clone();
