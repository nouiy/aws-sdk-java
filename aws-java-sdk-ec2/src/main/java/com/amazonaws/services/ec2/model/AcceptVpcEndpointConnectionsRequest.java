...
public class AcceptVpcEndpointConnectionsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<AcceptVpcEndpointConnectionsRequest> {
    ...
    public AcceptVpcEndpointConnectionsRequest withVpcEndpointIds(java.util.Collection<String> vpcEndpointIds) {
