...
public class ModifyVpnTunnelCertificateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyVpnTunnelCertificateResult withVpnConnection(VpnConnection vpnConnection) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVpnTunnelCertificateResult == false)
            return false;
        ModifyVpnTunnelCertificateResult other = (ModifyVpnTunnelCertificateResult) obj;
    ...
    @Override
    public ModifyVpnTunnelCertificateResult clone() {
        try {
            return (ModifyVpnTunnelCertificateResult) super.clone();
