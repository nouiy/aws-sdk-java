...
public class StartVpcEndpointServicePrivateDnsVerificationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartVpcEndpointServicePrivateDnsVerificationResult == false)
            return false;
        StartVpcEndpointServicePrivateDnsVerificationResult other = (StartVpcEndpointServicePrivateDnsVerificationResult) obj;
    ...
    @Override
    public StartVpcEndpointServicePrivateDnsVerificationResult clone() {
        try {
            return (StartVpcEndpointServicePrivateDnsVerificationResult) super.clone();
