...
/**
 * CreateDefaultSubnetRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateDefaultSubnetRequestMarshaller implements Marshaller<Request<CreateDefaultSubnetRequest>, CreateDefaultSubnetRequest> {
    ...
    public Request<CreateDefaultSubnetRequest> marshall(CreateDefaultSubnetRequest createDefaultSubnetRequest) {
        ...
        Request<CreateDefaultSubnetRequest> request = new DefaultRequest<CreateDefaultSubnetRequest>(createDefaultSubnetRequest, "AmazonEC2");
        request.addParameter("Action", "CreateDefaultSubnet");
        request.addParameter("Version", "2016-11-15");
        request.setHttpMethod(HttpMethodName.POST);

        if (createDefaultSubnetRequest.getAvailabilityZone() != null) {
