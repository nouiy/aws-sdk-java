...
/**
 * <p>
 * One or more targets associated with the specified event window. Only one <i>type</i> of target (instance ID, instance
 * tag, or Dedicated Host ID) can be associated with an event window.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/InstanceEventWindowAssociationRequest"
...
public class InstanceEventWindowAssociationRequest implements Serializable, Cloneable {
    ...
    public InstanceEventWindowAssociationRequest withInstanceIds(java.util.Collection<String> instanceIds) {
    ...
    public InstanceEventWindowAssociationRequest withInstanceTags(java.util.Collection<Tag> instanceTags) {
    ...
    public InstanceEventWindowAssociationRequest withDedicatedHostIds(java.util.Collection<String> dedicatedHostIds) {
