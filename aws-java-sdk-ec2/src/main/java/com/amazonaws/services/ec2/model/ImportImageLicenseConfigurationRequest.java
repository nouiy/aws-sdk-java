 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ImportImageLicenseConfigurationRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportImageLicenseConfigurationRequest implements Serializable, Cloneable {
    ...
    public ImportImageLicenseConfigurationRequest withLicenseConfigurationArn(String licenseConfigurationArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportImageLicenseConfigurationRequest == false)
            return false;
    ...
    @Override
    public ImportImageLicenseConfigurationRequest clone() {
        try {
            return (ImportImageLicenseConfigurationRequest) super.clone();
