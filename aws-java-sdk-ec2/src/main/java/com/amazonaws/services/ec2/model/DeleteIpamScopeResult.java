...
public class DeleteIpamScopeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteIpamScopeResult == false)
            return false;
        DeleteIpamScopeResult other = (DeleteIpamScopeResult) obj;
    ...
    @Override
    public DeleteIpamScopeResult clone() {
        try {
            return (DeleteIpamScopeResult) super.clone();
