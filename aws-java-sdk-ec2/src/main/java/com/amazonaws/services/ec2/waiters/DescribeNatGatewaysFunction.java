...
public class DescribeNatGatewaysFunction implements SdkFunction<DescribeNatGatewaysRequest, DescribeNatGatewaysResult> {
     ...
     */
    @Override
    public DescribeNatGatewaysResult apply(DescribeNatGatewaysRequest describeNatGatewaysRequest) {
