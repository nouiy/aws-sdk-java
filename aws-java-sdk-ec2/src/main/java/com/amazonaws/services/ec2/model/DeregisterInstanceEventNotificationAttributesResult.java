...
public class DeregisterInstanceEventNotificationAttributesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public DeregisterInstanceEventNotificationAttributesResult clone() {
        try {
            return (DeregisterInstanceEventNotificationAttributesResult) super.clone();
