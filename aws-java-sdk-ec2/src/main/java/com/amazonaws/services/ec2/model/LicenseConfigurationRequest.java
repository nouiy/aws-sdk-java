 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LicenseConfigurationRequest" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LicenseConfigurationRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LicenseConfigurationRequest == false)
            return false;
        LicenseConfigurationRequest other = (LicenseConfigurationRequest) obj;
    ...
    public LicenseConfigurationRequest clone() {
        try {
            return (LicenseConfigurationRequest) super.clone();
