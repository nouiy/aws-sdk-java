...
public class ModifyVpnConnectionOptionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyVpnConnectionOptionsResult withVpnConnection(VpnConnection vpnConnection) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVpnConnectionOptionsResult == false)
            return false;
        ModifyVpnConnectionOptionsResult other = (ModifyVpnConnectionOptionsResult) obj;
    ...
    @Override
    public ModifyVpnConnectionOptionsResult clone() {
        try {
            return (ModifyVpnConnectionOptionsResult) super.clone();
