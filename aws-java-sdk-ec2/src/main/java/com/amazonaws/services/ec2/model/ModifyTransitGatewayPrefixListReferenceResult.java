...
public class ModifyTransitGatewayPrefixListReferenceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public ModifyTransitGatewayPrefixListReferenceResult withTransitGatewayPrefixListReference(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyTransitGatewayPrefixListReferenceResult == false)
            return false;
        ModifyTransitGatewayPrefixListReferenceResult other = (ModifyTransitGatewayPrefixListReferenceResult) obj;
    ...
    @Override
    public ModifyTransitGatewayPrefixListReferenceResult clone() {
        try {
            return (ModifyTransitGatewayPrefixListReferenceResult) super.clone();
