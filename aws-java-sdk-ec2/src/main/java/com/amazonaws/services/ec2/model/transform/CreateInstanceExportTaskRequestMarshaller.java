...
public class CreateInstanceExportTaskRequestMarshaller implements Marshaller<Request<CreateInstanceExportTaskRequest>, CreateInstanceExportTaskRequest> {
    ...
    public Request<CreateInstanceExportTaskRequest> marshall(CreateInstanceExportTaskRequest createInstanceExportTaskRequest) {
        ...
        com.amazonaws.internal.SdkInternalList<TagSpecification> createInstanceExportTaskRequestTagSpecificationsList = (com.amazonaws.internal.SdkInternalList<TagSpecification>) createInstanceExportTaskRequest
                .getTagSpecifications();
        if (!createInstanceExportTaskRequestTagSpecificationsList.isEmpty() || !createInstanceExportTaskRequestTagSpecificationsList.isAutoConstruct()) {
            ...
            for (TagSpecification createInstanceExportTaskRequestTagSpecificationsListValue : createInstanceExportTaskRequestTagSpecificationsList) {
                ...
                if (createInstanceExportTaskRequestTagSpecificationsListValue.getResourceType() != null) {
                    request.addParameter("TagSpecification." + tagSpecificationsListIndex + ".ResourceType",
                            StringUtils.fromString(createInstanceExportTaskRequestTagSpecificationsListValue.getResourceType()));
                }

                com.amazonaws.internal.SdkInternalList<Tag> tagSpecificationTagsList = (com.amazonaws.internal.SdkInternalList<Tag>) createInstanceExportTaskRequestTagSpecificationsListValue
                        .getTags();
