...
/**
 * DisassociateVpcCidrBlockResult StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DisassociateVpcCidrBlockResultStaxUnmarshaller implements Unmarshaller<DisassociateVpcCidrBlockResult, StaxUnmarshallerContext> {

    public DisassociateVpcCidrBlockResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    private static DisassociateVpcCidrBlockResultStaxUnmarshaller instance;

    public static DisassociateVpcCidrBlockResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DisassociateVpcCidrBlockResultStaxUnmarshaller();
        return instance;
    }
}
