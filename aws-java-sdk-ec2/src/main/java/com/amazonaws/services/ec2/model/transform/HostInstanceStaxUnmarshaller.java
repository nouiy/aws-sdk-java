...
public class HostInstanceStaxUnmarshaller implements Unmarshaller<HostInstance, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("instanceId", targetDepth)) {
                    hostInstance.setInstanceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
