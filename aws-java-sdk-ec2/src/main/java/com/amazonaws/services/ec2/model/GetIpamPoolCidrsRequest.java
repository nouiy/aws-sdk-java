...
import com.amazonaws.services.ec2.model.transform.GetIpamPoolCidrsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetIpamPoolCidrsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable, DryRunSupportedRequest<GetIpamPoolCidrsRequest> {
     ...
     * </p>
     * 
     * @return The ID of the IPAM pool you want the CIDR for.
     */
    ...
    public GetIpamPoolCidrsRequest withFilters(Filter... filters) {
    ...
    public GetIpamPoolCidrsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public GetIpamPoolCidrsRequest withMaxResults(Integer maxResults) {
     ...
     */
    @Override
    public Request<GetIpamPoolCidrsRequest> getDryRunRequest() {
        Request<GetIpamPoolCidrsRequest> request = new GetIpamPoolCidrsRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIpamPoolCidrsRequest == false)
            return false;
        GetIpamPoolCidrsRequest other = (GetIpamPoolCidrsRequest) obj;
    ...
    @Override
    public GetIpamPoolCidrsRequest clone() {
        return (GetIpamPoolCidrsRequest) super.clone();
    }
}
