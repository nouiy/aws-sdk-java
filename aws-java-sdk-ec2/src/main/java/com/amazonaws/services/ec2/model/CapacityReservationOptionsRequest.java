 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/CapacityReservationOptionsRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CapacityReservationOptionsRequest implements Serializable, Cloneable {
    ...
    public CapacityReservationOptionsRequest withUsageStrategy(FleetCapacityReservationUsageStrategy usageStrategy) {
    ...
    @Override
    public CapacityReservationOptionsRequest clone() {
        try {
            return (CapacityReservationOptionsRequest) super.clone();
