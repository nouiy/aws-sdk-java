...
public class ResetFpgaImageAttributeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ResetFpgaImageAttributeResult withReturn(Boolean returnValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ResetFpgaImageAttributeResult == false)
            return false;
        ResetFpgaImageAttributeResult other = (ResetFpgaImageAttributeResult) obj;
    ...
    public ResetFpgaImageAttributeResult clone() {
        try {
            return (ResetFpgaImageAttributeResult) super.clone();
