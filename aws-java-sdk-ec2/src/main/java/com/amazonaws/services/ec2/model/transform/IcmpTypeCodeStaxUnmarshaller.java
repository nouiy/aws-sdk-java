...
public class IcmpTypeCodeStaxUnmarshaller implements Unmarshaller<IcmpTypeCode, StaxUnmarshallerContext> {

    public IcmpTypeCode unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    public static IcmpTypeCodeStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new IcmpTypeCodeStaxUnmarshaller();
        return instance;
    }
}
