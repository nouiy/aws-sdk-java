 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplatePrivateDnsNameOptionsRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LaunchTemplatePrivateDnsNameOptionsRequest implements Serializable, Cloneable {
     ...
     * 
     * @param hostnameType
     *        The type of hostname for Amazon EC2 instances. For IPv4 only subnets, an instance DNS name must be based
    ...
    public LaunchTemplatePrivateDnsNameOptionsRequest withHostnameType(String hostnameType) {
    ...
    public LaunchTemplatePrivateDnsNameOptionsRequest withHostnameType(HostnameType hostnameType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LaunchTemplatePrivateDnsNameOptionsRequest == false)
            return false;
    ...
    @Override
    public LaunchTemplatePrivateDnsNameOptionsRequest clone() {
        try {
            return (LaunchTemplatePrivateDnsNameOptionsRequest) super.clone();
