...
import com.amazonaws.services.ec2.model.transform.GetVpnTunnelReplacementStatusRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetVpnTunnelReplacementStatusRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<GetVpnTunnelReplacementStatusRequest> {
     ...
     */
    @Override
    public Request<GetVpnTunnelReplacementStatusRequest> getDryRunRequest() {
        Request<GetVpnTunnelReplacementStatusRequest> request = new GetVpnTunnelReplacementStatusRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVpnTunnelReplacementStatusRequest == false)
            return false;
        GetVpnTunnelReplacementStatusRequest other = (GetVpnTunnelReplacementStatusRequest) obj;
    ...
    public GetVpnTunnelReplacementStatusRequest clone() {
        return (GetVpnTunnelReplacementStatusRequest) super.clone();
    }
}
