 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateEnclaveOptions" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LaunchTemplateEnclaveOptions implements Serializable, Cloneable {
    ...
    public LaunchTemplateEnclaveOptions withEnabled(Boolean enabled) {
        setEnabled(enabled);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LaunchTemplateEnclaveOptions == false)
            return false;
        LaunchTemplateEnclaveOptions other = (LaunchTemplateEnclaveOptions) obj;
    ...
    public LaunchTemplateEnclaveOptions clone() {
        try {
            return (LaunchTemplateEnclaveOptions) super.clone();
