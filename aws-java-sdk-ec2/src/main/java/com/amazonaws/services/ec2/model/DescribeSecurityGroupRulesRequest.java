...
import com.amazonaws.services.ec2.model.transform.DescribeSecurityGroupRulesRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeSecurityGroupRulesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DescribeSecurityGroupRulesRequest> {
    ...
    public DescribeSecurityGroupRulesRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeSecurityGroupRulesRequest withSecurityGroupRuleIds(java.util.Collection<String> securityGroupRuleIds) {
     ...
     */
    @Override
    public Request<DescribeSecurityGroupRulesRequest> getDryRunRequest() {
        Request<DescribeSecurityGroupRulesRequest> request = new DescribeSecurityGroupRulesRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSecurityGroupRulesRequest == false)
            return false;
        DescribeSecurityGroupRulesRequest other = (DescribeSecurityGroupRulesRequest) obj;
    ...
    public DescribeSecurityGroupRulesRequest clone() {
        return (DescribeSecurityGroupRulesRequest) super.clone();
    }
}
