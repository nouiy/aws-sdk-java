...
import com.amazonaws.services.ec2.model.transform.RegisterTransitGatewayMulticastGroupMembersRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RegisterTransitGatewayMulticastGroupMembersRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<RegisterTransitGatewayMulticastGroupMembersRequest> {
    ...
    public RegisterTransitGatewayMulticastGroupMembersRequest withNetworkInterfaceIds(java.util.Collection<String> networkInterfaceIds) {
     ...
     */
    @Override
    public Request<RegisterTransitGatewayMulticastGroupMembersRequest> getDryRunRequest() {
        Request<RegisterTransitGatewayMulticastGroupMembersRequest> request = new RegisterTransitGatewayMulticastGroupMembersRequestMarshaller().marshall(this);
    ...
    public RegisterTransitGatewayMulticastGroupMembersRequest clone() {
        return (RegisterTransitGatewayMulticastGroupMembersRequest) super.clone();
    }
}
