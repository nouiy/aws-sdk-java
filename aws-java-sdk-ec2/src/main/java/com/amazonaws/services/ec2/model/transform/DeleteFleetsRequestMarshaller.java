...
/**
 * DeleteFleetsRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteFleetsRequestMarshaller implements Marshaller<Request<DeleteFleetsRequest>, DeleteFleetsRequest> {
    ...
    public Request<DeleteFleetsRequest> marshall(DeleteFleetsRequest deleteFleetsRequest) {
        ...
        Request<DeleteFleetsRequest> request = new DefaultRequest<DeleteFleetsRequest>(deleteFleetsRequest, "AmazonEC2");
        request.addParameter("Action", "DeleteFleets");
        request.addParameter("Version", "2016-11-15");
        request.setHttpMethod(HttpMethodName.POST);

        com.amazonaws.internal.SdkInternalList<String> deleteFleetsRequestFleetIdsList = (com.amazonaws.internal.SdkInternalList<String>) deleteFleetsRequest
                .getFleetIds();
