...
public class RejectTransitGatewayVpcAttachmentRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<RejectTransitGatewayVpcAttachmentRequest> {
    ...
    public Request<RejectTransitGatewayVpcAttachmentRequest> getDryRunRequest() {
        Request<RejectTransitGatewayVpcAttachmentRequest> request = new RejectTransitGatewayVpcAttachmentRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectTransitGatewayVpcAttachmentRequest == false)
            return false;
        RejectTransitGatewayVpcAttachmentRequest other = (RejectTransitGatewayVpcAttachmentRequest) obj;
    ...
    @Override
    public RejectTransitGatewayVpcAttachmentRequest clone() {
