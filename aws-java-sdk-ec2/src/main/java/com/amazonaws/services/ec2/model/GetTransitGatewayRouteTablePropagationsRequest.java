...
import com.amazonaws.services.ec2.model.transform.GetTransitGatewayRouteTablePropagationsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetTransitGatewayRouteTablePropagationsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<GetTransitGatewayRouteTablePropagationsRequest> {
    ...
    public GetTransitGatewayRouteTablePropagationsRequest withFilters(Filter... filters) {
    ...
    public GetTransitGatewayRouteTablePropagationsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public GetTransitGatewayRouteTablePropagationsRequest withMaxResults(Integer maxResults) {
     ...
     */
    @Override
    public Request<GetTransitGatewayRouteTablePropagationsRequest> getDryRunRequest() {
        Request<GetTransitGatewayRouteTablePropagationsRequest> request = new GetTransitGatewayRouteTablePropagationsRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTransitGatewayRouteTablePropagationsRequest == false)
            return false;
        GetTransitGatewayRouteTablePropagationsRequest other = (GetTransitGatewayRouteTablePropagationsRequest) obj;
    ...
    @Override
    public GetTransitGatewayRouteTablePropagationsRequest clone() {
        return (GetTransitGatewayRouteTablePropagationsRequest) super.clone();
    }
}
