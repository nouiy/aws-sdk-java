 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/IpamOperatingRegion" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IpamOperatingRegion implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IpamOperatingRegion == false)
            return false;
        IpamOperatingRegion other = (IpamOperatingRegion) obj;
    ...
    @Override
    public IpamOperatingRegion clone() {
        try {
            return (IpamOperatingRegion) super.clone();
