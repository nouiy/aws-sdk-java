...
public class RejectTransitGatewayVpcAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectTransitGatewayVpcAttachmentResult == false)
            return false;
        RejectTransitGatewayVpcAttachmentResult other = (RejectTransitGatewayVpcAttachmentResult) obj;
    ...
    public RejectTransitGatewayVpcAttachmentResult clone() {
        try {
            return (RejectTransitGatewayVpcAttachmentResult) super.clone();
