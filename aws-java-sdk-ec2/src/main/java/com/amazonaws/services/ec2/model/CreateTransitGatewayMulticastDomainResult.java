...
public class CreateTransitGatewayMulticastDomainResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    @Override
    public CreateTransitGatewayMulticastDomainResult clone() {
        try {
