...
public class DeleteSubnetResultStaxUnmarshaller implements Unmarshaller<DeleteSubnetResult, StaxUnmarshallerContext> {

    public DeleteSubnetResult unmarshall(StaxUnmarshallerContext context) throws Exception {
