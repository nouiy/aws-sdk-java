...
public class CreateDefaultVpcRequest extends AmazonWebServiceRequest implements Serializable, Cloneable, DryRunSupportedRequest<CreateDefaultVpcRequest> {
    ...
    public Request<CreateDefaultVpcRequest> getDryRunRequest() {
        Request<CreateDefaultVpcRequest> request = new CreateDefaultVpcRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDefaultVpcRequest == false)
            return false;
        CreateDefaultVpcRequest other = (CreateDefaultVpcRequest) obj;
        return true;
    }
    ...
    @Override
    public CreateDefaultVpcRequest clone() {
