...
public class FastLaunchLaunchTemplateSpecificationResponse implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FastLaunchLaunchTemplateSpecificationResponse == false)
            return false;
        FastLaunchLaunchTemplateSpecificationResponse other = (FastLaunchLaunchTemplateSpecificationResponse) obj;
    ...
    public FastLaunchLaunchTemplateSpecificationResponse clone() {
        try {
            return (FastLaunchLaunchTemplateSpecificationResponse) super.clone();
