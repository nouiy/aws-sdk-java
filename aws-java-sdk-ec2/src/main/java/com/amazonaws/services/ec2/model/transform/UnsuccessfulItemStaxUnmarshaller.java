...
public class UnsuccessfulItemStaxUnmarshaller implements Unmarshaller<UnsuccessfulItem, StaxUnmarshallerContext> {

    public UnsuccessfulItem unmarshall(StaxUnmarshallerContext context) throws Exception {
        UnsuccessfulItem unsuccessfulItem = new UnsuccessfulItem();
    ...
    public static UnsuccessfulItemStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new UnsuccessfulItemStaxUnmarshaller();
        return instance;
    }
}
