...
/**
 * DescribeTransitGatewayAttachmentsResult StAX Unmarshaller
 */
...
public class DescribeTransitGatewayAttachmentsResultStaxUnmarshaller implements Unmarshaller<DescribeTransitGatewayAttachmentsResult, StaxUnmarshallerContext> {
    ...
    public DescribeTransitGatewayAttachmentsResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("transitGatewayAttachments", targetDepth)) {
                    describeTransitGatewayAttachmentsResult.withTransitGatewayAttachments(new ArrayList<TransitGatewayAttachment>());
                    continue;
                }

                if (context.testExpression("transitGatewayAttachments/item", targetDepth)) {
                    describeTransitGatewayAttachmentsResult.withTransitGatewayAttachments(TransitGatewayAttachmentStaxUnmarshaller.getInstance().unmarshall(
                            context));
                    continue;
                }

                if (context.testExpression("nextToken", targetDepth)) {
                    describeTransitGatewayAttachmentsResult.setNextToken(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
