 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/LaunchTemplateLicenseConfigurationRequest"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LaunchTemplateLicenseConfigurationRequest implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LaunchTemplateLicenseConfigurationRequest == false)
            return false;
        LaunchTemplateLicenseConfigurationRequest other = (LaunchTemplateLicenseConfigurationRequest) obj;
    ...
    public LaunchTemplateLicenseConfigurationRequest clone() {
        try {
            return (LaunchTemplateLicenseConfigurationRequest) super.clone();
