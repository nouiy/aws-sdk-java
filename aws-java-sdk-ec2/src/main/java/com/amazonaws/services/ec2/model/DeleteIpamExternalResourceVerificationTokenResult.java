...
public class DeleteIpamExternalResourceVerificationTokenResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public DeleteIpamExternalResourceVerificationTokenResult withIpamExternalResourceVerificationToken(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteIpamExternalResourceVerificationTokenResult == false)
            return false;
        DeleteIpamExternalResourceVerificationTokenResult other = (DeleteIpamExternalResourceVerificationTokenResult) obj;
    ...
    @Override
    public DeleteIpamExternalResourceVerificationTokenResult clone() {
        try {
            return (DeleteIpamExternalResourceVerificationTokenResult) super.clone();
