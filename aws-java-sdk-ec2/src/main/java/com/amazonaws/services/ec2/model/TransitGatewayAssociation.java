 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TransitGatewayAssociation" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransitGatewayAssociation implements Serializable, Cloneable {
    ...
    public TransitGatewayAssociation withResourceType(String resourceType) {
    ...
    public TransitGatewayAssociation withResourceType(TransitGatewayAttachmentResourceType resourceType) {
    ...
    public TransitGatewayAssociation withState(String state) {
        setState(state);
        return this;
    }
    ...
    public TransitGatewayAssociation withState(TransitGatewayAssociationState state) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TransitGatewayAssociation == false)
            return false;
        TransitGatewayAssociation other = (TransitGatewayAssociation) obj;
    ...
    @Override
    public TransitGatewayAssociation clone() {
        try {
            return (TransitGatewayAssociation) super.clone();
