...
import com.amazonaws.services.ec2.model.transform.DescribeTrunkInterfaceAssociationsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeTrunkInterfaceAssociationsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DescribeTrunkInterfaceAssociationsRequest> {
     ...
     * <li>
     * <p>
     * <code>interface-protocol</code> - The interface protocol. Valid values are <code>VLAN</code> and <code>GRE</code>
     * .
     * </p>
     * </li>
     * </ul>
    ...
    public DescribeTrunkInterfaceAssociationsRequest withAssociationIds(java.util.Collection<String> associationIds) {
     ...
     *         <li>
     *         <p>
     *         <code>interface-protocol</code> - The interface protocol. Valid values are <code>VLAN</code> and
     *         <code>GRE</code>.
     *         </p>
     *         </li>
     */
    ...
    public DescribeTrunkInterfaceAssociationsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
    ...
    public DescribeTrunkInterfaceAssociationsRequest withMaxResults(Integer maxResults) {
     ...
     */
    @Override
    public Request<DescribeTrunkInterfaceAssociationsRequest> getDryRunRequest() {
        Request<DescribeTrunkInterfaceAssociationsRequest> request = new DescribeTrunkInterfaceAssociationsRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeTrunkInterfaceAssociationsRequest == false)
            return false;
        DescribeTrunkInterfaceAssociationsRequest other = (DescribeTrunkInterfaceAssociationsRequest) obj;
    ...
    public DescribeTrunkInterfaceAssociationsRequest clone() {
        return (DescribeTrunkInterfaceAssociationsRequest) super.clone();
    }
}
