...
public class DetachClassicLinkVpcResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachClassicLinkVpcResult == false)
            return false;
        DetachClassicLinkVpcResult other = (DetachClassicLinkVpcResult) obj;
    ...
    public DetachClassicLinkVpcResult clone() {
        try {
            return (DetachClassicLinkVpcResult) super.clone();
