...
public class DescribeIpamsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable, DryRunSupportedRequest<DescribeIpamsRequest> {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<String> ipamIds;
    ...
    public DescribeIpamsRequest withFilters(java.util.Collection<Filter> filters) {
        setFilters(filters);
        return this;
    }
     ...
     * </p>
     * 
     * @return The IDs of the IPAMs you want information on.
     */

    public java.util.List<String> getIpamIds() {
        if (ipamIds == null) {
            ipamIds = new com.amazonaws.internal.SdkInternalList<String>();
        }
        return ipamIds;
    }
    ...
    public void setIpamIds(java.util.Collection<String> ipamIds) {
        if (ipamIds == null) {
            this.ipamIds = null;
            return;
        }

        this.ipamIds = new com.amazonaws.internal.SdkInternalList<String>(ipamIds);
    }
     ...
     * <p>
     * <b>NOTE:</b> This method appends the values to the existing list (if any). Use
     * {@link #setIpamIds(java.util.Collection)} or {@link #withIpamIds(java.util.Collection)} if you want to override
     * the existing values.
     * </p>
     * 
     * @param ipamIds
    ...
    public DescribeIpamsRequest withIpamIds(String... ipamIds) {
        if (this.ipamIds == null) {
            setIpamIds(new com.amazonaws.internal.SdkInternalList<String>(ipamIds.length));
        }
        for (String ele : ipamIds) {
            this.ipamIds.add(ele);
        }
        return this;
    }
    ...
    public DescribeIpamsRequest withIpamIds(java.util.Collection<String> ipamIds) {
        setIpamIds(ipamIds);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getIpamIds() != null)
            sb.append("IpamIds: ").append(getIpamIds());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeIpamsRequest == false)
            return false;
        ...
        if (other.getIpamIds() == null ^ this.getIpamIds() == null)
            return false;
        if (other.getIpamIds() != null && other.getIpamIds().equals(this.getIpamIds()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getIpamIds() == null) ? 0 : getIpamIds().hashCode());
        return hashCode;
    }
