 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/EnableFastSnapshotRestoreErrorItem"
...
public class EnableFastSnapshotRestoreErrorItem implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<EnableFastSnapshotRestoreStateErrorItem> fastSnapshotRestoreStateErrors;
    ...
    public java.util.List<EnableFastSnapshotRestoreStateErrorItem> getFastSnapshotRestoreStateErrors() {
        if (fastSnapshotRestoreStateErrors == null) {
            fastSnapshotRestoreStateErrors = new com.amazonaws.internal.SdkInternalList<EnableFastSnapshotRestoreStateErrorItem>();
        }
    ...
    public void setFastSnapshotRestoreStateErrors(java.util.Collection<EnableFastSnapshotRestoreStateErrorItem> fastSnapshotRestoreStateErrors) {
        if (fastSnapshotRestoreStateErrors == null) {
            this.fastSnapshotRestoreStateErrors = null;
            return;
        }

        this.fastSnapshotRestoreStateErrors = new com.amazonaws.internal.SdkInternalList<EnableFastSnapshotRestoreStateErrorItem>(
    ...
    public EnableFastSnapshotRestoreErrorItem withFastSnapshotRestoreStateErrors(EnableFastSnapshotRestoreStateErrorItem... fastSnapshotRestoreStateErrors) {
        if (this.fastSnapshotRestoreStateErrors == null) {
            setFastSnapshotRestoreStateErrors(new com.amazonaws.internal.SdkInternalList<EnableFastSnapshotRestoreStateErrorItem>(
                    fastSnapshotRestoreStateErrors.length));
        }
        for (EnableFastSnapshotRestoreStateErrorItem ele : fastSnapshotRestoreStateErrors) {
    ...
    @Override
    public EnableFastSnapshotRestoreErrorItem clone() {
        try {
