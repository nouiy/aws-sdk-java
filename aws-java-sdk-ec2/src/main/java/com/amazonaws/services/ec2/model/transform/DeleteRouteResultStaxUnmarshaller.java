...
public class DeleteRouteResultStaxUnmarshaller implements Unmarshaller<DeleteRouteResult, StaxUnmarshallerContext> {

    public DeleteRouteResult unmarshall(StaxUnmarshallerContext context) throws Exception {
