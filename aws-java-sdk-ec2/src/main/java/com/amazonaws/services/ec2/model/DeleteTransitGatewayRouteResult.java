...
public class DeleteTransitGatewayRouteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTransitGatewayRouteResult == false)
            return false;
        DeleteTransitGatewayRouteResult other = (DeleteTransitGatewayRouteResult) obj;
    ...
    public DeleteTransitGatewayRouteResult clone() {
        try {
            return (DeleteTransitGatewayRouteResult) super.clone();
