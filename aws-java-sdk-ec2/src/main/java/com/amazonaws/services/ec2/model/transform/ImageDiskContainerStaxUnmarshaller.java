...
public class ImageDiskContainerStaxUnmarshaller implements Unmarshaller<ImageDiskContainer, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Description", targetDepth)) {
                    imageDiskContainer.setDescription(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
                ...
                if (context.testExpression("Url", targetDepth)) {
                    imageDiskContainer.setUrl(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
