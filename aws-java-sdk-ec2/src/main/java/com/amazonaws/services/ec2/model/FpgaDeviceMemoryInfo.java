 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/FpgaDeviceMemoryInfo" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FpgaDeviceMemoryInfo implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The size of the memory available to the FPGA accelerator, in MiB.
     */
    ...
    public FpgaDeviceMemoryInfo clone() {
        try {
            return (FpgaDeviceMemoryInfo) super.clone();
