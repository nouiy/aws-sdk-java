...
public class DisableTransitGatewayRouteTablePropagationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public DisableTransitGatewayRouteTablePropagationResult withPropagation(TransitGatewayPropagation propagation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisableTransitGatewayRouteTablePropagationResult == false)
            return false;
        DisableTransitGatewayRouteTablePropagationResult other = (DisableTransitGatewayRouteTablePropagationResult) obj;
    ...
    @Override
    public DisableTransitGatewayRouteTablePropagationResult clone() {
        try {
