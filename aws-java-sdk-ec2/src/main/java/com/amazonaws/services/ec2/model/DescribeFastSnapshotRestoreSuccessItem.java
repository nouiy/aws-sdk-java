 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFastSnapshotRestoreSuccessItem"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeFastSnapshotRestoreSuccessItem implements Serializable, Cloneable {
    ...
    public DescribeFastSnapshotRestoreSuccessItem withEnablingTime(java.util.Date enablingTime) {
    ...
    public DescribeFastSnapshotRestoreSuccessItem withOptimizingTime(java.util.Date optimizingTime) {
    ...
    public DescribeFastSnapshotRestoreSuccessItem withEnabledTime(java.util.Date enabledTime) {
    ...
    public DescribeFastSnapshotRestoreSuccessItem withDisablingTime(java.util.Date disablingTime) {
    ...
    public DescribeFastSnapshotRestoreSuccessItem withDisabledTime(java.util.Date disabledTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeFastSnapshotRestoreSuccessItem == false)
            return false;
    ...
    public DescribeFastSnapshotRestoreSuccessItem clone() {
        try {
            return (DescribeFastSnapshotRestoreSuccessItem) super.clone();
