...
public class DetachNetworkInterfaceResultStaxUnmarshaller implements Unmarshaller<DetachNetworkInterfaceResult, StaxUnmarshallerContext> {

    public DetachNetworkInterfaceResult unmarshall(StaxUnmarshallerContext context) throws Exception {
