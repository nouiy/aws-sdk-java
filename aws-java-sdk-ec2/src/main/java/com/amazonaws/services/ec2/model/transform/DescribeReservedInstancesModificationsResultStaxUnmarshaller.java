...
public class DescribeReservedInstancesModificationsResultStaxUnmarshaller implements
        Unmarshaller<DescribeReservedInstancesModificationsResult, StaxUnmarshallerContext> {
    ...
    public static DescribeReservedInstancesModificationsResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeReservedInstancesModificationsResultStaxUnmarshaller();
        return instance;
    }
}
