...
/**
 * Fluent builder for {@link com.amazonaws.services.ec2.AmazonEC2}. Use of the builder is preferred over using
...
public final class AmazonEC2ClientBuilder extends AwsSyncClientBuilder<AmazonEC2ClientBuilder, AmazonEC2> {
    ...
    public static AmazonEC2ClientBuilder standard() {
        return new AmazonEC2ClientBuilder();
    }
    ...
    private AmazonEC2ClientBuilder() {
     ...
     * @return Fully configured implementation of AmazonEC2.
     */
    @Override
    protected AmazonEC2 build(AwsSyncClientParams params) {
