...
public class ModifyIpamScopeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyIpamScopeResult == false)
            return false;
        ModifyIpamScopeResult other = (ModifyIpamScopeResult) obj;
    ...
    public ModifyIpamScopeResult clone() {
        try {
            return (ModifyIpamScopeResult) super.clone();
