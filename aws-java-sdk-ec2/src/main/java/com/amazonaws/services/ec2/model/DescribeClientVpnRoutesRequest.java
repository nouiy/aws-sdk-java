...
public class DescribeClientVpnRoutesRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DescribeClientVpnRoutesRequest> {
     ...
     */
    @Override
    public Request<DescribeClientVpnRoutesRequest> getDryRunRequest() {
        Request<DescribeClientVpnRoutesRequest> request = new DescribeClientVpnRoutesRequestMarshaller().marshall(this);
    ...
    @Override
    public DescribeClientVpnRoutesRequest clone() {
        return (DescribeClientVpnRoutesRequest) super.clone();
    }
}
