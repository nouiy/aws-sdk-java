...
public class DescribeNetworkInterfacesFunction implements SdkFunction<DescribeNetworkInterfacesRequest, DescribeNetworkInterfacesResult> {
     ...
     */
    @Override
    public DescribeNetworkInterfacesResult apply(DescribeNetworkInterfacesRequest describeNetworkInterfacesRequest) {
