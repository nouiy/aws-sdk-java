...
public class ReplaceTransitGatewayRouteResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReplaceTransitGatewayRouteResult == false)
            return false;
        ReplaceTransitGatewayRouteResult other = (ReplaceTransitGatewayRouteResult) obj;
    ...
    public ReplaceTransitGatewayRouteResult clone() {
        try {
            return (ReplaceTransitGatewayRouteResult) super.clone();
