...
public class AcceptTransitGatewayVpcAttachmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public AcceptTransitGatewayVpcAttachmentResult clone() {
        try {
            return (AcceptTransitGatewayVpcAttachmentResult) super.clone();
