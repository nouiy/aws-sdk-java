 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/PrivateDnsNameOptionsRequest" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PrivateDnsNameOptionsRequest implements Serializable, Cloneable {
    ...
    public PrivateDnsNameOptionsRequest withHostnameType(String hostnameType) {
    ...
    public PrivateDnsNameOptionsRequest withHostnameType(HostnameType hostnameType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PrivateDnsNameOptionsRequest == false)
            return false;
    ...
    @Override
    public PrivateDnsNameOptionsRequest clone() {
        try {
            return (PrivateDnsNameOptionsRequest) super.clone();
