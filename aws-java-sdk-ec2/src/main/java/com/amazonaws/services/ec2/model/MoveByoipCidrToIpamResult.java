...
public class MoveByoipCidrToIpamResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public MoveByoipCidrToIpamResult withByoipCidr(ByoipCidr byoipCidr) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MoveByoipCidrToIpamResult == false)
            return false;
        MoveByoipCidrToIpamResult other = (MoveByoipCidrToIpamResult) obj;
    ...
    @Override
    public MoveByoipCidrToIpamResult clone() {
        try {
            return (MoveByoipCidrToIpamResult) super.clone();
