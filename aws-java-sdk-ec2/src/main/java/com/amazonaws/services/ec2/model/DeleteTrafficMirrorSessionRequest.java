...
public class DeleteTrafficMirrorSessionRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DeleteTrafficMirrorSessionRequest> {
    ...
    public Request<DeleteTrafficMirrorSessionRequest> getDryRunRequest() {
        Request<DeleteTrafficMirrorSessionRequest> request = new DeleteTrafficMirrorSessionRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTrafficMirrorSessionRequest == false)
            return false;
        DeleteTrafficMirrorSessionRequest other = (DeleteTrafficMirrorSessionRequest) obj;
    ...
    @Override
    public DeleteTrafficMirrorSessionRequest clone() {
