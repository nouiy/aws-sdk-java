...
import com.amazonaws.services.ec2.model.transform.RejectTransitGatewayMulticastDomainAssociationsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RejectTransitGatewayMulticastDomainAssociationsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<RejectTransitGatewayMulticastDomainAssociationsRequest> {
    ...
    public RejectTransitGatewayMulticastDomainAssociationsRequest withSubnetIds(java.util.Collection<String> subnetIds) {
     ...
     */
    @Override
    public Request<RejectTransitGatewayMulticastDomainAssociationsRequest> getDryRunRequest() {
        Request<RejectTransitGatewayMulticastDomainAssociationsRequest> request = new RejectTransitGatewayMulticastDomainAssociationsRequestMarshaller()
                .marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectTransitGatewayMulticastDomainAssociationsRequest == false)
            return false;
        RejectTransitGatewayMulticastDomainAssociationsRequest other = (RejectTransitGatewayMulticastDomainAssociationsRequest) obj;
    ...
    @Override
    public RejectTransitGatewayMulticastDomainAssociationsRequest clone() {
        return (RejectTransitGatewayMulticastDomainAssociationsRequest) super.clone();
    }
}
