...
public class DescribeImagesFunction implements SdkFunction<DescribeImagesRequest, DescribeImagesResult> {
     ...
     */
    @Override
    public DescribeImagesResult apply(DescribeImagesRequest describeImagesRequest) {
