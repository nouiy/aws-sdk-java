...
public class DeleteTransitGatewayPrefixListReferenceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
     ...
     * </p>
     * 
     * @return Information about the deleted prefix list reference.
     */
    ...
    public DeleteTransitGatewayPrefixListReferenceResult withTransitGatewayPrefixListReference(
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteTransitGatewayPrefixListReferenceResult == false)
            return false;
        DeleteTransitGatewayPrefixListReferenceResult other = (DeleteTransitGatewayPrefixListReferenceResult) obj;
    ...
    @Override
    public DeleteTransitGatewayPrefixListReferenceResult clone() {
        try {
            return (DeleteTransitGatewayPrefixListReferenceResult) super.clone();
