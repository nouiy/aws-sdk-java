...
public class DescribeSpotFleetInstancesResultStaxUnmarshaller implements Unmarshaller<DescribeSpotFleetInstancesResult, StaxUnmarshallerContext> {

    public DescribeSpotFleetInstancesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    private static DescribeSpotFleetInstancesResultStaxUnmarshaller instance;

    public static DescribeSpotFleetInstancesResultStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new DescribeSpotFleetInstancesResultStaxUnmarshaller();
        return instance;
    }
}
