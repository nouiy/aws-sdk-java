...
/**
 * DescribeIpamsRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeIpamsRequestMarshaller implements Marshaller<Request<DescribeIpamsRequest>, DescribeIpamsRequest> {
    ...
    public Request<DescribeIpamsRequest> marshall(DescribeIpamsRequest describeIpamsRequest) {
        ...
        Request<DescribeIpamsRequest> request = new DefaultRequest<DescribeIpamsRequest>(describeIpamsRequest, "AmazonEC2");
        request.addParameter("Action", "DescribeIpams");
        request.addParameter("Version", "2016-11-15");
        request.setHttpMethod(HttpMethodName.POST);

        com.amazonaws.internal.SdkInternalList<Filter> describeIpamsRequestFiltersList = (com.amazonaws.internal.SdkInternalList<Filter>) describeIpamsRequest
                .getFilters();
        if (!describeIpamsRequestFiltersList.isEmpty() || !describeIpamsRequestFiltersList.isAutoConstruct()) {
            ...
            for (Filter describeIpamsRequestFiltersListValue : describeIpamsRequestFiltersList) {
                ...
                com.amazonaws.internal.SdkInternalList<String> filterValuesList = (com.amazonaws.internal.SdkInternalList<String>) describeIpamsRequestFiltersListValue
                        .getValues();
        ...
        com.amazonaws.internal.SdkInternalList<String> describeIpamsRequestIpamIdsList = (com.amazonaws.internal.SdkInternalList<String>) describeIpamsRequest
                .getIpamIds();
        if (!describeIpamsRequestIpamIdsList.isEmpty() || !describeIpamsRequestIpamIdsList.isAutoConstruct()) {
