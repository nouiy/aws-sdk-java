...
public class PurchaseRequestStaxUnmarshaller implements Unmarshaller<PurchaseRequest, StaxUnmarshallerContext> {
    ...
    private static PurchaseRequestStaxUnmarshaller instance;

    public static PurchaseRequestStaxUnmarshaller getInstance() {
        if (instance == null)
            instance = new PurchaseRequestStaxUnmarshaller();
        return instance;
    }
}
