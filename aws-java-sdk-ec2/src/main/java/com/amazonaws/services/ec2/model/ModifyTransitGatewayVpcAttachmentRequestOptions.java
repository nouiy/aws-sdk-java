 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ModifyTransitGatewayVpcAttachmentRequestOptions"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ModifyTransitGatewayVpcAttachmentRequestOptions implements Serializable, Cloneable {
    ...
    public ModifyTransitGatewayVpcAttachmentRequestOptions withSecurityGroupReferencingSupport(String securityGroupReferencingSupport) {
    ...
    public ModifyTransitGatewayVpcAttachmentRequestOptions withSecurityGroupReferencingSupport(
    ...
    public ModifyTransitGatewayVpcAttachmentRequestOptions clone() {
        try {
            return (ModifyTransitGatewayVpcAttachmentRequestOptions) super.clone();
