...
public class AvailabilityZoneMessageStaxUnmarshaller implements Unmarshaller<AvailabilityZoneMessage, StaxUnmarshallerContext> {
    ...
    public AvailabilityZoneMessage unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("message", targetDepth)) {
                    availabilityZoneMessage.setMessage(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
