...
class InternetGatewayExists {
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeInternetGatewaysResult> {
        ...
        private static final JmesPathExpression ast = new OpGreaterThan(new JmesPathLengthFunction(new JmesPathProjection(new JmesPathFlatten(
                new JmesPathField("InternetGateways")), new JmesPathField("InternetGatewayId"))), new JmesPathLiteral("0"));
         ...
         */
        @Override
        public boolean matches(DescribeInternetGatewaysResult result) {
    ...
    static class IsInvalidInternetGatewayNotFoundMatcher extends WaiterAcceptor<DescribeInternetGatewaysResult> {
        ...
        public boolean matches(AmazonServiceException e) {
            return "InvalidInternetGateway.NotFound".equals(e.getErrorCode());
        }
