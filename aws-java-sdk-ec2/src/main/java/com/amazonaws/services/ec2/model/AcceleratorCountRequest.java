 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/AcceleratorCountRequest" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AcceleratorCountRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The minimum number of accelerators. To specify no minimum limit, omit this parameter.
     */
     ...
     * </p>
     * 
     * @return The maximum number of accelerators. To specify no maximum limit, omit this parameter. To exclude
     *         accelerator-enabled instance types, set <code>Max</code> to <code>0</code>.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceleratorCountRequest == false)
            return false;
        AcceleratorCountRequest other = (AcceleratorCountRequest) obj;
    ...
    public AcceleratorCountRequest clone() {
        try {
            return (AcceleratorCountRequest) super.clone();
