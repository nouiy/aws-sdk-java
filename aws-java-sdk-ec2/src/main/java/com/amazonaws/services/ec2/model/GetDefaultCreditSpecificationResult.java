...
public class GetDefaultCreditSpecificationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public GetDefaultCreditSpecificationResult withInstanceFamilyCreditSpecification(InstanceFamilyCreditSpecification instanceFamilyCreditSpecification) {
    ...
    @Override
    public GetDefaultCreditSpecificationResult clone() {
        try {
            return (GetDefaultCreditSpecificationResult) super.clone();
