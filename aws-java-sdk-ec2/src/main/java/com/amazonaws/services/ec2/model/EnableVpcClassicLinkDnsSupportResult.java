...
public class EnableVpcClassicLinkDnsSupportResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableVpcClassicLinkDnsSupportResult == false)
            return false;
        EnableVpcClassicLinkDnsSupportResult other = (EnableVpcClassicLinkDnsSupportResult) obj;
    ...
    @Override
    public EnableVpcClassicLinkDnsSupportResult clone() {
        try {
            return (EnableVpcClassicLinkDnsSupportResult) super.clone();
