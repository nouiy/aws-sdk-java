...
public class ModifyVpcEndpointConnectionNotificationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVpcEndpointConnectionNotificationResult == false)
            return false;
        ModifyVpcEndpointConnectionNotificationResult other = (ModifyVpcEndpointConnectionNotificationResult) obj;
    ...
    @Override
    public ModifyVpcEndpointConnectionNotificationResult clone() {
        try {
            return (ModifyVpcEndpointConnectionNotificationResult) super.clone();
