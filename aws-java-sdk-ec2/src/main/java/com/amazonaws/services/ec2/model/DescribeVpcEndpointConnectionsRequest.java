...
import com.amazonaws.services.ec2.model.transform.DescribeVpcEndpointConnectionsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeVpcEndpointConnectionsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DescribeVpcEndpointConnectionsRequest> {
     ...
     */
    @Override
    public Request<DescribeVpcEndpointConnectionsRequest> getDryRunRequest() {
        Request<DescribeVpcEndpointConnectionsRequest> request = new DescribeVpcEndpointConnectionsRequestMarshaller().marshall(this);
    ...
    public DescribeVpcEndpointConnectionsRequest clone() {
        return (DescribeVpcEndpointConnectionsRequest) super.clone();
    }
}
