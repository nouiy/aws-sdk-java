...
public class ModifyVpnTunnelOptionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyVpnTunnelOptionsResult withVpnConnection(VpnConnection vpnConnection) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVpnTunnelOptionsResult == false)
            return false;
        ModifyVpnTunnelOptionsResult other = (ModifyVpnTunnelOptionsResult) obj;
    ...
    @Override
    public ModifyVpnTunnelOptionsResult clone() {
        try {
            return (ModifyVpnTunnelOptionsResult) super.clone();
