...
/**
 * CpuOptions StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CpuOptionsStaxUnmarshaller implements Unmarshaller<CpuOptions, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("coreCount", targetDepth)) {
                    cpuOptions.setCoreCount(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
