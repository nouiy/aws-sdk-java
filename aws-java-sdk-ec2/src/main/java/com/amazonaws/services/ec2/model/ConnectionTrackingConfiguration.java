 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/ConnectionTrackingConfiguration"
...
public class ConnectionTrackingConfiguration implements Serializable, Cloneable {
    ...
    public ConnectionTrackingConfiguration withTcpEstablishedTimeout(Integer tcpEstablishedTimeout) {
    ...
    public ConnectionTrackingConfiguration withUdpStreamTimeout(Integer udpStreamTimeout) {
    ...
    public ConnectionTrackingConfiguration withUdpTimeout(Integer udpTimeout) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConnectionTrackingConfiguration == false)
            return false;
        ConnectionTrackingConfiguration other = (ConnectionTrackingConfiguration) obj;
    ...
    @Override
    public ConnectionTrackingConfiguration clone() {
        try {
