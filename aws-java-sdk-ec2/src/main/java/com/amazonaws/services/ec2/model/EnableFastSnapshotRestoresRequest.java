...
public class EnableFastSnapshotRestoresRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
    ...
    public EnableFastSnapshotRestoresRequest withAvailabilityZones(java.util.Collection<String> availabilityZones) {
    ...
    public EnableFastSnapshotRestoresRequest withSourceSnapshotIds(java.util.Collection<String> sourceSnapshotIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EnableFastSnapshotRestoresRequest == false)
            return false;
