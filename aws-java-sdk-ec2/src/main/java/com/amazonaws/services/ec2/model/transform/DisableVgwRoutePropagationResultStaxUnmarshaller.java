...
public class DisableVgwRoutePropagationResultStaxUnmarshaller implements Unmarshaller<DisableVgwRoutePropagationResult, StaxUnmarshallerContext> {

    public DisableVgwRoutePropagationResult unmarshall(StaxUnmarshallerContext context) throws Exception {
