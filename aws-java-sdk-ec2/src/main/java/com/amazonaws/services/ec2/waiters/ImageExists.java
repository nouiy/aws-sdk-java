...
class ImageExists {
    ...
    static class IsTrueMatcher extends WaiterAcceptor<DescribeImagesResult> {
        ...
        private static final JmesPathExpression ast = new OpGreaterThan(new JmesPathLengthFunction(new JmesPathProjection(new JmesPathFlatten(
                new JmesPathField("Images")), new JmesPathIdentity())), new JmesPathLiteral("0"));
    ...
    static class IsInvalidAMIIDNotFoundMatcher extends WaiterAcceptor<DescribeImagesResult> {
        /**
        ...
        public boolean matches(AmazonServiceException e) {
            return "InvalidAMIID.NotFound".equals(e.getErrorCode());
        }
