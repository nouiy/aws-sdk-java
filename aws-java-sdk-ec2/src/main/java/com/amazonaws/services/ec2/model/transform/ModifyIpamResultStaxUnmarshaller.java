        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("ipam", targetDepth)) {
                    modifyIpamResult.setIpam(IpamStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
