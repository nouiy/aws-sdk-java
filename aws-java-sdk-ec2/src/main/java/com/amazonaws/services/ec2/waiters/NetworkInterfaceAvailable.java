...
class NetworkInterfaceAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeNetworkInterfacesResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("NetworkInterfaces")), new JmesPathField(
                "Status"));
    ...
    static class IsInvalidNetworkInterfaceIDNotFoundMatcher extends WaiterAcceptor<DescribeNetworkInterfacesResult> {
        /**
