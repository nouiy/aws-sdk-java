...
public class AcceptVpcEndpointConnectionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the interface endpoints that were not accepted, if applicable.
     */
    ...
    public AcceptVpcEndpointConnectionsResult withUnsuccessful(UnsuccessfulItem... unsuccessful) {
    ...
    public AcceptVpcEndpointConnectionsResult withUnsuccessful(java.util.Collection<UnsuccessfulItem> unsuccessful) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptVpcEndpointConnectionsResult == false)
            return false;
        AcceptVpcEndpointConnectionsResult other = (AcceptVpcEndpointConnectionsResult) obj;
    ...
    @Override
    public AcceptVpcEndpointConnectionsResult clone() {
        try {
            return (AcceptVpcEndpointConnectionsResult) super.clone();
