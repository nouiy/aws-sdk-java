...
public class SearchLocalGatewayRoutesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.amazonaws.internal.SdkInternalList<LocalGatewayRoute> routes;
    /**
     * <p>
    ...
    public java.util.List<LocalGatewayRoute> getRoutes() {
        if (routes == null) {
            routes = new com.amazonaws.internal.SdkInternalList<LocalGatewayRoute>();
        }
        return routes;
    }
    ...
    public void setRoutes(java.util.Collection<LocalGatewayRoute> routes) {
        ...
        this.routes = new com.amazonaws.internal.SdkInternalList<LocalGatewayRoute>(routes);
    }
    ...
    public SearchLocalGatewayRoutesResult withRoutes(LocalGatewayRoute... routes) {
        if (this.routes == null) {
            setRoutes(new com.amazonaws.internal.SdkInternalList<LocalGatewayRoute>(routes.length));
        }
        for (LocalGatewayRoute ele : routes) {
            this.routes.add(ele);
        }
        return this;
    }
