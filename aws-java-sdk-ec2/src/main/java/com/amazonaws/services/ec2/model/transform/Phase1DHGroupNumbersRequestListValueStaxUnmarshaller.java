...
/**
 * Phase1DHGroupNumbersRequestListValue StAX Unmarshaller
 */
...
public class Phase1DHGroupNumbersRequestListValueStaxUnmarshaller implements Unmarshaller<Phase1DHGroupNumbersRequestListValue, StaxUnmarshallerContext> {
    ...
    public Phase1DHGroupNumbersRequestListValue unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Value", targetDepth)) {
                    phase1DHGroupNumbersRequestListValue.setValue(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
