 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/TransitGatewayMulticastRegisteredGroupMembers"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TransitGatewayMulticastRegisteredGroupMembers implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the registered network interfaces.
     */
    ...
    public TransitGatewayMulticastRegisteredGroupMembers withRegisteredNetworkInterfaceIds(String... registeredNetworkInterfaceIds) {
    ...
    public TransitGatewayMulticastRegisteredGroupMembers withRegisteredNetworkInterfaceIds(java.util.Collection<String> registeredNetworkInterfaceIds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TransitGatewayMulticastRegisteredGroupMembers == false)
            return false;
        TransitGatewayMulticastRegisteredGroupMembers other = (TransitGatewayMulticastRegisteredGroupMembers) obj;
    ...
    public TransitGatewayMulticastRegisteredGroupMembers clone() {
        try {
            return (TransitGatewayMulticastRegisteredGroupMembers) super.clone();
