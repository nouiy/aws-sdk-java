...
public class ModifyInstanceEventStartTimeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyInstanceEventStartTimeResult == false)
            return false;
        ModifyInstanceEventStartTimeResult other = (ModifyInstanceEventStartTimeResult) obj;
    ...
    @Override
    public ModifyInstanceEventStartTimeResult clone() {
        try {
            return (ModifyInstanceEventStartTimeResult) super.clone();
