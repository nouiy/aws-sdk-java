...
import com.amazonaws.services.ec2.model.transform.AcceptTransitGatewayMulticastDomainAssociationsRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AcceptTransitGatewayMulticastDomainAssociationsRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<AcceptTransitGatewayMulticastDomainAssociationsRequest> {
    ...
    public AcceptTransitGatewayMulticastDomainAssociationsRequest withSubnetIds(java.util.Collection<String> subnetIds) {
     ...
     */
    @Override
    public Request<AcceptTransitGatewayMulticastDomainAssociationsRequest> getDryRunRequest() {
        Request<AcceptTransitGatewayMulticastDomainAssociationsRequest> request = new AcceptTransitGatewayMulticastDomainAssociationsRequestMarshaller()
                .marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AcceptTransitGatewayMulticastDomainAssociationsRequest == false)
            return false;
        AcceptTransitGatewayMulticastDomainAssociationsRequest other = (AcceptTransitGatewayMulticastDomainAssociationsRequest) obj;
    ...
    public AcceptTransitGatewayMulticastDomainAssociationsRequest clone() {
        return (AcceptTransitGatewayMulticastDomainAssociationsRequest) super.clone();
    }
}
