...
public class DescribeExportTasksFunction implements SdkFunction<DescribeExportTasksRequest, DescribeExportTasksResult> {
     ...
     */
    @Override
    public DescribeExportTasksResult apply(DescribeExportTasksRequest describeExportTasksRequest) {
