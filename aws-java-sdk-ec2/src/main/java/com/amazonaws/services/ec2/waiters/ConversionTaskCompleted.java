...
class ConversionTaskCompleted {
    ...
    static class IsCompletedMatcher extends WaiterAcceptor<DescribeConversionTasksResult> {
    ...
    static class IsCancelledMatcher extends WaiterAcceptor<DescribeConversionTasksResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCancellingMatcher extends WaiterAcceptor<DescribeConversionTasksResult> {
        private static final JsonNode expectedResult;
