...
public class EnableEbsEncryptionByDefaultResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    @Override
    public EnableEbsEncryptionByDefaultResult clone() {
        try {
            return (EnableEbsEncryptionByDefaultResult) super.clone();
