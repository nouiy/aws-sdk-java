...
public class DisassociateInstanceEventWindowRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DisassociateInstanceEventWindowRequest> {
    ...
    public void setAssociationTarget(InstanceEventWindowDisassociationRequest associationTarget) {
    ...
    public Request<DisassociateInstanceEventWindowRequest> getDryRunRequest() {
        Request<DisassociateInstanceEventWindowRequest> request = new DisassociateInstanceEventWindowRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateInstanceEventWindowRequest == false)
            return false;
