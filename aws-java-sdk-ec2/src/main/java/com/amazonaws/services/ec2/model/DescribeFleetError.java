 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFleetError" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DescribeFleetError implements Serializable, Cloneable {
    ...
    public DescribeFleetError withLaunchTemplateAndOverrides(LaunchTemplateAndOverridesResponse launchTemplateAndOverrides) {
    ...
    @Override
    public DescribeFleetError clone() {
        try {
            return (DescribeFleetError) super.clone();
