...
public class RejectTransitGatewayPeeringAttachmentRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<RejectTransitGatewayPeeringAttachmentRequest> {
    ...
    public Request<RejectTransitGatewayPeeringAttachmentRequest> getDryRunRequest() {
        Request<RejectTransitGatewayPeeringAttachmentRequest> request = new RejectTransitGatewayPeeringAttachmentRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectTransitGatewayPeeringAttachmentRequest == false)
            return false;
        RejectTransitGatewayPeeringAttachmentRequest other = (RejectTransitGatewayPeeringAttachmentRequest) obj;
    ...
    @Override
    public RejectTransitGatewayPeeringAttachmentRequest clone() {
