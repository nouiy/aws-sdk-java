...
public class DeleteFpgaImageResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteFpgaImageResult withReturn(Boolean returnValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteFpgaImageResult == false)
            return false;
        DeleteFpgaImageResult other = (DeleteFpgaImageResult) obj;
    ...
    @Override
    public DeleteFpgaImageResult clone() {
        try {
            return (DeleteFpgaImageResult) super.clone();
