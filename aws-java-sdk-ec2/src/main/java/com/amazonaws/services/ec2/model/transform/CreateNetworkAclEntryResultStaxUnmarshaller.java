...
public class CreateNetworkAclEntryResultStaxUnmarshaller implements Unmarshaller<CreateNetworkAclEntryResult, StaxUnmarshallerContext> {

    public CreateNetworkAclEntryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
