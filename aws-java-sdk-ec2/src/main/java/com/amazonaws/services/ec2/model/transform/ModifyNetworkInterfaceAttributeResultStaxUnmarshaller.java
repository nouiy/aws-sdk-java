...
public class ModifyNetworkInterfaceAttributeResultStaxUnmarshaller implements Unmarshaller<ModifyNetworkInterfaceAttributeResult, StaxUnmarshallerContext> {

    public ModifyNetworkInterfaceAttributeResult unmarshall(StaxUnmarshallerContext context) throws Exception {
