...
/**
 * DeleteIpamRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteIpamRequestMarshaller implements Marshaller<Request<DeleteIpamRequest>, DeleteIpamRequest> {
    ...
    public Request<DeleteIpamRequest> marshall(DeleteIpamRequest deleteIpamRequest) {
        ...
        Request<DeleteIpamRequest> request = new DefaultRequest<DeleteIpamRequest>(deleteIpamRequest, "AmazonEC2");
