...
public class DeleteNetworkAclEntryResultStaxUnmarshaller implements Unmarshaller<DeleteNetworkAclEntryResult, StaxUnmarshallerContext> {

    public DeleteNetworkAclEntryResult unmarshall(StaxUnmarshallerContext context) throws Exception {
