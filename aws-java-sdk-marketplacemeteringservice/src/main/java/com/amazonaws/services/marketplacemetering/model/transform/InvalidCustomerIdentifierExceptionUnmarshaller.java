...
public class InvalidCustomerIdentifierExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidCustomerIdentifierExceptionUnmarshaller instance;

    public static InvalidCustomerIdentifierExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidCustomerIdentifierExceptionUnmarshaller();
        return instance;
    }
}
