...
public class TimestampOutOfBoundsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static TimestampOutOfBoundsExceptionUnmarshaller instance;

    public static TimestampOutOfBoundsExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new TimestampOutOfBoundsExceptionUnmarshaller();
        return instance;
    }
}
