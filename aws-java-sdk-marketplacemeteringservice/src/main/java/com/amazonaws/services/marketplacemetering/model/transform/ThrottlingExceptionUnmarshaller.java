...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.marketplacemetering.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.marketplacemetering.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.marketplacemetering.model.ThrottlingException throttlingException = new com.amazonaws.services.marketplacemetering.model.ThrottlingException(
                null);
