...
@SdkInternalApi
public class BatchMeterUsageRequestMarshaller {

    private static final MarshallingInfo<List> USAGERECORDS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("UsageRecords").build();
    ...
    private static final BatchMeterUsageRequestMarshaller instance = new BatchMeterUsageRequestMarshaller();

    public static BatchMeterUsageRequestMarshaller getInstance() {
        return instance;
    }
