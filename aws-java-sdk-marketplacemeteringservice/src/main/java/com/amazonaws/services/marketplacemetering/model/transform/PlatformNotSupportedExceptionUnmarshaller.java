...
public class PlatformNotSupportedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static PlatformNotSupportedExceptionUnmarshaller instance;

    public static PlatformNotSupportedExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new PlatformNotSupportedExceptionUnmarshaller();
        return instance;
    }
}
