...
public class InvalidProductCodeExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidProductCodeExceptionUnmarshaller instance;

    public static InvalidProductCodeExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidProductCodeExceptionUnmarshaller();
        return instance;
    }
}
