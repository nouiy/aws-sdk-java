...
public class InvalidUsageDimensionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static InvalidUsageDimensionExceptionUnmarshaller instance;

    public static InvalidUsageDimensionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new InvalidUsageDimensionExceptionUnmarshaller();
        return instance;
    }
}
