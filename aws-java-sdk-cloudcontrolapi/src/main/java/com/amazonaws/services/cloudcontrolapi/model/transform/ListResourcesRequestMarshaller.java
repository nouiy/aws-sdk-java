...
public class ListResourcesRequestMarshaller {
    ...
    public void marshall(ListResourcesRequest listResourcesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listResourcesRequest.getTypeName(), TYPENAME_BINDING);
            protocolMarshaller.marshall(listResourcesRequest.getTypeVersionId(), TYPEVERSIONID_BINDING);
            protocolMarshaller.marshall(listResourcesRequest.getRoleArn(), ROLEARN_BINDING);
            ...
            protocolMarshaller.marshall(listResourcesRequest.getResourceModel(), RESOURCEMODEL_BINDING);
        } catch (Exception e) {
