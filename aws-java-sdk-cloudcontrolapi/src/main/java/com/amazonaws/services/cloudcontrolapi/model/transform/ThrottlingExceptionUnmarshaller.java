...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.cloudcontrolapi.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.cloudcontrolapi.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.cloudcontrolapi.model.ThrottlingException throttlingException = new com.amazonaws.services.cloudcontrolapi.model.ThrottlingException(
                null);
