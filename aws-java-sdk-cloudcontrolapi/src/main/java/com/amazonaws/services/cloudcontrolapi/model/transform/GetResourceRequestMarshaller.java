...
public class GetResourceRequestMarshaller {
    ...
    public void marshall(GetResourceRequest getResourceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getResourceRequest.getTypeName(), TYPENAME_BINDING);
            protocolMarshaller.marshall(getResourceRequest.getTypeVersionId(), TYPEVERSIONID_BINDING);
            protocolMarshaller.marshall(getResourceRequest.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(getResourceRequest.getIdentifier(), IDENTIFIER_BINDING);
        } catch (Exception e) {
