...
/**
 * ResourceDescriptionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ResourceDescriptionMarshaller {
    ...
    private static final ResourceDescriptionMarshaller instance = new ResourceDescriptionMarshaller();

    public static ResourceDescriptionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ResourceDescription resourceDescription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceDescription.getIdentifier(), IDENTIFIER_BINDING);
            protocolMarshaller.marshall(resourceDescription.getProperties(), PROPERTIES_BINDING);
        } catch (Exception e) {
