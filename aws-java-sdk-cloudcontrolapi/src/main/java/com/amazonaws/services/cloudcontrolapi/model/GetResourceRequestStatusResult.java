...
public class GetResourceRequestStatusResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetResourceRequestStatusResult == false)
            return false;
        GetResourceRequestStatusResult other = (GetResourceRequestStatusResult) obj;
    ...
    public GetResourceRequestStatusResult clone() {
        try {
            return (GetResourceRequestStatusResult) super.clone();
