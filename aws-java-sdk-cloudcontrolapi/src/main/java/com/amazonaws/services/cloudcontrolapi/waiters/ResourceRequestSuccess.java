...
class ResourceRequestSuccess {
    ...
    static class IsSUCCESSMatcher extends WaiterAcceptor<GetResourceRequestStatusResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathSubExpression(new JmesPathField("ProgressEvent"), new JmesPathField("OperationStatus"));
         ...
         */
        @Override
        public boolean matches(GetResourceRequestStatusResult result) {
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetResourceRequestStatusResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCEL_COMPLETEMatcher extends WaiterAcceptor<GetResourceRequestStatusResult> {
        private static final JsonNode expectedResult;

        static {
            try {
                expectedResult = ObjectMapperSingleton.getObjectMapper().readTree("\"CANCEL_COMPLETE\"");
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }
        }
