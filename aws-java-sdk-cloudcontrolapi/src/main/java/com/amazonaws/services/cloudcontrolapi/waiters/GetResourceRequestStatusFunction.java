...
public class GetResourceRequestStatusFunction implements SdkFunction<GetResourceRequestStatusRequest, GetResourceRequestStatusResult> {
    ...
    /**
     * Constructs a new GetResourceRequestStatusFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetResourceRequestStatusFunction(AWSCloudControlApi client) {
        this.client = client;
    }
    ...
    public GetResourceRequestStatusResult apply(GetResourceRequestStatusRequest getResourceRequestStatusRequest) {
        return client.getResourceRequestStatus(getResourceRequestStatusRequest);
    }
}
