...
public class ListConfigurationProfilesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListConfigurationProfilesResult withItems(ConfigurationProfileSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<ConfigurationProfileSummary>(items.length));
        }
        for (ConfigurationProfileSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListConfigurationProfilesResult withItems(java.util.Collection<ConfigurationProfileSummary> items) {
        setItems(items);
        return this;
    }
    ...
    @Override
    public ListConfigurationProfilesResult clone() {
        try {
            return (ListConfigurationProfilesResult) super.clone();
