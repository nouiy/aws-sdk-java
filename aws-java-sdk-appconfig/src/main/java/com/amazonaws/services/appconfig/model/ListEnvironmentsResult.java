...
public class ListEnvironmentsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<Environment> items;
    /**
     * <p>
    ...
    public java.util.List<Environment> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<Environment> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<Environment>(items);
    }
    ...
    public ListEnvironmentsResult withItems(Environment... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<Environment>(items.length));
        }
        for (Environment ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListEnvironmentsResult withItems(java.util.Collection<Environment> items) {
        setItems(items);
        return this;
    }
