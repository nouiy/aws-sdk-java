...
public class GetHostedConfigurationVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetHostedConfigurationVersionRequest withApplicationId(String applicationId) {
    ...
    public GetHostedConfigurationVersionRequest withConfigurationProfileId(String configurationProfileId) {
    ...
    public GetHostedConfigurationVersionRequest withVersionNumber(Integer versionNumber) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetHostedConfigurationVersionRequest == false)
            return false;
        GetHostedConfigurationVersionRequest other = (GetHostedConfigurationVersionRequest) obj;
    ...
    @Override
    public GetHostedConfigurationVersionRequest clone() {
        return (GetHostedConfigurationVersionRequest) super.clone();
    }
