...
public class CreateEnvironmentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateEnvironmentResult withApplicationId(String applicationId) {
    ...
    public CreateEnvironmentResult withMonitors(Monitor... monitors) {
    ...
    public CreateEnvironmentResult withMonitors(java.util.Collection<Monitor> monitors) {
