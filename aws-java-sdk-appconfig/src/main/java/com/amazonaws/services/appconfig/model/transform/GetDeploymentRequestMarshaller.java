...
public class GetDeploymentRequestMarshaller {
    ...
    public void marshall(GetDeploymentRequest getDeploymentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(getDeploymentRequest.getEnvironmentId(), ENVIRONMENTID_BINDING);
            protocolMarshaller.marshall(getDeploymentRequest.getDeploymentNumber(), DEPLOYMENTNUMBER_BINDING);
        } catch (Exception e) {
