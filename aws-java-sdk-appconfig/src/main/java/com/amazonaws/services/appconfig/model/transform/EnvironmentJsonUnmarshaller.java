        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ApplicationId", targetDepth)) {
                    context.nextToken();
                    environment.setApplicationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("State", targetDepth)) {
                    context.nextToken();
                    environment.setState(context.getUnmarshaller(String.class).unmarshall(context));
                }
