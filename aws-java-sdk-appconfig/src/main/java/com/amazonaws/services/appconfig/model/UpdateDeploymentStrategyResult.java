...
public class UpdateDeploymentStrategyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDeploymentStrategyResult withDeploymentDurationInMinutes(Integer deploymentDurationInMinutes) {
    ...
    @Override
    public UpdateDeploymentStrategyResult clone() {
        try {
            return (UpdateDeploymentStrategyResult) super.clone();
