...
public class AccessDeniedExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private AccessDeniedExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockagentruntime.model.AccessDeniedException.class, "AccessDeniedException");
    }

    @Override
    public com.amazonaws.services.bedrockagentruntime.model.AccessDeniedException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockagentruntime.model.AccessDeniedException accessDeniedException = new com.amazonaws.services.bedrockagentruntime.model.AccessDeniedException(
                null);
