...
/**
 * KnowledgeBaseVectorSearchConfigurationMarshaller
 */
...
public class KnowledgeBaseVectorSearchConfigurationMarshaller {
    ...
    public static KnowledgeBaseVectorSearchConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(KnowledgeBaseVectorSearchConfiguration knowledgeBaseVectorSearchConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (knowledgeBaseVectorSearchConfiguration == null) {
