...
/**
 * DeleteAgentMemoryResult JSON Unmarshaller
 */
...
public class DeleteAgentMemoryResultJsonUnmarshaller implements Unmarshaller<DeleteAgentMemoryResult, JsonUnmarshallerContext> {
    ...
    public DeleteAgentMemoryResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAgentMemoryResult deleteAgentMemoryResult = new DeleteAgentMemoryResult();
