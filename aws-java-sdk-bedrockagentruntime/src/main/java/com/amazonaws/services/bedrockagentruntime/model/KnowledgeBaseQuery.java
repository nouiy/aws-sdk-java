...
public class KnowledgeBaseQuery implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KnowledgeBaseQuery == false)
            return false;
    ...
    public KnowledgeBaseQuery clone() {
        try {
            return (KnowledgeBaseQuery) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.bedrockagentruntime.model.transform.KnowledgeBaseQueryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
