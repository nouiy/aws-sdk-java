...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockagentruntime.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.bedrockagentruntime.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockagentruntime.model.ThrottlingException throttlingException = new com.amazonaws.services.bedrockagentruntime.model.ThrottlingException(
                null);
