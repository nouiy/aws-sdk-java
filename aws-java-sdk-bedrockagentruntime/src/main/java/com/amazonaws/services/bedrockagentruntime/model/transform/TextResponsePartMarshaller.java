...
public class TextResponsePartMarshaller {
    ...
    public static TextResponsePartMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TextResponsePart textResponsePart, ProtocolMarshaller protocolMarshaller) {

        if (textResponsePart == null) {
