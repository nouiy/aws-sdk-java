...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockagentruntime.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.bedrockagentruntime.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockagentruntime.model.ValidationException validationException = new com.amazonaws.services.bedrockagentruntime.model.ValidationException(
                null);
