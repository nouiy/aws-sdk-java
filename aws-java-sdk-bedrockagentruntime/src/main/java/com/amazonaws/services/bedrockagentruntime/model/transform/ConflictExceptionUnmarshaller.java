...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.bedrockagentruntime.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.bedrockagentruntime.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bedrockagentruntime.model.ConflictException conflictException = new com.amazonaws.services.bedrockagentruntime.model.ConflictException(
                null);
