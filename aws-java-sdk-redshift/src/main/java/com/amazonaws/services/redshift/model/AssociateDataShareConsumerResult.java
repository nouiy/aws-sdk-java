...
public class AssociateDataShareConsumerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public AssociateDataShareConsumerResult withDataShareArn(String dataShareArn) {
    ...
    public AssociateDataShareConsumerResult withProducerArn(String producerArn) {
    ...
    public AssociateDataShareConsumerResult withAllowPubliclyAccessibleConsumers(Boolean allowPubliclyAccessibleConsumers) {
    ...
    public AssociateDataShareConsumerResult withDataShareAssociations(DataShareAssociation... dataShareAssociations) {
    ...
    public AssociateDataShareConsumerResult withDataShareAssociations(java.util.Collection<DataShareAssociation> dataShareAssociations) {
    ...
    public AssociateDataShareConsumerResult withManagedBy(String managedBy) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateDataShareConsumerResult == false)
            return false;
        AssociateDataShareConsumerResult other = (AssociateDataShareConsumerResult) obj;
    ...
    @Override
    public AssociateDataShareConsumerResult clone() {
        try {
