...
class SnapshotAvailable {
    ...
    static class IsAvailableMatcher extends WaiterAcceptor<DescribeClusterSnapshotsResult> {
        ...
        private static final JmesPathExpression ast = new JmesPathProjection(new JmesPathFlatten(new JmesPathField("Snapshots")), new JmesPathField("Status"));
         ...
         */
        @Override
        public boolean matches(DescribeClusterSnapshotsResult result) {
    ...
    static class IsFailedMatcher extends WaiterAcceptor<DescribeClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsDeletedMatcher extends WaiterAcceptor<DescribeClusterSnapshotsResult> {
        private static final JsonNode expectedResult;
