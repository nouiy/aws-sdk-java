        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Marker", targetDepth)) {
                    describeScheduledActionsResult.setMarker(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("ScheduledActions", targetDepth)) {
                    describeScheduledActionsResult.withScheduledActions(new ArrayList<ScheduledAction>());
                    continue;
                }

                if (context.testExpression("ScheduledActions/ScheduledAction", targetDepth)) {
                    describeScheduledActionsResult.withScheduledActions(ScheduledActionStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
