...
public class UpdatePartnerStatusResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdatePartnerStatusResult withDatabaseName(String databaseName) {
    ...
    public UpdatePartnerStatusResult withPartnerName(String partnerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePartnerStatusResult == false)
            return false;
        UpdatePartnerStatusResult other = (UpdatePartnerStatusResult) obj;
    ...
    @Override
    public UpdatePartnerStatusResult clone() {
        try {
