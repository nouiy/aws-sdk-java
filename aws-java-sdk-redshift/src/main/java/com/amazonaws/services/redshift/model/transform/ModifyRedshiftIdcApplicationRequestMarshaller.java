...
public class ModifyRedshiftIdcApplicationRequestMarshaller implements
        Marshaller<Request<ModifyRedshiftIdcApplicationRequest>, ModifyRedshiftIdcApplicationRequest> {

    public Request<ModifyRedshiftIdcApplicationRequest> marshall(ModifyRedshiftIdcApplicationRequest modifyRedshiftIdcApplicationRequest) {

        if (modifyRedshiftIdcApplicationRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        Request<ModifyRedshiftIdcApplicationRequest> request = new DefaultRequest<ModifyRedshiftIdcApplicationRequest>(modifyRedshiftIdcApplicationRequest,
                "AmazonRedshift");
        ...
        if (!modifyRedshiftIdcApplicationRequest.getAuthorizedTokenIssuerList().isEmpty()
                || !((com.amazonaws.internal.SdkInternalList<AuthorizedTokenIssuer>) modifyRedshiftIdcApplicationRequest.getAuthorizedTokenIssuerList())
                        .isAutoConstruct()) {
            com.amazonaws.internal.SdkInternalList<AuthorizedTokenIssuer> authorizedTokenIssuerListList = (com.amazonaws.internal.SdkInternalList<AuthorizedTokenIssuer>) modifyRedshiftIdcApplicationRequest
        ...
        if (!modifyRedshiftIdcApplicationRequest.getServiceIntegrations().isEmpty()
                || !((com.amazonaws.internal.SdkInternalList<ServiceIntegrationsUnion>) modifyRedshiftIdcApplicationRequest.getServiceIntegrations())
                        .isAutoConstruct()) {
            com.amazonaws.internal.SdkInternalList<ServiceIntegrationsUnion> serviceIntegrationsList = (com.amazonaws.internal.SdkInternalList<ServiceIntegrationsUnion>) modifyRedshiftIdcApplicationRequest
