...
public class DeleteClusterSubnetGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteClusterSubnetGroupResult == false)
            return false;
        DeleteClusterSubnetGroupResult other = (DeleteClusterSubnetGroupResult) obj;
        return true;
    }
    ...
    @Override
    public DeleteClusterSubnetGroupResult clone() {
        try {
            return (DeleteClusterSubnetGroupResult) super.clone();
