...
public class ModifyScheduledActionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ModifyScheduledActionResult withNextInvocations(java.util.Collection<java.util.Date> nextInvocations) {
    ...
    public ModifyScheduledActionResult clone() {
        try {
            return (ModifyScheduledActionResult) super.clone();
