...
public class InvalidAuthenticationProfileRequestException extends com.amazonaws.services.redshift.model.AmazonRedshiftException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a new InvalidAuthenticationProfileRequestException with the specified error message.
     *
     * @param message
