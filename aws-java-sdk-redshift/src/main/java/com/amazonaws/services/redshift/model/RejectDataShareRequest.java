...
public class RejectDataShareRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the datashare to reject.
     */
    ...
    public RejectDataShareRequest withDataShareArn(String dataShareArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RejectDataShareRequest == false)
            return false;
        RejectDataShareRequest other = (RejectDataShareRequest) obj;
    ...
    @Override
    public RejectDataShareRequest clone() {
