...
public class DeauthorizeDataShareResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeauthorizeDataShareResult withDataShareAssociations(DataShareAssociation... dataShareAssociations) {
    ...
    public DeauthorizeDataShareResult withDataShareAssociations(java.util.Collection<DataShareAssociation> dataShareAssociations) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeauthorizeDataShareResult == false)
            return false;
        DeauthorizeDataShareResult other = (DeauthorizeDataShareResult) obj;
    ...
    public DeauthorizeDataShareResult clone() {
        try {
            return (DeauthorizeDataShareResult) super.clone();
