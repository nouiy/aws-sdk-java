...
/**
 * LakeFormationQuery StAX Unmarshaller
 */
...
public class LakeFormationQueryStaxUnmarshaller implements Unmarshaller<LakeFormationQuery, StaxUnmarshallerContext> {
    ...
    public LakeFormationQuery unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Authorization", targetDepth)) {
                    lakeFormationQuery.setAuthorization(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
