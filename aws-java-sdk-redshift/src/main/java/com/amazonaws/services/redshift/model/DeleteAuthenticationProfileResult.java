...
public class DeleteAuthenticationProfileResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the authentication profile that was deleted.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAuthenticationProfileResult == false)
            return false;
        DeleteAuthenticationProfileResult other = (DeleteAuthenticationProfileResult) obj;
    ...
    public DeleteAuthenticationProfileResult clone() {
        try {
            return (DeleteAuthenticationProfileResult) super.clone();
