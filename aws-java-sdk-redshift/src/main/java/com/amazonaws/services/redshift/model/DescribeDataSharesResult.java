...
public class DescribeDataSharesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * a <a>DescribeDataShares</a> request exceed the value specified in <code>MaxRecords</code>, Amazon Web Services
     ...
     * </p>
     * 
     * @return The results returned from describing datashares.
     */
    ...
    public DescribeDataSharesResult withDataShares(java.util.Collection<DataShare> dataShares) {
     ...
     *        results of a <a>DescribeDataShares</a> request exceed the value specified in <code>MaxRecords</code>,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeDataSharesResult == false)
            return false;
        DescribeDataSharesResult other = (DescribeDataSharesResult) obj;
    ...
    public DescribeDataSharesResult clone() {
        try {
            return (DescribeDataSharesResult) super.clone();
