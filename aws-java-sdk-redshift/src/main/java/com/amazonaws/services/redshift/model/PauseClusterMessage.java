...
public class PauseClusterMessage implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PauseClusterMessage == false)
            return false;
        PauseClusterMessage other = (PauseClusterMessage) obj;
    ...
    @Override
    public PauseClusterMessage clone() {
        try {
            return (PauseClusterMessage) super.clone();
