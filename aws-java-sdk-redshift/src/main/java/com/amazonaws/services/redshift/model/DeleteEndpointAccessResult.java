...
public class DeleteEndpointAccessResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteEndpointAccessResult withEndpointCreateTime(java.util.Date endpointCreateTime) {
    ...
    public DeleteEndpointAccessResult withVpcSecurityGroups(VpcSecurityGroupMembership... vpcSecurityGroups) {
    ...
    public DeleteEndpointAccessResult withVpcSecurityGroups(java.util.Collection<VpcSecurityGroupMembership> vpcSecurityGroups) {
