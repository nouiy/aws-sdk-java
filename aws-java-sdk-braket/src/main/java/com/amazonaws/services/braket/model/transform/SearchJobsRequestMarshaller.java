...
public class SearchJobsRequestMarshaller {
    ...
    public void marshall(SearchJobsRequest searchJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchJobsRequest.getFilters(), FILTERS_BINDING);
            protocolMarshaller.marshall(searchJobsRequest.getMaxResults(), MAXRESULTS_BINDING);
            protocolMarshaller.marshall(searchJobsRequest.getNextToken(), NEXTTOKEN_BINDING);
        } catch (Exception e) {
