...
public class InternalServiceExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServiceExceptionUnmarshaller() {
        super(com.amazonaws.services.braket.model.InternalServiceException.class, "InternalServiceException");
    }

    @Override
    public com.amazonaws.services.braket.model.InternalServiceException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.braket.model.InternalServiceException internalServiceException = new com.amazonaws.services.braket.model.InternalServiceException(
                null);
