...
public class ListOfferingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * The maximum number of results to return per API request. For example, you submit a ListOfferings request with
     ...
     * 
     * @param maxResults
     *        The maximum number of results to return per API request. For example, you submit a ListOfferings request
     ...
     * defaults to pagination with a maximum of 10 results per page.
     * 
     * @return The maximum number of results to return per API request. For example, you submit a ListOfferings request
