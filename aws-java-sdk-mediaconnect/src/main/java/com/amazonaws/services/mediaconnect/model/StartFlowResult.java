...
public class StartFlowResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * The ARN of the flow that you started.
     * 
     * @return The ARN of the flow that you started.
     */
     ...
     * The status of the flow when the StartFlow process begins.
     * 
     * @return The status of the flow when the StartFlow process begins.
     * @see Status
     */
    ...
    public StartFlowResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public StartFlowResult withStatus(Status status) {
