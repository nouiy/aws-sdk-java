...
public class GrantFlowEntitlementsRequestMarshaller {
    ...
    private static final GrantFlowEntitlementsRequestMarshaller instance = new GrantFlowEntitlementsRequestMarshaller();

    public static GrantFlowEntitlementsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GrantFlowEntitlementsRequest grantFlowEntitlementsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(grantFlowEntitlementsRequest.getEntitlements(), ENTITLEMENTS_BINDING);
            protocolMarshaller.marshall(grantFlowEntitlementsRequest.getFlowArn(), FLOWARN_BINDING);
        } catch (Exception e) {
