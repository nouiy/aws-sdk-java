...
public class DescribeReservationRequestMarshaller {
    ...
    private static final MarshallingInfo<String> RESERVATIONARN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PATH).marshallLocationName("reservationArn").build();
    ...
    public void marshall(DescribeReservationRequest describeReservationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(describeReservationRequest.getReservationArn(), RESERVATIONARN_BINDING);
        } catch (Exception e) {
