 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconnect-2018-11-14/AddMaintenance" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AddMaintenance implements Serializable, Cloneable, StructuredPojo {
    ...
    public AddMaintenance withMaintenanceDay(String maintenanceDay) {
    ...
    public AddMaintenance withMaintenanceDay(MaintenanceDay maintenanceDay) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddMaintenance == false)
            return false;
    ...
    @Override
    public AddMaintenance clone() {
        try {
            return (AddMaintenance) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconnect.model.transform.AddMaintenanceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
