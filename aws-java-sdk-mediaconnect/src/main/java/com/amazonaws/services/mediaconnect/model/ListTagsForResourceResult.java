...
public class ListTagsForResourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * have a maximum length of 256 characters.
     * 
     * @return A map from tag keys to values. Tag keys can have a maximum character length of 128 characters, and tag
     ...
     * 
     * @param tags
     *        A map from tag keys to values. Tag keys can have a maximum character length of 128 characters, and tag
     *        values can have a maximum length of 256 characters.
     */
