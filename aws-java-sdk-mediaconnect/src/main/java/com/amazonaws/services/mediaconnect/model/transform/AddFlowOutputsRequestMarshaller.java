...
public class AddFlowOutputsRequestMarshaller {
    ...
    private static final AddFlowOutputsRequestMarshaller instance = new AddFlowOutputsRequestMarshaller();

    public static AddFlowOutputsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AddFlowOutputsRequest addFlowOutputsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(addFlowOutputsRequest.getFlowArn(), FLOWARN_BINDING);
            protocolMarshaller.marshall(addFlowOutputsRequest.getOutputs(), OUTPUTS_BINDING);
        } catch (Exception e) {
