...
/**
 * MediaStreamOutputConfigurationMarshaller
 */
...
public class MediaStreamOutputConfigurationMarshaller {
    ...
    public void marshall(MediaStreamOutputConfiguration mediaStreamOutputConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(mediaStreamOutputConfiguration.getEncodingName(), ENCODINGNAME_BINDING);
            protocolMarshaller.marshall(mediaStreamOutputConfiguration.getEncodingParameters(), ENCODINGPARAMETERS_BINDING);
            protocolMarshaller.marshall(mediaStreamOutputConfiguration.getMediaStreamName(), MEDIASTREAMNAME_BINDING);
        } catch (Exception e) {
