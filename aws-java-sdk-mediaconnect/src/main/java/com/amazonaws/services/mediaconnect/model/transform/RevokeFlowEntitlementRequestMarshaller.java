...
/**
 * RevokeFlowEntitlementRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RevokeFlowEntitlementRequestMarshaller {
    ...
    private static final RevokeFlowEntitlementRequestMarshaller instance = new RevokeFlowEntitlementRequestMarshaller();

    public static RevokeFlowEntitlementRequestMarshaller getInstance() {
        return instance;
    }
