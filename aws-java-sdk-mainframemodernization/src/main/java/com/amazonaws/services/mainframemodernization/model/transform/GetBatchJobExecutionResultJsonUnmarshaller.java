...
/**
 * GetBatchJobExecutionResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetBatchJobExecutionResultJsonUnmarshaller implements Unmarshaller<GetBatchJobExecutionResult, JsonUnmarshallerContext> {

    public GetBatchJobExecutionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetBatchJobExecutionResult getBatchJobExecutionResult = new GetBatchJobExecutionResult();
    ...
    private static GetBatchJobExecutionResultJsonUnmarshaller instance;

    public static GetBatchJobExecutionResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetBatchJobExecutionResultJsonUnmarshaller();
        return instance;
    }
}
