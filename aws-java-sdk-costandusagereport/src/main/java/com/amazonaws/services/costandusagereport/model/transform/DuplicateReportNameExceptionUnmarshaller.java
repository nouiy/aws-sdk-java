...
public class DuplicateReportNameExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static DuplicateReportNameExceptionUnmarshaller instance;

    public static DuplicateReportNameExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new DuplicateReportNameExceptionUnmarshaller();
        return instance;
    }
}
