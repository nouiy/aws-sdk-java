...
/**
 * PlacementDescription JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PlacementDescriptionJsonUnmarshaller implements Unmarshaller<PlacementDescription, JsonUnmarshallerContext> {

    public PlacementDescription unmarshall(JsonUnmarshallerContext context) throws Exception {
        PlacementDescription placementDescription = new PlacementDescription();
    ...
    private static PlacementDescriptionJsonUnmarshaller instance;

    public static PlacementDescriptionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PlacementDescriptionJsonUnmarshaller();
        return instance;
    }
}
