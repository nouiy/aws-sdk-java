...
/**
 * UpdatePlacementResult JSON Unmarshaller
 */
...
public class UpdatePlacementResultJsonUnmarshaller implements Unmarshaller<UpdatePlacementResult, JsonUnmarshallerContext> {
    ...
    public UpdatePlacementResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePlacementResult updatePlacementResult = new UpdatePlacementResult();
