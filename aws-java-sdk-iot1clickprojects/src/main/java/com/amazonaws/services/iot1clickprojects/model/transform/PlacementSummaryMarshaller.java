...
/**
 * PlacementSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PlacementSummaryMarshaller {
    ...
    private static final PlacementSummaryMarshaller instance = new PlacementSummaryMarshaller();

    public static PlacementSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PlacementSummary placementSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(placementSummary.getProjectName(), PROJECTNAME_BINDING);
            protocolMarshaller.marshall(placementSummary.getPlacementName(), PLACEMENTNAME_BINDING);
            protocolMarshaller.marshall(placementSummary.getCreatedDate(), CREATEDDATE_BINDING);
            protocolMarshaller.marshall(placementSummary.getUpdatedDate(), UPDATEDDATE_BINDING);
        } catch (Exception e) {
