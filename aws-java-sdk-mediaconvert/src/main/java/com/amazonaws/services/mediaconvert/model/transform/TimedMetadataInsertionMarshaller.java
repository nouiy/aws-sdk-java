...
/**
 * TimedMetadataInsertionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TimedMetadataInsertionMarshaller {

    private static final MarshallingInfo<List> ID3INSERTIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("id3Insertions").build();
