...
public enum DashIsoIntervalCadence {
    ...
    private DashIsoIntervalCadence(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return DashIsoIntervalCadence corresponding to the value
     *
    ...
    public static DashIsoIntervalCadence fromValue(String value) {
        ...
        for (DashIsoIntervalCadence enumEntry : DashIsoIntervalCadence.values()) {
