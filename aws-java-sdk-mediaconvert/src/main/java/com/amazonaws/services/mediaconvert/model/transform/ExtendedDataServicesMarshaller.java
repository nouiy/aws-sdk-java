...
/**
 * ExtendedDataServicesMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ExtendedDataServicesMarshaller {

    private static final MarshallingInfo<String> COPYPROTECTIONACTION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("copyProtectionAction").build();
    private static final MarshallingInfo<String> VCHIPACTION_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("vchipAction").build();
