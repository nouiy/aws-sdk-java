...
/**
 * M2tsScte35EsamMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class M2tsScte35EsamMarshaller {

    private static final MarshallingInfo<Integer> SCTE35ESAMPID_BINDING = MarshallingInfo.builder(MarshallingType.INTEGER)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("scte35EsamPid").build();
