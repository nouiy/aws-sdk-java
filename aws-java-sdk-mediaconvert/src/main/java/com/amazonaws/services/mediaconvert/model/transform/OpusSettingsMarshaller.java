...
/**
 * OpusSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class OpusSettingsMarshaller {
    ...
    private static final OpusSettingsMarshaller instance = new OpusSettingsMarshaller();

    public static OpusSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(OpusSettings opusSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(opusSettings.getBitrate(), BITRATE_BINDING);
            protocolMarshaller.marshall(opusSettings.getChannels(), CHANNELS_BINDING);
            protocolMarshaller.marshall(opusSettings.getSampleRate(), SAMPLERATE_BINDING);
        } catch (Exception e) {
