...
public class AccelerationSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public AccelerationSettings clone() {
        try {
            return (AccelerationSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconvert.model.transform.AccelerationSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
