 ...
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediaconvert-2017-08-29/HlsAdditionalManifest" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class HlsAdditionalManifest implements Serializable, Cloneable, StructuredPojo {
    ...
    public HlsAdditionalManifest withManifestNameModifier(String manifestNameModifier) {
    ...
    public HlsAdditionalManifest withSelectedOutputs(String... selectedOutputs) {
    ...
    public HlsAdditionalManifest withSelectedOutputs(java.util.Collection<String> selectedOutputs) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof HlsAdditionalManifest == false)
            return false;
    ...
    @Override
    public HlsAdditionalManifest clone() {
        try {
            return (HlsAdditionalManifest) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.mediaconvert.model.transform.HlsAdditionalManifestMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
