...
public enum XavcHdProfileBitrateClass {
    ...
    private XavcHdProfileBitrateClass(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return XavcHdProfileBitrateClass corresponding to the value
     *
    ...
    public static XavcHdProfileBitrateClass fromValue(String value) {
        ...
        for (XavcHdProfileBitrateClass enumEntry : XavcHdProfileBitrateClass.values()) {
