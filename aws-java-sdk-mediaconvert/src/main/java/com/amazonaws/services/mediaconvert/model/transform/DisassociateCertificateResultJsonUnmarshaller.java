...
/**
 * DisassociateCertificateResult JSON Unmarshaller
 */
...
public class DisassociateCertificateResultJsonUnmarshaller implements Unmarshaller<DisassociateCertificateResult, JsonUnmarshallerContext> {
    ...
    public DisassociateCertificateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateCertificateResult disassociateCertificateResult = new DisassociateCertificateResult();
