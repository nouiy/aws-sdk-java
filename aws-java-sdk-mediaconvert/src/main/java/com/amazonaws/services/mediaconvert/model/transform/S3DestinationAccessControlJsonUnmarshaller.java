...
/**
 * S3DestinationAccessControl JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class S3DestinationAccessControlJsonUnmarshaller implements Unmarshaller<S3DestinationAccessControl, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("cannedAcl", targetDepth)) {
                    context.nextToken();
                    s3DestinationAccessControl.setCannedAcl(context.getUnmarshaller(String.class).unmarshall(context));
                }
