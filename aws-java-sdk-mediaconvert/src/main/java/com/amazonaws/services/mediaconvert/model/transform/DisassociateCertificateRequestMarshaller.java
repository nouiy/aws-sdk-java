...
/**
 * DisassociateCertificateRequestMarshaller
 */
...
public class DisassociateCertificateRequestMarshaller {
    ...
    public static DisassociateCertificateRequestMarshaller getInstance() {
        return instance;
    }
    ...
    public void marshall(DisassociateCertificateRequest disassociateCertificateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(disassociateCertificateRequest.getArn(), ARN_BINDING);
        } catch (Exception e) {
