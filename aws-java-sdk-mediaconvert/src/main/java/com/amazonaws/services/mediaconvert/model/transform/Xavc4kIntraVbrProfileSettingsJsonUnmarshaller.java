...
/**
 * Xavc4kIntraVbrProfileSettings JSON Unmarshaller
 */
...
public class Xavc4kIntraVbrProfileSettingsJsonUnmarshaller implements Unmarshaller<Xavc4kIntraVbrProfileSettings, JsonUnmarshallerContext> {
    ...
    public Xavc4kIntraVbrProfileSettings unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("xavcClass", targetDepth)) {
                    context.nextToken();
                    xavc4kIntraVbrProfileSettings.setXavcClass(context.getUnmarshaller(String.class).unmarshall(context));
                }
