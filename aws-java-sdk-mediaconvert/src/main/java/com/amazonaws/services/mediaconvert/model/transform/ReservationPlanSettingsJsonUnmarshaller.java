...
/**
 * ReservationPlanSettings JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReservationPlanSettingsJsonUnmarshaller implements Unmarshaller<ReservationPlanSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("commitment", targetDepth)) {
                    context.nextToken();
                    reservationPlanSettings.setCommitment(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("renewalType", targetDepth)) {
                    context.nextToken();
                    reservationPlanSettings.setRenewalType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("reservedSlots", targetDepth)) {
                    context.nextToken();
                    reservationPlanSettings.setReservedSlots(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
