        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("bitrate", targetDepth)) {
                    context.nextToken();
                    eac3Settings.setBitrate(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                ...
                if (context.testExpression("dynamicRangeCompressionLine", targetDepth)) {
                    context.nextToken();
                    eac3Settings.setDynamicRangeCompressionLine(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("dynamicRangeCompressionRf", targetDepth)) {
                    context.nextToken();
                    eac3Settings.setDynamicRangeCompressionRf(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("sampleRate", targetDepth)) {
                    context.nextToken();
                    eac3Settings.setSampleRate(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
