...
public enum CmafIntervalCadence {
    ...
    private CmafIntervalCadence(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return CmafIntervalCadence corresponding to the value
     *
    ...
    public static CmafIntervalCadence fromValue(String value) {
        ...
        for (CmafIntervalCadence enumEntry : CmafIntervalCadence.values()) {
