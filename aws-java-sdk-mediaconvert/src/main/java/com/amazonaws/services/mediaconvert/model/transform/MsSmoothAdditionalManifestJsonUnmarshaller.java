...
/**
 * MsSmoothAdditionalManifest JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MsSmoothAdditionalManifestJsonUnmarshaller implements Unmarshaller<MsSmoothAdditionalManifest, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("manifestNameModifier", targetDepth)) {
                    context.nextToken();
                    msSmoothAdditionalManifest.setManifestNameModifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("selectedOutputs", targetDepth)) {
                    context.nextToken();
                    msSmoothAdditionalManifest.setSelectedOutputs(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
