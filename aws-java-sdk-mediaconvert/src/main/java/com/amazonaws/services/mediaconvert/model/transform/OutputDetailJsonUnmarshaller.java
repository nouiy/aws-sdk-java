...
/**
 * OutputDetail JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class OutputDetailJsonUnmarshaller implements Unmarshaller<OutputDetail, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("durationInMs", targetDepth)) {
                    context.nextToken();
                    outputDetail.setDurationInMs(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("videoDetails", targetDepth)) {
                    context.nextToken();
                    outputDetail.setVideoDetails(VideoDetailJsonUnmarshaller.getInstance().unmarshall(context));
                }
