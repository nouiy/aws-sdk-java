...
/**
 * CmafImageBasedTrickPlaySettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CmafImageBasedTrickPlaySettingsMarshaller {
    ...
    private static final CmafImageBasedTrickPlaySettingsMarshaller instance = new CmafImageBasedTrickPlaySettingsMarshaller();

    public static CmafImageBasedTrickPlaySettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CmafImageBasedTrickPlaySettings cmafImageBasedTrickPlaySettings, ProtocolMarshaller protocolMarshaller) {

        if (cmafImageBasedTrickPlaySettings == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(cmafImageBasedTrickPlaySettings.getIntervalCadence(), INTERVALCADENCE_BINDING);
            protocolMarshaller.marshall(cmafImageBasedTrickPlaySettings.getThumbnailHeight(), THUMBNAILHEIGHT_BINDING);
            protocolMarshaller.marshall(cmafImageBasedTrickPlaySettings.getThumbnailInterval(), THUMBNAILINTERVAL_BINDING);
            protocolMarshaller.marshall(cmafImageBasedTrickPlaySettings.getThumbnailWidth(), THUMBNAILWIDTH_BINDING);
            protocolMarshaller.marshall(cmafImageBasedTrickPlaySettings.getTileHeight(), TILEHEIGHT_BINDING);
            protocolMarshaller.marshall(cmafImageBasedTrickPlaySettings.getTileWidth(), TILEWIDTH_BINDING);
        } catch (Exception e) {
