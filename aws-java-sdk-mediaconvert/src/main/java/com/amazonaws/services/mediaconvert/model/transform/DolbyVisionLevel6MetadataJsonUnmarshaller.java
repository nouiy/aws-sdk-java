...
/**
 * DolbyVisionLevel6Metadata JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DolbyVisionLevel6MetadataJsonUnmarshaller implements Unmarshaller<DolbyVisionLevel6Metadata, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("maxCll", targetDepth)) {
                    context.nextToken();
                    dolbyVisionLevel6Metadata.setMaxCll(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("maxFall", targetDepth)) {
                    context.nextToken();
                    dolbyVisionLevel6Metadata.setMaxFall(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
