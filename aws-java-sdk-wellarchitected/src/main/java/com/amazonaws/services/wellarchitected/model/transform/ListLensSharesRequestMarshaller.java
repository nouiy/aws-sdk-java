...
/**
 * ListLensSharesRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListLensSharesRequestMarshaller {
    ...
    public static ListLensSharesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListLensSharesRequest listLensSharesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listLensSharesRequest.getLensAlias(), LENSALIAS_BINDING);
