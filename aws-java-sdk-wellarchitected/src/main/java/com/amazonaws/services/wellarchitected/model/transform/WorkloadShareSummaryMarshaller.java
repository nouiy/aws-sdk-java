...
/**
 * WorkloadShareSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WorkloadShareSummaryMarshaller {
    ...
    public static WorkloadShareSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WorkloadShareSummary workloadShareSummary, ProtocolMarshaller protocolMarshaller) {

        if (workloadShareSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(workloadShareSummary.getShareId(), SHAREID_BINDING);
