...
/**
 * LensReviewReportMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class LensReviewReportMarshaller {
    ...
    private static final LensReviewReportMarshaller instance = new LensReviewReportMarshaller();

    public static LensReviewReportMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LensReviewReport lensReviewReport, ProtocolMarshaller protocolMarshaller) {

        if (lensReviewReport == null) {
