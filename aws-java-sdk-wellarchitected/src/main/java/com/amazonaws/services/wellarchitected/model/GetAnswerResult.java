...
public class GetAnswerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetAnswerResult withWorkloadId(String workloadId) {
    ...
    public GetAnswerResult withMilestoneNumber(Integer milestoneNumber) {
    ...
    public GetAnswerResult withLensAlias(String lensAlias) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAnswerResult == false)
            return false;
        GetAnswerResult other = (GetAnswerResult) obj;
