...
/**
 * DeleteLensResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteLensResultJsonUnmarshaller implements Unmarshaller<DeleteLensResult, JsonUnmarshallerContext> {

    public DeleteLensResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteLensResult deleteLensResult = new DeleteLensResult();
