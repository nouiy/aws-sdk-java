...
public class LensMarshaller {
    ...
    public static LensMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Lens lens, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(lens.getLensArn(), LENSARN_BINDING);
            protocolMarshaller.marshall(lens.getLensVersion(), LENSVERSION_BINDING);
            protocolMarshaller.marshall(lens.getName(), NAME_BINDING);
