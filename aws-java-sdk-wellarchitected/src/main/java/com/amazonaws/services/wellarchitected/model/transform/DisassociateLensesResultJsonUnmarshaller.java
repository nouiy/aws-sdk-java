...
/**
 * DisassociateLensesResult JSON Unmarshaller
 */
...
public class DisassociateLensesResultJsonUnmarshaller implements Unmarshaller<DisassociateLensesResult, JsonUnmarshallerContext> {
    ...
    public DisassociateLensesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateLensesResult disassociateLensesResult = new DisassociateLensesResult();
