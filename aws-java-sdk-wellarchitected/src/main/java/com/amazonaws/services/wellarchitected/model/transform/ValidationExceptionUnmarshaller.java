...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.wellarchitected.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.wellarchitected.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.wellarchitected.model.ValidationException validationException = new com.amazonaws.services.wellarchitected.model.ValidationException(
                null);
