...
/**
 * LensSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LensSummaryJsonUnmarshaller implements Unmarshaller<LensSummary, JsonUnmarshallerContext> {

    public LensSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        LensSummary lensSummary = new LensSummary();
    ...
    private static LensSummaryJsonUnmarshaller instance;

    public static LensSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new LensSummaryJsonUnmarshaller();
        return instance;
    }
}
