...
public class ListWorkloadSharesRequestMarshaller {
    ...
    public static ListWorkloadSharesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListWorkloadSharesRequest listWorkloadSharesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listWorkloadSharesRequest.getWorkloadId(), WORKLOADID_BINDING);
