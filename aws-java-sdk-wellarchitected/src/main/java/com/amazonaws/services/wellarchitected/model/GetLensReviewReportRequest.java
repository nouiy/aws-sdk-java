...
public class GetLensReviewReportRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetLensReviewReportRequest withMilestoneNumber(Integer milestoneNumber) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetLensReviewReportRequest == false)
            return false;
        GetLensReviewReportRequest other = (GetLensReviewReportRequest) obj;
    ...
    @Override
    public GetLensReviewReportRequest clone() {
