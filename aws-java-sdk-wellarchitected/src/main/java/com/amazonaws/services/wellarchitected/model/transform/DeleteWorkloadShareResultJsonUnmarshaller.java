...
/**
 * DeleteWorkloadShareResult JSON Unmarshaller
 */
...
public class DeleteWorkloadShareResultJsonUnmarshaller implements Unmarshaller<DeleteWorkloadShareResult, JsonUnmarshallerContext> {
    ...
    public DeleteWorkloadShareResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteWorkloadShareResult deleteWorkloadShareResult = new DeleteWorkloadShareResult();
