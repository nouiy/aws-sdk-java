...
/**
 * PillarDifference JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PillarDifferenceJsonUnmarshaller implements Unmarshaller<PillarDifference, JsonUnmarshallerContext> {

    public PillarDifference unmarshall(JsonUnmarshallerContext context) throws Exception {
        PillarDifference pillarDifference = new PillarDifference();
    ...
    private static PillarDifferenceJsonUnmarshaller instance;

    public static PillarDifferenceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PillarDifferenceJsonUnmarshaller();
        return instance;
    }
}
