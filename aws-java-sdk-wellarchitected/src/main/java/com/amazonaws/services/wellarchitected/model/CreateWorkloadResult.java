...
public class CreateWorkloadResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateWorkloadResult withWorkloadId(String workloadId) {
    ...
    public CreateWorkloadResult withWorkloadArn(String workloadArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateWorkloadResult == false)
            return false;
        CreateWorkloadResult other = (CreateWorkloadResult) obj;
    ...
    @Override
    public CreateWorkloadResult clone() {
        try {
            return (CreateWorkloadResult) super.clone();
