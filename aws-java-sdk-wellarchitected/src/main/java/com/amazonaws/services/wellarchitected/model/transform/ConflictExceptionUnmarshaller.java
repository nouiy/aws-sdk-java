...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.wellarchitected.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.wellarchitected.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.wellarchitected.model.ConflictException conflictException = new com.amazonaws.services.wellarchitected.model.ConflictException(
                null);
