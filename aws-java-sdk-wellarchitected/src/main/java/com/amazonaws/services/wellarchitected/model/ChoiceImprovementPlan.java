 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/wellarchitected-2020-03-31/ChoiceImprovementPlan"
...
public class ChoiceImprovementPlan implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ChoiceImprovementPlan == false)
            return false;
    ...
    @Override
    public ChoiceImprovementPlan clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.wellarchitected.model.transform.ChoiceImprovementPlanMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
