...
public class LensSummaryMarshaller {
    ...
    public static LensSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(LensSummary lensSummary, ProtocolMarshaller protocolMarshaller) {
