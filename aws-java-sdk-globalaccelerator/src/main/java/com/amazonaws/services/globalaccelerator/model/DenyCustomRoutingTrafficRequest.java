...
public class DenyCustomRoutingTrafficRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DenyCustomRoutingTrafficRequest withDestinationAddresses(java.util.Collection<String> destinationAddresses) {
    ...
    public DenyCustomRoutingTrafficRequest withDestinationPorts(Integer... destinationPorts) {
    ...
    public DenyCustomRoutingTrafficRequest withDestinationPorts(java.util.Collection<Integer> destinationPorts) {
    ...
    public DenyCustomRoutingTrafficRequest withDenyAllTrafficToEndpoint(Boolean denyAllTrafficToEndpoint) {
        setDenyAllTrafficToEndpoint(denyAllTrafficToEndpoint);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DenyCustomRoutingTrafficRequest == false)
            return false;
        ...
        if (other.getDestinationPorts() != null && other.getDestinationPorts().equals(this.getDestinationPorts()) == false)
            return false;
        if (other.getDenyAllTrafficToEndpoint() == null ^ this.getDenyAllTrafficToEndpoint() == null)
            return false;
        if (other.getDenyAllTrafficToEndpoint() != null && other.getDenyAllTrafficToEndpoint().equals(this.getDenyAllTrafficToEndpoint()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDenyAllTrafficToEndpoint() == null) ? 0 : getDenyAllTrafficToEndpoint().hashCode());
        return hashCode;
    }
