...
public class ListenerNotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static ListenerNotFoundExceptionUnmarshaller instance;

    public static ListenerNotFoundExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new ListenerNotFoundExceptionUnmarshaller();
        return instance;
    }
}
