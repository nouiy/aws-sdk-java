...
/**
 * DeleteAcceleratorResult JSON Unmarshaller
 */
...
public class DeleteAcceleratorResultJsonUnmarshaller implements Unmarshaller<DeleteAcceleratorResult, JsonUnmarshallerContext> {
    ...
    public DeleteAcceleratorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAcceleratorResult deleteAcceleratorResult = new DeleteAcceleratorResult();
