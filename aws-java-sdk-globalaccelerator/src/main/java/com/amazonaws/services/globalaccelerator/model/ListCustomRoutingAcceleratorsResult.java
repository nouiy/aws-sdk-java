...
public class ListCustomRoutingAcceleratorsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     */
    private java.util.List<CustomRoutingAccelerator> accelerators;
    /**
     * <p>
    ...
    public java.util.List<CustomRoutingAccelerator> getAccelerators() {
        return accelerators;
    }
    ...
    public void setAccelerators(java.util.Collection<CustomRoutingAccelerator> accelerators) {
        if (accelerators == null) {
            this.accelerators = null;
            return;
        }

        this.accelerators = new java.util.ArrayList<CustomRoutingAccelerator>(accelerators);
    }
    ...
    public ListCustomRoutingAcceleratorsResult withAccelerators(CustomRoutingAccelerator... accelerators) {
        if (this.accelerators == null) {
            setAccelerators(new java.util.ArrayList<CustomRoutingAccelerator>(accelerators.length));
        }
    ...
    public ListCustomRoutingAcceleratorsResult withAccelerators(java.util.Collection<CustomRoutingAccelerator> accelerators) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCustomRoutingAcceleratorsResult == false)
            return false;
