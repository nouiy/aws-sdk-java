...
public class ListCustomRoutingEndpointGroupsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     */
    private java.util.List<CustomRoutingEndpointGroup> endpointGroups;
    /**
     * <p>
    ...
    public java.util.List<CustomRoutingEndpointGroup> getEndpointGroups() {
    ...
    public void setEndpointGroups(java.util.Collection<CustomRoutingEndpointGroup> endpointGroups) {
        if (endpointGroups == null) {
            this.endpointGroups = null;
            return;
        }

        this.endpointGroups = new java.util.ArrayList<CustomRoutingEndpointGroup>(endpointGroups);
    }
    ...
    public ListCustomRoutingEndpointGroupsResult withEndpointGroups(CustomRoutingEndpointGroup... endpointGroups) {
        if (this.endpointGroups == null) {
            setEndpointGroups(new java.util.ArrayList<CustomRoutingEndpointGroup>(endpointGroups.length));
        }
        for (CustomRoutingEndpointGroup ele : endpointGroups) {
    ...
    public ListCustomRoutingEndpointGroupsResult withEndpointGroups(java.util.Collection<CustomRoutingEndpointGroup> endpointGroups) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCustomRoutingEndpointGroupsResult == false)
            return false;
        ListCustomRoutingEndpointGroupsResult other = (ListCustomRoutingEndpointGroupsResult) obj;
    ...
    public ListCustomRoutingEndpointGroupsResult clone() {
        try {
            return (ListCustomRoutingEndpointGroupsResult) super.clone();
