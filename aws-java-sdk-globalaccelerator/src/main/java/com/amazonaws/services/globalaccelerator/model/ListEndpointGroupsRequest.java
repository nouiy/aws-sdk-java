...
public class ListEndpointGroupsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEndpointGroupsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEndpointGroupsRequest == false)
            return false;
        ListEndpointGroupsRequest other = (ListEndpointGroupsRequest) obj;
    ...
    @Override
    public ListEndpointGroupsRequest clone() {
        return (ListEndpointGroupsRequest) super.clone();
    }
