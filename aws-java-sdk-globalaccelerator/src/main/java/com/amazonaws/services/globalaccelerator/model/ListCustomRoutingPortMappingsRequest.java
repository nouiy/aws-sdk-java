...
public class ListCustomRoutingPortMappingsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListCustomRoutingPortMappingsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListCustomRoutingPortMappingsRequest == false)
            return false;
    ...
    @Override
    public ListCustomRoutingPortMappingsRequest clone() {
        return (ListCustomRoutingPortMappingsRequest) super.clone();
    }
