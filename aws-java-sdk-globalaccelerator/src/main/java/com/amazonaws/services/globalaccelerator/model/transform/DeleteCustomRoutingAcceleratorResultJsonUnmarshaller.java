...
/**
 * DeleteCustomRoutingAcceleratorResult JSON Unmarshaller
 */
...
public class DeleteCustomRoutingAcceleratorResultJsonUnmarshaller implements Unmarshaller<DeleteCustomRoutingAcceleratorResult, JsonUnmarshallerContext> {
    ...
    public DeleteCustomRoutingAcceleratorResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteCustomRoutingAcceleratorResult deleteCustomRoutingAcceleratorResult = new DeleteCustomRoutingAcceleratorResult();

        return deleteCustomRoutingAcceleratorResult;
    }
