...
public class UpdateCustomRoutingListenerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information for the updated listener for a custom routing accelerator.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateCustomRoutingListenerResult == false)
            return false;
        UpdateCustomRoutingListenerResult other = (UpdateCustomRoutingListenerResult) obj;
    ...
    public UpdateCustomRoutingListenerResult clone() {
        try {
            return (UpdateCustomRoutingListenerResult) super.clone();
