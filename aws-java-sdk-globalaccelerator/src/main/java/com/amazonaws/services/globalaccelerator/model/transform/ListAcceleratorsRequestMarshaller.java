...
/**
 * ListAcceleratorsRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListAcceleratorsRequestMarshaller {
    ...
    private static final ListAcceleratorsRequestMarshaller instance = new ListAcceleratorsRequestMarshaller();

    public static ListAcceleratorsRequestMarshaller getInstance() {
        return instance;
    }
