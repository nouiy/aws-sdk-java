...
/**
 * DeleteEndpointGroupResult JSON Unmarshaller
 */
...
public class DeleteEndpointGroupResultJsonUnmarshaller implements Unmarshaller<DeleteEndpointGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteEndpointGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEndpointGroupResult deleteEndpointGroupResult = new DeleteEndpointGroupResult();
