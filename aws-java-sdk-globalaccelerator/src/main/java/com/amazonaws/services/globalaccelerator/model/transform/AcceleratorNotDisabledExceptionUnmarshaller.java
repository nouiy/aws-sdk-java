...
public class AcceleratorNotDisabledExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static AcceleratorNotDisabledExceptionUnmarshaller instance;

    public static AcceleratorNotDisabledExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new AcceleratorNotDisabledExceptionUnmarshaller();
        return instance;
    }
}
