...
public class ReadPipelineRequestProtocolMarshaller implements Marshaller<Request<ReadPipelineRequest>, ReadPipelineRequest> {
    ...
    public ReadPipelineRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<ReadPipelineRequest> marshall(ReadPipelineRequest readPipelineRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<ReadPipelineRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    readPipelineRequest);

            protocolMarshaller.startMarshalling();
            ReadPipelineRequestMarshaller.getInstance().marshall(readPipelineRequest, protocolMarshaller);
