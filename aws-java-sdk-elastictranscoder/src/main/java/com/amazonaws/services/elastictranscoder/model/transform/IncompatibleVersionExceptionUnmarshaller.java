...
public class IncompatibleVersionExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    ...
    private static IncompatibleVersionExceptionUnmarshaller instance;

    public static IncompatibleVersionExceptionUnmarshaller getInstance() {
        if (instance == null)
            instance = new IncompatibleVersionExceptionUnmarshaller();
        return instance;
    }
}
