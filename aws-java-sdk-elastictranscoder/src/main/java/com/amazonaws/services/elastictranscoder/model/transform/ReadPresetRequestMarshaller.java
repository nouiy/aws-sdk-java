...
public class ReadPresetRequestMarshaller {
    ...
    private static final ReadPresetRequestMarshaller instance = new ReadPresetRequestMarshaller();

    public static ReadPresetRequestMarshaller getInstance() {
        return instance;
    }
