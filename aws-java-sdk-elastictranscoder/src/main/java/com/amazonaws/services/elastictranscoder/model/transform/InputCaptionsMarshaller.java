...
@SdkInternalApi
public class InputCaptionsMarshaller {
    ...
    private static final InputCaptionsMarshaller instance = new InputCaptionsMarshaller();

    public static InputCaptionsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(InputCaptions inputCaptions, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(inputCaptions.getMergePolicy(), MERGEPOLICY_BINDING);
            protocolMarshaller.marshall(inputCaptions.getCaptionSources(), CAPTIONSOURCES_BINDING);
        } catch (Exception e) {
