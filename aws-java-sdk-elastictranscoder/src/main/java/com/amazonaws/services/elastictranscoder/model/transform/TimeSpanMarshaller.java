...
@SdkInternalApi
public class TimeSpanMarshaller {
    ...
    private static final TimeSpanMarshaller instance = new TimeSpanMarshaller();

    public static TimeSpanMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TimeSpan timeSpan, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(timeSpan.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(timeSpan.getDuration(), DURATION_BINDING);
        } catch (Exception e) {
