...
public class CaptionFormatJsonUnmarshaller implements Unmarshaller<CaptionFormat, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Format", targetDepth)) {
                    context.nextToken();
                    captionFormat.setFormat(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Pattern", targetDepth)) {
                    context.nextToken();
                    captionFormat.setPattern(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    public static CaptionFormatJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new CaptionFormatJsonUnmarshaller();
        return instance;
    }
}
