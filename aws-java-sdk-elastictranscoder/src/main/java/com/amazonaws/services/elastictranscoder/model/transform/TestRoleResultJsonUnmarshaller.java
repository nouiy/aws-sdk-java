...
public class TestRoleResultJsonUnmarshaller implements Unmarshaller<TestRoleResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Success", targetDepth)) {
                    context.nextToken();
                    testRoleResult.setSuccess(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Messages", targetDepth)) {
                    context.nextToken();
                    testRoleResult.setMessages(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
    ...
    public static TestRoleResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TestRoleResultJsonUnmarshaller();
        return instance;
    }
}
