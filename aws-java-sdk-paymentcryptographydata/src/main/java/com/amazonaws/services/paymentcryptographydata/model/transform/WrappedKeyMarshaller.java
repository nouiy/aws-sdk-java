...
public class WrappedKeyMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> WRAPPEDKEYMATERIAL_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("WrappedKeyMaterial").build();
    ...
    public void marshall(WrappedKey wrappedKey, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(wrappedKey.getWrappedKeyMaterial(), WRAPPEDKEYMATERIAL_BINDING);
