    ...
    public WrappedKey unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("WrappedKeyMaterial", targetDepth)) {
                    context.nextToken();
                    wrappedKey.setWrappedKeyMaterial(WrappedKeyMaterialJsonUnmarshaller.getInstance().unmarshall(context));
                }
