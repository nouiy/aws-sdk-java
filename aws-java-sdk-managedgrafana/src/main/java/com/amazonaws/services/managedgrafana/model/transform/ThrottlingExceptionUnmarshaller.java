...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.managedgrafana.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.managedgrafana.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.managedgrafana.model.ThrottlingException throttlingException = new com.amazonaws.services.managedgrafana.model.ThrottlingException(
                null);
