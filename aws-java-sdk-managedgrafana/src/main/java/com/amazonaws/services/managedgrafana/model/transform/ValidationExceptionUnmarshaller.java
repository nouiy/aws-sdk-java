...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.managedgrafana.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.managedgrafana.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.managedgrafana.model.ValidationException validationException = new com.amazonaws.services.managedgrafana.model.ValidationException(
                null);
