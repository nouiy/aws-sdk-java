...
public class DisassociateLicenseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DisassociateLicenseResult withWorkspace(WorkspaceDescription workspace) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateLicenseResult == false)
            return false;
        DisassociateLicenseResult other = (DisassociateLicenseResult) obj;
    ...
    @Override
    public DisassociateLicenseResult clone() {
        try {
            return (DisassociateLicenseResult) super.clone();
