...
public class AssociateLicenseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure containing data about the workspace.
     */
    ...
    public AssociateLicenseResult withWorkspace(WorkspaceDescription workspace) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AssociateLicenseResult == false)
            return false;
        AssociateLicenseResult other = (AssociateLicenseResult) obj;
    ...
    @Override
    public AssociateLicenseResult clone() {
        try {
            return (AssociateLicenseResult) super.clone();
