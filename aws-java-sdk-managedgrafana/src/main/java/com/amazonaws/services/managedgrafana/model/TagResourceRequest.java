...
public class TagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The list of tag keys and values to associate with the resource. You can associate tag keys only, tags (key and
     * values) only or a combination of tag keys and tags.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The ARN of the resource the tag is associated with.
     */
     ...
     * </p>
     * 
     * @return The list of tag keys and values to associate with the resource. You can associate tag keys only, tags
     *         (key and values) only or a combination of tag keys and tags.
     */
     ...
     *        and values) only or a combination of tag keys and tags.
     */
