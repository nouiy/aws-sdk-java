...
public class InternalServerExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private InternalServerExceptionUnmarshaller() {
        super(com.amazonaws.services.managedgrafana.model.InternalServerException.class, "InternalServerException");
    }

    @Override
    public com.amazonaws.services.managedgrafana.model.InternalServerException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.managedgrafana.model.InternalServerException internalServerException = new com.amazonaws.services.managedgrafana.model.InternalServerException(
                null);
