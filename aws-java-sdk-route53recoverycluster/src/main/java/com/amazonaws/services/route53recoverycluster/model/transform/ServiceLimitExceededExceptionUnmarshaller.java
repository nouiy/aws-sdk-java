...
public class ServiceLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceLimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.route53recoverycluster.model.ServiceLimitExceededException.class, "ServiceLimitExceededException");
    }

    @Override
    public com.amazonaws.services.route53recoverycluster.model.ServiceLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.route53recoverycluster.model.ServiceLimitExceededException serviceLimitExceededException = new com.amazonaws.services.route53recoverycluster.model.ServiceLimitExceededException(
                null);
