 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/SuppressionOptions" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SuppressionOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    public SuppressionOptions withSuppressedReasons(java.util.Collection<String> suppressedReasons) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SuppressionOptions == false)
            return false;
        SuppressionOptions other = (SuppressionOptions) obj;
    ...
    public SuppressionOptions clone() {
        try {
            return (SuppressionOptions) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simpleemailv2.model.transform.SuppressionOptionsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
