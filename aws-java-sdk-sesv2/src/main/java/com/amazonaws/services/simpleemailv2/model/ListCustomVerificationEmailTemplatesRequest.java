...
public class ListCustomVerificationEmailTemplatesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The number of results to show in a single call to <code>ListCustomVerificationEmailTemplates</code>. If the
     ...
     *         the position in the list of custom verification email templates.
     */
     ...
     * 
     * @param pageSize
     *        The number of results to show in a single call to <code>ListCustomVerificationEmailTemplates</code>. If
     ...
     * </p>
     * 
     * @return The number of results to show in a single call to <code>ListCustomVerificationEmailTemplates</code>. If
     *         the number of results is larger than the number you specified in this parameter, then the response
     *         includes a <code>NextToken</code> element, which you can use to obtain additional results.</p>
     *         <p>
     *         The value you specify has to be at least 1, and can be no more than 50.
