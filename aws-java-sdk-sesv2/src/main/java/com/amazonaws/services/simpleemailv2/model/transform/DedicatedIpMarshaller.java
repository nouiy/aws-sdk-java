...
/**
 * DedicatedIpMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DedicatedIpMarshaller {
    ...
    private static final MarshallingInfo<String> WARMUPSTATUS_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("WarmupStatus").build();
    ...
    private static final DedicatedIpMarshaller instance = new DedicatedIpMarshaller();

    public static DedicatedIpMarshaller getInstance() {
        return instance;
    }
