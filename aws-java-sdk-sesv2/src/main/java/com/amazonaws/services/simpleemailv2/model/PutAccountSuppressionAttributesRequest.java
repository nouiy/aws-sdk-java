...
public class PutAccountSuppressionAttributesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutAccountSuppressionAttributesRequest withSuppressedReasons(java.util.Collection<String> suppressedReasons) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutAccountSuppressionAttributesRequest == false)
            return false;
    ...
    public PutAccountSuppressionAttributesRequest clone() {
        return (PutAccountSuppressionAttributesRequest) super.clone();
    }
