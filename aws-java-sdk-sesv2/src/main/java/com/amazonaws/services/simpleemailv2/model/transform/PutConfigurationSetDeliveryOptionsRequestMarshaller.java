...
public class PutConfigurationSetDeliveryOptionsRequestMarshaller {
    ...
    private static final PutConfigurationSetDeliveryOptionsRequestMarshaller instance = new PutConfigurationSetDeliveryOptionsRequestMarshaller();

    public static PutConfigurationSetDeliveryOptionsRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutConfigurationSetDeliveryOptionsRequest putConfigurationSetDeliveryOptionsRequest, ProtocolMarshaller protocolMarshaller) {
