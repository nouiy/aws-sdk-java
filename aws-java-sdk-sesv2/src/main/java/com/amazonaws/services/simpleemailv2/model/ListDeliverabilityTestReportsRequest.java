...
public class ListDeliverabilityTestReportsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListDeliverabilityTestReportsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListDeliverabilityTestReportsRequest == false)
            return false;
    ...
    @Override
    public ListDeliverabilityTestReportsRequest clone() {
        return (ListDeliverabilityTestReportsRequest) super.clone();
    }
