...
@SdkInternalApi
public class DeleteEmailTemplateRequestMarshaller {
    ...
    public static DeleteEmailTemplateRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DeleteEmailTemplateRequest deleteEmailTemplateRequest, ProtocolMarshaller protocolMarshaller) {
