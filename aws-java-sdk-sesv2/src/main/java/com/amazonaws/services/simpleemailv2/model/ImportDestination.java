 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/ImportDestination" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportDestination implements Serializable, Cloneable, StructuredPojo {
    ...
    public SuppressionListDestination getSuppressionListDestination() {
    ...
    public ImportDestination withSuppressionListDestination(SuppressionListDestination suppressionListDestination) {
        setSuppressionListDestination(suppressionListDestination);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportDestination == false)
            return false;
        ImportDestination other = (ImportDestination) obj;
        if (other.getSuppressionListDestination() == null ^ this.getSuppressionListDestination() == null)
            return false;
    ...
    public ImportDestination clone() {
        try {
            return (ImportDestination) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simpleemailv2.model.transform.ImportDestinationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
