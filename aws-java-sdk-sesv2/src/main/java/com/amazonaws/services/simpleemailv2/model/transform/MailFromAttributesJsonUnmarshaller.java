...
/**
 * MailFromAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MailFromAttributesJsonUnmarshaller implements Unmarshaller<MailFromAttributes, JsonUnmarshallerContext> {

    public MailFromAttributes unmarshall(JsonUnmarshallerContext context) throws Exception {
        MailFromAttributes mailFromAttributes = new MailFromAttributes();
    ...
    private static MailFromAttributesJsonUnmarshaller instance;

    public static MailFromAttributesJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new MailFromAttributesJsonUnmarshaller();
        return instance;
    }
}
