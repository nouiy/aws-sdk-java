 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/CloudWatchDimensionConfiguration"
...
public class CloudWatchDimensionConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     *        To use the message tags that you specify using an <code>X-SES-MESSAGE-TAGS</code> header or a parameter to
     *        the <code>SendEmail</code> or <code>SendRawEmail</code> API, choose <code>messageTag</code>. To use your
     *        own email headers, choose <code>emailHeader</code>. To use link tags, choose <code>linkTags</code>.
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simpleemailv2.model.transform.CloudWatchDimensionConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
