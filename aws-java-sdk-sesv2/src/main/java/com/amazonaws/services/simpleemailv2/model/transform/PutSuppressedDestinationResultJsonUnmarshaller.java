...
/**
 * PutSuppressedDestinationResult JSON Unmarshaller
 */
...
public class PutSuppressedDestinationResultJsonUnmarshaller implements Unmarshaller<PutSuppressedDestinationResult, JsonUnmarshallerContext> {
    ...
    public PutSuppressedDestinationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutSuppressedDestinationResult putSuppressedDestinationResult = new PutSuppressedDestinationResult();

        return putSuppressedDestinationResult;
    }
