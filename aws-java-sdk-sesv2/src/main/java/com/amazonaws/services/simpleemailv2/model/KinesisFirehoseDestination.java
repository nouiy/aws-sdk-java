 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sesv2-2019-09-27/KinesisFirehoseDestination" target="_top">AWS
 *      API Documentation</a>
 */
...
public class KinesisFirehoseDestination implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the IAM role that the Amazon SES API v2 uses to send email events to
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the Amazon Kinesis Data Firehose stream that the Amazon SES API v2
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.simpleemailv2.model.transform.KinesisFirehoseDestinationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
