...
/**
 * PutDeliverabilityDashboardOptionResult JSON Unmarshaller
 */
...
public class PutDeliverabilityDashboardOptionResultJsonUnmarshaller implements Unmarshaller<PutDeliverabilityDashboardOptionResult, JsonUnmarshallerContext> {
    ...
    public PutDeliverabilityDashboardOptionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutDeliverabilityDashboardOptionResult putDeliverabilityDashboardOptionResult = new PutDeliverabilityDashboardOptionResult();

        return putDeliverabilityDashboardOptionResult;
    }
