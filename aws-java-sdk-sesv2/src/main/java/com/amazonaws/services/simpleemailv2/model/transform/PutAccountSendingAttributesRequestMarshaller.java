...
public class PutAccountSendingAttributesRequestMarshaller {
    ...
    private static final PutAccountSendingAttributesRequestMarshaller instance = new PutAccountSendingAttributesRequestMarshaller();

    public static PutAccountSendingAttributesRequestMarshaller getInstance() {
        return instance;
    }
