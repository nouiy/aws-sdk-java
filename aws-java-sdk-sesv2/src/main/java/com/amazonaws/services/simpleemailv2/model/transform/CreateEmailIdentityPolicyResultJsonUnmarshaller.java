...
/**
 * CreateEmailIdentityPolicyResult JSON Unmarshaller
 */
...
public class CreateEmailIdentityPolicyResultJsonUnmarshaller implements Unmarshaller<CreateEmailIdentityPolicyResult, JsonUnmarshallerContext> {
    ...
    public CreateEmailIdentityPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateEmailIdentityPolicyResult createEmailIdentityPolicyResult = new CreateEmailIdentityPolicyResult();

        return createEmailIdentityPolicyResult;
    }
