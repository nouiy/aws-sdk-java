...
/**
 * ImportDestination JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportDestinationJsonUnmarshaller implements Unmarshaller<ImportDestination, JsonUnmarshallerContext> {

    public ImportDestination unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ImportDestinationJsonUnmarshaller instance;

    public static ImportDestinationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ImportDestinationJsonUnmarshaller();
        return instance;
    }
}
