...
public class ListCustomVerificationEmailTemplatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
     ...
     * </p>
     */
    private java.util.List<CustomVerificationEmailTemplateMetadata> customVerificationEmailTemplates;
    /**
     * <p>
    ...
    public java.util.List<CustomVerificationEmailTemplateMetadata> getCustomVerificationEmailTemplates() {
    ...
    public void setCustomVerificationEmailTemplates(java.util.Collection<CustomVerificationEmailTemplateMetadata> customVerificationEmailTemplates) {
        if (customVerificationEmailTemplates == null) {
            this.customVerificationEmailTemplates = null;
            return;
        }

        this.customVerificationEmailTemplates = new java.util.ArrayList<CustomVerificationEmailTemplateMetadata>(customVerificationEmailTemplates);
    }
    ...
    public ListCustomVerificationEmailTemplatesResult withCustomVerificationEmailTemplates(
        ...
        if (this.customVerificationEmailTemplates == null) {
            setCustomVerificationEmailTemplates(new java.util.ArrayList<CustomVerificationEmailTemplateMetadata>(customVerificationEmailTemplates.length));
        }
        for (CustomVerificationEmailTemplateMetadata ele : customVerificationEmailTemplates) {
    ...
    public ListCustomVerificationEmailTemplatesResult withCustomVerificationEmailTemplates(
            java.util.Collection<CustomVerificationEmailTemplateMetadata> customVerificationEmailTemplates) {
