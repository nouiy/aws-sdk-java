...
public class CreateImportJobRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> IMPORTDATASOURCE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ImportDataSource").build();
    ...
    public void marshall(CreateImportJobRequest createImportJobRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createImportJobRequest.getImportDestination(), IMPORTDESTINATION_BINDING);
            protocolMarshaller.marshall(createImportJobRequest.getImportDataSource(), IMPORTDATASOURCE_BINDING);
        } catch (Exception e) {
