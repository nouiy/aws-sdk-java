...
/**
 * IotTopicPublishAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IotTopicPublishActionJsonUnmarshaller implements Unmarshaller<IotTopicPublishAction, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("mqttTopic", targetDepth)) {
                    context.nextToken();
                    iotTopicPublishAction.setMqttTopic(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("payload", targetDepth)) {
                    context.nextToken();
                    iotTopicPublishAction.setPayload(PayloadJsonUnmarshaller.getInstance().unmarshall(context));
                }
