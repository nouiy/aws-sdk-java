...
/**
 * IotEventsAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IotEventsActionJsonUnmarshaller implements Unmarshaller<IotEventsAction, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("payload", targetDepth)) {
                    context.nextToken();
                    iotEventsAction.setPayload(PayloadJsonUnmarshaller.getInstance().unmarshall(context));
                }
