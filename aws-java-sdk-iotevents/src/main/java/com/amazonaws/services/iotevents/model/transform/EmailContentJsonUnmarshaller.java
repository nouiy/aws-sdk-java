        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("subject", targetDepth)) {
                    context.nextToken();
                    emailContent.setSubject(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("additionalMessage", targetDepth)) {
                    context.nextToken();
                    emailContent.setAdditionalMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
