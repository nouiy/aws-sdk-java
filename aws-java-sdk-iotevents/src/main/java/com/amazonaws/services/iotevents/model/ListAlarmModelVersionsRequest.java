...
public class ListAlarmModelVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAlarmModelVersionsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAlarmModelVersionsRequest == false)
            return false;
        ListAlarmModelVersionsRequest other = (ListAlarmModelVersionsRequest) obj;
    ...
    @Override
    public ListAlarmModelVersionsRequest clone() {
        return (ListAlarmModelVersionsRequest) super.clone();
    }
