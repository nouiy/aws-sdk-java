...
public class UpdateAlarmModelResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAlarmModelResult withCreationTime(java.util.Date creationTime) {
    ...
    public UpdateAlarmModelResult withLastUpdateTime(java.util.Date lastUpdateTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAlarmModelResult == false)
            return false;
        UpdateAlarmModelResult other = (UpdateAlarmModelResult) obj;
    ...
    public UpdateAlarmModelResult clone() {
        try {
            return (UpdateAlarmModelResult) super.clone();
