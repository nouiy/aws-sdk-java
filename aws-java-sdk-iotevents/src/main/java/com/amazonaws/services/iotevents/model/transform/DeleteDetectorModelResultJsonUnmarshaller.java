...
/**
 * DeleteDetectorModelResult JSON Unmarshaller
 */
...
public class DeleteDetectorModelResultJsonUnmarshaller implements Unmarshaller<DeleteDetectorModelResult, JsonUnmarshallerContext> {
    ...
    public DeleteDetectorModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDetectorModelResult deleteDetectorModelResult = new DeleteDetectorModelResult();
