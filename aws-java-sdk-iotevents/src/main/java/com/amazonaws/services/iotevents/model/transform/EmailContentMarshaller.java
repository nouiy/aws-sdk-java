...
public class EmailContentMarshaller {
    ...
    public void marshall(EmailContent emailContent, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(emailContent.getSubject(), SUBJECT_BINDING);
            protocolMarshaller.marshall(emailContent.getAdditionalMessage(), ADDITIONALMESSAGE_BINDING);
        } catch (Exception e) {
