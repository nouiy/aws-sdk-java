...
/**
 * DetectorModelConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DetectorModelConfigurationJsonUnmarshaller implements Unmarshaller<DetectorModelConfiguration, JsonUnmarshallerContext> {

    public DetectorModelConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        DetectorModelConfiguration detectorModelConfiguration = new DetectorModelConfiguration();
    ...
    private static DetectorModelConfigurationJsonUnmarshaller instance;

    public static DetectorModelConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DetectorModelConfigurationJsonUnmarshaller();
        return instance;
    }
}
