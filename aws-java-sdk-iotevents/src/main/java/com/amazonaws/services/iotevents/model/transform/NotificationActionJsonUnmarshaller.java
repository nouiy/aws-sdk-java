...
/**
 * NotificationAction JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NotificationActionJsonUnmarshaller implements Unmarshaller<NotificationAction, JsonUnmarshallerContext> {

    public NotificationAction unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static NotificationActionJsonUnmarshaller instance;

    public static NotificationActionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new NotificationActionJsonUnmarshaller();
        return instance;
    }
}
