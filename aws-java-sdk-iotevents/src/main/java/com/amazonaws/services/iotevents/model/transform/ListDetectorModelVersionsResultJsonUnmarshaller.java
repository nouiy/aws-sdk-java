...
/**
 * ListDetectorModelVersionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDetectorModelVersionsResultJsonUnmarshaller implements Unmarshaller<ListDetectorModelVersionsResult, JsonUnmarshallerContext> {

    public ListDetectorModelVersionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("nextToken", targetDepth)) {
                    context.nextToken();
                    listDetectorModelVersionsResult.setNextToken(context.getUnmarshaller(String.class).unmarshall(context));
                }
