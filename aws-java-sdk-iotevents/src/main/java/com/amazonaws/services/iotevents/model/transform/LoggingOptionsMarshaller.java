...
public class LoggingOptionsMarshaller {
    ...
    private static final MarshallingInfo<List> DETECTORDEBUGOPTIONS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("detectorDebugOptions").build();
    ...
    public void marshall(LoggingOptions loggingOptions, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(loggingOptions.getDetectorDebugOptions(), DETECTORDEBUGOPTIONS_BINDING);
        } catch (Exception e) {
