...
public class BasePathMappingJsonUnmarshaller implements Unmarshaller<BasePathMapping, JsonUnmarshallerContext> {
    ...
    public static BasePathMappingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BasePathMappingJsonUnmarshaller();
        return instance;
    }
}
