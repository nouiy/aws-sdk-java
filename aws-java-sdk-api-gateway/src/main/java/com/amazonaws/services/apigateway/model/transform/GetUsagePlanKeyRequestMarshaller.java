...
@SdkInternalApi
public class GetUsagePlanKeyRequestMarshaller {
    ...
    private static final GetUsagePlanKeyRequestMarshaller instance = new GetUsagePlanKeyRequestMarshaller();

    public static GetUsagePlanKeyRequestMarshaller getInstance() {
        return instance;
    }
