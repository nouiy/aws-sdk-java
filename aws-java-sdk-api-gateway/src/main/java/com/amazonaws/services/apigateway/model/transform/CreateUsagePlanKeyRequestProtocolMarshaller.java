...
public class CreateUsagePlanKeyRequestProtocolMarshaller implements Marshaller<Request<CreateUsagePlanKeyRequest>, CreateUsagePlanKeyRequest> {
    ...
    public CreateUsagePlanKeyRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<CreateUsagePlanKeyRequest> marshall(CreateUsagePlanKeyRequest createUsagePlanKeyRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<CreateUsagePlanKeyRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    createUsagePlanKeyRequest);

            protocolMarshaller.startMarshalling();
            CreateUsagePlanKeyRequestMarshaller.getInstance().marshall(createUsagePlanKeyRequest, protocolMarshaller);
