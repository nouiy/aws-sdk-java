...
/**
 * DeleteDocumentationVersionResult JSON Unmarshaller
 */
...
public class DeleteDocumentationVersionResultJsonUnmarshaller implements Unmarshaller<DeleteDocumentationVersionResult, JsonUnmarshallerContext> {
    ...
    public DeleteDocumentationVersionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDocumentationVersionResult deleteDocumentationVersionResult = new DeleteDocumentationVersionResult();
