...
public class ThrottleSettingsJsonUnmarshaller implements Unmarshaller<ThrottleSettings, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("burstLimit", targetDepth)) {
                    context.nextToken();
                    throttleSettings.setBurstLimit(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
    ...
    public static ThrottleSettingsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ThrottleSettingsJsonUnmarshaller();
        return instance;
    }
}
