...
public class DeleteDocumentationVersionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteDocumentationVersionRequest withRestApiId(String restApiId) {
     ...
     * </p>
     * 
     * @return [Required] The version identifier of a to-be-deleted documentation snapshot.
     */
    ...
    public DeleteDocumentationVersionRequest withDocumentationVersion(String documentationVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteDocumentationVersionRequest == false)
            return false;
        DeleteDocumentationVersionRequest other = (DeleteDocumentationVersionRequest) obj;
