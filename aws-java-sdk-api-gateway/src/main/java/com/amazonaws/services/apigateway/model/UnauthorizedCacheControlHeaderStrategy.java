...
public enum UnauthorizedCacheControlHeaderStrategy {
    ...
    private UnauthorizedCacheControlHeaderStrategy(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return UnauthorizedCacheControlHeaderStrategy corresponding to the value
     *
    ...
    public static UnauthorizedCacheControlHeaderStrategy fromValue(String value) {
        ...
        for (UnauthorizedCacheControlHeaderStrategy enumEntry : UnauthorizedCacheControlHeaderStrategy.values()) {
