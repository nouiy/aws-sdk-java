...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.apigateway.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.apigateway.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.apigateway.model.LimitExceededException limitExceededException = new com.amazonaws.services.apigateway.model.LimitExceededException(
                null);
