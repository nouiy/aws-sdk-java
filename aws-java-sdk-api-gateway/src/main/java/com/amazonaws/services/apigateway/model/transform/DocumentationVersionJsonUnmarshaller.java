...
/**
 * DocumentationVersion JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DocumentationVersionJsonUnmarshaller implements Unmarshaller<DocumentationVersion, JsonUnmarshallerContext> {
    ...
    private static DocumentationVersionJsonUnmarshaller instance;

    public static DocumentationVersionJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new DocumentationVersionJsonUnmarshaller();
        return instance;
    }
}
