        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    createVpcLinkResult.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("description", targetDepth)) {
                    context.nextToken();
                    createVpcLinkResult.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("targetArns", targetDepth)) {
                    context.nextToken();
                    createVpcLinkResult.setTargetArns(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("status", targetDepth)) {
                    context.nextToken();
                    createVpcLinkResult.setStatus(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("statusMessage", targetDepth)) {
                    context.nextToken();
                    createVpcLinkResult.setStatusMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
