...
public class DeleteRestApiRequestProtocolMarshaller implements Marshaller<Request<DeleteRestApiRequest>, DeleteRestApiRequest> {
    ...
    public DeleteRestApiRequestProtocolMarshaller(com.amazonaws.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DeleteRestApiRequest> marshall(DeleteRestApiRequest deleteRestApiRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DeleteRestApiRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
                    deleteRestApiRequest);

            protocolMarshaller.startMarshalling();
            DeleteRestApiRequestMarshaller.getInstance().marshall(deleteRestApiRequest, protocolMarshaller);
