...
public class GetBasePathMappingResultJsonUnmarshaller implements Unmarshaller<GetBasePathMappingResult, JsonUnmarshallerContext> {
    ...
    private static GetBasePathMappingResultJsonUnmarshaller instance;

    public static GetBasePathMappingResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetBasePathMappingResultJsonUnmarshaller();
        return instance;
    }
}
