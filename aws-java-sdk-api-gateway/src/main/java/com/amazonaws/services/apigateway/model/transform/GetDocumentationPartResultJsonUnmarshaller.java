...
public class GetDocumentationPartResultJsonUnmarshaller implements Unmarshaller<GetDocumentationPartResult, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    getDocumentationPartResult.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("location", targetDepth)) {
                    context.nextToken();
                    getDocumentationPartResult.setLocation(DocumentationPartLocationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("properties", targetDepth)) {
                    context.nextToken();
                    getDocumentationPartResult.setProperties(context.getUnmarshaller(String.class).unmarshall(context));
                }
