...
public class GetMethodResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetMethodResult withRequestParameters(java.util.Map<String, Boolean> requestParameters) {
    ...
    public GetMethodResult withRequestModels(java.util.Map<String, String> requestModels) {
    ...
    public GetMethodResult withMethodResponses(java.util.Map<String, MethodResponse> methodResponses) {
    ...
    public GetMethodResult withAuthorizationScopes(java.util.Collection<String> authorizationScopes) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetMethodResult == false)
            return false;
        GetMethodResult other = (GetMethodResult) obj;
