...
public class GetGatewayResponseResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The response type of the associated <a>GatewayResponse</a>.
     * @see GatewayResponseType
     */
    ...
    public GetGatewayResponseResult withResponseTemplates(java.util.Map<String, String> responseTemplates) {
    ...
    public GetGatewayResponseResult withDefaultResponse(Boolean defaultResponse) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetGatewayResponseResult == false)
            return false;
        GetGatewayResponseResult other = (GetGatewayResponseResult) obj;
    ...
    public GetGatewayResponseResult clone() {
        try {
            return (GetGatewayResponseResult) super.clone();
