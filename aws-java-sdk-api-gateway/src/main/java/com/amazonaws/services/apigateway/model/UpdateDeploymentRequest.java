...
public class UpdateDeploymentRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The replacement identifier for the <a>Deployment</a> resource to change information about.
     */
    ...
    public UpdateDeploymentRequest withPatchOperations(PatchOperation... patchOperations) {
    ...
    public UpdateDeploymentRequest withPatchOperations(java.util.Collection<PatchOperation> patchOperations) {
