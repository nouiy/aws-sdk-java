...
public class UpdateDeploymentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateDeploymentResult withApiSummary(java.util.Map<String, java.util.Map<String, MethodSnapshot>> apiSummary) {
     ...
     *
     * @see UpdateDeploymentResult#withApiSummary
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateDeploymentResult addApiSummaryEntry(String key, java.util.Map<String, MethodSnapshot> value) {
