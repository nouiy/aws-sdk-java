...
public class CreateDocumentationVersionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateDocumentationVersionResult withVersion(String version) {
        setVersion(version);
        return this;
    }
    ...
    public CreateDocumentationVersionResult withCreatedDate(java.util.Date createdDate) {
    ...
    public CreateDocumentationVersionResult withDescription(String description) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateDocumentationVersionResult == false)
            return false;
        CreateDocumentationVersionResult other = (CreateDocumentationVersionResult) obj;
    ...
    @Override
    public CreateDocumentationVersionResult clone() {
        try {
