...
public class GenerateClientCertificateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GenerateClientCertificateResult withCreatedDate(java.util.Date createdDate) {
    ...
    public GenerateClientCertificateResult withExpirationDate(java.util.Date expirationDate) {
     ...
     *
     * @see GenerateClientCertificateResult#withTags
