 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/qldb-session-2019-07-11/Page" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Page implements Serializable, Cloneable, StructuredPojo {
    ...
    public Page withValues(ValueHolder... values) {
        if (this.values == null) {
            setValues(new java.util.ArrayList<ValueHolder>(values.length));
        }
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.qldbsession.model.transform.PageMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
