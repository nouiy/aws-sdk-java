...
/**
 * IOUsage JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IOUsageJsonUnmarshaller implements Unmarshaller<IOUsage, JsonUnmarshallerContext> {

    public IOUsage unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static IOUsageJsonUnmarshaller instance;

    public static IOUsageJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new IOUsageJsonUnmarshaller();
        return instance;
    }
}
