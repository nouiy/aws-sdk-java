...
/**
 * ValueHolder JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ValueHolderJsonUnmarshaller implements Unmarshaller<ValueHolder, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("IonBinary", targetDepth)) {
                    context.nextToken();
                    valueHolder.setIonBinary(context.getUnmarshaller(java.nio.ByteBuffer.class).unmarshall(context));
                }
                if (context.testExpression("IonText", targetDepth)) {
                    context.nextToken();
                    valueHolder.setIonText(context.getUnmarshaller(String.class).unmarshall(context));
                }
