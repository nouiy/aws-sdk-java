...
public class LimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private LimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.qldbsession.model.LimitExceededException.class, "LimitExceededException");
    }

    @Override
    public com.amazonaws.services.qldbsession.model.LimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.qldbsession.model.LimitExceededException limitExceededException = new com.amazonaws.services.qldbsession.model.LimitExceededException(
                null);
